# 1 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/compound_dictionary.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 391 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/compound_dictionary.c" 2
...
# 10 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/compound_dictionary.h"
...
# 11 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/compound_dictionary.h" 2
...
# 14 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/compound_dictionary.h" 2
...
# 8 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/compound_dictionary.c" 2
...
# 14 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/compound_dictionary.c" 2
...
static PreparedDictionary* CreatePreparedDictionaryWithParams(MemoryManager* m,
  ...
  uint8_t* flat = ((void*)0);
  PreparedDictionary* result = ((void*)0);
  uint16_t* num = ((void*)0);
  uint32_t* bucket_heads = ((void*)0);
  uint32_t* next_bucket = ((void*)0);
  uint32_t* slot_offsets = ((void*)0);
  uint16_t* heads = ((void*)0);
  uint32_t* items = ((void*)0);
  const uint8_t** source_ref = ((void*)0);
  uint32_t i;
  uint32_t* slot_size = ((void*)0);
  uint32_t* slot_limit = ((void*)0);
  uint32_t total_items = 0;
  if (slot_bits > 16) return ((void*)0);
  if (slot_bits > bucket_bits) return ((void*)0);
  if (bucket_bits - slot_bits >= 16) return ((void*)0);

  flat = ((alloc_size) > 0 ? ((uint8_t*)BrotliAllocate((m), (alloc_size) * sizeof(uint8_t))) : ((void*)0));
  ...
  __builtin___memset_chk (num, 0, num_buckets * sizeof(num[0]), __builtin_object_size (num, 0));


  for (i = 0; i + 7 < source_size; ++i) {
    const uint64_t h = (BrotliUnalignedRead64(&source[i]) & hash_mask) *
  ...
  result = (PreparedDictionary*)((alloc_size) > 0 ? ((uint8_t*)BrotliAllocate((m), (alloc_size) * sizeof(uint8_t))) : ((void*)0));
  if ((!!0) || (!!0)) {
    { BrotliFree((m), (flat)); flat = ((void*)0); };
    return ((void*)0);
  }
...
void DestroyPreparedDictionary(MemoryManager* m,
  ...
  { BrotliFree((m), (dictionary)); dictionary = ((void*)0); };
}

int AttachPreparedDictionary(
    CompoundDictionary* compound, const PreparedDictionary* dictionary) {
  size_t length = 0;
  size_t index = 0;

  if (compound->num_chunks == 15) {
    return 0;
  }
