# 1 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/metablock.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 391 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/metablock.c" 2
# 10 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/metablock.c"
# 1 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/metablock.h" 1
# 13 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/metablock.h"
...
# 14 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/metablock.h" 2

# 1 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/../common/context.h" 1
# 91 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/../common/context.h"
# 1 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/include/brotli/port.h" 1
# 92 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/../common/context.h" 2
...
# 16 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/metablock.h" 2
...
# 17 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/metablock.h" 2
...
# 11 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/metablock.c" 2
...
# 18 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/metablock.c" 2
...
# 20 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/metablock.c" 2
...
# 21 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/metablock.c" 2
...
static int ComputeDistanceCost(const Command* cmds,
                                       size_t num_commands,
                                       const BrotliDistanceParams* orig_params,
                                       const BrotliDistanceParams* new_params,
                                       double* cost,
...
void BrotliBuildMetaBlock(MemoryManager* m,
  ...
  HistogramDistance* tmp = ((1) > 0 ? ((HistogramDistance*)BrotliAllocate((m), (1) * sizeof(HistogramDistance))) : ((void*)0));
...
# 1 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/metablock_inc.h" 1
# 14 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/metablock_inc.h"
...
static void InitBlockSplitterLiteral(
  ...
  *histograms = ((*histograms_size) > 0 ? ((HistogramLiteral*)BrotliAllocate((m), (*histograms_size) * sizeof(HistogramLiteral))) : ((void*)0));
...
static void BlockSplitterFinishBlockLiteral(
  ...
  if (self->num_blocks_ == 0) {
    ...
    for (j = 0; j < 2; ++j) {
      ...
      HistogramAddHistogramLiteral(&self->combined_histo[j],
...
# 291 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/metablock.c" 2
...
static void InitBlockSplitterCommand(
  ...
  self->split_->num_blocks = max_num_blocks;
                                 ;
  *histograms_size = max_num_types;
  *histograms = ((*histograms_size) > 0 ? ((HistogramCommand*)BrotliAllocate((m), (*histograms_size) * sizeof(HistogramCommand))) : ((void*)0));
  self->histograms_ = *histograms;
  if ((!!0) || (!!0)) return;
...
static void BlockSplitterFinishBlockCommand(
  ...
  if (self->num_blocks_ == 0) {
    ...
    for (j = 0; j < 2; ++j) {
      size_t last_histogram_ix = self->last_histogram_ix_[j];
      self->combined_histo[j] = histograms[self->curr_histogram_ix_];
      HistogramAddHistogramCommand(&self->combined_histo[j],
          &histograms[last_histogram_ix]);
      combined_entropy[j] = BitsEntropy(
          &self->combined_histo[j].data_[0], self->alphabet_size_);
      diff[j] = combined_entropy[j] - entropy - last_entropy[j];
...
# 295 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/metablock.c" 2
...
static void InitBlockSplitterDistance(
  ...
  self->split_->num_blocks = max_num_blocks;
                                 ;
  *histograms_size = max_num_types;
  *histograms = ((*histograms_size) > 0 ? ((HistogramDistance*)BrotliAllocate((m), (*histograms_size) * sizeof(HistogramDistance))) : ((void*)0));
  self->histograms_ = *histograms;
  if ((!!0) || (!!0)) return;
...
static void BlockSplitterFinishBlockDistance(
  ...
  if (self->num_blocks_ == 0) {
    ...
    for (j = 0; j < 2; ++j) {
      size_t last_histogram_ix = self->last_histogram_ix_[j];
      self->combined_histo[j] = histograms[self->curr_histogram_ix_];
      HistogramAddHistogramDistance(&self->combined_histo[j],
          &histograms[last_histogram_ix]);
      combined_entropy[j] = BitsEntropy(
          &self->combined_histo[j].data_[0], self->alphabet_size_);
      diff[j] = combined_entropy[j] - entropy - last_entropy[j];
...
# 299 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/metablock.c" 2
...
static void ContextBlockSplitterFinishBlock(
  ...
  if (self->num_blocks_ == 0) {
    ...
    HistogramLiteral* combined_histo =
        ((2 * num_contexts) > 0 ? ((HistogramLiteral*)BrotliAllocate((m), (2 * num_contexts) * sizeof(HistogramLiteral))) : ((void*)0));
    ...
    { BrotliFree((m), (combined_histo)); combined_histo = ((void*)0); };
  }
  if (is_final) {
...
static inline __attribute__((__always_inline__)) void BrotliBuildMetaBlockGreedyInternal(
  ...
  if ((!!0)) return;
  InitBlockSplitterCommand(m, &arena->cmd_blocks, 704,
  ...
  if (num_contexts == 1) {
    BlockSplitterFinishBlockLiteral(
        &arena->lit_blocks.plain, 1);
  } else {
    ContextBlockSplitterFinishBlock(
        &arena->lit_blocks.ctx, m, 1);
    if ((!!0)) return;
  }
...
void BrotliBuildMetaBlockGreedy(MemoryManager* m,
                                ...
                                size_t n_commands,
                                MetaBlockSplit* mb) {
  GreedyMetablockArena* arena = ((1) > 0 ? ((GreedyMetablockArena*)BrotliAllocate((m), (1) * sizeof(GreedyMetablockArena))) : ((void*)0));
  if ((!!0) || (!!0)) return;
  if (num_contexts == 1) {
    BrotliBuildMetaBlockGreedyInternal(m, arena, ringbuffer, pos, mask,
        prev_byte, prev_byte2, literal_context_lut, 1, ((void*)0), commands,
        n_commands, mb);
  } else {
    BrotliBuildMetaBlockGreedyInternal(m, arena, ringbuffer, pos, mask,
