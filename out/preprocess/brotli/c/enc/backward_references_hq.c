# 1 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/backward_references_hq.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 391 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/backward_references_hq.c" 2
...
# 12 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/backward_references_hq.h"
...
# 13 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/backward_references_hq.h" 2
...
# 15 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/backward_references_hq.h" 2
...
# 16 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/backward_references_hq.h" 2
...
# 17 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/backward_references_hq.h" 2
...
# 19 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/backward_references_hq.h" 2
...
# 20 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/backward_references_hq.h" 2
...
# 10 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/backward_references_hq.c" 2
# 22 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/backward_references_hq.c"
# 1 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/literal_cost.h" 1
# 24 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/literal_cost.h"
__attribute__ ((visibility ("hidden"))) void BrotliEstimateBitCostsForLiterals(
    size_t pos, size_t len, size_t mask, const uint8_t* data, size_t* histogram,
    float* cost);
# 23 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/backward_references_hq.c" 2
# 35 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/backward_references_hq.c"
...
static inline __attribute__((__always_inline__)) uint32_t ZopfliNodeCopyLength(const ZopfliNode* self) {
  return self->length & 0x1FFFFFF;
}

static inline __attribute__((__always_inline__)) uint32_t ZopfliNodeLengthCode(const ZopfliNode* self) {
  const uint32_t modifier = self->length >> 25;
  return ZopfliNodeCopyLength(self) + 9u - modifier;
}

static inline __attribute__((__always_inline__)) uint32_t ZopfliNodeCopyDistance(const ZopfliNode* self) {
  return self->distance;
}

static inline __attribute__((__always_inline__)) uint32_t ZopfliNodeDistanceCode(const ZopfliNode* self) {
  const uint32_t short_code = self->dcode_insert_length >> 27;
  return short_code == 0 ?
      ZopfliNodeCopyDistance(self) + 16 - 1 :
      short_code - 1;
}

static inline __attribute__((__always_inline__)) uint32_t ZopfliNodeCommandLength(const ZopfliNode* self) {
...
static void InitZopfliCostModel(
  ...
  self->literal_costs_ = ((num_bytes + 2) > 0 ? ((float*)BrotliAllocate((m), (num_bytes + 2) * sizeof(float))) : ((void*)0));
  self->cost_dist_ = ((dist->alphabet_size_limit) > 0 ? ((float*)BrotliAllocate((m), (dist->alphabet_size_limit) * sizeof(float))) : ((void*)0));
...
static void CleanupZopfliCostModel(MemoryManager* m, ZopfliCostModel* self) {
  { BrotliFree((m), (self->literal_costs_)); self->literal_costs_ = ((void*)0); };
  { BrotliFree((m), (self->cost_dist_)); self->cost_dist_ = ((void*)0); };
}
...
static void ZopfliCostModelSetFromCommands(ZopfliCostModel* self,
  ...
  __builtin___memset_chk (arena->histogram_literal, 0, sizeof(arena->histogram_literal), __builtin_object_size (arena->histogram_literal, 0));
  __builtin___memset_chk (arena->histogram_cmd, 0, sizeof(arena->histogram_cmd), __builtin_object_size (arena->histogram_cmd, 0));
  __builtin___memset_chk (arena->histogram_dist, 0, sizeof(arena->histogram_dist), __builtin_object_size (arena->histogram_dist, 0));
  ...
  SetCost(arena->histogram_literal, 256, 1,
          arena->cost_literal);
  SetCost(arena->histogram_cmd, 704, 0,
          cost_cmd);
  SetCost(arena->histogram_dist, self->distance_histogram_size, 0,
          self->cost_dist_);
...
static inline __attribute__((__always_inline__)) float ZopfliCostModelGetCommandCost(
    const ZopfliCostModel* self, uint16_t cmdcode) {
  return self->cost_cmd_[cmdcode];
}

static inline __attribute__((__always_inline__)) float ZopfliCostModelGetDistanceCost(
    const ZopfliCostModel* self, size_t distcode) {
  return self->cost_dist_[distcode];
}

static inline __attribute__((__always_inline__)) float ZopfliCostModelGetLiteralCosts(
    const ZopfliCostModel* self, size_t from, size_t to) {
  return self->literal_costs_[to] - self->literal_costs_[from];
}

static inline __attribute__((__always_inline__)) float ZopfliCostModelGetMinCostCmd(
...
static inline __attribute__((__always_inline__)) void UpdateZopfliNode(ZopfliNode* nodes, size_t pos,
...
static inline __attribute__((__always_inline__)) void InitStartPosQueue(StartPosQueue* self) {
  self->idx_ = 0;
}
...
static void StartPosQueuePush(StartPosQueue* self, const PosData* posdata) {
  ...
  for (i = 1; i < len; ++i) {
    if (q[offset & 7].costdiff > q[(offset + 1) & 7].costdiff) {
      { PosData __brotli_swap_tmp = (q)[(offset & 7)]; (q)[(offset & 7)] = (q)[((offset + 1) & 7)]; (q)[((offset + 1) & 7)] = __brotli_swap_tmp; };
    }
    ++offset;
  }
}
...
# 374 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/backward_references_hq.c"
...
void BrotliZopfliCreateCommands(const size_t num_bytes,
  ...
  for (i = 0; offset != (~((uint32_t)0)); i++) {
    ...
    }
    {
      ...
      int is_dictionary =
          (!!(distance > dictionary_start + gap) ? 1 : 0);
...
size_t BrotliZopfliComputeShortestPath(MemoryManager* m, size_t num_bytes,
  ...
  StartPosQueue queue;
  BackwardMatch* restrict matches =
      ((2 * (128 + 64)) > 0 ? ((BackwardMatch*)BrotliAllocate((m), (2 * (128 + 64)) * sizeof(BackwardMatch))) : ((void*)0));
  ...
  size_t lz_matches_offset =
      (addon->num_chunks != 0) ? (128 + 128) : 0;
  ZopfliCostModel* model = ((1) > 0 ? ((ZopfliCostModel*)BrotliAllocate((m), (1) * sizeof(ZopfliCostModel))) : ((void*)0));
  if ((!!0) || (!!0) || (!!0)) {
    return 0;
  }
  nodes[0].length = 0;
  ...
  for (i = 0; i + HashTypeLengthH10() - 1 < num_bytes; i++) {
    ...
    if (skip > 1) {
      ...
      StoreRangeH10(&hasher->privat._H10,
          ringbuffer, ringbuffer_mask, pos + 1, (brotli_min_size_t((pos + skip), (store_end))));
  ...
  { BrotliFree((m), (model)); model = ((void*)0); };
  { BrotliFree((m), (matches)); matches = ((void*)0); };
  return ComputeShortestPathFromNodes(num_bytes, nodes);
}
...
void BrotliCreateZopfliBackwardReferences(MemoryManager* m, size_t num_bytes,
    ...
    Hasher* hasher, int* dist_cache, size_t* last_insert_len,
    Command* commands, size_t* num_commands, size_t* num_literals) {
  ZopfliNode* nodes = ((num_bytes + 1) > 0 ? ((ZopfliNode*)BrotliAllocate((m), (num_bytes + 1) * sizeof(ZopfliNode))) : ((void*)0));
  if ((!!0) || (!!0)) return;
  ...
  *num_commands += BrotliZopfliComputeShortestPath(m, num_bytes,
  ...
  { BrotliFree((m), (nodes)); nodes = ((void*)0); };
}
...
void BrotliCreateHqZopfliBackwardReferences(MemoryManager* m, size_t num_bytes,
  ...
  const size_t stream_offset = params->stream_offset;
  const size_t max_backward_limit = (((size_t)1 << (params->lgwin)) - 16);
  uint32_t* num_matches = ((num_bytes) > 0 ? ((uint32_t*)BrotliAllocate((m), (num_bytes) * sizeof(uint32_t))) : ((void*)0));
  ...
  ZopfliCostModel* model = ((1) > 0 ? ((ZopfliCostModel*)BrotliAllocate((m), (1) * sizeof(ZopfliCostModel))) : ((void*)0));
  ZopfliNode* nodes;
  BackwardMatch* matches = ((matches_size) > 0 ? ((BackwardMatch*)BrotliAllocate((m), (matches_size) * sizeof(BackwardMatch))) : ((void*)0));
  const CompoundDictionary* addon = &params->dictionary.compound;
  size_t gap = addon->total_size;
  ...
  for (i = 0; i + HashTypeLengthH10() - 1 < num_bytes; ++i) {
    ...
    { if (matches_size < (cur_match_pos + 128 + shadow_matches)) { size_t _new_size = (matches_size == 0) ? (cur_match_pos + 128 + shadow_matches) : matches_size; BackwardMatch* new_array; while (_new_size < (cur_match_pos + 128 + shadow_matches)) _new_size *= 2; new_array = ((_new_size) > 0 ? ((BackwardMatch*)BrotliAllocate(((m)), (_new_size) * sizeof(BackwardMatch))) : ((void*)0)); if (!(!!0) && !(!!0) && matches_size != 0) __builtin___memcpy_chk (new_array, matches, matches_size * sizeof(BackwardMatch), __builtin_object_size (new_array, 0)); { BrotliFree(((m)), (matches)); matches = ((void*)0); }; matches = new_array; matches_size = _new_size; } };
    ...
    if (num_found_matches > 0) {
      ...
      if (match_len > 325) {
        ...
        StoreRangeH10(&hasher->privat._H10,
                      ...
                      (brotli_min_size_t((pos + match_len), (store_end))));
        __builtin___memset_chk (&num_matches[i + 1], 0, skip * sizeof(num_matches[0]), __builtin_object_size (&num_matches[i + 1], 0));
        i += skip;
      } else {
  ...
  __builtin___memcpy_chk (orig_dist_cache, dist_cache, 4 * sizeof(dist_cache[0]), __builtin_object_size (orig_dist_cache, 0));
  orig_num_commands = *num_commands;
  nodes = ((num_bytes + 1) > 0 ? ((ZopfliNode*)BrotliAllocate((m), (num_bytes + 1) * sizeof(ZopfliNode))) : ((void*)0));
  if ((!!0) || (!!0)) return;
  InitZopfliCostModel(m, model, &params->dist, num_bytes);
  if ((!!0)) return;
  for (i = 0; i < 2; i++) {
    ...
    *last_insert_len = orig_last_insert_len;
    __builtin___memcpy_chk (dist_cache, orig_dist_cache, 4 * sizeof(dist_cache[0]), __builtin_object_size (dist_cache, 0));
  ...
  { BrotliFree((m), (nodes)); nodes = ((void*)0); };
  { BrotliFree((m), (matches)); matches = ((void*)0); };
  { BrotliFree((m), (num_matches)); num_matches = ((void*)0); };
}
