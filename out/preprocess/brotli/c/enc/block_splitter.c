# 1 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/block_splitter.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 391 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/block_splitter.c" 2
...
# 12 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/block_splitter.h"
...
# 13 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/block_splitter.h" 2
...
# 15 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/block_splitter.h" 2
# 1 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/command.h" 1
# 14 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/command.h"
...
# 15 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/command.h" 2
...
# 10 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/block_splitter.c" 2
...
# 15 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/block_splitter.c" 2
# 1 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/cluster.h" 1
# 22 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/cluster.h"
...
# 16 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/block_splitter.c" 2
# 26 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/block_splitter.c"
...
static void CopyLiteralsToByteArray(const Command* cmds,
  ...
  for (i = 0; i < num_commands; ++i) {
    ...
    if (from_pos + insert_len > mask) {
      ...
      __builtin___memcpy_chk (literals + pos, data + from_pos, head_size, __builtin_object_size (literals + pos, 0));
      from_pos = 0;
      pos += head_size;
      insert_len -= head_size;
    }
    if (insert_len > 0) {
      __builtin___memcpy_chk (literals + pos, data + from_pos, insert_len, __builtin_object_size (literals + pos, 0));
      pos += insert_len;
    }
...
# 1 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/block_splitter_inc.h" 1
# 12 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/block_splitter_inc.h"
...
static size_t FindBlocksLiteral(const uint8_t* data, const size_t length,
                             ...
                             uint8_t* block_id) {
  const size_t alphabet_size = HistogramDataSizeLiteral();
  ...
  __builtin___memset_chk (insert_cost, 0, sizeof(insert_cost[0]) * alphabet_size * num_histograms, __builtin_object_size (insert_cost, 0));
  ...
  __builtin___memset_chk (cost, 0, sizeof(cost[0]) * num_histograms, __builtin_object_size (cost, 0));
  __builtin___memset_chk (switch_signal, 0, sizeof(switch_signal[0]) * length * bitmap_len, __builtin_object_size (switch_signal, 0));
...
static void ClusterBlocksLiteral(MemoryManager* m,
                              ...
                              uint8_t* block_ids,
                              BlockSplit* split) {
  uint32_t* histogram_symbols = ((num_blocks) > 0 ? ((uint32_t*)BrotliAllocate((m), (num_blocks) * sizeof(uint32_t))) : ((void*)0));
  uint32_t* u32 =
      ((num_blocks + 4 * 64) > 0 ? ((uint32_t*)BrotliAllocate((m), (num_blocks + 4 * 64) * sizeof(uint32_t))) : ((void*)0));
  ...
  HistogramLiteral* all_histograms =
      ((all_histograms_capacity) > 0 ? ((HistogramLiteral*)BrotliAllocate((m), (all_histograms_capacity) * sizeof(HistogramLiteral))) : ((void*)0));
  size_t cluster_size_size = 0;
  size_t cluster_size_capacity = expected_num_clusters;
  uint32_t* cluster_size = ((cluster_size_capacity) > 0 ? ((uint32_t*)BrotliAllocate((m), (cluster_size_capacity) * sizeof(uint32_t))) : ((void*)0));
  size_t num_clusters = 0;
  HistogramLiteral* histograms = (((brotli_min_size_t((num_blocks), (64)))) > 0 ? ((HistogramLiteral*)BrotliAllocate((m), ((brotli_min_size_t((num_blocks), (64)))) * sizeof(HistogramLiteral))) : ((void*)0));

  size_t max_num_pairs =
      64 * 64 / 2;
  size_t pairs_capacity = max_num_pairs + 1;
  HistogramPair* pairs = ((pairs_capacity) > 0 ? ((HistogramPair*)BrotliAllocate((m), (pairs_capacity) * sizeof(HistogramPair))) : ((void*)0));
  size_t pos = 0;
  uint32_t* clusters;
  ...
  uint32_t* new_index;
  size_t i;
  uint32_t* restrict const sizes = u32 + 0 * 64;
  uint32_t* restrict const new_clusters = u32 + 1 * 64;
  uint32_t* restrict const symbols = u32 + 2 * 64;
  uint32_t* restrict const remap = u32 + 3 * 64;
  uint32_t* restrict const block_lengths =
      u32 + 4 * 64;

  HistogramLiteral* tmp = ((2) > 0 ? ((HistogramLiteral*)BrotliAllocate((m), (2) * sizeof(HistogramLiteral))) : ((void*)0));
  ...
  __builtin___memset_chk (u32, 0, (num_blocks + 4 * 64) * sizeof(uint32_t), __builtin_object_size (u32, 0));
  ...
  { BrotliFree((m), (histograms)); histograms = ((void*)0); };


  max_num_pairs =
      (brotli_min_size_t((64 * num_clusters), ((num_clusters / 2) * num_clusters)));
  if (pairs_capacity < max_num_pairs + 1) {
    { BrotliFree((m), (pairs)); pairs = ((void*)0); };
    pairs = ((max_num_pairs + 1) > 0 ? ((HistogramPair*)BrotliAllocate((m), (max_num_pairs + 1) * sizeof(HistogramPair))) : ((void*)0));
    if ((!!0) || (!!0)) return;
  }
  clusters = ((num_clusters) > 0 ? ((uint32_t*)BrotliAllocate((m), (num_clusters) * sizeof(uint32_t))) : ((void*)0));
  if ((!!0) || (!!0)) return;
  ...
  num_final_clusters = BrotliHistogramCombineLiteral(
      ...
      max_num_pairs);
  { BrotliFree((m), (pairs)); pairs = ((void*)0); };
  { BrotliFree((m), (cluster_size)); cluster_size = ((void*)0); };


  new_index = ((num_clusters) > 0 ? ((uint32_t*)BrotliAllocate((m), (num_clusters) * sizeof(uint32_t))) : ((void*)0));
  if ((!!0) || (!!0)) return;
  ...
  { BrotliFree((m), (tmp)); tmp = ((void*)0); };
  { BrotliFree((m), (clusters)); clusters = ((void*)0); };
  { BrotliFree((m), (all_histograms)); all_histograms = ((void*)0); };
  { if (split->types_alloc_size < (num_blocks)) { size_t _new_size = (split->types_alloc_size == 0) ? (num_blocks) : split->types_alloc_size; uint8_t* new_array; while (_new_size < (num_blocks)) _new_size *= 2; new_array = ((_new_size) > 0 ? ((uint8_t*)BrotliAllocate(((m)), (_new_size) * sizeof(uint8_t))) : ((void*)0)); if (!(!!0) && !(!!0) && split->types_alloc_size != 0) __builtin___memcpy_chk (new_array, split->types, split->types_alloc_size * sizeof(uint8_t), __builtin_object_size (new_array, 0)); { BrotliFree(((m)), (split->types)); split->types = ((void*)0); }; split->types = new_array; split->types_alloc_size = _new_size; } };

  { if (split->lengths_alloc_size < (num_blocks)) { size_t _new_size = (split->lengths_alloc_size == 0) ? (num_blocks) : split->lengths_alloc_size; uint32_t* new_array; while (_new_size < (num_blocks)) _new_size *= 2; new_array = ((_new_size) > 0 ? ((uint32_t*)BrotliAllocate(((m)), (_new_size) * sizeof(uint32_t))) : ((void*)0)); if (!(!!0) && !(!!0) && split->lengths_alloc_size != 0) __builtin___memcpy_chk (new_array, split->lengths, split->lengths_alloc_size * sizeof(uint32_t), __builtin_object_size (new_array, 0)); { BrotliFree(((m)), (split->lengths)); split->lengths = ((void*)0); }; split->lengths = new_array; split->lengths_alloc_size = _new_size; } };
  ...
  { BrotliFree((m), (new_index)); new_index = ((void*)0); };
  { BrotliFree((m), (u32)); u32 = ((void*)0); };
  { BrotliFree((m), (histogram_symbols)); histogram_symbols = ((void*)0); };
}
...
static void SplitByteVectorLiteral(MemoryManager* m,
  ...
  histograms = ((num_histograms + 1) > 0 ? ((HistogramLiteral*)BrotliAllocate((m), (num_histograms + 1) * sizeof(HistogramLiteral))) : ((void*)0));
                         ...
                         num_histograms, histograms, tmp);
  {
    ...
    uint8_t* block_ids = ((length) > 0 ? ((uint8_t*)BrotliAllocate((m), (length) * sizeof(uint8_t))) : ((void*)0));
    size_t num_blocks = 0;
    const size_t bitmaplen = (num_histograms + 7) >> 3;
    double* insert_cost = ((data_size * num_histograms) > 0 ? ((double*)BrotliAllocate((m), (data_size * num_histograms) * sizeof(double))) : ((void*)0));
    double* cost = ((num_histograms) > 0 ? ((double*)BrotliAllocate((m), (num_histograms) * sizeof(double))) : ((void*)0));
    uint8_t* switch_signal = ((length * bitmaplen) > 0 ? ((uint8_t*)BrotliAllocate((m), (length * bitmaplen) * sizeof(uint8_t))) : ((void*)0));
    uint16_t* new_id = ((num_histograms) > 0 ? ((uint16_t*)BrotliAllocate((m), (num_histograms) * sizeof(uint16_t))) : ((void*)0));
    ...
    { BrotliFree((m), (insert_cost)); insert_cost = ((void*)0); };
    { BrotliFree((m), (cost)); cost = ((void*)0); };
    { BrotliFree((m), (switch_signal)); switch_signal = ((void*)0); };
    { BrotliFree((m), (new_id)); new_id = ((void*)0); };
    { BrotliFree((m), (histograms)); histograms = ((void*)0); };
    ClusterBlocksLiteral(m, data, length, num_blocks, block_ids, split);
    if ((!!0)) return;
    { BrotliFree((m), (block_ids)); block_ids = ((void*)0); };
  }
}
# 94 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/block_splitter.c" 2
...
static size_t FindBlocksCommand(const uint16_t* data, const size_t length,
                             ...
                             uint8_t* switch_signal,
                             uint8_t* block_id) {
  const size_t alphabet_size = HistogramDataSizeCommand();
  const size_t bitmap_len = (num_histograms + 7) >> 3;
  size_t num_blocks = 1;
  size_t byte_ix;
  size_t i;
...
static void ClusterBlocksCommand(MemoryManager* m,
  ...
  HistogramCommand* all_histograms =
      ((all_histograms_capacity) > 0 ? ((HistogramCommand*)BrotliAllocate((m), (all_histograms_capacity) * sizeof(HistogramCommand))) : ((void*)0));
  size_t cluster_size_size = 0;
  size_t cluster_size_capacity = expected_num_clusters;
  uint32_t* cluster_size = ((cluster_size_capacity) > 0 ? ((uint32_t*)BrotliAllocate((m), (cluster_size_capacity) * sizeof(uint32_t))) : ((void*)0));
  size_t num_clusters = 0;
  HistogramCommand* histograms = (((brotli_min_size_t((num_blocks), (64)))) > 0 ? ((HistogramCommand*)BrotliAllocate((m), ((brotli_min_size_t((num_blocks), (64)))) * sizeof(HistogramCommand))) : ((void*)0));
  ...
  HistogramCommand* tmp = ((2) > 0 ? ((HistogramCommand*)BrotliAllocate((m), (2) * sizeof(HistogramCommand))) : ((void*)0));
  ...
  for (i = 0; i < num_blocks; i += 64) {
    ...
    num_new_clusters = BrotliHistogramCombineCommand(
        histograms, tmp, sizes, symbols, new_clusters, pairs, num_to_combine,
        num_to_combine, 64, max_num_pairs);
    { if (all_histograms_capacity < (all_histograms_size + num_new_clusters)) { size_t _new_size = (all_histograms_capacity == 0) ? (all_histograms_size + num_new_clusters) : all_histograms_capacity; HistogramCommand* new_array; while (_new_size < (all_histograms_size + num_new_clusters)) _new_size *= 2; new_array = ((_new_size) > 0 ? ((HistogramCommand*)BrotliAllocate(((m)), (_new_size) * sizeof(HistogramCommand))) : ((void*)0)); if (!(!!0) && !(!!0) && all_histograms_capacity != 0) __builtin___memcpy_chk (new_array, all_histograms, all_histograms_capacity * sizeof(HistogramCommand), __builtin_object_size (new_array, 0)); { BrotliFree(((m)), (all_histograms)); all_histograms = ((void*)0); }; all_histograms = new_array; all_histograms_capacity = _new_size; } };
...
static void SplitByteVectorCommand(MemoryManager* m,
  ...
  histograms = ((num_histograms + 1) > 0 ? ((HistogramCommand*)BrotliAllocate((m), (num_histograms + 1) * sizeof(HistogramCommand))) : ((void*)0));
  tmp = histograms + num_histograms;
  if ((!!0) || (!!0)) return;
...
# 101 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/block_splitter.c" 2
...
static size_t FindBlocksDistance(const uint16_t* data, const size_t length,
                             ...
                             uint8_t* switch_signal,
                             uint8_t* block_id) {
  const size_t alphabet_size = HistogramDataSizeDistance();
  const size_t bitmap_len = (num_histograms + 7) >> 3;
  size_t num_blocks = 1;
  size_t byte_ix;
  size_t i;
...
static void ClusterBlocksDistance(MemoryManager* m,
  ...
  HistogramDistance* all_histograms =
      ((all_histograms_capacity) > 0 ? ((HistogramDistance*)BrotliAllocate((m), (all_histograms_capacity) * sizeof(HistogramDistance))) : ((void*)0));
  size_t cluster_size_size = 0;
  size_t cluster_size_capacity = expected_num_clusters;
  uint32_t* cluster_size = ((cluster_size_capacity) > 0 ? ((uint32_t*)BrotliAllocate((m), (cluster_size_capacity) * sizeof(uint32_t))) : ((void*)0));
  size_t num_clusters = 0;
  HistogramDistance* histograms = (((brotli_min_size_t((num_blocks), (64)))) > 0 ? ((HistogramDistance*)BrotliAllocate((m), ((brotli_min_size_t((num_blocks), (64)))) * sizeof(HistogramDistance))) : ((void*)0));
  ...
  HistogramDistance* tmp = ((2) > 0 ? ((HistogramDistance*)BrotliAllocate((m), (2) * sizeof(HistogramDistance))) : ((void*)0));
  ...
  for (i = 0; i < num_blocks; i += 64) {
    ...
    num_new_clusters = BrotliHistogramCombineDistance(
        histograms, tmp, sizes, symbols, new_clusters, pairs, num_to_combine,
        num_to_combine, 64, max_num_pairs);
    { if (all_histograms_capacity < (all_histograms_size + num_new_clusters)) { size_t _new_size = (all_histograms_capacity == 0) ? (all_histograms_size + num_new_clusters) : all_histograms_capacity; HistogramDistance* new_array; while (_new_size < (all_histograms_size + num_new_clusters)) _new_size *= 2; new_array = ((_new_size) > 0 ? ((HistogramDistance*)BrotliAllocate(((m)), (_new_size) * sizeof(HistogramDistance))) : ((void*)0)); if (!(!!0) && !(!!0) && all_histograms_capacity != 0) __builtin___memcpy_chk (new_array, all_histograms, all_histograms_capacity * sizeof(HistogramDistance), __builtin_object_size (new_array, 0)); { BrotliFree(((m)), (all_histograms)); all_histograms = ((void*)0); }; all_histograms = new_array; all_histograms_capacity = _new_size; } };
...
static void SplitByteVectorDistance(MemoryManager* m,
  ...
  histograms = ((num_histograms + 1) > 0 ? ((HistogramDistance*)BrotliAllocate((m), (num_histograms + 1) * sizeof(HistogramDistance))) : ((void*)0));
  tmp = histograms + num_histograms;
  if ((!!0) || (!!0)) return;
...
# 106 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/enc/block_splitter.c" 2
...
void BrotliDestroyBlockSplit(MemoryManager* m, BlockSplit* self) {
  { BrotliFree((m), (self->types)); self->types = ((void*)0); };
  { BrotliFree((m), (self->lengths)); self->lengths = ((void*)0); };
}
