# 1 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/dec/huffman.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 391 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/dec/huffman.c" 2
...
# 12 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/dec/huffman.h"
...
# 13 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/dec/huffman.h" 2

# 1 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/dec/../common/platform.h" 1
# 26 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/dec/../common/platform.h"
...
# 27 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/dec/../common/platform.h" 2

# 1 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/include/brotli/port.h" 1
# 29 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/dec/../common/platform.h" 2
...
# 15 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/dec/huffman.h" 2
...
# 10 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/dec/huffman.c" 2
...
# 16 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/dec/huffman.c" 2
# 71 "/Users/tamofplease/Workspace/research/c_macro_variable_analysis/out/cloned_projects/brotli/c/dec/huffman.c"
static inline __attribute__((__always_inline__)) uint64_t BrotliReverseBits(uint64_t num) {

  return BrotliRBit(num);
...
void BrotliBuildCodeLengthsHuffmanTable(HuffmanCode* table,
  ...
  {{ symbol += count[bits]; offset[bits] = symbol; bits++; }; { symbol += count[bits]; offset[bits] = symbol; bits++; }; { symbol += count[bits]; offset[bits] = symbol; bits++; }; { symbol += count[bits]; offset[bits] = symbol; bits++; }; { symbol += count[bits]; offset[bits] = symbol; bits++; };};
  ...
  symbol = (17 + 1);
  do {
    {{ symbol--; sorted[offset[code_lengths[symbol]]--] = symbol; }; { symbol--; sorted[offset[code_lengths[symbol]]--] = symbol; }; { symbol--; sorted[offset[code_lengths[symbol]]--] = symbol; }; { symbol--; sorted[offset[code_lengths[symbol]]--] = symbol; }; { symbol--; sorted[offset[code_lengths[symbol]]--] = symbol; }; { symbol--; sorted[offset[code_lengths[symbol]]--] = symbol; };};
  ...
  key = 0;
  key_step = ((uint64_t)1 << (8 - 1 + ((sizeof(uint64_t) << 3) - 8)));
  symbol = 0;
  bits = 1;
  step = 2;
  do {
...
uint32_t BrotliBuildHuffmanTable(HuffmanCode* root_table,
  ...
  while (total_size != table_size) {
    __builtin___memcpy_chk (&table[table_size], &table[0], (size_t)table_size * sizeof(table[0]), __builtin_object_size (&table[table_size], 0));

    table_size <<= 1;
  }


  key_step = ((uint64_t)1 << (8 - 1 + ((sizeof(uint64_t) << 3) - 8))) >> (root_bits - 1);
  sub_key = (((uint64_t)1 << (8 - 1 + ((sizeof(uint64_t) << 3) - 8))) << 1);
  sub_key_step = ((uint64_t)1 << (8 - 1 + ((sizeof(uint64_t) << 3) - 8)));
  for (len = root_bits + 1, step = 2; len <= max_length; ++len) {
    symbol = len - (15 + 1);
    for (; count[len] != 0; --count[len]) {
      if (sub_key == (((uint64_t)1 << (8 - 1 + ((sizeof(uint64_t) << 3) - 8))) << 1U)) {
        table += table_size;
