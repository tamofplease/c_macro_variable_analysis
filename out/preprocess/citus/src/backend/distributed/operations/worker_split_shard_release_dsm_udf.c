# 0 "//./citus/src/backend/distributed/operations/worker_split_shard_release_dsm_udf.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/operations/worker_split_shard_release_dsm_udf.c"
# 11 "//./citus/src/backend/distributed/operations/worker_split_shard_release_dsm_udf.c"
...
# 12 "//./citus/src/backend/distributed/operations/worker_split_shard_release_dsm_udf.c" 2
...
# 13 "//./citus/src/backend/distributed/operations/worker_split_shard_release_dsm_udf.c" 2
# 1 "//./citus/src/include/distributed/shardsplit_shared_memory.h" 1
# 22 "//./citus/src/include/distributed/shardsplit_shared_memory.h"
typedef struct ShardSplitInfo
{
 Oid distributedTableOid;
 int partitionColumnIndex;
 Oid sourceShardOid;
 Oid splitChildShardOid;
 int32 shardMinValue;
 int32 shardMaxValue;
 uint32_t nodeId;
 uint64 sourceShardId;
 uint64 splitChildShardId;
 char slotName[64];
} ShardSplitInfo;
...
{
 int count;
 ShardSplitInfo splitInfoArray[];
} ShardSplitInfoSMHeader;
# 54 "//./citus/src/include/distributed/shardsplit_shared_memory.h"
...
extern HTAB * PopulateSourceToDestinationShardMapForSlot(char *slotName, MemoryContext
               cxt);
# 14 "//./citus/src/backend/distributed/operations/worker_split_shard_release_dsm_udf.c" 2



extern Datum worker_split_shard_release_dsm(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_worker_split_shard_release_dsm(void); const Pg_finfo_record * pg_finfo_worker_split_shard_release_dsm (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;

Datum
worker_split_shard_release_dsm(FunctionCallInfo fcinfo)
{
