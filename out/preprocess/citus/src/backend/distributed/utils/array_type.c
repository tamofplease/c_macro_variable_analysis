# 0 "//./citus/src/backend/distributed/utils/array_type.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/utils/array_type.c"
# 12 "//./citus/src/backend/distributed/utils/array_type.c"
...
# 13 "//./citus/src/backend/distributed/utils/array_type.c" 2
...
# 14 "//./citus/src/backend/distributed/utils/array_type.c" 2
...
# 16 "//./citus/src/backend/distributed/utils/array_type.c" 2
# 1 "/usr/include/postgresql/14/server/catalog/pg_type.h" 1
# 23 "/usr/include/postgresql/14/server/catalog/pg_type.h"
...
extern char *makeMultirangeTypeName(const char *rangeTypeName,
         Oid typeNamespace);
# 17 "//./citus/src/backend/distributed/utils/array_type.c" 2

# 1 "//./citus/src/include/distributed/utils/array_type.h" 1
# 16 "//./citus/src/include/distributed/utils/array_type.h"
...
# 17 "//./citus/src/include/distributed/utils/array_type.h" 2
...
# 19 "//./citus/src/backend/distributed/utils/array_type.c" 2
...
# 21 "//./citus/src/backend/distributed/utils/array_type.c" 2
...
# 22 "//./citus/src/backend/distributed/utils/array_type.c" 2
...
{
 Datum *datumArray = 
# 32 "//./citus/src/backend/distributed/utils/array_type.c" 3 4
                    ((void *)0)
# 32 "//./citus/src/backend/distributed/utils/array_type.c"
                        ;
 
# 33 "//./citus/src/backend/distributed/utils/array_type.c" 3 4
_Bool 
# 33 "//./citus/src/backend/distributed/utils/array_type.c"
     *datumArrayNulls = 
# 33 "//./citus/src/backend/distributed/utils/array_type.c" 3 4
                        ((void *)0)
# 33 "//./citus/src/backend/distributed/utils/array_type.c"
...
# 36 "//./citus/src/backend/distributed/utils/array_type.c" 3 4
_Bool 
# 36 "//./citus/src/backend/distributed/utils/array_type.c"
     typeByVal = 
# 36 "//./citus/src/backend/distributed/utils/array_type.c" 3 4
                 0
# 36 "//./citus/src/backend/distributed/utils/array_type.c"
...
# 40 "//./citus/src/backend/distributed/utils/array_type.c" 3 4
_Bool 
# 40 "//./citus/src/backend/distributed/utils/array_type.c"
     arrayHasNull = ((arrayObject)->dataoffset != 0);
 if (arrayHasNull)
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 43 "//./citus/src/backend/distributed/utils/array_type.c" 3 4
 ((void *)0)
# 43 "//./citus/src/backend/distributed/utils/array_type.c"
 ) : errstart(21, 
# 43 "//./citus/src/backend/distributed/utils/array_type.c" 3 4
 ((void *)0)
# 43 "//./citus/src/backend/distributed/utils/array_type.c"
 )) (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('4') - '0') & 0x3F) << 24))), errmsg("worker array object cannot contain null values")), errfinish("//./citus/src/backend/distributed/utils/array_type.c", 43, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
                                                                ;
 }

 Oid typeId = ((arrayObject)->elemtype);
...
{
 int32 dimensionCount = ((arrayObject)->ndim);
 int32 *dimensionLengthArray = ((int *) (((char *) (arrayObject)) + sizeof(ArrayType)));
 ...
 ((void)
# 73 "//./citus/src/backend/distributed/utils/array_type.c" 3 4
1
# 73 "//./citus/src/backend/distributed/utils/array_type.c"
);
 ...
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 78 "//./citus/src/backend/distributed/utils/array_type.c" 3 4
 ((void *)0)
# 78 "//./citus/src/backend/distributed/utils/array_type.c"
 ) : errstart(21, 
# 78 "//./citus/src/backend/distributed/utils/array_type.c" 3 4
 ((void *)0)
# 78 "//./citus/src/backend/distributed/utils/array_type.c"
 )) (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('2') - '0') & 0x3F) << 18) + (((('E') - '0') & 0x3F) << 24))), errmsg("worker array object cannot be empty")), errfinish("//./citus/src/backend/distributed/utils/array_type.c", 78, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
                                                     ;
 }
...
# 94 "//./citus/src/backend/distributed/utils/array_type.c" 3 4
_Bool 
# 94 "//./citus/src/backend/distributed/utils/array_type.c"
     typeByValue = 
# 94 "//./citus/src/backend/distributed/utils/array_type.c" 3 4
                   0
# 94 "//./citus/src/backend/distributed/utils/array_type.c"
...
{
 List *list = 
# 111 "//./citus/src/backend/distributed/utils/array_type.c" 3 4
             ((void *)0)
# 111 "//./citus/src/backend/distributed/utils/array_type.c"
                 ;
 ...
 {
  int32 intObject = ((int32) (datumObjectArray[index]));
...
{
 List *list = 
# 131 "//./citus/src/backend/distributed/utils/array_type.c" 3 4
             ((void *)0)
# 131 "//./citus/src/backend/distributed/utils/array_type.c"
                 ;
 Datum *datumObjectArray = DeconstructArrayObject(arrayObject);
 int arrayObjectCount = ArrayObjectCount(arrayObject);
 ...
 for (int index = 0; index < arrayObjectCount; index++)
 {
  char *intAsStr = text_to_cstring(((text *) pg_detoast_datum((struct varlena *) ((Pointer) (datumObjectArray[index])))));
