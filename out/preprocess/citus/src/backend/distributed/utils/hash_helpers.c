# 0 "//./citus/src/backend/distributed/utils/hash_helpers.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/utils/hash_helpers.c"
# 11 "//./citus/src/backend/distributed/utils/hash_helpers.c"
...
# 12 "//./citus/src/backend/distributed/utils/hash_helpers.c" 2
...
# 14 "//./citus/src/backend/distributed/utils/hash_helpers.c" 2
...
# 15 "//./citus/src/backend/distributed/utils/hash_helpers.c" 2
# 1 "//./citus/src/include/distributed/hash_helpers.h" 1
# 14 "//./citus/src/include/distributed/hash_helpers.h"
# 1 "//./citus/src/include/distributed/pg_version_constants.h" 1
# 15 "//./citus/src/include/distributed/hash_helpers.h" 2
...
# 17 "//./citus/src/include/distributed/hash_helpers.h" 2
# 39 "//./citus/src/include/distributed/hash_helpers.h"
extern void hash_delete_all(HTAB *htab);
# 52 "//./citus/src/include/distributed/hash_helpers.h"
...
# 16 "//./citus/src/backend/distributed/utils/hash_helpers.c" 2
...
hash_delete_all(HTAB *htab)
{
 ...
 void *entry = 
# 26 "//./citus/src/backend/distributed/utils/hash_helpers.c" 3 4
              ((void *)0)
# 26 "//./citus/src/backend/distributed/utils/hash_helpers.c"
                  ;
...
# 31 "//./citus/src/backend/distributed/utils/hash_helpers.c" 3 4
 _Bool 
# 31 "//./citus/src/backend/distributed/utils/hash_helpers.c"
      found = 
# 31 "//./citus/src/backend/distributed/utils/hash_helpers.c" 3 4
              0
# 31 "//./citus/src/backend/distributed/utils/hash_helpers.c"
  ...
  ((void)
# 34 "//./citus/src/backend/distributed/utils/hash_helpers.c" 3 4
 1
# 34 "//./citus/src/backend/distributed/utils/hash_helpers.c"
 );
 }
}
          ...
          char *name, long nelem)
{
 ...
 int hashFlags = (0x0008 | 0x0400 | 0x0020);
...
{
 if ((var) != 
# 68 "//./citus/src/backend/distributed/utils/hash_helpers.c" 3 4
             ((void *)0)
# 68 "//./citus/src/backend/distributed/utils/hash_helpers.c"
                 )
 {
