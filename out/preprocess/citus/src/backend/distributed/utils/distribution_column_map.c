# 0 "//./citus/src/backend/distributed/utils/distribution_column_map.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/utils/distribution_column_map.c"
# 11 "//./citus/src/backend/distributed/utils/distribution_column_map.c"
...
# 12 "//./citus/src/backend/distributed/utils/distribution_column_map.c" 2

# 1 "/usr/include/postgresql/14/server/common/hashfn.h" 1
# 23 "/usr/include/postgresql/14/server/common/hashfn.h"
...
{
 return ((Datum) (hash_bytes(k, keylen)));
}

static inline Datum
hash_any_extended(const unsigned char *k, int keylen, uint64 seed)
{
 return ((Datum) (hash_bytes_extended(k, keylen, seed)));
}

static inline Datum
hash_uint32(uint32 k)
{
 return ((Datum) (hash_bytes_uint32(k)));
}

static inline Datum
hash_uint32_extended(uint32 k, uint64 seed)
{
 return ((Datum) (hash_bytes_uint32_extended(k, seed)));
}
...
# 67 "/usr/include/postgresql/14/server/common/hashfn.h"
...
hash_combine64(uint64 a, uint64 b)
{
 ...
 a ^= b + (0x49a0f4dd15e5a8e3UL) + (a << 54) + (a >> 7);
 return a;
}
...
# 14 "//./citus/src/backend/distributed/utils/distribution_column_map.c" 2
# 1 "//./citus/src/include/distributed/distribution_column.h" 1
# 18 "//./citus/src/include/distributed/distribution_column.h"
...
# 16 "/usr/include/postgresql/14/server/access/xloginsert.h"
...
# 17 "/usr/include/postgresql/14/server/access/xloginsert.h" 2
...
# 19 "//./citus/src/include/distributed/distribution_column.h" 2
...
# 15 "//./citus/src/backend/distributed/utils/distribution_column_map.c" 2
...
# 64 "/usr/include/postgresql/14/server/utils/array.h"
...
# 65 "/usr/include/postgresql/14/server/utils/array.h" 2
...
# 16 "//./citus/src/backend/distributed/utils/distribution_column_map.c" 2
...
# 17 "//./citus/src/backend/distributed/utils/distribution_column_map.c" 2
# 1 "//./citus/src/include/distributed/multi_partitioning_utils.h" 1
# 11 "//./citus/src/include/distributed/multi_partitioning_utils.h"
...
# 12 "//./citus/src/include/distributed/multi_partitioning_utils.h" 2



extern 
# 15 "//./citus/src/include/distributed/multi_partitioning_utils.h" 3 4
      _Bool 
# 15 "//./citus/src/include/distributed/multi_partitioning_utils.h"
           PartitionedTable(Oid relationId);
extern 
# 16 "//./citus/src/include/distributed/multi_partitioning_utils.h" 3 4
      _Bool 
# 16 "//./citus/src/include/distributed/multi_partitioning_utils.h"
           PartitionedTableNoLock(Oid relationId);
extern 
# 17 "//./citus/src/include/distributed/multi_partitioning_utils.h" 3 4
      _Bool 
# 17 "//./citus/src/include/distributed/multi_partitioning_utils.h"
           PartitionTable(Oid relationId);
extern 
# 18 "//./citus/src/include/distributed/multi_partitioning_utils.h" 3 4
      _Bool 
# 18 "//./citus/src/include/distributed/multi_partitioning_utils.h"
           PartitionTableNoLock(Oid relationId);
extern 
# 19 "//./citus/src/include/distributed/multi_partitioning_utils.h" 3 4
      _Bool 
# 19 "//./citus/src/include/distributed/multi_partitioning_utils.h"
           IsChildTable(Oid relationId);
extern 
# 20 "//./citus/src/include/distributed/multi_partitioning_utils.h" 3 4
      _Bool 
# 20 "//./citus/src/include/distributed/multi_partitioning_utils.h"
...
# 18 "//./citus/src/backend/distributed/utils/distribution_column_map.c" 2
# 1 "//./citus/src/include/distributed/utils/distribution_column_map.h" 1
# 20 "//./citus/src/include/distributed/utils/distribution_column_map.h"
...
# 19 "//./citus/src/backend/distributed/utils/distribution_column_map.c" 2
...
CreateDistributionColumnMap(void)
{
 ...
 uint32 hashFlags = (0x0008 | 0x0040 | 0x0400);
...
# 66 "//./citus/src/backend/distributed/utils/distribution_column_map.c" 3 4
_Bool 
# 66 "//./citus/src/backend/distributed/utils/distribution_column_map.c"
     entryFound = 
# 66 "//./citus/src/backend/distributed/utils/distribution_column_map.c" 3 4
                  0
# 66 "//./citus/src/backend/distributed/utils/distribution_column_map.c"
 ...
 ((void)
# 70 "//./citus/src/backend/distributed/utils/distribution_column_map.c" 3 4
1
# 70 "//./citus/src/backend/distributed/utils/distribution_column_map.c"
);

 entry->distributionColumn =
  BuildDistributionKeyFromColumnName(relationId, distributionColumnName, 0);
 ...
 if (PartitionedTable(relationId))
 {
  ...
  Oid partitionRelationId = ((Oid) 0);

  for (ListCell *(partitionRelationIdCellDoNotUse) = list_head(partitionList); (partitionRelationIdCellDoNotUse) != 
# 83 "//./citus/src/backend/distributed/utils/distribution_column_map.c" 3 4
 ((void *)0) 
# 83 "//./citus/src/backend/distributed/utils/distribution_column_map.c"
 && (((partitionRelationId) = ((partitionRelationIdCellDoNotUse)->oid_value)) || 
# 83 "//./citus/src/backend/distributed/utils/distribution_column_map.c" 3 4
 1
# 83 "//./citus/src/backend/distributed/utils/distribution_column_map.c"
 ); partitionRelationIdCellDoNotUse = lnext(partitionList, partitionRelationIdCellDoNotUse))
  {
...
# 100 "//./citus/src/backend/distributed/utils/distribution_column_map.c" 3 4
_Bool 
# 100 "//./citus/src/backend/distributed/utils/distribution_column_map.c"
     entryFound = 
# 100 "//./citus/src/backend/distributed/utils/distribution_column_map.c" 3 4
                  0
# 100 "//./citus/src/backend/distributed/utils/distribution_column_map.c"
 ...
 {
  return 
# 111 "//./citus/src/backend/distributed/utils/distribution_column_map.c" 3 4
        ((void *)0)
# 111 "//./citus/src/backend/distributed/utils/distribution_column_map.c"
            ;
 }
}
...
{
 Var *distributionColumn = 
# 125 "//./citus/src/backend/distributed/utils/distribution_column_map.c" 3 4
                          ((void *)0)
# 125 "//./citus/src/backend/distributed/utils/distribution_column_map.c"
                              ;

 if (distributionColumnOverrides != 
# 127 "//./citus/src/backend/distributed/utils/distribution_column_map.c" 3 4
                                   ((void *)0)
# 127 "//./citus/src/backend/distributed/utils/distribution_column_map.c"
                                       )
 {
  distributionColumn = GetDistributionColumnFromMap(distributionColumnOverrides,
                relationId);
  if (distributionColumn != 
# 131 "//./citus/src/backend/distributed/utils/distribution_column_map.c" 3 4
                           ((void *)0)
# 131 "//./citus/src/backend/distributed/utils/distribution_column_map.c"
                               )
  {
