# 0 "//./citus/src/backend/distributed/utils/tuplestore.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/utils/tuplestore.c"
# 11 "//./citus/src/backend/distributed/utils/tuplestore.c"
...
# 12 "//./citus/src/backend/distributed/utils/tuplestore.c" 2
...
# 14 "//./citus/src/backend/distributed/utils/tuplestore.c" 2
...
# 15 "//./citus/src/backend/distributed/utils/tuplestore.c" 2
...
CheckTuplestoreReturn(FunctionCallInfo fcinfo, TupleDesc *tupdesc)
{
 ...
 if (returnSetInfo == 
# 26 "//./citus/src/backend/distributed/utils/tuplestore.c" 3 4
                     ((void *)0) 
# 26 "//./citus/src/backend/distributed/utils/tuplestore.c"
                          || !((((const Node*)(returnSetInfo))->type) == T_ReturnSetInfo))
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 28 "//./citus/src/backend/distributed/utils/tuplestore.c" 3 4
 ((void *)0)
# 28 "//./citus/src/backend/distributed/utils/tuplestore.c"
 ) : errstart(21, 
# 28 "//./citus/src/backend/distributed/utils/tuplestore.c" 3 4
 ((void *)0)
# 28 "//./citus/src/backend/distributed/utils/tuplestore.c"
 )) (errcode((((('0') - '0') & 0x3F) + (((('A') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("set-valued function called in context that cannot " "accept a set")), errfinish("//./citus/src/backend/distributed/utils/tuplestore.c", 28, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
 ...
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 35 "//./citus/src/backend/distributed/utils/tuplestore.c" 3 4
 ((void *)0)
# 35 "//./citus/src/backend/distributed/utils/tuplestore.c"
 ) : errstart(21, 
# 35 "//./citus/src/backend/distributed/utils/tuplestore.c" 3 4
 ((void *)0)
# 35 "//./citus/src/backend/distributed/utils/tuplestore.c"
 )) (errcode((((('0') - '0') & 0x3F) + (((('A') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("materialize mode required, but it is not " "allowed in this context")), errfinish("//./citus/src/backend/distributed/utils/tuplestore.c", 35, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)


                                  ;
 }
 switch (get_call_result_type(fcinfo, 
# 40 "//./citus/src/backend/distributed/utils/tuplestore.c" 3 4
                                     ((void *)0)
# 40 "//./citus/src/backend/distributed/utils/tuplestore.c"
                                         , tupdesc))
 {
  ...
  case TYPEFUNC_RECORD:
  {
   ...
   do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 51 "//./citus/src/backend/distributed/utils/tuplestore.c" 3 4
  ((void *)0)
# 51 "//./citus/src/backend/distributed/utils/tuplestore.c"
  ) : errstart(21, 
# 51 "//./citus/src/backend/distributed/utils/tuplestore.c" 3 4
  ((void *)0)
# 51 "//./citus/src/backend/distributed/utils/tuplestore.c"
  )) (errcode((((('0') - '0') & 0x3F) + (((('A') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("function returning record called in context " "that cannot accept type record")), errfinish("//./citus/src/backend/distributed/utils/tuplestore.c", 51, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
  ...
  default:
  {
   ...
   do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 61 "//./citus/src/backend/distributed/utils/tuplestore.c" 3 4
  ((void *)0)
# 61 "//./citus/src/backend/distributed/utils/tuplestore.c"
  ) : errstart(21, 
# 61 "//./citus/src/backend/distributed/utils/tuplestore.c" 3 4
  ((void *)0)
# 61 "//./citus/src/backend/distributed/utils/tuplestore.c"
  )) errmsg_internal("return type must be a row type"), errfinish("//./citus/src/backend/distributed/utils/tuplestore.c", 61, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
   break;
  }
 }
...
# 79 "//./citus/src/backend/distributed/utils/tuplestore.c" 3 4
                                                  1
# 79 "//./citus/src/backend/distributed/utils/tuplestore.c"
                                                      , 
# 79 "//./citus/src/backend/distributed/utils/tuplestore.c" 3 4
                                                        0
# 79 "//./citus/src/backend/distributed/utils/tuplestore.c"
