# 0 "//./citus/src/backend/distributed/utils/param_utils.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/utils/param_utils.c"
# 10 "//./citus/src/backend/distributed/utils/param_utils.c"
...
# 11 "//./citus/src/backend/distributed/utils/param_utils.c" 2
...
# 13 "//./citus/src/backend/distributed/utils/param_utils.c" 2
# 1 "/usr/include/postgresql/14/server/nodes/nodeFuncs.h" 1
# 16 "/usr/include/postgresql/14/server/nodes/nodeFuncs.h"
...
# 17 "/usr/include/postgresql/14/server/nodes/nodeFuncs.h" 2
...
# 159 "/usr/include/postgresql/14/server/nodes/nodeFuncs.h"
                                                                   (*walker) (),
          void *context);
# 14 "//./citus/src/backend/distributed/utils/param_utils.c" 2
...
# 16 "//./citus/src/backend/distributed/utils/param_utils.c" 2


# 1 "//./citus/src/include/distributed/param_utils.h" 1
# 12 "//./citus/src/include/distributed/param_utils.h"
extern 
# 12 "//./citus/src/include/distributed/param_utils.h" 3 4
      _Bool 
# 12 "//./citus/src/include/distributed/param_utils.h"
...
# 19 "//./citus/src/backend/distributed/utils/param_utils.c" 2
...
# 24 "//./citus/src/backend/distributed/utils/param_utils.c" 3 4
_Bool

# 25 "//./citus/src/backend/distributed/utils/param_utils.c"
GetParamsUsedInQuery(Node *expression, Bitmapset **paramBitmap)
{
 if (expression == 
# 27 "//./citus/src/backend/distributed/utils/param_utils.c" 3 4
                  ((void *)0)
# 27 "//./citus/src/backend/distributed/utils/param_utils.c"
                      )
 {
  return 
# 29 "//./citus/src/backend/distributed/utils/param_utils.c" 3 4
        0
# 29 "//./citus/src/backend/distributed/utils/param_utils.c"
             ;
 }

 if (((((const Node*)(expression))->type) == T_Param))
 {
  ...
  {
   return 
# 40 "//./citus/src/backend/distributed/utils/param_utils.c" 3 4
         0
# 40 "//./citus/src/backend/distributed/utils/param_utils.c"
              ;
  }
  ...
  *paramBitmap = bms_add_member(*paramBitmap, paramId);
  ...
  return 
# 47 "//./citus/src/backend/distributed/utils/param_utils.c" 3 4
        0
# 47 "//./citus/src/backend/distributed/utils/param_utils.c"
             ;
 }


 if (((((const Node*)(expression))->type) == T_Query))
 {
...
MarkUnreferencedExternParams(Node *expression, ParamListInfo boundParams)
{
 ...
 Bitmapset *paramBitmap = 
# 75 "//./citus/src/backend/distributed/utils/param_utils.c" 3 4
                         ((void *)0)
# 75 "//./citus/src/backend/distributed/utils/param_utils.c"
                             ;
