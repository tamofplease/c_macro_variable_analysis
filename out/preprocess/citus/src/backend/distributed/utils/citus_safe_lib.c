# 0 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
# 15 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
...
# 16 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 2

# 1 "//./citus/src/include/distributed/pg_version_constants.h" 1
# 18 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 2
...
# 20 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 2
...
# 22 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 2

# 1 "//./citus/src/include/distributed/citus_safe_lib.h" 1
# 20 "//./citus/src/include/distributed/citus_safe_lib.h"
...
# 24 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 2
...
# 25 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 2
# 37 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
void
...
# 44 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 44 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ) : errstart(21, 
# 44 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 44 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 )) (errcode((((('X') - '0') & 0x3F) + (((('X') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg( "Memory constraint error: %s (errno %d)", message, error)), errfinish("//./citus/src/backend/distributed/utils/citus_safe_lib.c", 44, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
                                                                  ;
 }
 else if (message)
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 49 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 49 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ) : errstart(21, 
# 49 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 49 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 )) (errcode((((('X') - '0') & 0x3F) + (((('X') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg( "Memory constraint error: %s", message)), errfinish("//./citus/src/backend/distributed/utils/citus_safe_lib.c", 49, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
                                                ;
 }
 else if (error)
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 54 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 54 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ) : errstart(21, 
# 54 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 54 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 )) (errcode((((('X') - '0') & 0x3F) + (((('X') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg( "Unknown function failed with memory constraint error (errno %d)", error)), errfinish("//./citus/src/backend/distributed/utils/citus_safe_lib.c", 54, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
 ...
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 60 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 60 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ) : errstart(21, 
# 60 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 60 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 )) (errcode((((('X') - '0') & 0x3F) + (((('X') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg( "Unknown function failed with memory constraint error")), errfinish("//./citus/src/backend/distributed/utils/citus_safe_lib.c", 60, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
                                                                ;
 }
}
# 73 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
int64
SafeStringToInt64(const char *str)
{
 char *endptr;
 
# 77 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
(*__errno_location ()) 
# 77 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
      = 0;
 ...
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 82 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 82 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ) : errstart(21, 
# 82 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 82 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 )) (errmsg("Error parsing %s as int64, no digits found\n", str)), errfinish("//./citus/src/backend/distributed/utils/citus_safe_lib.c", 82, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
 }
 else if ((
# 84 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
          (*__errno_location ()) 
# 84 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                == 
# 84 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
                   34 
# 84 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
...
# 84 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ...
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 86 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 86 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ) : errstart(21, 
# 86 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 86 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 )) (errmsg("Error parsing %s as int64, underflow occurred\n", str)), errfinish("//./citus/src/backend/distributed/utils/citus_safe_lib.c", 86, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
 }
 else if ((
# 88 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
          (*__errno_location ()) 
# 88 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                == 
# 88 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
                   34 
# 88 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                          && number == 0x7fffffffffffffffLL) || number > 
# 88 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
...
# 88 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ...
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 90 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 90 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ) : errstart(21, 
# 90 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 90 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 )) (errmsg("Error parsing %s as int64, overflow occurred\n", str)), errfinish("//./citus/src/backend/distributed/utils/citus_safe_lib.c", 90, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
 }
 else if (
# 92 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
         (*__errno_location ()) 
# 92 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
               == 
# 92 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
                  22
# 92 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ...
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 94 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 94 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ) : errstart(21, 
# 94 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 94 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 )) (errmsg( "Error parsing %s as int64, base contains unsupported value\n", str)), errfinish("//./citus/src/backend/distributed/utils/citus_safe_lib.c", 94, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)

             ;
 }
 else if (
# 98 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
         (*__errno_location ()) 
# 98 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
               != 0 && number == 0)
 {
  int err = 
# 100 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
           (*__errno_location ())
# 100 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                ;
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 101 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 101 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ) : errstart(21, 
# 101 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 101 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 )) (errmsg("Error parsing %s as int64, errno %d\n", str, err)), errfinish("//./citus/src/backend/distributed/utils/citus_safe_lib.c", 101, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
 }
 else if (
# 103 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
         (*__errno_location ()) 
# 103 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
               == 0 && str && *endptr != '\0')
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 105 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 105 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ) : errstart(21, 
# 105 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 105 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 )) (errmsg( "Error parsing %s as int64, aditional characters remain after int64\n", str)), errfinish("//./citus/src/backend/distributed/utils/citus_safe_lib.c", 105, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)

             ;
 }
 return number;
}
# 120 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
int32
SafeStringToInt32(const char *str)
{
 char *endptr;
 
# 124 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
(*__errno_location ()) 
# 124 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
      = 0;
 ...
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 129 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 129 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ) : errstart(21, 
# 129 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 129 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 )) (errmsg("Error parsing %s as int32, no digits found\n", str)), errfinish("//./citus/src/backend/distributed/utils/citus_safe_lib.c", 129, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
 }
 else if ((
# 131 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
          (*__errno_location ()) 
# 131 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                == 
# 131 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
                   34 
# 131 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
...
# 131 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ...
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 133 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 133 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ) : errstart(21, 
# 133 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 133 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 )) (errmsg("Error parsing %s as int32, underflow occurred\n", str)), errfinish("//./citus/src/backend/distributed/utils/citus_safe_lib.c", 133, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
 }
 else if ((
# 135 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
          (*__errno_location ()) 
# 135 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                == 
# 135 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
                   34 
# 135 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                          && number == 0x7fffffffffffffffL) || number > 
# 135 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
                                                             (2147483647)
# 135 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                                                                      )
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 137 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 137 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ) : errstart(21, 
# 137 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 137 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 )) (errmsg("Error parsing %s as int32, overflow occurred\n", str)), errfinish("//./citus/src/backend/distributed/utils/citus_safe_lib.c", 137, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
 }
 else if (
# 139 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
         (*__errno_location ()) 
# 139 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
               == 
# 139 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
                  22
# 139 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ...
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 141 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 141 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ) : errstart(21, 
# 141 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 141 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 )) (errmsg( "Error parsing %s as int32, base contains unsupported value\n", str)), errfinish("//./citus/src/backend/distributed/utils/citus_safe_lib.c", 141, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)

             ;
 }
 else if (
# 145 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
         (*__errno_location ()) 
# 145 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
               != 0 && number == 0)
 {
  int err = 
# 147 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
           (*__errno_location ())
# 147 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                ;
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 148 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 148 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ) : errstart(21, 
# 148 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 148 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 )) (errmsg("Error parsing %s as int32, errno %d\n", str, err)), errfinish("//./citus/src/backend/distributed/utils/citus_safe_lib.c", 148, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
 }
 else if (
# 150 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
         (*__errno_location ()) 
# 150 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
               == 0 && str && *endptr != '\0')
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 152 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 152 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ) : errstart(21, 
# 152 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 152 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 )) (errmsg( "Error parsing %s as int32, aditional characters remain after int32\n", str)), errfinish("//./citus/src/backend/distributed/utils/citus_safe_lib.c", 152, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)

             ;
 }
 return number;
}
# 167 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
uint64
SafeStringToUint64(const char *str)
{
 char *endptr;
 
# 171 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
(*__errno_location ()) 
# 171 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
      = 0;
 ...
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 176 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 176 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ) : errstart(21, 
# 176 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 176 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 )) (errmsg("Error parsing %s as uint64, no digits found\n", str)), errfinish("//./citus/src/backend/distributed/utils/citus_safe_lib.c", 176, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
 }
 else if ((
# 178 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
          (*__errno_location ()) 
# 178 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                == 
# 178 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
                   34 
# 178 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
...
# 178 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ...
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 180 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 180 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ) : errstart(21, 
# 180 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 180 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 )) (errmsg("Error parsing %s as uint64, overflow occurred\n", str)), errfinish("//./citus/src/backend/distributed/utils/citus_safe_lib.c", 180, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
 }
 else if (
# 182 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
         (*__errno_location ()) 
# 182 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
               == 
# 182 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
                  22
# 182 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ...
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 184 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 184 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ) : errstart(21, 
# 184 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 184 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 )) (errmsg( "Error parsing %s as uint64, base contains unsupported value\n", str)), errfinish("//./citus/src/backend/distributed/utils/citus_safe_lib.c", 184, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)

             ;
 }
 else if (
# 188 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
         (*__errno_location ()) 
# 188 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
               != 0 && number == 0)
 {
  int err = 
# 190 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
           (*__errno_location ())
# 190 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                ;
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 191 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 191 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ) : errstart(21, 
# 191 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 191 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 )) (errmsg("Error parsing %s as uint64, errno %d\n", str, err)), errfinish("//./citus/src/backend/distributed/utils/citus_safe_lib.c", 191, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
 }
 else if (
# 193 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
         (*__errno_location ()) 
# 193 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
               == 0 && str && *endptr != '\0')
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 195 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 195 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 ) : errstart(21, 
# 195 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
 ((void *)0)
# 195 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
 )) (errmsg( "Error parsing %s as uint64, aditional characters remain after uint64\n", str)), errfinish("//./citus/src/backend/distributed/utils/citus_safe_lib.c", 195, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)

             ;
 }
 return number;
}
# 214 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
void
...
# 221 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
          ((void *)0)
# 221 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
              , ( 403 ));
 }
...
# 227 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
          ((void *)0)
# 227 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
              , ( 403 ));
 }
 if (size != 0)
 {
  if (ptr == 
# 231 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
            ((void *)0)
# 231 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                )
  {
   ereport_constraint_handler("SafeQsort: ptr is NULL", 
# 233 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
                                                       ((void *)0)
# 233 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                                                           , ( 400 ));
  }
  if (comp == 
# 235 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
             ((void *)0)
# 235 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                 )
  {
   ereport_constraint_handler("SafeQsort: comp is NULL", 
# 237 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
                                                        ((void *)0)
# 237 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                                                            , ( 400 ));
  }
 }
 pg_qsort(ptr, count, size, comp);
}
# 255 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
void *
...
# 262 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
          ((void *)0)
# 262 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
              , ( 403 ));
 }
...
# 268 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
          ((void *)0)
# 268 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
              , ( 403 ));
 }
 if (size != 0)
 {
  if (key == 
# 272 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
            ((void *)0)
# 272 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                )
  {
   ereport_constraint_handler("SafeBsearch: key is NULL", 
# 274 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
                                                         ((void *)0)
# 274 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                                                             , ( 400 ));
  }
  if (ptr == 
# 276 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
            ((void *)0)
# 276 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                )
  {
   ereport_constraint_handler("SafeBsearch: ptr is NULL", 
# 278 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
                                                         ((void *)0)
# 278 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                                                             , ( 400 ));
  }
  if (comp == 
# 280 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
             ((void *)0)
# 280 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                 )
  {
   ereport_constraint_handler("SafeBsearch: comp is NULL", 
# 282 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
                                                          ((void *)0)
# 282 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                                                              , ( 400 ));
  }
 }
...
# 312 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
int
SafeSnprintf(char *__restrict__ buffer, rsize_t bufsz, const char *__restrict__ format, ...)
{

 if (buffer == 
# 316 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
              ((void *)0)
# 316 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                  )
 {
  ereport_constraint_handler("SafeSnprintf: buffer is NULL", 
# 318 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
                                                            ((void *)0)
# 318 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                                                                , ( 400 ));
 }
 if (format == 
# 320 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
              ((void *)0)
# 320 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                  )
 {
  ereport_constraint_handler("SafeSnprintf: format is NULL", 
# 322 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
                                                            ((void *)0)
# 322 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
                                                                , ( 400 ));
 }
...
# 329 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
          ((void *)0)
# 329 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
              , ( 401 ));
 }
...
# 335 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
          ((void *)0)
# 335 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
              , ( 403 ));
 }
...
# 340 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
__builtin_va_start(
# 340 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
args
# 340 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
,
# 340 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
...
# 342 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
__builtin_va_end(
# 342 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
args
# 342 "//./citus/src/backend/distributed/utils/citus_safe_lib.c" 3 4
)
# 342 "//./citus/src/backend/distributed/utils/citus_safe_lib.c"
