# 0 "//./citus/src/backend/distributed/utils/listutils.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/utils/listutils.c"
# 12 "//./citus/src/backend/distributed/utils/listutils.c"
...
# 13 "//./citus/src/backend/distributed/utils/listutils.c" 2
# 1 "/usr/include/postgresql/14/server/c.h" 1
# 14 "//./citus/src/backend/distributed/utils/listutils.c" 2
# 1 "/usr/include/postgresql/14/server/port.h" 1
# 15 "//./citus/src/backend/distributed/utils/listutils.c" 2

# 1 "/usr/include/postgresql/14/server/utils/lsyscache.h" 1
# 16 "/usr/include/postgresql/14/server/utils/lsyscache.h"
# 1 "/usr/include/postgresql/14/server/access/attnum.h" 1
# 21 "/usr/include/postgresql/14/server/access/attnum.h"
typedef int16 AttrNumber;
# 17 "/usr/include/postgresql/14/server/utils/lsyscache.h" 2
...
# 19 "/usr/include/postgresql/14/server/utils/lsyscache.h" 2
...
# 17 "//./citus/src/backend/distributed/utils/listutils.c" 2
...
# 18 "//./citus/src/backend/distributed/utils/listutils.c" 2
# 1 "//./citus/src/include/distributed/citus_safe_lib.h" 1
# 18 "//./citus/src/include/distributed/citus_safe_lib.h"
...
# 19 "//./citus/src/include/distributed/citus_safe_lib.h" 2
...
# 19 "//./citus/src/backend/distributed/utils/listutils.c" 2
...
# 20 "//./citus/src/backend/distributed/utils/listutils.c" 2
...
extern MemoryContext GenerationContextCreate(MemoryContext parent,
            const char *name,
            Size blockSize);
# 22 "//./citus/src/backend/distributed/utils/listutils.c" 2
# 35 "//./citus/src/backend/distributed/utils/listutils.c"
List *
SortList(List *pointerList, int (*comparisonFunction)(const void *, const void *))
{
 List *sortedList = ((List *) 
# 38 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
                   ((void *)0)
# 38 "//./citus/src/backend/distributed/utils/listutils.c"
                   );
 uint32 arrayIndex = 0;
 ...
 void *pointer = 
# 43 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
                ((void *)0)
# 43 "//./citus/src/backend/distributed/utils/listutils.c"
                    ;
 for (ListCell *(pointerCellDoNotUse) = list_head(pointerList); (pointerCellDoNotUse) != 
# 44 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
((void *)0) 
# 44 "//./citus/src/backend/distributed/utils/listutils.c"
&& (((pointer) = ((pointerCellDoNotUse)->ptr_value)) || 
# 44 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
1
# 44 "//./citus/src/backend/distributed/utils/listutils.c"
); pointerCellDoNotUse = lnext(pointerList, pointerCellDoNotUse))
 {
 ...
 if (sortedList != ((List *) 
# 63 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
                  ((void *)0)
# 63 "//./citus/src/backend/distributed/utils/listutils.c"
                  ))
 {
...
PointerArrayFromList(List *pointerList)
{
 ...
 void *pointer = 
# 82 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
                ((void *)0)
# 82 "//./citus/src/backend/distributed/utils/listutils.c"
                    ;
 for (ListCell *(pointerCellDoNotUse) = list_head(pointerList); (pointerCellDoNotUse) != 
# 83 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
((void *)0) 
# 83 "//./citus/src/backend/distributed/utils/listutils.c"
&& (((pointer) = ((pointerCellDoNotUse)->ptr_value)) || 
# 83 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
1
# 83 "//./citus/src/backend/distributed/utils/listutils.c"
...
# 104 "//./citus/src/backend/distributed/utils/listutils.c"
HTAB *
ListToHashSet(List *itemList, Size keySize, 
# 105 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
                                           _Bool 
# 105 "//./citus/src/backend/distributed/utils/listutils.c"
                                                isStringList)
{
 HASHCTL info;
 int flags = 0x0008 | 0x0400;
 ...
 void *item = 
# 132 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
             ((void *)0)
# 132 "//./citus/src/backend/distributed/utils/listutils.c"
                 ;
 for (ListCell *(itemCellDoNotUse) = list_head(itemList); (itemCellDoNotUse) != 
# 133 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
((void *)0) 
# 133 "//./citus/src/backend/distributed/utils/listutils.c"
&& (((item) = ((itemCellDoNotUse)->ptr_value)) || 
# 133 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
1
# 133 "//./citus/src/backend/distributed/utils/listutils.c"
); itemCellDoNotUse = lnext(itemList, itemCellDoNotUse))
 {
  
# 135 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
 _Bool 
# 135 "//./citus/src/backend/distributed/utils/listutils.c"
      foundInSet = 
# 135 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
                   0
# 135 "//./citus/src/backend/distributed/utils/listutils.c"
...
{
 List *intList = ((List *) 
# 152 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
                ((void *)0)
# 152 "//./citus/src/backend/distributed/utils/listutils.c"
                );
...
# 167 "//./citus/src/backend/distributed/utils/listutils.c"
char *
StringJoin(List *stringList, char delimiter)
{
 return StringJoinParams(stringList, delimiter, 
# 170 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
                                               ((void *)0)
# 170 "//./citus/src/backend/distributed/utils/listutils.c"
                                                   , 
# 170 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
                                                     ((void *)0)
# 170 "//./citus/src/backend/distributed/utils/listutils.c"
...
StringJoinParams(List *stringList, char delimiter, char *prefix, char *postfix)
{
 ...
 if (prefix != 
# 184 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
              ((void *)0)
# 184 "//./citus/src/backend/distributed/utils/listutils.c"
                  )
 {
 ...
 const char *command = 
# 189 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
                      ((void *)0)
# 189 "//./citus/src/backend/distributed/utils/listutils.c"
                          ;
 int curIndex = 0;
 for (ListCell *(commandCellDoNotUse) = list_head(stringList); (commandCellDoNotUse) != 
# 191 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
((void *)0) 
# 191 "//./citus/src/backend/distributed/utils/listutils.c"
&& (((command) = ((commandCellDoNotUse)->ptr_value)) || 
# 191 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
1
# 191 "//./citus/src/backend/distributed/utils/listutils.c"
); commandCellDoNotUse = lnext(stringList, commandCellDoNotUse))
 {
  if (curIndex > 0)
  {
 ...
 if (postfix != 
# 201 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
               ((void *)0)
# 201 "//./citus/src/backend/distributed/utils/listutils.c"
                   )
 {
...
{
 List *result = ((List *) 
# 218 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
               ((void *)0)
# 218 "//./citus/src/backend/distributed/utils/listutils.c"
               );
 int listIndex = 0;

 void *pointer = 
# 221 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
                ((void *)0)
# 221 "//./citus/src/backend/distributed/utils/listutils.c"
                    ;
 for (ListCell *(pointerCellDoNotUse) = list_head(pointerList); (pointerCellDoNotUse) != 
# 222 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
((void *)0) 
# 222 "//./citus/src/backend/distributed/utils/listutils.c"
&& (((pointer) = ((pointerCellDoNotUse)->ptr_value)) || 
# 222 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
1
# 222 "//./citus/src/backend/distributed/utils/listutils.c"
...
# 246 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
 ((void *)0)
# 246 "//./citus/src/backend/distributed/utils/listutils.c"
 ) : errstart(21, 
# 246 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
 ((void *)0)
# 246 "//./citus/src/backend/distributed/utils/listutils.c"
 )) (errcode((((('X') - '0') & 0x3F) + (((('X') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("invalid list access: list length was %d but " "element at index %d was requested ", listLength, index)), errfinish("//./citus/src/backend/distributed/utils/listutils.c", 246, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
...
{
 List *list = ((List *) 
# 263 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
             ((void *)0)
# 263 "//./citus/src/backend/distributed/utils/listutils.c"
             );
...
List *
list_filter_oid(List *list, 
# 278 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
                           _Bool 
# 278 "//./citus/src/backend/distributed/utils/listutils.c"
                                (*keepElement)(Oid element))
{
 List *result = ((List *) 
# 280 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
               ((void *)0)
# 280 "//./citus/src/backend/distributed/utils/listutils.c"
               );
 Oid element = ((Oid) 0);
 for (ListCell *(elementCellDoNotUse) = list_head(list); (elementCellDoNotUse) != 
# 282 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
((void *)0) 
# 282 "//./citus/src/backend/distributed/utils/listutils.c"
&& (((element) = ((elementCellDoNotUse)->oid_value)) || 
# 282 "//./citus/src/backend/distributed/utils/listutils.c" 3 4
1
# 282 "//./citus/src/backend/distributed/utils/listutils.c"
); elementCellDoNotUse = lnext(list, elementCellDoNotUse))
 {
