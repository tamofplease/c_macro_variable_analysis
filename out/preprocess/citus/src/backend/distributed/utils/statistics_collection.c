# 0 "//./citus/src/backend/distributed/utils/statistics_collection.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/utils/statistics_collection.c"
# 11 "//./citus/src/backend/distributed/utils/statistics_collection.c"
...
# 12 "//./citus/src/backend/distributed/utils/statistics_collection.c" 2

# 1 "//./citus/src/include/citus_version.h" 1
# 14 "//./citus/src/backend/distributed/utils/statistics_collection.c" 2
...
# 15 "//./citus/src/backend/distributed/utils/statistics_collection.c" 2
# 1 "/usr/include/postgresql/14/server/utils/uuid.h" 1
# 20 "/usr/include/postgresql/14/server/utils/uuid.h"
typedef struct pg_uuid_t
{
 unsigned char data[16];
} pg_uuid_t;
# 16 "//./citus/src/backend/distributed/utils/statistics_collection.c" 2


# 17 "//./citus/src/backend/distributed/utils/statistics_collection.c" 3 4
_Bool 
# 17 "//./citus/src/backend/distributed/utils/statistics_collection.c"
...
extern Datum citus_server_id(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_citus_server_id(void); const Pg_finfo_record * pg_finfo_citus_server_id (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
# 322 "//./citus/src/backend/distributed/utils/statistics_collection.c"
Datum
citus_server_id(FunctionCallInfo fcinfo)
{
 uint8 *buf = (uint8 *) palloc(16);
 ...
 if (!pg_strong_random((char *) buf, 16))
 {
  for (int bufIdx = 0; bufIdx < 16; bufIdx++)
  {
