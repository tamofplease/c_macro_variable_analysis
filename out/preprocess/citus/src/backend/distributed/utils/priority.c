# 0 "//./citus/src/backend/distributed/utils/priority.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/utils/priority.c"
# 10 "//./citus/src/backend/distributed/utils/priority.c"
...
# 11 "//./citus/src/backend/distributed/utils/priority.c" 2
...
# 13 "//./citus/src/backend/distributed/utils/priority.c" 2
...
# 14 "//./citus/src/backend/distributed/utils/priority.c" 2
...
# 15 "//./citus/src/backend/distributed/utils/priority.c" 2
...
# 16 "//./citus/src/backend/distributed/utils/priority.c" 2


# 1 "//./citus/src/include/distributed/priority.h" 1
# 14 "//./citus/src/include/distributed/priority.h"
# 1 "/usr/include/postgresql/14/server/c.h" 1
# 15 "//./citus/src/include/distributed/priority.h" 2
...
# 17 "//./citus/src/include/distributed/priority.h" 2
...
# 18 "//./citus/src/include/distributed/priority.h" 2
...
# 19 "//./citus/src/include/distributed/priority.h" 2
...
# 19 "//./citus/src/backend/distributed/utils/priority.c" 2

int CpuPriority = 0;
int CpuPriorityLogicalRepSender = 1234;
...
SetOwnPriority(int priority)
{
 ...
 if (setpriority(
# 38 "//./citus/src/backend/distributed/utils/priority.c" 3 4
                PRIO_PROCESS
# 38 "//./citus/src/backend/distributed/utils/priority.c"
                            , getpid(), priority) == -1)
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(19) && (19) >= 21 ? errstart_cold(19, 
# 40 "//./citus/src/backend/distributed/utils/priority.c" 3 4
 ((void *)0)
# 40 "//./citus/src/backend/distributed/utils/priority.c"
 ) : errstart(19, 
# 40 "//./citus/src/backend/distributed/utils/priority.c" 3 4
 ((void *)0)
# 40 "//./citus/src/backend/distributed/utils/priority.c"
 )) ( errmsg("could not set cpu priority to %d: %m", priority), errhint("Try changing the 'nice' resource limit by changing " "/etc/security/limits.conf for the postgres user " "and/or by setting LimitNICE in your the systemd " "service file (depending on how you start " "postgres)." )), errfinish("//./citus/src/backend/distributed/utils/priority.c", 40, __func__); if (__builtin_constant_p(19) && (19) >= 21) __builtin_unreachable(); } while(0)
...
# 58 "//./citus/src/backend/distributed/utils/priority.c" 3 4
(*__errno_location ()) 
# 58 "//./citus/src/backend/distributed/utils/priority.c"
      = 0;
 int result = getpriority(
# 59 "//./citus/src/backend/distributed/utils/priority.c" 3 4
                         PRIO_PROCESS
# 59 "//./citus/src/backend/distributed/utils/priority.c"
                                     , getpid());
 ...
 if (result == -1 && 
# 65 "//./citus/src/backend/distributed/utils/priority.c" 3 4
                    (*__errno_location ()) 
# 65 "//./citus/src/backend/distributed/utils/priority.c"
                          != 0)
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(19) && (19) >= 21 ? errstart_cold(19, 
# 67 "//./citus/src/backend/distributed/utils/priority.c" 3 4
 ((void *)0)
# 67 "//./citus/src/backend/distributed/utils/priority.c"
 ) : errstart(19, 
# 67 "//./citus/src/backend/distributed/utils/priority.c" 3 4
 ((void *)0)
# 67 "//./citus/src/backend/distributed/utils/priority.c"
 )) (errmsg("could not get current cpu priority value, " "assuming 0: %m")), errfinish("//./citus/src/backend/distributed/utils/priority.c", 67, __func__); if (__builtin_constant_p(19) && (19) >= 21) __builtin_unreachable(); } while(0)
                            ;
  return 0;
 }
 return result;
