# 0 "//./citus/src/backend/distributed/utils/type_utils.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/utils/type_utils.c"
# 12 "//./citus/src/backend/distributed/utils/type_utils.c"
...
# 13 "//./citus/src/backend/distributed/utils/type_utils.c" 2
...
# 14 "//./citus/src/backend/distributed/utils/type_utils.c" 2
...
# 15 "//./citus/src/backend/distributed/utils/type_utils.c" 2
...
extern char *makeMultirangeTypeName(const char *rangeTypeName,
         Oid typeNamespace);
# 17 "//./citus/src/backend/distributed/utils/type_utils.c" 2
...
# 19 "//./citus/src/backend/distributed/utils/type_utils.c" 2
# 1 "/usr/include/postgresql/14/server/libpq/pqformat.h" 1
# 16 "/usr/include/postgresql/14/server/libpq/pqformat.h"
...
# 17 "/usr/include/postgresql/14/server/libpq/pqformat.h" 2
...
# 696 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
                                       noError);
# 18 "/usr/include/postgresql/14/server/libpq/pqformat.h" 2
# 1 "/usr/include/postgresql/14/server/port/pg_bswap.h" 1
# 19 "/usr/include/postgresql/14/server/libpq/pqformat.h" 2
...
# 27 "/usr/include/postgresql/14/server/libpq/pqformat.h" 3 4
         _Bool 
# 27 "/usr/include/postgresql/14/server/libpq/pqformat.h"
              countincludesself);
...
# 46 "/usr/include/postgresql/14/server/libpq/pqformat.h"
static inline void
pq_writeint8(StringInfoData *__restrict__ buf, uint8 i)
{
 ...
 ((void)
# 51 "/usr/include/postgresql/14/server/libpq/pqformat.h" 3 4
1
# 51 "/usr/include/postgresql/14/server/libpq/pqformat.h"
);
...
pq_writeint16(StringInfoData *__restrict__ buf, uint16 i)
{
 ...
 ((void)
# 65 "/usr/include/postgresql/14/server/libpq/pqformat.h" 3 4
1
# 65 "/usr/include/postgresql/14/server/libpq/pqformat.h"
);
...
pq_writeint32(StringInfoData *__restrict__ buf, uint32 i)
{
 ...
 ((void)
# 79 "/usr/include/postgresql/14/server/libpq/pqformat.h" 3 4
1
# 79 "/usr/include/postgresql/14/server/libpq/pqformat.h"
);
...
pq_writeint64(StringInfoData *__restrict__ buf, uint64 i)
{
 ...
 ((void)
# 93 "/usr/include/postgresql/14/server/libpq/pqformat.h" 3 4
1
# 93 "/usr/include/postgresql/14/server/libpq/pqformat.h"
);
 memcpy((char *__restrict__) (buf->data + buf->len), &ni, sizeof(uint64));
 buf->len += sizeof(uint64);
}
# 108 "/usr/include/postgresql/14/server/libpq/pqformat.h"
static inline void
pq_writestring(StringInfoData *__restrict__ buf, const char *__restrict__ str)
{
 ...
 ((void)
# 118 "/usr/include/postgresql/14/server/libpq/pqformat.h" 3 4
1
# 118 "/usr/include/postgresql/14/server/libpq/pqformat.h"
);
...
# 186 "/usr/include/postgresql/14/server/libpq/pqformat.h" 3 4
  ((void *)0)
# 186 "/usr/include/postgresql/14/server/libpq/pqformat.h"
  ) : errstart(21, 
# 186 "/usr/include/postgresql/14/server/libpq/pqformat.h" 3 4
  ((void *)0)
# 186 "/usr/include/postgresql/14/server/libpq/pqformat.h"
  )) errmsg_internal("unsupported integer size %d", b), errfinish("/usr/include/postgresql/14/server/libpq/pqformat.h", 186, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
   break;
 }
}
...
# 20 "//./citus/src/backend/distributed/utils/type_utils.c" 2

# 1 "//./citus/src/include/distributed/causal_clock.h" 1
# 15 "//./citus/src/include/distributed/causal_clock.h"
# 1 "//./citus/src/include/distributed/type_utils.h" 1
# 13 "//./citus/src/include/distributed/type_utils.h"
...
# 16 "//./citus/src/include/distributed/causal_clock.h" 2
# 34 "//./citus/src/include/distributed/causal_clock.h"
extern 
# 34 "//./citus/src/include/distributed/causal_clock.h" 3 4
      _Bool 
# 34 "//./citus/src/include/distributed/causal_clock.h"
           EnableClusterClock;
...
# 22 "//./citus/src/backend/distributed/utils/type_utils.c" 2
...
extern Datum cluster_clock_in(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_cluster_clock_in(void); const Pg_finfo_record * pg_finfo_cluster_clock_in (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum cluster_clock_out(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_cluster_clock_out(void); const Pg_finfo_record * pg_finfo_cluster_clock_out (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum cluster_clock_recv(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_cluster_clock_recv(void); const Pg_finfo_record * pg_finfo_cluster_clock_recv (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum cluster_clock_send(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_cluster_clock_send(void); const Pg_finfo_record * pg_finfo_cluster_clock_send (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
...
cluster_clock_in_internal(char *clockString)
{
 ...
 for (char *currentChar = clockString;
   (*currentChar) && (numClockField < 2) && (*currentChar !=
                  ')');
   currentChar++)
 {
  if (*currentChar == ',' || (*currentChar == '(' && !numClockField))
  {
 ...
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 58 "//./citus/src/backend/distributed/utils/type_utils.c" 3 4
 ((void *)0)
# 58 "//./citus/src/backend/distributed/utils/type_utils.c"
 ) : errstart(21, 
# 58 "//./citus/src/backend/distributed/utils/type_utils.c" 3 4
 ((void *)0)
# 58 "//./citus/src/backend/distributed/utils/type_utils.c"
 )) (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('P') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('2') - '0') & 0x3F) << 24))), errmsg("invalid input syntax for type %s: \"%s\"", "cluster_clock", clockString)), errfinish("//./citus/src/backend/distributed/utils/type_utils.c", 58, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
 ...
 char *endingChar = 
# 65 "//./citus/src/backend/distributed/utils/type_utils.c" 3 4
                   ((void *)0)
# 65 "//./citus/src/backend/distributed/utils/type_utils.c"
                       ;
 
# 66 "//./citus/src/backend/distributed/utils/type_utils.c" 3 4
(*__errno_location ()) 
# 66 "//./citus/src/backend/distributed/utils/type_utils.c"
      = 0;
 int64 logical = strtoul(clockFields[0], &endingChar, 10);

 if (
# 69 "//./citus/src/backend/distributed/utils/type_utils.c" 3 4
    (*__errno_location ()) 
# 69 "//./citus/src/backend/distributed/utils/type_utils.c"
          || (*endingChar != ',') || (logical > ((1LU << 42) - 1)) || logical < 0)
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 71 "//./citus/src/backend/distributed/utils/type_utils.c" 3 4
 ((void *)0)
# 71 "//./citus/src/backend/distributed/utils/type_utils.c"
 ) : errstart(21, 
# 71 "//./citus/src/backend/distributed/utils/type_utils.c" 3 4
 ((void *)0)
# 71 "//./citus/src/backend/distributed/utils/type_utils.c"
 )) (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('P') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('2') - '0') & 0x3F) << 24))), errmsg("invalid input syntax for type %s: \"%s\"", "cluster_clock", clockString)), errfinish("//./citus/src/backend/distributed/utils/type_utils.c", 71, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
 ...
 if (
# 80 "//./citus/src/backend/distributed/utils/type_utils.c" 3 4
    (*__errno_location ()) 
# 80 "//./citus/src/backend/distributed/utils/type_utils.c"
          || (*endingChar != ')') || (counter > ((1U << 22) - 1)) || counter < 0)
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 82 "//./citus/src/backend/distributed/utils/type_utils.c" 3 4
 ((void *)0)
# 82 "//./citus/src/backend/distributed/utils/type_utils.c"
 ) : errstart(21, 
# 82 "//./citus/src/backend/distributed/utils/type_utils.c" 3 4
 ((void *)0)
# 82 "//./citus/src/backend/distributed/utils/type_utils.c"
 )) (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('P') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('2') - '0') & 0x3F) << 24))), errmsg("invalid input syntax for type %s: \"%s\"", "cluster_clock", clockString)), errfinish("//./citus/src/backend/distributed/utils/type_utils.c", 82, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
...
Datum
cluster_clock_in(FunctionCallInfo fcinfo)
{
 char *clockString = ((char *) ((Pointer) ((fcinfo->args[0].value))));

 return ((Datum) (cluster_clock_in_internal(clockString)));
}
...
Datum
cluster_clock_out(FunctionCallInfo fcinfo)
{
 ClusterClock *clusterClock = (ClusterClock *) ((Pointer) ((fcinfo->args[0].value)));

 if (clusterClock == 
# 117 "//./citus/src/backend/distributed/utils/type_utils.c" 3 4
                    ((void *)0)
# 117 "//./citus/src/backend/distributed/utils/type_utils.c"
                        )
 {
  return ((Datum) (""));
 }
...
Datum
cluster_clock_recv(FunctionCallInfo fcinfo)
{
 StringInfo clockBuffer = (StringInfo) ((Pointer) ((fcinfo->args[0].value)));
 ClusterClock *clusterClock = (ClusterClock *) palloc(sizeof(ClusterClock));

 clusterClock->logical = pq_getmsgint64(clockBuffer);
 clusterClock->counter = pq_getmsgint(clockBuffer, sizeof(int));

 return ((Datum) (clusterClock));
}
...
Datum
cluster_clock_send(FunctionCallInfo fcinfo)
{
 ClusterClock *clusterClock = (ClusterClock *) ((Pointer) ((fcinfo->args[0].value)));
 ...
 return ((Datum) (pq_endtypsend(&clockBuffer)));
}
...
extern Datum cluster_clock_lt(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_cluster_clock_lt(void); const Pg_finfo_record * pg_finfo_cluster_clock_lt (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum cluster_clock_le(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_cluster_clock_le(void); const Pg_finfo_record * pg_finfo_cluster_clock_le (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum cluster_clock_eq(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_cluster_clock_eq(void); const Pg_finfo_record * pg_finfo_cluster_clock_eq (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum cluster_clock_ne(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_cluster_clock_ne(void); const Pg_finfo_record * pg_finfo_cluster_clock_ne (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum cluster_clock_gt(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_cluster_clock_gt(void); const Pg_finfo_record * pg_finfo_cluster_clock_gt (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum cluster_clock_ge(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_cluster_clock_ge(void); const Pg_finfo_record * pg_finfo_cluster_clock_ge (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum cluster_clock_cmp(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_cluster_clock_cmp(void); const Pg_finfo_record * pg_finfo_cluster_clock_cmp (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum cluster_clock_logical(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_cluster_clock_logical(void); const Pg_finfo_record * pg_finfo_cluster_clock_logical (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
# 184 "//./citus/src/backend/distributed/utils/type_utils.c"
int
cluster_clock_cmp_internal(ClusterClock *clusterClock1, ClusterClock *clusterClock2)
{
 ((void)
# 187 "//./citus/src/backend/distributed/utils/type_utils.c" 3 4
1
# 187 "//./citus/src/backend/distributed/utils/type_utils.c"
);
...
Datum
cluster_clock_lt(FunctionCallInfo fcinfo)
{
 ClusterClock *clock1 = (ClusterClock *) ((Pointer) ((fcinfo->args[0].value)));
 ClusterClock *clock2 = (ClusterClock *) ((Pointer) ((fcinfo->args[1].value)));

 return ((Datum) ((cluster_clock_cmp_internal(clock1, clock2) < 0) ? 1 : 0));
}
...
Datum
cluster_clock_le(FunctionCallInfo fcinfo)
{
 ClusterClock *clock1 = (ClusterClock *) ((Pointer) ((fcinfo->args[0].value)));
 ClusterClock *clock2 = (ClusterClock *) ((Pointer) ((fcinfo->args[1].value)));
...
Datum
cluster_clock_eq(FunctionCallInfo fcinfo)
{
 ClusterClock *clock1 = (ClusterClock *) ((Pointer) ((fcinfo->args[0].value)));
 ClusterClock *clock2 = (ClusterClock *) ((Pointer) ((fcinfo->args[1].value)));
...
Datum
cluster_clock_ne(FunctionCallInfo fcinfo)
{
 ClusterClock *clock1 = (ClusterClock *) ((Pointer) ((fcinfo->args[0].value)));
 ClusterClock *clock2 = (ClusterClock *) ((Pointer) ((fcinfo->args[1].value)));
...
Datum
cluster_clock_gt(FunctionCallInfo fcinfo)
{
 ClusterClock *clock1 = (ClusterClock *) ((Pointer) ((fcinfo->args[0].value)));
 ClusterClock *clock2 = (ClusterClock *) ((Pointer) ((fcinfo->args[1].value)));
...
Datum
cluster_clock_ge(FunctionCallInfo fcinfo)
{
 ClusterClock *clock1 = (ClusterClock *) ((Pointer) ((fcinfo->args[0].value)));
 ClusterClock *clock2 = (ClusterClock *) ((Pointer) ((fcinfo->args[1].value)));
...
Datum
cluster_clock_cmp(FunctionCallInfo fcinfo)
{
 ClusterClock *clock1 = (ClusterClock *) ((Pointer) ((fcinfo->args[0].value)));
 ClusterClock *clock2 = (ClusterClock *) ((Pointer) ((fcinfo->args[1].value)));

 return ((Datum) (cluster_clock_cmp_internal(clock1, clock2)));
}
...
Datum
cluster_clock_logical(FunctionCallInfo fcinfo)
{
 ClusterClock *clusterClock = (ClusterClock *) ((Pointer) ((fcinfo->args[0].value)));

 return ((Datum) (clusterClock->logical));
}
