# 0 "//./citus/src/backend/distributed/utils/errormessage.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/utils/errormessage.c"
...
# 9 "//./citus/src/backend/distributed/utils/errormessage.c" 2
...
# 17 "/usr/include/postgresql/14/server/nodes/memnodes.h"
...
# 18 "/usr/include/postgresql/14/server/nodes/memnodes.h" 2
...
extern MemoryContext GenerationContextCreate(MemoryContext parent,
            const char *name,
            Size blockSize);
# 10 "//./citus/src/backend/distributed/utils/errormessage.c" 2

# 1 "/usr/include/postgresql/14/server/common/sha2.h" 1
# 12 "//./citus/src/backend/distributed/utils/errormessage.c" 2
...
# 13 "//./citus/src/backend/distributed/utils/errormessage.c" 2
...
# 14 "//./citus/src/backend/distributed/utils/errormessage.c" 2
...
# 15 "//./citus/src/backend/distributed/utils/errormessage.c" 2
# 1 "/usr/include/postgresql/14/server/utils/builtins.h" 1
# 19 "/usr/include/postgresql/14/server/utils/builtins.h"
# 1 "/usr/include/postgresql/14/server/utils/fmgrprotos.h" 1
# 24 "/usr/include/postgresql/14/server/utils/fmgrprotos.h"
...
extern Datum dist_bp(FunctionCallInfo fcinfo);
...
extern Datum dist_sp(FunctionCallInfo fcinfo);
extern Datum dist_bs(FunctionCallInfo fcinfo);
...
extern Datum dist_pathp(FunctionCallInfo fcinfo);
...
extern Datum dist_lp(FunctionCallInfo fcinfo);
extern Datum dist_bl(FunctionCallInfo fcinfo);
extern Datum dist_ls(FunctionCallInfo fcinfo);
...
extern Datum dist_polyc(FunctionCallInfo fcinfo);
...
extern Datum pg_stat_get_wal(FunctionCallInfo fcinfo);
extern Datum pg_get_wal_replay_pause_state(FunctionCallInfo fcinfo);
...
extern Datum jsonb_path_query_tz(FunctionCallInfo fcinfo);
...
extern Datum multirange_unnest(FunctionCallInfo fcinfo);
...
extern Datum similar_to_escape_2(FunctionCallInfo fcinfo);
extern Datum similar_to_escape_1(FunctionCallInfo fcinfo);
...
extern Datum split_part(FunctionCallInfo fcinfo);
...
extern Datum pg_column_compression(FunctionCallInfo fcinfo);
...
extern Datum pg_get_backend_memory_contexts(FunctionCallInfo fcinfo);
...
extern Datum pg_stat_get_slru(FunctionCallInfo fcinfo);
extern Datum pg_stat_reset_slru(FunctionCallInfo fcinfo);
...
extern Datum pg_snapshot_in(FunctionCallInfo fcinfo);
extern Datum pg_snapshot_out(FunctionCallInfo fcinfo);
extern Datum pg_snapshot_recv(FunctionCallInfo fcinfo);
extern Datum pg_snapshot_send(FunctionCallInfo fcinfo);
extern Datum pg_current_xact_id(FunctionCallInfo fcinfo);
extern Datum pg_current_snapshot(FunctionCallInfo fcinfo);
extern Datum pg_snapshot_xmin(FunctionCallInfo fcinfo);
extern Datum pg_snapshot_xmax(FunctionCallInfo fcinfo);
extern Datum pg_snapshot_xip(FunctionCallInfo fcinfo);
extern Datum pg_visible_in_snapshot(FunctionCallInfo fcinfo);
...
extern Datum pg_current_xact_id_if_assigned(FunctionCallInfo fcinfo);
...
extern Datum pg_xact_status(FunctionCallInfo fcinfo);
...
extern Datum gen_random_uuid(FunctionCallInfo fcinfo);
extern Datum gtsvector_options(FunctionCallInfo fcinfo);
extern Datum gist_point_sortsupport(FunctionCallInfo fcinfo);
...
extern Datum gist_box_distance(FunctionCallInfo fcinfo);
...
extern Datum pg_lsn_larger(FunctionCallInfo fcinfo);
extern Datum pg_lsn_smaller(FunctionCallInfo fcinfo);
extern Datum regcollationin(FunctionCallInfo fcinfo);
extern Datum regcollationout(FunctionCallInfo fcinfo);
extern Datum to_regcollation(FunctionCallInfo fcinfo);
extern Datum regcollationrecv(FunctionCallInfo fcinfo);
extern Datum regcollationsend(FunctionCallInfo fcinfo);
...
extern Datum anycompatiblemultirange_in(FunctionCallInfo fcinfo);
extern Datum anycompatiblemultirange_out(FunctionCallInfo fcinfo);
extern Datum range_merge_from_multirange(FunctionCallInfo fcinfo);
extern Datum anymultirange_in(FunctionCallInfo fcinfo);
extern Datum anymultirange_out(FunctionCallInfo fcinfo);
extern Datum multirange_in(FunctionCallInfo fcinfo);
extern Datum multirange_out(FunctionCallInfo fcinfo);
extern Datum multirange_recv(FunctionCallInfo fcinfo);
extern Datum multirange_send(FunctionCallInfo fcinfo);
extern Datum multirange_lower(FunctionCallInfo fcinfo);
extern Datum multirange_upper(FunctionCallInfo fcinfo);
extern Datum multirange_empty(FunctionCallInfo fcinfo);
extern Datum multirange_lower_inc(FunctionCallInfo fcinfo);
extern Datum multirange_upper_inc(FunctionCallInfo fcinfo);
extern Datum multirange_lower_inf(FunctionCallInfo fcinfo);
extern Datum multirange_upper_inf(FunctionCallInfo fcinfo);
extern Datum multirange_typanalyze(FunctionCallInfo fcinfo);
extern Datum multirangesel(FunctionCallInfo fcinfo);
extern Datum multirange_eq(FunctionCallInfo fcinfo);
extern Datum multirange_ne(FunctionCallInfo fcinfo);
extern Datum range_overlaps_multirange(FunctionCallInfo fcinfo);
extern Datum multirange_overlaps_range(FunctionCallInfo fcinfo);
extern Datum multirange_overlaps_multirange(FunctionCallInfo fcinfo);
extern Datum multirange_contains_elem(FunctionCallInfo fcinfo);
extern Datum multirange_contains_range(FunctionCallInfo fcinfo);
extern Datum multirange_contains_multirange(FunctionCallInfo fcinfo);
extern Datum elem_contained_by_multirange(FunctionCallInfo fcinfo);
extern Datum range_contained_by_multirange(FunctionCallInfo fcinfo);
extern Datum multirange_contained_by_multirange(FunctionCallInfo fcinfo);
extern Datum range_adjacent_multirange(FunctionCallInfo fcinfo);
extern Datum multirange_adjacent_multirange(FunctionCallInfo fcinfo);
extern Datum multirange_adjacent_range(FunctionCallInfo fcinfo);
extern Datum range_before_multirange(FunctionCallInfo fcinfo);
extern Datum multirange_before_range(FunctionCallInfo fcinfo);
extern Datum multirange_before_multirange(FunctionCallInfo fcinfo);
extern Datum range_after_multirange(FunctionCallInfo fcinfo);
extern Datum multirange_after_range(FunctionCallInfo fcinfo);
extern Datum multirange_after_multirange(FunctionCallInfo fcinfo);
extern Datum range_overleft_multirange(FunctionCallInfo fcinfo);
extern Datum multirange_overleft_range(FunctionCallInfo fcinfo);
extern Datum multirange_overleft_multirange(FunctionCallInfo fcinfo);
extern Datum range_overright_multirange(FunctionCallInfo fcinfo);
extern Datum multirange_overright_range(FunctionCallInfo fcinfo);
extern Datum multirange_overright_multirange(FunctionCallInfo fcinfo);
extern Datum multirange_union(FunctionCallInfo fcinfo);
extern Datum multirange_minus(FunctionCallInfo fcinfo);
extern Datum multirange_intersect(FunctionCallInfo fcinfo);
extern Datum multirange_cmp(FunctionCallInfo fcinfo);
extern Datum multirange_lt(FunctionCallInfo fcinfo);
extern Datum multirange_le(FunctionCallInfo fcinfo);
extern Datum multirange_ge(FunctionCallInfo fcinfo);
extern Datum multirange_gt(FunctionCallInfo fcinfo);
extern Datum hash_multirange(FunctionCallInfo fcinfo);
extern Datum hash_multirange_extended(FunctionCallInfo fcinfo);
extern Datum multirange_constructor0(FunctionCallInfo fcinfo);
extern Datum multirange_constructor1(FunctionCallInfo fcinfo);
extern Datum multirange_constructor2(FunctionCallInfo fcinfo);
extern Datum range_agg_transfn(FunctionCallInfo fcinfo);
extern Datum range_agg_finalfn(FunctionCallInfo fcinfo);
extern Datum unicode_normalize_func(FunctionCallInfo fcinfo);
extern Datum unicode_is_normalized(FunctionCallInfo fcinfo);
extern Datum multirange_intersect_agg_transfn(FunctionCallInfo fcinfo);
extern Datum binary_upgrade_set_next_multirange_pg_type_oid(FunctionCallInfo fcinfo);
extern Datum binary_upgrade_set_next_multirange_array_pg_type_oid(FunctionCallInfo fcinfo);
extern Datum range_intersect_agg_transfn(FunctionCallInfo fcinfo);
extern Datum range_contains_multirange(FunctionCallInfo fcinfo);
extern Datum multirange_contained_by_range(FunctionCallInfo fcinfo);
extern Datum pg_log_backend_memory_contexts(FunctionCallInfo fcinfo);
...
extern Datum brin_bloom_opcinfo(FunctionCallInfo fcinfo);
extern Datum brin_bloom_add_value(FunctionCallInfo fcinfo);
extern Datum brin_bloom_consistent(FunctionCallInfo fcinfo);
extern Datum brin_bloom_union(FunctionCallInfo fcinfo);
extern Datum brin_bloom_options(FunctionCallInfo fcinfo);
extern Datum brin_bloom_summary_in(FunctionCallInfo fcinfo);
extern Datum brin_bloom_summary_out(FunctionCallInfo fcinfo);
extern Datum brin_bloom_summary_recv(FunctionCallInfo fcinfo);
extern Datum brin_bloom_summary_send(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_opcinfo(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_add_value(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_consistent(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_union(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_options(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_distance_int2(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_distance_int4(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_distance_int8(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_distance_float4(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_distance_float8(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_distance_numeric(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_distance_tid(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_distance_uuid(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_distance_date(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_distance_time(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_distance_interval(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_distance_timetz(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_distance_pg_lsn(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_distance_macaddr(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_distance_macaddr8(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_distance_inet(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_distance_timestamp(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_summary_in(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_summary_out(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_summary_recv(FunctionCallInfo fcinfo);
extern Datum brin_minmax_multi_summary_send(FunctionCallInfo fcinfo);
...
extern Datum pg_lsn_pli(FunctionCallInfo fcinfo);
extern Datum pg_lsn_mii(FunctionCallInfo fcinfo);
...
extern Datum network_sortsupport(FunctionCallInfo fcinfo);
extern Datum xid8lt(FunctionCallInfo fcinfo);
extern Datum xid8gt(FunctionCallInfo fcinfo);
extern Datum xid8le(FunctionCallInfo fcinfo);
extern Datum xid8ge(FunctionCallInfo fcinfo);
extern Datum matchingsel(FunctionCallInfo fcinfo);
extern Datum matchingjoinsel(FunctionCallInfo fcinfo);
extern Datum numeric_min_scale(FunctionCallInfo fcinfo);
extern Datum numeric_trim_scale(FunctionCallInfo fcinfo);
extern Datum int4gcd(FunctionCallInfo fcinfo);
extern Datum int8gcd(FunctionCallInfo fcinfo);
extern Datum int4lcm(FunctionCallInfo fcinfo);
extern Datum int8lcm(FunctionCallInfo fcinfo);
extern Datum numeric_gcd(FunctionCallInfo fcinfo);
extern Datum numeric_lcm(FunctionCallInfo fcinfo);
extern Datum btvarstrequalimage(FunctionCallInfo fcinfo);
extern Datum btequalimage(FunctionCallInfo fcinfo);
extern Datum pg_get_shmem_allocations(FunctionCallInfo fcinfo);
extern Datum pg_stat_get_ins_since_vacuum(FunctionCallInfo fcinfo);
extern Datum jsonb_set_lax(FunctionCallInfo fcinfo);
extern Datum xid8in(FunctionCallInfo fcinfo);
extern Datum xid8toxid(FunctionCallInfo fcinfo);
extern Datum xid8out(FunctionCallInfo fcinfo);
extern Datum xid8recv(FunctionCallInfo fcinfo);
extern Datum xid8send(FunctionCallInfo fcinfo);
extern Datum xid8eq(FunctionCallInfo fcinfo);
extern Datum xid8ne(FunctionCallInfo fcinfo);
extern Datum anycompatible_in(FunctionCallInfo fcinfo);
extern Datum anycompatible_out(FunctionCallInfo fcinfo);
extern Datum anycompatiblearray_in(FunctionCallInfo fcinfo);
extern Datum anycompatiblearray_out(FunctionCallInfo fcinfo);
extern Datum anycompatiblearray_recv(FunctionCallInfo fcinfo);
extern Datum anycompatiblearray_send(FunctionCallInfo fcinfo);
extern Datum anycompatiblenonarray_in(FunctionCallInfo fcinfo);
extern Datum anycompatiblenonarray_out(FunctionCallInfo fcinfo);
extern Datum anycompatiblerange_in(FunctionCallInfo fcinfo);
extern Datum anycompatiblerange_out(FunctionCallInfo fcinfo);
extern Datum xid8cmp(FunctionCallInfo fcinfo);
...
extern Datum jsonb_subscript_handler(FunctionCallInfo fcinfo);
extern Datum numeric_pg_lsn(FunctionCallInfo fcinfo);
...
extern Datum multirange_gist_consistent(FunctionCallInfo fcinfo);
extern Datum multirange_gist_compress(FunctionCallInfo fcinfo);
extern Datum pg_get_catalog_foreign_keys(FunctionCallInfo fcinfo);
extern Datum text_to_table(FunctionCallInfo fcinfo);
extern Datum text_to_table_null(FunctionCallInfo fcinfo);
extern Datum bit_bit_count(FunctionCallInfo fcinfo);
extern Datum bytea_bit_count(FunctionCallInfo fcinfo);
extern Datum pg_xact_commit_timestamp_origin(FunctionCallInfo fcinfo);
extern Datum pg_stat_get_replication_slot(FunctionCallInfo fcinfo);
extern Datum pg_stat_reset_replication_slot(FunctionCallInfo fcinfo);
extern Datum trim_array(FunctionCallInfo fcinfo);
extern Datum pg_get_statisticsobjdef_expressions(FunctionCallInfo fcinfo);
extern Datum pg_get_statisticsobjdef_columns(FunctionCallInfo fcinfo);
extern Datum timestamp_bin(FunctionCallInfo fcinfo);
extern Datum timestamptz_bin(FunctionCallInfo fcinfo);
extern Datum array_subscript_handler(FunctionCallInfo fcinfo);
extern Datum raw_array_subscript_handler(FunctionCallInfo fcinfo);
extern Datum pg_stat_get_db_session_time(FunctionCallInfo fcinfo);
extern Datum pg_stat_get_db_active_time(FunctionCallInfo fcinfo);
extern Datum pg_stat_get_db_idle_in_transaction_time(FunctionCallInfo fcinfo);
extern Datum pg_stat_get_db_sessions(FunctionCallInfo fcinfo);
extern Datum pg_stat_get_db_sessions_abandoned(FunctionCallInfo fcinfo);
extern Datum pg_stat_get_db_sessions_fatal(FunctionCallInfo fcinfo);
extern Datum pg_stat_get_db_sessions_killed(FunctionCallInfo fcinfo);
extern Datum hash_record(FunctionCallInfo fcinfo);
extern Datum hash_record_extended(FunctionCallInfo fcinfo);
extern Datum bytealtrim(FunctionCallInfo fcinfo);
extern Datum byteartrim(FunctionCallInfo fcinfo);
extern Datum pg_get_function_sqlbody(FunctionCallInfo fcinfo);
extern Datum unistr(FunctionCallInfo fcinfo);
extern Datum extract_date(FunctionCallInfo fcinfo);
extern Datum extract_time(FunctionCallInfo fcinfo);
extern Datum extract_timetz(FunctionCallInfo fcinfo);
extern Datum extract_timestamp(FunctionCallInfo fcinfo);
extern Datum extract_timestamptz(FunctionCallInfo fcinfo);
extern Datum extract_interval(FunctionCallInfo fcinfo);
# 20 "/usr/include/postgresql/14/server/utils/builtins.h" 2
...
extern 
# 25 "/usr/include/postgresql/14/server/utils/builtins.h" 3 4
      _Bool 
# 25 "/usr/include/postgresql/14/server/utils/builtins.h"
...
# 25 "/usr/include/postgresql/14/server/utils/builtins.h"
                                              *result);
extern 
# 26 "/usr/include/postgresql/14/server/utils/builtins.h" 3 4
      _Bool 
# 26 "/usr/include/postgresql/14/server/utils/builtins.h"
...
# 29 "/usr/include/postgresql/14/server/utils/builtins.h" 3 4
                                     _Bool 
# 29 "/usr/include/postgresql/14/server/utils/builtins.h"
...
# 64 "/usr/include/postgresql/14/server/utils/builtins.h" 3 4
                                               _Bool 
# 64 "/usr/include/postgresql/14/server/utils/builtins.h"
                                                    case_insensitive,
         Oid collation, 
# 65 "/usr/include/postgresql/14/server/utils/builtins.h" 3 4
                       _Bool 
# 65 "/usr/include/postgresql/14/server/utils/builtins.h"
                            *exact);


extern 
# 68 "/usr/include/postgresql/14/server/utils/builtins.h" 3 4
      _Bool 
# 68 "/usr/include/postgresql/14/server/utils/builtins.h"
...
# 102 "/usr/include/postgresql/14/server/utils/builtins.h" 3 4
                                                               _Bool 
# 102 "/usr/include/postgresql/14/server/utils/builtins.h"
                                                                    *failure);
...
# 117 "/usr/include/postgresql/14/server/utils/builtins.h"
...
# 16 "//./citus/src/backend/distributed/utils/errormessage.c" 2
...
{
 DeferredErrorMessage *error = ((DeferredErrorMessage *) ({ CitusNode *_result; ((void)
# 25 "//./citus/src/backend/distributed/utils/errormessage.c" 3 4
                              1
# 25 "//./citus/src/backend/distributed/utils/errormessage.c"
                              ); _result = (CitusNode *) ( ( ((sizeof(DeferredErrorMessage)) & (sizeof(long) - 1)) == 0 && (sizeof(DeferredErrorMessage)) <= 1024 && 1024 != 0 && (0) == 0 ) ? MemoryContextAllocZeroAligned(CurrentMemoryContext, sizeof(DeferredErrorMessage)) : MemoryContextAllocZero(CurrentMemoryContext, sizeof(DeferredErrorMessage)) ); _result->extensible.type = T_ExtensibleNode; _result->extensible.extnodename = CitusNodeTagNames[T_DeferredErrorMessage - 1200]; _result->citus_tag =(int) (T_DeferredErrorMessage); _result; }));

 ((void)
# 27 "//./citus/src/backend/distributed/utils/errormessage.c" 3 4
1
# 27 "//./citus/src/backend/distributed/utils/errormessage.c"
);
