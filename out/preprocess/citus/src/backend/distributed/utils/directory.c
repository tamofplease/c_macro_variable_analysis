# 0 "//./citus/src/backend/distributed/utils/directory.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/utils/directory.c"
# 11 "//./citus/src/backend/distributed/utils/directory.c"
# 1 "/usr/include/aarch64-linux-gnu/sys/stat.h" 1 3 4
# 25 "/usr/include/aarch64-linux-gnu/sys/stat.h" 3 4
...
# 26 "/usr/include/aarch64-linux-gnu/sys/stat.h" 2 3 4
...
# 12 "//./citus/src/backend/distributed/utils/directory.c" 2
...
# 13 "//./citus/src/backend/distributed/utils/directory.c" 2
...
# 31 "/usr/include/postgresql/14/server/postgres_ext.h"
...
# 196 "/usr/include/aarch64-linux-gnu/sys/types.h" 3 4
...
# 15 "//./citus/src/backend/distributed/utils/directory.c" 2
...
# 346 "/usr/include/postgresql/14/server/funcapi.h"
                           **nulls);
# 16 "//./citus/src/backend/distributed/utils/directory.c" 2
...
# 17 "//./citus/src/backend/distributed/utils/directory.c" 2

# 1 "//./citus/src/include/distributed/utils/directory.h" 1
# 21 "//./citus/src/include/distributed/utils/directory.h"
...
# 19 "//./citus/src/backend/distributed/utils/directory.c" 2



static 
# 22 "//./citus/src/backend/distributed/utils/directory.c" 3 4
      _Bool 
# 22 "//./citus/src/backend/distributed/utils/directory.c"
...
{
 int makeOK = mkdir(directoryName->data, 
# 31 "//./citus/src/backend/distributed/utils/directory.c" 3 4
                                        (0400|0200|0100)
# 31 "//./citus/src/backend/distributed/utils/directory.c"
                                               );
 if (makeOK != 0)
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 34 "//./citus/src/backend/distributed/utils/directory.c" 3 4
 ((void *)0)
# 34 "//./citus/src/backend/distributed/utils/directory.c"
 ) : errstart(21, 
# 34 "//./citus/src/backend/distributed/utils/directory.c" 3 4
 ((void *)0)
# 34 "//./citus/src/backend/distributed/utils/directory.c"
 )) (errcode_for_file_access(), errmsg("could not create directory \"%s\": %m", directoryName->data)), errfinish("//./citus/src/backend/distributed/utils/directory.c", 34, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
...
static 
# 44 "//./citus/src/backend/distributed/utils/directory.c" 3 4
      _Bool

# 45 "//./citus/src/backend/distributed/utils/directory.c"
FileIsLink(const char *filename, struct stat filestat)
{
 return 
# 47 "//./citus/src/backend/distributed/utils/directory.c" 3 4
       ((((
# 47 "//./citus/src/backend/distributed/utils/directory.c"
       filestat.st_mode
# 47 "//./citus/src/backend/distributed/utils/directory.c" 3 4
       )) & 0170000) == (0120000))
# 47 "//./citus/src/backend/distributed/utils/directory.c"
...
# 57 "//./citus/src/backend/distributed/utils/directory.c"
void
CitusRemoveDirectory(const char *filename)
{

 while (
# 61 "//./citus/src/backend/distributed/utils/directory.c" 3 4
       1
# 61 "//./citus/src/backend/distributed/utils/directory.c"
           )
 {
  ...
  {
   if (
# 69 "//./citus/src/backend/distributed/utils/directory.c" 3 4
      (*__errno_location ()) 
# 69 "//./citus/src/backend/distributed/utils/directory.c"
            == 
# 69 "//./citus/src/backend/distributed/utils/directory.c" 3 4
               2
# 69 "//./citus/src/backend/distributed/utils/directory.c"
   ...
   {
    do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 75 "//./citus/src/backend/distributed/utils/directory.c" 3 4
   ((void *)0)
# 75 "//./citus/src/backend/distributed/utils/directory.c"
   ) : errstart(21, 
# 75 "//./citus/src/backend/distributed/utils/directory.c" 3 4
   ((void *)0)
# 75 "//./citus/src/backend/distributed/utils/directory.c"
   )) (errcode_for_file_access(), errmsg("could not stat file \"%s\": %m", filename)), errfinish("//./citus/src/backend/distributed/utils/directory.c", 75, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
                                                            ;
   }
  }
  ...
  if (
# 85 "//./citus/src/backend/distributed/utils/directory.c" 3 4
     ((((
# 85 "//./citus/src/backend/distributed/utils/directory.c"
     fileStat.st_mode
# 85 "//./citus/src/backend/distributed/utils/directory.c" 3 4
     )) & 0170000) == (0040000)) 
# 85 "//./citus/src/backend/distributed/utils/directory.c"
                               && !FileIsLink(filename, fileStat))
  {
   const char *directoryName = filename;

   DIR *directory = AllocateDir(directoryName);
   if (directory == 
# 90 "//./citus/src/backend/distributed/utils/directory.c" 3 4
                   ((void *)0)
# 90 "//./citus/src/backend/distributed/utils/directory.c"
                       )
   {
    do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 92 "//./citus/src/backend/distributed/utils/directory.c" 3 4
   ((void *)0)
# 92 "//./citus/src/backend/distributed/utils/directory.c"
   ) : errstart(21, 
# 92 "//./citus/src/backend/distributed/utils/directory.c" 3 4
   ((void *)0)
# 92 "//./citus/src/backend/distributed/utils/directory.c"
   )) (errcode_for_file_access(), errmsg("could not open directory \"%s\": %m", directoryName)), errfinish("//./citus/src/backend/distributed/utils/directory.c", 92, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
   ...
   for (; directoryEntry != 
# 99 "//./citus/src/backend/distributed/utils/directory.c" 3 4
                           ((void *)0)
# 99 "//./citus/src/backend/distributed/utils/directory.c"
                 ...
                 directoryName))
   {
    ...
    if (strncmp(baseFilename, ".", 1024) == 0 ||
     strncmp(baseFilename, "..", 1024) == 0)
    {
     continue;
    }
  ...
  if (
# 123 "//./citus/src/backend/distributed/utils/directory.c" 3 4
     ((((
# 123 "//./citus/src/backend/distributed/utils/directory.c"
     fileStat.st_mode
# 123 "//./citus/src/backend/distributed/utils/directory.c" 3 4
     )) & 0170000) == (0040000))
# 123 "//./citus/src/backend/distributed/utils/directory.c"
                              )
  {
   ...
   if (
# 132 "//./citus/src/backend/distributed/utils/directory.c" 3 4
      (*__errno_location ()) 
# 132 "//./citus/src/backend/distributed/utils/directory.c"
            == 
# 132 "//./citus/src/backend/distributed/utils/directory.c" 3 4
               39 
# 132 "//./citus/src/backend/distributed/utils/directory.c"
...
# 132 "//./citus/src/backend/distributed/utils/directory.c"
  ...
  if (removed != 0 && 
# 147 "//./citus/src/backend/distributed/utils/directory.c" 3 4
                     (*__errno_location ()) 
# 147 "//./citus/src/backend/distributed/utils/directory.c"
                           != 
# 147 "//./citus/src/backend/distributed/utils/directory.c" 3 4
                              2
# 147 "//./citus/src/backend/distributed/utils/directory.c"
  ...
  {
   do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 149 "//./citus/src/backend/distributed/utils/directory.c" 3 4
  ((void *)0)
# 149 "//./citus/src/backend/distributed/utils/directory.c"
  ) : errstart(21, 
# 149 "//./citus/src/backend/distributed/utils/directory.c" 3 4
  ((void *)0)
# 149 "//./citus/src/backend/distributed/utils/directory.c"
  )) (errcode_for_file_access(), errmsg("could not remove file \"%s\": %m", filename)), errfinish("//./citus/src/backend/distributed/utils/directory.c", 149, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
                                                             ;
  }
...
CleanupJobCacheDirectory(void)
{
 ...
 appendStringInfo(jobCacheDirectory, "base/%s", "pgsql_job_cache");
