# 0 "//./citus/src/backend/distributed/commands/index_pg_source.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/commands/index_pg_source.c"
# 18 "//./citus/src/backend/distributed/commands/index_pg_source.c"
...
# 19 "//./citus/src/backend/distributed/commands/index_pg_source.c" 2
...
# 21 "//./citus/src/backend/distributed/commands/index_pg_source.c" 2
...
# 19 "/usr/include/postgresql/14/server/tcop/tcopprot.h"
...
# 38 "/usr/include/postgresql/14/server/utils/acl.h"
...
# 758 "//./citus/src/include/distributed/commands.h"
             autoConverted);
# 22 "//./citus/src/backend/distributed/commands/index_pg_source.c" 2
...
# 23 "//./citus/src/backend/distributed/commands/index_pg_source.c" 2
# 1 "/usr/include/postgresql/14/server/mb/pg_wchar.h" 1
# 25 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
typedef unsigned int pg_wchar;
# 238 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
typedef enum pg_enc
{
 PG_SQL_ASCII = 0,
 PG_EUC_JP,
...
# 353 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
...
typedef 
# 390 "/usr/include/postgresql/14/server/mb/pg_wchar.h" 3 4
       _Bool 
# 390 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
...
# 451 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
typedef struct
{
...
# 538 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
static inline 
# 538 "/usr/include/postgresql/14/server/mb/pg_wchar.h" 3 4
             _Bool

# 539 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
...
static inline 
# 544 "/usr/include/postgresql/14/server/mb/pg_wchar.h" 3 4
             _Bool

# 545 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
...
static inline 
# 550 "/usr/include/postgresql/14/server/mb/pg_wchar.h" 3 4
             _Bool

# 551 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
...
extern 
# 584 "/usr/include/postgresql/14/server/mb/pg_wchar.h" 3 4
      _Bool 
# 584 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
...
extern 
# 589 "/usr/include/postgresql/14/server/mb/pg_wchar.h" 3 4
      _Bool 
# 589 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
...
# 643 "/usr/include/postgresql/14/server/mb/pg_wchar.h" 3 4
           _Bool 
# 643 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
                noError);
...
extern int UtfToLocal(const unsigned char *utf, int len,
        ...
        int encoding, 
# 660 "/usr/include/postgresql/14/server/mb/pg_wchar.h" 3 4
                     _Bool 
# 660 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
                          noError);
extern int LocalToUtf(const unsigned char *iso, int len,
        ...
        utf_local_conversion_func conv_func,
        int encoding, 
# 666 "/usr/include/postgresql/14/server/mb/pg_wchar.h" 3 4
                     _Bool 
# 666 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
                          noError);

extern 
# 668 "/usr/include/postgresql/14/server/mb/pg_wchar.h" 3 4
      _Bool 
# 668 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
...
# 668 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
                                                           noError);
extern 
# 669 "/usr/include/postgresql/14/server/mb/pg_wchar.h" 3 4
      _Bool 
# 669 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
           pg_verify_mbstr(int encoding, const char *mbstr, int len,
       
# 670 "/usr/include/postgresql/14/server/mb/pg_wchar.h" 3 4
      _Bool 
# 670 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
           noError);
extern int pg_verify_mbstr_len(int encoding, const char *mbstr, int len,
        
# 672 "/usr/include/postgresql/14/server/mb/pg_wchar.h" 3 4
       _Bool 
# 672 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
            noError);
...
# 686 "/usr/include/postgresql/14/server/mb/pg_wchar.h" 3 4
                               _Bool 
# 686 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
                                    noError);
extern int latin2mic(const unsigned char *l, unsigned char *p, int len,
       int lc, int encoding, 
# 688 "/usr/include/postgresql/14/server/mb/pg_wchar.h" 3 4
                            _Bool 
# 688 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
                                 noError);
extern int mic2latin(const unsigned char *mic, unsigned char *p, int len,
       int lc, int encoding, 
# 690 "/usr/include/postgresql/14/server/mb/pg_wchar.h" 3 4
                            _Bool 
# 690 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
                                 noError);
extern int latin2mic_with_table(const unsigned char *l, unsigned char *p,
         int len, int lc, int encoding,
         const unsigned char *tab, 
# 693 "/usr/include/postgresql/14/server/mb/pg_wchar.h" 3 4
                                  _Bool 
# 693 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
                                       noError);
extern int mic2latin_with_table(const unsigned char *mic, unsigned char *p,
         int len, int lc, int encoding,
         const unsigned char *tab, 
# 696 "/usr/include/postgresql/14/server/mb/pg_wchar.h" 3 4
                                  _Bool 
# 696 "/usr/include/postgresql/14/server/mb/pg_wchar.h"
                                       noError);
# 24 "//./citus/src/backend/distributed/commands/index_pg_source.c" 2
# 36 "//./citus/src/backend/distributed/commands/index_pg_source.c"
char *
ChooseIndexName(const char *tabname, Oid namespaceId,
    List *colnames, List *exclusionOpNames,
    
# 39 "//./citus/src/backend/distributed/commands/index_pg_source.c" 3 4
   _Bool 
# 39 "//./citus/src/backend/distributed/commands/index_pg_source.c"
        primary, 
# 39 "//./citus/src/backend/distributed/commands/index_pg_source.c" 3 4
                 _Bool 
# 39 "//./citus/src/backend/distributed/commands/index_pg_source.c"
...
# 47 "//./citus/src/backend/distributed/commands/index_pg_source.c" 3 4
           ((void *)0)
# 47 "//./citus/src/backend/distributed/commands/index_pg_source.c"
               ,
            "pkey",
            namespaceId,
            
# 50 "//./citus/src/backend/distributed/commands/index_pg_source.c" 3 4
           1
# 50 "//./citus/src/backend/distributed/commands/index_pg_source.c"
               );
 }
 else if (exclusionOpNames != ((List *) 
# 52 "//./citus/src/backend/distributed/commands/index_pg_source.c" 3 4
                             ((void *)0)
# 52 "//./citus/src/backend/distributed/commands/index_pg_source.c"
                             ))
 {
  indexname = ChooseRelationName(tabname,
...
# 58 "//./citus/src/backend/distributed/commands/index_pg_source.c" 3 4
           1
# 58 "//./citus/src/backend/distributed/commands/index_pg_source.c"
               );
 }
...
# 66 "//./citus/src/backend/distributed/commands/index_pg_source.c" 3 4
           1
# 66 "//./citus/src/backend/distributed/commands/index_pg_source.c"
               );
 }
 else
 {
...
# 74 "//./citus/src/backend/distributed/commands/index_pg_source.c" 3 4
           0
# 74 "//./citus/src/backend/distributed/commands/index_pg_source.c"
                );
 }

 return indexname;
}
# 95 "//./citus/src/backend/distributed/commands/index_pg_source.c"
char *
ChooseIndexNameAddition(List *colnames)
{
 ...
 buf[0] = '\0';
 for (ForEachState lc__state = {(colnames), 0}; (lc__state.l != ((List *) 
# 103 "//./citus/src/backend/distributed/commands/index_pg_source.c" 3 4
((void *)0)
# 103 "//./citus/src/backend/distributed/commands/index_pg_source.c"
) && lc__state.i < lc__state.l->length) ? (lc = &lc__state.l->elements[lc__state.i], 
# 103 "//./citus/src/backend/distributed/commands/index_pg_source.c" 3 4
1
# 103 "//./citus/src/backend/distributed/commands/index_pg_source.c"
) : (lc = 
...
# 103 "//./citus/src/backend/distributed/commands/index_pg_source.c"
 ...
 {
  const char *name = (const char *) ((lc)->ptr_value);
...
# 137 "//./citus/src/backend/distributed/commands/index_pg_source.c"
List *
ChooseIndexColumnNames(List *indexElems)
{
 List *result = ((List *) 
# 140 "//./citus/src/backend/distributed/commands/index_pg_source.c" 3 4
               ((void *)0)
# 140 "//./citus/src/backend/distributed/commands/index_pg_source.c"
               );
 ListCell *lc;

 for (ForEachState lc__state = {(indexElems), 0}; (lc__state.l != ((List *) 
# 143 "//./citus/src/backend/distributed/commands/index_pg_source.c" 3 4
((void *)0)
# 143 "//./citus/src/backend/distributed/commands/index_pg_source.c"
) && lc__state.i < lc__state.l->length) ? (lc = &lc__state.l->elements[lc__state.i], 
# 143 "//./citus/src/backend/distributed/commands/index_pg_source.c" 3 4
1
# 143 "//./citus/src/backend/distributed/commands/index_pg_source.c"
...
# 143 "//./citus/src/backend/distributed/commands/index_pg_source.c"
 ...
 {
  IndexElem *ielem = (IndexElem *) ((lc)->ptr_value);
  const char *origname;
  const char *curname;
  int i;
  char buf[64];
  ...
  for (i = 1;; i++)
  {
   ...
   for (ForEachState lc2__state = {(result), 0}; (lc2__state.l != ((List *) 
# 173 "//./citus/src/backend/distributed/commands/index_pg_source.c" 3 4
  ((void *)0)
# 173 "//./citus/src/backend/distributed/commands/index_pg_source.c"
  ) && lc2__state.i < lc2__state.l->length) ? (lc2 = &lc2__state.l->elements[lc2__state.i], 
# 173 "//./citus/src/backend/distributed/commands/index_pg_source.c" 3 4
  1
# 173 "//./citus/src/backend/distributed/commands/index_pg_source.c"
  ) : (lc2 = 
...
# 173 "//./citus/src/backend/distributed/commands/index_pg_source.c"
   ...
   {
    if (strcmp(curname, (char *) ((lc2)->ptr_value)) == 0)
    {
     break;
    }
   }
   if (lc2 == 
# 180 "//./citus/src/backend/distributed/commands/index_pg_source.c" 3 4
             ((void *)0)
# 180 "//./citus/src/backend/distributed/commands/index_pg_source.c"
                 )
   {
    break;
   }
