# 0 "//./citus/src/backend/distributed/deparser/format_collate.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/deparser/format_collate.c"
# 13 "//./citus/src/backend/distributed/deparser/format_collate.c"
...
# 14 "//./citus/src/backend/distributed/deparser/format_collate.c" 2
...
# 16 "//./citus/src/backend/distributed/deparser/format_collate.c" 2
...
# 21 "/usr/include/postgresql/14/server/nodes/primnodes.h"
...
# 17 "//./citus/src/backend/distributed/deparser/format_collate.c" 2
# 1 "/usr/include/postgresql/14/server/catalog/pg_collation.h" 1
# 22 "/usr/include/postgresql/14/server/catalog/pg_collation.h"
...
# 82 "/usr/include/postgresql/14/server/catalog/pg_collation.h"
           quiet);
# 18 "//./citus/src/backend/distributed/deparser/format_collate.c" 2
...
# 19 "//./citus/src/backend/distributed/deparser/format_collate.c" 2
...
# 20 "//./citus/src/backend/distributed/deparser/format_collate.c" 2
...
# 21 "//./citus/src/backend/distributed/deparser/format_collate.c" 2

# 1 "//./citus/src/include/distributed/deparser.h" 1
# 19 "//./citus/src/include/distributed/deparser.h"
...
# 20 "//./citus/src/include/distributed/deparser.h" 2
# 1 "/usr/include/postgresql/14/server/catalog/objectaddress.h" 1
# 19 "/usr/include/postgresql/14/server/catalog/objectaddress.h"
...
# 21 "//./citus/src/include/distributed/deparser.h" 2
...
# 23 "//./citus/src/backend/distributed/deparser/format_collate.c" 2
...
{
 return FormatCollateExtended(collate_oid, 0x04);
}
# 48 "//./citus/src/backend/distributed/deparser/format_collate.c"
char *
FormatCollateExtended(Oid collid, bits16 flags)
{
 char *nspname = 
# 51 "//./citus/src/backend/distributed/deparser/format_collate.c" 3 4
                ((void *)0)
# 51 "//./citus/src/backend/distributed/deparser/format_collate.c"
                    ;

 if (collid == ((Oid) 0) && (flags & 0x02) != 0)
 {
  return pstrdup("-");
 }

 HeapTuple tuple = SearchSysCache1(COLLOID, ((Datum) (collid)));
 if (!((const void*)(tuple) != 
# 59 "//./citus/src/backend/distributed/deparser/format_collate.c" 3 4
     ((void *)0)
# 59 "//./citus/src/backend/distributed/deparser/format_collate.c"
     ))
 {
  if ((flags & 0x02) != 0)
  {
...
# 67 "//./citus/src/backend/distributed/deparser/format_collate.c" 3 4
  ((void *)0)
# 67 "//./citus/src/backend/distributed/deparser/format_collate.c"
  ) : errstart(21, 
# 67 "//./citus/src/backend/distributed/deparser/format_collate.c" 3 4
  ((void *)0)
# 67 "//./citus/src/backend/distributed/deparser/format_collate.c"
  )) errmsg_internal("cache lookup failed for collate %u", collid), errfinish("//./citus/src/backend/distributed/deparser/format_collate.c", 67, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
  }
 }
 Form_pg_collation collform = (Form_pg_collation) ((char *) ((tuple)->t_data) + (tuple)->t_data->t_hoff);

 if ((flags & 0x04) == 0 && CollationIsVisible(collid))
 {
  nspname = 
# 74 "//./citus/src/backend/distributed/deparser/format_collate.c" 3 4
           ((void *)0)
# 74 "//./citus/src/backend/distributed/deparser/format_collate.c"
               ;
 }
 else
 {
 ...
 char *typname = ((collform->collname).data);
