# 0 "//./citus/src/backend/distributed/deparser/deparse_attribute_stmts.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/deparser/deparse_attribute_stmts.c"
# 10 "//./citus/src/backend/distributed/deparser/deparse_attribute_stmts.c"
...
# 11 "//./citus/src/backend/distributed/deparser/deparse_attribute_stmts.c" 2
...
# 13 "//./citus/src/backend/distributed/deparser/deparse_attribute_stmts.c" 2
...
DeparseRenameAttributeStmt(Node *node)
{
 ...
 ((void)
# 18 "//./citus/src/backend/distributed/deparser/deparse_attribute_stmts.c" 3 4
1
# 18 "//./citus/src/backend/distributed/deparser/deparse_attribute_stmts.c"
);
...
# 29 "//./citus/src/backend/distributed/deparser/deparse_attribute_stmts.c" 3 4
  ((void *)0)
# 29 "//./citus/src/backend/distributed/deparser/deparse_attribute_stmts.c"
  ) : errstart(21, 
# 29 "//./citus/src/backend/distributed/deparser/deparse_attribute_stmts.c" 3 4
  ((void *)0)
# 29 "//./citus/src/backend/distributed/deparser/deparse_attribute_stmts.c"
  )) (errmsg("unsupported rename attribute statement for" " deparsing")), errfinish("//./citus/src/backend/distributed/deparser/deparse_attribute_stmts.c", 29, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
                          ;
  }
 }
}
