# 0 "//./citus/src/backend/distributed/deparser/objectaddress.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/deparser/objectaddress.c"
# 13 "//./citus/src/backend/distributed/deparser/objectaddress.c"
...
# 14 "//./citus/src/backend/distributed/deparser/objectaddress.c" 2

# 1 "/usr/include/postgresql/14/server/commands/extension.h" 1
# 17 "/usr/include/postgresql/14/server/commands/extension.h"
...
# 18 "/usr/include/postgresql/14/server/commands/extension.h" 2
...
# 19 "/usr/include/postgresql/14/server/commands/extension.h" 2
# 30 "/usr/include/postgresql/14/server/commands/extension.h"
extern 
# 30 "/usr/include/postgresql/14/server/commands/extension.h" 3 4
                  _Bool 
# 30 "/usr/include/postgresql/14/server/commands/extension.h"
                       creating_extension;
...
extern ObjectAddress InsertExtensionTuple(const char *extName, Oid extOwner,
            Oid schemaOid, 
# 39 "/usr/include/postgresql/14/server/commands/extension.h" 3 4
                          _Bool 
# 39 "/usr/include/postgresql/14/server/commands/extension.h"
                               relocatable, const char *extVersion,
...
extern Oid get_extension_oid(const char *extname, 
# 48 "/usr/include/postgresql/14/server/commands/extension.h" 3 4
                                                 _Bool 
# 48 "/usr/include/postgresql/14/server/commands/extension.h"
                                                      missing_ok);
extern char *get_extension_name(Oid ext_oid);
extern 
# 50 "/usr/include/postgresql/14/server/commands/extension.h" 3 4
      _Bool 
# 50 "/usr/include/postgresql/14/server/commands/extension.h"
           extension_file_exists(const char *extensionName);

extern ObjectAddress AlterExtensionNamespace(const char *extensionName, const char *newschema,
            Oid *oldschema);
# 16 "//./citus/src/backend/distributed/deparser/objectaddress.c" 2
...
# 758 "//./citus/src/include/distributed/commands.h"
             autoConverted);
# 17 "//./citus/src/backend/distributed/deparser/objectaddress.c" 2
...
# 18 "//./citus/src/backend/distributed/deparser/objectaddress.c" 2

# 1 "/usr/include/postgresql/14/server/catalog/pg_extension_d.h" 1
# 20 "//./citus/src/backend/distributed/deparser/objectaddress.c" 2
...
List *
GetObjectAddressListFromParseTree(Node *parseTree, 
# 27 "//./citus/src/backend/distributed/deparser/objectaddress.c" 3 4
                                                  _Bool 
# 27 "//./citus/src/backend/distributed/deparser/objectaddress.c"
                                                       missing_ok, 
# 27 "//./citus/src/backend/distributed/deparser/objectaddress.c" 3 4
                                                                   _Bool 
# 27 "//./citus/src/backend/distributed/deparser/objectaddress.c"
...
# 33 "//./citus/src/backend/distributed/deparser/objectaddress.c" 3 4
 ((void *)0)
# 33 "//./citus/src/backend/distributed/deparser/objectaddress.c"
 ) : errstart(21, 
# 33 "//./citus/src/backend/distributed/deparser/objectaddress.c" 3 4
 ((void *)0)
# 33 "//./citus/src/backend/distributed/deparser/objectaddress.c"
 )) (errmsg("unsupported statement to get object address for")), errfinish("//./citus/src/backend/distributed/deparser/objectaddress.c", 33, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
 }
...
List *
RenameAttributeStmtObjectAddress(Node *node, 
# 41 "//./citus/src/backend/distributed/deparser/objectaddress.c" 3 4
                                            _Bool 
# 41 "//./citus/src/backend/distributed/deparser/objectaddress.c"
                                                 missing_ok, 
# 41 "//./citus/src/backend/distributed/deparser/objectaddress.c" 3 4
                                                             _Bool 
# 41 "//./citus/src/backend/distributed/deparser/objectaddress.c"
                                                                  isPostprocess)
{
 ...
 ((void)
# 44 "//./citus/src/backend/distributed/deparser/objectaddress.c" 3 4
1
# 44 "//./citus/src/backend/distributed/deparser/objectaddress.c"
);
 ...
 switch (stmt->relationType)
 {
  ...
  {
   do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 55 "//./citus/src/backend/distributed/deparser/objectaddress.c" 3 4
  ((void *)0)
# 55 "//./citus/src/backend/distributed/deparser/objectaddress.c"
  ) : errstart(21, 
# 55 "//./citus/src/backend/distributed/deparser/objectaddress.c" 3 4
  ((void *)0)
# 55 "//./citus/src/backend/distributed/deparser/objectaddress.c"
  )) (errmsg("unsupported alter rename attribute statement to get " "object address for")), errfinish("//./citus/src/backend/distributed/deparser/objectaddress.c", 55, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
                                  ;
  }
 }
}
# 70 "//./citus/src/backend/distributed/deparser/objectaddress.c"
List *
CreateExtensionStmtObjectAddress(Node *node, 
# 71 "//./citus/src/backend/distributed/deparser/objectaddress.c" 3 4
                                            _Bool 
# 71 "//./citus/src/backend/distributed/deparser/objectaddress.c"
                                                 missing_ok, 
# 71 "//./citus/src/backend/distributed/deparser/objectaddress.c" 3 4
                                                             _Bool 
# 71 "//./citus/src/backend/distributed/deparser/objectaddress.c"
                                                                  isPostprocess)
{
 ...
 if (!missing_ok && extensionoid == ((Oid) 0))
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 83 "//./citus/src/backend/distributed/deparser/objectaddress.c" 3 4
 ((void *)0)
# 83 "//./citus/src/backend/distributed/deparser/objectaddress.c"
 ) : errstart(21, 
# 83 "//./citus/src/backend/distributed/deparser/objectaddress.c" 3 4
 ((void *)0)
# 83 "//./citus/src/backend/distributed/deparser/objectaddress.c"
 )) (errcode((((('4') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('7') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('4') - '0') & 0x3F) << 24))), errmsg("extension \"%s\" does not exist", extensionName)), errfinish("//./citus/src/backend/distributed/deparser/objectaddress.c", 83, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)

                          ;
 }

 do { (*address).classId = (3079); (*address).objectId = (extensionoid); (*address).objectSubId = (0); } while (0);

 return list_make1_impl(T_List, ((ListCell) {.ptr_value = (address)}));
}
