# 0 "//./citus/src/backend/distributed/deparser/qualify_role_stmt.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/deparser/qualify_role_stmt.c"
# 18 "//./citus/src/backend/distributed/deparser/qualify_role_stmt.c"
...
# 19 "//./citus/src/backend/distributed/deparser/qualify_role_stmt.c" 2

# 1 "//./citus/src/include/distributed/deparser.h" 1
# 18 "//./citus/src/include/distributed/deparser.h"
...
# 19 "//./citus/src/include/distributed/deparser.h" 2
...
# 21 "//./citus/src/backend/distributed/deparser/qualify_role_stmt.c" 2
...
# 23 "//./citus/src/backend/distributed/deparser/qualify_role_stmt.c" 2
...
# 52 "//./citus/src/backend/distributed/deparser/qualify_role_stmt.c"
static void
QualifyVarSetCurrent(VariableSetStmt *setStmt)
{
 char *configurationName = setStmt->name;
 char *configValue = GetConfigOptionByName(configurationName, 
# 56 "//./citus/src/backend/distributed/deparser/qualify_role_stmt.c" 3 4
                                                             ((void *)0)
# 56 "//./citus/src/backend/distributed/deparser/qualify_role_stmt.c"
                                                                 , 
# 56 "//./citus/src/backend/distributed/deparser/qualify_role_stmt.c" 3 4
                                                                   0
# 56 "//./citus/src/backend/distributed/deparser/qualify_role_stmt.c"
 ...
 setStmt->args = list_make1_impl(T_List, ((ListCell) {.ptr_value = (MakeSetStatementArguments(configurationName, configValue))}));
}
