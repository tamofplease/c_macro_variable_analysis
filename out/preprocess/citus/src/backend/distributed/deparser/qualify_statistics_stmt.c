# 0 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
# 15 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
...
# 16 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 2
...
# 18 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 2
# 1 "/usr/include/postgresql/14/server/catalog/pg_statistic_ext.h" 1
# 25 "/usr/include/postgresql/14/server/catalog/pg_statistic_ext.h"
# 1 "/usr/include/postgresql/14/server/catalog/genbki.h" 1
# 26 "/usr/include/postgresql/14/server/catalog/pg_statistic_ext.h" 2
# 1 "/usr/include/postgresql/14/server/catalog/pg_statistic_ext_d.h" 1
# 27 "/usr/include/postgresql/14/server/catalog/pg_statistic_ext.h" 2
...
typedef struct FormData_pg_statistic_ext
{
 ...
 int2vector stxkeys ;
# 62 "/usr/include/postgresql/14/server/catalog/pg_statistic_ext.h"
...
extern int no_such_variable;
# 19 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 2
...
# 758 "//./citus/src/include/distributed/commands.h"
             autoConverted);
# 20 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 2
...
# 21 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 2
...
# 22 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 2
...
# 25 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 2
...
# 26 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 2
...
{
 CreateStatsStmt *stmt = ((CreateStatsStmt *) (node));

 RangeVar *relation = (RangeVar *) ((list_nth_cell(stmt->relations, 0))->ptr_value);

 if (relation->schemaname == 
# 38 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 3 4
                            ((void *)0)
# 38 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
                                )
 {
 ...
 if (stat->schemaname == 
# 53 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 3 4
                        ((void *)0)
# 53 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
                            )
 {
...
{
 DropStmt *dropStatisticsStmt = ((DropStmt *) (node));
 ((void)
# 71 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 3 4
1
# 71 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
);

 List *objectNameListWithSchema = ((List *) 
# 73 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 3 4
                                 ((void *)0)
# 73 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
                                 );
 List *objectNameList = 
# 74 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 3 4
                       ((void *)0)
# 74 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
                           ;
 for (ListCell *(objectNameListCellDoNotUse) = list_head(dropStatisticsStmt->objects); (objectNameListCellDoNotUse) != 
# 75 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 3 4
((void *)0) 
# 75 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
&& (((objectNameList) = ((objectNameListCellDoNotUse)->ptr_value)) || 
# 75 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 3 4
1
# 75 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
); objectNameListCellDoNotUse = lnext(dropStatisticsStmt->objects, objectNameListCellDoNotUse))
 {
  RangeVar *stat = makeRangeVarFromNameList(objectNameList);

  if (stat->schemaname == 
# 79 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 3 4
                         ((void *)0)
# 79 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
                             )
  {
   ...
   if (((
# 84 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 3 4
      _Bool
# 84 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
      ) ((statsOid) != ((Oid) 0))))
   {
...
{
 RenameStmt *renameStmt = ((RenameStmt *) (node));
 ((void)
# 107 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 3 4
1
# 107 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
);
 ...
 if (list_length(nameList) == 1)
 {
  ...
  if (!((
# 115 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 3 4
      _Bool
# 115 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
      ) ((statsOid) != ((Oid) 0))))
  {
   return;
  }
...
QualifyAlterStatisticsSchemaStmt(Node *node)
{
 ...
 ((void)
# 135 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 3 4
1
# 135 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
);
 ...
 if (list_length(nameList) == 1)
 {
  ...
  if (!((
# 143 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 3 4
      _Bool
# 143 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
      ) ((statsOid) != ((Oid) 0))))
  {
   return;
  }
...
{
 AlterStatsStmt *stmt = ((AlterStatsStmt *) (node));
 ...
 if (list_length(stmt->defnames) == 1)
 {
  ...
  if (!((
# 169 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 3 4
      _Bool
# 169 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
      ) ((statsOid) != ((Oid) 0))))
  {
   return;
  }
...
QualifyAlterStatisticsOwnerStmt(Node *node)
{
 ...
 ((void)
# 189 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 3 4
1
# 189 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
);
 ...
 {
  RangeVar *stat = makeRangeVarFromNameList(nameList);
  Oid statsOid = get_statistics_object_oid(nameList, 
# 195 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 3 4
                                                                     1
# 195 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
                                                                         );

  if (!((
# 197 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 3 4
      _Bool
# 197 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
      ) ((statsOid) != ((Oid) 0))))
  {
   return;
  }
...
{
 HeapTuple heapTuple = SearchSysCache1(STATEXTOID, ((Datum) (statsOid)));
 if (!((const void*)(heapTuple) != 
# 218 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 3 4
     ((void *)0)
# 218 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
     ))
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 220 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 3 4
 ((void *)0)
# 220 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
 ) : errstart(21, 
# 220 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c" 3 4
 ((void *)0)
# 220 "//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c"
 )) (errmsg("cache lookup failed for statistics " "object with oid %u", statsOid)), errfinish("//./citus/src/backend/distributed/deparser/qualify_statistics_stmt.c", 220, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
                                           ;
 }
 FormData_pg_statistic_ext *statisticsForm =
  (FormData_pg_statistic_ext *) ((char *) ((heapTuple)->t_data) + (heapTuple)->t_data->t_hoff);
