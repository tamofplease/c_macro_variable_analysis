# 0 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
# 13 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
...
# 14 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 2
...
# 16 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 2
...
# 17 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 2
# 1 "//./citus/src/include/distributed/deparser.h" 1
# 21 "//./citus/src/include/distributed/deparser.h"
...
# 22 "//./citus/src/include/distributed/deparser.h" 2
...
# 18 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 2
...
# 19 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 2
...
# 23 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 2
...
{
 DefElem *defElement = 
# 41 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 3 4
                      ((void *)0)
# 41 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
                          ;
 for (ListCell *(defElementCellDoNotUse) = list_head(extensionOptions); (defElementCellDoNotUse) != 
# 42 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 3 4
((void *)0) 
# 42 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
&& (((defElement) = ((defElementCellDoNotUse)->ptr_value)) || 
# 42 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 3 4
1
# 42 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
); defElementCellDoNotUse = lnext(extensionOptions, defElementCellDoNotUse))
 {
  if (((((const Node*)(defElement))->type) == T_DefElem) &&
   strncmp(defElement->defname, defname, 64) == 0)
  {
   return defElement;
  }
 }
 ...
 return 
# 51 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 3 4
       ((void *)0)
# 51 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
           ;
}
...
# 103 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
static void
AppendCreateExtensionStmtOptions(StringInfo buf, List *options)
{
 ...
 DefElem *defElem = 
# 113 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 3 4
                   ((void *)0)
# 113 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
                       ;
 for (ListCell *(defElemCellDoNotUse) = list_head(options); (defElemCellDoNotUse) != 
# 114 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 3 4
((void *)0) 
# 114 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
&& (((defElem) = ((defElemCellDoNotUse)->ptr_value)) || 
# 114 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 3 4
1
# 114 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
); defElemCellDoNotUse = lnext(options, defElemCellDoNotUse))
 {
...
# 133 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 3 4
  _Bool 
# 133 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
       cascade = defGetBoolean(defElem);
   if (cascade)
   {
...
# 141 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 3 4
  ((void *)0)
# 141 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
  ) : errstart(21, 
# 141 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 3 4
  ((void *)0)
# 141 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
  )) errmsg_internal("unrecognized option: %s", defElem->defname), errfinish("//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c", 141, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
  }
 }
}
...
AppendAlterExtensionStmt(StringInfo buf, AlterExtensionStmt *alterExtensionStmt)
{
 ...
 DefElem *option = 
# 182 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 3 4
                  ((void *)0)
# 182 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
                      ;
 for (ListCell *(optionCellDoNotUse) = list_head(optionsList); (optionCellDoNotUse) != 
# 183 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 3 4
((void *)0) 
# 183 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
&& (((option) = ((optionCellDoNotUse)->ptr_value)) || 
# 183 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 3 4
1
# 183 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
); optionCellDoNotUse = lnext(optionsList, optionCellDoNotUse))
 {
  ...
  {
   do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 192 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 3 4
  ((void *)0)
# 192 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
  ) : errstart(21, 
# 192 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 3 4
  ((void *)0)
# 192 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
  )) errmsg_internal("unrecognized option: %s", option->defname), errfinish("//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c", 192, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
  }
 }
...
{
 ListCell *objectCell = 
# 251 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 3 4
                       ((void *)0)
# 251 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
                           ;

 for (ForEachState objectCell__state = {(objects), 0}; (objectCell__state.l != ((List *) 
# 253 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 3 4
((void *)0)
# 253 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
) && objectCell__state.i < objectCell__state.l->length) ? (objectCell = &objectCell__state.l->elements[objectCell__state.i], 
# 253 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 3 4
1
# 253 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
) : (objectCell = 
...
# 253 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
 ...
 {
  const char *extensionName = (((Value *)(((objectCell)->ptr_value)))->val.str);
  extensionName = quote_identifier(extensionName);
...
DeparseAlterExtensionSchemaStmt(Node *node)
{
 ...
 ((void)
# 279 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 3 4
1
# 279 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
);
...
{
 ((void)
# 295 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c" 3 4
1
# 295 "//./citus/src/backend/distributed/deparser/deparse_extension_stmts.c"
);

 const char *extensionName = (((Value *)(alterExtensionSchemaStmt->object))->val.str);
