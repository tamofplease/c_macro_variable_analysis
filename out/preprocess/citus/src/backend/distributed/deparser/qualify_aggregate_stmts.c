# 0 "//./citus/src/backend/distributed/deparser/qualify_aggregate_stmts.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/deparser/qualify_aggregate_stmts.c"
# 15 "//./citus/src/backend/distributed/deparser/qualify_aggregate_stmts.c"
...
# 16 "//./citus/src/backend/distributed/deparser/qualify_aggregate_stmts.c" 2
...
# 18 "//./citus/src/backend/distributed/deparser/qualify_aggregate_stmts.c" 2
...
# 19 "//./citus/src/backend/distributed/deparser/qualify_aggregate_stmts.c" 2
...
# 20 "//./citus/src/backend/distributed/deparser/qualify_aggregate_stmts.c" 2
...
# 21 "//./citus/src/backend/distributed/deparser/qualify_aggregate_stmts.c" 2
...
QualifyDefineAggregateStmt(Node *node)
{
 ...
 {
  char *objname = 
# 29 "//./citus/src/backend/distributed/deparser/qualify_aggregate_stmts.c" 3 4
                 ((void *)0)
# 29 "//./citus/src/backend/distributed/deparser/qualify_aggregate_stmts.c"
                     ;
  Oid creationSchema = QualifiedNameGetCreationNamespace(stmt->defnames, &objname);
  stmt->defnames = list_make2_impl(T_List, ((ListCell) {.ptr_value = (makeString(get_namespace_name(creationSchema)))}), ((ListCell) {.ptr_value = (((list_nth_cell(stmt->defnames, 0))->ptr_value))}))
                                  ;
 }
}
