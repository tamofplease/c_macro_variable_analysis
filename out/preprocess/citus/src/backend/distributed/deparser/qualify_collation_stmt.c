# 0 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c"
# 15 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c"
...
# 16 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c" 2
...
# 18 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c" 2
...
# 19 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c" 2
...
# 82 "/usr/include/postgresql/14/server/catalog/pg_collation.h"
           quiet);
# 20 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c" 2
...
# 21 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c" 2
...
# 22 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c" 2
...
# 24 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c" 2
...
# 25 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c" 2
...
QualifyRenameCollationStmt(Node *node)
{
 ...
 ((void)
# 38 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c" 3 4
1
# 38 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c"
);

 stmt->object = QualifyCollationName(((List *) (stmt->object)));
}
...
QualifyAlterCollationSchemaStmt(Node *node)
{
 ...
 ((void)
# 53 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c" 3 4
1
# 53 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c"
);
...
QualifyAlterCollationOwnerStmt(Node *node)
{
 ...
 ((void)
# 68 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c" 3 4
1
# 68 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c"
);
...
QualifyDropCollationStmt(Node *node)
{
 ...
 List *names = ((List *) 
# 83 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c" 3 4
              ((void *)0)
# 83 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c"
              );
 List *name = ((List *) 
# 84 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c" 3 4
             ((void *)0)
# 84 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c"
             );

 for (ListCell *(nameCellDoNotUse) = list_head(stmt->objects); (nameCellDoNotUse) != 
# 86 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c" 3 4
((void *)0) 
# 86 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c"
&& (((name) = ((nameCellDoNotUse)->ptr_value)) || 
# 86 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c" 3 4
1
# 86 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c"
); nameCellDoNotUse = lnext(stmt->objects, nameCellDoNotUse))
 {
...
{
 char *collationName = 
# 101 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c" 3 4
                      ((void *)0)
# 101 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c"
                          ;
 char *schemaName = 
# 102 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c" 3 4
                   ((void *)0)
# 102 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c"
                       ;
 ...
 if (schemaName == 
# 108 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c" 3 4
                  ((void *)0)
# 108 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c"
                      )
 {
  Oid collid = get_collation_oid(name, 
# 110 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c" 3 4
                                      1
# 110 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c"
                                          );
  ...
  if (!((const void*)(colltup) != 
# 119 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c" 3 4
      ((void *)0)
# 119 "//./citus/src/backend/distributed/deparser/qualify_collation_stmt.c"
      ))
  {
   return (Node *) name;
  }
  Form_pg_collation collationForm =
   (Form_pg_collation) ((char *) ((colltup)->t_data) + (colltup)->t_data->t_hoff);

  schemaName = get_namespace_name(collationForm->collnamespace);
  name = list_make2_impl(T_List, ((ListCell) {.ptr_value = (makeString(schemaName))}), ((ListCell) {.ptr_value = (makeString(collationName))}));
