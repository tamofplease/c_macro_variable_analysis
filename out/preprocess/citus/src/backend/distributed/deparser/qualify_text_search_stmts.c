# 0 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
# 18 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
...
# 19 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 2
...
# 21 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 2
...
# 22 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 2
# 1 "/usr/include/postgresql/14/server/catalog/pg_ts_config.h" 1
# 23 "/usr/include/postgresql/14/server/catalog/pg_ts_config.h"
# 1 "/usr/include/postgresql/14/server/catalog/pg_ts_config_d.h" 1
# 24 "/usr/include/postgresql/14/server/catalog/pg_ts_config.h" 2
...
extern int no_such_variable;
# 23 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 2
# 1 "/usr/include/postgresql/14/server/catalog/pg_ts_dict.h" 1
# 22 "/usr/include/postgresql/14/server/catalog/pg_ts_dict.h"
# 1 "/usr/include/postgresql/14/server/catalog/pg_ts_dict_d.h" 1
# 23 "/usr/include/postgresql/14/server/catalog/pg_ts_dict.h" 2
...
extern int no_such_variable;
# 24 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 2
...
# 25 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 2
...
# 26 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 2
...
# 28 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 2
...
# 29 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 2

static Oid get_ts_config_namespace(Oid tsconfigOid);
static Oid get_ts_dict_namespace(Oid tsdictOid);
# 40 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
void
QualifyDropTextSearchConfigurationStmt(Node *node)
{
 DropStmt *stmt = ((DropStmt *) (node));
 ((void)
# 44 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
1
# 44 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
);

 List *qualifiedObjects = ((List *) 
# 46 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                         ((void *)0)
# 46 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                         );
 List *objName = ((List *) 
# 47 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                ((void *)0)
# 47 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                );

 for (ListCell *(objNameCellDoNotUse) = list_head(stmt->objects); (objNameCellDoNotUse) != 
# 49 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
((void *)0) 
# 49 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
&& (((objName) = ((objNameCellDoNotUse)->ptr_value)) || 
# 49 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
1
# 49 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
); objNameCellDoNotUse = lnext(stmt->objects, objNameCellDoNotUse))
 {
  char *schemaName = 
# 51 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                    ((void *)0)
# 51 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                        ;
  char *tsconfigName = 
# 52 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                      ((void *)0)
# 52 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                          ;
  ...
  if (!schemaName)
  {
   ...
   if (((
# 58 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
      _Bool
# 58 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
      ) ((tsconfigOid) != ((Oid) 0))))
   {
    Oid namespaceOid = get_ts_config_namespace(tsconfigOid);
    schemaName = get_namespace_name(namespaceOid);

    objName = list_make2_impl(T_List, ((ListCell) {.ptr_value = (makeString(schemaName))}), ((ListCell) {.ptr_value = (makeString(tsconfigName))}))
                                   ;
   }
  }
...
# 81 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
void
QualifyDropTextSearchDictionaryStmt(Node *node)
{
 DropStmt *stmt = ((DropStmt *) (node));
 ((void)
# 85 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
1
# 85 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
);

 List *qualifiedObjects = ((List *) 
# 87 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                         ((void *)0)
# 87 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                         );
 List *objName = ((List *) 
# 88 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                ((void *)0)
# 88 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                );

 for (ListCell *(objNameCellDoNotUse) = list_head(stmt->objects); (objNameCellDoNotUse) != 
# 90 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
((void *)0) 
# 90 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
&& (((objName) = ((objNameCellDoNotUse)->ptr_value)) || 
# 90 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
1
# 90 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
 ...
 {
  char *schemaName = 
# 92 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                    ((void *)0)
# 92 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                        ;
  char *tsdictName = 
# 93 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                    ((void *)0)
# 93 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                        ;
  ...
  if (!schemaName)
  {
   ...
   if (((
# 99 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
      _Bool
# 99 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
      ) ((tsdictOid) != ((Oid) 0))))
   {
    Oid namespaceOid = get_ts_dict_namespace(tsdictOid);
    schemaName = get_namespace_name(namespaceOid);

    objName = list_make2_impl(T_List, ((ListCell) {.ptr_value = (makeString(schemaName))}), ((ListCell) {.ptr_value = (makeString(tsdictName))}))
                                 ;
   }
  }
...
QualifyAlterTextSearchConfigurationStmt(Node *node)
{
 ...
 char *schemaName = 
# 125 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                   ((void *)0)
# 125 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                       ;
 char *objName = 
# 126 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                ((void *)0)
# 126 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                    ;
 ...
 if (!schemaName)
 {
  Oid tsconfigOid = get_ts_config_oid(stmt->cfgname, 
# 132 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                                                    0
# 132 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                                                         );
  Oid namespaceOid = get_ts_config_namespace(tsconfigOid);
  schemaName = get_namespace_name(namespaceOid);

  stmt->cfgname = list_make2_impl(T_List, ((ListCell) {.ptr_value = (makeString(schemaName))}), ((ListCell) {.ptr_value = (makeString(objName))}))
                               ;
 }


 
# 141 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
_Bool 
# 141 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
     useNewDicts = 
# 141 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                   0
# 141 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                        ;
 List *dicts = 
# 142 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
              ((void *)0)
# 142 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                  ;
 List *dictName = ((List *) 
# 143 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                 ((void *)0)
# 143 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                 );
 for (ListCell *(dictNameCellDoNotUse) = list_head(stmt->dicts); (dictNameCellDoNotUse) != 
# 144 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
((void *)0) 
# 144 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
&& (((dictName) = ((dictNameCellDoNotUse)->ptr_value)) || 
# 144 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
1
# 144 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
); dictNameCellDoNotUse = lnext(stmt->dicts, dictNameCellDoNotUse))
 {
  ...
  if (!schemaName)
  {
   Oid dictOid = get_ts_dict_oid(dictName, 
# 151 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                                          0
# 151 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                                               );
   Oid namespaceOid = get_ts_dict_namespace(dictOid);
   schemaName = get_namespace_name(namespaceOid);

   useNewDicts = 
# 155 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                1
# 155 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                    ;
   dictName = list_make2_impl(T_List, ((ListCell) {.ptr_value = (makeString(schemaName))}), ((ListCell) {.ptr_value = (makeString(objName))}));
  }
...
QualifyAlterTextSearchDictionaryStmt(Node *node)
{
 ...
 char *schemaName = 
# 184 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                   ((void *)0)
# 184 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                       ;
 char *objName = 
# 185 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                ((void *)0)
# 185 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                    ;
 ...
 if (!schemaName)
 {
  Oid tsdictOid = get_ts_dict_oid(stmt->dictname, 
# 191 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                                                 0
# 191 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                                                      );
  Oid namespaceOid = get_ts_dict_namespace(tsdictOid);
  schemaName = get_namespace_name(namespaceOid);

  stmt->dictname = list_make2_impl(T_List, ((ListCell) {.ptr_value = (makeString(schemaName))}), ((ListCell) {.ptr_value = (makeString(objName))}))
                             ;
 }
}
...
QualifyRenameTextSearchConfigurationStmt(Node *node)
{
 ...
 ((void)
# 210 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
1
# 210 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
);

 char *schemaName = 
# 212 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                   ((void *)0)
# 212 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                       ;
 char *objName = 
# 213 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                ((void *)0)
# 213 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                    ;
 DeconstructQualifiedName(((List *) (stmt->object)), &schemaName, &objName);


 if (!schemaName)
 {
  Oid tsconfigOid = get_ts_config_oid(((List *) (stmt->object)), 
# 219 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                                                                   0
# 219 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                                                                        );
  Oid namespaceOid = get_ts_config_namespace(tsconfigOid);
  schemaName = get_namespace_name(namespaceOid);

  stmt->object = (Node *) list_make2_impl(T_List, ((ListCell) {.ptr_value = (makeString(schemaName))}), ((ListCell) {.ptr_value = (makeString(objName))}))
                                 ;
 }
}
...
QualifyRenameTextSearchDictionaryStmt(Node *node)
{
 RenameStmt *stmt = ((RenameStmt *) (node));
 ((void)
# 238 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
1
# 238 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
);

 char *schemaName = 
# 240 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                   ((void *)0)
# 240 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                       ;
 char *objName = 
# 241 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                ((void *)0)
# 241 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                    ;
 DeconstructQualifiedName(((List *) (stmt->object)), &schemaName, &objName);
 ...
 if (!schemaName)
 {
  Oid tsdictOid = get_ts_dict_oid(((List *) (stmt->object)), 
# 247 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                                                               0
# 247 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                                                                    );
  Oid namespaceOid = get_ts_dict_namespace(tsdictOid);
  schemaName = get_namespace_name(namespaceOid);
...
QualifyAlterTextSearchConfigurationSchemaStmt(Node *node)
{
 ...
 ((void)
# 265 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
1
# 265 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
);

 char *schemaName = 
# 267 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                   ((void *)0)
# 267 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                       ;
 char *objName = 
# 268 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                ((void *)0)
# 268 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                    ;
 DeconstructQualifiedName(((List *) (stmt->object)), &schemaName, &objName);
 ...
 {
  Oid tsconfigOid = get_ts_config_oid(((List *) (stmt->object)), 
# 273 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                                                                   0
# 273 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                                                                        );
  Oid namespaceOid = get_ts_config_namespace(tsconfigOid);
  schemaName = get_namespace_name(namespaceOid);
...
QualifyAlterTextSearchDictionarySchemaStmt(Node *node)
{
 AlterObjectSchemaStmt *stmt = ((AlterObjectSchemaStmt *) (node));
 ((void)
# 291 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
1
# 291 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
);

 char *schemaName = 
# 293 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                   ((void *)0)
# 293 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                       ;
 char *objName = 
# 294 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                ((void *)0)
# 294 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                    ;
 DeconstructQualifiedName(((List *) (stmt->object)), &schemaName, &objName);
 ...
 {
  Oid tsdictOid = get_ts_dict_oid(((List *) (stmt->object)), 
# 299 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                                                               0
# 299 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                                                                    );
  Oid namespaceOid = get_ts_dict_namespace(tsdictOid);
  schemaName = get_namespace_name(namespaceOid);
...
QualifyTextSearchConfigurationCommentStmt(Node *node)
{
 ...
 ((void)
# 317 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
1
# 317 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
);

 char *schemaName = 
# 319 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                   ((void *)0)
# 319 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                       ;
 char *objName = 
# 320 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                ((void *)0)
# 320 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                    ;
 DeconstructQualifiedName(((List *) (stmt->object)), &schemaName, &objName);
 ...
 {
  Oid tsconfigOid = get_ts_config_oid(((List *) (stmt->object)), 
# 325 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                                                                   0
# 325 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                                                                        );
  Oid namespaceOid = get_ts_config_namespace(tsconfigOid);
  schemaName = get_namespace_name(namespaceOid);
...
QualifyTextSearchDictionaryCommentStmt(Node *node)
{
 CommentStmt *stmt = ((CommentStmt *) (node));
 ((void)
# 343 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
1
# 343 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
);

 char *schemaName = 
# 345 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                   ((void *)0)
# 345 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                       ;
 char *objName = 
# 346 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                ((void *)0)
# 346 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                    ;
 DeconstructQualifiedName(((List *) (stmt->object)), &schemaName, &objName);
 ...
 {
  Oid tsdictOid = get_ts_dict_oid(((List *) (stmt->object)), 
# 351 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                                                               0
# 351 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                                                                    );
  Oid namespaceOid = get_ts_dict_namespace(tsdictOid);
  schemaName = get_namespace_name(namespaceOid);
...
QualifyAlterTextSearchConfigurationOwnerStmt(Node *node)
{
 ...
 ((void)
# 369 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
1
# 369 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
);

 char *schemaName = 
# 371 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                   ((void *)0)
# 371 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                       ;
 char *objName = 
# 372 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                ((void *)0)
# 372 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                    ;
 DeconstructQualifiedName(((List *) (stmt->object)), &schemaName, &objName);
 ...
 {
  Oid tsconfigOid = get_ts_config_oid(((List *) (stmt->object)), 
# 377 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                                                                   0
# 377 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                                                                        );
  Oid namespaceOid = get_ts_config_namespace(tsconfigOid);
  schemaName = get_namespace_name(namespaceOid);
...
QualifyAlterTextSearchDictionaryOwnerStmt(Node *node)
{
 AlterOwnerStmt *stmt = ((AlterOwnerStmt *) (node));
 ((void)
# 395 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
1
# 395 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
);

 char *schemaName = 
# 397 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                   ((void *)0)
# 397 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                       ;
 char *objName = 
# 398 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                ((void *)0)
# 398 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                    ;
 DeconstructQualifiedName(((List *) (stmt->object)), &schemaName, &objName);
 ...
 {
  Oid tsdictOid = get_ts_dict_oid(((List *) (stmt->object)), 
# 403 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
                                                               0
# 403 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
                                                                    );
  Oid namespaceOid = get_ts_dict_namespace(tsdictOid);
  schemaName = get_namespace_name(namespaceOid);
...
{
 HeapTuple tup = SearchSysCache1(TSCONFIGOID, ((Datum) (tsconfigOid)));

 if (((const void*)(tup) != 
# 422 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
    ((void *)0)
# 422 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
    ))
 {
  Form_pg_ts_config cfgform = (Form_pg_ts_config) ((char *) ((tup)->t_data) + (tup)->t_data->t_hoff);
...
{
 HeapTuple tup = SearchSysCache1(TSDICTOID, ((Datum) (tsdictOid)));

 if (((const void*)(tup) != 
# 444 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c" 3 4
    ((void *)0)
# 444 "//./citus/src/backend/distributed/deparser/qualify_text_search_stmts.c"
    ))
 {
  Form_pg_ts_dict cfgform = (Form_pg_ts_dict) ((char *) ((tup)->t_data) + (tup)->t_data->t_hoff);
