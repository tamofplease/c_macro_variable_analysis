# 0 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c"
# 12 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c"
...
# 13 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c" 2
...
# 15 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c" 2
...
# 16 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c" 2
...
# 17 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c" 2
...
# 19 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c" 2
...
# 20 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c" 2
...
QualifyDropViewStmt(Node *node)
{
 ...
 List *qualifiedViewNames = ((List *) 
# 30 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c" 3 4
                           ((void *)0)
# 30 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c"
                           );

 List *possiblyQualifiedViewName = 
# 32 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c" 3 4
                                  ((void *)0)
# 32 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c"
                                      ;
 for (ListCell *(possiblyQualifiedViewNameCellDoNotUse) = list_head(stmt->objects); (possiblyQualifiedViewNameCellDoNotUse) != 
# 33 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c" 3 4
((void *)0) 
# 33 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c"
&& (((possiblyQualifiedViewName) = ((possiblyQualifiedViewNameCellDoNotUse)->ptr_value)) || 
# 33 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c" 3 4
1
# 33 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c"
); possiblyQualifiedViewNameCellDoNotUse = lnext(stmt->objects, possiblyQualifiedViewNameCellDoNotUse))
 {
  char *viewName = 
# 35 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c" 3 4
                  ((void *)0)
# 35 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c"
                      ;
  char *schemaName = 
# 36 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c" 3 4
                    ((void *)0)
# 36 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c"
                        ;
  List *viewNameToAdd = possiblyQualifiedViewName;
  DeconstructQualifiedName(possiblyQualifiedViewName, &schemaName, &viewName);

  if (schemaName == 
# 40 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c" 3 4
                   ((void *)0)
# 40 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c"
                       )
  {
   RangeVar *viewRangeVar = makeRangeVarFromNameList(possiblyQualifiedViewName);
   Oid viewOid = RangeVarGetRelidExtended(viewRangeVar, 8, (stmt->missing_ok) ? RVR_MISSING_OK : 0, 
# 43 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c" 3 4
                ((void *)0)
# 43 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c"
                , 
# 43 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c" 3 4
                ((void *)0)
# 43 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c"
   ...
   if (((
# 50 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c" 3 4
      _Bool
# 50 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c"
      ) ((viewOid) != ((Oid) 0))))
   {
    Oid schemaOid = get_rel_namespace(viewOid);
    schemaName = get_namespace_name(schemaOid);

    List *qualifiedViewName = list_make2_impl(T_List, ((ListCell) {.ptr_value = (makeString(schemaName))}), ((ListCell) {.ptr_value = (makeString(viewName))}))
                                   ;
...
{
 if (view->schemaname == 
# 110 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c" 3 4
                        ((void *)0)
# 110 "//./citus/src/backend/distributed/deparser/qualify_view_stmt.c"
                            )
 {
