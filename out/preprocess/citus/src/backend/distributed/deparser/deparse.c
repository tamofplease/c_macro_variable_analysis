# 0 "//./citus/src/backend/distributed/deparser/deparse.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/deparser/deparse.c"
# 16 "//./citus/src/backend/distributed/deparser/deparse.c"
...
# 17 "//./citus/src/backend/distributed/deparser/deparse.c" 2
...
# 758 "//./citus/src/include/distributed/commands.h"
             autoConverted);
# 19 "//./citus/src/backend/distributed/deparser/deparse.c" 2
...
# 20 "//./citus/src/backend/distributed/deparser/deparse.c" 2
...
# 21 "//./citus/src/backend/distributed/deparser/deparse.c" 2
...
# 34 "//./citus/src/backend/distributed/deparser/deparse.c" 3 4
 ((void *)0)
# 34 "//./citus/src/backend/distributed/deparser/deparse.c"
 ) : errstart(21, 
# 34 "//./citus/src/backend/distributed/deparser/deparse.c" 3 4
 ((void *)0)
# 34 "//./citus/src/backend/distributed/deparser/deparse.c"
 )) (errmsg("unsupported statement for deparsing")), errfinish("//./citus/src/backend/distributed/deparser/deparse.c", 34, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
 }
...
{
 List *sqls = ((List *) 
# 48 "//./citus/src/backend/distributed/deparser/deparse.c" 3 4
             ((void *)0)
# 48 "//./citus/src/backend/distributed/deparser/deparse.c"
             );
 Node *stmt = 
# 49 "//./citus/src/backend/distributed/deparser/deparse.c" 3 4
             ((void *)0)
# 49 "//./citus/src/backend/distributed/deparser/deparse.c"
                 ;
 for (ListCell *(stmtCellDoNotUse) = list_head(stmts); (stmtCellDoNotUse) != 
# 50 "//./citus/src/backend/distributed/deparser/deparse.c" 3 4
((void *)0) 
# 50 "//./citus/src/backend/distributed/deparser/deparse.c"
&& (((stmt) = ((stmtCellDoNotUse)->ptr_value)) || 
# 50 "//./citus/src/backend/distributed/deparser/deparse.c" 3 4
1
# 50 "//./citus/src/backend/distributed/deparser/deparse.c"
); stmtCellDoNotUse = lnext(stmts, stmtCellDoNotUse))
 {
