# 0 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c"
# 12 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c"
...
# 13 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c" 2
...
# 346 "/usr/include/postgresql/14/server/funcapi.h"
                           **nulls);
# 14 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c" 2
...
# 15 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c" 2



extern Datum worker_cleanup_job_schema_cache(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_worker_cleanup_job_schema_cache(void); const Pg_finfo_record * pg_finfo_worker_cleanup_job_schema_cache (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum worker_create_schema(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_worker_create_schema(void); const Pg_finfo_record * pg_finfo_worker_create_schema (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum worker_fetch_foreign_file(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_worker_fetch_foreign_file(void); const Pg_finfo_record * pg_finfo_worker_fetch_foreign_file (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum worker_fetch_partition_file(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_worker_fetch_partition_file(void); const Pg_finfo_record * pg_finfo_worker_fetch_partition_file (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum worker_hash_partition_table(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_worker_hash_partition_table(void); const Pg_finfo_record * pg_finfo_worker_hash_partition_table (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum worker_merge_files_into_table(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_worker_merge_files_into_table(void); const Pg_finfo_record * pg_finfo_worker_merge_files_into_table (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum worker_merge_files_and_run_query(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_worker_merge_files_and_run_query(void); const Pg_finfo_record * pg_finfo_worker_merge_files_and_run_query (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum worker_range_partition_table(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_worker_range_partition_table(void); const Pg_finfo_record * pg_finfo_worker_range_partition_table (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum worker_repartition_cleanup(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_worker_repartition_cleanup(void); const Pg_finfo_record * pg_finfo_worker_repartition_cleanup (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
...
Datum
worker_range_partition_table(FunctionCallInfo fcinfo)
{
 do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 36 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c" 3 4
((void *)0)
# 36 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c"
) : errstart(21, 
# 36 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c" 3 4
((void *)0)
# 36 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c"
)) (errmsg("this function is deprecated and only kept for testing " "downgrade scripts")), errfinish("//./citus/src/backend/distributed/worker/worker_partition_protocol.c", 36, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
                               ;
}
...
Datum
worker_hash_partition_table(FunctionCallInfo fcinfo)
{
 do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 48 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c" 3 4
((void *)0)
# 48 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c"
) : errstart(21, 
# 48 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c" 3 4
((void *)0)
# 48 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c"
)) (errmsg("this function is deprecated and only kept for testing " "downgrade scripts")), errfinish("//./citus/src/backend/distributed/worker/worker_partition_protocol.c", 48, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
                               ;
}
...
Datum
worker_create_schema(FunctionCallInfo fcinfo)
{
 do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 59 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c" 3 4
((void *)0)
# 59 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c"
) : errstart(21, 
# 59 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c" 3 4
((void *)0)
# 59 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c"
)) (errmsg("this function is deprecated and only kept for testing " "downgrade scripts")), errfinish("//./citus/src/backend/distributed/worker/worker_partition_protocol.c", 59, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
                               ;
}
...
Datum
worker_repartition_cleanup(FunctionCallInfo fcinfo)
{
 do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 70 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c" 3 4
((void *)0)
# 70 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c"
) : errstart(21, 
# 70 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c" 3 4
((void *)0)
# 70 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c"
)) (errmsg("this function is deprecated and only kept for testing " "downgrade scripts")), errfinish("//./citus/src/backend/distributed/worker/worker_partition_protocol.c", 70, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
                               ;
}
...
Datum
worker_merge_files_into_table(FunctionCallInfo fcinfo)
{
 do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 82 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c" 3 4
((void *)0)
# 82 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c"
) : errstart(21, 
# 82 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c" 3 4
((void *)0)
# 82 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c"
)) (errmsg("this function is deprecated and only kept for testing " "downgrade scripts")), errfinish("//./citus/src/backend/distributed/worker/worker_partition_protocol.c", 82, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
                               ;
}
...
Datum
worker_merge_files_and_run_query(FunctionCallInfo fcinfo)
{
 do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 94 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c" 3 4
((void *)0)
# 94 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c"
) : errstart(21, 
# 94 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c" 3 4
((void *)0)
# 94 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c"
)) (errmsg("this function is deprecated and only kept for testing " "downgrade scripts")), errfinish("//./citus/src/backend/distributed/worker/worker_partition_protocol.c", 94, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
                               ;
}
...
Datum
worker_cleanup_job_schema_cache(FunctionCallInfo fcinfo)
{
 do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 106 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c" 3 4
((void *)0)
# 106 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c"
) : errstart(21, 
# 106 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c" 3 4
((void *)0)
# 106 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c"
)) (errmsg("this function is deprecated and only kept for testing " "downgrade scripts")), errfinish("//./citus/src/backend/distributed/worker/worker_partition_protocol.c", 106, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
                               ;
}
...
Datum
worker_fetch_foreign_file(FunctionCallInfo fcinfo)
{
 do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(13) && (13) >= 21 ? errstart_cold(13, 
# 118 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c" 3 4
((void *)0)
# 118 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c"
) : errstart(13, 
# 118 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c" 3 4
((void *)0)
# 118 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c"
)) (errmsg("this function is deprecated and no longer is used")), errfinish("//./citus/src/backend/distributed/worker/worker_partition_protocol.c", 118, __func__); if (__builtin_constant_p(13) && (13) >= 21) __builtin_unreachable(); } while(0);
 return (Datum) 0;
}
...
Datum
worker_fetch_partition_file(FunctionCallInfo fcinfo)
{
 do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 130 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c" 3 4
((void *)0)
# 130 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c"
) : errstart(21, 
# 130 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c" 3 4
((void *)0)
# 130 "//./citus/src/backend/distributed/worker/worker_partition_protocol.c"
)) (errmsg("this function is deprecated and only kept for testing " "downgrade scripts")), errfinish("//./citus/src/backend/distributed/worker/worker_partition_protocol.c", 130, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
                               ;
}
