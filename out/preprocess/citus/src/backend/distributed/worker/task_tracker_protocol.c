# 0 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c"
# 14 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c"
...
# 15 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c" 2
...
# 346 "/usr/include/postgresql/14/server/funcapi.h"
                           **nulls);
# 16 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c" 2
...
# 17 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c" 2



extern Datum task_tracker_assign_task(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_task_tracker_assign_task(void); const Pg_finfo_record * pg_finfo_task_tracker_assign_task (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum task_tracker_task_status(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_task_tracker_task_status(void); const Pg_finfo_record * pg_finfo_task_tracker_task_status (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum task_tracker_cleanup_job(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_task_tracker_cleanup_job(void); const Pg_finfo_record * pg_finfo_task_tracker_cleanup_job (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum task_tracker_conninfo_cache_invalidate(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_task_tracker_conninfo_cache_invalidate(void); const Pg_finfo_record * pg_finfo_task_tracker_conninfo_cache_invalidate (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;



Datum
task_tracker_assign_task(FunctionCallInfo fcinfo)
{
 do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 30 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c" 3 4
((void *)0)
# 30 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c"
) : errstart(21, 
# 30 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c" 3 4
((void *)0)
# 30 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c"
)) (errmsg("This UDF is deprecated.")), errfinish("//./citus/src/backend/distributed/worker/task_tracker_protocol.c", 30, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);

 do { fcinfo->isnull = 
# 32 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c" 3 4
1
# 32 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c"
...
Datum
task_tracker_task_status(FunctionCallInfo fcinfo)
{
 do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 40 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c" 3 4
((void *)0)
# 40 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c"
) : errstart(21, 
# 40 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c" 3 4
((void *)0)
# 40 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c"
)) (errmsg("This UDF is deprecated.")), errfinish("//./citus/src/backend/distributed/worker/task_tracker_protocol.c", 40, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
...
Datum
task_tracker_cleanup_job(FunctionCallInfo fcinfo)
{
 do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 50 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c" 3 4
((void *)0)
# 50 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c"
) : errstart(21, 
# 50 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c" 3 4
((void *)0)
# 50 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c"
)) (errmsg("This UDF is deprecated.")), errfinish("//./citus/src/backend/distributed/worker/task_tracker_protocol.c", 50, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);

 do { fcinfo->isnull = 
# 52 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c" 3 4
1
# 52 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c"
; return (Datum) 0; } while (0);
}
...
Datum
task_tracker_conninfo_cache_invalidate(FunctionCallInfo fcinfo)
{
 return (((Datum) (
# 60 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c" 3 4
((void *)0)
# 60 "//./citus/src/backend/distributed/worker/task_tracker_protocol.c"
)));
}
