# 0 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
# 11 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
...
# 12 "//./citus/src/backend/distributed/connection/worker_log_messages.c" 2
...
# 18 "//./citus/src/include/distributed/transaction_management.h" 2
...
# 24 "//./citus/src/include/distributed/connection_management.h" 2
...
# 25 "//./citus/src/include/distributed/connection_management.h" 2
...
# 14 "//./citus/src/backend/distributed/connection/worker_log_messages.c" 2
# 1 "//./citus/src/include/distributed/error_codes.h" 1
# 15 "//./citus/src/include/distributed/error_codes.h"
# 1 "/usr/include/postgresql/14/server/utils/elog.h" 1
# 16 "//./citus/src/include/distributed/error_codes.h" 2
# 15 "//./citus/src/backend/distributed/connection/worker_log_messages.c" 2
...
# 16 "//./citus/src/backend/distributed/connection/worker_log_messages.c" 2
...
# 17 "//./citus/src/backend/distributed/connection/worker_log_messages.c" 2
# 1 "//./citus/src/include/distributed/worker_log_messages.h" 1
# 19 "//./citus/src/include/distributed/worker_log_messages.h"
...
# 18 "//./citus/src/backend/distributed/connection/worker_log_messages.c" 2
# 26 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
int WorkerMinMessages = 18;
# 36 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
static 
# 36 "//./citus/src/backend/distributed/connection/worker_log_messages.c" 3 4
      _Bool 
# 36 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
           PreserveWorkerMessageLogLevel = 
# 36 "//./citus/src/backend/distributed/connection/worker_log_messages.c" 3 4
                                           0
# 36 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
                                                ;
...
DeferredErrorMessage *WorkerErrorIndication = 
# 44 "//./citus/src/backend/distributed/connection/worker_log_messages.c" 3 4
                                             ((void *)0)
# 44 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
                                                 ;
...
# 55 "//./citus/src/backend/distributed/connection/worker_log_messages.c" 3 4
((void *)0)

# 56 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
};
...
{
 PreserveWorkerMessageLogLevel = 
# 93 "//./citus/src/backend/distributed/connection/worker_log_messages.c" 3 4
                                1
# 93 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
                                    ;
}
...
{
 PreserveWorkerMessageLogLevel = 
# 104 "//./citus/src/backend/distributed/connection/worker_log_messages.c" 3 4
                                0
# 104 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
                                     ;
}
...
DefaultCitusNoticeReceiver(void *arg, const PGresult *result)
{
 ...
 char *levelName = PQresultErrorField(result, 'S');
 int logLevel = LogLevelNameToLogLevel(levelName);
 int sqlState = (((('X') - '0') & 0x3F) + (((('X') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24));
 char *sqlStateString = PQresultErrorField(result, 'C');

 if (sqlStateString != 
# 125 "//./citus/src/backend/distributed/connection/worker_log_messages.c" 3 4
                      ((void *)0)
# 125 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
                          )
 {
  sqlState = ((((sqlStateString[0]) - '0') & 0x3F) + ((((sqlStateString[1]) - '0') & 0x3F) << 6) + ((((sqlStateString[2]) - '0') & 0x3F) << 12) + ((((sqlStateString[3]) - '0') & 0x3F) << 18) + ((((sqlStateString[4]) - '0') & 0x3F) << 24))



                           ;
 }
# 141 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
 if (sqlState == (((('C') - '0') & 0x3F) + (((('I') - '0') & 0x3F) << 6) + (((('I') - '0') & 0x3F) << 12) + (((('N') - '0') & 0x3F) << 18) + (((('F') - '0') & 0x3F) << 24)) && logLevel == 19)
 {
  if (WorkerErrorIndication == 
# 143 "//./citus/src/backend/distributed/connection/worker_log_messages.c" 3 4
                              ((void *)0)
# 143 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
                                  )
  {

   MemoryContext oldContext = MemoryContextSwitchTo(TopTransactionContext);

   WorkerErrorIndication = DeferredErrorInternal(sqlState, pstrdup(trimmedMessage), 
# 148 "//./citus/src/backend/distributed/connection/worker_log_messages.c" 3 4
                          ((void *)0)
# 148 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
                          , 
# 148 "//./citus/src/backend/distributed/connection/worker_log_messages.c" 3 4
                          ((void *)0)
# 148 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
                          , "//./citus/src/backend/distributed/connection/worker_log_messages.c", 148, __func__)
                         ;
 ...
 if (logLevel < WorkerMinMessages || WorkerMinMessages == 0)
 {
 ...
 do { int ereport_loglevel = logLevel; (void) (ereport_loglevel); do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(logLevel) && (logLevel) >= 21 ? errstart_cold(logLevel, 
# 174 "//./citus/src/backend/distributed/connection/worker_log_messages.c" 3 4
((void *)0)
# 174 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
) : errstart(logLevel, 
# 174 "//./citus/src/backend/distributed/connection/worker_log_messages.c" 3 4
((void *)0)
# 174 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
)) (errcode(sqlState), errmsg("%s", trimmedMessage), errdetail("from %s:%d", nodeName, nodePort)), errfinish("//./citus/src/backend/distributed/connection/worker_log_messages.c", 174, __func__); if (__builtin_constant_p(logLevel) && (logLevel) >= 21) __builtin_unreachable(); } while(0); } while (0)


                                                 ;
}
# 189 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
static char *
...
LogLevelNameToLogLevel(char *levelName)
{
 ...
 while (LogLevelNames[levelIndex] != 
# 217 "//./citus/src/backend/distributed/connection/worker_log_messages.c" 3 4
                                    ((void *)0)
# 217 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
                                        )
 {
...
# 239 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
void
ErrorIfWorkerErrorIndicationReceived(void)
{
 if (WorkerErrorIndication != 
# 242 "//./citus/src/backend/distributed/connection/worker_log_messages.c" 3 4
                             ((void *)0)
# 242 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
                                 )
 {
  do { RaiseDeferredErrorInternal(WorkerErrorIndication, 21); if (__builtin_constant_p(21) && (21) >= 21) { __builtin_unreachable(); } } while (0);
 }
}
...
{
 WorkerErrorIndication = 
# 255 "//./citus/src/backend/distributed/connection/worker_log_messages.c" 3 4
                        ((void *)0)
# 255 "//./citus/src/backend/distributed/connection/worker_log_messages.c"
                            ;
}
