# 0 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c" 2
...
extern void invoke_safe_mem_constraint_handler(
                           ...
                           void *ptr,
                           errno_t error);
# 34 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_mem_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c" 2
# 89 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c"
errno_t
            ...
            const uint32_t *src, rsize_t smax, int *diff)
{
    ...
    if (diff == 
# 96 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c" 3 4
               ((void *)0)
# 96 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c"
                   ) {
        invoke_safe_mem_constraint_handler("memcmp32_s: diff is null",
                   
# 98 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c" 3 4
                  ((void *)0)
# 98 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c"
                      , ( 400 ));
        return ((( 400 )));
    }
    *diff = -1;
    ...
    if (dest == 
# 104 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c" 3 4
               ((void *)0)
# 104 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c"
                   ) {
        invoke_safe_mem_constraint_handler("memcmp32_s: dest is null",
                   
# 106 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c" 3 4
                  ((void *)0)
# 106 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c"
                      , ( 400 ));
        return ((( 400 )));
    }

    if (src == 
# 110 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c" 3 4
              ((void *)0)
# 110 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c"
                  ) {
        invoke_safe_mem_constraint_handler("memcmp32_s: src is null",
                   
# 112 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c" 3 4
                  ((void *)0)
# 112 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c"
                      , ( 400 ));
        return ((( 400 )));
    }
...
# 118 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c" 3 4
                  ((void *)0)
# 118 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c"
                      , ( 401 ));
        return ((( 401 )));
    }
...
# 124 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c" 3 4
                  ((void *)0)
# 124 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c"
                      , ( 403 ));
        return ((( 403 )));
    }
...
# 130 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c" 3 4
                  ((void *)0)
# 130 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c"
                      , ( 401 ));
        return ((( 401 )));
    }
...
# 136 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c" 3 4
                 ((void *)0)
# 136 "//./citus/src/backend/distributed/safeclib/memcmp32_s.c"
                     , ( 403 ));
       return ((( 403 )));
    }
