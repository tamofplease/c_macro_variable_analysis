# 0 "//./citus/src/backend/distributed/safeclib/mem_primitives_lib.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/mem_primitives_lib.c"
# 32 "//./citus/src/backend/distributed/safeclib/mem_primitives_lib.c"
# 1 "//./citus/src/backend/distributed/safeclib/mem_primitives_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/mem_primitives_lib.h"
...
# 36 "//./citus/src/backend/distributed/safeclib/mem_primitives_lib.h" 2
...
# 33 "//./citus/src/backend/distributed/safeclib/mem_primitives_lib.c" 2

#pragma GCC diagnostic ignored "-Wpragmas"
#pragma GCC diagnostic ignored "-Wimplicit-fallthrough"
# 69 "//./citus/src/backend/distributed/safeclib/mem_primitives_lib.c"
void
...
# 180 "//./citus/src/backend/distributed/safeclib/mem_primitives_lib.c"
void
...
# 251 "//./citus/src/backend/distributed/safeclib/mem_primitives_lib.c"
void
...
# 323 "//./citus/src/backend/distributed/safeclib/mem_primitives_lib.c"
void
mem_prim_move (void *dest, const void *src, uint32_t len)
{
    ...
    if ((uintptr_t)dp < (uintptr_t)sp) {
        ...
        if ((tsp | (uintptr_t)dp) & (sizeof(uint32_t) - 1)) {



            if ((tsp ^ (uintptr_t)dp) & (sizeof(uint32_t) - 1) || len < sizeof(uint32_t)) {
                tsp = len;

            } else {
                tsp = sizeof(uint32_t) - (tsp & (sizeof(uint32_t) - 1));
            }
...
# 409 "//./citus/src/backend/distributed/safeclib/mem_primitives_lib.c"
        sp += len;
        dp += len;
...
# 496 "//./citus/src/backend/distributed/safeclib/mem_primitives_lib.c"
void
...
# 555 "//./citus/src/backend/distributed/safeclib/mem_primitives_lib.c"
        sp += len;
        dp += len;
...
# 627 "//./citus/src/backend/distributed/safeclib/mem_primitives_lib.c"
void
...
# 685 "//./citus/src/backend/distributed/safeclib/mem_primitives_lib.c"
        sp += len;
        dp += len;
...
# 757 "//./citus/src/backend/distributed/safeclib/mem_primitives_lib.c"
void
...
# 814 "//./citus/src/backend/distributed/safeclib/mem_primitives_lib.c"
        sp += len;
        dp += len;
