# 0 "//./citus/src/backend/distributed/safeclib/snprintf_support.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/snprintf_support.c"
# 31 "//./citus/src/backend/distributed/safeclib/snprintf_support.c"
...
# 32 "//./citus/src/backend/distributed/safeclib/snprintf_support.c" 2
...
# 33 "//./citus/src/backend/distributed/safeclib/snprintf_support.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 34 "//./citus/src/backend/distributed/safeclib/snprintf_support.c" 2
# 1 "//./citus/vendor/safestringlib/include/snprintf_s.h" 1
# 34 "//./citus/vendor/safestringlib/include/snprintf_s.h"
# 1 "//./citus/vendor/safestringlib/include/safe_lib_errno.h" 1
# 35 "//./citus/vendor/safestringlib/include/snprintf_s.h" 2
...
# 35 "//./citus/src/backend/distributed/safeclib/snprintf_support.c" 2
# 57 "//./citus/src/backend/distributed/safeclib/snprintf_support.c"
...
parse_format(const char *format, char pformatList[], unsigned int maxFormats)
{
 ...
 while (index < ( 4UL << 10 ) && format[index] != '\0' && numFormats < maxFormats)
 {
  if (format[index] == '%') {
   start = index;
   ...
   case 'x' : case 'X' :
     if ( lmod == 'H') {
      pformatList[numFormats] = 'c';
       ...
       pformatList[numFormats] = 'l';
     } else if ( lmod == 'h') {
      pformatList[numFormats] = 'h';
     } else{
      pformatList[numFormats] = 'd';
     }
     numFormats++;
     index++;
     break;
   ...
   case 'n' :
     if ( lmod == 'H') {
      pformatList[numFormats] = '1';
     } else if ( lmod == 'l') {
      pformatList[numFormats] = '4';
     } else if ( lmod == 'h') {
      pformatList[numFormats] = '2';
     } else{
      pformatList[numFormats] = '3';
     }
     numFormats++;
     index++;
     break;
...
inline int snprintf_s_i(char *dest, rsize_t dmax, const char *format, int a)
{
 ...
 unsigned int nfo = parse_format(format, &pformatList[0], 16);
