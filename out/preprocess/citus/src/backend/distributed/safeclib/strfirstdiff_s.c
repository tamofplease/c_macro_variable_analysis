# 0 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c" 2
...
# 34 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c" 2
# 90 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c"
 errno_t
 strfirstdiff_s (const char *dest, rsize_t dmax,
                 const char *src, rsize_t *index)
{
    ...
    if (index == 
# 96 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c" 3 4
                ((void *)0)
# 96 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c"
                    ) {
        invoke_safe_str_constraint_handler("strfirstdiff_s: index is null",
                   
# 98 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c" 3 4
                  ((void *)0)
# 98 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
    *index = 0;
    ...
    if (dest == 
# 103 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c" 3 4
               ((void *)0)
# 103 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c"
                   ) {
        invoke_safe_str_constraint_handler("strfirstdiff_s: dest is null",
                   
# 105 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c" 3 4
                  ((void *)0)
# 105 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c"
                      , ( 400 ));
        return (( 400 ));
    }

    if (src == 
# 109 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c" 3 4
              ((void *)0)
# 109 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c"
                  ) {
        invoke_safe_str_constraint_handler("strfirstdiff_s: src is null",
                   
# 111 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c" 3 4
                  ((void *)0)
# 111 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 117 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c" 3 4
                  ((void *)0)
# 117 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 123 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c" 3 4
                  ((void *)0)
# 123 "//./citus/src/backend/distributed/safeclib/strfirstdiff_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
