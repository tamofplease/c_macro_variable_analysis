# 0 "//./citus/src/backend/distributed/safeclib/strisascii_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/strisascii_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/strisascii_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/strisascii_s.c" 2
...
# 34 "//./citus/src/backend/distributed/safeclib/strisascii_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/strisascii_s.c" 2
# 79 "//./citus/src/backend/distributed/safeclib/strisascii_s.c"

# 79 "//./citus/src/backend/distributed/safeclib/strisascii_s.c" 3 4
_Bool

# 80 "//./citus/src/backend/distributed/safeclib/strisascii_s.c"
strisascii_s (const char *dest, rsize_t dmax)
{
    if (!dest) {
        invoke_safe_str_constraint_handler("strisascii_s: dest is null",
                   
# 84 "//./citus/src/backend/distributed/safeclib/strisascii_s.c" 3 4
                  ((void *)0)
# 84 "//./citus/src/backend/distributed/safeclib/strisascii_s.c"
                      , ( 400 ));
        return (
# 85 "//./citus/src/backend/distributed/safeclib/strisascii_s.c" 3 4
               0
# 85 "//./citus/src/backend/distributed/safeclib/strisascii_s.c"
                    );
    }
...
# 90 "//./citus/src/backend/distributed/safeclib/strisascii_s.c" 3 4
                  ((void *)0)
# 90 "//./citus/src/backend/distributed/safeclib/strisascii_s.c"
                      , ( 401 ));
        return (
# 91 "//./citus/src/backend/distributed/safeclib/strisascii_s.c" 3 4
               0
# 91 "//./citus/src/backend/distributed/safeclib/strisascii_s.c"
                    );
    }
...
# 97 "//./citus/src/backend/distributed/safeclib/strisascii_s.c" 3 4
                  ((void *)0)
# 97 "//./citus/src/backend/distributed/safeclib/strisascii_s.c"
                      , ( 403 ));
        return (
# 98 "//./citus/src/backend/distributed/safeclib/strisascii_s.c" 3 4
               0
# 98 "//./citus/src/backend/distributed/safeclib/strisascii_s.c"
                    );
    }
    ...
    while (*dest && dmax) {
        if ((unsigned char)*dest > 127) {
            return (
# 103 "//./citus/src/backend/distributed/safeclib/strisascii_s.c" 3 4
                   0
# 103 "//./citus/src/backend/distributed/safeclib/strisascii_s.c"
                        );
        }
        dest++;
        dmax--;
    ...
    return (
# 109 "//./citus/src/backend/distributed/safeclib/strisascii_s.c" 3 4
           1
# 109 "//./citus/src/backend/distributed/safeclib/strisascii_s.c"
               );
}
