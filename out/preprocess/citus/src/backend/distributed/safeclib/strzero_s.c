# 0 "//./citus/src/backend/distributed/safeclib/strzero_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/strzero_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/strzero_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/strzero_s.c" 2
...
# 34 "//./citus/src/backend/distributed/safeclib/strzero_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/strzero_s.c" 2
# 73 "//./citus/src/backend/distributed/safeclib/strzero_s.c"
errno_t
strzero_s (char *dest, rsize_t dmax)
{
    if (dest == 
# 76 "//./citus/src/backend/distributed/safeclib/strzero_s.c" 3 4
               ((void *)0)
# 76 "//./citus/src/backend/distributed/safeclib/strzero_s.c"
                   ) {
        invoke_safe_str_constraint_handler("strzero_s: dest is null",
                   
# 78 "//./citus/src/backend/distributed/safeclib/strzero_s.c" 3 4
                  ((void *)0)
# 78 "//./citus/src/backend/distributed/safeclib/strzero_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 84 "//./citus/src/backend/distributed/safeclib/strzero_s.c" 3 4
                  ((void *)0)
# 84 "//./citus/src/backend/distributed/safeclib/strzero_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 90 "//./citus/src/backend/distributed/safeclib/strzero_s.c" 3 4
                  ((void *)0)
# 90 "//./citus/src/backend/distributed/safeclib/strzero_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
