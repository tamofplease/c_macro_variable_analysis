# 0 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c" 2
...
# 34 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c" 2
# 77 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c"

# 77 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c" 3 4
_Bool

# 78 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c"
strisdigit_s (const char *dest, rsize_t dmax)
{
    if (!dest) {
        invoke_safe_str_constraint_handler("strisdigit_s: dest is null",
                   
# 82 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c" 3 4
                  ((void *)0)
# 82 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c"
                      , ( 400 ));
        return (
# 83 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c" 3 4
               0
# 83 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c"
                    );
    }
...
# 88 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c" 3 4
                  ((void *)0)
# 88 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c"
                      , ( 401 ));
        return (
# 89 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c" 3 4
               0
# 89 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c"
                    );
    }
...
# 94 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c" 3 4
                  ((void *)0)
# 94 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c"
                      , ( 403 ));
        return (
# 95 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c" 3 4
               0
# 95 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c"
                    );
    }

    if (*dest == '\0') {
        return (
# 99 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c" 3 4
               0
# 99 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c"
                    );
    }
    ...
    while (*dest) {
        ...
        if ((*dest < '0') || (*dest > '9')) {
            return (
# 105 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c" 3 4
                   0
# 105 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c"
                        );
        }
        dest++;
        dmax--;
    ...
    return (
# 111 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c" 3 4
           1
# 111 "//./citus/src/backend/distributed/safeclib/strisdigit_s.c"
               );
}
