# 0 "//./citus/src/backend/distributed/safeclib/memmove_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/memmove_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/memmove_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/memmove_s.c" 2
...
extern void invoke_safe_mem_constraint_handler(
                           ...
                           void *ptr,
                           errno_t error);
# 34 "//./citus/src/backend/distributed/safeclib/memmove_s.c" 2
...
# 35 "//./citus/src/backend/distributed/safeclib/memmove_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_mem_lib.h" 1
# 36 "//./citus/src/backend/distributed/safeclib/memmove_s.c" 2
# 94 "//./citus/src/backend/distributed/safeclib/memmove_s.c"
errno_t
memmove_s (void *dest, rsize_t dmax, const void *src, rsize_t smax)
{
    ...
    if (dp == 
# 103 "//./citus/src/backend/distributed/safeclib/memmove_s.c" 3 4
             ((void *)0)
# 103 "//./citus/src/backend/distributed/safeclib/memmove_s.c"
                 ) {
        invoke_safe_mem_constraint_handler("memmove_s: dest is null",
                   
# 105 "//./citus/src/backend/distributed/safeclib/memmove_s.c" 3 4
                  ((void *)0)
# 105 "//./citus/src/backend/distributed/safeclib/memmove_s.c"
                      , ( 400 ));
        return ((( 400 )));
    }
...
# 111 "//./citus/src/backend/distributed/safeclib/memmove_s.c" 3 4
                  ((void *)0)
# 111 "//./citus/src/backend/distributed/safeclib/memmove_s.c"
                      , ( 401 ));
        return ((( 401 )));
    }
...
# 117 "//./citus/src/backend/distributed/safeclib/memmove_s.c" 3 4
                  ((void *)0)
# 117 "//./citus/src/backend/distributed/safeclib/memmove_s.c"
                      , ( 403 ));
        return ((( 403 )));
    }
...
# 124 "//./citus/src/backend/distributed/safeclib/memmove_s.c" 3 4
                  ((void *)0)
# 124 "//./citus/src/backend/distributed/safeclib/memmove_s.c"
                      , ( 401 ));
        return ((( 401 )));
    }
...
# 131 "//./citus/src/backend/distributed/safeclib/memmove_s.c" 3 4
                  ((void *)0)
# 131 "//./citus/src/backend/distributed/safeclib/memmove_s.c"
                      , ( 403 ));
        return ((( 403 )));
    }

    if (sp == 
# 135 "//./citus/src/backend/distributed/safeclib/memmove_s.c" 3 4
             ((void *)0)
# 135 "//./citus/src/backend/distributed/safeclib/memmove_s.c"
                 ) {
        mem_prim_set(dp, dmax, 0);
        invoke_safe_mem_constraint_handler("memmove_s: src is null",
                   
# 138 "//./citus/src/backend/distributed/safeclib/memmove_s.c" 3 4
                  ((void *)0)
# 138 "//./citus/src/backend/distributed/safeclib/memmove_s.c"
                      , ( 400 ));
        return ((( 400 )));
    }
