# 0 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c" 2
...
# 34 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c" 2
# 96 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c"
errno_t
strcpyfldout_s (char *dest, rsize_t dmax, const char *src, rsize_t slen)
{
    rsize_t orig_dmax;
    ...
    if (dest == 
# 103 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c" 3 4
               ((void *)0)
# 103 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c"
                   ) {
        invoke_safe_str_constraint_handler("strcpyfldout_s: dest is null",
                   
# 105 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c" 3 4
                  ((void *)0)
# 105 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 111 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c" 3 4
                  ((void *)0)
# 111 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 117 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c" 3 4
                  ((void *)0)
# 117 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c"
                      , ( 403 ));
        return (( 403 ));
    }

    if (src == 
# 121 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c" 3 4
              ((void *)0)
# 121 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c"
                  ) {
...
# 126 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c" 3 4
                  ((void *)0)
# 126 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 135 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c" 3 4
                  ((void *)0)
# 135 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 144 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c" 3 4
                  ((void *)0)
# 144 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
...
# 167 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c" 3 4
                          ((void *)0)
# 167 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c"
                              , ( 404 ));
                return (( 404 ));
            }
...
# 190 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c" 3 4
                          ((void *)0)
# 190 "//./citus/src/backend/distributed/safeclib/strcpyfldout_s.c"
                              , ( 404 ));
                return (( 404 ));
            }
