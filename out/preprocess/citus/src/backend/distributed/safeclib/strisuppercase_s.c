# 0 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c" 2
...
# 34 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c" 2
# 78 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c"

# 78 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c" 3 4
_Bool

# 79 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c"
...
# 85 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c" 3 4
                  ((void *)0)
# 85 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c"
                      , ( 400 ));
        return (
# 86 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c" 3 4
               0
# 86 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c"
                    );
    }
...
# 92 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c" 3 4
                  ((void *)0)
# 92 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c"
                      , ( 401 ));
        return (
# 93 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c" 3 4
               0
# 93 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c"
                    );
    }
...
# 99 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c" 3 4
                  ((void *)0)
# 99 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c"
                      , ( 403 ));
        return (
# 100 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c" 3 4
               0
# 100 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c"
                    );
    }

    if (*dest == '\0') {
        return (
# 104 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c" 3 4
               0
# 104 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c"
                    );
    }
    ...
    while (*dest) {
        ...
        if ((*dest < 'A') || (*dest > 'Z')) {
            return (
# 110 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c" 3 4
                   0
# 110 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c"
                        );
        }
        dest++;
        dmax--;
    ...
    return (
# 116 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c" 3 4
           1
# 116 "//./citus/src/backend/distributed/safeclib/strisuppercase_s.c"
               );
}
