# 0 "//./citus/src/backend/distributed/safeclib/strprefix_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/strprefix_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/strprefix_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/strprefix_s.c" 2
...
# 34 "//./citus/src/backend/distributed/safeclib/strprefix_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/strprefix_s.c" 2
# 84 "//./citus/src/backend/distributed/safeclib/strprefix_s.c"
errno_t
strprefix_s (const char *dest, rsize_t dmax, const char *src)
{
    if (dest == 
# 87 "//./citus/src/backend/distributed/safeclib/strprefix_s.c" 3 4
               ((void *)0)
# 87 "//./citus/src/backend/distributed/safeclib/strprefix_s.c"
                   ) {
        invoke_safe_str_constraint_handler("strprefix_s: dest is null",
                   
# 89 "//./citus/src/backend/distributed/safeclib/strprefix_s.c" 3 4
                  ((void *)0)
# 89 "//./citus/src/backend/distributed/safeclib/strprefix_s.c"
                      , ( 400 ));
        return (( 400 ));
    }

    if (src == 
# 93 "//./citus/src/backend/distributed/safeclib/strprefix_s.c" 3 4
              ((void *)0)
# 93 "//./citus/src/backend/distributed/safeclib/strprefix_s.c"
                  ) {
        invoke_safe_str_constraint_handler("strprefix_s: src is null",
                   
# 95 "//./citus/src/backend/distributed/safeclib/strprefix_s.c" 3 4
                  ((void *)0)
# 95 "//./citus/src/backend/distributed/safeclib/strprefix_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 101 "//./citus/src/backend/distributed/safeclib/strprefix_s.c" 3 4
                  ((void *)0)
# 101 "//./citus/src/backend/distributed/safeclib/strprefix_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 107 "//./citus/src/backend/distributed/safeclib/strprefix_s.c" 3 4
                  ((void *)0)
# 107 "//./citus/src/backend/distributed/safeclib/strprefix_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
