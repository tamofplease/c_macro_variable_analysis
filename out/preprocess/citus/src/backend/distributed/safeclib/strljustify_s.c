# 0 "//./citus/src/backend/distributed/safeclib/strljustify_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/strljustify_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/strljustify_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/strljustify_s.c" 2
...
# 34 "//./citus/src/backend/distributed/safeclib/strljustify_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/strljustify_s.c" 2
# 85 "//./citus/src/backend/distributed/safeclib/strljustify_s.c"
errno_t
strljustify_s (char *dest, rsize_t dmax)
{
    char *orig_dest;
    ...
    if (dest == 
# 91 "//./citus/src/backend/distributed/safeclib/strljustify_s.c" 3 4
               ((void *)0)
# 91 "//./citus/src/backend/distributed/safeclib/strljustify_s.c"
                   ) {
        invoke_safe_str_constraint_handler("strljustify_s_s: "
                   "dest is null",
                   
# 94 "//./citus/src/backend/distributed/safeclib/strljustify_s.c" 3 4
                  ((void *)0)
# 94 "//./citus/src/backend/distributed/safeclib/strljustify_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 101 "//./citus/src/backend/distributed/safeclib/strljustify_s.c" 3 4
                  ((void *)0)
# 101 "//./citus/src/backend/distributed/safeclib/strljustify_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 108 "//./citus/src/backend/distributed/safeclib/strljustify_s.c" 3 4
                  ((void *)0)
# 108 "//./citus/src/backend/distributed/safeclib/strljustify_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
...
# 132 "//./citus/src/backend/distributed/safeclib/strljustify_s.c" 3 4
                      ((void *)0)
# 132 "//./citus/src/backend/distributed/safeclib/strljustify_s.c"
                          , ( 407 ));
            return (( 407 ));
        }
        dmax--;
