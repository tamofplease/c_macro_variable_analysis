# 0 "//./citus/src/backend/distributed/safeclib/memzero_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/memzero_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/memzero_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/memzero_s.c" 2
...
extern void invoke_safe_mem_constraint_handler(
                           ...
                           void *ptr,
                           errno_t error);
# 34 "//./citus/src/backend/distributed/safeclib/memzero_s.c" 2
...
# 35 "//./citus/src/backend/distributed/safeclib/memzero_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_mem_lib.h" 1
# 36 "//./citus/src/backend/distributed/safeclib/memzero_s.c" 2
# 78 "//./citus/src/backend/distributed/safeclib/memzero_s.c"
errno_t
memzero_s (void *dest, rsize_t len)
{
    if (dest == 
# 81 "//./citus/src/backend/distributed/safeclib/memzero_s.c" 3 4
               ((void *)0)
# 81 "//./citus/src/backend/distributed/safeclib/memzero_s.c"
                   ) {
        invoke_safe_mem_constraint_handler("memzero_s: dest is null",
                   
# 83 "//./citus/src/backend/distributed/safeclib/memzero_s.c" 3 4
                  ((void *)0)
# 83 "//./citus/src/backend/distributed/safeclib/memzero_s.c"
                      , ( 400 ));
        return ((( 400 )));
    }
...
# 89 "//./citus/src/backend/distributed/safeclib/memzero_s.c" 3 4
                  ((void *)0)
# 89 "//./citus/src/backend/distributed/safeclib/memzero_s.c"
                      , ( 401 ));
        return ((( 401 )));
    }
...
# 95 "//./citus/src/backend/distributed/safeclib/memzero_s.c" 3 4
                  ((void *)0)
# 95 "//./citus/src/backend/distributed/safeclib/memzero_s.c"
                      , ( 403 ));
        return ((( 403 )));
    }
