# 0 "//./citus/src/backend/distributed/safeclib/strcspn_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/strcspn_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/strcspn_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/strcspn_s.c" 2
...
# 34 "//./citus/src/backend/distributed/safeclib/strcspn_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/strcspn_s.c" 2
# 91 "//./citus/src/backend/distributed/safeclib/strcspn_s.c"
errno_t
strcspn_s (const char *dest, rsize_t dmax,
           const char *src, rsize_t slen, rsize_t *count)
{
    ...
    if (count== 
# 98 "//./citus/src/backend/distributed/safeclib/strcspn_s.c" 3 4
               ((void *)0)
# 98 "//./citus/src/backend/distributed/safeclib/strcspn_s.c"
                   ) {
        invoke_safe_str_constraint_handler("strcspn_s: count is null",
                   
# 100 "//./citus/src/backend/distributed/safeclib/strcspn_s.c" 3 4
                  ((void *)0)
# 100 "//./citus/src/backend/distributed/safeclib/strcspn_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
    *count = 0;
    ...
    if (dest == 
# 105 "//./citus/src/backend/distributed/safeclib/strcspn_s.c" 3 4
               ((void *)0)
# 105 "//./citus/src/backend/distributed/safeclib/strcspn_s.c"
                   ) {
        invoke_safe_str_constraint_handler("strcspn_s: dest is null",
                   
# 107 "//./citus/src/backend/distributed/safeclib/strcspn_s.c" 3 4
                  ((void *)0)
# 107 "//./citus/src/backend/distributed/safeclib/strcspn_s.c"
                      , ( 400 ));
        return (( 400 ));
    }

    if (src == 
# 111 "//./citus/src/backend/distributed/safeclib/strcspn_s.c" 3 4
              ((void *)0)
# 111 "//./citus/src/backend/distributed/safeclib/strcspn_s.c"
                  ) {
        invoke_safe_str_constraint_handler("strcspn_s: src is null",
                   
# 113 "//./citus/src/backend/distributed/safeclib/strcspn_s.c" 3 4
                  ((void *)0)
# 113 "//./citus/src/backend/distributed/safeclib/strcspn_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 119 "//./citus/src/backend/distributed/safeclib/strcspn_s.c" 3 4
                  ((void *)0)
# 119 "//./citus/src/backend/distributed/safeclib/strcspn_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 125 "//./citus/src/backend/distributed/safeclib/strcspn_s.c" 3 4
                  ((void *)0)
# 125 "//./citus/src/backend/distributed/safeclib/strcspn_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
...
# 131 "//./citus/src/backend/distributed/safeclib/strcspn_s.c" 3 4
                  ((void *)0)
# 131 "//./citus/src/backend/distributed/safeclib/strcspn_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 137 "//./citus/src/backend/distributed/safeclib/strcspn_s.c" 3 4
                  ((void *)0)
# 137 "//./citus/src/backend/distributed/safeclib/strcspn_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
