# 0 "//./citus/src/backend/distributed/safeclib/strcat_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/strcat_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/strcat_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/strcat_s.c" 2
...
# 34 "//./citus/src/backend/distributed/safeclib/strcat_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/strcat_s.c" 2
# 100 "//./citus/src/backend/distributed/safeclib/strcat_s.c"
errno_t
strcat_s (char *dest, rsize_t dmax, const char *src)
{
    rsize_t orig_dmax;
    ...
    if (dest == 
# 107 "//./citus/src/backend/distributed/safeclib/strcat_s.c" 3 4
               ((void *)0)
# 107 "//./citus/src/backend/distributed/safeclib/strcat_s.c"
                   ) {
        invoke_safe_str_constraint_handler("strcat_s: dest is null",
                   
# 109 "//./citus/src/backend/distributed/safeclib/strcat_s.c" 3 4
                  ((void *)0)
# 109 "//./citus/src/backend/distributed/safeclib/strcat_s.c"
                      , ( 400 ));
        return (( 400 ));
    }

    if (src == 
# 113 "//./citus/src/backend/distributed/safeclib/strcat_s.c" 3 4
              ((void *)0)
# 113 "//./citus/src/backend/distributed/safeclib/strcat_s.c"
                  ) {
        invoke_safe_str_constraint_handler("strcat_s: src is null",
                   
# 115 "//./citus/src/backend/distributed/safeclib/strcat_s.c" 3 4
                  ((void *)0)
# 115 "//./citus/src/backend/distributed/safeclib/strcat_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 121 "//./citus/src/backend/distributed/safeclib/strcat_s.c" 3 4
                  ((void *)0)
# 121 "//./citus/src/backend/distributed/safeclib/strcat_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 127 "//./citus/src/backend/distributed/safeclib/strcat_s.c" 3 4
                  ((void *)0)
# 127 "//./citus/src/backend/distributed/safeclib/strcat_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
