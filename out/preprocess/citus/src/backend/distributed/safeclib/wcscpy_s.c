# 0 "//./citus/src/backend/distributed/safeclib/wcscpy_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/wcscpy_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/wcscpy_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/wcscpy_s.c" 2
...
# 34 "//./citus/src/backend/distributed/safeclib/wcscpy_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/wcscpy_s.c" 2
# 94 "//./citus/src/backend/distributed/safeclib/wcscpy_s.c"
errno_t
wcscpy_s(wchar_t* dest, rsize_t dmax, const wchar_t* src)
{
    rsize_t orig_dmax;
    ...
    if (dest == 
# 101 "//./citus/src/backend/distributed/safeclib/wcscpy_s.c" 3 4
               ((void *)0)
# 101 "//./citus/src/backend/distributed/safeclib/wcscpy_s.c"
                   ) {
        invoke_safe_str_constraint_handler("wcscpy_s: dest is null",
                   
# 103 "//./citus/src/backend/distributed/safeclib/wcscpy_s.c" 3 4
                  ((void *)0)
# 103 "//./citus/src/backend/distributed/safeclib/wcscpy_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 109 "//./citus/src/backend/distributed/safeclib/wcscpy_s.c" 3 4
                  ((void *)0)
# 109 "//./citus/src/backend/distributed/safeclib/wcscpy_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 115 "//./citus/src/backend/distributed/safeclib/wcscpy_s.c" 3 4
                  ((void *)0)
# 115 "//./citus/src/backend/distributed/safeclib/wcscpy_s.c"
                      , ( 403 ));
        return (( 403 ));
    }

    if (src == 
# 119 "//./citus/src/backend/distributed/safeclib/wcscpy_s.c" 3 4
              ((void *)0)
# 119 "//./citus/src/backend/distributed/safeclib/wcscpy_s.c"
                  ) {
...
# 127 "//./citus/src/backend/distributed/safeclib/wcscpy_s.c" 3 4
                  ((void *)0)
# 127 "//./citus/src/backend/distributed/safeclib/wcscpy_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 137 "//./citus/src/backend/distributed/safeclib/wcscpy_s.c" 3 4
                      ((void *)0)
# 137 "//./citus/src/backend/distributed/safeclib/wcscpy_s.c"
                          , ( 403 ));
            return (( 403 ));
     }
        return (( 0 ));
