# 0 "//./citus/src/backend/distributed/safeclib/strfirstchar_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/strfirstchar_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/strfirstchar_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/strfirstchar_s.c" 2
...
# 34 "//./citus/src/backend/distributed/safeclib/strfirstchar_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/strfirstchar_s.c" 2
# 87 "//./citus/src/backend/distributed/safeclib/strfirstchar_s.c"
errno_t
strfirstchar_s (char *dest, rsize_t dmax, char c, char **first)
{

    if (first == 
# 91 "//./citus/src/backend/distributed/safeclib/strfirstchar_s.c" 3 4
                ((void *)0)
# 91 "//./citus/src/backend/distributed/safeclib/strfirstchar_s.c"
                    ) {
        invoke_safe_str_constraint_handler("strfirstchar_s: index is null",
                   
# 93 "//./citus/src/backend/distributed/safeclib/strfirstchar_s.c" 3 4
                  ((void *)0)
# 93 "//./citus/src/backend/distributed/safeclib/strfirstchar_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
    *first = 
# 96 "//./citus/src/backend/distributed/safeclib/strfirstchar_s.c" 3 4
            ((void *)0)
# 96 "//./citus/src/backend/distributed/safeclib/strfirstchar_s.c"
                ;

    if (dest == 
# 98 "//./citus/src/backend/distributed/safeclib/strfirstchar_s.c" 3 4
               ((void *)0)
# 98 "//./citus/src/backend/distributed/safeclib/strfirstchar_s.c"
                   ) {
        invoke_safe_str_constraint_handler("strfirstchar_s: dest is null",
                   
# 100 "//./citus/src/backend/distributed/safeclib/strfirstchar_s.c" 3 4
                  ((void *)0)
# 100 "//./citus/src/backend/distributed/safeclib/strfirstchar_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 106 "//./citus/src/backend/distributed/safeclib/strfirstchar_s.c" 3 4
                  ((void *)0)
# 106 "//./citus/src/backend/distributed/safeclib/strfirstchar_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 112 "//./citus/src/backend/distributed/safeclib/strfirstchar_s.c" 3 4
                  ((void *)0)
# 112 "//./citus/src/backend/distributed/safeclib/strfirstchar_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
