# 0 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c" 2
...
# 34 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c" 2
# 90 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c"
errno_t
strpbrk_s (char *dest, rsize_t dmax,
           char *src, rsize_t slen, char **first)
{
    ...
    if (first == 
# 97 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c" 3 4
                ((void *)0)
# 97 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c"
                    ) {
        invoke_safe_str_constraint_handler("strpbrk_s: count is null",
                   
# 99 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c" 3 4
                  ((void *)0)
# 99 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
    *first = 
# 102 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c" 3 4
            ((void *)0)
# 102 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c"
                ;

    if (dest == 
# 104 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c" 3 4
               ((void *)0)
# 104 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c"
                   ) {
        invoke_safe_str_constraint_handler("strpbrk_s: dest is null",
                   
# 106 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c" 3 4
                  ((void *)0)
# 106 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c"
                      , ( 400 ));
        return (( 400 ));
    }

    if (src == 
# 110 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c" 3 4
              ((void *)0)
# 110 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c"
                  ) {
        invoke_safe_str_constraint_handler("strpbrk_s: src is null",
                   
# 112 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c" 3 4
                  ((void *)0)
# 112 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 118 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c" 3 4
                  ((void *)0)
# 118 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 124 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c" 3 4
                  ((void *)0)
# 124 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
...
# 130 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c" 3 4
                  ((void *)0)
# 130 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 136 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c" 3 4
                  ((void *)0)
# 136 "//./citus/src/backend/distributed/safeclib/strpbrk_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
