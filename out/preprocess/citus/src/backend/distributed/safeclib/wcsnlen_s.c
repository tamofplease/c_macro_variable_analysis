# 0 "//./citus/src/backend/distributed/safeclib/wcsnlen_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/wcsnlen_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/wcsnlen_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/wcsnlen_s.c" 2
...
# 34 "//./citus/src/backend/distributed/safeclib/wcsnlen_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/wcsnlen_s.c" 2
# 83 "//./citus/src/backend/distributed/safeclib/wcsnlen_s.c"
rsize_t
wcsnlen_s (const wchar_t *dest, rsize_t dmax)
{
    rsize_t count;
    ...
    if (dest == 
# 88 "//./citus/src/backend/distributed/safeclib/wcsnlen_s.c" 3 4
               ((void *)0)
# 88 "//./citus/src/backend/distributed/safeclib/wcsnlen_s.c"
                   ) {
        return (0);
    }
...
# 94 "//./citus/src/backend/distributed/safeclib/wcsnlen_s.c" 3 4
                  ((void *)0)
# 94 "//./citus/src/backend/distributed/safeclib/wcsnlen_s.c"
                      , ( 401 ));
        return (0);
    }
...
# 100 "//./citus/src/backend/distributed/safeclib/wcsnlen_s.c" 3 4
                  ((void *)0)
# 100 "//./citus/src/backend/distributed/safeclib/wcsnlen_s.c"
                      , ( 403 ));
        return (0);
    }
