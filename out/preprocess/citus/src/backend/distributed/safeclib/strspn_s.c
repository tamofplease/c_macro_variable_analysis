# 0 "//./citus/src/backend/distributed/safeclib/strspn_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/strspn_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/strspn_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/strspn_s.c" 2
...
# 34 "//./citus/src/backend/distributed/safeclib/strspn_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/strspn_s.c" 2
# 88 "//./citus/src/backend/distributed/safeclib/strspn_s.c"
errno_t
strspn_s (const char *dest, rsize_t dmax,
          const char *src, rsize_t slen, rsize_t *count)
{
...
# 94 "//./citus/src/backend/distributed/safeclib/strspn_s.c" 3 4
   _Bool 
# 94 "//./citus/src/backend/distributed/safeclib/strspn_s.c"
        match_found;

    if (count== 
# 96 "//./citus/src/backend/distributed/safeclib/strspn_s.c" 3 4
               ((void *)0)
# 96 "//./citus/src/backend/distributed/safeclib/strspn_s.c"
                   ) {
        invoke_safe_str_constraint_handler("strspn_s: count is null",
                   
# 98 "//./citus/src/backend/distributed/safeclib/strspn_s.c" 3 4
                  ((void *)0)
# 98 "//./citus/src/backend/distributed/safeclib/strspn_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
    *count = 0;
    ...
    if (dest == 
# 103 "//./citus/src/backend/distributed/safeclib/strspn_s.c" 3 4
               ((void *)0)
# 103 "//./citus/src/backend/distributed/safeclib/strspn_s.c"
                   ) {
        invoke_safe_str_constraint_handler("strspn_s: dest is null",
                   
# 105 "//./citus/src/backend/distributed/safeclib/strspn_s.c" 3 4
                  ((void *)0)
# 105 "//./citus/src/backend/distributed/safeclib/strspn_s.c"
                      , ( 400 ));
        return (( 400 ));
    }

    if (src == 
# 109 "//./citus/src/backend/distributed/safeclib/strspn_s.c" 3 4
              ((void *)0)
# 109 "//./citus/src/backend/distributed/safeclib/strspn_s.c"
                  ) {
        invoke_safe_str_constraint_handler("strspn_s: src is null",
                   
# 111 "//./citus/src/backend/distributed/safeclib/strspn_s.c" 3 4
                  ((void *)0)
# 111 "//./citus/src/backend/distributed/safeclib/strspn_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 117 "//./citus/src/backend/distributed/safeclib/strspn_s.c" 3 4
                  ((void *)0)
# 117 "//./citus/src/backend/distributed/safeclib/strspn_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 123 "//./citus/src/backend/distributed/safeclib/strspn_s.c" 3 4
                  ((void *)0)
# 123 "//./citus/src/backend/distributed/safeclib/strspn_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
...
# 129 "//./citus/src/backend/distributed/safeclib/strspn_s.c" 3 4
                  ((void *)0)
# 129 "//./citus/src/backend/distributed/safeclib/strspn_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 135 "//./citus/src/backend/distributed/safeclib/strspn_s.c" 3 4
                  ((void *)0)
# 135 "//./citus/src/backend/distributed/safeclib/strspn_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
    ...
    while (*dest && dmax) {
        ...
        match_found = 
# 145 "//./citus/src/backend/distributed/safeclib/strspn_s.c" 3 4
                     0
# 145 "//./citus/src/backend/distributed/safeclib/strspn_s.c"
                          ;
        smax = slen;
        scan2 = src;
        while (*scan2 && smax) {
            ...
            if (*dest == *scan2) {
                match_found = 
# 151 "//./citus/src/backend/distributed/safeclib/strspn_s.c" 3 4
                             1
# 151 "//./citus/src/backend/distributed/safeclib/strspn_s.c"
                                 ;
                break;
            }
            scan2++;
