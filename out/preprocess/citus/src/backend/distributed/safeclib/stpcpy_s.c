# 0 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c" 2
...
# 34 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c" 2
# 100 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c"
char *
stpcpy_s(char *dest, rsize_t dmax, const char *src, errno_t *err)
{
    rsize_t orig_dmax;
    ...
    if (dest == 
# 107 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c" 3 4
               ((void *)0)
# 107 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c"
                   ) {
        invoke_safe_str_constraint_handler("stpcpy_s: dest is null",
                   
# 109 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c" 3 4
                  ((void *)0)
# 109 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c"
                      , ( 400 ));
        *err = (( 400 ));
        return 
# 111 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c" 3 4
              ((void *)0)
# 111 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c"
                  ;
    }
...
# 116 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c" 3 4
                  ((void *)0)
# 116 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c"
                      , ( 401 ));
        *err = (( 401 ));
        return 
# 118 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c" 3 4
              ((void *)0)
# 118 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c"
                  ;
    }
...
# 123 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c" 3 4
                  ((void *)0)
# 123 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c"
                      , ( 403 ));
        *err = (( 403 ));
        return 
# 125 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c" 3 4
              ((void *)0)
# 125 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c"
                  ;
    }

    if (src == 
# 128 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c" 3 4
              ((void *)0)
# 128 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c"
                  ) {
...
# 136 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c" 3 4
                  ((void *)0)
# 136 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c"
                      , ( 400 ));
        *err = (( 400 ));
        return 
# 138 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c" 3 4
              ((void *)0)
# 138 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c"
                  ;
    }
     ...
     *err = (( 406 ));
     return 
# 164 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c" 3 4
           ((void *)0)
# 164 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c"
               ;
    }
    ...
    if (dest < src) {
        ...
        while (dmax > 0) {
            if (dest == overlap_bumper) {
                ...
                *err = (( 404 ));
                return 
# 178 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c" 3 4
                      ((void *)0)
# 178 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c"
                          ;
            }
        ...
        while (dmax > 0) {
            ...
            if (src == overlap_bumper) {
                ...
                *err = (( 404 ));
                return 
# 206 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c" 3 4
                      ((void *)0)
# 206 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c"
                          ;
            }
    ...
    *err = (( 406 ));
    return 
# 232 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c" 3 4
          ((void *)0)
# 232 "//./citus/src/backend/distributed/safeclib/stpcpy_s.c"
              ;
}
