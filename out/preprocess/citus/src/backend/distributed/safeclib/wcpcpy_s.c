# 0 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c" 2
...
# 34 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c" 2
# 99 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c"
wchar_t *
wcpcpy_s(wchar_t* dest, rsize_t dmax, const wchar_t* src, errno_t *err)
{
    rsize_t orig_dmax;
    ...
    if (dest == 
# 106 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c" 3 4
               ((void *)0)
# 106 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c"
                   ) {
        invoke_safe_str_constraint_handler("wcpcpy_s: dest is null",
                   
# 108 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c" 3 4
                  ((void *)0)
# 108 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c"
                      , ( 400 ));
        *err = (( 400 ));
        return 
# 110 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c" 3 4
              ((void *)0)
# 110 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c"
                  ;
    }
...
# 115 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c" 3 4
                  ((void *)0)
# 115 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c"
                      , ( 401 ));
        *err = (( 401 ));
        return 
# 117 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c" 3 4
              ((void *)0)
# 117 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c"
                  ;
    }

    if (dmax*sizeof(wchar_t) > ( 4UL << 10 )) {
        invoke_safe_str_constraint_handler("wcpcpy_s: dmax exceeds max",
                   
# 122 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c" 3 4
                  ((void *)0)
# 122 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c"
                      , ( 403 ));
        *err = (( 403 ));
        return 
# 124 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c" 3 4
              ((void *)0)
# 124 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c"
                  ;
    }

    if (src == 
# 127 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c" 3 4
              ((void *)0)
# 127 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c"
                  ) {
...
# 135 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c" 3 4
                  ((void *)0)
# 135 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c"
                      , ( 400 ));
        *err = (( 400 ));
        return 
# 137 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c" 3 4
              ((void *)0)
# 137 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c"
                  ;
    }
...
# 145 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c" 3 4
                        ((void *)0)
# 145 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c"
                            , ( 403 ));
   *err = (( 403 ));
   return 
# 147 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c" 3 4
         ((void *)0)
# 147 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c"
             ;
     }
     *err = (( 0 ));
     return dest;
    ...
    if (dest < src) {
       ...
       *err = (( 404 ));
       return 
# 165 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c" 3 4
             ((void *)0)
# 165 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c"
                 ;
            }
       ...
       *err = (( 404 ));
       return 
# 191 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c" 3 4
             ((void *)0)
# 191 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c"
                 ;
            }
    ...
    *err = (( 406 ));
    return 
# 217 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c" 3 4
          ((void *)0)
# 217 "//./citus/src/backend/distributed/safeclib/wcpcpy_s.c"
              ;
}
