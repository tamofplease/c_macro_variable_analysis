# 0 "//./citus/src/backend/distributed/safeclib/memset32_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/memset32_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/memset32_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/memset32_s.c" 2
...
extern void invoke_safe_mem_constraint_handler(
                           ...
                           void *ptr,
                           errno_t error);
# 34 "//./citus/src/backend/distributed/safeclib/memset32_s.c" 2
...
# 35 "//./citus/src/backend/distributed/safeclib/memset32_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_mem_lib.h" 1
# 36 "//./citus/src/backend/distributed/safeclib/memset32_s.c" 2
# 80 "//./citus/src/backend/distributed/safeclib/memset32_s.c"
errno_t
memset32_s (uint32_t *dest, rsize_t len, uint32_t value)
{
    if (dest == 
# 83 "//./citus/src/backend/distributed/safeclib/memset32_s.c" 3 4
               ((void *)0)
# 83 "//./citus/src/backend/distributed/safeclib/memset32_s.c"
                   ) {
        invoke_safe_mem_constraint_handler("memset32_s: dest is null",
                   
# 85 "//./citus/src/backend/distributed/safeclib/memset32_s.c" 3 4
                  ((void *)0)
# 85 "//./citus/src/backend/distributed/safeclib/memset32_s.c"
                      , ( 400 ));
        return ((( 400 )));
    }
...
# 91 "//./citus/src/backend/distributed/safeclib/memset32_s.c" 3 4
                  ((void *)0)
# 91 "//./citus/src/backend/distributed/safeclib/memset32_s.c"
                      , ( 401 ));
        return ((( 401 )));
    }
...
# 97 "//./citus/src/backend/distributed/safeclib/memset32_s.c" 3 4
                  ((void *)0)
# 97 "//./citus/src/backend/distributed/safeclib/memset32_s.c"
                      , ( 403 ));
        return ((( 403 )));
    }
