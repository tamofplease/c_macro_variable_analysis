# 0 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c" 2
...
# 34 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c" 2
# 78 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c"

# 78 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c" 3 4
_Bool

# 79 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c"
...
# 84 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c" 3 4
                  ((void *)0)
# 84 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c"
                      , ( 400 ));
        return (
# 85 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c" 3 4
               0
# 85 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c"
                    );
    }
...
# 91 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c" 3 4
                  ((void *)0)
# 91 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c"
                      , ( 401 ));
        return (
# 92 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c" 3 4
               0
# 92 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c"
                    );
    }
...
# 98 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c" 3 4
                  ((void *)0)
# 98 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c"
                      , ( 403 ));
        return (
# 99 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c" 3 4
               0
# 99 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c"
                    );
    }

    if (*dest == '\0') {
        return (
# 103 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c" 3 4
               0
# 103 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c"
                    );
    }
    ...
    while (*dest && dmax) {
        ...
        if (( (*dest >= '0') && (*dest <= '9') ) ||
            ...
            return (
# 114 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c" 3 4
                   0
# 114 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c"
                        );
        }
    }

    return (
# 118 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c" 3 4
           1
# 118 "//./citus/src/backend/distributed/safeclib/strisalphanumeric_s.c"
               );
}
