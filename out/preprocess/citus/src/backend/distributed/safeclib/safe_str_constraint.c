# 0 "//./citus/src/backend/distributed/safeclib/safe_str_constraint.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/safe_str_constraint.c"
# 33 "//./citus/src/backend/distributed/safeclib/safe_str_constraint.c"
...
# 34 "//./citus/src/backend/distributed/safeclib/safe_str_constraint.c" 2
...
# 35 "//./citus/src/backend/distributed/safeclib/safe_str_constraint.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 36 "//./citus/src/backend/distributed/safeclib/safe_str_constraint.c" 2


static constraint_handler_t str_handler = 
# 38 "//./citus/src/backend/distributed/safeclib/safe_str_constraint.c" 3 4
                                         ((void *)0)
# 38 "//./citus/src/backend/distributed/safeclib/safe_str_constraint.c"
                                             ;
# 94 "//./citus/src/backend/distributed/safeclib/safe_str_constraint.c"
constraint_handler_t
set_str_constraint_handler_s (constraint_handler_t handler)
{
    constraint_handler_t prev_handler = str_handler;
    if (
# 98 "//./citus/src/backend/distributed/safeclib/safe_str_constraint.c" 3 4
       ((void *)0) 
# 98 "//./citus/src/backend/distributed/safeclib/safe_str_constraint.c"
            == handler) {
        str_handler = ignore_handler_s;
    } else {
        str_handler = handler;
    }
    return prev_handler;
...
# 136 "//./citus/src/backend/distributed/safeclib/safe_str_constraint.c"
void
...
{
    if (
# 141 "//./citus/src/backend/distributed/safeclib/safe_str_constraint.c" 3 4
       ((void *)0) 
# 141 "//./citus/src/backend/distributed/safeclib/safe_str_constraint.c"
            != str_handler) {
