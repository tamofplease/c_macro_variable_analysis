# 0 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c" 2
...
# 34 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c" 2
# 80 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c"

# 80 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c" 3 4
_Bool

# 81 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c"
...
# 86 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c" 3 4
                  ((void *)0)
# 86 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c"
                      , ( 400 ));
        return (
# 87 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c" 3 4
               0
# 87 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c"
                    );
    }
...
# 93 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c" 3 4
                  ((void *)0)
# 93 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c"
                      , ( 401 ));
        return (
# 94 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c" 3 4
               0
# 94 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c"
                    );
    }
...
# 100 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c" 3 4
                  ((void *)0)
# 100 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c"
                      , ( 403 ));
        return (
# 101 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c" 3 4
               0
# 101 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c"
                    );
    }

    if (*dest == '\0') {
        return (
# 105 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c" 3 4
               0
# 105 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c"
                    );
    }
    ...
    while (*dest && dmax) {
        ...
        if ((*dest < 'a') || (*dest > 'z')) {
            return (
# 111 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c" 3 4
                   0
# 111 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c"
                        );
        }
        dest++;
        dmax--;
    ...
    return (
# 117 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c" 3 4
           1
# 117 "//./citus/src/backend/distributed/safeclib/strislowercase_s.c"
               );
}
