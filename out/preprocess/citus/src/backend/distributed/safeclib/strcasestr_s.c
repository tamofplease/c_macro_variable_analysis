# 0 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c"
# 32 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c"
...
# 33 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c" 2
...
# 34 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c" 2
# 88 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c"
errno_t
strcasestr_s (char *dest, rsize_t dmax,
              const char *src, rsize_t slen, char **substring)
{
    ...
    if (substring == 
# 96 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c" 3 4
                    ((void *)0)
# 96 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c"
                        ) {
        invoke_safe_str_constraint_handler("strcasestr_s: substring is null",
                   
# 98 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c" 3 4
                  ((void *)0)
# 98 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
    *substring = 
# 101 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c" 3 4
                ((void *)0)
# 101 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c"
                    ;

    if (dest == 
# 103 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c" 3 4
               ((void *)0)
# 103 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c"
                   ) {
        invoke_safe_str_constraint_handler("strcasestr_s: dest is null",
                   
# 105 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c" 3 4
                  ((void *)0)
# 105 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 111 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c" 3 4
                  ((void *)0)
# 111 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 117 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c" 3 4
                  ((void *)0)
# 117 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c"
                      , ( 403 ));
        return (( 403 ));
    }

    if (src == 
# 121 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c" 3 4
              ((void *)0)
# 121 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c"
                  ) {
        invoke_safe_str_constraint_handler("strcasestr_s: src is null",
                   
# 123 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c" 3 4
                  ((void *)0)
# 123 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 129 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c" 3 4
                  ((void *)0)
# 129 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 135 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c" 3 4
                  ((void *)0)
# 135 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
    ...
    *substring = 
# 177 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c" 3 4
                ((void *)0)
# 177 "//./citus/src/backend/distributed/safeclib/strcasestr_s.c"
                    ;
    return (( 409 ));
}
