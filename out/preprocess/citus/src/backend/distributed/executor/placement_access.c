# 0 "//./citus/src/backend/distributed/executor/placement_access.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/executor/placement_access.c"
# 11 "//./citus/src/backend/distributed/executor/placement_access.c"
# 1 "//./citus/src/include/distributed/placement_access.h" 1
# 13 "//./citus/src/include/distributed/placement_access.h"
...
# 14 "//./citus/src/include/distributed/placement_access.h" 2
...
# 15 "//./citus/src/include/distributed/placement_access.h" 2
...
# 16 "//./citus/src/include/distributed/placement_access.h" 2
...
extern ShardPlacementAccess * CreatePlacementAccess(ShardPlacement *placement,
             ShardPlacementAccessType accessType);
# 12 "//./citus/src/backend/distributed/executor/placement_access.c" 2
# 1 "//./citus/src/include/distributed/listutils.h" 1
# 19 "//./citus/src/include/distributed/listutils.h"
...
# 13 "//./citus/src/backend/distributed/executor/placement_access.c" 2
...
# 28 "//./citus/src/backend/distributed/executor/placement_access.c" 3 4
                            ((void *)0)
# 28 "//./citus/src/backend/distributed/executor/placement_access.c"
                            );
 List *relationShardList = task->relationShardList;
 
# 30 "//./citus/src/backend/distributed/executor/placement_access.c" 3 4
_Bool 
# 30 "//./citus/src/backend/distributed/executor/placement_access.c"
     addAnchorAccess = 
# 30 "//./citus/src/backend/distributed/executor/placement_access.c" 3 4
                       0
# 30 "//./citus/src/backend/distributed/executor/placement_access.c"
 ...
 if (task->taskType == MODIFY_TASK)
 {
  ...
  addAnchorAccess = 
# 36 "//./citus/src/backend/distributed/executor/placement_access.c" 3 4
                   1
# 36 "//./citus/src/backend/distributed/executor/placement_access.c"
                       ;
 ...
 else if (task->taskType == DDL_TASK || task->taskType == VACUUM_ANALYZE_TASK)
 {
  ...
  addAnchorAccess = 
# 42 "//./citus/src/backend/distributed/executor/placement_access.c" 3 4
                   1
# 42 "//./citus/src/backend/distributed/executor/placement_access.c"
                       ;
  accessType = PLACEMENT_ACCESS_DDL;
 }
 else if (relationShardList == ((List *) 
# 45 "//./citus/src/backend/distributed/executor/placement_access.c" 3 4
                              ((void *)0)
# 45 "//./citus/src/backend/distributed/executor/placement_access.c"
                              ))
 {

  addAnchorAccess = 
# 48 "//./citus/src/backend/distributed/executor/placement_access.c" 3 4
                   1
# 48 "//./citus/src/backend/distributed/executor/placement_access.c"
                       ;
 ...
 {
# 85 "//./citus/src/backend/distributed/executor/placement_access.c"
  List *relationShardAccessList =
...
# 101 "//./citus/src/backend/distributed/executor/placement_access.c"
static List *
...
{
 List *placementAccessList = ((List *) 
# 126 "//./citus/src/backend/distributed/executor/placement_access.c" 3 4
                            ((void *)0)
# 126 "//./citus/src/backend/distributed/executor/placement_access.c"
                            );

 RelationShard *relationShard = 
# 128 "//./citus/src/backend/distributed/executor/placement_access.c" 3 4
                               ((void *)0)
# 128 "//./citus/src/backend/distributed/executor/placement_access.c"
                                   ;
 for (ListCell *(relationShardCellDoNotUse) = list_head(relationShardList); (relationShardCellDoNotUse) != 
# 129 "//./citus/src/backend/distributed/executor/placement_access.c" 3 4
((void *)0) 
# 129 "//./citus/src/backend/distributed/executor/placement_access.c"
&& (((relationShard) = ((relationShardCellDoNotUse)->ptr_value)) || 
# 129 "//./citus/src/backend/distributed/executor/placement_access.c" 3 4
1
# 129 "//./citus/src/backend/distributed/executor/placement_access.c"
); relationShardCellDoNotUse = lnext(relationShardList, relationShardCellDoNotUse))
 {
  ShardPlacement *placement = ActiveShardPlacementOnGroup(groupId,
                relationShard->shardId);
  if (placement == 
# 133 "//./citus/src/backend/distributed/executor/placement_access.c" 3 4
                  ((void *)0)
# 133 "//./citus/src/backend/distributed/executor/placement_access.c"
                      )
  {
   continue;
  }
