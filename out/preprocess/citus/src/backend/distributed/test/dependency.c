# 0 "//./citus/src/backend/distributed/test/dependency.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/test/dependency.c"
# 11 "//./citus/src/backend/distributed/test/dependency.c"
...
# 12 "//./citus/src/backend/distributed/test/dependency.c" 2
# 1 "/usr/include/postgresql/14/server/c.h" 1
# 13 "//./citus/src/backend/distributed/test/dependency.c" 2
...
# 14 "//./citus/src/backend/distributed/test/dependency.c" 2

# 1 "//./citus/src/include/distributed/listutils.h" 1
# 18 "//./citus/src/include/distributed/listutils.h"
...
# 19 "//./citus/src/include/distributed/listutils.h" 2
...
# 27 "//./citus/src/include/pg_version_compat.h"
...
# 28 "//./citus/src/include/pg_version_compat.h" 2
# 1 "/usr/include/postgresql/14/server/storage/smgr.h" 1
# 17 "/usr/include/postgresql/14/server/storage/smgr.h"
...
# 18 "/usr/include/postgresql/14/server/storage/smgr.h" 2
...
# 19 "/usr/include/postgresql/14/server/storage/smgr.h" 2
...
# 17 "/usr/include/postgresql/14/server/utils/rel.h"
...
# 18 "/usr/include/postgresql/14/server/utils/rel.h" 2
...
# 18 "/usr/include/postgresql/14/server/utils/relcache.h"
...
# 20 "/usr/include/postgresql/14/server/access/xloginsert.h" 2
...
# 22 "//./citus/src/include/distributed/listutils.h" 2
...
# 16 "//./citus/src/backend/distributed/test/dependency.c" 2
# 1 "//./citus/src/include/distributed/metadata/dependency.h" 1
# 18 "//./citus/src/include/distributed/metadata/dependency.h"
# 1 "/usr/include/postgresql/14/server/catalog/pg_depend.h" 1
# 34 "/usr/include/postgresql/14/server/catalog/pg_depend.h"
# 1 "/usr/include/postgresql/14/server/catalog/pg_depend_d.h" 1
# 35 "/usr/include/postgresql/14/server/catalog/pg_depend.h" 2
...
extern int no_such_variable;
# 19 "//./citus/src/include/distributed/metadata/dependency.h" 2
# 1 "//./citus/src/include/distributed/errormessage.h" 1
# 14 "//./citus/src/include/distributed/errormessage.h"
...
# 15 "//./citus/src/include/distributed/errormessage.h" 2
...
# 20 "//./citus/src/include/distributed/metadata/dependency.h" 2
...
extern 
# 26 "//./citus/src/include/distributed/metadata/dependency.h" 3 4
      _Bool 
# 26 "//./citus/src/include/distributed/metadata/dependency.h"
...
extern 
# 31 "//./citus/src/include/distributed/metadata/dependency.h" 3 4
      _Bool 
# 31 "//./citus/src/include/distributed/metadata/dependency.h"
...
# 17 "//./citus/src/backend/distributed/test/dependency.c" 2
...
# 18 "//./citus/src/backend/distributed/test/dependency.c" 2
# 1 "//./citus/src/include/distributed/tuplestore.h" 1
# 13 "//./citus/src/include/distributed/tuplestore.h"
...
# 346 "/usr/include/postgresql/14/server/funcapi.h"
                           **nulls);
# 14 "//./citus/src/include/distributed/tuplestore.h" 2
...
# 19 "//./citus/src/backend/distributed/test/dependency.c" 2


extern Datum citus_get_all_dependencies_for_object(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_citus_get_all_dependencies_for_object(void); const Pg_finfo_record * pg_finfo_citus_get_all_dependencies_for_object (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum citus_get_dependencies_for_object(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_citus_get_dependencies_for_object(void); const Pg_finfo_record * pg_finfo_citus_get_dependencies_for_object (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
# 35 "//./citus/src/backend/distributed/test/dependency.c"
Datum
citus_get_all_dependencies_for_object(FunctionCallInfo fcinfo)
{
 CheckCitusVersion(21);

 Oid classid = ((Oid) ((fcinfo->args[0].value)));
 Oid objid = ((Oid) ((fcinfo->args[1].value)));
 int32 objsubid = ((int32) ((fcinfo->args[2].value)));

 TupleDesc tupleDescriptor = 
# 44 "//./citus/src/backend/distributed/test/dependency.c" 3 4
                            ((void *)0)
# 44 "//./citus/src/backend/distributed/test/dependency.c"
                                ;
 Tuplestorestate *tupleStore = SetupTuplestore(fcinfo, &tupleDescriptor);

 ObjectAddress address = { 0 };
 do { (address).classId = (classid); (address).objectId = (objid); (address).objectSubId = (objsubid); } while (0);

 List *dependencies = GetAllSupportedDependenciesForObject(&address);
 ObjectAddress *dependency = 
# 51 "//./citus/src/backend/distributed/test/dependency.c" 3 4
                            ((void *)0)
# 51 "//./citus/src/backend/distributed/test/dependency.c"
                                ;
 for (ListCell *(dependencyCellDoNotUse) = list_head(dependencies); (dependencyCellDoNotUse) != 
# 52 "//./citus/src/backend/distributed/test/dependency.c" 3 4
((void *)0) 
# 52 "//./citus/src/backend/distributed/test/dependency.c"
&& (((dependency) = ((dependencyCellDoNotUse)->ptr_value)) || 
# 52 "//./citus/src/backend/distributed/test/dependency.c" 3 4
1
# 52 "//./citus/src/backend/distributed/test/dependency.c"
); dependencyCellDoNotUse = lnext(dependencies, dependencyCellDoNotUse))
 {
  Datum values[3];
  
# 55 "//./citus/src/backend/distributed/test/dependency.c" 3 4
 _Bool 
# 55 "//./citus/src/backend/distributed/test/dependency.c"
      isNulls[3];

  memset(values, 0, sizeof(values));
  memset(isNulls, 0, sizeof(isNulls));

  values[0] = ((Datum) (dependency->classId));
  values[1] = ((Datum) (dependency->objectId));
  values[2] = ((Datum) (dependency->objectSubId));
...
# 80 "//./citus/src/backend/distributed/test/dependency.c"
Datum
citus_get_dependencies_for_object(FunctionCallInfo fcinfo)
{
 CheckCitusVersion(21);
 ...
 TupleDesc tupleDescriptor = 
# 89 "//./citus/src/backend/distributed/test/dependency.c" 3 4
                            ((void *)0)
# 89 "//./citus/src/backend/distributed/test/dependency.c"
                                ;
 Tuplestorestate *tupleStore = SetupTuplestore(fcinfo, &tupleDescriptor);
 ...
 ObjectAddress *dependency = 
# 96 "//./citus/src/backend/distributed/test/dependency.c" 3 4
                            ((void *)0)
# 96 "//./citus/src/backend/distributed/test/dependency.c"
                                ;
 for (ListCell *(dependencyCellDoNotUse) = list_head(dependencies); (dependencyCellDoNotUse) != 
# 97 "//./citus/src/backend/distributed/test/dependency.c" 3 4
((void *)0) 
# 97 "//./citus/src/backend/distributed/test/dependency.c"
&& (((dependency) = ((dependencyCellDoNotUse)->ptr_value)) || 
# 97 "//./citus/src/backend/distributed/test/dependency.c" 3 4
1
# 97 "//./citus/src/backend/distributed/test/dependency.c"
...
# 100 "//./citus/src/backend/distributed/test/dependency.c" 3 4
 _Bool 
# 100 "//./citus/src/backend/distributed/test/dependency.c"
      isNulls[3];
