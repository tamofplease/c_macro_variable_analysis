# 0 "//./citus/src/backend/distributed/test/global_pid.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/test/global_pid.c"
# 12 "//./citus/src/backend/distributed/test/global_pid.c"
...
# 13 "//./citus/src/backend/distributed/test/global_pid.c" 2
...
# 14 "//./citus/src/backend/distributed/test/global_pid.c" 2
...
# 16 "//./citus/src/backend/distributed/test/global_pid.c" 2
...
# 17 "//./citus/src/backend/distributed/test/global_pid.c" 2

extern Datum test_assign_global_pid(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_test_assign_global_pid(void); const Pg_finfo_record * pg_finfo_test_assign_global_pid (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
...
Datum
test_assign_global_pid(FunctionCallInfo fcinfo)
{
