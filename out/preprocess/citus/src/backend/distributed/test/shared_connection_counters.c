# 0 "//./citus/src/backend/distributed/test/shared_connection_counters.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/test/shared_connection_counters.c"
# 13 "//./citus/src/backend/distributed/test/shared_connection_counters.c"
...
# 14 "//./citus/src/backend/distributed/test/shared_connection_counters.c" 2
...
# 15 "//./citus/src/backend/distributed/test/shared_connection_counters.c" 2
...
# 16 "//./citus/src/backend/distributed/test/shared_connection_counters.c" 2

# 1 "//./citus/src/include/distributed/shared_connection_stats.h" 1
# 20 "//./citus/src/include/distributed/shared_connection_stats.h"
...
extern 
# 33 "//./citus/src/include/distributed/shared_connection_stats.h" 3 4
      _Bool 
# 33 "//./citus/src/include/distributed/shared_connection_stats.h"
...
extern int AdaptiveConnectionManagementFlag(
# 37 "//./citus/src/include/distributed/shared_connection_stats.h" 3 4
                                           _Bool 
# 37 "//./citus/src/include/distributed/shared_connection_stats.h"
                                                connectToLocalNode, int
           activeConnectionCount);
# 18 "//./citus/src/backend/distributed/test/shared_connection_counters.c" 2
...
# 19 "//./citus/src/backend/distributed/test/shared_connection_counters.c" 2
...
# 21 "//./citus/src/backend/distributed/test/shared_connection_counters.c" 2


extern Datum wake_up_connection_pool_waiters(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_wake_up_connection_pool_waiters(void); const Pg_finfo_record * pg_finfo_wake_up_connection_pool_waiters (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum set_max_shared_pool_size(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_set_max_shared_pool_size(void); const Pg_finfo_record * pg_finfo_set_max_shared_pool_size (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
...
Datum
wake_up_connection_pool_waiters(FunctionCallInfo fcinfo)
{
...
{
 A_Const *n = ((A_Const *) ({ Node *_result; ((void)
# 48 "//./citus/src/backend/distributed/test/shared_connection_counters.c" 3 4
             1
# 48 "//./citus/src/backend/distributed/test/shared_connection_counters.c"
...
Datum
set_max_shared_pool_size(FunctionCallInfo fcinfo)
{
 int value = ((int32) ((fcinfo->args[0].value)));

 AlterSystemStmt *alterSystemStmt = palloc0(sizeof(AlterSystemStmt));

 A_Const *aConstValue = ((A_Const *) (makeIntConst(value, 0)));

 alterSystemStmt->setstmt = ((VariableSetStmt *) ({ Node *_result; ((void)
# 77 "//./citus/src/backend/distributed/test/shared_connection_counters.c" 3 4
                           1
# 77 "//./citus/src/backend/distributed/test/shared_connection_counters.c"
                           ); _result = (Node *) ( ( ((sizeof(VariableSetStmt)) & (sizeof(long) - 1)) == 0 && (sizeof(VariableSetStmt)) <= 1024 && 1024 != 0 && (0) == 0 ) ? MemoryContextAllocZeroAligned(CurrentMemoryContext, sizeof(VariableSetStmt)) : MemoryContextAllocZero(CurrentMemoryContext, sizeof(VariableSetStmt)) ); _result->type = (T_VariableSetStmt); _result; }));
 alterSystemStmt->setstmt->name = "citus.max_shared_pool_size";
 alterSystemStmt->setstmt->is_local = 
# 79 "//./citus/src/backend/distributed/test/shared_connection_counters.c" 3 4
                                     0
# 79 "//./citus/src/backend/distributed/test/shared_connection_counters.c"
                                          ;
 alterSystemStmt->setstmt->kind = VAR_SET_VALUE;
 alterSystemStmt->setstmt->args = list_make1_impl(T_List, ((ListCell) {.ptr_value = (aConstValue)}));

 AlterSystemSetConfigFile(alterSystemStmt);

 kill(PostmasterPid, 
# 85 "//./citus/src/backend/distributed/test/shared_connection_counters.c" 3 4
                    1
# 85 "//./citus/src/backend/distributed/test/shared_connection_counters.c"
                          );
