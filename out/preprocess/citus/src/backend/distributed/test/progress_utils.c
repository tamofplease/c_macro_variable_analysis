# 0 "//./citus/src/backend/distributed/test/progress_utils.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/test/progress_utils.c"
# 14 "//./citus/src/backend/distributed/test/progress_utils.c"
...
# 15 "//./citus/src/backend/distributed/test/progress_utils.c" 2
...
# 16 "//./citus/src/backend/distributed/test/progress_utils.c" 2
...
# 17 "//./citus/src/backend/distributed/test/progress_utils.c" 2
...
# 346 "/usr/include/postgresql/14/server/funcapi.h"
                           **nulls);
# 18 "//./citus/src/backend/distributed/test/progress_utils.c" 2
...
# 22 "//./citus/src/backend/distributed/test/progress_utils.c" 2
# 1 "//./citus/src/include/distributed/multi_progress.h" 1
# 23 "//./citus/src/include/distributed/multi_progress.h"
...
extern 
# 37 "//./citus/src/include/distributed/multi_progress.h" 3 4
      _Bool 
# 37 "//./citus/src/include/distributed/multi_progress.h"
...
# 23 "//./citus/src/backend/distributed/test/progress_utils.c" 2
# 1 "//./citus/src/include/distributed/tuplestore.h" 1
# 16 "//./citus/src/include/distributed/tuplestore.h"
extern
...
# 24 "//./citus/src/backend/distributed/test/progress_utils.c" 2




extern Datum create_progress(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_create_progress(void); const Pg_finfo_record * pg_finfo_create_progress (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum update_progress(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_update_progress(void); const Pg_finfo_record * pg_finfo_update_progress (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum finish_progress(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_finish_progress(void); const Pg_finfo_record * pg_finfo_finish_progress (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum show_progress(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_show_progress(void); const Pg_finfo_record * pg_finfo_show_progress (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;


Datum
create_progress(FunctionCallInfo fcinfo)
{
 uint64 magicNumber = ((int64) ((fcinfo->args[0].value)));
 int stepCount = ((int32) ((fcinfo->args[1].value)));
 dsm_handle dsmHandle;
 ProgressMonitorData *monitor = CreateProgressMonitor(stepCount,
               sizeof(uint64), &dsmHandle);

 if (monitor != 
# 43 "//./citus/src/backend/distributed/test/progress_utils.c" 3 4
               ((void *)0)
# 43 "//./citus/src/backend/distributed/test/progress_utils.c"
                   )
 {
...
Datum
update_progress(FunctionCallInfo fcinfo)
{
 uint64 step = ((int64) ((fcinfo->args[0].value)));
 uint64 newValue = ((int64) ((fcinfo->args[1].value)));

 ProgressMonitorData *monitor = GetCurrentProgressMonitor();

 if (monitor != 
# 67 "//./citus/src/backend/distributed/test/progress_utils.c" 3 4
               ((void *)0) 
# 67 "//./citus/src/backend/distributed/test/progress_utils.c"
                    && step < monitor->stepCount)
 {
  uint64 *steps = (uint64 *) ProgressMonitorSteps(monitor);
  steps[step] = newValue;
 }
...
Datum
finish_progress(FunctionCallInfo fcinfo)
{
...
Datum
show_progress(FunctionCallInfo fcinfo)
{
 uint64 magicNumber = ((int64) ((fcinfo->args[0].value)));
 List *attachedDSMSegments = ((List *) 
# 90 "//./citus/src/backend/distributed/test/progress_utils.c" 3 4
                            ((void *)0)
# 90 "//./citus/src/backend/distributed/test/progress_utils.c"
                            );
...
# 95 "//./citus/src/backend/distributed/test/progress_utils.c" 3 4
                               ((void *)0)
# 95 "//./citus/src/backend/distributed/test/progress_utils.c"
                                   ;
 for (ListCell *(monitorCellDoNotUse) = list_head(monitorList); (monitorCellDoNotUse) != 
# 96 "//./citus/src/backend/distributed/test/progress_utils.c" 3 4
((void *)0) 
# 96 "//./citus/src/backend/distributed/test/progress_utils.c"
&& (((monitor) = ((monitorCellDoNotUse)->ptr_value)) || 
# 96 "//./citus/src/backend/distributed/test/progress_utils.c" 3 4
1
# 96 "//./citus/src/backend/distributed/test/progress_utils.c"
); monitorCellDoNotUse = lnext(monitorList, monitorCellDoNotUse))
 {
...
# 105 "//./citus/src/backend/distributed/test/progress_utils.c" 3 4
  _Bool 
# 105 "//./citus/src/backend/distributed/test/progress_utils.c"
       nulls[2];

   memset(values, 0, sizeof(values));
   memset(nulls, 0, sizeof(nulls));

   values[0] = ((Datum) (stepIndex));
   values[1] = ((Datum) (step));
