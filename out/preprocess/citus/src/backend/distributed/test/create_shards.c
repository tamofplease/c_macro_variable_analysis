# 0 "//./citus/src/backend/distributed/test/create_shards.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/test/create_shards.c"
# 13 "//./citus/src/backend/distributed/test/create_shards.c"
...
# 14 "//./citus/src/backend/distributed/test/create_shards.c" 2
# 1 "/usr/include/postgresql/14/server/c.h" 1
# 15 "//./citus/src/backend/distributed/test/create_shards.c" 2
...
# 16 "//./citus/src/backend/distributed/test/create_shards.c" 2
...
# 20 "//./citus/src/backend/distributed/test/create_shards.c" 2
...
extern Datum sort_names(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_sort_names(void); const Pg_finfo_record * pg_finfo_sort_names (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
...
Datum
sort_names(FunctionCallInfo fcinfo)
{
 char *first = ((char *) ((Pointer) ((fcinfo->args[0].value))));
 char *second = ((char *) ((Pointer) ((fcinfo->args[1].value))));
 char *third = ((char *) ((Pointer) ((fcinfo->args[2].value))));
 List *nameList = SortList(list_make3_impl(T_List, ((ListCell) {.ptr_value = (first)}), ((ListCell) {.ptr_value = (second)}), ((ListCell) {.ptr_value = (third)})),
         (int (*)(const void *, const void *))(&CompareStrings));
 StringInfo sortedNames = makeStringInfo();

 const char *name = 
# 46 "//./citus/src/backend/distributed/test/create_shards.c" 3 4
                   ((void *)0)
# 46 "//./citus/src/backend/distributed/test/create_shards.c"
                       ;
 for (ListCell *(nameCellDoNotUse) = list_head(nameList); (nameCellDoNotUse) != 
# 47 "//./citus/src/backend/distributed/test/create_shards.c" 3 4
((void *)0) 
# 47 "//./citus/src/backend/distributed/test/create_shards.c"
&& (((name) = ((nameCellDoNotUse)->ptr_value)) || 
# 47 "//./citus/src/backend/distributed/test/create_shards.c" 3 4
1
# 47 "//./citus/src/backend/distributed/test/create_shards.c"
); nameCellDoNotUse = lnext(nameList, nameCellDoNotUse))
 {
  appendStringInfo(sortedNames, "%s\n", name);
 }


 return ((Datum) (sortedNames->data));
}
