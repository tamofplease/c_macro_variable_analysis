# 0 "//./citus/src/backend/distributed/test/pg_send_cancellation.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/test/pg_send_cancellation.c"
# 12 "//./citus/src/backend/distributed/test/pg_send_cancellation.c"
...
# 13 "//./citus/src/backend/distributed/test/pg_send_cancellation.c" 2
...
# 14 "//./citus/src/backend/distributed/test/pg_send_cancellation.c" 2
...
# 15 "//./citus/src/backend/distributed/test/pg_send_cancellation.c" 2
# 1 "/usr/include/postgresql/14/server/port.h" 1
# 16 "//./citus/src/backend/distributed/test/pg_send_cancellation.c" 2

# 1 "/usr/include/postgresql/14/server/postmaster/postmaster.h" 1
# 17 "/usr/include/postgresql/14/server/postmaster/postmaster.h"
extern 
# 17 "/usr/include/postgresql/14/server/postmaster/postmaster.h" 3 4
      _Bool 
# 17 "/usr/include/postgresql/14/server/postmaster/postmaster.h"
           EnableSSL;
...
extern 
# 24 "/usr/include/postgresql/14/server/postmaster/postmaster.h" 3 4
      _Bool 
# 24 "/usr/include/postgresql/14/server/postmaster/postmaster.h"
           ClientAuthInProgress;
extern int PreAuthDelay;
extern int AuthenticationTimeout;
extern 
# 27 "/usr/include/postgresql/14/server/postmaster/postmaster.h" 3 4
      _Bool 
# 27 "/usr/include/postgresql/14/server/postmaster/postmaster.h"
           Log_connections;
extern 
# 28 "/usr/include/postgresql/14/server/postmaster/postmaster.h" 3 4
      _Bool 
# 28 "/usr/include/postgresql/14/server/postmaster/postmaster.h"
           log_hostname;
extern 
# 29 "/usr/include/postgresql/14/server/postmaster/postmaster.h" 3 4
      _Bool 
# 29 "/usr/include/postgresql/14/server/postmaster/postmaster.h"
           enable_bonjour;
extern char *bonjour_name;
extern 
# 31 "/usr/include/postgresql/14/server/postmaster/postmaster.h" 3 4
      _Bool 
# 31 "/usr/include/postgresql/14/server/postmaster/postmaster.h"
           restart_after_crash;
extern 
# 32 "/usr/include/postgresql/14/server/postmaster/postmaster.h" 3 4
      _Bool 
# 32 "/usr/include/postgresql/14/server/postmaster/postmaster.h"
...
# 48 "/usr/include/postgresql/14/server/postmaster/postmaster.h"
extern const char *progname;

extern void PostmasterMain(int argc, char *argv[]) __attribute__((noreturn));
extern void ClosePostmasterPorts(
# 51 "/usr/include/postgresql/14/server/postmaster/postmaster.h" 3 4
                                _Bool 
# 51 "/usr/include/postgresql/14/server/postmaster/postmaster.h"
                                     am_syslogger);
...
extern 
# 56 "/usr/include/postgresql/14/server/postmaster/postmaster.h" 3 4
      _Bool 
# 56 "/usr/include/postgresql/14/server/postmaster/postmaster.h"
           PostmasterMarkPIDForWorkerNotify(int);
# 18 "//./citus/src/backend/distributed/test/pg_send_cancellation.c" 2
...
extern Datum get_cancellation_key(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_get_cancellation_key(void); const Pg_finfo_record * pg_finfo_get_cancellation_key (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum run_pg_send_cancellation(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_run_pg_send_cancellation(void); const Pg_finfo_record * pg_finfo_run_pg_send_cancellation (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
...
Datum
get_cancellation_key(FunctionCallInfo fcinfo)
{
 return ((Datum) (MyCancelKey));
}
...
Datum
run_pg_send_cancellation(FunctionCallInfo fcinfo)
{
 int pid = ((int32) ((fcinfo->args[0].value)));
 int cancelKey = ((int32) ((fcinfo->args[1].value)));

 char sendCancellationPath[1024];
 char command[1024];


 if (find_other_exec(my_exec_path, "pg_send_cancellation",
      "pg_send_cancellation (PostgreSQL) " "14.5 (Ubuntu 14.5-0ubuntu0.22.04.1)" "\n",
      sendCancellationPath) < 0)
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 58 "//./citus/src/backend/distributed/test/pg_send_cancellation.c" 3 4
 ((void *)0)
# 58 "//./citus/src/backend/distributed/test/pg_send_cancellation.c"
 ) : errstart(21, 
# 58 "//./citus/src/backend/distributed/test/pg_send_cancellation.c" 3 4
 ((void *)0)
# 58 "//./citus/src/backend/distributed/test/pg_send_cancellation.c"
 )) (errmsg("could not locate pg_send_cancellation")), errfinish("//./citus/src/backend/distributed/test/pg_send_cancellation.c", 58, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
 }
 ...
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 66 "//./citus/src/backend/distributed/test/pg_send_cancellation.c" 3 4
 ((void *)0)
# 66 "//./citus/src/backend/distributed/test/pg_send_cancellation.c"
 ) : errstart(21, 
# 66 "//./citus/src/backend/distributed/test/pg_send_cancellation.c" 3 4
 ((void *)0)
# 66 "//./citus/src/backend/distributed/test/pg_send_cancellation.c"
 )) (errmsg("failed to run command: %s", command)), errfinish("//./citus/src/backend/distributed/test/pg_send_cancellation.c", 66, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
 }
