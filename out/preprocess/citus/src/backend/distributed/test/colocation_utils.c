# 0 "//./citus/src/backend/distributed/test/colocation_utils.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/distributed/test/colocation_utils.c"
# 13 "//./citus/src/backend/distributed/test/colocation_utils.c"
...
# 14 "//./citus/src/backend/distributed/test/colocation_utils.c" 2
...
# 15 "//./citus/src/backend/distributed/test/colocation_utils.c" 2

# 1 "/usr/include/postgresql/14/server/catalog/pg_type.h" 1
# 21 "/usr/include/postgresql/14/server/catalog/pg_type.h"
# 1 "/usr/include/postgresql/14/server/catalog/genbki.h" 1
# 22 "/usr/include/postgresql/14/server/catalog/pg_type.h" 2
...
extern char *makeMultirangeTypeName(const char *rangeTypeName,
         Oid typeNamespace);
# 17 "//./citus/src/backend/distributed/test/colocation_utils.c" 2
# 1 "//./citus/src/include/distributed/colocation_utils.h" 1
# 15 "//./citus/src/include/distributed/colocation_utils.h"
...
# 17 "/usr/include/postgresql/14/server/utils/guc.h"
...
# 16 "//./citus/src/include/distributed/colocation_utils.h" 2
...
extern 
# 21 "//./citus/src/include/distributed/colocation_utils.h" 3 4
      _Bool 
# 21 "//./citus/src/include/distributed/colocation_utils.h"
           TablesColocated(Oid leftDistributedTableId, Oid rightDistributedTableId);
extern 
# 22 "//./citus/src/include/distributed/colocation_utils.h" 3 4
      _Bool 
# 22 "//./citus/src/include/distributed/colocation_utils.h"
           ShardsColocated(ShardInterval *leftShardInterval,
...
extern void InsertColocationGroupLocally(uint32 colocationId, int shardCount,
           ...
           Oid distributionColumnCollation);
extern 
# 38 "//./citus/src/include/distributed/colocation_utils.h" 3 4
      _Bool 
# 38 "//./citus/src/include/distributed/colocation_utils.h"
           IsColocateWithNone(char *colocateWithTableName);
extern 
# 39 "//./citus/src/include/distributed/colocation_utils.h" 3 4
      _Bool 
# 39 "//./citus/src/include/distributed/colocation_utils.h"
...
# 48 "//./citus/src/include/distributed/colocation_utils.h" 3 4
           _Bool 
# 48 "//./citus/src/include/distributed/colocation_utils.h"
                localOnly);
...
extern uint32 FindColocateWithColocationId(Oid relationId, char replicationModel,
             ...
             Oid distributionColumnCollation,
             int shardCount, 
# 55 "//./citus/src/include/distributed/colocation_utils.h" 3 4
                            _Bool 
# 55 "//./citus/src/include/distributed/colocation_utils.h"
                                 shardCountIsStrict,
...
# 18 "//./citus/src/backend/distributed/test/colocation_utils.c" 2
...
# 19 "//./citus/src/backend/distributed/test/colocation_utils.c" 2

# 1 "//./citus/src/include/distributed/utils/array_type.h" 1
# 19 "//./citus/src/include/distributed/utils/array_type.h"
...
# 21 "//./citus/src/backend/distributed/test/colocation_utils.c" 2



extern Datum get_table_colocation_id(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_get_table_colocation_id(void); const Pg_finfo_record * pg_finfo_get_table_colocation_id (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum tables_colocated(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_tables_colocated(void); const Pg_finfo_record * pg_finfo_tables_colocated (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum shards_colocated(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_shards_colocated(void); const Pg_finfo_record * pg_finfo_shards_colocated (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum get_colocated_table_array(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_get_colocated_table_array(void); const Pg_finfo_record * pg_finfo_get_colocated_table_array (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum find_shard_interval_index(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_find_shard_interval_index(void); const Pg_finfo_record * pg_finfo_find_shard_interval_index (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
...
Datum
get_table_colocation_id(FunctionCallInfo fcinfo)
{
 Oid distributedTableId = ((Oid) ((fcinfo->args[0].value)));
 uint32 colocationId = TableColocationId(distributedTableId);

 return ((Datum) (colocationId));
}
...
Datum
tables_colocated(FunctionCallInfo fcinfo)
{
 Oid leftDistributedTableId = ((Oid) ((fcinfo->args[0].value)));
 Oid rightDistributedTableId = ((Oid) ((fcinfo->args[1].value)));
 
# 53 "//./citus/src/backend/distributed/test/colocation_utils.c" 3 4
_Bool 
# 53 "//./citus/src/backend/distributed/test/colocation_utils.c"
     tablesColocated = TablesColocated(leftDistributedTableId,
             rightDistributedTableId);

 return ((Datum) ((tablesColocated) ? 1 : 0));
}
...
Datum
shards_colocated(FunctionCallInfo fcinfo)
{
 uint32 leftShardId = ((uint32) ((fcinfo->args[0].value)));
 uint32 rightShardId = ((uint32) ((fcinfo->args[1].value)));
 ShardInterval *leftShard = LoadShardInterval(leftShardId);
 ShardInterval *rightShard = LoadShardInterval(rightShardId);

 
# 72 "//./citus/src/backend/distributed/test/colocation_utils.c" 3 4
_Bool 
# 72 "//./citus/src/backend/distributed/test/colocation_utils.c"
     shardsColocated = ShardsColocated(leftShard, rightShard);

 return ((Datum) ((shardsColocated) ? 1 : 0));
}
...
Datum
get_colocated_table_array(FunctionCallInfo fcinfo)
{
 Oid distributedTableId = ((Oid) ((fcinfo->args[0].value)));
 ...
 Oid colocatedTableId = ((Oid) 0);
 for (ListCell *(colocatedTableIdCellDoNotUse) = list_head(colocatedTableList); (colocatedTableIdCellDoNotUse) != 
# 94 "//./citus/src/backend/distributed/test/colocation_utils.c" 3 4
((void *)0) 
# 94 "//./citus/src/backend/distributed/test/colocation_utils.c"
&& (((colocatedTableId) = ((colocatedTableIdCellDoNotUse)->oid_value)) || 
# 94 "//./citus/src/backend/distributed/test/colocation_utils.c" 3 4
1
# 94 "//./citus/src/backend/distributed/test/colocation_utils.c"
); colocatedTableIdCellDoNotUse = lnext(colocatedTableList, colocatedTableIdCellDoNotUse))
 {
  Datum colocatedTableDatum = ((Datum) (colocatedTableId));
 ...
 return ((Datum) (colocatedTablesArrayType));
}
...
Datum
find_shard_interval_index(FunctionCallInfo fcinfo)
{
 uint32 shardId = ((uint32) ((fcinfo->args[0].value)));
