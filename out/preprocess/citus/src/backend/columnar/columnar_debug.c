# 0 "//./citus/src/backend/columnar/columnar_debug.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/columnar_debug.c"
# 11 "//./citus/src/backend/columnar/columnar_debug.c"
...
# 12 "//./citus/src/backend/columnar/columnar_debug.c" 2
...
# 346 "/usr/include/postgresql/14/server/funcapi.h"
                           **nulls);
# 14 "//./citus/src/backend/columnar/columnar_debug.c" 2
...
# 18 "/usr/include/postgresql/14/server/access/genam.h"
...
extern void ScanKeyEntryInitializeWithInfo(ScanKey entry,
             ...
             FmgrInfo *finfo,
             Datum argument);
# 19 "/usr/include/postgresql/14/server/access/genam.h" 2
...
# 21 "/usr/include/postgresql/14/server/access/genam.h" 2
...
# 20 "/usr/include/postgresql/14/server/access/tableam.h"
...
# 21 "/usr/include/postgresql/14/server/access/tableam.h" 2
...
# 2072 "/usr/include/postgresql/14/server/access/tableam.h"
           check_default_table_access_method(char **newval, void **extra,
             GucSource source);
# 21 "/usr/include/postgresql/14/server/access/nbtree.h" 2
...
# 27 "/usr/include/postgresql/14/server/access/nbtree.h" 2
...
# 15 "//./citus/src/backend/columnar/columnar_debug.c" 2
...
# 16 "//./citus/src/backend/columnar/columnar_debug.c" 2
...
extern int no_such_variable;
# 17 "//./citus/src/backend/columnar/columnar_debug.c" 2
...
extern char *makeMultirangeTypeName(const char *rangeTypeName,
         Oid typeNamespace);
# 18 "//./citus/src/backend/columnar/columnar_debug.c" 2
# 1 "//./citus/src/include/distributed/pg_version_constants.h" 1
# 19 "//./citus/src/backend/columnar/columnar_debug.c" 2
...
# 20 "//./citus/src/backend/columnar/columnar_debug.c" 2
...
# 22 "//./citus/src/backend/columnar/columnar_debug.c" 2
...
# 29 "//./citus/src/include/pg_version_compat.h"
...
# 28 "//./citus/src/backend/columnar/columnar_debug.c" 2
...
# 29 "//./citus/src/backend/columnar/columnar_debug.c" 2
...
# 11 "//./citus/src/include/columnar/columnar_tableam.h" 2
...
# 30 "//./citus/src/backend/columnar/columnar_debug.c" 2
# 1 "//./citus/src/include/columnar/columnar_version_compat.h" 1
# 31 "//./citus/src/backend/columnar/columnar_debug.c" 2

static void MemoryContextTotals(MemoryContext context, MemoryContextCounters *counters);

extern Datum columnar_store_memory_stats(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_columnar_store_memory_stats(void); const Pg_finfo_record * pg_finfo_columnar_store_memory_stats (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
extern Datum columnar_storage_info(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_columnar_storage_info(void); const Pg_finfo_record * pg_finfo_columnar_storage_info (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
...
Datum
columnar_store_memory_stats(FunctionCallInfo fcinfo)
{
...
# 65 "//./citus/src/backend/columnar/columnar_debug.c" 3 4
_Bool 
# 65 "//./citus/src/backend/columnar/columnar_debug.c"
     nulls[3] = { 
# 65 "//./citus/src/backend/columnar/columnar_debug.c" 3 4
                  0 
# 65 "//./citus/src/backend/columnar/columnar_debug.c"
 ...
 Datum values[3] = {
  ((Datum) (topCounters.totalspace)),
  ((Datum) (transactionCounters.totalspace)),
  ((Datum) (writeStateCounters.totalspace))
 };
...
# 93 "//./citus/src/backend/columnar/columnar_debug.c"
Datum
columnar_storage_info(FunctionCallInfo fcinfo)
{

 Oid relid = ((Oid) ((fcinfo->args[0].value)));
 TupleDesc tupdesc;


 if (get_call_result_type(fcinfo, 
# 101 "//./citus/src/backend/columnar/columnar_debug.c" 3 4
                                 ((void *)0)
# 101 "//./citus/src/backend/columnar/columnar_debug.c"
                                     , &tupdesc) != TYPEFUNC_COMPOSITE)
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 103 "//./citus/src/backend/columnar/columnar_debug.c" 3 4
 ((void *)0)
# 103 "//./citus/src/backend/columnar/columnar_debug.c"
 ) : errstart(21, 
# 103 "//./citus/src/backend/columnar/columnar_debug.c" 3 4
 ((void *)0)
# 103 "//./citus/src/backend/columnar/columnar_debug.c"
 )) errmsg_internal("return type must be a row type"), errfinish("//./citus/src/backend/columnar/columnar_debug.c", 103, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
 }

 if (tupdesc->natts != 6)
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 108 "//./citus/src/backend/columnar/columnar_debug.c" 3 4
 ((void *)0)
# 108 "//./citus/src/backend/columnar/columnar_debug.c"
 ) : errstart(21, 
# 108 "//./citus/src/backend/columnar/columnar_debug.c" 3 4
 ((void *)0)
# 108 "//./citus/src/backend/columnar/columnar_debug.c"
 )) errmsg_internal("return type must have %d columns", 6), errfinish("//./citus/src/backend/columnar/columnar_debug.c", 108, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
 }

 Relation rel = table_open(relid, 1);
 if (!IsColumnarTableAmTable(relid))
 {
  do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 114 "//./citus/src/backend/columnar/columnar_debug.c" 3 4
 ((void *)0)
# 114 "//./citus/src/backend/columnar/columnar_debug.c"
 ) : errstart(21, 
# 114 "//./citus/src/backend/columnar/columnar_debug.c" 3 4
 ((void *)0)
# 114 "//./citus/src/backend/columnar/columnar_debug.c"
 )) (errmsg("table \"%s\" is not a columnar table", ((((rel)->rd_rel->relname).data)))), errfinish("//./citus/src/backend/columnar/columnar_debug.c", 114, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
                                         ;
 }

 Datum values[6] = { 0 };
 
# 119 "//./citus/src/backend/columnar/columnar_debug.c" 3 4
_Bool 
# 119 "//./citus/src/backend/columnar/columnar_debug.c"
     nulls[6] = { 0 };
# 128 "//./citus/src/backend/columnar/columnar_debug.c"
 values[0] = ((Datum) (ColumnarStorageGetVersionMajor(rel, 
# 128 "//./citus/src/backend/columnar/columnar_debug.c" 3 4
            1
# 128 "//./citus/src/backend/columnar/columnar_debug.c"
            )));
 values[1] = ((Datum) (ColumnarStorageGetVersionMinor(rel, 
# 129 "//./citus/src/backend/columnar/columnar_debug.c" 3 4
            1
# 129 "//./citus/src/backend/columnar/columnar_debug.c"
            )));
 values[2] = ((Datum) (ColumnarStorageGetStorageId(rel, 
# 130 "//./citus/src/backend/columnar/columnar_debug.c" 3 4
            1
# 130 "//./citus/src/backend/columnar/columnar_debug.c"
            )));
 values[3] = ((Datum) (ColumnarStorageGetReservedStripeId(rel, 
# 131 "//./citus/src/backend/columnar/columnar_debug.c" 3 4
            1
# 131 "//./citus/src/backend/columnar/columnar_debug.c"
            )));
 values[4] = ((Datum) (ColumnarStorageGetReservedRowNumber(rel, 
# 132 "//./citus/src/backend/columnar/columnar_debug.c" 3 4
            1
# 132 "//./citus/src/backend/columnar/columnar_debug.c"
            )));
 values[5] = ((Datum) (ColumnarStorageGetReservedOffset(rel, 
# 133 "//./citus/src/backend/columnar/columnar_debug.c" 3 4
            1
# 133 "//./citus/src/backend/columnar/columnar_debug.c"
            )));
...
{
 if (context == 
# 151 "//./citus/src/backend/columnar/columnar_debug.c" 3 4
               ((void *)0)
# 151 "//./citus/src/backend/columnar/columnar_debug.c"
                   )
 {
  return;
 }
 ...
 MemoryContext child;
 for (child = context->firstchild; child != 
# 157 "//./citus/src/backend/columnar/columnar_debug.c" 3 4
                                           ((void *)0)
# 157 "//./citus/src/backend/columnar/columnar_debug.c"
...
# 162 "//./citus/src/backend/columnar/columnar_debug.c" 3 4
                  ((void *)0)
# 162 "//./citus/src/backend/columnar/columnar_debug.c"
                  , 
# 162 "//./citus/src/backend/columnar/columnar_debug.c" 3 4
                  ((void *)0)
# 162 "//./citus/src/backend/columnar/columnar_debug.c"
