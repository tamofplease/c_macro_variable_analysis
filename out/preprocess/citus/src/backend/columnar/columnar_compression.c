# 0 "//./citus/src/backend/columnar/columnar_compression.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/columnar_compression.c"
# 14 "//./citus/src/backend/columnar/columnar_compression.c"
...
# 15 "//./citus/src/backend/columnar/columnar_compression.c" 2

# 1 "//./citus/src/include/citus_version.h" 1
# 17 "//./citus/src/backend/columnar/columnar_compression.c" 2
# 1 "/usr/include/postgresql/14/server/common/pg_lzcompress.h" 1
# 57 "/usr/include/postgresql/14/server/common/pg_lzcompress.h"
...
# 78 "/usr/include/postgresql/14/server/common/pg_lzcompress.h"
...
extern int32 pglz_decompress(const char *source, int32 slen, char *dest,
        int32 rawsize, 
# 89 "/usr/include/postgresql/14/server/common/pg_lzcompress.h" 3 4
                      _Bool 
# 89 "/usr/include/postgresql/14/server/common/pg_lzcompress.h"
                           check_complete);
extern int32 pglz_maximum_compressed_size(int32 rawsize,
            int32 total_compressed_size);
# 18 "//./citus/src/backend/columnar/columnar_compression.c" 2
...
# 19 "//./citus/src/backend/columnar/columnar_compression.c" 2
...
# 21 "//./citus/src/backend/columnar/columnar_compression.c" 2
# 34 "//./citus/src/backend/columnar/columnar_compression.c"
typedef struct ColumnarCompressHeader
{
 int32 vl_len_;
 int32 rawsize;
} ColumnarCompressHeader;
# 58 "//./citus/src/backend/columnar/columnar_compression.c"

# 58 "//./citus/src/backend/columnar/columnar_compression.c" 3 4
_Bool

# 59 "//./citus/src/backend/columnar/columnar_compression.c"
CompressBuffer(StringInfo inputBuffer,
      StringInfo outputBuffer,
      CompressionType compressionType,
      int compressionLevel)
{
 ...
 {
# 119 "//./citus/src/backend/columnar/columnar_compression.c"
  case COMPRESSION_PG_LZ:
  {
   uint64 maximumLength = ((inputBuffer->len) + 4) +
           ((int32) sizeof(ColumnarCompressHeader));
   
# 123 "//./citus/src/backend/columnar/columnar_compression.c" 3 4
  _Bool 
# 123 "//./citus/src/backend/columnar/columnar_compression.c"
       compressionResult = 
# 123 "//./citus/src/backend/columnar/columnar_compression.c" 3 4
                           0
# 123 "//./citus/src/backend/columnar/columnar_compression.c"
   ...
   int32 compressedByteCount = pglz_compress((const char *) inputBuffer->data,
               inputBuffer->len,
               (((char *) (outputBuffer->data)) + ((int32) sizeof(ColumnarCompressHeader)))
                                   ,
               PGLZ_strategy_always);
   if (compressedByteCount >= 0)
   {
    (((ColumnarCompressHeader *) (outputBuffer->data))->rawsize = (inputBuffer->len));
    (((varattrib_4b *) (outputBuffer->data))->va_4byte.va_header = (((uint32) (compressedByteCount + ((int32) sizeof(ColumnarCompressHeader)))) << 2) | 0x02)
                                                          ;
    compressionResult = 
# 138 "//./citus/src/backend/columnar/columnar_compression.c" 3 4
                       1
# 138 "//./citus/src/backend/columnar/columnar_compression.c"
                           ;
   }

   if (compressionResult)
   {
    outputBuffer->len = ((((varattrib_4b *) (outputBuffer->data))->va_4byte.va_header >> 2) & 0x3FFFFFFF);
   }
  ...
  {
   return 
# 151 "//./citus/src/backend/columnar/columnar_compression.c" 3 4
         0
# 151 "//./citus/src/backend/columnar/columnar_compression.c"
              ;
  }
 }
}
...
# 227 "//./citus/src/backend/columnar/columnar_compression.c"
  case COMPRESSION_PG_LZ:
  {
   uint32 compressedDataSize = ((((varattrib_4b *) (buffer->data))->va_4byte.va_header >> 2) & 0x3FFFFFFF) - ((int32) sizeof(ColumnarCompressHeader));
   uint32 decompressedDataSize = (((ColumnarCompressHeader *) (buffer->data))->rawsize);

   if (compressedDataSize + ((int32) sizeof(ColumnarCompressHeader)) != buffer->len)
   {
    do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 234 "//./citus/src/backend/columnar/columnar_compression.c" 3 4
   ((void *)0)
# 234 "//./citus/src/backend/columnar/columnar_compression.c"
   ) : errstart(21, 
# 234 "//./citus/src/backend/columnar/columnar_compression.c" 3 4
   ((void *)0)
# 234 "//./citus/src/backend/columnar/columnar_compression.c"
   )) (errmsg("cannot decompress the buffer"), errdetail("Expected %u bytes, but received %u bytes", compressedDataSize, buffer->len)), errfinish("//./citus/src/backend/columnar/columnar_compression.c", 234, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
   ...
   int32 decompressedByteCount = pglz_decompress((((char *) (buffer->data)) + ((int32) sizeof(ColumnarCompressHeader)))
                              ,
                compressedDataSize,
                decompressedData,
                decompressedDataSize, 
# 245 "//./citus/src/backend/columnar/columnar_compression.c" 3 4
                                     1
# 245 "//./citus/src/backend/columnar/columnar_compression.c"
                                         );

   if (decompressedByteCount < 0)
   {
    do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 249 "//./citus/src/backend/columnar/columnar_compression.c" 3 4
   ((void *)0)
# 249 "//./citus/src/backend/columnar/columnar_compression.c"
   ) : errstart(21, 
# 249 "//./citus/src/backend/columnar/columnar_compression.c" 3 4
   ((void *)0)
# 249 "//./citus/src/backend/columnar/columnar_compression.c"
   )) (errmsg("cannot decompress the buffer"), errdetail("compressed data is corrupted")), errfinish("//./citus/src/backend/columnar/columnar_compression.c", 249, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0)
                                                   ;
   }
  ...
  {
   do { int __errno_location __attribute__((unused)); if (__builtin_constant_p(21) && (21) >= 21 ? errstart_cold(21, 
# 263 "//./citus/src/backend/columnar/columnar_compression.c" 3 4
  ((void *)0)
# 263 "//./citus/src/backend/columnar/columnar_compression.c"
  ) : errstart(21, 
# 263 "//./citus/src/backend/columnar/columnar_compression.c" 3 4
  ((void *)0)
# 263 "//./citus/src/backend/columnar/columnar_compression.c"
  )) (errmsg("unexpected compression type: %d", compressionType)), errfinish("//./citus/src/backend/columnar/columnar_compression.c", 263, __func__); if (__builtin_constant_p(21) && (21) >= 21) __builtin_unreachable(); } while(0);
  }
 }
}
