# 0 "//./citus/src/backend/columnar/safeclib/strcpy_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/safeclib/strcpy_s.c"
# 32 "//./citus/src/backend/columnar/safeclib/strcpy_s.c"
...
# 33 "//./citus/src/backend/columnar/safeclib/strcpy_s.c" 2
...
# 34 "//./citus/src/backend/columnar/safeclib/strcpy_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/columnar/safeclib/strcpy_s.c" 2
# 93 "//./citus/src/backend/columnar/safeclib/strcpy_s.c"
errno_t
strcpy_s (char *dest, rsize_t dmax, const char *src)
{
    rsize_t orig_dmax;
    ...
    if (dest == 
# 100 "//./citus/src/backend/columnar/safeclib/strcpy_s.c" 3 4
               ((void *)0)
# 100 "//./citus/src/backend/columnar/safeclib/strcpy_s.c"
                   ) {
        invoke_safe_str_constraint_handler("strcpy_s: dest is null",
                   
# 102 "//./citus/src/backend/columnar/safeclib/strcpy_s.c" 3 4
                  ((void *)0)
# 102 "//./citus/src/backend/columnar/safeclib/strcpy_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 108 "//./citus/src/backend/columnar/safeclib/strcpy_s.c" 3 4
                  ((void *)0)
# 108 "//./citus/src/backend/columnar/safeclib/strcpy_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 114 "//./citus/src/backend/columnar/safeclib/strcpy_s.c" 3 4
                  ((void *)0)
# 114 "//./citus/src/backend/columnar/safeclib/strcpy_s.c"
                      , ( 403 ));
        return (( 403 ));
    }

    if (src == 
# 118 "//./citus/src/backend/columnar/safeclib/strcpy_s.c" 3 4
              ((void *)0)
# 118 "//./citus/src/backend/columnar/safeclib/strcpy_s.c"
                  ) {
...
# 126 "//./citus/src/backend/columnar/safeclib/strcpy_s.c" 3 4
                  ((void *)0)
# 126 "//./citus/src/backend/columnar/safeclib/strcpy_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
