# 0 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c"
# 34 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c"
...
# 35 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c" 2
...
extern void invoke_safe_mem_constraint_handler(
                           ...
                           void *ptr,
                           errno_t error);
# 36 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_mem_lib.h" 1
# 37 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c" 2
# 91 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c"
errno_t
            ...
            const wchar_t *src, rsize_t smax, int *diff)
{
    ...
    if (diff == 
# 98 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c" 3 4
               ((void *)0)
# 98 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c"
                   ) {
        invoke_safe_mem_constraint_handler("wmemcmp_s: diff is null",
                   
# 100 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c" 3 4
                  ((void *)0)
# 100 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c"
                      , ( 400 ));
        return ((( 400 )));
    }
    *diff = -1;
    ...
    if (dest == 
# 106 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c" 3 4
               ((void *)0)
# 106 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c"
                   ) {
        invoke_safe_mem_constraint_handler("wmemcmp_s: dest is null",
                   
# 108 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c" 3 4
                  ((void *)0)
# 108 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c"
                      , ( 400 ));
        return ((( 400 )));
    }

    if (src == 
# 112 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c" 3 4
              ((void *)0)
# 112 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c"
                  ) {
        invoke_safe_mem_constraint_handler("wmemcmp_s: src is null",
                   
# 114 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c" 3 4
                  ((void *)0)
# 114 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c"
                      , ( 400 ));
        return ((( 400 )));
    }
...
# 120 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c" 3 4
                  ((void *)0)
# 120 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c"
                      , ( 401 ));
        return ((( 401 )));
    }
...
# 126 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c" 3 4
                  ((void *)0)
# 126 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c"
                      , ( 403 ));
        return ((( 403 )));
    }
...
# 132 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c" 3 4
                  ((void *)0)
# 132 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c"
                      , ( 401 ));
        return ((( 401 )));
    }
...
# 138 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c" 3 4
                 ((void *)0)
# 138 "//./citus/src/backend/columnar/safeclib/wmemcmp_s.c"
                     , ( 403 ));
       return ((( 403 )));
    }
