# 0 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c"
# 32 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c"
...
# 33 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c" 2
...
extern void invoke_safe_mem_constraint_handler(
                           ...
                           void *ptr,
                           errno_t error);
# 34 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c" 2
...
# 35 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_mem_lib.h" 1
# 36 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c" 2
# 95 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c"
errno_t
wmemmove_s(wchar_t* dest, rsize_t dmax, const wchar_t* src, size_t smax)
{
    ...
    if (dp == 
# 104 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c" 3 4
             ((void *)0)
# 104 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c"
                 ) {
        invoke_safe_mem_constraint_handler("wmemmove_s: dest is null",
                   
# 106 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c" 3 4
                  ((void *)0)
# 106 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c"
                      , ( 400 ));
        return ((( 400 )));
    }
...
# 112 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c" 3 4
                  ((void *)0)
# 112 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c"
                      , ( 401 ));
        return ((( 401 )));
    }
...
# 118 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c" 3 4
                  ((void *)0)
# 118 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c"
                      , ( 403 ));
        return ((( 403 )));
    }
...
# 125 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c" 3 4
                  ((void *)0)
# 125 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c"
                      , ( 401 ));
        return ((( 401 )));
    }
...
# 132 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c" 3 4
                  ((void *)0)
# 132 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c"
                      , ( 403 ));
        return ((( 403 )));
    }

    if (sp == 
# 136 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c" 3 4
             ((void *)0)
# 136 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c"
                 ) {
        mem_prim_set(dp, dmax*sizeof(wchar_t), 0);
        invoke_safe_mem_constraint_handler("wmemmove_s: src is null",
                   
# 139 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c" 3 4
                  ((void *)0)
# 139 "//./citus/src/backend/columnar/safeclib/wmemmove_s.c"
                      , ( 400 ));
        return ((( 400 )));
    }
