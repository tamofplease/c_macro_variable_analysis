# 0 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c"
# 32 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c"
...
# 33 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c" 2
...
# 34 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c" 2
# 93 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c"
errno_t
strcmpfld_s (const char *dest, rsize_t dmax,
             const char *src, int *indicator)
{
    if (indicator == 
# 97 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c" 3 4
                    ((void *)0)
# 97 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c"
                        ) {
        invoke_safe_str_constraint_handler("strcmpfld_s: indicator is null",
                   
# 99 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c" 3 4
                  ((void *)0)
# 99 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
    *indicator = 0;
    ...
    if (dest == 
# 104 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c" 3 4
               ((void *)0)
# 104 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c"
                   ) {
        invoke_safe_str_constraint_handler("strcmpfld_s: dest is null",
                   
# 106 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c" 3 4
                  ((void *)0)
# 106 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c"
                      , ( 400 ));
        return (( 400 ));
    }

    if (src == 
# 110 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c" 3 4
              ((void *)0)
# 110 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c"
                  ) {
        invoke_safe_str_constraint_handler("strcmpfld_s: src is null",
                   
# 112 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c" 3 4
                  ((void *)0)
# 112 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 118 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c" 3 4
                  ((void *)0)
# 118 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 124 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c" 3 4
                  ((void *)0)
# 124 "//./citus/src/backend/columnar/safeclib/strcmpfld_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
