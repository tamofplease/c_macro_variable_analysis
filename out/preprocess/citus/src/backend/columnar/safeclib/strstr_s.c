# 0 "//./citus/src/backend/columnar/safeclib/strstr_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/safeclib/strstr_s.c"
# 32 "//./citus/src/backend/columnar/safeclib/strstr_s.c"
...
# 33 "//./citus/src/backend/columnar/safeclib/strstr_s.c" 2
...
# 34 "//./citus/src/backend/columnar/safeclib/strstr_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/columnar/safeclib/strstr_s.c" 2
# 87 "//./citus/src/backend/columnar/safeclib/strstr_s.c"
errno_t
strstr_s (char *dest, rsize_t dmax,
          const char *src, rsize_t slen, char **substring)
{
    ...
    if (substring == 
# 95 "//./citus/src/backend/columnar/safeclib/strstr_s.c" 3 4
                    ((void *)0)
# 95 "//./citus/src/backend/columnar/safeclib/strstr_s.c"
                        ) {
        invoke_safe_str_constraint_handler("strstr_s: substring is null",
                   
# 97 "//./citus/src/backend/columnar/safeclib/strstr_s.c" 3 4
                  ((void *)0)
# 97 "//./citus/src/backend/columnar/safeclib/strstr_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
    *substring = 
# 100 "//./citus/src/backend/columnar/safeclib/strstr_s.c" 3 4
                ((void *)0)
# 100 "//./citus/src/backend/columnar/safeclib/strstr_s.c"
                    ;

    if (dest == 
# 102 "//./citus/src/backend/columnar/safeclib/strstr_s.c" 3 4
               ((void *)0)
# 102 "//./citus/src/backend/columnar/safeclib/strstr_s.c"
                   ) {
        invoke_safe_str_constraint_handler("strstr_s: dest is null",
                   
# 104 "//./citus/src/backend/columnar/safeclib/strstr_s.c" 3 4
                  ((void *)0)
# 104 "//./citus/src/backend/columnar/safeclib/strstr_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 110 "//./citus/src/backend/columnar/safeclib/strstr_s.c" 3 4
                  ((void *)0)
# 110 "//./citus/src/backend/columnar/safeclib/strstr_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 116 "//./citus/src/backend/columnar/safeclib/strstr_s.c" 3 4
                  ((void *)0)
# 116 "//./citus/src/backend/columnar/safeclib/strstr_s.c"
                      , ( 403 ));
        return (( 403 ));
    }

    if (src == 
# 120 "//./citus/src/backend/columnar/safeclib/strstr_s.c" 3 4
              ((void *)0)
# 120 "//./citus/src/backend/columnar/safeclib/strstr_s.c"
                  ) {
        invoke_safe_str_constraint_handler("strstr_s: src is null",
                   
# 122 "//./citus/src/backend/columnar/safeclib/strstr_s.c" 3 4
                  ((void *)0)
# 122 "//./citus/src/backend/columnar/safeclib/strstr_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 128 "//./citus/src/backend/columnar/safeclib/strstr_s.c" 3 4
                  ((void *)0)
# 128 "//./citus/src/backend/columnar/safeclib/strstr_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 134 "//./citus/src/backend/columnar/safeclib/strstr_s.c" 3 4
                  ((void *)0)
# 134 "//./citus/src/backend/columnar/safeclib/strstr_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
    ...
    *substring = 
# 176 "//./citus/src/backend/columnar/safeclib/strstr_s.c" 3 4
                ((void *)0)
# 176 "//./citus/src/backend/columnar/safeclib/strstr_s.c"
                    ;
    return (( 409 ));
}
