# 0 "//./citus/src/backend/columnar/safeclib/strishex_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/safeclib/strishex_s.c"
# 32 "//./citus/src/backend/columnar/safeclib/strishex_s.c"
...
# 33 "//./citus/src/backend/columnar/safeclib/strishex_s.c" 2
...
# 34 "//./citus/src/backend/columnar/safeclib/strishex_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/columnar/safeclib/strishex_s.c" 2
# 79 "//./citus/src/backend/columnar/safeclib/strishex_s.c"

# 79 "//./citus/src/backend/columnar/safeclib/strishex_s.c" 3 4
_Bool

# 80 "//./citus/src/backend/columnar/safeclib/strishex_s.c"
strishex_s (const char *dest, rsize_t dmax)
{
    if (!dest) {
        invoke_safe_str_constraint_handler("strishex_s: dest is null",
                   
# 84 "//./citus/src/backend/columnar/safeclib/strishex_s.c" 3 4
                  ((void *)0)
# 84 "//./citus/src/backend/columnar/safeclib/strishex_s.c"
                      , ( 400 ));
        return (
# 85 "//./citus/src/backend/columnar/safeclib/strishex_s.c" 3 4
               0
# 85 "//./citus/src/backend/columnar/safeclib/strishex_s.c"
                    );
    }
...
# 90 "//./citus/src/backend/columnar/safeclib/strishex_s.c" 3 4
                  ((void *)0)
# 90 "//./citus/src/backend/columnar/safeclib/strishex_s.c"
                      , ( 401 ));
        return (
# 91 "//./citus/src/backend/columnar/safeclib/strishex_s.c" 3 4
               0
# 91 "//./citus/src/backend/columnar/safeclib/strishex_s.c"
                    );
    }
...
# 96 "//./citus/src/backend/columnar/safeclib/strishex_s.c" 3 4
                  ((void *)0)
# 96 "//./citus/src/backend/columnar/safeclib/strishex_s.c"
                      , ( 403 ));
        return (
# 97 "//./citus/src/backend/columnar/safeclib/strishex_s.c" 3 4
               0
# 97 "//./citus/src/backend/columnar/safeclib/strishex_s.c"
                    );
    }

    if (*dest == '\0') {
        return (
# 101 "//./citus/src/backend/columnar/safeclib/strishex_s.c" 3 4
               0
# 101 "//./citus/src/backend/columnar/safeclib/strishex_s.c"
                    );
    }
    ...
    while (*dest && dmax) {
        ...
        if (((*dest >= '0') && (*dest <= '9')) ||
            ...
            return (
# 113 "//./citus/src/backend/columnar/safeclib/strishex_s.c" 3 4
                   0
# 113 "//./citus/src/backend/columnar/safeclib/strishex_s.c"
                        );
        }
    }

    return (
# 117 "//./citus/src/backend/columnar/safeclib/strishex_s.c" 3 4
           1
# 117 "//./citus/src/backend/columnar/safeclib/strishex_s.c"
               );
}
