# 0 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c"
# 32 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c"
...
# 33 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c" 2
...
# 34 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c" 2
# 92 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c"
errno_t
strcpyfld_s (char *dest, rsize_t dmax, const char *src, rsize_t slen)
{
    rsize_t orig_dmax;
    ...
    if (dest == 
# 99 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c" 3 4
               ((void *)0)
# 99 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c"
                   ) {
        invoke_safe_str_constraint_handler("strcpyfld_s: dest is null",
                   
# 101 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c" 3 4
                  ((void *)0)
# 101 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 107 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c" 3 4
                  ((void *)0)
# 107 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 113 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c" 3 4
                  ((void *)0)
# 113 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c"
                      , ( 403 ));
        return (( 403 ));
    }

    if (src == 
# 117 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c" 3 4
              ((void *)0)
# 117 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c"
                  ) {
...
# 122 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c" 3 4
                  ((void *)0)
# 122 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 131 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c" 3 4
                  ((void *)0)
# 131 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 140 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c" 3 4
                  ((void *)0)
# 140 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
...
# 163 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c" 3 4
                          ((void *)0)
# 163 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c"
                              , ( 404 ));
                return (( 404 ));
            }
...
# 186 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c" 3 4
                          ((void *)0)
# 186 "//./citus/src/backend/columnar/safeclib/strcpyfld_s.c"
                              , ( 404 ));
                return (( 404 ));
            }
