# 0 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
# 32 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
# 1 "//./citus/src/backend/columnar/safeclib/safeclib_private.h" 1
# 35 "//./citus/src/backend/columnar/safeclib/safeclib_private.h"
# 1 "//./citus/src/include/citus_config.h" 1
# 36 "//./citus/src/backend/columnar/safeclib/safeclib_private.h" 2
# 57 "//./citus/src/backend/columnar/safeclib/safeclib_private.h"
...
# 58 "//./citus/src/backend/columnar/safeclib/safeclib_private.h" 2
# 92 "//./citus/src/backend/columnar/safeclib/safeclib_private.h"
...
# 93 "//./citus/src/backend/columnar/safeclib/safeclib_private.h" 2
# 33 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 2
# 1 "//./citus/src/backend/columnar/safeclib/safe_str_constraint.h" 1
# 41 "//./citus/src/backend/columnar/safeclib/safe_str_constraint.h"
...
# 60 "//./citus/src/backend/columnar/safeclib/safe_str_constraint.h" 3 4
                                               ((void *)0)
# 60 "//./citus/src/backend/columnar/safeclib/safe_str_constraint.h"
                                                   , err_code);
    return;
}
                                ...
                                char *err_msg, errno_t err_code)
{
    ...
    *orig_dest = L'\0';
    ...
    invoke_safe_str_constraint_handler(err_msg, 
# 74 "//./citus/src/backend/columnar/safeclib/safe_str_constraint.h" 3 4
                                               ((void *)0)
# 74 "//./citus/src/backend/columnar/safeclib/safe_str_constraint.h"
                                                   , err_code);
    return;
}
# 34 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 2
# 171 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
char *
strtok_s(char *dest, rsize_t *dmax, const char *src, char **ptr)
{
# 182 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
    const char *pt;
    char *ptoken;
    rsize_t dlen;
    rsize_t slen;
    ...
    if (dmax == 
# 187 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
               ((void *)0)
# 187 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                   ) {
        invoke_safe_str_constraint_handler("strtok_s: dmax is NULL",
                   
# 189 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
                  ((void *)0)
# 189 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                      , ( 400 ));
        return (
# 190 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
               ((void *)0)
# 190 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                   );
    }
...
# 195 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
                  ((void *)0)
# 195 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                      , ( 401 ));
        return (
# 196 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
               ((void *)0)
# 196 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                   );
    }
...
# 201 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
                  ((void *)0)
# 201 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                      , ( 403 ));
        return (
# 202 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
               ((void *)0)
# 202 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                   );
    }

    if (src == 
# 205 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
              ((void *)0)
# 205 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                  ) {
        invoke_safe_str_constraint_handler("strtok_s: src is null",
                   
# 207 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
                  ((void *)0)
# 207 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                      , ( 400 ));
        return (
# 208 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
               ((void *)0)
# 208 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                   );
    }

    if (ptr == 
# 211 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
              ((void *)0)
# 211 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                  ) {
        invoke_safe_str_constraint_handler("strtok_s: ptr is null",
                   
# 213 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
                  ((void *)0)
# 213 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                      , ( 400 ));
        return (
# 214 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
               ((void *)0)
# 214 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                   );
    }


    if (dest == 
# 218 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
               ((void *)0)
# 218 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                   ) {
        dest = *ptr;
    }
    ...
    dlen = *dmax;
    ptoken = 
# 226 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
            ((void *)0)
# 226 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                ;
    while (*dest != '\0' && !ptoken) {

        if (dlen == 0) {
            *ptr = 
# 230 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
                  ((void *)0)
# 230 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                      ;
            invoke_safe_str_constraint_handler(
                      "strtok_s: dest is unterminated",
                       
# 233 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
                      ((void *)0)
# 233 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                          , ( 407 ));
            return (
# 234 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
                   ((void *)0)
# 234 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                       );
        }
        ...
        while (*pt != '\0') {
            ...
            if (slen == 0) {
                *ptr = 
# 246 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
                      ((void *)0)
# 246 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                          ;
                invoke_safe_str_constraint_handler(
                          "strtok_s: src is unterminated",
                           
# 249 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
                          ((void *)0)
# 249 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                              , ( 407 ));
                return (
# 250 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
                       ((void *)0)
# 250 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                           );
            }
            slen--;
            ...
            if (*dest == *pt) {
                ptoken = 
# 255 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
                        ((void *)0)
# 255 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                            ;
                break;
            } else {
                pt++;
    ...
    if (ptoken == 
# 270 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
                 ((void *)0)
# 270 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                     ) {
        *dmax = dlen;
        return (ptoken);
    }
    ...
    while (*dest != '\0') {
        ...
        if (dlen == 0) {
            *ptr = 
# 281 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
                  ((void *)0)
# 281 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                      ;
            invoke_safe_str_constraint_handler(
                      "strtok_s: dest is unterminated",
                       
# 284 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
                      ((void *)0)
# 284 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                          , ( 407 ));
            return (
# 285 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
                   ((void *)0)
# 285 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                       );
        }
        ...
        while (*pt != '\0') {
            ...
            if (slen == 0) {
                *ptr = 
# 293 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
                      ((void *)0)
# 293 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                          ;
                invoke_safe_str_constraint_handler(
                          "strtok_s: src is unterminated",
                           
# 296 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
                          ((void *)0)
# 296 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                              , ( 407 ));
                return (
# 297 "//./citus/src/backend/columnar/safeclib/strtok_s.c" 3 4
                       ((void *)0)
# 297 "//./citus/src/backend/columnar/safeclib/strtok_s.c"
                           );
            }
            slen--;
