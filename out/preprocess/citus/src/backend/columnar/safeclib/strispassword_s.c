# 0 "//./citus/src/backend/columnar/safeclib/strispassword_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/safeclib/strispassword_s.c"
# 32 "//./citus/src/backend/columnar/safeclib/strispassword_s.c"
...
# 33 "//./citus/src/backend/columnar/safeclib/strispassword_s.c" 2
...
# 34 "//./citus/src/backend/columnar/safeclib/strispassword_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/columnar/safeclib/strispassword_s.c" 2
# 82 "//./citus/src/backend/columnar/safeclib/strispassword_s.c"

# 82 "//./citus/src/backend/columnar/safeclib/strispassword_s.c" 3 4
_Bool

# 83 "//./citus/src/backend/columnar/safeclib/strispassword_s.c"
...
# 94 "//./citus/src/backend/columnar/safeclib/strispassword_s.c" 3 4
                  ((void *)0)
# 94 "//./citus/src/backend/columnar/safeclib/strispassword_s.c"
                      , ( 400 ));
        return (
# 95 "//./citus/src/backend/columnar/safeclib/strispassword_s.c" 3 4
               0
# 95 "//./citus/src/backend/columnar/safeclib/strispassword_s.c"
                    );
    }
...
# 101 "//./citus/src/backend/columnar/safeclib/strispassword_s.c" 3 4
                  ((void *)0)
# 101 "//./citus/src/backend/columnar/safeclib/strispassword_s.c"
                      , ( 402 ));
        return (
# 102 "//./citus/src/backend/columnar/safeclib/strispassword_s.c" 3 4
               0
# 102 "//./citus/src/backend/columnar/safeclib/strispassword_s.c"
                    );
    }
...
# 108 "//./citus/src/backend/columnar/safeclib/strispassword_s.c" 3 4
                  ((void *)0)
# 108 "//./citus/src/backend/columnar/safeclib/strispassword_s.c"
                      , ( 403 ));
        return (
# 109 "//./citus/src/backend/columnar/safeclib/strispassword_s.c" 3 4
               0
# 109 "//./citus/src/backend/columnar/safeclib/strispassword_s.c"
                    );
    }

    if (*dest == '\0') {
        return (
# 113 "//./citus/src/backend/columnar/safeclib/strispassword_s.c" 3 4
               0
# 113 "//./citus/src/backend/columnar/safeclib/strispassword_s.c"
                    );
    }
...
# 124 "//./citus/src/backend/columnar/safeclib/strispassword_s.c" 3 4
                      ((void *)0)
# 124 "//./citus/src/backend/columnar/safeclib/strispassword_s.c"
                          , ( 407 ));
            return (
# 125 "//./citus/src/backend/columnar/safeclib/strispassword_s.c" 3 4
                   0
# 125 "//./citus/src/backend/columnar/safeclib/strispassword_s.c"
                        );
        }
        dmax--;
        ...
        if ((*dest >= '0') && (*dest <= '9')) {
            ...
            return (
# 154 "//./citus/src/backend/columnar/safeclib/strispassword_s.c" 3 4
                   0
# 154 "//./citus/src/backend/columnar/safeclib/strispassword_s.c"
                        );
        }
        dest++;
    }
    ...
    if (cnt_all < ( 32 ) &&
        ...
        cnt_specials >= ( 1 ) ) {
        return (
# 164 "//./citus/src/backend/columnar/safeclib/strispassword_s.c" 3 4
               1
# 164 "//./citus/src/backend/columnar/safeclib/strispassword_s.c"
                   );
    } else {
        return (
# 166 "//./citus/src/backend/columnar/safeclib/strispassword_s.c" 3 4
               0
# 166 "//./citus/src/backend/columnar/safeclib/strispassword_s.c"
                    );
    }
}
