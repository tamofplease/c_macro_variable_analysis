# 0 "//./citus/src/backend/columnar/safeclib/memcpy_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/safeclib/memcpy_s.c"
# 32 "//./citus/src/backend/columnar/safeclib/memcpy_s.c"
...
# 33 "//./citus/src/backend/columnar/safeclib/memcpy_s.c" 2
...
extern void invoke_safe_mem_constraint_handler(
                           ...
                           void *ptr,
                           errno_t error);
# 34 "//./citus/src/backend/columnar/safeclib/memcpy_s.c" 2
...
# 35 "//./citus/src/backend/columnar/safeclib/memcpy_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_mem_lib.h" 1
# 36 "//./citus/src/backend/columnar/safeclib/memcpy_s.c" 2
# 92 "//./citus/src/backend/columnar/safeclib/memcpy_s.c"
errno_t
memcpy_s (void *dest, rsize_t dmax, const void *src, rsize_t smax)
{
    ...
    if (dp == 
# 101 "//./citus/src/backend/columnar/safeclib/memcpy_s.c" 3 4
             ((void *)0)
# 101 "//./citus/src/backend/columnar/safeclib/memcpy_s.c"
                 ) {
        invoke_safe_mem_constraint_handler("memcpy_s: dest is NULL",
                   
# 103 "//./citus/src/backend/columnar/safeclib/memcpy_s.c" 3 4
                  ((void *)0)
# 103 "//./citus/src/backend/columnar/safeclib/memcpy_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 109 "//./citus/src/backend/columnar/safeclib/memcpy_s.c" 3 4
                  ((void *)0)
# 109 "//./citus/src/backend/columnar/safeclib/memcpy_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 115 "//./citus/src/backend/columnar/safeclib/memcpy_s.c" 3 4
                  ((void *)0)
# 115 "//./citus/src/backend/columnar/safeclib/memcpy_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
...
# 126 "//./citus/src/backend/columnar/safeclib/memcpy_s.c" 3 4
                  ((void *)0)
# 126 "//./citus/src/backend/columnar/safeclib/memcpy_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 133 "//./citus/src/backend/columnar/safeclib/memcpy_s.c" 3 4
                  ((void *)0)
# 133 "//./citus/src/backend/columnar/safeclib/memcpy_s.c"
                      , ( 403 ));
        return (( 403 ));
    }

    if (sp == 
# 137 "//./citus/src/backend/columnar/safeclib/memcpy_s.c" 3 4
             ((void *)0)
# 137 "//./citus/src/backend/columnar/safeclib/memcpy_s.c"
                 ) {
        mem_prim_set(dp, dmax, 0);
        invoke_safe_mem_constraint_handler("memcpy_s: src is NULL",
                   
# 140 "//./citus/src/backend/columnar/safeclib/memcpy_s.c" 3 4
                  ((void *)0)
# 140 "//./citus/src/backend/columnar/safeclib/memcpy_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 152 "//./citus/src/backend/columnar/safeclib/memcpy_s.c" 3 4
                  ((void *)0)
# 152 "//./citus/src/backend/columnar/safeclib/memcpy_s.c"
                      , ( 404 ));
        return (( 404 ));
    }
