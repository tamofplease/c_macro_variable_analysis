# 0 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c"
# 32 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c"
...
# 33 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c" 2
# 1 "//./citus/src/backend/columnar/safeclib/safe_mem_constraint.h" 1
# 41 "//./citus/src/backend/columnar/safeclib/safe_mem_constraint.h"
extern void invoke_safe_mem_constraint_handler(
                           const char *msg,
                           void *ptr,
                           errno_t error);
# 34 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c" 2
# 1 "//./citus/src/backend/columnar/safeclib/mem_primitives_lib.h" 1
# 44 "//./citus/src/backend/columnar/safeclib/mem_primitives_lib.h"
extern void
...
# 35 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_mem_lib.h" 1
# 36 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c" 2
# 91 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c"
errno_t
memcpy16_s (uint16_t *dest, rsize_t dmax, const uint16_t *src, rsize_t smax)
{
    if (dest == 
# 94 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c" 3 4
               ((void *)0)
# 94 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c"
                   ) {
        invoke_safe_mem_constraint_handler("memcpy16_s: dest is NULL",
                   
# 96 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c" 3 4
                  ((void *)0)
# 96 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c"
                      , ( 400 ));
        return ((( 400 )));
    }
...
# 102 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c" 3 4
                  ((void *)0)
# 102 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c"
                      , ( 401 ));
        return ((( 401 )));
    }
...
# 108 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c" 3 4
                  ((void *)0)
# 108 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c"
                      , ( 403 ));
        return ((( 403 )));
    }
...
# 115 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c" 3 4
                  ((void *)0)
# 115 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c"
                      , ( 401 ));
        return ((( 401 )));
    }
...
# 122 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c" 3 4
                  ((void *)0)
# 122 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c"
                      , ( 403 ));
        return ((( 403 )));
    }

    if (src == 
# 126 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c" 3 4
              ((void *)0)
# 126 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c"
                  ) {
        mem_prim_set16(dest, dmax, 0);
        invoke_safe_mem_constraint_handler("memcpy16_s: src is NULL",
                   
# 129 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c" 3 4
                  ((void *)0)
# 129 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c"
                      , ( 400 ));
        return ((( 400 )));
    }
...
# 140 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c" 3 4
                  ((void *)0)
# 140 "//./citus/src/backend/columnar/safeclib/memcpy16_s.c"
                      , ( 404 ));
        return ((( 404 )));
    }
