# 0 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c"
# 32 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c"
...
# 33 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c" 2
...
# 34 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c" 2
# 92 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c"
errno_t
strcasecmp_s (const char *dest, rsize_t dmax,
              const char *src, int *indicator)
{
    ...
    if (indicator == 
# 99 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c" 3 4
                    ((void *)0)
# 99 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c"
                        ) {
        invoke_safe_str_constraint_handler("strcasecmp_s: indicator is null",
                   
# 101 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c" 3 4
                  ((void *)0)
# 101 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
    *indicator = 0;
    ...
    if (dest == 
# 106 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c" 3 4
               ((void *)0)
# 106 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c"
                   ) {
        invoke_safe_str_constraint_handler("strcasecmp_s: dest is null",
                   
# 108 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c" 3 4
                  ((void *)0)
# 108 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c"
                      , ( 400 ));
        return (( 400 ));
    }

    if (src == 
# 112 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c" 3 4
              ((void *)0)
# 112 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c"
                  ) {
        invoke_safe_str_constraint_handler("strcasecmp_s: src is null",
                   
# 114 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c" 3 4
                  ((void *)0)
# 114 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 120 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c" 3 4
                  ((void *)0)
# 120 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 126 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c" 3 4
                  ((void *)0)
# 126 "//./citus/src/backend/columnar/safeclib/strcasecmp_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
