# 0 "//./citus/src/backend/columnar/safeclib/strremovews_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/safeclib/strremovews_s.c"
# 32 "//./citus/src/backend/columnar/safeclib/strremovews_s.c"
...
# 33 "//./citus/src/backend/columnar/safeclib/strremovews_s.c" 2
...
# 34 "//./citus/src/backend/columnar/safeclib/strremovews_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/columnar/safeclib/strremovews_s.c" 2
# 81 "//./citus/src/backend/columnar/safeclib/strremovews_s.c"
errno_t
strremovews_s (char *dest, rsize_t dmax)
{
    char *orig_dest;
    ...
    if (dest == 
# 88 "//./citus/src/backend/columnar/safeclib/strremovews_s.c" 3 4
               ((void *)0)
# 88 "//./citus/src/backend/columnar/safeclib/strremovews_s.c"
                   ) {
        invoke_safe_str_constraint_handler("strremovews_s: dest is null",
                   
# 90 "//./citus/src/backend/columnar/safeclib/strremovews_s.c" 3 4
                  ((void *)0)
# 90 "//./citus/src/backend/columnar/safeclib/strremovews_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 96 "//./citus/src/backend/columnar/safeclib/strremovews_s.c" 3 4
                  ((void *)0)
# 96 "//./citus/src/backend/columnar/safeclib/strremovews_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 102 "//./citus/src/backend/columnar/safeclib/strremovews_s.c" 3 4
                  ((void *)0)
# 102 "//./citus/src/backend/columnar/safeclib/strremovews_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
...
# 126 "//./citus/src/backend/columnar/safeclib/strremovews_s.c" 3 4
                      ((void *)0)
# 126 "//./citus/src/backend/columnar/safeclib/strremovews_s.c"
                          , ( 407 ));
            return (( 407 ));
        }
        dmax--;
