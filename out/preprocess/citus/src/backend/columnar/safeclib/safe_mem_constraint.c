# 0 "//./citus/src/backend/columnar/safeclib/safe_mem_constraint.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/safeclib/safe_mem_constraint.c"
# 33 "//./citus/src/backend/columnar/safeclib/safe_mem_constraint.c"
...
# 34 "//./citus/src/backend/columnar/safeclib/safe_mem_constraint.c" 2
...
extern void invoke_safe_mem_constraint_handler(
                           ...
                           void *ptr,
                           errno_t error);
# 35 "//./citus/src/backend/columnar/safeclib/safe_mem_constraint.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_mem_lib.h" 1
# 36 "//./citus/src/backend/columnar/safeclib/safe_mem_constraint.c" 2


static constraint_handler_t mem_handler = 
# 38 "//./citus/src/backend/columnar/safeclib/safe_mem_constraint.c" 3 4
                                         ((void *)0)
# 38 "//./citus/src/backend/columnar/safeclib/safe_mem_constraint.c"
                                             ;
# 90 "//./citus/src/backend/columnar/safeclib/safe_mem_constraint.c"
constraint_handler_t
set_mem_constraint_handler_s (constraint_handler_t handler)
{
    constraint_handler_t prev_handler = mem_handler;
    if (
# 94 "//./citus/src/backend/columnar/safeclib/safe_mem_constraint.c" 3 4
       ((void *)0) 
# 94 "//./citus/src/backend/columnar/safeclib/safe_mem_constraint.c"
            == handler) {
...
# 132 "//./citus/src/backend/columnar/safeclib/safe_mem_constraint.c"
void
...
{
    if (
# 137 "//./citus/src/backend/columnar/safeclib/safe_mem_constraint.c" 3 4
       ((void *)0) 
# 137 "//./citus/src/backend/columnar/safeclib/safe_mem_constraint.c"
            != mem_handler) {
