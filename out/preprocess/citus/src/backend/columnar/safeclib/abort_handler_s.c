# 0 "//./citus/src/backend/columnar/safeclib/abort_handler_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/safeclib/abort_handler_s.c"
# 32 "//./citus/src/backend/columnar/safeclib/abort_handler_s.c"
...
# 33 "//./citus/src/backend/columnar/safeclib/abort_handler_s.c" 2
# 68 "//./citus/src/backend/columnar/safeclib/abort_handler_s.c"
void abort_handler_s(const char *msg, void *ptr, errno_t error)
{
 fprintf(
# 70 "//./citus/src/backend/columnar/safeclib/abort_handler_s.c" 3 4
stderr
# 70 "//./citus/src/backend/columnar/safeclib/abort_handler_s.c"
