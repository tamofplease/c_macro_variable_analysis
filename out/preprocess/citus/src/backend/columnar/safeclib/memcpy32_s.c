# 0 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c"
# 32 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c"
...
# 33 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c" 2
...
extern void invoke_safe_mem_constraint_handler(
                           ...
                           void *ptr,
                           errno_t error);
# 34 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c" 2
...
# 35 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_mem_lib.h" 1
# 36 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c" 2
# 90 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c"
errno_t
memcpy32_s (uint32_t *dest, rsize_t dmax, const uint32_t *src, rsize_t smax)
{
    if (dest == 
# 93 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c" 3 4
               ((void *)0)
# 93 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c"
                   ) {
        invoke_safe_mem_constraint_handler("memcpy32_s: dest is NULL",
                   
# 95 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c" 3 4
                  ((void *)0)
# 95 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c"
                      , ( 400 ));
        return ((( 400 )));
    }
...
# 101 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c" 3 4
                  ((void *)0)
# 101 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c"
                      , ( 401 ));
        return ((( 401 )));
    }
...
# 107 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c" 3 4
                  ((void *)0)
# 107 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c"
                      , ( 403 ));
        return ((( 403 )));
    }
...
# 114 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c" 3 4
                  ((void *)0)
# 114 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c"
                      , ( 401 ));
        return ((( 401 )));
    }
...
# 121 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c" 3 4
                  ((void *)0)
# 121 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c"
                      , ( 403 ));
        return ((( 403 )));
    }

    if (src == 
# 125 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c" 3 4
              ((void *)0)
# 125 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c"
                  ) {
        mem_prim_set32(dest, dmax, 0);
        invoke_safe_mem_constraint_handler("memcpy32_s: src is NULL",
                   
# 128 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c" 3 4
                  ((void *)0)
# 128 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c"
                      , ( 400 ));
        return ((( 400 )));
    }
...
# 139 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c" 3 4
                  ((void *)0)
# 139 "//./citus/src/backend/columnar/safeclib/memcpy32_s.c"
                      , ( 404 ));
        return ((( 404 )));
    }
