# 0 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c"
# 32 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c"
...
# 33 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c" 2
...
extern void invoke_safe_mem_constraint_handler(
                           ...
                           void *ptr,
                           errno_t error);
# 34 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c" 2
...
# 35 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_mem_lib.h" 1
# 36 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c" 2
# 91 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c"
errno_t
wmemcpy_s(wchar_t* dest, rsize_t dmax, const wchar_t* src, rsize_t smax)
{
 wchar_t *dp;
    ...
    if (dp == 
# 100 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c" 3 4
             ((void *)0)
# 100 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c"
                 ) {
        invoke_safe_mem_constraint_handler("wmemcpy_s: dest is NULL",
                   
# 102 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c" 3 4
                  ((void *)0)
# 102 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 108 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c" 3 4
                  ((void *)0)
# 108 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 114 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c" 3 4
                  ((void *)0)
# 114 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
...
# 121 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c" 3 4
                  ((void *)0)
# 121 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 128 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c" 3 4
                  ((void *)0)
# 128 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c"
                      , ( 403 ));
        return (( 403 ));
    }

    if (sp == 
# 132 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c" 3 4
             ((void *)0)
# 132 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c"
                 ) {
        mem_prim_set(dp, dmax*sizeof(wchar_t), 0);
        invoke_safe_mem_constraint_handler("wmemcpy_s: src is NULL",
                   
# 135 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c" 3 4
                  ((void *)0)
# 135 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 147 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c" 3 4
                  ((void *)0)
# 147 "//./citus/src/backend/columnar/safeclib/wmemcpy_s.c"
                      , ( 404 ));
        return (( 404 ));
    }
