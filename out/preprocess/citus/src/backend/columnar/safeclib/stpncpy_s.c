# 0 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
# 32 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
...
# 33 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 2
...
# 34 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 2
# 111 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
char *
stpncpy_s(char *dest, rsize_t dmax, const char *src, rsize_t smax, errno_t *err)
{
    rsize_t orig_dmax;
    ...
    if (dest == 
# 117 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
               ((void *)0)
# 117 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
                   ) {
        invoke_safe_str_constraint_handler("stpncpy_s: dest is null",
                   
# 119 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
                  ((void *)0)
# 119 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
                      , ( 400 ));
        *err = (( 400 ));
        return 
# 121 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
              ((void *)0)
# 121 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
                  ;
    }

    if (src == 
# 124 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
              ((void *)0)
# 124 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
                  ) {
        invoke_safe_str_constraint_handler("stpncpy_s: src is null",
                   
# 126 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
                  ((void *)0)
# 126 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
                      , ( 400 ));
        *err = (( 400 ));
        dest[0] = '\0';
        return 
# 129 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
              ((void *)0)
# 129 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
                  ;
    }
...
# 134 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
                  ((void *)0)
# 134 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
                      , ( 401 ));
        *err = (( 401 ));
        return 
# 136 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
              ((void *)0)
# 136 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
                  ;
    }
...
# 141 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
                  ((void *)0)
# 141 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
                      , ( 403 ));
        *err = (( 403 ));
        return 
# 143 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
              ((void *)0)
# 143 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
                  ;
    }
...
# 148 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
                  ((void *)0)
# 148 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
                      , ( 403 ));
        *err = (( 403 ));
        return 
# 150 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
              ((void *)0)
# 150 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
                  ;
    }
...
# 155 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
                  ((void *)0)
# 155 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
                      , ( 406 ));
        *err = (( 406 ));
        dest[0] = '\0';
        return 
# 158 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
              ((void *)0)
# 158 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
                  ;
    }
...
# 164 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
                  ((void *)0)
# 164 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
                      , ( 404 ));
        *err = (( 404 ));
        dest[0] = '\0';
        return 
# 167 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
              ((void *)0)
# 167 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
                  ;
    }
...
# 173 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
                  ((void *)0)
# 173 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
                      , ( 404 ));
        *err = (( 404 ));
        dest[0] = '\0';
        return 
# 176 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
              ((void *)0)
# 176 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
                  ;
    }
# 198 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
    if (src == 
# 198 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
              ((void *)0)
# 198 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
                  ) {
...
# 206 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
                  ((void *)0)
# 206 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
                      , ( 400 ));
        *err = (( 400 ));
        return 
# 208 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
              ((void *)0)
# 208 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
                  ;
    }
     ...
     *err = (( 406 ));
     return 
# 240 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
           ((void *)0)
# 240 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
               ;
    }
  ...
  *dest = *src;
  ...
  src++;
    ...
    *err = (( 406 ));
    return 
# 280 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c" 3 4
          ((void *)0)
# 280 "//./citus/src/backend/columnar/safeclib/stpncpy_s.c"
              ;
}
