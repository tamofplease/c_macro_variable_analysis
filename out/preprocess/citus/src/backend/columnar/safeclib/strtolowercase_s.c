# 0 "//./citus/src/backend/columnar/safeclib/strtolowercase_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/safeclib/strtolowercase_s.c"
# 32 "//./citus/src/backend/columnar/safeclib/strtolowercase_s.c"
...
# 33 "//./citus/src/backend/columnar/safeclib/strtolowercase_s.c" 2
...
# 34 "//./citus/src/backend/columnar/safeclib/strtolowercase_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/columnar/safeclib/strtolowercase_s.c" 2
# 80 "//./citus/src/backend/columnar/safeclib/strtolowercase_s.c"
errno_t
...
# 86 "//./citus/src/backend/columnar/safeclib/strtolowercase_s.c" 3 4
                  ((void *)0)
# 86 "//./citus/src/backend/columnar/safeclib/strtolowercase_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 93 "//./citus/src/backend/columnar/safeclib/strtolowercase_s.c" 3 4
                  ((void *)0)
# 93 "//./citus/src/backend/columnar/safeclib/strtolowercase_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 100 "//./citus/src/backend/columnar/safeclib/strtolowercase_s.c" 3 4
                  ((void *)0)
# 100 "//./citus/src/backend/columnar/safeclib/strtolowercase_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
