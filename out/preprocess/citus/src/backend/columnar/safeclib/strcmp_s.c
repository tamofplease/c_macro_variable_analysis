# 0 "//./citus/src/backend/columnar/safeclib/strcmp_s.c"
# 1 "/citus//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "//./citus/src/backend/columnar/safeclib/strcmp_s.c"
# 32 "//./citus/src/backend/columnar/safeclib/strcmp_s.c"
...
# 33 "//./citus/src/backend/columnar/safeclib/strcmp_s.c" 2
...
# 34 "//./citus/src/backend/columnar/safeclib/strcmp_s.c" 2
# 1 "//./citus/vendor/safestringlib/include/safe_str_lib.h" 1
# 35 "//./citus/src/backend/columnar/safeclib/strcmp_s.c" 2
# 91 "//./citus/src/backend/columnar/safeclib/strcmp_s.c"
errno_t
strcmp_s (const char *dest, rsize_t dmax,
          const char *src, int *indicator)
{
    if (indicator == 
# 95 "//./citus/src/backend/columnar/safeclib/strcmp_s.c" 3 4
                    ((void *)0)
# 95 "//./citus/src/backend/columnar/safeclib/strcmp_s.c"
                        ) {
        invoke_safe_str_constraint_handler("strcmp_s: indicator is null",
                   
# 97 "//./citus/src/backend/columnar/safeclib/strcmp_s.c" 3 4
                  ((void *)0)
# 97 "//./citus/src/backend/columnar/safeclib/strcmp_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
    *indicator = 0;
    ...
    if (dest == 
# 102 "//./citus/src/backend/columnar/safeclib/strcmp_s.c" 3 4
               ((void *)0)
# 102 "//./citus/src/backend/columnar/safeclib/strcmp_s.c"
                   ) {
        invoke_safe_str_constraint_handler("strcmp_s: dest is null",
                   
# 104 "//./citus/src/backend/columnar/safeclib/strcmp_s.c" 3 4
                  ((void *)0)
# 104 "//./citus/src/backend/columnar/safeclib/strcmp_s.c"
                      , ( 400 ));
        return (( 400 ));
    }

    if (src == 
# 108 "//./citus/src/backend/columnar/safeclib/strcmp_s.c" 3 4
              ((void *)0)
# 108 "//./citus/src/backend/columnar/safeclib/strcmp_s.c"
                  ) {
        invoke_safe_str_constraint_handler("strcmp_s: src is null",
                   
# 110 "//./citus/src/backend/columnar/safeclib/strcmp_s.c" 3 4
                  ((void *)0)
# 110 "//./citus/src/backend/columnar/safeclib/strcmp_s.c"
                      , ( 400 ));
        return (( 400 ));
    }
...
# 116 "//./citus/src/backend/columnar/safeclib/strcmp_s.c" 3 4
                  ((void *)0)
# 116 "//./citus/src/backend/columnar/safeclib/strcmp_s.c"
                      , ( 401 ));
        return (( 401 ));
    }
...
# 122 "//./citus/src/backend/columnar/safeclib/strcmp_s.c" 3 4
                  ((void *)0)
# 122 "//./citus/src/backend/columnar/safeclib/strcmp_s.c"
                      , ( 403 ));
        return (( 403 ));
    }
