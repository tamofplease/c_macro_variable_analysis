# 0 "/libmdbx/src/mdbx_stat.c"
# 1 "/libmdbx/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/libmdbx/src/mdbx_stat.c"
# 24 "/libmdbx/src/mdbx_stat.c"
...
# 25 "/libmdbx/src/mdbx_stat.c" 2
# 38 "/libmdbx/src/mdbx_stat.c"
...
static void print_stat(MDBX_stat *ms) {
  ...
  printf("  Tree depth: %u\n", ms->ms_depth);
  printf("  Branch pages: %" 
# 49 "/libmdbx/src/mdbx_stat.c" 3 4
                            "l" "u" 
# 49 "/libmdbx/src/mdbx_stat.c"
                                   "\n", ms->ms_branch_pages);
  printf("  Leaf pages: %" 
# 50 "/libmdbx/src/mdbx_stat.c" 3 4
                          "l" "u" 
# 50 "/libmdbx/src/mdbx_stat.c"
                                 "\n", ms->ms_leaf_pages);
  printf("  Overflow pages: %" 
# 51 "/libmdbx/src/mdbx_stat.c" 3 4
                              "l" "u" 
# 51 "/libmdbx/src/mdbx_stat.c"
                                     "\n", ms->ms_overflow_pages);
  printf("  Entries: %" 
# 52 "/libmdbx/src/mdbx_stat.c" 3 4
                       "l" "u" 
# 52 "/libmdbx/src/mdbx_stat.c"
                              "\n", ms->ms_entries);
}

static void usage(const char *prog) {
  fprintf(
# 56 "/libmdbx/src/mdbx_stat.c" 3 4
         stderr
# 56 "/libmdbx/src/mdbx_stat.c"
               ,
          ...
          prog);
  exit(
# 68 "/libmdbx/src/mdbx_stat.c" 3 4
      1
# 68 "/libmdbx/src/mdbx_stat.c"
                  );
}
...
static int reader_list_func(void *ctx, int num, int slot, mdbx_pid_t pid,
  ...
  printf(" %3d)\t[%d]\t%6" 
# 81 "/libmdbx/src/mdbx_stat.c" 3 4
                          "l" "d" 
# 81 "/libmdbx/src/mdbx_stat.c"
                                   " %*" 
# 81 "/libmdbx/src/mdbx_stat.c" 3 4
                                         "l" "x"
# 81 "/libmdbx/src/mdbx_stat.c"
  ...
  if (txnid)
    printf(" %20" 
# 84 "/libmdbx/src/mdbx_stat.c" 3 4
                 "l" "u" 
# 84 "/libmdbx/src/mdbx_stat.c"
                        " %10" 
# 84 "/libmdbx/src/mdbx_stat.c" 3 4
                               "l" "u" 
# 84 "/libmdbx/src/mdbx_stat.c"
...
static void error(const char *func, int rc) {
  if (!quiet)
    fprintf(
# 96 "/libmdbx/src/mdbx_stat.c" 3 4
           stderr
# 96 "/libmdbx/src/mdbx_stat.c"
                 , "%s: %s() error %d %s\n", prog, func, rc,
            mdbx_strerror(rc));
}
...
int main(int argc, char *argv[]) {
  ...
  char *envname;
  char *subname = 
# 108 "/libmdbx/src/mdbx_stat.c" 3 4
                 ((void *)0)
# 108 "/libmdbx/src/mdbx_stat.c"
                        ;
  _Bool alldbs = (0), envinfo = (0), pgop = (0);
  ...
  while ((opt = getopt(argc, argv,
                       ...
                       "r"
                       "s:")) != 
# 124 "/libmdbx/src/mdbx_stat.c" 3 4
                                (-1)
# 124 "/libmdbx/src/mdbx_stat.c"
                                   ) {
    switch (opt) {
    case 'V':
      printf("mdbx_stat version %d.%d.%d.%d\n"
             ...
             mdbx_build.options);
      return 
# 139 "/libmdbx/src/mdbx_stat.c" 3 4
            0
# 139 "/libmdbx/src/mdbx_stat.c"
                        ;
    case 'q':
      quiet = (1);
      break;
  ...
  signal(
# 179 "/libmdbx/src/mdbx_stat.c" 3 4
        13
# 179 "/libmdbx/src/mdbx_stat.c"
               , signal_handler);


  signal(
# 182 "/libmdbx/src/mdbx_stat.c" 3 4
        1
# 182 "/libmdbx/src/mdbx_stat.c"
              , signal_handler);

  signal(
# 184 "/libmdbx/src/mdbx_stat.c" 3 4
        2
# 184 "/libmdbx/src/mdbx_stat.c"
              , signal_handler);
  signal(
# 185 "/libmdbx/src/mdbx_stat.c" 3 4
        15
# 185 "/libmdbx/src/mdbx_stat.c"
               , signal_handler);
  ...
  if (!quiet) {
    ...
    fflush(
# 194 "/libmdbx/src/mdbx_stat.c" 3 4
          ((void *)0)
# 194 "/libmdbx/src/mdbx_stat.c"
                 );
  }
  ...
  if (__builtin_expect(!!(rc != MDBX_SUCCESS), 0)) {
    ...
    return 
# 200 "/libmdbx/src/mdbx_stat.c" 3 4
          1
# 200 "/libmdbx/src/mdbx_stat.c"
                      ;
  }
...
# 217 "/libmdbx/src/mdbx_stat.c" 3 4
                          ((void *)0)
# 217 "/libmdbx/src/mdbx_stat.c"
                                 , MDBX_TXN_RDONLY, &txn);
  if (__builtin_expect(!!(rc != MDBX_SUCCESS), 0)) {
  ...
  if (pgop) {
    ...
    printf("      New: %8" 
# 236 "/libmdbx/src/mdbx_stat.c" 3 4
                          "l" "u" 
# 236 "/libmdbx/src/mdbx_stat.c"
                                 "\t// quantity of a new pages added\n",
           mei.mi_pgop_stat.newly);
    printf("      CoW: %8" 
# 238 "/libmdbx/src/mdbx_stat.c" 3 4
                          "l" "u"
           
# 239 "/libmdbx/src/mdbx_stat.c"
          "\t// quantity of pages copied for altering\n",
           mei.mi_pgop_stat.cow);
    printf("    Clone: %8" 
# 241 "/libmdbx/src/mdbx_stat.c" 3 4
                          "l" "u" 
# 241 "/libmdbx/src/mdbx_stat.c"
                                 "\t// quantity of parent's dirty pages "
           "clones for nested transactions\n",
           mei.mi_pgop_stat.clone);
    printf("    Split: %8" 
# 244 "/libmdbx/src/mdbx_stat.c" 3 4
                          "l" "u"
           
# 245 "/libmdbx/src/mdbx_stat.c"
          "\t// page splits during insertions or updates\n",
           mei.mi_pgop_stat.split);
    printf("    Merge: %8" 
# 247 "/libmdbx/src/mdbx_stat.c" 3 4
                          "l" "u"
           
# 248 "/libmdbx/src/mdbx_stat.c"
          "\t// page merges during deletions or updates\n",
           mei.mi_pgop_stat.merge);
    printf("    Spill: %8" 
# 250 "/libmdbx/src/mdbx_stat.c" 3 4
                          "l" "u" 
# 250 "/libmdbx/src/mdbx_stat.c"
                                 "\t// quantity of spilled/ousted `dirty` "
           "pages during large transactions\n",
           mei.mi_pgop_stat.spill);
    printf("  Unspill: %8" 
# 253 "/libmdbx/src/mdbx_stat.c" 3 4
                          "l" "u" 
# 253 "/libmdbx/src/mdbx_stat.c"
                                 "\t// quantity of unspilled/redone `dirty` "
           "pages during large transactions\n",
           mei.mi_pgop_stat.unspill);
    printf("      WOP: %8" 
# 256 "/libmdbx/src/mdbx_stat.c" 3 4
                          "l" "u"
           
# 257 "/libmdbx/src/mdbx_stat.c"
  ...
  if (envinfo) {
    ...
    if (mei.mi_geo.lower != mei.mi_geo.upper) {
      printf("  Dynamic datafile: %" 
# 265 "/libmdbx/src/mdbx_stat.c" 3 4
                                    "l" "u" 
# 265 "/libmdbx/src/mdbx_stat.c"
                                           "..%" 
# 265 "/libmdbx/src/mdbx_stat.c" 3 4
                                                 "l" "u" 
# 265 "/libmdbx/src/mdbx_stat.c"
...
# 266 "/libmdbx/src/mdbx_stat.c"
            "/-%" 
# 266 "/libmdbx/src/mdbx_stat.c" 3 4
                  "l" "u" 
# 266 "/libmdbx/src/mdbx_stat.c"
                         "), %" 
# 266 "/libmdbx/src/mdbx_stat.c" 3 4
...
# 267 "/libmdbx/src/mdbx_stat.c"
            "/-%" 
# 267 "/libmdbx/src/mdbx_stat.c" 3 4
                  "l" "u" 
# 267 "/libmdbx/src/mdbx_stat.c"
                         ")\n",
      ...
      printf("  Current mapsize: %" 
# 273 "/libmdbx/src/mdbx_stat.c" 3 4
                                   "l" "u" 
# 273 "/libmdbx/src/mdbx_stat.c"
                                          " bytes, %" 
# 273 "/libmdbx/src/mdbx_stat.c" 3 4
                                                      "l" "u" 
# 273 "/libmdbx/src/mdbx_stat.c"
      ...
      printf("  Current datafile: %" 
# 275 "/libmdbx/src/mdbx_stat.c" 3 4
                                    "l" "u" 
# 275 "/libmdbx/src/mdbx_stat.c"
                                           " bytes, %" 
# 275 "/libmdbx/src/mdbx_stat.c" 3 4
                                                       "l" "u" 
# 275 "/libmdbx/src/mdbx_stat.c"
...
# 285 "/libmdbx/src/mdbx_stat.c"
    } else {
      printf("  Fixed datafile: %" 
# 286 "/libmdbx/src/mdbx_stat.c" 3 4
                                  "l" "u" 
# 286 "/libmdbx/src/mdbx_stat.c"
                                         " bytes, %" 
# 286 "/libmdbx/src/mdbx_stat.c" 3 4
                                                     "l" "u" 
# 286 "/libmdbx/src/mdbx_stat.c"
    ...
    printf("  Last transaction ID: %" 
# 289 "/libmdbx/src/mdbx_stat.c" 3 4
                                     "l" "u" 
# 289 "/libmdbx/src/mdbx_stat.c"
                                            "\n", mei.mi_recent_txnid);
    printf("  Latter reader transaction ID: %" 
# 290 "/libmdbx/src/mdbx_stat.c" 3 4
                                              "l" "u" 
# 290 "/libmdbx/src/mdbx_stat.c"
                                                     " (%" 
# 290 "/libmdbx/src/mdbx_stat.c" 3 4
                                                           "l" "i" 
# 290 "/libmdbx/src/mdbx_stat.c"
  ...
  if (rdrinfo) {
    rc = mdbx_reader_list(env, reader_list_func, 
# 298 "/libmdbx/src/mdbx_stat.c" 3 4
                                                ((void *)0)
# 298 "/libmdbx/src/mdbx_stat.c"
                                                       );
    ...
    if (rc == MDBX_RESULT_TRUE)
      ...
      if (rc == MDBX_RESULT_TRUE) {
        ...
        rc = mdbx_reader_list(env, reader_list_func, 
# 314 "/libmdbx/src/mdbx_stat.c" 3 4
                                                    ((void *)0)
# 314 "/libmdbx/src/mdbx_stat.c"
                                                           );
        if (rc == MDBX_RESULT_TRUE)
  ...
  if (freinfo) {
    ...
    while (MDBX_SUCCESS ==
      ...
      if (freinfo > 1) {
        char *bad = "";
        pgno_t prev =
            0 ? 3 - 1 : (pgno_t)mei.mi_last_pgno + 1;
        pgno_t span = 1;
        for (unsigned i = 0; i < number; ++i) {
          ...
          prev = pg;
          while (i + span < number &&
                 iptr[i + span] == (0 ? pgno_add(pg, span)
                                                       : pgno_sub(pg, span)))
            ++span;
        }
        printf("    Transaction %" 
# 373 "/libmdbx/src/mdbx_stat.c" 3 4
                                  "l" "i" 
# 373 "/libmdbx/src/mdbx_stat.c"
                                          ", %" 
# 373 "/libmdbx/src/mdbx_stat.c" 3 4
                                                "u"
               
# 374 "/libmdbx/src/mdbx_stat.c"
              " pages, maxspan %" 
# 374 "/libmdbx/src/mdbx_stat.c" 3 4
                                  "u" 
# 374 "/libmdbx/src/mdbx_stat.c"
                                           "%s\n",
        ...
        if (freinfo > 2) {
          for (unsigned i = 0; i < number; i += span) {
            ...
            if (span > 1)
              printf("     %9" 
# 386 "/libmdbx/src/mdbx_stat.c" 3 4
                              "u" 
# 386 "/libmdbx/src/mdbx_stat.c"
                                       "[%" 
# 386 "/libmdbx/src/mdbx_stat.c" 3 4
                                            "u" 
# 386 "/libmdbx/src/mdbx_stat.c"
              ...
              printf("     %9" 
# 388 "/libmdbx/src/mdbx_stat.c" 3 4
                              "u" 
# 388 "/libmdbx/src/mdbx_stat.c"
                                       "\n", pg);
          }
        }
      }
    ...
    cursor = 
# 394 "/libmdbx/src/mdbx_stat.c" 3 4
            ((void *)0)
# 394 "/libmdbx/src/mdbx_stat.c"
                   ;
    ...
    case MDBX_EINTR:
      if (!quiet)
        fprintf(
# 402 "/libmdbx/src/mdbx_stat.c" 3 4
               stderr
# 402 "/libmdbx/src/mdbx_stat.c"
    ...
    if (envinfo) {
      ...
      printf("Page Usage\n");
      printf("  Total: %" 
# 413 "/libmdbx/src/mdbx_stat.c" 3 4
                         "l" "u" 
# 413 "/libmdbx/src/mdbx_stat.c"
                                " 100%%\n", value);

      value = mei.mi_geo.current / mei.mi_dxb_pagesize;
      printf("  Backed: %" 
# 416 "/libmdbx/src/mdbx_stat.c" 3 4
                          "l" "u" 
# 416 "/libmdbx/src/mdbx_stat.c"
                                 " %.1f%%\n", value, value / percent);

      value = mei.mi_last_pgno + 1;
      printf("  Allocated: %" 
# 419 "/libmdbx/src/mdbx_stat.c" 3 4
                             "l" "u" 
# 419 "/libmdbx/src/mdbx_stat.c"
                                    " %.1f%%\n", value, value / percent);

      value = mei.mi_mapsize / mei.mi_dxb_pagesize - (mei.mi_last_pgno + 1);
      printf("  Remained: %" 
# 422 "/libmdbx/src/mdbx_stat.c" 3 4
                            "l" "u" 
# 422 "/libmdbx/src/mdbx_stat.c"
                                   " %.1f%%\n", value, value / percent);

      value = mei.mi_last_pgno + 1 - pages;
      printf("  Used: %" 
# 425 "/libmdbx/src/mdbx_stat.c" 3 4
                        "l" "u" 
# 425 "/libmdbx/src/mdbx_stat.c"
                               " %.1f%%\n", value, value / percent);

      value = pages;
      printf("  GC: %" 
# 428 "/libmdbx/src/mdbx_stat.c" 3 4
                      "l" "u" 
# 428 "/libmdbx/src/mdbx_stat.c"
                             " %.1f%%\n", value, value / percent);

      value = pages - reclaimable;
      printf("  Retained: %" 
# 431 "/libmdbx/src/mdbx_stat.c" 3 4
                            "l" "u" 
# 431 "/libmdbx/src/mdbx_stat.c"
                                   " %.1f%%\n", value, value / percent);

      value = reclaimable;
      printf("  Reclaimable: %" 
# 434 "/libmdbx/src/mdbx_stat.c" 3 4
                               "l" "u" 
# 434 "/libmdbx/src/mdbx_stat.c"
                                      " %.1f%%\n", value, value / percent);

      value = mei.mi_mapsize / mei.mi_dxb_pagesize - (mei.mi_last_pgno + 1) +
              reclaimable;
      printf("  Available: %" 
# 438 "/libmdbx/src/mdbx_stat.c" 3 4
                             "l" "u" 
# 438 "/libmdbx/src/mdbx_stat.c"
                                    " %.1f%%\n", value, value / percent);
    } else
      printf("  GC: %" 
# 440 "/libmdbx/src/mdbx_stat.c" 3 4
                      "u" 
# 440 "/libmdbx/src/mdbx_stat.c"
                               " pages\n", pages);
  }
  ...
  if (alldbs) {
    ...
    MDBX_val key;
    while (MDBX_SUCCESS ==
           (rc = mdbx_cursor_get(cursor, &key, 
# 468 "/libmdbx/src/mdbx_stat.c" 3 4
                                              ((void *)0)
# 468 "/libmdbx/src/mdbx_stat.c"
                                                     , MDBX_NEXT_NODUP))) {
      MDBX_dbi subdbi;
      if (memchr(key.iov_base, '\0', key.iov_len))
        continue;
      subname = malloc(key.iov_len + 1);
    ...
    mdbx_cursor_close(cursor);
    cursor = 
# 500 "/libmdbx/src/mdbx_stat.c" 3 4
            ((void *)0)
# 500 "/libmdbx/src/mdbx_stat.c"
                   ;
  }
  ...
  case MDBX_EINTR:
    if (!quiet)
      fprintf(
# 509 "/libmdbx/src/mdbx_stat.c" 3 4
             stderr
# 509 "/libmdbx/src/mdbx_stat.c"
                   , "Interrupted by signal/user\n");
    break;
  default:
    if (__builtin_expect(!!(rc != MDBX_SUCCESS), 0))
...
env_close:
  ...
  return rc ? 
# 522 "/libmdbx/src/mdbx_stat.c" 3 4
             1 
# 522 "/libmdbx/src/mdbx_stat.c"
                          : 
# 522 "/libmdbx/src/mdbx_stat.c" 3 4
                            0
# 522 "/libmdbx/src/mdbx_stat.c"
