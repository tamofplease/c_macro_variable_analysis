# 0 "/libmdbx/src/mdbx_drop.c"
# 1 "/libmdbx/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/libmdbx/src/mdbx_drop.c"
# 26 "/libmdbx/src/mdbx_drop.c"
...
# 29 "/libmdbx/src/mdbx_drop.c" 2
# 42 "/libmdbx/src/mdbx_drop.c"
...
static void usage(void) {
  fprintf(
# 53 "/libmdbx/src/mdbx_drop.c" 3 4
         stderr
# 53 "/libmdbx/src/mdbx_drop.c"
               ,
          ...
          prog);
  exit(
# 61 "/libmdbx/src/mdbx_drop.c" 3 4
      1
# 61 "/libmdbx/src/mdbx_drop.c"
                  );
}
...
static void error(const char *func, int rc) {
  if (!quiet)
    fprintf(
# 66 "/libmdbx/src/mdbx_drop.c" 3 4
           stderr
# 66 "/libmdbx/src/mdbx_drop.c"
                 , "%s: %s() error %d %s\n", prog, func, rc,
            mdbx_strerror(rc));
}
...
int main(int argc, char *argv[]) {
  ...
  MDBX_dbi dbi;
  char *envname = 
# 75 "/libmdbx/src/mdbx_drop.c" 3 4
                 ((void *)0)
# 75 "/libmdbx/src/mdbx_drop.c"
                        ;
  char *subname = 
# 76 "/libmdbx/src/mdbx_drop.c" 3 4
                 ((void *)0)
# 76 "/libmdbx/src/mdbx_drop.c"
                        ;
  ...
  while ((i = getopt(argc, argv,
                     ...
                     "q"
                     "V")) != 
# 89 "/libmdbx/src/mdbx_drop.c" 3 4
                             (-1)
# 89 "/libmdbx/src/mdbx_drop.c"
                                ) {
    switch (i) {
    case 'V':
      printf("mdbx_drop version %d.%d.%d.%d\n"
             ...
             mdbx_build.options);
      return 
# 104 "/libmdbx/src/mdbx_drop.c" 3 4
            0
# 104 "/libmdbx/src/mdbx_drop.c"
                        ;
    case 'q':
      quiet = (1);
      break;
  ...
  signal(
# 128 "/libmdbx/src/mdbx_drop.c" 3 4
        13
# 128 "/libmdbx/src/mdbx_drop.c"
               , signal_handler);


  signal(
# 131 "/libmdbx/src/mdbx_drop.c" 3 4
        1
# 131 "/libmdbx/src/mdbx_drop.c"
              , signal_handler);

  signal(
# 133 "/libmdbx/src/mdbx_drop.c" 3 4
        2
# 133 "/libmdbx/src/mdbx_drop.c"
              , signal_handler);
  signal(
# 134 "/libmdbx/src/mdbx_drop.c" 3 4
        15
# 134 "/libmdbx/src/mdbx_drop.c"
               , signal_handler);
  ...
  if (!quiet) {
    ...
    fflush(
# 142 "/libmdbx/src/mdbx_drop.c" 3 4
          ((void *)0)
# 142 "/libmdbx/src/mdbx_drop.c"
                 );
  }
  ...
  if (__builtin_expect(!!(rc != MDBX_SUCCESS), 0)) {
    ...
    return 
# 148 "/libmdbx/src/mdbx_drop.c" 3 4
          1
# 148 "/libmdbx/src/mdbx_drop.c"
                      ;
  }
...
# 165 "/libmdbx/src/mdbx_drop.c" 3 4
                          ((void *)0)
# 165 "/libmdbx/src/mdbx_drop.c"
                              , 0, &txn);
  if (__builtin_expect(!!(rc != MDBX_SUCCESS), 0)) {
  ...
  txn = 
# 188 "/libmdbx/src/mdbx_drop.c" 3 4
       ((void *)0)
# 188 "/libmdbx/src/mdbx_drop.c"
              ;
...
env_close:
  ...
  return rc ? 
# 196 "/libmdbx/src/mdbx_drop.c" 3 4
             1 
# 196 "/libmdbx/src/mdbx_drop.c"
                          : 
# 196 "/libmdbx/src/mdbx_drop.c" 3 4
                            0
# 196 "/libmdbx/src/mdbx_drop.c"
