# 0 "/libmdbx/src/mdbx_copy.c"
# 1 "/libmdbx/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/libmdbx/src/mdbx_copy.c"
# 24 "/libmdbx/src/mdbx_copy.c"
...
# 25 "/libmdbx/src/mdbx_copy.c" 2
# 38 "/libmdbx/src/mdbx_copy.c"
...
static void usage(const char *prog) {
  fprintf(
# 47 "/libmdbx/src/mdbx_copy.c" 3 4
         stderr
# 47 "/libmdbx/src/mdbx_copy.c"
               ,
          ...
          prog);
  exit(
# 55 "/libmdbx/src/mdbx_copy.c" 3 4
      1
# 55 "/libmdbx/src/mdbx_copy.c"
                  );
}
...
int main(int argc, char *argv[]) {
  int rc;
  MDBX_env *env = 
# 60 "/libmdbx/src/mdbx_copy.c" 3 4
                 ((void *)0)
# 60 "/libmdbx/src/mdbx_copy.c"
                     ;
  ...
  for (; argc > 1 && argv[1][0] == '-'; argc--, argv++) {
    if (argv[1][1] == 'n' && argv[1][2] == '\0')
      ...
      printf("mdbx_copy version %d.%d.%d.%d\n"
             ...
             mdbx_build.options);
      return 
# 89 "/libmdbx/src/mdbx_copy.c" 3 4
            0
# 89 "/libmdbx/src/mdbx_copy.c"
                        ;
    } else
      argc = 0;
  }
  ...
  signal(
# 101 "/libmdbx/src/mdbx_copy.c" 3 4
        13
# 101 "/libmdbx/src/mdbx_copy.c"
               , signal_handler);


  signal(
# 104 "/libmdbx/src/mdbx_copy.c" 3 4
        1
# 104 "/libmdbx/src/mdbx_copy.c"
              , signal_handler);

  signal(
# 106 "/libmdbx/src/mdbx_copy.c" 3 4
        2
# 106 "/libmdbx/src/mdbx_copy.c"
              , signal_handler);
  signal(
# 107 "/libmdbx/src/mdbx_copy.c" 3 4
        15
# 107 "/libmdbx/src/mdbx_copy.c"
               , signal_handler);


  if (!quiet) {
    fprintf((argc == 2) ? 
# 111 "/libmdbx/src/mdbx_copy.c" 3 4
                         stderr 
# 111 "/libmdbx/src/mdbx_copy.c"
                                : 
# 111 "/libmdbx/src/mdbx_copy.c" 3 4
                                  stdout
# 111 "/libmdbx/src/mdbx_copy.c"
    ...
    fflush(
# 115 "/libmdbx/src/mdbx_copy.c" 3 4
          ((void *)0)
# 115 "/libmdbx/src/mdbx_copy.c"
              );
  }
  ...
  if (rc == MDBX_SUCCESS) {
    ...
    if (argc == 2) {
      ...
      fd = fileno(
# 130 "/libmdbx/src/mdbx_copy.c" 3 4
                 stdout
# 130 "/libmdbx/src/mdbx_copy.c"
                       );
  ...
  if (rc)
    fprintf(
# 137 "/libmdbx/src/mdbx_copy.c" 3 4
           stderr
# 137 "/libmdbx/src/mdbx_copy.c"
                 , "%s: %s failed, error %d (%s)\n", progname, act, rc,
            mdbx_strerror(rc));
  mdbx_env_close(env);

  return rc ? 
# 141 "/libmdbx/src/mdbx_copy.c" 3 4
             1 
# 141 "/libmdbx/src/mdbx_copy.c"
                          : 
# 141 "/libmdbx/src/mdbx_copy.c" 3 4
                            0
# 141 "/libmdbx/src/mdbx_copy.c"
