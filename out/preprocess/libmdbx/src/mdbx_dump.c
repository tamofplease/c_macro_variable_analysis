# 0 "/libmdbx/src/mdbx_dump.c"
# 1 "/libmdbx/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/libmdbx/src/mdbx_dump.c"
# 24 "/libmdbx/src/mdbx_dump.c"
...
# 27 "/libmdbx/src/mdbx_dump.c" 2




# 30 "/libmdbx/src/mdbx_dump.c"
static int mode = 2;
...
flagbit dbflags[] = {{MDBX_REVERSEKEY, "reversekey"},
                     ...
                     {0, 
# 43 "/libmdbx/src/mdbx_dump.c" 3 4
                        ((void *)0)
# 43 "/libmdbx/src/mdbx_dump.c"
                               }};
# 57 "/libmdbx/src/mdbx_dump.c"
...
static void text(MDBX_val *v) {
  ...
  while (c < end) {
    if (
# 79 "/libmdbx/src/mdbx_dump.c" 3 4
       ((*__ctype_b_loc ())[(int) ((
# 79 "/libmdbx/src/mdbx_dump.c"
       *c
# 79 "/libmdbx/src/mdbx_dump.c" 3 4
...
_Bool quiet = (0), rescue = (0);
const char *prog;
static void error(const char *func, int rc) {
  if (!quiet)
    fprintf(
# 105 "/libmdbx/src/mdbx_dump.c" 3 4
           stderr
# 105 "/libmdbx/src/mdbx_dump.c"
                 , "%s: %s() error %d %s\n", prog, func, rc,
            mdbx_strerror(rc));
}
...
static int dump_sdb(MDBX_txn *txn, MDBX_dbi dbi, char *name) {
  ...
  if (mode & 2) {
    ...
    if (info.mi_geo.upper != info.mi_geo.lower)
      printf("geometry=l%" 
# 136 "/libmdbx/src/mdbx_dump.c" 3 4
                          "l" "u" 
# 136 "/libmdbx/src/mdbx_dump.c"
                                 ",c%" 
# 136 "/libmdbx/src/mdbx_dump.c" 3 4
                                       "l" "u" 
# 136 "/libmdbx/src/mdbx_dump.c"
...
# 137 "/libmdbx/src/mdbx_dump.c"
            ",g%" 
# 137 "/libmdbx/src/mdbx_dump.c" 3 4
                  "l" "u" 
# 137 "/libmdbx/src/mdbx_dump.c"
                         "\n",
    ...
    printf("mapsize=%" 
# 140 "/libmdbx/src/mdbx_dump.c" 3 4
                      "l" "u" 
# 140 "/libmdbx/src/mdbx_dump.c"
                             "\n", info.mi_geo.upper);
    printf("maxreaders=%u\n", info.mi_maxreaders);
    ...
    if (canary.v)
      printf("canary=v%" 
# 150 "/libmdbx/src/mdbx_dump.c" 3 4
                        "l" "u" 
# 150 "/libmdbx/src/mdbx_dump.c"
                               ",x%" 
# 150 "/libmdbx/src/mdbx_dump.c" 3 4
                                     "l" "u" 
# 150 "/libmdbx/src/mdbx_dump.c"
...
# 150 "/libmdbx/src/mdbx_dump.c"
  ...
  if (sequence)
    printf("sequence=%" 
# 178 "/libmdbx/src/mdbx_dump.c" 3 4
                       "l" "u" 
# 178 "/libmdbx/src/mdbx_dump.c"
                              "\n", sequence);
  ...
  if (0 > 0 && rescue) {
    cursor->mc_flags |= 0x800;
    if (cursor->mc_xcursor)
      cursor->mc_xcursor->mx_cursor.mc_flags |= 0x800;
  }
...
static void usage(void) {
  fprintf(
# 220 "/libmdbx/src/mdbx_dump.c" 3 4
         stderr
# 220 "/libmdbx/src/mdbx_dump.c"
               ,
          ...
          prog);
  exit(
# 233 "/libmdbx/src/mdbx_dump.c" 3 4
      1
# 233 "/libmdbx/src/mdbx_dump.c"
                  );
}
...
int main(int argc, char *argv[]) {
  ...
  char *envname;
  char *subname = 
# 250 "/libmdbx/src/mdbx_dump.c" 3 4
                 ((void *)0)
# 250 "/libmdbx/src/mdbx_dump.c"
                        , *buf4free = 
# 250 "/libmdbx/src/mdbx_dump.c" 3 4
                                      ((void *)0)
# 250 "/libmdbx/src/mdbx_dump.c"
  ...
  while ((i = getopt(argc, argv,
                     ...
                     "r"
                     "q")) != 
# 266 "/libmdbx/src/mdbx_dump.c" 3 4
                             (-1)
# 266 "/libmdbx/src/mdbx_dump.c"
                                ) {
    switch (i) {
    case 'V':
      printf("mdbx_dump version %d.%d.%d.%d\n"
             ...
             mdbx_build.options);
      return 
# 281 "/libmdbx/src/mdbx_dump.c" 3 4
            0
# 281 "/libmdbx/src/mdbx_dump.c"
                        ;
    case 'l':
      list = (1);
                     ;
    ...
    case 'f':
      if (freopen(optarg, "w", 
# 292 "/libmdbx/src/mdbx_dump.c" 3 4
                              stdout
# 292 "/libmdbx/src/mdbx_dump.c"
                                    ) == 
# 292 "/libmdbx/src/mdbx_dump.c" 3 4
                                         ((void *)0)
# 292 "/libmdbx/src/mdbx_dump.c"
        ...
        fprintf(
# 293 "/libmdbx/src/mdbx_dump.c" 3 4
               stderr
# 293 "/libmdbx/src/mdbx_dump.c"
                     , "%s: %s: reopen: %s\n", prog, optarg,
                mdbx_strerror(
# 294 "/libmdbx/src/mdbx_dump.c" 3 4
                             (*__errno_location ())
# 294 "/libmdbx/src/mdbx_dump.c"
                                  ));
        exit(
# 295 "/libmdbx/src/mdbx_dump.c" 3 4
            1
# 295 "/libmdbx/src/mdbx_dump.c"
                        );
      }
      break;
    case 'n':
  ...
  signal(
# 326 "/libmdbx/src/mdbx_dump.c" 3 4
        13
# 326 "/libmdbx/src/mdbx_dump.c"
               , signal_handler);


  signal(
# 329 "/libmdbx/src/mdbx_dump.c" 3 4
        1
# 329 "/libmdbx/src/mdbx_dump.c"
              , signal_handler);

  signal(
# 331 "/libmdbx/src/mdbx_dump.c" 3 4
        2
# 331 "/libmdbx/src/mdbx_dump.c"
              , signal_handler);
  signal(
# 332 "/libmdbx/src/mdbx_dump.c" 3 4
        15
# 332 "/libmdbx/src/mdbx_dump.c"
               , signal_handler);
  ...
  if (!quiet) {
    fprintf(
# 337 "/libmdbx/src/mdbx_dump.c" 3 4
           stderr
# 337 "/libmdbx/src/mdbx_dump.c"
                 , "mdbx_dump %s (%s, T-%s)\nRunning for %s...\n",
            mdbx_version.git.describe, mdbx_version.git.datetime,
            mdbx_version.git.tree, envname);
    fflush(
# 340 "/libmdbx/src/mdbx_dump.c" 3 4
          ((void *)0)
# 340 "/libmdbx/src/mdbx_dump.c"
                 );
  }
  ...
  if (__builtin_expect(!!(rc != MDBX_SUCCESS), 0)) {
    ...
    return 
# 346 "/libmdbx/src/mdbx_dump.c" 3 4
          1
# 346 "/libmdbx/src/mdbx_dump.c"
                      ;
  }
...
# 365 "/libmdbx/src/mdbx_dump.c" 3 4
                          ((void *)0)
# 365 "/libmdbx/src/mdbx_dump.c"
                                 , MDBX_TXN_RDONLY, &txn);
  if (__builtin_expect(!!(rc != MDBX_SUCCESS), 0)) {
...
# 378 "/libmdbx/src/mdbx_dump.c" 3 4
   ((void) (0))
# 378 "/libmdbx/src/mdbx_dump.c"
                          ;

    MDBX_cursor *cursor;
    rc = mdbx_cursor_open(txn, 1, &cursor);
    if (__builtin_expect(!!(rc != MDBX_SUCCESS), 0)) {
      error("mdbx_cursor_open", rc);
      goto txn_abort;
    }
...
# 396 "/libmdbx/src/mdbx_dump.c" 3 4
                                              ((void *)0)
# 396 "/libmdbx/src/mdbx_dump.c"
                                                     , MDBX_NEXT_NODUP))) {
      if (user_break) {
        rc = MDBX_EINTR;
        break;
      ...
      if (memchr(key.iov_base, '\0', key.iov_len))
        continue;
      subname = realloc(buf4free, key.iov_len + 1);
      if (!subname) {
        rc = MDBX_ENOMEM;
        break;
      }
      ...
      rc = mdbx_dbi_open_ex(txn, subname, MDBX_DB_ACCEDE, &sub_dbi,
                            rescue ? equal_or_greater : 
# 416 "/libmdbx/src/mdbx_dump.c" 3 4
                                                       ((void *)0)
# 416 "/libmdbx/src/mdbx_dump.c"
                                                              ,
                            rescue ? equal_or_greater : 
# 417 "/libmdbx/src/mdbx_dump.c" 3 4
                                                       ((void *)0)
# 417 "/libmdbx/src/mdbx_dump.c"
                                                              );
      if (__builtin_expect(!!(rc != MDBX_SUCCESS), 0)) {
        ...
        if (list) {
          ...
          if (__builtin_expect(!!(rc != MDBX_SUCCESS), 0)) {
            ...
            if (!quiet)
              fprintf(
# 436 "/libmdbx/src/mdbx_dump.c" 3 4
                     stderr
# 436 "/libmdbx/src/mdbx_dump.c"
                           , "%s: %s: ignore %s for `%s` and continue\n", prog,
                      envname, mdbx_strerror(rc), subname);
# 446 "/libmdbx/src/mdbx_dump.c"
    ...
    mdbx_cursor_close(cursor);
    cursor = 
# 466 "/libmdbx/src/mdbx_dump.c" 3 4
            ((void *)0)
# 466 "/libmdbx/src/mdbx_dump.c"
                   ;

    if (have_raw && (!count ))
      rc = dump_sdb(txn, 1, 
# 469 "/libmdbx/src/mdbx_dump.c" 3 4
                                  ((void *)0)
# 469 "/libmdbx/src/mdbx_dump.c"
                                         );
    else if (!count) {
      if (!quiet)
        fprintf(
# 472 "/libmdbx/src/mdbx_dump.c" 3 4
               stderr
# 472 "/libmdbx/src/mdbx_dump.c"
  ...
  case MDBX_EINTR:
    if (!quiet)
      fprintf(
# 487 "/libmdbx/src/mdbx_dump.c" 3 4
             stderr
# 487 "/libmdbx/src/mdbx_dump.c"
...
env_close:
  ...
  return rc ? 
# 501 "/libmdbx/src/mdbx_dump.c" 3 4
             1 
# 501 "/libmdbx/src/mdbx_dump.c"
                          : 
# 501 "/libmdbx/src/mdbx_dump.c" 3 4
                            0
# 501 "/libmdbx/src/mdbx_dump.c"
