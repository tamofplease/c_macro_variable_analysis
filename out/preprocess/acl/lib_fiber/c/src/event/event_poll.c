# 1 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 2
...
void hook_once(void);
# 7 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 2
...
# 8 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 2
# 1 "/workspace/acl/lib_fiber/c/src/event/event_poll.h" 1
...
# 9 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 2
...
# 40 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 ((void) sizeof ((
# 40 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
 ep->count < ep->size
# 40 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
...
# 40 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
 "ep->count < ep->size"
# 40 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 , "/workspace/acl/lib_fiber/c/src/event/event_poll.c", 40, __extension__ __PRETTY_FUNCTION__); }))
# 40 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                             ;
  fe->id = ep->count++;
 }
 ...
 if (pfd->events & (
# 46 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                   0x001 
# 46 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                          | 
# 46 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                            0x004
# 46 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
...
# 47 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 ((void) sizeof ((
# 47 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
 ep->files[fe->id] == fe
# 47 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 47 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
...
# 47 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
 "ep->files[fe->id] == fe"
# 47 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 , "/workspace/acl/lib_fiber/c/src/event/event_poll.c", 47, __extension__ __PRETTY_FUNCTION__); }))
# 47 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                                ;
 } else {
  pfd->events = 0;
 ...
 pfd->events |= 
# 57 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
               0x001
# 57 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                     ;
 return 0;
}
...
static int poll_add_write(EVENT_POLL *ep, FILE_EVENT *fe)
{
 struct pollfd *pfd = (fe->id >= 0 && fe->id < ep->count)
  ? &ep->pfds[fe->id] : 
# 64 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                       ((void *)0)
# 64 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                           ;

 if (fe->id == -1) {
  
# 67 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 ((void) sizeof ((
# 67 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
 ep->count < ep->size
# 67 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 67 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
...
# 67 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
 "ep->count < ep->size"
# 67 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 , "/workspace/acl/lib_fiber/c/src/event/event_poll.c", 67, __extension__ __PRETTY_FUNCTION__); }))
# 67 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                             ;
  fe->id = ep->count++;
 }
 ...
 if (pfd->events & (
# 73 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                   0x001 
# 73 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                          | 
# 73 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                            0x004
# 73 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
...
# 74 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 ((void) sizeof ((
# 74 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
 ep->files[fe->id] == fe
# 74 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 74 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
...
# 74 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
 "ep->files[fe->id] == fe"
# 74 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 , "/workspace/acl/lib_fiber/c/src/event/event_poll.c", 74, __extension__ __PRETTY_FUNCTION__); }))
# 74 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                                ;
 } else {
  pfd->events = 0;
 ...
 pfd->events |= 
# 84 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
               0x004
# 84 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                      ;
 return 0;
}
...
# 92 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
((void) sizeof ((
# 92 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
fe->id >= 0 && fe->id < ep->count
# 92 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 92 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
fe->id >= 0 && fe->id < ep->count
...
"fe->id >= 0 && fe->id < ep->count"
# 92 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/event/event_poll.c", 92, __extension__ __PRETTY_FUNCTION__); }))
# 92 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                                         ;
 pfd = &ep->pfds[fe->id];
 
# 94 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
((void) sizeof ((
# 94 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
pfd
# 94 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 94 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
...
"pfd"
# 94 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/event/event_poll.c", 94, __extension__ __PRETTY_FUNCTION__); }))
# 94 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
           ;

 if (pfd->events & 
# 96 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                  0x001
# 96 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                        ) {
  pfd->events &= ~
# 97 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                 0x001
# 97 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                       ;
 }
 if (!(pfd->events & 
# 99 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                    0x004
# 99 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                           )) {
  if (fe->id < --ep->count) {
...
# 119 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
((void) sizeof ((
# 119 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
fe->id >= 0 && fe->id < ep->count
# 119 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 119 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
...
"fe->id >= 0 && fe->id < ep->count"
# 119 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/event/event_poll.c", 119, __extension__ __PRETTY_FUNCTION__); }))
# 119 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                                         ;
 pfd = &ep->pfds[fe->id];
 
# 121 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
((void) sizeof ((
# 121 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
pfd
# 121 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 121 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
...
"pfd"
# 121 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/event/event_poll.c", 121, __extension__ __PRETTY_FUNCTION__); }))
# 121 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
           ;

 if (pfd->events & 
# 123 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                  0x004
# 123 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                         ) {
  pfd->events &= ~
# 124 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                 0x004
# 124 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                        ;
 }
 if (!(pfd->events & 
# 126 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                    0x001
# 126 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                          )) {
  if (fe->id < --ep->count) {
   ep->pfds[fe->id] = ep->pfds[ep->count];
   ep->files[fe->id] = ep->files[ep->count];
...
# 164 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                               4
# 164 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                                          ) {
   return 0;
  }
 ...
 for (i = 0; i < ep->count; i++) {
  ...
  if (pfd->revents & (
# 178 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                     0x001 
# 178 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                            | (
# 178 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                              0x008 
# 178 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
...
# 178 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
   ...
   if (pfd->revents & 
# 179 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                     0x008
# 179 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                            ) {
    fe->mask |= (unsigned) (1 << 4);
   }
   if (pfd->revents & 
# 182 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                     0x010
# 182 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                            ) {
    fe->mask |= (unsigned) (1 << 5);
   }
   if (pfd->revents & 
# 185 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                     0x020
# 185 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                             ) {
    fe->mask |= (unsigned) (1 << 6);
   }
  ...
  if (pfd->revents & (
# 197 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                     0x004 
# 197 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                             | (
# 197 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                               0x008 
# 197 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
...
# 197 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
   ...
   if (pfd->revents & 
# 198 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                     0x008
# 198 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                            ) {
    fe->mask |= (unsigned) (1 << 4);
   }
   if (pfd->revents & 
# 201 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                     0x010
# 201 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                            ) {
    fe->mask |= (unsigned) (1 << 5);
   }
   if (pfd->revents & 
# 204 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                     0x020
# 204 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                             ) {
    fe->mask |= (unsigned) (1 << 6);
   }
...
# 232 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
 return n;
}

static int poll_checkfd(EVENT *ev __attribute__((__unused__)), FILE_EVENT *fe __attribute__((__unused__)))
{
 return -1;
}
...
EVENT *event_poll_create(int size)
{
 ...
 if (sys_poll == 
# 255 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                ((void *)0)
# 255 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                    ) {
  hook_once();
  
# 257 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 ((void) sizeof ((
# 257 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
 sys_poll != 
# 257 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
...
# 257 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
 "sys_poll != NULL"
# 257 "/workspace/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 , "/workspace/acl/lib_fiber/c/src/event/event_poll.c", 257, __extension__ __PRETTY_FUNCTION__); }))
# 257 "/workspace/acl/lib_fiber/c/src/event/event_poll.c"
                         ;
 }
