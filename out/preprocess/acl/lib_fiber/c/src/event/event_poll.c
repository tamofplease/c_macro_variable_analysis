# 0 "/acl/lib_fiber/c/src/event/event_poll.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/event/event_poll.c"
...
# 2 "/acl/lib_fiber/c/src/event/event_poll.c" 2
...
# 3 "/acl/lib_fiber/c/src/event/event_poll.c" 2
...
void hook_once(void);
# 7 "/acl/lib_fiber/c/src/event/event_poll.c" 2
...
# 8 "/acl/lib_fiber/c/src/event/event_poll.c" 2
...
# 9 "/acl/lib_fiber/c/src/event/event_poll.c" 2
...
# 40 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 ((void) sizeof ((
# 40 "/acl/lib_fiber/c/src/event/event_poll.c"
 ep->count < ep->size
# 40 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
...
# 40 "/acl/lib_fiber/c/src/event/event_poll.c"
 "ep->count < ep->size"
# 40 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 , "/acl/lib_fiber/c/src/event/event_poll.c", 40, __extension__ __PRETTY_FUNCTION__); }))
# 40 "/acl/lib_fiber/c/src/event/event_poll.c"
                             ;
  fe->id = ep->count++;
 }
 ...
 if (pfd->events & (
# 46 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                   0x001 
# 46 "/acl/lib_fiber/c/src/event/event_poll.c"
                          | 
# 46 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                            0x004
# 46 "/acl/lib_fiber/c/src/event/event_poll.c"
...
# 47 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 ((void) sizeof ((
# 47 "/acl/lib_fiber/c/src/event/event_poll.c"
 ep->files[fe->id] == fe
# 47 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 47 "/acl/lib_fiber/c/src/event/event_poll.c"
...
# 47 "/acl/lib_fiber/c/src/event/event_poll.c"
 "ep->files[fe->id] == fe"
# 47 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 , "/acl/lib_fiber/c/src/event/event_poll.c", 47, __extension__ __PRETTY_FUNCTION__); }))
# 47 "/acl/lib_fiber/c/src/event/event_poll.c"
                                ;
 } else {
  pfd->events = 0;
 ...
 pfd->events |= 
# 57 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
               0x001
# 57 "/acl/lib_fiber/c/src/event/event_poll.c"
                     ;
 return 0;
}
...
static int poll_add_write(EVENT_POLL *ep, FILE_EVENT *fe)
{
 struct pollfd *pfd = (fe->id >= 0 && fe->id < ep->count)
  ? &ep->pfds[fe->id] : 
# 64 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                       ((void *)0)
# 64 "/acl/lib_fiber/c/src/event/event_poll.c"
                           ;

 if (fe->id == -1) {
  
# 67 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 ((void) sizeof ((
# 67 "/acl/lib_fiber/c/src/event/event_poll.c"
 ep->count < ep->size
# 67 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 67 "/acl/lib_fiber/c/src/event/event_poll.c"
...
# 67 "/acl/lib_fiber/c/src/event/event_poll.c"
 "ep->count < ep->size"
# 67 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 , "/acl/lib_fiber/c/src/event/event_poll.c", 67, __extension__ __PRETTY_FUNCTION__); }))
# 67 "/acl/lib_fiber/c/src/event/event_poll.c"
                             ;
  fe->id = ep->count++;
 }
 ...
 if (pfd->events & (
# 73 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                   0x001 
# 73 "/acl/lib_fiber/c/src/event/event_poll.c"
                          | 
# 73 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                            0x004
# 73 "/acl/lib_fiber/c/src/event/event_poll.c"
...
# 74 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 ((void) sizeof ((
# 74 "/acl/lib_fiber/c/src/event/event_poll.c"
 ep->files[fe->id] == fe
# 74 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 74 "/acl/lib_fiber/c/src/event/event_poll.c"
...
# 74 "/acl/lib_fiber/c/src/event/event_poll.c"
 "ep->files[fe->id] == fe"
# 74 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 , "/acl/lib_fiber/c/src/event/event_poll.c", 74, __extension__ __PRETTY_FUNCTION__); }))
# 74 "/acl/lib_fiber/c/src/event/event_poll.c"
                                ;
 } else {
  pfd->events = 0;
 ...
 pfd->events |= 
# 84 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
               0x004
# 84 "/acl/lib_fiber/c/src/event/event_poll.c"
                      ;
 return 0;
}
...
# 92 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
((void) sizeof ((
# 92 "/acl/lib_fiber/c/src/event/event_poll.c"
...
"fe->id >= 0 && fe->id < ep->count"
# 92 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
, "/acl/lib_fiber/c/src/event/event_poll.c", 92, __extension__ __PRETTY_FUNCTION__); }))
# 92 "/acl/lib_fiber/c/src/event/event_poll.c"
                                         ;
 pfd = &ep->pfds[fe->id];
 
# 94 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
((void) sizeof ((
# 94 "/acl/lib_fiber/c/src/event/event_poll.c"
pfd
# 94 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 94 "/acl/lib_fiber/c/src/event/event_poll.c"
...
"pfd"
# 94 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
, "/acl/lib_fiber/c/src/event/event_poll.c", 94, __extension__ __PRETTY_FUNCTION__); }))
# 94 "/acl/lib_fiber/c/src/event/event_poll.c"
           ;

 if (pfd->events & 
# 96 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                  0x001
# 96 "/acl/lib_fiber/c/src/event/event_poll.c"
                        ) {
  pfd->events &= ~
# 97 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                 0x001
# 97 "/acl/lib_fiber/c/src/event/event_poll.c"
                       ;
 }
 if (!(pfd->events & 
# 99 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                    0x004
# 99 "/acl/lib_fiber/c/src/event/event_poll.c"
                           )) {
  if (fe->id < --ep->count) {
...
# 119 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
((void) sizeof ((
# 119 "/acl/lib_fiber/c/src/event/event_poll.c"
fe->id >= 0 && fe->id < ep->count
# 119 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 119 "/acl/lib_fiber/c/src/event/event_poll.c"
...
"fe->id >= 0 && fe->id < ep->count"
# 119 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
, "/acl/lib_fiber/c/src/event/event_poll.c", 119, __extension__ __PRETTY_FUNCTION__); }))
# 119 "/acl/lib_fiber/c/src/event/event_poll.c"
                                         ;
 pfd = &ep->pfds[fe->id];
 
# 121 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
((void) sizeof ((
# 121 "/acl/lib_fiber/c/src/event/event_poll.c"
pfd
# 121 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 121 "/acl/lib_fiber/c/src/event/event_poll.c"
...
"pfd"
# 121 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
, "/acl/lib_fiber/c/src/event/event_poll.c", 121, __extension__ __PRETTY_FUNCTION__); }))
# 121 "/acl/lib_fiber/c/src/event/event_poll.c"
           ;

 if (pfd->events & 
# 123 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                  0x004
# 123 "/acl/lib_fiber/c/src/event/event_poll.c"
                         ) {
  pfd->events &= ~
# 124 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                 0x004
# 124 "/acl/lib_fiber/c/src/event/event_poll.c"
                        ;
 }
 if (!(pfd->events & 
# 126 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                    0x001
# 126 "/acl/lib_fiber/c/src/event/event_poll.c"
                          )) {
  if (fe->id < --ep->count) {
   ep->pfds[fe->id] = ep->pfds[ep->count];
   ep->files[fe->id] = ep->files[ep->count];
...
# 164 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                               4
# 164 "/acl/lib_fiber/c/src/event/event_poll.c"
                                          ) {
   return 0;
  }
 ...
 for (i = 0; i < ep->count; i++) {
  ...
  if (pfd->revents & (
# 178 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                     0x001 
# 178 "/acl/lib_fiber/c/src/event/event_poll.c"
                            | (
# 178 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                              0x008 
# 178 "/acl/lib_fiber/c/src/event/event_poll.c"
...
# 178 "/acl/lib_fiber/c/src/event/event_poll.c"
   ...
   if (pfd->revents & 
# 179 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                     0x008
# 179 "/acl/lib_fiber/c/src/event/event_poll.c"
                            ) {
    fe->mask |= (unsigned) (1 << 4);
   }
   if (pfd->revents & 
# 182 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                     0x010
# 182 "/acl/lib_fiber/c/src/event/event_poll.c"
                            ) {
    fe->mask |= (unsigned) (1 << 5);
   }
   if (pfd->revents & 
# 185 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                     0x020
# 185 "/acl/lib_fiber/c/src/event/event_poll.c"
                             ) {
  ...
  if (pfd->revents & (
# 197 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                     0x004 
# 197 "/acl/lib_fiber/c/src/event/event_poll.c"
                             | (
# 197 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                               0x008 
# 197 "/acl/lib_fiber/c/src/event/event_poll.c"
...
# 197 "/acl/lib_fiber/c/src/event/event_poll.c"
   ...
   if (pfd->revents & 
# 198 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                     0x008
# 198 "/acl/lib_fiber/c/src/event/event_poll.c"
                            ) {
    fe->mask |= (unsigned) (1 << 4);
   }
   if (pfd->revents & 
# 201 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                     0x010
# 201 "/acl/lib_fiber/c/src/event/event_poll.c"
                            ) {
    fe->mask |= (unsigned) (1 << 5);
   }
   if (pfd->revents & 
# 204 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                     0x020
# 204 "/acl/lib_fiber/c/src/event/event_poll.c"
                             ) {
    fe->mask |= (unsigned) (1 << 6);
   }
...
# 232 "/acl/lib_fiber/c/src/event/event_poll.c"
 return n;
}
...
EVENT *event_poll_create(int size)
{
 ...
 if (sys_poll == 
# 255 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
                ((void *)0)
# 255 "/acl/lib_fiber/c/src/event/event_poll.c"
                    ) {
  hook_once();
  
# 257 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 ((void) sizeof ((
# 257 "/acl/lib_fiber/c/src/event/event_poll.c"
 sys_poll != 
# 257 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
...
# 257 "/acl/lib_fiber/c/src/event/event_poll.c"
 "sys_poll != NULL"
# 257 "/acl/lib_fiber/c/src/event/event_poll.c" 3 4
 , "/acl/lib_fiber/c/src/event/event_poll.c", 257, __extension__ __PRETTY_FUNCTION__); }))
# 257 "/acl/lib_fiber/c/src/event/event_poll.c"
                         ;
 }
