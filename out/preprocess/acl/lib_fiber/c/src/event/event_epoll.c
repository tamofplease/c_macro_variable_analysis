# 1 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 2
# 11 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
...
# 12 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 2
# 1 "/workspace/acl/lib_fiber/c/src/event/event_epoll.h" 1
...
# 13 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 2
...
static epoll_create_fn __sys_epoll_create = 
# 18 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                                           ((void *)0)
# 18 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                                               ;
static epoll_wait_fn __sys_epoll_wait = 
# 19 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                                           ((void *)0)
# 19 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                                               ;
static epoll_ctl_fn __sys_epoll_ctl = 
# 20 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                                           ((void *)0)
# 20 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                                               ;

static void hook_api(void)
{
 __sys_epoll_create = (epoll_create_fn) dlsym(
# 24 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                                             ((void *) -1l)
# 24 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                                                      , "epoll_create");
 
# 25 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
((void) sizeof ((
# 25 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
__sys_epoll_create
# 25 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
...
"__sys_epoll_create"
# 25 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/event/event_epoll.c", 25, __extension__ __PRETTY_FUNCTION__); }))
# 25 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                          ;

 __sys_epoll_wait = (epoll_wait_fn) dlsym(
# 27 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                                           ((void *) -1l)
# 27 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                                                    , "epoll_wait");
 
# 28 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
((void) sizeof ((
# 28 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
__sys_epoll_wait
# 28 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 28 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
...
"__sys_epoll_wait"
# 28 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/event/event_epoll.c", 28, __extension__ __PRETTY_FUNCTION__); }))
# 28 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                        ;

 __sys_epoll_ctl = (epoll_ctl_fn) dlsym(
# 30 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                                          ((void *) -1l)
# 30 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                                                   , "epoll_ctl");
 
# 31 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
((void) sizeof ((
# 31 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
__sys_epoll_ctl
# 31 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 31 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
...
"__sys_epoll_ctl"
# 31 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/event/event_epoll.c", 31, __extension__ __PRETTY_FUNCTION__); }))
# 31 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                       ;
}

static pthread_once_t __once_control = 
# 34 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                                      0
# 34 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                                                       ;
...
static int epoll_add_read(EVENT_EPOLL *ep, FILE_EVENT *fe)
{
 ...
 ee.events |= 
# 82 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
             EPOLLIN
# 82 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                    ;
 if (fe->mask & (unsigned) (1 << 3)) {
  ee.events |= 
# 84 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
              EPOLLOUT
# 84 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                      ;
  op = 
# 85 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
      3
# 85 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                   ;
  n = 0;
 } else {
  op = 
# 88 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
      1
# 88 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                   ;
  n = 1;
 }
 ...
 if (
# 98 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
    (*__errno_location ()) 
# 98 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
          != 
# 98 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
             1
# 98 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
  ...
  msg_error("%s(%d): epoll_ctl error %s, epfd=%d, fd=%d\n",
   __FUNCTION__, 100, last_serror(), ep->epfd, fe->fd);
 }
 return -1;
}
...
static int epoll_add_write(EVENT_EPOLL *ep, FILE_EVENT *fe)
{
 ...
 ee.events |= 
# 115 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
             EPOLLOUT
# 115 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                     ;

 if (fe->mask & (unsigned) (1 << 2)) {
  ee.events |= 
# 118 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
              EPOLLIN
# 118 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                     ;
  op = 
# 119 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
      3
# 119 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                   ;
  n = 0;
 } else {
  op = 
# 122 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
      1
# 122 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                   ;
  n = 1;
 }
 ...
 if (
# 132 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
    (*__errno_location ()) 
# 132 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
          != 
# 132 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
             1
# 132 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
  ...
  msg_error("%s(%d): epoll_ctl error %s, epfd=%d, fd=%d",
   __FUNCTION__, 134, last_serror(), ep->epfd, fe->fd);
 }
 return -1;
}
...
static int epoll_del_read(EVENT_EPOLL *ep, FILE_EVENT *fe)
{
 ...
 if (fe->mask & (unsigned) (1 << 3)) {
  ee.events = 
# 150 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
             EPOLLOUT
# 150 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                     ;
  op = 
# 151 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
      3
# 151 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                   ;
  n = 0;
 } else {
  op = 
# 154 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
      2
# 154 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                   ;
  n = -1;
 }
 ...
 if (
# 164 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
    (*__errno_location ()) 
# 164 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
          != 
# 164 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
             17
# 164 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
  ...
  msg_error("%s(%d), epoll_ctl error: %s, epfd=%d, fd=%d",
   __FUNCTION__, 166, last_serror(), ep->epfd, fe->fd);
 }
 return -1;
}
...
static int epoll_del_write(EVENT_EPOLL *ep, FILE_EVENT *fe)
{
 ...
 if (fe->mask & (unsigned) (1 << 2)) {
  ee.events = 
# 182 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
             EPOLLIN
# 182 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                    ;
  op = 
# 183 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
      3
# 183 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                   ;
  n = 0;
 } else {
  op = 
# 186 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
      2
# 186 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                   ;
  n = -1;
 }
 ...
 if (
# 196 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
    (*__errno_location ()) 
# 196 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
          != 
# 196 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
             17
# 196 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
  ...
  msg_error("%s(%d), epoll_ctl error: %s, efd=%d, fd=%d",
   __FUNCTION__, 198, last_serror(), ep->epfd, fe->fd);
 }
 return -1;
}
...
static int epoll_event_wait(EVENT *ev, int timeout)
{
 ...
 if (__sys_epoll_wait == 
# 213 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                        ((void *)0)
# 213 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                            ) {
  hook_init();
 }
...
# 220 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                               4
# 220 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                                          ) {
   return 0;
  }
 ...
 for (i = 0; i < n; i++) {
  ...
  if (ee->events & (
# 234 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                   EPOLLIN 
# 234 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                           | (
# 234 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                             EPOLLERR 
# 234 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
...
# 234 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
   ...
   if (ee->events & 
# 235 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                   EPOLLERR
# 235 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                           ) {
    fe->mask |= (unsigned) (1 << 4);
   }
   if (ee->events & 
# 238 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                   EPOLLHUP
# 238 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                           ) {
    fe->mask |= (unsigned) (1 << 5);
   }
  ...
  if (ee->events & (
# 250 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                   EPOLLOUT 
# 250 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                            | (
# 250 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                              EPOLLERR 
# 250 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
...
# 250 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
   ...
   if (ee->events & 
# 251 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                   EPOLLERR
# 251 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                           ) {
    fe->mask |= (unsigned) (1 << 4);
   }
   if (ee->events & 
# 254 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                   EPOLLHUP
# 254 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                           ) {
    fe->mask |= (unsigned) (1 << 5);
   }
...
# 282 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
 return n;
}

static int epoll_checkfd(EVENT *ev __attribute__((__unused__)), FILE_EVENT *fe __attribute__((__unused__)))
{
...
EVENT *event_epoll_create(int size)
{
 ...
 if (__sys_epoll_create == 
# 314 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                          ((void *)0)
# 314 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                              ) {
  hook_init();
 }
...
# 336 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
((void) sizeof ((
# 336 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
ep->epfd >= 0
# 336 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 336 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
...
"ep->epfd >= 0"
# 336 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/event/event_epoll.c", 336, __extension__ __PRETTY_FUNCTION__); }))
# 336 "/workspace/acl/lib_fiber/c/src/event/event_epoll.c"
                     ;
