# 0 "/acl/lib_fiber/c/src/event/event_epoll.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/event/event_epoll.c"
...
# 2 "/acl/lib_fiber/c/src/event/event_epoll.c" 2
...
# 3 "/acl/lib_fiber/c/src/event/event_epoll.c" 2
# 11 "/acl/lib_fiber/c/src/event/event_epoll.c"
...
# 12 "/acl/lib_fiber/c/src/event/event_epoll.c" 2
# 1 "/acl/lib_fiber/c/src/event/event_epoll.h" 1
...
# 13 "/acl/lib_fiber/c/src/event/event_epoll.c" 2
...
# 18 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                                           ((void *)0)
# 18 "/acl/lib_fiber/c/src/event/event_epoll.c"
                                               ;
static epoll_wait_fn __sys_epoll_wait = 
# 19 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                                           ((void *)0)
# 19 "/acl/lib_fiber/c/src/event/event_epoll.c"
                                               ;
static epoll_ctl_fn __sys_epoll_ctl = 
# 20 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                                           ((void *)0)
# 20 "/acl/lib_fiber/c/src/event/event_epoll.c"
                                               ;

static void hook_api(void)
{
 __sys_epoll_create = (epoll_create_fn) dlsym(
# 24 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                                             ((void *) -1l)
# 24 "/acl/lib_fiber/c/src/event/event_epoll.c"
                                                      , "epoll_create");
 
# 25 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
((void) sizeof ((
# 25 "/acl/lib_fiber/c/src/event/event_epoll.c"
__sys_epoll_create
# 25 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
...
"__sys_epoll_create"
# 25 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
, "/acl/lib_fiber/c/src/event/event_epoll.c", 25, __extension__ __PRETTY_FUNCTION__); }))
# 25 "/acl/lib_fiber/c/src/event/event_epoll.c"
                          ;

 __sys_epoll_wait = (epoll_wait_fn) dlsym(
# 27 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                                           ((void *) -1l)
# 27 "/acl/lib_fiber/c/src/event/event_epoll.c"
                                                    , "epoll_wait");
 
# 28 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
((void) sizeof ((
# 28 "/acl/lib_fiber/c/src/event/event_epoll.c"
__sys_epoll_wait
# 28 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 28 "/acl/lib_fiber/c/src/event/event_epoll.c"
...
"__sys_epoll_wait"
# 28 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
, "/acl/lib_fiber/c/src/event/event_epoll.c", 28, __extension__ __PRETTY_FUNCTION__); }))
# 28 "/acl/lib_fiber/c/src/event/event_epoll.c"
                        ;

 __sys_epoll_ctl = (epoll_ctl_fn) dlsym(
# 30 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                                          ((void *) -1l)
# 30 "/acl/lib_fiber/c/src/event/event_epoll.c"
                                                   , "epoll_ctl");
 
# 31 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
((void) sizeof ((
# 31 "/acl/lib_fiber/c/src/event/event_epoll.c"
__sys_epoll_ctl
# 31 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 31 "/acl/lib_fiber/c/src/event/event_epoll.c"
...
"__sys_epoll_ctl"
# 31 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
, "/acl/lib_fiber/c/src/event/event_epoll.c", 31, __extension__ __PRETTY_FUNCTION__); }))
# 31 "/acl/lib_fiber/c/src/event/event_epoll.c"
                       ;
}

static pthread_once_t __once_control = 
# 34 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                                      0
# 34 "/acl/lib_fiber/c/src/event/event_epoll.c"
                                                       ;
...
static int epoll_add_read(EVENT_EPOLL *ep, FILE_EVENT *fe)
{
 ...
 ee.events |= 
# 82 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
             EPOLLIN
# 82 "/acl/lib_fiber/c/src/event/event_epoll.c"
                    ;
 if (fe->mask & (unsigned) (1 << 3)) {
  ee.events |= 
# 84 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
              EPOLLOUT
# 84 "/acl/lib_fiber/c/src/event/event_epoll.c"
                      ;
  op = 
# 85 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
      3
# 85 "/acl/lib_fiber/c/src/event/event_epoll.c"
                   ;
  n = 0;
 } else {
  op = 
# 88 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
      1
# 88 "/acl/lib_fiber/c/src/event/event_epoll.c"
                   ;
  n = 1;
 }
 ...
 if (
# 98 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
    (*__errno_location ()) 
# 98 "/acl/lib_fiber/c/src/event/event_epoll.c"
          != 
# 98 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
             1
# 98 "/acl/lib_fiber/c/src/event/event_epoll.c"
...
static int epoll_add_write(EVENT_EPOLL *ep, FILE_EVENT *fe)
{
 ...
 ee.events |= 
# 115 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
             EPOLLOUT
# 115 "/acl/lib_fiber/c/src/event/event_epoll.c"
                     ;

 if (fe->mask & (unsigned) (1 << 2)) {
  ee.events |= 
# 118 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
              EPOLLIN
# 118 "/acl/lib_fiber/c/src/event/event_epoll.c"
                     ;
  op = 
# 119 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
      3
# 119 "/acl/lib_fiber/c/src/event/event_epoll.c"
                   ;
  n = 0;
 } else {
  op = 
# 122 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
      1
# 122 "/acl/lib_fiber/c/src/event/event_epoll.c"
                   ;
  n = 1;
 }
 ...
 if (
# 132 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
    (*__errno_location ()) 
# 132 "/acl/lib_fiber/c/src/event/event_epoll.c"
          != 
# 132 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
             1
# 132 "/acl/lib_fiber/c/src/event/event_epoll.c"
...
static int epoll_del_read(EVENT_EPOLL *ep, FILE_EVENT *fe)
{
 ...
 if (fe->mask & (unsigned) (1 << 3)) {
  ee.events = 
# 150 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
             EPOLLOUT
# 150 "/acl/lib_fiber/c/src/event/event_epoll.c"
                     ;
  op = 
# 151 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
      3
# 151 "/acl/lib_fiber/c/src/event/event_epoll.c"
                   ;
  n = 0;
 } else {
  op = 
# 154 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
      2
# 154 "/acl/lib_fiber/c/src/event/event_epoll.c"
                   ;
  n = -1;
 }
 ...
 if (
# 164 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
    (*__errno_location ()) 
# 164 "/acl/lib_fiber/c/src/event/event_epoll.c"
          != 
# 164 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
             17
# 164 "/acl/lib_fiber/c/src/event/event_epoll.c"
...
static int epoll_del_write(EVENT_EPOLL *ep, FILE_EVENT *fe)
{
 ...
 if (fe->mask & (unsigned) (1 << 2)) {
  ee.events = 
# 182 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
             EPOLLIN
# 182 "/acl/lib_fiber/c/src/event/event_epoll.c"
                    ;
  op = 
# 183 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
      3
# 183 "/acl/lib_fiber/c/src/event/event_epoll.c"
                   ;
  n = 0;
 } else {
  op = 
# 186 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
      2
# 186 "/acl/lib_fiber/c/src/event/event_epoll.c"
                   ;
  n = -1;
 }
 ...
 if (
# 196 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
    (*__errno_location ()) 
# 196 "/acl/lib_fiber/c/src/event/event_epoll.c"
          != 
# 196 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
             17
# 196 "/acl/lib_fiber/c/src/event/event_epoll.c"
...
static int epoll_event_wait(EVENT *ev, int timeout)
{
 ...
 if (__sys_epoll_wait == 
# 213 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                        ((void *)0)
# 213 "/acl/lib_fiber/c/src/event/event_epoll.c"
                            ) {
  hook_init();
 }
...
# 220 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                               4
# 220 "/acl/lib_fiber/c/src/event/event_epoll.c"
                                          ) {
   return 0;
  }
 ...
 for (i = 0; i < n; i++) {
  ...
  if (ee->events & (
# 234 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                   EPOLLIN 
# 234 "/acl/lib_fiber/c/src/event/event_epoll.c"
                           | (
# 234 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                             EPOLLERR 
# 234 "/acl/lib_fiber/c/src/event/event_epoll.c"
...
# 234 "/acl/lib_fiber/c/src/event/event_epoll.c"
   ...
   if (ee->events & 
# 235 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                   EPOLLERR
# 235 "/acl/lib_fiber/c/src/event/event_epoll.c"
                           ) {
    fe->mask |= (unsigned) (1 << 4);
   }
   if (ee->events & 
# 238 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                   EPOLLHUP
# 238 "/acl/lib_fiber/c/src/event/event_epoll.c"
                           ) {
  ...
  if (ee->events & (
# 250 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                   EPOLLOUT 
# 250 "/acl/lib_fiber/c/src/event/event_epoll.c"
                            | (
# 250 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                              EPOLLERR 
# 250 "/acl/lib_fiber/c/src/event/event_epoll.c"
...
# 250 "/acl/lib_fiber/c/src/event/event_epoll.c"
   ...
   if (ee->events & 
# 251 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                   EPOLLERR
# 251 "/acl/lib_fiber/c/src/event/event_epoll.c"
                           ) {
    fe->mask |= (unsigned) (1 << 4);
   }
   if (ee->events & 
# 254 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                   EPOLLHUP
# 254 "/acl/lib_fiber/c/src/event/event_epoll.c"
                           ) {
    fe->mask |= (unsigned) (1 << 5);
   }
...
# 282 "/acl/lib_fiber/c/src/event/event_epoll.c"
 return n;
}
...
# 314 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
                          ((void *)0)
# 314 "/acl/lib_fiber/c/src/event/event_epoll.c"
                              ) {
  hook_init();
 }
...
# 336 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
((void) sizeof ((
# 336 "/acl/lib_fiber/c/src/event/event_epoll.c"
ep->epfd >= 0
# 336 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 336 "/acl/lib_fiber/c/src/event/event_epoll.c"
...
"ep->epfd >= 0"
# 336 "/acl/lib_fiber/c/src/event/event_epoll.c" 3 4
, "/acl/lib_fiber/c/src/event/event_epoll.c", 336, __extension__ __PRETTY_FUNCTION__); }))
# 336 "/acl/lib_fiber/c/src/event/event_epoll.c"
                     ;
