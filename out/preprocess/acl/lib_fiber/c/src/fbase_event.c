# 1 "/workspace/acl/lib_fiber/c/src/fbase_event.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/fbase_event.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/fbase_event.c" 2
...
# 10 "/workspace/acl/lib_fiber/c/src/fbase_event.c" 2
...
# 13 "/workspace/acl/lib_fiber/c/src/fbase_event.c" 2
...
# 1 "/workspace/acl/lib_fiber/c/include/fiber/fiber_hook.h" 1
# 21 "/workspace/acl/lib_fiber/c/src/fbase_event.c" 2
...
void hook_once(void);
# 23 "/workspace/acl/lib_fiber/c/src/fbase_event.c" 2
...
# 1 "/workspace/acl/lib_fiber/c/src/hook/../define.h" 1
# 5 "/workspace/acl/lib_fiber/c/src/hook/../event.h" 2
# 1 "/workspace/acl/lib_fiber/c/src/hook/../common/gettimeofday.h" 1
# 6 "/workspace/acl/lib_fiber/c/src/hook/../event.h" 2
# 1 "/workspace/acl/lib_fiber/c/src/hook/../common/timer_cache.h" 1
# 7 "/workspace/acl/lib_fiber/c/src/hook/../event.h" 2
# 34 "/workspace/acl/lib_fiber/c/src/hook/../event.h"
...
# 75 "/workspace/acl/lib_fiber/c/src/hook/../event.h"
struct FILE_EVENT {
 RING me;
 ACL_FIBER *fiber_r;
 ACL_FIBER *fiber_w;
 ...
 int id;
 unsigned status;
# 123 "/workspace/acl/lib_fiber/c/src/hook/../event.h"
 unsigned type;
 ...
 unsigned mask;
# 175 "/workspace/acl/lib_fiber/c/src/hook/../event.h"
 event_proc *r_proc;
 event_proc *w_proc;
 ...
 EPOLL_CTX *epx;
# 296 "/workspace/acl/lib_fiber/c/src/hook/../event.h"
 short refer;
 short busy;
...
# 384 "/workspace/acl/lib_fiber/c/src/hook/../event.h"
...
# 24 "/workspace/acl/lib_fiber/c/src/fbase_event.c" 2
...
# 25 "/workspace/acl/lib_fiber/c/src/fbase_event.c" 2
...
void fbase_event_open(FIBER_BASE *fbase)
{
 ...
 flags |= 
# 34 "/workspace/acl/lib_fiber/c/src/fbase_event.c" 3 4
         1
# 34 "/workspace/acl/lib_fiber/c/src/fbase_event.c"
                   ;
...
# 57 "/workspace/acl/lib_fiber/c/src/fbase_event.c"
 if (fbase->event_in == -1) {
  msg_fatal("%s(%d), %s event_in(%d) invalid",
   "/workspace/acl/lib_fiber/c/src/fbase_event.c", 59, __FUNCTION__, (int) fbase->event_in);
 }
...
# 81 "/workspace/acl/lib_fiber/c/src/fbase_event.c"
...
void fbase_event_close(FIBER_BASE *fbase)
{
 ...
 fbase->event_out = -1;
 fbase->in = 
# 101 "/workspace/acl/lib_fiber/c/src/fbase_event.c" 3 4
             ((void *)0)
# 101 "/workspace/acl/lib_fiber/c/src/fbase_event.c"
                 ;
 fbase->out = 
# 102 "/workspace/acl/lib_fiber/c/src/fbase_event.c" 3 4
             ((void *)0)
# 102 "/workspace/acl/lib_fiber/c/src/fbase_event.c"
                 ;
}
...
int fbase_event_wait(FIBER_BASE *fbase)
{
 ...
 if (fd == -1) {
  msg_fatal("%s(%d), %s: invalid event_in=%d",
   "/workspace/acl/lib_fiber/c/src/fbase_event.c", 113, __FUNCTION__, (int) fd);
 }
 ...
 while (1) {
  if (read_wait(fbase->event_in, -1) == -1) {
   msg_error("%s(%d), %s: read_wait error=%s, fd=%d",
    "/workspace/acl/lib_fiber/c/src/fbase_event.c", 120, __FUNCTION__,
  ...
  if (ret >= 0) {
   msg_fatal("%s(%d), %s: read ret=%d invalid length, "
    "interrupt=%d, fd=%d", "/workspace/acl/lib_fiber/c/src/fbase_event.c", 146,
  ...
  if (err == 
# 152 "/workspace/acl/lib_fiber/c/src/fbase_event.c" 3 4
            4
# 152 "/workspace/acl/lib_fiber/c/src/fbase_event.c"
                 ) {
   interrupt++;
   msg_info("%s(%d), %s: read EINTR=%d, in=%d, ret=%d",
    "/workspace/acl/lib_fiber/c/src/fbase_event.c", 155, __FUNCTION__,
    interrupt, (int) fbase->event_in, ret);
   doze(1);
  } else if (err == 
# 158 "/workspace/acl/lib_fiber/c/src/fbase_event.c" 3 4
                   11
# 158 "/workspace/acl/lib_fiber/c/src/fbase_event.c"
                               ) {
   msg_info("%s(%d), %s: scheduled %s, read EAGAIN, "
    "in=%d, ret=%d", "/workspace/acl/lib_fiber/c/src/fbase_event.c", 160,
    __FUNCTION__, acl_fiber_scheduled() ? "yes":"no",
    (int) fbase->event_in, ret);
   doze(1);
  } else {
   msg_error("%s(%d), %s: read error %s, %d, in=%d, ret=%d,"
    " interrupt=%d, fiber=%d", "/workspace/acl/lib_fiber/c/src/fbase_event.c", 166,
...
int fbase_event_wakeup(FIBER_BASE *fbase)
{
 ...
 if (fd == -1) {
  msg_fatal("%s(%d), %s: fbase=%p, invalid event_out=%d",
   "/workspace/acl/lib_fiber/c/src/fbase_event.c", 185, __FUNCTION__, fbase, (int) fd);
 }
 ...
 while (1) {
  ...
  if (ret >= 0) {
   msg_fatal("%s(%d), %s: fiber=%d, write ret=%d invalid"
    ...
    "/workspace/acl/lib_fiber/c/src/fbase_event.c", 211, __FUNCTION__,
    acl_fiber_self(), ret, interrupt,
    (int) fbase->event_out);
  }

  if (acl_fiber_last_error() == 
# 216 "/workspace/acl/lib_fiber/c/src/fbase_event.c" 3 4
                               4
# 216 "/workspace/acl/lib_fiber/c/src/fbase_event.c"
                                    ) {
   interrupt++;
   msg_info("%s(%d), %s: write EINTR=%d, out=%d, ret=%d",
    "/workspace/acl/lib_fiber/c/src/fbase_event.c", 219, __FUNCTION__,
  ...
  msg_error("%s(%d), %s: write error %s, fb=%p, out=%d, ret=%d, "
   "interrupt=%d, fiber=%d", "/workspace/acl/lib_fiber/c/src/fbase_event.c", 226,
