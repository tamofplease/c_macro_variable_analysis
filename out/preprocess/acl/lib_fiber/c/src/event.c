# 1 "/workspace/acl/lib_fiber/c/src/event.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/event.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/event.c" 2
...
# 5 "/workspace/acl/lib_fiber/c/src/event/event_epoll.h" 2



EVENT *event_epoll_create(int setsize);
# 5 "/workspace/acl/lib_fiber/c/src/event.c" 2
# 1 "/workspace/acl/lib_fiber/c/src/event/event_kqueue.h" 1
# 6 "/workspace/acl/lib_fiber/c/src/event.c" 2
...
# 7 "/workspace/acl/lib_fiber/c/src/event.c" 2
...
# 8 "/workspace/acl/lib_fiber/c/src/event.c" 2
# 1 "/workspace/acl/lib_fiber/c/src/event/event_wmsg.h" 1
# 9 "/workspace/acl/lib_fiber/c/src/event.c" 2
# 1 "/workspace/acl/lib_fiber/c/src/event/event_iocp.h" 1
# 10 "/workspace/acl/lib_fiber/c/src/event.c" 2




# 1 "/workspace/acl/lib_fiber/c/src/event.h" 1
# 15 "/workspace/acl/lib_fiber/c/src/event.c" 2

static __thread int __event_mode = 0;
...
{
 EVENT *ev = 
# 35 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
            ((void *)0)
# 35 "/workspace/acl/lib_fiber/c/src/event.c"
                ;
...
# 54 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
 ((void) sizeof ((
# 54 "/workspace/acl/lib_fiber/c/src/event.c"
 0
# 54 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
...
# 54 "/workspace/acl/lib_fiber/c/src/event.c"
 "0"
# 54 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
 , "/workspace/acl/lib_fiber/c/src/event.c", 54, __extension__ __PRETTY_FUNCTION__); }))
# 54 "/workspace/acl/lib_fiber/c/src/event.c"
          ;
...
# 62 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
 ((void) sizeof ((
# 62 "/workspace/acl/lib_fiber/c/src/event.c"
 0
# 62 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 62 "/workspace/acl/lib_fiber/c/src/event.c"
...
# 62 "/workspace/acl/lib_fiber/c/src/event.c"
 "0"
# 62 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
 , "/workspace/acl/lib_fiber/c/src/event.c", 62, __extension__ __PRETTY_FUNCTION__); }))
# 62 "/workspace/acl/lib_fiber/c/src/event.c"
          ;
...
# 76 "/workspace/acl/lib_fiber/c/src/event.c"
  break;
 }

 
# 79 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
((void) sizeof ((
# 79 "/workspace/acl/lib_fiber/c/src/event.c"
ev
# 79 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 79 "/workspace/acl/lib_fiber/c/src/event.c"
...
"ev"
# 79 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
, "/workspace/acl/lib_fiber/c/src/event.c", 79, __extension__ __PRETTY_FUNCTION__); }))
# 79 "/workspace/acl/lib_fiber/c/src/event.c"
          ;
 do { RING *_ring = &ev->events; _ring->pred = _ring->succ = _ring; _ring->parent = _ring; _ring->len = 0; } while (0);
 ev->timeout = -1;
 ev->setsize = size;
 ev->fdcount = 0;
 ev->maxfd = -1;
 ...
 do { struct timeval _tv; gettimeofday(&_tv, 
# 87 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
((void *)0)
# 87 "/workspace/acl/lib_fiber/c/src/event.c"
); (ev->stamp) = ((long long) _tv.tv_sec) * 1000 + ((long long) _tv.tv_usec)/ 1000; } while (0);

 ev->poll_list = timer_cache_create();
 do { RING *_ring = &ev->poll_ready; _ring->pred = _ring->succ = _ring; _ring->parent = _ring; _ring->len = 0; } while (0);



 ev->epoll_list = timer_cache_create();
 do { RING *_ring = &ev->epoll_ready; _ring->pred = _ring->succ = _ring; _ring->parent = _ring; _ring->len = 0; } while (0);
...
{
 do { struct timeval _tv; gettimeofday(&_tv, 
# 122 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
((void *)0)
# 122 "/workspace/acl/lib_fiber/c/src/event.c"
); (ev->stamp) = ((long long) _tv.tv_sec) * 1000 + ((long long) _tv.tv_usec)/ 1000; } while (0);
 return ev->stamp;
}
...
# 147 "/workspace/acl/lib_fiber/c/src/event.c"
int event_checkfd(EVENT *ev __attribute__((__unused__)), FILE_EVENT *fe)
{



 if (lseek(fe->fd, (off_t) 0, 
# 152 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
                             0
# 152 "/workspace/acl/lib_fiber/c/src/event.c"
                                     ) == -1) {
  switch (
# 153 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
         (*__errno_location ())
# 153 "/workspace/acl/lib_fiber/c/src/event.c"
              ) {
  case 
# 154 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
      29
# 154 "/workspace/acl/lib_fiber/c/src/event.c"
            :
   fe->type = (unsigned) (1 << 0) | (unsigned) (1 << 3);
   acl_fiber_set_error(0);
   return 1;
  case 
# 158 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
      9
# 158 "/workspace/acl/lib_fiber/c/src/event.c"
           :
   fe->type = (unsigned) (1 << 2);
   msg_error("%s(%d): badfd=%d, fe=%p",
    __FUNCTION__, 161, fe->fd, fe);
   return -1;
  default:
   fe->type = (unsigned) (1 << 1);
   acl_fiber_set_error(0);
   return 0;
  }
  ...
  if (ev->del_read(ev, fe) == -1) {
   msg_error("%s(%d): del_read error=%s, fd=%d",
    __FUNCTION__, 186, last_serror(), fe->fd);
  }
...
# 234 "/workspace/acl/lib_fiber/c/src/event.c"
int event_add_read(EVENT *ev, FILE_EVENT *fe, event_proc *proc)
{
 if (fe->type == (unsigned) 0) {
 ...
 if (!(fe->type & (unsigned) (1 << 3))) {
  if (fe->type & (unsigned) (1 << 1)) {
   return 0;
  } else if (fe->type & (unsigned) (1 << 2)) {

   acl_fiber_set_error(
# 250 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
                      9
# 250 "/workspace/acl/lib_fiber/c/src/event.c"
                           );
   ...
   acl_fiber_set_error(
# 257 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
                      22
# 257 "/workspace/acl/lib_fiber/c/src/event.c"
                            );

   msg_error("%s(%d): invalid type=%d, fd=%d",
    __FUNCTION__, 260, fe->type, (int) fe->fd);
   return -1;
  }
 }
 ...
 if (fe->fd >= (socket_t) ev->setsize) {
  msg_error("%s(%d): fd=%d >= setsize=%d", __FUNCTION__,
   267, fe->fd, (int) ev->setsize);
  acl_fiber_set_error(
# 268 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
                     34
# 268 "/workspace/acl/lib_fiber/c/src/event.c"
                           );
  return 0;
 }
 ...
 if (fe->oper & (unsigned) (1 << 1)) {
  fe->oper &= ~(unsigned) (1 << 1);
 }

 if (!(fe->mask & (unsigned) (1 << 2))) {
  if (fe->mask & (unsigned) (1 << 0)) {
   ...
   do { ((RING*)(&fe->me))->pred = ((RING*)(&ev->events))->pred; ((RING*)(&fe->me))->succ = (RING*)(&ev->events); ((RING*)(&fe->me))->parent = ((RING*)(&ev->events))->parent; ((RING*)(&ev->events))->pred->succ = (RING*)(&fe->me); ((RING*)(&ev->events))->pred = (RING*)(&fe->me); ((RING*)(&ev->events))->parent->len++; } while (0);
  }

  fe->oper |= (unsigned) (1 << 0);
 }
...
int event_add_write(EVENT *ev, FILE_EVENT *fe, event_proc *proc)
{
 ...
 if (fe->fd >= (socket_t) ev->setsize) {
  msg_error("%s(%d): fd=%d >= setsize=%d", __FUNCTION__,
   316, fe->fd, (int) ev->setsize);
  acl_fiber_set_error(
# 317 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
                     34
# 317 "/workspace/acl/lib_fiber/c/src/event.c"
                           );
  return 0;
 }
 ...
 if (fe->oper & (unsigned) (1 << 3)) {
  fe->oper &= ~(unsigned) (1 << 3);
 }
...
void event_del_read(EVENT *ev, FILE_EVENT *fe)
{
 ...
 fe->r_proc = 
# 356 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
              ((void *)0)
# 356 "/workspace/acl/lib_fiber/c/src/event.c"
                  ;
}

void event_del_write(EVENT *ev, FILE_EVENT *fe)
{
 if (fe->oper & (unsigned) (1 << 2)) {
  fe->oper &= ~(unsigned) (1 << 2);
 }
 ...
 fe->w_proc = 
# 373 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
             ((void *)0)
# 373 "/workspace/acl/lib_fiber/c/src/event.c"
                 ;
}
...
void event_close(EVENT *ev, FILE_EVENT *fe)
{
 ...
 if (fe->me.parent != &fe->me) {
  do { RING *_succ, *_pred; if (((RING*)(&fe->me))->parent != (RING*)(&fe->me)) { _succ = ((RING*)(&fe->me))->succ; _pred = ((RING*)(&fe->me))->pred; if (_succ && _pred) { _pred->succ = _succ; _succ->pred = _pred; ((RING*)(&fe->me))->parent->len--; ((RING*)(&fe->me))->succ = (RING*)(&fe->me); ((RING*)(&fe->me))->pred = (RING*)(&fe->me); ((RING*)(&fe->me))->parent = (RING*)(&fe->me); ((RING*)(&fe->me))->len = 0; } } } while (0);
 }
...
static void event_prepare(EVENT *ev)
{
 ...
 while ((next = (((&ev->events)->succ) != (&ev->events) ? ((&ev->events)->succ) : 0))) {
  fe = ((FILE_EVENT *) (((char *) (next)) - 
# 405 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
      __builtin_offsetof (
# 405 "/workspace/acl/lib_fiber/c/src/event.c"
      FILE_EVENT
# 405 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
      , 
# 405 "/workspace/acl/lib_fiber/c/src/event.c"
...
# 405 "/workspace/acl/lib_fiber/c/src/event.c"
  ...
  do { RING *_succ, *_pred; if (((RING*)(next))->parent != (RING*)(next)) { _succ = ((RING*)(next))->succ; _pred = ((RING*)(next))->pred; if (_succ && _pred) { _pred->succ = _succ; _succ->pred = _pred; ((RING*)(next))->parent->len--; ((RING*)(next))->succ = (RING*)(next); ((RING*)(next))->pred = (RING*)(next); ((RING*)(next))->parent = (RING*)(next); ((RING*)(next))->len = 0; } } } while (0);
  fe->oper = 0;
 }
...
static void event_process_poll(EVENT *ev)
{
 ...
 while (node && node->expire >= 0 && node->expire <= now) {
  next = avl_walk(&ev->poll_list->tree, node, (1));


  for ((iter).ptr = (((&node->ring))->succ); (iter).ptr != (&node->ring); (iter).ptr = (((iter).ptr)->succ)) {
   pe = ((POLL_EVENT *) (((char *) (iter.ptr)) - 
# 448 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
       __builtin_offsetof (
# 448 "/workspace/acl/lib_fiber/c/src/event.c"
       POLL_EVENT
# 448 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
       , 
# 448 "/workspace/acl/lib_fiber/c/src/event.c"
...
# 448 "/workspace/acl/lib_fiber/c/src/event.c"
 ...
 while ((head = ring_pop_head(&ev->poll_ready)) != 
# 455 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
                                                  ((void *)0)
# 455 "/workspace/acl/lib_fiber/c/src/event.c"
                                                      ) {
  pe = ((POLL_EVENT *) (((char *) (head)) - 
# 456 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
      __builtin_offsetof (
# 456 "/workspace/acl/lib_fiber/c/src/event.c"
      POLL_EVENT
# 456 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
      , 
# 456 "/workspace/acl/lib_fiber/c/src/event.c"
...
static void event_process_epoll(EVENT *ev)
{
 ...
 while (node && node->expire >= 0 && node->expire <= now) {
  next = avl_walk(&ev->epoll_list->tree, node, (1));

  for ((iter).ptr = (((&node->ring))->succ); (iter).ptr != (&node->ring); (iter).ptr = (((iter).ptr)->succ)) {
   ee = ((EPOLL_EVENT *) (((char *) (iter.ptr)) - 
# 477 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
       __builtin_offsetof (
# 477 "/workspace/acl/lib_fiber/c/src/event.c"
       EPOLL_EVENT
# 477 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
       , 
# 477 "/workspace/acl/lib_fiber/c/src/event.c"
...
# 477 "/workspace/acl/lib_fiber/c/src/event.c"
 ...
 while ((head = ring_pop_head(&ev->epoll_ready)) != 
# 484 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
                                                   ((void *)0)
# 484 "/workspace/acl/lib_fiber/c/src/event.c"
                                                       ) {
  ee = ((EPOLL_EVENT *) (((char *) (head)) - 
# 485 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
      __builtin_offsetof (
# 485 "/workspace/acl/lib_fiber/c/src/event.c"
      EPOLL_EVENT
# 485 "/workspace/acl/lib_fiber/c/src/event.c" 3 4
      , 
# 485 "/workspace/acl/lib_fiber/c/src/event.c"
