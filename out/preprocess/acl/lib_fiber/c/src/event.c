# 0 "/acl/lib_fiber/c/src/event.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/event.c"
...
# 2 "/acl/lib_fiber/c/src/event.c" 2
...
# 3 "/acl/lib_fiber/c/src/event.c" 2
...
# 5 "/acl/lib_fiber/c/src/event/event_epoll.h" 2



EVENT *event_epoll_create(int setsize);
# 5 "/acl/lib_fiber/c/src/event.c" 2
# 1 "/acl/lib_fiber/c/src/event/event_kqueue.h" 1
# 6 "/acl/lib_fiber/c/src/event.c" 2
...
# 7 "/acl/lib_fiber/c/src/event.c" 2
# 1 "/acl/lib_fiber/c/src/event/event_poll.h" 1
...
# 8 "/acl/lib_fiber/c/src/event.c" 2
# 1 "/acl/lib_fiber/c/src/event/event_wmsg.h" 1
# 9 "/acl/lib_fiber/c/src/event.c" 2
# 1 "/acl/lib_fiber/c/src/event/event_iocp.h" 1
# 10 "/acl/lib_fiber/c/src/event.c" 2




# 1 "/acl/lib_fiber/c/src/event.h" 1
# 15 "/acl/lib_fiber/c/src/event.c" 2
...
{
 EVENT *ev = 
# 35 "/acl/lib_fiber/c/src/event.c" 3 4
            ((void *)0)
# 35 "/acl/lib_fiber/c/src/event.c"
                ;
...
# 54 "/acl/lib_fiber/c/src/event.c" 3 4
 ((void) sizeof ((
# 54 "/acl/lib_fiber/c/src/event.c"
 0
# 54 "/acl/lib_fiber/c/src/event.c" 3 4
...
# 54 "/acl/lib_fiber/c/src/event.c"
 "0"
# 54 "/acl/lib_fiber/c/src/event.c" 3 4
 , "/acl/lib_fiber/c/src/event.c", 54, __extension__ __PRETTY_FUNCTION__); }))
# 54 "/acl/lib_fiber/c/src/event.c"
          ;
...
# 62 "/acl/lib_fiber/c/src/event.c" 3 4
 ((void) sizeof ((
# 62 "/acl/lib_fiber/c/src/event.c"
 0
# 62 "/acl/lib_fiber/c/src/event.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 62 "/acl/lib_fiber/c/src/event.c"
...
# 62 "/acl/lib_fiber/c/src/event.c"
 "0"
# 62 "/acl/lib_fiber/c/src/event.c" 3 4
 , "/acl/lib_fiber/c/src/event.c", 62, __extension__ __PRETTY_FUNCTION__); }))
# 62 "/acl/lib_fiber/c/src/event.c"
          ;
...
# 76 "/acl/lib_fiber/c/src/event.c"
  break;
 }

 
# 79 "/acl/lib_fiber/c/src/event.c" 3 4
((void) sizeof ((
# 79 "/acl/lib_fiber/c/src/event.c"
ev
# 79 "/acl/lib_fiber/c/src/event.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 79 "/acl/lib_fiber/c/src/event.c"
...
"ev"
# 79 "/acl/lib_fiber/c/src/event.c" 3 4
, "/acl/lib_fiber/c/src/event.c", 79, __extension__ __PRETTY_FUNCTION__); }))
# 79 "/acl/lib_fiber/c/src/event.c"
          ;
...
# 87 "/acl/lib_fiber/c/src/event.c" 3 4
((void *)0)
# 87 "/acl/lib_fiber/c/src/event.c"
...
{
 do { struct timeval _tv; gettimeofday(&_tv, 
# 122 "/acl/lib_fiber/c/src/event.c" 3 4
((void *)0)
# 122 "/acl/lib_fiber/c/src/event.c"
); (ev->stamp) = ((long long) _tv.tv_sec) * 1000 + ((long long) _tv.tv_usec)/ 1000; } while (0);
 return ev->stamp;
}
...
# 147 "/acl/lib_fiber/c/src/event.c"
...
# 152 "/acl/lib_fiber/c/src/event.c" 3 4
                             0
# 152 "/acl/lib_fiber/c/src/event.c"
                                     ) == -1) {
  switch (
# 153 "/acl/lib_fiber/c/src/event.c" 3 4
         (*__errno_location ())
# 153 "/acl/lib_fiber/c/src/event.c"
              ) {
  case 
# 154 "/acl/lib_fiber/c/src/event.c" 3 4
      29
# 154 "/acl/lib_fiber/c/src/event.c"
            :
   fe->type = (unsigned) (1 << 0) | (unsigned) (1 << 3);
   acl_fiber_set_error(0);
   return 1;
  case 
# 158 "/acl/lib_fiber/c/src/event.c" 3 4
      9
# 158 "/acl/lib_fiber/c/src/event.c"
           :
...
# 234 "/acl/lib_fiber/c/src/event.c"
int event_add_read(EVENT *ev, FILE_EVENT *fe, event_proc *proc)
{
 ...
 if (!(fe->type & (unsigned) (1 << 3))) {
  if (fe->type & (unsigned) (1 << 1)) {
   ...
   acl_fiber_set_error(
# 250 "/acl/lib_fiber/c/src/event.c" 3 4
                      9
# 250 "/acl/lib_fiber/c/src/event.c"
                           );
   ...
   acl_fiber_set_error(
# 257 "/acl/lib_fiber/c/src/event.c" 3 4
                      22
# 257 "/acl/lib_fiber/c/src/event.c"
                            );
 ...
 if (fe->fd >= (socket_t) ev->setsize) {
  ...
  acl_fiber_set_error(
# 268 "/acl/lib_fiber/c/src/event.c" 3 4
                     34
# 268 "/acl/lib_fiber/c/src/event.c"
                           );
  return 0;
 }
...
int event_add_write(EVENT *ev, FILE_EVENT *fe, event_proc *proc)
{
 ...
 if (fe->fd >= (socket_t) ev->setsize) {
  ...
  acl_fiber_set_error(
# 317 "/acl/lib_fiber/c/src/event.c" 3 4
                     34
# 317 "/acl/lib_fiber/c/src/event.c"
                           );
  return 0;
 }
...
void event_del_read(EVENT *ev, FILE_EVENT *fe)
{
 ...
 fe->r_proc = 
# 356 "/acl/lib_fiber/c/src/event.c" 3 4
              ((void *)0)
# 356 "/acl/lib_fiber/c/src/event.c"
                  ;
}
...
void event_del_write(EVENT *ev, FILE_EVENT *fe)
{
 ...
 fe->w_proc = 
# 373 "/acl/lib_fiber/c/src/event.c" 3 4
             ((void *)0)
# 373 "/acl/lib_fiber/c/src/event.c"
                 ;
}
...
# 405 "/acl/lib_fiber/c/src/event.c" 3 4
      __builtin_offsetof (
# 405 "/acl/lib_fiber/c/src/event.c"
      FILE_EVENT
# 405 "/acl/lib_fiber/c/src/event.c" 3 4
      , 
# 405 "/acl/lib_fiber/c/src/event.c"
...
# 448 "/acl/lib_fiber/c/src/event.c" 3 4
       __builtin_offsetof (
# 448 "/acl/lib_fiber/c/src/event.c"
       POLL_EVENT
# 448 "/acl/lib_fiber/c/src/event.c" 3 4
       , 
# 448 "/acl/lib_fiber/c/src/event.c"
...
# 455 "/acl/lib_fiber/c/src/event.c" 3 4
                                                  ((void *)0)
# 455 "/acl/lib_fiber/c/src/event.c"
                                                      ) {
  pe = ((POLL_EVENT *) (((char *) (head)) - 
# 456 "/acl/lib_fiber/c/src/event.c" 3 4
      __builtin_offsetof (
# 456 "/acl/lib_fiber/c/src/event.c"
      POLL_EVENT
# 456 "/acl/lib_fiber/c/src/event.c" 3 4
      , 
# 456 "/acl/lib_fiber/c/src/event.c"
...
# 477 "/acl/lib_fiber/c/src/event.c" 3 4
       __builtin_offsetof (
# 477 "/acl/lib_fiber/c/src/event.c"
       EPOLL_EVENT
# 477 "/acl/lib_fiber/c/src/event.c" 3 4
       , 
# 477 "/acl/lib_fiber/c/src/event.c"
...
# 484 "/acl/lib_fiber/c/src/event.c" 3 4
                                                   ((void *)0)
# 484 "/acl/lib_fiber/c/src/event.c"
                                                       ) {
  ee = ((EPOLL_EVENT *) (((char *) (head)) - 
# 485 "/acl/lib_fiber/c/src/event.c" 3 4
      __builtin_offsetof (
# 485 "/acl/lib_fiber/c/src/event.c"
      EPOLL_EVENT
# 485 "/acl/lib_fiber/c/src/event.c" 3 4
      , 
# 485 "/acl/lib_fiber/c/src/event.c"
