# 0 "/acl/lib_fiber/c/src/hook/io.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/hook/io.c"
...
# 2 "/acl/lib_fiber/c/src/hook/io.c" 2
...
# 3 "/acl/lib_fiber/c/src/hook/io.c" 2
...
# 5 "/acl/lib_fiber/c/src/hook/io.c" 2
...
void hook_once(void);
# 6 "/acl/lib_fiber/c/src/hook/io.c" 2
...
# 7 "/acl/lib_fiber/c/src/hook/io.c" 2
# 15 "/acl/lib_fiber/c/src/hook/io.c"
unsigned int sleep(unsigned int seconds)
{
 if (!var_hook_sys_api) {
  if (sys_sleep == 
# 18 "/acl/lib_fiber/c/src/hook/io.c" 3 4
                  ((void *)0)
# 18 "/acl/lib_fiber/c/src/hook/io.c"
                      ) {
   hook_once();
  }
...
int acl_fiber_close(socket_t fd)
{
 ...
 if (sys_close == 
# 40 "/acl/lib_fiber/c/src/hook/io.c" 3 4
                 ((void *)0)
# 40 "/acl/lib_fiber/c/src/hook/io.c"
                     ) {
  hook_once();
  if (sys_close == 
# 42 "/acl/lib_fiber/c/src/hook/io.c" 3 4
                  ((void *)0)
# 42 "/acl/lib_fiber/c/src/hook/io.c"
                      ) {
 ...
 fe = fiber_file_get(fd);
 if (fe == 
# 78 "/acl/lib_fiber/c/src/hook/io.c" 3 4
          ((void *)0)
# 78 "/acl/lib_fiber/c/src/hook/io.c"
              ) {
  ret = (*sys_close)(fd);
  if (ret != 0) {
...
# 102 "/acl/lib_fiber/c/src/hook/io.c"
 fiber_file_close(fe);
...
ssize_t acl_fiber_read(socket_t fd, void *buf, size_t count)
{
 ...
 if (sys_read == 
# 141 "/acl/lib_fiber/c/src/hook/io.c" 3 4
                ((void *)0)
# 141 "/acl/lib_fiber/c/src/hook/io.c"
                    ) {
  hook_once();
 }
...
ssize_t acl_fiber_readv(socket_t fd, const struct iovec *iov, int iovcnt)
{
 ...
 if (sys_readv == 
# 161 "/acl/lib_fiber/c/src/hook/io.c" 3 4
                 ((void *)0)
# 161 "/acl/lib_fiber/c/src/hook/io.c"
                     ) {
  hook_once();
 }
...
# 191 "/acl/lib_fiber/c/src/hook/io.c"
...

{
 ...
 if (sys_recv == 
# 200 "/acl/lib_fiber/c/src/hook/io.c" 3 4
                ((void *)0)
# 200 "/acl/lib_fiber/c/src/hook/io.c"
                    ) {
  hook_once();
 }
...

{
 ...
 if (sys_recvfrom == 
# 226 "/acl/lib_fiber/c/src/hook/io.c" 3 4
                    ((void *)0)
# 226 "/acl/lib_fiber/c/src/hook/io.c"
                        ) {
  hook_once();
 }
...
ssize_t acl_fiber_recvmsg(socket_t sockfd, struct msghdr *msg, int flags)
{
 ...
 if (sys_recvmsg == 
# 249 "/acl/lib_fiber/c/src/hook/io.c" 3 4
                   ((void *)0)
# 249 "/acl/lib_fiber/c/src/hook/io.c"
                       ) {
  hook_once();
 }
...
ssize_t acl_fiber_write(socket_t fd, const void *buf, size_t count)
{
 ...
 if (sys_write == 
# 273 "/acl/lib_fiber/c/src/hook/io.c" 3 4
                 ((void *)0)
# 273 "/acl/lib_fiber/c/src/hook/io.c"
                     ) {
  hook_once();
 }
...
ssize_t acl_fiber_writev(socket_t fd, const struct iovec *iov, int iovcnt)
{
 ...
 if (sys_writev == 
# 293 "/acl/lib_fiber/c/src/hook/io.c" 3 4
                  ((void *)0)
# 293 "/acl/lib_fiber/c/src/hook/io.c"
                      ) {
  hook_once();
 }
...

{
 ...
 if (sys_send == 
# 318 "/acl/lib_fiber/c/src/hook/io.c" 3 4
                ((void *)0)
# 318 "/acl/lib_fiber/c/src/hook/io.c"
                    ) {
  hook_once();
 }
...

{
 ...
 if (sys_sendto == 
# 345 "/acl/lib_fiber/c/src/hook/io.c" 3 4
                  ((void *)0)
# 345 "/acl/lib_fiber/c/src/hook/io.c"
                      ) {
  hook_once();
 }
...
ssize_t acl_fiber_sendmsg(socket_t sockfd, const struct msghdr *msg, int flags)
{
 ...
 if (sys_sendmsg == 
# 367 "/acl/lib_fiber/c/src/hook/io.c" 3 4
                   ((void *)0)
# 367 "/acl/lib_fiber/c/src/hook/io.c"
                       ) {
  hook_once();
 }
...
ssize_t sendfile64(socket_t out_fd, int in_fd, off64_t *offset, size_t count)
{
 ...
 if (sys_sendfile64 == 
# 449 "/acl/lib_fiber/c/src/hook/io.c" 3 4
                      ((void *)0)
# 449 "/acl/lib_fiber/c/src/hook/io.c"
                          ) {
  hook_once();
 }
