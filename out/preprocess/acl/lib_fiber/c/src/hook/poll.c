# 0 "/acl/lib_fiber/c/src/hook/poll.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/hook/poll.c"
...
# 2 "/acl/lib_fiber/c/src/hook/poll.c" 2
...
# 3 "/acl/lib_fiber/c/src/hook/poll.c" 2
...
# 5 "/acl/lib_fiber/c/src/hook/poll.c" 2
...
# 6 "/acl/lib_fiber/c/src/hook/poll.c" 2
...
void hook_once(void);
# 7 "/acl/lib_fiber/c/src/hook/poll.c" 2
...
# 26 "/acl/lib_fiber/c/src/hook/poll.c"
static void read_callback(EVENT *ev, FILE_EVENT *fe)
{
 ...
 if (pfd == 
# 33 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
           ((void *)0)
# 33 "/acl/lib_fiber/c/src/hook/poll.c"
               ) {
  return;
 }

 
# 37 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
((void) sizeof ((
# 37 "/acl/lib_fiber/c/src/hook/poll.c"
pfd->pfd->events & 
# 37 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
...
# 37 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
, "/acl/lib_fiber/c/src/hook/poll.c", 37, __extension__ __PRETTY_FUNCTION__); }))
# 37 "/acl/lib_fiber/c/src/hook/poll.c"
                                 ;
 ...
 pfd->pfd->revents |= 
# 41 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
                     0x001
# 41 "/acl/lib_fiber/c/src/hook/poll.c"
                           ;

 if (fe->mask & (unsigned) (1 << 4)) {
  pfd->pfd->revents |= 
# 44 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
                      0x008
# 44 "/acl/lib_fiber/c/src/hook/poll.c"
                             ;
 }
 if (fe->mask & (unsigned) (1 << 5)) {
  pfd->pfd->revents |= 
# 47 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
                      0x010
# 47 "/acl/lib_fiber/c/src/hook/poll.c"
                             ;
 }
 if (fe->mask & (unsigned) (1 << 6)) {
  pfd->pfd->revents |= 
# 50 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
                      0x020
# 50 "/acl/lib_fiber/c/src/hook/poll.c"
                              ;
 }

 if (!(pfd->pfd->events & 
# 53 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
                         0x004
# 53 "/acl/lib_fiber/c/src/hook/poll.c"
                                )) {
  fe->pfd = 
# 54 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
           ((void *)0)
# 54 "/acl/lib_fiber/c/src/hook/poll.c"
               ;
  pfd->fe = 
# 55 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
           ((void *)0)
# 55 "/acl/lib_fiber/c/src/hook/poll.c"
               ;
 }
# 66 "/acl/lib_fiber/c/src/hook/poll.c"
 if (pfd->pe->nready == 0) {
...
static void write_callback(EVENT *ev, FILE_EVENT *fe)
{
 ...
 if (pfd == 
# 86 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
           ((void *)0)
# 86 "/acl/lib_fiber/c/src/hook/poll.c"
               ) {
  return;
 }

 
# 90 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
((void) sizeof ((
# 90 "/acl/lib_fiber/c/src/hook/poll.c"
pfd->pfd->events & 
# 90 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
...
# 90 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
, "/acl/lib_fiber/c/src/hook/poll.c", 90, __extension__ __PRETTY_FUNCTION__); }))
# 90 "/acl/lib_fiber/c/src/hook/poll.c"
                                  ;
 ...
 pfd->pfd->revents |= 
# 94 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
                     0x004
# 94 "/acl/lib_fiber/c/src/hook/poll.c"
                            ;

 if (fe->mask & (unsigned) (1 << 4)) {
  pfd->pfd->revents |= 
# 97 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
                      0x008
# 97 "/acl/lib_fiber/c/src/hook/poll.c"
                             ;
 }
 if (fe->mask & (unsigned) (1 << 5)) {
  pfd->pfd->revents |= 
# 100 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
                      0x010
# 100 "/acl/lib_fiber/c/src/hook/poll.c"
                             ;
 }
 if (fe->mask & (unsigned) (1 << 6)) {
  pfd->pfd->revents |= 
# 103 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
                      0x020
# 103 "/acl/lib_fiber/c/src/hook/poll.c"
                              ;
 }

 if (!(pfd->pfd->events & 
# 106 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
                         0x001
# 106 "/acl/lib_fiber/c/src/hook/poll.c"
                               )) {
  fe->pfd = 
# 107 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
           ((void *)0)
# 107 "/acl/lib_fiber/c/src/hook/poll.c"
               ;
  pfd->fe = 
# 108 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
           ((void *)0)
# 108 "/acl/lib_fiber/c/src/hook/poll.c"
               ;
 }
...
static void poll_event_set(EVENT *ev, POLL_EVENT *pe, int timeout)
{
 ...
 for (i = 0; i < pe->nfds; i++) {
  ...
  if (pfd->pfd->events & 
# 134 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
                        0x001
# 134 "/acl/lib_fiber/c/src/hook/poll.c"
                              ) {
  ...
  if (pfd->pfd->events & 
# 142 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
                        0x004
# 142 "/acl/lib_fiber/c/src/hook/poll.c"
                               ) {
...
static void poll_event_clean(EVENT *ev, POLL_EVENT *pe)
{
 ...
 for (i = 0; i < pe->nfds; i++) {
  ...
  if (pfd->fe == 
# 173 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
                ((void *)0)
# 173 "/acl/lib_fiber/c/src/hook/poll.c"
                    ) {
   continue;
  }
  ...
  if (pfd->pfd->events & 
# 179 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
                        0x001
# 179 "/acl/lib_fiber/c/src/hook/poll.c"
                              ) {
   ((pfd->fe)->status &= ~(unsigned) (1 << 5));
  ...
  if (pfd->pfd->events & 
# 186 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
                        0x004
# 186 "/acl/lib_fiber/c/src/hook/poll.c"
                               ) {
   ((pfd->fe)->status &= ~(unsigned) (1 << 6));
  ...
  pfd->fe->pfd = 
# 193 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
                ((void *)0)
# 193 "/acl/lib_fiber/c/src/hook/poll.c"
                    ;
  pfd->fe = 
# 194 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
                ((void *)0)
# 194 "/acl/lib_fiber/c/src/hook/poll.c"
                    ;
 }
}
...
static POLLFD *pollfd_alloc(POLL_EVENT *pe, struct pollfd *fds, nfds_t nfds)
{
 ...
 for (i = 0; i < nfds; i++) {
  if (fds[i].events & 
# 216 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
                     0x001
# 216 "/acl/lib_fiber/c/src/hook/poll.c"
                           ) {
...
# 288 "/acl/lib_fiber/c/src/hook/poll.c"
int acl_fiber_poll(struct pollfd *fds, nfds_t nfds, int timeout)
{
 long long now;
 EVENT *ev;
 ...
 ACL_FIBER *curr;
# 305 "/acl/lib_fiber/c/src/hook/poll.c"
 POLL_EVENT pevent, *pe;


 if (sys_poll == 
# 308 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
                ((void *)0)
# 308 "/acl/lib_fiber/c/src/hook/poll.c"
                    ) {
  hook_once();
 }
...
# 338 "/acl/lib_fiber/c/src/hook/poll.c"
 pe = &pevent;
 ...
 while (1) {
  ...
  if (acl_fiber_killed(pe->fiber)) {
   ...
   msg_info("%s(%d), %s: fiber-%u was killed, %s, timeout=%d",
    "/acl/lib_fiber/c/src/hook/poll.c", 374, __FUNCTION__,
  ...
  if (pe->expire > 0 && now >= pe->expire) {
   acl_fiber_set_error(
# 389 "/acl/lib_fiber/c/src/hook/poll.c" 3 4
                      62
# 389 "/acl/lib_fiber/c/src/hook/poll.c"
                                 );
   break;
  }
 }
 ...
 nready = pe->nready;
# 406 "/acl/lib_fiber/c/src/hook/poll.c"
 return nready;
}
