# 1 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 2
...
# 5 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 2
...
# 6 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 2
...
void hook_once(void);
# 7 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 2
...
# 26 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
static void read_callback(EVENT *ev, FILE_EVENT *fe)
{
 ...
 if (pfd == 
# 33 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
           ((void *)0)
# 33 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
               ) {
  return;
 }

 
# 37 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
((void) sizeof ((
# 37 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
pfd->pfd->events & 
# 37 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
0x001) ? 1 : 0), __extension__ ({ if (
# 37 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
pfd->pfd->events & 
# 37 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
0x001) ; else __assert_fail (
# 37 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
"pfd->pfd->events & POLLIN"
# 37 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/hook/poll.c", 37, __extension__ __PRETTY_FUNCTION__); }))
# 37 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                                 ;
 ...
 pfd->pfd->revents |= 
# 41 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
                     0x001
# 41 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                           ;

 if (fe->mask & (unsigned) (1 << 4)) {
  pfd->pfd->revents |= 
# 44 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
                      0x008
# 44 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                             ;
 }
 if (fe->mask & (unsigned) (1 << 5)) {
  pfd->pfd->revents |= 
# 47 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
                      0x010
# 47 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                             ;
 }
 if (fe->mask & (unsigned) (1 << 6)) {
  pfd->pfd->revents |= 
# 50 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
                      0x020
# 50 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                              ;
 }

 if (!(pfd->pfd->events & 
# 53 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
                         0x004
# 53 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                                )) {
  fe->pfd = 
# 54 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
           ((void *)0)
# 54 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
               ;
  pfd->fe = 
# 55 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
           ((void *)0)
# 55 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
               ;
 }
# 66 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
 if (pfd->pe->nready == 0) {
  ...
  do { ((RING*)(&pfd->pe->me))->pred = ((RING*)(&ev->poll_ready))->pred; ((RING*)(&pfd->pe->me))->succ = (RING*)(&ev->poll_ready); ((RING*)(&pfd->pe->me))->parent = ((RING*)(&ev->poll_ready))->parent; ((RING*)(&ev->poll_ready))->pred->succ = (RING*)(&pfd->pe->me); ((RING*)(&ev->poll_ready))->pred = (RING*)(&pfd->pe->me); ((RING*)(&ev->poll_ready))->parent->len++; } while (0);
 }
...
static void write_callback(EVENT *ev, FILE_EVENT *fe)
{
 ...
 if (pfd == 
# 86 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
           ((void *)0)
# 86 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
               ) {
  return;
 }

 
# 90 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
((void) sizeof ((
# 90 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
pfd->pfd->events & 
# 90 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
0x004) ? 1 : 0), __extension__ ({ if (
# 90 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
pfd->pfd->events & 
# 90 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
0x004) ; else __assert_fail (
# 90 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
"pfd->pfd->events & POLLOUT"
# 90 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/hook/poll.c", 90, __extension__ __PRETTY_FUNCTION__); }))
# 90 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                                  ;
 ...
 pfd->pfd->revents |= 
# 94 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
                     0x004
# 94 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                            ;

 if (fe->mask & (unsigned) (1 << 4)) {
  pfd->pfd->revents |= 
# 97 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
                      0x008
# 97 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                             ;
 }
 if (fe->mask & (unsigned) (1 << 5)) {
  pfd->pfd->revents |= 
# 100 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
                      0x010
# 100 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                             ;
 }
 if (fe->mask & (unsigned) (1 << 6)) {
  pfd->pfd->revents |= 
# 103 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
                      0x020
# 103 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                              ;
 }

 if (!(pfd->pfd->events & 
# 106 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
                         0x001
# 106 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                               )) {
  fe->pfd = 
# 107 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
           ((void *)0)
# 107 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
               ;
  pfd->fe = 
# 108 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
           ((void *)0)
# 108 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
               ;
 }
...
static void poll_event_set(EVENT *ev, POLL_EVENT *pe, int timeout)
{
 ...
 for (i = 0; i < pe->nfds; i++) {
  ...
  if (pfd->pfd->events & 
# 134 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
                        0x001
# 134 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                              ) {
   ...
   ((pfd->fe)->status |= (unsigned) (1 << 5));
  }
  if (pfd->pfd->events & 
# 142 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
                        0x004
# 142 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                               ) {
...
static void poll_event_clean(EVENT *ev, POLL_EVENT *pe)
{
 ...
 for (i = 0; i < pe->nfds; i++) {
  ...
  if (pfd->fe == 
# 173 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
                ((void *)0)
# 173 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                    ) {
   continue;
  }

  ((pfd->fe)->status &= ~(unsigned) (1 << 3));

  if (pfd->pfd->events & 
# 179 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
                        0x001
# 179 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                              ) {
   ((pfd->fe)->status &= ~(unsigned) (1 << 5));
  ...
  if (pfd->pfd->events & 
# 186 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
                        0x004
# 186 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                               ) {
   ((pfd->fe)->status &= ~(unsigned) (1 << 6));
  ...
  pfd->fe->pfd = 
# 193 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
                ((void *)0)
# 193 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                    ;
  pfd->fe = 
# 194 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
                ((void *)0)
# 194 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                    ;
 }
}
...
static void poll_callback(EVENT *ev __attribute__ ((__unused__)), POLL_EVENT *pe)
{
...
static POLLFD *pollfd_alloc(POLL_EVENT *pe, struct pollfd *fds, nfds_t nfds)
{
 ...
 for (i = 0; i < nfds; i++) {
  if (fds[i].events & 
# 216 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
                     0x001
# 216 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                           ) {
...
# 288 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
int acl_fiber_poll(struct pollfd *fds, nfds_t nfds, int timeout)
{
 long long now;
 EVENT *ev;
 ...
 ACL_FIBER *curr;
# 305 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
 POLL_EVENT pevent, *pe;


 if (sys_poll == 
# 308 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
                ((void *)0)
# 308 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                    ) {
  hook_once();
 }
...
# 338 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
 pe = &pevent;
 ...
 while (1) {
  ...
  if (acl_fiber_killed(pe->fiber)) {
   ...
   msg_info("%s(%d), %s: fiber-%u was killed, %s, timeout=%d",
    "/workspace/acl/lib_fiber/c/src/hook/poll.c", 374, __FUNCTION__,
  ...
  if (pe->expire > 0 && now >= pe->expire) {
   acl_fiber_set_error(
# 389 "/workspace/acl/lib_fiber/c/src/hook/poll.c" 3 4
                      62
# 389 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
                                 );
   break;
  }
 }
 ...
 nready = pe->nready;
# 406 "/workspace/acl/lib_fiber/c/src/hook/poll.c"
 return nready;
}
