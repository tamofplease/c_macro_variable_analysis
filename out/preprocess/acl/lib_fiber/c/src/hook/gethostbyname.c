# 1 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 2
...
# 4 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 2
...
void hook_once(void);
# 5 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 2
...
struct hostent * acl_fiber_gethostbyname(const char *name)
{
 ...
 if (!var_hook_sys_api) {
  ret = acl_fiber_gethostbyname_r(name, &res, buf, 4096,
      &result, &errnum);



  
# 30 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
 (*__h_errno_location ()) 
# 30 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
         = errnum;

  return ret == 0 ? result : 
# 32 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                            ((void *)0)
# 32 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
                                ;
 }

 fiber_buf = (char *) acl_fiber_get_specific(__fiber_buf_key);
 if (fiber_buf == 
# 36 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                 ((void *)0)
# 36 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
                     ) {
  fiber_buf = (char *) mem_malloc(4096);
  acl_fiber_set_specific(&__fiber_buf_key, fiber_buf, free_fn);
 }
 
# 40 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
((void) sizeof ((
# 40 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
fiber_buf
# 40 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
...
"fiber_buf"
# 40 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
, "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c", 40, __extension__ __PRETTY_FUNCTION__); }))
# 40 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
                 ;

 fiber_res = (struct hostent *) acl_fiber_get_specific(__fiber_res_key);
 if (fiber_res == 
# 43 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                 ((void *)0)
# 43 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
                     ) {
  fiber_res = (struct hostent *) mem_malloc(sizeof(struct hostent));
  acl_fiber_set_specific(&__fiber_res_key, fiber_res, free_fn);
 }
 
# 47 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
((void) sizeof ((
# 47 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
fiber_res
# 47 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 47 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
...
"fiber_res"
# 47 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
, "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c", 47, __extension__ __PRETTY_FUNCTION__); }))
# 47 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
                 ;

 ret = acl_fiber_gethostbyname_r(name, fiber_res, fiber_buf, 4096,
   &result, &errnum);
...
# 55 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
(*__h_errno_location ()) 
# 55 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
        = errnum;


 return ret == 0 ? result : 
# 58 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                           ((void *)0)
# 58 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
                               ;
}
...
static struct addrinfo *get_addrinfo(const char *name)
{
 ...
 hints.ai_family = 
# 66 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                    0
# 66 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
                             ;
 hints.ai_socktype = 
# 67 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                    SOCK_STREAM
# 67 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
                               ;
 hints.ai_protocol = 
# 68 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                    IPPROTO_TCP
# 68 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
                               ;

 if (getaddrinfo(name, 
# 70 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                      ((void *)0)
# 70 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
                          , &hints, &res) != 0) {
  msg_error("%s(%d): getaddrinfo error", __FUNCTION__, 71);
  return 
# 72 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
        ((void *)0)
# 72 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
            ;
 }
 ...
 const struct addrinfo *res, char *buf, size_t buflen, size_t ncopied)
{
 ...
 do { if (len > 0) { size_t _n = strlen(name); _n = _n > (size_t ) len - 1? (size_t) len - 1 : _n; memcpy(buf, name, _n); buf[_n] = 0; } } while (0);
 ent->h_name = buf;
 buf += len;

 for (ai = res, i = 0; ai != 
# 99 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                            ((void *)0)
# 99 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
                                ; ai = ai->ai_next) {
  ...
  if (ai->ai_family == 
# 110 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                      2
# 110 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
                             ) {
   len = sizeof(struct in_addr);
   memcpy((void *) buf, &sa->in.sin_addr, len);
   ent->h_length = 4;

  } else if (ai->ai_family == 
# 115 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                             10
# 115 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
                                     ) {
 ...
 char *buf, size_t buflen, struct hostent **result, int *h_errnop)
{
 ...
 if (sys_gethostbyname_r == 
# 150 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                           ((void *)0)
# 150 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
                               ) {
 ...
 if (!var_hook_sys_api) {
# 166 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
 ...
 if (ncopied + 1 >= buflen) {
  msg_error("%s(%d): n(%d) > buflen(%d)",
   __FUNCTION__, 180, (int) ncopied, (int) buflen);

  if (h_errnop) {
   *h_errnop = 
# 183 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
              34
# 183 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
                    ;
  }
  return -1;
 }
 ...
 if ((res = get_addrinfo(name)) == 
# 190 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                                  ((void *)0)
# 190 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
                                      ) {
  if (h_errnop) {
   *h_errnop = 
# 192 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
              4
# 192 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
                     ;
  }
  return -1;
 }
 ...
 if (ncopied >= buflen) {
  msg_error("%s(%d): n(%d) > buflen(%d)",
   __FUNCTION__, 203, (int) ncopied, (int) buflen);
  if (h_errnop) {
   *h_errnop = 
# 205 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
              34
# 205 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
                    ;
  }
  return -1;
 }
 ...
 msg_error("%s(%d), %s: i == 0, ncopied: %d, buflen: %d",
  "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c", 223, __FUNCTION__, (int) ncopied, (int) buflen);

 if (h_errnop) {
  *h_errnop = 
# 226 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
             34
# 226 "/workspace/acl/lib_fiber/c/src/hook/gethostbyname.c"
                   ;
 }
