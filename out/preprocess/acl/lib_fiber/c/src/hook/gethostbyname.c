# 0 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
...
# 2 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 2
...
# 3 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 2
...
# 4 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 2
...
void hook_once(void);
# 5 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 2
...
# 30 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
 (*__h_errno_location ()) 
# 30 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
         = errnum;

  return ret == 0 ? result : 
# 32 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                            ((void *)0)
# 32 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
                                ;
 }

 fiber_buf = (char *) acl_fiber_get_specific(__fiber_buf_key);
 if (fiber_buf == 
# 36 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                 ((void *)0)
# 36 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
                     ) {
  fiber_buf = (char *) mem_malloc(4096);
  acl_fiber_set_specific(&__fiber_buf_key, fiber_buf, free_fn);
 }
 
# 40 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
((void) sizeof ((
# 40 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
fiber_buf
# 40 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
...
"fiber_buf"
# 40 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
, "/acl/lib_fiber/c/src/hook/gethostbyname.c", 40, __extension__ __PRETTY_FUNCTION__); }))
# 40 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
                 ;

 fiber_res = (struct hostent *) acl_fiber_get_specific(__fiber_res_key);
 if (fiber_res == 
# 43 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                 ((void *)0)
# 43 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
                     ) {
  fiber_res = (struct hostent *) mem_malloc(sizeof(struct hostent));
  acl_fiber_set_specific(&__fiber_res_key, fiber_res, free_fn);
 }
 
# 47 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
((void) sizeof ((
# 47 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
fiber_res
# 47 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 47 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
...
"fiber_res"
# 47 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
, "/acl/lib_fiber/c/src/hook/gethostbyname.c", 47, __extension__ __PRETTY_FUNCTION__); }))
# 47 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
                 ;
...
# 55 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
(*__h_errno_location ()) 
# 55 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
        = errnum;


 return ret == 0 ? result : 
# 58 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                           ((void *)0)
# 58 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
                               ;
}
...
static struct addrinfo *get_addrinfo(const char *name)
{
 ...
 hints.ai_family = 
# 66 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                    0
# 66 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
                             ;
 hints.ai_socktype = 
# 67 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                    SOCK_STREAM
# 67 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
                               ;
 hints.ai_protocol = 
# 68 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                    IPPROTO_TCP
# 68 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
                               ;

 if (getaddrinfo(name, 
# 70 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                      ((void *)0)
# 70 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
                          , &hints, &res) != 0) {
  msg_error("%s(%d): getaddrinfo error", __FUNCTION__, 71);
  return 
# 72 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
        ((void *)0)
# 72 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
            ;
 }
 ...
 const struct addrinfo *res, char *buf, size_t buflen, size_t ncopied)
{
 ...
 for (ai = res, i = 0; ai != 
# 99 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                            ((void *)0)
# 99 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
                                ; ai = ai->ai_next) {
  ...
  if (ai->ai_family == 
# 110 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                      2
# 110 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
                             ) {
...
# 115 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                             10
# 115 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
                                     ) {
...
# 150 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                           ((void *)0)
# 150 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
                               ) {
 ...
 if (!var_hook_sys_api) {
# 166 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
 ...
 if (ncopied + 1 >= buflen) {
  ...
  if (h_errnop) {
   *h_errnop = 
# 183 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
              34
# 183 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
                    ;
  }
  return -1;
 }
...
# 190 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
                                  ((void *)0)
# 190 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
                                      ) {
  if (h_errnop) {
   *h_errnop = 
# 192 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
              4
# 192 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
                     ;
  }
  return -1;
 }
 ...
 if (ncopied >= buflen) {
  ...
  if (h_errnop) {
   *h_errnop = 
# 205 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
              34
# 205 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
                    ;
  }
  return -1;
 }
 ...
 msg_error("%s(%d), %s: i == 0, ncopied: %d, buflen: %d",
  "/acl/lib_fiber/c/src/hook/gethostbyname.c", 223, __FUNCTION__, (int) ncopied, (int) buflen);

 if (h_errnop) {
  *h_errnop = 
# 226 "/acl/lib_fiber/c/src/hook/gethostbyname.c" 3 4
             34
# 226 "/acl/lib_fiber/c/src/hook/gethostbyname.c"
                   ;
 }
