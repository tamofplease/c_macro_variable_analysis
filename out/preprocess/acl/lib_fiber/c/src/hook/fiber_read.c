# 0 "/acl/lib_fiber/c/src/hook/fiber_read.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/hook/fiber_read.c"
...
# 2 "/acl/lib_fiber/c/src/hook/fiber_read.c" 2
...
# 3 "/acl/lib_fiber/c/src/hook/fiber_read.c" 2
...
# 5 "/acl/lib_fiber/c/src/hook/fiber_read.c" 2
...
void hook_once(void);
# 6 "/acl/lib_fiber/c/src/hook/fiber_read.c" 2
...
# 7 "/acl/lib_fiber/c/src/hook/fiber_read.c" 2
# 225 "/acl/lib_fiber/c/src/hook/fiber_read.c"
ssize_t fiber_read(FILE_EVENT *fe, void *buf, size_t count)
{
 ((fe)->status &= ~(unsigned) (1 << 3));
# 261 "/acl/lib_fiber/c/src/hook/fiber_read.c"
...
# 261 "/acl/lib_fiber/c/src/hook/fiber_read.c" 3 4
11
# 261 "/acl/lib_fiber/c/src/hook/fiber_read.c"
...
{
 ((fe)->status &= ~(unsigned) (1 << 3));
# 297 "/acl/lib_fiber/c/src/hook/fiber_read.c"
...
# 297 "/acl/lib_fiber/c/src/hook/fiber_read.c" 3 4
11
# 297 "/acl/lib_fiber/c/src/hook/fiber_read.c"
)) { if (!(fe->type & (unsigned) (1 << 3))) { fiber_file_free(fe); } return -1; } } while (1);
}
...
{
 ((fe)->status &= ~(unsigned) (1 << 3));
# 332 "/acl/lib_fiber/c/src/hook/fiber_read.c"
...
# 332 "/acl/lib_fiber/c/src/hook/fiber_read.c" 3 4
11
# 332 "/acl/lib_fiber/c/src/hook/fiber_read.c"
)) { if (!(fe->type & (unsigned) (1 << 3))) { fiber_file_free(fe); } return -1; } } while (1);
}
...
{
 ((fe)->status &= ~(unsigned) (1 << 3));
# 374 "/acl/lib_fiber/c/src/hook/fiber_read.c"
...
# 374 "/acl/lib_fiber/c/src/hook/fiber_read.c" 3 4
11
# 374 "/acl/lib_fiber/c/src/hook/fiber_read.c"
)) { if (!(fe->type & (unsigned) (1 << 3))) { fiber_file_free(fe); } return -1; } } while (1);
}
...
{
 ((fe)->status &= ~(unsigned) (1 << 3));
# 417 "/acl/lib_fiber/c/src/hook/fiber_read.c"
...
# 417 "/acl/lib_fiber/c/src/hook/fiber_read.c" 3 4
11
# 417 "/acl/lib_fiber/c/src/hook/fiber_read.c"
)) { if (!(fe->type & (unsigned) (1 << 3))) { fiber_file_free(fe); } return -1; } } while (1);
}
