# 1 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c" 2
...
# 5 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c" 2
...
void hook_once(void);
# 6 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c" 2
...
# 7 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c" 2
# 229 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c"
ssize_t fiber_read(FILE_EVENT *fe, void *buf, size_t count)
{
 ((fe)->status &= ~(unsigned) (1 << 3));
# 265 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c"
 do { ssize_t ret; int err; if (((fe)->status & (unsigned) (1 << 1))) { ((fe)->status &= ~(unsigned) (1 << 1)); } else if (fiber_wait_read(fe) < 0) { return -1; } if (acl_fiber_canceled(fe->fiber_r)) { acl_fiber_set_error(fe->fiber_r->errnum); return -1; } ret = (*sys_read)(fe->fd, buf, count); if (ret >= 0) { return ret; } err = acl_fiber_last_error(); fiber_save_errno(err); if (!((err) == 
# 265 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c" 3 4
11
# 265 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c"
)) { if (!(fe->type & (unsigned) (1 << 3))) { fiber_file_free(fe); } return -1; } } while (1);
}

ssize_t fiber_readv(FILE_EVENT *fe, const struct iovec *iov, int iovcnt)
{
 ((fe)->status &= ~(unsigned) (1 << 3));
# 301 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c"
 do { ssize_t ret; int err; if (((fe)->status & (unsigned) (1 << 1))) { ((fe)->status &= ~(unsigned) (1 << 1)); } else if (fiber_wait_read(fe) < 0) { return -1; } if (acl_fiber_canceled(fe->fiber_r)) { acl_fiber_set_error(fe->fiber_r->errnum); return -1; } ret = (*sys_readv)(fe->fd, iov, iovcnt); if (ret >= 0) { return ret; } err = acl_fiber_last_error(); fiber_save_errno(err); if (!((err) == 
# 301 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c" 3 4
11
# 301 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c"
)) { if (!(fe->type & (unsigned) (1 << 3))) { fiber_file_free(fe); } return -1; } } while (1);
}
...
{
 ((fe)->status &= ~(unsigned) (1 << 3));
# 336 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c"
 do { ssize_t ret; int err; if (((fe)->status & (unsigned) (1 << 1))) { ((fe)->status &= ~(unsigned) (1 << 1)); } else if (fiber_wait_read(fe) < 0) { return -1; } if (acl_fiber_canceled(fe->fiber_r)) { acl_fiber_set_error(fe->fiber_r->errnum); return -1; } ret = (*sys_recvmsg)(fe->fd, msg, flags); if (ret >= 0) { return ret; } err = acl_fiber_last_error(); fiber_save_errno(err); if (!((err) == 
# 336 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c" 3 4
11
# 336 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c"
)) { if (!(fe->type & (unsigned) (1 << 3))) { fiber_file_free(fe); } return -1; } } while (1);
}
...
{
 ((fe)->status &= ~(unsigned) (1 << 3));
# 378 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c"
 do { ssize_t ret; int err; if (((fe)->status & (unsigned) (1 << 1))) { ((fe)->status &= ~(unsigned) (1 << 1)); } else if (fiber_wait_read(fe) < 0) { return -1; } if (acl_fiber_canceled(fe->fiber_r)) { acl_fiber_set_error(fe->fiber_r->errnum); return -1; } ret = (*sys_recv)(fe->fd, buf, len, flags); if (ret >= 0) { return ret; } err = acl_fiber_last_error(); fiber_save_errno(err); if (!((err) == 
# 378 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c" 3 4
11
# 378 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c"
)) { if (!(fe->type & (unsigned) (1 << 3))) { fiber_file_free(fe); } return -1; } } while (1);
}
...
{
 ((fe)->status &= ~(unsigned) (1 << 3));
# 421 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c"
 do { ssize_t ret; int err; if (((fe)->status & (unsigned) (1 << 1))) { ((fe)->status &= ~(unsigned) (1 << 1)); } else if (fiber_wait_read(fe) < 0) { return -1; } if (acl_fiber_canceled(fe->fiber_r)) { acl_fiber_set_error(fe->fiber_r->errnum); return -1; } ret = (*sys_recvfrom)(fe->fd, buf, len, flags, src_addr, addrlen); if (ret >= 0) { return ret; } err = acl_fiber_last_error(); fiber_save_errno(err); if (!((err) == 
# 421 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c" 3 4
11
# 421 "/workspace/acl/lib_fiber/c/src/hook/fiber_read.c"
)) { if (!(fe->type & (unsigned) (1 << 3))) { fiber_file_free(fe); } return -1; } } while (1);
}
