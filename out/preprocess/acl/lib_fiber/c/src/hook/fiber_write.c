# 0 "/acl/lib_fiber/c/src/hook/fiber_write.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/hook/fiber_write.c"
...
# 2 "/acl/lib_fiber/c/src/hook/fiber_write.c" 2
...
# 3 "/acl/lib_fiber/c/src/hook/fiber_write.c" 2
...
# 5 "/acl/lib_fiber/c/src/hook/fiber_write.c" 2
...
void hook_once(void);
# 6 "/acl/lib_fiber/c/src/hook/fiber_write.c" 2
...
# 7 "/acl/lib_fiber/c/src/hook/fiber_write.c" 2
# 34 "/acl/lib_fiber/c/src/hook/fiber_write.c"
...
# 121 "/acl/lib_fiber/c/src/hook/fiber_write.c"
ssize_t fiber_write(FILE_EVENT *fe, const void *buf, size_t count)
{
 ((fe)->status &= ~(unsigned) (1 << 3));
# 153 "/acl/lib_fiber/c/src/hook/fiber_write.c"
...
# 158 "/acl/lib_fiber/c/src/hook/fiber_write.c" 3 4
 11
# 158 "/acl/lib_fiber/c/src/hook/fiber_write.c"
...
{
 ((fe)->status &= ~(unsigned) (1 << 3));
# 195 "/acl/lib_fiber/c/src/hook/fiber_write.c"
 do { if (var_hook_sys_api) { FILE_EVENT *_fe = fiber_file_get(fe->fd); if (_fe && ((_fe)->status & (unsigned) (1 << 4))) { non_blocking(fe->fd, 1); ((_fe)->status &= ~(unsigned) (1 << 4)); } } } while (0);
 ...
 while (1) {
  ...
  do { int _err; if (n >= 0) { return n; } _err = acl_fiber_last_error(); fiber_save_errno(_err); if (!((_err) == 
# 200 "/acl/lib_fiber/c/src/hook/fiber_write.c" 3 4
 11
# 200 "/acl/lib_fiber/c/src/hook/fiber_write.c"
 )) { return -1; } if (wait_write(fe) == -1) { return -1; } } while (0);
 }
}
...
{
 ((fe)->status &= ~(unsigned) (1 << 3));
# 238 "/acl/lib_fiber/c/src/hook/fiber_write.c"
 do { if (var_hook_sys_api) { FILE_EVENT *_fe = fiber_file_get(fe->fd); if (_fe && ((_fe)->status & (unsigned) (1 << 4))) { non_blocking(fe->fd, 1); ((_fe)->status &= ~(unsigned) (1 << 4)); } } } while (0);
 ...
 while (1) {
  ...
  do { int _err; if (n >= 0) { return n; } _err = acl_fiber_last_error(); fiber_save_errno(_err); if (!((_err) == 
# 243 "/acl/lib_fiber/c/src/hook/fiber_write.c" 3 4
 11
# 243 "/acl/lib_fiber/c/src/hook/fiber_write.c"
 )) { return -1; } if (wait_write(fe) == -1) { return -1; } } while (0);
 }
}
...
{
 ((fe)->status &= ~(unsigned) (1 << 3));
# 283 "/acl/lib_fiber/c/src/hook/fiber_write.c"
 do { if (var_hook_sys_api) { FILE_EVENT *_fe = fiber_file_get(fe->fd); if (_fe && ((_fe)->status & (unsigned) (1 << 4))) { non_blocking(fe->fd, 1); ((_fe)->status &= ~(unsigned) (1 << 4)); } } } while (0);
 ...
 while (1) {
  ...
  do { int _err; if (n >= 0) { return n; } _err = acl_fiber_last_error(); fiber_save_errno(_err); if (!((_err) == 
# 289 "/acl/lib_fiber/c/src/hook/fiber_write.c" 3 4
 11
# 289 "/acl/lib_fiber/c/src/hook/fiber_write.c"
 )) { return -1; } if (wait_write(fe) == -1) { return -1; } } while (0);
 }
}
...
{
 ((fe)->status &= ~(unsigned) (1 << 3));
# 325 "/acl/lib_fiber/c/src/hook/fiber_write.c"
 do { if (var_hook_sys_api) { FILE_EVENT *_fe = fiber_file_get(fe->fd); if (_fe && ((_fe)->status & (unsigned) (1 << 4))) { non_blocking(fe->fd, 1); ((_fe)->status &= ~(unsigned) (1 << 4)); } } } while (0);
 ...
 while (1) {
  ...
  do { int _err; if (n >= 0) { return n; } _err = acl_fiber_last_error(); fiber_save_errno(_err); if (!((_err) == 
# 330 "/acl/lib_fiber/c/src/hook/fiber_write.c" 3 4
 11
# 330 "/acl/lib_fiber/c/src/hook/fiber_write.c"
 )) { return -1; } if (wait_write(fe) == -1) { return -1; } } while (0);
 }
}
...
ssize_t fiber_sendfile64(socket_t out_fd, int in_fd, off64_t *offset, size_t count)
{
 ...
 while (1) {
  ...
  if (!((err) == 
# 359 "/acl/lib_fiber/c/src/hook/fiber_write.c" 3 4
      11
# 359 "/acl/lib_fiber/c/src/hook/fiber_write.c"
      )) {
   return -1;
  }
  ...
  if (fiber_wait_write(fe) < 0) {
   msg_error("%s(%d): fiber_wait_write error=%s, fd=%d",
    __FUNCTION__, 368, last_serror(), (int) out_fd);
   fiber_file_free(fe);
   return -1;
  }
  ...
  if (((fe)->status & (unsigned) (1 << 7))) {
   msg_info("%s(%d): fd=%d being closing",
    __FUNCTION__, 375, (int) out_fd);
   return 0;
  }

  if (fe->mask & ((unsigned) (1 << 4) | (unsigned) (1 << 5) | (unsigned) (1 << 6))) {
   msg_error("%s(%d): fd=%d error",
    __FUNCTION__, 381, out_fd);
   return -1;
  }
