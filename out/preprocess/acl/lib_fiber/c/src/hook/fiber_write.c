# 1 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c" 2
...
# 5 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c" 2
...
void hook_once(void);
# 6 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c" 2
...
# 7 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c" 2
# 34 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c"
static int wait_write(FILE_EVENT *fe)
{
 ...
 if (fe->mask & ((unsigned) (1 << 4) | (unsigned) (1 << 5) | (unsigned) (1 << 6))) {
...
# 125 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c"
ssize_t fiber_write(FILE_EVENT *fe, const void *buf, size_t count)
{
 ((fe)->status &= ~(unsigned) (1 << 3));
# 157 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c"
 do { if (var_hook_sys_api) { FILE_EVENT *_fe = fiber_file_get(fe->fd); if (_fe && ((_fe)->status & (unsigned) (1 << 4))) { non_blocking(fe->fd, 1); ((_fe)->status &= ~(unsigned) (1 << 4)); } } } while (0);

 while (1) {
  ssize_t n = (*sys_write)(fe->fd, buf, count);

  do { int _err; if (n >= 0) { return n; } _err = acl_fiber_last_error(); fiber_save_errno(_err); if (!((_err) == 
# 162 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c" 3 4
 11
# 162 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c"
 )) { return -1; } if (wait_write(fe) == -1) { return -1; } } while (0);
 }
}
...
{
 ((fe)->status &= ~(unsigned) (1 << 3));
# 199 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c"
 do { if (var_hook_sys_api) { FILE_EVENT *_fe = fiber_file_get(fe->fd); if (_fe && ((_fe)->status & (unsigned) (1 << 4))) { non_blocking(fe->fd, 1); ((_fe)->status &= ~(unsigned) (1 << 4)); } } } while (0);
 ...
 while (1) {
  ...
  do { int _err; if (n >= 0) { return n; } _err = acl_fiber_last_error(); fiber_save_errno(_err); if (!((_err) == 
# 204 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c" 3 4
 11
# 204 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c"
 )) { return -1; } if (wait_write(fe) == -1) { return -1; } } while (0);
 }
}
...
{
 ((fe)->status &= ~(unsigned) (1 << 3));
# 242 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c"
 do { if (var_hook_sys_api) { FILE_EVENT *_fe = fiber_file_get(fe->fd); if (_fe && ((_fe)->status & (unsigned) (1 << 4))) { non_blocking(fe->fd, 1); ((_fe)->status &= ~(unsigned) (1 << 4)); } } } while (0);
 ...
 while (1) {
  ...
  do { int _err; if (n >= 0) { return n; } _err = acl_fiber_last_error(); fiber_save_errno(_err); if (!((_err) == 
# 247 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c" 3 4
 11
# 247 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c"
 )) { return -1; } if (wait_write(fe) == -1) { return -1; } } while (0);
 }
}
...
{
 ((fe)->status &= ~(unsigned) (1 << 3));
# 287 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c"
 do { if (var_hook_sys_api) { FILE_EVENT *_fe = fiber_file_get(fe->fd); if (_fe && ((_fe)->status & (unsigned) (1 << 4))) { non_blocking(fe->fd, 1); ((_fe)->status &= ~(unsigned) (1 << 4)); } } } while (0);
 ...
 while (1) {
  ...
  do { int _err; if (n >= 0) { return n; } _err = acl_fiber_last_error(); fiber_save_errno(_err); if (!((_err) == 
# 293 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c" 3 4
 11
# 293 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c"
 )) { return -1; } if (wait_write(fe) == -1) { return -1; } } while (0);
 }
}
...
{
 ((fe)->status &= ~(unsigned) (1 << 3));
# 329 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c"
 do { if (var_hook_sys_api) { FILE_EVENT *_fe = fiber_file_get(fe->fd); if (_fe && ((_fe)->status & (unsigned) (1 << 4))) { non_blocking(fe->fd, 1); ((_fe)->status &= ~(unsigned) (1 << 4)); } } } while (0);
 ...
 while (1) {
  ...
  do { int _err; if (n >= 0) { return n; } _err = acl_fiber_last_error(); fiber_save_errno(_err); if (!((_err) == 
# 334 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c" 3 4
 11
# 334 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c"
 )) { return -1; } if (wait_write(fe) == -1) { return -1; } } while (0);
 }
}
...
ssize_t fiber_sendfile64(socket_t out_fd, int in_fd, off64_t *offset, size_t count)
{
 ...
 do { if (var_hook_sys_api) { FILE_EVENT *_fe = fiber_file_get(out_fd); if (_fe && ((_fe)->status & (unsigned) (1 << 4))) { non_blocking(out_fd, 1); ((_fe)->status &= ~(unsigned) (1 << 4)); } } } while (0);
 ...
 while (1) {
  ...
  if (!((err) == 
# 363 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c" 3 4
      11
# 363 "/workspace/acl/lib_fiber/c/src/hook/fiber_write.c"
      )) {
   return -1;
  }
  ...
  if (fiber_wait_write(fe) < 0) {
   msg_error("%s(%d): fiber_wait_write error=%s, fd=%d",
    __FUNCTION__, 372, last_serror(), (int) out_fd);
   fiber_file_free(fe);
   return -1;
  }
  ...
  if (((fe)->status & (unsigned) (1 << 7))) {
   msg_info("%s(%d): fd=%d being closing",
    __FUNCTION__, 379, (int) out_fd);
   return 0;
  }

  if (fe->mask & ((unsigned) (1 << 4) | (unsigned) (1 << 5) | (unsigned) (1 << 6))) {
   msg_error("%s(%d): fd=%d error",
    __FUNCTION__, 385, out_fd);
   return -1;
  }
