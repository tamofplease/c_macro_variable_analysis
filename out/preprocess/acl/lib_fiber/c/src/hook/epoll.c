# 1 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 2
...
# 6 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 2

# 1 "/workspace/acl/lib_fiber/c/src/event.h" 1




# 1 "/workspace/acl/lib_fiber/c/src/common/gettimeofday.h" 1
# 6 "/workspace/acl/lib_fiber/c/src/event.h" 2
# 34 "/workspace/acl/lib_fiber/c/src/event.h"
...
# 75 "/workspace/acl/lib_fiber/c/src/event.h"
struct FILE_EVENT {
 RING me;
 ACL_FIBER *fiber_r;
 ACL_FIBER *fiber_w;
 ...
 int id;
 unsigned status;
# 123 "/workspace/acl/lib_fiber/c/src/event.h"
 unsigned type;
 ...
 unsigned mask;
# 175 "/workspace/acl/lib_fiber/c/src/event.h"
 event_proc *r_proc;
 event_proc *w_proc;
 ...
 EPOLL_CTX *epx;
# 296 "/workspace/acl/lib_fiber/c/src/event.h"
 short refer;
 short busy;
...
# 384 "/workspace/acl/lib_fiber/c/src/event.h"
...
# 8 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 2
# 1 "/workspace/acl/lib_fiber/c/src/fiber.h" 1




# 1 "/workspace/acl/lib_fiber/c/src/event.h" 1
# 6 "/workspace/acl/lib_fiber/c/src/fiber.h" 2
# 16 "/workspace/acl/lib_fiber/c/src/fiber.h"
typedef enum {
 FIBER_STATUS_NONE,
 FIBER_STATUS_READY,
...
# 102 "/workspace/acl/lib_fiber/c/src/fiber.h"
...
# 9 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 2
...
void hook_once(void);
# 10 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 2
...
# 33 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
struct EPOLL {
 int epfd;
 EPOLL_CTX **fds;
 size_t nfds;
...
# 53 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
...
# 64 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 64 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
curr
# 64 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
...
"curr"
# 64 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 64, __extension__ __PRETTY_FUNCTION__); }))
# 64 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
            ;
 ...
 if (ee->epoll == 
# 69 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                 ((void *)0)
# 69 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                     ) {
  epoll_event_free(ee);
  return;
 }
 ...
 if (tmp == 
# 77 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
           ((void *)0)
# 77 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
               ) {
  msg_fatal("%s(%d), %s: not found ee=%p, curr fiber=%d,"
   " ee fiber=%d", "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 79, __FUNCTION__,
   ee, acl_fiber_id(curr), acl_fiber_id(ee->fiber));
 }

 
# 83 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 83 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
tmp == ee
# 83 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 83 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
...
"tmp == ee"
# 83 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 83, __extension__ __PRETTY_FUNCTION__); }))
# 83 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                 ;
 htable_delete(ee->epoll->ep_events, key, 
# 84 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                                         ((void *)0)
# 84 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                                             );
 epoll_event_free(ee);
}
...
static EPOLL_EVENT *epoll_event_alloc(void)
{
 ...
 do { RING *_ring = &ee->me; _ring->pred = _ring->succ = _ring; _ring->parent = _ring; _ring->len = 0; } while (0);
...
static ARRAY *__main_epfds = 
# 112 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                                ((void *)0)
# 112 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                                    ;
static __thread ARRAY *__epfds = 
# 113 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                                ((void *)0)
# 113 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                                    ;

static pthread_key_t __once_key;
static pthread_once_t __once_control = 
# 116 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                                      0
# 116 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                                                       ;

static void epoll_free(EPOLL *ep);

static void thread_free(void *ctx __attribute__ ((__unused__)))
{
 ITER iter;

 if (__epfds == 
# 124 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
               ((void *)0)
# 124 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                   ) {
  return;
 }
 ...
 if (__epfds == __main_epfds) {
  __main_epfds = 
# 129 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                ((void *)0)
# 129 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                    ;
 }

 for ((__epfds)->iter_head(&(iter), (__epfds)); (iter).ptr; (__epfds)->iter_next(&(iter), (__epfds))) {
 ...
 array_free(__epfds, 
# 142 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                    ((void *)0)
# 142 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                        );
 __epfds = 
# 143 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
          ((void *)0)
# 143 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
              ;
}
...
static void main_thread_free(void)
{
 if (__main_epfds) {
  ...
  __main_epfds = 
# 150 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                ((void *)0)
# 150 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                    ;
 }
}
...
static void thread_init(void)
{
 if (pthread_key_create(&__once_key, thread_free) != 0) {
  msg_fatal("%s(%d), %s: pthread_key_create error %s",
   "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 158, __FUNCTION__, last_serror());
 }
}
...
static EPOLL *epoll_alloc(int epfd)
{
 ...
 if (maxfd <= 0) {
  msg_fatal("%s(%d), %s: open_limit error %s",
   "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 169, __FUNCTION__, last_serror());
 }


 if (__epfds == 
# 173 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
               ((void *)0)
# 173 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                   ) {
  if (pthread_once(&__once_control, thread_init) != 0) {
   msg_fatal("%s(%d), %s: pthread_once error %s",
    "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 176, __FUNCTION__, last_serror());
  }

  __epfds = array_create(5, (1 << 0));
 ...
 for (i = 0; i < maxfd; i++) {
  ep->fds[i] = 
# 200 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
              ((void *)0)
# 200 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                  ;
 }
...
static void epoll_free(EPOLL *ep)
{
 ...
 for ((ep->ep_events)->iter_head(&(iter), (ep->ep_events)); (iter).ptr; (ep->ep_events)->iter_next(&(iter), (ep->ep_events))) {
  EPOLL_EVENT *ee = (EPOLL_EVENT *) iter.data;
  ee->epoll = 
# 218 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
             ((void *)0)
# 218 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                 ;
 }

 htable_free(ep->ep_events, 
# 221 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                           ((void *)0)
# 221 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                               );

 for (i = 0; i < ep->nfds; i++) {
  if (ep->fds[i] != 
# 224 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                   ((void *)0)
# 224 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                       ) {
   mem_free(ep->fds[i]);
  }
 }
...
int epoll_event_close(int epfd)
{
 ...
 int sys_epfd;
 EPOLL *ep = 
# 237 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
            ((void *)0)
# 237 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                ;
 int pos = -1;
 ITER iter;

 if (__epfds == 
# 241 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
               ((void *)0) 
# 241 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                    || epfd < 0) {
  return -1;
 }
 ...
 if (ep == 
# 254 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
          ((void *)0)
# 254 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
              ) {
  return -1;
 }
...
# 259 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 259 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
ev
# 259 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 259 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
...
"ev"
# 259 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 259, __extension__ __PRETTY_FUNCTION__); }))
# 259 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
          ;

 sys_epfd = event_handle(ev);
 
# 262 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 262 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
sys_epfd >= 0
# 262 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 262 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
...
"sys_epfd >= 0"
# 262 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 262, __extension__ __PRETTY_FUNCTION__); }))
# 262 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                     ;
 ...
 if (epfd == sys_epfd) {
  msg_error("%s(%d): can't close the event sys_epfd=%d",
   __FUNCTION__, 271, epfd);
  return -1;
 }

 epoll_free(ep);
 array_delete(__epfds, pos, 
# 276 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                           ((void *)0)
# 276 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                               );
...
static EPOLL_EVENT *epoll_event_find(int epfd, int create)
{
 ACL_FIBER *curr = acl_fiber_running();
 EPOLL *ep = 
# 284 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
            ((void *)0)
# 284 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                ;
 EPOLL_EVENT *ee;
 char key[32];
 ITER iter;
 ...
 if (__epfds == 
# 289 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
               ((void *)0)
# 289 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                   ) {
  msg_error("%s(%d), %s: __epfds NULL",
   "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 291, __FUNCTION__);
  return 
# 292 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
        ((void *)0)
# 292 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
            ;
 }
 ...
 if (ep == 
# 303 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
          ((void *)0)
# 303 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
              ) {
  msg_error("%s(%d, %s: not found epfd=%d",
   "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 305, __FUNCTION__, epfd);
  return 
# 306 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
        ((void *)0)
# 306 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
            ;
 }
 ...
 if (ee != 
# 311 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
          ((void *)0)
# 311 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
              ) {
  ee->epoll = ep;
  return ee;
 }
 ...
 if (create) {
  ...
  return 
# 323 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
        ((void *)0)
# 323 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
            ;
 }
}
...
int epoll_create(int size __attribute__ ((__unused__)))
{
 ...
 if (sys_epoll_create == 
# 335 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                        ((void *)0)
# 335 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                            ) {
  hook_once();
 }
...
# 344 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 344 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
ev
# 344 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 344 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
...
"ev"
# 344 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 344, __extension__ __PRETTY_FUNCTION__); }))
# 344 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
          ;
 ...
 if (epfd < 0) {
  msg_error("%s(%d), %s: invalid event_handle %d",
   "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 350, __FUNCTION__, epfd);
  return epfd;
 }
...
int epoll_create1(int flags)
{
 ...
 if (flags & 
# 368 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
            EPOLL_CLOEXEC
# 368 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                         ) {
...
# 381 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 381 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
epx
# 381 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 381 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
...
"epx"
# 381 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 381, __extension__ __PRETTY_FUNCTION__); }))
# 381 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
           ;
 
# 382 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 382 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
epx->mask & (unsigned) (1 << 2)
# 382 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 382 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
epx->mask & (unsigned) (1 << 2)
...
"epx->mask & EVENT_READ"
# 382 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 382, __extension__ __PRETTY_FUNCTION__); }))
# 382 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                              ;

 ee = epx->ee;
 
# 385 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 385 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
ee
# 385 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 385 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
...
"ee"
# 385 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 385, __extension__ __PRETTY_FUNCTION__); }))
# 385 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
          ;

 ep = ee->epoll;
 
# 388 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 388 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
ep
# 388 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 388 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
...
"ep"
# 388 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 388, __extension__ __PRETTY_FUNCTION__); }))
# 388 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
          ;
 ...
 ee->events[ee->nready].events |= 
# 398 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                                 EPOLLIN
# 398 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                                        ;
 ...
 if (ee->nready == 0) {
  ...
  do { ((RING*)(&ee->me))->pred = ((RING*)(&ev->epoll_ready))->pred; ((RING*)(&ee->me))->succ = (RING*)(&ev->epoll_ready); ((RING*)(&ee->me))->parent = ((RING*)(&ev->epoll_ready))->parent; ((RING*)(&ev->epoll_ready))->pred->succ = (RING*)(&ee->me); ((RING*)(&ev->epoll_ready))->pred = (RING*)(&ee->me); ((RING*)(&ev->epoll_ready))->parent->len++; } while (0);
 }

 if (!(ee->events[ee->nready].events & 
# 407 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                                      EPOLLOUT
# 407 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                                              )) {
  ee->nready++;
 }

 ((fe)->status |= (unsigned) (1 << 1));
}

static void write_callback(EVENT *ev __attribute__ ((__unused__)), FILE_EVENT *fe)
{
 EPOLL_CTX *epx = fe->epx;
 EPOLL_EVENT *ee;
 EPOLL *ep;
...
# 420 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 420 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
epx
# 420 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 420 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
...
"epx"
# 420 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 420, __extension__ __PRETTY_FUNCTION__); }))
# 420 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
           ;
 
# 421 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 421 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
epx->mask & (unsigned) (1 << 3)
# 421 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 421 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
epx->mask & (unsigned) (1 << 3)
...
# 421 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 421, __extension__ __PRETTY_FUNCTION__); }))
# 421 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                               ;

 ee = epx->ee;
 
# 424 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 424 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
ee
# 424 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 424 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
...
"ee"
# 424 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 424, __extension__ __PRETTY_FUNCTION__); }))
# 424 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
          ;

 ep = ee->epoll;
 
# 427 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 427 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
ep
# 427 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 427 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
...
"ep"
# 427 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 427, __extension__ __PRETTY_FUNCTION__); }))
# 427 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
          ;
 ...
 ee->events[ee->nready].events |= 
# 433 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                                 EPOLLOUT
# 433 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                                         ;
 memcpy(&ee->events[ee->nready].data, &ep->fds[epx->fd]->data,
  sizeof(ep->fds[epx->fd]->data));
 ...
 if (!(ee->events[ee->nready].events & 
# 442 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                                      EPOLLIN
# 442 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                                             )) {
  ee->nready++;
 }

 ((fe)->status |= (unsigned) (1 << 2));
}
 ...
 struct epoll_event *event, int fd, int op)
{
 ...
 if (ep->fds[fd] == 
# 454 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                   ((void *)0)
# 454 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                       ) {
 ...
 if (event->events & 
# 466 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                    EPOLLIN
# 466 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                           ) {
  ep->fds[fd]->mask |= (unsigned) (1 << 2);
  ep->fds[fd]->fe = fiber_file_open_read(fd);
  ep->fds[fd]->fe->epx = ep->fds[fd];

  event_add_read(ev, ep->fds[fd]->fe, read_callback);
  ((ep->fds[fd]->fe)->status |= (unsigned) (1 << 5));
 }

 if (event->events & 
# 475 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                    EPOLLOUT
# 475 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                            ) {
  ep->fds[fd]->mask |= (unsigned) (1 << 3);
  ep->fds[fd]->fe = fiber_file_open_write(fd);
  ep->fds[fd]->fe->epx = ep->fds[fd];

  event_add_write(ev, ep->fds[fd]->fe, write_callback);
  ((ep->fds[fd]->fe)->status |= (unsigned) (1 << 6));
 }
}
...
static void epoll_ctl_del(EVENT *ev, EPOLL_EVENT *ee, int fd)
{
 ...
 if (ep->fds[fd]->mask & (unsigned) (1 << 2)) {
  event_del_read(ev, ep->fds[fd]->fe);
  ((ep->fds[fd]->fe)->status &= ~(unsigned) (1 << 5));
 }

 if (ep->fds[fd]->mask & (unsigned) (1 << 3)) {
 ...
 ep->fds[fd]->rmask = 0;
 ep->fds[fd]->fe->epx = 
# 503 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                       ((void *)0)
# 503 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                           ;
 ep->fds[fd]->fe = 
# 504 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                       ((void *)0)
# 504 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                           ;
 memset(&ep->fds[fd]->data, 0, sizeof(ep->fds[fd]->data));

 mem_free(ep->fds[fd]);
 ep->fds[fd] = 
# 508 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
              ((void *)0)
# 508 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                  ;
}
...
int epoll_ctl(int epfd, int op, int fd, struct epoll_event *event)
{
 ...
 if (sys_epoll_ctl == 
# 516 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                     ((void *)0)
# 516 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                         ) {
  hook_once();
 }
 ...
 if (ee == 
# 525 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
          ((void *)0)
# 525 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
              ) {
  msg_error("%s(%d), %s: not exist epfd=%d",
   "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 527, __FUNCTION__, epfd);
  return -1;
 }

 
# 531 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 531 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
ee->epoll
# 531 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 531 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
...
"ee->epoll"
# 531 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 531, __extension__ __PRETTY_FUNCTION__); }))
# 531 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                 ;
 ...
 if (op == 
# 535 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
          1 
# 535 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                        || op == 
# 535 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                                 3
# 535 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
...
# 537 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                 2
# 537 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                              ) {
  msg_error("%s(%d), %s: invalid op %d, fd %d",
   "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 539, __FUNCTION__, op, fd);
  return -1;
 } else if (ee->epoll->fds[fd] != 
# 541 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                                 ((void *)0)
# 541 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                                     ) {
  epoll_ctl_del(ev, ee, fd);
 } else {
  msg_error("%s(%d), %s: invalid fd=%d",
   "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 545, __FUNCTION__, fd);
  return -1;
 }
...
static void epoll_callback(EVENT *ev __attribute__ ((__unused__)), EPOLL_EVENT *ee)
{
...
int epoll_wait(int epfd, struct epoll_event *events, int maxevents, int timeout)
{
 ...
 if (sys_epoll_wait == 
# 584 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                      ((void *)0)
# 584 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                          ) {
  hook_once();
 }
 ...
 ev = fiber_io_event();
 if (ev == 
# 594 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
          ((void *)0)
# 594 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
              ) {
  msg_error("%s(%d), %s: EVENT NULL",
   "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 596, __FUNCTION__);
  return -1;
 }

 ee = epoll_event_find(epfd, 0);
 if (ee == 
# 601 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
          ((void *)0)
# 601 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
              ) {
  msg_error("%s(%d), %s: not exist epfd %d",
   "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 603, __FUNCTION__, epfd);
  return -1;
 }
 ...
 while (1) {
  ...
  if (acl_fiber_killed(ee->fiber)) {
   ...
   msg_info("%s(%d), %s: fiber-%u was killed",
    "/workspace/acl/lib_fiber/c/src/hook/epoll.c", 638, __FUNCTION__,
  ...
  if (ee->expire > 0 && now >= ee->expire) {
   acl_fiber_set_error(
# 653 "/workspace/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                      62
# 653 "/workspace/acl/lib_fiber/c/src/hook/epoll.c"
                                 );
   break;
  }
 }
