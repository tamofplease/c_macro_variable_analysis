# 0 "/acl/lib_fiber/c/src/hook/epoll.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/hook/epoll.c"
...
# 2 "/acl/lib_fiber/c/src/hook/epoll.c" 2
...
# 6 "/acl/lib_fiber/c/src/hook/epoll.c" 2

# 1 "/acl/lib_fiber/c/src/event.h" 1




# 1 "/acl/lib_fiber/c/src/common/gettimeofday.h" 1
# 6 "/acl/lib_fiber/c/src/event.h" 2
# 34 "/acl/lib_fiber/c/src/event.h"
...
# 75 "/acl/lib_fiber/c/src/event.h"
struct FILE_EVENT {
 RING me;
 ACL_FIBER *fiber_r;
 ACL_FIBER *fiber_w;
 ...
 int id;
 unsigned status;
# 123 "/acl/lib_fiber/c/src/event.h"
 unsigned type;
 ...
 unsigned mask;
# 175 "/acl/lib_fiber/c/src/event.h"
 event_proc *r_proc;
 event_proc *w_proc;
 ...
 EPOLL_CTX *epx;
# 296 "/acl/lib_fiber/c/src/event.h"
 short refer;
 short busy;
...
# 384 "/acl/lib_fiber/c/src/event.h"
...
# 8 "/acl/lib_fiber/c/src/hook/epoll.c" 2
# 1 "/acl/lib_fiber/c/src/fiber.h" 1




# 1 "/acl/lib_fiber/c/src/event.h" 1
# 6 "/acl/lib_fiber/c/src/fiber.h" 2
# 16 "/acl/lib_fiber/c/src/fiber.h"
typedef enum {
 FIBER_STATUS_NONE,
 FIBER_STATUS_READY,
...
# 102 "/acl/lib_fiber/c/src/fiber.h"
...
# 9 "/acl/lib_fiber/c/src/hook/epoll.c" 2
...
void hook_once(void);
# 10 "/acl/lib_fiber/c/src/hook/epoll.c" 2
...
# 33 "/acl/lib_fiber/c/src/hook/epoll.c"
struct EPOLL {
 int epfd;
 EPOLL_CTX **fds;
 size_t nfds;
...
# 53 "/acl/lib_fiber/c/src/hook/epoll.c"
...
# 64 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 64 "/acl/lib_fiber/c/src/hook/epoll.c"
curr
# 64 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
...
"curr"
# 64 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/acl/lib_fiber/c/src/hook/epoll.c", 64, __extension__ __PRETTY_FUNCTION__); }))
# 64 "/acl/lib_fiber/c/src/hook/epoll.c"
            ;
 ...
 if (ee->epoll == 
# 69 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                 ((void *)0)
# 69 "/acl/lib_fiber/c/src/hook/epoll.c"
                     ) {
  epoll_event_free(ee);
  return;
 }
 ...
 if (tmp == 
# 77 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
           ((void *)0)
# 77 "/acl/lib_fiber/c/src/hook/epoll.c"
               ) {
  msg_fatal("%s(%d), %s: not found ee=%p, curr fiber=%d,"
   " ee fiber=%d", "/acl/lib_fiber/c/src/hook/epoll.c", 79, __FUNCTION__,
   ee, acl_fiber_id(curr), acl_fiber_id(ee->fiber));
 }

 
# 83 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 83 "/acl/lib_fiber/c/src/hook/epoll.c"
tmp == ee
# 83 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 83 "/acl/lib_fiber/c/src/hook/epoll.c"
...
"tmp == ee"
# 83 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/acl/lib_fiber/c/src/hook/epoll.c", 83, __extension__ __PRETTY_FUNCTION__); }))
# 83 "/acl/lib_fiber/c/src/hook/epoll.c"
                 ;
 htable_delete(ee->epoll->ep_events, key, 
# 84 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                                         ((void *)0)
# 84 "/acl/lib_fiber/c/src/hook/epoll.c"
                                             );
 epoll_event_free(ee);
}
...
# 112 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                                ((void *)0)
# 112 "/acl/lib_fiber/c/src/hook/epoll.c"
                                    ;
static __thread ARRAY *__epfds = 
# 113 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                                ((void *)0)
# 113 "/acl/lib_fiber/c/src/hook/epoll.c"
                                    ;

static pthread_key_t __once_key;
static pthread_once_t __once_control = 
# 116 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                                      0
# 116 "/acl/lib_fiber/c/src/hook/epoll.c"
                                                       ;
...
static void thread_free(void *ctx __attribute__ ((__unused__)))
{
 ...
 if (__epfds == 
# 124 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
               ((void *)0)
# 124 "/acl/lib_fiber/c/src/hook/epoll.c"
                   ) {
  return;
 }
 ...
 if (__epfds == __main_epfds) {
  __main_epfds = 
# 129 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                ((void *)0)
# 129 "/acl/lib_fiber/c/src/hook/epoll.c"
                    ;
 }
 ...
 array_free(__epfds, 
# 142 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                    ((void *)0)
# 142 "/acl/lib_fiber/c/src/hook/epoll.c"
                        );
 __epfds = 
# 143 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
          ((void *)0)
# 143 "/acl/lib_fiber/c/src/hook/epoll.c"
              ;
}
...
static void main_thread_free(void)
{
 if (__main_epfds) {
  ...
  __main_epfds = 
# 150 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                ((void *)0)
# 150 "/acl/lib_fiber/c/src/hook/epoll.c"
                    ;
 }
}
...
static void thread_init(void)
{
 if (pthread_key_create(&__once_key, thread_free) != 0) {
  msg_fatal("%s(%d), %s: pthread_key_create error %s",
   "/acl/lib_fiber/c/src/hook/epoll.c", 158, __FUNCTION__, last_serror());
 }
}
...
static EPOLL *epoll_alloc(int epfd)
{
 ...
 if (maxfd <= 0) {
  msg_fatal("%s(%d), %s: open_limit error %s",
   "/acl/lib_fiber/c/src/hook/epoll.c", 169, __FUNCTION__, last_serror());
 }


 if (__epfds == 
# 173 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
               ((void *)0)
# 173 "/acl/lib_fiber/c/src/hook/epoll.c"
                   ) {
  if (pthread_once(&__once_control, thread_init) != 0) {
   msg_fatal("%s(%d), %s: pthread_once error %s",
    "/acl/lib_fiber/c/src/hook/epoll.c", 176, __FUNCTION__, last_serror());
  }
 ...
 for (i = 0; i < maxfd; i++) {
  ep->fds[i] = 
# 200 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
              ((void *)0)
# 200 "/acl/lib_fiber/c/src/hook/epoll.c"
                  ;
 }
...
static void epoll_free(EPOLL *ep)
{
 ...
 for ((ep->ep_events)->iter_head(&(iter), (ep->ep_events)); (iter).ptr; (ep->ep_events)->iter_next(&(iter), (ep->ep_events))) {
  ...
  ee->epoll = 
# 218 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
             ((void *)0)
# 218 "/acl/lib_fiber/c/src/hook/epoll.c"
                 ;
 }

 htable_free(ep->ep_events, 
# 221 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                           ((void *)0)
# 221 "/acl/lib_fiber/c/src/hook/epoll.c"
                               );

 for (i = 0; i < ep->nfds; i++) {
  if (ep->fds[i] != 
# 224 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                   ((void *)0)
# 224 "/acl/lib_fiber/c/src/hook/epoll.c"
                       ) {
   mem_free(ep->fds[i]);
  }
 }
...
int epoll_event_close(int epfd)
{
 ...
 int sys_epfd;
 EPOLL *ep = 
# 237 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
            ((void *)0)
# 237 "/acl/lib_fiber/c/src/hook/epoll.c"
                ;
 int pos = -1;
 ITER iter;

 if (__epfds == 
# 241 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
               ((void *)0) 
# 241 "/acl/lib_fiber/c/src/hook/epoll.c"
                    || epfd < 0) {
  return -1;
 }
 ...
 if (ep == 
# 254 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
          ((void *)0)
# 254 "/acl/lib_fiber/c/src/hook/epoll.c"
              ) {
  return -1;
 }
...
# 259 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 259 "/acl/lib_fiber/c/src/hook/epoll.c"
ev
# 259 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 259 "/acl/lib_fiber/c/src/hook/epoll.c"
...
"ev"
# 259 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/acl/lib_fiber/c/src/hook/epoll.c", 259, __extension__ __PRETTY_FUNCTION__); }))
# 259 "/acl/lib_fiber/c/src/hook/epoll.c"
          ;

 sys_epfd = event_handle(ev);
 
# 262 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 262 "/acl/lib_fiber/c/src/hook/epoll.c"
sys_epfd >= 0
# 262 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 262 "/acl/lib_fiber/c/src/hook/epoll.c"
...
"sys_epfd >= 0"
# 262 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/acl/lib_fiber/c/src/hook/epoll.c", 262, __extension__ __PRETTY_FUNCTION__); }))
# 262 "/acl/lib_fiber/c/src/hook/epoll.c"
                     ;
...
# 276 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                           ((void *)0)
# 276 "/acl/lib_fiber/c/src/hook/epoll.c"
                               );
...
static EPOLL_EVENT *epoll_event_find(int epfd, int create)
{
 ACL_FIBER *curr = acl_fiber_running();
 EPOLL *ep = 
# 284 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
            ((void *)0)
# 284 "/acl/lib_fiber/c/src/hook/epoll.c"
                ;
 EPOLL_EVENT *ee;
 char key[32];
 ITER iter;
 ...
 if (__epfds == 
# 289 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
               ((void *)0)
# 289 "/acl/lib_fiber/c/src/hook/epoll.c"
                   ) {
  msg_error("%s(%d), %s: __epfds NULL",
   "/acl/lib_fiber/c/src/hook/epoll.c", 291, __FUNCTION__);
  return 
# 292 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
        ((void *)0)
# 292 "/acl/lib_fiber/c/src/hook/epoll.c"
            ;
 }
 ...
 if (ep == 
# 303 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
          ((void *)0)
# 303 "/acl/lib_fiber/c/src/hook/epoll.c"
              ) {
  msg_error("%s(%d, %s: not found epfd=%d",
   "/acl/lib_fiber/c/src/hook/epoll.c", 305, __FUNCTION__, epfd);
  return 
# 306 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
        ((void *)0)
# 306 "/acl/lib_fiber/c/src/hook/epoll.c"
            ;
 }
 ...
 if (ee != 
# 311 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
          ((void *)0)
# 311 "/acl/lib_fiber/c/src/hook/epoll.c"
              ) {
  ee->epoll = ep;
  return ee;
 }
 ...
 if (create) {
  ...
  return 
# 323 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
        ((void *)0)
# 323 "/acl/lib_fiber/c/src/hook/epoll.c"
            ;
 }
}
...
int epoll_create(int size __attribute__ ((__unused__)))
{
 ...
 if (sys_epoll_create == 
# 335 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                        ((void *)0)
# 335 "/acl/lib_fiber/c/src/hook/epoll.c"
                            ) {
  hook_once();
 }
...
# 344 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 344 "/acl/lib_fiber/c/src/hook/epoll.c"
ev
# 344 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 344 "/acl/lib_fiber/c/src/hook/epoll.c"
...
"ev"
# 344 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/acl/lib_fiber/c/src/hook/epoll.c", 344, __extension__ __PRETTY_FUNCTION__); }))
# 344 "/acl/lib_fiber/c/src/hook/epoll.c"
          ;
 ...
 if (epfd < 0) {
  msg_error("%s(%d), %s: invalid event_handle %d",
   "/acl/lib_fiber/c/src/hook/epoll.c", 350, __FUNCTION__, epfd);
  return epfd;
 }
...
int epoll_create1(int flags)
{
 ...
 if (flags & 
# 368 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
            EPOLL_CLOEXEC
# 368 "/acl/lib_fiber/c/src/hook/epoll.c"
                         ) {
...
# 381 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 381 "/acl/lib_fiber/c/src/hook/epoll.c"
epx
# 381 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 381 "/acl/lib_fiber/c/src/hook/epoll.c"
...
"epx"
# 381 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/acl/lib_fiber/c/src/hook/epoll.c", 381, __extension__ __PRETTY_FUNCTION__); }))
# 381 "/acl/lib_fiber/c/src/hook/epoll.c"
           ;
 
# 382 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 382 "/acl/lib_fiber/c/src/hook/epoll.c"
...
"epx->mask & EVENT_READ"
# 382 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/acl/lib_fiber/c/src/hook/epoll.c", 382, __extension__ __PRETTY_FUNCTION__); }))
# 382 "/acl/lib_fiber/c/src/hook/epoll.c"
                              ;

 ee = epx->ee;
 
# 385 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 385 "/acl/lib_fiber/c/src/hook/epoll.c"
ee
# 385 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 385 "/acl/lib_fiber/c/src/hook/epoll.c"
...
"ee"
# 385 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/acl/lib_fiber/c/src/hook/epoll.c", 385, __extension__ __PRETTY_FUNCTION__); }))
# 385 "/acl/lib_fiber/c/src/hook/epoll.c"
          ;

 ep = ee->epoll;
 
# 388 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 388 "/acl/lib_fiber/c/src/hook/epoll.c"
ep
# 388 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 388 "/acl/lib_fiber/c/src/hook/epoll.c"
...
"ep"
# 388 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/acl/lib_fiber/c/src/hook/epoll.c", 388, __extension__ __PRETTY_FUNCTION__); }))
# 388 "/acl/lib_fiber/c/src/hook/epoll.c"
          ;
...
# 398 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                                 EPOLLIN
# 398 "/acl/lib_fiber/c/src/hook/epoll.c"
                                        ;
...
# 407 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                                      EPOLLOUT
# 407 "/acl/lib_fiber/c/src/hook/epoll.c"
                                              )) {
  ee->nready++;
 }
...
# 420 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 420 "/acl/lib_fiber/c/src/hook/epoll.c"
epx
# 420 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 420 "/acl/lib_fiber/c/src/hook/epoll.c"
...
"epx"
# 420 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/acl/lib_fiber/c/src/hook/epoll.c", 420, __extension__ __PRETTY_FUNCTION__); }))
# 420 "/acl/lib_fiber/c/src/hook/epoll.c"
           ;
 
# 421 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 421 "/acl/lib_fiber/c/src/hook/epoll.c"
...
# 421 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/acl/lib_fiber/c/src/hook/epoll.c", 421, __extension__ __PRETTY_FUNCTION__); }))
# 421 "/acl/lib_fiber/c/src/hook/epoll.c"
                               ;

 ee = epx->ee;
 
# 424 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 424 "/acl/lib_fiber/c/src/hook/epoll.c"
ee
# 424 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 424 "/acl/lib_fiber/c/src/hook/epoll.c"
...
"ee"
# 424 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/acl/lib_fiber/c/src/hook/epoll.c", 424, __extension__ __PRETTY_FUNCTION__); }))
# 424 "/acl/lib_fiber/c/src/hook/epoll.c"
          ;

 ep = ee->epoll;
 
# 427 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 427 "/acl/lib_fiber/c/src/hook/epoll.c"
ep
# 427 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 427 "/acl/lib_fiber/c/src/hook/epoll.c"
...
"ep"
# 427 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/acl/lib_fiber/c/src/hook/epoll.c", 427, __extension__ __PRETTY_FUNCTION__); }))
# 427 "/acl/lib_fiber/c/src/hook/epoll.c"
          ;
 ...
 ee->events[ee->nready].events |= 
# 433 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                                 EPOLLOUT
# 433 "/acl/lib_fiber/c/src/hook/epoll.c"
                                         ;
 memcpy(&ee->events[ee->nready].data, &ep->fds[epx->fd]->data,
  sizeof(ep->fds[epx->fd]->data));
 ...
 if (!(ee->events[ee->nready].events & 
# 442 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                                      EPOLLIN
# 442 "/acl/lib_fiber/c/src/hook/epoll.c"
                                             )) {
  ee->nready++;
 }
 ...
 struct epoll_event *event, int fd, int op)
{
 ...
 if (ep->fds[fd] == 
# 454 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                   ((void *)0)
# 454 "/acl/lib_fiber/c/src/hook/epoll.c"
                       ) {
 ...
 ep->fds[fd]->fd = fd;
 ep->fds[fd]->op = op;
 ep->fds[fd]->mask = (unsigned) (0);
 ep->fds[fd]->rmask = (unsigned) (0);
 ep->fds[fd]->ee = ee;

 memcpy(&ep->fds[fd]->data, &event->data, sizeof(event->data));

 if (event->events & 
# 466 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                    EPOLLIN
# 466 "/acl/lib_fiber/c/src/hook/epoll.c"
                           ) {
 ...
 if (event->events & 
# 475 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                    EPOLLOUT
# 475 "/acl/lib_fiber/c/src/hook/epoll.c"
                            ) {
...
static void epoll_ctl_del(EVENT *ev, EPOLL_EVENT *ee, int fd)
{
 ...
 ep->fds[fd]->rmask = (unsigned) (0);
 ep->fds[fd]->fe->epx = 
# 503 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                       ((void *)0)
# 503 "/acl/lib_fiber/c/src/hook/epoll.c"
                           ;
 ep->fds[fd]->fe = 
# 504 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                       ((void *)0)
# 504 "/acl/lib_fiber/c/src/hook/epoll.c"
                           ;
 memset(&ep->fds[fd]->data, 0, sizeof(ep->fds[fd]->data));

 mem_free(ep->fds[fd]);
 ep->fds[fd] = 
# 508 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
              ((void *)0)
# 508 "/acl/lib_fiber/c/src/hook/epoll.c"
                  ;
}
...
int epoll_ctl(int epfd, int op, int fd, struct epoll_event *event)
{
 ...
 if (sys_epoll_ctl == 
# 516 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                     ((void *)0)
# 516 "/acl/lib_fiber/c/src/hook/epoll.c"
                         ) {
  hook_once();
 }
 ...
 if (ee == 
# 525 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
          ((void *)0)
# 525 "/acl/lib_fiber/c/src/hook/epoll.c"
              ) {
  msg_error("%s(%d), %s: not exist epfd=%d",
   "/acl/lib_fiber/c/src/hook/epoll.c", 527, __FUNCTION__, epfd);
  return -1;
 }

 
# 531 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
((void) sizeof ((
# 531 "/acl/lib_fiber/c/src/hook/epoll.c"
ee->epoll
# 531 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 531 "/acl/lib_fiber/c/src/hook/epoll.c"
...
"ee->epoll"
# 531 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
, "/acl/lib_fiber/c/src/hook/epoll.c", 531, __extension__ __PRETTY_FUNCTION__); }))
# 531 "/acl/lib_fiber/c/src/hook/epoll.c"
                 ;
 ...
 if (op == 
# 535 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
          1 
# 535 "/acl/lib_fiber/c/src/hook/epoll.c"
                        || op == 
# 535 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                                 3
# 535 "/acl/lib_fiber/c/src/hook/epoll.c"
...
# 537 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                 2
# 537 "/acl/lib_fiber/c/src/hook/epoll.c"
                              ) {
  msg_error("%s(%d), %s: invalid op %d, fd %d",
   "/acl/lib_fiber/c/src/hook/epoll.c", 539, __FUNCTION__, op, fd);
  return -1;
 } else if (ee->epoll->fds[fd] != 
# 541 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                                 ((void *)0)
# 541 "/acl/lib_fiber/c/src/hook/epoll.c"
                                     ) {
  epoll_ctl_del(ev, ee, fd);
 } else {
  msg_error("%s(%d), %s: invalid fd=%d",
   "/acl/lib_fiber/c/src/hook/epoll.c", 545, __FUNCTION__, fd);
  return -1;
 }
...
int epoll_wait(int epfd, struct epoll_event *events, int maxevents, int timeout)
{
 ...
 if (sys_epoll_wait == 
# 584 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                      ((void *)0)
# 584 "/acl/lib_fiber/c/src/hook/epoll.c"
                          ) {
  hook_once();
 }
 ...
 ev = fiber_io_event();
 if (ev == 
# 594 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
          ((void *)0)
# 594 "/acl/lib_fiber/c/src/hook/epoll.c"
              ) {
  msg_error("%s(%d), %s: EVENT NULL",
   "/acl/lib_fiber/c/src/hook/epoll.c", 596, __FUNCTION__);
  return -1;
 }

 ee = epoll_event_find(epfd, 0);
 if (ee == 
# 601 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
          ((void *)0)
# 601 "/acl/lib_fiber/c/src/hook/epoll.c"
              ) {
  msg_error("%s(%d), %s: not exist epfd %d",
   "/acl/lib_fiber/c/src/hook/epoll.c", 603, __FUNCTION__, epfd);
  return -1;
 }
 ...
 while (1) {
  ...
  if (acl_fiber_killed(ee->fiber)) {
   ...
   msg_info("%s(%d), %s: fiber-%u was killed",
    "/acl/lib_fiber/c/src/hook/epoll.c", 638, __FUNCTION__,
  ...
  if (ee->expire > 0 && now >= ee->expire) {
   acl_fiber_set_error(
# 653 "/acl/lib_fiber/c/src/hook/epoll.c" 3 4
                      62
# 653 "/acl/lib_fiber/c/src/hook/epoll.c"
                                 );
   break;
  }
 }
