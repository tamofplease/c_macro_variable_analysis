# 0 "/acl/lib_fiber/c/src/hook/socket.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/hook/socket.c"
...
# 2 "/acl/lib_fiber/c/src/hook/socket.c" 2
...
# 3 "/acl/lib_fiber/c/src/hook/socket.c" 2
...
# 5 "/acl/lib_fiber/c/src/hook/socket.c" 2
...
# 6 "/acl/lib_fiber/c/src/hook/socket.c" 2
...
void hook_once(void);
# 7 "/acl/lib_fiber/c/src/hook/socket.c" 2
...
socket_t acl_fiber_socket(int domain, int type, int protocol)
{
 ...
 if (sys_socket == 
# 12 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                  ((void *)0)
# 12 "/acl/lib_fiber/c/src/hook/socket.c"
                      ) {
  hook_once();
  if (sys_socket == 
# 14 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                   ((void *)0)
# 14 "/acl/lib_fiber/c/src/hook/socket.c"
                       ) {
   return -1;
  }
 }
...
# 35 "/acl/lib_fiber/c/src/hook/socket.c"
 if (sockfd == -1) {
...
{
 if (sys_listen == 
# 45 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                  ((void *)0)
# 45 "/acl/lib_fiber/c/src/hook/socket.c"
                      ) {
  hook_once();
  if (sys_listen == 
# 47 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                   ((void *)0)
# 47 "/acl/lib_fiber/c/src/hook/socket.c"
                       ) {
...
# 103 "/acl/lib_fiber/c/src/hook/socket.c"
...
# 124 "/acl/lib_fiber/c/src/hook/socket.c"
 if (sys_accept == 
# 124 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                  ((void *)0)
# 124 "/acl/lib_fiber/c/src/hook/socket.c"
                      ) {
  hook_once();
  if (sys_accept == 
# 126 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                   ((void *)0)
# 126 "/acl/lib_fiber/c/src/hook/socket.c"
                       ) {
...
# 153 "/acl/lib_fiber/c/src/hook/socket.c"
 non_blocking(sockfd, 1);
 ...
 if (!((err) == 
# 169 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
     11
# 169 "/acl/lib_fiber/c/src/hook/socket.c"
     )) {
  return -1;
 }
 ...
 while (1) {
  ...
  if (acl_fiber_killed(fe->fiber_r)) {
   msg_info("%s(%d), %s: fiber-%u was killed", "/acl/lib_fiber/c/src/hook/socket.c",
    185, __FUNCTION__, acl_fiber_id(fe->fiber_r));
   return -1;
  }
# 213 "/acl/lib_fiber/c/src/hook/socket.c"
  clifd = (*sys_accept)(sockfd, addr, addrlen);
  ...
  if (!((err) == 
# 225 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
      11
# 225 "/acl/lib_fiber/c/src/hook/socket.c"
      )) {
   return -1;
  }
 }
# 277 "/acl/lib_fiber/c/src/hook/socket.c"
}

extern int event_iocp_connect(EVENT* ev, FILE_EVENT* fe);
# 303 "/acl/lib_fiber/c/src/hook/socket.c"
 ...
 socklen_t addrlen)
{
 ...
 if (sys_connect == 
# 311 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                   ((void *)0)
# 311 "/acl/lib_fiber/c/src/hook/socket.c"
                       ) {
  hook_once();
  if (sys_connect == 
# 313 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                    ((void *)0)
# 313 "/acl/lib_fiber/c/src/hook/socket.c"
                        ) {
...
# 340 "/acl/lib_fiber/c/src/hook/socket.c"
 nblock = is_non_blocking(sockfd);
 if (!nblock) {
  non_blocking(sockfd, 1);
 }
# 364 "/acl/lib_fiber/c/src/hook/socket.c"
 ...
 if (err != 
# 376 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
           115 
# 376 "/acl/lib_fiber/c/src/hook/socket.c"
                             && !((err) == 
# 376 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                                 11
# 376 "/acl/lib_fiber/c/src/hook/socket.c"
  ...
  if (err == 
# 377 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
            111
# 377 "/acl/lib_fiber/c/src/hook/socket.c"
                              ) {
   msg_error("%s(%d), %s: connect ECONNREFUSED",
    "/acl/lib_fiber/c/src/hook/socket.c", 379, __FUNCTION__);
  } else if (err == 
# 380 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                   104
# 380 "/acl/lib_fiber/c/src/hook/socket.c"
                                   ) {
   msg_error("%s(%d), %s: connect ECONNRESET",
    "/acl/lib_fiber/c/src/hook/socket.c", 382, __FUNCTION__);
  } else if (err == 
# 383 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                   100
# 383 "/acl/lib_fiber/c/src/hook/socket.c"
                                 ) {
   msg_error("%s(%d), %s: connect ENETDOWN",
    "/acl/lib_fiber/c/src/hook/socket.c", 385, __FUNCTION__);
  } else if (err == 
# 386 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                   101
# 386 "/acl/lib_fiber/c/src/hook/socket.c"
                                    ) {
   msg_error("%s(%d), %s: connect ENETUNREACH",
    "/acl/lib_fiber/c/src/hook/socket.c", 388, __FUNCTION__);

  } else if (err == 
# 390 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                   112
# 390 "/acl/lib_fiber/c/src/hook/socket.c"
                                  ) {
   msg_error("%s(%d), %s: connect EHOSTDOWN",
    "/acl/lib_fiber/c/src/hook/socket.c", 392, __FUNCTION__);

  } else if (err == 
# 394 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                   113
# 394 "/acl/lib_fiber/c/src/hook/socket.c"
                                     ) {
   msg_error("%s(%d), %s: connect EHOSTUNREACH",
    "/acl/lib_fiber/c/src/hook/socket.c", 396, __FUNCTION__);
# 405 "/acl/lib_fiber/c/src/hook/socket.c"
  } else {
   msg_error("%s(%d), %s: connect errno=%d, %s",
    "/acl/lib_fiber/c/src/hook/socket.c", 407, __FUNCTION__, err,
    last_serror());
  }
 ...
 if (acl_fiber_killed(fe->fiber_w)) {
  msg_info("%s(%d), %s: fiber-%u was killed, %s, spend %ld",
   "/acl/lib_fiber/c/src/hook/socket.c", 433, __FUNCTION__,
...
# 440 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                         1
# 440 "/acl/lib_fiber/c/src/hook/socket.c"
                                   , 
# 440 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                                     4
# 440 "/acl/lib_fiber/c/src/hook/socket.c"
 ...
 if (ret == 0 && err == 0) {
  ...
  msg_error("%s(%d), %s: getpeername error %s, fd: %d, spend %ld",
   "/acl/lib_fiber/c/src/hook/socket.c", 452, __FUNCTION__, last_serror(),
...
static void fiber_timeout(ACL_FIBER *fiber __attribute__((__unused__)), void *ctx)
{
 ...
 if (fe == 
# 499 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
          ((void *)0) 
# 499 "/acl/lib_fiber/c/src/hook/socket.c"
               || tc->fiber != fe->fiber_r
 ...
 if (fe->fiber_r->status == FIBER_STATUS_WAIT_READ
  ...
  tc->fiber->errnum = 
# 511 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                     11
# 511 "/acl/lib_fiber/c/src/hook/socket.c"
                                 ;
  acl_fiber_signal(tc->fiber, 
# 512 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                             2
# 512 "/acl/lib_fiber/c/src/hook/socket.c"
                                   );
 }
 ...
 const void *optval, socklen_t optlen)
{
 ...
 if (sys_setsockopt == 
# 525 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                      ((void *)0)
# 525 "/acl/lib_fiber/c/src/hook/socket.c"
                          ) {
  hook_once();
 }

 if (!var_hook_sys_api || (optname != 
# 529 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                                     20
    
# 530 "/acl/lib_fiber/c/src/hook/socket.c"
   && optname != 
# 530 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                 21
# 530 "/acl/lib_fiber/c/src/hook/socket.c"
                            )) {
 ...
 if (sys_setsockopt == 
# 535 "/acl/lib_fiber/c/src/hook/socket.c" 3 4
                      ((void *)0)
# 535 "/acl/lib_fiber/c/src/hook/socket.c"
                          ) {
