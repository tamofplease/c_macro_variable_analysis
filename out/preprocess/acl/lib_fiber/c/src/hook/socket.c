# 1 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 2
...
# 5 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 2
...
# 6 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 2
...
void hook_once(void);
# 7 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 2
...
socket_t acl_fiber_socket(int domain, int type, int protocol)
{
 ...
 if (sys_socket == 
# 12 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                  ((void *)0)
# 12 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
                      ) {
  hook_once();
  if (sys_socket == 
# 14 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                   ((void *)0)
# 14 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
                       ) {
   return -1;
  }
 }
...
# 35 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
 if (sockfd == -1) {
...
{
 if (sys_listen == 
# 45 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                  ((void *)0)
# 45 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
                      ) {
  hook_once();
  if (sys_listen == 
# 47 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                   ((void *)0)
# 47 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
                       ) {
...
# 103 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
socket_t acl_fiber_accept(socket_t sockfd, struct sockaddr *addr,
 socklen_t *addrlen)
{
 FILE_EVENT *fe;
 socket_t clifd;
...
# 124 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
 if (sys_accept == 
# 124 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                  ((void *)0)
# 124 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
                      ) {
  hook_once();
  if (sys_accept == 
# 126 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                   ((void *)0)
# 126 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
                       ) {
 ...
 if (!var_hook_sys_api) {
  ...
  return sys_accept ?
   (*sys_accept)(sockfd, addr, addrlen) : -1;

 }
# 153 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
 non_blocking(sockfd, 1);
 ...
 if (!((err) == 
# 169 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
     11
# 169 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
     )) {
  return -1;
 }
 ...
 while (1) {
  if (fiber_wait_read(fe) < 0) {
   msg_error("%s(%d): fiber_wait_read error=%s, fd=%d",
    __FUNCTION__, 178, last_serror(),
    (int) sockfd);
   return -1;
  }

  if (acl_fiber_killed(fe->fiber_r)) {
   msg_info("%s(%d), %s: fiber-%u was killed", "/workspace/acl/lib_fiber/c/src/hook/socket.c",
    185, __FUNCTION__, acl_fiber_id(fe->fiber_r));
   return -1;
  }
# 213 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
  clifd = (*sys_accept)(sockfd, addr, addrlen);
  ...
  if (!((err) == 
# 225 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
      11
# 225 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
      )) {
   return -1;
  }
 }
# 277 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
}

extern int event_iocp_connect(EVENT* ev, FILE_EVENT* fe);
# 303 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
int acl_fiber_connect(socket_t sockfd, const struct sockaddr *addr,
 socklen_t addrlen)
{
 int err, ret, nblock;
 socklen_t len;
 ...
 if (sys_connect == 
# 311 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                   ((void *)0)
# 311 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
                       ) {
  hook_once();
  if (sys_connect == 
# 313 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                    ((void *)0)
# 313 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
                        ) {
 ...
 ((fe)->status |= (unsigned) (1 << 4));

 ((fe)->status |= (unsigned) (1 << 0));
# 340 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
 nblock = is_non_blocking(sockfd);
 if (!nblock) {
  non_blocking(sockfd, 1);
 }
# 364 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
 ...
 if (err != 
# 376 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
           115 
# 376 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
                             && !((err) == 
# 376 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                                 11
# 376 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
  ...
  if (err == 
# 377 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
            111
# 377 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
                              ) {
   msg_error("%s(%d), %s: connect ECONNREFUSED",
    "/workspace/acl/lib_fiber/c/src/hook/socket.c", 379, __FUNCTION__);
  } else if (err == 
# 380 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                   104
# 380 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
                                   ) {
   msg_error("%s(%d), %s: connect ECONNRESET",
    "/workspace/acl/lib_fiber/c/src/hook/socket.c", 382, __FUNCTION__);
  } else if (err == 
# 383 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                   100
# 383 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
                                 ) {
   msg_error("%s(%d), %s: connect ENETDOWN",
    "/workspace/acl/lib_fiber/c/src/hook/socket.c", 385, __FUNCTION__);
  } else if (err == 
# 386 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                   101
# 386 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
                                    ) {
   msg_error("%s(%d), %s: connect ENETUNREACH",
    "/workspace/acl/lib_fiber/c/src/hook/socket.c", 388, __FUNCTION__);

  } else if (err == 
# 390 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                   112
# 390 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
                                  ) {
   msg_error("%s(%d), %s: connect EHOSTDOWN",
    "/workspace/acl/lib_fiber/c/src/hook/socket.c", 392, __FUNCTION__);

  } else if (err == 
# 394 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                   113
# 394 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
                                     ) {
   msg_error("%s(%d), %s: connect EHOSTUNREACH",
    "/workspace/acl/lib_fiber/c/src/hook/socket.c", 396, __FUNCTION__);
# 405 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
  } else {
   msg_error("%s(%d), %s: connect errno=%d, %s",
    "/workspace/acl/lib_fiber/c/src/hook/socket.c", 407, __FUNCTION__, err,
    last_serror());
  }
 ...
 if (fiber_wait_write(fe) < 0) {
  ...
  msg_error("%s(%d): fiber_wait_write error=%s, fd=%d, cost=%ld",
   __FUNCTION__, 423, last_serror(), (int) sockfd,
   (long)(end - begin));
  return -1;
 }
 time(&end);
 ...
 if (acl_fiber_killed(fe->fiber_w)) {
  msg_info("%s(%d), %s: fiber-%u was killed, %s, spend %ld",
   "/workspace/acl/lib_fiber/c/src/hook/socket.c", 433, __FUNCTION__,
 ...
 len = sizeof(err);
 ret = getsockopt(sockfd, 
# 440 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                         1
# 440 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
                                   , 
# 440 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                                     4
# 440 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
 ...
 if (ret == 0 && err == 0) {
  ...
  msg_error("%s(%d), %s: getpeername error %s, fd: %d, spend %ld",
   "/workspace/acl/lib_fiber/c/src/hook/socket.c", 452, __FUNCTION__, last_serror(),
 ...
 msg_error("%s(%d): getsockopt error: %s, ret: %d, err: %d, spend %ld",
  __FUNCTION__, 459, last_serror(), ret, err,
  (long) (end - begin));
...
static void fiber_timeout(ACL_FIBER *fiber __attribute__((__unused__)), void *ctx)
{
 ...
 if (fe == 
# 499 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
          ((void *)0) 
# 499 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
               || tc->fiber != fe->fiber_r
 ...
 if (fe->fiber_r->status == FIBER_STATUS_WAIT_READ
  ...
  tc->fiber->errnum = 
# 511 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                     11
# 511 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
                                 ;
  acl_fiber_signal(tc->fiber, 
# 512 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                             2
# 512 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
                                   );
 }
 ...
 const void *optval, socklen_t optlen)
{
 ...
 if (sys_setsockopt == 
# 525 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                      ((void *)0)
# 525 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
                          ) {
  hook_once();
 }

 if (!var_hook_sys_api || (optname != 
# 529 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                                     20
    
# 530 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
   && optname != 
# 530 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                 21
# 530 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
                            )) {
 ...
 if (sys_setsockopt == 
# 535 "/workspace/acl/lib_fiber/c/src/hook/socket.c" 3 4
                      ((void *)0)
# 535 "/workspace/acl/lib_fiber/c/src/hook/socket.c"
                          ) {
