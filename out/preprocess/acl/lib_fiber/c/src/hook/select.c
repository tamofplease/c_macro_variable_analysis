# 1 "/workspace/acl/lib_fiber/c/src/hook/select.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/hook/select.c" 2
...
# 6 "/workspace/acl/lib_fiber/c/src/hook/select.c" 2
...
# 8 "/workspace/acl/lib_fiber/c/src/hook/select.c" 2
...
# 9 "/workspace/acl/lib_fiber/c/src/hook/select.c" 2
...
void hook_once(void);
# 10 "/workspace/acl/lib_fiber/c/src/hook/select.c" 2
# 85 "/workspace/acl/lib_fiber/c/src/hook/select.c"
static struct pollfd *pfds_create(int *nfds, fd_set *readfds,
 fd_set *writefds, fd_set *exceptfds __attribute__ ((__unused__)))
{
 int fd;
 struct pollfd *fds;
 ...
 for (fd = 0; fd < *nfds; fd++) {
  if (readfds && 
# 94 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
                ((((
# 94 "/workspace/acl/lib_fiber/c/src/hook/select.c"
                readfds
# 94 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
...
# 94 "/workspace/acl/lib_fiber/c/src/hook/select.c"
   ...
   fds[fd].fd = fd;
   fds[fd].events |= 
# 96 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
                    0x001
# 96 "/workspace/acl/lib_fiber/c/src/hook/select.c"
                          ;
  }

  if (writefds && 
# 99 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
                 ((((
# 99 "/workspace/acl/lib_fiber/c/src/hook/select.c"
                 writefds
# 99 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
                 )->fds_bits)[__extension__ ({ long int __d = (
# 99 "/workspace/acl/lib_fiber/c/src/hook/select.c"
...
# 99 "/workspace/acl/lib_fiber/c/src/hook/select.c"
   ...
   fds[fd].fd = fd;
   fds[fd].events |= 
# 101 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
                    0x004
# 101 "/workspace/acl/lib_fiber/c/src/hook/select.c"
                           ;
  }
...

{
 ...
 if (sys_select == 
# 128 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
                  ((void *)0)
# 128 "/workspace/acl/lib_fiber/c/src/hook/select.c"
                      ) {
  hook_once();
 }
 ...
 if (fds == 
# 137 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
           ((void *)0)
# 137 "/workspace/acl/lib_fiber/c/src/hook/select.c"
               ) {
  fiber_save_errno(
# 138 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
                  22
# 138 "/workspace/acl/lib_fiber/c/src/hook/select.c"
                              );
  return -1;
 }

 if (timeout != 
# 142 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
               ((void *)0)
# 142 "/workspace/acl/lib_fiber/c/src/hook/select.c"
                   )
...
# 152 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
 do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((
# 152 "/workspace/acl/lib_fiber/c/src/hook/select.c"
 writefds
# 152 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
 )->fds_bits)[0]) : "memory"); } while (0)
# 152 "/workspace/acl/lib_fiber/c/src/hook/select.c"
...
# 154 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
 do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((
# 154 "/workspace/acl/lib_fiber/c/src/hook/select.c"
 exceptfds
# 154 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
 )->fds_bits)[0]) : "memory"); } while (0)
# 154 "/workspace/acl/lib_fiber/c/src/hook/select.c"
...
# 161 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
                                  0x001
# 161 "/workspace/acl/lib_fiber/c/src/hook/select.c"
                                        )) {
   
# 162 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
  ((void) (((
# 162 "/workspace/acl/lib_fiber/c/src/hook/select.c"
  readfds
# 162 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
  )->fds_bits)[__extension__ ({ long int __d = (
# 162 "/workspace/acl/lib_fiber/c/src/hook/select.c"
...
# 166 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
                                   0x004
# 166 "/workspace/acl/lib_fiber/c/src/hook/select.c"
                                          )) {
   
# 167 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
  ((void) (((
# 167 "/workspace/acl/lib_fiber/c/src/hook/select.c"
  writefds
# 167 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
  )->fds_bits)[__extension__ ({ long int __d = (
# 167 "/workspace/acl/lib_fiber/c/src/hook/select.c"
...
# 167 "/workspace/acl/lib_fiber/c/src/hook/select.c"
  ...
  if (exceptfds && (fds[i].revents & (
# 171 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
                                     0x008 
# 171 "/workspace/acl/lib_fiber/c/src/hook/select.c"
                                             | 
# 171 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
                                               0x010
# 171 "/workspace/acl/lib_fiber/c/src/hook/select.c"
...
# 172 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
  ((void) (((
# 172 "/workspace/acl/lib_fiber/c/src/hook/select.c"
  exceptfds
# 172 "/workspace/acl/lib_fiber/c/src/hook/select.c" 3 4
  )->fds_bits)[__extension__ ({ long int __d = (
# 172 "/workspace/acl/lib_fiber/c/src/hook/select.c"
