# 0 "/acl/lib_fiber/c/src/hook/select.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/hook/select.c"
...
# 2 "/acl/lib_fiber/c/src/hook/select.c" 2
...
# 6 "/acl/lib_fiber/c/src/hook/select.c" 2
...
# 8 "/acl/lib_fiber/c/src/hook/select.c" 2
...
# 9 "/acl/lib_fiber/c/src/hook/select.c" 2
...
void hook_once(void);
# 10 "/acl/lib_fiber/c/src/hook/select.c" 2
# 85 "/acl/lib_fiber/c/src/hook/select.c"
 ...
 fd_set *writefds, fd_set *exceptfds __attribute__ ((__unused__)))
{
 ...
 for (fd = 0; fd < *nfds; fd++) {
  if (readfds && 
# 94 "/acl/lib_fiber/c/src/hook/select.c" 3 4
                ((((
# 94 "/acl/lib_fiber/c/src/hook/select.c"
                readfds
# 94 "/acl/lib_fiber/c/src/hook/select.c" 3 4
...
# 94 "/acl/lib_fiber/c/src/hook/select.c"
   ...
   fds[fd].fd = fd;
   fds[fd].events |= 
# 96 "/acl/lib_fiber/c/src/hook/select.c" 3 4
                    0x001
# 96 "/acl/lib_fiber/c/src/hook/select.c"
                          ;
  }

  if (writefds && 
# 99 "/acl/lib_fiber/c/src/hook/select.c" 3 4
                 ((((
# 99 "/acl/lib_fiber/c/src/hook/select.c"
                 writefds
# 99 "/acl/lib_fiber/c/src/hook/select.c" 3 4
                 )->fds_bits)[__extension__ ({ long int __d = (
# 99 "/acl/lib_fiber/c/src/hook/select.c"
...
# 99 "/acl/lib_fiber/c/src/hook/select.c"
   ...
   fds[fd].fd = fd;
   fds[fd].events |= 
# 101 "/acl/lib_fiber/c/src/hook/select.c" 3 4
                    0x004
# 101 "/acl/lib_fiber/c/src/hook/select.c"
                           ;
  }
...

{
 ...
 if (sys_select == 
# 128 "/acl/lib_fiber/c/src/hook/select.c" 3 4
                  ((void *)0)
# 128 "/acl/lib_fiber/c/src/hook/select.c"
                      ) {
  hook_once();
 }
 ...
 if (fds == 
# 137 "/acl/lib_fiber/c/src/hook/select.c" 3 4
           ((void *)0)
# 137 "/acl/lib_fiber/c/src/hook/select.c"
               ) {
  fiber_save_errno(
# 138 "/acl/lib_fiber/c/src/hook/select.c" 3 4
                  22
# 138 "/acl/lib_fiber/c/src/hook/select.c"
                              );
  return -1;
 }

 if (timeout != 
# 142 "/acl/lib_fiber/c/src/hook/select.c" 3 4
               ((void *)0)
# 142 "/acl/lib_fiber/c/src/hook/select.c"
                   )
...
# 150 "/acl/lib_fiber/c/src/hook/select.c" 3 4
 do { unsigned int __i; fd_set *__arr = (
# 150 "/acl/lib_fiber/c/src/hook/select.c"
 readfds
# 150 "/acl/lib_fiber/c/src/hook/select.c" 3 4
...
# 152 "/acl/lib_fiber/c/src/hook/select.c" 3 4
 do { unsigned int __i; fd_set *__arr = (
# 152 "/acl/lib_fiber/c/src/hook/select.c"
 writefds
# 152 "/acl/lib_fiber/c/src/hook/select.c" 3 4
 ); for (__i = 0; __i < sizeof (fd_set) / sizeof (__fd_mask); ++__i) ((__arr)->fds_bits)[__i] = 0; } while (0)
# 152 "/acl/lib_fiber/c/src/hook/select.c"
...
# 154 "/acl/lib_fiber/c/src/hook/select.c" 3 4
 do { unsigned int __i; fd_set *__arr = (
# 154 "/acl/lib_fiber/c/src/hook/select.c"
 exceptfds
# 154 "/acl/lib_fiber/c/src/hook/select.c" 3 4
 ); for (__i = 0; __i < sizeof (fd_set) / sizeof (__fd_mask); ++__i) ((__arr)->fds_bits)[__i] = 0; } while (0)
# 154 "/acl/lib_fiber/c/src/hook/select.c"
...
# 161 "/acl/lib_fiber/c/src/hook/select.c" 3 4
                                  0x001
# 161 "/acl/lib_fiber/c/src/hook/select.c"
                                        )) {
   
# 162 "/acl/lib_fiber/c/src/hook/select.c" 3 4
  ((void) (((
# 162 "/acl/lib_fiber/c/src/hook/select.c"
  readfds
# 162 "/acl/lib_fiber/c/src/hook/select.c" 3 4
  )->fds_bits)[__extension__ ({ long int __d = (
# 162 "/acl/lib_fiber/c/src/hook/select.c"
...
# 166 "/acl/lib_fiber/c/src/hook/select.c" 3 4
                                   0x004
# 166 "/acl/lib_fiber/c/src/hook/select.c"
                                          )) {
   
# 167 "/acl/lib_fiber/c/src/hook/select.c" 3 4
  ((void) (((
# 167 "/acl/lib_fiber/c/src/hook/select.c"
  writefds
# 167 "/acl/lib_fiber/c/src/hook/select.c" 3 4
  )->fds_bits)[__extension__ ({ long int __d = (
# 167 "/acl/lib_fiber/c/src/hook/select.c"
...
# 171 "/acl/lib_fiber/c/src/hook/select.c" 3 4
                                     0x008 
# 171 "/acl/lib_fiber/c/src/hook/select.c"
                                             | 
# 171 "/acl/lib_fiber/c/src/hook/select.c" 3 4
                                               0x010
# 171 "/acl/lib_fiber/c/src/hook/select.c"
...
# 172 "/acl/lib_fiber/c/src/hook/select.c" 3 4
  ((void) (((
# 172 "/acl/lib_fiber/c/src/hook/select.c"
  exceptfds
# 172 "/acl/lib_fiber/c/src/hook/select.c" 3 4
  )->fds_bits)[__extension__ ({ long int __d = (
# 172 "/acl/lib_fiber/c/src/hook/select.c"
