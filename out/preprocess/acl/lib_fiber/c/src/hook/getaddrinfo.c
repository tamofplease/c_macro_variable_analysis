# 0 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
...
# 2 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 2
# 1 "/acl/lib_fiber/c/src/dns/sane_inet.h" 1
# 15 "/acl/lib_fiber/c/src/dns/sane_inet.h"
const char *inet_ntop4(const unsigned char *src, char *dst, size_t size);
# 24 "/acl/lib_fiber/c/src/dns/sane_inet.h"
...
# 3 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 2
# 1 "/acl/lib_fiber/c/src/dns/resolver.h" 1
...
# 9 "/acl/lib_fiber/c/src/common/argv.h" 2
...
# 5 "/acl/lib_fiber/c/src/dns/resolver.h" 2
...
# 4 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 2
...
# 13 "/acl/lib_fiber/c/src/common/array.h"
...
# 5 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 2
...
# 6 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 2
...
void hook_once(void);
# 7 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 2
 ...
 int iptype, int socktype, int flags)
{
 ...
 if (iptype == 
# 18 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
              2
# 18 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                     ) {
  sa.in.sin_family = 
# 19 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                         2
# 19 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                                ;
  sa.in.sin_addr.s_addr = inet_addr(ip);
  sa.in.sin_port = 
# 21 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                         __bswap_16 (
# 21 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                         port
# 21 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                         )
# 21 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
...
# 23 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                     10
# 23 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                             ) {
  char buf[256], *ptr;
  struct sockaddr_in6 *in6;
  ...
  sa.in6.sin6_family = 
# 41 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                      10
# 41 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                              ;
  sa.in6.sin6_port = 
# 42 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                      __bswap_16 (
# 42 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                      port
# 42 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                      )
# 42 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
  ...
  if (ptr && *ptr) {
   if (!(in6->sin6_scope_id = if_nametoindex(ptr))) {
    return 
# 46 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
          ((void *)0)
# 46 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
              ;
   }
  }
  if (inet_pton(
# 49 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
               10
# 49 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                       , buf, &sa.in6.sin6_addr) <= 0) {
   return 
# 50 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
         ((void *)0)
# 50 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
             ;
  }
  ...
  return 
# 55 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
        ((void *)0)
# 55 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
            ;
 }
 ...
 const struct addrinfo *hints)
{
 ...
 if (is_ipv4(node)) {
  iptype = 
# 73 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
          2
# 73 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                 ;
  ipaddr = node;

 } else if (is_ipv6(node)) {
  iptype = 
# 77 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
          10
# 77 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                  ;
  ipaddr = node;

 } else if ((host = find_from_localhost(node)) == 
# 80 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                                                 ((void *)0)
# 80 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                                                     ) {
  return 
# 81 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
        ((void *)0)
# 81 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
            ;

 } else if (hints->ai_family == 
# 83 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                               10 
# 83 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                                        && host->ipv6[0]) {
  ...
  iptype = 
# 88 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
          2
# 88 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                 ;
  ipaddr = host->ipv4;

 } else if (host->ipv6[0]) {
  iptype = 
# 92 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
          10
# 92 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                  ;
  ipaddr = host->ipv6;

 } else {
  return 
# 96 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
        ((void *)0)
# 96 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
            ;
 }
...
# 101 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                                              SOCK_STREAM
# 101 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                                                         ;
  struct addrinfo *ai = create_addrinfo(ipaddr, port, iptype,
        socktype, hints ? hints->ai_flags : 0);
  if (ai) {
   ai->ai_next = 
# 105 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                ((void *)0)
# 105 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                    ;
   return ai;
  }
 }
 return 
# 109 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
       ((void *)0)
# 109 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
           ;
}
 ...
 const struct addrinfo* hints, struct addrinfo **res)
{
 ...
 if (sys_getaddrinfo == 
# 117 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                       ((void *)0)
# 117 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                           ) {
  hook_once();
 }
# 128 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
 if (!var_hook_sys_api) {
  return sys_getaddrinfo ? (*sys_getaddrinfo)
   (node, service, hints, res) : 
# 130 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                                -5
# 130 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                                          ;
 }
 ...
 if (hints == 
# 135 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
             ((void *)0)
# 135 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                 ) {
  memset(&hints_tmp, 0, sizeof(hints_tmp));
  hints_tmp.ai_family = 
# 137 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                         0
# 137 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                                  ;
  hints_tmp.ai_socktype = 
# 138 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                         SOCK_STREAM
# 138 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                                    ;
# 149 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
  hints_tmp.ai_flags = 
# 149 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                         0x0008 
# 149 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                                     | 
# 149 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
 ...
 *res = check_local(node, service, hints);
 if (*res != 
# 155 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
            ((void *)0)
# 155 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                ) {
  return 0;
 }
 ...
 *res = resolver_getaddrinfo(node, service, hints);
 if (*res == 
# 160 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
            ((void *)0)
# 160 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                ) {
  return 
# 161 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
        -5
# 161 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                  ;
 }
...
{
 if (sys_freeaddrinfo == 
# 169 "/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                        ((void *)0)
# 169 "/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                            ) {
  hook_once();
 }
