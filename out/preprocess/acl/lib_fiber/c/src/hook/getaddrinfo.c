# 1 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 2
# 1 "/workspace/acl/lib_fiber/c/src/dns/sane_inet.h" 1
# 15 "/workspace/acl/lib_fiber/c/src/dns/sane_inet.h"
const char *inet_ntop4(const unsigned char *src, char *dst, size_t size);
# 24 "/workspace/acl/lib_fiber/c/src/dns/sane_inet.h"
...
# 3 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 2
# 1 "/workspace/acl/lib_fiber/c/src/dns/resolver.h" 1
...
# 9 "/workspace/acl/lib_fiber/c/src/common/argv.h" 2
...
# 5 "/workspace/acl/lib_fiber/c/src/dns/resolver.h" 2
...
# 4 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 2
...
# 13 "/workspace/acl/lib_fiber/c/src/common/array.h"
...
# 5 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 2
...
# 6 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 2
...
void hook_once(void);
# 7 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 2
 ...
 int iptype, int socktype, int flags)
{
 ...
 if (iptype == 
# 18 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
              2
# 18 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                     ) {
  sa.in.sin_family = 
# 19 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                         2
# 19 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                                ;
  sa.in.sin_addr.s_addr = inet_addr(ip);
  sa.in.sin_port = 
# 21 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                         (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 21 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                         port
# 21 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
...
# 23 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                     10
# 23 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                             ) {
  char buf[256], *ptr;
  struct sockaddr_in6 *in6;

  do { if (sizeof(buf) > 0) { size_t _n = strlen(ip); _n = _n > (size_t ) sizeof(buf) - 1? (size_t) sizeof(buf) - 1 : _n; memcpy(buf, ip, _n); buf[_n] = 0; } } while (0);
  ...
  sa.in6.sin6_family = 
# 41 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                      10
# 41 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                              ;
  sa.in6.sin6_port = 
# 42 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                      (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 42 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                      port
# 42 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                      ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 42 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
  ...
  if (ptr && *ptr) {
   if (!(in6->sin6_scope_id = if_nametoindex(ptr))) {
    return 
# 46 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
          ((void *)0)
# 46 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
              ;
   }
  }
  if (inet_pton(
# 49 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
               10
# 49 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                       , buf, &sa.in6.sin6_addr) <= 0) {
   return 
# 50 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
         ((void *)0)
# 50 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
             ;
  }
  ...
  return 
# 55 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
        ((void *)0)
# 55 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
            ;
 }
 ...
 const struct addrinfo *hints)
{
 ...
 if (is_ipv4(node)) {
  iptype = 
# 73 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
          2
# 73 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                 ;
  ipaddr = node;

 } else if (is_ipv6(node)) {
  iptype = 
# 77 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
          10
# 77 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                  ;
  ipaddr = node;

 } else if ((host = find_from_localhost(node)) == 
# 80 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                                                 ((void *)0)
# 80 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                                                     ) {
  return 
# 81 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
        ((void *)0)
# 81 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
            ;

 } else if (hints->ai_family == 
# 83 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                               10 
# 83 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                                        && host->ipv6[0]) {
  ...
  iptype = 
# 88 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
          2
# 88 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                 ;
  ipaddr = host->ipv4;

 } else if (host->ipv6[0]) {
  iptype = 
# 92 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
          10
# 92 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                  ;
  ipaddr = host->ipv6;

 } else {
  return 
# 96 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
        ((void *)0)
# 96 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
            ;
 }

 if (ipaddr && *ipaddr) {
  int port = get_service_port(service);
  int socktype = hints ? hints->ai_socktype : 
# 101 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                                              SOCK_STREAM
# 101 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                                                         ;
  struct addrinfo *ai = create_addrinfo(ipaddr, port, iptype,
        socktype, hints ? hints->ai_flags : 0);
  if (ai) {
   ai->ai_next = 
# 105 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                ((void *)0)
# 105 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                    ;
   return ai;
  }
 }
 return 
# 109 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
       ((void *)0)
# 109 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
           ;
}
 ...
 const struct addrinfo* hints, struct addrinfo **res)
{
 ...
 if (sys_getaddrinfo == 
# 117 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                       ((void *)0)
# 117 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                           ) {
  hook_once();
 }
# 128 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
 if (!var_hook_sys_api) {
  return sys_getaddrinfo ? (*sys_getaddrinfo)
   (node, service, hints, res) : 
# 130 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                                -5
# 130 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                                          ;
 }
 ...
 if (hints == 
# 135 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
             ((void *)0)
# 135 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                 ) {
  memset(&hints_tmp, 0, sizeof(hints_tmp));
  hints_tmp.ai_family = 
# 137 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                         0
# 137 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                                  ;
  hints_tmp.ai_socktype = 
# 138 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                         SOCK_STREAM
# 138 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                                    ;
# 149 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
  hints_tmp.ai_flags = 
# 149 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                         0x0008 
# 149 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                                     | 
# 149 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
 ...
 *res = check_local(node, service, hints);
 if (*res != 
# 155 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
            ((void *)0)
# 155 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                ) {
  return 0;
 }
 ...
 *res = resolver_getaddrinfo(node, service, hints);
 if (*res == 
# 160 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
            ((void *)0)
# 160 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                ) {
  return 
# 161 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
        -5
# 161 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                  ;
 }
...
{
 if (sys_freeaddrinfo == 
# 169 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c" 3 4
                        ((void *)0)
# 169 "/workspace/acl/lib_fiber/c/src/hook/getaddrinfo.c"
                            ) {
  hook_once();
 }
