# 1 "/workspace/acl/lib_fiber/c/src/fiber.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/fiber.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/fiber.c" 2
...
# 34 "/workspace/acl/lib_fiber/c/src/common/avl_impl.h"
# 1 "/workspace/acl/lib_fiber/c/src/stdafx.h" 1
# 35 "/workspace/acl/lib_fiber/c/src/common/avl_impl.h" 2
...
# 4 "/workspace/acl/lib_fiber/c/src/fiber.c" 2
# 14 "/workspace/acl/lib_fiber/c/src/fiber.c"
...
# 15 "/workspace/acl/lib_fiber/c/src/fiber.c" 2
# 26 "/workspace/acl/lib_fiber/c/src/fiber.c"
...
static THREAD *__main_fiber = 
# 49 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                                        ((void *)0)
# 49 "/workspace/acl/lib_fiber/c/src/fiber.c"
                                            ;
static __thread THREAD *__thread_fiber = 
# 50 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                                        ((void *)0)
# 50 "/workspace/acl/lib_fiber/c/src/fiber.c"
                                            ;
...
# 83 "/workspace/acl/lib_fiber/c/src/fiber.c"
...
static void thread_free(void *ctx)
{
 ...
 if (__thread_fiber == 
# 103 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                      ((void *)0)
# 103 "/workspace/acl/lib_fiber/c/src/fiber.c"
                          ) {
  return;
 }
 ...
 while ((head = ring_pop_head(&__thread_fiber->dead))) {
  fiber = ((ACL_FIBER *) (((char *) (head)) - 
# 109 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
         __builtin_offsetof (
# 109 "/workspace/acl/lib_fiber/c/src/fiber.c"
         ACL_FIBER
# 109 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
         , 
# 109 "/workspace/acl/lib_fiber/c/src/fiber.c"
...
# 109 "/workspace/acl/lib_fiber/c/src/fiber.c"
 ...
 if (__main_fiber == __thread_fiber) {
  __main_fiber = 
# 130 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                ((void *)0)
# 130 "/workspace/acl/lib_fiber/c/src/fiber.c"
                    ;
 }

 __thread_fiber = 
# 133 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                 ((void *)0)
# 133 "/workspace/acl/lib_fiber/c/src/fiber.c"
                     ;
}
...
static void fiber_schedule_main_free(void)
{
 if (__main_fiber) {
  ...
  if (__thread_fiber == __main_fiber) {
   __thread_fiber = 
# 141 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                   ((void *)0)
# 141 "/workspace/acl/lib_fiber/c/src/fiber.c"
                       ;
  }
  __main_fiber = 
# 143 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                ((void *)0)
# 143 "/workspace/acl/lib_fiber/c/src/fiber.c"
                    ;
 }
}
...
static void thread_init(void)
{
 if (pthread_key_create(&__fiber_key, thread_free) != 0) {
  msg_fatal("%s(%d), %s: pthread_key_create error %s",
   "/workspace/acl/lib_fiber/c/src/fiber.c", 151, __FUNCTION__, last_serror());
 }
}

static pthread_once_t __once_control = 
# 155 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                                      0
# 155 "/workspace/acl/lib_fiber/c/src/fiber.c"
                                                       ;

static void fiber_check(void)
{
 if (__thread_fiber != 
# 159 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                      ((void *)0)
# 159 "/workspace/acl/lib_fiber/c/src/fiber.c"
                          ) {
  return;
 }
 ...
 if (pthread_once(&__once_control, thread_init) != 0) {
  printf("%s(%d), %s: pthread_once error %s\r\n",
   "/workspace/acl/lib_fiber/c/src/fiber.c", 165, __FUNCTION__, last_serror());
  abort();
 }
...
# 172 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                           ((void *)0)
# 172 "/workspace/acl/lib_fiber/c/src/fiber.c"
                               ;
 ...
 do { RING *_ring = &__thread_fiber->ready; _ring->pred = _ring->succ = _ring; _ring->parent = _ring; _ring->len = 0; } while (0);
 do { RING *_ring = &__thread_fiber->dead; _ring->pred = _ring->succ = _ring; _ring->parent = _ring; _ring->len = 0; } while (0);
...
# 337 "/workspace/acl/lib_fiber/c/src/fiber.c"
void acl_fiber_set_errno(ACL_FIBER *fiber, int errnum)
{
 if (fiber == 
# 339 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
             ((void *)0)
# 339 "/workspace/acl/lib_fiber/c/src/fiber.c"
                 ) {
...
{
 if (fiber == 
# 349 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
             ((void *)0)
# 349 "/workspace/acl/lib_fiber/c/src/fiber.c"
                 ) {
  fiber = acl_fiber_running();
 }
...
{
 if (fiber == 
# 357 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
             ((void *)0)
# 357 "/workspace/acl/lib_fiber/c/src/fiber.c"
                 ) {
  fiber = acl_fiber_running();
 }
 if (fiber) {
  if (yesno) {
   fiber->flag |= (unsigned) 1 << 0;
  } else {
   fiber->flag &= ~(unsigned) 1 << 0;
  }
 }
...
void fiber_save_errno(int errnum)
{
 ...
 if (__thread_fiber == 
# 373 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                      ((void *)0)
# 373 "/workspace/acl/lib_fiber/c/src/fiber.c"
                          ) {
  fiber_check();
 }

 if ((curr = __thread_fiber->running) == 
# 377 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                                        ((void *)0)
# 377 "/workspace/acl/lib_fiber/c/src/fiber.c"
                                            ) {
  curr = __thread_fiber->original;
 }

 if (curr->flag & (unsigned) 1 << 0) {
...
static void fiber_kick(int max)
{
 ...
 while (max > 0) {
  ...
  if (head == 
# 396 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
             ((void *)0)
# 396 "/workspace/acl/lib_fiber/c/src/fiber.c"
                 ) {
   break;
  }
  fiber = ((ACL_FIBER *) (((char *) (head)) - 
# 399 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
         __builtin_offsetof (
# 399 "/workspace/acl/lib_fiber/c/src/fiber.c"
         ACL_FIBER
# 399 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
         , 
# 399 "/workspace/acl/lib_fiber/c/src/fiber.c"
...
static void fiber_swap(ACL_FIBER *from, ACL_FIBER *to)
{
 if (from->status == FIBER_STATUS_EXITING) {
  ...
  int n = (((RING*)(&__thread_fiber->dead))->len);
  ...
  do { ((RING*)(&from->me))->pred = ((RING*)(&__thread_fiber->dead))->pred; ((RING*)(&from->me))->succ = (RING*)(&__thread_fiber->dead); ((RING*)(&from->me))->parent = ((RING*)(&__thread_fiber->dead))->parent; ((RING*)(&__thread_fiber->dead))->pred->succ = (RING*)(&from->me); ((RING*)(&__thread_fiber->dead))->pred = (RING*)(&from->me); ((RING*)(&__thread_fiber->dead))->parent->len++; } while (0);
 } else {
...
static void check_timer(ACL_FIBER *fiber __attribute__ ((__unused__)), void *ctx)
{
...
int acl_fiber_killed(ACL_FIBER *fiber)
{
 ...
 return fiber && (fiber->flag & (unsigned) 1 << 1);
}
...
int acl_fiber_signaled(ACL_FIBER *fiber)
{
 ...
 return fiber && (fiber->flag & (unsigned) 1 << 3);
}
...
int acl_fiber_closed(ACL_FIBER *fiber)
{
 ...
 return fiber && (fiber->flag & (unsigned) 1 << 2);
}
...
int acl_fiber_canceled(ACL_FIBER *fiber)
{
 ...
 return fiber && (fiber->flag & ((unsigned) 1 << 1 | (unsigned) 1 << 2 | (unsigned) 1 << 3));
}

void acl_fiber_kill(ACL_FIBER *fiber)
{
 fiber->errnum = 
# 503 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                125
# 503 "/workspace/acl/lib_fiber/c/src/fiber.c"
                         ;
 acl_fiber_signal(fiber, 
# 504 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                        15
# 504 "/workspace/acl/lib_fiber/c/src/fiber.c"
                               );
}
...
void acl_fiber_signal(ACL_FIBER *fiber, int signum)
{
 ...
 if (fiber == 
# 511 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
             ((void *)0)
# 511 "/workspace/acl/lib_fiber/c/src/fiber.c"
                 ) {
  msg_error("%s(%d), %s: fiber NULL",
   "/workspace/acl/lib_fiber/c/src/fiber.c", 513, __FUNCTION__);
  return;
 }

 if (curr == 
# 517 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
            ((void *)0)
# 517 "/workspace/acl/lib_fiber/c/src/fiber.c"
                ) {
  msg_error("%s(%d), %s: current fiber NULL",
   "/workspace/acl/lib_fiber/c/src/fiber.c", 519, __FUNCTION__);
  return;
 }
 ...
 if (signum == 
# 526 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
              9 
# 526 "/workspace/acl/lib_fiber/c/src/fiber.c"
                      || signum == 
# 526 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                                   15 
# 526 "/workspace/acl/lib_fiber/c/src/fiber.c"
...
# 526 "/workspace/acl/lib_fiber/c/src/fiber.c"
  ...
  fiber->flag |= (unsigned) 1 << 1 | (unsigned) 1 << 3;
 } else {
  fiber->flag |= (unsigned) 1 << 3;
 }
 ...
 do { RING *_succ, *_pred; if (((RING*)(&curr->me))->parent != (RING*)(&curr->me)) { _succ = ((RING*)(&curr->me))->succ; _pred = ((RING*)(&curr->me))->pred; if (_succ && _pred) { _pred->succ = _succ; _succ->pred = _pred; ((RING*)(&curr->me))->parent->len--; ((RING*)(&curr->me))->succ = (RING*)(&curr->me); ((RING*)(&curr->me))->pred = (RING*)(&curr->me); ((RING*)(&curr->me))->parent = (RING*)(&curr->me); ((RING*)(&curr->me))->len = 0; } } } while (0);
 do { RING *_succ, *_pred; if (((RING*)(&fiber->me))->parent != (RING*)(&fiber->me)) { _succ = ((RING*)(&fiber->me))->succ; _pred = ((RING*)(&fiber->me))->pred; if (_succ && _pred) { _pred->succ = _succ; _succ->pred = _pred; ((RING*)(&fiber->me))->parent->len--; ((RING*)(&fiber->me))->succ = (RING*)(&fiber->me); ((RING*)(&fiber->me))->pred = (RING*)(&fiber->me); ((RING*)(&fiber->me))->parent = (RING*)(&fiber->me); ((RING*)(&fiber->me))->len = 0; } } } while (0);
# 551 "/workspace/acl/lib_fiber/c/src/fiber.c"
 curr->status = FIBER_STATUS_READY;
 do { ((RING*)(&curr->me))->succ = ((RING*)(&__thread_fiber->ready))->succ; ((RING*)(&curr->me))->pred = (RING*)(&__thread_fiber->ready); ((RING*)(&curr->me))->parent = ((RING*)(&__thread_fiber->ready))->parent; ((RING*)(&__thread_fiber->ready))->succ->pred = (RING*)(&curr->me); ((RING*)(&__thread_fiber->ready))->succ = (RING*)(&curr->me); ((RING*)(&__thread_fiber->ready))->parent->len++; } while (0);

 fiber->status = FIBER_STATUS_READY;
 do { ((RING*)(&fiber->me))->succ = ((RING*)(&__thread_fiber->ready))->succ; ((RING*)(&fiber->me))->pred = (RING*)(&__thread_fiber->ready); ((RING*)(&fiber->me))->parent = ((RING*)(&__thread_fiber->ready))->parent; ((RING*)(&__thread_fiber->ready))->succ->pred = (RING*)(&fiber->me); ((RING*)(&__thread_fiber->ready))->succ = (RING*)(&fiber->me); ((RING*)(&__thread_fiber->ready))->parent->len++; } while (0);
...
# 593 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
 ((void) sizeof ((
# 593 "/workspace/acl/lib_fiber/c/src/fiber.c"
 __thread_fiber
# 593 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
...
# 593 "/workspace/acl/lib_fiber/c/src/fiber.c"
 "__thread_fiber"
# 593 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
 , "/workspace/acl/lib_fiber/c/src/fiber.c", 593, __extension__ __PRETTY_FUNCTION__); }))
# 593 "/workspace/acl/lib_fiber/c/src/fiber.c"
                       ;
  do { ((RING*)(&fiber->me))->pred = ((RING*)(&__thread_fiber->ready))->pred; ((RING*)(&fiber->me))->succ = (RING*)(&__thread_fiber->ready); ((RING*)(&fiber->me))->parent = ((RING*)(&__thread_fiber->ready))->parent; ((RING*)(&__thread_fiber->ready))->pred->succ = (RING*)(&fiber->me); ((RING*)(&__thread_fiber->ready))->pred = (RING*)(&fiber->me); ((RING*)(&__thread_fiber->ready))->parent->len++; } while (0);
 }
}

int acl_fiber_yield(void)
{
 if ((((RING*)(&__thread_fiber->ready))->len) == 0) {
  return 0;
 }
...
{
 if (__thread_fiber == 
# 614 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                      ((void *)0)
# 614 "/workspace/acl/lib_fiber/c/src/fiber.c"
                          ) {
  return 0;
 }
 return (unsigned) (((RING*)(&__thread_fiber->dead))->len);
}

unsigned acl_fiber_number(void)
{
 if (__thread_fiber == 
# 622 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                      ((void *)0)
# 622 "/workspace/acl/lib_fiber/c/src/fiber.c"
                          ) {
  return 0;
 }
...
static void fbase_init(FIBER_BASE *fbase, int flag)
{
 ...
 fbase->event_in = -1;
 fbase->event_out = -1;
 do { RING *_ring = &fbase->event_waiter; _ring->pred = _ring->succ = _ring; _ring->parent = _ring; _ring->len = 0; } while (0);
}
...
static void fiber_start(ACL_FIBER *fiber)
{
 ...
 for (i = 0; i < fiber->nlocal; i++) {
  if (fiber->locals[i] == 
# 665 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                         ((void *)0)
# 665 "/workspace/acl/lib_fiber/c/src/fiber.c"
                             ) {
   continue;
  }
 ...
 if (fiber->locals) {
  ...
  fiber->locals = 
# 676 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                 ((void *)0)
# 676 "/workspace/acl/lib_fiber/c/src/fiber.c"
                     ;
  fiber->nlocal = 0;
 }
...
{
 ACL_FIBER *fiber = 
# 693 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                   ((void *)0)
# 693 "/workspace/acl/lib_fiber/c/src/fiber.c"
                       ;
 RING *head;
 ...
 head = ring_pop_head(&__thread_fiber->dead);
 if (head == 
# 702 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
            ((void *)0)
# 702 "/workspace/acl/lib_fiber/c/src/fiber.c"
                ) {
  fiber = __fiber_alloc_fn(fiber_start, attr);
  fiber->tid = __pthread_self();
 } else {
  fiber = ((ACL_FIBER *) (((char *) (head)) - 
# 706 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
         __builtin_offsetof (
# 706 "/workspace/acl/lib_fiber/c/src/fiber.c"
         ACL_FIBER
# 706 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
         , 
# 706 "/workspace/acl/lib_fiber/c/src/fiber.c"
...
# 706 "/workspace/acl/lib_fiber/c/src/fiber.c"
 ...
 fiber->waiting = 
# 723 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                 ((void *)0)
# 723 "/workspace/acl/lib_fiber/c/src/fiber.c"
                     ;
 do { RING *_ring = &fiber->holding; _ring->pred = _ring->succ = _ring; _ring->parent = _ring; _ring->len = 0; } while (0);
...
int acl_fiber_use_share_stack(const ACL_FIBER *fiber)
{
 return fiber->oflag & (unsigned) 1 << 0 ? 1 : 0;
}
...
{
 if (fiber == 
# 807 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
             ((void *)0)
# 807 "/workspace/acl/lib_fiber/c/src/fiber.c"
                 ) {
  fiber = acl_fiber_running();
 }
...
void acl_fiber_schedule(void)
{
 ...
 for (;;) {
  ...
  if (head == 
# 866 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
             ((void *)0)
# 866 "/workspace/acl/lib_fiber/c/src/fiber.c"
                 ) {
  ...
  fiber = ((ACL_FIBER *) (((char *) (head)) - 
# 871 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
         __builtin_offsetof (
# 871 "/workspace/acl/lib_fiber/c/src/fiber.c"
         ACL_FIBER
# 871 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
         , 
# 871 "/workspace/acl/lib_fiber/c/src/fiber.c"
...
# 871 "/workspace/acl/lib_fiber/c/src/fiber.c"
  ...
  __thread_fiber->running = 
# 878 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                           ((void *)0)
# 878 "/workspace/acl/lib_fiber/c/src/fiber.c"
                               ;
 }


 while ((head = ring_pop_head(&__thread_fiber->dead)) != 
# 882 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                                                        ((void *)0)
# 882 "/workspace/acl/lib_fiber/c/src/fiber.c"
                                                            ) {
  fiber = ((ACL_FIBER *) (((char *) (head)) - 
# 883 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
         __builtin_offsetof (
# 883 "/workspace/acl/lib_fiber/c/src/fiber.c"
         ACL_FIBER
# 883 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
         , 
# 883 "/workspace/acl/lib_fiber/c/src/fiber.c"
...
void acl_fiber_switch(void)
{
 ...
 head = ring_pop_head(&__thread_fiber->ready);
 if (head == 
# 920 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
            ((void *)0)
# 920 "/workspace/acl/lib_fiber/c/src/fiber.c"
                ) {
 ...
 fiber = ((ACL_FIBER *) (((char *) (head)) - 
# 926 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
        __builtin_offsetof (
# 926 "/workspace/acl/lib_fiber/c/src/fiber.c"
        ACL_FIBER
# 926 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
        , 
# 926 "/workspace/acl/lib_fiber/c/src/fiber.c"
...
int acl_fiber_set_specific(int *key, void *ctx, void (*free_fn)(void *))
{
 ...
 if (key == 
# 940 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
           ((void *)0)
# 940 "/workspace/acl/lib_fiber/c/src/fiber.c"
               ) {
  msg_error("%s(%d), %s: key NULL",
   "/workspace/acl/lib_fiber/c/src/fiber.c", 942, __FUNCTION__);
  return -1;
 }

 if (__thread_fiber == 
# 946 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                      ((void *)0)
# 946 "/workspace/acl/lib_fiber/c/src/fiber.c"
                          ) {
  msg_error("%s(%d), %s: __thread_fiber: NULL",
   "/workspace/acl/lib_fiber/c/src/fiber.c", 948, __FUNCTION__);
  return -1;
 } else if (__thread_fiber->running == 
# 950 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                                      ((void *)0)
# 950 "/workspace/acl/lib_fiber/c/src/fiber.c"
                                          ) {
  msg_error("%s(%d), %s: running: NULL",
   "/workspace/acl/lib_fiber/c/src/fiber.c", 952, __FUNCTION__);
  return -1;
 } else
  ...
  *key = ++__thread_fiber->nlocal;
  ...
  msg_error("%s(%d), %s: invalid key: %d > nlocal: %d",
   "/workspace/acl/lib_fiber/c/src/fiber.c", 961, __FUNCTION__,
   *key, __thread_fiber->nlocal);
  return -1;
 }
 ...
 if (curr->nlocal < __thread_fiber->nlocal) {
  ...
  for (i = n; i < curr->nlocal; i++)
   curr->locals[i] = 
# 972 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                    ((void *)0)
# 972 "/workspace/acl/lib_fiber/c/src/fiber.c"
                        ;
 }
...
void *acl_fiber_get_specific(int key)
{
 ...
 if (key <= 0) {
  return 
# 989 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
        ((void *)0)
# 989 "/workspace/acl/lib_fiber/c/src/fiber.c"
            ;
 }

 if (__thread_fiber == 
# 992 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                      ((void *)0)
# 992 "/workspace/acl/lib_fiber/c/src/fiber.c"
                          ) {
  msg_error("%s(%d), %s: __thread_fiber NULL",
   "/workspace/acl/lib_fiber/c/src/fiber.c", 994, __FUNCTION__);
  return 
# 995 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
        ((void *)0)
# 995 "/workspace/acl/lib_fiber/c/src/fiber.c"
            ;
 } else if (__thread_fiber->running == 
# 996 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                                      ((void *)0)
# 996 "/workspace/acl/lib_fiber/c/src/fiber.c"
                                          ) {
  msg_error("%s(%d), %s: running fiber NULL",
   "/workspace/acl/lib_fiber/c/src/fiber.c", 998, __FUNCTION__);
  return 
# 999 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
        ((void *)0)
# 999 "/workspace/acl/lib_fiber/c/src/fiber.c"
            ;
 } else
  curr = __thread_fiber->running;
 ...
 if (key > curr->nlocal) {
  return 
# 1004 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
        ((void *)0)
# 1004 "/workspace/acl/lib_fiber/c/src/fiber.c"
            ;
 }

 local = curr->locals[key - 1];

 return local ? local->ctx : 
# 1009 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
                            ((void *)0)
# 1009 "/workspace/acl/lib_fiber/c/src/fiber.c"
                                ;
}
...
int acl_fiber_last_error(void)
{
 ...
 return 
# 1021 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
       (*__errno_location ())
# 1021 "/workspace/acl/lib_fiber/c/src/fiber.c"
            ;
...
# 1030 "/workspace/acl/lib_fiber/c/src/fiber.c" 3 4
(*__errno_location ()) 
# 1030 "/workspace/acl/lib_fiber/c/src/fiber.c"
      = errnum;
}
