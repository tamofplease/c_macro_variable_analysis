# 0 "/acl/lib_fiber/c/src/fiber.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/fiber.c"
...
# 2 "/acl/lib_fiber/c/src/fiber.c" 2
...
# 3 "/acl/lib_fiber/c/src/fiber.c" 2
...
# 34 "/acl/lib_fiber/c/src/common/avl_impl.h"
# 1 "/acl/lib_fiber/c/src/stdafx.h" 1
# 35 "/acl/lib_fiber/c/src/common/avl_impl.h" 2
...
# 4 "/acl/lib_fiber/c/src/fiber.c" 2
# 14 "/acl/lib_fiber/c/src/fiber.c"
...
# 15 "/acl/lib_fiber/c/src/fiber.c" 2
# 26 "/acl/lib_fiber/c/src/fiber.c"
...
static ATOMIC *__idgen_atomic = 
# 48 "/acl/lib_fiber/c/src/fiber.c" 3 4
                                 ((void *)0)
# 48 "/acl/lib_fiber/c/src/fiber.c"
                                     ;
static long long __idgen_value = 0;

static THREAD *__main_fiber = 
# 51 "/acl/lib_fiber/c/src/fiber.c" 3 4
                                        ((void *)0)
# 51 "/acl/lib_fiber/c/src/fiber.c"
                                            ;
static __thread THREAD *__thread_fiber = 
# 52 "/acl/lib_fiber/c/src/fiber.c" 3 4
                                        ((void *)0)
# 52 "/acl/lib_fiber/c/src/fiber.c"
                                            ;
...
# 85 "/acl/lib_fiber/c/src/fiber.c"
...
static void thread_free(void *ctx)
{
 ...
 if (__thread_fiber == 
# 105 "/acl/lib_fiber/c/src/fiber.c" 3 4
                      ((void *)0)
# 105 "/acl/lib_fiber/c/src/fiber.c"
                          ) {
  return;
 }
...
# 111 "/acl/lib_fiber/c/src/fiber.c" 3 4
         __builtin_offsetof (
# 111 "/acl/lib_fiber/c/src/fiber.c"
         ACL_FIBER
# 111 "/acl/lib_fiber/c/src/fiber.c" 3 4
         , 
# 111 "/acl/lib_fiber/c/src/fiber.c"
...
# 111 "/acl/lib_fiber/c/src/fiber.c"
 ...
 if (__main_fiber == __thread_fiber) {
  __main_fiber = 
# 132 "/acl/lib_fiber/c/src/fiber.c" 3 4
                ((void *)0)
# 132 "/acl/lib_fiber/c/src/fiber.c"
                    ;
 }

 __thread_fiber = 
# 135 "/acl/lib_fiber/c/src/fiber.c" 3 4
                 ((void *)0)
# 135 "/acl/lib_fiber/c/src/fiber.c"
                     ;
}
...
static void fiber_schedule_main_free(void)
{
 if (__main_fiber) {
  ...
  if (__thread_fiber == __main_fiber) {
   __thread_fiber = 
# 143 "/acl/lib_fiber/c/src/fiber.c" 3 4
                   ((void *)0)
# 143 "/acl/lib_fiber/c/src/fiber.c"
                       ;
  }
  __main_fiber = 
# 145 "/acl/lib_fiber/c/src/fiber.c" 3 4
                ((void *)0)
# 145 "/acl/lib_fiber/c/src/fiber.c"
                    ;
 }
}
...
{
 if (__idgen_atomic != 
# 151 "/acl/lib_fiber/c/src/fiber.c" 3 4
                      ((void *)0)
# 151 "/acl/lib_fiber/c/src/fiber.c"
                          ) {
  atomic_free(__idgen_atomic);
  __idgen_atomic = 
# 153 "/acl/lib_fiber/c/src/fiber.c" 3 4
                  ((void *)0)
# 153 "/acl/lib_fiber/c/src/fiber.c"
                      ;
 }
}
...
static void thread_init(void)
{
 if (pthread_key_create(&__fiber_key, thread_free) != 0) {
  msg_fatal("%s(%d), %s: pthread_key_create error %s",
   "/acl/lib_fiber/c/src/fiber.c", 161, __FUNCTION__, last_serror());
 }
...
# 170 "/acl/lib_fiber/c/src/fiber.c" 3 4
                                      0
# 170 "/acl/lib_fiber/c/src/fiber.c"
                                                       ;

static void fiber_check(void)
{
 if (__thread_fiber != 
# 174 "/acl/lib_fiber/c/src/fiber.c" 3 4
                      ((void *)0)
# 174 "/acl/lib_fiber/c/src/fiber.c"
                          ) {
  return;
 }
 ...
 if (pthread_once(&__once_control, thread_init) != 0) {
  printf("%s(%d), %s: pthread_once error %s\r\n",
   "/acl/lib_fiber/c/src/fiber.c", 180, __FUNCTION__, last_serror());
  abort();
 }
...
# 187 "/acl/lib_fiber/c/src/fiber.c" 3 4
                           ((void *)0)
# 187 "/acl/lib_fiber/c/src/fiber.c"
                               ;
...
# 351 "/acl/lib_fiber/c/src/fiber.c"
void acl_fiber_set_errno(ACL_FIBER *fiber, int errnum)
{
 if (fiber == 
# 353 "/acl/lib_fiber/c/src/fiber.c" 3 4
             ((void *)0)
# 353 "/acl/lib_fiber/c/src/fiber.c"
                 ) {
...
{
 if (fiber == 
# 363 "/acl/lib_fiber/c/src/fiber.c" 3 4
             ((void *)0)
# 363 "/acl/lib_fiber/c/src/fiber.c"
                 ) {
  fiber = acl_fiber_running();
 }
...
{
 if (fiber == 
# 371 "/acl/lib_fiber/c/src/fiber.c" 3 4
             ((void *)0)
# 371 "/acl/lib_fiber/c/src/fiber.c"
                 ) {
  fiber = acl_fiber_running();
 }
 if (fiber) {
...
void fiber_save_errno(int errnum)
{
 ...
 if (__thread_fiber == 
# 387 "/acl/lib_fiber/c/src/fiber.c" 3 4
                      ((void *)0)
# 387 "/acl/lib_fiber/c/src/fiber.c"
                          ) {
  fiber_check();
 }

 if ((curr = __thread_fiber->running) == 
# 391 "/acl/lib_fiber/c/src/fiber.c" 3 4
                                        ((void *)0)
# 391 "/acl/lib_fiber/c/src/fiber.c"
                                            ) {
...
static void fiber_kick(int max)
{
 ...
 while (max > 0) {
  ...
  if (head == 
# 410 "/acl/lib_fiber/c/src/fiber.c" 3 4
             ((void *)0)
# 410 "/acl/lib_fiber/c/src/fiber.c"
                 ) {
   break;
  }
  fiber = ((ACL_FIBER *) (((char *) (head)) - 
# 413 "/acl/lib_fiber/c/src/fiber.c" 3 4
         __builtin_offsetof (
# 413 "/acl/lib_fiber/c/src/fiber.c"
         ACL_FIBER
# 413 "/acl/lib_fiber/c/src/fiber.c" 3 4
         , 
# 413 "/acl/lib_fiber/c/src/fiber.c"
...
{
 fiber->errnum = 
# 517 "/acl/lib_fiber/c/src/fiber.c" 3 4
                125
# 517 "/acl/lib_fiber/c/src/fiber.c"
                         ;
 acl_fiber_signal(fiber, 
# 518 "/acl/lib_fiber/c/src/fiber.c" 3 4
                        15
# 518 "/acl/lib_fiber/c/src/fiber.c"
                               );
}
...
void acl_fiber_signal(ACL_FIBER *fiber, int signum)
{
 ...
 if (fiber == 
# 525 "/acl/lib_fiber/c/src/fiber.c" 3 4
             ((void *)0)
# 525 "/acl/lib_fiber/c/src/fiber.c"
                 ) {
  msg_error("%s(%d), %s: fiber NULL",
   "/acl/lib_fiber/c/src/fiber.c", 527, __FUNCTION__);
  return;
 }

 if (curr == 
# 531 "/acl/lib_fiber/c/src/fiber.c" 3 4
            ((void *)0)
# 531 "/acl/lib_fiber/c/src/fiber.c"
                ) {
  msg_error("%s(%d), %s: current fiber NULL",
   "/acl/lib_fiber/c/src/fiber.c", 533, __FUNCTION__);
  return;
 }
 ...
 if (signum == 
# 540 "/acl/lib_fiber/c/src/fiber.c" 3 4
              9 
# 540 "/acl/lib_fiber/c/src/fiber.c"
                      || signum == 
# 540 "/acl/lib_fiber/c/src/fiber.c" 3 4
                                   15 
# 540 "/acl/lib_fiber/c/src/fiber.c"
...
# 565 "/acl/lib_fiber/c/src/fiber.c"
...
# 607 "/acl/lib_fiber/c/src/fiber.c" 3 4
 ((void) sizeof ((
# 607 "/acl/lib_fiber/c/src/fiber.c"
 __thread_fiber
# 607 "/acl/lib_fiber/c/src/fiber.c" 3 4
...
# 607 "/acl/lib_fiber/c/src/fiber.c"
 "__thread_fiber"
# 607 "/acl/lib_fiber/c/src/fiber.c" 3 4
 , "/acl/lib_fiber/c/src/fiber.c", 607, __extension__ __PRETTY_FUNCTION__); }))
# 607 "/acl/lib_fiber/c/src/fiber.c"
                       ;
...
{
 if (__thread_fiber == 
# 628 "/acl/lib_fiber/c/src/fiber.c" 3 4
                      ((void *)0)
# 628 "/acl/lib_fiber/c/src/fiber.c"
                          ) {
  return 0;
 }
...
{
 if (__thread_fiber == 
# 636 "/acl/lib_fiber/c/src/fiber.c" 3 4
                      ((void *)0)
# 636 "/acl/lib_fiber/c/src/fiber.c"
                          ) {
  return 0;
 }
...
static void fiber_start(ACL_FIBER *fiber)
{
 ...
 for (i = 0; i < fiber->nlocal; i++) {
  if (fiber->locals[i] == 
# 679 "/acl/lib_fiber/c/src/fiber.c" 3 4
                         ((void *)0)
# 679 "/acl/lib_fiber/c/src/fiber.c"
                             ) {
   continue;
  }
 ...
 if (fiber->locals) {
  ...
  fiber->locals = 
# 690 "/acl/lib_fiber/c/src/fiber.c" 3 4
                 ((void *)0)
# 690 "/acl/lib_fiber/c/src/fiber.c"
                     ;
  fiber->nlocal = 0;
 }
...
{
 ACL_FIBER *fiber = 
# 707 "/acl/lib_fiber/c/src/fiber.c" 3 4
                   ((void *)0)
# 707 "/acl/lib_fiber/c/src/fiber.c"
                       ;
 RING *head;
 unsigned long id;
 ...
 head = ring_pop_head(&__thread_fiber->dead);
 if (head == 
# 717 "/acl/lib_fiber/c/src/fiber.c" 3 4
            ((void *)0)
# 717 "/acl/lib_fiber/c/src/fiber.c"
                ) {
  fiber = __fiber_alloc_fn(fiber_start, attr);
  fiber->tid = thread_self();
 } else {
  fiber = ((ACL_FIBER *) (((char *) (head)) - 
# 721 "/acl/lib_fiber/c/src/fiber.c" 3 4
         __builtin_offsetof (
# 721 "/acl/lib_fiber/c/src/fiber.c"
         ACL_FIBER
# 721 "/acl/lib_fiber/c/src/fiber.c" 3 4
         , 
# 721 "/acl/lib_fiber/c/src/fiber.c"
...
# 721 "/acl/lib_fiber/c/src/fiber.c"
 ...
 fiber->waiting = 
# 739 "/acl/lib_fiber/c/src/fiber.c" 3 4
                 ((void *)0)
# 739 "/acl/lib_fiber/c/src/fiber.c"
                     ;
...
{
 if (fiber == 
# 823 "/acl/lib_fiber/c/src/fiber.c" 3 4
             ((void *)0)
# 823 "/acl/lib_fiber/c/src/fiber.c"
                 ) {
  fiber = acl_fiber_running();
 }
...
void acl_fiber_schedule(void)
{
 ...
 for (;;) {
  ...
  if (head == 
# 882 "/acl/lib_fiber/c/src/fiber.c" 3 4
             ((void *)0)
# 882 "/acl/lib_fiber/c/src/fiber.c"
                 ) {
  ...
  fiber = ((ACL_FIBER *) (((char *) (head)) - 
# 887 "/acl/lib_fiber/c/src/fiber.c" 3 4
         __builtin_offsetof (
# 887 "/acl/lib_fiber/c/src/fiber.c"
         ACL_FIBER
# 887 "/acl/lib_fiber/c/src/fiber.c" 3 4
         , 
# 887 "/acl/lib_fiber/c/src/fiber.c"
...
# 894 "/acl/lib_fiber/c/src/fiber.c" 3 4
                           ((void *)0)
# 894 "/acl/lib_fiber/c/src/fiber.c"
                               ;
 }


 while ((head = ring_pop_head(&__thread_fiber->dead)) != 
# 898 "/acl/lib_fiber/c/src/fiber.c" 3 4
                                                        ((void *)0)
# 898 "/acl/lib_fiber/c/src/fiber.c"
                                                            ) {
  fiber = ((ACL_FIBER *) (((char *) (head)) - 
# 899 "/acl/lib_fiber/c/src/fiber.c" 3 4
         __builtin_offsetof (
# 899 "/acl/lib_fiber/c/src/fiber.c"
         ACL_FIBER
# 899 "/acl/lib_fiber/c/src/fiber.c" 3 4
         , 
# 899 "/acl/lib_fiber/c/src/fiber.c"
...
void acl_fiber_switch(void)
{
 ...
 head = ring_pop_head(&__thread_fiber->ready);
 if (head == 
# 936 "/acl/lib_fiber/c/src/fiber.c" 3 4
            ((void *)0)
# 936 "/acl/lib_fiber/c/src/fiber.c"
                ) {
 ...
 fiber = ((ACL_FIBER *) (((char *) (head)) - 
# 942 "/acl/lib_fiber/c/src/fiber.c" 3 4
        __builtin_offsetof (
# 942 "/acl/lib_fiber/c/src/fiber.c"
        ACL_FIBER
# 942 "/acl/lib_fiber/c/src/fiber.c" 3 4
        , 
# 942 "/acl/lib_fiber/c/src/fiber.c"
...
int acl_fiber_set_specific(int *key, void *ctx, void (*free_fn)(void *))
{
 ...
 if (key == 
# 956 "/acl/lib_fiber/c/src/fiber.c" 3 4
           ((void *)0)
# 956 "/acl/lib_fiber/c/src/fiber.c"
               ) {
  msg_error("%s(%d), %s: key NULL",
   "/acl/lib_fiber/c/src/fiber.c", 958, __FUNCTION__);
  return -1;
 }

 if (__thread_fiber == 
# 962 "/acl/lib_fiber/c/src/fiber.c" 3 4
                      ((void *)0)
# 962 "/acl/lib_fiber/c/src/fiber.c"
                          ) {
  msg_error("%s(%d), %s: __thread_fiber: NULL",
   "/acl/lib_fiber/c/src/fiber.c", 964, __FUNCTION__);
  return -1;
 } else if (__thread_fiber->running == 
# 966 "/acl/lib_fiber/c/src/fiber.c" 3 4
                                      ((void *)0)
# 966 "/acl/lib_fiber/c/src/fiber.c"
                                          ) {
  msg_error("%s(%d), %s: running: NULL",
   "/acl/lib_fiber/c/src/fiber.c", 968, __FUNCTION__);
  return -1;
 } else
  ...
  *key = ++__thread_fiber->nlocal;
  ...
  msg_error("%s(%d), %s: invalid key: %d > nlocal: %d",
   "/acl/lib_fiber/c/src/fiber.c", 977, __FUNCTION__,
   *key, __thread_fiber->nlocal);
  return -1;
 }
 ...
 if (curr->nlocal < __thread_fiber->nlocal) {
  ...
  for (i = n; i < curr->nlocal; i++)
   curr->locals[i] = 
# 988 "/acl/lib_fiber/c/src/fiber.c" 3 4
                    ((void *)0)
# 988 "/acl/lib_fiber/c/src/fiber.c"
                        ;
 }
...
void *acl_fiber_get_specific(int key)
{
 ...
 if (key <= 0) {
  return 
# 1005 "/acl/lib_fiber/c/src/fiber.c" 3 4
        ((void *)0)
# 1005 "/acl/lib_fiber/c/src/fiber.c"
            ;
 }

 if (__thread_fiber == 
# 1008 "/acl/lib_fiber/c/src/fiber.c" 3 4
                      ((void *)0)
# 1008 "/acl/lib_fiber/c/src/fiber.c"
                          ) {
  msg_error("%s(%d), %s: __thread_fiber NULL",
   "/acl/lib_fiber/c/src/fiber.c", 1010, __FUNCTION__);
  return 
# 1011 "/acl/lib_fiber/c/src/fiber.c" 3 4
        ((void *)0)
# 1011 "/acl/lib_fiber/c/src/fiber.c"
            ;
 } else if (__thread_fiber->running == 
# 1012 "/acl/lib_fiber/c/src/fiber.c" 3 4
                                      ((void *)0)
# 1012 "/acl/lib_fiber/c/src/fiber.c"
                                          ) {
  msg_error("%s(%d), %s: running fiber NULL",
   "/acl/lib_fiber/c/src/fiber.c", 1014, __FUNCTION__);
  return 
# 1015 "/acl/lib_fiber/c/src/fiber.c" 3 4
        ((void *)0)
# 1015 "/acl/lib_fiber/c/src/fiber.c"
            ;
 } else
  curr = __thread_fiber->running;
 ...
 if (key > curr->nlocal) {
  return 
# 1020 "/acl/lib_fiber/c/src/fiber.c" 3 4
        ((void *)0)
# 1020 "/acl/lib_fiber/c/src/fiber.c"
            ;
 }
...
# 1025 "/acl/lib_fiber/c/src/fiber.c" 3 4
                            ((void *)0)
# 1025 "/acl/lib_fiber/c/src/fiber.c"
                                ;
}
...
int acl_fiber_last_error(void)
{
 ...
 return 
# 1037 "/acl/lib_fiber/c/src/fiber.c" 3 4
       (*__errno_location ())
# 1037 "/acl/lib_fiber/c/src/fiber.c"
            ;
...
# 1046 "/acl/lib_fiber/c/src/fiber.c" 3 4
(*__errno_location ()) 
# 1046 "/acl/lib_fiber/c/src/fiber.c"
      = errnum;
}
