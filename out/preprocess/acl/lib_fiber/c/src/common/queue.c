# 1 "/workspace/acl/lib_fiber/c/src/common/queue.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/common/queue.c" 2
# 15 "/workspace/acl/lib_fiber/c/src/common/queue.c"
...
# 16 "/workspace/acl/lib_fiber/c/src/common/queue.c" 2
# 1 "/workspace/acl/lib_fiber/c/src/common/queue.h" 1
# 18 "/workspace/acl/lib_fiber/c/src/common/queue.h"
...
# 65 "/workspace/acl/lib_fiber/c/src/common/queue.h"
...
# 17 "/workspace/acl/lib_fiber/c/src/common/queue.c" 2
...
QUEUE *queue_new(void)
{
 ...
 pthread_mutex_init(&que->lock, 
# 41 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
                               ((void *)0)
# 41 "/workspace/acl/lib_fiber/c/src/common/queue.c"
                                   );
 pthread_cond_init(&que->cond, 
# 42 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
                              ((void *)0)
# 42 "/workspace/acl/lib_fiber/c/src/common/queue.c"
                                  );

 que->first = que->last = 
# 44 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
                         ((void *)0)
# 44 "/workspace/acl/lib_fiber/c/src/common/queue.c"
                             ;
 que->qlen = 0;
 que->error = 0;
 que->quit = 0;
...
void queue_free(QUEUE *que, QUEUE_FREE_FN free_fn)
{
 ...
 if (que == 
# 74 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
           ((void *)0)
# 74 "/workspace/acl/lib_fiber/c/src/common/queue.c"
               ) {
  return;
 }
 ...
 while (1) {
  qi = que->first;
  if (qi == 
# 92 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
           ((void *)0)
# 92 "/workspace/acl/lib_fiber/c/src/common/queue.c"
               ) {
   break;
  }
  que->first = qi->next;
  if (free_fn != 
# 96 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
                ((void *)0)
# 96 "/workspace/acl/lib_fiber/c/src/common/queue.c"
                    ) {
   free_fn(qi->data);
  }
  free(qi);
...
static int queue_wait(QUEUE *que, const struct timespec *ptimeo)
{
 ...
 while (que->first == 
# 116 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
                     ((void *)0) 
# 116 "/workspace/acl/lib_fiber/c/src/common/queue.c"
                          && que->quit == 0) {
  if (ptimeo != 
# 117 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
               ((void *)0)
# 117 "/workspace/acl/lib_fiber/c/src/common/queue.c"
                   ) {
  ...
  if (ptimeo && status == 
# 124 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
                         110
# 124 "/workspace/acl/lib_fiber/c/src/common/queue.c"
                                  ) {
   status = pthread_mutex_unlock(&que->lock);
   if (status != 0) {
    msg_error("%s(%d): unlock error(%s)",
     __FUNCTION__, 128, last_serror());
   }
...
void *queue_pop_timedwait(QUEUE *que, int tmo_sec, int tmo_usec)
{
 ...
 if (que == 
# 158 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
           ((void *)0)
# 158 "/workspace/acl/lib_fiber/c/src/common/queue.c"
               ) {
 ...
 if (status) {
  ...
  msg_error("%s: lock error(%s)", __FUNCTION__, last_serror());
  return 
# 168 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
        ((void *)0)
# 168 "/workspace/acl/lib_fiber/c/src/common/queue.c"
            ;
 }

 qi = 
# 171 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
     ((void *)0)
# 171 "/workspace/acl/lib_fiber/c/src/common/queue.c"
         ;

 while (1) {
  if (tmo_sec < 0 || tmo_usec < 0) {
   ptimeo = 
# 175 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
           ((void *)0)
# 175 "/workspace/acl/lib_fiber/c/src/common/queue.c"
               ;
  } else {
   gettimeofday(&tv, 
# 177 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
                    ((void *)0)
# 177 "/workspace/acl/lib_fiber/c/src/common/queue.c"
                        );
  ...
  if (queue_wait(que, ptimeo) < 0) {
   return 
# 186 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
         ((void *)0)
# 186 "/workspace/acl/lib_fiber/c/src/common/queue.c"
             ;
  }

  qi = que->first;
  if (qi != 
# 190 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
           ((void *)0)
# 190 "/workspace/acl/lib_fiber/c/src/common/queue.c"
               ) {
   que->first = qi->next;
   que->qlen--;
   if (que->last == qi) {
    que->last = 
# 194 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
               ((void *)0)
# 194 "/workspace/acl/lib_fiber/c/src/common/queue.c"
                   ;
   }
   break;
  }
  if (que->quit != 0) {
   ...
   if (status != 0) {
    msg_error("%s(%d): unlock error(%s)",
     __FUNCTION__, 202, last_serror());
    que->error = 2;
   }

   return 
# 206 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
         ((void *)0)
# 206 "/workspace/acl/lib_fiber/c/src/common/queue.c"
             ;
  }
 }
 ...
 if (status != 0)
  msg_error("%s(%d): unlock error(%s)",
   __FUNCTION__, 213, last_serror());

 if (qi == 
# 215 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
          ((void *)0)
# 215 "/workspace/acl/lib_fiber/c/src/common/queue.c"
              ) {
  msg_fatal("%s(%d): qi null", __FUNCTION__, 216);
 }
...
int queue_push(QUEUE *que, void *data)
{
 ...
 if (que == 
# 235 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
           ((void *)0)
# 235 "/workspace/acl/lib_fiber/c/src/common/queue.c"
               ) {
 ...
 if (que->first == 
# 250 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
                  ((void *)0)
# 250 "/workspace/acl/lib_fiber/c/src/common/queue.c"
                      ) {
  que->first = qi;
 } else {
  que->last->next = qi;
...
int queue_qlen(QUEUE* que)
{
 ...
 if (status) {
  msg_error("%s(%d): pthread_mutex_lock error(%s)",
   __FUNCTION__, 281, strerror(status));
  return -1;
 }
 ...
 if (status) {
  msg_error("%s(%d): pthread_mutex_unlock error(%s)",
   __FUNCTION__, 290, strerror(status));
  return -1;
 }
...
{
 if (que == 
# 305 "/workspace/acl/lib_fiber/c/src/common/queue.c" 3 4
           ((void *)0)
# 305 "/workspace/acl/lib_fiber/c/src/common/queue.c"
               ) {
  return -1;
 }
