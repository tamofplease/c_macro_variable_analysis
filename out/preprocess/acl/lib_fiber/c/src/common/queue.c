# 0 "/acl/lib_fiber/c/src/common/queue.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/common/queue.c"
...
# 2 "/acl/lib_fiber/c/src/common/queue.c" 2
# 15 "/acl/lib_fiber/c/src/common/queue.c"
...
# 16 "/acl/lib_fiber/c/src/common/queue.c" 2
# 1 "/acl/lib_fiber/c/src/common/pthread_patch.h" 1
# 46 "/acl/lib_fiber/c/src/common/pthread_patch.h"
long thread_self(void);
# 17 "/acl/lib_fiber/c/src/common/queue.c" 2
# 1 "/acl/lib_fiber/c/src/common/queue.h" 1
# 18 "/acl/lib_fiber/c/src/common/queue.h"
...
# 65 "/acl/lib_fiber/c/src/common/queue.h"
...
# 18 "/acl/lib_fiber/c/src/common/queue.c" 2
...
# 42 "/acl/lib_fiber/c/src/common/queue.c" 3 4
                               ((void *)0)
# 42 "/acl/lib_fiber/c/src/common/queue.c"
                                   );
 pthread_cond_init(&que->cond, 
# 43 "/acl/lib_fiber/c/src/common/queue.c" 3 4
                              ((void *)0)
# 43 "/acl/lib_fiber/c/src/common/queue.c"
                                  );

 que->first = que->last = 
# 45 "/acl/lib_fiber/c/src/common/queue.c" 3 4
                         ((void *)0)
# 45 "/acl/lib_fiber/c/src/common/queue.c"
                             ;
 que->qlen = 0;
 que->error = 0;
 que->quit = 0;
...
void queue_free(QUEUE *que, QUEUE_FREE_FN free_fn)
{
 ...
 if (que == 
# 75 "/acl/lib_fiber/c/src/common/queue.c" 3 4
           ((void *)0)
# 75 "/acl/lib_fiber/c/src/common/queue.c"
               ) {
  return;
 }
 ...
 while (1) {
  qi = que->first;
  if (qi == 
# 93 "/acl/lib_fiber/c/src/common/queue.c" 3 4
           ((void *)0)
# 93 "/acl/lib_fiber/c/src/common/queue.c"
               ) {
   break;
  }
  que->first = qi->next;
  if (free_fn != 
# 97 "/acl/lib_fiber/c/src/common/queue.c" 3 4
                ((void *)0)
# 97 "/acl/lib_fiber/c/src/common/queue.c"
                    ) {
   free_fn(qi->data);
  }
  free(qi);
...
static int queue_wait(QUEUE *que, const struct timespec *ptimeo)
{
 ...
 while (que->first == 
# 117 "/acl/lib_fiber/c/src/common/queue.c" 3 4
                     ((void *)0) 
# 117 "/acl/lib_fiber/c/src/common/queue.c"
                          && que->quit == 0) {
  if (ptimeo != 
# 118 "/acl/lib_fiber/c/src/common/queue.c" 3 4
               ((void *)0)
# 118 "/acl/lib_fiber/c/src/common/queue.c"
                   ) {
  ...
  if (ptimeo && status == 
# 125 "/acl/lib_fiber/c/src/common/queue.c" 3 4
                         110
# 125 "/acl/lib_fiber/c/src/common/queue.c"
                                  ) {
   status = pthread_mutex_unlock(&que->lock);
   if (status != 0) {
    msg_error("%s(%d): unlock error(%s)",
     __FUNCTION__, 129, last_serror());
   }
...
void *queue_pop_timedwait(QUEUE *que, int tmo_sec, int tmo_usec)
{
 ...
 if (que == 
# 159 "/acl/lib_fiber/c/src/common/queue.c" 3 4
           ((void *)0)
# 159 "/acl/lib_fiber/c/src/common/queue.c"
               ) {
 ...
 if (status) {
  ...
  msg_error("%s: lock error(%s)", __FUNCTION__, last_serror());
  return 
# 169 "/acl/lib_fiber/c/src/common/queue.c" 3 4
        ((void *)0)
# 169 "/acl/lib_fiber/c/src/common/queue.c"
            ;
 }

 qi = 
# 172 "/acl/lib_fiber/c/src/common/queue.c" 3 4
     ((void *)0)
# 172 "/acl/lib_fiber/c/src/common/queue.c"
         ;

 while (1) {
  if (tmo_sec < 0 || tmo_usec < 0) {
   ptimeo = 
# 176 "/acl/lib_fiber/c/src/common/queue.c" 3 4
           ((void *)0)
# 176 "/acl/lib_fiber/c/src/common/queue.c"
               ;
  } else {
   gettimeofday(&tv, 
# 178 "/acl/lib_fiber/c/src/common/queue.c" 3 4
                    ((void *)0)
# 178 "/acl/lib_fiber/c/src/common/queue.c"
                        );
  ...
  if (queue_wait(que, ptimeo) < 0) {
   return 
# 187 "/acl/lib_fiber/c/src/common/queue.c" 3 4
         ((void *)0)
# 187 "/acl/lib_fiber/c/src/common/queue.c"
             ;
  }

  qi = que->first;
  if (qi != 
# 191 "/acl/lib_fiber/c/src/common/queue.c" 3 4
           ((void *)0)
# 191 "/acl/lib_fiber/c/src/common/queue.c"
               ) {
   que->first = qi->next;
   que->qlen--;
   if (que->last == qi) {
    que->last = 
# 195 "/acl/lib_fiber/c/src/common/queue.c" 3 4
               ((void *)0)
# 195 "/acl/lib_fiber/c/src/common/queue.c"
                   ;
   }
   break;
  }
  if (que->quit != 0) {
   ...
   if (status != 0) {
    msg_error("%s(%d): unlock error(%s)",
     __FUNCTION__, 203, last_serror());
    que->error = 2;
   }

   return 
# 207 "/acl/lib_fiber/c/src/common/queue.c" 3 4
         ((void *)0)
# 207 "/acl/lib_fiber/c/src/common/queue.c"
             ;
  }
 }
 ...
 if (status != 0)
  msg_error("%s(%d): unlock error(%s)",
   __FUNCTION__, 214, last_serror());

 if (qi == 
# 216 "/acl/lib_fiber/c/src/common/queue.c" 3 4
          ((void *)0)
# 216 "/acl/lib_fiber/c/src/common/queue.c"
              ) {
  msg_fatal("%s(%d): qi null", __FUNCTION__, 217);
 }
...
int queue_push(QUEUE *que, void *data)
{
 ...
 if (que == 
# 236 "/acl/lib_fiber/c/src/common/queue.c" 3 4
           ((void *)0)
# 236 "/acl/lib_fiber/c/src/common/queue.c"
               ) {
 ...
 if (que->first == 
# 251 "/acl/lib_fiber/c/src/common/queue.c" 3 4
                  ((void *)0)
# 251 "/acl/lib_fiber/c/src/common/queue.c"
                      ) {
  que->first = qi;
 } else {
  que->last->next = qi;
...
int queue_qlen(QUEUE* que)
{
 ...
 if (status) {
  msg_error("%s(%d): pthread_mutex_lock error(%s)",
   __FUNCTION__, 282, strerror(status));
  return -1;
 }
 ...
 if (status) {
  msg_error("%s(%d): pthread_mutex_unlock error(%s)",
   __FUNCTION__, 291, strerror(status));
  return -1;
 }
...
{
 if (que == 
# 306 "/acl/lib_fiber/c/src/common/queue.c" 3 4
           ((void *)0)
# 306 "/acl/lib_fiber/c/src/common/queue.c"
               ) {
  return -1;
 }
