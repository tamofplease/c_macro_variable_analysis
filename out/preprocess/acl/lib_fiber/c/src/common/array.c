# 1 "/workspace/acl/lib_fiber/c/src/common/array.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/common/array.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/common/array.c" 2
...
# 4 "/workspace/acl/lib_fiber/c/src/common/array.c" 2
...
# 5 "/workspace/acl/lib_fiber/c/src/common/array.c" 2
...
void *array_pop_back(struct ARRAY *a)
{
 ...
 if (a->count <= 0) {
  return 
# 20 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
        ((void *)0)
# 20 "/workspace/acl/lib_fiber/c/src/common/array.c"
            ;
 }
 a->count--;
 obj = a->items[a->count];
...
void *array_pop_front(struct ARRAY *a)
{
 ...
 if (a->count <= 0) {
  return 
# 32 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
        ((void *)0)
# 32 "/workspace/acl/lib_fiber/c/src/common/array.c"
            ;
 }
...
static void *array_iter_head(ITER *iter, struct ARRAY *a)
{
 iter->dlen = -1;
 iter->key = 
# 57 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
            ((void *)0)
# 57 "/workspace/acl/lib_fiber/c/src/common/array.c"
                ;
 iter->klen = 0;
 iter->i = 0;
 iter->size = a->count;
 if (a->items == 
# 61 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
                ((void *)0) 
# 61 "/workspace/acl/lib_fiber/c/src/common/array.c"
                     || a->count <= 0) {
...
static void *array_iter_tail(ITER *iter, struct ARRAY *a)
{
 iter->dlen = -1;
 iter->key = 
# 88 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
            ((void *)0)
# 88 "/workspace/acl/lib_fiber/c/src/common/array.c"
                ;
 iter->klen = 0;
 iter->i = a->count - 1;
 iter->size = a->count;
 if (a->items == 
# 92 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
                ((void *)0) 
# 92 "/workspace/acl/lib_fiber/c/src/common/array.c"
                     || iter->i < 0) {
  iter->ptr = iter->data = 0;
 } else {
  iter->data = iter->ptr = a->items[iter->i];
...
static void array_grow(ARRAY *a, int min_capacity)
{
 ...
 if (a->items == 
# 136 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
                ((void *)0)
# 136 "/workspace/acl/lib_fiber/c/src/common/array.c"
                    ) {
...
void array_clean(ARRAY *a, void (*free_fn)(void *))
{
 ...
 for(idx = 0; idx < a->count; idx++) {
  if(free_fn != 
# 176 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
               ((void *)0) 
# 176 "/workspace/acl/lib_fiber/c/src/common/array.c"
                    && a->items[idx] != 
# 176 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
                                        ((void *)0)
# 176 "/workspace/acl/lib_fiber/c/src/common/array.c"
  ...
  a->items[idx] = 
# 179 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
                 ((void *)0)
# 179 "/workspace/acl/lib_fiber/c/src/common/array.c"
                     ;
 }
 a->count = 0;
}
...
# 259 "/workspace/acl/lib_fiber/c/src/common/array.c"
...
int array_delete(ARRAY *a, int pos, void (*free_fn)(void*))
{
 ...
 if (free_fn != 
# 278 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
               ((void *)0) 
# 278 "/workspace/acl/lib_fiber/c/src/common/array.c"
                    && a->items[pos] != 
# 278 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
                                        ((void *)0)
# 278 "/workspace/acl/lib_fiber/c/src/common/array.c"
...
int array_delete_obj(ARRAY *a, void *obj, void (*free_fn)(void *))
{
 ...
 if (free_fn != 
# 309 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
               ((void *)0) 
# 309 "/workspace/acl/lib_fiber/c/src/common/array.c"
                    && obj != 
# 309 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
                              ((void *)0)
# 309 "/workspace/acl/lib_fiber/c/src/common/array.c"
 ...
 return array_delete(a, pos, 
# 317 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
                            ((void *)0)
# 317 "/workspace/acl/lib_fiber/c/src/common/array.c"
                                );
}
 ...
 void (*free_fn)(void*))
{
 ...
 if (free_fn != 
# 338 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
               ((void *)0)
# 338 "/workspace/acl/lib_fiber/c/src/common/array.c"
                   ) {
  for (i = ibegin; i <= iend; i++) {
   if (a->items[i] != 
# 340 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
                     ((void *)0)
# 340 "/workspace/acl/lib_fiber/c/src/common/array.c"
                         ) {
    free_fn(a->items[i]);
   }
   a->items[i] = 
# 343 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
                ((void *)0)
# 343 "/workspace/acl/lib_fiber/c/src/common/array.c"
                    ;
  }
 }
...
int array_mv_idx(ARRAY *a, int ito, int ifrom, void (*free_fn)(void *))
{
 ...
 if (free_fn != 
# 372 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
               ((void *)0)
# 372 "/workspace/acl/lib_fiber/c/src/common/array.c"
                   ) {
  for (i = i_obj; i < i_src; i++) {
   if (a->items[i] != 
# 374 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
                     ((void *)0)
# 374 "/workspace/acl/lib_fiber/c/src/common/array.c"
                         ) {
    free_fn(a->items[i]);
   }
   a->items[i] = 
# 377 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
                ((void *)0)
# 377 "/workspace/acl/lib_fiber/c/src/common/array.c"
                    ;
  }
 }
...
void array_pre_append(ARRAY *a, int app_count)
{
 ...
 if (app_count <= 0) {
  msg_fatal("%s(%d)->%s: invalid input", "/workspace/acl/lib_fiber/c/src/common/array.c", 400, name);
 }
...
void *array_index(const ARRAY *a, int idx)
{
 if (idx < 0 || idx > a->count - 1) {
  return 
# 411 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
        ((void *)0)
# 411 "/workspace/acl/lib_fiber/c/src/common/array.c"
            ;
 }
...
void *array_head(ARRAY *a)
{
 if (a->count > 0) {
  ...
  return 
# 427 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
        ((void *)0)
# 427 "/workspace/acl/lib_fiber/c/src/common/array.c"
            ;
 }
}
...
void *array_tail(ARRAY *a)
{
 if (a->count > 0) {
  ...
  return 
# 436 "/workspace/acl/lib_fiber/c/src/common/array.c" 3 4
        ((void *)0)
# 436 "/workspace/acl/lib_fiber/c/src/common/array.c"
            ;
 }
}
