# 0 "/acl/lib_fiber/c/src/common/array.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/common/array.c"
...
# 2 "/acl/lib_fiber/c/src/common/array.c" 2
...
# 3 "/acl/lib_fiber/c/src/common/array.c" 2
...
# 4 "/acl/lib_fiber/c/src/common/array.c" 2
...
# 5 "/acl/lib_fiber/c/src/common/array.c" 2
...
void *array_pop_back(struct ARRAY *a)
{
 ...
 if (a->count <= 0) {
  return 
# 20 "/acl/lib_fiber/c/src/common/array.c" 3 4
        ((void *)0)
# 20 "/acl/lib_fiber/c/src/common/array.c"
            ;
 }
 a->count--;
 obj = a->items[a->count];
...
void *array_pop_front(struct ARRAY *a)
{
 ...
 if (a->count <= 0) {
  return 
# 32 "/acl/lib_fiber/c/src/common/array.c" 3 4
        ((void *)0)
# 32 "/acl/lib_fiber/c/src/common/array.c"
            ;
 }
...
static void *array_iter_head(ITER *iter, struct ARRAY *a)
{
 iter->dlen = -1;
 iter->key = 
# 57 "/acl/lib_fiber/c/src/common/array.c" 3 4
            ((void *)0)
# 57 "/acl/lib_fiber/c/src/common/array.c"
                ;
 iter->klen = 0;
 iter->i = 0;
 iter->size = a->count;
 if (a->items == 
# 61 "/acl/lib_fiber/c/src/common/array.c" 3 4
                ((void *)0) 
# 61 "/acl/lib_fiber/c/src/common/array.c"
                     || a->count <= 0) {
...
static void *array_iter_tail(ITER *iter, struct ARRAY *a)
{
 iter->dlen = -1;
 iter->key = 
# 88 "/acl/lib_fiber/c/src/common/array.c" 3 4
            ((void *)0)
# 88 "/acl/lib_fiber/c/src/common/array.c"
                ;
 iter->klen = 0;
 iter->i = a->count - 1;
 iter->size = a->count;
 if (a->items == 
# 92 "/acl/lib_fiber/c/src/common/array.c" 3 4
                ((void *)0) 
# 92 "/acl/lib_fiber/c/src/common/array.c"
                     || iter->i < 0) {
  iter->ptr = iter->data = 0;
 } else {
  iter->data = iter->ptr = a->items[iter->i];
...
static void array_grow(ARRAY *a, int min_capacity)
{
 ...
 if (a->items == 
# 136 "/acl/lib_fiber/c/src/common/array.c" 3 4
                ((void *)0)
# 136 "/acl/lib_fiber/c/src/common/array.c"
                    ) {
...
void array_clean(ARRAY *a, void (*free_fn)(void *))
{
 ...
 for(idx = 0; idx < a->count; idx++) {
  if(free_fn != 
# 176 "/acl/lib_fiber/c/src/common/array.c" 3 4
               ((void *)0) 
# 176 "/acl/lib_fiber/c/src/common/array.c"
                    && a->items[idx] != 
# 176 "/acl/lib_fiber/c/src/common/array.c" 3 4
                                        ((void *)0)
# 176 "/acl/lib_fiber/c/src/common/array.c"
  ...
  a->items[idx] = 
# 179 "/acl/lib_fiber/c/src/common/array.c" 3 4
                 ((void *)0)
# 179 "/acl/lib_fiber/c/src/common/array.c"
                     ;
 }
 a->count = 0;
}
...
# 259 "/acl/lib_fiber/c/src/common/array.c"
...
int array_delete(ARRAY *a, int pos, void (*free_fn)(void*))
{
 ...
 if (free_fn != 
# 278 "/acl/lib_fiber/c/src/common/array.c" 3 4
               ((void *)0) 
# 278 "/acl/lib_fiber/c/src/common/array.c"
                    && a->items[pos] != 
# 278 "/acl/lib_fiber/c/src/common/array.c" 3 4
                                        ((void *)0)
# 278 "/acl/lib_fiber/c/src/common/array.c"
...
int array_delete_obj(ARRAY *a, void *obj, void (*free_fn)(void *))
{
 ...
 if (free_fn != 
# 309 "/acl/lib_fiber/c/src/common/array.c" 3 4
               ((void *)0) 
# 309 "/acl/lib_fiber/c/src/common/array.c"
                    && obj != 
# 309 "/acl/lib_fiber/c/src/common/array.c" 3 4
                              ((void *)0)
# 309 "/acl/lib_fiber/c/src/common/array.c"
...
# 317 "/acl/lib_fiber/c/src/common/array.c" 3 4
                            ((void *)0)
# 317 "/acl/lib_fiber/c/src/common/array.c"
                                );
}
 ...
 void (*free_fn)(void*))
{
 ...
 if (free_fn != 
# 338 "/acl/lib_fiber/c/src/common/array.c" 3 4
               ((void *)0)
# 338 "/acl/lib_fiber/c/src/common/array.c"
                   ) {
  for (i = ibegin; i <= iend; i++) {
   if (a->items[i] != 
# 340 "/acl/lib_fiber/c/src/common/array.c" 3 4
                     ((void *)0)
# 340 "/acl/lib_fiber/c/src/common/array.c"
                         ) {
    free_fn(a->items[i]);
   }
   a->items[i] = 
# 343 "/acl/lib_fiber/c/src/common/array.c" 3 4
                ((void *)0)
# 343 "/acl/lib_fiber/c/src/common/array.c"
                    ;
  }
 }
...
int array_mv_idx(ARRAY *a, int ito, int ifrom, void (*free_fn)(void *))
{
 ...
 if (free_fn != 
# 372 "/acl/lib_fiber/c/src/common/array.c" 3 4
               ((void *)0)
# 372 "/acl/lib_fiber/c/src/common/array.c"
                   ) {
  for (i = i_obj; i < i_src; i++) {
   if (a->items[i] != 
# 374 "/acl/lib_fiber/c/src/common/array.c" 3 4
                     ((void *)0)
# 374 "/acl/lib_fiber/c/src/common/array.c"
                         ) {
    free_fn(a->items[i]);
   }
   a->items[i] = 
# 377 "/acl/lib_fiber/c/src/common/array.c" 3 4
                ((void *)0)
# 377 "/acl/lib_fiber/c/src/common/array.c"
                    ;
  }
 }
...
void array_pre_append(ARRAY *a, int app_count)
{
 ...
 if (app_count <= 0) {
  msg_fatal("%s(%d)->%s: invalid input", "/acl/lib_fiber/c/src/common/array.c", 400, name);
 }
...
void *array_index(const ARRAY *a, int idx)
{
 if (idx < 0 || idx > a->count - 1) {
  return 
# 411 "/acl/lib_fiber/c/src/common/array.c" 3 4
        ((void *)0)
# 411 "/acl/lib_fiber/c/src/common/array.c"
            ;
 }
...
void *array_head(ARRAY *a)
{
 if (a->count > 0) {
  ...
  return 
# 427 "/acl/lib_fiber/c/src/common/array.c" 3 4
        ((void *)0)
# 427 "/acl/lib_fiber/c/src/common/array.c"
            ;
 }
}
...
void *array_tail(ARRAY *a)
{
 if (a->count > 0) {
  ...
  return 
# 436 "/acl/lib_fiber/c/src/common/array.c" 3 4
        ((void *)0)
# 436 "/acl/lib_fiber/c/src/common/array.c"
            ;
 }
}
