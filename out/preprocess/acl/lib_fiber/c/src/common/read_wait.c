# 1 "/workspace/acl/lib_fiber/c/src/common/read_wait.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/common/read_wait.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/common/read_wait.c" 2
...
# 5 "/workspace/acl/lib_fiber/c/src/fiber.h" 2
...
# 1 "/workspace/acl/lib_fiber/c/src/define.h" 1
# 5 "/workspace/acl/lib_fiber/c/src/common/gettimeofday.h" 2
...
# 7 "/workspace/acl/lib_fiber/c/src/event.h" 2
# 18 "/workspace/acl/lib_fiber/c/src/event.h"
...
# 19 "/workspace/acl/lib_fiber/c/src/event.h" 2
...
# 4 "/workspace/acl/lib_fiber/c/src/common/read_wait.c" 2
...
# 5 "/workspace/acl/lib_fiber/c/src/common/read_wait.c" 2
...
# 6 "/workspace/acl/lib_fiber/c/src/common/read_wait.c" 2
...
int read_wait(socket_t fd, int delay)
{
 ...
 fds.events = 
# 11 "/workspace/acl/lib_fiber/c/src/common/read_wait.c" 3 4
             0x001
# 11 "/workspace/acl/lib_fiber/c/src/common/read_wait.c"
                   ;
 fds.fd = fd;
...
# 21 "/workspace/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                                4
# 21 "/workspace/acl/lib_fiber/c/src/common/read_wait.c"
                                           ) {
    continue;
   }
   return -1;
  case 0:
   acl_fiber_set_error(
# 26 "/workspace/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                      62
# 26 "/workspace/acl/lib_fiber/c/src/common/read_wait.c"
                                 );
   return -1;
  default:
   if ((fds.revents & 
# 29 "/workspace/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                     0x001
# 29 "/workspace/acl/lib_fiber/c/src/common/read_wait.c"
                           )) {
    return 0;
   }
   if (fds.revents & (
# 32 "/workspace/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                     0x010 
# 32 "/workspace/acl/lib_fiber/c/src/common/read_wait.c"
                             | 
# 32 "/workspace/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                               0x008 
# 32 "/workspace/acl/lib_fiber/c/src/common/read_wait.c"
...
static int readable(socket_t fd)
{
 ...
 fds.events = 
# 50 "/workspace/acl/lib_fiber/c/src/common/read_wait.c" 3 4
             0x001 
# 50 "/workspace/acl/lib_fiber/c/src/common/read_wait.c"
                    | 
# 50 "/workspace/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                      0x010 
# 50 "/workspace/acl/lib_fiber/c/src/common/read_wait.c"
...
# 50 "/workspace/acl/lib_fiber/c/src/common/read_wait.c"
 ...
 for (;;) {
  ...
  case -1:
   ...
   if (acl_fiber_last_error() == 
# 61 "/workspace/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                                4
# 61 "/workspace/acl/lib_fiber/c/src/common/read_wait.c"
                                           ) {
    continue;
   }
  ...
  default:
   if ((fds.revents & 
# 69 "/workspace/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                     0x001
# 69 "/workspace/acl/lib_fiber/c/src/common/read_wait.c"
                           )) {
    return 1;
   } else if (fds.revents & (
# 71 "/workspace/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                            0x010 
# 71 "/workspace/acl/lib_fiber/c/src/common/read_wait.c"
                                    | 
# 71 "/workspace/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                                      0x008
# 71 "/workspace/acl/lib_fiber/c/src/common/read_wait.c"
...
int socket_alive(socket_t fd)
{
 ...
 ret = (int) acl_fiber_recv(fd, buf, sizeof(buf), 
# 93 "/workspace/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                                                 MSG_PEEK
# 93 "/workspace/acl/lib_fiber/c/src/common/read_wait.c"
                                                         );
 ...
 if (ret < 0 && acl_fiber_last_error() != 
# 99 "/workspace/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                                         11
# 99 "/workspace/acl/lib_fiber/c/src/common/read_wait.c"
                                                          ) {
  return 0;
 }
