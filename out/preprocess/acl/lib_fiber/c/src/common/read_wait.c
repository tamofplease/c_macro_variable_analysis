# 0 "/acl/lib_fiber/c/src/common/read_wait.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/common/read_wait.c"
...
# 2 "/acl/lib_fiber/c/src/common/read_wait.c" 2
...
# 3 "/acl/lib_fiber/c/src/common/read_wait.c" 2
...
# 5 "/acl/lib_fiber/c/src/fiber.h" 2
...
# 1 "/acl/lib_fiber/c/src/define.h" 1
# 5 "/acl/lib_fiber/c/src/common/gettimeofday.h" 2
...
# 7 "/acl/lib_fiber/c/src/event.h" 2
# 18 "/acl/lib_fiber/c/src/event.h"
...
# 19 "/acl/lib_fiber/c/src/event.h" 2
...
# 4 "/acl/lib_fiber/c/src/common/read_wait.c" 2
...
# 5 "/acl/lib_fiber/c/src/common/read_wait.c" 2
...
# 6 "/acl/lib_fiber/c/src/common/read_wait.c" 2
...
int read_wait(socket_t fd, int delay)
{
 ...
 fds.events = 
# 11 "/acl/lib_fiber/c/src/common/read_wait.c" 3 4
             0x001
# 11 "/acl/lib_fiber/c/src/common/read_wait.c"
                   ;
 fds.fd = fd;
...
# 21 "/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                                4
# 21 "/acl/lib_fiber/c/src/common/read_wait.c"
                                           ) {
    continue;
   }
   return -1;
  case 0:
   acl_fiber_set_error(
# 26 "/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                      62
# 26 "/acl/lib_fiber/c/src/common/read_wait.c"
                                 );
   return -1;
  default:
   if ((fds.revents & 
# 29 "/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                     0x001
# 29 "/acl/lib_fiber/c/src/common/read_wait.c"
                           )) {
    return 0;
   }
   if (fds.revents & (
# 32 "/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                     0x010 
# 32 "/acl/lib_fiber/c/src/common/read_wait.c"
                             | 
# 32 "/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                               0x008 
# 32 "/acl/lib_fiber/c/src/common/read_wait.c"
...
static int readable(socket_t fd)
{
 ...
 fds.events = 
# 50 "/acl/lib_fiber/c/src/common/read_wait.c" 3 4
             0x001 
# 50 "/acl/lib_fiber/c/src/common/read_wait.c"
                    | 
# 50 "/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                      0x010 
# 50 "/acl/lib_fiber/c/src/common/read_wait.c"
...
# 50 "/acl/lib_fiber/c/src/common/read_wait.c"
 ...
 for (;;) {
  ...
  case -1:
   ...
   if (acl_fiber_last_error() == 
# 61 "/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                                4
# 61 "/acl/lib_fiber/c/src/common/read_wait.c"
                                           ) {
    continue;
   }
  ...
  default:
   if ((fds.revents & 
# 69 "/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                     0x001
# 69 "/acl/lib_fiber/c/src/common/read_wait.c"
                           )) {
    return 1;
   } else if (fds.revents & (
# 71 "/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                            0x010 
# 71 "/acl/lib_fiber/c/src/common/read_wait.c"
                                    | 
# 71 "/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                                      0x008
# 71 "/acl/lib_fiber/c/src/common/read_wait.c"
...
# 93 "/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                                                 MSG_PEEK
# 93 "/acl/lib_fiber/c/src/common/read_wait.c"
                                                         );
...
# 99 "/acl/lib_fiber/c/src/common/read_wait.c" 3 4
                                         11
# 99 "/acl/lib_fiber/c/src/common/read_wait.c"
                                                          ) {
  return 0;
 }
