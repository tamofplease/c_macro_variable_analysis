# 1 "/workspace/acl/lib_fiber/c/src/common/non_blocking.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/common/non_blocking.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/common/non_blocking.c" 2
...
# 5 "/workspace/acl/lib_fiber/c/src/common/non_blocking.c" 2
...
# 6 "/workspace/acl/lib_fiber/c/src/common/non_blocking.c" 2
# 42 "/workspace/acl/lib_fiber/c/src/common/non_blocking.c"
int non_blocking(socket_t fd, int on)
{
 int flags;
 int nonb = 
# 45 "/workspace/acl/lib_fiber/c/src/common/non_blocking.c" 3 4
             04000
# 45 "/workspace/acl/lib_fiber/c/src/common/non_blocking.c"
                    ;
# 60 "/workspace/acl/lib_fiber/c/src/common/non_blocking.c"
 if ((flags = fcntl(fd, 
# 60 "/workspace/acl/lib_fiber/c/src/common/non_blocking.c" 3 4
                       3
# 60 "/workspace/acl/lib_fiber/c/src/common/non_blocking.c"
                              )) == -1) {
  msg_error("%s(%d), %s: fcntl(%d, F_GETFL) error: %s",
   "/workspace/acl/lib_fiber/c/src/common/non_blocking.c", 62, __FUNCTION__, fd, last_serror());
  return -1;
 }
 if (fcntl(fd, 
# 65 "/workspace/acl/lib_fiber/c/src/common/non_blocking.c" 3 4
              4
# 65 "/workspace/acl/lib_fiber/c/src/common/non_blocking.c"
                     , on ? flags | nonb : flags & ~nonb) < 0) {
  msg_error("%s(%d), %s: fcntl(%d, F_SETL, nonb) error: %s",
   "/workspace/acl/lib_fiber/c/src/common/non_blocking.c", 67, __FUNCTION__, fd, last_serror());
  return -1;
 }

 return (flags & 
# 71 "/workspace/acl/lib_fiber/c/src/common/non_blocking.c" 3 4
                04000
# 71 "/workspace/acl/lib_fiber/c/src/common/non_blocking.c"
                       ) ? 1 : 0;
}
...
int is_non_blocking(socket_t fd)
{
 ...
 if ((flags = fcntl(fd, 
# 78 "/workspace/acl/lib_fiber/c/src/common/non_blocking.c" 3 4
                       3
# 78 "/workspace/acl/lib_fiber/c/src/common/non_blocking.c"
                              )) == -1) {
  msg_error("%s(%d), %s: fcntl(%d, F_GETFL) error: %s",
   "/workspace/acl/lib_fiber/c/src/common/non_blocking.c", 80, __FUNCTION__,
   fd, last_serror());
  return 0;
 }

 return (flags & 
# 85 "/workspace/acl/lib_fiber/c/src/common/non_blocking.c" 3 4
                04000
# 85 "/workspace/acl/lib_fiber/c/src/common/non_blocking.c"
                       ) ? 1 : 0;
}
