# 0 "/acl/lib_fiber/c/src/common/htable.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/common/htable.c"
...
# 2 "/acl/lib_fiber/c/src/common/htable.c" 2
...
# 3 "/acl/lib_fiber/c/src/common/htable.c" 2
...
# 4 "/acl/lib_fiber/c/src/common/htable.c" 2
...
# 9 "/acl/lib_fiber/c/src/common/htable.h" 2
...
# 5 "/acl/lib_fiber/c/src/common/htable.c" 2
...
{
 HTABLE_INFO *ptr = 
# 10 "/acl/lib_fiber/c/src/common/htable.c" 3 4
                   ((void *)0)
# 10 "/acl/lib_fiber/c/src/common/htable.c"
                       ;
 ...
 iter->ptr = 
# 16 "/acl/lib_fiber/c/src/common/htable.c" 3 4
            ((void *)0)
# 16 "/acl/lib_fiber/c/src/common/htable.c"
                ;

 for (; iter->i < iter->size; iter->i++) {
  if (table->data[iter->i] != 
# 19 "/acl/lib_fiber/c/src/common/htable.c" 3 4
                             ((void *)0)
# 19 "/acl/lib_fiber/c/src/common/htable.c"
                                 ) {
 ...
 if (ptr) {
  ...
  iter->data = 
# 29 "/acl/lib_fiber/c/src/common/htable.c" 3 4
              ((void *)0)
# 29 "/acl/lib_fiber/c/src/common/htable.c"
                  ;
  iter->key = 
# 30 "/acl/lib_fiber/c/src/common/htable.c" 3 4
             ((void *)0)
# 30 "/acl/lib_fiber/c/src/common/htable.c"
                 ;
 }
 return (iter->ptr);
}
...
static void *htable_iter_next(ITER *iter, HTABLE *table)
{
 ...
 if (ptr) {
  ...
  if (ptr != 
# 44 "/acl/lib_fiber/c/src/common/htable.c" 3 4
            ((void *)0)
# 44 "/acl/lib_fiber/c/src/common/htable.c"
                ) {
   iter->data = ptr->value;
   iter->key = ptr->key;
   return (iter->ptr);
 ...
 for (iter->i++; iter->i < iter->size; iter->i++) {
  if (table->data[iter->i] != 
# 52 "/acl/lib_fiber/c/src/common/htable.c" 3 4
                             ((void *)0)
# 52 "/acl/lib_fiber/c/src/common/htable.c"
                                 ) {
   iter->ptr = ptr = table->data[iter->i];
   break;
  }
 ...
 if (ptr) {
  ...
  iter->data = 
# 62 "/acl/lib_fiber/c/src/common/htable.c" 3 4
              ((void *)0)
# 62 "/acl/lib_fiber/c/src/common/htable.c"
                  ;
  iter->key = 
# 63 "/acl/lib_fiber/c/src/common/htable.c" 3 4
             ((void *)0)
# 63 "/acl/lib_fiber/c/src/common/htable.c"
                 ;
 }
 return (iter->ptr);
}
...
{
 HTABLE_INFO *ptr = 
# 72 "/acl/lib_fiber/c/src/common/htable.c" 3 4
                   ((void *)0)
# 72 "/acl/lib_fiber/c/src/common/htable.c"
                       ;
 ...
 iter->size = table->size;
 iter->ptr = 
# 78 "/acl/lib_fiber/c/src/common/htable.c" 3 4
            ((void *)0)
# 78 "/acl/lib_fiber/c/src/common/htable.c"
                ;

 for (; iter->i >= 0; iter->i--) {
  if (table->data[iter->i] != 
# 81 "/acl/lib_fiber/c/src/common/htable.c" 3 4
                             ((void *)0)
# 81 "/acl/lib_fiber/c/src/common/htable.c"
                                 ) {
   iter->ptr = ptr = table->data[iter->i];
   break;
  }
 ...
 if (ptr) {
  ...
  iter->data = 
# 91 "/acl/lib_fiber/c/src/common/htable.c" 3 4
              ((void *)0)
# 91 "/acl/lib_fiber/c/src/common/htable.c"
                  ;
  iter->key = 
# 92 "/acl/lib_fiber/c/src/common/htable.c" 3 4
             ((void *)0)
# 92 "/acl/lib_fiber/c/src/common/htable.c"
                 ;
 }
 return (iter->ptr);
}
...
static void *htable_iter_prev(ITER *iter, HTABLE *table)
{
 ...
 if (ptr) {
  iter->ptr = ptr = ptr->next;
  if (ptr != 
# 106 "/acl/lib_fiber/c/src/common/htable.c" 3 4
            ((void *)0)
# 106 "/acl/lib_fiber/c/src/common/htable.c"
                ) {
   iter->data = ptr->value;
   iter->key = ptr->key;
   return (iter->ptr);
 ...
 for (iter->i--; iter->i >= 0; iter->i--) {
  if (table->data[iter->i] != 
# 114 "/acl/lib_fiber/c/src/common/htable.c" 3 4
                             ((void *)0)
# 114 "/acl/lib_fiber/c/src/common/htable.c"
                                 ) {
   iter->ptr = ptr = table->data[iter->i];
   break;
  }
 ...
 if (ptr) {
  ...
  iter->data = 
# 124 "/acl/lib_fiber/c/src/common/htable.c" 3 4
              ((void *)0)
# 124 "/acl/lib_fiber/c/src/common/htable.c"
                  ;
  iter->key = 
# 125 "/acl/lib_fiber/c/src/common/htable.c" 3 4
             ((void *)0)
# 125 "/acl/lib_fiber/c/src/common/htable.c"
                 ;
 }
 return (iter->ptr);
}
...
# 135 "/acl/lib_fiber/c/src/common/htable.c" 3 4
                                               ((void *)0)
# 135 "/acl/lib_fiber/c/src/common/htable.c"
                                                   );
}
...
# 173 "/acl/lib_fiber/c/src/common/htable.c"
static int __htable_size(HTABLE *table, unsigned size)
{
 ...
 if(table->data == 
# 180 "/acl/lib_fiber/c/src/common/htable.c" 3 4
                  ((void *)0)
# 180 "/acl/lib_fiber/c/src/common/htable.c"
                      ) {
  return -1;
 }
...
HTABLE *htable_create(int size)
{
 ...
 if (table == 
# 229 "/acl/lib_fiber/c/src/common/htable.c" 3 4
             ((void *)0)
# 229 "/acl/lib_fiber/c/src/common/htable.c"
                 ) {
  return 
# 230 "/acl/lib_fiber/c/src/common/htable.c" 3 4
        ((void *)0)
# 230 "/acl/lib_fiber/c/src/common/htable.c"
            ;
 }
 ...
 if(ret < 0) {
  mem_free(table);
  return 
# 237 "/acl/lib_fiber/c/src/common/htable.c" 3 4
        ((void *)0)
# 237 "/acl/lib_fiber/c/src/common/htable.c"
            ;
 }
...
{
 if (table == 
# 251 "/acl/lib_fiber/c/src/common/htable.c" 3 4
             ((void *)0)
# 251 "/acl/lib_fiber/c/src/common/htable.c"
                 ) {
  return 1;
 }
 return table->status;
...
HTABLE_INFO *htable_enter(HTABLE *table, const char *key, void *value)
{
 ...
 if (table->used >= table->size) {
  ...
  if(ret < 0) {
   return 
# 280 "/acl/lib_fiber/c/src/common/htable.c" 3 4
         ((void *)0)
# 280 "/acl/lib_fiber/c/src/common/htable.c"
             ;
  }
 }
 ...
 if (ht == 
# 296 "/acl/lib_fiber/c/src/common/htable.c" 3 4
          ((void *)0)
# 296 "/acl/lib_fiber/c/src/common/htable.c"
              ) {
  msg_error("%s(%d): alloc error", __FUNCTION__, 297);
  return 
# 298 "/acl/lib_fiber/c/src/common/htable.c" 3 4
        ((void *)0)
# 298 "/acl/lib_fiber/c/src/common/htable.c"
            ;
 }
 ...
 if (ht->key == 
# 306 "/acl/lib_fiber/c/src/common/htable.c" 3 4
               ((void *)0)
# 306 "/acl/lib_fiber/c/src/common/htable.c"
                   ) {
  msg_error("%s(%d): alloc error", __FUNCTION__, 307);
  mem_free(ht);
  return 
# 309 "/acl/lib_fiber/c/src/common/htable.c" 3 4
        ((void *)0)
# 309 "/acl/lib_fiber/c/src/common/htable.c"
            ;
 }
 ht->hash = hash;
 ht->value = value;
...
void *htable_find(HTABLE *table, const char *key)
{
 ...
 return ht != 
# 324 "/acl/lib_fiber/c/src/common/htable.c" 3 4
             ((void *)0) 
# 324 "/acl/lib_fiber/c/src/common/htable.c"
                  ? ht->value : 
# 324 "/acl/lib_fiber/c/src/common/htable.c" 3 4
                                ((void *)0)
# 324 "/acl/lib_fiber/c/src/common/htable.c"
...
HTABLE_INFO *htable_locate(HTABLE *table, const char *key)
{
 ...
 return 
# 343 "/acl/lib_fiber/c/src/common/htable.c" 3 4
       ((void *)0)
# 343 "/acl/lib_fiber/c/src/common/htable.c"
           ;
}
...
# 478 "/acl/lib_fiber/c/src/common/htable.c"
HTABLE_INFO **htable_list(const HTABLE *table)
{
 HTABLE_INFO **list;
 HTABLE_INFO *member;
