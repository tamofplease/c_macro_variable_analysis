# 1 "/workspace/acl/lib_fiber/c/src/common/htable.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/common/htable.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/common/htable.c" 2
...
# 4 "/workspace/acl/lib_fiber/c/src/common/htable.c" 2
...
# 9 "/workspace/acl/lib_fiber/c/src/common/htable.h" 2
...
# 5 "/workspace/acl/lib_fiber/c/src/common/htable.c" 2
...
{
 HTABLE_INFO *ptr = 
# 10 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
                   ((void *)0)
# 10 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                       ;
 ...
 iter->ptr = 
# 16 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
            ((void *)0)
# 16 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                ;

 for (; iter->i < iter->size; iter->i++) {
  if (table->data[iter->i] != 
# 19 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
                             ((void *)0)
# 19 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                                 ) {
 ...
 if (ptr) {
  ...
  iter->data = 
# 29 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
              ((void *)0)
# 29 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                  ;
  iter->key = 
# 30 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
             ((void *)0)
# 30 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                 ;
 }
 return (iter->ptr);
}
...
static void *htable_iter_next(ITER *iter, HTABLE *table)
{
 ...
 if (ptr) {
  ...
  if (ptr != 
# 44 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
            ((void *)0)
# 44 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                ) {
   iter->data = ptr->value;
   iter->key = ptr->key;
   return (iter->ptr);
 ...
 for (iter->i++; iter->i < iter->size; iter->i++) {
  if (table->data[iter->i] != 
# 52 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
                             ((void *)0)
# 52 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                                 ) {
   iter->ptr = ptr = table->data[iter->i];
   break;
  }
 ...
 if (ptr) {
  ...
  iter->data = 
# 62 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
              ((void *)0)
# 62 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                  ;
  iter->key = 
# 63 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
             ((void *)0)
# 63 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                 ;
 }
 return (iter->ptr);
}
...
{
 HTABLE_INFO *ptr = 
# 72 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
                   ((void *)0)
# 72 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                       ;
 ...
 iter->size = table->size;
 iter->ptr = 
# 78 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
            ((void *)0)
# 78 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                ;

 for (; iter->i >= 0; iter->i--) {
  if (table->data[iter->i] != 
# 81 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
                             ((void *)0)
# 81 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                                 ) {
   iter->ptr = ptr = table->data[iter->i];
   break;
  }
 ...
 if (ptr) {
  ...
  iter->data = 
# 91 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
              ((void *)0)
# 91 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                  ;
  iter->key = 
# 92 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
             ((void *)0)
# 92 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                 ;
 }
 return (iter->ptr);
}
...
static void *htable_iter_prev(ITER *iter, HTABLE *table)
{
 ...
 if (ptr) {
  iter->ptr = ptr = ptr->next;
  if (ptr != 
# 106 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
            ((void *)0)
# 106 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                ) {
   iter->data = ptr->value;
   iter->key = ptr->key;
   return (iter->ptr);
 ...
 for (iter->i--; iter->i >= 0; iter->i--) {
  if (table->data[iter->i] != 
# 114 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
                             ((void *)0)
# 114 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                                 ) {
   iter->ptr = ptr = table->data[iter->i];
   break;
  }
 ...
 if (ptr) {
  ...
  iter->data = 
# 124 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
              ((void *)0)
# 124 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                  ;
  iter->key = 
# 125 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
             ((void *)0)
# 125 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                 ;
 }
 return (iter->ptr);
}
...
{
 (void) table;
 return (iter->ptr ? (HTABLE_INFO*) iter->ptr : 
# 135 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
                                               ((void *)0)
# 135 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                                                   );
}
...
# 173 "/workspace/acl/lib_fiber/c/src/common/htable.c"
static int __htable_size(HTABLE *table, unsigned size)
{
 ...
 if(table->data == 
# 180 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
                  ((void *)0)
# 180 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                      ) {
  return -1;
 }
...
static int htable_grow(HTABLE *table)
{
 ...
 while (old_size-- > 0) {
  for (ht = *h0++; ht; ht = next) {
   ...
   { HTABLE_INFO **_h = table->data + n; ht->prev = 0; if ((ht->next = *_h) != 0) (*_h)->prev = ht; *_h = ht; table->used++; };
  }
 }
...
HTABLE *htable_create(int size)
{
 ...
 if (table == 
# 229 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
             ((void *)0)
# 229 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                 ) {
  return 
# 230 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
        ((void *)0)
# 230 "/workspace/acl/lib_fiber/c/src/common/htable.c"
            ;
 }
 ...
 if(ret < 0) {
  mem_free(table);
  return 
# 237 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
        ((void *)0)
# 237 "/workspace/acl/lib_fiber/c/src/common/htable.c"
            ;
 }
...
{
 if (table == 
# 251 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
             ((void *)0)
# 251 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                 ) {
  return 1;
 }
 return table->status;
...
HTABLE_INFO *htable_enter(HTABLE *table, const char *key, void *value)
{
 ...
 if (table->used >= table->size) {
  ...
  if(ret < 0) {
   return 
# 280 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
         ((void *)0)
# 280 "/workspace/acl/lib_fiber/c/src/common/htable.c"
             ;
  }
 }
 ...
 for (ht = table->data[n]; ht; ht = ht->next) {
  if ((key == ht->key || (key[0] == ht->key[0] && strcmp(key,ht->key) == 0))) {
   table->status = 2;
   msg_info("%s(%d): duplex key(%s) exist",
    __FUNCTION__, 290, key);
   return ht;
  }
 }
 ...
 if (ht == 
# 296 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
          ((void *)0)
# 296 "/workspace/acl/lib_fiber/c/src/common/htable.c"
              ) {
  msg_error("%s(%d): alloc error", __FUNCTION__, 297);
  return 
# 298 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
        ((void *)0)
# 298 "/workspace/acl/lib_fiber/c/src/common/htable.c"
            ;
 }
 ...
 if (ht->key == 
# 306 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
               ((void *)0)
# 306 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                   ) {
  msg_error("%s(%d): alloc error", __FUNCTION__, 307);
  mem_free(ht);
  return 
# 309 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
        ((void *)0)
# 309 "/workspace/acl/lib_fiber/c/src/common/htable.c"
            ;
 }
 ht->hash = hash;
 ht->value = value;
...
void *htable_find(HTABLE *table, const char *key)
{
 ...
 return ht != 
# 324 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
             ((void *)0) 
# 324 "/workspace/acl/lib_fiber/c/src/common/htable.c"
                  ? ht->value : 
# 324 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
                                ((void *)0)
# 324 "/workspace/acl/lib_fiber/c/src/common/htable.c"
...
HTABLE_INFO *htable_locate(HTABLE *table, const char *key)
{
 ...
 return 
# 343 "/workspace/acl/lib_fiber/c/src/common/htable.c" 3 4
       ((void *)0)
# 343 "/workspace/acl/lib_fiber/c/src/common/htable.c"
           ;
}
...
# 478 "/workspace/acl/lib_fiber/c/src/common/htable.c"
HTABLE_INFO **htable_list(const HTABLE *table)
{
 HTABLE_INFO **list;
 HTABLE_INFO *member;
