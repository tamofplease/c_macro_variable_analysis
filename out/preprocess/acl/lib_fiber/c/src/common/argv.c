# 1 "/workspace/acl/lib_fiber/c/src/common/argv.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/common/argv.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/common/argv.c" 2
...
# 4 "/workspace/acl/lib_fiber/c/src/common/argv.c" 2
...
# 5 "/workspace/acl/lib_fiber/c/src/common/argv.c" 2
...
static char *argv_pop_back(struct ARGV *argvp)
{
 if (argvp->argc <= 0) {
  return 
# 45 "/workspace/acl/lib_fiber/c/src/common/argv.c" 3 4
        ((void *)0)
# 45 "/workspace/acl/lib_fiber/c/src/common/argv.c"
            ;
 }
...
static char *argv_pop_front(struct ARGV *argvp)
{
 ...
 if (argvp->argc <= 0) {
  return (
# 56 "/workspace/acl/lib_fiber/c/src/common/argv.c" 3 4
         ((void *)0)
# 56 "/workspace/acl/lib_fiber/c/src/common/argv.c"
             );
 }
 s = argvp->argv[0];
 argvp->argc--;
...
static void *argv_iter_head(ITER *iter, struct ARGV *argv)
{
 iter->dlen = -1;
 iter->key = 
# 71 "/workspace/acl/lib_fiber/c/src/common/argv.c" 3 4
             ((void *)0)
# 71 "/workspace/acl/lib_fiber/c/src/common/argv.c"
                 ;
 iter->klen = -1;
...
static void *argv_iter_tail(ITER *iter, struct ARGV *argv)
{
 iter->dlen = -1;
 iter->key = 
# 100 "/workspace/acl/lib_fiber/c/src/common/argv.c" 3 4
             ((void *)0)
# 100 "/workspace/acl/lib_fiber/c/src/common/argv.c"
                 ;
 iter->klen = -1;
...
ARGV *argv_free(ARGV *argvp)
{
 ...
 mem_free(argvp);
 return 
# 137 "/workspace/acl/lib_fiber/c/src/common/argv.c" 3 4
       ((void *)0)
# 137 "/workspace/acl/lib_fiber/c/src/common/argv.c"
           ;
}
...
# 180 "/workspace/acl/lib_fiber/c/src/common/argv.c" 3 4
__builtin_va_start(
# 180 "/workspace/acl/lib_fiber/c/src/common/argv.c"
ap
# 180 "/workspace/acl/lib_fiber/c/src/common/argv.c" 3 4
,
# 180 "/workspace/acl/lib_fiber/c/src/common/argv.c"
...
# 180 "/workspace/acl/lib_fiber/c/src/common/argv.c"
                   ;
 while ((arg = 
# 181 "/workspace/acl/lib_fiber/c/src/common/argv.c" 3 4
              __builtin_va_arg(
# 181 "/workspace/acl/lib_fiber/c/src/common/argv.c"
              ap
# 181 "/workspace/acl/lib_fiber/c/src/common/argv.c" 3 4
              ,
# 181 "/workspace/acl/lib_fiber/c/src/common/argv.c"
...
# 187 "/workspace/acl/lib_fiber/c/src/common/argv.c" 3 4
__builtin_va_end(
# 187 "/workspace/acl/lib_fiber/c/src/common/argv.c"
ap
# 187 "/workspace/acl/lib_fiber/c/src/common/argv.c" 3 4
)
# 187 "/workspace/acl/lib_fiber/c/src/common/argv.c"
...
void argv_addv(ARGV *argvp, va_list ap)
{
 ...
 while ((arg = 
# 197 "/workspace/acl/lib_fiber/c/src/common/argv.c" 3 4
              __builtin_va_arg(
# 197 "/workspace/acl/lib_fiber/c/src/common/argv.c"
              ap
# 197 "/workspace/acl/lib_fiber/c/src/common/argv.c" 3 4
              ,
# 197 "/workspace/acl/lib_fiber/c/src/common/argv.c"
...
{
 if (argvp == 
# 216 "/workspace/acl/lib_fiber/c/src/common/argv.c" 3 4
             ((void *)0)
# 216 "/workspace/acl/lib_fiber/c/src/common/argv.c"
                 )
  return -1;
