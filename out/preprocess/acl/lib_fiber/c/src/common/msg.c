# 0 "/acl/lib_fiber/c/src/common/msg.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/common/msg.c"
...
# 2 "/acl/lib_fiber/c/src/common/msg.c" 2
...
# 3 "/acl/lib_fiber/c/src/common/msg.c" 2
...
# 6 "/acl/lib_fiber/c/src/common/msg.c" 2
...
# 7 "/acl/lib_fiber/c/src/common/msg.c" 2
...
# 12 "/acl/lib_fiber/c/src/common/msg.c" 3 4
                                              ((void *)0)
# 12 "/acl/lib_fiber/c/src/common/msg.c"
                                                  ;
static FIBER_MSG_PRE_WRITE_FN __pre_write_fn = 
# 13 "/acl/lib_fiber/c/src/common/msg.c" 3 4
                                              ((void *)0)
# 13 "/acl/lib_fiber/c/src/common/msg.c"
                                                  ;

static void *__pre_write_ctx = 
# 15 "/acl/lib_fiber/c/src/common/msg.c" 3 4
                              ((void *)0)
# 15 "/acl/lib_fiber/c/src/common/msg.c"
                                  ;
static void *__msg_ctx = 
# 16 "/acl/lib_fiber/c/src/common/msg.c" 3 4
                              ((void *)0)
# 16 "/acl/lib_fiber/c/src/common/msg.c"
                                  ;

void acl_fiber_msg_register(FIBER_MSG_WRITE_FN write_fn, void *ctx)
{
 if (write_fn != 
# 20 "/acl/lib_fiber/c/src/common/msg.c" 3 4
                ((void *)0)
# 20 "/acl/lib_fiber/c/src/common/msg.c"
                    ) {
  __write_fn = write_fn;
  __msg_ctx = ctx;
 }
...
{
 __write_fn = 
# 28 "/acl/lib_fiber/c/src/common/msg.c" 3 4
                  ((void *)0)
# 28 "/acl/lib_fiber/c/src/common/msg.c"
                      ;
 __msg_ctx = 
# 29 "/acl/lib_fiber/c/src/common/msg.c" 3 4
                  ((void *)0)
# 29 "/acl/lib_fiber/c/src/common/msg.c"
                      ;
 __pre_write_fn = 
# 30 "/acl/lib_fiber/c/src/common/msg.c" 3 4
                  ((void *)0)
# 30 "/acl/lib_fiber/c/src/common/msg.c"
                      ;
 __pre_write_ctx = 
# 31 "/acl/lib_fiber/c/src/common/msg.c" 3 4
                  ((void *)0)
# 31 "/acl/lib_fiber/c/src/common/msg.c"
                      ;
}
...
# 49 "/acl/lib_fiber/c/src/common/msg.c" 3 4
__builtin_va_start(
# 49 "/acl/lib_fiber/c/src/common/msg.c"
ap
# 49 "/acl/lib_fiber/c/src/common/msg.c" 3 4
,
# 49 "/acl/lib_fiber/c/src/common/msg.c"
...
# 56 "/acl/lib_fiber/c/src/common/msg.c" 3 4
 __builtin_va_copy(
# 56 "/acl/lib_fiber/c/src/common/msg.c"
 ap_tmp
# 56 "/acl/lib_fiber/c/src/common/msg.c" 3 4
 ,
# 56 "/acl/lib_fiber/c/src/common/msg.c"
...
# 67 "/acl/lib_fiber/c/src/common/msg.c" 3 4
 __builtin_va_copy(
# 67 "/acl/lib_fiber/c/src/common/msg.c"
 ap_tmp
# 67 "/acl/lib_fiber/c/src/common/msg.c" 3 4
 ,
# 67 "/acl/lib_fiber/c/src/common/msg.c"
...
# 67 "/acl/lib_fiber/c/src/common/msg.c"
 ...
 if (__write_fn != 
# 74 "/acl/lib_fiber/c/src/common/msg.c" 3 4
                  ((void *)0)
# 74 "/acl/lib_fiber/c/src/common/msg.c"
                      ) {
  __write_fn(__msg_ctx, fmt, ap);
 }

 
# 78 "/acl/lib_fiber/c/src/common/msg.c" 3 4
__builtin_va_end(
# 78 "/acl/lib_fiber/c/src/common/msg.c"
ap
# 78 "/acl/lib_fiber/c/src/common/msg.c" 3 4
)
# 78 "/acl/lib_fiber/c/src/common/msg.c"
...
# 85 "/acl/lib_fiber/c/src/common/msg.c" 3 4
__builtin_va_start(
# 85 "/acl/lib_fiber/c/src/common/msg.c"
ap
# 85 "/acl/lib_fiber/c/src/common/msg.c" 3 4
,
# 85 "/acl/lib_fiber/c/src/common/msg.c"
...
# 92 "/acl/lib_fiber/c/src/common/msg.c" 3 4
 __builtin_va_copy(
# 92 "/acl/lib_fiber/c/src/common/msg.c"
 ap_tmp
# 92 "/acl/lib_fiber/c/src/common/msg.c" 3 4
 ,
# 92 "/acl/lib_fiber/c/src/common/msg.c"
...
# 103 "/acl/lib_fiber/c/src/common/msg.c" 3 4
 __builtin_va_copy(
# 103 "/acl/lib_fiber/c/src/common/msg.c"
 ap_tmp
# 103 "/acl/lib_fiber/c/src/common/msg.c" 3 4
 ,
# 103 "/acl/lib_fiber/c/src/common/msg.c"
...
# 103 "/acl/lib_fiber/c/src/common/msg.c"
 ...
 if (__write_fn != 
# 110 "/acl/lib_fiber/c/src/common/msg.c" 3 4
                  ((void *)0)
# 110 "/acl/lib_fiber/c/src/common/msg.c"
                      ) {
  __write_fn(__msg_ctx, fmt, ap);
 }

 
# 114 "/acl/lib_fiber/c/src/common/msg.c" 3 4
__builtin_va_end(
# 114 "/acl/lib_fiber/c/src/common/msg.c"
ap
# 114 "/acl/lib_fiber/c/src/common/msg.c" 3 4
)
# 114 "/acl/lib_fiber/c/src/common/msg.c"
...
# 121 "/acl/lib_fiber/c/src/common/msg.c" 3 4
__builtin_va_start(
# 121 "/acl/lib_fiber/c/src/common/msg.c"
ap
# 121 "/acl/lib_fiber/c/src/common/msg.c" 3 4
,
# 121 "/acl/lib_fiber/c/src/common/msg.c"
...
# 128 "/acl/lib_fiber/c/src/common/msg.c" 3 4
 __builtin_va_copy(
# 128 "/acl/lib_fiber/c/src/common/msg.c"
 ap_tmp
# 128 "/acl/lib_fiber/c/src/common/msg.c" 3 4
 ,
# 128 "/acl/lib_fiber/c/src/common/msg.c"
...
# 139 "/acl/lib_fiber/c/src/common/msg.c" 3 4
 __builtin_va_copy(
# 139 "/acl/lib_fiber/c/src/common/msg.c"
 ap_tmp
# 139 "/acl/lib_fiber/c/src/common/msg.c" 3 4
 ,
# 139 "/acl/lib_fiber/c/src/common/msg.c"
...
# 139 "/acl/lib_fiber/c/src/common/msg.c"
 ...
 if (__write_fn != 
# 146 "/acl/lib_fiber/c/src/common/msg.c" 3 4
                  ((void *)0)
# 146 "/acl/lib_fiber/c/src/common/msg.c"
                      ) {
  __write_fn(__msg_ctx, fmt, ap);
 }

 
# 150 "/acl/lib_fiber/c/src/common/msg.c" 3 4
__builtin_va_end(
# 150 "/acl/lib_fiber/c/src/common/msg.c"
ap
# 150 "/acl/lib_fiber/c/src/common/msg.c" 3 4
)
# 150 "/acl/lib_fiber/c/src/common/msg.c"
...
# 157 "/acl/lib_fiber/c/src/common/msg.c" 3 4
__builtin_va_start(
# 157 "/acl/lib_fiber/c/src/common/msg.c"
ap
# 157 "/acl/lib_fiber/c/src/common/msg.c" 3 4
,
# 157 "/acl/lib_fiber/c/src/common/msg.c"
...
# 164 "/acl/lib_fiber/c/src/common/msg.c" 3 4
 __builtin_va_copy(
# 164 "/acl/lib_fiber/c/src/common/msg.c"
 ap_tmp
# 164 "/acl/lib_fiber/c/src/common/msg.c" 3 4
 ,
# 164 "/acl/lib_fiber/c/src/common/msg.c"
...
# 176 "/acl/lib_fiber/c/src/common/msg.c" 3 4
 __builtin_va_copy(
# 176 "/acl/lib_fiber/c/src/common/msg.c"
 ap_tmp
# 176 "/acl/lib_fiber/c/src/common/msg.c" 3 4
 ,
# 176 "/acl/lib_fiber/c/src/common/msg.c"
...
# 176 "/acl/lib_fiber/c/src/common/msg.c"
 ...
 if (__write_fn != 
# 184 "/acl/lib_fiber/c/src/common/msg.c" 3 4
                  ((void *)0)
# 184 "/acl/lib_fiber/c/src/common/msg.c"
                      ) {
  __write_fn(__msg_ctx, fmt, ap);
 }

 
# 188 "/acl/lib_fiber/c/src/common/msg.c" 3 4
__builtin_va_end(
# 188 "/acl/lib_fiber/c/src/common/msg.c"
ap
# 188 "/acl/lib_fiber/c/src/common/msg.c" 3 4
)
# 188 "/acl/lib_fiber/c/src/common/msg.c"
...
{
# 221 "/acl/lib_fiber/c/src/common/msg.c"
 if (buffer == 
# 221 "/acl/lib_fiber/c/src/common/msg.c" 3 4
              ((void *)0) 
# 221 "/acl/lib_fiber/c/src/common/msg.c"
                   || size <= 0) {
  msg_error("%s, %s(%d): input error",
   "/acl/lib_fiber/c/src/common/msg.c", __FUNCTION__, 223);
  return 
# 224 "/acl/lib_fiber/c/src/common/msg.c" 3 4
        ((void *)0)
# 224 "/acl/lib_fiber/c/src/common/msg.c"
            ;
 }
...
# 238 "/acl/lib_fiber/c/src/common/msg.c" 3 4
                         ((void *)0)
# 238 "/acl/lib_fiber/c/src/common/msg.c"
                             ;
...
# 261 "/acl/lib_fiber/c/src/common/msg.c" 3 4
                                    0
# 261 "/acl/lib_fiber/c/src/common/msg.c"
                                                     ;
...
const char *last_serror(void)
{
 ...
 if (buf == 
# 274 "/acl/lib_fiber/c/src/common/msg.c" 3 4
           ((void *)0)
# 274 "/acl/lib_fiber/c/src/common/msg.c"
               ) {
...
# 296 "/acl/lib_fiber/c/src/common/msg.c" 3 4
__builtin_va_start(
# 296 "/acl/lib_fiber/c/src/common/msg.c"
ap
# 296 "/acl/lib_fiber/c/src/common/msg.c" 3 4
,
# 296 "/acl/lib_fiber/c/src/common/msg.c"
...
# 299 "/acl/lib_fiber/c/src/common/msg.c" 3 4
__builtin_va_end(
# 299 "/acl/lib_fiber/c/src/common/msg.c"
ap
# 299 "/acl/lib_fiber/c/src/common/msg.c" 3 4
)
# 299 "/acl/lib_fiber/c/src/common/msg.c"
