# 1 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c" 2
...
# 4 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c" 2
...
# 5 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c" 2
...
# 26 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c" 3 4
 __builtin_offsetof (
# 26 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c"
 TIMER_CACHE_NODE
# 26 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c" 3 4
 , 
# 26 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c"
...
# 26 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c"
 ...
 do { RING *_ring = &cache->caches; _ring->pred = _ring->succ = _ring; _ring->parent = _ring; _ring->len = 0; } while (0);
...
void timer_cache_free(TIMER_CACHE *cache)
{
 ...
 while (node != 
# 42 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c" 3 4
               ((void *)0)
# 42 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c"
                   ) {
  next = avl_walk(&cache->tree, node, (1));
  mem_free(node);
  node = next;
 }
 ...
 while (1) {
  ...
  if (r == 
# 50 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c" 3 4
          ((void *)0)
# 50 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c"
              ) {
   break;
  }
  node = ((TIMER_CACHE_NODE *) (((char *) (r)) - 
# 53 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c" 3 4
        __builtin_offsetof (
# 53 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c"
        TIMER_CACHE_NODE
# 53 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c" 3 4
        , 
# 53 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c"
...
void timer_cache_add(TIMER_CACHE *cache, long long expire, RING *entry)
{
 ...
 n.expire = expire;
 node = avl_find(&cache->tree, &n, 
# 65 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c" 3 4
                                  ((void *)0)
# 65 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c"
                                      );
 if (node == 
# 66 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c" 3 4
            ((void *)0)
# 66 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c"
                ) {
  RING *ring = ring_pop_head(&cache->caches);
  if (ring != 
# 68 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c" 3 4
             ((void *)0)
# 68 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c"
                 ) {
   node = ((TIMER_CACHE_NODE *) (((char *) (ring)) - 
# 69 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c" 3 4
         __builtin_offsetof (
# 69 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c"
         TIMER_CACHE_NODE
# 69 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c" 3 4
         , 
# 69 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c"
...
# 69 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c"
  ...
  node->expire = expire;
  do { RING *_ring = &node->ring; _ring->pred = _ring->succ = _ring; _ring->parent = _ring; _ring->len = 0; } while (0);
  avl_add(&cache->tree, node);
 }

 do { ((RING*)(entry))->succ = ((RING*)(&node->ring))->succ; ((RING*)(entry))->pred = (RING*)(&node->ring); ((RING*)(entry))->parent = ((RING*)(&node->ring))->parent; ((RING*)(&node->ring))->succ->pred = (RING*)(entry); ((RING*)(&node->ring))->succ = (RING*)(entry); ((RING*)(&node->ring))->parent->len++; } while (0);
}
...
void timer_cache_remove(TIMER_CACHE *cache, long long expire, RING *entry)
{
 ...
 node = avl_find(&cache->tree, &n, 
# 86 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c" 3 4
                                  ((void *)0)
# 86 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c"
                                      );
 if (node == 
# 87 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c" 3 4
            ((void *)0)
# 87 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c"
                ) {
  msg_error("not found expire=%lld", expire);
  return;
 }

 do { RING *_succ, *_pred; if (((RING*)(entry))->parent != (RING*)(entry)) { _succ = ((RING*)(entry))->succ; _pred = ((RING*)(entry))->pred; if (_succ && _pred) { _pred->succ = _succ; _succ->pred = _pred; ((RING*)(entry))->parent->len--; ((RING*)(entry))->succ = (RING*)(entry); ((RING*)(entry))->pred = (RING*)(entry); ((RING*)(entry))->parent = (RING*)(entry); ((RING*)(entry))->len = 0; } } } while (0);

 if ((((RING*)(&node->ring))->len) == 0) {
...
void timer_cache_free_node(TIMER_CACHE *cache, TIMER_CACHE_NODE *node)
{
 ...
 if (cache->cache_max > 0 && (((RING*)(&cache->caches))->len) < cache->cache_max) {
  do { ((RING*)(&node->ring))->succ = ((RING*)(&cache->caches))->succ; ((RING*)(&node->ring))->pred = (RING*)(&cache->caches); ((RING*)(&node->ring))->parent = ((RING*)(&cache->caches))->parent; ((RING*)(&cache->caches))->succ->pred = (RING*)(&node->ring); ((RING*)(&cache->caches))->succ = (RING*)(&node->ring); ((RING*)(&cache->caches))->parent->len++; } while (0);
 } else {
  mem_free(node);
 }
}
...
int timer_cache_remove_exist(TIMER_CACHE *cache, long long expire, RING *entry)
{
 ...
 n.expire = expire;
 node = avl_find(&cache->tree, &n, 
# 118 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c" 3 4
                                  ((void *)0)
# 118 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c"
                                      );
 if (node == 
# 119 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c" 3 4
            ((void *)0)
# 119 "/workspace/acl/lib_fiber/c/src/common/timer_cache.c"
                ) {
  return 0;
 }
