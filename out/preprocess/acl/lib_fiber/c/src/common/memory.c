# 0 "/acl/lib_fiber/c/src/common/memory.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/common/memory.c"
...
# 2 "/acl/lib_fiber/c/src/common/memory.c" 2
...
# 3 "/acl/lib_fiber/c/src/common/memory.c" 2
# 69 "/acl/lib_fiber/c/src/common/memory.c"
void *stack_alloc(size_t size)
{
...
# 100 "/acl/lib_fiber/c/src/common/memory.c"
void *mem_malloc(size_t size)
{
