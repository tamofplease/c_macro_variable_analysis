# 1 "/workspace/acl/lib_fiber/c/src/common/memory.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/common/memory.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/common/memory.c" 2
# 69 "/workspace/acl/lib_fiber/c/src/common/memory.c"
void *stack_alloc(size_t size)
{
...
# 100 "/workspace/acl/lib_fiber/c/src/common/memory.c"
void *mem_malloc(size_t size)
{
