# 1 "/workspace/acl/lib_fiber/c/src/common/yqueue.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/common/yqueue.c" 2
...
# 4 "/workspace/acl/lib_fiber/c/src/common/yqueue.c" 2
# 1 "/workspace/acl/lib_fiber/c/src/common/yqueue.h" 1
...
# 5 "/workspace/acl/lib_fiber/c/src/common/yqueue.c" 2
...
YQUEUE *yqueue_new(void)
{
 ...
 self->begin_pos = 0;
 self->back_chunk = 
# 35 "/workspace/acl/lib_fiber/c/src/common/yqueue.c" 3 4
                    ((void *)0)
# 35 "/workspace/acl/lib_fiber/c/src/common/yqueue.c"
                        ;
 self->back_pos = 0;
 self->end_chunk = self->begin_chunk;
 self->end_pos = 0;
 self->spare_chunk = atomic_new();
 atomic_set(self->spare_chunk, 
# 40 "/workspace/acl/lib_fiber/c/src/common/yqueue.c" 3 4
                              ((void *)0)
# 40 "/workspace/acl/lib_fiber/c/src/common/yqueue.c"
                                  );
...
# 48 "/workspace/acl/lib_fiber/c/src/common/yqueue.c" 3 4
((void) sizeof ((
# 48 "/workspace/acl/lib_fiber/c/src/common/yqueue.c"
chunk
# 48 "/workspace/acl/lib_fiber/c/src/common/yqueue.c" 3 4
...
"chunk"
# 48 "/workspace/acl/lib_fiber/c/src/common/yqueue.c" 3 4
, "/workspace/acl/lib_fiber/c/src/common/yqueue.c", 48, __extension__ __PRETTY_FUNCTION__); }))
# 48 "/workspace/acl/lib_fiber/c/src/common/yqueue.c"
             ;
...
void yqueue_free(YQUEUE *self, void(*free_fn)(void*))
{
 ...
 cs = (chunk_t *) atomic_xchg(self->spare_chunk, 
# 92 "/workspace/acl/lib_fiber/c/src/common/yqueue.c" 3 4
                                                ((void *)0)
# 92 "/workspace/acl/lib_fiber/c/src/common/yqueue.c"
                                                    );
 if (cs) {
  free(cs);
 }
...
void yqueue_push(YQUEUE *self)
{
 ...
 sc = (chunk_t *) atomic_xchg(self->spare_chunk, 
# 124 "/workspace/acl/lib_fiber/c/src/common/yqueue.c" 3 4
                                                ((void *)0)
# 124 "/workspace/acl/lib_fiber/c/src/common/yqueue.c"
                                                    );
...
# 132 "/workspace/acl/lib_fiber/c/src/common/yqueue.c" 3 4
 ((void) sizeof ((
# 132 "/workspace/acl/lib_fiber/c/src/common/yqueue.c"
 self->end_chunk
# 132 "/workspace/acl/lib_fiber/c/src/common/yqueue.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 132 "/workspace/acl/lib_fiber/c/src/common/yqueue.c"
...
# 132 "/workspace/acl/lib_fiber/c/src/common/yqueue.c"
 "self->end_chunk"
# 132 "/workspace/acl/lib_fiber/c/src/common/yqueue.c" 3 4
 , "/workspace/acl/lib_fiber/c/src/common/yqueue.c", 132, __extension__ __PRETTY_FUNCTION__); }))
# 132 "/workspace/acl/lib_fiber/c/src/common/yqueue.c"
                        ;
...
void yqueue_pop(YQUEUE *self)
{
 ...
 if (self->begin_pos == 10) {
  chunk_t *cs;
  chunk_t *o = self->begin_chunk;

  self->begin_chunk = self->begin_chunk->next;
  self->begin_chunk->prev = 
# 150 "/workspace/acl/lib_fiber/c/src/common/yqueue.c" 3 4
                           ((void *)0)
# 150 "/workspace/acl/lib_fiber/c/src/common/yqueue.c"
                               ;
  self->begin_pos = 0;
