# 0 "/acl/lib_fiber/c/src/common/yqueue.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/common/yqueue.c"
...
# 2 "/acl/lib_fiber/c/src/common/yqueue.c" 2
...
# 4 "/acl/lib_fiber/c/src/common/yqueue.c" 2
# 1 "/acl/lib_fiber/c/src/common/yqueue.h" 1
...
# 5 "/acl/lib_fiber/c/src/common/yqueue.c" 2
...
YQUEUE *yqueue_new(void)
{
 ...
 self->begin_pos = 0;
 self->back_chunk = 
# 35 "/acl/lib_fiber/c/src/common/yqueue.c" 3 4
                    ((void *)0)
# 35 "/acl/lib_fiber/c/src/common/yqueue.c"
                        ;
 self->back_pos = 0;
...
# 40 "/acl/lib_fiber/c/src/common/yqueue.c" 3 4
                              ((void *)0)
# 40 "/acl/lib_fiber/c/src/common/yqueue.c"
                                  );
...
# 48 "/acl/lib_fiber/c/src/common/yqueue.c" 3 4
((void) sizeof ((
# 48 "/acl/lib_fiber/c/src/common/yqueue.c"
chunk
# 48 "/acl/lib_fiber/c/src/common/yqueue.c" 3 4
...
"chunk"
# 48 "/acl/lib_fiber/c/src/common/yqueue.c" 3 4
, "/acl/lib_fiber/c/src/common/yqueue.c", 48, __extension__ __PRETTY_FUNCTION__); }))
# 48 "/acl/lib_fiber/c/src/common/yqueue.c"
             ;
...
# 92 "/acl/lib_fiber/c/src/common/yqueue.c" 3 4
                                                ((void *)0)
# 92 "/acl/lib_fiber/c/src/common/yqueue.c"
                                                    );
 if (cs) {
  free(cs);
 }
...
# 124 "/acl/lib_fiber/c/src/common/yqueue.c" 3 4
                                                ((void *)0)
# 124 "/acl/lib_fiber/c/src/common/yqueue.c"
                                                    );
...
# 132 "/acl/lib_fiber/c/src/common/yqueue.c" 3 4
 ((void) sizeof ((
# 132 "/acl/lib_fiber/c/src/common/yqueue.c"
 self->end_chunk
# 132 "/acl/lib_fiber/c/src/common/yqueue.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 132 "/acl/lib_fiber/c/src/common/yqueue.c"
...
# 132 "/acl/lib_fiber/c/src/common/yqueue.c"
 "self->end_chunk"
# 132 "/acl/lib_fiber/c/src/common/yqueue.c" 3 4
 , "/acl/lib_fiber/c/src/common/yqueue.c", 132, __extension__ __PRETTY_FUNCTION__); }))
# 132 "/acl/lib_fiber/c/src/common/yqueue.c"
                        ;
...
# 150 "/acl/lib_fiber/c/src/common/yqueue.c" 3 4
                           ((void *)0)
# 150 "/acl/lib_fiber/c/src/common/yqueue.c"
                               ;
  self->begin_pos = 0;
