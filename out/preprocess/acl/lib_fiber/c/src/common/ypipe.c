# 1 "/workspace/acl/lib_fiber/c/src/common/ypipe.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/common/ypipe.c" 2
...
# 4 "/workspace/acl/lib_fiber/c/src/common/ypipe.c" 2
...
# 5 "/workspace/acl/lib_fiber/c/src/common/ypipe.c" 2
...
# 6 "/workspace/acl/lib_fiber/c/src/common/ypipe.c" 2
...
void *ypipe_read(YPIPE *self)
{
 ...
 if (!ypipe_check_read(self)) {
  return 
# 45 "/workspace/acl/lib_fiber/c/src/common/ypipe.c" 3 4
        ((void *)0)
# 45 "/workspace/acl/lib_fiber/c/src/common/ypipe.c"
            ;
 }
...
int ypipe_check_read(YPIPE *self)
{
 ...
 self->r = (void **) atomic_cas(self->c, front, 
# 87 "/workspace/acl/lib_fiber/c/src/common/ypipe.c" 3 4
                                               ((void *)0)
# 87 "/workspace/acl/lib_fiber/c/src/common/ypipe.c"
                                                   );
