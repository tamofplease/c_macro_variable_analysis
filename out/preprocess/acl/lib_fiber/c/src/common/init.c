# 0 "/acl/lib_fiber/c/src/common/init.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/common/init.c"
...
# 4 "/acl/lib_fiber/c/src/common/init.c" 2
