# 0 "/acl/lib_fiber/c/src/common/sane_socket.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/common/sane_socket.c"
...
# 2 "/acl/lib_fiber/c/src/common/sane_socket.c" 2
...
# 3 "/acl/lib_fiber/c/src/common/sane_socket.c" 2
...
# 4 "/acl/lib_fiber/c/src/common/sane_socket.c" 2
...
# 5 "/acl/lib_fiber/c/src/common/sane_socket.c" 2
...
int is_listen_socket(socket_t fd)
{
 ...
 ret = getsockopt(fd, 
# 15 "/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
                     1
# 15 "/acl/lib_fiber/c/src/common/sane_socket.c"
                               , 
# 15 "/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
                                 30
# 15 "/acl/lib_fiber/c/src/common/sane_socket.c"
...
int getsockfamily(socket_t fd)
{
 ...
 if (sa->sa_family == 
# 40 "/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
                     1
# 40 "/acl/lib_fiber/c/src/common/sane_socket.c"
                            ) {
  return 
# 41 "/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
        1
# 41 "/acl/lib_fiber/c/src/common/sane_socket.c"
               ;
 }


 if (sa->sa_family == 
# 45 "/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
                     2 
# 45 "/acl/lib_fiber/c/src/common/sane_socket.c"
                             || sa->sa_family == 
# 45 "/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
                                                 10
# 45 "/acl/lib_fiber/c/src/common/sane_socket.c"
...
int getsocktype(socket_t fd)
{
 ...
 if (getsockopt(fd, 
# 60 "/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
                   1
# 60 "/acl/lib_fiber/c/src/common/sane_socket.c"
                             , 
# 60 "/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
                               3
# 60 "/acl/lib_fiber/c/src/common/sane_socket.c"
...
void tcp_so_linger(socket_t fd, int onoff, int timeout)
{
 ...
 if (n != 
# 74 "/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
         2 
# 74 "/acl/lib_fiber/c/src/common/sane_socket.c"
                 && n != 
# 74 "/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
                         10
# 74 "/acl/lib_fiber/c/src/common/sane_socket.c"
 ...
 if (setsockopt(fd, 
# 83 "/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
                   1
# 83 "/acl/lib_fiber/c/src/common/sane_socket.c"
                             , 
# 83 "/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
                               13
# 83 "/acl/lib_fiber/c/src/common/sane_socket.c"
