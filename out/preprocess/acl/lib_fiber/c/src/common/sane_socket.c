# 1 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c" 2
...
# 4 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c" 2
...
# 5 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c" 2
...
int is_listen_socket(socket_t fd)
{
 ...
 ret = getsockopt(fd, 
# 15 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
                     1
# 15 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c"
                               , 
# 15 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
                                 30
# 15 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c"
...
int getsockfamily(socket_t fd)
{
 ...
 if (sa->sa_family == 
# 40 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
                     1
# 40 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c"
                            ) {
  return 
# 41 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
        1
# 41 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c"
               ;
 }


 if (sa->sa_family == 
# 45 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
                     2 
# 45 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c"
                             || sa->sa_family == 
# 45 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
                                                 10
# 45 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c"
...
int getsocktype(socket_t fd)
{
 ...
 if (getsockopt(fd, 
# 60 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
                   1
# 60 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c"
                             , 
# 60 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
                               3
# 60 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c"
...
void tcp_so_linger(socket_t fd, int onoff, int timeout)
{
 ...
 if (n != 
# 74 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
         2 
# 74 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c"
                 && n != 
# 74 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
                         10
# 74 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c"
 ...
 if (setsockopt(fd, 
# 83 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
                   1
# 83 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c"
                             , 
# 83 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c" 3 4
                               13
# 83 "/workspace/acl/lib_fiber/c/src/common/sane_socket.c"
