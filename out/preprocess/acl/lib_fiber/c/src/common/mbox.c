# 0 "/acl/lib_fiber/c/src/common/mbox.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/common/mbox.c"
...
# 2 "/acl/lib_fiber/c/src/common/mbox.c" 2
...
# 3 "/acl/lib_fiber/c/src/common/mbox.c" 2
...
# 5 "/acl/lib_fiber/c/src/common/mbox.c" 2
# 1 "/acl/lib_fiber/c/src/common/pthread_patch.h" 1
# 46 "/acl/lib_fiber/c/src/common/pthread_patch.h"
long thread_self(void);
# 6 "/acl/lib_fiber/c/src/common/mbox.c" 2
# 1 "/acl/lib_fiber/c/src/common/ypipe.h" 1
...
# 7 "/acl/lib_fiber/c/src/common/mbox.c" 2
...
# 8 "/acl/lib_fiber/c/src/common/mbox.c" 2
# 1 "/acl/lib_fiber/c/src/common/mbox.h" 1



typedef struct MBOX MBOX;
# 14 "/acl/lib_fiber/c/src/common/mbox.h"
...
# 39 "/acl/lib_fiber/c/src/common/mbox.h"
...
# 9 "/acl/lib_fiber/c/src/common/mbox.c" 2
...
# 16 "/acl/lib_fiber/c/src/common/mbox.c" 2
...
# 18 "/acl/lib_fiber/c/src/common/mbox.c" 2
# 29 "/acl/lib_fiber/c/src/common/mbox.c"
...
MBOX *mbox_create(unsigned type)
{
 ...
 fds[1] = fds[0];
# 71 "/acl/lib_fiber/c/src/common/mbox.c"
...
# 82 "/acl/lib_fiber/c/src/common/mbox.c" 3 4
                                    ((void *)0)
# 82 "/acl/lib_fiber/c/src/common/mbox.c"
                                        ) != 0) {
   msg_fatal("%s(%d), %s: pthread_mutex_init error",
    "/acl/lib_fiber/c/src/common/mbox.c", 84, __FUNCTION__);
  }
 } else {
  mbox->lock = 
# 87 "/acl/lib_fiber/c/src/common/mbox.c" 3 4
              ((void *)0)
# 87 "/acl/lib_fiber/c/src/common/mbox.c"
                  ;
 }
...
void mbox_free(MBOX *mbox, void (*free_fn)(void*))
{
 ...
 if (mbox->lock != 
# 100 "/acl/lib_fiber/c/src/common/mbox.c" 3 4
                  ((void *)0)
# 100 "/acl/lib_fiber/c/src/common/mbox.c"
                      ) {
...
# 148 "/acl/lib_fiber/c/src/common/mbox.c"
 if (ret == -1) {
  msg_error("%s(%d), %s: mbox write %d error %s", "/acl/lib_fiber/c/src/common/mbox.c",
...
void *mbox_read(MBOX *mbox, int timeout, int *success)
{
 ...
 if (msg != 
# 163 "/acl/lib_fiber/c/src/common/mbox.c" 3 4
           ((void *)0)
# 163 "/acl/lib_fiber/c/src/common/mbox.c"
               ) {
  if (success) {
   *success = 1;
  }
  ...
  return 
# 172 "/acl/lib_fiber/c/src/common/mbox.c" 3 4
        ((void *)0)
# 172 "/acl/lib_fiber/c/src/common/mbox.c"
            ;
 }
...
# 178 "/acl/lib_fiber/c/src/common/mbox.c" 3 4
                               62
# 178 "/acl/lib_fiber/c/src/common/mbox.c"
                                          ) {
   if (success) {
    *success = 1;
   }
  ...
  return 
# 185 "/acl/lib_fiber/c/src/common/mbox.c" 3 4
        ((void *)0)
# 185 "/acl/lib_fiber/c/src/common/mbox.c"
            ;
 }
 ...
 if (ret == -1) {
  ...
  return 
# 198 "/acl/lib_fiber/c/src/common/mbox.c" 3 4
        ((void *)0)
# 198 "/acl/lib_fiber/c/src/common/mbox.c"
            ;
 }
