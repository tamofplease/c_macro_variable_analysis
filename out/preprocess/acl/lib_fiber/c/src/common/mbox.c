# 1 "/workspace/acl/lib_fiber/c/src/common/mbox.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/common/mbox.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/common/mbox.c" 2
...
# 5 "/workspace/acl/lib_fiber/c/src/common/mbox.c" 2
...
# 6 "/workspace/acl/lib_fiber/c/src/common/mbox.c" 2
# 1 "/workspace/acl/lib_fiber/c/src/common/ypipe.h" 1
...
# 7 "/workspace/acl/lib_fiber/c/src/common/mbox.c" 2
...
# 8 "/workspace/acl/lib_fiber/c/src/common/mbox.c" 2
# 1 "/workspace/acl/lib_fiber/c/src/common/mbox.h" 1



typedef struct MBOX MBOX;
# 14 "/workspace/acl/lib_fiber/c/src/common/mbox.h"
...
# 39 "/workspace/acl/lib_fiber/c/src/common/mbox.h"
...
# 9 "/workspace/acl/lib_fiber/c/src/common/mbox.c" 2
...
# 16 "/workspace/acl/lib_fiber/c/src/common/mbox.c" 2
...
# 18 "/workspace/acl/lib_fiber/c/src/common/mbox.c" 2
# 29 "/workspace/acl/lib_fiber/c/src/common/mbox.c"
...
MBOX *mbox_create(unsigned type)
{
 ...
 fds[1] = fds[0];
# 71 "/workspace/acl/lib_fiber/c/src/common/mbox.c"
 ...
 if (type == 1) {
  ...
  if (pthread_mutex_init(mbox->lock, 
# 82 "/workspace/acl/lib_fiber/c/src/common/mbox.c" 3 4
                                    ((void *)0)
# 82 "/workspace/acl/lib_fiber/c/src/common/mbox.c"
                                        ) != 0) {
   msg_fatal("%s(%d), %s: pthread_mutex_init error",
    "/workspace/acl/lib_fiber/c/src/common/mbox.c", 84, __FUNCTION__);
  }
 } else {
  mbox->lock = 
# 87 "/workspace/acl/lib_fiber/c/src/common/mbox.c" 3 4
              ((void *)0)
# 87 "/workspace/acl/lib_fiber/c/src/common/mbox.c"
                  ;
 }
...
void mbox_free(MBOX *mbox, void (*free_fn)(void*))
{
 ...
 if (mbox->lock != 
# 100 "/workspace/acl/lib_fiber/c/src/common/mbox.c" 3 4
                  ((void *)0)
# 100 "/workspace/acl/lib_fiber/c/src/common/mbox.c"
                      ) {
...
# 148 "/workspace/acl/lib_fiber/c/src/common/mbox.c"
 if (ret == -1) {
  msg_error("%s(%d), %s: mbox write %d error %s", "/workspace/acl/lib_fiber/c/src/common/mbox.c",
   150, __FUNCTION__, mbox->out, last_serror());
  return -1;
 }
...
void *mbox_read(MBOX *mbox, int timeout, int *success)
{
 ...
 if (msg != 
# 163 "/workspace/acl/lib_fiber/c/src/common/mbox.c" 3 4
           ((void *)0)
# 163 "/workspace/acl/lib_fiber/c/src/common/mbox.c"
               ) {
  if (success) {
   *success = 1;
  }
  ...
  return 
# 172 "/workspace/acl/lib_fiber/c/src/common/mbox.c" 3 4
        ((void *)0)
# 172 "/workspace/acl/lib_fiber/c/src/common/mbox.c"
            ;
 }
...
# 178 "/workspace/acl/lib_fiber/c/src/common/mbox.c" 3 4
                               62
# 178 "/workspace/acl/lib_fiber/c/src/common/mbox.c"
                                          ) {
   if (success) {
    *success = 1;
   }
  ...
  return 
# 185 "/workspace/acl/lib_fiber/c/src/common/mbox.c" 3 4
        ((void *)0)
# 185 "/workspace/acl/lib_fiber/c/src/common/mbox.c"
            ;
 }
 ...
 if (ret == -1) {
  ...
  return 
# 198 "/workspace/acl/lib_fiber/c/src/common/mbox.c" 3 4
        ((void *)0)
# 198 "/workspace/acl/lib_fiber/c/src/common/mbox.c"
            ;
 }
