# 0 "/acl/lib_fiber/c/src/common/open_limit.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/common/open_limit.c"
...
# 2 "/acl/lib_fiber/c/src/common/open_limit.c" 2
...
# 3 "/acl/lib_fiber/c/src/common/open_limit.c" 2
...
# 4 "/acl/lib_fiber/c/src/common/open_limit.c" 2
...
# 5 "/acl/lib_fiber/c/src/common/open_limit.c" 2
# 38 "/acl/lib_fiber/c/src/common/open_limit.c"
int open_limit(int limit)
{
 int rlim_cur = -1;
 ...
 if (getrlimit(
# 45 "/acl/lib_fiber/c/src/common/open_limit.c" 3 4
              RLIMIT_NOFILE
# 45 "/acl/lib_fiber/c/src/common/open_limit.c"
                           , &rl) < 0) {
 ...
 if (limit > 0) {
  ...
  if (setrlimit(
# 67 "/acl/lib_fiber/c/src/common/open_limit.c" 3 4
               RLIMIT_NOFILE
# 67 "/acl/lib_fiber/c/src/common/open_limit.c"
                            , &rl) < 0) {
  ...
  rl.rlim_cur = rl.rlim_max;
  if (setrlimit(
# 78 "/acl/lib_fiber/c/src/common/open_limit.c" 3 4
               RLIMIT_NOFILE
# 78 "/acl/lib_fiber/c/src/common/open_limit.c"
                            , &rl) < 0) {
...
# 99 "/acl/lib_fiber/c/src/common/open_limit.c"
}
