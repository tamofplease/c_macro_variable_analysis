# 1 "/workspace/acl/lib_fiber/c/src/common/open_limit.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/common/open_limit.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/common/open_limit.c" 2
...
# 4 "/workspace/acl/lib_fiber/c/src/common/open_limit.c" 2
...
# 5 "/workspace/acl/lib_fiber/c/src/common/open_limit.c" 2
# 38 "/workspace/acl/lib_fiber/c/src/common/open_limit.c"
int open_limit(int limit)
{
 int rlim_cur = -1;
 ...
 if (getrlimit(
# 45 "/workspace/acl/lib_fiber/c/src/common/open_limit.c" 3 4
              RLIMIT_NOFILE
# 45 "/workspace/acl/lib_fiber/c/src/common/open_limit.c"
                           , &rl) < 0) {
  ...
  msg_warn("%s(%d): getrlimit error: %s, use: %d",
   __FUNCTION__, 52, last_serror(), rlim_cur);
  return rlim_cur;
 }
 ...
 if (limit > 0) {
  ...
  if (setrlimit(
# 67 "/workspace/acl/lib_fiber/c/src/common/open_limit.c" 3 4
               RLIMIT_NOFILE
# 67 "/workspace/acl/lib_fiber/c/src/common/open_limit.c"
                            , &rl) < 0) {
   msg_warn("%s(%d): setrlimit error: %s, limit: %d,"
    " curr: %d", __FUNCTION__, 69,
  ...
  rl.rlim_cur = rl.rlim_max;
  if (setrlimit(
# 78 "/workspace/acl/lib_fiber/c/src/common/open_limit.c" 3 4
               RLIMIT_NOFILE
# 78 "/workspace/acl/lib_fiber/c/src/common/open_limit.c"
                            , &rl) < 0) {
   msg_warn("%s(%d): setrlimit error: %s,"
    " cur: %d, max: %d", __FUNCTION__, 80,
...
# 99 "/workspace/acl/lib_fiber/c/src/common/open_limit.c"
}
