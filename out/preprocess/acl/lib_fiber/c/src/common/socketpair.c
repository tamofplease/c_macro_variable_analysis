# 1 "/workspace/acl/lib_fiber/c/src/common/socketpair.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/common/socketpair.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/common/socketpair.c" 2
...
# 4 "/workspace/acl/lib_fiber/c/src/common/socketpair.c" 2
...
# 5 "/workspace/acl/lib_fiber/c/src/common/socketpair.c" 2
...
# 6 "/workspace/acl/lib_fiber/c/src/common/socketpair.c" 2
# 235 "/workspace/acl/lib_fiber/c/src/common/socketpair.c"
int sane_socketpair(int domain, int type, int protocol, socket_t result[2])
{
 static int socketpair_ok_errors[] = {
  
# 238 "/workspace/acl/lib_fiber/c/src/common/socketpair.c" 3 4
 4
# 238 "/workspace/acl/lib_fiber/c/src/common/socketpair.c"
      ,
  0,
 };
 int count;
