# 0 "/acl/lib_fiber/c/src/common/socketpair.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/common/socketpair.c"
...
# 2 "/acl/lib_fiber/c/src/common/socketpair.c" 2
...
# 3 "/acl/lib_fiber/c/src/common/socketpair.c" 2
...
# 4 "/acl/lib_fiber/c/src/common/socketpair.c" 2
...
# 5 "/acl/lib_fiber/c/src/common/socketpair.c" 2
...
# 6 "/acl/lib_fiber/c/src/common/socketpair.c" 2
# 235 "/acl/lib_fiber/c/src/common/socketpair.c"
int sane_socketpair(int domain, int type, int protocol, socket_t result[2])
{
 static int socketpair_ok_errors[] = {
  
# 238 "/acl/lib_fiber/c/src/common/socketpair.c" 3 4
 4
# 238 "/acl/lib_fiber/c/src/common/socketpair.c"
      ,
  0,
 };
 int count;
