# 1 "/workspace/acl/lib_fiber/c/src/common/close_on_exec.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/common/close_on_exec.c" 2
...
# 7 "/workspace/acl/lib_fiber/c/src/common/close_on_exec.c" 2
...
# 8 "/workspace/acl/lib_fiber/c/src/common/close_on_exec.c" 2
...
int close_on_exec(int fd, int on)
{
 ...
 if ((flags = fcntl(fd, 
# 18 "/workspace/acl/lib_fiber/c/src/common/close_on_exec.c" 3 4
                       1
# 18 "/workspace/acl/lib_fiber/c/src/common/close_on_exec.c"
                              , 0)) < 0) {
  msg_fatal("fcntl: get flags: %s", last_serror());
 }
 if (fcntl(fd, 
# 21 "/workspace/acl/lib_fiber/c/src/common/close_on_exec.c" 3 4
              2
# 21 "/workspace/acl/lib_fiber/c/src/common/close_on_exec.c"
                     , on ? flags | 
# 21 "/workspace/acl/lib_fiber/c/src/common/close_on_exec.c" 3 4
                                    1 
# 21 "/workspace/acl/lib_fiber/c/src/common/close_on_exec.c"
...
# 21 "/workspace/acl/lib_fiber/c/src/common/close_on_exec.c"
 ...
 return ((flags & 
# 26 "/workspace/acl/lib_fiber/c/src/common/close_on_exec.c" 3 4
                 1
# 26 "/workspace/acl/lib_fiber/c/src/common/close_on_exec.c"
                        ) != 0);
