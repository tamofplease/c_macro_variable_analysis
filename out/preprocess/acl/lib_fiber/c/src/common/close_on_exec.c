# 0 "/acl/lib_fiber/c/src/common/close_on_exec.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/common/close_on_exec.c"
...
# 2 "/acl/lib_fiber/c/src/common/close_on_exec.c" 2
...
# 7 "/acl/lib_fiber/c/src/common/close_on_exec.c" 2
...
# 8 "/acl/lib_fiber/c/src/common/close_on_exec.c" 2
...
int close_on_exec(int fd, int on)
{
 ...
 if ((flags = fcntl(fd, 
# 18 "/acl/lib_fiber/c/src/common/close_on_exec.c" 3 4
                       1
# 18 "/acl/lib_fiber/c/src/common/close_on_exec.c"
                              , 0)) < 0) {
  msg_fatal("fcntl: get flags: %s", last_serror());
 }
 if (fcntl(fd, 
# 21 "/acl/lib_fiber/c/src/common/close_on_exec.c" 3 4
              2
# 21 "/acl/lib_fiber/c/src/common/close_on_exec.c"
                     , on ? flags | 
# 21 "/acl/lib_fiber/c/src/common/close_on_exec.c" 3 4
                                    1 
# 21 "/acl/lib_fiber/c/src/common/close_on_exec.c"
...
# 21 "/acl/lib_fiber/c/src/common/close_on_exec.c"
 ...
 return ((flags & 
# 26 "/acl/lib_fiber/c/src/common/close_on_exec.c" 3 4
                 1
# 26 "/acl/lib_fiber/c/src/common/close_on_exec.c"
                        ) != 0);
