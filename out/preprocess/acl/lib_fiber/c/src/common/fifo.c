# 1 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 2
...
# 4 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 2
# 1 "/workspace/acl/lib_fiber/c/src/common/fifo.h" 1
# 10 "/workspace/acl/lib_fiber/c/src/common/fifo.h"
...
# 64 "/workspace/acl/lib_fiber/c/src/common/fifo.h"
...
# 5 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 2
...
static void *iter_head(ITER *iter, struct FIFO *fifo)
{
 ...
 iter->dlen = -1;
 iter->key = 
# 31 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
            ((void *)0)
# 31 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                ;
 iter->klen = -1;
 iter->i = 0;
 iter->size = fifo->cnt;
...
# 36 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                               ((void *)0)
# 36 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                                   ;
 return iter->ptr;
}

static void *iter_next(ITER *iter, struct FIFO *fifo __attribute__ ((__unused__)))
{
 FIFO_INFO *ptr;

 ptr = (FIFO_INFO*) iter->ptr;
 iter->ptr = ptr = ptr ? ptr->next : 
# 45 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                                    ((void *)0)
# 45 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                                        ;
 if (ptr) {
  iter->data = ptr->data;
  iter->i++;
  ...
  iter->data = 
# 50 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
              ((void *)0)
# 50 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                  ;
 return iter;
}
...
static void *iter_tail(ITER *iter, struct FIFO *fifo)
{
 ...
 iter->dlen = -1;
 iter->key = 
# 59 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
            ((void *)0)
# 59 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                ;
 iter->klen = -1;
 iter->i = fifo->cnt - 1;
 iter->size = fifo->cnt;
 ...
 iter->data = ptr ? ptr->data : 
# 64 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                               ((void *)0)
# 64 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                                   ;
 return iter->ptr;
}

static void *iter_prev(ITER *iter, struct FIFO *fifo __attribute__ ((__unused__)))
{
 FIFO_INFO *ptr;

 ptr = (FIFO_INFO*) iter->ptr;
 iter->ptr = ptr = ptr ? ptr->prev : 
# 73 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                                    ((void *)0)
# 73 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                                        ;
 if (ptr) {
  iter->data = ptr->data;
  iter->i--;
  ...
  iter->data = 
# 78 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
              ((void *)0)
# 78 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                  ;
 return iter;
}

static FIFO_INFO *iter_info(ITER *iter, struct FIFO *fifo __attribute__ ((__unused__)))
{
 return iter->ptr ? (FIFO_INFO*) iter->ptr : 
# 84 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                                            ((void *)0)
# 84 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                                                ;
}
...
{
 fifo->head = 
# 89 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
             ((void *)0)
# 89 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                 ;
 fifo->tail = 
# 90 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
             ((void *)0)
# 90 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                 ;
 fifo->cnt = 0;
...
FIFO *fifo_new(void)
{
 ...
 fifo->head = 
# 109 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
             ((void *)0)
# 109 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                 ;
 fifo->tail = 
# 110 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
             ((void *)0)
# 110 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                 ;
 fifo->cnt = 0;
...
void fifo_free(FIFO *fifo, void (*free_fn)(void *))
{
 ...
 while ((data = fifo_pop_front(fifo)) != 
# 129 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                                  ((void *)0)
# 129 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                                      ) {
  if (free_fn)
   free_fn(data);
 }
...
FIFO_INFO *fifo_push_back(FIFO *fifo, void *data)
{
 ...
 if (fifo->tail == 
# 143 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                  ((void *)0)
# 143 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                      ) {
  info->prev = info->next = 
# 144 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                           ((void *)0)
# 144 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                               ;
  ...
  info->prev = fifo->tail;
  info->next = 
# 149 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
              ((void *)0)
# 149 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                  ;
  fifo->tail = info;
 }
...
FIFO_INFO *fifo_push_front(FIFO *fifo, void *data)
{
 ...
 if (fifo->head == 
# 164 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                  ((void *)0)
# 164 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                      ) {
  info->prev = info->next = 
# 165 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                           ((void *)0)
# 165 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                               ;
  fifo->head = fifo->tail = info;
 } else {
  info->next = fifo->head;
  fifo->head->prev = info;
  info->prev = 
# 170 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
              ((void *)0)
# 170 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                  ;
  fifo->head = info;
 }
...
void *fifo_pop_front(FIFO *fifo)
{
 ...
 if (fifo->head == 
# 183 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                  ((void *)0)
# 183 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                      )
  return 
# 184 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
        ((void *)0)
# 184 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
            ;

 info = fifo->head;
 if (fifo->head->next) {
  fifo->head->next->prev = 
# 188 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                          ((void *)0)
# 188 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                              ;
  fifo->head = fifo->head->next;
 } else {
  fifo->head = fifo->tail = 
# 191 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                           ((void *)0)
# 191 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                               ;
 }
 data = info->data;
 mem_free(info);
...
void *fifo_pop_back(FIFO *fifo)
{
 ...
 if (fifo->tail == 
# 204 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                  ((void *)0)
# 204 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                      )
  return 
# 205 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
        ((void *)0)
# 205 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
            ;

 info = fifo->tail;
 if (fifo->tail->prev) {
  fifo->tail->prev->next = 
# 209 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                          ((void *)0)
# 209 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                              ;
  fifo->tail = fifo->tail->prev;
 } else {
  fifo->head = fifo->tail = 
# 212 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                           ((void *)0)
# 212 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                               ;
 }
 data = info->data;
 mem_free(info);
...
void *fifo_head(FIFO *fifo)
{
 if (fifo->head)
  ...
  return 
# 249 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
        ((void *)0)
# 249 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
            ;
}
...
void *fifo_tail(FIFO *fifo)
{
 if (fifo->tail)
  ...
  return 
# 257 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
        ((void *)0)
# 257 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
            ;
}
...
void fifo_free2(FIFO *fifo, void (*free_fn)(FIFO_INFO *))
{
 ...
 while ((info = fifo_pop_info(fifo)) != 
# 264 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                                       ((void *)0)
# 264 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                                           ) {
  if (free_fn)
   free_fn(info);
 }
...
{
 if (fifo->tail == 
# 273 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                  ((void *)0)
# 273 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                      ) {
  info->prev = info->next = 
# 274 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                           ((void *)0)
# 274 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                               ;
  fifo->head = fifo->tail = info;
 } else {
  fifo->tail->next = info;
  info->prev = fifo->tail;
  info->next = 
# 279 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
              ((void *)0)
# 279 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                  ;
  fifo->tail = info;
 }
...
FIFO_INFO *fifo_pop_info(FIFO *fifo)
{
 ...
 if (fifo->head == 
# 290 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                  ((void *)0)
# 290 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                      )
  return 
# 291 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
        ((void *)0)
# 291 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
            ;

 info = fifo->head;
 if (fifo->head->next) {
  fifo->head->next->prev = 
# 295 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                          ((void *)0)
# 295 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                              ;
  fifo->head = fifo->head->next;
 } else {
  fifo->head = fifo->tail = 
# 298 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
                           ((void *)0)
# 298 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
                               ;
 }
...
FIFO_INFO *fifo_head_info(FIFO *fifo)
{
 if (fifo->head)
  ...
  return 
# 325 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
        ((void *)0)
# 325 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
            ;
}
...
FIFO_INFO *fifo_tail_info(FIFO *fifo)
{
 if (fifo->tail)
  ...
  return 
# 333 "/workspace/acl/lib_fiber/c/src/common/fifo.c" 3 4
        ((void *)0)
# 333 "/workspace/acl/lib_fiber/c/src/common/fifo.c"
            ;
}
