# 0 "/acl/lib_fiber/c/src/common/fifo.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/common/fifo.c"
...
# 2 "/acl/lib_fiber/c/src/common/fifo.c" 2
...
# 3 "/acl/lib_fiber/c/src/common/fifo.c" 2
...
# 4 "/acl/lib_fiber/c/src/common/fifo.c" 2
# 1 "/acl/lib_fiber/c/src/common/fifo.h" 1
# 10 "/acl/lib_fiber/c/src/common/fifo.h"
...
# 64 "/acl/lib_fiber/c/src/common/fifo.h"
...
# 5 "/acl/lib_fiber/c/src/common/fifo.c" 2
...
static void *iter_head(ITER *iter, struct FIFO *fifo)
{
 ...
 iter->dlen = -1;
 iter->key = 
# 31 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
            ((void *)0)
# 31 "/acl/lib_fiber/c/src/common/fifo.c"
                ;
 iter->klen = -1;
 iter->i = 0;
 iter->size = fifo->cnt;
...
# 36 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                               ((void *)0)
# 36 "/acl/lib_fiber/c/src/common/fifo.c"
                                   ;
 return iter->ptr;
}
...
# 45 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                                    ((void *)0)
# 45 "/acl/lib_fiber/c/src/common/fifo.c"
                                        ;
 if (ptr) {
  iter->data = ptr->data;
  iter->i++;
  ...
  iter->data = 
# 50 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
              ((void *)0)
# 50 "/acl/lib_fiber/c/src/common/fifo.c"
                  ;
 return iter;
}
...
static void *iter_tail(ITER *iter, struct FIFO *fifo)
{
 ...
 iter->dlen = -1;
 iter->key = 
# 59 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
            ((void *)0)
# 59 "/acl/lib_fiber/c/src/common/fifo.c"
                ;
 iter->klen = -1;
 iter->i = fifo->cnt - 1;
 iter->size = fifo->cnt;
 ...
 iter->data = ptr ? ptr->data : 
# 64 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                               ((void *)0)
# 64 "/acl/lib_fiber/c/src/common/fifo.c"
                                   ;
 return iter->ptr;
}
...
# 73 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                                    ((void *)0)
# 73 "/acl/lib_fiber/c/src/common/fifo.c"
                                        ;
 if (ptr) {
  iter->data = ptr->data;
  iter->i--;
  ...
  iter->data = 
# 78 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
              ((void *)0)
# 78 "/acl/lib_fiber/c/src/common/fifo.c"
                  ;
 return iter;
}
...
# 84 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                                            ((void *)0)
# 84 "/acl/lib_fiber/c/src/common/fifo.c"
                                                ;
}
...
{
 fifo->head = 
# 89 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
             ((void *)0)
# 89 "/acl/lib_fiber/c/src/common/fifo.c"
                 ;
 fifo->tail = 
# 90 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
             ((void *)0)
# 90 "/acl/lib_fiber/c/src/common/fifo.c"
                 ;
 fifo->cnt = 0;
...
FIFO *fifo_new(void)
{
 ...
 fifo->head = 
# 109 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
             ((void *)0)
# 109 "/acl/lib_fiber/c/src/common/fifo.c"
                 ;
 fifo->tail = 
# 110 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
             ((void *)0)
# 110 "/acl/lib_fiber/c/src/common/fifo.c"
                 ;
 fifo->cnt = 0;
...
# 129 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                                  ((void *)0)
# 129 "/acl/lib_fiber/c/src/common/fifo.c"
                                      ) {
  if (free_fn)
   free_fn(data);
 }
...
FIFO_INFO *fifo_push_back(FIFO *fifo, void *data)
{
 ...
 if (fifo->tail == 
# 143 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                  ((void *)0)
# 143 "/acl/lib_fiber/c/src/common/fifo.c"
                      ) {
  info->prev = info->next = 
# 144 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                           ((void *)0)
# 144 "/acl/lib_fiber/c/src/common/fifo.c"
                               ;
  ...
  info->prev = fifo->tail;
  info->next = 
# 149 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
              ((void *)0)
# 149 "/acl/lib_fiber/c/src/common/fifo.c"
                  ;
  fifo->tail = info;
 }
...
FIFO_INFO *fifo_push_front(FIFO *fifo, void *data)
{
 ...
 if (fifo->head == 
# 164 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                  ((void *)0)
# 164 "/acl/lib_fiber/c/src/common/fifo.c"
                      ) {
  info->prev = info->next = 
# 165 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                           ((void *)0)
# 165 "/acl/lib_fiber/c/src/common/fifo.c"
                               ;
  fifo->head = fifo->tail = info;
 } else {
  info->next = fifo->head;
  fifo->head->prev = info;
  info->prev = 
# 170 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
              ((void *)0)
# 170 "/acl/lib_fiber/c/src/common/fifo.c"
                  ;
  fifo->head = info;
 }
...
void *fifo_pop_front(FIFO *fifo)
{
 ...
 if (fifo->head == 
# 183 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                  ((void *)0)
# 183 "/acl/lib_fiber/c/src/common/fifo.c"
                      )
  return 
# 184 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
        ((void *)0)
# 184 "/acl/lib_fiber/c/src/common/fifo.c"
            ;

 info = fifo->head;
 if (fifo->head->next) {
  fifo->head->next->prev = 
# 188 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                          ((void *)0)
# 188 "/acl/lib_fiber/c/src/common/fifo.c"
                              ;
  fifo->head = fifo->head->next;
 } else {
  fifo->head = fifo->tail = 
# 191 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                           ((void *)0)
# 191 "/acl/lib_fiber/c/src/common/fifo.c"
                               ;
 }
 data = info->data;
 mem_free(info);
...
void *fifo_pop_back(FIFO *fifo)
{
 ...
 if (fifo->tail == 
# 204 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                  ((void *)0)
# 204 "/acl/lib_fiber/c/src/common/fifo.c"
                      )
  return 
# 205 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
        ((void *)0)
# 205 "/acl/lib_fiber/c/src/common/fifo.c"
            ;

 info = fifo->tail;
 if (fifo->tail->prev) {
  fifo->tail->prev->next = 
# 209 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                          ((void *)0)
# 209 "/acl/lib_fiber/c/src/common/fifo.c"
                              ;
  fifo->tail = fifo->tail->prev;
 } else {
  fifo->head = fifo->tail = 
# 212 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                           ((void *)0)
# 212 "/acl/lib_fiber/c/src/common/fifo.c"
                               ;
 }
 data = info->data;
 mem_free(info);
...
void *fifo_head(FIFO *fifo)
{
 if (fifo->head)
  ...
  return 
# 249 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
        ((void *)0)
# 249 "/acl/lib_fiber/c/src/common/fifo.c"
            ;
}
...
void *fifo_tail(FIFO *fifo)
{
 if (fifo->tail)
  ...
  return 
# 257 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
        ((void *)0)
# 257 "/acl/lib_fiber/c/src/common/fifo.c"
            ;
}
...
# 264 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                                       ((void *)0)
# 264 "/acl/lib_fiber/c/src/common/fifo.c"
                                           ) {
  if (free_fn)
   free_fn(info);
 }
...
{
 if (fifo->tail == 
# 273 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                  ((void *)0)
# 273 "/acl/lib_fiber/c/src/common/fifo.c"
                      ) {
  info->prev = info->next = 
# 274 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                           ((void *)0)
# 274 "/acl/lib_fiber/c/src/common/fifo.c"
                               ;
  fifo->head = fifo->tail = info;
 } else {
  fifo->tail->next = info;
  info->prev = fifo->tail;
  info->next = 
# 279 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
              ((void *)0)
# 279 "/acl/lib_fiber/c/src/common/fifo.c"
                  ;
  fifo->tail = info;
 }
...
FIFO_INFO *fifo_pop_info(FIFO *fifo)
{
 ...
 if (fifo->head == 
# 290 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                  ((void *)0)
# 290 "/acl/lib_fiber/c/src/common/fifo.c"
                      )
  return 
# 291 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
        ((void *)0)
# 291 "/acl/lib_fiber/c/src/common/fifo.c"
            ;

 info = fifo->head;
 if (fifo->head->next) {
  fifo->head->next->prev = 
# 295 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                          ((void *)0)
# 295 "/acl/lib_fiber/c/src/common/fifo.c"
                              ;
  fifo->head = fifo->head->next;
 } else {
  fifo->head = fifo->tail = 
# 298 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
                           ((void *)0)
# 298 "/acl/lib_fiber/c/src/common/fifo.c"
                               ;
 }
...
FIFO_INFO *fifo_head_info(FIFO *fifo)
{
 if (fifo->head)
  ...
  return 
# 325 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
        ((void *)0)
# 325 "/acl/lib_fiber/c/src/common/fifo.c"
            ;
}
...
FIFO_INFO *fifo_tail_info(FIFO *fifo)
{
 if (fifo->tail)
  ...
  return 
# 333 "/acl/lib_fiber/c/src/common/fifo.c" 3 4
        ((void *)0)
# 333 "/acl/lib_fiber/c/src/common/fifo.c"
            ;
}
