# 0 "/acl/lib_fiber/c/src/common/strops.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/common/strops.c"
...
# 2 "/acl/lib_fiber/c/src/common/strops.c" 2
...
# 3 "/acl/lib_fiber/c/src/common/strops.c" 2
# 62 "/acl/lib_fiber/c/src/common/strops.c"
char *mystrtok(char **src, const char *sep)
{
 char *start = *src;
 char *end;
...
char *lowercase(char *s)
{
 ...
 if (s == 
# 90 "/acl/lib_fiber/c/src/common/strops.c" 3 4
         ((void *)0)
# 90 "/acl/lib_fiber/c/src/common/strops.c"
             )
  return 
# 91 "/acl/lib_fiber/c/src/common/strops.c" 3 4
        ((void *)0)
# 91 "/acl/lib_fiber/c/src/common/strops.c"
            ;

 while (*cp) {
  *cp = 
# 94 "/acl/lib_fiber/c/src/common/strops.c" 3 4
       (__extension__ ({ int __res; if (sizeof (
# 94 "/acl/lib_fiber/c/src/common/strops.c"
       *cp
# 94 "/acl/lib_fiber/c/src/common/strops.c" 3 4
...
{
 if (s == 
# 103 "/acl/lib_fiber/c/src/common/strops.c" 3 4
         ((void *)0) 
# 103 "/acl/lib_fiber/c/src/common/strops.c"
              || *s == 0)
  return 0;
 for (; *s != 0; s++)
  if (!
# 106 "/acl/lib_fiber/c/src/common/strops.c" 3 4
      ((*__ctype_b_loc ())[(int) ((
# 106 "/acl/lib_fiber/c/src/common/strops.c"
      (int) (*s)
# 106 "/acl/lib_fiber/c/src/common/strops.c" 3 4
