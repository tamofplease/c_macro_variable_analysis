# 1 "/workspace/acl/lib_fiber/c/src/common/strops.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/common/strops.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/common/strops.c" 2
# 62 "/workspace/acl/lib_fiber/c/src/common/strops.c"
char *mystrtok(char **src, const char *sep)
{
 char *start = *src;
 char *end;
...
char *lowercase(char *s)
{
 ...
 if (s == 
# 90 "/workspace/acl/lib_fiber/c/src/common/strops.c" 3 4
         ((void *)0)
# 90 "/workspace/acl/lib_fiber/c/src/common/strops.c"
             )
  return 
# 91 "/workspace/acl/lib_fiber/c/src/common/strops.c" 3 4
        ((void *)0)
# 91 "/workspace/acl/lib_fiber/c/src/common/strops.c"
            ;

 while (*cp) {
  *cp = 
# 94 "/workspace/acl/lib_fiber/c/src/common/strops.c" 3 4
       (__extension__ ({ int __res; if (sizeof (
# 94 "/workspace/acl/lib_fiber/c/src/common/strops.c"
       *cp
# 94 "/workspace/acl/lib_fiber/c/src/common/strops.c" 3 4
...
{
 if (s == 
# 103 "/workspace/acl/lib_fiber/c/src/common/strops.c" 3 4
         ((void *)0) 
# 103 "/workspace/acl/lib_fiber/c/src/common/strops.c"
              || *s == 0)
  return 0;
 for (; *s != 0; s++)
  if (!
# 106 "/workspace/acl/lib_fiber/c/src/common/strops.c" 3 4
      ((*__ctype_b_loc ())[(int) ((
# 106 "/workspace/acl/lib_fiber/c/src/common/strops.c"
      (int) (*s)
# 106 "/workspace/acl/lib_fiber/c/src/common/strops.c" 3 4
