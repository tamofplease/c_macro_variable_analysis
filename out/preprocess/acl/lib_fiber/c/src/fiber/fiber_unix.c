# 0 "/acl/lib_fiber/c/src/fiber/fiber_unix.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/fiber/fiber_unix.c"
...
# 2 "/acl/lib_fiber/c/src/fiber/fiber_unix.c" 2
...
# 3 "/acl/lib_fiber/c/src/fiber/fiber_unix.c" 2
...
# 5 "/acl/lib_fiber/c/src/fiber/fiber_unix.c" 2
# 16 "/acl/lib_fiber/c/src/fiber/fiber_unix.c"
# 1 "/acl/lib_fiber/c/src/fiber/boost_jmp.h" 1
...
# 17 "/acl/lib_fiber/c/src/fiber/fiber_unix.c" 2
# 32 "/acl/lib_fiber/c/src/fiber/fiber_unix.c"
typedef struct FIBER_UNIX {
 ...
 fcontext_t fcontext;
 char *stack;
# 53 "/acl/lib_fiber/c/src/fiber/fiber_unix.c"
 size_t size;
 char *buff;
 size_t dlen;
} FIBER_UNIX;
...
# 111 "/acl/lib_fiber/c/src/fiber/fiber_unix.c"
static void fiber_unix_swap(FIBER_UNIX *from, FIBER_UNIX *to)
{
# 129 "/acl/lib_fiber/c/src/fiber/fiber_unix.c"
 swap_fcontext(from, to);
# 164 "/acl/lib_fiber/c/src/fiber/fiber_unix.c"
}

static void fiber_unix_free(ACL_FIBER *fiber)
{
 FIBER_UNIX *fb = (FIBER_UNIX *) fiber;
# 179 "/acl/lib_fiber/c/src/fiber/fiber_unix.c"
 stack_free(fb->buff);
 mem_free(fb);
}
...
# 222 "/acl/lib_fiber/c/src/fiber/fiber_unix.c"
...
ACL_FIBER *fiber_unix_origin(void)
{
 ...
 fb->fiber.swap_fn = (void (*)(ACL_FIBER*, ACL_FIBER*))fiber_unix_swap;
 fb->fiber.start_fn = 
# 340 "/acl/lib_fiber/c/src/fiber/fiber_unix.c" 3 4
                     ((void *)0)
# 340 "/acl/lib_fiber/c/src/fiber/fiber_unix.c"
                         ;
# 350 "/acl/lib_fiber/c/src/fiber/fiber_unix.c"
 fb->fiber.free_fn = fiber_unix_free;
 fb->fiber.swap_fn = (void (*)(ACL_FIBER*, ACL_FIBER*)) fiber_unix_swap;
