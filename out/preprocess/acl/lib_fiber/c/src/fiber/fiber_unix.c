# 1 "/workspace/acl/lib_fiber/c/src/fiber/fiber_unix.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/fiber/fiber_unix.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/fiber/fiber_unix.c" 2
...
# 5 "/workspace/acl/lib_fiber/c/src/fiber/fiber_unix.c" 2
# 16 "/workspace/acl/lib_fiber/c/src/fiber/fiber_unix.c"
# 1 "/workspace/acl/lib_fiber/c/src/fiber/boost_jmp.h" 1
...
# 17 "/workspace/acl/lib_fiber/c/src/fiber/fiber_unix.c" 2
# 32 "/workspace/acl/lib_fiber/c/src/fiber/fiber_unix.c"
typedef struct FIBER_UNIX {
 ...
 fcontext_t fcontext;
 char *stack;
# 53 "/workspace/acl/lib_fiber/c/src/fiber/fiber_unix.c"
 size_t size;
 char *buff;
 size_t dlen;
} FIBER_UNIX;
...
# 111 "/workspace/acl/lib_fiber/c/src/fiber/fiber_unix.c"
static void fiber_unix_swap(FIBER_UNIX *from, FIBER_UNIX *to)
{
# 129 "/workspace/acl/lib_fiber/c/src/fiber/fiber_unix.c"
 swap_fcontext(from, to);
# 164 "/workspace/acl/lib_fiber/c/src/fiber/fiber_unix.c"
}

static void fiber_unix_free(ACL_FIBER *fiber)
{
 FIBER_UNIX *fb = (FIBER_UNIX *) fiber;
# 179 "/workspace/acl/lib_fiber/c/src/fiber/fiber_unix.c"
 stack_free(fb->buff);
 mem_free(fb);
}
...
# 222 "/workspace/acl/lib_fiber/c/src/fiber/fiber_unix.c"
...
# 254 "/workspace/acl/lib_fiber/c/src/fiber/fiber_unix.c"
 fb->stack = fb->buff + fb->size;
 fb->fcontext = make_fcontext(fb->stack, fb->size,
  (void(*)(transfer_t)) fiber_unix_start);
# 310 "/workspace/acl/lib_fiber/c/src/fiber/fiber_unix.c"
}
...
ACL_FIBER *fiber_unix_origin(void)
{
 ...
 fb->fiber.swap_fn = (void (*)(ACL_FIBER*, ACL_FIBER*))fiber_unix_swap;
 fb->fiber.start_fn = 
# 340 "/workspace/acl/lib_fiber/c/src/fiber/fiber_unix.c" 3 4
                     ((void *)0)
# 340 "/workspace/acl/lib_fiber/c/src/fiber/fiber_unix.c"
                         ;
# 350 "/workspace/acl/lib_fiber/c/src/fiber/fiber_unix.c"
 fb->fiber.free_fn = fiber_unix_free;
 fb->fiber.swap_fn = (void (*)(ACL_FIBER*, ACL_FIBER*)) fiber_unix_swap;
