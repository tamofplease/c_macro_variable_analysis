# 0 "/acl/lib_fiber/c/src/dns/resolver.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/dns/resolver.c"
...
# 2 "/acl/lib_fiber/c/src/dns/resolver.c" 2
...
# 4 "/acl/lib_fiber/c/src/dns/resolver.c" 2
# 1 "/acl/lib_fiber/c/include/fiber/fiber_hook.h" 1



# 1 "/acl/lib_fiber/c/include/fiber/fiber_define.h" 1
# 5 "/acl/lib_fiber/c/include/fiber/fiber_hook.h" 2
...
# 5 "/acl/lib_fiber/c/src/dns/resolver.c" 2
...
# 11 "/acl/lib_fiber/c/src/common/msg.h"
# 1 "/acl/lib_fiber/c/src/define.h" 1
...
# 13 "/acl/lib_fiber/c/src/dns/resolver.c" 2
...
# 14 "/acl/lib_fiber/c/src/dns/resolver.c" 2
...
# 17 "/acl/lib_fiber/c/src/dns/resolver.c" 2

# 1 "/acl/lib_fiber/c/src/dns/rfc1035.h" 1
# 12 "/acl/lib_fiber/c/src/dns/rfc1035.h"
struct ARGV;
...
# 161 "/acl/lib_fiber/c/src/dns/rfc1035.h"
RFC1035_MESSAGE *rfc1035_request_unpack(const char *buf, size_t sz);
# 171 "/acl/lib_fiber/c/src/dns/rfc1035.h"
...
# 191 "/acl/lib_fiber/c/src/dns/rfc1035.h"
...
# 19 "/acl/lib_fiber/c/src/dns/resolver.c" 2
...
# 20 "/acl/lib_fiber/c/src/dns/resolver.c" 2
# 1 "/acl/lib_fiber/c/src/dns/resolver.h" 1
# 10 "/acl/lib_fiber/c/src/dns/resolver.h"
...
# 21 "/acl/lib_fiber/c/src/dns/resolver.c" 2
...
# 26 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                              ((void *)0)
# 26 "/acl/lib_fiber/c/src/dns/resolver.c"
                                  ;
static resolv_conf *__resolv = 
# 27 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                              ((void *)0)
# 27 "/acl/lib_fiber/c/src/dns/resolver.c"
                                  ;

static char *__hosts_file = 
# 29 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                              ((void *)0)
# 29 "/acl/lib_fiber/c/src/dns/resolver.c"
                                  ;
static HTABLE *__hosts = 
# 30 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                              ((void *)0)
# 30 "/acl/lib_fiber/c/src/dns/resolver.c"
                                  ;

static char *__services_file = 
# 32 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                              ((void *)0)
# 32 "/acl/lib_fiber/c/src/dns/resolver.c"
                                  ;
static HTABLE *__services = 
# 33 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                              ((void *)0)
# 33 "/acl/lib_fiber/c/src/dns/resolver.c"
                                  ;
...
static void resolver_end(void)
{
 if (__resolv) {
  ...
  free(__resolv);
  __resolv = 
# 48 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
            ((void *)0)
# 48 "/acl/lib_fiber/c/src/dns/resolver.c"
                ;
 }
 if (__resolv_file) {
  free(__resolv_file);
  __resolv_file = 
# 52 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                 ((void *)0)
# 52 "/acl/lib_fiber/c/src/dns/resolver.c"
                     ;
 }
 ...
 if (__hosts) {
  ...
  __hosts = 
# 57 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
           ((void *)0)
# 57 "/acl/lib_fiber/c/src/dns/resolver.c"
               ;
 }
 if (__hosts_file) {
  free(__hosts_file);
  __hosts_file = 
# 61 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                ((void *)0)
# 61 "/acl/lib_fiber/c/src/dns/resolver.c"
                    ;
 }
 ...
 if (__services) {
  ...
  __services = 
# 66 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
              ((void *)0)
# 66 "/acl/lib_fiber/c/src/dns/resolver.c"
                  ;
 }
 if (__services_file) {
  free(__services_file);
  __services_file = 
# 70 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                   ((void *)0)
# 70 "/acl/lib_fiber/c/src/dns/resolver.c"
                       ;
 }
}
# 85 "/acl/lib_fiber/c/src/dns/resolver.c"
static void load_reolv_conf(const char *file, resolv_conf *conf)
{
 ...
 if (fp == 
# 90 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
          ((void *)0)
# 90 "/acl/lib_fiber/c/src/dns/resolver.c"
              ) {
 ...
 while (!feof(fp)) {
  ...
  if (s == 
# 98 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
          ((void *)0)
# 98 "/acl/lib_fiber/c/src/dns/resolver.c"
              ) {
   break;
  }
...
# 113 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                                              ((void *)0)
# 113 "/acl/lib_fiber/c/src/dns/resolver.c"
                                                  );
  argv_free(tokens);
 }
...
# 155 "/acl/lib_fiber/c/src/dns/resolver.c"
static void host_add(HTABLE *hosts, const char *line)
{
 ...
 if (is_ipv4(tokens->argv[0])) {
  ip_type = 
# 173 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
           2
# 173 "/acl/lib_fiber/c/src/dns/resolver.c"
                  ;

 } else if (is_ipv6(tokens->argv[0])) {
  ip_type = 
# 176 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
           10
# 176 "/acl/lib_fiber/c/src/dns/resolver.c"
                   ;
 ...
 if (host == 
# 189 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
            ((void *)0)
# 189 "/acl/lib_fiber/c/src/dns/resolver.c"
                ) {
 ...
 if (ip_type == 
# 195 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
               2
# 195 "/acl/lib_fiber/c/src/dns/resolver.c"
                      ) {
...
# 198 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                      10
# 198 "/acl/lib_fiber/c/src/dns/resolver.c"
                              ) {
...
static void load_hosts_conf(const char *file, HTABLE *hosts)
{
 ...
 if (fp == 
# 210 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
          ((void *)0)
# 210 "/acl/lib_fiber/c/src/dns/resolver.c"
              ) {
  msg_error("open %s error %s", file, last_serror());
  return;
 }
 ...
 while (!feof(fp)) {
  char *s = fgets(buf, (int) sizeof(buf), fp);
  if (s == 
# 217 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
          ((void *)0)
# 217 "/acl/lib_fiber/c/src/dns/resolver.c"
              ) {
   break;
  }
...
const HOST_LOCAL *find_from_localhost(const char *name)
{
 ...
 if (__hosts == 
# 234 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
               ((void *)0)
# 234 "/acl/lib_fiber/c/src/dns/resolver.c"
                   ) {
  return 
# 235 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
        ((void *)0)
# 235 "/acl/lib_fiber/c/src/dns/resolver.c"
            ;
 }
...
static void service_add(HTABLE *services, const char *line)
{
 ...
 if (service == 
# 275 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
               ((void *)0)
# 275 "/acl/lib_fiber/c/src/dns/resolver.c"
                   ) {
...
# 292 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                                          ((void *)0)
# 292 "/acl/lib_fiber/c/src/dns/resolver.c"
                                              );
 }
 argv_free(tokens);
}
...
static void load_services_conf(const char *file, HTABLE *services)
{
 ...
 if (fp == 
# 302 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
          ((void *)0)
# 302 "/acl/lib_fiber/c/src/dns/resolver.c"
              ) {
  msg_error("open %s error %s", file, last_serror());
  return;
 }
 ...
 while (!feof(fp)) {
  char *s = fgets(buf, (int) sizeof(buf), fp);
  if (s == 
# 309 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
          ((void *)0)
# 309 "/acl/lib_fiber/c/src/dns/resolver.c"
              ) {
   break;
  }
...
unsigned short get_service_port(const char *name)
{
 ...
 if (name == 
# 323 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
            ((void *)0) 
# 323 "/acl/lib_fiber/c/src/dns/resolver.c"
                 || *name == 0) {
  return 0;
 }
 ...
 if (__services == 
# 331 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                  ((void *)0)
# 331 "/acl/lib_fiber/c/src/dns/resolver.c"
                      ) {
  return 0;
 }
 ...
 if (service == 
# 338 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
               ((void *)0)
# 338 "/acl/lib_fiber/c/src/dns/resolver.c"
                   ) {
  return 0;
 }
 return service->port;
...
# 378 "/acl/lib_fiber/c/src/dns/resolver.c"
}

static pthread_once_t __once_control = 
# 380 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                                       0
# 380 "/acl/lib_fiber/c/src/dns/resolver.c"
                                                        ;
...
# 402 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                                 2
# 402 "/acl/lib_fiber/c/src/dns/resolver.c"
                                        , 
# 402 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                                          SOCK_DGRAM
# 402 "/acl/lib_fiber/c/src/dns/resolver.c"
 ...
 addr.sin_family = 
# 411 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                       2
# 411 "/acl/lib_fiber/c/src/dns/resolver.c"
                              ;
 addr.sin_port = 
# 412 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                       __bswap_16 (
# 412 "/acl/lib_fiber/c/src/dns/resolver.c"
                       port
# 412 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                       )
# 412 "/acl/lib_fiber/c/src/dns/resolver.c"
 ...
 if (read_wait(sock, __wait_timeout) < 0) {
  ...
  msg_warn("%s(%d), %s: read timeout",
   "/acl/lib_fiber/c/src/dns/resolver.c", 433, __FUNCTION__);
  return -1;
 }
 ...
 const struct addrinfo *hints, ARGV *cnames)
{
 ...
 for (i = 0; i < message->ancount; i++) {
  ...
  if (message->answer[i].type == 1) {
   ...
   in.sin_family = 
# 471 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                  2
# 471 "/acl/lib_fiber/c/src/dns/resolver.c"
                         ;
   in.sin_port = 
# 472 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                __bswap_16 (
# 472 "/acl/lib_fiber/c/src/dns/resolver.c"
                service_port
# 472 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                )
# 472 "/acl/lib_fiber/c/src/dns/resolver.c"
   ...
   in.sin6_family = 
# 482 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                   10
# 482 "/acl/lib_fiber/c/src/dns/resolver.c"
                           ;
   in.sin6_port = 
# 483 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                 __bswap_16 (
# 483 "/acl/lib_fiber/c/src/dns/resolver.c"
                 service_port
# 483 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                 )
# 483 "/acl/lib_fiber/c/src/dns/resolver.c"
...
# 495 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                          ((void *)0)
# 495 "/acl/lib_fiber/c/src/dns/resolver.c"
                              );
   continue;
  } else {
   continue;
...
static size_t build_request(const ARGV *names, char *buf, size_t size, int type)
{
 ...
 for (i = 0; i < names->argc; i++) {
  size_t dlen = rfc1035_build_query(names->argv[i], buf, size,
     get_next_qid(), type, 1, 
# 523 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                                            ((void *)0)
# 523 "/acl/lib_fiber/c/src/dns/resolver.c"
                                                );
  if (dlen > 0) {
   return dlen;
  }
 ...
 const struct addrinfo *hints, int type)
{
 const char *req = data;
 struct addrinfo *res = 
# 536 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                       ((void *)0)
# 536 "/acl/lib_fiber/c/src/dns/resolver.c"
                           ;
 int i;
 ...
 for (i = 0; i < 5; i++) {
  ...
  if (message == 
# 550 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                ((void *)0)
# 550 "/acl/lib_fiber/c/src/dns/resolver.c"
                    ) {
   break;
  }
 ...
 const struct addrinfo* hints)
{
 ...
 if (__resolv == 
# 581 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                ((void *)0) 
# 581 "/acl/lib_fiber/c/src/dns/resolver.c"
                     || __resolv->nameservers->argc <= 0) {
  return 
# 582 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
        ((void *)0)
# 582 "/acl/lib_fiber/c/src/dns/resolver.c"
            ;
 }
 ...
 if (hints) {
  ...
  case 
# 587 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
      10
# 587 "/acl/lib_fiber/c/src/dns/resolver.c"
              :
   type = 28;
   break;
  case 
# 590 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
      2
# 590 "/acl/lib_fiber/c/src/dns/resolver.c"
             :
  default:
   type = 1;
   break;
 ...
 size = rfc1035_build_query(name, buf, sizeof(buf), get_next_qid(), type,
   1, 
# 600 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                    ((void *)0)
# 600 "/acl/lib_fiber/c/src/dns/resolver.c"
                        );
 if (size == 0) {
  msg_error("%s(%d): rfc1035_build_query4a error, name=%s",
     __FUNCTION__ , 603, name);
  return 
# 604 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
        ((void *)0)
# 604 "/acl/lib_fiber/c/src/dns/resolver.c"
            ;
 }
 ...
 for (i = 0; i < __resolv->nameservers->argc; i++) {
  ...
  if (res != 
# 613 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
            ((void *)0)
# 613 "/acl/lib_fiber/c/src/dns/resolver.c"
                ) {
   return res;
  }
 }
 ...
 return 
# 618 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
       ((void *)0)
# 618 "/acl/lib_fiber/c/src/dns/resolver.c"
           ;
}
...
struct addrinfo *resolver_addrinfo_alloc(const struct sockaddr *sa)
{
 ...
 if (sa->sa_family == 
# 626 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                     2
# 626 "/acl/lib_fiber/c/src/dns/resolver.c"
                            ) {
  addrlen = (socklen_t) sizeof(struct sockaddr_in);

 } else if (sa->sa_family == 
# 629 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                            10
# 629 "/acl/lib_fiber/c/src/dns/resolver.c"
                                    ) {
  addrlen = (socklen_t) sizeof(struct sockaddr_in6);

 } else {
  return 
# 633 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
        ((void *)0)
# 633 "/acl/lib_fiber/c/src/dns/resolver.c"
            ;
 }
 ...
 ai->ai_next = 
# 640 "/acl/lib_fiber/c/src/dns/resolver.c" 3 4
              ((void *)0)
# 640 "/acl/lib_fiber/c/src/dns/resolver.c"
                  ;
