# 1 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 2
...
# 4 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 2
# 1 "/workspace/acl/lib_fiber/c/include/fiber/fiber_hook.h" 1



# 1 "/workspace/acl/lib_fiber/c/include/fiber/fiber_define.h" 1
# 5 "/workspace/acl/lib_fiber/c/include/fiber/fiber_hook.h" 2
...
# 5 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 2
...
# 11 "/workspace/acl/lib_fiber/c/src/common/msg.h"
# 1 "/workspace/acl/lib_fiber/c/src/define.h" 1
...
# 13 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 2
...
# 14 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 2
...
# 15 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 2
...
# 16 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 2
...
# 17 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 2

# 1 "/workspace/acl/lib_fiber/c/src/dns/rfc1035.h" 1
# 12 "/workspace/acl/lib_fiber/c/src/dns/rfc1035.h"
struct ARGV;
...
size_t rfc1035_build_query(const char *hostname, char *buf, size_t sz,
 ...
 RFC1035_QUERY *query);
# 132 "/workspace/acl/lib_fiber/c/src/dns/rfc1035.h"
size_t rfc1035_build_query4ptr(const struct in_addr addr, char *buf, size_t sz,
 unsigned short qid, RFC1035_QUERY *query);
# 143 "/workspace/acl/lib_fiber/c/src/dns/rfc1035.h"
...
# 161 "/workspace/acl/lib_fiber/c/src/dns/rfc1035.h"
RFC1035_MESSAGE *rfc1035_request_unpack(const char *buf, size_t sz);
# 171 "/workspace/acl/lib_fiber/c/src/dns/rfc1035.h"
...
# 191 "/workspace/acl/lib_fiber/c/src/dns/rfc1035.h"
...
# 19 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 2
...
# 20 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 2
# 1 "/workspace/acl/lib_fiber/c/src/dns/resolver.h" 1
# 10 "/workspace/acl/lib_fiber/c/src/dns/resolver.h"
...
# 21 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 2

typedef struct resolv_conf {
 ARGV *nameservers;
} resolv_conf;

static char *__resolv_file = 
# 26 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                              ((void *)0)
# 26 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                                  ;
static resolv_conf *__resolv = 
# 27 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                              ((void *)0)
# 27 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                                  ;

static char *__hosts_file = 
# 29 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                              ((void *)0)
# 29 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                                  ;
static HTABLE *__hosts = 
# 30 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                              ((void *)0)
# 30 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                                  ;

static char *__services_file = 
# 32 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                              ((void *)0)
# 32 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                                  ;
static HTABLE *__services = 
# 33 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                              ((void *)0)
# 33 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                                  ;
...
static void resolver_end(void)
{
 if (__resolv) {
  ...
  free(__resolv);
  __resolv = 
# 48 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
            ((void *)0)
# 48 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                ;
 }
 if (__resolv_file) {
  free(__resolv_file);
  __resolv_file = 
# 52 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                 ((void *)0)
# 52 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                     ;
 }
 ...
 if (__hosts) {
  ...
  __hosts = 
# 57 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
           ((void *)0)
# 57 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
               ;
 }
 if (__hosts_file) {
  free(__hosts_file);
  __hosts_file = 
# 61 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                ((void *)0)
# 61 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                    ;
 }
 ...
 if (__services) {
  ...
  __services = 
# 66 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
              ((void *)0)
# 66 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                  ;
 }
 if (__services_file) {
  free(__services_file);
  __services_file = 
# 70 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                   ((void *)0)
# 70 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                       ;
 }
}
# 85 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
static void load_reolv_conf(const char *file, resolv_conf *conf)
{
 ...
 if (fp == 
# 90 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
          ((void *)0)
# 90 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
              ) {
 ...
 while (!feof(fp)) {
  ...
  if (s == 
# 98 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
          ((void *)0)
# 98 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
              ) {
   break;
  }
  ...
  tokens = argv_split(s, " \t\r\n");
  if (tokens->argc < 2 || !!strcasecmp((tokens->argv[0]), ("nameserver"))
   || !is_ip(tokens->argv[1])) {
   argv_free(tokens);
   continue;
  }
  argv_add(conf->nameservers, tokens->argv[1], 
# 113 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                                              ((void *)0)
# 113 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                                                  );
  argv_free(tokens);
 }
...
# 155 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
static void host_add(HTABLE *hosts, const char *line)
{
 ...
 if (is_ipv4(tokens->argv[0])) {
  ip_type = 
# 173 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
           2
# 173 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                  ;

 } else if (is_ipv6(tokens->argv[0])) {
  ip_type = 
# 176 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
           10
# 176 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                   ;
 ...
 if (host == 
# 189 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
            ((void *)0)
# 189 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                ) {
 ...
 if (ip_type == 
# 195 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
               2
# 195 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                      ) {
  do { if (sizeof(host->ipv4) > 0) { size_t _n = strlen(ip); _n = _n > (size_t ) sizeof(host->ipv4) - 1? (size_t) sizeof(host->ipv4) - 1 : _n; memcpy(host->ipv4, ip, _n); host->ipv4[_n] = 0; } } while (0);

 } else if (ip_type == 
# 198 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                      10
# 198 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                              ) {
  do { if (sizeof(host->ipv6) > 0) { size_t _n = strlen(ip); _n = _n > (size_t ) sizeof(host->ipv6) - 1? (size_t) sizeof(host->ipv6) - 1 : _n; memcpy(host->ipv6, ip, _n); host->ipv6[_n] = 0; } } while (0);
...
static void load_hosts_conf(const char *file, HTABLE *hosts)
{
 ...
 if (fp == 
# 210 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
          ((void *)0)
# 210 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
              ) {
  msg_error("open %s error %s", file, last_serror());
  return;
 }
 ...
 while (!feof(fp)) {
  char *s = fgets(buf, (int) sizeof(buf), fp);
  if (s == 
# 217 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
          ((void *)0)
# 217 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
              ) {
   break;
  }
...
const HOST_LOCAL *find_from_localhost(const char *name)
{
 ...
 if (__hosts == 
# 234 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
               ((void *)0)
# 234 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                   ) {
  return 
# 235 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
        ((void *)0)
# 235 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
            ;
 }

 do { if (sizeof(buf) > 0) { size_t _n = strlen(name); _n = _n > (size_t ) sizeof(buf) - 1? (size_t) sizeof(buf) - 1 : _n; memcpy(buf, name, _n); buf[_n] = 0; } } while (0);
 lowercase(buf);
...
static void service_add(HTABLE *services, const char *line)
{
 ...
 if (service == 
# 275 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
               ((void *)0)
# 275 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                   ) {
  service = (SERVICE_PORT*) calloc(1, sizeof(SERVICE_PORT));
  service->transports = argv_alloc(2);
  do { if (sizeof(service->name) > 0) { size_t _n = strlen(tokens->argv[0]); _n = _n > (size_t ) sizeof(service->name) - 1? (size_t) sizeof(service->name) - 1 : _n; memcpy(service->name, tokens->argv[0], _n); service->name[_n] = 0; } } while (0)
                         ;
 ...
 for (i = 0; i < service->transports->argc; i++) {
  if (!strcasecmp((service->transports->argv[i]), (transport))) {
   found = 1;
  }
 }
 if (!found) {
  argv_add(service->transports, transport, 
# 292 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                                          ((void *)0)
# 292 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                                              );
 }
 argv_free(tokens);
}
...
static void load_services_conf(const char *file, HTABLE *services)
{
 ...
 if (fp == 
# 302 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
          ((void *)0)
# 302 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
              ) {
  msg_error("open %s error %s", file, last_serror());
  return;
 }
 ...
 while (!feof(fp)) {
  char *s = fgets(buf, (int) sizeof(buf), fp);
  if (s == 
# 309 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
          ((void *)0)
# 309 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
              ) {
   break;
  }
...
unsigned short get_service_port(const char *name)
{
 ...
 if (name == 
# 323 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
            ((void *)0) 
# 323 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                 || *name == 0) {
  return 0;
 }
 ...
 if (__services == 
# 331 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                  ((void *)0)
# 331 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                      ) {
  return 0;
 }

 do { if (sizeof(key) > 0) { size_t _n = strlen(name); _n = _n > (size_t ) sizeof(key) - 1? (size_t) sizeof(key) - 1 : _n; memcpy(key, name, _n); key[_n] = 0; } } while (0);
 lowercase(key);
 service = (SERVICE_PORT*) htable_find(__services, key);
 if (service == 
# 338 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
               ((void *)0)
# 338 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                   ) {
  return 0;
 }
 return service->port;
...
# 378 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
}

static pthread_once_t __once_control = 
# 380 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                                       0
# 380 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                                                        ;
 ...
 const char *data, size_t dlen, char *buf, size_t size)
{
 ...
 socklen_t len;
 socket_t sock = acl_fiber_socket(
# 402 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                                 2
# 402 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                                        , 
# 402 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                                          SOCK_DGRAM
# 402 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
 ...
 if (sock == -1) {
  msg_error("%s(%d): create socket error %s",
     __FUNCTION__ , 406, last_serror());
  return -1;
 }

 memset(&addr, 0, sizeof(addr));
 addr.sin_family = 
# 411 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                       2
# 411 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                              ;
 addr.sin_port = 
# 412 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                       (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 412 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                       port
# 412 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
...
# 412 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
 ...
 if (read_wait(sock, __wait_timeout) < 0) {
  ...
  msg_warn("%s(%d), %s: read timeout",
   "/workspace/acl/lib_fiber/c/src/dns/resolver.c", 433, __FUNCTION__);
  return -1;
 }
 ...
 const struct addrinfo *hints, ARGV *cnames)
{
 ...
 for (i = 0; i < message->ancount; i++) {
  ...
  if (message->answer[i].type == 1) {
   ...
   in.sin_family = 
# 471 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                  2
# 471 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                         ;
   in.sin_port = 
# 472 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 472 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                service_port
# 472 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 472 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
  ...
  } else if (message->answer[i].type == 28) {
   ...
   in.sin6_family = 
# 482 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                   10
# 482 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                           ;
   in.sin6_port = 
# 483 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                 (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 483 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                 service_port
# 483 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                 ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 483 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
  ...
  } else if (message->answer[i].type == 5) {
   char cname[256];
   ...
   cname[len] = 0;
   argv_add(cnames, cname, 
# 495 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                          ((void *)0)
# 495 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                              );
   continue;
  } else {
   continue;
...
static size_t build_request(const ARGV *names, char *buf, size_t size, int type)
{
 ...
 for (i = 0; i < names->argc; i++) {
  size_t dlen = rfc1035_build_query(names->argv[i], buf, size,
     get_next_qid(), type, 1, 
# 523 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                                            ((void *)0)
# 523 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                                                );
  if (dlen > 0) {
   return dlen;
  }
 ...
 const struct addrinfo *hints, int type)
{
 const char *req = data;
 struct addrinfo *res = 
# 536 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                       ((void *)0)
# 536 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                           ;
 int i;
 ...
 for (i = 0; i < 5; i++) {
  ...
  if (message == 
# 550 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                ((void *)0)
# 550 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                    ) {
   break;
  }
 ...
 const struct addrinfo* hints)
{
 ...
 if (__resolv == 
# 581 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                ((void *)0) 
# 581 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                     || __resolv->nameservers->argc <= 0) {
  return 
# 582 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
        ((void *)0)
# 582 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
            ;
 }
 ...
 if (hints) {
  ...
  case 
# 587 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
      10
# 587 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
              :
   type = 28;
   break;
  case 
# 590 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
      2
# 590 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
             :
  default:
   type = 1;
   break;
 ...
 size = rfc1035_build_query(name, buf, sizeof(buf), get_next_qid(), type,
   1, 
# 600 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                    ((void *)0)
# 600 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                        );
 if (size == 0) {
  msg_error("%s(%d): rfc1035_build_query4a error, name=%s",
     __FUNCTION__ , 603, name);
  return 
# 604 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
        ((void *)0)
# 604 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
            ;
 }
 ...
 for (i = 0; i < __resolv->nameservers->argc; i++) {
  ...
  if (res != 
# 613 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
            ((void *)0)
# 613 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                ) {
   return res;
  }
 }
 ...
 return 
# 618 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
       ((void *)0)
# 618 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
           ;
}
...
struct addrinfo *resolver_addrinfo_alloc(const struct sockaddr *sa)
{
 ...
 if (sa->sa_family == 
# 626 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                     2
# 626 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                            ) {
  addrlen = (socklen_t) sizeof(struct sockaddr_in);

 } else if (sa->sa_family == 
# 629 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
                            10
# 629 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                                    ) {
  addrlen = (socklen_t) sizeof(struct sockaddr_in6);

 } else {
  return 
# 633 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
        ((void *)0)
# 633 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
            ;
 }
 ...
 ai->ai_next = 
# 640 "/workspace/acl/lib_fiber/c/src/dns/resolver.c" 3 4
              ((void *)0)
# 640 "/workspace/acl/lib_fiber/c/src/dns/resolver.c"
                  ;
