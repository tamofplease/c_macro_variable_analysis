# 1 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c"
...
# 3 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c" 2
...
# 4 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c" 2
# 1 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.h" 1
# 16 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.h"
...
# 5 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c" 2
...
int valid_hostname(const char *name, int gripe)
{
 ...
 for (cp = name; (ch = *(const unsigned char *) cp) != 0; cp++) {
  if (
# 30 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
     ((*__ctype_b_loc ())[(int) ((
# 30 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c"
     ch
# 30 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
...
# 30 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c"
   ...
   if (!
# 40 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
       ((*__ctype_b_loc ())[(int) ((
# 40 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c"
       ch
# 40 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
...
int valid_ipv4_hostaddr(const char *addr_in, int gripe)
{
 ...
 do { if (sizeof(addr) > 0) { size_t _n = strlen(addr_in); _n = _n > (size_t ) sizeof(addr) - 1? (size_t) sizeof(addr) - 1 : _n; memcpy(addr, addr_in, _n); addr[_n] = 0; } } while (0);
 if ((ptr = strrchr(addr, '|')) != 
# 128 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
                                  ((void *)0)
# 128 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c"
                                      ) {
  *ptr = 0;
 } else if ((ptr = strrchr(addr, ':')) != 
# 130 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
                                         ((void *)0)
# 130 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c"
                                             ) {
  *ptr = 0;
 }
 ...
 for (cp = addr; (ch = *(unsigned const char *) cp) != 0; cp++) {
  if (
# 141 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
     ((*__ctype_b_loc ())[(int) ((
# 141 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c"
     ch
# 141 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
     ))] & (unsigned short int) _ISdigit)
# 141 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c"
 ...
 if (byte_count != 4 && strcmp(addr, "0") != 0) {
  if (gripe)
...
int valid_ipv6_hostaddr(const char *addr_in, int gripe)
{
 ...
 do { if (sizeof(addr) > 0) { size_t _n = strlen(addr_in); _n = _n > (size_t ) sizeof(addr) - 1? (size_t) sizeof(addr) - 1 : _n; memcpy(addr, addr_in, _n); addr[_n] = 0; } } while (0);
 if ((ptr = strrchr(addr, '|')) != 
# 201 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
                                  ((void *)0)
# 201 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c"
                                      ) {
  *ptr = 0;
 }

 if ((ptr = strrchr(addr, '%')) != 
# 205 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
                                  ((void *)0)
# 205 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c"
                                      ) {
  *ptr = 0;
 }

 cp = (const unsigned char *) addr;
# 224 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c"
 for (;;) {
  switch (*cp) {
  case 0:
  ...
  case ':':
   ...
   if (field == 0 && len == 0 && 
# 253 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
                                ((*__ctype_b_loc ())[(int) ((
# 253 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c"
                                cp[1]
# 253 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
                                ))] & (unsigned short int) _ISalnum)
# 253 "/workspace/acl/lib_fiber/c/src/dns/valid_hostname.c"
