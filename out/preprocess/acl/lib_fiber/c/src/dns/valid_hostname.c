# 0 "/acl/lib_fiber/c/src/dns/valid_hostname.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/dns/valid_hostname.c"
...
# 3 "/acl/lib_fiber/c/src/dns/valid_hostname.c" 2
...
# 4 "/acl/lib_fiber/c/src/dns/valid_hostname.c" 2
# 1 "/acl/lib_fiber/c/src/dns/valid_hostname.h" 1
# 16 "/acl/lib_fiber/c/src/dns/valid_hostname.h"
...
# 5 "/acl/lib_fiber/c/src/dns/valid_hostname.c" 2
...
int valid_hostname(const char *name, int gripe)
{
 ...
 for (cp = name; (ch = *(const unsigned char *) cp) != 0; cp++) {
  if (
# 30 "/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
     ((*__ctype_b_loc ())[(int) ((
# 30 "/acl/lib_fiber/c/src/dns/valid_hostname.c"
     ch
# 30 "/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
...
# 30 "/acl/lib_fiber/c/src/dns/valid_hostname.c"
   ...
   if (!
# 40 "/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
       ((*__ctype_b_loc ())[(int) ((
# 40 "/acl/lib_fiber/c/src/dns/valid_hostname.c"
       ch
# 40 "/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
...
int valid_ipv4_hostaddr(const char *addr_in, int gripe)
{
 ...
 if ((ptr = strrchr(addr, '|')) != 
# 128 "/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
                                  ((void *)0)
# 128 "/acl/lib_fiber/c/src/dns/valid_hostname.c"
                                      ) {
  *ptr = 0;
 } else if ((ptr = strrchr(addr, ':')) != 
# 130 "/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
                                         ((void *)0)
# 130 "/acl/lib_fiber/c/src/dns/valid_hostname.c"
                                             ) {
  *ptr = 0;
 }
 ...
 for (cp = addr; (ch = *(unsigned const char *) cp) != 0; cp++) {
  if (
# 141 "/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
     ((*__ctype_b_loc ())[(int) ((
# 141 "/acl/lib_fiber/c/src/dns/valid_hostname.c"
     ch
# 141 "/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
     ))] & (unsigned short int) _ISdigit)
# 141 "/acl/lib_fiber/c/src/dns/valid_hostname.c"
...
int valid_ipv6_hostaddr(const char *addr_in, int gripe)
{
 ...
 do { if (sizeof(addr) > 0) { size_t _n = strlen(addr_in); _n = _n > (size_t ) sizeof(addr) - 1? (size_t) sizeof(addr) - 1 : _n; memcpy(addr, addr_in, _n); addr[_n] = 0; } } while (0);
 if ((ptr = strrchr(addr, '|')) != 
# 201 "/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
                                  ((void *)0)
# 201 "/acl/lib_fiber/c/src/dns/valid_hostname.c"
                                      ) {
  *ptr = 0;
 }

 if ((ptr = strrchr(addr, '%')) != 
# 205 "/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
                                  ((void *)0)
# 205 "/acl/lib_fiber/c/src/dns/valid_hostname.c"
                                      ) {
  *ptr = 0;
 }

 cp = (const unsigned char *) addr;
# 224 "/acl/lib_fiber/c/src/dns/valid_hostname.c"
 for (;;) {
  switch (*cp) {
  case 0:
  ...
  case ':':
   ...
   if (field == 0 && len == 0 && 
# 253 "/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
                                ((*__ctype_b_loc ())[(int) ((
# 253 "/acl/lib_fiber/c/src/dns/valid_hostname.c"
                                cp[1]
# 253 "/acl/lib_fiber/c/src/dns/valid_hostname.c" 3 4
                                ))] & (unsigned short int) _ISalnum)
# 253 "/acl/lib_fiber/c/src/dns/valid_hostname.c"
