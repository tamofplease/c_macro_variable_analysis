# 0 "/acl/lib_fiber/c/src/dns/sane_inet.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/dns/sane_inet.c"
...
# 2 "/acl/lib_fiber/c/src/dns/sane_inet.c" 2
...
# 3 "/acl/lib_fiber/c/src/dns/sane_inet.c" 2
...
# 4 "/acl/lib_fiber/c/src/dns/sane_inet.c" 2
...
const char *inet_ntop4(const unsigned char *src, char *dst, size_t size)
{
 ...
 if (size < MIN_SIZE)
  return 
# 12 "/acl/lib_fiber/c/src/dns/sane_inet.c" 3 4
        ((void *)0)
# 12 "/acl/lib_fiber/c/src/dns/sane_inet.c"
            ;
...
int ipv4_addr_valid(const char *addr)
{
 ...
 if (addr == 
# 61 "/acl/lib_fiber/c/src/dns/sane_inet.c" 3 4
            ((void *)0) 
# 61 "/acl/lib_fiber/c/src/dns/sane_inet.c"
                 || *addr == 0)
  return (0);
 k = 3;
 while (*ptr && *ptr != '.') {
