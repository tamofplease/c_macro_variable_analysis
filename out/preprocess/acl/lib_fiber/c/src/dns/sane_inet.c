# 1 "/workspace/acl/lib_fiber/c/src/dns/sane_inet.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/dns/sane_inet.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/dns/sane_inet.c" 2
...
# 4 "/workspace/acl/lib_fiber/c/src/dns/sane_inet.c" 2
...
const char *inet_ntop4(const unsigned char *src, char *dst, size_t size)
{
 ...
 if (size < MIN_SIZE)
  return 
# 12 "/workspace/acl/lib_fiber/c/src/dns/sane_inet.c" 3 4
        ((void *)0)
# 12 "/workspace/acl/lib_fiber/c/src/dns/sane_inet.c"
            ;
...
int ipv4_addr_valid(const char *addr)
{
 ...
 if (addr == 
# 61 "/workspace/acl/lib_fiber/c/src/dns/sane_inet.c" 3 4
            ((void *)0) 
# 61 "/workspace/acl/lib_fiber/c/src/dns/sane_inet.c"
                 || *addr == 0)
  return (0);
 k = 3;
 while (*ptr && *ptr != '.') {
