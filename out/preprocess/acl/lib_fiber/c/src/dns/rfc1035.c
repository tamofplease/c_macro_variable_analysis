# 0 "/acl/lib_fiber/c/src/dns/rfc1035.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/dns/rfc1035.c"
...
# 2 "/acl/lib_fiber/c/src/dns/rfc1035.c" 2
# 13 "/acl/lib_fiber/c/src/dns/rfc1035.c"
# 1 "/acl/lib_fiber/c/src/common/strops.h" 1



# 1 "/acl/lib_fiber/c/src/define.h" 1
# 5 "/acl/lib_fiber/c/src/common/strops.h" 2
# 21 "/acl/lib_fiber/c/src/common/strops.h"
char *mystrtok(char **src, const char *sep);
char *lowercase(char *s);
int alldig(const char *s);
# 14 "/acl/lib_fiber/c/src/dns/rfc1035.c" 2
...
# 15 "/acl/lib_fiber/c/src/dns/rfc1035.c" 2
...
# 16 "/acl/lib_fiber/c/src/dns/rfc1035.c" 2
...
# 17 "/acl/lib_fiber/c/src/dns/rfc1035.c" 2
# 33 "/acl/lib_fiber/c/src/dns/rfc1035.c"
static size_t rfc1035_header_pack(char *buf, size_t sz, RFC1035_MESSAGE * hdr)
{
 ...
 s = 
# 44 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    __bswap_16 (
# 44 "/acl/lib_fiber/c/src/dns/rfc1035.c"
    hdr->id
# 44 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    )
# 44 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 t |= hdr->rcode;
 s = 
# 55 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    __bswap_16 (
# 55 "/acl/lib_fiber/c/src/dns/rfc1035.c"
    t
# 55 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    )
# 55 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 off += sizeof(s);
 s = 
# 58 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    __bswap_16 (
# 58 "/acl/lib_fiber/c/src/dns/rfc1035.c"
    hdr->qdcount
# 58 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    )
# 58 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 off += sizeof(s);
 s = 
# 61 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    __bswap_16 (
# 61 "/acl/lib_fiber/c/src/dns/rfc1035.c"
    hdr->ancount
# 61 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    )
# 61 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 off += sizeof(s);
 s = 
# 64 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    __bswap_16 (
# 64 "/acl/lib_fiber/c/src/dns/rfc1035.c"
    hdr->nscount
# 64 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    )
# 64 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 off += sizeof(s);
 s = 
# 67 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    __bswap_16 (
# 67 "/acl/lib_fiber/c/src/dns/rfc1035.c"
    hdr->arcount
# 67 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    )
# 67 "/acl/lib_fiber/c/src/dns/rfc1035.c"
...
# 84 "/acl/lib_fiber/c/src/dns/rfc1035.c"
static int rfc1035_label_pack(char *buf, size_t sz, const char *label)
{
 ...
 if (label) {
  if (strchr(label, '.') != 
# 91 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
                           ((void *)0)
# 91 "/acl/lib_fiber/c/src/dns/rfc1035.c"
                               ) {
...
# 117 "/acl/lib_fiber/c/src/dns/rfc1035.c"
...
# 138 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
                                               ((void *)0)
# 138 "/acl/lib_fiber/c/src/dns/rfc1035.c"
                                                   );
 if (off > (int) sz) {
 ...
 unsigned short type, unsigned short tclass)
{
 ...
 s = 
# 160 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    __bswap_16 (
# 160 "/acl/lib_fiber/c/src/dns/rfc1035.c"
    type
# 160 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    )
# 160 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 s = 
# 164 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    __bswap_16 (
# 164 "/acl/lib_fiber/c/src/dns/rfc1035.c"
    tclass
# 164 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    )
# 164 "/acl/lib_fiber/c/src/dns/rfc1035.c"
...
# 191 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 unsigned short *rdlength, char *name, size_t ns, int rdepth)
{
 ...
 do {
  ...
  if (c > 191) {
   ...
   s = 
# 218 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
      __bswap_16 (
# 218 "/acl/lib_fiber/c/src/dns/rfc1035.c"
      s
# 218 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
      )
# 218 "/acl/lib_fiber/c/src/dns/rfc1035.c"
...
const char *rfc1035_strerror(int errnum)
{
 ...
 static const struct __ERRMSG errmsg[] = {
  ...
  { -1, 
# 290 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
       ((void *)0) 
# 290 "/acl/lib_fiber/c/src/dns/rfc1035.c"
            },
 };
...
# 295 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
                             ((void *)0)
# 295 "/acl/lib_fiber/c/src/dns/rfc1035.c"
                                 ; i++) {
...
# 306 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
(*__errno_location ()) 
# 306 "/acl/lib_fiber/c/src/dns/rfc1035.c"
      = n;
}
...
# 351 "/acl/lib_fiber/c/src/dns/rfc1035.c"
static int rfc1035_rr_pack(const RFC1035_RR *rr, char *buf, size_t sz)
{
 ...
 s = 
# 359 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    __bswap_16 (
# 359 "/acl/lib_fiber/c/src/dns/rfc1035.c"
    rr->type
# 359 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    )
# 359 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 s = 
# 363 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    __bswap_16 (
# 363 "/acl/lib_fiber/c/src/dns/rfc1035.c"
    rr->tclass
# 363 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    )
# 363 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 i = 
# 367 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    __bswap_32 (
# 367 "/acl/lib_fiber/c/src/dns/rfc1035.c"
    rr->ttl
# 367 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    )
# 367 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 case 16:
  ...
  s = 
# 384 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
     __bswap_16 (
# 384 "/acl/lib_fiber/c/src/dns/rfc1035.c"
     s
# 384 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
     )
# 384 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 default:
  s = 
# 388 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
     __bswap_16 (
# 388 "/acl/lib_fiber/c/src/dns/rfc1035.c"
     rr->rdlength
# 388 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
     )
# 388 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 size_t sz, unsigned short qid, RFC1035_QUERY * query)
{
 ...
 memset(&h, '\0', sizeof(h));
 i = (unsigned int) 
# 470 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
                   __bswap_32 (
# 470 "/acl/lib_fiber/c/src/dns/rfc1035.c"
                   addr.s_addr
# 470 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
                   )
# 470 "/acl/lib_fiber/c/src/dns/rfc1035.c"
...
{
 unsigned short s = 
# 505 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
                   __bswap_16 (
# 505 "/acl/lib_fiber/c/src/dns/rfc1035.c"
                   qid
# 505 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
                   )
# 505 "/acl/lib_fiber/c/src/dns/rfc1035.c"
...
# 526 "/acl/lib_fiber/c/src/dns/rfc1035.c"
...
# 533 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
((void) sizeof ((
# 533 "/acl/lib_fiber/c/src/dns/rfc1035.c"
h
# 533 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
...
"h"
# 533 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
, "/acl/lib_fiber/c/src/dns/rfc1035.c", 533, __extension__ __PRETTY_FUNCTION__); }))
# 533 "/acl/lib_fiber/c/src/dns/rfc1035.c"
         ;
 ...
 h->id = 
# 551 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
        __bswap_16 (
# 551 "/acl/lib_fiber/c/src/dns/rfc1035.c"
        s
# 551 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
        )
# 551 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 t = 
# 555 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    __bswap_16 (
# 555 "/acl/lib_fiber/c/src/dns/rfc1035.c"
    s
# 555 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
    )
# 555 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 (*off) += sizeof(s);
 h->qdcount = 
# 571 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
             __bswap_16 (
# 571 "/acl/lib_fiber/c/src/dns/rfc1035.c"
             s
# 571 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
             )
# 571 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 (*off) += sizeof(s);
 h->ancount = 
# 575 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
             __bswap_16 (
# 575 "/acl/lib_fiber/c/src/dns/rfc1035.c"
             s
# 575 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
             )
# 575 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 (*off) += sizeof(s);
 h->nscount = 
# 579 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
             __bswap_16 (
# 579 "/acl/lib_fiber/c/src/dns/rfc1035.c"
             s
# 579 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
             )
# 579 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 (*off) += sizeof(s);
 h->arcount = 
# 583 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
             __bswap_16 (
# 583 "/acl/lib_fiber/c/src/dns/rfc1035.c"
             s
# 583 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
             )
# 583 "/acl/lib_fiber/c/src/dns/rfc1035.c"
...
# 601 "/acl/lib_fiber/c/src/dns/rfc1035.c"
...
# 606 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
                                      ((void *)0)
# 606 "/acl/lib_fiber/c/src/dns/rfc1035.c"
                                          , query->name,
  256, 0)) {
 ...
 *off += 2;
 query->qtype = 
# 622 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
               __bswap_16 (
# 622 "/acl/lib_fiber/c/src/dns/rfc1035.c"
               s
# 622 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
               )
# 622 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 *off += 2;
 query->qclass = 
# 626 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
                __bswap_16 (
# 626 "/acl/lib_fiber/c/src/dns/rfc1035.c"
                s
# 626 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
                )
# 626 "/acl/lib_fiber/c/src/dns/rfc1035.c"
...
# 641 "/acl/lib_fiber/c/src/dns/rfc1035.c"
static int rfc1035_rr_unpack(const char *buf, size_t sz, size_t *off, RFC1035_RR *rr)
{
 ...
 if (rfc1035_name_unpack(buf, sz, off, 
# 649 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
                                      ((void *)0)
# 649 "/acl/lib_fiber/c/src/dns/rfc1035.c"
                                          , rr->name,
  256, 0)) {
 ...
 (*off) += sizeof(s);
 rr->type = 
# 668 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
           __bswap_16 (
# 668 "/acl/lib_fiber/c/src/dns/rfc1035.c"
           s
# 668 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
           )
# 668 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 (*off) += sizeof(s);
 rr->tclass = 
# 672 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
             __bswap_16 (
# 672 "/acl/lib_fiber/c/src/dns/rfc1035.c"
             s
# 672 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
             )
# 672 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 (*off) += sizeof(i);
 rr->ttl = 
# 676 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
          __bswap_32 (
# 676 "/acl/lib_fiber/c/src/dns/rfc1035.c"
          i
# 676 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
          )
# 676 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 (*off) += sizeof(s);
 rdlength = 
# 680 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
           __bswap_16 (
# 680 "/acl/lib_fiber/c/src/dns/rfc1035.c"
           s
# 680 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
           )
# 680 "/acl/lib_fiber/c/src/dns/rfc1035.c"
 ...
 *nr = 0;
 ...
 if (count == 0) {
  return 
# 747 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
        ((void *)0)
# 747 "/acl/lib_fiber/c/src/dns/rfc1035.c"
            ;
 }
 ...
 if (*nr == 0) {
  free(rr);
  return 
# 766 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
        ((void *)0)
# 766 "/acl/lib_fiber/c/src/dns/rfc1035.c"
            ;
 }
...
# 778 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
(*__errno_location ()) 
# 778 "/acl/lib_fiber/c/src/dns/rfc1035.c"
      = 0;
 ...
 if (rfc1035_header_unpack(buf + off, sz - off, &off, msg)) {
  ...
  return 
# 785 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
        ((void *)0)
# 785 "/acl/lib_fiber/c/src/dns/rfc1035.c"
            ;
 }
 ...
 if (msg->rcode) {
  ...
  rfc1035_message_destroy(msg);
  return 
# 792 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
        ((void *)0)
# 792 "/acl/lib_fiber/c/src/dns/rfc1035.c"
            ;
 }
 ...
 if (msg->ancount == 0) {
  rfc1035_message_destroy(msg);
  return 
# 797 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
        ((void *)0)
# 797 "/acl/lib_fiber/c/src/dns/rfc1035.c"
            ;
 }
 ...
 if (msg->qdcount != 1) {
  ...
  rfc1035_message_destroy(msg);
  return 
# 805 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
        ((void *)0)
# 805 "/acl/lib_fiber/c/src/dns/rfc1035.c"
            ;
 }
 ...
 for (i = 0; i < (int) msg->qdcount; i++) {
  if (rfc1035_query_unpack(buf, sz, &off, &msg->query[i])) {
   ...
   rfc1035_message_destroy(msg);
   return 
# 816 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
         ((void *)0)
# 816 "/acl/lib_fiber/c/src/dns/rfc1035.c"
             ;
  }
 }
 ...
 if (msg->answer == 
# 823 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
                   ((void *)0)
# 823 "/acl/lib_fiber/c/src/dns/rfc1035.c"
                       ) {
  ...
  rfc1035_set_errno(15);
  return 
# 830 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
        ((void *)0)
# 830 "/acl/lib_fiber/c/src/dns/rfc1035.c"
            ;
 }
 ...
 if (msg->nscount > 0) {
  ...
  if (msg->authority == 
# 837 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
                       ((void *)0)
# 837 "/acl/lib_fiber/c/src/dns/rfc1035.c"
                           ) {
   (void)0;
   rfc1035_message_destroy(msg);
   rfc1035_set_errno(15);
   return 
# 841 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
         ((void *)0)
# 841 "/acl/lib_fiber/c/src/dns/rfc1035.c"
             ;
  }
 }
 ...
 if (msg->arcount > 0) {
  ...
  if (msg->additional == 
# 849 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
                        ((void *)0)
# 849 "/acl/lib_fiber/c/src/dns/rfc1035.c"
                            ) {
   (void)0;
   rfc1035_message_destroy(msg);
   rfc1035_set_errno(15);
   return 
# 853 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
         ((void *)0)
# 853 "/acl/lib_fiber/c/src/dns/rfc1035.c"
             ;
  }
 }
...
# 866 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
(*__errno_location ()) 
# 866 "/acl/lib_fiber/c/src/dns/rfc1035.c"
      = 0;
 msg = (RFC1035_MESSAGE*) calloc(1, sizeof(*msg));
 ...
 if (rfc1035_header_unpack(buf + off, sz - off, &off, msg)) {
  ...
  rfc1035_message_destroy(msg);
  return 
# 873 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
        ((void *)0)
# 873 "/acl/lib_fiber/c/src/dns/rfc1035.c"
            ;
 }
 ...
 if (msg->rcode) {
  ...
  rfc1035_message_destroy(msg);
  return 
# 880 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
        ((void *)0)
# 880 "/acl/lib_fiber/c/src/dns/rfc1035.c"
            ;
 }
 ...
 if (msg->qdcount != 1) {
  ...
  rfc1035_message_destroy(msg);
  return 
# 888 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
        ((void *)0)
# 888 "/acl/lib_fiber/c/src/dns/rfc1035.c"
            ;
 }
...
static void rfc1035_rr_destroy(RFC1035_RR *rr, int n)
{
 ...
 if (rr == 
# 911 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
          ((void *)0)
# 911 "/acl/lib_fiber/c/src/dns/rfc1035.c"
              ) {
  return;
 }
...
static size_t save_addr2rr(int type, const char *src, RFC1035_RR *rr)
{
 if (type == 1) {
  ...
  in6.sin6_family = 
# 1017 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
                   10
# 1017 "/acl/lib_fiber/c/src/dns/rfc1035.c"
                           ;
  in6.sin6_port = 
# 1018 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
                   __bswap_16 (
# 1018 "/acl/lib_fiber/c/src/dns/rfc1035.c"
                   0
# 1018 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
                   )
# 1018 "/acl/lib_fiber/c/src/dns/rfc1035.c"
  ...
  if (inet_pton(
# 1027 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
               10
# 1027 "/acl/lib_fiber/c/src/dns/rfc1035.c"
                       , buf, &in6.sin6_addr) == 0) {
...
size_t rfc1035_build_reply(const RFC1035_REPLY *reply, char *buf, size_t sz)
{
 ...
 if (reply->ips == 
# 1056 "/acl/lib_fiber/c/src/dns/rfc1035.c" 3 4
                  ((void *)0) 
# 1056 "/acl/lib_fiber/c/src/dns/rfc1035.c"
                       || reply->ips->argc <= 0) {
  msg_error("ips null");
  return 0;
 }
