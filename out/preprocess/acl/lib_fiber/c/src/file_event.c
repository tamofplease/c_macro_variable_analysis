# 0 "/acl/lib_fiber/c/src/file_event.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/file_event.c"
...
# 2 "/acl/lib_fiber/c/src/file_event.c" 2
...
# 3 "/acl/lib_fiber/c/src/file_event.c" 2
...
# 6 "/acl/lib_fiber/c/src/file_event.c" 2
...
void file_event_init(FILE_EVENT *fe, socket_t fd)
{
 ...
 fe->fd = fd;
 fe->id = -1;
 fe->status = (unsigned) (0);
 fe->type = (unsigned) (0);
 fe->oper = 0;
 fe->mask = 0;
 fe->r_proc = 
# 18 "/acl/lib_fiber/c/src/file_event.c" 3 4
             ((void *)0)
# 18 "/acl/lib_fiber/c/src/file_event.c"
                 ;
 fe->w_proc = 
# 19 "/acl/lib_fiber/c/src/file_event.c" 3 4
             ((void *)0)
# 19 "/acl/lib_fiber/c/src/file_event.c"
                 ;


 fe->pfd = 
# 22 "/acl/lib_fiber/c/src/file_event.c" 3 4
             ((void *)0)
# 22 "/acl/lib_fiber/c/src/file_event.c"
                 ;
# 49 "/acl/lib_fiber/c/src/file_event.c"
 fe->refer = 1;
 fe->busy = 0;
}
