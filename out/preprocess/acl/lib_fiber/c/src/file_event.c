# 1 "/workspace/acl/lib_fiber/c/src/file_event.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/file_event.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/file_event.c" 2
...
# 6 "/workspace/acl/lib_fiber/c/src/file_event.c" 2

void file_event_init(FILE_EVENT *fe, socket_t fd)
{
 do { RING *_ring = &fe->me; _ring->pred = _ring->succ = _ring; _ring->parent = _ring; _ring->len = 0; } while (0);
 ...
 fe->mask = 0;
 fe->r_proc = 
# 18 "/workspace/acl/lib_fiber/c/src/file_event.c" 3 4
             ((void *)0)
# 18 "/workspace/acl/lib_fiber/c/src/file_event.c"
                 ;
 fe->w_proc = 
# 19 "/workspace/acl/lib_fiber/c/src/file_event.c" 3 4
             ((void *)0)
# 19 "/workspace/acl/lib_fiber/c/src/file_event.c"
                 ;


 fe->pfd = 
# 22 "/workspace/acl/lib_fiber/c/src/file_event.c" 3 4
             ((void *)0)
# 22 "/workspace/acl/lib_fiber/c/src/file_event.c"
                 ;
# 49 "/workspace/acl/lib_fiber/c/src/file_event.c"
 fe->refer = 1;
 fe->busy = 0;
}
