# 0 "/acl/lib_fiber/c/src/fiber_io.c"
# 1 "/acl/build/fiber//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_fiber/c/src/fiber_io.c"
...
# 2 "/acl/lib_fiber/c/src/fiber_io.c" 2
...
# 3 "/acl/lib_fiber/c/src/fiber_io.c" 2


# 1 "/acl/lib_fiber/c/src/common/gettimeofday.h" 1
# 6 "/acl/lib_fiber/c/src/fiber_io.c" 2
...
# 7 "/acl/lib_fiber/c/src/fiber_io.c" 2
...
void hook_once(void);
# 8 "/acl/lib_fiber/c/src/fiber_io.c" 2
# 1 "/acl/lib_fiber/c/src/hook/io.h" 1




# 1 "/acl/lib_fiber/c/src/hook/../event.h" 1
# 6 "/acl/lib_fiber/c/src/hook/io.h" 2
...
# 9 "/acl/lib_fiber/c/src/fiber_io.c" 2
...
# 10 "/acl/lib_fiber/c/src/fiber_io.c" 2
...
# 26 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
                                ((void *)0)
# 26 "/acl/lib_fiber/c/src/fiber_io.c"
                                    ;
static __thread FIBER_TLS *__thread_fiber = 
# 27 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
                                           ((void *)0)
# 27 "/acl/lib_fiber/c/src/fiber_io.c"
                                               ;
...
{
 if (__thread_fiber != 
# 38 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
                      ((void *)0)
# 38 "/acl/lib_fiber/c/src/fiber_io.c"
                          ) {
  fiber_io_check();
...
static void thread_free(void *ctx)
{
 ...
 if (__thread_fiber == 
# 62 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
                      ((void *)0)
# 62 "/acl/lib_fiber/c/src/fiber_io.c"
                          ) {
  return;
 }
 ...
 if (tf->event) {
  event_free(tf->event);
  tf->event = 
# 68 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
             ((void *)0)
# 68 "/acl/lib_fiber/c/src/fiber_io.c"
                 ;
 }
 ...
 if (__main_fiber == __thread_fiber) {
  __main_fiber = 
# 81 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
                ((void *)0)
# 81 "/acl/lib_fiber/c/src/fiber_io.c"
                    ;
 }
 __thread_fiber = 
# 83 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
                 ((void *)0)
# 83 "/acl/lib_fiber/c/src/fiber_io.c"
                     ;
}
...
static void fiber_io_main_free(void)
{
 if (__main_fiber) {
  ...
  if (__thread_fiber == __main_fiber) {
   __thread_fiber = 
# 91 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
                   ((void *)0)
# 91 "/acl/lib_fiber/c/src/fiber_io.c"
                       ;
  }
  __main_fiber = 
# 93 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
                ((void *)0)
# 93 "/acl/lib_fiber/c/src/fiber_io.c"
                    ;
 }
}
...
static void thread_once(void)
{
 if (pthread_key_create(&__fiber_key, thread_free) != 0) {
  msg_fatal("%s(%d), %s: pthread_key_create error %s",
   "/acl/lib_fiber/c/src/fiber_io.c", 101, __FUNCTION__, last_serror());
 }
}
...
# 139 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
                                      0
# 139 "/acl/lib_fiber/c/src/fiber_io.c"
                                                       ;
...
{
 if (__thread_fiber != 
# 146 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
                      ((void *)0)
# 146 "/acl/lib_fiber/c/src/fiber_io.c"
                          ) {
  if (__thread_fiber->ev_fiber == 
# 147 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
                                 ((void *)0)
# 147 "/acl/lib_fiber/c/src/fiber_io.c"
                                     ) {
   __thread_fiber->ev_fiber = acl_fiber_create(fiber_io_loop,
    __thread_fiber->event, 819200);
   __thread_fiber->nsleeping = 0;
 ...
 if (pthread_once(&__once_control, thread_once) != 0) {
  printf("%s(%d), %s: pthread_once error %s\r\n",
   "/acl/lib_fiber/c/src/fiber_io.c", 159, __FUNCTION__, last_serror());
  abort();
 }
...
# 189 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
         __builtin_offsetof (
# 189 "/acl/lib_fiber/c/src/fiber_io.c"
         ACL_FIBER
# 189 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
         , 
# 189 "/acl/lib_fiber/c/src/fiber_io.c"
...
# 189 "/acl/lib_fiber/c/src/fiber_io.c"
  ...
  if (timer == 
# 190 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
              ((void *)0)
# 190 "/acl/lib_fiber/c/src/fiber_io.c"
                  ) {
   left = -1;
  } else {
  ...
  if (timer == 
# 213 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
              ((void *)0)
# 213 "/acl/lib_fiber/c/src/fiber_io.c"
                  ) {
   ...
   timer = (((&__thread_fiber->ev_timer)->succ) != (&__thread_fiber->ev_timer) ? ((ACL_FIBER *) ((char *) (((&__thread_fiber->ev_timer)->succ)) - 
# 227 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
          __builtin_offsetof (
# 227 "/acl/lib_fiber/c/src/fiber_io.c"
          ACL_FIBER
# 227 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
          , 
# 227 "/acl/lib_fiber/c/src/fiber_io.c"
...
# 227 "/acl/lib_fiber/c/src/fiber_io.c"
  ...
  do {
   ...
   timer = (((&__thread_fiber->ev_timer)->succ) != (&__thread_fiber->ev_timer) ? ((ACL_FIBER *) ((char *) (((&__thread_fiber->ev_timer)->succ)) - 
# 252 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
          __builtin_offsetof (
# 252 "/acl/lib_fiber/c/src/fiber_io.c"
          ACL_FIBER
# 252 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
          , 
# 252 "/acl/lib_fiber/c/src/fiber_io.c"
...
# 253 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
                   ((void *)0) 
# 253 "/acl/lib_fiber/c/src/fiber_io.c"
                        && now >= timer->when);
 }

 msg_info("%s(%d), tid=%lu: IO fiber exit now",
  __FUNCTION__, 257, thread_self());
...
# 268 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
                            ((void *)0)
# 268 "/acl/lib_fiber/c/src/fiber_io.c"
                                ;
 }
}
...
# 299 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
         __builtin_offsetof (
# 299 "/acl/lib_fiber/c/src/fiber_io.c"
         ACL_FIBER
# 299 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
         , 
# 299 "/acl/lib_fiber/c/src/fiber_io.c"
...
# 316 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
        __builtin_offsetof (
# 316 "/acl/lib_fiber/c/src/fiber_io.c"
        ACL_FIBER
# 316 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
        , 
# 316 "/acl/lib_fiber/c/src/fiber_io.c"
...
FILE_EVENT *fiber_file_get(socket_t fd)
{
# 504 "/acl/lib_fiber/c/src/fiber_io.c"
 fiber_io_check();
 if (fd <= -1 || fd >= var_maxfd) {
# 515 "/acl/lib_fiber/c/src/fiber_io.c"
  msg_error("%s(%d): invalid fd=%d", __FUNCTION__, 515, fd);

  return 
# 517 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
        ((void *)0)
# 517 "/acl/lib_fiber/c/src/fiber_io.c"
            ;
 }
...
void fiber_file_set(FILE_EVENT *fe)
{
# 534 "/acl/lib_fiber/c/src/fiber_io.c"
...
# 539 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
                                      ((void *)0)
# 539 "/acl/lib_fiber/c/src/fiber_io.c"
                                          ) {
...
FILE_EVENT *fiber_file_open_read(socket_t fd)
{
 ...
 if (fe == 
# 553 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
          ((void *)0)
# 553 "/acl/lib_fiber/c/src/fiber_io.c"
              ) {
...
FILE_EVENT *fiber_file_open_write(socket_t fd)
{
 ...
 if (fe == 
# 575 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
          ((void *)0)
# 575 "/acl/lib_fiber/c/src/fiber_io.c"
              ) {
  fe = file_event_alloc(fd);
  fiber_file_set(fe);
...
void acl_fiber_set_sysio(socket_t fd)
{
 ...
 if (fe == 
# 599 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
          ((void *)0)
# 599 "/acl/lib_fiber/c/src/fiber_io.c"
              ) {
  fe = file_event_alloc(fd);
  fiber_file_set(fe);
 }
...
{
# 622 "/acl/lib_fiber/c/src/fiber_io.c"
 if (fd == -1 || fd >= var_maxfd) {
...
# 633 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
                             ((void *)0)
# 633 "/acl/lib_fiber/c/src/fiber_io.c"
                                 ;
 return 0;
...
# 659 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
((void) sizeof ((
# 659 "/acl/lib_fiber/c/src/fiber_io.c"
fe
# 659 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
...
"fe"
# 659 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
, "/acl/lib_fiber/c/src/fiber_io.c", 659, __extension__ __PRETTY_FUNCTION__); }))
# 659 "/acl/lib_fiber/c/src/fiber_io.c"
          ;
 fiber_io_check();
...
# 682 "/acl/lib_fiber/c/src/fiber_io.c"
...
FILE_EVENT *fiber_file_cache_get(socket_t fd)
{
 ...
 if (fe == 
# 723 "/acl/lib_fiber/c/src/fiber_io.c" 3 4
          ((void *)0)
# 723 "/acl/lib_fiber/c/src/fiber_io.c"
              ) {
  fe = file_event_alloc(fd);
 } else {
