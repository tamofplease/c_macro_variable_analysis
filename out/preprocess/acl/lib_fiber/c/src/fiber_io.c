# 1 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
...
# 2 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 2
...
# 3 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 2


# 1 "/workspace/acl/lib_fiber/c/src/common/gettimeofday.h" 1
# 6 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 2
...
# 7 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 2
...
void hook_once(void);
# 8 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 2
# 1 "/workspace/acl/lib_fiber/c/src/hook/io.h" 1




# 1 "/workspace/acl/lib_fiber/c/src/hook/../event.h" 1
# 6 "/workspace/acl/lib_fiber/c/src/hook/io.h" 2
...
# 9 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 2
...
# 10 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 2
...
static FIBER_TLS *__main_fiber = 
# 26 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
                                ((void *)0)
# 26 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
                                    ;
static __thread FIBER_TLS *__thread_fiber = 
# 27 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
                                           ((void *)0)
# 27 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
                                               ;
...
{
 if (__thread_fiber != 
# 38 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
                      ((void *)0)
# 38 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
                          ) {
  fiber_io_check();
...
static void thread_free(void *ctx)
{
 ...
 if (__thread_fiber == 
# 62 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
                      ((void *)0)
# 62 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
                          ) {
  return;
 }
 ...
 if (tf->event) {
  event_free(tf->event);
  tf->event = 
# 68 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
             ((void *)0)
# 68 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
                 ;
 }
 ...
 if (__main_fiber == __thread_fiber) {
  __main_fiber = 
# 81 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
                ((void *)0)
# 81 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
                    ;
 }
 __thread_fiber = 
# 83 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
                 ((void *)0)
# 83 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
                     ;
}
...
static void fiber_io_main_free(void)
{
 if (__main_fiber) {
  ...
  if (__thread_fiber == __main_fiber) {
   __thread_fiber = 
# 91 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
                   ((void *)0)
# 91 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
                       ;
  }
  __main_fiber = 
# 93 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
                ((void *)0)
# 93 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
                    ;
 }
}
...
static void thread_once(void)
{
 if (pthread_key_create(&__fiber_key, thread_free) != 0) {
  msg_fatal("%s(%d), %s: pthread_key_create error %s",
   "/workspace/acl/lib_fiber/c/src/fiber_io.c", 101, __FUNCTION__, last_serror());
 }
}
...
static void thread_init(void)
{
 ...
 __thread_fiber->ev_fiber = acl_fiber_create(fiber_io_loop,
   __thread_fiber->event, 819200);
 __thread_fiber->nsleeping = 0;
 __thread_fiber->io_stop = 0;
 do { RING *_ring = &__thread_fiber->ev_timer; _ring->pred = _ring->succ = _ring; _ring->parent = _ring; _ring->len = 0; } while (0);
 ...
 __thread_fiber->cache = array_create(100, (1 << 0));
...
# 139 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
                                      0
# 139 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
                                                       ;
...
{
 if (__thread_fiber != 
# 146 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
                      ((void *)0)
# 146 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
                          ) {
  if (__thread_fiber->ev_fiber == 
# 147 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
                                 ((void *)0)
# 147 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
                                     ) {
   __thread_fiber->ev_fiber = acl_fiber_create(fiber_io_loop,
    __thread_fiber->event, 819200);
   __thread_fiber->nsleeping = 0;
 ...
 if (pthread_once(&__once_control, thread_once) != 0) {
  printf("%s(%d), %s: pthread_once error %s\r\n",
   "/workspace/acl/lib_fiber/c/src/fiber_io.c", 159, __FUNCTION__, last_serror());
  abort();
 }
...
static void fiber_io_loop(ACL_FIBER *self __attribute__ ((__unused__)), void *ctx)
{
 EVENT *ev = (EVENT *) ctx;
 ACL_FIBER *timer;
 ...
 for (;;) {
  ...
  timer = (((&__thread_fiber->ev_timer)->succ) != (&__thread_fiber->ev_timer) ? ((ACL_FIBER *) ((char *) (((&__thread_fiber->ev_timer)->succ)) - 
# 189 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
         __builtin_offsetof (
# 189 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
         ACL_FIBER
# 189 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
         , 
# 189 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
...
# 189 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
  ...
  if (timer == 
# 190 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
              ((void *)0)
# 190 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
                  ) {
   left = -1;
  } else {
  ...
  if (__thread_fiber->io_stop) {
   msg_info("%s(%d): io_stop set!", __FUNCTION__, 208);
   break;
  }


  if (timer == 
# 213 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
              ((void *)0)
# 213 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
                  ) {
   ...
   if ( ev->waiter > 0) {
    continue;
   } else if ((((RING*)(&ev->events))->len) > 0) {
    continue;
   }


   timer = (((&__thread_fiber->ev_timer)->succ) != (&__thread_fiber->ev_timer) ? ((ACL_FIBER *) ((char *) (((&__thread_fiber->ev_timer)->succ)) - 
# 227 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
          __builtin_offsetof (
# 227 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
          ACL_FIBER
# 227 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
          , 
# 227 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
...
# 227 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
   ...
   msg_info("%s(%d), tid=%lu: fdcount=0, waiter=%u, events=%d",
    __FUNCTION__, 233, __pthread_self(),
    ev->waiter, (((RING*)(&ev->events))->len));
   break;
  }
  ...
  do {
   do { RING *_succ, *_pred; if (((RING*)(&timer->me))->parent != (RING*)(&timer->me)) { _succ = ((RING*)(&timer->me))->succ; _pred = ((RING*)(&timer->me))->pred; if (_succ && _pred) { _pred->succ = _succ; _succ->pred = _pred; ((RING*)(&timer->me))->parent->len--; ((RING*)(&timer->me))->succ = (RING*)(&timer->me); ((RING*)(&timer->me))->pred = (RING*)(&timer->me); ((RING*)(&timer->me))->parent = (RING*)(&timer->me); ((RING*)(&timer->me))->len = 0; } } } while (0);
   ...
   timer = (((&__thread_fiber->ev_timer)->succ) != (&__thread_fiber->ev_timer) ? ((ACL_FIBER *) ((char *) (((&__thread_fiber->ev_timer)->succ)) - 
# 252 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
          __builtin_offsetof (
# 252 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
          ACL_FIBER
# 252 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
          , 
# 252 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
...
# 253 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
                   ((void *)0) 
# 253 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
                        && now >= timer->when);
 }

 msg_info("%s(%d), tid=%lu: IO fiber exit now",
  __FUNCTION__, 257, __pthread_self());
...
{
 if (__thread_fiber) {
  __thread_fiber->ev_fiber = 
# 268 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
                            ((void *)0)
# 268 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
                                ;
 }
}
...
unsigned int acl_fiber_delay(unsigned int milliseconds)
{
 ...
 for ((iter).ptr = (((&__thread_fiber->ev_timer))->succ); (iter).ptr != (&__thread_fiber->ev_timer); (iter).ptr = (((iter).ptr)->succ)) {
  fiber = ((ACL_FIBER *) (((char *) (iter.ptr)) - 
# 299 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
         __builtin_offsetof (
# 299 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
         ACL_FIBER
# 299 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
         , 
# 299 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
...
# 299 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
 ...
 do { ((RING*)(&fiber->me))->pred = ((RING*)(iter.ptr))->pred; ((RING*)(&fiber->me))->succ = (RING*)(iter.ptr); ((RING*)(&fiber->me))->parent = ((RING*)(iter.ptr))->parent; ((RING*)(iter.ptr))->pred->succ = (RING*)(&fiber->me); ((RING*)(iter.ptr))->pred = (RING*)(&fiber->me); ((RING*)(iter.ptr))->parent->len++; } while (0);
 ...
 fiber = (((&__thread_fiber->ev_timer)->succ) != (&__thread_fiber->ev_timer) ? ((ACL_FIBER *) ((char *) (((&__thread_fiber->ev_timer)->succ)) - 
# 316 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
        __builtin_offsetof (
# 316 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
        ACL_FIBER
# 316 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
        , 
# 316 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
...
# 316 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
 ...
 if ((((RING*)(&__thread_fiber->ev_timer))->len) == 0) {
  ev->timeout = -1;
 }
...
FILE_EVENT *fiber_file_get(socket_t fd)
{
# 504 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
 fiber_io_check();
 if (fd <= -1 || fd >= var_maxfd) {
# 515 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
  msg_error("%s(%d): invalid fd=%d", __FUNCTION__, 515, fd);

  return 
# 517 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
        ((void *)0)
# 517 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
            ;
 }
...
void fiber_file_set(FILE_EVENT *fe)
{
# 534 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
 if (fe->fd <= -1 || fe->fd >= (socket_t) var_maxfd) {
  printf("%s(%d): invalid fd=%d\r\n", __FUNCTION__, 535, fe->fd);
  abort();
 }

 if (__thread_fiber->events[fe->fd] != 
# 539 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
                                      ((void *)0)
# 539 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
                                          ) {
  printf("%s(%d): exist fd=%d, old=%p new=%p\r\n", __FUNCTION__,
   541, fe->fd, __thread_fiber->events[fe->fd], fe);
  abort();
 }
...
FILE_EVENT *fiber_file_open_read(socket_t fd)
{
 ...
 if (fe == 
# 553 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
          ((void *)0)
# 553 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
              ) {
...
FILE_EVENT *fiber_file_open_write(socket_t fd)
{
 ...
 if (fe == 
# 575 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
          ((void *)0)
# 575 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
              ) {
  fe = file_event_alloc(fd);
  fiber_file_set(fe);
...
void acl_fiber_set_sysio(socket_t fd)
{
 ...
 if (fe == 
# 599 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
          ((void *)0)
# 599 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
              ) {
  fe = file_event_alloc(fd);
  fiber_file_set(fe);
 }
 fe->mask |= (unsigned) (1 << 1);
}

static int fiber_file_del(FILE_EVENT *fe, socket_t fd)
{
# 622 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
 if (fd == -1 || fd >= var_maxfd) {
  msg_error("%s(%d): invalid fd=%d", __FUNCTION__, 623, fd);
  return -1;
 }

 if (__thread_fiber->events[fd] != fe) {
  msg_error("%s(%d): invalid fe=%p, fd=%d, origin=%p",
   __FUNCTION__, 629, fe, fd, __thread_fiber->events[fd]);
  return -1;
 }

 __thread_fiber->events[fd] = 
# 633 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
                             ((void *)0)
# 633 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
                                 ;
 return 0;
...
# 659 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
((void) sizeof ((
# 659 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
fe
# 659 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
...
"fe"
# 659 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
, "/workspace/acl/lib_fiber/c/src/fiber_io.c", 659, __extension__ __PRETTY_FUNCTION__); }))
# 659 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
          ;
 fiber_io_check();


 if (!((fe)->status & (unsigned) (1 << 7))) {
  EVENT *event;
 ...
 if (((fe)->status & (unsigned) (1 << 5)) && fe->fiber_r && fe->fiber_r != curr
  && fe->fiber_r->status != FIBER_STATUS_EXITING) {
# 682 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
  ((fe)->status |= (unsigned) (1 << 7));
  ((fe)->status &= ~(unsigned) (1 << 5));
 ...
 if (((fe)->status & (unsigned) (1 << 6)) && fe->fiber_w && fe->fiber_w != curr
...
FILE_EVENT *fiber_file_cache_get(socket_t fd)
{
 ...
 if (fe == 
# 723 "/workspace/acl/lib_fiber/c/src/fiber_io.c" 3 4
          ((void *)0)
# 723 "/workspace/acl/lib_fiber/c/src/fiber_io.c"
              ) {
  fe = file_event_alloc(fd);
 } else {
