# 1 "/workspace/acl/lib_protocol/src/icmp/icmp_pkt.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_protocol/src/icmp/icmp_pkt.c" 2
...
# 4 "/workspace/acl/lib_protocol/src/icmp/icmp_pkt.c" 2
...
# 5 "/workspace/acl/lib_protocol/src/icmp/icmp_pkt.c" 2
...
# 6 "/workspace/acl/lib_protocol/src/icmp/icmp_pkt.c" 2
...
ICMP_PKT *icmp_pkt_alloc(void)
{
 ICMP_PKT *pkt = (ICMP_PKT*) acl_calloc_glue("/workspace/acl/lib_protocol/src/icmp/icmp_pkt.c", 26, 1, sizeof(ICMP_PKT));
...
void icmp_pkt_free(ICMP_PKT *ipkt)
{
 do { if (ipkt) { acl_free_glue("/workspace/acl/lib_protocol/src/icmp/icmp_pkt.c", 35, (ipkt)); (ipkt) = 
# 35 "/workspace/acl/lib_protocol/src/icmp/icmp_pkt.c" 3 4
((void *)0)
# 35 "/workspace/acl/lib_protocol/src/icmp/icmp_pkt.c"
; } } while (0);
}
 ...
 unsigned char code, const void *payload, size_t payload_len)
{
 ...
 pkt->pkt_status.rtt = 65535;
 pkt->pkt_status.status = 0;
...
ICMP_PKT *icmp_pkt_check(const ICMP_HOST *host, const ICMP_PKT *pkt)
{
 ...
 if (seq < 0 || (size_t) seq >= host->npkt) {
  ...
  return 
# 175 "/workspace/acl/lib_protocol/src/icmp/icmp_pkt.c" 3 4
        ((void *)0)
# 175 "/workspace/acl/lib_protocol/src/icmp/icmp_pkt.c"
            ;
 }

 if (host->pkts[seq]->pkt_status.status == 0)
  return host->pkts[seq];
 return 
# 180 "/workspace/acl/lib_protocol/src/icmp/icmp_pkt.c" 3 4
       ((void *)0)
# 180 "/workspace/acl/lib_protocol/src/icmp/icmp_pkt.c"
           ;
}
