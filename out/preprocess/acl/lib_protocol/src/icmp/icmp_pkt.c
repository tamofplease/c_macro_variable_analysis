# 0 "/acl/lib_protocol/src/icmp/icmp_pkt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_protocol/src/icmp/icmp_pkt.c"
...
# 2 "/acl/lib_protocol/src/icmp/icmp_pkt.c" 2
...
# 4 "/acl/lib_protocol/src/icmp/icmp_pkt.c" 2
...
# 5 "/acl/lib_protocol/src/icmp/icmp_pkt.c" 2
...
# 6 "/acl/lib_protocol/src/icmp/icmp_pkt.c" 2
...
ICMP_PKT *icmp_pkt_alloc(void)
{
 ICMP_PKT *pkt = (ICMP_PKT*) acl_calloc_glue("/acl/lib_protocol/src/icmp/icmp_pkt.c", 26, 1, sizeof(ICMP_PKT));
...
void icmp_pkt_free(ICMP_PKT *ipkt)
{
 do { if (ipkt) { acl_free_glue("/acl/lib_protocol/src/icmp/icmp_pkt.c", 35, (ipkt)); (ipkt) = 
# 35 "/acl/lib_protocol/src/icmp/icmp_pkt.c" 3 4
((void *)0)
# 35 "/acl/lib_protocol/src/icmp/icmp_pkt.c"
; } } while (0);
}
...
ICMP_PKT *icmp_pkt_check(const ICMP_HOST *host, const ICMP_PKT *pkt)
{
 ...
 if (seq < 0 || (size_t) seq >= host->npkt) {
  ...
  return 
# 175 "/acl/lib_protocol/src/icmp/icmp_pkt.c" 3 4
        ((void *)0)
# 175 "/acl/lib_protocol/src/icmp/icmp_pkt.c"
            ;
 }
 ...
 return 
# 180 "/acl/lib_protocol/src/icmp/icmp_pkt.c" 3 4
       ((void *)0)
# 180 "/acl/lib_protocol/src/icmp/icmp_pkt.c"
           ;
}
