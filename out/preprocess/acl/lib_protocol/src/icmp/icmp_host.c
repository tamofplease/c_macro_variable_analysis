# 0 "/acl/lib_protocol/src/icmp/icmp_host.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_protocol/src/icmp/icmp_host.c"
...
# 2 "/acl/lib_protocol/src/icmp/icmp_host.c" 2
...
# 3 "/acl/lib_protocol/src/icmp/icmp_host.c" 2
...
# 4 "/acl/lib_protocol/src/icmp/icmp_host.c" 2
...
# 5 "/acl/lib_protocol/src/icmp/icmp_host.c" 2
...
void icmp_host_free(ICMP_HOST *host)
{
 ...
 do { if (host) { acl_free_glue("/acl/lib_protocol/src/icmp/icmp_host.c", 13, (host)); (host) = 
# 13 "/acl/lib_protocol/src/icmp/icmp_host.c" 3 4
((void *)0)
# 13 "/acl/lib_protocol/src/icmp/icmp_host.c"
; } } while (0);
}
...
ICMP_HOST *icmp_host_alloc(ICMP_CHAT *chat, const char *domain, const char *ip)
{
 ...
 if (ip == 
# 21 "/acl/lib_protocol/src/icmp/icmp_host.c" 3 4
          ((void *)0) 
# 21 "/acl/lib_protocol/src/icmp/icmp_host.c"
               || *ip == 0)
  acl_msg_fatal("%s(%d): ip null", __FUNCTION__, 22);

 host = (ICMP_HOST*) acl_calloc_glue("/acl/lib_protocol/src/icmp/icmp_host.c", 24, 1, sizeof(ICMP_HOST));
 if (domain && *domain)
 ...
 if (chat->aio != 
# 33 "/acl/lib_protocol/src/icmp/icmp_host.c" 3 4
                 ((void *)0)
# 33 "/acl/lib_protocol/src/icmp/icmp_host.c"
                     )
...
# 38 "/acl/lib_protocol/src/icmp/icmp_host.c" 3 4
                             2
# 38 "/acl/lib_protocol/src/icmp/icmp_host.c"
                                    ;
 ...
 size_t npkt, size_t dlen, int delay, int timeout)
{
 ...
 host->dlen = dlen;
 host->npkt = npkt;
 host->pkts = (ICMP_PKT**) acl_calloc_glue("/acl/lib_protocol/src/icmp/icmp_host.c", 58, host->npkt, sizeof(ICMP_PKT*));

 for (i = 0; i < npkt; i++) {
  ICMP_PKT *pkt = icmp_pkt_alloc();
  icmp_pkt_client(host, pkt, type, code, 
# 62 "/acl/lib_protocol/src/icmp/icmp_host.c" 3 4
                                        ((void *)0)
# 62 "/acl/lib_protocol/src/icmp/icmp_host.c"
                                            , dlen);
  host->pkts[i] = pkt;
 }
}
