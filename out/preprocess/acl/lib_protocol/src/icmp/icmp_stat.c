# 1 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c" 2
...
# 3 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c" 2
...
# 4 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c" 2
...
# 5 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c" 2
...
static void icmp_rtt_compute(ICMP_PKT *pkt)
{
 ...
 gettimeofday(&now, 
# 26 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c" 3 4
                   ((void *)0)
# 26 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c"
                       );
...
void icmp_stat_timeout(ICMP_HOST *host, ICMP_PKT *pkt)
{
 ...
 pkt->pkt_status.status = (1<<2);
 if (host->enable_log)
  acl_msg_info("%s Ping timeout, icmp_seq %d",
   host->dest_ip, pkt->hdr.seq);
 if (host->stat_timeout != 
# 37 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c" 3 4
                          ((void *)0)
# 37 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c"
                              )
...
{
 icmp_rtt_compute(pkt);
 pkt->pkt_status.status = (1<<1);
 if (host->enable_log)
  acl_msg_info("%s Destination host unreachable.", host->dest_ip);
 if (host->stat_unreach != 
# 47 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c" 3 4
                          ((void *)0)
# 47 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c"
                              )
...
void icmp_stat_report(ICMP_HOST *host, ICMP_PKT *pkt)
{
 ...
 if (host->stat_respond != 
# 61 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c" 3 4
                          ((void *)0)
# 61 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c"
                              )
...
void icmp_stat(ICMP_CHAT *chat)
{
 ...
 host = (((&chat->host_head)->succ) != (&chat->host_head) ? ((ICMP_HOST *) ((char *) (((&chat->host_head)->succ)) - 
# 127 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c" 3 4
       __builtin_offsetof (
# 127 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c"
       ICMP_HOST
# 127 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c" 3 4
       , 
# 127 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c"
...
# 127 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c"
 ...
 while (host) {
  ...
  host = (((&host->host_ring)->succ) != (&chat->host_head) ? ((ICMP_HOST *) ((char *) (((&host->host_ring)->succ)) - 
# 130 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c" 3 4
        __builtin_offsetof (
# 130 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c"
        ICMP_HOST
# 130 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c" 3 4
        , 
# 130 "/workspace/acl/lib_protocol/src/icmp/icmp_stat.c"
