# 1 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 2
...
# 3 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 2
...
# 4 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 2
...
# 5 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 2
...
static void read_pkt(ICMP_HOST *host, ICMP_PKT *pkt_src)
{
 ...
 gettimeofday(&begin, 
# 16 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
                     ((void *)0)
# 16 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
                         );

 
# 18 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
((void) sizeof ((
# 18 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
pkt_src->body.gid == chat->gid
# 18 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
...
"pkt_src->body.gid == chat->gid"
# 18 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
, "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c", 18, __extension__ __PRETTY_FUNCTION__); }))
# 18 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
                                          ;

 while (1) {
  pkt_src->peer = 
# 21 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
                 ((void *)0)
# 21 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
                     ;


  if (acl_read_poll_wait(((stream)->fd.sock),
   host->timeout) < 0) {
  ...
  if (ptr != 
# 58 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
            ((void *)0)
# 58 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
                ) {
   
# 59 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
  ((void) sizeof ((
# 59 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
  ptr == pkt_src
# 59 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
  ) ? 1 : 0), __extension__ ({ if (
# 59 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
...
# 59 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
  "ptr == pkt_src"
# 59 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
  , "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c", 59, __extension__ __PRETTY_FUNCTION__); }))
# 59 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
                            ;
   break;
  }
 ...
 gettimeofday(&end, 
# 64 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
                   ((void *)0)
# 64 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
                       );
...
static void send_pkt(ICMP_HOST *host, ICMP_PKT *pkt)
{
 ...
 gettimeofday(&pkt->stamp, 
# 87 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
                          ((void *)0)
# 87 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
                              );
...
void icmp_chat_sio_free(ICMP_CHAT *chat)
{
 ...
 do { if (chat) { acl_free_glue("/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c", 116, (chat)); (chat) = 
# 116 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
((void *)0)
# 116 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
; } } while (0);
}
