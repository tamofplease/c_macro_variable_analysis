# 0 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
...
# 2 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 2
...
# 3 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 2
...
# 4 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 2
...
# 5 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 2
...
static void read_pkt(ICMP_HOST *host, ICMP_PKT *pkt_src)
{
 ...
 gettimeofday(&begin, 
# 16 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
                     ((void *)0)
# 16 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
                         );

 
# 18 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
((void) sizeof ((
# 18 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
...
"pkt_src->body.gid == chat->gid"
# 18 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
, "/acl/lib_protocol/src/icmp/icmp_chat_sio.c", 18, __extension__ __PRETTY_FUNCTION__); }))
# 18 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
                                          ;

 while (1) {
  pkt_src->peer = 
# 21 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
                 ((void *)0)
# 21 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
                     ;
  ...
  if (ptr != 
# 58 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
            ((void *)0)
# 58 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
                ) {
   
# 59 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
  ((void) sizeof ((
# 59 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
  ptr == pkt_src
# 59 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
  ) ? 1 : 0), __extension__ ({ if (
# 59 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
...
# 59 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
  "ptr == pkt_src"
# 59 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
  , "/acl/lib_protocol/src/icmp/icmp_chat_sio.c", 59, __extension__ __PRETTY_FUNCTION__); }))
# 59 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
                            ;
   break;
  }
 ...
 gettimeofday(&end, 
# 64 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
                   ((void *)0)
# 64 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
                       );
...
# 87 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
                          ((void *)0)
# 87 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
                              );
...
void icmp_chat_sio_free(ICMP_CHAT *chat)
{
 ...
 do { if (chat) { acl_free_glue("/acl/lib_protocol/src/icmp/icmp_chat_sio.c", 116, (chat)); (chat) = 
# 116 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c" 3 4
((void *)0)
# 116 "/acl/lib_protocol/src/icmp/icmp_chat_sio.c"
; } } while (0);
}
