# 1 "/workspace/acl/lib_protocol/src/icmp/icmp_chat.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_protocol/src/icmp/icmp_chat.c" 2
...
# 3 "/workspace/acl/lib_protocol/src/icmp/icmp_chat.c" 2
...
# 4 "/workspace/acl/lib_protocol/src/icmp/icmp_chat.c" 2
...
# 5 "/workspace/acl/lib_protocol/src/icmp/icmp_chat.c" 2
...
static ACL_ATOMIC *__unique_lock = 
# 13 "/workspace/acl/lib_protocol/src/icmp/icmp_chat.c" 3 4
                                  ((void *)0)
# 13 "/workspace/acl/lib_protocol/src/icmp/icmp_chat.c"
                                      ;
static acl_pthread_once_t once_control = 
# 14 "/workspace/acl/lib_protocol/src/icmp/icmp_chat.c" 3 4
                                        0
# 14 "/workspace/acl/lib_protocol/src/icmp/icmp_chat.c"
                                                             ;
...
static void proc_on_exit(void)
{
 if (__unique_lock) {
  ...
  __unique_lock = 
# 21 "/workspace/acl/lib_protocol/src/icmp/icmp_chat.c" 3 4
                 ((void *)0)
# 21 "/workspace/acl/lib_protocol/src/icmp/icmp_chat.c"
                     ;
 }
}
...
ICMP_CHAT *icmp_chat_create(ACL_AIO* aio, int check_id)
{
 ...
 if (pthread_once(&once_control, icmp_once) != 0)
  acl_msg_fatal("acl_pthread_once failed %s", acl_last_serror());

 chat = (ICMP_CHAT*) acl_calloc_glue("/workspace/acl/lib_protocol/src/icmp/icmp_chat.c", 42, 1, sizeof(ICMP_CHAT));
