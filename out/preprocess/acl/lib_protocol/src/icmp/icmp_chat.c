# 0 "/acl/lib_protocol/src/icmp/icmp_chat.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_protocol/src/icmp/icmp_chat.c"
...
# 2 "/acl/lib_protocol/src/icmp/icmp_chat.c" 2
...
# 3 "/acl/lib_protocol/src/icmp/icmp_chat.c" 2
...
# 4 "/acl/lib_protocol/src/icmp/icmp_chat.c" 2
...
# 5 "/acl/lib_protocol/src/icmp/icmp_chat.c" 2
...
# 13 "/acl/lib_protocol/src/icmp/icmp_chat.c" 3 4
                                  ((void *)0)
# 13 "/acl/lib_protocol/src/icmp/icmp_chat.c"
                                      ;
static acl_pthread_once_t once_control = 
# 14 "/acl/lib_protocol/src/icmp/icmp_chat.c" 3 4
                                        0
# 14 "/acl/lib_protocol/src/icmp/icmp_chat.c"
                                                             ;
...
static void proc_on_exit(void)
{
 if (__unique_lock) {
  ...
  __unique_lock = 
# 21 "/acl/lib_protocol/src/icmp/icmp_chat.c" 3 4
                 ((void *)0)
# 21 "/acl/lib_protocol/src/icmp/icmp_chat.c"
                     ;
 }
}
...
ICMP_CHAT *icmp_chat_create(ACL_AIO* aio, int check_id)
{
 ...
 chat = (ICMP_CHAT*) acl_calloc_glue("/acl/lib_protocol/src/icmp/icmp_chat.c", 42, 1, sizeof(ICMP_CHAT));
