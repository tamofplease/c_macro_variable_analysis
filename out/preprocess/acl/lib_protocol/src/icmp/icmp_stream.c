# 1 "/workspace/acl/lib_protocol/src/icmp/icmp_stream.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_protocol/src/icmp/icmp_stream.c" 2
...
# 3 "/workspace/acl/lib_protocol/src/icmp/icmp_stream.c" 2
...
# 4 "/workspace/acl/lib_protocol/src/icmp/icmp_stream.c" 2
...
# 5 "/workspace/acl/lib_protocol/src/icmp/icmp_stream.c" 2

static int icmp_read(int fd, void* buf, size_t size,
 int timeout __attribute__ ((__unused__)), ACL_VSTREAM* stream, void* arg)
{
 ...
 if (ret < 0)
  acl_msg_error("%s(%d): recvfrom error(%s)", "/workspace/acl/lib_protocol/src/icmp/icmp_stream.c",
   26, acl_last_serror());
 return ret;
}

static int icmp_write(int fd, const void* buf, size_t size,
 int timeout __attribute__ ((__unused__)), ACL_VSTREAM* stream __attribute__ ((__unused__)), void* arg)
{
 ICMP_STREAM* is = (ICMP_STREAM*) arg;
 int ret;
...
void icmp_stream_close(ICMP_STREAM* is)
{
 ...
 do { if (is) { acl_free_glue("/workspace/acl/lib_protocol/src/icmp/icmp_stream.c", 74, (is)); (is) = 
# 74 "/workspace/acl/lib_protocol/src/icmp/icmp_stream.c" 3 4
((void *)0)
# 74 "/workspace/acl/lib_protocol/src/icmp/icmp_stream.c"
; } } while (0);
}
...
ICMP_STREAM* icmp_stream_open(ACL_AIO* aio)
{
 ...
 int fd;
 ICMP_STREAM* is = (ICMP_STREAM*) acl_calloc_glue("/workspace/acl/lib_protocol/src/icmp/icmp_stream.c", 81, 1, sizeof(ICMP_STREAM));
 ...
 fd = socket(
# 87 "/workspace/acl/lib_protocol/src/icmp/icmp_stream.c" 3 4
            2
# 87 "/workspace/acl/lib_protocol/src/icmp/icmp_stream.c"
                   , 
# 87 "/workspace/acl/lib_protocol/src/icmp/icmp_stream.c" 3 4
                     SOCK_RAW
# 87 "/workspace/acl/lib_protocol/src/icmp/icmp_stream.c"
...
# 87 "/workspace/acl/lib_protocol/src/icmp/icmp_stream.c"
 ...
 if (fd == (int) -1)
  acl_msg_fatal("%s(%d): socket create error", myname, 89);

 is->vstream = acl_vstream_fdopen(fd, 
# 91 "/workspace/acl/lib_protocol/src/icmp/icmp_stream.c" 3 4
                                     02
# 91 "/workspace/acl/lib_protocol/src/icmp/icmp_stream.c"
                                           , 1024, -1,
   (1 << 0));

 acl_vstream_ctl(is->vstream, 1, icmp_read,
  2, icmp_write, 6,
  is, 0);
...
void icmp_stream_reopen(ACL_AIO* aio, ICMP_STREAM* is)
{
 int fd = ((is->vstream)->fd.sock);
 ((is->vstream)->fd.sock) =
  (int) -1;

 is->vstream = acl_vstream_fdopen(
  fd, 
# 112 "/workspace/acl/lib_protocol/src/icmp/icmp_stream.c" 3 4
     02
# 112 "/workspace/acl/lib_protocol/src/icmp/icmp_stream.c"
           , 1024, -1, (1 << 0));
 acl_vstream_ctl(is->vstream, 1, icmp_read,
  2, icmp_write, 6,
  is, 0);
