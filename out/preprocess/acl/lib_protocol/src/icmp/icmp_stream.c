# 0 "/acl/lib_protocol/src/icmp/icmp_stream.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_protocol/src/icmp/icmp_stream.c"
...
# 2 "/acl/lib_protocol/src/icmp/icmp_stream.c" 2
...
# 3 "/acl/lib_protocol/src/icmp/icmp_stream.c" 2
...
# 4 "/acl/lib_protocol/src/icmp/icmp_stream.c" 2
...
# 5 "/acl/lib_protocol/src/icmp/icmp_stream.c" 2
 ...
 int timeout __attribute__ ((__unused__)), ACL_VSTREAM* stream, void* arg)
{
 ...
 if (ret < 0)
  acl_msg_error("%s(%d): recvfrom error(%s)", "/acl/lib_protocol/src/icmp/icmp_stream.c",
   26, acl_last_serror());
 return ret;
}
...
void icmp_stream_close(ICMP_STREAM* is)
{
 ...
 do { if (is) { acl_free_glue("/acl/lib_protocol/src/icmp/icmp_stream.c", 74, (is)); (is) = 
# 74 "/acl/lib_protocol/src/icmp/icmp_stream.c" 3 4
((void *)0)
# 74 "/acl/lib_protocol/src/icmp/icmp_stream.c"
; } } while (0);
}
...
ICMP_STREAM* icmp_stream_open(ACL_AIO* aio)
{
 ...
 int fd;
 ICMP_STREAM* is = (ICMP_STREAM*) acl_calloc_glue("/acl/lib_protocol/src/icmp/icmp_stream.c", 81, 1, sizeof(ICMP_STREAM));
 ...
 fd = socket(
# 87 "/acl/lib_protocol/src/icmp/icmp_stream.c" 3 4
            2
# 87 "/acl/lib_protocol/src/icmp/icmp_stream.c"
                   , 
# 87 "/acl/lib_protocol/src/icmp/icmp_stream.c" 3 4
                     SOCK_RAW
# 87 "/acl/lib_protocol/src/icmp/icmp_stream.c"
...
# 91 "/acl/lib_protocol/src/icmp/icmp_stream.c" 3 4
                                     02
# 91 "/acl/lib_protocol/src/icmp/icmp_stream.c"
                                           , 1024, -1,
   (1 << 0));
...
void icmp_stream_reopen(ACL_AIO* aio, ICMP_STREAM* is)
{
 ...
 is->vstream = acl_vstream_fdopen(
  fd, 
# 112 "/acl/lib_protocol/src/icmp/icmp_stream.c" 3 4
     02
# 112 "/acl/lib_protocol/src/icmp/icmp_stream.c"
           , 1024, -1, (1 << 0));
 acl_vstream_ctl(is->vstream, 1, icmp_read,
  2, icmp_write, 6,
  is, 0);
