# 0 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c"
...
# 2 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 2
# 1 "/acl/lib_protocol/include/icmp/lib_icmp.h" 1




# 1 "/acl/lib_protocol/include/icmp/lib_icmp_type.h" 1
# 9 "/acl/lib_protocol/include/icmp/lib_icmp_type.h"
...
# 6 "/acl/lib_protocol/include/icmp/lib_icmp.h" 2
# 35 "/acl/lib_protocol/include/icmp/lib_icmp.h"
...
# 103 "/acl/lib_protocol/include/icmp/lib_icmp.h"
...
# 121 "/acl/lib_protocol/include/icmp/lib_icmp.h"
 void icmp_host_set(ICMP_HOST *host, void *arg,
 void (*stat_respond)(ICMP_PKT_STATUS*, void*),
 void (*stat_timeout)(ICMP_PKT_STATUS*, void*),
 void (*stat_unreach)(ICMP_PKT_STATUS*, void*),
 void (*stat_finish)(ICMP_HOST*, void*));
# 137 "/acl/lib_protocol/include/icmp/lib_icmp.h"
...
# 3 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 2
# 1 "/acl/lib_protocol/src/icmp/icmp_struct.h" 1
...
# 1 "/acl/lib_protocol/include/icmp/lib_icmp_type.h" 1
# 7 "/acl/lib_protocol/src/icmp/icmp_struct.h" 2
...
# 4 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 2
# 1 "/acl/lib_protocol/src/icmp/icmp_private.h" 1
...
# 5 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 2
 ...
 ACL_EVENT *event __attribute__ ((__unused__)), void *context)
{
 ...
 if (chat == 
# 17 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 3 4
            ((void *)0)
# 17 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c"
                )
 ...
 while (1) {
  ...
  if (pkt == 
# 22 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 3 4
            ((void *)0)
# 22 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c"
                )
   break;
...
static void delay_send_pkt(ICMP_HOST *host, ICMP_PKT *pkt, int delay)
{
 ...
 if (pkt == 
# 109 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 3 4
           ((void *)0)
# 109 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c"
               )
 ...
 const char *data, int dlen)
{
 ...
 if (chat == 
# 151 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 3 4
            ((void *)0)
# 151 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c"
                )
  acl_msg_fatal("%s(%d): chat null", "/acl/lib_protocol/src/icmp/icmp_chat_aio.c", 152);
 ...
 if (pkt_src == 
# 166 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 3 4
               ((void *)0)
# 166 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c"
                   ) {
...
# 235 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 3 4
                                                           ((void *)0)
# 235 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c"
                                                               ) {
  host = ((ICMP_HOST *) ((char *) (ring_ptr) - 
# 236 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 3 4
        __builtin_offsetof (
# 236 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c"
        ICMP_HOST
# 236 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 3 4
        , 
# 236 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c"
...
void icmp_chat_aio_free(ICMP_CHAT *chat)
{
 ...
 do { if (chat) { acl_free_glue("/acl/lib_protocol/src/icmp/icmp_chat_aio.c", 249, (chat)); (chat) = 
# 249 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 3 4
((void *)0)
# 249 "/acl/lib_protocol/src/icmp/icmp_chat_aio.c"
; } } while (0);
}
