# 1 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 2
# 1 "/workspace/acl/lib_protocol/include/icmp/lib_icmp.h" 1
...
# 6 "/workspace/acl/lib_protocol/include/icmp/lib_icmp.h" 2
# 35 "/workspace/acl/lib_protocol/include/icmp/lib_icmp.h"
...
# 103 "/workspace/acl/lib_protocol/include/icmp/lib_icmp.h"
...
# 121 "/workspace/acl/lib_protocol/include/icmp/lib_icmp.h"
 void icmp_host_set(ICMP_HOST *host, void *arg,
 void (*stat_respond)(ICMP_PKT_STATUS*, void*),
 void (*stat_timeout)(ICMP_PKT_STATUS*, void*),
 void (*stat_unreach)(ICMP_PKT_STATUS*, void*),
 void (*stat_finish)(ICMP_HOST*, void*));
# 137 "/workspace/acl/lib_protocol/include/icmp/lib_icmp.h"
...
# 3 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 2
...
# 4 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 2
...
# 5 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 2
...
static void check_timer(int event_type __attribute__ ((__unused__)),
 ACL_EVENT *event __attribute__ ((__unused__)), void *context)
{
 ...
 if (chat == 
# 17 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 3 4
            ((void *)0)
# 17 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c"
                )
  acl_msg_fatal("%s(%d): chat null", myname, 18);

 while (1) {
  ICMP_PKT *pkt = (ICMP_PKT*) chat->timer->popup(chat->timer);
  if (pkt == 
# 22 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 3 4
            ((void *)0)
# 22 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c"
                )
   break;
...
static void delay_send_timer(int event_type __attribute__ ((__unused__)),
 ACL_EVENT *event __attribute__ ((__unused__)), void *context)
{
...
static void delay_send_pkt(ICMP_HOST *host, ICMP_PKT *pkt, int delay)
{
 ...
 if (pkt == 
# 109 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 3 4
           ((void *)0)
# 109 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c"
               )
  acl_msg_fatal("%s(%d): pkt null", myname, 110);
...
static int read_close_fn(ACL_ASTREAM *astream __attribute__ ((__unused__)), void *arg)
{
 ...
 acl_msg_warn("%s(%d): sock read error", myname, 126);
 ...
 const char *data, int dlen)
{
 ...
 if (chat == 
# 151 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 3 4
            ((void *)0)
# 151 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c"
                )
  acl_msg_fatal("%s(%d): chat null", "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c", 152);

 if (icmp_pkt_unpack(chat->is->from, data, dlen, &pkt) < 0)
  do { acl_aio_read(astream); return(0); } while (0);
 ...
 if (pkt_src == 
# 166 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 3 4
               ((void *)0)
# 166 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c"
                   ) {
  acl_msg_warn("%s(%d): seq(%d) not found",
   myname, 168, pkt.hdr.seq);
  do { acl_aio_read(astream); return(0); } while (0);
 }
...
static int timeout_fn(ACL_ASTREAM *astream __attribute__ ((__unused__)), void *arg __attribute__ ((__unused__)))
{
 const char *myname = "timeout_fn";

 acl_msg_fatal("%s(%d): be called", myname, 193);


 return (-1);
}

static int write_ready_fn(ACL_ASTREAM *astream __attribute__ ((__unused__)), void *arg __attribute__ ((__unused__)))
{
 const char *myname = "write_ready_fn";

 acl_msg_fatal("%s(%d): be called", myname, 203);
 return (-1);
}
...
void icmp_chat_aio_add(ICMP_CHAT *chat, ICMP_HOST *host)
{
 ...
 acl_aio_ctl(chat->is->astream,
  14, read_ready_fn, host,
  16, write_ready_fn, host,
  18, read_close_fn, host,
  20, timeout_fn, host,
  4, 0,
  0);
...
static void icmp_rset(ICMP_CHAT *chat)
{
 ...
 while ((ring_ptr = acl_ring_pop_head(&chat->host_head)) != 
# 235 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 3 4
                                                           ((void *)0)
# 235 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c"
                                                               ) {
  host = ((ICMP_HOST *) ((char *) (ring_ptr) - 
# 236 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 3 4
        __builtin_offsetof (
# 236 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c"
        ICMP_HOST
# 236 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 3 4
        , 
# 236 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c"
...
void icmp_chat_aio_free(ICMP_CHAT *chat)
{
 ...
 do { if (chat) { acl_free_glue("/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c", 249, (chat)); (chat) = 
# 249 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c" 3 4
((void *)0)
# 249 "/workspace/acl/lib_protocol/src/icmp/icmp_chat_aio.c"
; } } while (0);
}
