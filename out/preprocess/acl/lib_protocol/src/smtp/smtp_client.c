# 1 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 2

# 1 "/usr/include/assert.h" 1 3 4
# 4 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 2

# 1 "/workspace/acl/lib_protocol/include/smtp/smtp_client.h" 1
# 26 "/workspace/acl/lib_protocol/include/smtp/smtp_client.h"
...
# 50 "/workspace/acl/lib_protocol/include/smtp/smtp_client.h"
...
# 76 "/workspace/acl/lib_protocol/include/smtp/smtp_client.h"
 int smtp_greet(SMTP_CLIENT *client, const char* name, int ehlo);
# 85 "/workspace/acl/lib_protocol/include/smtp/smtp_client.h"
 int smtp_helo(SMTP_CLIENT *client, const char *helo);
# 94 "/workspace/acl/lib_protocol/include/smtp/smtp_client.h"
 int smtp_ehlo(SMTP_CLIENT *client, const char *ehlo);
# 104 "/workspace/acl/lib_protocol/include/smtp/smtp_client.h"
 int smtp_auth(SMTP_CLIENT *client, const char *user, const char *pass);
# 113 "/workspace/acl/lib_protocol/include/smtp/smtp_client.h"
 int smtp_mail(SMTP_CLIENT *client, const char *from);
# 122 "/workspace/acl/lib_protocol/include/smtp/smtp_client.h"
...
# 140 "/workspace/acl/lib_protocol/include/smtp/smtp_client.h"
 int smtp_send(SMTP_CLIENT *client, const char* src, size_t len);
# 150 "/workspace/acl/lib_protocol/include/smtp/smtp_client.h"
...
# 167 "/workspace/acl/lib_protocol/include/smtp/smtp_client.h"
 int smtp_send_file(SMTP_CLIENT *client, const char *filepath);
# 176 "/workspace/acl/lib_protocol/include/smtp/smtp_client.h"
...
# 6 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 2
 ...
 int rw_timeout, int line_limit)
{
 ...
 conn = acl_vstream_connect(addr, 0, conn_timeout,
  rw_timeout, 4096);
 if (conn == 
# 17 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
            ((void *)0)
# 17 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
                ) {
  acl_msg_error("%s(%d): connect %s error(%s)",
   __FUNCTION__, 19, addr,
   acl_last_serror());
  return 
# 21 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
        ((void *)0)
# 21 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
            ;
 }

 client = (SMTP_CLIENT*) acl_calloc_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 24, 1, sizeof(SMTP_CLIENT));
 client->conn = conn;
 client->buf = (char*) acl_malloc_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 26, line_limit);
...
void smtp_close(SMTP_CLIENT *client)
{
 ...
 do { if (client->buf) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 39, (client->buf)); (client->buf) = 
# 39 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
((void *)0)
# 39 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
; } } while (0);
 do { if (client) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 40, (client)); (client) = 
# 40 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
((void *)0)
# 40 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
; } } while (0);
}
...
int smtp_get_banner(SMTP_CLIENT *client)
{
 ...
 if (ptr == 
# 62 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
           ((void *)0)
# 62 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
               )
  ptr = strchr(client->buf, '\t');
 if (ptr == 
# 64 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
           ((void *)0)
# 64 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
               ) {
  acl_msg_error("%s(%d): get banner(%s) invalid",
   __FUNCTION__, 66, client->buf);
  return -1;
 }
 *ptr = 0;
 ...
 *ptr = ' ';
 if (client->smtp_code != 220) {
  acl_msg_error("%s(%d): get banner code(%d) error(%s)",
   __FUNCTION__, 74, client->smtp_code, client->buf);
  return -1;
 }
 return 0;
}
...
int smtp_helo(SMTP_CLIENT *client, const char *helo)
{
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): send helo error(%s)",
   __FUNCTION__, 102, acl_last_serror());
  return -1;
 }
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): gets helo's error(%s)",
   __FUNCTION__, 110, acl_last_serror());
  return -1;
 }

 ptr = strchr(client->buf, ' ');
 if (ptr == 
# 115 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
           ((void *)0)
# 115 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
               )
  ptr = strchr(client->buf, '\t');
 if (ptr == 
# 117 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
           ((void *)0)
# 117 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
               ) {
  acl_msg_error("%s(%d): get helo reply error, line(%s)",
   __FUNCTION__, 119, client->buf);
  return -1;
 }
 *ptr = 0;
 client->smtp_code = atoi(client->buf);
 *ptr = ' ';
 if (client->smtp_code != 250) {
  acl_msg_error("%s(%d): helo's reply code: %d, line(%s)",
   __FUNCTION__, 127, client->smtp_code, client->buf);
  return -1;
 }
 return 0;
}
...
int smtp_ehlo(SMTP_CLIENT *client, const char *ehlo)
{
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): set EHLO error(%s)",
   __FUNCTION__, 167, acl_last_serror());
  return -1;
 }
 ...
 while (1) {
  ...
  if (ret == (-1)) {
   acl_msg_error("%s(%d): get EHLO's reply error(%s)",
    __FUNCTION__, 175, acl_last_serror());
   return -1;
  } else if (ret < 3) {
   acl_msg_warn("%s(%d): EHLO's reply(%s) tool short",
    __FUNCTION__, 179, client->buf);
   continue;
  }
  ...
  if (strncmp(client->buf, "250", 3) != 0) {
   ...
   acl_msg_error("%s(%d): EHLO's reply(%s) code(%d) error",
    __FUNCTION__, 190, client->buf, ret);
   return -1;
  } else
...
int smtp_auth(SMTP_CLIENT *client, const char *user, const char *pass)
{
 int ret;
 ACL_ARGV *tokens = 
# 215 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
                   ((void *)0)
# 215 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
                       ;
 char *user_encoded = 
# 216 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
                     ((void *)0)
# 216 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
                         , *pass_encoded = 
# 216 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
                                           ((void *)0)
# 216 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
                                               ;
# 229 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
 client->smtp_code = 0;
 client->buf[0] = 0;
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): send AUTH LOGIN to error(%s)",
   __FUNCTION__, 237, acl_last_serror());
  do { if (tokens) acl_argv_free(tokens); if (user_encoded) do { if (user_encoded) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 238, (user_encoded)); (user_encoded) = 
# 238 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 238 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); if (pass_encoded) do { if (pass_encoded) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 238, (pass_encoded)); (pass_encoded) = 
# 238 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 238 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): gets AUTH LOGIN's reply error(%s)",
   __FUNCTION__, 244, acl_last_serror());
  do { if (tokens) acl_argv_free(tokens); if (user_encoded) do { if (user_encoded) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 245, (user_encoded)); (user_encoded) = 
# 245 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 245 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); if (pass_encoded) do { if (pass_encoded) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 245, (pass_encoded)); (pass_encoded) = 
# 245 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 245 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); return (-1); } while (0);
 ...
 if (client->smtp_code != 334) {
  acl_msg_error("%s(%d): AUTH LOGIN failed, line(%s)",
   __FUNCTION__, 252, client->buf);
  do { if (tokens) acl_argv_free(tokens); if (user_encoded) do { if (user_encoded) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 253, (user_encoded)); (user_encoded) = 
# 253 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 253 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); if (pass_encoded) do { if (pass_encoded) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 253, (pass_encoded)); (pass_encoded) = 
# 253 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 253 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); return (-1); } while (0);
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): send user error(%s)",
   __FUNCTION__, 262, acl_last_serror());
  do { if (tokens) acl_argv_free(tokens); if (user_encoded) do { if (user_encoded) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 263, (user_encoded)); (user_encoded) = 
# 263 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 263 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); if (pass_encoded) do { if (pass_encoded) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 263, (pass_encoded)); (pass_encoded) = 
# 263 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 263 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); return (-1); } while (0);
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): auth gets error(%s)",
   __FUNCTION__, 269, acl_last_serror());
  do { if (tokens) acl_argv_free(tokens); if (user_encoded) do { if (user_encoded) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 270, (user_encoded)); (user_encoded) = 
# 270 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 270 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); if (pass_encoded) do { if (pass_encoded) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 270, (pass_encoded)); (pass_encoded) = 
# 270 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 270 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); return (-1); } while (0);
 ...
 if (client->smtp_code != 334) {
  acl_msg_error("%s(%d): AUTH LOGIN failed, line(%s)",
   __FUNCTION__, 277, client->buf);
  do { if (tokens) acl_argv_free(tokens); if (user_encoded) do { if (user_encoded) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 278, (user_encoded)); (user_encoded) = 
# 278 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 278 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); if (pass_encoded) do { if (pass_encoded) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 278, (pass_encoded)); (pass_encoded) = 
# 278 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 278 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); return (-1); } while (0);
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): send pass error(%s)",
   __FUNCTION__, 287, acl_last_serror());
  do { if (tokens) acl_argv_free(tokens); if (user_encoded) do { if (user_encoded) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 288, (user_encoded)); (user_encoded) = 
# 288 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 288 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); if (pass_encoded) do { if (pass_encoded) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 288, (pass_encoded)); (pass_encoded) = 
# 288 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 288 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); return (-1); } while (0);
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): auth gets pass's reply error(%s)",
   __FUNCTION__, 293, acl_last_serror());
  do { if (tokens) acl_argv_free(tokens); if (user_encoded) do { if (user_encoded) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 294, (user_encoded)); (user_encoded) = 
# 294 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 294 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); if (pass_encoded) do { if (pass_encoded) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 294, (pass_encoded)); (pass_encoded) = 
# 294 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 294 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); return (-1); } while (0);
 ...
 if (client->smtp_code != 235) {
  acl_msg_error("%s(%d): AUTH LOGIN failed, line(%s)",
   __FUNCTION__, 301, client->buf);
  do { if (tokens) acl_argv_free(tokens); if (user_encoded) do { if (user_encoded) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 302, (user_encoded)); (user_encoded) = 
# 302 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 302 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); if (pass_encoded) do { if (pass_encoded) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 302, (pass_encoded)); (pass_encoded) = 
# 302 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 302 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); return (-1); } while (0);
 ...
 do { if (tokens) acl_argv_free(tokens); if (user_encoded) do { if (user_encoded) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 305, (user_encoded)); (user_encoded) = 
# 305 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
((void *)0)
# 305 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
; } } while (0); if (pass_encoded) do { if (pass_encoded) { acl_free_glue("/workspace/acl/lib_protocol/src/smtp/smtp_client.c", 305, (pass_encoded)); (pass_encoded) = 
# 305 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
((void *)0)
# 305 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
...
int smtp_mail(SMTP_CLIENT *client, const char *from)
{
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): send mail from error(%s)",
   __FUNCTION__, 322, acl_last_serror());
  return -1;
 }
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): gets mail from's reply error(%s)",
   __FUNCTION__, 331, acl_last_serror());
  return (-1);
 }
 ...
 if (client->smtp_code != 250) {
  acl_msg_error("%s(%d): mail from error(%d), line(%s)",
   __FUNCTION__, 339, client->smtp_code, client->buf);
  acl_argv_free(tokens);
  return -1;
 }
...
int smtp_rcpt(SMTP_CLIENT *client, const char *to)
{
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): send rcpt error(%s)",
   __FUNCTION__, 361, acl_last_serror());
  return -1;
 }
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): gets rcpt's reply error(%s)",
   __FUNCTION__, 368, acl_last_serror());
  return -1;
 }
 ...
 if (client->smtp_code != 250) {
  acl_msg_error("%s(%d): rcpt's reply error(%d), line(%s)",
   __FUNCTION__, 376, client->smtp_code, client->buf);
  acl_argv_free(tokens);
  return -1;
 }
...
int smtp_data(SMTP_CLIENT *client)
{
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): send data error(%s)",
   __FUNCTION__, 398, acl_last_serror());
  return -1;
 }
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): gets data's reply error(%s)",
   __FUNCTION__, 405, acl_last_serror());
  return -1;
 }
 ...
 if (client->smtp_code != 354) {
  acl_msg_error("%s(%d): data denied, error(%d), line(%s)",
   __FUNCTION__, 413, client->smtp_code, client->buf);
  acl_argv_free(tokens);
  return -1;
 }
 acl_argv_free(tokens);
...
int smtp_data_end(SMTP_CLIENT *client)
{
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): send mail eof error(%s)",
   __FUNCTION__, 435, acl_last_serror());
  return -1;
 }
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): gets mail eof's reply error(%s)",
   __FUNCTION__, 442, acl_last_serror());
  return -1;
 }
 ...
 if (client->smtp_code != 250) {
  acl_msg_error("%s(%d): send mail error(%d), line: %s",
   __FUNCTION__, 450, client->smtp_code, client->buf);
  acl_argv_free(tokens);
  return -1;
 }
...
int smtp_send(SMTP_CLIENT *client, const char* src, size_t len)
{
 if (acl_vstream_writen(client->conn, src, len) == (-1)) {
  acl_msg_error("%s(%d): write data error(%s)",
   __FUNCTION__, 463, acl_last_serror());
  return -1;
 }
...
# 475 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
__builtin_va_start(
# 475 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
ap
# 475 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
,
# 475 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
...
# 477 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
__builtin_va_end(
# 477 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
ap
# 477 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
)
# 477 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
...
int smtp_send_stream(SMTP_CLIENT *client, ACL_VSTREAM *in)
{
 ...
 while (1) {
  ...
  {
   acl_msg_error("%s(%d): write data error(%s)",
    __FUNCTION__, 496, acl_last_serror());
   return -1;
  }
  n += ret;
 }
...
{
 int ret;
 ACL_VSTREAM *in = acl_vstream_fopen(filepath, 
# 515 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
                                              00
# 515 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
                                                      , 0600, 4096);

 if (in == 
# 517 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
          ((void *)0)
# 517 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
              ) {
  acl_msg_error("%s(%d): open %s error(%s)", __FUNCTION__,
   519, filepath, acl_last_serror());
  return -1;
 }
...
int smtp_quit(SMTP_CLIENT *client)
{
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): send quit cmd error(%s)",
   __FUNCTION__, 540, acl_last_serror());
  return -1;
 }
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): gets quit's reply error(%s)",
   __FUNCTION__, 547, acl_last_serror());
  return -1;
 }
 ...
 if (client->smtp_code != 221) {
  acl_msg_error("%s(%d): quit's reply: %d",
   __FUNCTION__, 555, client->smtp_code);
  acl_argv_free(tokens);
  return -1;
 }
 acl_argv_free(tokens);
...
int smtp_noop(SMTP_CLIENT *client)
{
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): write NOOP error(%s)",
   __FUNCTION__, 576, acl_last_serror());
  return -1;
 }
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): get NOOP's reply error(%s)",
   __FUNCTION__, 583, acl_last_serror());
  return -1;
 }

 ptr = strchr(client->buf, ' ');
 if (ptr == 
# 588 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
           ((void *)0)
# 588 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
               )
  ptr = strchr(client->buf, '\t');
 if (ptr == 
# 590 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
           ((void *)0)
# 590 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
               ) {
  acl_msg_error("%s(%d): NOOP's reply(%s) invalid",
   __FUNCTION__, 592, client->buf);
  return -1;
 }
 ret = *ptr;
 *ptr = 0;
 ...
 *ptr = ret;
 if (client->smtp_code != 250) {
  acl_msg_error("%s(%d): NOOP's reply(%s) code(%d) error",
   __FUNCTION__, 601, client->buf, client->smtp_code);
  return -1;
 }
...
int smtp_rset(SMTP_CLIENT *client)
{
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): write RSET error(%s)",
   __FUNCTION__, 621, acl_last_serror());
  return -1;
 }
 ret = acl_vstream_gets_nonl(client->conn, client->buf, client->size);
 if (ret == (-1)) {
  acl_msg_error("%s(%d): get RSET's reply error(%s)",
   __FUNCTION__, 627, acl_last_serror());
  return -1;
 }

 ptr = strchr(client->buf, ' ');
 if (ptr == 
# 632 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
           ((void *)0)
# 632 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
               )
  ptr = strchr(client->buf, '\t');
 if (ptr == 
# 634 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
           ((void *)0)
# 634 "/workspace/acl/lib_protocol/src/smtp/smtp_client.c"
               ) {
  acl_msg_error("%s(%d): RSET's reply(%s) invalid",
   __FUNCTION__, 636, client->buf);
  return -1;
 }
 ...
 *ptr = ret;
 ...
 if (client->smtp_code != 250) {
  acl_msg_error("%s(%d): RSET's reply(%s) code(%d) error",
   __FUNCTION__, 647, client->buf, client->smtp_code);
  return -1;
 }
