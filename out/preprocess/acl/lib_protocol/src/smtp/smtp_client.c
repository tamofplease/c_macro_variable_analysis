# 0 "/acl/lib_protocol/src/smtp/smtp_client.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_protocol/src/smtp/smtp_client.c"
...
# 2 "/acl/lib_protocol/src/smtp/smtp_client.c" 2

# 1 "/usr/include/assert.h" 1 3 4
# 4 "/acl/lib_protocol/src/smtp/smtp_client.c" 2

# 1 "/acl/lib_protocol/include/smtp/smtp_client.h" 1
# 26 "/acl/lib_protocol/include/smtp/smtp_client.h"
...
# 50 "/acl/lib_protocol/include/smtp/smtp_client.h"
...
# 76 "/acl/lib_protocol/include/smtp/smtp_client.h"
 int smtp_greet(SMTP_CLIENT *client, const char* name, int ehlo);
# 85 "/acl/lib_protocol/include/smtp/smtp_client.h"
 int smtp_helo(SMTP_CLIENT *client, const char *helo);
# 94 "/acl/lib_protocol/include/smtp/smtp_client.h"
 int smtp_ehlo(SMTP_CLIENT *client, const char *ehlo);
# 104 "/acl/lib_protocol/include/smtp/smtp_client.h"
 int smtp_auth(SMTP_CLIENT *client, const char *user, const char *pass);
# 113 "/acl/lib_protocol/include/smtp/smtp_client.h"
 int smtp_mail(SMTP_CLIENT *client, const char *from);
# 122 "/acl/lib_protocol/include/smtp/smtp_client.h"
...
# 140 "/acl/lib_protocol/include/smtp/smtp_client.h"
 int smtp_send(SMTP_CLIENT *client, const char* src, size_t len);
# 150 "/acl/lib_protocol/include/smtp/smtp_client.h"
...
# 167 "/acl/lib_protocol/include/smtp/smtp_client.h"
 int smtp_send_file(SMTP_CLIENT *client, const char *filepath);
# 176 "/acl/lib_protocol/include/smtp/smtp_client.h"
...
# 6 "/acl/lib_protocol/src/smtp/smtp_client.c" 2
 ...
 int rw_timeout, int line_limit)
{
 ...
 conn = acl_vstream_connect(addr, 0, conn_timeout,
  rw_timeout, 4096);
 if (conn == 
# 17 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
            ((void *)0)
# 17 "/acl/lib_protocol/src/smtp/smtp_client.c"
                ) {
  acl_msg_error("%s(%d): connect %s error(%s)",
   __FUNCTION__, 19, addr,
   acl_last_serror());
  return 
# 21 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
        ((void *)0)
# 21 "/acl/lib_protocol/src/smtp/smtp_client.c"
            ;
 }

 client = (SMTP_CLIENT*) acl_calloc_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 24, 1, sizeof(SMTP_CLIENT));
 client->conn = conn;
 client->buf = (char*) acl_malloc_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 26, line_limit);
...
void smtp_close(SMTP_CLIENT *client)
{
 ...
 do { if (client->buf) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 39, (client->buf)); (client->buf) = 
# 39 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
((void *)0)
# 39 "/acl/lib_protocol/src/smtp/smtp_client.c"
; } } while (0);
 do { if (client) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 40, (client)); (client) = 
# 40 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
((void *)0)
# 40 "/acl/lib_protocol/src/smtp/smtp_client.c"
; } } while (0);
}
...
int smtp_get_banner(SMTP_CLIENT *client)
{
 ...
 if (ptr == 
# 62 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
           ((void *)0)
# 62 "/acl/lib_protocol/src/smtp/smtp_client.c"
               )
  ptr = strchr(client->buf, '\t');
 if (ptr == 
# 64 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
           ((void *)0)
# 64 "/acl/lib_protocol/src/smtp/smtp_client.c"
               ) {
...
int smtp_helo(SMTP_CLIENT *client, const char *helo)
{
 ...
 ptr = strchr(client->buf, ' ');
 if (ptr == 
# 115 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
           ((void *)0)
# 115 "/acl/lib_protocol/src/smtp/smtp_client.c"
               )
  ptr = strchr(client->buf, '\t');
 if (ptr == 
# 117 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
           ((void *)0)
# 117 "/acl/lib_protocol/src/smtp/smtp_client.c"
               ) {
...
int smtp_auth(SMTP_CLIENT *client, const char *user, const char *pass)
{
 int ret;
 ACL_ARGV *tokens = 
# 215 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
                   ((void *)0)
# 215 "/acl/lib_protocol/src/smtp/smtp_client.c"
                       ;
 char *user_encoded = 
# 216 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
                     ((void *)0)
# 216 "/acl/lib_protocol/src/smtp/smtp_client.c"
                         , *pass_encoded = 
# 216 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
                                           ((void *)0)
# 216 "/acl/lib_protocol/src/smtp/smtp_client.c"
                                               ;
# 229 "/acl/lib_protocol/src/smtp/smtp_client.c"
 client->smtp_code = 0;
 client->buf[0] = 0;
 ...
 if (ret == (-1)) {
  ...
  do { if (tokens) acl_argv_free(tokens); if (user_encoded) do { if (user_encoded) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 238, (user_encoded)); (user_encoded) = 
# 238 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 238 "/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); if (pass_encoded) do { if (pass_encoded) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 238, (pass_encoded)); (pass_encoded) = 
# 238 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 238 "/acl/lib_protocol/src/smtp/smtp_client.c"
 ...
 if (ret == (-1)) {
  ...
  do { if (tokens) acl_argv_free(tokens); if (user_encoded) do { if (user_encoded) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 245, (user_encoded)); (user_encoded) = 
# 245 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 245 "/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); if (pass_encoded) do { if (pass_encoded) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 245, (pass_encoded)); (pass_encoded) = 
# 245 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 245 "/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); return (-1); } while (0);
 ...
 if (client->smtp_code != 334) {
  ...
  do { if (tokens) acl_argv_free(tokens); if (user_encoded) do { if (user_encoded) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 253, (user_encoded)); (user_encoded) = 
# 253 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 253 "/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); if (pass_encoded) do { if (pass_encoded) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 253, (pass_encoded)); (pass_encoded) = 
# 253 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 253 "/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); return (-1); } while (0);
 ...
 if (ret == (-1)) {
  ...
  do { if (tokens) acl_argv_free(tokens); if (user_encoded) do { if (user_encoded) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 263, (user_encoded)); (user_encoded) = 
# 263 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 263 "/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); if (pass_encoded) do { if (pass_encoded) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 263, (pass_encoded)); (pass_encoded) = 
# 263 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 263 "/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); return (-1); } while (0);
 ...
 if (ret == (-1)) {
  ...
  do { if (tokens) acl_argv_free(tokens); if (user_encoded) do { if (user_encoded) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 270, (user_encoded)); (user_encoded) = 
# 270 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 270 "/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); if (pass_encoded) do { if (pass_encoded) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 270, (pass_encoded)); (pass_encoded) = 
# 270 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 270 "/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); return (-1); } while (0);
 ...
 if (client->smtp_code != 334) {
  ...
  do { if (tokens) acl_argv_free(tokens); if (user_encoded) do { if (user_encoded) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 278, (user_encoded)); (user_encoded) = 
# 278 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 278 "/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); if (pass_encoded) do { if (pass_encoded) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 278, (pass_encoded)); (pass_encoded) = 
# 278 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 278 "/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); return (-1); } while (0);
 ...
 if (ret == (-1)) {
  ...
  do { if (tokens) acl_argv_free(tokens); if (user_encoded) do { if (user_encoded) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 288, (user_encoded)); (user_encoded) = 
# 288 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 288 "/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); if (pass_encoded) do { if (pass_encoded) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 288, (pass_encoded)); (pass_encoded) = 
# 288 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 288 "/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); return (-1); } while (0);
 ...
 if (ret == (-1)) {
  ...
  do { if (tokens) acl_argv_free(tokens); if (user_encoded) do { if (user_encoded) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 294, (user_encoded)); (user_encoded) = 
# 294 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 294 "/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); if (pass_encoded) do { if (pass_encoded) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 294, (pass_encoded)); (pass_encoded) = 
# 294 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 294 "/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); return (-1); } while (0);
 ...
 if (client->smtp_code != 235) {
  ...
  do { if (tokens) acl_argv_free(tokens); if (user_encoded) do { if (user_encoded) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 302, (user_encoded)); (user_encoded) = 
# 302 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 302 "/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); if (pass_encoded) do { if (pass_encoded) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 302, (pass_encoded)); (pass_encoded) = 
# 302 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
 ((void *)0)
# 302 "/acl/lib_protocol/src/smtp/smtp_client.c"
 ; } } while (0); return (-1); } while (0);
 ...
 do { if (tokens) acl_argv_free(tokens); if (user_encoded) do { if (user_encoded) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 305, (user_encoded)); (user_encoded) = 
# 305 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
((void *)0)
# 305 "/acl/lib_protocol/src/smtp/smtp_client.c"
; } } while (0); if (pass_encoded) do { if (pass_encoded) { acl_free_glue("/acl/lib_protocol/src/smtp/smtp_client.c", 305, (pass_encoded)); (pass_encoded) = 
# 305 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
((void *)0)
# 305 "/acl/lib_protocol/src/smtp/smtp_client.c"
...
# 475 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
__builtin_va_start(
# 475 "/acl/lib_protocol/src/smtp/smtp_client.c"
ap
# 475 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
,
# 475 "/acl/lib_protocol/src/smtp/smtp_client.c"
...
# 477 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
__builtin_va_end(
# 477 "/acl/lib_protocol/src/smtp/smtp_client.c"
ap
# 477 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
)
# 477 "/acl/lib_protocol/src/smtp/smtp_client.c"
...
# 515 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
                                              00
# 515 "/acl/lib_protocol/src/smtp/smtp_client.c"
                                                      , 0600, 4096);

 if (in == 
# 517 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
          ((void *)0)
# 517 "/acl/lib_protocol/src/smtp/smtp_client.c"
              ) {
...
int smtp_noop(SMTP_CLIENT *client)
{
 ...
 ptr = strchr(client->buf, ' ');
 if (ptr == 
# 588 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
           ((void *)0)
# 588 "/acl/lib_protocol/src/smtp/smtp_client.c"
               )
  ptr = strchr(client->buf, '\t');
 if (ptr == 
# 590 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
           ((void *)0)
# 590 "/acl/lib_protocol/src/smtp/smtp_client.c"
               ) {
...
int smtp_rset(SMTP_CLIENT *client)
{
 ...
 ptr = strchr(client->buf, ' ');
 if (ptr == 
# 632 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
           ((void *)0)
# 632 "/acl/lib_protocol/src/smtp/smtp_client.c"
               )
  ptr = strchr(client->buf, '\t');
 if (ptr == 
# 634 "/acl/lib_protocol/src/smtp/smtp_client.c" 3 4
           ((void *)0)
# 634 "/acl/lib_protocol/src/smtp/smtp_client.c"
               ) {
