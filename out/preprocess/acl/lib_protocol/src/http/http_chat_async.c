# 0 "/acl/lib_protocol/src/http/http_chat_async.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_protocol/src/http/http_chat_async.c"
...
# 2 "/acl/lib_protocol/src/http/http_chat_async.c" 2
...
# 7 "/acl/lib_protocol/src/http/http_chat_async.c" 2
...
# 8 "/acl/lib_protocol/src/http/http_chat_async.c" 2
...
# 49 "/acl/lib_protocol/src/http/http_chat_async.c"
static HTTP_CHAT_CTX *new_ctx(ctx_type type)
{
 const char *myname = "__new_ctx";
 HTTP_CHAT_CTX *ctx;

 ctx = (HTTP_CHAT_CTX*) acl_calloc_glue("/acl/lib_protocol/src/http/http_chat_async.c", 54, 1, sizeof(HTTP_CHAT_CTX));
 if (ctx == 
# 55 "/acl/lib_protocol/src/http/http_chat_async.c" 3 4
           ((void *)0)
# 55 "/acl/lib_protocol/src/http/http_chat_async.c"
               ) {
  acl_msg_fatal("%s, %s(%d): calloc error(%s)",
   "/acl/lib_protocol/src/http/http_chat_async.c", myname, 57, acl_last_serror());
 }
...
{
 do { if (ctx) { acl_free_glue("/acl/lib_protocol/src/http/http_chat_async.c", 66, (ctx)); (ctx) = 
# 66 "/acl/lib_protocol/src/http/http_chat_async.c" 3 4
((void *)0)
# 66 "/acl/lib_protocol/src/http/http_chat_async.c"
; } } while (0);
}
...
static int hdr_ready(HTTP_HDR *hdr, char *line, int dlen)
{
 ...
 if (entry == 
# 102 "/acl/lib_protocol/src/http/http_chat_async.c" 3 4
             ((void *)0)
# 102 "/acl/lib_protocol/src/http/http_chat_async.c"
                 ) {
  return 1;
 }
...
# 152 "/acl/lib_protocol/src/http/http_chat_async.c"
static int hdr_can_read(ACL_ASTREAM *astream, void *context)
{
 ...
 while (1) {
  ...
  if (sbuf == 
# 170 "/acl/lib_protocol/src/http/http_chat_async.c" 3 4
             ((void *)0)
# 170 "/acl/lib_protocol/src/http/http_chat_async.c"
                 ) {
   break;
  }
 ...
 HTTP_HDR_NOTIFY notify, void *arg, int timeout)
{
 ...
 if (hdr == 
# 209 "/acl/lib_protocol/src/http/http_chat_async.c" 3 4
           ((void *)0) 
# 209 "/acl/lib_protocol/src/http/http_chat_async.c"
                || astream == 
# 209 "/acl/lib_protocol/src/http/http_chat_async.c" 3 4
                              ((void *)0) 
# 209 "/acl/lib_protocol/src/http/http_chat_async.c"
...
# 209 "/acl/lib_protocol/src/http/http_chat_async.c"
 ...
 if (hdr->chat_ctx == 
# 216 "/acl/lib_protocol/src/http/http_chat_async.c" 3 4
                     ((void *)0)
# 216 "/acl/lib_protocol/src/http/http_chat_async.c"
                         ) {
 ...
 ctx->arg = arg;
 ctx->status = (1 << 0);
# 234 "/acl/lib_protocol/src/http/http_chat_async.c"
...
static int chunked_data_endl(ACL_ASTREAM *astream, HTTP_CHAT_CTX *ctx)
{
 ...
 if (sbuf == 
# 265 "/acl/lib_protocol/src/http/http_chat_async.c" 3 4
            ((void *)0)
# 265 "/acl/lib_protocol/src/http/http_chat_async.c"
                ) {
  return 0;
 }
...
static int chunked_data(ACL_ASTREAM *astream, HTTP_CHAT_CTX *ctx)
{
 ...
 void *arg = ctx->arg;
 ACL_VSTRING *sbuf = 
# 286 "/acl/lib_protocol/src/http/http_chat_async.c" 3 4
                    ((void *)0)
# 286 "/acl/lib_protocol/src/http/http_chat_async.c"
                        ;
 char *data;
 int dlen, ret;
 ...
 if (ctx->chunked) {
  ...
  if (ret <= 0) {
   ...
   do { acl_aio_disable_read((astream)); } while (0);
   if (notify(0, 
# 302 "/acl/lib_protocol/src/http/http_chat_async.c" 3 4
                           ((void *)0)
# 302 "/acl/lib_protocol/src/http/http_chat_async.c"
                               , 0, arg) < 0) {
    return -1;
   }
   return -1;
 ...
 if (sbuf == 
# 314 "/acl/lib_protocol/src/http/http_chat_async.c" 3 4
            ((void *)0)
# 314 "/acl/lib_protocol/src/http/http_chat_async.c"
                ) {
  return 0;
 }
...
static int chunked_trailer(ACL_ASTREAM *astream, HTTP_CHAT_CTX *ctx)
{
 ...
 sbuf = acl_aio_gets_peek(astream);
 if (sbuf == 
# 364 "/acl/lib_protocol/src/http/http_chat_async.c" 3 4
            ((void *)0)
# 364 "/acl/lib_protocol/src/http/http_chat_async.c"
                ) {
  return 0;
 }
...
static int chunked_hdr(ACL_ASTREAM *astream, HTTP_CHAT_CTX *ctx)
{
 ...
 sbuf = acl_aio_gets_peek(astream);
 if (sbuf == 
# 396 "/acl/lib_protocol/src/http/http_chat_async.c" 3 4
            ((void *)0)
# 396 "/acl/lib_protocol/src/http/http_chat_async.c"
                ) {
  return 0;
 }
...
# 411 "/acl/lib_protocol/src/http/http_chat_async.c" 3 4
                               ((void *)0)
# 411 "/acl/lib_protocol/src/http/http_chat_async.c"
                                   , 16);
 if (ptr) {
  *ptr = ' ';
 }
...
static int body_can_read(ACL_ASTREAM *astream, void *context)
{
 ...
 while (1) {
  if ((ret = acl_aio_can_read(astream)) == (-1)) {
   (void) notify(101, 
# 439 "/acl/lib_protocol/src/http/http_chat_async.c" 3 4
                                  ((void *)0)
# 439 "/acl/lib_protocol/src/http/http_chat_async.c"
                                      , 0, arg);
   return -1;
  } else if (ret == 0) {
   break;
  ...
  HTTP_BODY_NOTIFY notify, void *arg, int timeout)
{
 ...
 if (request == 
# 492 "/acl/lib_protocol/src/http/http_chat_async.c" 3 4
               ((void *)0) 
# 492 "/acl/lib_protocol/src/http/http_chat_async.c"
                    || astream == 
# 492 "/acl/lib_protocol/src/http/http_chat_async.c" 3 4
                                  ((void *)0) 
# 492 "/acl/lib_protocol/src/http/http_chat_async.c"
...
# 492 "/acl/lib_protocol/src/http/http_chat_async.c"
 ...
 if (request->hdr_req == 
# 495 "/acl/lib_protocol/src/http/http_chat_async.c" 3 4
                        ((void *)0)
# 495 "/acl/lib_protocol/src/http/http_chat_async.c"
                            ) {
 ...
 HTTP_BODY_NOTIFY notify, void *arg, int timeout)
{
 ...
 if (respond == 
# 526 "/acl/lib_protocol/src/http/http_chat_async.c" 3 4
               ((void *)0) 
# 526 "/acl/lib_protocol/src/http/http_chat_async.c"
                    || astream == 
# 526 "/acl/lib_protocol/src/http/http_chat_async.c" 3 4
                                  ((void *)0) 
# 526 "/acl/lib_protocol/src/http/http_chat_async.c"
...
# 526 "/acl/lib_protocol/src/http/http_chat_async.c"
  ...
  acl_msg_fatal("%s, %s(%d): input invalid",
   myname, "/acl/lib_protocol/src/http/http_chat_async.c", 528);
 }
 if (respond->hdr_res == 
# 530 "/acl/lib_protocol/src/http/http_chat_async.c" 3 4
                        ((void *)0)
# 530 "/acl/lib_protocol/src/http/http_chat_async.c"
                            ) {
  acl_msg_fatal("%s: hdr null", myname);
 }
 ...
 if (hdr->debug && hdr->content_length <= 0 && !hdr->chunked) {
  acl_msg_warn("%s, %s(%d): content_length(%lld), status(%d)",
   "/acl/lib_protocol/src/http/http_chat_async.c", myname, 537, hdr->content_length,
