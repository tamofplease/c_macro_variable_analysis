# 1 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 2
...
# 7 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 2
...
# 8 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 2
...
# 49 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
static HTTP_CHAT_CTX *new_ctx(ctx_type type)
{
 const char *myname = "__new_ctx";
 HTTP_CHAT_CTX *ctx;

 ctx = (HTTP_CHAT_CTX*) acl_calloc_glue("/workspace/acl/lib_protocol/src/http/http_chat_async.c", 54, 1, sizeof(HTTP_CHAT_CTX));
 if (ctx == 
# 55 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 3 4
           ((void *)0)
# 55 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
               ) {
  acl_msg_fatal("%s, %s(%d): calloc error(%s)",
   "/workspace/acl/lib_protocol/src/http/http_chat_async.c", myname, 57, acl_last_serror());
 }
...
{
 do { if (ctx) { acl_free_glue("/workspace/acl/lib_protocol/src/http/http_chat_async.c", 66, (ctx)); (ctx) = 
# 66 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 3 4
((void *)0)
# 66 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
; } } while (0);
}
...
static int hdr_ready(HTTP_HDR *hdr, char *line, int dlen)
{
 ...
 if (hdr->max_lines > 0 && hdr->cur_lines > hdr->max_lines) {
  acl_msg_error("%s(%d): cur_lines(%d) > max_lines(%d)",
   myname, 81, hdr->cur_lines, hdr->max_lines);
  return 103;
 }
 ...
 if (entry == 
# 102 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 3 4
             ((void *)0)
# 102 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
                 ) {
  return 1;
 }
...
# 152 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
static int hdr_can_read(ACL_ASTREAM *astream, void *context)
{
 ...
 while (1) {
  if ((ret = acl_aio_can_read(astream)) == (-1)) {
   notify(101, arg);
   return -1;
  } else if (ret == 0) {
   break;
  ...
  if (sbuf == 
# 170 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 3 4
             ((void *)0)
# 170 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
                 ) {
   break;
  }
  data = ((char *) (sbuf)->vbuf.data);
  dlen = (int) (size_t) ((sbuf)->vbuf.ptr - (sbuf)->vbuf.data);
  { (sbuf)->vbuf.ptr = (sbuf)->vbuf.data; ((&(sbuf)->vbuf)->flags &= ~((1<<0) | (1<<1) | (1<<2))); };
  ...
  case 1:
   break;
  case 0:
   do { acl_aio_disable_read((astream)); } while (0);
   if (notify(ret, arg) < 0) {
    return -1;
   }
   return 0;
 ...
 HTTP_HDR_NOTIFY notify, void *arg, int timeout)
{
 ...
 if (hdr == 
# 209 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 3 4
           ((void *)0) 
# 209 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
                || astream == 
# 209 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 3 4
                              ((void *)0) 
# 209 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
...
# 209 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
 ...
 if (hdr->chat_ctx == 
# 216 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 3 4
                     ((void *)0)
# 216 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
                         ) {
 ...
 ctx->arg = arg;
 ctx->status = (1 << 0);
# 234 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
    acl_aio_ctl(astream, 4, timeout,
        0);
    acl_aio_enable_read(astream, hdr_can_read, ctx);
...
static int chunked_data_endl(ACL_ASTREAM *astream, HTTP_CHAT_CTX *ctx)
{
 ...
 if (sbuf == 
# 265 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 3 4
            ((void *)0)
# 265 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
                ) {
  return 0;
 }
...
static int chunked_data(ACL_ASTREAM *astream, HTTP_CHAT_CTX *ctx)
{
 ...
 void *arg = ctx->arg;
 ACL_VSTRING *sbuf = 
# 286 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 3 4
                    ((void *)0)
# 286 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
                        ;
 char *data;
 int dlen, ret;

 if (ctx->chunked) {
  ret = (int) (ctx->chunk_len > 0 ? (ctx->chunk_len > ctx->read_cnt + var_http_buf_size ? var_http_buf_size : ctx->chunk_len - ctx->read_cnt) : var_http_buf_size);
  ...
  if (ret <= 0) {
   ...
   do { acl_aio_disable_read((astream)); } while (0);
   if (notify(0, 
# 302 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 3 4
                           ((void *)0)
# 302 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
                               , 0, arg) < 0) {
    return -1;
   }
   return -1;
 ...
 if (sbuf == 
# 314 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 3 4
            ((void *)0)
# 314 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
                ) {
  return 0;
 }
...
static int chunked_trailer(ACL_ASTREAM *astream, HTTP_CHAT_CTX *ctx)
{
 ...
 sbuf = acl_aio_gets_peek(astream);
 if (sbuf == 
# 364 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 3 4
            ((void *)0)
# 364 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
                ) {
  return 0;
 }
 ...
 if (strcmp(data, "\r\n") == 0 || strcmp(data, "\n") == 0) {
  do { acl_aio_disable_read((astream)); } while (0);
  if ((dlen = notify(0, data, dlen, arg)) < 0) {
   return -1;
  }
  return 1;
 }
 if (notify(5, data, dlen, arg) < 0) {
  return -1;
 }
 return 0;
}
...
static int chunked_hdr(ACL_ASTREAM *astream, HTTP_CHAT_CTX *ctx)
{
 ...
 sbuf = acl_aio_gets_peek(astream);
 if (sbuf == 
# 396 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 3 4
            ((void *)0)
# 396 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
                ) {
  return 0;
 }
 ...
 ctx->chunk_len = strtoul(data, 
# 411 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 3 4
                               ((void *)0)
# 411 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
                                   , 16);
 if (ptr) {
  *ptr = ' ';
 }

 if (notify(3, data, dlen, arg) < 0) {
  return -1;
 }
...
static int body_can_read(ACL_ASTREAM *astream, void *context)
{
 ...
 while (1) {
  if ((ret = acl_aio_can_read(astream)) == (-1)) {
   (void) notify(101, 
# 439 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 3 4
                                  ((void *)0)
# 439 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
                                      , 0, arg);
   return -1;
  } else if (ret == 0) {
   break;
  ...
  HTTP_BODY_NOTIFY notify, void *arg, int timeout)
{
 ...
 if (request == 
# 492 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 3 4
               ((void *)0) 
# 492 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
                    || astream == 
# 492 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 3 4
                                  ((void *)0) 
# 492 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
...
# 492 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
 ...
 if (request->hdr_req == 
# 495 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 3 4
                        ((void *)0)
# 495 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
                            ) {
 ...
 HTTP_BODY_NOTIFY notify, void *arg, int timeout)
{
 ...
 if (respond == 
# 526 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 3 4
               ((void *)0) 
# 526 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
                    || astream == 
# 526 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 3 4
                                  ((void *)0) 
# 526 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
...
# 526 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
  ...
  acl_msg_fatal("%s, %s(%d): input invalid",
   myname, "/workspace/acl/lib_protocol/src/http/http_chat_async.c", 528);
 }
 if (respond->hdr_res == 
# 530 "/workspace/acl/lib_protocol/src/http/http_chat_async.c" 3 4
                        ((void *)0)
# 530 "/workspace/acl/lib_protocol/src/http/http_chat_async.c"
                            ) {
  acl_msg_fatal("%s: hdr null", myname);
 }
 ...
 if (hdr->debug && hdr->content_length <= 0 && !hdr->chunked) {
  acl_msg_warn("%s, %s(%d): content_length(%lld), status(%d)",
   "/workspace/acl/lib_protocol/src/http/http_chat_async.c", myname, 537, hdr->content_length,
