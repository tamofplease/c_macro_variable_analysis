# 1 "/workspace/acl/lib_protocol/src/http/http_rfc1123.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_protocol/src/http/http_rfc1123.c" 2
...
# 5 "/workspace/acl/lib_protocol/src/http/http_rfc1123.c" 2



const char *http_mkrfc1123(char *buf, size_t size, time_t t)
{
# 20 "/workspace/acl/lib_protocol/src/http/http_rfc1123.c"
 ...
 if (gmt != 
# 25 "/workspace/acl/lib_protocol/src/http/http_rfc1123.c" 3 4
           ((void *)0)
# 25 "/workspace/acl/lib_protocol/src/http/http_rfc1123.c"
               )
  strftime(buf, size - 1, "%a, %d %b %Y %H:%M:%S GMT", gmt);
 return (buf);
}
