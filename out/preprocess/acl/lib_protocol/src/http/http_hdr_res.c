# 0 "/acl/lib_protocol/src/http/http_hdr_res.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_protocol/src/http/http_hdr_res.c"
...
# 2 "/acl/lib_protocol/src/http/http_hdr_res.c" 2
...
# 7 "/acl/lib_protocol/src/http/http_hdr_res.c" 2
...
# 8 "/acl/lib_protocol/src/http/http_hdr_res.c" 2
...
# 23 "/acl/lib_protocol/src/http/http_hdr_res.c" 3 4
                                        0
# 23 "/acl/lib_protocol/src/http/http_hdr_res.c"
                                                             ;

static ACL_ARRAY *main_cache = 
# 25 "/acl/lib_protocol/src/http/http_hdr_res.c" 3 4
                              ((void *)0)
# 25 "/acl/lib_protocol/src/http/http_hdr_res.c"
                                  ;
...
static void main_cache_free(void)
{
 if (main_cache) {
  ...
  main_cache = 
# 32 "/acl/lib_protocol/src/http/http_hdr_res.c" 3 4
              ((void *)0)
# 32 "/acl/lib_protocol/src/http/http_hdr_res.c"
                  ;
 }
}
...
# 72 "/acl/lib_protocol/src/http/http_hdr_res.c"
 pthread_once(&once_control, thread_cache_init);
 pool = (ACL_ARRAY*) pthread_getspecific(cache_key);
 if (pool == 
# 74 "/acl/lib_protocol/src/http/http_hdr_res.c" 3 4
            ((void *)0)
# 74 "/acl/lib_protocol/src/http/http_hdr_res.c"
                ) {
...
void http_hdr_res_free(HTTP_HDR_RES *hh)
{
 ...
 if (hh == 
# 118 "/acl/lib_protocol/src/http/http_hdr_res.c" 3 4
          ((void *)0)
# 118 "/acl/lib_protocol/src/http/http_hdr_res.c"
              )
  return;
...
# 126 "/acl/lib_protocol/src/http/http_hdr_res.c" 3 4
                                             ((void *)0)
# 126 "/acl/lib_protocol/src/http/http_hdr_res.c"
                                                 ) {
  __hdr_free_member(hh);
  http_hdr_free((HTTP_HDR *) hh);
  return;
 }
# 139 "/acl/lib_protocol/src/http/http_hdr_res.c"
 pool = (ACL_ARRAY*) pthread_getspecific(cache_key);
 if (pool != 
# 140 "/acl/lib_protocol/src/http/http_hdr_res.c" 3 4
            ((void *)0) 
# 140 "/acl/lib_protocol/src/http/http_hdr_res.c"
...
{
 if (hh == 
# 151 "/acl/lib_protocol/src/http/http_hdr_res.c" 3 4
          ((void *)0)
# 151 "/acl/lib_protocol/src/http/http_hdr_res.c"
              )
  return;
...
int http_hdr_res_status_parse(HTTP_HDR_RES *hh, const char *dbuf)
{
 ...
 if (hh == 
# 165 "/acl/lib_protocol/src/http/http_hdr_res.c" 3 4
          ((void *)0) 
# 165 "/acl/lib_protocol/src/http/http_hdr_res.c"
               || dbuf == 
# 165 "/acl/lib_protocol/src/http/http_hdr_res.c" 3 4
                          ((void *)0)
# 165 "/acl/lib_protocol/src/http/http_hdr_res.c"
  ...
  acl_msg_error("%s, %s(%d): input invalid",
    "/acl/lib_protocol/src/http/http_hdr_res.c", myname, 167);
  return (-1);
 }
 ...
 if (status_argv->argc < 2) {
  acl_msg_error("%s, %s(%d): invalid reply status line=%s",
    "/acl/lib_protocol/src/http/http_hdr_res.c", myname, 176, dbuf);
 ...
 if (ptr == 
# 188 "/acl/lib_protocol/src/http/http_hdr_res.c" 3 4
           ((void *)0)
# 188 "/acl/lib_protocol/src/http/http_hdr_res.c"
               )
  acl_msg_fatal("%s, %s(%d): null value, idx=1, argc=%d",
    "/acl/lib_protocol/src/http/http_hdr_res.c", myname, 190, status_argv->argc);
 hh->reply_status = atoi(ptr);
 if (hh->reply_status < 0) {
  acl_msg_error("%s, %s(%d): invalid status(%d)",
    "/acl/lib_protocol/src/http/http_hdr_res.c", myname, 194, hh->reply_status);
  acl_argv_free(status_argv);
  return (-1);
 }
 acl_argv_free(status_argv);
...
int http_hdr_res_parse(HTTP_HDR_RES *hdr_res)
{
 ...
 if (hdr == 
# 211 "/acl/lib_protocol/src/http/http_hdr_res.c" 3 4
           ((void *)0)
# 211 "/acl/lib_protocol/src/http/http_hdr_res.c"
               )
  acl_msg_fatal("%s: hdr_res null", myname);
 if (hdr->entry_lnk == 
# 213 "/acl/lib_protocol/src/http/http_hdr_res.c" 3 4
                      ((void *)0)
# 213 "/acl/lib_protocol/src/http/http_hdr_res.c"
                          )
 ...
 http_off_t *range_to, http_off_t *total_length)
{
 ...
 if (hdr_res == 
# 260 "/acl/lib_protocol/src/http/http_hdr_res.c" 3 4
               ((void *)0)
# 260 "/acl/lib_protocol/src/http/http_hdr_res.c"
                   )
  acl_msg_fatal("%s(%d): hdr_res null", myname, 261);
 if (range_from == 
# 262 "/acl/lib_protocol/src/http/http_hdr_res.c" 3 4
                  ((void *)0)
# 262 "/acl/lib_protocol/src/http/http_hdr_res.c"
                      )
  acl_msg_fatal("%s(%d): range_from null", myname, 263);
 if (range_to == 
# 264 "/acl/lib_protocol/src/http/http_hdr_res.c" 3 4
                ((void *)0)
# 264 "/acl/lib_protocol/src/http/http_hdr_res.c"
                    )
  acl_msg_fatal("%s(%d): range_to null", myname, 265);

 value = http_hdr_entry_value(&hdr_res->hdr, "Content-Range");
 if (value == 
# 268 "/acl/lib_protocol/src/http/http_hdr_res.c" 3 4
             ((void *)0)
# 268 "/acl/lib_protocol/src/http/http_hdr_res.c"
                 )
  return (-1);
 ...
 pto = strchr(pfrom, '-');
 if (pto == 
# 290 "/acl/lib_protocol/src/http/http_hdr_res.c" 3 4
           ((void *)0) 
# 290 "/acl/lib_protocol/src/http/http_hdr_res.c"
                || pto == pfrom)
  return (-1);
 *pto++ = 0;
 ...
 ptr = strchr(pto, '/');
 if (ptr == 
# 296 "/acl/lib_protocol/src/http/http_hdr_res.c" 3 4
           ((void *)0) 
# 296 "/acl/lib_protocol/src/http/http_hdr_res.c"
                || ptr == pto)
  return (-1);
