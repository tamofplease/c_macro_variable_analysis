# 1 "/workspace/acl/lib_protocol/src/http/http_util.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_protocol/src/http/http_util.c" 2
...
# 4 "/workspace/acl/lib_protocol/src/http/http_util.c" 2
...
# 5 "/workspace/acl/lib_protocol/src/http/http_util.c" 2
# 1 "/workspace/acl/lib_protocol/include/http/lib_http_util.h" 1
# 10 "/workspace/acl/lib_protocol/include/http/lib_http_util.h"
...
# 156 "/workspace/acl/lib_protocol/include/http/lib_http_util.h"
...
# 212 "/workspace/acl/lib_protocol/include/http/lib_http_util.h"
...
# 6 "/workspace/acl/lib_protocol/src/http/http_util.c" 2

void http_util_free(HTTP_UTIL *http_util)
{
 if ((http_util->flag & (1 << 0))) {
 ...
 do { if (http_util) { acl_free_glue("/workspace/acl/lib_protocol/src/http/http_util.c", 24, (http_util)); (http_util) = 
# 24 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
((void *)0)
# 24 "/workspace/acl/lib_protocol/src/http/http_util.c"
; } } while (0);
}
...
HTTP_UTIL *http_util_req_new(const char *url, const char *method)
{
 ...
 HTTP_UTIL *http_util = (HTTP_UTIL*) acl_calloc_glue("/workspace/acl/lib_protocol/src/http/http_util.c", 30, 1, sizeof(HTTP_UTIL));
 const char *ptr, *host;

 if (url == 
# 33 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
           ((void *)0) 
# 33 "/workspace/acl/lib_protocol/src/http/http_util.c"
                || *url == 0) {
  acl_msg_error("%s(%d): url invalid", myname, 34);
  return (
# 35 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
         ((void *)0)
# 35 "/workspace/acl/lib_protocol/src/http/http_util.c"
             );
 }
 if (method == 
# 37 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
              ((void *)0) 
# 37 "/workspace/acl/lib_protocol/src/http/http_util.c"
                   || *method == 0) {
  acl_msg_error("%s(%d): method invalid", myname, 38);
  return (
# 39 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
         ((void *)0)
# 39 "/workspace/acl/lib_protocol/src/http/http_util.c"
             );
 }

 if (acl_strncasecmp(url, "http://", sizeof("http://") - 1) != 0) {
  acl_msg_error("%s(%d): url(%s) invalid", myname, 43, url);
  return (
# 44 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
         ((void *)0)
# 44 "/workspace/acl/lib_protocol/src/http/http_util.c"
             );
 }
 ...
 {
  acl_msg_error("%s(%d): method(%s) invalid", myname, 50, method);
  return (
# 51 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
         ((void *)0)
# 51 "/workspace/acl/lib_protocol/src/http/http_util.c"
             );
 }
 ...
 if (host) {
  ptr = strchr(host, ':');
  if (ptr == 
# 62 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
            ((void *)0)
# 62 "/workspace/acl/lib_protocol/src/http/http_util.c"
                )
   snprintf(http_util->server_addr,
    sizeof(http_util->server_addr), "%s:80", host);
  else
   do { if (sizeof(http_util->server_addr) > 0) { size_t _n = strlen(host); _n = _n > (size_t ) sizeof(http_util->server_addr) - 1? (size_t) sizeof(http_util->server_addr) - 1 : _n; memcpy(http_util->server_addr, host, _n); http_util->server_addr[_n] = 0; } } while (0)
                                   ;
 }
...
HTTP_UTIL *http_util_res_new(int status)
{
 HTTP_UTIL *http_util = (HTTP_UTIL*) acl_calloc_glue("/workspace/acl/lib_protocol/src/http/http_util.c", 77, 1, sizeof(HTTP_UTIL));
...
{
 if (name == 
# 97 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
            ((void *)0) 
# 97 "/workspace/acl/lib_protocol/src/http/http_util.c"
                 || *name == 0)
  return (
# 98 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
         ((void *)0)
# 98 "/workspace/acl/lib_protocol/src/http/http_util.c"
             );
...
{
 if (name == 
# 104 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
            ((void *)0) 
# 104 "/workspace/acl/lib_protocol/src/http/http_util.c"
                 || *name == 0)
  return (
# 105 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
         ((void *)0)
# 105 "/workspace/acl/lib_protocol/src/http/http_util.c"
             );
...
{
 if (value == 
# 131 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
             ((void *)0) 
# 131 "/workspace/acl/lib_protocol/src/http/http_util.c"
                  || *value == 0)
  return;
...
{
 if (refer == 
# 138 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
             ((void *)0) 
# 138 "/workspace/acl/lib_protocol/src/http/http_util.c"
                  || *refer == 0)
  return;
...
void http_util_set_req_cookie(HTTP_UTIL *http_util, const char *name, const char *value)
{
 ...
 if (name == 
# 148 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
            ((void *)0) 
# 148 "/workspace/acl/lib_protocol/src/http/http_util.c"
                 || *name == 0 || value == 
# 148 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
                                           ((void *)0)
# 148 "/workspace/acl/lib_protocol/src/http/http_util.c"
 ...
 if (hdr_entry == 
# 151 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
                 ((void *)0)
# 151 "/workspace/acl/lib_protocol/src/http/http_util.c"
                     ) {
  http_hdr_put_str(&http_util->hdr_req->hdr, name, value);
  return;
 }

 ptr = acl_concatenate(hdr_entry->value, "; ", name, "=", value, 
# 156 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
                                                                ((void *)0)
# 156 "/workspace/acl/lib_protocol/src/http/http_util.c"
                                                                    );
 do { if (hdr_entry->value) { acl_free_glue("/workspace/acl/lib_protocol/src/http/http_util.c", 157, (hdr_entry->value)); (hdr_entry->value) = 
# 157 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
((void *)0)
# 157 "/workspace/acl/lib_protocol/src/http/http_util.c"
; } } while (0);
 hdr_entry->value = ptr;
}
...
{
 if (proxy && *proxy)
  do { if (sizeof(http_util->server_addr) > 0) { size_t _n = strlen(proxy); _n = _n > (size_t ) sizeof(http_util->server_addr) - 1? (size_t) sizeof(http_util->server_addr) - 1 : _n; memcpy(http_util->server_addr, proxy, _n); http_util->server_addr[_n] = 0; } } while (0)
                                  ;
}
...
void http_util_set_dump_stream(HTTP_UTIL *http_util, ACL_VSTREAM *stream)
{
 ...
 if (stream == 
# 172 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
              ((void *)0)
# 172 "/workspace/acl/lib_protocol/src/http/http_util.c"
                  )
  return;
...
int http_util_set_dump_file(HTTP_UTIL *http_util, const char *filename)
{
 ...
 if (filename == 
# 189 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
                ((void *)0) 
# 189 "/workspace/acl/lib_protocol/src/http/http_util.c"
                     || *filename == 0) {
  acl_msg_error("%s(%d): filename invalid", myname, 190);
  return (-1);
 }
 if ((http_util->flag & (1 << 1))) {
...
# 200 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
  0100 
# 200 "/workspace/acl/lib_protocol/src/http/http_util.c"
          | 
# 200 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
            01000 
# 200 "/workspace/acl/lib_protocol/src/http/http_util.c"
...
# 200 "/workspace/acl/lib_protocol/src/http/http_util.c"
                              , 0600, 4096);
 if (http_util->dump_stream == 
# 201 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
                              ((void *)0)
# 201 "/workspace/acl/lib_protocol/src/http/http_util.c"
                                  ) {
  acl_msg_error("%s(%d): open dump file(%s) error(%s)",
   myname, 203, filename, acl_last_serror());
  return (-1);
 }
 http_util->flag |= (1 << 0);
 return (0);
...
int http_util_req_open(HTTP_UTIL *http_util)
{
 ...
 http_util->stream = acl_vstream_connect(http_util->server_addr,
   0 ,
   http_util->conn_timeout ,
   http_util->rw_timeout ,
   4096 );
 if (http_util->stream == 
# 222 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
                         ((void *)0)
# 222 "/workspace/acl/lib_protocol/src/http/http_util.c"
                             ) {
  acl_msg_error("%s(%d): connect %s error(%s)",
   myname, 224, http_util->server_addr,
   acl_last_serror());
  return (-1);
 }
 ...
 ret = acl_vstream_writen(http_util->stream,
   ((char *) (http_util->req_buf)->vbuf.data),
   (size_t) ((http_util->req_buf)->vbuf.ptr - (http_util->req_buf)->vbuf.data));
 if (ret == (-1)) {
  acl_msg_error("%s(%d): send request to server(%s) error(%s)",
   myname, 240, http_util->server_addr,
   acl_last_serror());
  return (-1);
 }
...
int http_util_put_req_data(HTTP_UTIL *http_util, const char *data, size_t dlen)
{
 ...
 if (data == 
# 252 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
            ((void *)0) 
# 252 "/workspace/acl/lib_protocol/src/http/http_util.c"
                 || dlen == 0) {
  acl_msg_info("%s(%d): data %s, dlen %d invalid",
   myname, 254, data ? "not null" : "null", (int) dlen);
  return (-1);
 }
 if (acl_vstream_writen(http_util->stream, data, dlen) == (-1))
  return (-1);
 return ((int) dlen);
}
...
{
 if (name == 
# 285 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
            ((void *)0) 
# 285 "/workspace/acl/lib_protocol/src/http/http_util.c"
                 || *name == 0)
  return (
# 286 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
         ((void *)0)
# 286 "/workspace/acl/lib_protocol/src/http/http_util.c"
             );
...
{
 if (name == 
# 292 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
            ((void *)0) 
# 292 "/workspace/acl/lib_protocol/src/http/http_util.c"
                 || *name == 0)
  return (
# 293 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
         ((void *)0)
# 293 "/workspace/acl/lib_protocol/src/http/http_util.c"
             );
...
{
 if (name == 
# 299 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
            ((void *)0) 
# 299 "/workspace/acl/lib_protocol/src/http/http_util.c"
                 || *name == 0 || value == 
# 299 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
                                           ((void *)0) 
# 299 "/workspace/acl/lib_protocol/src/http/http_util.c"
...
{
 if (name == 
# 306 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
            ((void *)0) 
# 306 "/workspace/acl/lib_protocol/src/http/http_util.c"
                 || *name == 0)
  return;
...
int http_util_get_res_body(HTTP_UTIL *http_util, char *buf, size_t size)
{
 ...
 if (buf == 
# 334 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
           ((void *)0) 
# 334 "/workspace/acl/lib_protocol/src/http/http_util.c"
                || size == 0) {
  acl_msg_error("%s(%d): buf(%s), size(%d) invalid",
   myname, 336, buf ? "not null" : "null", (int) size);
  return (-1);
 }

 if ((http_util->flag & ((1 << 2)
  | (1 << 3))) == 0)
 {
 ...
 if (http_util->dump_stream == 
# 352 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
                              ((void *)0)
# 352 "/workspace/acl/lib_protocol/src/http/http_util.c"
                                  )
  return (ret);

 if (acl_vstream_writen(http_util->dump_stream, buf, ret) == (-1))
 {


  acl_msg_error("%s(%d): dump to stream(%s) error(%s)",
   myname, 360, ((http_util->dump_stream)->path ? (http_util->dump_stream)->path : ""),
   acl_last_serror());
  if ((http_util->flag & (1 << 0))) {
   if (http_util->dump_stream)
    acl_vstream_close(http_util->dump_stream);
  ...
  http_util->dump_stream = 
# 369 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
                          ((void *)0)
# 369 "/workspace/acl/lib_protocol/src/http/http_util.c"
                              ;
 }
...
int http_util_dump_url(const char *url, const char *dump)
{
 ...
 if (http_util == 
# 382 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
                 ((void *)0)
# 382 "/workspace/acl/lib_protocol/src/http/http_util.c"
                     )
  return (-1);
 if (dump == 
# 384 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
            ((void *)0) 
# 384 "/workspace/acl/lib_protocol/src/http/http_util.c"
                 || *dump == 0) {
  acl_msg_error("%s(%d): dump invalid", myname, 385);
  return (-1);
 }

 if (http_util_set_dump_file(http_util, dump) < 0) {
  acl_msg_error("%s(%d): open dump file(%s) error(%s)",
   myname, 391, dump, acl_last_serror());
 ...
 if (http_util_req_open(http_util) < 0) {
  acl_msg_error("%s(%d): open url(%s) error(%s)",
   myname, 398, url, acl_last_serror());
  http_util_free(http_util);
  return (-1);
 }
...
int http_util_dump_url_to_stream(const char *url, ACL_VSTREAM *stream)
{
 ...
 if (http_util == 
# 427 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
                 ((void *)0)
# 427 "/workspace/acl/lib_protocol/src/http/http_util.c"
                     )
  return (-1);
 if (stream == 
# 429 "/workspace/acl/lib_protocol/src/http/http_util.c" 3 4
              ((void *)0)
# 429 "/workspace/acl/lib_protocol/src/http/http_util.c"
                  ) {
  acl_msg_error("%s(%d): dump invalid", myname, 430);
  return (-1);
 }
 ...
 if (http_util_req_open(http_util) < 0) {
  acl_msg_error("%s(%d): open url(%s) error(%s)",
   myname, 438, url, acl_last_serror());
  http_util_free(http_util);
  return (-1);
 }
