# 0 "/acl/lib_protocol/src/http/http_util.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_protocol/src/http/http_util.c"
...
# 2 "/acl/lib_protocol/src/http/http_util.c" 2
...
# 4 "/acl/lib_protocol/src/http/http_util.c" 2
...
# 5 "/acl/lib_protocol/src/http/http_util.c" 2
# 1 "/acl/lib_protocol/include/http/lib_http_util.h" 1
# 10 "/acl/lib_protocol/include/http/lib_http_util.h"
...
# 156 "/acl/lib_protocol/include/http/lib_http_util.h"
...
# 212 "/acl/lib_protocol/include/http/lib_http_util.h"
...
# 6 "/acl/lib_protocol/src/http/http_util.c" 2
...
void http_util_free(HTTP_UTIL *http_util)
{
 ...
 do { if (http_util) { acl_free_glue("/acl/lib_protocol/src/http/http_util.c", 24, (http_util)); (http_util) = 
# 24 "/acl/lib_protocol/src/http/http_util.c" 3 4
((void *)0)
# 24 "/acl/lib_protocol/src/http/http_util.c"
; } } while (0);
}
...
HTTP_UTIL *http_util_req_new(const char *url, const char *method)
{
 ...
 HTTP_UTIL *http_util = (HTTP_UTIL*) acl_calloc_glue("/acl/lib_protocol/src/http/http_util.c", 30, 1, sizeof(HTTP_UTIL));
 const char *ptr, *host;

 if (url == 
# 33 "/acl/lib_protocol/src/http/http_util.c" 3 4
           ((void *)0) 
# 33 "/acl/lib_protocol/src/http/http_util.c"
                || *url == 0) {
  acl_msg_error("%s(%d): url invalid", myname, 34);
  return (
# 35 "/acl/lib_protocol/src/http/http_util.c" 3 4
         ((void *)0)
# 35 "/acl/lib_protocol/src/http/http_util.c"
             );
 }
 if (method == 
# 37 "/acl/lib_protocol/src/http/http_util.c" 3 4
              ((void *)0) 
# 37 "/acl/lib_protocol/src/http/http_util.c"
                   || *method == 0) {
  acl_msg_error("%s(%d): method invalid", myname, 38);
  return (
# 39 "/acl/lib_protocol/src/http/http_util.c" 3 4
         ((void *)0)
# 39 "/acl/lib_protocol/src/http/http_util.c"
             );
 }
 ...
 if (acl_strncasecmp(url, "http://", sizeof("http://") - 1) != 0) {
  ...
  return (
# 44 "/acl/lib_protocol/src/http/http_util.c" 3 4
         ((void *)0)
# 44 "/acl/lib_protocol/src/http/http_util.c"
             );
 }
  ...
  && strcmp(method, "HEAD") != 0 && strcmp(method, "CONNECT") != 0)
 {
  ...
  return (
# 51 "/acl/lib_protocol/src/http/http_util.c" 3 4
         ((void *)0)
# 51 "/acl/lib_protocol/src/http/http_util.c"
             );
 }
 ...
 if (host) {
  ptr = strchr(host, ':');
  if (ptr == 
# 62 "/acl/lib_protocol/src/http/http_util.c" 3 4
            ((void *)0)
# 62 "/acl/lib_protocol/src/http/http_util.c"
                )
...
HTTP_UTIL *http_util_res_new(int status)
{
 HTTP_UTIL *http_util = (HTTP_UTIL*) acl_calloc_glue("/acl/lib_protocol/src/http/http_util.c", 77, 1, sizeof(HTTP_UTIL));
...
{
 if (name == 
# 97 "/acl/lib_protocol/src/http/http_util.c" 3 4
            ((void *)0) 
# 97 "/acl/lib_protocol/src/http/http_util.c"
                 || *name == 0)
  return (
# 98 "/acl/lib_protocol/src/http/http_util.c" 3 4
         ((void *)0)
# 98 "/acl/lib_protocol/src/http/http_util.c"
             );
...
{
 if (name == 
# 104 "/acl/lib_protocol/src/http/http_util.c" 3 4
            ((void *)0) 
# 104 "/acl/lib_protocol/src/http/http_util.c"
                 || *name == 0)
  return (
# 105 "/acl/lib_protocol/src/http/http_util.c" 3 4
         ((void *)0)
# 105 "/acl/lib_protocol/src/http/http_util.c"
             );
...
{
 if (value == 
# 131 "/acl/lib_protocol/src/http/http_util.c" 3 4
             ((void *)0) 
# 131 "/acl/lib_protocol/src/http/http_util.c"
                  || *value == 0)
  return;
...
{
 if (refer == 
# 138 "/acl/lib_protocol/src/http/http_util.c" 3 4
             ((void *)0) 
# 138 "/acl/lib_protocol/src/http/http_util.c"
                  || *refer == 0)
  return;
...
void http_util_set_req_cookie(HTTP_UTIL *http_util, const char *name, const char *value)
{
 ...
 if (name == 
# 148 "/acl/lib_protocol/src/http/http_util.c" 3 4
            ((void *)0) 
# 148 "/acl/lib_protocol/src/http/http_util.c"
                 || *name == 0 || value == 
# 148 "/acl/lib_protocol/src/http/http_util.c" 3 4
                                           ((void *)0)
# 148 "/acl/lib_protocol/src/http/http_util.c"
 ...
 if (hdr_entry == 
# 151 "/acl/lib_protocol/src/http/http_util.c" 3 4
                 ((void *)0)
# 151 "/acl/lib_protocol/src/http/http_util.c"
                     ) {
...
# 156 "/acl/lib_protocol/src/http/http_util.c" 3 4
                                                                ((void *)0)
# 156 "/acl/lib_protocol/src/http/http_util.c"
                                                                    );
 do { if (hdr_entry->value) { acl_free_glue("/acl/lib_protocol/src/http/http_util.c", 157, (hdr_entry->value)); (hdr_entry->value) = 
# 157 "/acl/lib_protocol/src/http/http_util.c" 3 4
((void *)0)
# 157 "/acl/lib_protocol/src/http/http_util.c"
; } } while (0);
 hdr_entry->value = ptr;
}
...
void http_util_set_dump_stream(HTTP_UTIL *http_util, ACL_VSTREAM *stream)
{
 ...
 if (stream == 
# 172 "/acl/lib_protocol/src/http/http_util.c" 3 4
              ((void *)0)
# 172 "/acl/lib_protocol/src/http/http_util.c"
                  )
  return;
...
int http_util_set_dump_file(HTTP_UTIL *http_util, const char *filename)
{
 ...
 if (filename == 
# 189 "/acl/lib_protocol/src/http/http_util.c" 3 4
                ((void *)0) 
# 189 "/acl/lib_protocol/src/http/http_util.c"
                     || *filename == 0) {
...
# 200 "/acl/lib_protocol/src/http/http_util.c" 3 4
  0100 
# 200 "/acl/lib_protocol/src/http/http_util.c"
          | 
# 200 "/acl/lib_protocol/src/http/http_util.c" 3 4
            01000 
# 200 "/acl/lib_protocol/src/http/http_util.c"
...
# 200 "/acl/lib_protocol/src/http/http_util.c"
                              , 0600, 4096);
 if (http_util->dump_stream == 
# 201 "/acl/lib_protocol/src/http/http_util.c" 3 4
                              ((void *)0)
# 201 "/acl/lib_protocol/src/http/http_util.c"
                                  ) {
...
int http_util_req_open(HTTP_UTIL *http_util)
{
 ...
 http_util->stream = acl_vstream_connect(http_util->server_addr,
   ...
   4096 );
 if (http_util->stream == 
# 222 "/acl/lib_protocol/src/http/http_util.c" 3 4
                         ((void *)0)
# 222 "/acl/lib_protocol/src/http/http_util.c"
                             ) {
...
int http_util_put_req_data(HTTP_UTIL *http_util, const char *data, size_t dlen)
{
 ...
 if (data == 
# 252 "/acl/lib_protocol/src/http/http_util.c" 3 4
            ((void *)0) 
# 252 "/acl/lib_protocol/src/http/http_util.c"
                 || dlen == 0) {
...
{
 if (name == 
# 285 "/acl/lib_protocol/src/http/http_util.c" 3 4
            ((void *)0) 
# 285 "/acl/lib_protocol/src/http/http_util.c"
                 || *name == 0)
  return (
# 286 "/acl/lib_protocol/src/http/http_util.c" 3 4
         ((void *)0)
# 286 "/acl/lib_protocol/src/http/http_util.c"
             );
...
{
 if (name == 
# 292 "/acl/lib_protocol/src/http/http_util.c" 3 4
            ((void *)0) 
# 292 "/acl/lib_protocol/src/http/http_util.c"
                 || *name == 0)
  return (
# 293 "/acl/lib_protocol/src/http/http_util.c" 3 4
         ((void *)0)
# 293 "/acl/lib_protocol/src/http/http_util.c"
             );
...
{
 if (name == 
# 299 "/acl/lib_protocol/src/http/http_util.c" 3 4
            ((void *)0) 
# 299 "/acl/lib_protocol/src/http/http_util.c"
                 || *name == 0 || value == 
# 299 "/acl/lib_protocol/src/http/http_util.c" 3 4
                                           ((void *)0) 
# 299 "/acl/lib_protocol/src/http/http_util.c"
...
{
 if (name == 
# 306 "/acl/lib_protocol/src/http/http_util.c" 3 4
            ((void *)0) 
# 306 "/acl/lib_protocol/src/http/http_util.c"
                 || *name == 0)
  return;
...
int http_util_get_res_body(HTTP_UTIL *http_util, char *buf, size_t size)
{
 ...
 if (buf == 
# 334 "/acl/lib_protocol/src/http/http_util.c" 3 4
           ((void *)0) 
# 334 "/acl/lib_protocol/src/http/http_util.c"
                || size == 0) {
 ...
 if (http_util->dump_stream == 
# 352 "/acl/lib_protocol/src/http/http_util.c" 3 4
                              ((void *)0)
# 352 "/acl/lib_protocol/src/http/http_util.c"
                                  )
  return (ret);
...
# 369 "/acl/lib_protocol/src/http/http_util.c" 3 4
                          ((void *)0)
# 369 "/acl/lib_protocol/src/http/http_util.c"
                              ;
 }
...
int http_util_dump_url(const char *url, const char *dump)
{
 ...
 if (http_util == 
# 382 "/acl/lib_protocol/src/http/http_util.c" 3 4
                 ((void *)0)
# 382 "/acl/lib_protocol/src/http/http_util.c"
                     )
  return (-1);
 if (dump == 
# 384 "/acl/lib_protocol/src/http/http_util.c" 3 4
            ((void *)0) 
# 384 "/acl/lib_protocol/src/http/http_util.c"
                 || *dump == 0) {
...
int http_util_dump_url_to_stream(const char *url, ACL_VSTREAM *stream)
{
 ...
 if (http_util == 
# 427 "/acl/lib_protocol/src/http/http_util.c" 3 4
                 ((void *)0)
# 427 "/acl/lib_protocol/src/http/http_util.c"
                     )
  return (-1);
 if (stream == 
# 429 "/acl/lib_protocol/src/http/http_util.c" 3 4
              ((void *)0)
# 429 "/acl/lib_protocol/src/http/http_util.c"
                  ) {
