# 0 "/acl/lib_protocol/src/http/http_init.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_protocol/src/http/http_init.c"
...
# 2 "/acl/lib_protocol/src/http/http_init.c" 2
...
# 6 "/acl/lib_protocol/src/http/http_init.c" 2
...
# 7 "/acl/lib_protocol/src/http/http_init.c" 2
...
# 8 "/acl/lib_protocol/src/http/http_init.c" 2
