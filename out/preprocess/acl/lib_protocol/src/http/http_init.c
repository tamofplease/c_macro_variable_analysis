# 1 "/workspace/acl/lib_protocol/src/http/http_init.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_protocol/src/http/http_init.c" 2
...
# 6 "/workspace/acl/lib_protocol/src/http/http_init.c" 2
...
# 7 "/workspace/acl/lib_protocol/src/http/http_init.c" 2
...
# 8 "/workspace/acl/lib_protocol/src/http/http_init.c" 2

http_off_t var_http_buf_size = 8192;
