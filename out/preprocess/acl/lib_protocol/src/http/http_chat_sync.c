# 0 "/acl/lib_protocol/src/http/http_chat_sync.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_protocol/src/http/http_chat_sync.c"
...
# 2 "/acl/lib_protocol/src/http/http_chat_sync.c" 2
...
# 7 "/acl/lib_protocol/src/http/http_chat_sync.c" 2
...
# 8 "/acl/lib_protocol/src/http/http_chat_sync.c" 2
...
static HTTP_CHAT_CTX *new_ctx(void)
{
 ...
 ctx = (HTTP_CHAT_CTX*) acl_calloc_glue("/acl/lib_protocol/src/http/http_chat_sync.c", 38, 1, sizeof(HTTP_CHAT_CTX));
 if (ctx == 
# 39 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
           ((void *)0)
# 39 "/acl/lib_protocol/src/http/http_chat_sync.c"
               ) {
  char ebuf[256];

  acl_msg_fatal("%s, %s(%d): calloc error(%s)",
   "/acl/lib_protocol/src/http/http_chat_sync.c", myname, 43, acl_last_strerror(ebuf, sizeof(ebuf)));
 }
...
{
 do { if (ctx) { acl_free_glue("/acl/lib_protocol/src/http/http_chat_sync.c", 51, (ctx)); (ctx) = 
# 51 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
((void *)0)
# 51 "/acl/lib_protocol/src/http/http_chat_sync.c"
; } } while (0);
}
...
static int hdr_ready(HTTP_HDR *hdr, const char *line, int dlen)
{
 ...
 if (entry == 
# 79 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
             ((void *)0)
# 79 "/acl/lib_protocol/src/http/http_chat_sync.c"
                 ) {
  return 1;
 }
...
static int chunked_hdr_get(HTTP_CHAT_CTX *ctx)
{
 ...
 char *ext = 
# 170 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
            ((void *)0)
# 170 "/acl/lib_protocol/src/http/http_chat_sync.c"
                ;
 ...
 ctx->read_cnt = 0;
 ctx->body_len += n;
# 190 "/acl/lib_protocol/src/http/http_chat_sync.c"
 ...
 void *buf, int size)
{
 ...
 if (request->ctx == 
# 300 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
                    ((void *)0)
# 300 "/acl/lib_protocol/src/http/http_chat_sync.c"
                        ) {
  ctx = new_ctx();
 ...
 void *buf, int size)
{
 ...
 if (respond->ctx == 
# 338 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
                    ((void *)0)
# 338 "/acl/lib_protocol/src/http/http_chat_sync.c"
                        ) {
  ctx = new_ctx();
...
# 364 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
__builtin_va_start(
# 364 "/acl/lib_protocol/src/http/http_chat_sync.c"
ap
# 364 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
,
# 364 "/acl/lib_protocol/src/http/http_chat_sync.c"
...
# 364 "/acl/lib_protocol/src/http/http_chat_sync.c"
                  ;
 for (; name != 0; name = 
# 365 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
                                              __builtin_va_arg(
# 365 "/acl/lib_protocol/src/http/http_chat_sync.c"
                                              ap
# 365 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
                                              ,
# 365 "/acl/lib_protocol/src/http/http_chat_sync.c"
...
# 365 "/acl/lib_protocol/src/http/http_chat_sync.c"
  ...
  case 1:
   n = 
# 368 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
      __builtin_va_arg(
# 368 "/acl/lib_protocol/src/http/http_chat_sync.c"
      ap
# 368 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
      ,
# 368 "/acl/lib_protocol/src/http/http_chat_sync.c"
...
# 368 "/acl/lib_protocol/src/http/http_chat_sync.c"
  ...
  default:
   acl_msg_panic("%s, %s(%d): bad name %d",
    myname, "/acl/lib_protocol/src/http/http_chat_sync.c", 377, name);
   break;
  }
 }
 
# 381 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
__builtin_va_end(
# 381 "/acl/lib_protocol/src/http/http_chat_sync.c"
ap
# 381 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
)
# 381 "/acl/lib_protocol/src/http/http_chat_sync.c"
...
# 390 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
__builtin_va_start(
# 390 "/acl/lib_protocol/src/http/http_chat_sync.c"
ap
# 390 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
,
# 390 "/acl/lib_protocol/src/http/http_chat_sync.c"
...
# 390 "/acl/lib_protocol/src/http/http_chat_sync.c"
                  ;
 for (; name != 0; name = 
# 391 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
                                              __builtin_va_arg(
# 391 "/acl/lib_protocol/src/http/http_chat_sync.c"
                                              ap
# 391 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
                                              ,
# 391 "/acl/lib_protocol/src/http/http_chat_sync.c"
...
# 391 "/acl/lib_protocol/src/http/http_chat_sync.c"
  ...
  case 1:
   n = 
# 394 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
      __builtin_va_arg(
# 394 "/acl/lib_protocol/src/http/http_chat_sync.c"
      ap
# 394 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
      ,
# 394 "/acl/lib_protocol/src/http/http_chat_sync.c"
...
# 394 "/acl/lib_protocol/src/http/http_chat_sync.c"
  ...
  default:
   acl_msg_panic("%s, %s(%d): bad name %d",
    myname, "/acl/lib_protocol/src/http/http_chat_sync.c", 403, name);
   break;
  }
 }
 
# 407 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
__builtin_va_end(
# 407 "/acl/lib_protocol/src/http/http_chat_sync.c"
ap
# 407 "/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
)
# 407 "/acl/lib_protocol/src/http/http_chat_sync.c"
