# 1 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 2
...
# 7 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 2
...
# 8 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 2
...
static HTTP_CHAT_CTX *new_ctx(void)
{
 ...
 ctx = (HTTP_CHAT_CTX*) acl_calloc_glue("/workspace/acl/lib_protocol/src/http/http_chat_sync.c", 38, 1, sizeof(HTTP_CHAT_CTX));
 if (ctx == 
# 39 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
           ((void *)0)
# 39 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
               ) {
  char ebuf[256];

  acl_msg_fatal("%s, %s(%d): calloc error(%s)",
   "/workspace/acl/lib_protocol/src/http/http_chat_sync.c", myname, 43, acl_last_strerror(ebuf, sizeof(ebuf)));
 }
...
{
 do { if (ctx) { acl_free_glue("/workspace/acl/lib_protocol/src/http/http_chat_sync.c", 51, (ctx)); (ctx) = 
# 51 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
((void *)0)
# 51 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
; } } while (0);
}
...
static int hdr_ready(HTTP_HDR *hdr, const char *line, int dlen)
{
 ...
 if (entry == 
# 79 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
             ((void *)0)
# 79 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
                 ) {
  return 1;
 }
...
{
 return hdr_get(&hdr_req->hdr, stream, timeout) == 0 ? 0 : -1;
}

int http_hdr_res_get_sync(HTTP_HDR_RES *hdr_res, ACL_VSTREAM *stream, int timeout)
{
 return hdr_get(&hdr_res->hdr, stream, timeout) == 0 ? 0 : -1;
}
...
static int chunked_hdr_get(HTTP_CHAT_CTX *ctx)
{
 ...
 char *ext = 
# 170 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
            ((void *)0)
# 170 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
                ;
...
static int chunked_sep_gets(HTTP_CHAT_CTX *ctx)
{
 ...
 n = acl_vstream_gets(ctx->stream, buf, sizeof(buf));
 if (n == (-1)) {
  acl_msg_error("%s(%d): gets sep line error", myname, 211);
  return -1;
 }
...
static int chunked_trailer_get(HTTP_CHAT_CTX *ctx)
{
 ...
 while (1) {
  n = acl_vstream_gets(ctx->stream, buf, sizeof(buf));
  if (n == (-1)) {
   acl_msg_error("%s(%d): get line error", myname, 228);
   return -1;
  }
  ctx->body_len += n;
  if (strcmp(buf, "\r\n") == 0 || strcmp(buf, "\n") == 0) {
...
static http_off_t body_get(HTTP_CHAT_CTX *ctx, void *buf, int size)
{
 ...
 while (1) {
  if (ctx->chunk.chunk_oper == 1) {
   ret = chunked_hdr_get(ctx);
   if (ret < 0) {
    return -1;
   }
   if (ctx->chunk_len == 0) {
    ctx->chunk.chunk_oper = 4;
   } else {
    ctx->chunk.chunk_oper = 2;
   }
  } else if (ctx->chunk.chunk_oper == 2) {
   ...
   if (ctx->read_cnt >= ctx->chunk_len) {
    ...
    ctx->chunk.chunk_oper = 1;
   }
   return ret;
  } else if (ctx->chunk.chunk_oper == 4) {
   ret = chunked_trailer_get(ctx);
   return ret;
  } else {
   acl_msg_error("%s(%d): unknown oper status(%d)",
    myname, 282, ctx->chunk.chunk_oper);
   return -1;
  }
 }
}
 ...
 void *buf, int size)
{
 ...
 if (request->ctx == 
# 300 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
                    ((void *)0)
# 300 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
                        ) {
  ctx = new_ctx();
 ...
 void *buf, int size)
{
 ...
 if (respond->ctx == 
# 338 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
                    ((void *)0)
# 338 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
                        ) {
  ctx = new_ctx();
...
# 364 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
__builtin_va_start(
# 364 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
ap
# 364 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
,
# 364 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
...
# 364 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
                  ;
 for (; name != 0; name = 
# 365 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
                                              __builtin_va_arg(
# 365 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
                                              ap
# 365 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
                                              ,
# 365 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
...
# 365 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
  ...
  case 1:
   n = 
# 368 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
      __builtin_va_arg(
# 368 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
      ap
# 368 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
      ,
# 368 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
...
# 368 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
  ...
  default:
   acl_msg_panic("%s, %s(%d): bad name %d",
    myname, "/workspace/acl/lib_protocol/src/http/http_chat_sync.c", 377, name);
   break;
  }
 }
 
# 381 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
__builtin_va_end(
# 381 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
ap
# 381 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
)
# 381 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
...
# 390 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
__builtin_va_start(
# 390 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
ap
# 390 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
,
# 390 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
...
# 390 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
                  ;
 for (; name != 0; name = 
# 391 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
                                              __builtin_va_arg(
# 391 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
                                              ap
# 391 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
                                              ,
# 391 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
...
# 391 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
  ...
  case 1:
   n = 
# 394 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
      __builtin_va_arg(
# 394 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
      ap
# 394 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
      ,
# 394 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
...
# 394 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
  ...
  default:
   acl_msg_panic("%s, %s(%d): bad name %d",
    myname, "/workspace/acl/lib_protocol/src/http/http_chat_sync.c", 403, name);
   break;
  }
 }
 
# 407 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
__builtin_va_end(
# 407 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
ap
# 407 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c" 3 4
)
# 407 "/workspace/acl/lib_protocol/src/http/http_chat_sync.c"
