# 0 "/acl/lib_protocol/src/http/http_req.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_protocol/src/http/http_req.c"
...
# 2 "/acl/lib_protocol/src/http/http_req.c" 2
...
# 7 "/acl/lib_protocol/src/http/http_req.c" 2
...
HTTP_REQ *http_req_new(HTTP_HDR_REQ *hdr_req)
{
 ...
 request = (HTTP_REQ*) acl_calloc_glue("/acl/lib_protocol/src/http/http_req.c", 13, 1, sizeof(HTTP_REQ));
 if (request == 
# 14 "/acl/lib_protocol/src/http/http_req.c" 3 4
               ((void *)0)
# 14 "/acl/lib_protocol/src/http/http_req.c"
                   ) {
  char ebuf[256];
  acl_msg_fatal("%s, %s(%d): calloc error(%s)",
   "/acl/lib_protocol/src/http/http_req.c", myname, 17, acl_last_strerror(ebuf, sizeof(ebuf)));
 }
...
void http_req_free(HTTP_REQ *request)
{
 if (request) {
  ...
  do { if (request) { acl_free_glue("/acl/lib_protocol/src/http/http_req.c", 31, (request)); (request) = 
# 31 "/acl/lib_protocol/src/http/http_req.c" 3 4
 ((void *)0)
# 31 "/acl/lib_protocol/src/http/http_req.c"
 ; } } while (0);
 }
}
