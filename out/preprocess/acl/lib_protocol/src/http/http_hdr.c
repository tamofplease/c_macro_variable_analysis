# 0 "/acl/lib_protocol/src/http/http_hdr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_protocol/src/http/http_hdr.c"
...
# 2 "/acl/lib_protocol/src/http/http_hdr.c" 2
...
# 7 "/acl/lib_protocol/src/http/http_hdr.c" 2
...
HTTP_HDR *http_hdr_new(size_t size)
{
 ...
 if (size != sizeof(HTTP_HDR_REQ) && size != sizeof(HTTP_HDR_RES))
  acl_msg_fatal("%s, %s(%d): size(%d) invalid",
   "/acl/lib_protocol/src/http/http_hdr.c", myname, 32, (int) size);

 hh = (HTTP_HDR*) acl_calloc_glue("/acl/lib_protocol/src/http/http_hdr.c", 34, 1, (int) size);
...
void http_hdr_clone(const HTTP_HDR *src, HTTP_HDR *dst)
{
 ...
 dst->chat_ctx = 
# 50 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
                ((void *)0)
# 50 "/acl/lib_protocol/src/http/http_hdr.c"
                    ;
 dst->chat_free_ctx_fn = 
# 51 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
                        ((void *)0)
# 51 "/acl/lib_protocol/src/http/http_hdr.c"
                            ;
...
{
 if (hh == 
# 65 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
          ((void *)0)
# 65 "/acl/lib_protocol/src/http/http_hdr.c"
              )
  return;
 if (hh->entry_lnk != 
# 67 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
                     ((void *)0)
# 67 "/acl/lib_protocol/src/http/http_hdr.c"
                         )
  acl_array_free(hh->entry_lnk, acl_free_fn_glue);

 if (hh->chat_free_ctx_fn && hh->chat_ctx)
  hh->chat_free_ctx_fn(hh->chat_ctx);
 do { if (hh) { acl_free_glue("/acl/lib_protocol/src/http/http_hdr.c", 72, (hh)); (hh) = 
# 72 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
((void *)0)
# 72 "/acl/lib_protocol/src/http/http_hdr.c"
; } } while (0);
}
...
{
 if (hh != 
# 77 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
          ((void *)0)
# 77 "/acl/lib_protocol/src/http/http_hdr.c"
              ) {
  if (hh->entry_lnk != 
# 78 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
                      ((void *)0)
# 78 "/acl/lib_protocol/src/http/http_hdr.c"
                          )
...
HTTP_HDR_ENTRY *http_hdr_entry_build(const char *name, const char *value)
{
 ...
 entry = (HTTP_HDR_ENTRY*) acl_malloc_glue("/acl/lib_protocol/src/http/http_hdr.c", 91, n0 + n1 + n2 + 2);
 entry->off = 0;
...
# 110 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
                                           ((void *)0)
# 110 "/acl/lib_protocol/src/http/http_hdr.c"
                                               ;
 HTTP_HDR_ENTRY *entry;
 size_t n;
 ...
 if (*data == 0)
  return 
# 117 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
        ((void *)0)
# 117 "/acl/lib_protocol/src/http/http_hdr.c"
            ;

 n = strlen(data);
 if (n >= sizeof(buf_fixed) - 1) {
  buf = acl_strdup_glue("/acl/lib_protocol/src/http/http_hdr.c", 121, (data));
  name = buf;
 } else {
  name = buf_fixed;
  memcpy(name, data, n);
 ...
 if (*value == 0) {
  if (buf)
   do { if (buf) { acl_free_glue("/acl/lib_protocol/src/http/http_hdr.c", 143, (buf)); (buf) = 
# 143 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
  ((void *)0)
# 143 "/acl/lib_protocol/src/http/http_hdr.c"
  ; } } while (0);
  return 
# 144 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
        ((void *)0)
# 144 "/acl/lib_protocol/src/http/http_hdr.c"
            ;
 }

 entry = http_hdr_entry_build(name, value);
 if (buf)
  do { if (buf) { acl_free_glue("/acl/lib_protocol/src/http/http_hdr.c", 149, (buf)); (buf) = 
# 149 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
 ((void *)0)
# 149 "/acl/lib_protocol/src/http/http_hdr.c"
 ; } } while (0);
 return entry;
}
...
HTTP_HDR_ENTRY *http_hdr_entry_head(char *data)
{
 ...
 char *ptr, *pname, *psep = 
# 157 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
                           ((void *)0)
# 157 "/acl/lib_protocol/src/http/http_hdr.c"
                               ;
 HTTP_HDR_ENTRY *entry;
 ...
 if (*ptr == 0) {
  acl_msg_error("%s, %s(%d): invalid data=%s",
   "/acl/lib_protocol/src/http/http_hdr.c", myname, 171, data);
  return (
# 172 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
         ((void *)0)
# 172 "/acl/lib_protocol/src/http/http_hdr.c"
             );
 }
 while (*ptr == ' ' || *ptr == '\t')
  ptr++;
 if (*ptr == 0) {
   ...
   *psep = ' ';
  acl_msg_error("%s, %s(%d): invalid data=%s",
   "/acl/lib_protocol/src/http/http_hdr.c", myname, 180, data);
  return (
# 181 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
         ((void *)0)
# 181 "/acl/lib_protocol/src/http/http_hdr.c"
             );
 }
...
HTTP_HDR_ENTRY *http_hdr_entry_new2(char *data)
{
 ...
 char *ptr, *pname, *psep = 
# 192 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
                           ((void *)0)
# 192 "/acl/lib_protocol/src/http/http_hdr.c"
                               ;
 HTTP_HDR_ENTRY *entry;
 ...
 if (*ptr == 0) {
  acl_msg_error("%s, %s(%d): invalid data=%s",
   "/acl/lib_protocol/src/http/http_hdr.c", myname, 206, data);
  return (
# 207 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
         ((void *)0)
# 207 "/acl/lib_protocol/src/http/http_hdr.c"
             );
 }
 while (*ptr == ':' || *ptr == ' ' || *ptr == '\t')
  ptr++;
 if (*ptr == 0) {
   ...
   *psep = ':';
  acl_msg_error("%s, %s(%d): invalid data=%s",
   "/acl/lib_protocol/src/http/http_hdr.c", myname, 215, data);
  return (
# 216 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
         ((void *)0)
# 216 "/acl/lib_protocol/src/http/http_hdr.c"
             );
 }
...
void http_hdr_append_entry(HTTP_HDR *hh, HTTP_HDR_ENTRY *entry)
{
 ...
 if (acl_array_append(hh->entry_lnk, entry) < 0)
  acl_msg_fatal("%s, %s(%d): acl_array_append error(%s)",
   "/acl/lib_protocol/src/http/http_hdr.c", myname, 231, acl_last_serror());
}
...
int http_hdr_parse_version(HTTP_HDR *hh, const char *data)
{
 ...
 if (hh == 
# 238 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
          ((void *)0)
# 238 "/acl/lib_protocol/src/http/http_hdr.c"
              )
  acl_msg_fatal("%s, %s(%d): hh null",
    "/acl/lib_protocol/src/http/http_hdr.c", myname, 240);

 if (data == 
# 242 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
            ((void *)0) 
# 242 "/acl/lib_protocol/src/http/http_hdr.c"
                 || *data == 0)
  return -1;
...
static HTTP_HDR_ENTRY *__get_hdr_entry(const HTTP_HDR *hh, const char *name)
{
 ...
 if (hh->entry_lnk == 
# 268 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
                     ((void *)0)
# 268 "/acl/lib_protocol/src/http/http_hdr.c"
                         )
  acl_msg_fatal("%s, %s(%d): entry_lnk null",
   "/acl/lib_protocol/src/http/http_hdr.c", myname, 270);
 ...
 return 
# 278 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
       ((void *)0)
# 278 "/acl/lib_protocol/src/http/http_hdr.c"
           ;
}
...
char *http_hdr_entry_value(const HTTP_HDR *hh, const char *name)
{
 ...
 if (hdr_entry == 
# 291 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
                 ((void *)0)
# 291 "/acl/lib_protocol/src/http/http_hdr.c"
                     )
  return (
# 292 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
         ((void *)0)
# 292 "/acl/lib_protocol/src/http/http_hdr.c"
             );
 ...
 const char *value, int force)
{
 ...
 if (hh == 
# 302 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
          ((void *)0) 
# 302 "/acl/lib_protocol/src/http/http_hdr.c"
               || name == 
# 302 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
                          ((void *)0) 
# 302 "/acl/lib_protocol/src/http/http_hdr.c"
...
# 302 "/acl/lib_protocol/src/http/http_hdr.c"
  ...
  acl_msg_error("%s, %s(%d): input invalid",
   "/acl/lib_protocol/src/http/http_hdr.c", myname, 304);
  return -1;
 }

 entry = __get_hdr_entry(hh, name);
 if (entry == 
# 309 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
             ((void *)0)
# 309 "/acl/lib_protocol/src/http/http_hdr.c"
                 ) {
  if (force == 0)
   return -1;
  entry = http_hdr_entry_build(name, value);
...
# 314 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
                                            ((void *)0)
# 314 "/acl/lib_protocol/src/http/http_hdr.c"
                                                );
  do { if (entry) { acl_free_glue("/acl/lib_protocol/src/http/http_hdr.c", 315, (entry)); (entry) = 
# 315 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
 ((void *)0)
# 315 "/acl/lib_protocol/src/http/http_hdr.c"
 ; } } while (0);
  entry = http_hdr_entry_build(name, value);
 }
 ...
 const char *from, const char *to, int ignore_case)
{
 ...
 for (i = 0; i < hh->entry_lnk->count; i++) {
  ...
  while (*ptr_prev) {
   ...
   if (ptr == 
# 354 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
             ((void *)0)
# 354 "/acl/lib_protocol/src/http/http_hdr.c"
                 ) {
  ...
  if (n > 0) {
   do { if (entry) { acl_free_glue("/acl/lib_protocol/src/http/http_hdr.c", 367, (entry)); (entry) = 
# 367 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
  ((void *)0)
# 367 "/acl/lib_protocol/src/http/http_hdr.c"
  ; } } while (0);
...
void http_hdr_entry_off(HTTP_HDR *hh, const char *name)
{
 ...
 if (hh == 
# 384 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
          ((void *)0) 
# 384 "/acl/lib_protocol/src/http/http_hdr.c"
               || name == 
# 384 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
                          ((void *)0)
# 384 "/acl/lib_protocol/src/http/http_hdr.c"
  ...
  acl_msg_fatal("%s, %s(%d): input invalid",
   "/acl/lib_protocol/src/http/http_hdr.c", myname, 386);

 entry = __get_hdr_entry(hh, name);
 if (entry == 
# 389 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
             ((void *)0)
# 389 "/acl/lib_protocol/src/http/http_hdr.c"
                 )
  return;
...
# 484 "/acl/lib_protocol/src/http/http_hdr.c"
...
# 549 "/acl/lib_protocol/src/http/http_hdr.c"
 if (keep_alive >= 0) {
...
void http_hdr_print(const HTTP_HDR *hh, const char *msg)
{
 ...
 if (hh == 
# 567 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
          ((void *)0)
# 567 "/acl/lib_protocol/src/http/http_hdr.c"
              )
  acl_msg_fatal("%s, %s(%d): invalid input",
    "/acl/lib_protocol/src/http/http_hdr.c", myname, 569);
 n = acl_array_size(hh->entry_lnk);
 if (n <= 0) {
  acl_msg_info("%s, %s(%d): array empty",
    "/acl/lib_protocol/src/http/http_hdr.c", myname, 573);
  return;
 }
 ...
 for (i = 1; i < n; i++) {
  ...
  if (entry == 
# 584 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
              ((void *)0)
# 584 "/acl/lib_protocol/src/http/http_hdr.c"
                  )
   break;
  if (entry->off == 0)
   printf("%s: %s\r\n", entry->name, entry->value);
...
void http_hdr_fprint(ACL_VSTREAM *fp, const HTTP_HDR *hh, const char *msg)
{
 ...
 if (fp == 
# 598 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
          ((void *)0) 
# 598 "/acl/lib_protocol/src/http/http_hdr.c"
               || hh == 
# 598 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
                        ((void *)0)
# 598 "/acl/lib_protocol/src/http/http_hdr.c"
 ...
 if (n <= 0) {
  acl_msg_info("%s, %s(%d): array empty",
   myname, "/acl/lib_protocol/src/http/http_hdr.c", 606);
  return;
 }
 ...
 for (i = 1; i < n; i++) {
  entry = (HTTP_HDR_ENTRY *) acl_array_index(hh->entry_lnk, i);
  if (entry == 
# 618 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
              ((void *)0)
# 618 "/acl/lib_protocol/src/http/http_hdr.c"
                  )
   break;
  if (entry->off == 0)
   acl_vstream_fprintf(fp, "%s: %s\r\n",
...
void http_hdr_sprint(ACL_VSTRING *bf, const HTTP_HDR *hh, const char *msg)
{
 ...
 if (bf == 
# 635 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
          ((void *)0) 
# 635 "/acl/lib_protocol/src/http/http_hdr.c"
               || hh == 
# 635 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
                        ((void *)0)
# 635 "/acl/lib_protocol/src/http/http_hdr.c"
 ...
 if (n <= 0) {
  acl_msg_info("%s, %s(%d): array empty",
   myname, "/acl/lib_protocol/src/http/http_hdr.c", 643);
  return;
 }
 ...
 for (i = 1; i < n; i++) {
  entry = (HTTP_HDR_ENTRY *) acl_array_index(hh->entry_lnk, i);
  if (entry == 
# 657 "/acl/lib_protocol/src/http/http_hdr.c" 3 4
              ((void *)0)
# 657 "/acl/lib_protocol/src/http/http_hdr.c"
                  )
   break;
  if (entry->off == 0)
   acl_vstring_sprintf_append(bf, "%s: %s\r\n",
