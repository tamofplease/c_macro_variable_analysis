# 1 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 2
...
# 7 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 2
...
HTTP_HDR *http_hdr_new(size_t size)
{
 ...
 if (size != sizeof(HTTP_HDR_REQ) && size != sizeof(HTTP_HDR_RES))
  acl_msg_fatal("%s, %s(%d): size(%d) invalid",
   "/workspace/acl/lib_protocol/src/http/http_hdr.c", myname, 32, (int) size);

 hh = (HTTP_HDR*) acl_calloc_glue("/workspace/acl/lib_protocol/src/http/http_hdr.c", 34, 1, (int) size);
...
void http_hdr_clone(const HTTP_HDR *src, HTTP_HDR *dst)
{
 ACL_ARRAY *entry_lnk_saved = dst->entry_lnk;
 HTTP_HDR_ENTRY *entry, *entry_from;
 int i, n;

 memcpy(dst, src, sizeof(HTTP_HDR));
 dst->entry_lnk = entry_lnk_saved;
 dst->chat_ctx = 
# 50 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
                ((void *)0)
# 50 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
                    ;
 dst->chat_free_ctx_fn = 
# 51 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
                        ((void *)0)
# 51 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
                            ;
...
{
 if (hh == 
# 65 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
          ((void *)0)
# 65 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
              )
  return;
 if (hh->entry_lnk != 
# 67 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
                     ((void *)0)
# 67 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
                         )
  acl_array_free(hh->entry_lnk, acl_free_fn_glue);

 if (hh->chat_free_ctx_fn && hh->chat_ctx)
  hh->chat_free_ctx_fn(hh->chat_ctx);
 do { if (hh) { acl_free_glue("/workspace/acl/lib_protocol/src/http/http_hdr.c", 72, (hh)); (hh) = 
# 72 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
((void *)0)
# 72 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
; } } while (0);
}
...
{
 if (hh != 
# 77 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
          ((void *)0)
# 77 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
              ) {
  if (hh->entry_lnk != 
# 78 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
                      ((void *)0)
# 78 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
                          )
   acl_array_clean(hh->entry_lnk, acl_free_fn_glue);
  __hdr_init(hh);
 }
}
...
HTTP_HDR_ENTRY *http_hdr_entry_build(const char *name, const char *value)
{
 ...
 entry = (HTTP_HDR_ENTRY*) acl_malloc_glue("/workspace/acl/lib_protocol/src/http/http_hdr.c", 91, n0 + n1 + n2 + 2);
 entry->off = 0;
...
HTTP_HDR_ENTRY *http_hdr_entry_new(const char *data)
{
 ...
 char buf_fixed[512], *name, *value, *buf = 
# 110 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
                                           ((void *)0)
# 110 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
                                               ;
 HTTP_HDR_ENTRY *entry;
 size_t n;
 ...
 if (*data == 0)
  return 
# 117 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
        ((void *)0)
# 117 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
            ;

 n = strlen(data);
 if (n >= sizeof(buf_fixed) - 1) {
  buf = acl_strdup_glue("/workspace/acl/lib_protocol/src/http/http_hdr.c", 121, (data));
  name = buf;
 } else {
  name = buf_fixed;
  memcpy(name, data, n);
 ...
 if (*value == 0) {
  if (buf)
   do { if (buf) { acl_free_glue("/workspace/acl/lib_protocol/src/http/http_hdr.c", 143, (buf)); (buf) = 
# 143 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
  ((void *)0)
# 143 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
  ; } } while (0);
  return 
# 144 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
        ((void *)0)
# 144 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
            ;
 }

 entry = http_hdr_entry_build(name, value);
 if (buf)
  do { if (buf) { acl_free_glue("/workspace/acl/lib_protocol/src/http/http_hdr.c", 149, (buf)); (buf) = 
# 149 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
 ((void *)0)
# 149 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
 ; } } while (0);
 return entry;
}
...
HTTP_HDR_ENTRY *http_hdr_entry_head(char *data)
{
 ...
 char *ptr, *pname, *psep = 
# 157 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
                           ((void *)0)
# 157 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
                               ;
 HTTP_HDR_ENTRY *entry;
 ...
 if (*ptr == 0) {
  acl_msg_error("%s, %s(%d): invalid data=%s",
   "/workspace/acl/lib_protocol/src/http/http_hdr.c", myname, 171, data);
  return (
# 172 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
         ((void *)0)
# 172 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
             );
 }
 while (*ptr == ' ' || *ptr == '\t')
  ptr++;
 if (*ptr == 0) {
   ...
   *psep = ' ';
  acl_msg_error("%s, %s(%d): invalid data=%s",
   "/workspace/acl/lib_protocol/src/http/http_hdr.c", myname, 180, data);
  return (
# 181 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
         ((void *)0)
# 181 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
             );
 }
...
HTTP_HDR_ENTRY *http_hdr_entry_new2(char *data)
{
 ...
 char *ptr, *pname, *psep = 
# 192 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
                           ((void *)0)
# 192 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
                               ;
 HTTP_HDR_ENTRY *entry;
 ...
 if (*ptr == 0) {
  acl_msg_error("%s, %s(%d): invalid data=%s",
   "/workspace/acl/lib_protocol/src/http/http_hdr.c", myname, 206, data);
  return (
# 207 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
         ((void *)0)
# 207 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
             );
 }
 while (*ptr == ':' || *ptr == ' ' || *ptr == '\t')
  ptr++;
 if (*ptr == 0) {
   ...
   *psep = ':';
  acl_msg_error("%s, %s(%d): invalid data=%s",
   "/workspace/acl/lib_protocol/src/http/http_hdr.c", myname, 215, data);
  return (
# 216 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
         ((void *)0)
# 216 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
             );
 }
...
void http_hdr_append_entry(HTTP_HDR *hh, HTTP_HDR_ENTRY *entry)
{
 ...
 if (acl_array_append(hh->entry_lnk, entry) < 0)
  acl_msg_fatal("%s, %s(%d): acl_array_append error(%s)",
   "/workspace/acl/lib_protocol/src/http/http_hdr.c", myname, 231, acl_last_serror());
}
...
int http_hdr_parse_version(HTTP_HDR *hh, const char *data)
{
 ...
 if (hh == 
# 238 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
          ((void *)0)
# 238 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
              )
  acl_msg_fatal("%s, %s(%d): hh null",
    "/workspace/acl/lib_protocol/src/http/http_hdr.c", myname, 240);

 if (data == 
# 242 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
            ((void *)0) 
# 242 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
                 || *data == 0)
  return -1;
 ...
 do { if (sizeof(hh->proto) > 0) { size_t _n = strlen("HTTP"); _n = _n > (size_t ) sizeof(hh->proto) - 1? (size_t) sizeof(hh->proto) - 1 : _n; memcpy(hh->proto, "HTTP", _n); hh->proto[_n] = 0; } } while (0);
 return 0;
}
...
static HTTP_HDR_ENTRY *__get_hdr_entry(const HTTP_HDR *hh, const char *name)
{
 ...
 if (hh->entry_lnk == 
# 268 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
                     ((void *)0)
# 268 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
                         )
  acl_msg_fatal("%s, %s(%d): entry_lnk null",
   "/workspace/acl/lib_protocol/src/http/http_hdr.c", myname, 270);

 for ((hh->entry_lnk)->iter_head(&(iter), (hh->entry_lnk)); (iter).ptr; (hh->entry_lnk)->iter_next(&(iter), (hh->entry_lnk))) {
 ...
 return 
# 278 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
       ((void *)0)
# 278 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
           ;
}
...
char *http_hdr_entry_value(const HTTP_HDR *hh, const char *name)
{
 ...
 if (hdr_entry == 
# 291 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
                 ((void *)0)
# 291 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
                     )
  return (
# 292 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
         ((void *)0)
# 292 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
             );
 ...
 const char *value, int force)
{
 ...
 if (hh == 
# 302 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
          ((void *)0) 
# 302 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
               || name == 
# 302 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
                          ((void *)0) 
# 302 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
...
# 302 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
  ...
  acl_msg_error("%s, %s(%d): input invalid",
   "/workspace/acl/lib_protocol/src/http/http_hdr.c", myname, 304);
  return -1;
 }

 entry = __get_hdr_entry(hh, name);
 if (entry == 
# 309 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
             ((void *)0)
# 309 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
                 ) {
  if (force == 0)
   return -1;
  entry = http_hdr_entry_build(name, value);
 } else {
  acl_array_delete_obj(hh->entry_lnk, entry, 
# 314 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
                                            ((void *)0)
# 314 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
                                                );
  do { if (entry) { acl_free_glue("/workspace/acl/lib_protocol/src/http/http_hdr.c", 315, (entry)); (entry) = 
# 315 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
 ((void *)0)
# 315 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
 ; } } while (0);
  entry = http_hdr_entry_build(name, value);
 }
 ...
 const char *from, const char *to, int ignore_case)
{
 ...
 for (i = 0; i < hh->entry_lnk->count; i++) {
  ...
  { (value)->vbuf.ptr = (value)->vbuf.data; ((&(value)->vbuf)->flags &= ~((1<<0) | (1<<1) | (1<<2))); };
  ((&(value)->vbuf)->ptr < (&(value)->vbuf)->data + (&(value)->vbuf)->len ? *(&(value)->vbuf)->ptr = 0 : acl_vbuf_space((&(value)->vbuf), 1), *(&(value)->vbuf)->ptr = 0);
  ...
  while (*ptr_prev) {
   ...
   if (ptr == 
# 354 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
             ((void *)0)
# 354 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
                 ) {
  ...
  if (n > 0) {
   do { if (entry) { acl_free_glue("/workspace/acl/lib_protocol/src/http/http_hdr.c", 367, (entry)); (entry) = 
# 367 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
  ((void *)0)
# 367 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
  ; } } while (0);
   hh->entry_lnk->items[i] = http_hdr_entry_build(name,
     ((char *) (value)->vbuf.data));
  }
  if (once)
   break;
 }
...
void http_hdr_entry_off(HTTP_HDR *hh, const char *name)
{
 ...
 if (hh == 
# 384 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
          ((void *)0) 
# 384 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
               || name == 
# 384 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
                          ((void *)0)
# 384 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
  ...
  acl_msg_fatal("%s, %s(%d): input invalid",
   "/workspace/acl/lib_protocol/src/http/http_hdr.c", myname, 386);

 entry = __get_hdr_entry(hh, name);
 if (entry == 
# 389 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
             ((void *)0)
# 389 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
                 )
  return;
...
# 484 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
...
# 549 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
 if (keep_alive >= 0) {
...
void http_hdr_print(const HTTP_HDR *hh, const char *msg)
{
 ...
 if (hh == 
# 567 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
          ((void *)0)
# 567 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
              )
  acl_msg_fatal("%s, %s(%d): invalid input",
    "/workspace/acl/lib_protocol/src/http/http_hdr.c", myname, 569);
 n = acl_array_size(hh->entry_lnk);
 if (n <= 0) {
  acl_msg_info("%s, %s(%d): array empty",
    "/workspace/acl/lib_protocol/src/http/http_hdr.c", myname, 573);
  return;
 }
 ...
 for (i = 1; i < n; i++) {
  ...
  if (entry == 
# 584 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
              ((void *)0)
# 584 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
                  )
   break;
  if (entry->off == 0)
   printf("%s: %s\r\n", entry->name, entry->value);
...
void http_hdr_fprint(ACL_VSTREAM *fp, const HTTP_HDR *hh, const char *msg)
{
 ...
 if (fp == 
# 598 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
          ((void *)0) 
# 598 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
               || hh == 
# 598 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
                        ((void *)0)
# 598 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
                            ) {
  acl_msg_error("%s(%d): input invalid", myname, 599);
  return;
 }
 ...
 if (n <= 0) {
  acl_msg_info("%s, %s(%d): array empty",
   myname, "/workspace/acl/lib_protocol/src/http/http_hdr.c", 606);
  return;
 }
 ...
 for (i = 1; i < n; i++) {
  entry = (HTTP_HDR_ENTRY *) acl_array_index(hh->entry_lnk, i);
  if (entry == 
# 618 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
              ((void *)0)
# 618 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
                  )
   break;
  if (entry->off == 0)
   acl_vstream_fprintf(fp, "%s: %s\r\n",
...
void http_hdr_sprint(ACL_VSTRING *bf, const HTTP_HDR *hh, const char *msg)
{
 ...
 if (bf == 
# 635 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
          ((void *)0) 
# 635 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
               || hh == 
# 635 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
                        ((void *)0)
# 635 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
                            ) {
  acl_msg_error("%s(%d): input invalid", myname, 636);
  return;
 }
 ...
 if (n <= 0) {
  acl_msg_info("%s, %s(%d): array empty",
   myname, "/workspace/acl/lib_protocol/src/http/http_hdr.c", 643);
  return;
 }
 ...
 for (i = 1; i < n; i++) {
  entry = (HTTP_HDR_ENTRY *) acl_array_index(hh->entry_lnk, i);
  if (entry == 
# 657 "/workspace/acl/lib_protocol/src/http/http_hdr.c" 3 4
              ((void *)0)
# 657 "/workspace/acl/lib_protocol/src/http/http_hdr.c"
                  )
   break;
  if (entry->off == 0)
   acl_vstring_sprintf_append(bf, "%s: %s\r\n",
