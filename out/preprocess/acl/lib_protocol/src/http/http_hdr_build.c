# 1 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c" 2
...
# 9 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c" 2
...
void http_hdr_put_fmt(HTTP_HDR *hdr, const char *name, const char *fmt, ...)
{
 ...
 if (strbuf == 
# 39 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c" 3 4
              ((void *)0)
# 39 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c"
                  ) {
  acl_msg_fatal("%s, %s(%d): calloc error(%s)",
   "/workspace/acl/lib_protocol/src/http/http_hdr_build.c", myname, 41, acl_last_serror());
 }

 
# 44 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c" 3 4
__builtin_va_start(
# 44 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c"
ap
# 44 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c" 3 4
,
# 44 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c"
...
# 46 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c" 3 4
__builtin_va_end(
# 46 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c"
ap
# 46 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c" 3 4
)
# 46 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c"
 ...
 entry = http_hdr_entry_build(name, ((char *) (strbuf)->vbuf.data));
 if (entry) {
  http_hdr_append_entry(hdr, entry);
 }
...
int http_hdr_set_keepalive(const HTTP_HDR_REQ *req, HTTP_HDR_RES *res)
{
# 99 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c"
 int keep;
 const char *ptr;

 ptr = http_hdr_entry_value(&req->hdr, "Connection");
 if (ptr != 
# 103 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c" 3 4
           ((void *)0)
# 103 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c"
               ) {
...
HTTP_HDR_RES *http_hdr_res_static(int status)
{
 ...
 http_hdr_put_time(&res_hdr->hdr, "Date", time(
# 142 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c" 3 4
                                              ((void *)0)
# 142 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c"
                                                  ));
 return res_hdr;
}
...
HTTP_HDR_RES *http_hdr_res_error(int status)
{
 ...
 http_hdr_res_init(res_hdr, status);
 http_hdr_put_time(&res_hdr->hdr, "Date", time(
# 153 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c" 3 4
                                              ((void *)0)
# 153 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c"
                                                  ));
...
void http_hdr_build(const HTTP_HDR *hdr, ACL_VSTRING *strbuf)
{
 ...
 for (i = 1; i < n; i++) {
  ...
  if (entry == 
# 177 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c" 3 4
              ((void *)0)
# 177 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c"
                  ) {
   break;
  }
  if (entry->off) {
...
void http_hdr_build_request(const HTTP_HDR_REQ *hdr_req, ACL_VSTRING *strbuf)
{
 ...
 acl_vstring_sprintf(strbuf, "%s %s HTTP/%d.%d\r\n", entry->name,
  ((char *) (hdr_req->url_part)->vbuf.data),
 ...
 for (i = 1; i < n; i++) {
  entry = (HTTP_HDR_ENTRY *) acl_array_index(entries, i);
  if (entry == 
# 210 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c" 3 4
              ((void *)0)
# 210 "/workspace/acl/lib_protocol/src/http/http_hdr_build.c"
                  ) {
   break;
  }
  if (entry->off) {
