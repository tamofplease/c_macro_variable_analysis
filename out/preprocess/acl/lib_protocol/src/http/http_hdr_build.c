# 0 "/acl/lib_protocol/src/http/http_hdr_build.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_protocol/src/http/http_hdr_build.c"
...
# 2 "/acl/lib_protocol/src/http/http_hdr_build.c" 2
...
# 9 "/acl/lib_protocol/src/http/http_hdr_build.c" 2
...
void http_hdr_put_fmt(HTTP_HDR *hdr, const char *name, const char *fmt, ...)
{
 ...
 if (strbuf == 
# 39 "/acl/lib_protocol/src/http/http_hdr_build.c" 3 4
              ((void *)0)
# 39 "/acl/lib_protocol/src/http/http_hdr_build.c"
                  ) {
  acl_msg_fatal("%s, %s(%d): calloc error(%s)",
   "/acl/lib_protocol/src/http/http_hdr_build.c", myname, 41, acl_last_serror());
 }

 
# 44 "/acl/lib_protocol/src/http/http_hdr_build.c" 3 4
__builtin_va_start(
# 44 "/acl/lib_protocol/src/http/http_hdr_build.c"
ap
# 44 "/acl/lib_protocol/src/http/http_hdr_build.c" 3 4
,
# 44 "/acl/lib_protocol/src/http/http_hdr_build.c"
...
# 46 "/acl/lib_protocol/src/http/http_hdr_build.c" 3 4
__builtin_va_end(
# 46 "/acl/lib_protocol/src/http/http_hdr_build.c"
ap
# 46 "/acl/lib_protocol/src/http/http_hdr_build.c" 3 4
)
# 46 "/acl/lib_protocol/src/http/http_hdr_build.c"
...
int http_hdr_set_keepalive(const HTTP_HDR_REQ *req, HTTP_HDR_RES *res)
{
# 99 "/acl/lib_protocol/src/http/http_hdr_build.c"
 int keep;
 const char *ptr;

 ptr = http_hdr_entry_value(&req->hdr, "Connection");
 if (ptr != 
# 103 "/acl/lib_protocol/src/http/http_hdr_build.c" 3 4
           ((void *)0)
# 103 "/acl/lib_protocol/src/http/http_hdr_build.c"
               ) {
...
# 142 "/acl/lib_protocol/src/http/http_hdr_build.c" 3 4
                                              ((void *)0)
# 142 "/acl/lib_protocol/src/http/http_hdr_build.c"
                                                  ));
 return res_hdr;
}
...
HTTP_HDR_RES *http_hdr_res_error(int status)
{
 ...
 http_hdr_res_init(res_hdr, status);
 http_hdr_put_time(&res_hdr->hdr, "Date", time(
# 153 "/acl/lib_protocol/src/http/http_hdr_build.c" 3 4
                                              ((void *)0)
# 153 "/acl/lib_protocol/src/http/http_hdr_build.c"
                                                  ));
...
void http_hdr_build(const HTTP_HDR *hdr, ACL_VSTRING *strbuf)
{
 ...
 for (i = 1; i < n; i++) {
  ...
  if (entry == 
# 177 "/acl/lib_protocol/src/http/http_hdr_build.c" 3 4
              ((void *)0)
# 177 "/acl/lib_protocol/src/http/http_hdr_build.c"
                  ) {
   break;
  }
  if (entry->off) {
...
void http_hdr_build_request(const HTTP_HDR_REQ *hdr_req, ACL_VSTRING *strbuf)
{
 ...
 for (i = 1; i < n; i++) {
  entry = (HTTP_HDR_ENTRY *) acl_array_index(entries, i);
  if (entry == 
# 210 "/acl/lib_protocol/src/http/http_hdr_build.c" 3 4
              ((void *)0)
# 210 "/acl/lib_protocol/src/http/http_hdr_build.c"
                  ) {
   break;
  }
  if (entry->off) {
