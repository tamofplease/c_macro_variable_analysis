# 0 "/acl/lib_protocol/src/http/http_res.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_protocol/src/http/http_res.c"
...
# 2 "/acl/lib_protocol/src/http/http_res.c" 2
...
# 7 "/acl/lib_protocol/src/http/http_res.c" 2
...
HTTP_RES *http_res_new(HTTP_HDR_RES *hdr_res)
{
 ...
 respond = (HTTP_RES*) acl_calloc_glue("/acl/lib_protocol/src/http/http_res.c", 13, 1, sizeof(HTTP_RES));
 if (respond == 
# 14 "/acl/lib_protocol/src/http/http_res.c" 3 4
               ((void *)0)
# 14 "/acl/lib_protocol/src/http/http_res.c"
                   ) {
  char ebuf[256];
  acl_msg_fatal("%s, %s(%d): calloc error(%s)",
   "/acl/lib_protocol/src/http/http_res.c", myname, 17, acl_last_strerror(ebuf, sizeof(ebuf)));
 }
...
void http_res_free(HTTP_RES *respond)
{
 if (respond) {
  ...
  do { if (respond) { acl_free_glue("/acl/lib_protocol/src/http/http_res.c", 30, (respond)); (respond) = 
# 30 "/acl/lib_protocol/src/http/http_res.c" 3 4
 ((void *)0)
# 30 "/acl/lib_protocol/src/http/http_res.c"
 ; } } while (0);
 }
}
