# 0 "/acl/lib_acl/src/unit_test/acl_test_outer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/unit_test/acl_test_outer.c"
...
# 2 "/acl/lib_acl/src/unit_test/acl_test_outer.c" 2
# 23 "/acl/lib_acl/src/unit_test/acl_test_outer.c"
AUT_LINE *aut_add_outer_cmd(const ACL_CFG_LINE *cfg_line)
{
 ...
 test_line = (AUT_LINE *) acl_calloc_glue("/acl/lib_acl/src/unit_test/acl_test_outer.c", 33, 1, sizeof(*test_line));

 if (test_line == 
# 35 "/acl/lib_acl/src/unit_test/acl_test_outer.c" 3 4
                 ((void *)0)
# 35 "/acl/lib_acl/src/unit_test/acl_test_outer.c"
                     ) {
  char tbuf[256];
 ...
 if (cfg_line->ncount >= 4) {
  test_line->args_str = acl_strdup_glue("/acl/lib_acl/src/unit_test/acl_test_outer.c", 48, (cfg_line->value[3]));
  if (test_line->args_str == 
# 49 "/acl/lib_acl/src/unit_test/acl_test_outer.c" 3 4
                            ((void *)0)
# 49 "/acl/lib_acl/src/unit_test/acl_test_outer.c"
                                ) {
   char tbuf[256];
  ...
  if (test_line->argv == 
# 58 "/acl/lib_acl/src/unit_test/acl_test_outer.c" 3 4
                        ((void *)0)
# 58 "/acl/lib_acl/src/unit_test/acl_test_outer.c"
                            )
   aut_log_fatal("%s: cmd_name=%s, aut_parse_args_list error",
     myname, cfg_line->value[0]);
 } else {
  test_line->args_str = 
# 62 "/acl/lib_acl/src/unit_test/acl_test_outer.c" 3 4
                       ((void *)0)
# 62 "/acl/lib_acl/src/unit_test/acl_test_outer.c"
                           ;
  test_line->argv = 
# 63 "/acl/lib_acl/src/unit_test/acl_test_outer.c" 3 4
                   ((void *)0)
# 63 "/acl/lib_acl/src/unit_test/acl_test_outer.c"
                       ;
 }
