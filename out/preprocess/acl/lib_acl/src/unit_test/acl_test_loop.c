# 0 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
...
# 2 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 2
# 18 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
...
# 25 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                            ((void *)0)
# 25 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
                                ;
 const char *ptr;
 ...
 loop_token = (AUT_CMD_TOKEN *) acl_calloc_glue("/acl/lib_acl/src/unit_test/acl_test_loop.c", 34, 1, sizeof(*loop_token));
 loop_token->flag = 1;
 loop_token->status = 0;
 ...
 loop_token->nloop_cur = 0;
 loop_token->peer = 
# 41 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                              ((void *)0)
# 41 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
                                  ;
 ...
 if (ptr != 
# 60 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
           ((void *)0)
# 60 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
               )
...
AUT_LINE *aut_loop_make_break(const ACL_CFG_LINE *cfg_line)
{
 ...
 break_token = (AUT_CMD_TOKEN *) acl_calloc_glue("/acl/lib_acl/src/unit_test/acl_test_loop.c", 79, 1, sizeof(AUT_CMD_TOKEN));
 break_token->flag = 2;
 ...
 begin_line = 
# 88 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
             ((void *)0)
# 88 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
                 ;
 begin_token = 
# 89 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
              ((void *)0)
# 89 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
                  ;

 for (i = n - 1; i >= 0; i--) {
  tmp_line = (AUT_LINE *) acl_array_index(var_aut_line_array, i);
  if (tmp_line == 
# 93 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                 ((void *)0)
# 93 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
                     )
   aut_log_fatal("%s(%d): loop_begin null", myname, 94);
  if (tmp_line->obj_type != 1)
   continue;
  if (tmp_line->arg_inner == 
# 97 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                            ((void *)0)
# 97 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
                                )
   continue;
 ...
 if (begin_line == 
# 107 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                  ((void *)0) 
# 107 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
                       || begin_token == 
# 107 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                                         ((void *)0)
# 107 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
...
AUT_LINE *aut_loop_make_end(const ACL_CFG_LINE *cfg_line)
{
 ...
 AUT_CMD_TOKEN *loop_token = 
# 119 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                            ((void *)0)
# 119 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
                                , *loop_token_peer;
 int n, i;
 ...
 loop_token = (AUT_CMD_TOKEN *) acl_calloc_glue("/acl/lib_acl/src/unit_test/acl_test_loop.c", 125, 1, sizeof(*loop_token));
 loop_token->flag = 4;
 loop_token->status = 1;
 ...
 loop_token->match_number = __loop_nested_count;
 loop_token->peer = 
# 131 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                   ((void *)0)
# 131 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
                       ;
 ...
 for (i = 0; i < n; i++) {
  ...
  if (test_line_peer == 
# 152 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                       ((void *)0)
# 152 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
                           )
   break;
...
# 160 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                                  ((void *)0)
# 160 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
                                      )
   continue;
 ...
 if (loop_token->peer == 
# 183 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                        ((void *)0)
# 183 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
                            ) {
  aut_log_fatal("%s(%d)->%s: line_number=%d, cmd=%s, "
    ...
    "/acl/lib_acl/src/unit_test/acl_test_loop.c", 188, myname,
...
{
 if (test_begin == 
# 200 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                  ((void *)0)
# 200 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
                      )
  return (
# 201 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
         ((void *)0)
# 201 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
             );
...
int aut_loop_count(const AUT_LINE *test_line)
{
 ...
 if (test_line == 
# 209 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                 ((void *)0) 
# 209 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
                      || test_line->arg_inner == 
# 209 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                                                 ((void *)0)
# 209 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
 ...
 if (token->flag == 1)
  ...
  if (token == 
# 217 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
              ((void *)0)
# 217 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
                  )
   return (-1);
  if (token->flag == 1)
   return (token->nloop_max);
...
int aut_loop_from(const AUT_LINE *test_line)
{
 ...
 if (test_line == 
# 232 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                 ((void *)0) 
# 232 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
                      || test_line->arg_inner == 
# 232 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                                                 ((void *)0)
# 232 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
 ...
 if (test_begin == 
# 243 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                  ((void *)0) 
# 243 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
...
int aut_loop_to(const AUT_LINE *test_line)
{
 ...
 if (test_line == 
# 261 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                 ((void *)0) 
# 261 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
                      || test_line->arg_inner == 
# 261 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                                                 ((void *)0)
# 261 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
 ...
 if (test_end == 
# 272 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                ((void *)0) 
# 272 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
                     || test_end->arg_inner == 
# 272 "/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                                               ((void *)0)
# 272 "/acl/lib_acl/src/unit_test/acl_test_loop.c"
