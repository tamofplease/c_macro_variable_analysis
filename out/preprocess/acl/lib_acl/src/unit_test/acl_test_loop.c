# 1 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 2
# 18 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
...
{
 AUT_LINE *test_line;
 AUT_CMD_TOKEN *loop_token = 
# 25 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                            ((void *)0)
# 25 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
                                ;
 const char *ptr;
 ...
 loop_token = (AUT_CMD_TOKEN *) acl_calloc_glue("/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c", 34, 1, sizeof(*loop_token));
 loop_token->flag = 1;
 loop_token->status = 0;
 ...
 loop_token->nloop_cur = 0;
 loop_token->peer = 
# 41 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                              ((void *)0)
# 41 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
                                  ;

 test_line = aut_line_new(cfg_line);
 test_line->obj_type = 1;


 test_line->arg_inner = (void *) loop_token;
 test_line->free_arg_inner = acl_free_fn_glue;
 ...
 if (ptr != 
# 60 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
           ((void *)0)
# 60 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
               )
...
AUT_LINE *aut_loop_make_break(const ACL_CFG_LINE *cfg_line)
{
 ...
 break_line->obj_type = 1;

 break_token = (AUT_CMD_TOKEN *) acl_calloc_glue("/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c", 79, 1, sizeof(AUT_CMD_TOKEN));
 break_token->flag = 2;


 break_line->arg_inner = (void *) break_token;
 break_line->free_arg_inner = acl_free_fn_glue;

 n = acl_array_size(var_aut_line_array);

 begin_line = 
# 88 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
             ((void *)0)
# 88 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
                 ;
 begin_token = 
# 89 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
              ((void *)0)
# 89 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
                  ;

 for (i = n - 1; i >= 0; i--) {
  tmp_line = (AUT_LINE *) acl_array_index(var_aut_line_array, i);
  if (tmp_line == 
# 93 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                 ((void *)0)
# 93 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
                     )
   aut_log_fatal("%s(%d): loop_begin null", myname, 94);
  if (tmp_line->obj_type != 1)
   continue;
  if (tmp_line->arg_inner == 
# 97 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                            ((void *)0)
# 97 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
                                )
   continue;
 ...
 if (begin_line == 
# 107 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                  ((void *)0) 
# 107 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
                       || begin_token == 
# 107 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                                         ((void *)0)
# 107 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
...
AUT_LINE *aut_loop_make_end(const ACL_CFG_LINE *cfg_line)
{
 ...
 AUT_CMD_TOKEN *loop_token = 
# 119 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                            ((void *)0)
# 119 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
                                , *loop_token_peer;
 int n, i;
 ...
 loop_token = (AUT_CMD_TOKEN *) acl_calloc_glue("/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c", 125, 1, sizeof(*loop_token));
 loop_token->flag = 4;
 loop_token->status = 1;
 ...
 loop_token->match_number = __loop_nested_count;
 loop_token->peer = 
# 131 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                   ((void *)0)
# 131 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
                       ;
 ...
 for (i = 0; i < n; i++) {
  ...
  if (test_line_peer == 
# 152 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                       ((void *)0)
# 152 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
                           )
   break;


  if (test_line_peer->obj_type != 1)
   continue;


  if (test_line_peer->arg_inner == 
# 160 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                                  ((void *)0)
# 160 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
                                      )
   continue;
  ...
  if (loop_token_peer->status == 1)
   continue;


  if (loop_token_peer->flag != 1)
   continue;
  ...
  loop_token_peer->status = 1;
  loop_token->peer = test_line_peer;
 }

 if (loop_token->peer == 
# 183 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                        ((void *)0)
# 183 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
                            ) {
  aut_log_fatal("%s(%d)->%s: line_number=%d, cmd=%s, "
    ...
    "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c", 188, myname,
...
{
 if (test_begin == 
# 200 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                  ((void *)0)
# 200 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
                      )
  return (
# 201 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
         ((void *)0)
# 201 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
             );
...
int aut_loop_count(const AUT_LINE *test_line)
{
 ...
 if (test_line == 
# 209 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                 ((void *)0) 
# 209 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
                      || test_line->arg_inner == 
# 209 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                                                 ((void *)0)
# 209 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
 ...
 else if (token->flag == 4) {
  token = aut_line_peer_token(test_line);
  if (token == 
# 217 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
              ((void *)0)
# 217 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
                  )
   return (-1);
  if (token->flag == 1)
   return (token->nloop_max);
...
int aut_loop_from(const AUT_LINE *test_line)
{
 ...
 if (test_line == 
# 232 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                 ((void *)0) 
# 232 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
                      || test_line->arg_inner == 
# 232 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                                                 ((void *)0)
# 232 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
 ...
 if (test_begin == 
# 243 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                  ((void *)0) 
# 243 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
                       || test_begin->arg_inner == 
# 243 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                                                   ((void *)0)
# 243 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
                                                       )
...
int aut_loop_to(const AUT_LINE *test_line)
{
 ...
 if (test_line == 
# 261 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                 ((void *)0) 
# 261 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
                      || test_line->arg_inner == 
# 261 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                                                 ((void *)0)
# 261 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
 ...
 if (test_end == 
# 272 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                ((void *)0) 
# 272 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
                     || test_end->arg_inner == 
# 272 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c" 3 4
                                               ((void *)0)
# 272 "/workspace/acl/lib_acl/src/unit_test/acl_test_loop.c"
