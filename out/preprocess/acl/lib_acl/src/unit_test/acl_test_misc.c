# 0 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
...
# 2 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 2
# 21 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
AUT_LINE *aut_line_new(const ACL_CFG_LINE *cfg_line)
{
 AUT_LINE *test_line = 
# 23 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                      ((void *)0)
# 23 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                          ;

 test_line = (AUT_LINE *) acl_calloc_glue("/acl/lib_acl/src/unit_test/acl_test_misc.c", 25, 1, sizeof(AUT_LINE));
...
void aut_line_free(void *ctx)
{
 ...
 if (test_line->args_str)
  do { if (test_line->args_str) { acl_free_glue("/acl/lib_acl/src/unit_test/acl_test_misc.c", 39, (test_line->args_str)); (test_line->args_str) = 
# 39 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
 ((void *)0)
# 39 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
 ; } } while (0);
 if (test_line->argv)
 ...
 do { if (test_line) { acl_free_glue("/acl/lib_acl/src/unit_test/acl_test_misc.c", 45, (test_line)); (test_line) = 
# 45 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
((void *)0)
# 45 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
; } } while (0);
}
...
# 54 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                          ((void *)0)
# 54 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                              )
 ...
 for (i = 0; i < n; i++) {
  ...
  if (test_line == 
# 60 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                  ((void *)0)
# 60 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                      )
   break;
 ...
 return (
# 66 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
        ((void *)0)
# 66 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
            );
}
...
int aut_size(void)
{
 ...
 if (var_aut_line_array == 
# 74 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                          ((void *)0)
# 74 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                              )
  aut_log_fatal("%s: var_aut_line_array=NULL", myname);
...
AUT_LINE *aut_index(int idx)
{
 ...
 if (var_aut_line_array == 
# 87 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                          ((void *)0)
# 87 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                              )
  aut_log_fatal("%s: var_aut_line_array=NULL", myname);
 ...
 if (idx < 0 || idx > n) {
  printf("%s: idx=%d, acl_array_size=%d, err_msg=invalid idx\n",
   myname, idx, n);
  return (
# 95 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
         ((void *)0)
# 95 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
             );
 }
...
int aut_line_cmdcmp(const AUT_LINE *test_line, const char *cmd_name)
{
 ...
 if (test_line == 
# 107 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                 ((void *)0) 
# 107 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                      || cmd_name == 
# 107 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                                     ((void *)0)
# 107 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
...
int aut_line_resultcmp(const AUT_LINE *test_line, int value)
{
 ...
 if (test_line == 
# 120 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                 ((void *)0)
# 120 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                     ) {
  printf("%s: input error\n", myname);
  return (-1);
 }
...
int aut_line_number(const AUT_LINE *test_line)
{
 ...
 if (test_line == 
# 135 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                 ((void *)0)
# 135 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                     ) {
  printf("%s: input error\n", myname);
  return (-1);
 }
...
{
 if (test_line == 
# 144 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                 ((void *)0)
# 144 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                     )
  return (-1);
...
const char *aut_line_cmdname(const AUT_LINE *test_line)
{
 ...
 if (test_line == 
# 154 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                 ((void *)0)
# 154 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                     ) {
  printf("%s: input error\n", myname);
  return (
# 156 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
         ((void *)0)
# 156 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
             );
 }
...
int aut_line_argc(const AUT_LINE *test_line)
{
 ...
 if (test_line == 
# 167 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                 ((void *)0)
# 167 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                     ) {
  printf("%s: input error\n", myname);
  return (-1);
 }
...
const char *aut_line_getvalue(const AUT_LINE *test_line, const char *name)
{
 ...
 AUT_ARG_ITEM *arg = 
# 178 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                    ((void *)0)
# 178 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                        ;
 int i, n;

 if (test_line == 
# 181 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                 ((void *)0) 
# 181 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                      || name == 
# 181 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                                 ((void *)0) 
# 181 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
  ...
  printf("%s: input error\n", myname);
  return (
# 183 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
         ((void *)0)
# 183 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
             );
 }
 ...
 for (i = 0; i < n; i++) {
  ...
  if (arg == 
# 190 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
            ((void *)0) 
# 190 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                 || arg->name == 
# 190 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                                 ((void *)0)
# 190 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
 ...
 return (
# 196 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
        ((void *)0)
# 196 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
            );
}
...
const char *aut_line_argstr(const AUT_LINE *test_line)
{
 ...
 if (test_line == 
# 204 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                 ((void *)0)
# 204 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                     ) {
  printf("%s: input error\n", myname);
  return (
# 206 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
         ((void *)0)
# 206 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
             );
 }
...
int aut_line_result(const AUT_LINE *test_line)
{
 ...
 if (test_line == 
# 217 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                 ((void *)0)
# 217 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                     ) {
  printf("%s: input error\n", myname);
  return (-1);
 }
...
int aut_line_stop(const AUT_LINE *test_line)
{
 ...
 if (test_line == 
# 230 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                 ((void *)0)
# 230 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                     )
...
int aut_line_reserved(AUT_LINE *test_line)
{
 ...
 if (test_line == 
# 243 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                 ((void *)0)
# 243 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                     )
  aut_log_fatal("%s: input error", myname);
...
int aut_line_add_arg(AUT_LINE *test_line, void *arg)
{
 ...
 if (test_line == 
# 256 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                 ((void *)0)
# 256 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                     )
  aut_log_fatal("%s: input error", myname);
...
{
 if (test_line == 
# 265 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                 ((void *)0)
# 265 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                     )
  return;
 if (free_fn != 
# 267 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
               ((void *)0)
# 267 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                   )
  free_fn(test_line->arg_outer);
 test_line->arg_outer = 
# 269 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                       ((void *)0)
# 269 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                           ;
}
...
{
 if (test_line == 
# 274 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                 ((void *)0)
# 274 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                     )
  return (
# 275 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
         ((void *)0)
# 275 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
             );
...
# 283 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                                ((void *)0)
# 283 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                                    ;

 if (var_aut_line_array == 
# 285 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                          ((void *)0)
# 285 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                              ) {
 ...
 if (test_line_start == 
# 291 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                       ((void *)0)
# 291 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                           )
  return (-1);
 ...
 if (test_line_end == 
# 297 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                     ((void *)0)
# 297 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                         )
  return (-1);
...
const AUT_LINE *aut_lookup_from_line(const AUT_LINE *test_line, int flag)
{
 ...
 if (test_line == 
# 309 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                 ((void *)0)
# 309 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                     )
  return (
# 310 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
         ((void *)0)
# 310 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
             );
 ...
 for (i = aut_line_valid_linenum(test_line) + 1; i < n; i++) {
  ...
  if (dst_line == 
# 315 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                 ((void *)0)
# 315 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                     )
   break;
  if (dst_line->arg_inner == 
# 317 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
                            ((void *)0)
# 317 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
                                )
   continue;
 ...
 return (
# 324 "/acl/lib_acl/src/unit_test/acl_test_misc.c" 3 4
        ((void *)0)
# 324 "/acl/lib_acl/src/unit_test/acl_test_misc.c"
            );
}
