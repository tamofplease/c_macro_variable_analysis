# 0 "/acl/lib_acl/src/unit_test/acl_test_inner.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/unit_test/acl_test_inner.c"
...
# 2 "/acl/lib_acl/src/unit_test/acl_test_inner.c" 2
# 21 "/acl/lib_acl/src/unit_test/acl_test_inner.c"
...
# 31 "/acl/lib_acl/src/unit_test/acl_test_inner.c" 3 4
                          ((void *)0)
# 31 "/acl/lib_acl/src/unit_test/acl_test_inner.c"
                              ;

 __if_nested_count++;

 if_token = (AUT_CMD_TOKEN *) acl_calloc_glue("/acl/lib_acl/src/unit_test/acl_test_inner.c", 35, 1, sizeof(*if_token));
 if_token->flag = 5;
 if_token->match_number = ++__if_count;
 if_token->peer = 
# 38 "/acl/lib_acl/src/unit_test/acl_test_inner.c" 3 4
                         ((void *)0)
# 38 "/acl/lib_acl/src/unit_test/acl_test_inner.c"
                             ;
...
static AUT_LINE *__mkcmd_endif(const ACL_CFG_LINE *line)
{
 ...
 AUT_CMD_TOKEN *if_token = 
# 52 "/acl/lib_acl/src/unit_test/acl_test_inner.c" 3 4
                          ((void *)0)
# 52 "/acl/lib_acl/src/unit_test/acl_test_inner.c"
                              , *if_token_peer;
 int n, i;

 __if_nested_count--;
 if_token = (AUT_CMD_TOKEN *) acl_calloc_glue("/acl/lib_acl/src/unit_test/acl_test_inner.c", 56, 1, sizeof(*if_token));
 if_token->flag = 8;
 if_token->match_number = ++__endif_count;
 if_token->peer = 
# 59 "/acl/lib_acl/src/unit_test/acl_test_inner.c" 3 4
                         ((void *)0)
# 59 "/acl/lib_acl/src/unit_test/acl_test_inner.c"
                             ;
...
# 69 "/acl/lib_acl/src/unit_test/acl_test_inner.c" 3 4
                                  ((void *)0)
# 69 "/acl/lib_acl/src/unit_test/acl_test_inner.c"
                                      )
   continue;
 ...
 if (if_token->peer == 
# 83 "/acl/lib_acl/src/unit_test/acl_test_inner.c" 3 4
                      ((void *)0)
# 83 "/acl/lib_acl/src/unit_test/acl_test_inner.c"
                          ) {
...
# 99 "/acl/lib_acl/src/unit_test/acl_test_inner.c" 3 4
                             ((void *)0)
# 99 "/acl/lib_acl/src/unit_test/acl_test_inner.c"
                                 ;
 ...
 snprintf(test_line->cmd_name, sizeof(test_line->cmd_name),
   "%s", line->value[0]);
 inner_token = (AUT_CMD_TOKEN *) acl_calloc_glue("/acl/lib_acl/src/unit_test/acl_test_inner.c", 105, 1, sizeof(*inner_token));
 inner_token->flag = 9;
...
static __MATCH_CMD __inner_cmd_tab[] = {
 ...
 { "STOP", __mkcmd_stop },
 { 
# 129 "/acl/lib_acl/src/unit_test/acl_test_inner.c" 3 4
  ((void *)0)
# 129 "/acl/lib_acl/src/unit_test/acl_test_inner.c"
      , 
# 129 "/acl/lib_acl/src/unit_test/acl_test_inner.c" 3 4
        ((void *)0) 
# 129 "/acl/lib_acl/src/unit_test/acl_test_inner.c"
...
AUT_LINE *aut_add_inner_cmd(const ACL_CFG_LINE *line)
{
 ...
 AUT_LINE *test_line = 
# 137 "/acl/lib_acl/src/unit_test/acl_test_inner.c" 3 4
                      ((void *)0)
# 137 "/acl/lib_acl/src/unit_test/acl_test_inner.c"
                          ;
 ...
 if (line->ncount < 1) {
  ...
  return (
# 144 "/acl/lib_acl/src/unit_test/acl_test_inner.c" 3 4
         ((void *)0)
# 144 "/acl/lib_acl/src/unit_test/acl_test_inner.c"
             );
 }

 for (i = 0; __inner_cmd_tab[i].cmd_name != 
# 147 "/acl/lib_acl/src/unit_test/acl_test_inner.c" 3 4
                                           ((void *)0)
# 147 "/acl/lib_acl/src/unit_test/acl_test_inner.c"
                                               ; i++) {
 ...
 if (test_line == 
# 158 "/acl/lib_acl/src/unit_test/acl_test_inner.c" 3 4
                 ((void *)0)
# 158 "/acl/lib_acl/src/unit_test/acl_test_inner.c"
                     )
  return (
# 159 "/acl/lib_acl/src/unit_test/acl_test_inner.c" 3 4
         ((void *)0)
# 159 "/acl/lib_acl/src/unit_test/acl_test_inner.c"
             );
 ...
 if (inner_token == 
# 170 "/acl/lib_acl/src/unit_test/acl_test_inner.c" 3 4
                   ((void *)0)
# 170 "/acl/lib_acl/src/unit_test/acl_test_inner.c"
                       )
  return (test_line);
