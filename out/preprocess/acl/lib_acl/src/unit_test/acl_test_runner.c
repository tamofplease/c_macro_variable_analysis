# 1 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 2
# 26 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
int var_aut_verbose = 0;

static ACL_ARRAY *__all_callback_fn = 
# 28 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                     ((void *)0)
# 28 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                         ;
...
static int __test_stop(AUT_LINE *test_line, void *arg __attribute__ ((__unused__)))
{
...
static int __test_sleep(AUT_LINE *test_line, void *arg __attribute__ ((__unused__)))
{
 const char *myname = "__test_sleep";
 const char *ptr;
 int sleep_second;

 ptr = aut_line_getvalue(test_line, "COUNT");
 if (ptr == 
# 54 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
           ((void *)0)
# 54 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
               ) {
...
static int __test_pause(AUT_LINE *test_line __attribute__ ((__unused__)), void *arg __attribute__ ((__unused__)))
{
...
static int __test_loop_begin(AUT_LINE *test_line, void *arg __attribute__ ((__unused__)))
{
 ...
 if (count < 0) {
  aut_log_error("%s(%d): no loop count", myname, 91);
  return (-1);
 }
...
static int __test_loop_break(AUT_LINE *test_line, void *arg __attribute__ ((__unused__)))
{
 const char *myname = "__test_loop_break";
 const AUT_LINE *loop_end_line;
 int num_break, num_end;

 loop_end_line = aut_lookup_from_line(test_line, 4);
 if (loop_end_line == 
# 125 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                     ((void *)0)
# 125 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                         ) {
...
static int __test_loop_end(AUT_LINE *test_line __attribute__ ((__unused__)), void *arg __attribute__ ((__unused__)))
{
 return (1);
}


static int __test_if(AUT_LINE *test_line __attribute__ ((__unused__)), void *arg __attribute__ ((__unused__)))
{
 return (1);
}


static int __test_else(AUT_LINE *test_line __attribute__ ((__unused__)), void *arg __attribute__ ((__unused__)))
{
 return (1);
}


static int __test_endif(AUT_LINE *test_line __attribute__ ((__unused__)), void *arg __attribute__ ((__unused__)))
{
 return (1);
}


static int __test_goto(AUT_LINE *test_line __attribute__ ((__unused__)), void *arg __attribute__ ((__unused__)))
{
 return (1);
}
...
static AUT_FN_ITEM __inner_fn_tab[] = {
 ...
 { "STOP", "__test_stop", __test_stop, 
# 180 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                            ((void *)0)
# 180 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                                , 1 },
 { "SLEEP", "__test_sleep", __test_sleep, 
# 181 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                               ((void *)0)
# 181 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                                   , 1 },
 { "PAUSE", "__test_pause", __test_pause, 
# 182 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                               ((void *)0)
# 182 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                                   , 1 },

 { "LOOP_BEGIN", "__test_loop_begin", __test_loop_begin, 
# 184 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                                              ((void *)0)
# 184 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                                                  , 1 },
 { "LOOP_BREAK", "__test_loop_break", __test_loop_break, 
# 185 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                                              ((void *)0)
# 185 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                                                  , 1 },
 { "LOOP_END", "__test_loop_end", __test_loop_end, 
# 186 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                                        ((void *)0)
# 186 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                                            , 1 },

 { "IF", "__test_if", __test_if, 
# 188 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                      ((void *)0)
# 188 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                          , 1 },
 { "ELSE", "__test_else", __test_else, 
# 189 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                            ((void *)0)
# 189 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                                , 1 },
 { "ENDIF", "__testt_endif", __test_endif, 
# 190 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                                ((void *)0)
# 190 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                                    , 1 },

 { "GOTO", "__test_goto", __test_goto, 
# 192 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                            ((void *)0)
# 192 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                                , 1 },

 { 
# 194 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
  ((void *)0)
# 194 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
      , 
# 194 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
        ((void *)0)
# 194 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
...
static AUT_FN_ITEM *__lookup_fn_item(const AUT_LINE *test_line)
{
 ...
 int i, n;
 AUT_FN_ITEM *item = 
# 202 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                    ((void *)0)
# 202 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                        , *tmp;
 ...
 for (i = 0; i < n; i++) {
  ...
  if (tmp == 
# 207 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
            ((void *)0)
# 207 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                )
...
static int __fn_callback(int from, int to, int *stop)
{
 ...
 for (; from < to;) {
  ...
  if (test_line == 
# 232 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                  ((void *)0)
# 232 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                      )
   break;
  item = __lookup_fn_item(test_line);
  if (item == 
# 235 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
             ((void *)0)
# 235 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                 ) {
...
# 291 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                         ((void *)0)
# 291 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                             ) {
 ...
 return (__fn_callback(0, max, 
# 304 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                              ((void *)0)
# 304 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                  ));
}
...
static void free_fn_item(void *arg)
{
 ...
 do { if (item) { acl_free_glue("/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c", 311, (item)); (item) = 
# 311 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
((void *)0)
# 311 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
; } } while (0);
}
...
void aut_stop(void)
{
 if (var_aut_line_array) {
  ...
  var_aut_line_array = 
# 318 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                      ((void *)0)
# 318 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                          ;
 }
 if (__all_callback_fn) {
  acl_array_free(__all_callback_fn, free_fn_item);
  __all_callback_fn = 
# 322 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                     ((void *)0)
# 322 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                         ;
 }
}
...
static void __add_fn_item(ACL_ARRAY *fn_tab, const AUT_FN_ITEM *fn_item, int inner)
{
 ...
 item = (AUT_FN_ITEM *) acl_calloc_glue("/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c", 331, 1, sizeof(AUT_FN_ITEM));
 ...
 if (acl_array_append(fn_tab, item) < 0) {
  ...
  aut_log_fatal("%s(%d): array_append error(%s)",
   myname, 341, acl_last_strerror(tbuf, sizeof(tbuf)));
 }
}
...
void aut_register(const AUT_FN_ITEM test_fn_tab[])
{
 ...
 if (__all_callback_fn == 
# 349 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                         ((void *)0)
# 349 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                             )
  __all_callback_fn = acl_array_create(10);


 for (i = 0; __inner_fn_tab[i].cmd_name != 
# 353 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                          ((void *)0)
# 353 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                              ; i++)
  __add_fn_item(__all_callback_fn, &__inner_fn_tab[i], 1);


 for (i = 0; test_fn_tab[i].cmd_name != 
# 357 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                       ((void *)0)
# 357 "/workspace/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                           ; i++)
