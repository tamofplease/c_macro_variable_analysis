# 0 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
...
# 2 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 2
# 26 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
int var_aut_verbose = 0;

static ACL_ARRAY *__all_callback_fn = 
# 28 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                     ((void *)0)
# 28 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                         ;
...
static int __test_sleep(AUT_LINE *test_line, void *arg __attribute__ ((__unused__)))
{
 ...
 if (ptr == 
# 54 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
           ((void *)0)
# 54 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
               ) {
...
static int __test_loop_break(AUT_LINE *test_line, void *arg __attribute__ ((__unused__)))
{
 ...
 if (loop_end_line == 
# 125 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                     ((void *)0)
# 125 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                         ) {
...
# 180 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                            ((void *)0)
# 180 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                                , 1 },
 { "SLEEP", "__test_sleep", __test_sleep, 
# 181 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                               ((void *)0)
# 181 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                                   , 1 },
 { "PAUSE", "__test_pause", __test_pause, 
# 182 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                               ((void *)0)
# 182 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                                   , 1 },

 { "LOOP_BEGIN", "__test_loop_begin", __test_loop_begin, 
# 184 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                                              ((void *)0)
# 184 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                                                  , 1 },
 { "LOOP_BREAK", "__test_loop_break", __test_loop_break, 
# 185 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                                              ((void *)0)
# 185 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                                                  , 1 },
 { "LOOP_END", "__test_loop_end", __test_loop_end, 
# 186 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                                        ((void *)0)
# 186 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                                            , 1 },

 { "IF", "__test_if", __test_if, 
# 188 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                      ((void *)0)
# 188 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                          , 1 },
 { "ELSE", "__test_else", __test_else, 
# 189 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                            ((void *)0)
# 189 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                                , 1 },
 { "ENDIF", "__testt_endif", __test_endif, 
# 190 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                                ((void *)0)
# 190 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                                    , 1 },

 { "GOTO", "__test_goto", __test_goto, 
# 192 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                            ((void *)0)
# 192 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                                , 1 },

 { 
# 194 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
  ((void *)0)
# 194 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
      , 
# 194 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
        ((void *)0)
# 194 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
...
static AUT_FN_ITEM *__lookup_fn_item(const AUT_LINE *test_line)
{
 ...
 int i, n;
 AUT_FN_ITEM *item = 
# 202 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                    ((void *)0)
# 202 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                        , *tmp;
 ...
 for (i = 0; i < n; i++) {
  ...
  if (tmp == 
# 207 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
            ((void *)0)
# 207 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                )
...
static int __fn_callback(int from, int to, int *stop)
{
 ...
 for (; from < to;) {
  ...
  if (test_line == 
# 232 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                  ((void *)0)
# 232 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                      )
   break;
  item = __lookup_fn_item(test_line);
  if (item == 
# 235 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
             ((void *)0)
# 235 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                 ) {
...
# 291 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                         ((void *)0)
# 291 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                             ) {
...
# 304 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                              ((void *)0)
# 304 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                  ));
}
...
static void free_fn_item(void *arg)
{
 ...
 do { if (item) { acl_free_glue("/acl/lib_acl/src/unit_test/acl_test_runner.c", 311, (item)); (item) = 
# 311 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
((void *)0)
# 311 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
; } } while (0);
}
...
void aut_stop(void)
{
 if (var_aut_line_array) {
  ...
  var_aut_line_array = 
# 318 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                      ((void *)0)
# 318 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                          ;
 }
 if (__all_callback_fn) {
  acl_array_free(__all_callback_fn, free_fn_item);
  __all_callback_fn = 
# 322 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                     ((void *)0)
# 322 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                         ;
 }
}
...
static void __add_fn_item(ACL_ARRAY *fn_tab, const AUT_FN_ITEM *fn_item, int inner)
{
 ...
 item = (AUT_FN_ITEM *) acl_calloc_glue("/acl/lib_acl/src/unit_test/acl_test_runner.c", 331, 1, sizeof(AUT_FN_ITEM));
...
void aut_register(const AUT_FN_ITEM test_fn_tab[])
{
 ...
 if (__all_callback_fn == 
# 349 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                         ((void *)0)
# 349 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                             )
  __all_callback_fn = acl_array_create(10);


 for (i = 0; __inner_fn_tab[i].cmd_name != 
# 353 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                          ((void *)0)
# 353 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                              ; i++)
  __add_fn_item(__all_callback_fn, &__inner_fn_tab[i], 1);


 for (i = 0; test_fn_tab[i].cmd_name != 
# 357 "/acl/lib_acl/src/unit_test/acl_test_runner.c" 3 4
                                       ((void *)0)
# 357 "/acl/lib_acl/src/unit_test/acl_test_runner.c"
                                           ; i++)
