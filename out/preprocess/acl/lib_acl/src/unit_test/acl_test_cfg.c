# 1 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c" 2
# 41 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
ACL_ARRAY *var_aut_line_array = 
# 41 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c" 3 4
                               ((void *)0)
# 41 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
                                   ;
...
ACL_ARRAY *aut_parse_args_list(const char *str_in)
{
 ...
 ACL_ARRAY *argvs_array = 
# 52 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c" 3 4
                         ((void *)0)
# 52 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
                             ;
 AUT_ARG_ITEM *arg_item = 
# 53 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c" 3 4
                         ((void *)0)
# 53 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
                             ;
 ...
 pstr = acl_strdup_glue("/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c", 60, (str_in));
 pstr_saved = pstr;
 ...
 while (1) {
  ...
  ptr_item = acl_strtok(&pstr, ",");
  if (ptr_item == 
# 70 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c" 3 4
                 ((void *)0)
# 70 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
                     )
   break;


  { while (*ptr_item && ((*ptr_item == ' ' || *ptr_item == '\t'))) ptr_item++; };
  pname = ptr_item;


  pvalue = strstr(ptr_item, "=");
  if (pvalue == 
# 79 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c" 3 4
               ((void *)0)
# 79 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
                   )
   continue;
  ...
  *pvalue = 0;
  ...
  arg_item = (AUT_ARG_ITEM *) acl_calloc_glue("/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c", 98, 1, sizeof(AUT_ARG_ITEM));
  arg_item->name = acl_strdup_glue("/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c", 99, (pname));
  arg_item->value = acl_strdup_glue("/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c", 100, (pvalue));


  if (acl_array_append(argvs_array, (void *) arg_item) < 0)
   aut_log_fatal("%s(%d): append to array error(%s)",
    myname, 105, acl_last_strerror(tbuf, sizeof(tbuf)));
 }

 do { if (pstr_saved) { acl_free_glue("/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c", 108, (pstr_saved)); (pstr_saved) = 
# 108 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c" 3 4
((void *)0)
# 108 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
; } } while (0);
...
static void free_arg_item(void* arg)
{
 ...
 do { if (item->name) { acl_free_glue("/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c", 116, (item->name)); (item->name) = 
# 116 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c" 3 4
((void *)0)
# 116 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
; } } while (0);
 do { if (item->value) { acl_free_glue("/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c", 117, (item->value)); (item->value) = 
# 117 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c" 3 4
((void *)0)
# 117 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
; } } while (0);
 do { if (item) { acl_free_glue("/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c", 118, (item)); (item) = 
# 118 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c" 3 4
((void *)0)
# 118 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
; } } while (0);
}
...
{
 if (a == 
# 123 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c" 3 4
         ((void *)0)
# 123 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
             )
  return;
...
{
# 142 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
...
# 158 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c" 3 4
                          ((void *)0)
# 158 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
                              )
  return;

 var_aut_line_array = acl_array_create(10);
 if (var_aut_line_array == 
# 162 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c" 3 4
                          ((void *)0)
# 162 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
                              ) {
  char tbuf[256];
...
int aut_cfg_parse(const char *pathname)
{
 ...
 if (pathname == 
# 178 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c" 3 4
                ((void *)0) 
# 178 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
                     || *pathname == 0) {
 ...
 if (cfg_parser == 
# 187 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c" 3 4
                  ((void *)0)
# 187 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
                      ) {
  char tbuf[256];
 ...
 for (i = 0; i < n; i++) {
  ...
  if (cfg_line == 
# 196 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c" 3 4
                 ((void *)0)
# 196 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
                     )
   break;
...
int aut_cfg_print(void)
{
 ...
 AUT_LINE *line = 
# 213 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c" 3 4
                 ((void *)0)
# 213 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
                     ;
 AUT_ARG_ITEM *arg;
 int i, j, n, m, first_line_arg;

 if (var_aut_line_array == 
# 217 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c" 3 4
                          ((void *)0)
# 217 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
                              ) {
 ...
 for (i = 0; i < n; i++) {
  ...
  if (line == 
# 226 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c" 3 4
             ((void *)0)
# 226 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
                 )
   break;
  ...
  for (j = 0; j < m; j++) {
   ...
   if (arg == 
# 234 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c" 3 4
             ((void *)0)
# 234 "/workspace/acl/lib_acl/src/unit_test/acl_test_cfg.c"
                 )
    break;
