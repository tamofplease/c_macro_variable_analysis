# 1 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 2
# 52 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
...
ACL_AQUEUE *acl_aqueue_new(void)
{
 ...
 queue = (ACL_AQUEUE *) acl_malloc_glue("/workspace/acl/lib_acl/src/msg/acl_aqueue.c", 73, sizeof(ACL_AQUEUE));

 pthread_mutex_init(&queue->lock, 
# 75 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
                                     ((void *)0)
# 75 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
                                         );
 pthread_cond_init(&queue->cond, 
# 76 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
                                    ((void *)0)
# 76 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
                                        );

 queue->first = queue->last = 
# 78 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
                             ((void *)0)
# 78 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
                                 ;
 queue->qlen = 0;
 queue->error = 0;
 queue->quit = 0;
 queue->nlink = 0;
 queue->owner = (unsigned long) pthread_self();
 queue->check_owner = 0;
...
void acl_aqueue_free(ACL_AQUEUE *queue, ACL_AQUEUE_FREE_FN free_fn)
{
 ...
 if (queue == 
# 107 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
             ((void *)0)
# 107 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
                 )
  return;

 if (queue->check_owner
  && (unsigned long) pthread_self() != queue->owner)
 {
 ...
 queue->quit = 1;
 status = pthread_mutex_lock(&queue->lock);
 if (status != 0)
 ...
 while (1) {
  qi = queue->first;
  if (qi == 
# 125 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
           ((void *)0)
# 125 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
               )
   break;
  queue->first = qi->next;
  if (free_fn != 
# 128 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
                ((void *)0)
# 128 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
                    )
   free_fn(qi->data);
  do { if (qi) { acl_free_glue("/workspace/acl/lib_acl/src/msg/acl_aqueue.c", 130, (qi)); (qi) = 
# 130 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
 ((void *)0)
# 130 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
 ; } } while (0);
 }

 status = pthread_mutex_unlock(&queue->lock);
 if (status != 0)
  acl_msg_error("%s: lock error(%s)", myname, acl_last_serror());

 pthread_mutex_destroy(&queue->lock);
 pthread_cond_destroy(&queue->cond);
 do { if (queue) { acl_free_glue("/workspace/acl/lib_acl/src/msg/acl_aqueue.c", 139, (queue)); (queue) = 
# 139 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
((void *)0)
# 139 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
; } } while (0);
}
...
static int aqueue_wait(ACL_AQUEUE *queue, const struct timespec *ptimeo)
{
 ...
 while (queue->first == 
# 152 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
                       ((void *)0) 
# 152 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
                            && queue->quit == 0) {
  if (ptimeo != 
# 153 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
               ((void *)0)
# 153 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
                   )
   status = pthread_cond_timedwait(&queue->cond,
     &queue->lock, ptimeo);
  else
   status = pthread_cond_wait(&queue->cond, &queue->lock);

  if (ptimeo && status == 
# 159 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
                         110
# 159 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
                                      ) {
   status = pthread_mutex_unlock(&queue->lock);
   if (status != 0)
    acl_msg_error("%s(%d): unlock error(%s)",
     myname, 163, acl_last_serror());
...
void *acl_aqueue_pop_timedwait(ACL_AQUEUE *queue, int tmo_sec, int tmo_usec)
{
 ...
 if (queue == 
# 193 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
             ((void *)0)
# 193 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
                 )
 ...
 if (status) {
  ...
  acl_msg_error("%s: lock error(%s)", myname, acl_last_serror());
  return 
# 203 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
        ((void *)0)
# 203 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
            ;
 }

 qi = 
# 206 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
     ((void *)0)
# 206 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
         ;

 while (1) {
  if (tmo_sec < 0 || tmo_usec < 0)
   ptimeo = 
# 210 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
           ((void *)0)
# 210 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
               ;
  else {
   gettimeofday(&tv, 
# 212 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
                    ((void *)0)
# 212 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
                        );
  ...
  if (aqueue_wait(queue, ptimeo) < 0)
   return 
# 221 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
         ((void *)0)
# 221 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
             ;

  qi = queue->first;
  if (qi != 
# 224 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
           ((void *)0)
# 224 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
               ) {
   queue->first = qi->next;
   queue->qlen--;
   if (queue->last == qi)
    queue->last = 
# 228 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
                 ((void *)0)
# 228 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
                     ;
   break;
  }
  if (queue->quit != 0) {
   ...
   if (status != 0) {
    acl_msg_error("%s(%d): unlock error(%s)",
     myname, 235, acl_last_serror());
    queue->error = 2;
   }

   return 
# 239 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
         ((void *)0)
# 239 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
             ;
  }
 }
 ...
 if (status != 0)
  acl_msg_error("%s(%d): unlock error(%s)",
   myname, 246, acl_last_serror());

 if (qi == 
# 248 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
          ((void *)0)
# 248 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
              )
  acl_msg_fatal("%s(%d): qi null", myname, 249);

 data = qi->data;
 do { if (qi) { acl_free_glue("/workspace/acl/lib_acl/src/msg/acl_aqueue.c", 252, (qi)); (qi) = 
# 252 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
((void *)0)
# 252 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
; } } while (0);
...
int acl_aqueue_push(ACL_AQUEUE *queue, void *data)
{
 ...
 if (queue == 
# 263 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
             ((void *)0)
# 263 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
                 )
  acl_msg_fatal("%s: aqueue null", myname);

 qi = acl_calloc_glue("/workspace/acl/lib_acl/src/msg/acl_aqueue.c", 266, 1, sizeof(ACL_AQUEUE_ITEM));
 qi->data = data;
 ...
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_error("%s: lock error(%s)", myname, acl_last_serror());
  do { if (qi) { acl_free_glue("/workspace/acl/lib_acl/src/msg/acl_aqueue.c", 273, (qi)); (qi) = 
# 273 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
 ((void *)0)
# 273 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
 ; } } while (0);
  queue->error = 1;
  return -1;
 }
 ...
 if (queue->first == 
# 278 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
                    ((void *)0)
# 278 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
                        )
  queue->first = qi;
 else
  queue->last->next = qi;
 ...
 status = pthread_cond_signal(&queue->cond);
 if (status != 0) {
  (acl_set_error(status));
...
int acl_aqueue_qlen(ACL_AQUEUE* queue)
{
 ...
 if (status) {
  acl_msg_error("%s(%d), %s: pthread_mutex_lock error(%s)",
   "/workspace/acl/lib_acl/src/msg/acl_aqueue.c", 312, myname, strerror(status));
  return -1;
 }
 ...
 if (status) {
  acl_msg_error("%s(%d), %s: pthread_mutex_unlock error(%s)",
   "/workspace/acl/lib_acl/src/msg/acl_aqueue.c", 321, myname, strerror(status));
  return -1;
 }
...
{
 if (queue == 
# 335 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c" 3 4
             ((void *)0)
# 335 "/workspace/acl/lib_acl/src/msg/acl_aqueue.c"
                 )
  return (-1);
