# 0 "/acl/lib_acl/src/msg/acl_msgio.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/msg/acl_msgio.c"
...
# 2 "/acl/lib_acl/src/msg/acl_msgio.c" 2
# 22 "/acl/lib_acl/src/msg/acl_msgio.c"
...
# 67 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
                                ((void *)0)
# 67 "/acl/lib_acl/src/msg/acl_msgio.c"
                                    ;
...
static MSGIO_CTX *msgio_ctx_new(ACL_MSGIO *mio, const char *addr)
{
 ...
 ctx = acl_calloc_glue("/acl/lib_acl/src/msg/acl_msgio.c", 76, 1, sizeof(MSGIO_CTX));
...
static void msg_ctx_free(MSGIO_CTX *ctx)
{
 ...
 do { if (ctx) { acl_free_glue("/acl/lib_acl/src/msg/acl_msgio.c", 87, (ctx)); (ctx) = 
# 87 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
((void *)0)
# 87 "/acl/lib_acl/src/msg/acl_msgio.c"
; } } while (0);
}
...
{
 MSG_CALL *call = acl_calloc_glue("/acl/lib_acl/src/msg/acl_msgio.c", 96, 1, sizeof(MSG_CALL));
...
{
 do { if (call) { acl_free_glue("/acl/lib_acl/src/msg/acl_msgio.c", 108, (call)); (call) = 
# 108 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
((void *)0)
# 108 "/acl/lib_acl/src/msg/acl_msgio.c"
; } } while (0);
}
...
static MSG_ITEM *msg_new(int id, int inherit)
{
 ...
 msg = acl_calloc_glue("/acl/lib_acl/src/msg/acl_msgio.c", 119, 1, sizeof(MSG_ITEM));
 msg->id = id;
 msg->inherit = inherit;
...
# 140 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
                                                     ((void *)0)
# 140 "/acl/lib_acl/src/msg/acl_msgio.c"
                                                         ) {
  call = ((MSG_CALL *) (((char *) (tmp)) - 
# 141 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
        __builtin_offsetof (
# 141 "/acl/lib_acl/src/msg/acl_msgio.c"
        MSG_CALL
# 141 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
        , 
# 141 "/acl/lib_acl/src/msg/acl_msgio.c"
...
# 141 "/acl/lib_acl/src/msg/acl_msgio.c"
 ...
 do { if (msg) { acl_free_glue("/acl/lib_acl/src/msg/acl_msgio.c", 144, (msg)); (msg) = 
# 144 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
((void *)0)
# 144 "/acl/lib_acl/src/msg/acl_msgio.c"
; } } while (0);
}
...
# 155 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
        __builtin_offsetof (
# 155 "/acl/lib_acl/src/msg/acl_msgio.c"
        MSG_CALL
# 155 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
        , 
# 155 "/acl/lib_acl/src/msg/acl_msgio.c"
...
# 173 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
             __builtin_offsetof (
# 173 "/acl/lib_acl/src/msg/acl_msgio.c"
             MSG_CALL
# 173 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
             , 
# 173 "/acl/lib_acl/src/msg/acl_msgio.c"
...
# 188 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
            __builtin_offsetof (
# 188 "/acl/lib_acl/src/msg/acl_msgio.c"
            MSG_ITEM
# 188 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
            , 
# 188 "/acl/lib_acl/src/msg/acl_msgio.c"
...
# 205 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
       __builtin_offsetof (
# 205 "/acl/lib_acl/src/msg/acl_msgio.c"
       MSG_ITEM
# 205 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
       , 
# 205 "/acl/lib_acl/src/msg/acl_msgio.c"
...
# 205 "/acl/lib_acl/src/msg/acl_msgio.c"
 ...
 return (
# 210 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
        ((void *)0)
# 210 "/acl/lib_acl/src/msg/acl_msgio.c"
            );
}
...
static void msg_unreg(MSG_ITEM *msg, ACL_MSGIO_NOTIFY_FN notify_fn)
{
 ...
 for ((iter).ptr = (((&msg->call_list))->succ); (iter).ptr != (&msg->call_list); (iter).ptr = (((iter).ptr)->succ)) {
  call = ((MSG_CALL *) (((char *) (iter.ptr)) - 
# 221 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
        __builtin_offsetof (
# 221 "/acl/lib_acl/src/msg/acl_msgio.c"
        MSG_CALL
# 221 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
        , 
# 221 "/acl/lib_acl/src/msg/acl_msgio.c"
...
static ACL_MSGIO *msgio_new(void)
{
 ...
 mio = acl_calloc_glue("/acl/lib_acl/src/msg/acl_msgio.c", 244, 1, sizeof(ACL_MSGIO));
 if (mio == 
# 245 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 245 "/acl/lib_acl/src/msg/acl_msgio.c"
               ) {
  char ebuf[256];
...
void acl_msgio_init(void)
{
 ...
 if (__global_mio != 
# 269 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
                    ((void *)0)
# 269 "/acl/lib_acl/src/msg/acl_msgio.c"
                        )
  acl_msg_fatal("%s: be called more than twice", myname);

 pthread_mutex_init(&__global_mutex, 
# 272 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
                                        ((void *)0)
# 272 "/acl/lib_acl/src/msg/acl_msgio.c"
                                            );
 ...
 ACL_MSGIO_NOTIFY_FN callback, void *arg, int inherit)
{
 ...
 if (mio == 
# 282 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 282 "/acl/lib_acl/src/msg/acl_msgio.c"
               )
  mio = __global_mio;

 if (mio == 
# 285 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 285 "/acl/lib_acl/src/msg/acl_msgio.c"
               )
...
void acl_msgio_unreg(ACL_MSGIO *mio, int id, ACL_MSGIO_NOTIFY_FN callback)
{
 ...
 if (mio == 
# 323 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 323 "/acl/lib_acl/src/msg/acl_msgio.c"
               )
  mio = __global_mio;

 if (mio == 
# 326 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 326 "/acl/lib_acl/src/msg/acl_msgio.c"
               )
  acl_msg_fatal("%s: call acl_msgio_init first", myname);

 msg = msg_find(mio, id);
 if (msg != 
# 330 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 330 "/acl/lib_acl/src/msg/acl_msgio.c"
               )
...
void acl_msgio_unreg_id(ACL_MSGIO *mio, int id)
{
 ...
 if (mio == 
# 339 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 339 "/acl/lib_acl/src/msg/acl_msgio.c"
               )
  mio = __global_mio;

 if (mio == 
# 342 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 342 "/acl/lib_acl/src/msg/acl_msgio.c"
               )
  acl_msg_fatal("%s: call acl_msgio_init first", myname);

 msg = msg_find(mio, id);
 if (msg != 
# 346 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 346 "/acl/lib_acl/src/msg/acl_msgio.c"
               ) {
...
void acl_msgio_unreg_all(ACL_MSGIO *mio)
{
 ...
 if (mio == 
# 358 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 358 "/acl/lib_acl/src/msg/acl_msgio.c"
               )
  mio = __global_mio;

 if (mio == 
# 361 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 361 "/acl/lib_acl/src/msg/acl_msgio.c"
               )
  acl_msg_fatal("%s: call acl_msgio_init first", myname);
 ...
 while (1) {
  ...
  if (tmp == 
# 366 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
            ((void *)0)
# 366 "/acl/lib_acl/src/msg/acl_msgio.c"
                )
   break;

  msg = ((MSG_ITEM *) (((char *) (tmp)) - 
# 369 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
       __builtin_offsetof (
# 369 "/acl/lib_acl/src/msg/acl_msgio.c"
       MSG_ITEM
# 369 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
       , 
# 369 "/acl/lib_acl/src/msg/acl_msgio.c"
...
static int dispatch_foreach(ACL_MSGIO *mio, const ACL_MSGIO_INFO *info, int id)
{
 ...
 msg = msg_find(mio, id);
 if (msg == 
# 386 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 386 "/acl/lib_acl/src/msg/acl_msgio.c"
               ) {
  if (id == 5) {
 ...
 for ((iter).ptr = (((&msg->call_list))->succ); (iter).ptr != (&msg->call_list); (iter).ptr = (((iter).ptr)->succ)) {
  call = ((MSG_CALL *) (((char *) (iter.ptr)) - 
# 396 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
        __builtin_offsetof (
# 396 "/acl/lib_acl/src/msg/acl_msgio.c"
        MSG_CALL
# 396 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
        , 
# 396 "/acl/lib_acl/src/msg/acl_msgio.c"
...
static void free_mio_onclose(ACL_VSTREAM *stream __attribute__ ((__unused__)), void *arg)
{
 ...
 acl_msgio_unreg_all(mio);
 do { if (mio) { acl_free_glue("/acl/lib_acl/src/msg/acl_msgio.c", 566, (mio)); (mio) = 
# 566 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
((void *)0)
# 566 "/acl/lib_acl/src/msg/acl_msgio.c"
; } } while (0);
}
...
# 610 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
                                     ((void *)0)
# 610 "/acl/lib_acl/src/msg/acl_msgio.c"
                                         , 0);
 if (stream == 
# 611 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
              ((void *)0)
# 611 "/acl/lib_acl/src/msg/acl_msgio.c"
                  ) {
  acl_msg_error("%s(%d): accept error(%s)",
   myname, 613, acl_last_serror());
  return (
# 614 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
         ((void *)0)
# 614 "/acl/lib_acl/src/msg/acl_msgio.c"
             );
 }
...
static int listen_callback(ACL_ASTREAM *sstream __attribute__ ((__unused__)), void *arg)
{
 ...
 if (mio_client == 
# 655 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
                  ((void *)0)
# 655 "/acl/lib_acl/src/msg/acl_msgio.c"
                      )
...
ACL_MSGIO *acl_msgio_listen(ACL_AIO *aio, const char *addr)
{
 ...
 if (aio == 
# 671 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 671 "/acl/lib_acl/src/msg/acl_msgio.c"
               )
  acl_msg_fatal("%s: aio null", myname);
 if (addr != 
# 673 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
            ((void *)0)
# 673 "/acl/lib_acl/src/msg/acl_msgio.c"
                )
  addr_ptr = addr;
 else
  addr_ptr = local;
 ...
 if (stream == 
# 683 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
              ((void *)0)
# 683 "/acl/lib_acl/src/msg/acl_msgio.c"
                  )
 ...
 int rw_timeout, MSGIO_CTX *ctx)
{
 ...
 if (astream == 
# 756 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
               ((void *)0)
# 756 "/acl/lib_acl/src/msg/acl_msgio.c"
                   )
  return (
# 757 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
         ((void *)0)
# 757 "/acl/lib_acl/src/msg/acl_msgio.c"
             );
...
ACL_MSGIO *acl_msgio_connect(ACL_AIO *aio, const char *addr, int rw_timeout)
{
 ...
 if (aio != 
# 794 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 794 "/acl/lib_acl/src/msg/acl_msgio.c"
               ) {
  mio->aio = aio;
  ...
  if (mio->stream.async)
   ...
   stream = 
# 800 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 800 "/acl/lib_acl/src/msg/acl_msgio.c"
               ;
 } else {
 ...
 if (stream == 
# 807 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
              ((void *)0)
# 807 "/acl/lib_acl/src/msg/acl_msgio.c"
                  ) {
  msg_ctx_free(ctx);
  acl_msgio_close(mio);
  return (
# 810 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
         ((void *)0)
# 810 "/acl/lib_acl/src/msg/acl_msgio.c"
             );
 }
...
static int send_msg(ACL_MSGIO *mio, int type, void *data, int dlen)
{
 ...
 if (stream == 
# 833 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
              ((void *)0)
# 833 "/acl/lib_acl/src/msg/acl_msgio.c"
                  )
  acl_msg_fatal("%s: stream NULL", myname);

 if (data == 
# 836 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
            ((void *)0) 
# 836 "/acl/lib_acl/src/msg/acl_msgio.c"
                 || dlen < 0)
  dlen = 0;
 ...
 return (0);
# 902 "/acl/lib_acl/src/msg/acl_msgio.c"
 return (0);
}
...
int acl_msgio_send(ACL_MSGIO *mio, int type, void *data, int dlen)
{
 ...
 if (mio == 
# 909 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0) 
# 909 "/acl/lib_acl/src/msg/acl_msgio.c"
                || mio->ctx == 
# 909 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
                               ((void *)0)
# 909 "/acl/lib_acl/src/msg/acl_msgio.c"
...
# 918 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
                            ((void *)0)
# 918 "/acl/lib_acl/src/msg/acl_msgio.c"
                                , addr, 10);
  if (client == 
# 919 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
               ((void *)0)
# 919 "/acl/lib_acl/src/msg/acl_msgio.c"
                   ) {
...
ACL_ASTREAM *acl_msgio_astream(ACL_MSGIO *mio)
{
 if (mio->aio)
  ...
  return (
# 955 "/acl/lib_acl/src/msg/acl_msgio.c" 3 4
         ((void *)0)
# 955 "/acl/lib_acl/src/msg/acl_msgio.c"
             );
}
