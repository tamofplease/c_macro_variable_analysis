# 1 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 2
# 22 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
...
static ACL_MSGIO *__global_mio = 
# 67 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
                                ((void *)0)
# 67 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
                                    ;
...
static MSGIO_CTX *msgio_ctx_new(ACL_MSGIO *mio, const char *addr)
{
 ...
 ctx = acl_calloc_glue("/workspace/acl/lib_acl/src/msg/acl_msgio.c", 76, 1, sizeof(MSGIO_CTX));
 ctx->info.body.buf = acl_vstring_alloc(256);
 ctx->mio = mio;
 do { if (sizeof(ctx->addr) > 0) { size_t _n = strlen(addr); _n = _n > (size_t ) sizeof(ctx->addr) - 1? (size_t) sizeof(ctx->addr) - 1 : _n; memcpy(ctx->addr, addr, _n); ctx->addr[_n] = 0; } } while (0);
 mio->ctx = ctx;
 return (ctx);
}
...
static void msg_ctx_free(MSGIO_CTX *ctx)
{
 ...
 do { if (ctx) { acl_free_glue("/workspace/acl/lib_acl/src/msg/acl_msgio.c", 87, (ctx)); (ctx) = 
# 87 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
((void *)0)
# 87 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
; } } while (0);
}
...
{
 MSG_CALL *call = acl_calloc_glue("/workspace/acl/lib_acl/src/msg/acl_msgio.c", 96, 1, sizeof(MSG_CALL));
...
{
 do { if (call) { acl_free_glue("/workspace/acl/lib_acl/src/msg/acl_msgio.c", 108, (call)); (call) = 
# 108 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
((void *)0)
# 108 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
; } } while (0);
}
...
static MSG_ITEM *msg_new(int id, int inherit)
{
 ...
 msg = acl_calloc_glue("/workspace/acl/lib_acl/src/msg/acl_msgio.c", 119, 1, sizeof(MSG_ITEM));
 msg->id = id;
 msg->inherit = inherit;
...
static void msg_free(MSG_ITEM *msg)
{
 ...
 while ((tmp = acl_ring_pop_head(&msg->call_list)) != 
# 140 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
                                                     ((void *)0)
# 140 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
                                                         ) {
  call = ((MSG_CALL *) (((char *) (tmp)) - 
# 141 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
        __builtin_offsetof (
# 141 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
        MSG_CALL
# 141 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
        , 
# 141 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
...
# 141 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
 ...
 do { if (msg) { acl_free_glue("/workspace/acl/lib_acl/src/msg/acl_msgio.c", 144, (msg)); (msg) = 
# 144 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
((void *)0)
# 144 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
; } } while (0);
}
...
static void msg_append(MSG_ITEM *msg, ACL_MSGIO_NOTIFY_FN notify_fn, void *arg)
{
 ...
 for ((iter).ptr = (((&msg->call_list))->succ); (iter).ptr != (&msg->call_list); (iter).ptr = (((iter).ptr)->succ)) {
  call = ((MSG_CALL *) (((char *) (iter.ptr)) - 
# 155 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
        __builtin_offsetof (
# 155 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
        MSG_CALL
# 155 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
        , 
# 155 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
...
static void msg_clone(MSG_ITEM *msg_from, MSG_ITEM *msg_to)
{
 ...
 for ((iter).ptr = (((&msg_from->call_list))->succ); (iter).ptr != (&msg_from->call_list); (iter).ptr = (((iter).ptr)->succ)) {
  call_from = ((MSG_CALL *) (((char *) (iter.ptr)) - 
# 173 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
             __builtin_offsetof (
# 173 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
             MSG_CALL
# 173 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
             , 
# 173 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
...
static void msg_list_clone(ACL_MSGIO *mio_from, ACL_MSGIO *mio_to)
{
 ...
 for ((iter).ptr = (((&mio_from->msg_list))->succ); (iter).ptr != (&mio_from->msg_list); (iter).ptr = (((iter).ptr)->succ)) {
  msg_from = ((MSG_ITEM *) (((char *) (iter.ptr)) - 
# 188 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
            __builtin_offsetof (
# 188 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
            MSG_ITEM
# 188 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
            , 
# 188 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
...
static MSG_ITEM *msg_find(ACL_MSGIO *mio, int id)
{
 ...
 for ((iter).ptr = (((&mio->msg_list))->succ); (iter).ptr != (&mio->msg_list); (iter).ptr = (((iter).ptr)->succ)) {
  msg = ((MSG_ITEM *) (((char *) (iter.ptr)) - 
# 205 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
       __builtin_offsetof (
# 205 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
       MSG_ITEM
# 205 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
       , 
# 205 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
...
# 205 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
 ...
 return (
# 210 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
        ((void *)0)
# 210 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
            );
}
...
static void msg_unreg(MSG_ITEM *msg, ACL_MSGIO_NOTIFY_FN notify_fn)
{
 ...
 for ((iter).ptr = (((&msg->call_list))->succ); (iter).ptr != (&msg->call_list); (iter).ptr = (((iter).ptr)->succ)) {
  call = ((MSG_CALL *) (((char *) (iter.ptr)) - 
# 221 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
        __builtin_offsetof (
# 221 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
        MSG_CALL
# 221 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
        , 
# 221 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
...
static ACL_MSGIO *msgio_new(void)
{
 ...
 mio = acl_calloc_glue("/workspace/acl/lib_acl/src/msg/acl_msgio.c", 244, 1, sizeof(ACL_MSGIO));
 if (mio == 
# 245 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 245 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
               ) {
  char ebuf[256];
...
void acl_msgio_init(void)
{
 ...
 if (__global_mio != 
# 269 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
                    ((void *)0)
# 269 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
                        )
  acl_msg_fatal("%s: be called more than twice", myname);

 pthread_mutex_init(&__global_mutex, 
# 272 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
                                        ((void *)0)
# 272 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
                                            );
 ...
 ACL_MSGIO_NOTIFY_FN callback, void *arg, int inherit)
{
 ...
 if (mio == 
# 282 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 282 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
               )
  mio = __global_mio;

 if (mio == 
# 285 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 285 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
               )
...
void acl_msgio_unreg(ACL_MSGIO *mio, int id, ACL_MSGIO_NOTIFY_FN callback)
{
 ...
 if (mio == 
# 323 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 323 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
               )
  mio = __global_mio;

 if (mio == 
# 326 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 326 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
               )
  acl_msg_fatal("%s: call acl_msgio_init first", myname);

 msg = msg_find(mio, id);
 if (msg != 
# 330 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 330 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
               )
...
void acl_msgio_unreg_id(ACL_MSGIO *mio, int id)
{
 ...
 if (mio == 
# 339 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 339 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
               )
  mio = __global_mio;

 if (mio == 
# 342 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 342 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
               )
  acl_msg_fatal("%s: call acl_msgio_init first", myname);

 msg = msg_find(mio, id);
 if (msg != 
# 346 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 346 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
               ) {
...
void acl_msgio_unreg_all(ACL_MSGIO *mio)
{
 ...
 if (mio == 
# 358 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 358 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
               )
  mio = __global_mio;

 if (mio == 
# 361 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 361 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
               )
  acl_msg_fatal("%s: call acl_msgio_init first", myname);
 ...
 while (1) {
  ...
  if (tmp == 
# 366 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
            ((void *)0)
# 366 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
                )
   break;

  msg = ((MSG_ITEM *) (((char *) (tmp)) - 
# 369 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
       __builtin_offsetof (
# 369 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
       MSG_ITEM
# 369 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
       , 
# 369 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
...
static int dispatch_foreach(ACL_MSGIO *mio, const ACL_MSGIO_INFO *info, int id)
{
 ...
 msg = msg_find(mio, id);
 if (msg == 
# 386 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 386 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
               ) {
  if (id == 5) {
 ...
 for ((iter).ptr = (((&msg->call_list))->succ); (iter).ptr != (&msg->call_list); (iter).ptr = (((iter).ptr)->succ)) {
  call = ((MSG_CALL *) (((char *) (iter.ptr)) - 
# 396 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
        __builtin_offsetof (
# 396 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
        MSG_CALL
# 396 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
        , 
# 396 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
...
static int read_body_callback(ACL_ASTREAM *astream __attribute__ ((__unused__)), void *arg,
 char *data, int dlen)
{
...
static int sync_wait_msg(ACL_MSGIO *mio)
{
 ...
 if (acl_vstream_readn(mio->stream.sync,
  &ctx->info.hdr, sizeof(ctx->info.hdr)) == (-1))
 {
...
static void free_mio_onclose(ACL_VSTREAM *stream __attribute__ ((__unused__)), void *arg)
{
 ACL_MSGIO *mio = (ACL_MSGIO *) arg;
 acl_msgio_unreg_all(mio);
 do { if (mio) { acl_free_glue("/workspace/acl/lib_acl/src/msg/acl_msgio.c", 566, (mio)); (mio) = 
# 566 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
((void *)0)
# 566 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
; } } while (0);
}

static void free_msg_ctx_onclose(ACL_VSTREAM *stream __attribute__ ((__unused__)), void *arg)
{
 MSGIO_CTX *ctx = (MSGIO_CTX *) arg;
 msg_ctx_free(ctx);
}
...
static int close_callback(ACL_ASTREAM *astream, void *arg)
{
 ...
 acl_msg_error("%s: close it(%d) now(%s)", myname,
  ((acl_aio_vstream(astream))->fd.sock), acl_last_serror());
...
static int io_timeout_callback(ACL_ASTREAM *astream __attribute__ ((__unused__)), void *arg)
{
 MSGIO_CTX *ctx = (MSGIO_CTX *) arg;
...
static ACL_MSGIO *accept_connection(ACL_VSTREAM *sstream, ACL_MSGIO *listener)
{
 ...
 stream = acl_vstream_accept(sstream, 
# 610 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
                                     ((void *)0)
# 610 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
                                         , 0);
 if (stream == 
# 611 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
              ((void *)0)
# 611 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
                  ) {
  acl_msg_error("%s(%d): accept error(%s)",
   myname, 613, acl_last_serror());
  return (
# 614 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
         ((void *)0)
# 614 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
             );
 }

 acl_non_blocking(((stream)->fd.sock), 0);
 ...
 ctx_client = msgio_ctx_new(mio_client, ((stream)->addr_peer ? (stream)->addr_peer : ""));
 ...
 if (mio_client->aio) {
  ...
  acl_aio_ctl(mio_client->stream.async,
   4, mio_client->rw_timeout,
   20, io_timeout_callback, ctx_client,
   18, close_callback, ctx_client,
   3, ctx_client,
   0);
 } else
...
static int listen_callback(ACL_ASTREAM *sstream __attribute__ ((__unused__)), void *arg)
{
 ...
 if (sstream != ctx->mio->stream.async)
  acl_msg_fatal("%s(%d): sstream invalid", myname, 652);

 mio_client = accept_connection(acl_aio_vstream(sstream), ctx->mio);
 if (mio_client == 
# 655 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
                  ((void *)0)
# 655 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
                      )
  acl_msg_warn("%s(%d): accept null", myname, 656);
 else if (acl_msgio_wait(mio_client) < 0)
  acl_msg_warn("%s(%d): acl_msgio_wait error", myname, 658);
 return (0);
}
...
ACL_MSGIO *acl_msgio_listen(ACL_AIO *aio, const char *addr)
{
 ...
 if (aio == 
# 671 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 671 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
               )
  acl_msg_fatal("%s: aio null", myname);
 if (addr != 
# 673 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
            ((void *)0)
# 673 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
                )
  addr_ptr = addr;
 else
  addr_ptr = local;
 ...
 stream = acl_vstream_listen_ex(
   addr_ptr, 128, 1, 1024, 0);

 if (stream == 
# 683 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
              ((void *)0)
# 683 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
                  )
  acl_msg_fatal("%s: listen(%s) error(%s)",
   myname, addr_ptr, acl_last_serror());

 if (((stream)->addr_local ? (stream)->addr_local : "") && *((stream)->addr_local ? (stream)->addr_local : ""))
  do { if (sizeof(listener->addr) > 0) { size_t _n = strlen(((stream)->addr_local ? (stream)->addr_local : "")); _n = _n > (size_t ) sizeof(listener->addr) - 1? (size_t) sizeof(listener->addr) - 1 : _n; memcpy(listener->addr, ((stream)->addr_local ? (stream)->addr_local : ""), _n); listener->addr[_n] = 0; } } while (0)
                          ;
 else
  listener->addr[0] = 0;
...
static int connect_timeout_callback(ACL_ASTREAM *astream __attribute__ ((__unused__)), void *arg)
{
 MSGIO_CTX *ctx = (MSGIO_CTX *) arg;
...
static int connect_callback(ACL_ASTREAM *astream, void *arg)
{
 ...
 acl_aio_ctl(astream, 20, io_timeout_callback, ctx,
  0);
 ...
 int rw_timeout, MSGIO_CTX *ctx)
{
 ...
 if (astream == 
# 756 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
               ((void *)0)
# 756 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
                   )
  return (
# 757 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
         ((void *)0)
# 757 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
             );

 acl_aio_ctl(astream,
  22, connect_callback, ctx,
  18, close_callback, ctx,
  20, connect_timeout_callback, ctx,
  4, rw_timeout,
  0);
 return (astream);
}
...
ACL_MSGIO *acl_msgio_connect(ACL_AIO *aio, const char *addr, int rw_timeout)
{
 ...
 do { if (sizeof(mio->addr) > 0) { size_t _n = strlen(addr); _n = _n > (size_t ) sizeof(mio->addr) - 1? (size_t) sizeof(mio->addr) - 1 : _n; memcpy(mio->addr, addr, _n); mio->addr[_n] = 0; } } while (0);

 ctx = msgio_ctx_new(mio, addr);

 if (aio != 
# 794 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 794 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
               ) {
  mio->aio = aio;
  ...
  if (mio->stream.async)
   ...
   stream = 
# 800 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0)
# 800 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
               ;
 } else {
  stream = acl_vstream_connect(addr, 0, rw_timeout,
    rw_timeout, 1024);
  mio->stream.sync = stream;
 }

 if (stream == 
# 807 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
              ((void *)0)
# 807 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
                  ) {
  msg_ctx_free(ctx);
  acl_msgio_close(mio);
  return (
# 810 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
         ((void *)0)
# 810 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
             );
 }
...
static int send_msg(ACL_MSGIO *mio, int type, void *data, int dlen)
{
 ...
 if (stream == 
# 833 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
              ((void *)0)
# 833 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
                  )
  acl_msg_fatal("%s: stream NULL", myname);

 if (data == 
# 836 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
            ((void *)0) 
# 836 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
                 || dlen < 0)
  dlen = 0;
 ...
 return (0);
# 902 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
 return (0);
}
...
int acl_msgio_send(ACL_MSGIO *mio, int type, void *data, int dlen)
{
 ...
 if (mio == 
# 909 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
           ((void *)0) 
# 909 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
                || mio->ctx == 
# 909 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
                               ((void *)0)
# 909 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
 ...
 if (mio->type == 2) {
  ...
  client = acl_msgio_connect(
# 918 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
                            ((void *)0)
# 918 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
                                , addr, 10);
  if (client == 
# 919 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
               ((void *)0)
# 919 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
                   ) {
...
void acl_msgio_addr(const ACL_MSGIO *mio, char *buf, size_t size)
{
 do { if (size > 0) { size_t _n = strlen(mio->addr); _n = _n > (size_t ) size - 1? (size_t) size - 1 : _n; memcpy(buf, mio->addr, _n); buf[_n] = 0; } } while (0);
}
...
ACL_ASTREAM *acl_msgio_astream(ACL_MSGIO *mio)
{
 if (mio->aio)
  ...
  return (
# 955 "/workspace/acl/lib_acl/src/msg/acl_msgio.c" 3 4
         ((void *)0)
# 955 "/workspace/acl/lib_acl/src/msg/acl_msgio.c"
             );
}
