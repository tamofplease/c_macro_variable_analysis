# 0 "/acl/lib_acl/src/code/acl_urlcode.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/code/acl_urlcode.c"
...
# 2 "/acl/lib_acl/src/code/acl_urlcode.c" 2
# 15 "/acl/lib_acl/src/code/acl_urlcode.c"
...
char *acl_url_encode(const char *str, ACL_DBUF_POOL *dbuf)
{
 ...
 if (dbuf != 
# 25 "/acl/lib_acl/src/code/acl_urlcode.c" 3 4
            ((void *)0)
# 25 "/acl/lib_acl/src/code/acl_urlcode.c"
                )
  tmp = (unsigned char*) acl_dbuf_pool_alloc(dbuf, len + 1);
 else
  tmp = (unsigned char*) acl_malloc_glue("/acl/lib_acl/src/code/acl_urlcode.c", 28, len + 1);
 ...
 for (i = 0, j = 0; i < len; i++, j++) {
  ...
  if (!
# 35 "/acl/lib_acl/src/code/acl_urlcode.c" 3 4
      ((*__ctype_b_loc ())[(int) ((
# 35 "/acl/lib_acl/src/code/acl_urlcode.c"
      tmp[j]
# 35 "/acl/lib_acl/src/code/acl_urlcode.c" 3 4
...
# 35 "/acl/lib_acl/src/code/acl_urlcode.c"
   ...
   tmp_len += 3;
   if (dbuf != 
# 37 "/acl/lib_acl/src/code/acl_urlcode.c" 3 4
              ((void *)0)
# 37 "/acl/lib_acl/src/code/acl_urlcode.c"
                  ) {
    ...
    tmp = acl_realloc_glue("/acl/lib_acl/src/code/acl_urlcode.c", 44, (tmp), tmp_len);
...
char *acl_url_decode(const char *str, ACL_DBUF_POOL *dbuf)
{
 ...
 len = (int) strlen(str);
 if (dbuf != 
# 81 "/acl/lib_acl/src/code/acl_urlcode.c" 3 4
            ((void *)0)
# 81 "/acl/lib_acl/src/code/acl_urlcode.c"
                )
  tmp = (char*) acl_dbuf_pool_alloc(dbuf, len + 1);
 else
  tmp = (char*) acl_malloc_glue("/acl/lib_acl/src/code/acl_urlcode.c", 84, len + 1);

 for (i = 0; i < len; i++) {
# 97 "/acl/lib_acl/src/code/acl_urlcode.c"
  if (str[i] != '%')
   tmp[pos] = str[i];
  else if (i + 2 >= len) {
   tmp[pos++] = '%';
...
# 105 "/acl/lib_acl/src/code/acl_urlcode.c" 3 4
            ((*__ctype_b_loc ())[(int) ((
# 105 "/acl/lib_acl/src/code/acl_urlcode.c"
            (int) str[i + 1]
# 105 "/acl/lib_acl/src/code/acl_urlcode.c" 3 4
            ))] & (unsigned short int) _ISalnum) 
# 105 "/acl/lib_acl/src/code/acl_urlcode.c"
