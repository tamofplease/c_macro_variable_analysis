# 1 "/workspace/acl/lib_acl/src/code/acl_base64.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/code/acl_base64.c" 2
# 17 "/workspace/acl/lib_acl/src/code/acl_base64.c"
...
unsigned char *acl_base64_encode(const char *in, int len)
{
 ...
 unsigned char *code = 
# 42 "/workspace/acl/lib_acl/src/code/acl_base64.c" 3 4
                      ((void *)0)
# 42 "/workspace/acl/lib_acl/src/code/acl_base64.c"
                          ;
 unsigned char *p;

 code = acl_malloc_glue("/workspace/acl/lib_acl/src/code/acl_base64.c", 45, 4 * ((len + 2) / 3) + 1);
 p = code;
...
int acl_base64_decode(const char *in, char **pptr_in)
{
 ...
 register int x, y;
 unsigned char *result, *result_saved = 
# 88 "/workspace/acl/lib_acl/src/code/acl_base64.c" 3 4
                                       ((void *)0)
# 88 "/workspace/acl/lib_acl/src/code/acl_base64.c"
                                           ;
# 98 "/workspace/acl/lib_acl/src/code/acl_base64.c"
 in_len = strlen((const char *) code);
 in_end = code + in_len;
 result_saved = result = acl_malloc_glue("/workspace/acl/lib_acl/src/code/acl_base64.c", 100, 3 * (in_len / 4) + 1);
 *pptr = result;
 ...
 while (in_end - code >= 4 && (x = (*code++)) != 0) {
  if (x > 127 || (x = un_b64_tab[x]) == 255)
   { if (result_saved != 
# 108 "/workspace/acl/lib_acl/src/code/acl_base64.c" 3 4
  ((void *)0)
# 108 "/workspace/acl/lib_acl/src/code/acl_base64.c"
  ) do { if (result_saved) { acl_free_glue("/workspace/acl/lib_acl/src/code/acl_base64.c", 108, (result_saved)); (result_saved) = 
# 108 "/workspace/acl/lib_acl/src/code/acl_base64.c" 3 4
  ((void *)0)
# 108 "/workspace/acl/lib_acl/src/code/acl_base64.c"
  ; } } while (0); *pptr = 
...
# 108 "/workspace/acl/lib_acl/src/code/acl_base64.c"
  ...
  if ((y = (*code++)) == 0 || (y = un_b64_tab[y]) == 255)
   { if (result_saved != 
# 110 "/workspace/acl/lib_acl/src/code/acl_base64.c" 3 4
  ((void *)0)
# 110 "/workspace/acl/lib_acl/src/code/acl_base64.c"
  ) do { if (result_saved) { acl_free_glue("/workspace/acl/lib_acl/src/code/acl_base64.c", 110, (result_saved)); (result_saved) = 
# 110 "/workspace/acl/lib_acl/src/code/acl_base64.c" 3 4
  ((void *)0)
# 110 "/workspace/acl/lib_acl/src/code/acl_base64.c"
  ; } } while (0); *pptr = 
...
# 110 "/workspace/acl/lib_acl/src/code/acl_base64.c"
  ...
  *result++ = (x << 2) | (y >> 4);
  ...
  if ((x = (*code++)) == '=') {
   if (*code++ != '=' || *code != 0)
    { if (result_saved != 
# 115 "/workspace/acl/lib_acl/src/code/acl_base64.c" 3 4
   ((void *)0)
# 115 "/workspace/acl/lib_acl/src/code/acl_base64.c"
   ) do { if (result_saved) { acl_free_glue("/workspace/acl/lib_acl/src/code/acl_base64.c", 115, (result_saved)); (result_saved) = 
# 115 "/workspace/acl/lib_acl/src/code/acl_base64.c" 3 4
   ((void *)0)
# 115 "/workspace/acl/lib_acl/src/code/acl_base64.c"
   ; } } while (0); *pptr = 
...
# 115 "/workspace/acl/lib_acl/src/code/acl_base64.c"
   ...
   if (x > 127 || (x = un_b64_tab[x]) == 255)
    { if (result_saved != 
# 118 "/workspace/acl/lib_acl/src/code/acl_base64.c" 3 4
   ((void *)0)
# 118 "/workspace/acl/lib_acl/src/code/acl_base64.c"
   ) do { if (result_saved) { acl_free_glue("/workspace/acl/lib_acl/src/code/acl_base64.c", 118, (result_saved)); (result_saved) = 
# 118 "/workspace/acl/lib_acl/src/code/acl_base64.c" 3 4
   ((void *)0)
# 118 "/workspace/acl/lib_acl/src/code/acl_base64.c"
   ; } } while (0); *pptr = 
...
# 118 "/workspace/acl/lib_acl/src/code/acl_base64.c"
   ...
   *result++ = (y << 4) | (x >> 2);
   if ((y = (*code++)) == '=') {
    if (*code != 0)
     { if (result_saved != 
# 122 "/workspace/acl/lib_acl/src/code/acl_base64.c" 3 4
    ((void *)0)
# 122 "/workspace/acl/lib_acl/src/code/acl_base64.c"
    ) do { if (result_saved) { acl_free_glue("/workspace/acl/lib_acl/src/code/acl_base64.c", 122, (result_saved)); (result_saved) = 
# 122 "/workspace/acl/lib_acl/src/code/acl_base64.c" 3 4
    ((void *)0)
# 122 "/workspace/acl/lib_acl/src/code/acl_base64.c"
    ; } } while (0); *pptr = 
...
# 122 "/workspace/acl/lib_acl/src/code/acl_base64.c"
    ...
    if (y > 127 || (y = un_b64_tab[y]) == 255)
     { if (result_saved != 
# 125 "/workspace/acl/lib_acl/src/code/acl_base64.c" 3 4
    ((void *)0)
# 125 "/workspace/acl/lib_acl/src/code/acl_base64.c"
    ) do { if (result_saved) { acl_free_glue("/workspace/acl/lib_acl/src/code/acl_base64.c", 125, (result_saved)); (result_saved) = 
# 125 "/workspace/acl/lib_acl/src/code/acl_base64.c" 3 4
    ((void *)0)
# 125 "/workspace/acl/lib_acl/src/code/acl_base64.c"
    ; } } while (0); *pptr = 
