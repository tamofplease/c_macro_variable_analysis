# 1 "/workspace/acl/lib_acl/src/code/acl_vstring_base64.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 3 "/workspace/acl/lib_acl/src/code/acl_vstring_base64.c" 2
# 29 "/workspace/acl/lib_acl/src/code/acl_vstring_base64.c"
 ...
 const char *in, int len)
{
 ...
 acl_vbuf_space(&(result)->vbuf, size);




 { (result)->vbuf.ptr = (result)->vbuf.data; ((&(result)->vbuf)->flags &= ~((1<<0) | (1<<1) | (1<<2))); };
 for (cp = ((const unsigned char *)(in)), count = len;
      count > 0; count -= 3, cp += 3) {
  ((&(result)->vbuf)->ptr < (&(result)->vbuf)->data + (&(result)->vbuf)->len ? (int) (*(&(result)->vbuf)->ptr++ = (to_b64[cp[0] >> 2])) : acl_vbuf_put((&(result)->vbuf),(to_b64[cp[0] >> 2])));
  if (count > 1) {
   ((&(result)->vbuf)->ptr < (&(result)->vbuf)->data + (&(result)->vbuf)->len ? (int) (*(&(result)->vbuf)->ptr++ = (to_b64[(cp[0] & 0x3) << 4 | cp[1] >> 4])) : acl_vbuf_put((&(result)->vbuf),(to_b64[(cp[0] & 0x3) << 4 | cp[1] >> 4])))
                                            ;
   if (count > 2) {
    ((&(result)->vbuf)->ptr < (&(result)->vbuf)->data + (&(result)->vbuf)->len ? (int) (*(&(result)->vbuf)->ptr++ = (to_b64[(cp[1] & 0xf) << 2 | cp[2] >> 6])) : acl_vbuf_put((&(result)->vbuf),(to_b64[(cp[1] & 0xf) << 2 | cp[2] >> 6])))
                                             ;
    ((&(result)->vbuf)->ptr < (&(result)->vbuf)->data + (&(result)->vbuf)->len ? (int) (*(&(result)->vbuf)->ptr++ = (to_b64[cp[2] & 0x3f])) : acl_vbuf_put((&(result)->vbuf),(to_b64[cp[2] & 0x3f])));
   } else {
    ((&(result)->vbuf)->ptr < (&(result)->vbuf)->data + (&(result)->vbuf)->len ? (int) (*(&(result)->vbuf)->ptr++ = (to_b64[(cp[1] & 0xf) << 2])) : acl_vbuf_put((&(result)->vbuf),(to_b64[(cp[1] & 0xf) << 2])));
    ((&(result)->vbuf)->ptr < (&(result)->vbuf)->data + (&(result)->vbuf)->len ? (int) (*(&(result)->vbuf)->ptr++ = ('=')) : acl_vbuf_put((&(result)->vbuf),('=')));
    break;
   }
  } else {
   ((&(result)->vbuf)->ptr < (&(result)->vbuf)->data + (&(result)->vbuf)->len ? (int) (*(&(result)->vbuf)->ptr++ = (to_b64[(cp[0] & 0x3) << 4])) : acl_vbuf_put((&(result)->vbuf),(to_b64[(cp[0] & 0x3) << 4])));
   ((&(result)->vbuf)->ptr < (&(result)->vbuf)->data + (&(result)->vbuf)->len ? (int) (*(&(result)->vbuf)->ptr++ = ('=')) : acl_vbuf_put((&(result)->vbuf),('=')));
   ((&(result)->vbuf)->ptr < (&(result)->vbuf)->data + (&(result)->vbuf)->len ? (int) (*(&(result)->vbuf)->ptr++ = ('=')) : acl_vbuf_put((&(result)->vbuf),('=')));
   break;
  }
 }
 ((&(result)->vbuf)->ptr < (&(result)->vbuf)->data + (&(result)->vbuf)->len ? *(&(result)->vbuf)->ptr = 0 : acl_vbuf_space((&(result)->vbuf), 1), *(&(result)->vbuf)->ptr = 0);
 return (result);
}
 ...
 const char *in, int len)
{
 ...
 if (len % 4)
  return (
# 112 "/workspace/acl/lib_acl/src/code/acl_vstring_base64.c" 3 4
         ((void *)0)
# 112 "/workspace/acl/lib_acl/src/code/acl_vstring_base64.c"
             );
# 125 "/workspace/acl/lib_acl/src/code/acl_vstring_base64.c"
 acl_vbuf_space(&(result)->vbuf, len);
 ...
 for (cp = ((const unsigned char *)(in)), count = 0; count < len; count += 4) {
  if ((ch0 = un_b64[*cp++]) == 0xff
      || (ch1 = un_b64[*cp++]) == 0xff)
   return (0);
  ((&(result)->vbuf)->ptr < (&(result)->vbuf)->data + (&(result)->vbuf)->len ? (int) (*(&(result)->vbuf)->ptr++ = (ch0 << 2 | ch1 >> 4)) : acl_vbuf_put((&(result)->vbuf),(ch0 << 2 | ch1 >> 4)));
  if ((ch2 = *cp++) == '=')
   break;
  if ((ch2 = un_b64[ch2]) == 0xff)
   return (0);
  ((&(result)->vbuf)->ptr < (&(result)->vbuf)->data + (&(result)->vbuf)->len ? (int) (*(&(result)->vbuf)->ptr++ = (ch1 << 4 | ch2 >> 2)) : acl_vbuf_put((&(result)->vbuf),(ch1 << 4 | ch2 >> 2)));
  if ((ch3 = *cp++) == '=')
   break;
  if ((ch3 = un_b64[ch3]) == 0xff)
   return (0);
  ((&(result)->vbuf)->ptr < (&(result)->vbuf)->data + (&(result)->vbuf)->len ? (int) (*(&(result)->vbuf)->ptr++ = (ch2 << 6 | ch3)) : acl_vbuf_put((&(result)->vbuf),(ch2 << 6 | ch3)));
 }
 ((&(result)->vbuf)->ptr < (&(result)->vbuf)->data + (&(result)->vbuf)->len ? *(&(result)->vbuf)->ptr = 0 : acl_vbuf_space((&(result)->vbuf), 1), *(&(result)->vbuf)->ptr = 0);
 return (result);
}
