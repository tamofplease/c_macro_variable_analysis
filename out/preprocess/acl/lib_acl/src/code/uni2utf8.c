# 1 "/workspace/acl/lib_acl/src/code/uni2utf8.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/code/uni2utf8.c" 2
...
# 3 "/workspace/acl/lib_acl/src/code/uni2utf8.c" 2
# 16 "/workspace/acl/lib_acl/src/code/uni2utf8.c"
int uni2utf8(unsigned int c, char *buf, size_t size)
{
 unsigned int len = 0;
 int first;
