# 0 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 2 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 2
# 21 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
# 1 "/acl/lib_acl/src/ioctl/ioctl_internal.h" 1



# 1 "/acl/lib_acl/include/thread/acl_pthread_pool.h" 1
# 5 "/acl/lib_acl/src/ioctl/ioctl_internal.h" 2
# 1 "/acl/lib_acl/include/stdlib/acl_vstream.h" 1
# 6 "/acl/lib_acl/src/ioctl/ioctl_internal.h" 2
...
void listen_notify_callback(int event_type, ACL_EVENT *event,
 ACL_VSTREAM *stream, void *context);
# 22 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 2
 ...
 int idle_timeout, int delay_sec, int delay_usec)
{
 ...
 if (max_threads > 0 && idle_timeout <= 0) {
  ...
  acl_msg_error("%s, %s(%d): idle_timeout(%d) invalid",
   "/acl/lib_acl/src/ioctl/acl_ioctl.c", myname, 42, idle_timeout);
 }

 ioc = (ACL_IOCTL *) acl_calloc_glue("/acl/lib_acl/src/ioctl/acl_ioctl.c", 45, 1, sizeof(ACL_IOCTL));
...
# 73 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
__builtin_va_start(
# 73 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
ap
# 73 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
,
# 73 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 73 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
 ...
 for (; name != 0; name = 
# 75 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                                         __builtin_va_arg(
# 75 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                                         ap
# 75 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                                         ,
# 75 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 75 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
  ...
  case 1:
   ioc->max_threads = 
# 78 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                     __builtin_va_arg(
# 78 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                     ap
# 78 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                     ,
# 78 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 78 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
  ...
  case 9:
   ioc->stacksize = 
# 81 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                   __builtin_va_arg(
# 81 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                   ap
# 81 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                   ,
# 81 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 81 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
  ...
  case 2:
   ioc->idle_timeout = 
# 84 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                      __builtin_va_arg(
# 84 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                      ap
# 84 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                      ,
# 84 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 84 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
  ...
  case 3:
   ioc->delay_sec = 
# 87 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                   __builtin_va_arg(
# 87 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                   ap
# 87 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                   ,
# 87 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 87 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
  ...
  case 4:
   ioc->delay_usec = 
# 92 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                    __builtin_va_arg(
# 92 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                    ap
# 92 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                    ,
# 92 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 92 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
  ...
  case 5:
   ioc->thread_init_fn = 
# 97 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                        __builtin_va_arg(
# 97 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                        ap
# 97 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                        ,
# 97 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 97 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
  ...
  case 6:
   ioc->thread_exit_fn = 
# 100 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                        __builtin_va_arg(
# 100 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                        ap
# 100 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                        ,
# 100 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 100 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
  ...
  case 7:
   ioc->thread_init_arg = 
# 103 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                         __builtin_va_arg(
# 103 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                         ap
# 103 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                         ,
# 103 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 103 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
  ...
  case 8:
   ioc->thread_exit_arg = 
# 106 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                         __builtin_va_arg(
# 106 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                         ap
# 106 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                         ,
# 106 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 106 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
   ...
   break;
  default:
   acl_msg_fatal("%s(%d): unknown arg", "/acl/lib_acl/src/ioctl/acl_ioctl.c", 109);
...
# 115 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
__builtin_va_end(
# 115 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
ap
# 115 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
)
# 115 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
{
 if (ioc == 
# 120 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
           ((void *)0)
# 120 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
               )
  return;
 ...
 do { if (ioc) { acl_free_glue("/acl/lib_acl/src/ioctl/acl_ioctl.c", 128, (ioc)); (ioc) = 
# 128 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
((void *)0)
# 128 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
; } } while (0);
}
...
# 144 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                           ((void *)0)
# 144 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                               )
  acl_msg_fatal("%s, %s(%d): thread_init_fn null",
   "/acl/lib_acl/src/ioctl/acl_ioctl.c", myname, 146);
...
# 157 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                           ((void *)0)
# 157 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                               )
  acl_msg_fatal("%s, %s(%d): thread_exit_fn null",
   "/acl/lib_acl/src/ioctl/acl_ioctl.c", myname, 159);
...
int acl_ioctl_start(ACL_IOCTL *ioc)
{
 ...
 if (ioc->max_threads == 0) {
  ioc->tp = 
# 168 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
           ((void *)0)
# 168 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
               ;
...
ACL_EVENT *acl_ioctl_event(ACL_IOCTL *ioc)
{
 if (ioc)
  return (ioc->event);
 return 
# 201 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
       ((void *)0)
# 201 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
           ;
}
...
{
 do { if (ctx) { acl_free_glue("/acl/lib_acl/src/ioctl/acl_ioctl.c", 239, (ctx)); (ctx) = 
# 239 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
((void *)0)
# 239 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
; } } while (0);
}
 ...
 int timeout, ACL_IOCTL_NOTIFY_FN notify_fn, void *context)
{
 ...
 if (ioc == 
# 248 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
           ((void *)0) 
# 248 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                || stream == 
# 248 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                             ((void *)0)
# 248 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 251 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                              ((void *)0)
# 251 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                                  ) {
  stream->ioctl_read_ctx = acl_malloc_glue("/acl/lib_acl/src/ioctl/acl_ioctl.c", 252, sizeof(ACL_IOCTL_CTX));
 ...
 int timeout, ACL_IOCTL_NOTIFY_FN notify_fn, void *context)
{
 ...
 if (ioc == 
# 280 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
           ((void *)0) 
# 280 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                || stream == 
# 280 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                             ((void *)0)
# 280 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 283 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                               ((void *)0)
# 283 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                                   ) {
  stream->ioctl_write_ctx = acl_malloc_glue("/acl/lib_acl/src/ioctl/acl_ioctl.c", 284, sizeof(ACL_IOCTL_CTX));
 ...
 int timeout, ACL_IOCTL_NOTIFY_FN notify_fn, void *context)
{
 ...
 if (ioc == 
# 310 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
           ((void *)0) 
# 310 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                || stream == 
# 310 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                             ((void *)0)
# 310 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
 ...
 int timeout, ACL_IOCTL_NOTIFY_FN notify_fn, void *context)
{
 ...
 if (ioc == 
# 322 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
           ((void *)0) 
# 322 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                || stream == 
# 322 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                             ((void *)0)
# 322 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
 ...
 if (stream->ioctl_read_ctx == 
# 325 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                              ((void *)0)
# 325 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                                  ) {
  stream->ioctl_read_ctx = acl_malloc_glue("/acl/lib_acl/src/ioctl/acl_ioctl.c", 326, sizeof(ACL_IOCTL_CTX));
  ((ACL_IOCTL_CTX *) stream->ioctl_read_ctx)->stream = stream;
 ...
 void *context, long long int idle_limit)
{
 ...
 if (ioc == 
# 381 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
           ((void *)0) 
# 381 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                || timer_fn == 
# 381 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                               ((void *)0)
# 381 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
 ...
 if (ioc->event == 
# 383 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                  ((void *)0)
# 383 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                      )
 ...
 ACL_EVENT_NOTIFY_TIME timer_fn, void *context)
{
 ...
 if (ioc == 
# 395 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
           ((void *)0) 
# 395 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
                || ioc->event == 
# 395 "/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                                 ((void *)0) 
# 395 "/acl/lib_acl/src/ioctl/acl_ioctl.c"
