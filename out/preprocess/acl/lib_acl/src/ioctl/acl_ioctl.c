# 1 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 2
# 21 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
# 1 "/workspace/acl/lib_acl/src/ioctl/ioctl_internal.h" 1



# 1 "/workspace/acl/lib_acl/include/thread/acl_pthread_pool.h" 1
# 5 "/workspace/acl/lib_acl/src/ioctl/ioctl_internal.h" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_vstream.h" 1
# 6 "/workspace/acl/lib_acl/src/ioctl/ioctl_internal.h" 2
...
void listen_notify_callback(int event_type, ACL_EVENT *event,
 ACL_VSTREAM *stream, void *context);
# 22 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 2
 ...
 int idle_timeout, int delay_sec, int delay_usec)
{
 ...
 if (max_threads > 0 && idle_timeout <= 0) {
  ...
  acl_msg_error("%s, %s(%d): idle_timeout(%d) invalid",
   "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c", myname, 42, idle_timeout);
 }

 ioc = (ACL_IOCTL *) acl_calloc_glue("/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c", 45, 1, sizeof(ACL_IOCTL));
...
ACL_IOCTL *acl_ioctl_create(int max_threads, int idle_timeout)
{
 ...
 return acl_ioctl_create_ex(0, max_threads,
...
# 73 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
__builtin_va_start(
# 73 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
ap
# 73 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
,
# 73 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 73 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
 ...
 for (; name != 0; name = 
# 75 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                                         __builtin_va_arg(
# 75 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                                         ap
# 75 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                                         ,
# 75 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 75 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
  ...
  case 1:
   ioc->max_threads = 
# 78 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                     __builtin_va_arg(
# 78 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                     ap
# 78 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                     ,
# 78 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 78 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
  ...
  case 9:
   ioc->stacksize = 
# 81 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                   __builtin_va_arg(
# 81 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                   ap
# 81 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                   ,
# 81 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 81 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
  ...
  case 2:
   ioc->idle_timeout = 
# 84 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                      __builtin_va_arg(
# 84 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                      ap
# 84 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                      ,
# 84 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 84 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
  ...
  case 3:
   ioc->delay_sec = 
# 87 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                   __builtin_va_arg(
# 87 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                   ap
# 87 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                   ,
# 87 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 87 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
  ...
  case 4:
   ioc->delay_usec = 
# 92 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                    __builtin_va_arg(
# 92 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                    ap
# 92 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                    ,
# 92 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 92 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
  ...
  case 5:
   ioc->thread_init_fn = 
# 97 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                        __builtin_va_arg(
# 97 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                        ap
# 97 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                        ,
# 97 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 97 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
  ...
  case 6:
   ioc->thread_exit_fn = 
# 100 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                        __builtin_va_arg(
# 100 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                        ap
# 100 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                        ,
# 100 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 100 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
  ...
  case 7:
   ioc->thread_init_arg = 
# 103 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                         __builtin_va_arg(
# 103 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                         ap
# 103 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                         ,
# 103 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 103 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
  ...
  case 8:
   ioc->thread_exit_arg = 
# 106 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                         __builtin_va_arg(
# 106 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                         ap
# 106 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                         ,
# 106 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 106 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
   ...
   break;
  default:
   acl_msg_fatal("%s(%d): unknown arg", "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c", 109);
...
# 115 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
__builtin_va_end(
# 115 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
ap
# 115 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
)
# 115 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
{
 if (ioc == 
# 120 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
           ((void *)0)
# 120 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
               )
  return;
 ...
 do { if (ioc) { acl_free_glue("/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c", 128, (ioc)); (ioc) = 
# 128 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
((void *)0)
# 128 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
; } } while (0);
}
...
# 144 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                           ((void *)0)
# 144 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                               )
  acl_msg_fatal("%s, %s(%d): thread_init_fn null",
   "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c", myname, 146);
...
# 157 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                           ((void *)0)
# 157 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                               )
  acl_msg_fatal("%s, %s(%d): thread_exit_fn null",
   "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c", myname, 159);
...
int acl_ioctl_start(ACL_IOCTL *ioc)
{
 ...
 if (ioc->max_threads == 0) {
  ioc->tp = 
# 168 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
           ((void *)0)
# 168 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
               ;
...
ACL_EVENT *acl_ioctl_event(ACL_IOCTL *ioc)
{
 if (ioc)
  return (ioc->event);
 return 
# 201 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
       ((void *)0)
# 201 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
           ;
}
...
static void __free_ctx(ACL_VSTREAM *stream __attribute__ ((__unused__)), void *ctx)
{
 do { if (ctx) { acl_free_glue("/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c", 239, (ctx)); (ctx) = 
# 239 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
((void *)0)
# 239 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
; } } while (0);
}
 ...
 int timeout, ACL_IOCTL_NOTIFY_FN notify_fn, void *context)
{
 ...
 if (ioc == 
# 248 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
           ((void *)0) 
# 248 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                || stream == 
# 248 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                             ((void *)0)
# 248 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                                 )
  acl_msg_fatal("%s(%d): input invalid", myname, 249);

 if (stream->ioctl_read_ctx == 
# 251 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                              ((void *)0)
# 251 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                                  ) {
  stream->ioctl_read_ctx = acl_malloc_glue("/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c", 252, sizeof(ACL_IOCTL_CTX));
 ...
 int timeout, ACL_IOCTL_NOTIFY_FN notify_fn, void *context)
{
 ...
 if (ioc == 
# 280 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
           ((void *)0) 
# 280 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                || stream == 
# 280 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                             ((void *)0)
# 280 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                                 )
  acl_msg_fatal("%s(%d): input invalid", myname, 281);

 if (stream->ioctl_write_ctx == 
# 283 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                               ((void *)0)
# 283 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                                   ) {
  stream->ioctl_write_ctx = acl_malloc_glue("/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c", 284, sizeof(ACL_IOCTL_CTX));
 ...
 int timeout, ACL_IOCTL_NOTIFY_FN notify_fn, void *context)
{
 ...
 if (ioc == 
# 310 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
           ((void *)0) 
# 310 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                || stream == 
# 310 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                             ((void *)0)
# 310 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                                 )
  acl_msg_fatal("%s(%d): input invalid", myname, 311);
 ...
 int timeout, ACL_IOCTL_NOTIFY_FN notify_fn, void *context)
{
 ...
 if (ioc == 
# 322 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
           ((void *)0) 
# 322 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                || stream == 
# 322 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                             ((void *)0)
# 322 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                                 )
  acl_msg_fatal("%s(%d): input invalid", myname, 323);

 if (stream->ioctl_read_ctx == 
# 325 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                              ((void *)0)
# 325 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                                  ) {
  stream->ioctl_read_ctx = acl_malloc_glue("/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c", 326, sizeof(ACL_IOCTL_CTX));
  ((ACL_IOCTL_CTX *) stream->ioctl_read_ctx)->stream = stream;
...
ACL_VSTREAM *acl_ioctl_connect(const char *addr, int timeout)
{
 ...
 if (timeout == 0)
  stream = acl_vstream_connect(addr, 1, 0, 0, 4096);
 else if (timeout < 0)
  stream = acl_vstream_connect(addr, 0, 0, 0, 4096);
 else
  stream = acl_vstream_connect(addr, 1, timeout, 0, 4096);
...
ACL_VSTREAM *acl_ioctl_listen_ex(const char *addr, int qlen,
 int block_mode, int io_bufsize, int io_timeout)
{
 return acl_vstream_listen_ex(addr, qlen, block_mode == 0
  ? 0 : 1, io_bufsize, io_timeout);
}
...
long long int acl_ioctl_request_timer(ACL_IOCTL *ioc, ACL_EVENT_NOTIFY_TIME timer_fn,
 void *context, long long int idle_limit)
{
 const char *myname = "acl_ioctl_request_timer";

 if (ioc == 
# 381 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
           ((void *)0) 
# 381 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                || timer_fn == 
# 381 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                               ((void *)0)
# 381 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                                   )
  acl_msg_fatal("%s(%d): input invalid", myname, 382);
 if (ioc->event == 
# 383 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                  ((void *)0)
# 383 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                      )
  acl_msg_fatal("%s(%d): ioctl's event null", myname, 384);
 ...
 ACL_EVENT_NOTIFY_TIME timer_fn, void *context)
{
 ...
 if (ioc == 
# 395 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
           ((void *)0) 
# 395 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
                || ioc->event == 
# 395 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c" 3 4
                                 ((void *)0) 
# 395 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
...
# 395 "/workspace/acl/lib_acl/src/ioctl/acl_ioctl.c"
  ...
  acl_msg_fatal("%s(%d): input invalid", myname, 396);
