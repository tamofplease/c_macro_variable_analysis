# 1 "/workspace/acl/lib_acl/src/ioctl/ioctl_thr.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/ioctl/ioctl_thr.c" 2
# 21 "/workspace/acl/lib_acl/src/ioctl/ioctl_thr.c"
...
void listen_notify_callback(int event_type, ACL_EVENT *event,
 ACL_VSTREAM *stream, void *context);
# 22 "/workspace/acl/lib_acl/src/ioctl/ioctl_thr.c" 2
...
void read_notify_callback_r(int event_type, ACL_EVENT *event __attribute__ ((__unused__)),
 ACL_VSTREAM *stream __attribute__ ((__unused__)), void *context)
{
 ...
 case (1 << 6):
 case (1 << 4):
  acl_pthread_pool_add_one(ioc->tp, worker_callback_r, ctx);
  break;
 default:
  acl_msg_fatal("%s(%d): unknown event type(%d)",
   "/workspace/acl/lib_acl/src/ioctl/ioctl_thr.c", 50, event_type);

  break;
 }
}

void write_notify_callback_r(int event_type, ACL_EVENT *event __attribute__ ((__unused__)),
 ACL_VSTREAM *stream __attribute__ ((__unused__)), void *context)
{
 ACL_IOCTL_CTX *ctx = (ACL_IOCTL_CTX *) context;
 ACL_IOCTL *ioc = ctx->ioc;
 ...
 default:
  acl_msg_fatal("%s(%d): unknown event type(%d)",
   "/workspace/acl/lib_acl/src/ioctl/ioctl_thr.c", 72, event_type);

  break;
 }
}

void listen_notify_callback_r(int event_type, ACL_EVENT *event __attribute__ ((__unused__)),
 ACL_VSTREAM *stream __attribute__ ((__unused__)), void *context)
{
 ACL_IOCTL_CTX *ctx= (ACL_IOCTL_CTX *) context;
 ACL_IOCTL *ioc = ctx->ioc;
 ...
 default:
  acl_msg_fatal("%s(%d): unknown event type(%d)",
   "/workspace/acl/lib_acl/src/ioctl/ioctl_thr.c", 96, event_type);
...
static void worker_ready_callback(void *context)
{
 ...
 do { if (ctx) { acl_free_glue("/workspace/acl/lib_acl/src/ioctl/ioctl_thr.c", 109, (ctx)); (ctx) = 
# 109 "/workspace/acl/lib_acl/src/ioctl/ioctl_thr.c" 3 4
((void *)0)
# 109 "/workspace/acl/lib_acl/src/ioctl/ioctl_thr.c"
; } } while (0);
 callback(ioc, arg);
}
...
int acl_ioctl_add(ACL_IOCTL *ioc, ACL_IOCTL_WORKER_FN callback, void *arg)
{
 ...
 if (ioc == 
# 118 "/workspace/acl/lib_acl/src/ioctl/ioctl_thr.c" 3 4
           ((void *)0) 
# 118 "/workspace/acl/lib_acl/src/ioctl/ioctl_thr.c"
                || ioc->tp == 
# 118 "/workspace/acl/lib_acl/src/ioctl/ioctl_thr.c" 3 4
                              ((void *)0)
# 118 "/workspace/acl/lib_acl/src/ioctl/ioctl_thr.c"
                                  )
  acl_msg_fatal("%s(%d): input invalid", myname, 119);

 ctx = acl_malloc_glue("/workspace/acl/lib_acl/src/ioctl/ioctl_thr.c", 121, sizeof(ACL_IOCTL_CTX));
 ctx->ioc = ioc;
 ctx->worker_fn = callback;
 ctx->context = arg;

 acl_pthread_pool_add_one(ioc->tp, worker_ready_callback, ctx);
 return 0;
}
