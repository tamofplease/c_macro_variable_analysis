# 0 "/acl/lib_acl/src/ioctl/ioctl_thr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/ioctl/ioctl_thr.c"
...
# 2 "/acl/lib_acl/src/ioctl/ioctl_thr.c" 2
# 21 "/acl/lib_acl/src/ioctl/ioctl_thr.c"
...
void listen_notify_callback(int event_type, ACL_EVENT *event,
 ACL_VSTREAM *stream, void *context);
# 22 "/acl/lib_acl/src/ioctl/ioctl_thr.c" 2
 ...
 ACL_VSTREAM *stream __attribute__ ((__unused__)), void *context)
{
 ...
 default:
  acl_msg_fatal("%s(%d): unknown event type(%d)",
   "/acl/lib_acl/src/ioctl/ioctl_thr.c", 50, event_type);
 ...
 ACL_VSTREAM *stream __attribute__ ((__unused__)), void *context)
{
 ...
 default:
  acl_msg_fatal("%s(%d): unknown event type(%d)",
   "/acl/lib_acl/src/ioctl/ioctl_thr.c", 72, event_type);
 ...
 ACL_VSTREAM *stream __attribute__ ((__unused__)), void *context)
{
 ...
 default:
  acl_msg_fatal("%s(%d): unknown event type(%d)",
   "/acl/lib_acl/src/ioctl/ioctl_thr.c", 96, event_type);
...
static void worker_ready_callback(void *context)
{
 ...
 do { if (ctx) { acl_free_glue("/acl/lib_acl/src/ioctl/ioctl_thr.c", 109, (ctx)); (ctx) = 
# 109 "/acl/lib_acl/src/ioctl/ioctl_thr.c" 3 4
((void *)0)
# 109 "/acl/lib_acl/src/ioctl/ioctl_thr.c"
; } } while (0);
 callback(ioc, arg);
}
...
int acl_ioctl_add(ACL_IOCTL *ioc, ACL_IOCTL_WORKER_FN callback, void *arg)
{
 ...
 if (ioc == 
# 118 "/acl/lib_acl/src/ioctl/ioctl_thr.c" 3 4
           ((void *)0) 
# 118 "/acl/lib_acl/src/ioctl/ioctl_thr.c"
                || ioc->tp == 
# 118 "/acl/lib_acl/src/ioctl/ioctl_thr.c" 3 4
                              ((void *)0)
# 118 "/acl/lib_acl/src/ioctl/ioctl_thr.c"
 ...
 ctx = acl_malloc_glue("/acl/lib_acl/src/ioctl/ioctl_thr.c", 121, sizeof(ACL_IOCTL_CTX));
 ctx->ioc = ioc;
