# 0 "/acl/lib_acl/src/db/acl_dbsql.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/db/acl_dbsql.c"
...
# 2 "/acl/lib_acl/src/db/acl_dbsql.c" 2
# 21 "/acl/lib_acl/src/db/acl_dbsql.c"
ACL_SQL_RES *acl_dbsql_select(ACL_DB_HANDLE *handle, const char *sql, int *error)
{
 const char *myname = "acl_dbsql_select";

 if (handle == 
# 25 "/acl/lib_acl/src/db/acl_dbsql.c" 3 4
              ((void *)0) 
# 25 "/acl/lib_acl/src/db/acl_dbsql.c"
                   || sql == 
# 25 "/acl/lib_acl/src/db/acl_dbsql.c" 3 4
                             ((void *)0) 
# 25 "/acl/lib_acl/src/db/acl_dbsql.c"
...
# 28 "/acl/lib_acl/src/db/acl_dbsql.c" 3 4
                          ((void *)0)
# 28 "/acl/lib_acl/src/db/acl_dbsql.c"
                              )
...
void acl_dbsql_free_result(ACL_DB_HANDLE *handle, ACL_SQL_RES *res)
{
 ...
 if (handle == 
# 38 "/acl/lib_acl/src/db/acl_dbsql.c" 3 4
              ((void *)0) 
# 38 "/acl/lib_acl/src/db/acl_dbsql.c"
                   || res == 
# 38 "/acl/lib_acl/src/db/acl_dbsql.c" 3 4
                             ((void *)0)
# 38 "/acl/lib_acl/src/db/acl_dbsql.c"
...
# 42 "/acl/lib_acl/src/db/acl_dbsql.c" 3 4
                           ((void *)0)
# 42 "/acl/lib_acl/src/db/acl_dbsql.c"
                               )
 ...
 int (*walk_fn)(const void** result_row, void *arg), void *arg)
{
 ...
 if (handle == 
# 55 "/acl/lib_acl/src/db/acl_dbsql.c" 3 4
              ((void *)0) 
# 55 "/acl/lib_acl/src/db/acl_dbsql.c"
                   || sql == 
# 55 "/acl/lib_acl/src/db/acl_dbsql.c" 3 4
                             ((void *)0) 
# 55 "/acl/lib_acl/src/db/acl_dbsql.c"
...
# 58 "/acl/lib_acl/src/db/acl_dbsql.c" 3 4
                           ((void *)0)
# 58 "/acl/lib_acl/src/db/acl_dbsql.c"
                               )
 ...
 int (*walk_fn)(const void** result_row, void *arg), void *arg)
{
 ...
 if (handle == 
# 76 "/acl/lib_acl/src/db/acl_dbsql.c" 3 4
              ((void *)0) 
# 76 "/acl/lib_acl/src/db/acl_dbsql.c"
                   || sql == 
# 76 "/acl/lib_acl/src/db/acl_dbsql.c" 3 4
                             ((void *)0) 
# 76 "/acl/lib_acl/src/db/acl_dbsql.c"
...
# 76 "/acl/lib_acl/src/db/acl_dbsql.c"
 ...
 if (handle->sql_results == 
# 79 "/acl/lib_acl/src/db/acl_dbsql.c" 3 4
                           ((void *)0)
# 79 "/acl/lib_acl/src/db/acl_dbsql.c"
                               )
...
int acl_dbsql_update(ACL_DB_HANDLE *handle, const char *sql, int *error)
{
 ...
 if (handle == 
# 94 "/acl/lib_acl/src/db/acl_dbsql.c" 3 4
              ((void *)0) 
# 94 "/acl/lib_acl/src/db/acl_dbsql.c"
                   || sql == 
# 94 "/acl/lib_acl/src/db/acl_dbsql.c" 3 4
                             ((void *)0) 
# 94 "/acl/lib_acl/src/db/acl_dbsql.c"
...
# 97 "/acl/lib_acl/src/db/acl_dbsql.c" 3 4
                          ((void *)0)
# 97 "/acl/lib_acl/src/db/acl_dbsql.c"
                              )
