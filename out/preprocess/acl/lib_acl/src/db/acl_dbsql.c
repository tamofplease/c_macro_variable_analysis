# 1 "/workspace/acl/lib_acl/src/db/acl_dbsql.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/db/acl_dbsql.c" 2
# 21 "/workspace/acl/lib_acl/src/db/acl_dbsql.c"
ACL_SQL_RES *acl_dbsql_select(ACL_DB_HANDLE *handle, const char *sql, int *error)
{
 const char *myname = "acl_dbsql_select";

 if (handle == 
# 25 "/workspace/acl/lib_acl/src/db/acl_dbsql.c" 3 4
              ((void *)0) 
# 25 "/workspace/acl/lib_acl/src/db/acl_dbsql.c"
                   || sql == 
# 25 "/workspace/acl/lib_acl/src/db/acl_dbsql.c" 3 4
                             ((void *)0) 
# 25 "/workspace/acl/lib_acl/src/db/acl_dbsql.c"
                                  || *sql == 0)
  acl_msg_fatal("%s(%d): input invalid", myname, 26);

 if (handle->sql_select == 
# 28 "/workspace/acl/lib_acl/src/db/acl_dbsql.c" 3 4
                          ((void *)0)
# 28 "/workspace/acl/lib_acl/src/db/acl_dbsql.c"
                              )
  acl_msg_fatal("%s(%d): sql_select null", myname, 29);
...
void acl_dbsql_free_result(ACL_DB_HANDLE *handle, ACL_SQL_RES *res)
{
 ...
 if (handle == 
# 38 "/workspace/acl/lib_acl/src/db/acl_dbsql.c" 3 4
              ((void *)0) 
# 38 "/workspace/acl/lib_acl/src/db/acl_dbsql.c"
                   || res == 
# 38 "/workspace/acl/lib_acl/src/db/acl_dbsql.c" 3 4
                             ((void *)0)
# 38 "/workspace/acl/lib_acl/src/db/acl_dbsql.c"
                                 ) {
  acl_msg_error("%s(%d): input invalid", myname, 39);
  return;
 }
 if (handle->free_result == 
# 42 "/workspace/acl/lib_acl/src/db/acl_dbsql.c" 3 4
                           ((void *)0)
# 42 "/workspace/acl/lib_acl/src/db/acl_dbsql.c"
                               )
  acl_msg_fatal("%s(%d): free_result null", myname, 43);
 ...
 int (*walk_fn)(const void** result_row, void *arg), void *arg)
{
 ...
 if (handle == 
# 55 "/workspace/acl/lib_acl/src/db/acl_dbsql.c" 3 4
              ((void *)0) 
# 55 "/workspace/acl/lib_acl/src/db/acl_dbsql.c"
                   || sql == 
# 55 "/workspace/acl/lib_acl/src/db/acl_dbsql.c" 3 4
                             ((void *)0) 
# 55 "/workspace/acl/lib_acl/src/db/acl_dbsql.c"
...
# 55 "/workspace/acl/lib_acl/src/db/acl_dbsql.c"
  ...
  acl_msg_fatal("%s(%d): input invalid", myname, 56);

 if (handle->sql_results == 
# 58 "/workspace/acl/lib_acl/src/db/acl_dbsql.c" 3 4
                           ((void *)0)
# 58 "/workspace/acl/lib_acl/src/db/acl_dbsql.c"
                               )
  acl_msg_fatal("%s(%d): sql_results null", myname, 59);
 ...
 int (*walk_fn)(const void** result_row, void *arg), void *arg)
{
 ...
 if (handle == 
# 76 "/workspace/acl/lib_acl/src/db/acl_dbsql.c" 3 4
              ((void *)0) 
# 76 "/workspace/acl/lib_acl/src/db/acl_dbsql.c"
                   || sql == 
# 76 "/workspace/acl/lib_acl/src/db/acl_dbsql.c" 3 4
                             ((void *)0) 
# 76 "/workspace/acl/lib_acl/src/db/acl_dbsql.c"
...
# 76 "/workspace/acl/lib_acl/src/db/acl_dbsql.c"
  ...
  acl_msg_fatal("%s(%d): input invalid", myname, 77);

 if (handle->sql_results == 
# 79 "/workspace/acl/lib_acl/src/db/acl_dbsql.c" 3 4
                           ((void *)0)
# 79 "/workspace/acl/lib_acl/src/db/acl_dbsql.c"
                               )
  acl_msg_fatal("%s(%d): sql_result null", myname, 80);
...
int acl_dbsql_update(ACL_DB_HANDLE *handle, const char *sql, int *error)
{
 ...
 if (handle == 
# 94 "/workspace/acl/lib_acl/src/db/acl_dbsql.c" 3 4
              ((void *)0) 
# 94 "/workspace/acl/lib_acl/src/db/acl_dbsql.c"
                   || sql == 
# 94 "/workspace/acl/lib_acl/src/db/acl_dbsql.c" 3 4
                             ((void *)0) 
# 94 "/workspace/acl/lib_acl/src/db/acl_dbsql.c"
                                  || *sql == 0)
  acl_msg_fatal("%s(%d): input invalid", myname, 95);

 if (handle->sql_update == 
# 97 "/workspace/acl/lib_acl/src/db/acl_dbsql.c" 3 4
                          ((void *)0)
# 97 "/workspace/acl/lib_acl/src/db/acl_dbsql.c"
                              )
  acl_msg_fatal("%s(%d): sql_update null", myname, 98);
