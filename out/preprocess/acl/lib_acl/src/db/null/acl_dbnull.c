# 1 "/workspace/acl/lib_acl/src/db/null/acl_dbnull.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/db/null/acl_dbnull.c" 2
# 20 "/workspace/acl/lib_acl/src/db/null/acl_dbnull.c"
...
# 21 "/workspace/acl/lib_acl/src/db/null/acl_dbnull.c" 2

int acl_dbnull_results(ACL_DB_HANDLE *handle __attribute__ ((__unused__)),
 const char *sql __attribute__ ((__unused__)), int *error __attribute__ ((__unused__)),
 int (*walk_fn)(const void** my_row, void *arg) __attribute__ ((__unused__)),
 void *arg __attribute__ ((__unused__)))
{
 const char *myname = "acl_dbnull_results";

 acl_msg_fatal("%s, %s(%d): not supported!", "/workspace/acl/lib_acl/src/db/null/acl_dbnull.c", myname, 29);
 return (-1);
}

int acl_dbnull_result(ACL_DB_HANDLE *handle __attribute__ ((__unused__)),
 const char *sql __attribute__ ((__unused__)), int *error __attribute__ ((__unused__)),
 int (*callback)(const void** my_row, void *arg) __attribute__ ((__unused__)),
 void *arg __attribute__ ((__unused__)))
{
 const char *myname = "acl_dbnull_result";

 acl_msg_fatal("%s, %s(%d): not supported!", "/workspace/acl/lib_acl/src/db/null/acl_dbnull.c", myname, 40);
 return (-1);
}

int acl_dbnull_update(ACL_DB_HANDLE *handle __attribute__ ((__unused__)),
 const char *sql __attribute__ ((__unused__)), int *error __attribute__ ((__unused__)))
{
 const char *myname = "acl_dbnull_update";

 acl_msg_fatal("%s, %s(%d): not supported!", "/workspace/acl/lib_acl/src/db/null/acl_dbnull.c", myname, 49);
 return (-1);
}
