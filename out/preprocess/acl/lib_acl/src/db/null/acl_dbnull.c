# 0 "/acl/lib_acl/src/db/null/acl_dbnull.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/db/null/acl_dbnull.c"
...
# 2 "/acl/lib_acl/src/db/null/acl_dbnull.c" 2
# 20 "/acl/lib_acl/src/db/null/acl_dbnull.c"
...
# 21 "/acl/lib_acl/src/db/null/acl_dbnull.c" 2
 ...
 void *arg __attribute__ ((__unused__)))
{
 ...
 acl_msg_fatal("%s, %s(%d): not supported!", "/acl/lib_acl/src/db/null/acl_dbnull.c", myname, 29);
 return (-1);
}
 ...
 void *arg __attribute__ ((__unused__)))
{
 ...
 acl_msg_fatal("%s, %s(%d): not supported!", "/acl/lib_acl/src/db/null/acl_dbnull.c", myname, 40);
 return (-1);
}
 ...
 const char *sql __attribute__ ((__unused__)), int *error __attribute__ ((__unused__)))
{
 ...
 acl_msg_fatal("%s, %s(%d): not supported!", "/acl/lib_acl/src/db/null/acl_dbnull.c", myname, 49);
 return (-1);
}
