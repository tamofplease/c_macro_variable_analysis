# 0 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
...
# 2 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 2
# 22 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
# 1 "/acl/lib_acl/src/db/null/acl_dbnull.h" 1



# 1 "/acl/lib_acl/include/db/acl_dbpool.h" 1
# 5 "/acl/lib_acl/src/db/null/acl_dbnull.h" 2
...
# 23 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 2
# 1 "/acl/lib_acl/src/db/null/acl_dbpool_null.h" 1
# 18 "/acl/lib_acl/src/db/null/acl_dbpool_null.h"
extern ACL_DB_POOL *acl_dbpool_null_create(const ACL_DB_INFO *db_info);
# 24 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 2
...
static ACL_DB_HANDLE_NULL *__new_null_handle(void)
{
 ...
 handle = (ACL_DB_HANDLE_NULL *)
  acl_calloc_glue("/acl/lib_acl/src/db/null/acl_dbpool_null.c", 47, 1, sizeof(ACL_DB_HANDLE_NULL));
     ...
     ACL_DB_INFO *db_info)
{
 ...
 if (handle == 
# 62 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
              ((void *)0)
# 62 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                  )
...
# 70 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
                          ((void *)0)
# 70 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                              ) {
  char ebuf[256];
  acl_msg_error("%s, %s(%d): connect addr(%s) error(%s)",
   "/acl/lib_acl/src/db/null/acl_dbpool_null.c", myname, 73, db_info->db_addr,
   acl_last_strerror(ebuf, sizeof(ebuf)));
  if (!reuse_flag)
   do { if (handle) { acl_free_glue("/acl/lib_acl/src/db/null/acl_dbpool_null.c", 76, (handle)); (handle) = 
# 76 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
  ((void *)0)
# 76 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
  ; } } while (0);
  return (
# 77 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
         ((void *)0)
# 77 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
             );
 }

 handle->handle.status = 1;
 handle->handle.timeout = time(
# 81 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
                              ((void *)0)
# 81 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                                  ) + db_info->timeout_inter;
 handle->handle.ping = time(
# 82 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
                              ((void *)0)
# 82 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                                  ) + db_info->ping_inter;
...
{
 if (handle->connection == 
# 90 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
                          ((void *)0)
# 90 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                              )
  return;
 acl_vstream_close(handle->connection);
 handle->connection = 
# 93 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
                     ((void *)0)
# 93 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                         ;
...
static void __dbpool_check(ACL_DB_POOL *db_pool)
{
 ...
 int i, n, ping_inter;
 time_t now = time(
# 115 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
                  ((void *)0)
# 115 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                      );
 ...
 for (i = 0; i < n; i++) {
  ...
  if (handle == 
# 123 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
               ((void *)0)
# 123 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                   )
   continue;
...
# 135 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
                               ((void *)0)
# 135 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                                   )
   continue;
  ...
  if (pool->db_pool.dbh_ping((ACL_DB_HANDLE*) handle) == 0) {
   handle->handle.ping = time(
# 143 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
                             ((void *)0)
# 143 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                                 ) + ping_inter;
  } else {
   __close_handle(handle);
   pool->db_pool.db_ready--;
...
# 156 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
                                           ((void *)0)
# 156 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                                               ;
 int i, n;
 time_t now;
 static time_t last_time;
# 175 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
 { pthread_mutex_lock(&null_pool->mutex); };

 if (time(
# 177 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
         ((void *)0)
# 177 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
...
# 182 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
                              ((void *)0)
# 182 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                                  ) + inter;
 }

 if (db_pool->db_inuse >= db_pool->db_max) {
  acl_msg_warn("%s, %s(%d): all connections be used, reached db_max(%d)",
   "/acl/lib_acl/src/db/null/acl_dbpool_null.c", myname, 187, db_pool->db_max);
  do { now = time(
# 188 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
 ((void *)0)
# 188 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
...
# 188 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
 ...
 for (i = 0; i < n; i++) {
  ...
  if (handle == 
# 198 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
               ((void *)0)
# 198 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                   )
   continue;
  ...
  if (handle->handle.status == 1) {
   ...
   do { now = time(
# 206 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
  ((void *)0)
# 206 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
      ...
      && handle_slot == 
# 208 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
                       ((void *)0)
# 208 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                           )
   handle_slot = handle;
 }
 ...
 if (handle == 
# 215 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
              ((void *)0)
# 215 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                  )
  do { now = time(
# 216 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
 ((void *)0)
# 216 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
 ); if (acl_msg_verbose && now - last_time > 5) { acl_msg_info("Database status: max = %d, idle = %d, busy = %d", db_pool->db_max, db_pool->db_ready, db_pool->db_inuse); last_time = now; } { pthread_mutex_unlock(&null_pool->mutex); }; return (
# 216 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
 ((void *)0)
# 216 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
 ...
 if (handle_slot == 
# 218 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
                   ((void *)0)
# 218 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                       ) {
  if (acl_array_append(null_pool->handles, (void *) handle) < 0) {
   char tbuf[256];
   acl_msg_fatal("%s, %s(%d): append to handles error(%s)",
    "/acl/lib_acl/src/db/null/acl_dbpool_null.c", myname, 222,
 ...
 do { now = time(
# 230 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
((void *)0)
# 230 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
); if (acl_msg_verbose && now - last_time > 5) { acl_msg_info("Database status: max = %d, idle = %d, busy = %d", db_pool->db_max, db_pool->db_ready, db_pool->db_inuse); last_time = now; } { pthread_mutex_unlock(&null_pool->mutex); }; return ((ACL_DB_HANDLE *) handle); } while (0);
...
# 246 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
                                                                       ((void *)0)
# 246 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                                                                           ) {
  acl_msg_error("%s, %s(%d): status %s ACL_DBH_STATUS_INUSE, connection %s",
   "/acl/lib_acl/src/db/null/acl_dbpool_null.c", myname, 248,
   db_handle->status == 2 ? "=" : "!=",
 ...
 if (db_pool == 
# 258 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
               ((void *)0)
# 258 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                   )
  acl_msg_fatal("%s, %s(%d): db_handle's parent is null",
   "/acl/lib_acl/src/db/null/acl_dbpool_null.c", myname, 260);
...
# 266 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
                          ((void *)0)
# 266 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                              ) + timeout_inter;
 db_handle->ping = time(
# 267 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
                          ((void *)0)
# 267 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                              ) + ping_inter;
...
static void __dbpool_close(ACL_DB_HANDLE *db_handle)
{
 ...
 if (db_handle->status != 2 || handle->connection == 
# 289 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
                                                                       ((void *)0)
# 289 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                                                                           ) {
  acl_msg_error("%s, %s(%d): status %s ACL_DBH_STATUS_INUSE, connection %s",
   "/acl/lib_acl/src/db/null/acl_dbpool_null.c", myname, 291,
   db_handle->status == 2 ? "=" : "!=",
   handle->connection ? "not null" : "null");
  return;
 }
 ...
 db_pool = db_handle->parent;
 if (db_pool == 
# 298 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
               ((void *)0)
# 298 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                   )
  acl_msg_fatal("%s, %s(%d): db_handle's parent is null",
   "/acl/lib_acl/src/db/null/acl_dbpool_null.c", myname, 300);
 null_pool = (ACL_DB_POOL_NULL *) db_pool;
...
static void __dbpool_destroy(ACL_DB_POOL *db_pool)
{
 ...
 for (i = 0; i < n; i++) {
  handle = (ACL_DB_HANDLE_NULL *)
   acl_array_index(null_pool->handles, i);
  if (handle == 
# 323 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
               ((void *)0)
# 323 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                   )
   continue;
  __close_handle(handle);
  do { if (handle) { acl_free_glue("/acl/lib_acl/src/db/null/acl_dbpool_null.c", 326, (handle)); (handle) = 
# 326 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
 ((void *)0)
# 326 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
 ; } } while (0);
 }
 pthread_mutex_destroy(&null_pool->mutex);
 do { if (null_pool) { acl_free_glue("/acl/lib_acl/src/db/null/acl_dbpool_null.c", 329, (null_pool)); (null_pool) = 
# 329 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
((void *)0)
# 329 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
; } } while (0);
}
...
ACL_DB_POOL *acl_dbpool_null_create(const ACL_DB_INFO *db_info)
{
 ...
 null_pool = (ACL_DB_POOL_NULL *) acl_calloc_glue("/acl/lib_acl/src/db/null/acl_dbpool_null.c", 337, 1, sizeof(ACL_DB_POOL_NULL));
 if (null_pool == 
# 338 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
                 ((void *)0)
# 338 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                     ) {
  char tbuf[256];
  acl_msg_fatal("%s, %s(%d): calloc error=%s",
   "/acl/lib_acl/src/db/null/acl_dbpool_null.c", myname, 341, acl_last_strerror(tbuf, sizeof(tbuf)));
 }
...
# 354 "/acl/lib_acl/src/db/null/acl_dbpool_null.c" 3 4
                                          ((void *)0)
# 354 "/acl/lib_acl/src/db/null/acl_dbpool_null.c"
                                              );
