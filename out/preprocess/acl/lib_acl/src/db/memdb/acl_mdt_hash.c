# 0 "/acl/lib_acl/src/db/memdb/acl_mdt_hash.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/db/memdb/acl_mdt_hash.c"
...
# 2 "/acl/lib_acl/src/db/memdb/acl_mdt_hash.c" 2
# 19 "/acl/lib_acl/src/db/memdb/acl_mdt_hash.c"
...
# 20 "/acl/lib_acl/src/db/memdb/acl_mdt_hash.c" 2
...
# 21 "/acl/lib_acl/src/db/memdb/acl_mdt_hash.c" 2
 ...
 const char *name, unsigned int flag)
{
 ...
 if (init_capacity < 128)
  init_capacity = 128;
 idx = (ACL_MDT_IDX_HASH*) acl_calloc_glue("/acl/lib_acl/src/db/memdb/acl_mdt_hash.c", 33, 1, sizeof(ACL_MDT_IDX_HASH));

 if ((flag & (1 << 1)))
  flag2 |= (1 << 0);

 idx->table = acl_htable_create((int) init_capacity, flag2);
 idx->idx.name = acl_strdup_glue("/acl/lib_acl/src/db/memdb/acl_mdt_hash.c", 39, (name));
 idx->idx.flag = flag;
...
# 48 "/acl/lib_acl/src/db/memdb/acl_mdt_hash.c" 3 4
                                 ((void *)0)
# 48 "/acl/lib_acl/src/db/memdb/acl_mdt_hash.c"
                                     );
 do { if (idx->name) { acl_free_glue("/acl/lib_acl/src/db/memdb/acl_mdt_hash.c", 49, (idx->name)); (idx->name) = 
# 49 "/acl/lib_acl/src/db/memdb/acl_mdt_hash.c" 3 4
((void *)0)
# 49 "/acl/lib_acl/src/db/memdb/acl_mdt_hash.c"
; } } while (0);
 do { if (idx_hash) { acl_free_glue("/acl/lib_acl/src/db/memdb/acl_mdt_hash.c", 50, (idx_hash)); (idx_hash) = 
# 50 "/acl/lib_acl/src/db/memdb/acl_mdt_hash.c" 3 4
((void *)0)
# 50 "/acl/lib_acl/src/db/memdb/acl_mdt_hash.c"
; } } while (0);
}
# 60 "/acl/lib_acl/src/db/memdb/acl_mdt_hash.c"
static void mdt_idx_add(ACL_MDT_IDX *idx, const char *key, ACL_MDT_REC *rec)
{
 ...
 if (info == 
# 67 "/acl/lib_acl/src/db/memdb/acl_mdt_hash.c" 3 4
            ((void *)0)
# 67 "/acl/lib_acl/src/db/memdb/acl_mdt_hash.c"
                )
...
# 102 "/acl/lib_acl/src/db/memdb/acl_mdt_hash.c" 3 4
                                        ((void *)0)
# 102 "/acl/lib_acl/src/db/memdb/acl_mdt_hash.c"
                                            );
}
...
static void mdt_hash_free(ACL_MDT *mdt)
{
 ...
 do { if (mdt_hash) { acl_free_glue("/acl/lib_acl/src/db/memdb/acl_mdt_hash.c", 112, (mdt_hash)); (mdt_hash) = 
# 112 "/acl/lib_acl/src/db/memdb/acl_mdt_hash.c" 3 4
((void *)0)
# 112 "/acl/lib_acl/src/db/memdb/acl_mdt_hash.c"
; } } while (0);
}
...
ACL_MDT *acl_mdt_hash_create()
{
 ...
 mdt = (ACL_MDT_HASH *) acl_calloc_glue("/acl/lib_acl/src/db/memdb/acl_mdt_hash.c", 119, 1, sizeof(ACL_MDT_HASH));
