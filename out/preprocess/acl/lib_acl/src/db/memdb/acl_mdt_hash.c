# 1 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c" 2
# 19 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c"
...
# 20 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c" 2
...
# 21 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c" 2




static ACL_MDT_IDX *mdt_idx_create(ACL_MDT *mdt __attribute__ ((__unused__)), size_t init_capacity,
 const char *name, unsigned int flag)
{
 ...
 if (init_capacity < 128)
  init_capacity = 128;
 idx = (ACL_MDT_IDX_HASH*) acl_calloc_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c", 33, 1, sizeof(ACL_MDT_IDX_HASH));

 if ((flag & (1 << 1)))
  flag2 |= (1 << 0);

 idx->table = acl_htable_create((int) init_capacity, flag2);
 idx->idx.name = acl_strdup_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c", 39, (name));
 idx->idx.flag = flag;
...
static void mdt_idx_free(ACL_MDT_IDX *idx)
{
 ...
 acl_htable_free(idx_hash->table, 
# 48 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c" 3 4
                                 ((void *)0)
# 48 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c"
                                     );
 do { if (idx->name) { acl_free_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c", 49, (idx->name)); (idx->name) = 
# 49 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c" 3 4
((void *)0)
# 49 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c"
; } } while (0);
 do { if (idx_hash) { acl_free_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c", 50, (idx_hash)); (idx_hash) = 
# 50 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c" 3 4
((void *)0)
# 50 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c"
; } } while (0);
}
# 60 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c"
static void mdt_idx_add(ACL_MDT_IDX *idx, const char *key, ACL_MDT_REC *rec)
{
 ...
 if (info == 
# 67 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c" 3 4
            ((void *)0)
# 67 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c"
                )
...
static void mdt_idx_del(ACL_MDT_IDX *idx, const char *key)
{
 ...
 acl_htable_delete(idx_hash->table, key, 
# 102 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c" 3 4
                                        ((void *)0)
# 102 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c"
                                            );
}
...
static void mdt_hash_free(ACL_MDT *mdt)
{
 ...
 do { if (mdt_hash) { acl_free_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c", 112, (mdt_hash)); (mdt_hash) = 
# 112 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c" 3 4
((void *)0)
# 112 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c"
; } } while (0);
}
...
ACL_MDT *acl_mdt_hash_create()
{
 ...
 mdt = (ACL_MDT_HASH *) acl_calloc_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt_hash.c", 119, 1, sizeof(ACL_MDT_HASH));
