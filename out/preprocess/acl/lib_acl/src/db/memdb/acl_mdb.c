# 0 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
...
# 2 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 2
# 22 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
...
# 23 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 2
...
# 24 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 2
...
ACL_MDB *acl_mdb_create(const char *dbname, const char *dbtype)
{
 ...
 if (dbname == 
# 30 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
              ((void *)0) 
# 30 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
                   || *dbname == 0) {
  acl_msg_error("%s(%d): dbname invalid", myname, 31);
  return (
# 32 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 32 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }
 if (dbtype == 
# 34 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
              ((void *)0) 
# 34 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
                   || *dbtype == 0) {
  acl_msg_error("%s(%d): dbtype invalid", myname, 35);
  return (
# 36 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 36 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }

 mdb = acl_calloc_glue("/acl/lib_acl/src/db/memdb/acl_mdb.c", 39, 1, sizeof(ACL_MDB));
...
void acl_mdb_free(ACL_MDB *mdb)
{
 ...
 do { if (mdb) { acl_free_glue("/acl/lib_acl/src/db/memdb/acl_mdb.c", 55, (mdb)); (mdb) = 
# 55 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
((void *)0)
# 55 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
; } } while (0);
}
 ...
 const char *key_labels[], unsigned int flags[])
{
 ...
 if (mdb == 
# 65 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0) 
# 65 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
                || tbl_name == 
# 65 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                               ((void *)0) 
# 65 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
  ...
  return (
# 67 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 67 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }
...
# 76 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                                                           ((void *)0)
# 76 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
                                                               )
 ...
 const char *key_labels[], const char *keys[])
{
 ...
 if (tbl_name == 
# 91 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                ((void *)0) 
# 91 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
                     || *tbl_name == 0) {
  acl_msg_error("%s(%d): tbl_name invalid", myname, 92);
  return (
# 93 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 93 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }
 if (data == 
# 95 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
            ((void *)0)
# 95 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
                ) {
  acl_msg_error("%s(%d): data invalid", myname, 96);
  return (
# 97 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 97 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }
 ...
 if (mdt == 
# 102 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0)
# 102 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
               ) {
  acl_msg_error("%s(%d): table no exist, tbl_name(%s)",
   myname, 104, tbl_name);
  return (
# 105 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 105 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }
 ...
 const char *key_label, const char *key)
{
 ...
 if (tbl_name == 
# 119 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                ((void *)0) 
# 119 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
                     || *tbl_name == 0) {
  acl_msg_error("%s(%d): tbl_name invalid", myname, 120);
  return (0);
 }
 if (key_label == 
# 123 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                 ((void *)0) 
# 123 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
                      || *key_label == 0) {
  acl_msg_error("%s(%d): key_label invalid", myname, 124);
  return (0);
 }
 if (key == 
# 127 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0) 
# 127 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
                || *key == 0) {
 ...
 mdt = (ACL_MDT *) acl_htable_find(mdb->tbls, tbl_name);
 if (mdt == 
# 133 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0)
# 133 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
               ) {
  acl_msg_error("%s(%d): table no exist, tbl_name(%s)",
   myname, 135, tbl_name);
  return (0);
 ...
 const char *key_label, const char *key, int from, int limit)
{
 ...
 if (tbl_name == 
# 148 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                ((void *)0) 
# 148 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
                     || *tbl_name == 0) {
  acl_msg_error("%s(%d): tbl_name invalid", myname, 149);
  return (
# 150 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 150 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }
 if (key_label == 
# 152 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                 ((void *)0) 
# 152 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
                      || *key_label == 0) {
  acl_msg_error("%s(%d): key_label invalid", myname, 153);
  return (
# 154 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 154 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }
 if (key == 
# 156 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0) 
# 156 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
                || *key == 0) {
  acl_msg_error("%s(%d): key invalid", myname, 157);
  return (
# 158 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 158 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }

 mdt = (ACL_MDT *) acl_htable_find(mdb->tbls, tbl_name);
 if (mdt == 
# 162 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0)
# 162 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
               ) {
  acl_msg_error("%s(%d): table no exist, tbl_name(%s)",
   myname, 164, tbl_name);
  return (
# 165 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 165 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }
...
ACL_MDT_RES *acl_mdb_list(ACL_MDB *mdb, const char *tbl_name, int from, int limit)
{
 ...
 if (tbl_name == 
# 176 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                ((void *)0) 
# 176 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
                     || *tbl_name == 0) {
  acl_msg_error("%s(%d): tbl_name invalid", myname, 177);
  return (
# 178 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 178 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }

 mdt = (ACL_MDT *) acl_htable_find(mdb->tbls, tbl_name);
 if (mdt == 
# 182 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0)
# 182 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
               ) {
  acl_msg_error("%s(%d): table no exist, tbl_name(%s)",
   myname, 184, tbl_name);
  return (
# 185 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 185 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }
 ...
 void (*onfree_fn)(void*, unsigned int))
{
 ...
 if (tbl_name == 
# 198 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                ((void *)0) 
# 198 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
                     || *tbl_name == 0) {
  acl_msg_error("%s(%d): tbl_name invalid", myname, 199);
  return (-1);
 }
 if (key_label == 
# 202 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                 ((void *)0) 
# 202 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
                      || *key_label == 0) {
  acl_msg_error("%s(%d): key_label invalid", myname, 203);
  return (-1);
 }
 if (key == 
# 206 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0) 
# 206 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
                || *key == 0) {
 ...
 mdt = (ACL_MDT *) acl_htable_find(mdb->tbls, tbl_name);
 if (mdt == 
# 212 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0)
# 212 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
               ) {
  acl_msg_error("%s(%d): table no exist, tbl_name(%s)",
   myname, 214, tbl_name);
  return (-1);
 ...
 int (*walk_fn)(const void*, unsigned int), int from, int limit)
{
 ...
 if (tbl_name == 
# 227 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                ((void *)0) 
# 227 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
                     || *tbl_name == 0) {
 ...
 mdt = (ACL_MDT *) acl_htable_find(mdb->tbls, tbl_name);
 if (mdt == 
# 233 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0)
# 233 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
               ) {
  acl_msg_error("%s(%d): table no exist, tbl_name(%s)",
   myname, 235, tbl_name);
  return (-1);
...
int acl_mdb_cnt(ACL_MDB *mdb, const char *tbl_name)
{
 ...
 if (tbl_name == 
# 247 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                ((void *)0) 
# 247 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
                     || *tbl_name == 0) {
 ...
 mdt = (ACL_MDT *) acl_htable_find(mdb->tbls, tbl_name);
 if (mdt == 
# 253 "/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0)
# 253 "/acl/lib_acl/src/db/memdb/acl_mdb.c"
               ) {
  acl_msg_error("%s(%d): table no exist, tbl_name(%s)",
   myname, 255, tbl_name);
  return (-1);
