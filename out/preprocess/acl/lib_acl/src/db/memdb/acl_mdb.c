# 1 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 2
# 22 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
...
# 23 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 2
...
# 24 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 2
...
ACL_MDB *acl_mdb_create(const char *dbname, const char *dbtype)
{
 ...
 if (dbname == 
# 30 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
              ((void *)0) 
# 30 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
                   || *dbname == 0) {
  acl_msg_error("%s(%d): dbname invalid", myname, 31);
  return (
# 32 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 32 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }
 if (dbtype == 
# 34 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
              ((void *)0) 
# 34 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
                   || *dbtype == 0) {
  acl_msg_error("%s(%d): dbtype invalid", myname, 35);
  return (
# 36 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 36 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }

 mdb = acl_calloc_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c", 39, 1, sizeof(ACL_MDB));
 do { if (sizeof(mdb->name) > 0) { size_t _n = strlen(dbname); _n = _n > (size_t ) sizeof(mdb->name) - 1? (size_t) sizeof(mdb->name) - 1 : _n; memcpy(mdb->name, dbname, _n); mdb->name[_n] = 0; } } while (0);
 do { if (sizeof(mdb->type) > 0) { size_t _n = strlen(dbtype); _n = _n > (size_t ) sizeof(mdb->type) - 1? (size_t) sizeof(mdb->type) - 1 : _n; memcpy(mdb->type, dbtype, _n); mdb->type[_n] = 0; } } while (0);
...
void acl_mdb_free(ACL_MDB *mdb)
{
 ...
 do { if (mdb) { acl_free_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c", 55, (mdb)); (mdb) = 
# 55 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
((void *)0)
# 55 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
; } } while (0);
}
 ...
 const char *key_labels[], unsigned int flags[])
{
 ...
 if (mdb == 
# 65 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0) 
# 65 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
                || tbl_name == 
# 65 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                               ((void *)0) 
# 65 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
                                    || *tbl_name == 0) {
  acl_msg_error("%s(%d): input invalid", myname, 66);
  return (
# 67 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 67 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }
 ...
 if (acl_htable_enter(mdb->tbls, tbl_name, (char *) mdt) == 
# 76 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                                                           ((void *)0)
# 76 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
                                                               )
 ...
 const char *key_labels[], const char *keys[])
{
 ...
 if (tbl_name == 
# 91 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                ((void *)0) 
# 91 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
                     || *tbl_name == 0) {
  acl_msg_error("%s(%d): tbl_name invalid", myname, 92);
  return (
# 93 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 93 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }
 if (data == 
# 95 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
            ((void *)0)
# 95 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
                ) {
  acl_msg_error("%s(%d): data invalid", myname, 96);
  return (
# 97 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 97 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }
 ...
 if (mdt == 
# 102 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0)
# 102 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
               ) {
  acl_msg_error("%s(%d): table no exist, tbl_name(%s)",
   myname, 104, tbl_name);
  return (
# 105 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 105 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }
 ...
 const char *key_label, const char *key)
{
 ...
 if (tbl_name == 
# 119 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                ((void *)0) 
# 119 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
                     || *tbl_name == 0) {
  acl_msg_error("%s(%d): tbl_name invalid", myname, 120);
  return (0);
 }
 if (key_label == 
# 123 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                 ((void *)0) 
# 123 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
                      || *key_label == 0) {
  acl_msg_error("%s(%d): key_label invalid", myname, 124);
  return (0);
 }
 if (key == 
# 127 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0) 
# 127 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
                || *key == 0) {
  acl_msg_error("%s(%d): key invalid", myname, 128);
  return (0);
 }

 mdt = (ACL_MDT *) acl_htable_find(mdb->tbls, tbl_name);
 if (mdt == 
# 133 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0)
# 133 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
               ) {
  acl_msg_error("%s(%d): table no exist, tbl_name(%s)",
   myname, 135, tbl_name);
  return (0);
 ...
 const char *key_label, const char *key, int from, int limit)
{
 ...
 if (tbl_name == 
# 148 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                ((void *)0) 
# 148 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
                     || *tbl_name == 0) {
  acl_msg_error("%s(%d): tbl_name invalid", myname, 149);
  return (
# 150 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 150 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }
 if (key_label == 
# 152 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                 ((void *)0) 
# 152 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
                      || *key_label == 0) {
  acl_msg_error("%s(%d): key_label invalid", myname, 153);
  return (
# 154 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 154 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }
 if (key == 
# 156 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0) 
# 156 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
                || *key == 0) {
  acl_msg_error("%s(%d): key invalid", myname, 157);
  return (
# 158 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 158 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }

 mdt = (ACL_MDT *) acl_htable_find(mdb->tbls, tbl_name);
 if (mdt == 
# 162 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0)
# 162 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
               ) {
  acl_msg_error("%s(%d): table no exist, tbl_name(%s)",
   myname, 164, tbl_name);
  return (
# 165 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 165 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }
...
ACL_MDT_RES *acl_mdb_list(ACL_MDB *mdb, const char *tbl_name, int from, int limit)
{
 ...
 if (tbl_name == 
# 176 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                ((void *)0) 
# 176 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
                     || *tbl_name == 0) {
  acl_msg_error("%s(%d): tbl_name invalid", myname, 177);
  return (
# 178 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 178 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }

 mdt = (ACL_MDT *) acl_htable_find(mdb->tbls, tbl_name);
 if (mdt == 
# 182 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0)
# 182 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
               ) {
  acl_msg_error("%s(%d): table no exist, tbl_name(%s)",
   myname, 184, tbl_name);
  return (
# 185 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
         ((void *)0)
# 185 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
             );
 }
 ...
 void (*onfree_fn)(void*, unsigned int))
{
 ...
 if (tbl_name == 
# 198 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                ((void *)0) 
# 198 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
                     || *tbl_name == 0) {
  acl_msg_error("%s(%d): tbl_name invalid", myname, 199);
  return (-1);
 }
 if (key_label == 
# 202 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                 ((void *)0) 
# 202 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
                      || *key_label == 0) {
  acl_msg_error("%s(%d): key_label invalid", myname, 203);
  return (-1);
 }
 if (key == 
# 206 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0) 
# 206 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
                || *key == 0) {
  acl_msg_error("%s(%d): key invalid", myname, 207);
  return (-1);
 }

 mdt = (ACL_MDT *) acl_htable_find(mdb->tbls, tbl_name);
 if (mdt == 
# 212 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0)
# 212 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
               ) {
  acl_msg_error("%s(%d): table no exist, tbl_name(%s)",
   myname, 214, tbl_name);
  return (-1);
 ...
 int (*walk_fn)(const void*, unsigned int), int from, int limit)
{
 ...
 if (tbl_name == 
# 227 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                ((void *)0) 
# 227 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
                     || *tbl_name == 0) {
  acl_msg_error("%s(%d): tbl_name invalid", myname, 228);
  return (-1);
 }

 mdt = (ACL_MDT *) acl_htable_find(mdb->tbls, tbl_name);
 if (mdt == 
# 233 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0)
# 233 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
               ) {
  acl_msg_error("%s(%d): table no exist, tbl_name(%s)",
   myname, 235, tbl_name);
  return (-1);
...
int acl_mdb_cnt(ACL_MDB *mdb, const char *tbl_name)
{
 ...
 if (tbl_name == 
# 247 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
                ((void *)0) 
# 247 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
                     || *tbl_name == 0) {
  acl_msg_error("%s(%d): tbl_name invalid", myname, 248);
  return (-1);
 }

 mdt = (ACL_MDT *) acl_htable_find(mdb->tbls, tbl_name);
 if (mdt == 
# 253 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c" 3 4
           ((void *)0)
# 253 "/workspace/acl/lib_acl/src/db/memdb/acl_mdb.c"
               ) {
  acl_msg_error("%s(%d): table no exist, tbl_name(%s)",
   myname, 255, tbl_name);
  return (-1);
