# 1 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 2
# 21 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
# 1 "/workspace/acl/lib_acl/src/db/memdb/struct.h" 1
# 9 "/workspace/acl/lib_acl/src/db/memdb/struct.h"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_array.h" 1
# 10 "/workspace/acl/lib_acl/src/db/memdb/struct.h" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_htable.h" 1
# 11 "/workspace/acl/lib_acl/src/db/memdb/struct.h" 2
# 1 "/workspace/acl/lib_acl/include/db/acl_mdb.h" 1
# 12 "/workspace/acl/lib_acl/src/db/memdb/struct.h" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_avl.h" 1
# 13 "/workspace/acl/lib_acl/src/db/memdb/struct.h" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_slice.h" 1
# 14 "/workspace/acl/lib_acl/src/db/memdb/struct.h" 2

# 1 "/workspace/acl/lib_acl/include/stdlib/acl_binhash.h" 1
# 16 "/workspace/acl/lib_acl/src/db/memdb/struct.h" 2
# 1 "/workspace/acl/lib_acl/src/db/memdb/ring.h" 1
# 9 "/workspace/acl/lib_acl/src/db/memdb/ring.h"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/7/include/stddef.h" 1 3 4
# 10 "/workspace/acl/lib_acl/src/db/memdb/ring.h" 2
...
# 17 "/workspace/acl/lib_acl/src/db/memdb/struct.h" 2
...
struct ACL_MDT_NOD {
 ...
 RING ref_head;
 void *data;
# 38 "/workspace/acl/lib_acl/src/db/memdb/struct.h"
 unsigned int dlen:24;
 unsigned int nrefer:8;
};
...
# 22 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 2
# 1 "/workspace/acl/lib_acl/src/db/memdb/mdb_private.h" 1
...
# 23 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 2
...
static ACL_MDT_IDX *mdt_idx(const ACL_MDT *mdt, const char *key_label)
{
 ...
 for (iter = ((&mdt->idx_head)->succ); iter != (&mdt->idx_head); iter = ((iter)->succ)) {
  idx = ((ACL_MDT_IDX *) (((char *) (iter)) - 
# 35 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
       __builtin_offsetof (
# 35 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
       ACL_MDT_IDX
# 35 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
       , 
# 35 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
# 35 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ...
 return (
# 40 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
        ((void *)0)
# 40 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
            );
}
 ...
 const char *key_labels[], unsigned int idx_flags[])
{
 ...
 while ((ptr = key_labels[i]) != 
# 52 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
                                ((void *)0)
# 52 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
                                    ) {
  idx = mdt->idx_create(mdt, init_capacity, ptr, idx_flags[i]);
  idx->mdt = mdt;
  do { RING *ring = &mdt->idx_head; RING *entry = &idx->mdt_entry; entry->pred = ring->pred; entry->succ = ring; ring->pred->succ = entry; ring->pred = entry; } while (0);
  i++;
 }
}
...
static void mdt_idx_free(ACL_MDT *mdt)
{
 ...
 for (iter = ((&mdt->idx_head)->succ); iter != &mdt->idx_head;) {
  iter_tmp = ((iter)->succ);
  idx = ((ACL_MDT_IDX *) (((char *) (iter)) - 
# 69 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
       __builtin_offsetof (
# 69 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
       ACL_MDT_IDX
# 69 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
       , 
# 69 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ...
 void (*onfree_fn)(void*, unsigned int))
{
 ...
 do { RING *entry = &node->mdt_entry; RING *succ; RING *pred; succ = entry->succ; pred = entry->pred; if (succ != 
# 87 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
((void *)0) 
# 87 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
&& pred != 
# 87 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
((void *)0)
# 87 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
) { pred->succ = succ; succ->pred = pred; entry->succ = entry->pred = 0; } } while (0);
 if ((mdt->tbl_flag & (1 << 2)) == 0 && node->data)
  do { if (node->data) { acl_free_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c", 89, (node->data)); (node->data) = 
# 89 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
 ((void *)0)
# 89 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ; } } while (0);
 if (mdt->nod_slice)
  acl_slice_free2(mdt->nod_slice, node);
 else
  do { if (node) { acl_free_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c", 93, (node)); (node) = 
# 93 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
 ((void *)0)
# 93 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ; } } while (0);
 mdt->node_cnt--;
}
...
static ACL_MDT_NOD *mdt_node_new(ACL_MDT *mdt, void *data, unsigned int dlen)
{
 ...
 if (mdt->nod_slice)
  ...
  node = (ACL_MDT_NOD*) acl_malloc_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c", 110, sizeof(ACL_MDT_NOD));

 if ((mdt->tbl_flag & (1 << 2)) == 0) {
  pdata = acl_malloc_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c", 113, dlen);
 ...
 node->dlen = dlen;
 node->nrefer = 0;
 do { RING *ring = &node->ref_head; ring->pred = ring->succ = ring; } while (0);


 do { RING *ring = &mdt->nod_head; RING *entry = &node->mdt_entry; entry->pred = ring->pred; entry->succ = ring; ring->pred->succ = entry; ring->pred = entry; } while (0);
 mdt->node_cnt++;
 return (node);
}
...
static ACL_MDT_REC *mdt_rec_new(ACL_MDT *mdt)
{
 ...
 if (mdt->rec_slice)
  ...
  rec = (ACL_MDT_REC*) acl_calloc_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c", 139, 1, sizeof(ACL_MDT_REC));

 do { RING *ring = &rec->ref_head; ring->pred = ring->succ = ring; } while (0);
 rec->nrefer = 0;
...
static void mdt_rec_free(ACL_MDT *mdt, ACL_MDT_REC *rec)
{
 if (mdt->rec_slice)
  ...
  do { if (rec) { acl_free_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c", 156, (rec)); (rec) = 
# 156 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
 ((void *)0)
# 156 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ; } } while (0);
}
...
{
 do { RING *entry = &ref->nod_entry; RING *succ; RING *pred; succ = entry->succ; pred = entry->pred; if (succ != 
# 166 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
((void *)0) 
# 166 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
&& pred != 
# 166 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
((void *)0)
# 166 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
) { pred->succ = succ; succ->pred = pred; entry->succ = entry->pred = 0; } } while (0);
 do { RING *entry = &ref->rec_entry; RING *succ; RING *pred; succ = entry->succ; pred = entry->pred; if (succ != 
# 167 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
((void *)0) 
# 167 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
&& pred != 
# 167 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
((void *)0)
# 167 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ...
 if (mdt->ref_slice)
  ...
  do { if (ref) { acl_free_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c", 173, (ref)); (ref) = 
# 173 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
 ((void *)0)
# 173 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ; } } while (0);
}
...
static void mdt_ref_add(ACL_MDT *mdt, ACL_MDT_NOD *node, ACL_MDT_REC *rec)
{
 ...
 if (mdt->ref_slice)
  ...
  ref = (ACL_MDT_REF *) acl_calloc_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c", 189, 1, sizeof(ACL_MDT_REF));


 ref->node = node;
 node->nrefer++;

 do { RING *ring = &node->ref_head; RING *entry = &ref->nod_entry; entry->pred = ring->pred; entry->succ = ring; ring->pred->succ = entry; ring->pred = entry; } while (0);


 ref->rec = rec;
 rec->nrefer++;

 do { RING *ring = &rec->ref_head; RING *entry = &ref->rec_entry; entry->pred = ring->pred; entry->succ = ring; ring->pred->succ = entry; ring->pred = entry; } while (0);
}
# 213 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ...
 const char *key_labels[], const char *keys[])
{
 ...
 node = mdt_node_new(mdt, data, dlen);

 i = 0;
 while (key_labels[i] != 
# 227 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
                        ((void *)0) 
# 227 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
                             && keys[i] != 
# 227 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
                                           ((void *)0)
# 227 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
  ...
  if (idx == 
# 229 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
            ((void *)0)
# 229 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
                ) {
   acl_msg_error("%s(%d): key_label(%s) no exist in table(%s)",
    myname, 231, key_labels[i], mdt->name);
   return (
# 232 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
          ((void *)0)
# 232 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
              );
  }

  rec = mdt->idx_get(idx, keys[i]);
  if (rec == 
# 236 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
            ((void *)0)
# 236 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
                ) {
  ...
  } else if (idx->flag & (1 << 0)) {
   acl_msg_warn("%s(%d): duplex key, key_label(%s), key(%s)",
    myname, 245, key_labels[i], keys[i]);
   mdt_node_free(mdt, node, 
# 246 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
                           ((void *)0)
# 246 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
                               );
   return (
# 247 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
          ((void *)0)
# 247 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
              );
  }
...
# 264 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
static int mdt_probe(ACL_MDT *mdt, const char *key_label, const char *key)
{
 ...
 if (idx == 
# 271 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0)
# 271 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
               ) {
 ...
 if (rec == 
# 278 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0)
# 278 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
               )
  return (0);
 return (1);
}
# 292 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ...
 const char *key, int from, int limit)
{
 ...
 idx = mdt_idx(mdt, key_label);
 if (idx == 
# 305 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0)
# 305 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
               ) {
  acl_msg_warn("%s: key_lable(%s) no exist in %s",
   myname, key_label, mdt->name);
  return (
# 308 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
         ((void *)0)
# 308 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
             );
 }

 rec = mdt->idx_get(idx, key);
 if (rec == 
# 312 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0)
# 312 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
               )
  return (
# 313 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
         ((void *)0)
# 313 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
             );

 res = (ACL_MDT_RES*) acl_calloc_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c", 315, 1, sizeof(ACL_MDT_RES));
 res->a = acl_array_create(100);
 res->ipos = 0;

 i = 0;
 n = 0;
 for (ref_iter = ((&rec->ref_head)->succ); ref_iter != (&rec->ref_head); ref_iter = ((ref_iter)->succ)) {
  if (from >= 0 && i++ < from)
   continue;
  ref = ((ACL_MDT_REF *) (((char *) (ref_iter)) - 
# 324 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
       __builtin_offsetof (
# 324 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
       ACL_MDT_REF
# 324 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
       , 
# 324 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
# 324 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
  ...
  data = acl_malloc_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c", 325, ref->node->dlen);
  memcpy(data, ref->node->data, ref->node->dlen);
  if (acl_array_append(res->a, data) < 0)
   acl_msg_fatal("%s(%d): add array error(%s)",
    myname, 329, acl_last_serror());
  if (limit > 0 && ++n >= limit)
   break;
 }
 if (acl_array_size(res->a) == 0) {
  acl_array_free(res->a, 
# 334 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
                           ((void *)0)
# 334 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
                               );
  do { if (res) { acl_free_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c", 335, (res)); (res) = 
# 335 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
 ((void *)0)
# 335 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ; } } while (0);
  return (
# 336 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
         ((void *)0)
# 336 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
             );
 }
 return (res);
}
# 349 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ...
 const char *key, void (*onfree_fn)(void*, unsigned int))
{
 ...
 idx = mdt_idx(mdt, key_label);
 if (idx == 
# 361 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0)
# 361 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
               ) {
 ...
 rec = mdt->idx_get(idx, key);
 if (rec == 
# 369 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0)
# 369 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
               )
  return (0);


 for (iter = ((&rec->ref_head)->succ); iter && rec->nrefer > 0;) {

  ref = ((ACL_MDT_REF *) (((char *) (iter)) - 
# 375 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
       __builtin_offsetof (
# 375 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
       ACL_MDT_REF
# 375 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
       , 
# 375 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
# 375 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
  ...
  for (iter2 = ((&node->ref_head)->succ);
   iter2 != 
# 383 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0) 
# 383 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
                && node->nrefer > 0;) {

   ref2 = ((ACL_MDT_REF *) (((char *) (iter2)) - 
# 385 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
         __builtin_offsetof (
# 385 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
         ACL_MDT_REF
# 385 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
         , 
# 385 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
# 385 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
  ...
  if (node->nrefer != 0)
   acl_msg_fatal("%s(%d): node->nrefer(%d) != 0,"
    ...
    myname, 401, node->nrefer,
    mdt->name, key_label, key);
  mdt_node_free(mdt, node, onfree_fn);
...
# 428 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
static ACL_MDT_RES *mdt_list(ACL_MDT *mdt, int from, int limit)
{
 ...
 if (mdt == 
# 437 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0)
# 437 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
               )
  return (
# 438 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
         ((void *)0)
# 438 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
             );

 res = (ACL_MDT_RES*) acl_calloc_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c", 440, 1, sizeof(ACL_MDT_RES));
 res->a = acl_array_create(limit > 0 ? limit : 100);
 res->ipos = 0;

 for (nod_iter = ((&mdt->nod_head)->succ); nod_iter != (&mdt->nod_head); nod_iter = ((nod_iter)->succ)) {
  if (from >= 0 && i++ < from)
   continue;
  n++;
  node = ((ACL_MDT_NOD *) (((char *) (nod_iter)) - 
# 448 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
        __builtin_offsetof (
# 448 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
        ACL_MDT_NOD
# 448 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
        , 
# 448 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
# 448 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
  ...
  data = acl_malloc_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c", 449, node->dlen);
  memcpy(data, node->data, node->dlen);
  if (acl_array_append(res->a, data) < 0) {
   acl_msg_fatal("%s(%d): add array", myname, 452);
   break;
  }
  if (limit > 0 && n >= limit)
   break;
...
# 470 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ...
 int from, int limit)
{
 ...
 if (walk_fn == 
# 477 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
               ((void *)0) 
# 477 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
                    || mdt == 
# 477 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
                              ((void *)0)
# 477 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ...
 for (iter = ((&mdt->nod_head)->succ); iter != (&mdt->nod_head); iter = ((iter)->succ)) {
  if (from >= 0 && i++ < from)
   continue;
  node = ((ACL_MDT_NOD *) (((char *) (iter)) - 
# 483 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
        __builtin_offsetof (
# 483 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
        ACL_MDT_NOD
# 483 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
        , 
# 483 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
static void mdt_nodes_free(ACL_MDT *mdt)
{
 ...
 for (iter = ((&mdt->nod_head)->succ); iter != &mdt->nod_head; ) {
  tmp = ((iter)->succ);
  node = ((ACL_MDT_NOD *) (((char *) (iter)) - 
# 505 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
        __builtin_offsetof (
# 505 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
        ACL_MDT_NOD
# 505 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
        , 
# 505 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
# 505 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
  ...
  for (iter2 = ((&node->ref_head)->succ); iter2 != &node->ref_head;) {
   ref = ((ACL_MDT_REF *) (((char *) (iter2)) - 
# 507 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
        __builtin_offsetof (
# 507 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
        ACL_MDT_REF
# 507 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
        , 
# 507 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
# 507 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
  ...
  mdt_node_free(mdt, node, 
# 515 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
                          ((void *)0)
# 515 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
                              );
  iter = tmp;
 }
}
 ...
 const char *key_labels[], unsigned int idx_flags[])
{
 ...
 if (strcasecmp(dbtype, "hash") == 0) {
  ...
  acl_msg_error("%s(%d): dbtype(%s)", myname, 537, dbtype);
  return (
# 538 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
         ((void *)0)
# 538 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
             );
 }

 mdt->name = acl_strdup_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c", 541, (tbl_name));
 mdt->node_cnt = 0;
 mdt->tbl_flag = tbl_flag;

 do { RING *ring = &mdt->nod_head; ring->pred = ring->succ = ring; } while (0);
 do { RING *ring = &mdt->idx_head; ring->pred = ring->succ = ring; } while (0);
 ...
 if ((tbl_flag & (1 << 10))) {
  mdt->nod_slice = acl_slice_create("nod_slice", 0,
   sizeof(ACL_MDT_NOD), (1 << 0) | rtgc_flag);
  mdt->rec_slice = acl_slice_create("rec_slice", 0,
   sizeof(ACL_MDT_REC), (1 << 0) | rtgc_flag);
  mdt->ref_slice = acl_slice_create("ref_slice", 0,
   sizeof(ACL_MDT_REF), (1 << 0) | rtgc_flag);
 } else if ((tbl_flag & (1 << 11))) {
  mdt->nod_slice = acl_slice_create("nod_slice", 0,
   sizeof(ACL_MDT_NOD), (1 << 1) | rtgc_flag);
  mdt->rec_slice = acl_slice_create("rec_slice", 0,
   sizeof(ACL_MDT_REC), (1 << 1) | rtgc_flag);
  mdt->ref_slice = acl_slice_create("ref_slice", 0,
   sizeof(ACL_MDT_REF), (1 << 1) | rtgc_flag);
 } else if ((tbl_flag & (1 << 12))) {
  mdt->nod_slice = acl_slice_create("nod_slice", 0,
   sizeof(ACL_MDT_NOD), (1 << 2) | rtgc_flag);
  mdt->rec_slice = acl_slice_create("rec_slice", 0,
   sizeof(ACL_MDT_REC), (1 << 2) | rtgc_flag);
  mdt->ref_slice = acl_slice_create("ref_slice", 0,
   sizeof(ACL_MDT_REF), (1 << 2) | rtgc_flag);
 }
 return (mdt);
}
...
void acl_mdt_free(ACL_MDT *mdt)
{
 do { if (mdt->name) { acl_free_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c", 586, (mdt->name)); (mdt->name) = 
# 586 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
((void *)0)
# 586 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
; } } while (0);
 mdt_idx_free(mdt);
 mdt_nodes_free(mdt);
 if (mdt->nod_slice)
...
const void *acl_mdt_fetch_row(ACL_MDT_RES *res)
{
 ...
 if (res == 
# 638 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0) 
# 638 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
                || res->a == 
# 638 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
                             ((void *)0) 
# 638 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
                                  || res->ipos < 0) {
  acl_msg_error("%s(%d): input error", myname, 639);
  return (
# 640 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
         ((void *)0)
# 640 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
             );
 }
 ...
 if (res->ipos >= n)
  return (
# 645 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
         ((void *)0)
# 645 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
             );
...
{
 if (res == 
# 652 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0) 
# 652 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
                || res->a == 
# 652 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
                             ((void *)0) 
# 652 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
{
 if (res->a)
  acl_array_free(res->a, acl_free_fn_glue);
 do { if (res) { acl_free_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c", 661, (res)); (res) = 
# 661 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
((void *)0)
# 661 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
; } } while (0);
}
...
{
 if (mdt == 
# 666 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0)
# 666 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt.c"
               )
  return (0);
