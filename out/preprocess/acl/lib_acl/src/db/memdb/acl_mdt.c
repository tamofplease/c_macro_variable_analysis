# 0 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
# 2 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 2
# 21 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
# 1 "/acl/lib_acl/src/db/memdb/struct.h" 1
# 9 "/acl/lib_acl/src/db/memdb/struct.h"
# 1 "/acl/lib_acl/include/stdlib/acl_array.h" 1
# 10 "/acl/lib_acl/src/db/memdb/struct.h" 2
# 1 "/acl/lib_acl/include/stdlib/acl_htable.h" 1
# 11 "/acl/lib_acl/src/db/memdb/struct.h" 2
# 1 "/acl/lib_acl/include/db/acl_mdb.h" 1
# 12 "/acl/lib_acl/src/db/memdb/struct.h" 2
# 1 "/acl/lib_acl/include/stdlib/acl_avl.h" 1
# 13 "/acl/lib_acl/src/db/memdb/struct.h" 2
# 1 "/acl/lib_acl/include/stdlib/acl_slice.h" 1
# 14 "/acl/lib_acl/src/db/memdb/struct.h" 2

# 1 "/acl/lib_acl/include/stdlib/acl_binhash.h" 1
# 16 "/acl/lib_acl/src/db/memdb/struct.h" 2
# 1 "/acl/lib_acl/src/db/memdb/ring.h" 1
# 9 "/acl/lib_acl/src/db/memdb/ring.h"
# 1 "/usr/lib/gcc/aarch64-linux-gnu/11/include/stddef.h" 1 3 4
# 10 "/acl/lib_acl/src/db/memdb/ring.h" 2
...
# 17 "/acl/lib_acl/src/db/memdb/struct.h" 2
...
struct ACL_MDT_NOD {
 ...
 RING ref_head;
 void *data;
# 38 "/acl/lib_acl/src/db/memdb/struct.h"
...
# 22 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 2
# 1 "/acl/lib_acl/src/db/memdb/mdb_private.h" 1
...
# 23 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 2
...
# 35 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
       __builtin_offsetof (
# 35 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
       ACL_MDT_IDX
# 35 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
       , 
# 35 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
# 35 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ...
 return (
# 40 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
        ((void *)0)
# 40 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
            );
}
...
# 52 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
                                ((void *)0)
# 52 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
                                    ) {
...
static void mdt_idx_free(ACL_MDT *mdt)
{
 ...
 for (iter = ((&mdt->idx_head)->succ); iter != &mdt->idx_head;) {
  iter_tmp = ((iter)->succ);
  idx = ((ACL_MDT_IDX *) (((char *) (iter)) - 
# 69 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
       __builtin_offsetof (
# 69 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
       ACL_MDT_IDX
# 69 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
       , 
# 69 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
# 87 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
((void *)0) 
# 87 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
&& pred != 
# 87 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
((void *)0)
# 87 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ...
 if ((mdt->tbl_flag & (1 << 2)) == 0 && node->data)
  do { if (node->data) { acl_free_glue("/acl/lib_acl/src/db/memdb/acl_mdt.c", 89, (node->data)); (node->data) = 
# 89 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
 ((void *)0)
# 89 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ; } } while (0);
 if (mdt->nod_slice)
  acl_slice_free2(mdt->nod_slice, node);
 else
  do { if (node) { acl_free_glue("/acl/lib_acl/src/db/memdb/acl_mdt.c", 93, (node)); (node) = 
# 93 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
 ((void *)0)
# 93 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ; } } while (0);
 mdt->node_cnt--;
}
...
static ACL_MDT_NOD *mdt_node_new(ACL_MDT *mdt, void *data, unsigned int dlen)
{
 ...
 if (mdt->nod_slice)
  ...
  node = (ACL_MDT_NOD*) acl_malloc_glue("/acl/lib_acl/src/db/memdb/acl_mdt.c", 110, sizeof(ACL_MDT_NOD));

 if ((mdt->tbl_flag & (1 << 2)) == 0) {
  pdata = acl_malloc_glue("/acl/lib_acl/src/db/memdb/acl_mdt.c", 113, dlen);
...
static ACL_MDT_REC *mdt_rec_new(ACL_MDT *mdt)
{
 ...
 if (mdt->rec_slice)
  ...
  rec = (ACL_MDT_REC*) acl_calloc_glue("/acl/lib_acl/src/db/memdb/acl_mdt.c", 139, 1, sizeof(ACL_MDT_REC));
...
static void mdt_rec_free(ACL_MDT *mdt, ACL_MDT_REC *rec)
{
 if (mdt->rec_slice)
  ...
  do { if (rec) { acl_free_glue("/acl/lib_acl/src/db/memdb/acl_mdt.c", 156, (rec)); (rec) = 
# 156 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
 ((void *)0)
# 156 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ; } } while (0);
}
...
# 166 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
((void *)0) 
# 166 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
&& pred != 
# 166 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
((void *)0)
# 166 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
# 167 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
((void *)0) 
# 167 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
&& pred != 
# 167 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
((void *)0)
# 167 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ...
 if (mdt->ref_slice)
  ...
  do { if (ref) { acl_free_glue("/acl/lib_acl/src/db/memdb/acl_mdt.c", 173, (ref)); (ref) = 
# 173 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
 ((void *)0)
# 173 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ; } } while (0);
}
...
static void mdt_ref_add(ACL_MDT *mdt, ACL_MDT_NOD *node, ACL_MDT_REC *rec)
{
 ...
 if (mdt->ref_slice)
  ...
  ref = (ACL_MDT_REF *) acl_calloc_glue("/acl/lib_acl/src/db/memdb/acl_mdt.c", 189, 1, sizeof(ACL_MDT_REF));
...
# 213 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ...
 const char *key_labels[], const char *keys[])
{
 ...
 i = 0;
 while (key_labels[i] != 
# 227 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
                        ((void *)0) 
# 227 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
                             && keys[i] != 
# 227 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
                                           ((void *)0)
# 227 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
  ...
  if (idx == 
# 229 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
            ((void *)0)
# 229 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
                ) {
   acl_msg_error("%s(%d): key_label(%s) no exist in table(%s)",
    myname, 231, key_labels[i], mdt->name);
   return (
# 232 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
          ((void *)0)
# 232 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
              );
  }

  rec = mdt->idx_get(idx, keys[i]);
  if (rec == 
# 236 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
            ((void *)0)
# 236 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
                ) {
...
# 246 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
                           ((void *)0)
# 246 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
                               );
   return (
# 247 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
          ((void *)0)
# 247 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
              );
  }
...
# 264 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
static int mdt_probe(ACL_MDT *mdt, const char *key_label, const char *key)
{
 ...
 if (idx == 
# 271 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0)
# 271 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
               ) {
 ...
 if (rec == 
# 278 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0)
# 278 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
               )
  return (0);
 return (1);
}
# 292 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ...
 const char *key, int from, int limit)
{
 ...
 idx = mdt_idx(mdt, key_label);
 if (idx == 
# 305 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0)
# 305 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
               ) {
  acl_msg_warn("%s: key_lable(%s) no exist in %s",
   myname, key_label, mdt->name);
  return (
# 308 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
         ((void *)0)
# 308 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
             );
 }

 rec = mdt->idx_get(idx, key);
 if (rec == 
# 312 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0)
# 312 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
               )
  return (
# 313 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
         ((void *)0)
# 313 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
             );

 res = (ACL_MDT_RES*) acl_calloc_glue("/acl/lib_acl/src/db/memdb/acl_mdt.c", 315, 1, sizeof(ACL_MDT_RES));
...
# 324 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
       __builtin_offsetof (
# 324 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
       ACL_MDT_REF
# 324 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
       , 
# 324 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
# 324 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
  ...
  data = acl_malloc_glue("/acl/lib_acl/src/db/memdb/acl_mdt.c", 325, ref->node->dlen);
...
# 334 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
                           ((void *)0)
# 334 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
                               );
  do { if (res) { acl_free_glue("/acl/lib_acl/src/db/memdb/acl_mdt.c", 335, (res)); (res) = 
# 335 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
 ((void *)0)
# 335 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ; } } while (0);
  return (
# 336 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
         ((void *)0)
# 336 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
             );
 }
 return (res);
}
# 349 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ...
 const char *key, void (*onfree_fn)(void*, unsigned int))
{
 ...
 idx = mdt_idx(mdt, key_label);
 if (idx == 
# 361 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0)
# 361 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
               ) {
 ...
 rec = mdt->idx_get(idx, key);
 if (rec == 
# 369 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0)
# 369 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
               )
  return (0);
...
# 375 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
       __builtin_offsetof (
# 375 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
       ACL_MDT_REF
# 375 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
       , 
# 375 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
# 375 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
  ...
  for (iter2 = ((&node->ref_head)->succ);
   iter2 != 
# 383 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0) 
# 383 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
                && node->nrefer > 0;) {

   ref2 = ((ACL_MDT_REF *) (((char *) (iter2)) - 
# 385 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
         __builtin_offsetof (
# 385 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
         ACL_MDT_REF
# 385 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
         , 
# 385 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
# 428 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
static ACL_MDT_RES *mdt_list(ACL_MDT *mdt, int from, int limit)
{
 ...
 if (mdt == 
# 437 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0)
# 437 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
               )
  return (
# 438 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
         ((void *)0)
# 438 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
             );

 res = (ACL_MDT_RES*) acl_calloc_glue("/acl/lib_acl/src/db/memdb/acl_mdt.c", 440, 1, sizeof(ACL_MDT_RES));
...
# 448 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
        __builtin_offsetof (
# 448 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
        ACL_MDT_NOD
# 448 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
        , 
# 448 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
# 448 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
  ...
  data = acl_malloc_glue("/acl/lib_acl/src/db/memdb/acl_mdt.c", 449, node->dlen);
...
# 470 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
 ...
 int from, int limit)
{
 ...
 if (walk_fn == 
# 477 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
               ((void *)0) 
# 477 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
                    || mdt == 
# 477 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
                              ((void *)0)
# 477 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
# 483 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
        __builtin_offsetof (
# 483 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
        ACL_MDT_NOD
# 483 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
        , 
# 483 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
static void mdt_nodes_free(ACL_MDT *mdt)
{
 ...
 for (iter = ((&mdt->nod_head)->succ); iter != &mdt->nod_head; ) {
  tmp = ((iter)->succ);
  node = ((ACL_MDT_NOD *) (((char *) (iter)) - 
# 505 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
        __builtin_offsetof (
# 505 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
        ACL_MDT_NOD
# 505 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
        , 
# 505 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
# 507 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
        __builtin_offsetof (
# 507 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
        ACL_MDT_REF
# 507 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
        , 
# 507 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
# 507 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
  ...
  mdt_node_free(mdt, node, 
# 515 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
                          ((void *)0)
# 515 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
                              );
  iter = tmp;
 }
}
 ...
 const char *key_labels[], unsigned int idx_flags[])
{
 ...
 if (strcasecmp(dbtype, "hash") == 0) {
  ...
  return (
# 538 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
         ((void *)0)
# 538 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
             );
 }

 mdt->name = acl_strdup_glue("/acl/lib_acl/src/db/memdb/acl_mdt.c", 541, (tbl_name));
 mdt->node_cnt = 0;
...
void acl_mdt_free(ACL_MDT *mdt)
{
 do { if (mdt->name) { acl_free_glue("/acl/lib_acl/src/db/memdb/acl_mdt.c", 586, (mdt->name)); (mdt->name) = 
# 586 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
((void *)0)
# 586 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
; } } while (0);
 mdt_idx_free(mdt);
 mdt_nodes_free(mdt);
 if (mdt->nod_slice)
...
const void *acl_mdt_fetch_row(ACL_MDT_RES *res)
{
 ...
 if (res == 
# 638 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0) 
# 638 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
                || res->a == 
# 638 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
                             ((void *)0) 
# 638 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
  ...
  return (
# 640 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
         ((void *)0)
# 640 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
             );
 }
 ...
 if (res->ipos >= n)
  return (
# 645 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
         ((void *)0)
# 645 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
             );
...
{
 if (res == 
# 652 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0) 
# 652 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
                || res->a == 
# 652 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
                             ((void *)0) 
# 652 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
...
void acl_mdt_res_free(ACL_MDT_RES *res)
{
 ...
 do { if (res) { acl_free_glue("/acl/lib_acl/src/db/memdb/acl_mdt.c", 661, (res)); (res) = 
# 661 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
((void *)0)
# 661 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
; } } while (0);
}
...
{
 if (mdt == 
# 666 "/acl/lib_acl/src/db/memdb/acl_mdt.c" 3 4
           ((void *)0)
# 666 "/acl/lib_acl/src/db/memdb/acl_mdt.c"
               )
  return (0);
