# 1 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c" 2
# 19 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c"
...
# 20 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c" 2
...
# 21 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c" 2
 ...
 const char *name, unsigned int flag)
{
 ...
 if (init_capacity < 128)
  init_capacity = 128;
 idx = (ACL_MDT_IDX_BHASH*) acl_calloc_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c", 33, 1, sizeof(ACL_MDT_IDX_BHASH));
 ...
 idx->idx.name = acl_strdup_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c", 48, (name));
 idx->idx.flag = flag;
...
static void mdt_idx_free(ACL_MDT_IDX *idx)
{
 ...
 acl_binhash_free(idx_bhash->table, 
# 57 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c" 3 4
                                   ((void *)0)
# 57 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c"
                                       );
 do { if (idx->name) { acl_free_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c", 58, (idx->name)); (idx->name) = 
# 58 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c" 3 4
((void *)0)
# 58 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c"
; } } while (0);
 do { if (idx_bhash) { acl_free_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c", 59, (idx_bhash)); (idx_bhash) = 
# 59 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c" 3 4
((void *)0)
# 59 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c"
; } } while (0);
}
# 70 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c"
static void mdt_idx_add(ACL_MDT_IDX *idx, const char *key, ACL_MDT_REC *rec)
{
 ...
 if (info == 
# 78 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c" 3 4
            ((void *)0)
# 78 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c"
                )
...
static void mdt_idx_del(ACL_MDT_IDX *idx, const char *key)
{
 ...
 acl_binhash_delete(idx_bhash->table, key, (int) strlen(key) + 1, 
# 113 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c" 3 4
                                                                 ((void *)0)
# 113 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c"
                                                                     );
}
...
static void mdt_binhash_free(ACL_MDT *mdt)
{
 ...
 do { if (mdt_bhash) { acl_free_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c", 123, (mdt_bhash)); (mdt_bhash) = 
# 123 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c" 3 4
((void *)0)
# 123 "/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c"
; } } while (0);
}
...
ACL_MDT *acl_mdt_binhash_create()
{
 ...
 mdt = (ACL_MDT_BHASH *) acl_calloc_glue("/workspace/acl/lib_acl/src/db/memdb/acl_mdt_binhash.c", 130, 1, sizeof(ACL_MDT_BHASH));
