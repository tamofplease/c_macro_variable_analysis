# 0 "/acl/lib_acl/src/db/acl_dbpool.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/db/acl_dbpool.c"
...
# 2 "/acl/lib_acl/src/db/acl_dbpool.c" 2
# 20 "/acl/lib_acl/src/db/acl_dbpool.c"
# 1 "/acl/lib_acl/src/db/mysql/acl_dbpool_mysql.h" 1
...
# 1 "/acl/lib_acl/include/db/acl_dbpool.h" 1
# 7 "/acl/lib_acl/src/db/mysql/acl_dbpool_mysql.h" 2
# 21 "/acl/lib_acl/src/db/acl_dbpool.c" 2
...
# 22 "/acl/lib_acl/src/db/acl_dbpool.c" 2
# 37 "/acl/lib_acl/src/db/acl_dbpool.c"
ACL_DB_POOL *acl_dbpool_create(const char *db_type, const ACL_DB_INFO *db_info)
{
 const char *myname = "acl_dbpool_create";
 ACL_DB_POOL *db_pool = 
# 40 "/acl/lib_acl/src/db/acl_dbpool.c" 3 4
                       ((void *)0)
# 40 "/acl/lib_acl/src/db/acl_dbpool.c"
                           ;
 ACL_DB_INFO *info;

 if (db_type == 
# 43 "/acl/lib_acl/src/db/acl_dbpool.c" 3 4
               ((void *)0)
# 43 "/acl/lib_acl/src/db/acl_dbpool.c"
                   )
  db_type = "mysql";
 ...
 if (strcasecmp(db_type, "null") == 0)
  ...
  acl_msg_fatal("%s, %s(%d): %s not supported yet",
    "/acl/lib_acl/src/db/acl_dbpool.c", myname, 54, db_type);
 }

 if (db_pool == 
# 57 "/acl/lib_acl/src/db/acl_dbpool.c" 3 4
               ((void *)0)
# 57 "/acl/lib_acl/src/db/acl_dbpool.c"
                   ) {
  acl_msg_error("%s, %s(%d): dbpool_%s_create error",
    "/acl/lib_acl/src/db/acl_dbpool.c", myname, 59, db_type);
  return (
# 60 "/acl/lib_acl/src/db/acl_dbpool.c" 3 4
         ((void *)0)
# 60 "/acl/lib_acl/src/db/acl_dbpool.c"
             );
 }

 info = &db_pool->db_info;
# 76 "/acl/lib_acl/src/db/acl_dbpool.c"
