# 1 "/workspace/acl/lib_acl/src/db/acl_dbpool.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/db/acl_dbpool.c" 2
# 20 "/workspace/acl/lib_acl/src/db/acl_dbpool.c"
# 1 "/workspace/acl/lib_acl/src/db/mysql/acl_dbpool_mysql.h" 1
...
# 1 "/workspace/acl/lib_acl/include/db/acl_dbpool.h" 1
# 7 "/workspace/acl/lib_acl/src/db/mysql/acl_dbpool_mysql.h" 2
# 21 "/workspace/acl/lib_acl/src/db/acl_dbpool.c" 2
...
# 22 "/workspace/acl/lib_acl/src/db/acl_dbpool.c" 2
# 37 "/workspace/acl/lib_acl/src/db/acl_dbpool.c"
ACL_DB_POOL *acl_dbpool_create(const char *db_type, const ACL_DB_INFO *db_info)
{
 const char *myname = "acl_dbpool_create";
 ACL_DB_POOL *db_pool = 
# 40 "/workspace/acl/lib_acl/src/db/acl_dbpool.c" 3 4
                       ((void *)0)
# 40 "/workspace/acl/lib_acl/src/db/acl_dbpool.c"
                           ;
 ACL_DB_INFO *info;

 if (db_type == 
# 43 "/workspace/acl/lib_acl/src/db/acl_dbpool.c" 3 4
               ((void *)0)
# 43 "/workspace/acl/lib_acl/src/db/acl_dbpool.c"
                   )
  db_type = "mysql";
 ...
 if (strcasecmp(db_type, "null") == 0)
  ...
  acl_msg_fatal("%s, %s(%d): %s not supported yet",
    "/workspace/acl/lib_acl/src/db/acl_dbpool.c", myname, 54, db_type);
 }

 if (db_pool == 
# 57 "/workspace/acl/lib_acl/src/db/acl_dbpool.c" 3 4
               ((void *)0)
# 57 "/workspace/acl/lib_acl/src/db/acl_dbpool.c"
                   ) {
  acl_msg_error("%s, %s(%d): dbpool_%s_create error",
    "/workspace/acl/lib_acl/src/db/acl_dbpool.c", myname, 59, db_type);
  return (
# 60 "/workspace/acl/lib_acl/src/db/acl_dbpool.c" 3 4
         ((void *)0)
# 60 "/workspace/acl/lib_acl/src/db/acl_dbpool.c"
             );
 }

 info = &db_pool->db_info;
# 76 "/workspace/acl/lib_acl/src/db/acl_dbpool.c"
