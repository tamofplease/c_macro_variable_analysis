# 1 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 2
# 13 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
...
# 14 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 2
...
static void free_tls(void *ptr)
{
 ...
 do { if (ctx->blk) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 28, (ctx->blk)); (ctx->blk) = 
# 28 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
((void *)0)
# 28 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
; } } while (0);
 do { if (ctx) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 29, (ctx)); (ctx) = 
# 29 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
((void *)0)
# 29 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
; } } while (0);
}

static void *__tls = 
# 32 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
                    ((void *)0)
# 32 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                        ;
...
static void main_free_tls(void)
{
 if (__tls) {
  ...
  do { if (ctx->blk) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 38, (ctx->blk)); (ctx->blk) = 
# 38 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
 ((void *)0)
# 38 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 ; } } while (0);
  do { if (ctx) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 39, (ctx)); (ctx) = 
# 39 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
 ((void *)0)
# 39 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 ; } } while (0);
  __tls = 
# 40 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
         ((void *)0)
# 40 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
             ;
 }
}
...
# 57 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
                                        0
# 57 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                                                             ;
static BLK_CTX_T *tls_alloc(int len)
{
 ...
 ptr = (BLK_CTX_T*) pthread_getspecific(once_key);
 if (ptr == 
# 64 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
           ((void *)0)
# 64 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
               ) {
  ptr = acl_malloc_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 65, sizeof(BLK_CTX_T));
  ptr->blk = acl_malloc_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 66, len);
  ptr->blk_len = len;
 ...
 do { if (ptr->blk) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 75, (ptr->blk)); (ptr->blk) = 
# 75 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
((void *)0)
# 75 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
; } } while (0);
 ptr->blk = acl_malloc_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 76, len);
 ptr->blk_len = len;
 return ptr;
}
...
static const void *dat_iter_get_next(ZDB_DAT_STORE *store, ACL_ITER *iter)
{
 ...
 zdb_off_t blk_off;
 int ret;
 int blk_len = (int) ( ((zdb_off_t) ((store))->hdr.blk_hdr_dlen) + (zdb_off_t) (store)->hdr.blk_dlen * (zdb_off_t) (store)->hdr.blk_count );
 BLK_CTX_T *ctx = tls_alloc(blk_len);
 ZDB_BLK *blk = ctx->blk;

    if (iter->i >= store->hdr.size) {
        iter->data = iter->ptr = 
# 91 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
                                ((void *)0)
# 91 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                                    ;
        return 
# 92 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
              ((void *)0)
# 92 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                  ;
    }

    blk_off = ( (zdb_off_t) sizeof(ZDB_DAT_HDR) + ( ((zdb_off_t) (((store)))->hdr.blk_hdr_dlen) + (zdb_off_t) ((store))->hdr.blk_dlen * (zdb_off_t) ((store))->hdr.blk_count ) * (zdb_off_t) ((iter->i)) );
    ret = zdb_read((ZDB_STORE*) store, blk, blk_len, blk_off);
    if (ret == -1 ) {
        acl_msg_error("%s(%d): zdb_read %s error, blk_off("
            "%lld" ")", myname, 99,
    (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""), blk_off);
        iter->data = iter->ptr = 
# 101 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
                                ((void *)0)
# 101 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                                    ;
        return 
# 102 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
              ((void *)0)
# 102 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                  ;
    }
    if (blk->hdr.key == -1) {
        iter->data = iter->ptr = 
# 105 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
                                ((void *)0)
# 105 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                                    ;
        return 
# 106 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
              ((void *)0)
# 106 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                  ;
    }
...
{
# 131 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 iter->key = 
# 131 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
            ((void *)0)
# 131 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                ;
 iter->klen = 0;

 if (!(((ZDB_STORE*) store)->db->oflags & (1 << 0))) {
  iter->i = 0;
  return dat_iter_get_next(store, iter);
 }
# 159 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 iter->i = 0;
 return dat_iter_get_next(store, iter);
...
{
# 180 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 if (!(((ZDB_STORE*) store)->db->oflags & (1 << 0))) {
  return dat_iter_get_next(store, iter);
 }
# 205 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 return dat_iter_get_next(store, iter);
...
static void dummy2(void *ptr __attribute__ ((__unused__)))
{
...
{
 do { if (ptr) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 218, (ptr)); (ptr) = 
# 218 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
((void *)0)
# 218 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
; } } while (0);
}

static void *__tls2 = 
# 221 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
                     ((void *)0)
# 221 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                         ;

static void main_free_tls2(void)
{
 if (__tls2) {
  do { if (__tls2) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 226, (__tls2)); (__tls2) = 
# 226 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
 ((void *)0)
# 226 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 ; } } while (0);
  __tls2 = 
# 227 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
          ((void *)0)
# 227 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
              ;
 }
}
...
{
 if ((unsigned long) pthread_self() == acl_main_thread_self()) {
  pthread_key_create(&once_key2, dummy2);

  atexit(main_free_tls2);

 } else
  pthread_key_create(&once_key2, free_tls2);
}

static acl_pthread_once_t once_control2 = 
# 244 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
                                         0
# 244 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                                                              ;
static ZDB_BLK_HDR *get_blk_hdr(void)
{
 ZDB_BLK_HDR *ptr;

 (void) pthread_once(&once_control2, once_init2);
 ptr = (ZDB_BLK_HDR*) pthread_getspecific(once_key2);
 if (ptr == 
# 251 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
           ((void *)0)
# 251 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
               ) {
  ptr = (ZDB_BLK_HDR *) acl_malloc_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 252, sizeof(ZDB_BLK_HDR));
  pthread_setspecific(once_key2, ptr);
  if ((unsigned long) pthread_self() == acl_main_thread_self())
   __tls2 = ptr;
 }
 return ptr;
...
static const void *hdr_iter_get_next(ZDB_DAT_STORE *store, ACL_ITER *iter)
{
 ...
 zdb_off_t blk_off;
 int ret;
 int hdr_len = (int) ((zdb_off_t) (store)->hdr.blk_hdr_dlen);
 ZDB_BLK_HDR *blk_hdr = get_blk_hdr();

    if (iter->i >= store->hdr.size) {
        iter->data = iter->ptr = 
# 269 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
                                ((void *)0)
# 269 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                                    ;
        return 
# 270 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
              ((void *)0)
# 270 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                  ;
    }
    ...
    if (ret == -1 ) {
        acl_msg_error("%s(%d): zdb_read %s error, blk_off("
            ...
            (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""), blk_off);
        iter->data = iter->ptr = 
# 279 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
                                ((void *)0)
# 279 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                                    ;
        return 
# 280 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
              ((void *)0)
# 280 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                  ;
    }
    if (blk_hdr->key == -1) {
        iter->data = iter->ptr = 
# 283 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
                                ((void *)0)
# 283 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                                    ;
        return 
# 284 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
              ((void *)0)
# 284 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                  ;
    }
...
{
# 308 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 iter->key = 
# 308 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
            ((void *)0)
# 308 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                ;
 iter->klen = 0;
...
# 336 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 iter->i = 0;
 return hdr_iter_get_next(store, iter);
...
{
# 356 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 if (!(((ZDB_STORE*) store)->db->oflags & (1 << 0))) {
  return hdr_iter_get_next(store, iter);
 }
# 381 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 return hdr_iter_get_next(store, iter);
