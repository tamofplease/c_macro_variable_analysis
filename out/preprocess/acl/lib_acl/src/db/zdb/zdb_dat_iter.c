# 0 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
...
# 2 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 2
# 13 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
...
# 14 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 2
...
static void free_tls(void *ptr)
{
 ...
 do { if (ctx->blk) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 28, (ctx->blk)); (ctx->blk) = 
# 28 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
((void *)0)
# 28 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
; } } while (0);
 do { if (ctx) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 29, (ctx)); (ctx) = 
# 29 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
((void *)0)
# 29 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
; } } while (0);
}

static void *__tls = 
# 32 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
                    ((void *)0)
# 32 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                        ;
...
static void main_free_tls(void)
{
 if (__tls) {
  ...
  do { if (ctx->blk) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 38, (ctx->blk)); (ctx->blk) = 
# 38 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
 ((void *)0)
# 38 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 ; } } while (0);
  do { if (ctx) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 39, (ctx)); (ctx) = 
# 39 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
 ((void *)0)
# 39 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 ; } } while (0);
  __tls = 
# 40 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
         ((void *)0)
# 40 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
             ;
 }
}
...
# 57 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
                                        0
# 57 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                                                             ;
static BLK_CTX_T *tls_alloc(int len)
{
 ...
 if (ptr == 
# 64 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
           ((void *)0)
# 64 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
               ) {
  ptr = acl_malloc_glue("/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 65, sizeof(BLK_CTX_T));
  ptr->blk = acl_malloc_glue("/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 66, len);
  ptr->blk_len = len;
 ...
 do { if (ptr->blk) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 75, (ptr->blk)); (ptr->blk) = 
# 75 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
((void *)0)
# 75 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
; } } while (0);
 ptr->blk = acl_malloc_glue("/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 76, len);
 ptr->blk_len = len;
 return ptr;
}
...
static const void *dat_iter_get_next(ZDB_DAT_STORE *store, ACL_ITER *iter)
{
 ...
 ZDB_BLK *blk = ctx->blk;
    ...
    if (iter->i >= store->hdr.size) {
        iter->data = iter->ptr = 
# 91 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
                                ((void *)0)
# 91 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                                    ;
        return 
# 92 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
              ((void *)0)
# 92 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                  ;
    }
    ...
    (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""), blk_off);
        iter->data = iter->ptr = 
# 101 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
                                ((void *)0)
# 101 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                                    ;
        return 
# 102 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
              ((void *)0)
# 102 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                  ;
    }
    if (blk->hdr.key == -1) {
        iter->data = iter->ptr = 
# 105 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
                                ((void *)0)
# 105 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                                    ;
        return 
# 106 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
              ((void *)0)
# 106 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                  ;
    }
...
{
# 131 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 iter->key = 
# 131 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
            ((void *)0)
# 131 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                ;
 iter->klen = 0;
...
# 159 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 iter->i = 0;
 return dat_iter_get_next(store, iter);
...
{
# 180 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 if (!(((ZDB_STORE*) store)->db->oflags & (1 << 0))) {
  return dat_iter_get_next(store, iter);
 }
# 205 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 return dat_iter_get_next(store, iter);
...
{
 do { if (ptr) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 218, (ptr)); (ptr) = 
# 218 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
((void *)0)
# 218 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
; } } while (0);
}

static void *__tls2 = 
# 221 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
                     ((void *)0)
# 221 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                         ;

static void main_free_tls2(void)
{
 if (__tls2) {
  do { if (__tls2) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 226, (__tls2)); (__tls2) = 
# 226 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
 ((void *)0)
# 226 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 ; } } while (0);
  __tls2 = 
# 227 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
          ((void *)0)
# 227 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
              ;
 }
}
...
# 244 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
                                         0
# 244 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                                                              ;
static ZDB_BLK_HDR *get_blk_hdr(void)
{
 ...
 if (ptr == 
# 251 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
           ((void *)0)
# 251 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
               ) {
  ptr = (ZDB_BLK_HDR *) acl_malloc_glue("/acl/lib_acl/src/db/zdb/zdb_dat_iter.c", 252, sizeof(ZDB_BLK_HDR));
...
static const void *hdr_iter_get_next(ZDB_DAT_STORE *store, ACL_ITER *iter)
{
 ...
 ZDB_BLK_HDR *blk_hdr = get_blk_hdr();
    ...
    if (iter->i >= store->hdr.size) {
        iter->data = iter->ptr = 
# 269 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
                                ((void *)0)
# 269 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                                    ;
        return 
# 270 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
              ((void *)0)
# 270 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                  ;
    }
    ...
    if (ret == -1 ) {
        acl_msg_error("%s(%d): zdb_read %s error, blk_off("
            ...
            (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""), blk_off);
        iter->data = iter->ptr = 
# 279 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
                                ((void *)0)
# 279 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                                    ;
        return 
# 280 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
              ((void *)0)
# 280 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                  ;
    }
    if (blk_hdr->key == -1) {
        iter->data = iter->ptr = 
# 283 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
                                ((void *)0)
# 283 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                                    ;
        return 
# 284 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
              ((void *)0)
# 284 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                  ;
    }
...
{
# 308 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 iter->key = 
# 308 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c" 3 4
            ((void *)0)
# 308 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
                ;
 iter->klen = 0;
...
# 336 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 iter->i = 0;
 return hdr_iter_get_next(store, iter);
...
{
# 356 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 if (!(((ZDB_STORE*) store)->db->oflags & (1 << 0))) {
  return hdr_iter_get_next(store, iter);
 }
# 381 "/acl/lib_acl/src/db/zdb/zdb_dat_iter.c"
 return hdr_iter_get_next(store, iter);
