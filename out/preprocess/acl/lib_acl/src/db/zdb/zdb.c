# 0 "/acl/lib_acl/src/db/zdb/zdb.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/db/zdb/zdb.c"
...
# 2 "/acl/lib_acl/src/db/zdb/zdb.c" 2
# 21 "/acl/lib_acl/src/db/zdb/zdb.c"
...
# 22 "/acl/lib_acl/src/db/zdb/zdb.c" 2
...
# 47 "/acl/lib_acl/src/db/zdb/zdb.c"
static void free_disk(void *arg)
{
 ZDB_DISK *disk = (ZDB_DISK*) arg;

 if (disk->path)
  do { if (disk->path) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb.c", 52, (disk->path)); (disk->path) = 
# 52 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
 ((void *)0)
# 52 "/acl/lib_acl/src/db/zdb/zdb.c"
 ; } } while (0);
 do { if (disk) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb.c", 53, (disk)); (disk) = 
# 53 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
((void *)0)
# 53 "/acl/lib_acl/src/db/zdb/zdb.c"
; } } while (0);
}
...
static ZDB_DISK *zdb_disks_load(const char *dbname, const char *dbpath)
{
 ...
 ACL_FILE *fp = 
# 60 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
               ((void *)0)
# 60 "/acl/lib_acl/src/db/zdb/zdb.c"
                   ;
 char disk_info[(256 + 32 + 32 + 32 + 32 + 2) + 1];
 ZDB_DISK *disk, *disks;
 ACL_ARRAY *a = 
# 63 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
               ((void *)0)
# 63 "/acl/lib_acl/src/db/zdb/zdb.c"
                   ;
 ACL_ITER iter;
 int n, i;
# 77 "/acl/lib_acl/src/db/zdb/zdb.c"
 acl_vstring_sprintf(buf, "%s/.%s.disk", dbpath, dbname);
 fp = acl_fopen(((char *) ((buf))->vbuf.data), "r");
 if (fp == 
# 79 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
          ((void *)0)
# 79 "/acl/lib_acl/src/db/zdb/zdb.c"
              ) {
...
# 82 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
 ((void *)0)
# 82 "/acl/lib_acl/src/db/zdb/zdb.c"
 ); } while (0);
 }
...
# 89 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
                                                         ((void *)0)
# 89 "/acl/lib_acl/src/db/zdb/zdb.c"
                                                             )
   break;
  ...
  disk = (ZDB_DISK*) acl_calloc_glue("/acl/lib_acl/src/db/zdb/zdb.c", 98, 1, sizeof(ZDB_DISK));
  disk->path = acl_strdup_glue("/acl/lib_acl/src/db/zdb/zdb.c", 99, (argv->argv[0]));
 ...
 if (n <= 0) {
  ...
  do { if (fp) acl_fclose(fp); acl_vstring_free(buf); if (a) acl_array_free(a, free_disk); return (
# 113 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
 ((void *)0)
# 113 "/acl/lib_acl/src/db/zdb/zdb.c"
 ); } while (0);
 }

 disks = (ZDB_DISK*) acl_calloc_glue("/acl/lib_acl/src/db/zdb/zdb.c", 116, n + 1, sizeof(ZDB_DISK));
 i = 0;
 for ((a)->iter_head(&(iter), (a)); (iter).ptr; (a)->iter_next(&(iter), (a))) {
  ...
  disks[i].path = acl_strdup_glue("/acl/lib_acl/src/db/zdb/zdb.c", 122, (disk->path));
  disks[i].idisk = disk->idisk;
  disks[i].priority = disk->priority;
  disks[i].dat_ifiles = 
# 125 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
                       ((void *)0)
# 125 "/acl/lib_acl/src/db/zdb/zdb.c"
                           ;
  disks[i].dat_ifiles_size = 0;
  if (disks[i].idisk != i) {
   acl_msg_error("%s(%d): idisk(%d) != %d invalid for %s",
    myname, 129, disks[i].idisk, i, disks[i].path);
   do { if (disks) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb.c", 130, (disks)); (disks) = 
# 130 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
  ((void *)0)
# 130 "/acl/lib_acl/src/db/zdb/zdb.c"
  ; } } while (0);
   do { if (fp) acl_fclose(fp); acl_vstring_free(buf); if (a) acl_array_free(a, free_disk); return (
# 131 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
  ((void *)0)
# 131 "/acl/lib_acl/src/db/zdb/zdb.c"
  ); } while (0);
  }
  i++;
 }
 ...
 disks[i].path = 
# 136 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
                ((void *)0)
# 136 "/acl/lib_acl/src/db/zdb/zdb.c"
                    ;
...
static void zdb_disks_update(const char *dbname, const char *dbpath, const ZDB_DISK *disks)
{
 ...
 if (fp == 
# 150 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
          ((void *)0)
# 150 "/acl/lib_acl/src/db/zdb/zdb.c"
              ) {
  acl_msg_error("%s(%d): fopen(%s) error(%s)",
...
# 160 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
                             ((void *)0)
# 160 "/acl/lib_acl/src/db/zdb/zdb.c"
                                 ; i++) {
...
# 169 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
                                (-1)
# 169 "/acl/lib_acl/src/db/zdb/zdb.c"
                                   ) {
...
# 186 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
                                     ((void *)0)
# 186 "/acl/lib_acl/src/db/zdb/zdb.c"
                                         ; i++) {
...
ZDB *zdb_open(const char *dbname, unsigned int oflags, const ZDB_CFG *cfg)
{
 ...
 if (disks == 
# 222 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
             ((void *)0)
# 222 "/acl/lib_acl/src/db/zdb/zdb.c"
                 ) {
  acl_msg_error("%s(%d): zdb_disks_load error",
   myname, 224);
  return (
# 225 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
         ((void *)0)
# 225 "/acl/lib_acl/src/db/zdb/zdb.c"
             );
 }

 db = (ZDB*) acl_calloc_glue("/acl/lib_acl/src/db/zdb/zdb.c", 228, 1, sizeof(ZDB));

 db->dbname = acl_strdup_glue("/acl/lib_acl/src/db/zdb/zdb.c", 230, (dbname));
 db->key_path = acl_strdup_glue("/acl/lib_acl/src/db/zdb/zdb.c", 231, (cfg->key_path));
 db->oflags = oflags;
 db->dat_disks = disks;
...
# 280 "/acl/lib_acl/src/db/zdb/zdb.c"
 return (db);
}
...
void zdb_close(ZDB *db)
{
 ...
 zdb_sync(db);
 do { if (db->dbname) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb.c", 288, (db->dbname)); (db->dbname) = 
# 288 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
((void *)0)
# 288 "/acl/lib_acl/src/db/zdb/zdb.c"
; } } while (0);
 do { if (db->key_path) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb.c", 289, (db->key_path)); (db->key_path) = 
# 289 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
((void *)0)
# 289 "/acl/lib_acl/src/db/zdb/zdb.c"
; } } while (0);
 acl_vstring_free(db->path_tmp);

 for (i = 0; db->dat_disks[i].path != 
# 292 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
                                     ((void *)0)
# 292 "/acl/lib_acl/src/db/zdb/zdb.c"
                                         ; i++) {
  if (db->dat_disks[i].dat_ifiles)
   do { if (db->dat_disks[i].dat_ifiles) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb.c", 294, (db->dat_disks[i].dat_ifiles)); (db->dat_disks[i].dat_ifiles) = 
# 294 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
  ((void *)0)
# 294 "/acl/lib_acl/src/db/zdb/zdb.c"
  ; } } while (0);
  do { if (db->dat_disks[i].path) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb.c", 295, (db->dat_disks[i].path)); (db->dat_disks[i].path) = 
# 295 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
 ((void *)0)
# 295 "/acl/lib_acl/src/db/zdb/zdb.c"
 ; } } while (0);
 }
 do { if (db->dat_disks) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb.c", 297, (db->dat_disks)); (db->dat_disks) = 
# 297 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
((void *)0)
# 297 "/acl/lib_acl/src/db/zdb/zdb.c"
; } } while (0);
 do { if (db) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb.c", 298, (db)); (db) = 
# 298 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
((void *)0)
# 298 "/acl/lib_acl/src/db/zdb/zdb.c"
; } } while (0);
}
...
ZDB_BLK *zdb_lookup(ZDB *db, zdb_key_t key, size_t *size_ptr, ZDB_BLK_OFF *blk_off_buf)
{
 ...
 if (key < db->key_begin) {
  ...
  return (
# 313 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
         ((void *)0)
# 313 "/acl/lib_acl/src/db/zdb/zdb.c"
             );
 }
 ...
 if (ret <= 0)
  return (
# 318 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
         ((void *)0)
# 318 "/acl/lib_acl/src/db/zdb/zdb.c"
             );

 blk = db->dat_get(db, &blk_off, &key_tmp, size_ptr);
 if (blk == 
# 321 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
           ((void *)0)
# 321 "/acl/lib_acl/src/db/zdb/zdb.c"
               ) {
  ...
  return (
# 328 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
         ((void *)0)
# 328 "/acl/lib_acl/src/db/zdb/zdb.c"
             );
 }
 ...
 if (key != key_tmp) {
  ...
  do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb.c", 341, ((blk))); ((blk)) = 
# 341 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
 ((void *)0)
# 341 "/acl/lib_acl/src/db/zdb/zdb.c"
 ; } } while (0);
  return (
# 342 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
         ((void *)0)
# 342 "/acl/lib_acl/src/db/zdb/zdb.c"
             );
 }
 ...
 const void *dat, size_t len)
{
 ...
 if (dat == 
# 362 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
           ((void *)0)
# 362 "/acl/lib_acl/src/db/zdb/zdb.c"
               ) {
 ...
 if (blk_off_saved == 
# 374 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
                     ((void *)0) 
# 374 "/acl/lib_acl/src/db/zdb/zdb.c"
                          || blk_off_saved->offset < 0) {
  blk_off_saved = 
# 375 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
                 ((void *)0)
# 375 "/acl/lib_acl/src/db/zdb/zdb.c"
                     ;
  ret = db->key_get(db, key, &blk_off);
  if (ret < 0) {
 ...
 if (blk_off_saved == 
# 386 "/acl/lib_acl/src/db/zdb/zdb.c" 3 4
                     ((void *)0)
# 386 "/acl/lib_acl/src/db/zdb/zdb.c"
                         ) {
  db->status |= (1 << 0);
