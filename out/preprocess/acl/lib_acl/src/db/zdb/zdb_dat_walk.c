# 1 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_walk.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_walk.c" 2
# 15 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_walk.c"
...
# 16 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_walk.c" 2
 ...
 int (*walk_fn)(ZDB_DAT_STORE *store))
{
 ...
 if (scan == 
# 28 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_walk.c" 3 4
            ((void *)0)
# 28 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_walk.c"
                ) {
  acl_msg_error("%s(%d): open dir %s error(%s)",
   myname, 30, path, acl_last_serror());
  return (-1);
 }
 ...
 while (1) {
  ...
  if (fname == 
# 36 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_walk.c" 3 4
              ((void *)0)
# 36 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_walk.c"
                  ) {
   acl_msg_info("%s(%d): scan over for %s",
    myname, 38, path);
   break;
  }
  if (acl_strrncasecmp(fname, ".dat", 4) != 0) {
   acl_msg_info("%s(%d): skip %s/%s", myname,
    43, acl_scan_dir_path(scan), fname);
   continue;
  }
  ...
  if (store == 
# 49 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_walk.c" 3 4
              ((void *)0)
# 49 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_walk.c"
                  ) {
   acl_msg_error("%s(%d): open file(%s) error(%s)",
    myname, 51, pathbuf, acl_last_serror());
   break;
  }
...
# 74 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_walk.c" 3 4
                                     ((void *)0)
# 74 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat_walk.c"
                                         ; i++) {
  acl_msg_info("%s(%d): begin scan %s",
   myname, 76, db->dat_disks[i].path);
  ret = zdb_dat_scan_path(db, db->dat_disks[i].path, walk_fn);
  acl_msg_info("%s(%d): scan %s end\n",
   myname, 79, db->dat_disks[i].path);
  if (ret < 0)
   break;
 }
