# 1 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 2
# 16 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
...
# 17 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 2
...
int key_store_header_sync(ZDB_KEY_STORE *store)
{
 ...
 if (ret == -1)
  acl_msg_error("%s(%d): zdb_write to %s error(%s)",
   myname, 26, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""), acl_last_serror());
 return (ret);
}
...
{
 do { if (ptr) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_key.c", 37, (ptr)); (ptr) = 
# 37 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
((void *)0)
# 37 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
; } } while (0);
}

static void *__tls = 
# 40 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
                    ((void *)0)
# 40 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
                        ;

static void main_free_tls(void)
{
 if (__tls) {
  do { if (__tls) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_key.c", 45, (__tls)); (__tls) = 
# 45 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
 ((void *)0)
# 45 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
 ; } } while (0);
  __tls = 
# 46 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
         ((void *)0)
# 46 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
             ;
 }
}
...
# 63 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
                                        0
# 63 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
                                                             ;
static ZDB_BLK_OFF *get_tls(void)
{
 ...
 ptr = (ZDB_BLK_OFF*) pthread_getspecific(once_key);
 if (ptr == 
# 70 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
           ((void *)0)
# 70 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
               ) {
  ptr = (ZDB_BLK_OFF *) acl_malloc_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_key.c", 71, sizeof(ZDB_BLK_OFF));
...
static const void *key_iter_head(ACL_ITER *iter, struct ZDB_KEY_STORE *store)
{
 ...
 iter->key = 
# 90 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
            ((void *)0)
# 90 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
                ;
 iter->klen = 0;
 for (iter->i = 0; iter->i < store->hdr.key_limit; iter->i++) {
  key_off = ( ((iter->i) - (int) (((iter->i)) / ((((ZDB_STORE*) store)->db))->key_limit) * (zdb_off_t) (((ZDB_STORE*) store)->db)->key_limit) * (zdb_off_t) sizeof(ZDB_BLK_OFF) + (zdb_off_t) sizeof(ZDB_KEY_HDR) );
  ret = zdb_read((ZDB_STORE*) store, blk_off,
    sizeof(ZDB_BLK_OFF), key_off);
  if (ret == -1) {
   iter->data = iter->ptr = 
# 97 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
                           ((void *)0)
# 97 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
                               ;
   return (
# 98 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
          ((void *)0)
# 98 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
              );
  }
 ...
 iter->data = iter->ptr = 
# 107 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
                         ((void *)0)
# 107 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
                             ;
 return (
# 108 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
        ((void *)0)
# 108 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
            );
}
...
static const void *key_iter_next(ACL_ITER *iter, struct ZDB_KEY_STORE *store)
{
 ...
 for (; iter->i < store->hdr.key_limit; iter->i++) {
  ...
  if (ret == -1) {
   iter->data = iter->ptr = 
# 127 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
                           ((void *)0)
# 127 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
                               ;
   return (
# 128 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
          ((void *)0)
# 128 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
              );
  }
  if (blk_off->offset >= 0 && blk_off->inode >= 0) {
   iter->data = iter->ptr = blk_off;
 ...
 iter->data = iter->ptr = 
# 137 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
                         ((void *)0)
# 137 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
                             ;
 return (
# 138 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
        ((void *)0)
# 138 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
            );
}
...
static int key_store_init(ZDB_KEY_STORE *store)
{
 ...
 if ((((ZDB_STORE*) store)->db->oflags & (1 << 3)) == 0)
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): write header to %s error(%s)",
   myname, 163, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""),
   acl_last_serror());
  return (-1);
 }
  ...
  for (i = 0; i < store->hdr.key_limit; i++) {
   ...
   if (ret == (-1)) {
    acl_msg_error("%s(%d): write to %s error(%s)",
     myname, 177, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""),
     acl_last_serror());
    return (-1);
   }
  }
 ...
 if ((((ZDB_STORE*) store)->db->oflags & (1 << 3)) == 0) {
    ...
    == (-1))
  {
   acl_msg_error("%s(%d): fflush to %s error %s", myname,
    203, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""),
    acl_last_serror());
   return (-1);
  }
 }
...
static int key_store_on_open(ACL_FHANDLE *fh, void *arg)
{
 ...
 if (fh->fsize == 0) {
  !acl_do_debug(((500 + 3)), (1)) ? (void) 0 : acl_msg_info ("%s: begin init %s ...", myname, ((char *) ((db->path_tmp))->vbuf.data));
  ...
  if (key_store_init(store) < 0) {
   acl_msg_error("%s(%d): key_store_init error", myname, 248);
   return (-1);
  }
  !acl_do_debug(((500 + 3)), (1)) ? (void) 0 : acl_msg_info ("%s: init %s ok", myname, ((char *) ((db->path_tmp))->vbuf.data));
  return (0);
 }
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): read key header from %s error(%s)",
   myname, 266, ((char *) ((db->path_tmp))->vbuf.data), acl_last_serror());
  return (-1);
 }
...
static void key_store_on_close(ACL_FHANDLE *fh)
{
 ...
 !acl_do_debug(((500 + 3)), (2)) ? (void) 0 : acl_msg_info ("%s(%d): sync header ok, close %s now, nrefer: %d",
  myname, 292, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""),
...
ZDB_KEY_STORE *zdb_key_store_open2(ZDB *db, const char *filepath)
{
 ...
 store = (ZDB_KEY_STORE*) acl_fhandle_open(sizeof(ZDB_KEY_STORE), oflags,
   ...
   key_store_on_close);
 if (store == 
# 309 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
             ((void *)0)
# 309 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
                 ) {
  acl_msg_error("%s(%d): acl_fhandle_open %s error(%s)",
   myname, 311, filepath, acl_last_serror());
  return (
# 312 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
         ((void *)0)
# 312 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
             );
 } else {
...
ZDB_KEY_STORE *zdb_key_store_open(ZDB *db, zdb_key_t key)
{
 ...
 inode = (int) ((key) / (db)->key_limit);
 if (inode < 0 || inode > 65353) {
  acl_msg_error("%s(%d): inode(%d) invalid, key(" "%lld" ")",
   myname, 330, inode, key);
  return (
# 331 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
         ((void *)0)
# 331 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
             );
 }
 ...
 return (zdb_key_store_open2(db, ((char *) ((db->path_tmp))->vbuf.data)));
}
...
int zdb_key_set(ZDB *db, zdb_key_t key, const ZDB_BLK_OFF *blk_off)
{
 ...
 zdb_off_t key_off;
 ZDB_KEY_STORE *store = 
# 354 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
                       ((void *)0)
# 354 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
                           ;
 int ret, inode;
# 364 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
 store = zdb_key_store_open(db, key);
 if (store == 
# 365 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
             ((void *)0)
# 365 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
                 ) {
  acl_msg_error("%s(%d): open key(" "%lld" ") store error",
   myname, 367, key);
  do { if (store) zdb_key_store_close(store); return ((-1)); } while (0);
 }



 inode = (int) ((key) / (store->store.db)->key_limit);
 if (inode < 0 || inode > 65353) {
  acl_msg_error("%s(%d): %s, inode(%d) invalid, key("
   "%lld" ")", myname, 376,
   ((((&store->store)->fhandle.fp))->path ? (((&store->store)->fhandle.fp))->path : ""), inode, key);
  do { if (store) zdb_key_store_close(store); return ((-1)); } while (0);
 }

 key_off = ( ((key) - (int) (((key)) / ((store->store.db))->key_limit) * (zdb_off_t) (store->store.db)->key_limit) * (zdb_off_t) sizeof(ZDB_BLK_OFF) + (zdb_off_t) sizeof(ZDB_KEY_HDR) );
 if (key_off < (zdb_off_t) sizeof(ZDB_KEY_HDR)) {
  acl_msg_error("%s(%d): %s, key_off(" "%lld"
   ") < ZDB_KEY_HDR's size(%d), key(" "%lld"
   "), inode(%d), key_limit(" "%lld" ")",
   myname, 386, ((((&store->store)->fhandle.fp))->path ? (((&store->store)->fhandle.fp))->path : ""), key_off,
 ...
 if (ret == -1) {
  acl_msg_error("%s(%d): write to %s error %s, blk_off("
   "%lld" ", %d), key(" "%lld" ")",
   myname, 395, ((((&store->store)->fhandle.fp))->path ? (((&store->store)->fhandle.fp))->path : ""), acl_last_serror(),
 ...
 if ((db->status & (1 << 0)))
  store->hdr.key_count++;
 do { if (store) zdb_key_store_close(store); return ((0)); } while (0);
}
...
int zdb_key_get(ZDB *db, zdb_key_t key, ZDB_BLK_OFF *blk_off)
{
 ...
 zdb_off_t key_off;
 ZDB_KEY_STORE *store = 
# 411 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
                       ((void *)0)
# 411 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
                           ;
 int ret, inode;
# 421 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
 store = zdb_key_store_open(db, key);
 if (store == 
# 422 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
             ((void *)0)
# 422 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
                 ) {
  acl_msg_error("%s(%d): open key(" "%lld" ") store error",
   myname, 424, key);
  do { if (store) zdb_key_store_close(store); return ((-1)); } while (0);
 ...
 if (key_off < (int) sizeof(ZDB_KEY_HDR)) {
  acl_msg_error("%s(%d): %s, key_off(" "%lld"
   ") < ZDB_KEY_HDR's size(%d), key(" "%lld"
   "), inode(%d), key_limit(" "%lld" ")",
   myname, 443, ((((&store->store)->fhandle.fp))->path ? (((&store->store)->fhandle.fp))->path : ""), key_off,
   (int) sizeof(ZDB_KEY_HDR), key, inode, store->store.db->key_limit);
  do { if (store) zdb_key_store_close(store); return ((-1)); } while (0);
 }
 ...
 !acl_do_debug(((500)), (2)) ? (void) 0 : acl_msg_info
  ("%s(%d): zdb_read ret: %d, blk_off: " "%lld"
  ", key_off: " "%lld",
  myname, 453, ret, blk_off->offset, key_off);

 if (ret == -1) {
  acl_msg_error("%s(%d): zdb_read from %s error %s,"
   " key(" "%lld" "), key_off(" "%lld" ")",
   myname, 458, ((((&store->store)->fhandle.fp))->path ? (((&store->store)->fhandle.fp))->path : ""),
 ...
 if (blk_off->offset < 0 || blk_off->inode < 0) {
  !acl_do_debug(((500)), (2)) ? (void) 0 : acl_msg_info
   ("%s(%d): blk_off(" "%lld" ") from %s invalid for"
    " key(" "%lld" "), key_off(" "%lld" ")",
   myname, 467, blk_off->offset,
   ((((&store->store)->fhandle.fp))->path ? (((&store->store)->fhandle.fp))->path : ""), key, key_off);
  do { if (store) zdb_key_store_close(store); return ((0)); } while (0);
 }
...
int zdb_key_status(ZDB *db, const char *filepath, ZDB_KEY_HDR *key_hdr)
{
 ...
 if (store == 
# 482 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
             ((void *)0)
# 482 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
                 ) {
  acl_msg_error("%s(%d): open %s error(%s)",
   myname, 484, filepath, acl_last_serror());
  return (-1);
 }
...
int zdb_key_check(ZDB_KEY_STORE *store, ZDB_KEY_HDR *key_hdr)
{
 ...
 acl_msg_info("%s(%d): begin check %s's used key",
  myname, 506, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""));
 ...
 if (nused != store->hdr.key_count) {
  acl_msg_error("%s(%d): nused(" "%lld"
   ") != store->hdr.key_count(" "%lld" ")"
   " for %s, please repair it!", myname, 515,
   nused, store->hdr.key_count, ((((&store->store)->fhandle.fp))->path ? (((&store->store)->fhandle.fp))->path : ""));
  failed = 1;
 } else {
  acl_msg_info("%s(%d): check used key ok for %s,"
   " store->hdr.key_count(" "%lld" ")", myname, 520,
   ((((&store->store)->fhandle.fp))->path ? (((&store->store)->fhandle.fp))->path : ""), store->hdr.key_count);
 }
 return (failed ? -1 : 0);
}
...
int zdb_key_check3(ZDB *db, const char *filepath, ZDB_KEY_HDR *key_hdr)
{
 ...
 store = zdb_key_store_open2(db, filepath);
 if (store == 
# 533 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
             ((void *)0)
# 533 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
                 ) {
  acl_msg_error("%s(%d): open %s error(%s)",
   myname, 535, filepath, acl_last_serror());
  return (-1);
 }
...
static int store_init_on_open(ACL_FHANDLE *fh, void *arg)
{
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): write header to %s error(%s)",
   myname, 571, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""),
   acl_last_serror());
  return (-1);
 }
 ...
 for (key = 0; key < store->hdr.key_limit; key++) {
  ...
  if (ret == (-1)) {
   acl_msg_error("%s(%d): write to %s error(%s)", myname,
    583, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""),
    acl_last_serror());
   return (-1);
  }
  if ((key % 5000000) == 0) {
   acl_msg_info("%s(%d): %s, key: " "%lld" ", key_limit: "
    "%lld", myname, 589,
    (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""), key, db->key_limit);
  }
 }


 if (acl_vstream_fflush(((ZDB_STORE*) store)->fhandle.fp) == (-1)) {
  acl_msg_error("%s(%d): fflush to %s error %s", myname, 596,
   (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""), acl_last_serror());
  return (-1);
 }
...
int zdb_key_init(ZDB *db, zdb_key_t key_begin, zdb_key_t key_end)
{
 ...
 acl_msg_info("%s(%d): key_begin: " "%lld" ", key_end: "
  "%lld" ", key_limit: " "%lld",
  myname, 623, key_begin, key_end, db->key_limit);
 ...
 for (key = key_begin; key < key_end;) {
  ...
  acl_msg_info("%s(%d): open %s", myname, 630, ((char *) ((db->path_tmp))->vbuf.data));
  store = (ZDB_KEY_STORE*) acl_fhandle_open(sizeof(ZDB_KEY_STORE),
    0, ((char *) ((db->path_tmp))->vbuf.data), store_init_on_open,
    db, store_init_on_close);
  if (store == 
# 634 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
              ((void *)0)
# 634 "/workspace/acl/lib_acl/src/db/zdb/zdb_key.c"
                  ) {
   acl_msg_error("%s(%d): acl_fhandle_open %s error(%s)",
    myname, 636, ((char *) ((db->path_tmp))->vbuf.data),
    acl_last_serror());
   return (-1);
  }

  acl_msg_info("%s(%d): close %s", myname, 641, ((char *) ((db->path_tmp))->vbuf.data));
