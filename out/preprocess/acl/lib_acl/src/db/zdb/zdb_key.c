# 0 "/acl/lib_acl/src/db/zdb/zdb_key.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/db/zdb/zdb_key.c"
...
# 2 "/acl/lib_acl/src/db/zdb/zdb_key.c" 2
# 16 "/acl/lib_acl/src/db/zdb/zdb_key.c"
...
# 17 "/acl/lib_acl/src/db/zdb/zdb_key.c" 2
...
{
 do { if (ptr) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_key.c", 37, (ptr)); (ptr) = 
# 37 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
((void *)0)
# 37 "/acl/lib_acl/src/db/zdb/zdb_key.c"
; } } while (0);
}

static void *__tls = 
# 40 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
                    ((void *)0)
# 40 "/acl/lib_acl/src/db/zdb/zdb_key.c"
                        ;

static void main_free_tls(void)
{
 if (__tls) {
  do { if (__tls) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_key.c", 45, (__tls)); (__tls) = 
# 45 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
 ((void *)0)
# 45 "/acl/lib_acl/src/db/zdb/zdb_key.c"
 ; } } while (0);
  __tls = 
# 46 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
         ((void *)0)
# 46 "/acl/lib_acl/src/db/zdb/zdb_key.c"
             ;
 }
}
...
# 63 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
                                        0
# 63 "/acl/lib_acl/src/db/zdb/zdb_key.c"
                                                             ;
static ZDB_BLK_OFF *get_tls(void)
{
 ...
 if (ptr == 
# 70 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
           ((void *)0)
# 70 "/acl/lib_acl/src/db/zdb/zdb_key.c"
               ) {
  ptr = (ZDB_BLK_OFF *) acl_malloc_glue("/acl/lib_acl/src/db/zdb/zdb_key.c", 71, sizeof(ZDB_BLK_OFF));
...
static const void *key_iter_head(ACL_ITER *iter, struct ZDB_KEY_STORE *store)
{
 ...
 iter->key = 
# 90 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
            ((void *)0)
# 90 "/acl/lib_acl/src/db/zdb/zdb_key.c"
                ;
 iter->klen = 0;
 for (iter->i = 0; iter->i < store->hdr.key_limit; iter->i++) {
  ...
  if (ret == -1) {
   iter->data = iter->ptr = 
# 97 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
                           ((void *)0)
# 97 "/acl/lib_acl/src/db/zdb/zdb_key.c"
                               ;
   return (
# 98 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
          ((void *)0)
# 98 "/acl/lib_acl/src/db/zdb/zdb_key.c"
              );
  }
 ...
 iter->data = iter->ptr = 
# 107 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
                         ((void *)0)
# 107 "/acl/lib_acl/src/db/zdb/zdb_key.c"
                             ;
 return (
# 108 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
        ((void *)0)
# 108 "/acl/lib_acl/src/db/zdb/zdb_key.c"
            );
}
...
static const void *key_iter_next(ACL_ITER *iter, struct ZDB_KEY_STORE *store)
{
 ...
 for (; iter->i < store->hdr.key_limit; iter->i++) {
  ...
  if (ret == -1) {
   iter->data = iter->ptr = 
# 127 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
                           ((void *)0)
# 127 "/acl/lib_acl/src/db/zdb/zdb_key.c"
                               ;
   return (
# 128 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
          ((void *)0)
# 128 "/acl/lib_acl/src/db/zdb/zdb_key.c"
              );
  }
  if (blk_off->offset >= 0 && blk_off->inode >= 0) {
   iter->data = iter->ptr = blk_off;
 ...
 iter->data = iter->ptr = 
# 137 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
                         ((void *)0)
# 137 "/acl/lib_acl/src/db/zdb/zdb_key.c"
                             ;
 return (
# 138 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
        ((void *)0)
# 138 "/acl/lib_acl/src/db/zdb/zdb_key.c"
            );
}
...
ZDB_KEY_STORE *zdb_key_store_open2(ZDB *db, const char *filepath)
{
 ...
 store = (ZDB_KEY_STORE*) acl_fhandle_open(sizeof(ZDB_KEY_STORE), oflags,
   ...
   key_store_on_close);
 if (store == 
# 309 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
             ((void *)0)
# 309 "/acl/lib_acl/src/db/zdb/zdb_key.c"
                 ) {
  acl_msg_error("%s(%d): acl_fhandle_open %s error(%s)",
   myname, 311, filepath, acl_last_serror());
  return (
# 312 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
         ((void *)0)
# 312 "/acl/lib_acl/src/db/zdb/zdb_key.c"
             );
 } else {
...
ZDB_KEY_STORE *zdb_key_store_open(ZDB *db, zdb_key_t key)
{
 ...
 if (inode < 0 || inode > 65353) {
  ...
  return (
# 331 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
         ((void *)0)
# 331 "/acl/lib_acl/src/db/zdb/zdb_key.c"
             );
 }
...
int zdb_key_set(ZDB *db, zdb_key_t key, const ZDB_BLK_OFF *blk_off)
{
 ...
 zdb_off_t key_off;
 ZDB_KEY_STORE *store = 
# 354 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
                       ((void *)0)
# 354 "/acl/lib_acl/src/db/zdb/zdb_key.c"
                           ;
 int ret, inode;
# 364 "/acl/lib_acl/src/db/zdb/zdb_key.c"
 store = zdb_key_store_open(db, key);
 if (store == 
# 365 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
             ((void *)0)
# 365 "/acl/lib_acl/src/db/zdb/zdb_key.c"
                 ) {
...
int zdb_key_get(ZDB *db, zdb_key_t key, ZDB_BLK_OFF *blk_off)
{
 ...
 zdb_off_t key_off;
 ZDB_KEY_STORE *store = 
# 411 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
                       ((void *)0)
# 411 "/acl/lib_acl/src/db/zdb/zdb_key.c"
                           ;
 int ret, inode;
# 421 "/acl/lib_acl/src/db/zdb/zdb_key.c"
 store = zdb_key_store_open(db, key);
 if (store == 
# 422 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
             ((void *)0)
# 422 "/acl/lib_acl/src/db/zdb/zdb_key.c"
                 ) {
  acl_msg_error("%s(%d): open key(" "%lld" ") store error",
   myname, 424, key);
  do { if (store) zdb_key_store_close(store); return ((-1)); } while (0);
...
int zdb_key_status(ZDB *db, const char *filepath, ZDB_KEY_HDR *key_hdr)
{
 ...
 if (store == 
# 482 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
             ((void *)0)
# 482 "/acl/lib_acl/src/db/zdb/zdb_key.c"
                 ) {
...
int zdb_key_check3(ZDB *db, const char *filepath, ZDB_KEY_HDR *key_hdr)
{
 ...
 store = zdb_key_store_open2(db, filepath);
 if (store == 
# 533 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
             ((void *)0)
# 533 "/acl/lib_acl/src/db/zdb/zdb_key.c"
                 ) {
  acl_msg_error("%s(%d): open %s error(%s)",
...
int zdb_key_init(ZDB *db, zdb_key_t key_begin, zdb_key_t key_end)
{
 ...
 for (key = key_begin; key < key_end;) {
  ...
  if (store == 
# 634 "/acl/lib_acl/src/db/zdb/zdb_key.c" 3 4
              ((void *)0)
# 634 "/acl/lib_acl/src/db/zdb/zdb_key.c"
                  ) {
   acl_msg_error("%s(%d): acl_fhandle_open %s error(%s)",
