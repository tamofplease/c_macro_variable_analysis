# 1 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c" 2
# 33 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
...
# 34 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c" 2
...
# 84 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
  if (acl_vstream_fseek(((io)->store->fhandle.fp), blk->off, 
# 84 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                                                0
# 84 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
                                                        ) < 0) {
   acl_msg_error("%s(%d): fseek %s error(%s), off: " "%lld",
    myname, 86, ((((((io)->store)->fhandle.fp))->path ? ((((io)->store)->fhandle.fp))->path : "")),
    acl_last_serror(), blk->off);
  } else if ((ret = acl_vstream_writen(((io)->store->fhandle.fp), blk->dat, blk->dlen))
    == (-1))
  {
   acl_msg_error("%s(%d): readn from %s, ret(%d) != size(%d),"
    " off(" "%lld" "), error(%s)", myname, 92,
    ((((((io)->store)->fhandle.fp))->path ? ((((io)->store)->fhandle.fp))->path : "")), ret, (int) blk->dlen,
 ...
 if (blk->io->dat_slice)
  ...
  do { if (blk->dat) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_io.c", 102, (blk->dat)); (blk->dat) = 
# 102 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
 ((void *)0)
# 102 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
 ; } } while (0);
 if (blk->io->blk_slice)
  acl_slice_free2(blk->io->blk_slice, blk);
 else
  do { if (blk) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_io.c", 106, (blk)); (blk) = 
# 106 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
 ((void *)0)
# 106 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
 ; } } while (0);
 __n--;
}
...
static ZDB_IO_BLK *io_blk_new(ZDB_IO *io)
{
 ...
 if (io->blk_slice)
  ...
  blk = (ZDB_IO_BLK*) acl_malloc_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_io.c", 117, sizeof(ZDB_IO_BLK));
 if (io->dat_slice)
  blk->dat = (char*) acl_slice_alloc(io->dat_slice);
 else
  blk->dat = (char*) acl_malloc_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_io.c", 121, io->blk_len);
...
static void free_blk_cache(const ACL_CACHE_INFO *info __attribute__ ((__unused__)), void *arg)
{
...
void zdb_io_cache_open(ZDB_STORE *store, size_t blk_len)
{
 ZDB_IO *io = (ZDB_IO*) acl_calloc_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_io.c", 153, 1, sizeof(ZDB_IO));

 unsigned int flag = (1 << 1) | (1 << 10) | (1 << 11);
...
# 167 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
  __builtin_offsetof (
# 167 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
  ZDB_IO_BLK
# 167 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
  , 
# 167 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
...
# 167 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
 ...
 if ((store->flag & (1 << 2))) {
  ...
  io->blk_slice = 
# 176 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                 ((void *)0)
# 176 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
                     ;
  io->dat_slice = 
# 177 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                 ((void *)0)
# 177 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
                     ;
 }
...
void zdb_io_cache_close(ZDB_STORE *store)
{
 ...
 do { if (store->io) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_io.c", 196, (store->io)); (store->io) = 
# 196 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
((void *)0)
# 196 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
; } } while (0);
}
...
int zdb_io_cache_sync(ZDB_STORE *store)
{
 ...
 while (1) {
  ...
  if (blk_first == 
# 212 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                  ((void *)0)
# 212 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
                      )
   break;
  ...
  n = 0;
  while (1) {
   blk_next = (ZDB_IO_BLK*) avl_walk(&io->blk_tree, blk_iter, (1));
   if (blk_next == 
# 223 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                  ((void *)0)
# 223 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
                      )
    break;
...
# 247 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
  if (acl_vstream_fseek(((io)->store->fhandle.fp), off, 
# 247 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                                           0
# 247 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
                                                   ) < 0) {
   acl_msg_error("%s(%d): fseek %s error(%s), off: " "%lld",
    myname, 249, ((((((io)->store)->fhandle.fp))->path ? ((((io)->store)->fhandle.fp))->path : "")), acl_last_serror(), off);
   return (-1);
  }

  ret = acl_vstream_writen(((io)->store->fhandle.fp), ((char *) ((io->buf))->vbuf.data), (size_t) (((io->buf))->vbuf.ptr - ((io->buf))->vbuf.data));
  if (ret == (-1)) {
   acl_msg_error("%s(%d): readn from %s, ret(%d) != size(%d),"
    " off(" "%lld" "), error(%s)", myname, 256,
    ((((((io)->store)->fhandle.fp))->path ? ((((io)->store)->fhandle.fp))->path : "")), ret, (int) (size_t) (((io->buf))->vbuf.ptr - ((io->buf))->vbuf.data),
    off, acl_last_serror());
   return (-1);
  }


  dlen += (int) (size_t) (((io->buf))->vbuf.ptr - ((io->buf))->vbuf.data);
  if (n == 0) {
 ...
 size_t size, zdb_off_t off)
{
 ...
 blk = (ZDB_IO_BLK*) acl_cache_find(io->blk_cache, key);
 if (blk != 
# 348 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
           ((void *)0) 
# 348 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
                && blk->dlen >= size) {
...
int zdb_write(ZDB_STORE *store, const void *buf, size_t len, zdb_off_t off)
{
 ...
 if (store->io != 
# 361 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                 ((void *)0)
# 361 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
                     ) {
  ret = zdb_io_cache_write(store->io, buf, len, off);
  if (ret > 0)
   return (ret);
 }
# 376 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
 if (acl_vstream_fseek(((store)->fhandle.fp), off, 
# 376 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                                                0
# 376 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
                                                        ) < 0) {
  acl_msg_error("%s(%d): fseek %s error(%s), off: " "%lld",
   myname, 378, ((((store)->fhandle.fp))->path ? (((store)->fhandle.fp))->path : ""), acl_last_serror(), off);
  return ((-1));
 }

 ret = acl_vstream_writen(((store)->fhandle.fp), buf, len);
 if (ret == (-1)) {
  acl_msg_error("%s(%d): readn from %s, ret(%d) != size(%d),"
   " off(" "%lld" "), error(%s)", myname, 385,
   ((((store)->fhandle.fp))->path ? (((store)->fhandle.fp))->path : ""), ret, (int) len, off, acl_last_serror());
  return ((-1));
 }
...
int zdb_read(ZDB_STORE *store, void *buf, size_t size, zdb_off_t off)
{
 ...
 if (store->io != 
# 399 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                 ((void *)0)
# 399 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
                     ) {
  ret = zdb_io_cache_read(store->io, buf, size, off);
  if (ret > 0)
   return (ret);
 }
# 414 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
 if (acl_vstream_fseek(((store)->fhandle.fp), off, 
# 414 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                                                0
# 414 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
                                                        ) < 0) {
  acl_msg_error("%s(%d): fseek %s error(%s), off: " "%lld",
   myname, 416, ((((store)->fhandle.fp))->path ? (((store)->fhandle.fp))->path : ""), acl_last_serror(), off);
  return ((-1));
 }

 ret = acl_vstream_readn(((store)->fhandle.fp), buf, size);
 if (ret == (-1)) {
  acl_msg_error("%s(%d): readn from %s, ret(%d) != size(%d),"
   " off(" "%lld" "), error(%s)", myname, 423,
   ((((store)->fhandle.fp))->path ? (((store)->fhandle.fp))->path : ""), ret, (int) size, off, acl_last_serror());
  return ((-1));
 }


 if (store->io != 
# 429 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                 ((void *)0)
# 429 "/workspace/acl/lib_acl/src/db/zdb/zdb_io.c"
                     ) {
