# 0 "/acl/lib_acl/src/db/zdb/zdb_io.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/db/zdb/zdb_io.c"
...
# 2 "/acl/lib_acl/src/db/zdb/zdb_io.c" 2
# 33 "/acl/lib_acl/src/db/zdb/zdb_io.c"
...
# 34 "/acl/lib_acl/src/db/zdb/zdb_io.c" 2
...
# 84 "/acl/lib_acl/src/db/zdb/zdb_io.c"
  if (acl_vstream_fseek(((io)->store->fhandle.fp), blk->off, 
# 84 "/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                                                0
# 84 "/acl/lib_acl/src/db/zdb/zdb_io.c"
                                                        ) < 0) {
 ...
 if (blk->io->dat_slice)
  ...
  do { if (blk->dat) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_io.c", 102, (blk->dat)); (blk->dat) = 
# 102 "/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
 ((void *)0)
# 102 "/acl/lib_acl/src/db/zdb/zdb_io.c"
 ; } } while (0);
 if (blk->io->blk_slice)
  acl_slice_free2(blk->io->blk_slice, blk);
 else
  do { if (blk) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_io.c", 106, (blk)); (blk) = 
# 106 "/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
 ((void *)0)
# 106 "/acl/lib_acl/src/db/zdb/zdb_io.c"
 ; } } while (0);
 __n--;
}
...
static ZDB_IO_BLK *io_blk_new(ZDB_IO *io)
{
 ...
 if (io->blk_slice)
  ...
  blk = (ZDB_IO_BLK*) acl_malloc_glue("/acl/lib_acl/src/db/zdb/zdb_io.c", 117, sizeof(ZDB_IO_BLK));
 if (io->dat_slice)
  blk->dat = (char*) acl_slice_alloc(io->dat_slice);
 else
  blk->dat = (char*) acl_malloc_glue("/acl/lib_acl/src/db/zdb/zdb_io.c", 121, io->blk_len);
...
void zdb_io_cache_open(ZDB_STORE *store, size_t blk_len)
{
 ZDB_IO *io = (ZDB_IO*) acl_calloc_glue("/acl/lib_acl/src/db/zdb/zdb_io.c", 153, 1, sizeof(ZDB_IO));
...
# 167 "/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
  __builtin_offsetof (
# 167 "/acl/lib_acl/src/db/zdb/zdb_io.c"
  ZDB_IO_BLK
# 167 "/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
  , 
# 167 "/acl/lib_acl/src/db/zdb/zdb_io.c"
...
# 167 "/acl/lib_acl/src/db/zdb/zdb_io.c"
 ...
 if ((store->flag & (1 << 2))) {
  ...
  io->blk_slice = 
# 176 "/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                 ((void *)0)
# 176 "/acl/lib_acl/src/db/zdb/zdb_io.c"
                     ;
  io->dat_slice = 
# 177 "/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                 ((void *)0)
# 177 "/acl/lib_acl/src/db/zdb/zdb_io.c"
                     ;
 }
...
void zdb_io_cache_close(ZDB_STORE *store)
{
 ...
 do { if (store->io) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_io.c", 196, (store->io)); (store->io) = 
# 196 "/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
((void *)0)
# 196 "/acl/lib_acl/src/db/zdb/zdb_io.c"
; } } while (0);
}
...
int zdb_io_cache_sync(ZDB_STORE *store)
{
 ...
 while (1) {
  ...
  if (blk_first == 
# 212 "/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                  ((void *)0)
# 212 "/acl/lib_acl/src/db/zdb/zdb_io.c"
                      )
   break;
  ...
  while (1) {
   ...
   if (blk_next == 
# 223 "/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                  ((void *)0)
# 223 "/acl/lib_acl/src/db/zdb/zdb_io.c"
                      )
    break;
...
# 247 "/acl/lib_acl/src/db/zdb/zdb_io.c"
  if (acl_vstream_fseek(((io)->store->fhandle.fp), off, 
# 247 "/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                                           0
# 247 "/acl/lib_acl/src/db/zdb/zdb_io.c"
                                                   ) < 0) {
   acl_msg_error("%s(%d): fseek %s error(%s), off: " "%lld",
 ...
 size_t size, zdb_off_t off)
{
 ...
 blk = (ZDB_IO_BLK*) acl_cache_find(io->blk_cache, key);
 if (blk != 
# 348 "/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
           ((void *)0) 
# 348 "/acl/lib_acl/src/db/zdb/zdb_io.c"
                && blk->dlen >= size) {
...
int zdb_write(ZDB_STORE *store, const void *buf, size_t len, zdb_off_t off)
{
 ...
 if (store->io != 
# 361 "/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                 ((void *)0)
# 361 "/acl/lib_acl/src/db/zdb/zdb_io.c"
                     ) {
  ret = zdb_io_cache_write(store->io, buf, len, off);
  if (ret > 0)
   return (ret);
 }
# 376 "/acl/lib_acl/src/db/zdb/zdb_io.c"
 if (acl_vstream_fseek(((store)->fhandle.fp), off, 
# 376 "/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                                                0
# 376 "/acl/lib_acl/src/db/zdb/zdb_io.c"
                                                        ) < 0) {
  acl_msg_error("%s(%d): fseek %s error(%s), off: " "%lld",
...
int zdb_read(ZDB_STORE *store, void *buf, size_t size, zdb_off_t off)
{
 ...
 if (store->io != 
# 399 "/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                 ((void *)0)
# 399 "/acl/lib_acl/src/db/zdb/zdb_io.c"
                     ) {
  ret = zdb_io_cache_read(store->io, buf, size, off);
  if (ret > 0)
   return (ret);
 }
# 414 "/acl/lib_acl/src/db/zdb/zdb_io.c"
 if (acl_vstream_fseek(((store)->fhandle.fp), off, 
# 414 "/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                                                0
# 414 "/acl/lib_acl/src/db/zdb/zdb_io.c"
                                                        ) < 0) {
  acl_msg_error("%s(%d): fseek %s error(%s), off: " "%lld",
 ...
 if (store->io != 
# 429 "/acl/lib_acl/src/db/zdb/zdb_io.c" 3 4
                 ((void *)0)
# 429 "/acl/lib_acl/src/db/zdb/zdb_io.c"
                     ) {
