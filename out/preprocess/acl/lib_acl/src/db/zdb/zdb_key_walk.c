# 1 "/workspace/acl/lib_acl/src/db/zdb/zdb_key_walk.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/db/zdb/zdb_key_walk.c" 2
# 16 "/workspace/acl/lib_acl/src/db/zdb/zdb_key_walk.c"
...
# 17 "/workspace/acl/lib_acl/src/db/zdb/zdb_key_walk.c" 2
...
int zdb_key_walk(ZDB *db, int (*walk_fn)(ZDB_KEY_STORE*))
{
 ...
 ZDB_KEY_STORE *store;
 ACL_SCAN_DIR *scan = 
# 22 "/workspace/acl/lib_acl/src/db/zdb/zdb_key_walk.c" 3 4
                     ((void *)0)
# 22 "/workspace/acl/lib_acl/src/db/zdb/zdb_key_walk.c"
                         ;
 const char *fname;
 char pathbuf[256];
 int ret = 0;
 ...
 if (scan == 
# 28 "/workspace/acl/lib_acl/src/db/zdb/zdb_key_walk.c" 3 4
            ((void *)0)
# 28 "/workspace/acl/lib_acl/src/db/zdb/zdb_key_walk.c"
                ) {
 ...
 while (1) {
  ...
  if (fname == 
# 36 "/workspace/acl/lib_acl/src/db/zdb/zdb_key_walk.c" 3 4
              ((void *)0)
# 36 "/workspace/acl/lib_acl/src/db/zdb/zdb_key_walk.c"
                  ) {
   acl_msg_info("%s: scan over for %s\n", myname, db->key_path);
   break;
  }
  if (acl_strrncasecmp(fname, ".key", 4) != 0) {
  ...
  if (store == 
# 48 "/workspace/acl/lib_acl/src/db/zdb/zdb_key_walk.c" 3 4
              ((void *)0)
# 48 "/workspace/acl/lib_acl/src/db/zdb/zdb_key_walk.c"
                  ) {
