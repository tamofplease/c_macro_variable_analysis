# 0 "/acl/lib_acl/src/db/zdb/zdb_key_walk.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/db/zdb/zdb_key_walk.c"
...
# 2 "/acl/lib_acl/src/db/zdb/zdb_key_walk.c" 2
# 16 "/acl/lib_acl/src/db/zdb/zdb_key_walk.c"
...
# 17 "/acl/lib_acl/src/db/zdb/zdb_key_walk.c" 2
...
int zdb_key_walk(ZDB *db, int (*walk_fn)(ZDB_KEY_STORE*))
{
 ...
 ZDB_KEY_STORE *store;
 ACL_SCAN_DIR *scan = 
# 22 "/acl/lib_acl/src/db/zdb/zdb_key_walk.c" 3 4
                     ((void *)0)
# 22 "/acl/lib_acl/src/db/zdb/zdb_key_walk.c"
                         ;
 const char *fname;
 char pathbuf[256];
 int ret = 0;
 ...
 if (scan == 
# 28 "/acl/lib_acl/src/db/zdb/zdb_key_walk.c" 3 4
            ((void *)0)
# 28 "/acl/lib_acl/src/db/zdb/zdb_key_walk.c"
                ) {
 ...
 while (1) {
  ...
  if (fname == 
# 36 "/acl/lib_acl/src/db/zdb/zdb_key_walk.c" 3 4
              ((void *)0)
# 36 "/acl/lib_acl/src/db/zdb/zdb_key_walk.c"
                  ) {
  ...
  if (store == 
# 48 "/acl/lib_acl/src/db/zdb/zdb_key_walk.c" 3 4
              ((void *)0)
# 48 "/acl/lib_acl/src/db/zdb/zdb_key_walk.c"
                  ) {
