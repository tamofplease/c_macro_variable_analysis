# 0 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
...
# 2 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 2
# 18 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
# 1 "/acl/lib_acl/src/db/zdb/zdb_private.h" 1





# 1 "/acl/lib_acl/include/db/zdb.h" 1




# 1 "/acl/lib_acl/include/db/../stdlib/acl_vstring.h" 1
# 6 "/acl/lib_acl/include/db/zdb.h" 2
# 1 "/acl/lib_acl/include/db/../stdlib/acl_fhandle.h" 1
# 7 "/acl/lib_acl/include/db/zdb.h" 2
...
# 186 "/acl/lib_acl/include/db/zdb.h"
} ZDB_BLK_HDR;
...
# 250 "/acl/lib_acl/include/db/zdb.h"
 void zdb_test(const char *cmd);
# 259 "/acl/lib_acl/include/db/zdb.h"
 void zdb_init(void);
...
# 279 "/acl/lib_acl/include/db/zdb.h"
...
# 407 "/acl/lib_acl/include/db/zdb.h"
...
# 504 "/acl/lib_acl/include/db/zdb.h"
 void zdb_dat_iter_set(ZDB_DAT_STORE *store, int read_data);
# 7 "/acl/lib_acl/src/db/zdb/zdb_private.h" 2
# 20 "/acl/lib_acl/src/db/zdb/zdb_private.h"
typedef const void *(*STORE_ITER)(ACL_ITER*, ZDB_STORE*);
# 149 "/acl/lib_acl/src/db/zdb/zdb_private.h"
int zdb_disk_select(ZDB *db);
# 172 "/acl/lib_acl/src/db/zdb/zdb_private.h"
...
# 57 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                                       ((void *)0)
# 57 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                                           ) {
  if (size < 16)
   size = 16;
  db->dat_disks[idisk].dat_ifiles = (int*)
   acl_calloc_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 61, size, sizeof(int));
 ...
 if (size < db->dat_disks[idisk].dat_ifiles_size)
  return;
 db->dat_disks[idisk].dat_ifiles = (int*)
  acl_realloc_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 69, (db->dat_disks[idisk].dat_ifiles), size * sizeof(int));
...
# 115 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
...
# 119 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                                   ((void *)0)
# 119 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                                       ;

 buf_safe = (ACL_VSTRING*) acl_pthread_tls_get(&buf_key);
 if (buf_safe == 
# 122 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                ((void *)0)
# 122 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                    ) {
  if (buf_key == (acl_pthread_key_t) 0xffffffff) {
   if (__buf_unsafe == 
# 124 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                      ((void *)0)
# 124 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                          )
 ...
 if (buf == 
# 133 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
           ((void *)0)
# 133 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
               )
  buf = buf_safe;
...
# 153 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
static ACL_VSTRING *dat_path(ZDB *db, ACL_VSTRING *buf, int idisk, int inode __attribute__ ((__unused__)))
{
 static acl_pthread_key_t buf_key = (acl_pthread_key_t) 0xffffffff;
 ACL_VSTRING *buf_safe;
 static ACL_VSTRING *__buf_unsafe = 
# 157 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                                   ((void *)0)
# 157 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                                       ;

 buf_safe = (ACL_VSTRING*) acl_pthread_tls_get(&buf_key);
 if (buf_safe == 
# 160 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                ((void *)0)
# 160 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                    ) {
  if (buf_key == (acl_pthread_key_t) 0xffffffff) {
   if (__buf_unsafe == 
# 162 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                      ((void *)0)
# 162 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                          )
    __buf_unsafe = acl_vstring_alloc(256);
   buf_safe = __buf_unsafe;
  } else {
 ...
 if (buf == 
# 171 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
           ((void *)0)
# 171 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
               )
  buf = buf_safe;
...
# 462 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
...
# 491 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                                                            2
# 491 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                                                                    ) < 0) {
 ...
 blk = (ZDB_BLK*) acl_calloc_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 500, 1, (size_t) ( ((zdb_off_t) ((store))->hdr.blk_hdr_dlen) + (zdb_off_t) (store)->hdr.blk_dlen * (zdb_off_t) (store)->hdr.blk_count ));
 ...
 if ((((ZDB_STORE*) store)->db->oflags & (1 << 2)) == 0) {
  for (i = store->hdr.size; i < count; i++) {
   ...
   if (ret == (-1)) {
    do { if (blk) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 524, (blk)); (blk) = 
# 524 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
   ((void *)0)
# 524 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
   ; } } while (0);
  ...
  for (i = store->hdr.size; i < count; i++) {
   ...
   if (ret == (-1)) {
    do { if (blk) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 552, (blk)); (blk) = 
# 552 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
   ((void *)0)
# 552 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
   ; } } while (0);
    acl_msg_error("%s(%d): write to %s error(%s)", myname,
 ...
 do { if (blk) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 561, (blk)); (blk) = 
# 561 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
((void *)0)
# 561 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
; } } while (0);
...
static int dat_store_on_open(ACL_FHANDLE *fh, void *arg)
{
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): %s, read key header from %s error(%s)",
   myname, 681, "/acl/lib_acl/src/db/zdb/zdb_dat.c", (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""), acl_last_serror());
  return (-1);
 }
...
ZDB_DAT_STORE *zdb_dat_store_open(ZDB *db, const char *filepath)
{
 ...
 if (store == 
# 728 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
             ((void *)0)
# 728 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                 )
...
ZDB_BLK *zdb_dat_get(ZDB *db, const ZDB_BLK_OFF *blk_off, zdb_key_t *key, size_t *size)
{
 ...
 if (idisk < 0 || idisk > (1 << 8)) {
  acl_msg_error("%s(%d): idisk(%d) invalid",
   myname, 747, idisk);
  return (
# 748 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
         ((void *)0)
# 748 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
             );
 }
 ...
 if (inode < 0 || inode > (1 << 24)) {
  acl_msg_error("%s(%d): inode(%d) invalid",
   myname, 754, inode);
  return (
# 755 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
         ((void *)0)
# 755 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
             );
 }
 ...
 if (blk_off->offset < 0) {
  ...
  return (
# 762 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
         ((void *)0)
# 762 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
             );
 }
...
# 767 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                        ((void *)0)
# 767 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                            , idisk, inode, ifile);
 store = zdb_dat_store_open(db, ((char *) ((path))->vbuf.data));
 if (store == 
# 769 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
             ((void *)0)
# 769 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                 ) {
  acl_msg_error("%s(%d): open %s error(%s)",
   myname, 771, ((char *) ((path))->vbuf.data), acl_last_serror());
  return (
# 772 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
         ((void *)0)
# 772 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
             );
 }
 ...
 blk = (ZDB_BLK*) acl_calloc_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 786, 1, blk_dlen);
 ...
 if (ret == -1) {
  acl_msg_error("%s(%d): zdb_read %s error(%s), blk_off("
   ...
   idisk, inode, ifile);
  do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 803, ((blk))); ((blk)) = 
# 803 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 803 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0);
  zdb_dat_store_close(store);
  return (
# 805 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
         ((void *)0)
# 805 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
             );
 }
...
int zdb_dat_add(ZDB *db, zdb_key_t key, const void *dat, int len)
{
 ...
 ZDB_DAT_STORE *store = 
# 820 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                       ((void *)0)
# 820 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                           , *store_tmp;
 int n, blk_dlen, idisk, inode, ifile;
 ZDB_BLK *blk = 
# 822 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
               ((void *)0)
# 822 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                   ;
 ZDB_BLK_OFF blk_off;
 zdb_off_t off;
 zdb_lnk_t ilnk;
 const ACL_VSTRING *path;
# 841 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 inode = dat_inode(db, len);
 if (inode < 0) {
  acl_msg_error("%s(%d): inode(%d) invalid, dat len(%d)",
   myname, 844, inode, len);
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 845, ((blk))); ((blk)) = 
# 845 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 845 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ...
 if (idisk < 0) {
  ...
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 856, ((blk))); ((blk)) = 
# 856 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 856 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return ((-1)); } while (0);
 }
 ...
 for (; ifile < 10000; ifile++) {
  path = dat_filepath(db, 
# 867 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                         ((void *)0)
# 867 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                             , idisk, inode, ifile);
  ...
  if (store_tmp == 
# 871 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                  ((void *)0)
# 871 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                      ) {
   acl_msg_error("%s(%d): zdb_dat_store_open %s error(%s)",
    myname, 873, ((char *) ((path))->vbuf.data), acl_last_serror());
   do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 874, ((blk))); ((blk)) = 
# 874 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
  ((void *)0)
# 874 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
  ; } } while (0); return ((-1)); } while (0);
  }
  ...
  if (store_tmp->hdr.size <= store_tmp->hdr.count) {
   ...
   if (n < 0) {
    ...
    zdb_dat_store_close(store_tmp);
    do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 893, ((blk))); ((blk)) = 
# 893 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
   ((void *)0)
# 893 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
   ; } } while (0); return ((-1)); } while (0);
   }
  }
 ...
 if (store == 
# 902 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
             ((void *)0)
# 902 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                 ) {
  acl_msg_error("%s(%d): too many ifile(%d), ZDB_DAT_FILE_LIMIT(%d),"
   " idisk(%d), inode(%d), path(%s)", myname, 904, ifile,
   10000, idisk, inode,
   acl_sane_dirname(
# 906 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                   ((void *)0)
# 906 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                       , ((char *) ((dat_path(db, 
# 906 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                         ((void *)0)
# 906 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                         , idisk, inode)))->vbuf.data)));
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 907, ((blk))); ((blk)) = 
# 907 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 907 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return ((-1)); } while (0);
 }
 ...
 if (store->hdr.ihead_idle < 0) {
  acl_msg_error("%s(%d): %s, ihead_idle(%d) invalid, limit("
   ...
   store->hdr.count);
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 916, ((blk))); ((blk)) = 
# 916 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 916 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return ((-1)); } while (0);
 }
 ...
 blk = (ZDB_BLK*) acl_malloc_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 935, blk_dlen);
 if (blk == 
# 936 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
           ((void *)0)
# 936 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
               )
 ...
 if (n == -1) {
  ...
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 948, ((blk))); ((blk)) = 
# 948 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 948 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return ((-1)); } while (0);
 }
 ...
 blk->hdr.inext_idle = -1;
# 964 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 !acl_do_debug(((500 + 2)), (2)) ? (void) 0 : acl_msg_info
 ...
 if (n == -1) {
  acl_msg_error("%s(%d): zdb_write to %s error(%s)",
   ...
   acl_last_serror());
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 977, ((blk))); ((blk)) = 
# 977 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 977 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return ((-1)); } while (0);
 }
 ...
 if (blk_off.offset < 0) {
  ...
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 990, ((blk))); ((blk)) = 
# 990 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 990 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return ((-1)); } while (0);
 }
 ...
 if (db->key_set(db, key, &blk_off) < 0) {
  ...
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 1006, ((blk))); ((blk)) = 
# 1006 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1006 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return ((-1)); } while (0);
 }

 do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 1009, ((blk))); ((blk)) = 
# 1009 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
((void *)0)
# 1009 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
; } } while (0); return ((1)); } while (0);
}
 ...
 const void *dat, size_t len)
{
 ...
 const ACL_VSTRING *path;
 ZDB_DAT_STORE *store = 
# 1018 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                       ((void *)0)
# 1018 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                           ;
 zdb_lnk_t ilnk;
 zdb_off_t off;
 ZDB_BLK *blk = 
# 1021 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
               ((void *)0)
# 1021 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                   ;
# 1032 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 idisk = (blk_off->inode >> 24) & 0xff;
 if (idisk < 0 || idisk > (1 << 8)) {
  acl_msg_error("%s(%d): idisk(%d) invalid",
   myname, 1035, idisk);
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 1036, ((blk))); ((blk)) = 
# 1036 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1036 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return (-1); } while (0);
 }
 ...
 if (inode < 0 || inode > (1 << 24)) {
  acl_msg_error("%s(%d): inode(%d) invalid",
   myname, 1042, inode);
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 1043, ((blk))); ((blk)) = 
# 1043 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1043 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return (-1); } while (0);
 }
 ...
 if (blk_off->offset < 0) {
  ...
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 1050, ((blk))); ((blk)) = 
# 1050 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1050 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return (-1); } while (0);
 }
 ...
 if (inode_new < 0) {
  ...
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 1058, ((blk))); ((blk)) = 
# 1058 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1058 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return (-1); } while (0);
 }
 ...
 path = dat_filepath(db, 
# 1066 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                        ((void *)0)
# 1066 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                            , idisk, inode, ifile);
 store = zdb_dat_store_open(db, ((char *) ((path))->vbuf.data));
 if (store == 
# 1068 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
             ((void *)0)
# 1068 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                 ) {
  acl_msg_error("%s(%d): open %s error(%s)",
   myname, 1070, ((char *) ((path))->vbuf.data), acl_last_serror());
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 1071, ((blk))); ((blk)) = 
# 1071 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1071 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return (-1); } while (0);
 }
 ...
 if (inode_new == inode) {
  ...
  if (ret == -1) {
   ...
   do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 1086, ((blk))); ((blk)) = 
# 1086 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
  ((void *)0)
# 1086 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
  ; } } while (0); return (-1); } while (0);
  }
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 1088, ((blk))); ((blk)) = 
# 1088 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1088 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return (1); } while (0);
 }
 ...
 if (store->hdr.count <= 0) {
  ...
  store->hdr.count = 0;
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 1104, ((blk))); ((blk)) = 
# 1104 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1104 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return (-1); } while (0);
 }
 ...
 blk = (ZDB_BLK*) acl_malloc_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 1112, (size_t) ( ((zdb_off_t) ((store))->hdr.blk_hdr_dlen) + (zdb_off_t) (store)->hdr.blk_dlen * (zdb_off_t) (store)->hdr.blk_count ));
 ...
 if (ret == -1) {
  ...
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 1121, ((blk))); ((blk)) = 
# 1121 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1121 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return (-1); } while (0);
 }

 blk->hdr.key = -1;
 blk->hdr.inext_idle = store->hdr.ihead_idle;
# 1139 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ...
 if (ret == -1) {
  ...
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 1155, ((blk))); ((blk)) = 
# 1155 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1155 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return (-1); } while (0);
 }
 ...
 if (db->dat_disks[idisk].count < 0) {
  ...
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 1163, ((blk))); ((blk)) = 
# 1163 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1163 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return (-1); } while (0);
 }
 ...
 do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 1169, ((blk))); ((blk)) = 
# 1169 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
((void *)0)
# 1169 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
...
int zdb_dat_stat(ZDB *db, const char *filepath, ZDB_DAT_HDR *dat_hdr)
{
 ...
 if (store == 
# 1178 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
             ((void *)0)
# 1178 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                 ) {
  acl_msg_error("%s(%d): open %s error(%s)",
...
int zdb_dat_check(ZDB_DAT_STORE *store, ZDB_DAT_HDR *dat_hdr)
{
 ...
 for (((ZDB_STORE*) store)->iter_head(&(iter), ((ZDB_STORE*) store)); (iter).ptr; ((ZDB_STORE*) store)->iter_next(&(iter), ((ZDB_STORE*) store))) {
  ...
  if (nused > 0 && nused % 10000 == 0) {
   ...
   acl_meter_time("/acl/lib_acl/src/db/zdb/zdb_dat.c", 1233, "-");
  }
 }
 ...
 if (nused != store->hdr.count) {
  acl_msg_error("%s(%d):\terror, nused(" "%lld"
   ...
   (long) (time(
# 1242 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
               ((void *)0)
# 1242 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                   ) - begin));
  failed = 1;
 } else {
...
# 1247 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                                           ((void *)0)
# 1247 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                                               ) - begin);
 }
 ...
 blk = (ZDB_BLK*) acl_malloc_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 1261, blk_len);
 ilnk = store->hdr.ihead_idle;
 while (ilnk >= 0) {
...
# 1281 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                                ((void *)0)
# 1281 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                                    ) - begin);
 else {
...
# 1284 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                                                         ((void *)0)
# 1284 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                                                             ) - begin);
 ...
 do { if ((blk)) { acl_free_glue("/acl/lib_acl/src/db/zdb/zdb_dat.c", 1292, ((blk))); ((blk)) = 
# 1292 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
((void *)0)
# 1292 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
; } } while (0);
...
int zdb_dat_check3(ZDB *db, const char *filepath, ZDB_DAT_HDR *dat_hdr)
{
 ...
 store = zdb_dat_store_open(db, filepath);
 if (store == 
# 1304 "/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
             ((void *)0)
# 1304 "/acl/lib_acl/src/db/zdb/zdb_dat.c"
                 ) {
  acl_msg_error("%s(%d): open %s error(%s)",
