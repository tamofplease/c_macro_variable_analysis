# 1 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 2
# 18 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
# 1 "/workspace/acl/lib_acl/src/db/zdb/zdb_private.h" 1





# 1 "/workspace/acl/lib_acl/include/db/zdb.h" 1




# 1 "/workspace/acl/lib_acl/include/db/../stdlib/acl_vstring.h" 1
# 6 "/workspace/acl/lib_acl/include/db/zdb.h" 2
# 1 "/workspace/acl/lib_acl/include/db/../stdlib/acl_fhandle.h" 1
# 7 "/workspace/acl/lib_acl/include/db/zdb.h" 2
...
typedef long long int zdb_off_t;


typedef long long int zdb_key_t;
...
struct ZDB_DAT_HDR {
 ...
 long long int size;
 long long int count;
 long long int reserv1;
 long long int reserv2;
 long long int reserv3;
 long long int reserv4;
 int nstep;
 int blk_hdr_dlen;
 int blk_dlen;
 int blk_count;
...
# 186 "/workspace/acl/lib_acl/include/db/zdb.h"
} ZDB_BLK_HDR;
...
# 250 "/workspace/acl/lib_acl/include/db/zdb.h"
 void zdb_test(const char *cmd);
# 259 "/workspace/acl/lib_acl/include/db/zdb.h"
 void zdb_init(void);
...
# 279 "/workspace/acl/lib_acl/include/db/zdb.h"
...
# 303 "/workspace/acl/lib_acl/include/db/zdb.h"
 ZDB_BLK *zdb_lookup(ZDB *db, zdb_key_t key, size_t *size, ZDB_BLK_OFF *blk_off_buf);
# 329 "/workspace/acl/lib_acl/include/db/zdb.h"
 int zdb_update(ZDB *db, zdb_key_t key, const ZDB_BLK_OFF *blk_off_saved,
 const void *dat, size_t len);
# 339 "/workspace/acl/lib_acl/include/db/zdb.h"
...
# 407 "/workspace/acl/lib_acl/include/db/zdb.h"
...
# 445 "/workspace/acl/lib_acl/include/db/zdb.h"
 ZDB_BLK *zdb_dat_get(ZDB *db, const ZDB_BLK_OFF *blk_off,
 zdb_key_t *key, size_t *size);
# 456 "/workspace/acl/lib_acl/include/db/zdb.h"
 int zdb_dat_add(ZDB *db, zdb_key_t key, const void *dat, int len);
# 467 "/workspace/acl/lib_acl/include/db/zdb.h"
 int zdb_dat_update(ZDB *db, zdb_key_t key, const ZDB_BLK_OFF *blk_off,
 const void *dat, size_t len);
# 477 "/workspace/acl/lib_acl/include/db/zdb.h"
 int zdb_dat_stat(ZDB *db, const char *filepath, ZDB_DAT_HDR *dat_hdr);
# 486 "/workspace/acl/lib_acl/include/db/zdb.h"
 ...
 int zdb_key_walk(ZDB *db, int (*walk_fn)(ZDB_KEY_STORE *store));


 int zdb_dat_walk(ZDB *db, int (*walk_fn)(ZDB_DAT_STORE *store));
# 504 "/workspace/acl/lib_acl/include/db/zdb.h"
 void zdb_dat_iter_set(ZDB_DAT_STORE *store, int read_data);
# 7 "/workspace/acl/lib_acl/src/db/zdb/zdb_private.h" 2
# 20 "/workspace/acl/lib_acl/src/db/zdb/zdb_private.h"
typedef const void *(*STORE_ITER)(ACL_ITER*, ZDB_STORE*);
# 149 "/workspace/acl/lib_acl/src/db/zdb/zdb_private.h"
int zdb_disk_select(ZDB *db);
# 172 "/workspace/acl/lib_acl/src/db/zdb/zdb_private.h"
...
# 184 "/workspace/acl/lib_acl/src/db/zdb/zdb_private.h"
int zdb_write(ZDB_STORE *store, const void *buf, size_t len, zdb_off_t off);
# 194 "/workspace/acl/lib_acl/src/db/zdb/zdb_private.h"
int zdb_read(ZDB_STORE *store, void *buf, size_t size, zdb_off_t off);
# 19 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 2
...
int dat_store_header_sync(ZDB_DAT_STORE *store)
{
 ...
 if (ret == -1)
  acl_msg_error("%s(%d): zdb_write to %s error(%s)", myname,
   28, ((((&store->store)->fhandle.fp))->path ? (((&store->store)->fhandle.fp))->path : ""), acl_last_serror());
 return (ret);
}
...
static void dat_ifiles_space(ZDB *db, int idisk, int size)
{
 ...
 if (db->dat_disks[idisk].dat_ifiles == 
# 57 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                                       ((void *)0)
# 57 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                                           ) {
  if (size < 16)
   size = 16;
  db->dat_disks[idisk].dat_ifiles = (int*)
   acl_calloc_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 61, size, sizeof(int));
 ...
 if (size < db->dat_disks[idisk].dat_ifiles_size)
  return;
 db->dat_disks[idisk].dat_ifiles = (int*)
  acl_realloc_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 69, (db->dat_disks[idisk].dat_ifiles), size * sizeof(int));
...
static int dat_inode(ZDB *db, int len)
{
 ...
 if (inode > (1 << 24)) {
  acl_msg_error("%s(%d): inode(%d) > %u, too large",
   myname, 100, inode, (1 << 24));
  return (-1);
 }

 return (inode);
}
# 115 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
static ACL_VSTRING *dat_filepath(ZDB *db, ACL_VSTRING *buf, int idisk, int inode, int ifile)
{
 static acl_pthread_key_t buf_key = (acl_pthread_key_t) 0xffffffff;
 ACL_VSTRING *buf_safe;
 static ACL_VSTRING *__buf_unsafe = 
# 119 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                                   ((void *)0)
# 119 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                                       ;

 buf_safe = (ACL_VSTRING*) acl_pthread_tls_get(&buf_key);
 if (buf_safe == 
# 122 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                ((void *)0)
# 122 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                    ) {
  if (buf_key == (acl_pthread_key_t) 0xffffffff) {
   if (__buf_unsafe == 
# 124 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                      ((void *)0)
# 124 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                          )
 ...
 if (buf == 
# 133 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
           ((void *)0)
# 133 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
               )
  buf = buf_safe;
...
# 153 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
static ACL_VSTRING *dat_path(ZDB *db, ACL_VSTRING *buf, int idisk, int inode __attribute__ ((__unused__)))
{
 static acl_pthread_key_t buf_key = (acl_pthread_key_t) 0xffffffff;
 ACL_VSTRING *buf_safe;
 static ACL_VSTRING *__buf_unsafe = 
# 157 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                                   ((void *)0)
# 157 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                                       ;

 buf_safe = (ACL_VSTRING*) acl_pthread_tls_get(&buf_key);
 if (buf_safe == 
# 160 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                ((void *)0)
# 160 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                    ) {
  if (buf_key == (acl_pthread_key_t) 0xffffffff) {
   if (__buf_unsafe == 
# 162 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                      ((void *)0)
# 162 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                          )
    __buf_unsafe = acl_vstring_alloc(256);
   buf_safe = __buf_unsafe;
  } else {
 ...
 if (buf == 
# 171 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
           ((void *)0)
# 171 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
               )
  buf = buf_safe;
...
# 462 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
static int dat_store_blk_add(ZDB_DAT_STORE *store, long long int count)
{
 ...
 if (count <= 0) {
  acl_msg_error("%s(%d): count(" "%lld" ") invalid",
   myname, 472, count);
  return (-1);
 }
 ...
 if (store->hdr.size >= store->hdr.limit) {
  acl_msg_error("%s(%d): store(%s)'s size(" "%lld"
   ") >= limit(" "%lld" ")",
   myname, 480, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""),
   store->hdr.size, store->hdr.limit);
  return (-1);
 }

 count += store->hdr.size;
 if (count > store->hdr.limit)
  count = store->hdr.limit;

 if ((((ZDB_STORE*) store)->db->oflags & (1 << 2)) == 0) {

  if (acl_vstream_fseek(((ZDB_STORE*) store)->fhandle.fp, 0, 
# 491 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                                                            2
# 491 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                                                                    ) < 0) {
   acl_msg_error("%s(%d): fseek %s error(%s)",
    myname, 493, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""),
    acl_last_serror());
   return (-1);
  }
 }
 ...
 blk = (ZDB_BLK*) acl_calloc_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 500, 1, (size_t) ( ((zdb_off_t) ((store))->hdr.blk_hdr_dlen) + (zdb_off_t) (store)->hdr.blk_dlen * (zdb_off_t) (store)->hdr.blk_count ));
 ...
 if ((((ZDB_STORE*) store)->db->oflags & (1 << 2)) == 0) {
  for (i = store->hdr.size; i < count; i++) {
   ...
   store->hdr.ihead_idle = (zdb_lnk_t) i;

   ret = acl_vstream_buffed_writen(((ZDB_STORE*) store)->fhandle.fp,
     blk, (size_t) ( ((zdb_off_t) ((store))->hdr.blk_hdr_dlen) + (zdb_off_t) (store)->hdr.blk_dlen * (zdb_off_t) (store)->hdr.blk_count ));
   if (ret == (-1)) {
    do { if (blk) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 524, (blk)); (blk) = 
# 524 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
   ((void *)0)
# 524 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
   ; } } while (0);
    acl_msg_error("%s(%d): write to %s error(%s)", myname,
     526, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""),
     acl_last_serror());
    return (-1);
   }
  }
  ...
  for (i = store->hdr.size; i < count; i++) {
   ...
   ret = zdb_write((ZDB_STORE*) store, blk, (size_t) ((zdb_off_t) (store)->hdr.blk_hdr_dlen),
     ( (zdb_off_t) sizeof(ZDB_DAT_HDR) + ( ((zdb_off_t) (((store)))->hdr.blk_hdr_dlen) + (zdb_off_t) ((store))->hdr.blk_dlen * (zdb_off_t) ((store))->hdr.blk_count ) * (zdb_off_t) ((i)) ));
   if (ret == (-1)) {
    do { if (blk) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 552, (blk)); (blk) = 
# 552 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
   ((void *)0)
# 552 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
   ; } } while (0);
    acl_msg_error("%s(%d): write to %s error(%s)", myname,
     554, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""),
     acl_last_serror());
    return (-1);
   }
  }
 ...
 do { if (blk) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 561, (blk)); (blk) = 
# 561 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
((void *)0)
# 561 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
; } } while (0);

 if ((((ZDB_STORE*) store)->db->oflags & (1 << 2)) == 0) {

  if (acl_vstream_fflush(((ZDB_STORE*)store)->fhandle.fp) == (-1)) {
   acl_msg_error("%s(%d): fflush to %s error %s",
    myname, 567, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""),
    acl_last_serror());
   return (-1);
  }
 }

 store->hdr.size = count;
 return (0);
}
...
static int dat_store_init(ZDB_DAT_STORE *store, ZDB *db)
{
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): write header to %s error(%s)",
   myname, 612, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""),
   acl_last_serror());
  return (-1);
 }
...
static int dat_store_on_open(ACL_FHANDLE *fh, void *arg)
{
 ...
 ((ZDB_STORE*) store)->flag = (1 << 1);
 if ((db->oflags & (1 << 5)))
  ((ZDB_STORE*) store)->flag |= (1 << 2);



 if (fh->fsize == 0) {
  !acl_do_debug(((500 + 4)), (1)) ? (void) 0 : acl_msg_info ("%s: begin init %s ...",
   myname, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""));
  if (dat_store_init(store, db) < 0) {
   acl_msg_error("%s(%d): %s, dat_store_init error",
    myname, 648, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""));
   return (-1);
  }
  !acl_do_debug(((500 + 4)), (1)) ? (void) 0 : acl_msg_info ("%s: init %s ok",
   myname, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""));
  ...
  if ((db->oflags & (1 << 2)) != 0) {
   ...
   zdb_io_cache_open((ZDB_STORE*) store, (size_t) ( ((zdb_off_t) ((store))->hdr.blk_hdr_dlen) + (zdb_off_t) (store)->hdr.blk_dlen * (zdb_off_t) (store)->hdr.blk_count ));
  }
 ...
 if (ret == (-1)) {
  acl_msg_error("%s(%d): %s, read key header from %s error(%s)",
   myname, 681, "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""), acl_last_serror());
  return (-1);
 }
...
static void dat_store_on_close(ACL_FHANDLE *fh)
{
 ...
 !acl_do_debug(((500 + 4)), (2)) ? (void) 0 : acl_msg_info ("%s(%d): sync header ok, close %s now",
  myname, 708, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""));
}
...
ZDB_DAT_STORE *zdb_dat_store_open(ZDB *db, const char *filepath)
{
 ...
 if (store == 
# 728 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
             ((void *)0)
# 728 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                 )
  acl_msg_error("%s(%d): open file(%s) error(%s)",
   myname, 730, filepath, acl_last_serror());
 return (store);
}
...
ZDB_BLK *zdb_dat_get(ZDB *db, const ZDB_BLK_OFF *blk_off, zdb_key_t *key, size_t *size)
{
 ...
 idisk = (blk_off->inode >> 24) & 0xff;
 if (idisk < 0 || idisk > (1 << 8)) {
  acl_msg_error("%s(%d): idisk(%d) invalid",
   myname, 747, idisk);
  return (
# 748 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
         ((void *)0)
# 748 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
             );
 }

 inode = blk_off->inode & 0xffffff;
 if (inode < 0 || inode > (1 << 24)) {
  acl_msg_error("%s(%d): inode(%d) invalid",
   myname, 754, inode);
  return (
# 755 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
         ((void *)0)
# 755 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
             );
 }


 if (blk_off->offset < 0) {
  acl_msg_error("%s(%d): blk_off_old(" "%lld" ") invalid",
   myname, 761, blk_off->offset);
  return (
# 762 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
         ((void *)0)
# 762 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
             );
 }

 ifile = (int) blk_off->offset / (int) db->dat_limit;

 path = dat_filepath(db, 
# 767 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                        ((void *)0)
# 767 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                            , idisk, inode, ifile);
 store = zdb_dat_store_open(db, ((char *) ((path))->vbuf.data));
 if (store == 
# 769 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
             ((void *)0)
# 769 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                 ) {
  acl_msg_error("%s(%d): open %s error(%s)",
   myname, 771, ((char *) ((path))->vbuf.data), acl_last_serror());
  return (
# 772 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
         ((void *)0)
# 772 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
             );
 }



 blk_ilnk = (int) blk_off->offset - (zdb_lnk_t) db->dat_limit * ifile;
 off = ( (zdb_off_t) sizeof(ZDB_DAT_HDR) + ( ((zdb_off_t) (((store)))->hdr.blk_hdr_dlen) + (zdb_off_t) ((store))->hdr.blk_dlen * (zdb_off_t) ((store))->hdr.blk_count ) * (zdb_off_t) ((blk_ilnk)) );



 blk_dlen = (int) ( ((zdb_off_t) ((store))->hdr.blk_hdr_dlen) + (zdb_off_t) (store)->hdr.blk_dlen * (zdb_off_t) (store)->hdr.blk_count );



 blk = (ZDB_BLK*) acl_calloc_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 786, 1, blk_dlen);

 ret = zdb_read((ZDB_STORE*) store, blk, blk_dlen, off);

 !acl_do_debug(((500 + 1)), (2)) ? (void) 0 : acl_msg_info
  ("%s(%d): %s, zdb_read(%d), blk_off: " "%lld"
  ", idisk: %d, inode: %d,"
   " ifile: %d, ilnk: %d, dat_limit: " "%lld" ", blk_dlen: %d",
   myname, 794, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""), ret, off,
   idisk, inode, ifile, blk_ilnk, db->dat_limit, blk_dlen);

 if (ret == -1) {
  acl_msg_error("%s(%d): zdb_read %s error(%s), blk_off("
   "%lld" "), blk_dlen(%d), idisk: %d, inode: %d, ifile: %d",
   myname, 800, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""),
   acl_last_serror(), off, blk_dlen,
   idisk, inode, ifile);
  do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 803, ((blk))); ((blk)) = 
# 803 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 803 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0);
  zdb_dat_store_close(store);
  return (
# 805 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
         ((void *)0)
# 805 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
             );
 }
  ...
  *key = blk->hdr.key;
 if (size)
  *size = (size_t) (( ((zdb_off_t) ((store))->hdr.blk_hdr_dlen) + (zdb_off_t) (store)->hdr.blk_dlen * (zdb_off_t) (store)->hdr.blk_count ) - ((zdb_off_t) (store)->hdr.blk_hdr_dlen));
 return (blk);
}
...
int zdb_dat_add(ZDB *db, zdb_key_t key, const void *dat, int len)
{
 ...
 ZDB_DAT_STORE *store = 
# 820 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                       ((void *)0)
# 820 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                           , *store_tmp;
 int n, blk_dlen, idisk, inode, ifile;
 ZDB_BLK *blk = 
# 822 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
               ((void *)0)
# 822 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                   ;
 ZDB_BLK_OFF blk_off;
 zdb_off_t off;
 zdb_lnk_t ilnk;
 const ACL_VSTRING *path;
# 841 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 inode = dat_inode(db, len);
 if (inode < 0) {
  acl_msg_error("%s(%d): inode(%d) invalid, dat len(%d)",
   myname, 844, inode, len);
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 845, ((blk))); ((blk)) = 
# 845 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 845 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return ((-1)); } while (0);
 }


 db->blk_count_tmp = inode;



 idisk = zdb_disk_select(db);
 if (idisk < 0) {
  acl_msg_error("%s(%d): no disk available", myname, 855);
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 856, ((blk))); ((blk)) = 
# 856 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 856 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return ((-1)); } while (0);
 }
 ...
 for (; ifile < 10000; ifile++) {
  path = dat_filepath(db, 
# 867 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                         ((void *)0)
# 867 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                             , idisk, inode, ifile);
  !acl_do_debug(((500 + 2)), (2)) ? (void) 0 : acl_msg_info ("%s(%d): path(%s)",
   myname, 869, ((char *) ((path))->vbuf.data));
  store_tmp = zdb_dat_store_open(db, ((char *) ((path))->vbuf.data));
  if (store_tmp == 
# 871 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                  ((void *)0)
# 871 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                      ) {
   acl_msg_error("%s(%d): zdb_dat_store_open %s error(%s)",
    myname, 873, ((char *) ((path))->vbuf.data), acl_last_serror());
   do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 874, ((blk))); ((blk)) = 
# 874 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
  ((void *)0)
# 874 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
  ; } } while (0); return ((-1)); } while (0);
  }
  ...
  if (store_tmp->hdr.size <= store_tmp->hdr.count) {
   ...
   if (n < 0) {
    acl_msg_error("%s(%d): add blk to %s error",
     myname, 890,
     (((((ZDB_STORE*) store_tmp)->fhandle.fp))->path ? ((((ZDB_STORE*) store_tmp)->fhandle.fp))->path : ""));
    zdb_dat_store_close(store_tmp);
    do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 893, ((blk))); ((blk)) = 
# 893 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
   ((void *)0)
# 893 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
   ; } } while (0); return ((-1)); } while (0);
   }
  }

  store = store_tmp;
  db->dat_disks[idisk].dat_ifiles[inode] = ifile;
  break;
 }

 if (store == 
# 902 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
             ((void *)0)
# 902 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                 ) {
  acl_msg_error("%s(%d): too many ifile(%d), ZDB_DAT_FILE_LIMIT(%d),"
   " idisk(%d), inode(%d), path(%s)", myname, 904, ifile,
   10000, idisk, inode,
   acl_sane_dirname(
# 906 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                   ((void *)0)
# 906 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                       , ((char *) ((dat_path(db, 
# 906 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                         ((void *)0)
# 906 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                         , idisk, inode)))->vbuf.data)));
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 907, ((blk))); ((blk)) = 
# 907 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 907 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return ((-1)); } while (0);
 }

 if (store->hdr.ihead_idle < 0) {
  acl_msg_error("%s(%d): %s, ihead_idle(%d) invalid, limit("
   "%lld" "), count(" "%lld" ")", myname,
   913, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""),
   store->hdr.ihead_idle, store->hdr.limit,
   store->hdr.count);
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 916, ((blk))); ((blk)) = 
# 916 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 916 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return ((-1)); } while (0);
 }
 ...
 off = ( (zdb_off_t) sizeof(ZDB_DAT_HDR) + ( ((zdb_off_t) (((store)))->hdr.blk_hdr_dlen) + (zdb_off_t) ((store))->hdr.blk_dlen * (zdb_off_t) ((store))->hdr.blk_count ) * (zdb_off_t) ((ilnk)) );

 !acl_do_debug(((500 + 2)), (2)) ? (void) 0 : acl_msg_info
  ("%s(%d): blk_count: %d, blk_dlen: %d, blk_off(" "%lld"
  "), blk_hdr_dlen: %d, len: %d", myname, 930,
   store->hdr.blk_count, store->hdr.blk_dlen,
  off, store->hdr.blk_hdr_dlen, len);


 blk = (ZDB_BLK*) acl_malloc_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 935, blk_dlen);
 if (blk == 
# 936 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
           ((void *)0)
# 936 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
               )
  acl_msg_fatal("%s(%d): calloc error(%s)",
   myname, 938, acl_last_serror());


 n = zdb_read((ZDB_STORE*) store, blk, (size_t) ((zdb_off_t) (store)->hdr.blk_hdr_dlen), off);
 if (n == -1) {
  acl_msg_error("%s(%d): zdb_read %s error(%s), ihead_idle(%d),"
   " blk_dlen(%d), blk_off(" "%lld" "), blk_hdr_dlen(%d)",
   myname, 945, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""),
   acl_last_serror(), ilnk, blk_dlen, off,
   store->hdr.blk_hdr_dlen);
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 948, ((blk))); ((blk)) = 
# 948 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 948 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return ((-1)); } while (0);
 }
 ...
 blk->hdr.key = key;
 store->hdr.ihead_idle = blk->hdr.inext_idle;
 blk->hdr.inext_idle = -1;
# 964 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 !acl_do_debug(((500 + 2)), (2)) ? (void) 0 : acl_msg_info
  ("%s(%d): blk_off: " "%lld" ", inext: %d, key: "
  "%lld", myname, 966, off, ilnk, key);



 memcpy(blk->dat, dat, len);

 n = zdb_write((ZDB_STORE*) store, blk, blk_dlen, off);
 if (n == -1) {
  acl_msg_error("%s(%d): zdb_write to %s error(%s)",
   myname, 975, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""),
   acl_last_serror());
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 977, ((blk))); ((blk)) = 
# 977 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 977 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return ((-1)); } while (0);
 }
 ...
 blk_off.offset = ilnk + db->dat_limit * ifile;
 if (blk_off.offset < 0) {
  acl_msg_error("%s(%d): blk_off.offset(" "%lld"
   ") too large", myname, 989, blk_off.offset);
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 990, ((blk))); ((blk)) = 
# 990 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 990 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return ((-1)); } while (0);
 }

 !acl_do_debug(((500 + 2)), (2)) ? (void) 0 : acl_msg_info
  ("%s(%d): blk_off: " "%lld" ", ihead_idle: %d, dat_limit: "
  "%lld" ", inode: %d, ifile: %d",
  myname, 996, blk_off.offset, store->hdr.ihead_idle,
  db->dat_limit, inode, ifile);


 blk_off.inode = (idisk << 24) + inode;


 if (db->key_set(db, key, &blk_off) < 0) {
  acl_msg_error("%s(%d): set key store error(%s)",
   myname, 1005, acl_last_serror());
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 1006, ((blk))); ((blk)) = 
# 1006 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1006 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return ((-1)); } while (0);
 }

 do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 1009, ((blk))); ((blk)) = 
# 1009 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
((void *)0)
# 1009 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
; } } while (0); return ((1)); } while (0);
}
 ...
 const void *dat, size_t len)
{
 ...
 const ACL_VSTRING *path;
 ZDB_DAT_STORE *store = 
# 1018 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                       ((void *)0)
# 1018 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                           ;
 zdb_lnk_t ilnk;
 zdb_off_t off;
 ZDB_BLK *blk = 
# 1021 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
               ((void *)0)
# 1021 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                   ;
# 1032 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 idisk = (blk_off->inode >> 24) & 0xff;
 if (idisk < 0 || idisk > (1 << 8)) {
  acl_msg_error("%s(%d): idisk(%d) invalid",
   myname, 1035, idisk);
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 1036, ((blk))); ((blk)) = 
# 1036 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1036 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return (-1); } while (0);
 }
 ...
 if (inode < 0 || inode > (1 << 24)) {
  acl_msg_error("%s(%d): inode(%d) invalid",
   myname, 1042, inode);
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 1043, ((blk))); ((blk)) = 
# 1043 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1043 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return (-1); } while (0);
 }


 if (blk_off->offset < 0) {
  acl_msg_error("%s(%d): blk_off_old(" "%lld"
   ") invalid", myname, 1049, blk_off->offset);
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 1050, ((blk))); ((blk)) = 
# 1050 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1050 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return (-1); } while (0);
 }
 ...
 if (inode_new < 0) {
  acl_msg_error("%s(%d): inode(%d) invalid, dat len(%d)",
   myname, 1057, inode_new, (int) len);
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 1058, ((blk))); ((blk)) = 
# 1058 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1058 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return (-1); } while (0);
 }
 ...
 path = dat_filepath(db, 
# 1066 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                        ((void *)0)
# 1066 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                            , idisk, inode, ifile);
 store = zdb_dat_store_open(db, ((char *) ((path))->vbuf.data));
 if (store == 
# 1068 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
             ((void *)0)
# 1068 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                 ) {
  acl_msg_error("%s(%d): open %s error(%s)",
   myname, 1070, ((char *) ((path))->vbuf.data), acl_last_serror());
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 1071, ((blk))); ((blk)) = 
# 1071 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1071 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return (-1); } while (0);
 }
 ...
 if (inode_new == inode) {
  ...
  off = (( (zdb_off_t) sizeof(ZDB_DAT_HDR) + ( ((zdb_off_t) (((store)))->hdr.blk_hdr_dlen) + (zdb_off_t) ((store))->hdr.blk_dlen * (zdb_off_t) ((store))->hdr.blk_count ) * (zdb_off_t) ((ilnk)) ) + (zdb_off_t) sizeof(ZDB_BLK_HDR));
  ...
  if (ret == -1) {
   acl_msg_error("%s(%d): zdb_write to %s error(%s)",
    myname, 1085, ((char *) ((path))->vbuf.data), acl_last_serror());
   do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 1086, ((blk))); ((blk)) = 
# 1086 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
  ((void *)0)
# 1086 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
  ; } } while (0); return (-1); } while (0);
  }
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 1088, ((blk))); ((blk)) = 
# 1088 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1088 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return (1); } while (0);
 }
 ...
 if (store->hdr.count <= 0) {
  acl_msg_error("%s(%d): %s, store->hdr.count(" "%lld"
   ") <= 0, ihead_idle(%d), inode(%d, %d), inode_new(%d, %d),"
   " key(" "%lld" "), blk_off(" "%lld" ")",
   myname, 1099, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""),
   store->hdr.count, store->hdr.ihead_idle,
   idisk, inode, inode_new >> 8,
   inode_new & 0xffffff, key, blk_off->offset);
  store->hdr.count = 0;
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 1104, ((blk))); ((blk)) = 
# 1104 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1104 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return (-1); } while (0);
 }
 ...
 blk = (ZDB_BLK*) acl_malloc_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 1112, (size_t) ( ((zdb_off_t) ((store))->hdr.blk_hdr_dlen) + (zdb_off_t) (store)->hdr.blk_dlen * (zdb_off_t) (store)->hdr.blk_count ));


 ret = zdb_read((ZDB_STORE*) store, blk, (size_t) ((zdb_off_t) (store)->hdr.blk_hdr_dlen), off);
 if (ret == -1) {
  acl_msg_error("%s(%d): zdb_read %s error(%s),"
   " blk_hdr_dlen(%d), blk_off(" "%lld" ")",
   myname, 1119, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""),
   acl_last_serror(), (int) ((zdb_off_t) (store)->hdr.blk_hdr_dlen), blk_off->offset);
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 1121, ((blk))); ((blk)) = 
# 1121 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1121 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return (-1); } while (0);
 }

 blk->hdr.key = -1;
 blk->hdr.inext_idle = store->hdr.ihead_idle;
# 1139 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ...
 ret = zdb_write((ZDB_STORE*) store, blk, (size_t) ((zdb_off_t) (store)->hdr.blk_hdr_dlen), off);
 if (ret == -1) {
  acl_msg_error("%s(%d): prwrite %s error(%s), blk_off("
   "%lld" ", " "%lld" ")",
   myname, 1153, ((char *) ((path))->vbuf.data),
   acl_last_serror(), blk_off->offset, off);
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 1155, ((blk))); ((blk)) = 
# 1155 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1155 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return (-1); } while (0);
 }
 ...
 if (db->dat_disks[idisk].count < 0) {
  acl_msg_error("%s(%d): count(%lld) < 0 in %s",
   myname, 1161, db->dat_disks[idisk].count,
   db->dat_disks[idisk].path);
  do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 1163, ((blk))); ((blk)) = 
# 1163 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
 ((void *)0)
# 1163 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
 ; } } while (0); return (-1); } while (0);
 }
 ...
 do { if (store) zdb_dat_store_close(store); if (blk) do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 1169, ((blk))); ((blk)) = 
# 1169 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
((void *)0)
# 1169 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
; } } while (0); return (ret); } while (0);
}
...
int zdb_dat_stat(ZDB *db, const char *filepath, ZDB_DAT_HDR *dat_hdr)
{
 ...
 if (store == 
# 1178 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
             ((void *)0)
# 1178 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                 ) {
  acl_msg_error("%s(%d): open %s error(%s)",
   myname, 1180, filepath, acl_last_serror());
  return (-1);
 }
...
int zdb_dat_check(ZDB_DAT_STORE *store, ZDB_DAT_HDR *dat_hdr)
{
 ...
 acl_msg_info("%s(%d): %s: checking ......",
  myname, 1201, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""));
 acl_msg_info("%s(%d):\tHDR STATUS:", myname, 1202);
 acl_msg_info("%s(%d):\tlimit: " "%lld" ", size: "
  "%lld" ", count: " "%lld",
  myname, 1205, store->hdr.limit,
  store->hdr.size, store->hdr.count);
 acl_msg_info("%s(%d):\tnstep: %d, blk_hdr_dlen: %d, blk_dlen: %d,"
  " blk_count: %d", myname, 1208, store->hdr.nstep,
  store->hdr.blk_hdr_dlen, store->hdr.blk_dlen,
  store->hdr.blk_count);
 acl_msg_info("%s(%d):\tihead_idle: %d, ihead_busy: %d",
  myname, 1212, store->hdr.ihead_idle, store->hdr.ihead_busy);
 ...
 acl_msg_info("%s(%d):\tBegin check used blk ......", myname, 1219);

 time(&begin);


 zdb_dat_iter_set(store, 1);
 for (((ZDB_STORE*) store)->iter_head(&(iter), ((ZDB_STORE*) store)); (iter).ptr; ((ZDB_STORE*) store)->iter_next(&(iter), ((ZDB_STORE*) store))) {
  nused++;
  if (nused > 0 && nused % 10000 == 0) {
   ZDB_BLK_HDR *blk_hdr = (ZDB_BLK_HDR*) iter.data;

   printf("\tnused: " "%lld" ", key: "
    "%lld" ", dlen: %d, ",
    nused, blk_hdr->key, iter.dlen);
   acl_meter_time("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 1233, "-");
  }
 }

 if (nused != store->hdr.count) {
  acl_msg_error("%s(%d):\terror, nused(" "%lld"
   ") != store->hdr.count(" "%lld"
   ") for %s, please repair it!, time: %ld", myname, 1240,
   nused, store->hdr.count, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""),
   (long) (time(
# 1242 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
               ((void *)0)
# 1242 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                   ) - begin));
  failed = 1;
 } else {
  acl_msg_info("%s(%d):\tOk, check used blk over, busy blk: "
   "%lld" ", time: %ld",
   myname, 1247, store->hdr.count, time(
# 1247 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                                           ((void *)0)
# 1247 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                                               ) - begin);
 }
 ...
 acl_msg_info("%s(%d):\tBegin check idle blk ......", myname, 1255);

 time(&begin);

 ret = 0;
 blk_len = (int) ( ((zdb_off_t) ((store))->hdr.blk_hdr_dlen) + (zdb_off_t) (store)->hdr.blk_dlen * (zdb_off_t) (store)->hdr.blk_count );
 blk = (ZDB_BLK*) acl_malloc_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 1261, blk_len);
 ilnk = store->hdr.ihead_idle;
 while (ilnk >= 0) {
  blk_off = ( (zdb_off_t) sizeof(ZDB_DAT_HDR) + ( ((zdb_off_t) (((store)))->hdr.blk_hdr_dlen) + (zdb_off_t) ((store))->hdr.blk_dlen * (zdb_off_t) ((store))->hdr.blk_count ) * (zdb_off_t) ((ilnk)) );
  ret = zdb_read((ZDB_STORE*) store, blk, blk_len, blk_off);
  if (ret == -1) {
   acl_msg_error("%s(%d): zdb_read %s error(%s), blk_off("
    "%lld" ")", myname, 1268,
    (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""),
 ...
 if (ret >= 0 && nidle == store->hdr.size - store->hdr.count)
  acl_msg_info("%s(%d):\tOk, check idle blk over , idle blk: "
   "%lld" ", time: %ld",
   myname, 1281, nidle, time(
# 1281 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                                ((void *)0)
# 1281 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                                    ) - begin);
 else {
  acl_msg_error("%s(%d):\tcheck idle blk error for %s, time: %ld",
   myname, 1284, (((((ZDB_STORE*) store)->fhandle.fp))->path ? ((((ZDB_STORE*) store)->fhandle.fp))->path : ""), time(
# 1284 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
                                                         ((void *)0)
# 1284 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                                                             ) - begin);
  acl_msg_error("%s(%d): \tret: %d, idle blk: " "%lld"
   ", store->hdr.size - store->hdr.count: " "%lld",
   myname, 1287, ret, nidle,
   store->hdr.size - store->hdr.count);
  failed = 1;
 }

 do { if ((blk)) { acl_free_glue("/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c", 1292, ((blk))); ((blk)) = 
# 1292 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
((void *)0)
# 1292 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
; } } while (0);
...
int zdb_dat_check3(ZDB *db, const char *filepath, ZDB_DAT_HDR *dat_hdr)
{
 ...
 store = zdb_dat_store_open(db, filepath);
 if (store == 
# 1304 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c" 3 4
             ((void *)0)
# 1304 "/workspace/acl/lib_acl/src/db/zdb/zdb_dat.c"
                 ) {
  acl_msg_error("%s(%d): open %s error(%s)",
   myname, 1306, filepath, acl_last_serror());
  return (-1);
 }
