# 1 "/workspace/acl/lib_acl/src/master/acl_master_proto.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 3 "/workspace/acl/lib_acl/src/master/acl_master_proto.c" 2
# 22 "/workspace/acl/lib_acl/src/master/acl_master_proto.c"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 23 "/workspace/acl/lib_acl/src/master/acl_master_proto.c" 2



# 1 "/workspace/acl/lib_acl/include/master/acl_master_proto.h" 1
# 27 "/workspace/acl/lib_acl/src/master/acl_master_proto.c" 2

int acl_master_notify(int pid, unsigned generation, int status)
{
 char *myname = "acl_master_notify";
 ACL_MASTER_STATUS stat_buf;
# 40 "/workspace/acl/lib_acl/src/master/acl_master_proto.c"
 stat_buf.pid = pid;
 stat_buf.gen = generation;
 stat_buf.status = status;

 if (write(5, (char *) &stat_buf, sizeof(stat_buf))
     != sizeof(stat_buf)) {
  acl_msg_warn("%s(%d), %s: status %d, error %s",
   "/workspace/acl/lib_acl/src/master/acl_master_proto.c", 47, myname, status, strerror(
# 47 "/workspace/acl/lib_acl/src/master/acl_master_proto.c" 3 4
                                               (*__errno_location ())
# 47 "/workspace/acl/lib_acl/src/master/acl_master_proto.c"
                                                    ));
  return -1;
 } else if (acl_msg_verbose)
  acl_msg_info("%s(%d)->%s: OK, status %d, pid = %d",
   "/workspace/acl/lib_acl/src/master/acl_master_proto.c", 51, myname, status, pid);
