# 0 "/acl/lib_acl/src/master/acl_master_proto.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/master/acl_master_proto.c"
...
# 3 "/acl/lib_acl/src/master/acl_master_proto.c" 2
# 22 "/acl/lib_acl/src/master/acl_master_proto.c"
# 1 "/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 23 "/acl/lib_acl/src/master/acl_master_proto.c" 2



# 1 "/acl/lib_acl/include/master/acl_master_proto.h" 1
# 27 "/acl/lib_acl/src/master/acl_master_proto.c" 2

int acl_master_notify(int pid, unsigned generation, int status)
{
 char *myname = "acl_master_notify";
 ACL_MASTER_STATUS stat_buf;
# 40 "/acl/lib_acl/src/master/acl_master_proto.c"
 stat_buf.pid = pid;
 ...
 if (write(5, (char *) &stat_buf, sizeof(stat_buf))
  ...
  acl_msg_warn("%s(%d), %s: status %d, error %s",
   "/acl/lib_acl/src/master/acl_master_proto.c", 47, myname, status, strerror(
# 47 "/acl/lib_acl/src/master/acl_master_proto.c" 3 4
                                               (*__errno_location ())
# 47 "/acl/lib_acl/src/master/acl_master_proto.c"
                                                    ));
  return -1;
 } else if (acl_msg_verbose)
  acl_msg_info("%s(%d)->%s: OK, status %d, pid = %d",
   "/acl/lib_acl/src/master/acl_master_proto.c", 51, myname, status, pid);
