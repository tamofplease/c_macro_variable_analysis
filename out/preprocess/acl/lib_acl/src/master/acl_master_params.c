# 1 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 2
# 18 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
# 1 "/workspace/acl/lib_acl/include/master/acl_master_conf.h" 1
# 19 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 2





static void init_conf_int_vars(ACL_CFG_INT_TABLE cit[])
{
 int i;
...
static void init_conf_int64_vars(ACL_CFG_INT64_TABLE cit[])
{
 int i;
...
static void init_conf_str_vars(ACL_CFG_STR_TABLE cst[])
{
 int i;

 for (i = 0; cst[i].name != 0; i++)
  *(cst[i].target) = acl_strdup_glue("/workspace/acl/lib_acl/src/master/acl_master_params.c", 45, (cst[i].defval));
}

static void init_conf_bool_vars(ACL_CFG_BOOL_TABLE cbt[])
{
 int i;
...
static void update_conf_int_vars(ACL_CFG_INT_TABLE cit[],
 const char *name, const char *value)
{
 int i;
...
static void update_conf_int64_vars(ACL_CFG_INT64_TABLE cit[],
 const char *name, const char *value)
{
 int i;
...
static void update_conf_str_vars(ACL_CFG_STR_TABLE cst[],
 const char *name, const char *value)
{
 int i;
 ...
 for (i = 0; cst[i].name != 0; i++) {
  if (strcasecmp(cst[i].name, name) == 0) {
   do { if (*(cst[i].target)) { acl_free_glue("/workspace/acl/lib_acl/src/master/acl_master_params.c", 89, (*(cst[i].target))); (*(cst[i].target)) = 
# 89 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 3 4
  ((void *)0)
# 89 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
  ; } } while (0);
   *(cst[i].target) = acl_strdup_glue("/workspace/acl/lib_acl/src/master/acl_master_params.c", 90, (value));
  }
 }
}

static void update_conf_bool_vars(ACL_CFG_BOOL_TABLE cbt[],
 const char *name, const char *value)
{
 int i, n;
...
static ACL_XINETD_CFG_PARSER *__app_cfg = 
# 115 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 3 4
                                         ((void *)0)
# 115 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
                                             ;
static char *__app_conf_file = 
# 116 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 3 4
                              ((void *)0)
# 116 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
                                  ;
...
void acl_app_conf_load(const char *pathname)
{
 ...
 if (pathname == 
# 122 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 3 4
                ((void *)0) 
# 122 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
                     || *pathname == 0)
  acl_msg_fatal("%s(%d), %s: input error",
   "/workspace/acl/lib_acl/src/master/acl_master_params.c", 124, myname);

 if (__app_cfg != 
# 126 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 3 4
                 ((void *)0)
# 126 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
                     )
 ...
 if (__app_cfg == 
# 131 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 3 4
                 ((void *)0)
# 131 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
                     )
  acl_msg_fatal("%s(%d), %s: load file(%s) error(%s)",
   "/workspace/acl/lib_acl/src/master/acl_master_params.c", 133, myname, pathname, strerror(
# 133 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 3 4
                                                 (*__errno_location ())
# 133 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
                                                      ));

 __app_conf_file = acl_strdup_glue("/workspace/acl/lib_acl/src/master/acl_master_params.c", 135, (pathname));
}
...
void acl_app_conf_unload(void)
{
 if (__app_cfg) {
  acl_xinetd_cfg_free(__app_cfg);
  __app_cfg = 
# 142 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 3 4
             ((void *)0)
# 142 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
                 ;
 }

 if (__app_conf_file) {
  do { if (__app_conf_file) { acl_free_glue("/workspace/acl/lib_acl/src/master/acl_master_params.c", 146, (__app_conf_file)); (__app_conf_file) = 
# 146 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 3 4
 ((void *)0)
# 146 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
 ; } } while (0);
  __app_conf_file = 
# 147 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 3 4
                   ((void *)0)
# 147 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
                       ;
 }
}
...
void acl_get_app_conf_int_table(ACL_CFG_INT_TABLE *table)
{
 ...
 if (table == 
# 156 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 3 4
             ((void *)0)
# 156 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
                 )
  return;
 ...
 if (__app_cfg == 
# 161 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 3 4
                 ((void *)0)
# 161 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
                     )
  return;
...
void acl_get_app_conf_int64_table(ACL_CFG_INT64_TABLE *table)
{
 ...
 if (table == 
# 178 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 3 4
             ((void *)0)
# 178 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
                 )
  return;
 ...
 if (__app_cfg == 
# 183 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 3 4
                 ((void *)0)
# 183 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
                     )
  return;
...
void acl_get_app_conf_str_table(ACL_CFG_STR_TABLE *table)
{
 ...
 if (table == 
# 200 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 3 4
             ((void *)0)
# 200 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
                 )
  return;
 ...
 if (__app_cfg == 
# 205 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 3 4
                 ((void *)0)
# 205 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
                     )
  return;
...
void acl_free_app_conf_str_table(ACL_CFG_STR_TABLE *table)
{
 ...
 if (table == 
# 221 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 3 4
             ((void *)0)
# 221 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
                 )
  return;

 for (i = 0; table[i].name != 0; i++) {
  if (*(table[i].target) != 0)
   do { if (*(table[i].target)) { acl_free_glue("/workspace/acl/lib_acl/src/master/acl_master_params.c", 226, (*(table[i].target))); (*(table[i].target)) = 
# 226 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 3 4
  ((void *)0)
# 226 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
  ; } } while (0);
 }
}
...
void acl_get_app_conf_bool_table(ACL_CFG_BOOL_TABLE *table)
{
 ...
 if (table == 
# 235 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 3 4
             ((void *)0)
# 235 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
                 )
  return;
 ...
 if (__app_cfg == 
# 240 "/workspace/acl/lib_acl/src/master/acl_master_params.c" 3 4
                 ((void *)0)
# 240 "/workspace/acl/lib_acl/src/master/acl_master_params.c"
                     )
  return;
