# 1 "/workspace/acl/lib_acl/src/master/template/master_log.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/master/template/master_log.c" 2
...
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 8 "/workspace/acl/lib_acl/src/master/template/master_log.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_env.h" 1
# 9 "/workspace/acl/lib_acl/src/master/template/master_log.c" 2
...
# 10 "/workspace/acl/lib_acl/src/master/template/master_log.c" 2
...
void master_log_open(const char *procname)
{
 ...
 if (master_log == 
# 34 "/workspace/acl/lib_acl/src/master/template/master_log.c" 3 4
                  ((void *)0)
# 34 "/workspace/acl/lib_acl/src/master/template/master_log.c"
                      )
