# 1 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 3 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 21 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/7/include-fixed/limits.h" 1 3 4
# 22 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 34 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
# 1 "/workspace/acl/lib_acl/include/init/acl_init.h" 1
# 35 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 36 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/unix/acl_chroot_uid.h" 1
# 37 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/unix/acl_core_limit.h" 1
# 38 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_vstring.h" 1
# 39 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_vstream.h" 1
# 40 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_mymalloc.h" 1
# 41 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_iostuff.h" 1
# 42 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_stringops.h" 1
# 43 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_myflock.h" 1
# 44 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/unix/acl_watchdog.h" 1
# 45 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/include/net/acl_access.h" 1
# 46 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/include/net/acl_listen.h" 1
# 47 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/include/net/acl_tcp_ctl.h" 1
# 48 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/include/net/acl_sane_socket.h" 1
# 49 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/include/net/acl_vstream_net.h" 1
# 50 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/include/event/acl_events.h" 1
# 51 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
...
# 1 "/workspace/acl/lib_acl/include/master/acl_master_flow.h" 1
# 57 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/include/master/acl_master_proto.h" 1
# 58 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/include/master/acl_threads_params.h" 1
# 59 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/include/master/acl_server_api.h" 1
# 60 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/include/master/acl_master_type.h" 1
# 61 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/include/master/acl_master_conf.h" 1
# 62 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2
# 1 "/workspace/acl/lib_acl/src/master/template/master_log.h" 1
# 12 "/workspace/acl/lib_acl/src/master/template/master_log.h"
void master_log_open(const char *procname);
void master_log_close(void);
# 63 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 2

int acl_var_threads_pid;
char *acl_var_threads_procname = 
# 65 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                ((void *)0)
# 65 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                                    ;
char *acl_var_threads_log_file = 
# 66 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                ((void *)0)
# 66 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                                    ;
...
static ACL_CFG_INT64_TABLE __conf_int64_tab[] = {
...
# 176 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                           ((void *)0)
# 176 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                               ;
static acl_pthread_pool_t *__threads = 
# 177 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                      ((void *)0)
# 177 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                                          ;
...
# 198 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                          ((void *)0)
# 198 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                              ;
...
{
 lock_closing_time();
 __last_closing_time = time(
# 231 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                           ((void *)0)
# 231 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                               );
 unlock_closing_time();
}
...
{
 if (__sstreams == 
# 288 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                  ((void *)0)
# 288 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                      ) {
...
static void server_close(ACL_VSTREAM **streams)
{
 ...
 if (streams == 
# 298 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
               ((void *)0)
# 298 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                   ) {
  return;
 }

 for (i = 0; streams[i] != 
# 302 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                          ((void *)0)
# 302 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                              ; i++) {
  if (streams[i] != 
# 303 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                   ((void *)0)
# 303 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                       ) {
   acl_vstream_close(streams[i]);
   streams[i] = 
# 305 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
               ((void *)0)
# 305 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                   ;
  }
 }
 do { if (streams) { acl_free_glue("/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", 308, (streams)); (streams) = 
# 308 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
((void *)0)
# 308 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
; } } while (0);
 acl_msg_info("All listener closed now!");
}

static void listen_cleanup_timer(int type __attribute__ ((__unused__)),
 ACL_EVENT *event __attribute__ ((__unused__)), void *ctx __attribute__ ((__unused__)))
{
 if (__sstreams != 
# 315 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                  ((void *)0)
# 315 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                      ) {
  server_close(__sstreams);
  __sstreams = 
# 317 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
              ((void *)0)
# 317 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                  ;
 }
}
...
static void listen_cleanup(ACL_EVENT *event)
{
 ...
 if (__sstreams == 
# 325 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                  ((void *)0)
# 325 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                      ) {
  return;
 }

 for (i = 0; __sstreams[i] != 
# 329 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                             ((void *)0)
# 329 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                                 ; i++) {
  acl_event_disable_readwrite(event, __sstreams[i]);
 }
# 344 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
 if ((unsigned long) pthread_self() != acl_main_thread_self()) {
  ...
  server_close(__sstreams);
  __sstreams = 
# 349 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
              ((void *)0)
# 349 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                  ;
 }
}
...
static void server_exit(void)
{
 ...
 if (acl_var_threads_procname) {
  do { if (acl_var_threads_procname) { acl_free_glue("/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", 368, (acl_var_threads_procname)); (acl_var_threads_procname) = 
# 368 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
 ((void *)0)
# 368 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
 ; } } while (0);
 }
 if (acl_var_threads_log_file) {
  do { if (acl_var_threads_log_file) { acl_free_glue("/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", 371, (acl_var_threads_log_file)); (acl_var_threads_log_file) = 
# 371 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
 ((void *)0)
# 371 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
 ; } } while (0);
 }
 ...
 if (__sstreams) {
  server_close(__sstreams);
  __sstreams = 
# 376 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
              ((void *)0)
# 376 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                  ;
 }
 if (__daemon_mode == 0) {
  if (__event) {
...
static void server_exiting(int type __attribute__ ((__unused__)), ACL_EVENT *event, void *ctx)
{
 ...
 if (__server_exit_timer != 
# 424 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                           ((void *)0)
  
# 425 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
static void server_timeout(int type __attribute__ ((__unused__)), ACL_EVENT *event, void *ctx)
{
 ...
 inter = time(
# 453 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
             ((void *)0)
# 453 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                 ) - last;

 if (inter >= 0 && inter < acl_var_threads_idle_limit) {
  acl_event_request_timer(event, server_timeout, ctx,
   (long long int) (acl_var_threads_idle_limit - inter)
    * 1000000, 0);
 } else {
...
static void server_abort(int event_type __attribute__ ((__unused__)), ACL_EVENT *event,
 ACL_VSTREAM *stream __attribute__ ((__unused__)), void *ctx)
{
 if (__aborting) {
  return;
 }
...
static void server_use_timer(int type, ACL_EVENT *event, void *ctx)
{
 ...
 if ((int) __use_count >= acl_var_threads_use_limit) {
  ...
  acl_event_request_timer(event, server_use_timer, ctx,
   (long long int) __use_limit_delay * 1000000, 0);
 }
}
...
static void client_wakeup(ACL_EVENT *event, ACL_VSTREAM *stream)
{
 ...
 const char* peer = ((stream)->addr_peer ? (stream)->addr_peer : "");
 char addr[256];

 if (peer) {
  char *ptr;
  do { if (sizeof(addr) > 0) { size_t _n = strlen(peer); _n = _n > (size_t ) sizeof(addr) - 1? (size_t) sizeof(addr) - 1 : _n; memcpy(addr, peer, _n); addr[_n] = 0; } } while (0);
  ptr = strchr(addr, ':');
  if (ptr)
   *ptr = 0;
 } else {
 ...
 if (addr[0] != 0 && !acl_access_permit(addr)) {
  ...
  if (ctx->serv_close != 
# 534 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                        ((void *)0)
# 534 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                            ) {
 ...
 if (ctx->serv_handshake != 
# 541 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                           ((void *)0)
  
# 542 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
static void thread_callback(void *arg)
{
 ...
 if ((ctx->event_type & (1 << 0)) != 0) {
  ...
  if (ret == 0) {
   ...
   if (ctx->serv_close != 
# 562 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                         ((void *)0)
# 562 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                             ) {
    ctx->serv_close(ctx->serv_arg, ctx->stream);
   }
   acl_vstream_close(ctx->stream);
  }
 } else if ((ctx->event_type & (1 << 1)) != 0) {
  client_wakeup(ctx->event, ctx->stream);
 } else if ((ctx->event_type & (1 << 4)) != 0) {
  if (ctx->serv_close != 
# 570 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                        ((void *)0)
# 570 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                            ) {
   ctx->serv_close(ctx->serv_arg, ctx->stream);
  }
  acl_vstream_close(ctx->stream);
 } else if ((ctx->event_type & (1 << 6)) == 0) {
  acl_msg_fatal("%s, %s(%d): unknown event type(%d)",
   "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", __FUNCTION__, 576, ctx->event_type);
 } else if (ctx->serv_timeout == 
# 577 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                ((void *)0)
# 577 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                                    ) {
  if (ctx->serv_close != 
# 578 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                        ((void *)0)
# 578 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                            ) {
   ctx->serv_close(ctx->serv_arg, ctx->stream);
  }
  acl_vstream_close(ctx->stream);
  ...
  if (ctx->serv_close != 
# 583 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                        ((void *)0)
# 583 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                            ) {
   ctx->serv_close(ctx->serv_arg, ctx->stream);
  }
  acl_vstream_close(ctx->stream);
...
static void read_callback1(int event_type, ACL_EVENT *event __attribute__ ((__unused__)),
 ACL_VSTREAM *stream __attribute__ ((__unused__)), void *context)
{
...
static void read_callback2(int event_type, ACL_EVENT *event __attribute__ ((__unused__)),
 ACL_VSTREAM *stream __attribute__ ((__unused__)), void *context)
{
 READ_CTX *ctx = (READ_CTX*) context;
 ctx->event_type = event_type;
...
static void event_fire_begin(ACL_EVENT *event __attribute__ ((__unused__)), void *ctx)
{
 acl_pthread_pool_t *threads = (acl_pthread_pool_t*) ctx;
 acl_pthread_pool_bat_add_begin(threads);
}

static void event_fire_end(ACL_EVENT *event __attribute__ ((__unused__)), void *ctx)
{
 acl_pthread_pool_t *threads = (acl_pthread_pool_t*) ctx;
 acl_pthread_pool_bat_add_end(threads);
}

static void free_ctx(ACL_VSTREAM *stream __attribute__ ((__unused__)), void *context)
{
 READ_CTX *ctx = (READ_CTX*) context;
 if (ctx->job)
  acl_pthread_pool_free_job(ctx->job);
 do { if (ctx) { acl_free_glue("/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", 627, (ctx)); (ctx) = 
# 627 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
((void *)0)
# 627 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
; } } while (0);
}

static void decrease_counter_callback(ACL_VSTREAM *stream __attribute__ ((__unused__)),
...
static READ_CTX *create_job(ACL_EVENT *event, acl_pthread_pool_t *threads,
 ACL_VSTREAM *stream)
{
 READ_CTX *ctx = (READ_CTX*) acl_malloc_glue("/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", 640, sizeof(READ_CTX));
...
# 680 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                02
# 680 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                                      , acl_var_threads_buf_size,
   acl_var_threads_rw_timeout, (1 << 0));
 if (remote) {
 ...
 acl_vstream_add_close_handle(stream, decrease_counter_callback, 
# 693 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                                                ((void *)0)
# 693 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                                                                    );


 ctx = create_job(event, threads, stream);
 if (ctx->serv_accept != 
# 697 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                        ((void *)0)
  
# 698 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
 && ctx->serv_accept(ctx->serv_arg, stream) < 0) {

  if (ctx->serv_close != 
# 700 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                        ((void *)0)
# 700 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                            ) {
   ctx->serv_close(ctx->serv_arg, stream);
  }
  acl_vstream_close(stream);
 ...
 acl_pthread_pool_t *threads, ACL_VSTREAM *stream)
{
 ...
 if (ctx == 
# 715 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
           ((void *)0) 
# 715 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                || ctx->read_callback == 
# 715 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                         ((void *)0)
# 715 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
static void restart_listen_timer(int type __attribute__ ((__unused__)),
...
# 738 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
((void) sizeof ((
# 738 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
__threads
# 738 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
...
"__threads"
# 738 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
, "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", 738, __extension__ __PRETTY_FUNCTION__); }))
# 738 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                     ;
 ...
 ACL_VSTREAM *stream, void *ctx)
{
 ...
 int listen_fd = ((stream)->fd.sock), fd;
 int time_left = -1, i = 0, delay_listen = 0, sock_type, errnum;
 char remote[64], local[64];
 acl_pthread_pool_t *threads = (acl_pthread_pool_t*) ctx;

 if (__sstreams == 
# 753 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                  ((void *)0)
# 753 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                      ) {
 ...
 if (event_type != (1 << 0)) {
  acl_msg_fatal("%s, %s(%d): unknown event_type(%d)",
   "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", myname, 760, event_type);
 }
 ...
 while (i++ < acl_var_threads_max_accept) {
  ...
  if (fd >= 0) {
   ...
   if (sock_type == 
# 779 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                   2 
# 779 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                           || sock_type == 
# 779 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                           10
# 779 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
  ...
  if (errnum == 
# 796 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
               24
# 796 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                         ) {
   delay_listen = 1;
  ...
  if (errnum == 
# 802 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
               11 
# 802 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                          || errnum == 
# 802 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                       4
# 802 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
  ...
  acl_msg_warn("accept connection: %s(%d, %d), stoping ...",
   acl_last_serror(), errnum, 
# 807 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                             11
# 807 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                                       );
  acl_event_disable_readwrite(event, stream);
 ...
 if (time_left > 0) {
  acl_event_request_timer(event, server_timeout, threads,
   (long long int) time_left * 1000000, 0);
 }
}
...
static void server_init(const char *procname)
{
 ...
 if (procname == 
# 840 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                ((void *)0) 
# 840 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                     || *procname == 0) {
  acl_msg_fatal("%s(%d); procname null", myname, 841);
 }
 ...
 signal(
# 848 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
       13
# 848 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
              , 
# 848 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                ((__sighandler_t) 1)
# 848 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
 ...
 signal(
# 855 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
       25
# 855 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
              , 
# 855 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                ((__sighandler_t) 1)
# 855 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
 ...
 acl_var_threads_procname = acl_strdup_glue("/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", 868, (acl_safe_basename(procname)));

 ptr = acl_getenv("SERVICE_LOG");
 if ((ptr = acl_getenv("SERVICE_LOG")) != 
# 871 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                         ((void *)0) 
# 871 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                                              && *ptr != 0) {
  acl_var_threads_log_file = acl_strdup_glue("/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", 872, (ptr));
 } else {
  acl_var_threads_log_file = acl_strdup_glue("/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", 874, ("acl_master.log"));
  acl_msg_info("%s(%d)->%s: can't get SERVICE_LOG's env value,"
   " use %s log", "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", 876, myname,
 ...
 if (__deny_info == 
# 884 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                   ((void *)0)
# 884 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                       ) {
 ...
 if (!strcasecmp(acl_var_threads_master_reuseport, "yes")
  || !strcasecmp(acl_var_threads_master_reuseport, "true")
  || !strcasecmp(acl_var_threads_master_reuseport, "on")) {
...
static void log_event_mode(int event_mode)
{
 ...
 switch (event_mode) {
 case 0:
  acl_msg_info("%s(%d): use select event", myname, 906);
  break;
 case 1:
  acl_msg_info("%s(%d): use poll event", myname, 909);
  break;
 case 2:
  acl_msg_info("%s(%d): use kernel_event", myname, 912);
  break;
 default:
  acl_msg_info("%s(%d): use select event", myname, 915);
  break;
 }
}
...
# 970 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
 if (acl_var_threads_idle_limit > 0) {
  acl_event_request_timer(event, server_timeout, threads,
   (long long int) acl_var_threads_idle_limit * 1000000, 0);
 }
...
static void dispatch_connect_timer(int type __attribute__ ((__unused__)),
 ACL_EVENT *event, void *ctx)
{
 acl_pthread_pool_t *threads = (acl_pthread_pool_t*) ctx;
...
static ACL_VSTREAM *__dispatch_conn = 
# 999 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                     ((void *)0)
# 999 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                                         ;
...
static int dispatch_report(void)
{
 ...
 if (__dispatch_conn == 
# 1006 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                       ((void *)0)
# 1006 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                           ) {
  if (__aborting) {
   return 0;
  }
...
static void dispatch_timer(int type __attribute__ ((__unused__)), ACL_EVENT *event, void *ctx)
{
 acl_pthread_pool_t *threads = (acl_pthread_pool_t*) ctx;
...
static void dispatch_receive(int event_type __attribute__ ((__unused__)), ACL_EVENT *event,
 ACL_VSTREAM *conn, void *ctx)
{
 ...
 if (conn != __dispatch_conn) {
  acl_msg_fatal("%s(%d), %s: conn invalid",
   __FUNCTION__, 1057, myname);
 }


 conn->read_ready = 0;
 ret = acl_read_fd(((conn)->fd.sock), buf, sizeof(buf) - 1, &fd);

 if (ret <= 0 || fd < 0) {
  acl_msg_warn("%s(%d), %s: read from master_dispatch(%s) error",
   __FUNCTION__, 1066, myname,
   acl_var_threads_dispatch_addr);

  acl_vstream_close(conn);
  __dispatch_conn = 
# 1070 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                   ((void *)0)
# 1070 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                       ;
...
static void dispatch_close(ACL_EVENT *event)
{
 if (__dispatch_conn) {
  ...
  __dispatch_conn = 
# 1100 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                   ((void *)0)
# 1100 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                       ;
  __aborting = 1;
 }
}
...
static void dispatch_open(ACL_EVENT *event, acl_pthread_pool_t *threads)
{
 ...
 if (__aborting) {
  acl_msg_info("%s(%d), %s: master disconnect -- aborting",
   "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", 1111, myname);
  return;
 }

 if (acl_var_threads_dispatch_addr == 
# 1115 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                     ((void *)0)
  
# 1116 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
 || *acl_var_threads_dispatch_addr == 0) {

  acl_msg_warn("%s(%d), %s: acl_var_threads_dispatch_addr null",
   __FUNCTION__, 1119, myname);
  return;
 }
 ...
 if (__dispatch_conn) {
  acl_non_blocking(((__dispatch_conn)->fd.sock),
   1);
 }

 if (__dispatch_conn == 
# 1131 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                       ((void *)0)
# 1131 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                           ) {
 ...
 ACL_MASTER_SERVER_THREAD_EXIT_FN exit_fn, void *init_ctx, void *exit_ctx)
{
 ...
 pthread_mutex_init(&__closing_time_mutex, 
# 1178 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                              ((void *)0)
# 1178 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                                                  );
 pthread_mutex_init(&__counter_mutex, 
# 1179 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                         ((void *)0)
# 1179 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                                             );
 __last_closing_time = time(
# 1180 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                           ((void *)0)
# 1180 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                               );
...
static void server_status_init(ACL_EVENT *event, acl_pthread_pool_t *threads)
{
 ...
 stat_stream = acl_vstream_fdopen(5,
  
# 1195 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
 02
# 1195 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
       , 8192, -1, (1 << 0));

 acl_event_enable_read(event, stat_stream, 0, server_abort, threads);

 acl_close_on_exec(5, 1);
 acl_close_on_exec(3, 1);
 acl_close_on_exec(4, 1);
}
 ...
 acl_pthread_pool_t *threads, int count, int fdtype)
{
 ...
 streams = (ACL_VSTREAM **)
  acl_calloc_glue("/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", 1215, count + 1, sizeof(ACL_VSTREAM *));

 for (i = 0; i < count + 1; i++) {
  streams[i] = 
# 1218 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
              ((void *)0)
# 1218 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                  ;
 }
 ...
 fd = 6;
 for (; fd < 6 + count; fd++) {
  ACL_VSTREAM *stream = acl_vstream_fdopen(fd, 
# 1224 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                              02
# 1224 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                                                    ,
    acl_var_threads_buf_size,
    acl_var_threads_rw_timeout, fdtype);
  if (stream == 
# 1227 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
               ((void *)0)
# 1227 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                   ) {
   acl_msg_fatal("%s(%d)->%s: stream null, fd = %d",
    "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", 1229, myname, fd);
  }

  acl_non_blocking(fd, 1);
  acl_close_on_exec(fd, 1);
  acl_event_enable_listen(event, stream, 0,
   __server_accept, threads);
...
{
 if (is_ipaddr(addr)) {
  do { if (size > 0) { size_t _n = strlen(addr); _n = _n > (size_t ) size - 1? (size_t) size - 1 : _n; memcpy(buf, addr, _n); buf[_n] = 0; } } while (0);
 } else {
 ...
 acl_pthread_pool_t *threads, const char *addrs)
{
 ...
 ACL_VSTREAM **streams = (ACL_VSTREAM **)
  acl_calloc_glue("/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", 1292, tokens->argc + 1, sizeof(ACL_VSTREAM *));
 ...
 for (i = 0; i < tokens->argc + 1; i++) {
  streams[i] = 
# 1299 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
              ((void *)0)
# 1299 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                  ;
 }

 i = 0;
 for ((tokens)->iter_head(&(iter), (tokens)); (iter).ptr; (tokens)->iter_next(&(iter), (tokens))) {
  ...
  ACL_VSTREAM* sstream = acl_vstream_listen_ex(addrbuf, 128,
    flag, 0, 0);
  if (sstream == 
# 1310 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                ((void *)0)
# 1310 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                    ) {
   acl_msg_error("%s(%d): listen %s error(%s)",
    myname, 1312, addrbuf, acl_last_serror());
   exit(2);
  }

  acl_non_blocking(((sstream)->fd.sock), 1);

  acl_close_on_exec(((sstream)->fd.sock), 1);
...
{
 if (argc <= 0) {
  acl_msg_fatal("%s(%d): argc %d", "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", 1336, argc);
 }
 ...
 ACL_THREADS_SERVER_FN service, void *service_ctx, int name, ...)
{
 ...
 char *root_dir = 
# 1354 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                 ((void *)0)
# 1354 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                     , *user = 
# 1354 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                               ((void *)0)
# 1354 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1357 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                        ((void *)0)
# 1357 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                            , *thread_exit_ctx = 
# 1357 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                                 ((void *)0)
# 1357 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                                                     ;
 ACL_MASTER_SERVER_INIT_FN pre_jail = 
# 1358 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                     ((void *)0)
# 1358 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                                         ;
 ACL_MASTER_SERVER_INIT_FN post_init = 
# 1359 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                      ((void *)0)
# 1359 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                                          ;
 ACL_MASTER_SERVER_THREAD_INIT_FN thread_init_fn = 
# 1360 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                                  ((void *)0)
# 1360 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                                                      ;
 ACL_MASTER_SERVER_THREAD_EXIT_FN thread_exit_fn = 
# 1361 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                                  ((void *)0)
# 1361 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                                                      ;
 ...
 if (__conf_file[0] == 0) {
  acl_msg_info("%s(%d)->%s: no configure file",
   "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", 1422, myname);
 } else {
  acl_msg_info("%s(%d)->%s: configure file = %s",
   "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", 1425, myname, __conf_file);
 }


 if (isatty(
# 1429 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
           0
# 1429 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                       )) {
  __daemon_mode = 0;
 } else {
...
# 1448 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
 server_init(argv[0]);

 
# 1450 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
__builtin_va_start(
# 1450 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
ap
# 1450 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
,
# 1450 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1450 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                  ;
 for (; name != 0; name = 
# 1451 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                       __builtin_va_arg(
# 1451 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                                       ap
# 1451 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                                       ,
# 1451 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1455 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   __builtin_va_arg(
# 1455 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
   ap
# 1455 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   ,
# 1455 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1459 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   __builtin_va_arg(
# 1459 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
   ap
# 1459 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   ,
# 1459 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1463 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   __builtin_va_arg(
# 1463 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
   ap
# 1463 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   ,
# 1463 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1467 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   __builtin_va_arg(
# 1467 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
   ap
# 1467 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   ,
# 1467 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1467 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
  ...
  case 10:
   pre_jail = 
# 1470 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
             __builtin_va_arg(
# 1470 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
             ap
# 1470 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
             ,
# 1470 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1470 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
  ...
  case 11:
   post_init = 
# 1473 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
              __builtin_va_arg(
# 1473 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
              ap
# 1473 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
              ,
# 1473 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1477 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   __builtin_va_arg(
# 1477 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
   ap
# 1477 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   ,
# 1477 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1481 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   __builtin_va_arg(
# 1481 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
   ap
# 1481 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   ,
# 1481 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1485 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   __builtin_va_arg(
# 1485 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
   ap
# 1485 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   ,
# 1485 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1489 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   __builtin_va_arg(
# 1489 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
   ap
# 1489 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   ,
# 1489 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1493 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   __builtin_va_arg(
# 1493 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
   ap
# 1493 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   ,
# 1493 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1497 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   __builtin_va_arg(
# 1497 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
   ap
# 1497 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   ,
# 1497 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1501 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   __builtin_va_arg(
# 1501 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
   ap
# 1501 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   ,
# 1501 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1505 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   __builtin_va_arg(
# 1505 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
   ap
# 1505 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   ,
# 1505 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1505 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
  ...
  case 21:
   thread_init_ctx = 
# 1508 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                    __builtin_va_arg(
# 1508 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                    ap
# 1508 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                    ,
# 1508 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1512 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   __builtin_va_arg(
# 1512 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
   ap
# 1512 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   ,
# 1512 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1512 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
  ...
  case 23:
   thread_exit_ctx = 
# 1515 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                    __builtin_va_arg(
# 1515 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                    ap
# 1515 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                    ,
# 1515 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1515 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
   ...
   break;
  case 25:
   __deny_info = acl_strdup_glue("/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", 1518, (
# 1518 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                __builtin_va_arg(
# 1518 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                ap
# 1518 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
                ,
# 1518 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1522 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   __builtin_va_arg(
# 1522 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
   ap
# 1522 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
   ,
# 1522 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1529 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
__builtin_va_end(
# 1529 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
ap
# 1529 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
)
# 1529 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
 ...
 if ((generation = getenv("GENERATION")) != 0) {
 ...
 do { if (sizeof(__service_name) > 0) { size_t _n = strlen(service_name); _n = _n > (size_t ) sizeof(__service_name) - 1? (size_t) sizeof(__service_name) - 1 : _n; memcpy(__service_name, service_name, _n); __service_name[_n] = 0; } } while (0);
 ...
 if (__daemon_mode == 0) {
  if (addrs == 
# 1588 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
              ((void *)0) 
# 1588 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                   || *addrs == 0) {
...
# 1594 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
 ((void) sizeof ((
# 1594 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1594 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
 "acl_var_threads_master_service"
# 1594 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
 , "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", 1594, __extension__ __PRETTY_FUNCTION__); }))
# 1594 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                                       ;
  
# 1595 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
 ((void) sizeof ((
# 1595 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
 *acl_var_threads_master_service
# 1595 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1595 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
...
# 1595 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
 "*acl_var_threads_master_service"
# 1595 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c" 3 4
 , "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c", 1595, __extension__ __PRETTY_FUNCTION__); }))
# 1595 "/workspace/acl/lib_acl/src/master/template/acl_threads_server.c"
                                        ;
  addrs = acl_var_threads_master_service;
 ...
 acl_msg_info("%s(%d), %s daemon started, log: %s",
  myname, 1653, argv[0], acl_var_threads_log_file);
