# 1 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 2
# 10 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
...
# 8 "/usr/include/linux/netlink.h" 2 3 4
...
# 109 "/usr/include/linux/netlink.h" 3 4
struct nlmsgerr {
 int error;
 struct nlmsghdr msg;
# 121 "/usr/include/linux/netlink.h" 3 4
};
# 135 "/usr/include/linux/netlink.h" 3 4
enum nlmsgerr_attrs {
...
# 157 "/usr/include/linux/netlink.h" 3 4
struct nl_pktinfo {
 __u32 group;
};
...
# 206 "/usr/include/linux/netlink.h" 3 4
struct nlattr {
 __u16 nla_len;
 __u16 nla_type;
};
# 242 "/usr/include/linux/netlink.h" 3 4
struct nla_bitfield32 {
 __u32 value;
 __u32 selector;
};
# 11 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 2
...
# 106 "/usr/include/linux/if_link.h" 3 4
enum {
 IFLA_UNSPEC,
 IFLA_ADDRESS,
 IFLA_BROADCAST,
...
# 177 "/usr/include/linux/if_link.h" 3 4
enum {
 IFLA_INET_UNSPEC,
 IFLA_INET_CONF,
 __IFLA_INET_MAX,
...
# 762 "/usr/include/linux/if_link.h" 3 4
enum {
 IFLA_VF_PORT_UNSPEC,
 IFLA_VF_PORT,
 __IFLA_VF_PORT_MAX,
...
# 885 "/usr/include/linux/if_link.h" 3 4
enum {
...
# 913 "/usr/include/linux/if_link.h" 3 4
enum {
 XDP_ATTACHED_NONE = 0,
 XDP_ATTACHED_DRV,
 XDP_ATTACHED_SKB,
...
# 57 "/usr/include/linux/if_addr.h" 3 4
...
# 69 "/usr/include/linux/neighbour.h" 3 4
...
# 101 "/usr/include/linux/neighbour.h" 3 4
struct ndt_stats {
 __u64 ndts_allocs;
 __u64 ndts_destroys;
...
# 167 "/usr/include/linux/rtnetlink.h" 3 4
struct rtattr {
 unsigned short rta_len;
 unsigned short rta_type;
};
# 193 "/usr/include/linux/rtnetlink.h" 3 4
struct rtmsg {
...
# 269 "/usr/include/linux/rtnetlink.h" 3 4
enum rt_scope_t {
 RT_SCOPE_UNIVERSE=0,
...
# 289 "/usr/include/linux/rtnetlink.h" 3 4
enum rt_class_t {
 RT_TABLE_UNSPEC=0,
...
# 347 "/usr/include/linux/rtnetlink.h" 3 4
struct rtnexthop {
...
# 377 "/usr/include/linux/rtnetlink.h" 3 4
struct rtvia {
...
# 449 "/usr/include/linux/rtnetlink.h" 3 4
struct rta_session {
 __u8 proto;
 __u8 pad1;
 __u16 pad2;
...
# 493 "/usr/include/linux/rtnetlink.h" 3 4
struct ifinfomsg {
...
# 573 "/usr/include/linux/rtnetlink.h" 3 4
struct nduseroptmsg {
...
# 615 "/usr/include/linux/rtnetlink.h" 3 4
...
# 13 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 2


# 1 "/workspace/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 16 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_mymalloc.h" 1
# 17 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_vstream.h" 1
# 18 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_iostuff.h" 1
# 19 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 2
...
# 1 "/workspace/acl/lib_acl/include/event/acl_events.h" 1
# 9 "/workspace/acl/lib_acl/src/master/template/ifmonitor.h" 2
...
# 20 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 2
...
static int netlink_changed(struct nlmsghdr *nh, unsigned int dlen)
{
 ...
 for (; 
# 30 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
       ((
# 30 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
       dlen
# 30 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
...
# 30 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
                                nh
# 30 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
                                )->nlmsg_len)+4U -1) & ~(4U -1) ), (struct nlmsghdr*)(((char*)(
# 30 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
                                nh
# 30 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
                                )) + ( (((
...
# 30 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
  ...
  case 
# 32 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
      RTM_NEWADDR
# 32 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
                 :

  case 
# 34 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
      RTM_DELADDR
# 34 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
                 :

  case 
# 36 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
      RTM_NEWROUTE
# 36 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
                  :

  case 
# 38 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
      RTM_DELROUTE
# 38 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
                  :
...
static void netlink_callback(int event_type, ACL_EVENT *event __attribute__ ((__unused__)),
 ACL_VSTREAM *stream, void *context)
{
 ...
 if (event_type != (1 << 0))
  acl_msg_fatal("%s, %s(%d): unknown event_type: %d",
   "/workspace/acl/lib_acl/src/master/template/ifmonitor.c", __FUNCTION__, 61, event_type);

 ret = acl_vstream_read(stream, buf, sizeof(buf));
 if (ret == (-1)) {
  acl_msg_error("%s, %s(%d): read error %s",
   "/workspace/acl/lib_acl/src/master/template/ifmonitor.c", __FUNCTION__, 66, acl_last_serror());
 } else if (ret < (int) sizeof(struct nlmsghdr)) {
  acl_msg_error("%s, %s(%d): invalid read length=%d",
   "/workspace/acl/lib_acl/src/master/template/ifmonitor.c", __FUNCTION__, 69, ret);
 } else {
...
static ACL_VSTREAM *netlink_open(void)
{
 ...
 int fd = socket(
# 81 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
                16
# 81 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
                          , 
# 81 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
                            SOCK_RAW
# 81 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
...
# 81 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
 ...
 if (fd < 0) {
  acl_msg_error("%s(%d), %s: create raw socket error %s",
   "/workspace/acl/lib_acl/src/master/template/ifmonitor.c", 86, __FUNCTION__, acl_last_serror());
  return 
# 87 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
        ((void *)0)
# 87 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
            ;
 }
 ...
 sa.nl_family = 
# 93 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
               16
# 93 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
                         ;
 sa.nl_groups = 
# 94 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
               1 
# 94 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
                           | 
# 94 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
                             0x10 
# 94 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
...
# 95 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
 0x100 
# 95 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
                    | 
# 95 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
                      0x400
# 95 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
 ...
 if (bind(fd, (struct sockaddr *)&sa, sizeof(sa)) != 0) {
  acl_msg_error("%s(%d), %s: bind raw socket error %s",
   "/workspace/acl/lib_acl/src/master/template/ifmonitor.c", 98, __FUNCTION__, acl_last_serror());
  close(fd);
  return 
# 100 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
        ((void *)0)
# 100 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
            ;
 }

 stream = acl_vstream_fdopen(fd, 
# 103 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
                                02
# 103 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
                                      , 8192, -1, (1 << 0));
 return stream;
}
...
void netlink_monitor(ACL_EVENT *event, monitor_callback callback, void *ctx)
{
 ...
 NETLINK_CTX *nc;
 if (stream == 
# 111 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
              ((void *)0)
# 111 "/workspace/acl/lib_acl/src/master/template/ifmonitor.c"
                  )
  return;

 nc = (NETLINK_CTX *) acl_calloc_glue("/workspace/acl/lib_acl/src/master/template/ifmonitor.c", 114, 1, sizeof(NETLINK_CTX));
