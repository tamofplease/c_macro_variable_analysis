# 0 "/acl/lib_acl/src/master/template/ifmonitor.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/master/template/ifmonitor.c"
...
# 2 "/acl/lib_acl/src/master/template/ifmonitor.c" 2
# 10 "/acl/lib_acl/src/master/template/ifmonitor.c"
...
# 11 "/acl/lib_acl/src/master/template/ifmonitor.c" 2
...
# 1028 "/usr/include/linux/if_link.h" 3 4
enum {
 IFLA_VF_PORT_UNSPEC,
 IFLA_VF_PORT,
 __IFLA_VF_PORT_MAX,
...
# 1161 "/usr/include/linux/if_link.h" 3 4
enum {
...
# 1191 "/usr/include/linux/if_link.h" 3 4
enum {
 XDP_ATTACHED_NONE = 0,
 XDP_ATTACHED_DRV,
 XDP_ATTACHED_SKB,
...
# 1251 "/usr/include/linux/if_link.h" 3 4
enum {
 IFLA_RMNET_UNSPEC,
 IFLA_RMNET_MUX_ID,
 IFLA_RMNET_FLAGS,
...
# 13 "/acl/lib_acl/src/master/template/ifmonitor.c" 2


# 1 "/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 16 "/acl/lib_acl/src/master/template/ifmonitor.c" 2
# 1 "/acl/lib_acl/include/stdlib/acl_mymalloc.h" 1
# 17 "/acl/lib_acl/src/master/template/ifmonitor.c" 2
# 1 "/acl/lib_acl/include/stdlib/acl_vstream.h" 1
# 18 "/acl/lib_acl/src/master/template/ifmonitor.c" 2
# 1 "/acl/lib_acl/include/stdlib/acl_iostuff.h" 1
# 19 "/acl/lib_acl/src/master/template/ifmonitor.c" 2
...
# 1 "/acl/lib_acl/include/event/acl_events.h" 1
# 9 "/acl/lib_acl/src/master/template/ifmonitor.h" 2
...
# 20 "/acl/lib_acl/src/master/template/ifmonitor.c" 2
...
static int netlink_changed(struct nlmsghdr *nh, unsigned int dlen)
{
 ...
 for (; 
# 30 "/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
       ((
# 30 "/acl/lib_acl/src/master/template/ifmonitor.c"
       dlen
# 30 "/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
...
# 30 "/acl/lib_acl/src/master/template/ifmonitor.c"
  ...
  case 
# 32 "/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
      RTM_NEWADDR
# 32 "/acl/lib_acl/src/master/template/ifmonitor.c"
                 :

  case 
# 34 "/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
      RTM_DELADDR
# 34 "/acl/lib_acl/src/master/template/ifmonitor.c"
                 :

  case 
# 36 "/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
      RTM_NEWROUTE
# 36 "/acl/lib_acl/src/master/template/ifmonitor.c"
                  :

  case 
# 38 "/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
      RTM_DELROUTE
# 38 "/acl/lib_acl/src/master/template/ifmonitor.c"
                  :
 ...
 ACL_VSTREAM *stream, void *context)
{
 ...
 if (event_type != (1 << 0))
  acl_msg_fatal("%s, %s(%d): unknown event_type: %d",
   "/acl/lib_acl/src/master/template/ifmonitor.c", __FUNCTION__, 61, event_type);

 ret = acl_vstream_read(stream, buf, sizeof(buf));
 if (ret == (-1)) {
  acl_msg_error("%s, %s(%d): read error %s",
   "/acl/lib_acl/src/master/template/ifmonitor.c", __FUNCTION__, 66, acl_last_serror());
 } else if (ret < (int) sizeof(struct nlmsghdr)) {
  acl_msg_error("%s, %s(%d): invalid read length=%d",
   "/acl/lib_acl/src/master/template/ifmonitor.c", __FUNCTION__, 69, ret);
 } else {
...
static ACL_VSTREAM *netlink_open(void)
{
 ...
 int fd = socket(
# 81 "/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
                16
# 81 "/acl/lib_acl/src/master/template/ifmonitor.c"
                          , 
# 81 "/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
                            SOCK_RAW
# 81 "/acl/lib_acl/src/master/template/ifmonitor.c"
...
# 81 "/acl/lib_acl/src/master/template/ifmonitor.c"
 ...
 if (fd < 0) {
  acl_msg_error("%s(%d), %s: create raw socket error %s",
   "/acl/lib_acl/src/master/template/ifmonitor.c", 86, __FUNCTION__, acl_last_serror());
  return 
# 87 "/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
        ((void *)0)
# 87 "/acl/lib_acl/src/master/template/ifmonitor.c"
            ;
 }
 ...
 sa.nl_family = 
# 93 "/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
               16
# 93 "/acl/lib_acl/src/master/template/ifmonitor.c"
                         ;
 sa.nl_groups = 
# 94 "/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
               1 
# 94 "/acl/lib_acl/src/master/template/ifmonitor.c"
                           | 
# 94 "/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
                             0x10 
# 94 "/acl/lib_acl/src/master/template/ifmonitor.c"
...
# 95 "/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
 0x100 
# 95 "/acl/lib_acl/src/master/template/ifmonitor.c"
                    | 
# 95 "/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
                      0x400
# 95 "/acl/lib_acl/src/master/template/ifmonitor.c"
 ...
 if (bind(fd, (struct sockaddr *)&sa, sizeof(sa)) != 0) {
  acl_msg_error("%s(%d), %s: bind raw socket error %s",
   "/acl/lib_acl/src/master/template/ifmonitor.c", 98, __FUNCTION__, acl_last_serror());
  close(fd);
  return 
# 100 "/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
        ((void *)0)
# 100 "/acl/lib_acl/src/master/template/ifmonitor.c"
            ;
 }

 stream = acl_vstream_fdopen(fd, 
# 103 "/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
                                02
# 103 "/acl/lib_acl/src/master/template/ifmonitor.c"
                                      , 8192, -1, (1 << 0));
 return stream;
}
...
void netlink_monitor(ACL_EVENT *event, monitor_callback callback, void *ctx)
{
 ...
 NETLINK_CTX *nc;
 if (stream == 
# 111 "/acl/lib_acl/src/master/template/ifmonitor.c" 3 4
              ((void *)0)
# 111 "/acl/lib_acl/src/master/template/ifmonitor.c"
                  )
  return;

 nc = (NETLINK_CTX *) acl_calloc_glue("/acl/lib_acl/src/master/template/ifmonitor.c", 114, 1, sizeof(NETLINK_CTX));
