# 1 "/workspace/acl/lib_acl/src/master/acl_server_sig.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/master/acl_server_sig.c" 2
# 27 "/workspace/acl/lib_acl/src/master/acl_server_sig.c"
...
void acl_server_sighup_setup(void)
{
 ...
 action.sa_flags |= 
# 55 "/workspace/acl/lib_acl/src/master/acl_server_sig.c" 3 4
                   0x10000000
# 55 "/workspace/acl/lib_acl/src/master/acl_server_sig.c"
                             ;

 action.
# 57 "/workspace/acl/lib_acl/src/master/acl_server_sig.c" 3 4
       __sigaction_handler.sa_handler 
# 57 "/workspace/acl/lib_acl/src/master/acl_server_sig.c"
                  = server_sighup;

 if (sigaction(
# 59 "/workspace/acl/lib_acl/src/master/acl_server_sig.c" 3 4
              1
# 59 "/workspace/acl/lib_acl/src/master/acl_server_sig.c"
                    , &action, (struct sigaction *) 0) < 0)
  acl_msg_fatal("%s: sigaction(%d): %s",
   __FUNCTION__, 
# 61 "/workspace/acl/lib_acl/src/master/acl_server_sig.c" 3 4
                1
# 61 "/workspace/acl/lib_acl/src/master/acl_server_sig.c"
                      , strerror(
# 61 "/workspace/acl/lib_acl/src/master/acl_server_sig.c" 3 4
                                 (*__errno_location ())
# 61 "/workspace/acl/lib_acl/src/master/acl_server_sig.c"
...
static void server_sigterm(int sig __attribute__ ((__unused__)))
{
 int i = 0, max = 1024;
...
void acl_server_sigterm_setup(void)
{
 ...
 action.sa_flags |= 
# 92 "/workspace/acl/lib_acl/src/master/acl_server_sig.c" 3 4
                   0x10000000
# 92 "/workspace/acl/lib_acl/src/master/acl_server_sig.c"
                             ;

 action.
# 94 "/workspace/acl/lib_acl/src/master/acl_server_sig.c" 3 4
       __sigaction_handler.sa_handler 
# 94 "/workspace/acl/lib_acl/src/master/acl_server_sig.c"
                  = server_sigterm;

 if (sigaction(
# 96 "/workspace/acl/lib_acl/src/master/acl_server_sig.c" 3 4
              15
# 96 "/workspace/acl/lib_acl/src/master/acl_server_sig.c"
                     , &action, (struct sigaction *) 0) < 0)
  acl_msg_fatal("%s: sigaction(%d): %s",
   __FUNCTION__, 
# 98 "/workspace/acl/lib_acl/src/master/acl_server_sig.c" 3 4
                15
# 98 "/workspace/acl/lib_acl/src/master/acl_server_sig.c"
                       , strerror(
# 98 "/workspace/acl/lib_acl/src/master/acl_server_sig.c" 3 4
                                  (*__errno_location ())
# 98 "/workspace/acl/lib_acl/src/master/acl_server_sig.c"
