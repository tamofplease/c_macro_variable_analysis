# 0 "/acl/lib_acl/src/master/acl_server_sig.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/master/acl_server_sig.c"
...
# 2 "/acl/lib_acl/src/master/acl_server_sig.c" 2
# 27 "/acl/lib_acl/src/master/acl_server_sig.c"
...
void acl_server_sighup_setup(void)
{
 ...
 action.sa_flags |= 
# 55 "/acl/lib_acl/src/master/acl_server_sig.c" 3 4
                   0x10000000
# 55 "/acl/lib_acl/src/master/acl_server_sig.c"
                             ;

 action.
# 57 "/acl/lib_acl/src/master/acl_server_sig.c" 3 4
       __sigaction_handler.sa_handler 
# 57 "/acl/lib_acl/src/master/acl_server_sig.c"
                  = server_sighup;

 if (sigaction(
# 59 "/acl/lib_acl/src/master/acl_server_sig.c" 3 4
              1
# 59 "/acl/lib_acl/src/master/acl_server_sig.c"
                    , &action, (struct sigaction *) 0) < 0)
  acl_msg_fatal("%s: sigaction(%d): %s",
   __FUNCTION__, 
# 61 "/acl/lib_acl/src/master/acl_server_sig.c" 3 4
                1
# 61 "/acl/lib_acl/src/master/acl_server_sig.c"
                      , strerror(
# 61 "/acl/lib_acl/src/master/acl_server_sig.c" 3 4
                                 (*__errno_location ())
# 61 "/acl/lib_acl/src/master/acl_server_sig.c"
...
void acl_server_sigterm_setup(void)
{
 ...
 action.sa_flags |= 
# 92 "/acl/lib_acl/src/master/acl_server_sig.c" 3 4
                   0x10000000
# 92 "/acl/lib_acl/src/master/acl_server_sig.c"
                             ;

 action.
# 94 "/acl/lib_acl/src/master/acl_server_sig.c" 3 4
       __sigaction_handler.sa_handler 
# 94 "/acl/lib_acl/src/master/acl_server_sig.c"
                  = server_sigterm;

 if (sigaction(
# 96 "/acl/lib_acl/src/master/acl_server_sig.c" 3 4
              15
# 96 "/acl/lib_acl/src/master/acl_server_sig.c"
                     , &action, (struct sigaction *) 0) < 0)
  acl_msg_fatal("%s: sigaction(%d): %s",
   __FUNCTION__, 
# 98 "/acl/lib_acl/src/master/acl_server_sig.c" 3 4
                15
# 98 "/acl/lib_acl/src/master/acl_server_sig.c"
                       , strerror(
# 98 "/acl/lib_acl/src/master/acl_server_sig.c" 3 4
                                  (*__errno_location ())
# 98 "/acl/lib_acl/src/master/acl_server_sig.c"
