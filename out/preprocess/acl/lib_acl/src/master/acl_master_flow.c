# 1 "/workspace/acl/lib_acl/src/master/acl_master_flow.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 3 "/workspace/acl/lib_acl/src/master/acl_master_flow.c" 2
# 21 "/workspace/acl/lib_acl/src/master/acl_master_flow.c"
...
# 22 "/workspace/acl/lib_acl/src/master/acl_master_flow.c" 2



# 1 "/workspace/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 26 "/workspace/acl/lib_acl/src/master/acl_master_flow.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_iostuff.h" 1
# 27 "/workspace/acl/lib_acl/src/master/acl_master_flow.c" 2



# 1 "/workspace/acl/lib_acl/include/master/acl_master_proto.h" 1
# 31 "/workspace/acl/lib_acl/src/master/acl_master_flow.c" 2
# 1 "/workspace/acl/lib_acl/include/master/acl_master_flow.h" 1
# 32 "/workspace/acl/lib_acl/src/master/acl_master_flow.c" 2




# 35 "/workspace/acl/lib_acl/src/master/acl_master_flow.c"
...
void acl_master_flow_init(void)
{
 ...
 acl_msg_fatal("%s(%d)->%s: pipe: %s",
  "/workspace/acl/lib_acl/src/master/acl_master_flow.c", 45, myname, strerror(
# 45 "/workspace/acl/lib_acl/src/master/acl_master_flow.c" 3 4
                                      (*__errno_location ())
# 45 "/workspace/acl/lib_acl/src/master/acl_master_flow.c"
                                           ));

    acl_non_blocking(acl_var_master_flow_pipe[0], 1);
    acl_non_blocking(acl_var_master_flow_pipe[1], 1);

    acl_close_on_exec(acl_var_master_flow_pipe[0], 1);
    acl_close_on_exec(acl_var_master_flow_pipe[1], 1);
}
...
int acl_master_flow_get(int len)
{
 ...
 if (fstat(4, &st) < 0)
  acl_msg_fatal("fstat flow pipe write descriptor: %s",
   strerror(
# 75 "/workspace/acl/lib_acl/src/master/acl_master_flow.c" 3 4
           (*__errno_location ())
# 75 "/workspace/acl/lib_acl/src/master/acl_master_flow.c"
                ));
...
int acl_master_flow_put(int len)
{
 ...
 memset(buf, 0, len > 1024 ? 1024 : len);
...
int acl_master_flow_count(void)
{
 ...
 if ((count = acl_peekfd(3)) < 0)
  acl_msg_warn("%s: %s", myname, strerror(
# 130 "/workspace/acl/lib_acl/src/master/acl_master_flow.c" 3 4
                                         (*__errno_location ())
# 130 "/workspace/acl/lib_acl/src/master/acl_master_flow.c"
                                              ));
 return count;
}
