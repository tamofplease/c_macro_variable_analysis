# 0 "/acl/lib_acl/src/xml/acl_xml3_util.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/xml/acl_xml3_util.c"
...
# 2 "/acl/lib_acl/src/xml/acl_xml3_util.c" 2
# 16 "/acl/lib_acl/src/xml/acl_xml3_util.c"
static ACL_TOKEN *tag_tree = 
# 16 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
                            ((void *)0)
# 16 "/acl/lib_acl/src/xml/acl_xml3_util.c"
                                ;
...
void acl_xml3_tag_init(void)
{
 ...
 if (tag_tree == 
# 22 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
                ((void *)0)
# 22 "/acl/lib_acl/src/xml/acl_xml3_util.c"
                    )
...
# 33 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
                                                     ((void *)0)
# 33 "/acl/lib_acl/src/xml/acl_xml3_util.c"
                                                         );
 }
}
...
int acl_xml3_tag_selfclosed(const char *tag)
{
 ...
 if (tag_tree == 
# 42 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
                ((void *)0)
# 42 "/acl/lib_acl/src/xml/acl_xml3_util.c"
                    )
  return (0);
...
{
 acl_array_free(a, 
# 64 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
                     ((void *)0)
# 64 "/acl/lib_acl/src/xml/acl_xml3_util.c"
                         );
}
...
ACL_XML3_NODE *acl_xml3_getFirstElementByTagName(ACL_XML3 *xml, const char *tag)
{
 ...
 return 
# 77 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
       ((void *)0)
# 77 "/acl/lib_acl/src/xml/acl_xml3_util.c"
           ;
}
...
ACL_ARRAY *acl_xml3_getElementsByTagName(ACL_XML3 *xml, const char *tag)
{
 ...
 if (acl_array_size(a) == 0) {
  acl_array_free(a, 
# 92 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
                      ((void *)0)
# 92 "/acl/lib_acl/src/xml/acl_xml3_util.c"
                          );
  return 
# 93 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
        ((void *)0)
# 93 "/acl/lib_acl/src/xml/acl_xml3_util.c"
            ;
 }
...
ACL_ARRAY *acl_xml3_getElementsByTags(ACL_XML3 *xml, const char *tags)
{
 ...
 if (a == 
# 106 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
         ((void *)0)
# 106 "/acl/lib_acl/src/xml/acl_xml3_util.c"
             ) {
  acl_argv_free(tokens);
  return 
# 108 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
        ((void *)0)
# 108 "/acl/lib_acl/src/xml/acl_xml3_util.c"
            ;
 }
 ...
 if (acl_array_size(ret) == 0) {
  acl_array_free(ret, 
# 132 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
                     ((void *)0)
# 132 "/acl/lib_acl/src/xml/acl_xml3_util.c"
                         );
  ret = 
# 133 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
       ((void *)0)
# 133 "/acl/lib_acl/src/xml/acl_xml3_util.c"
           ;
 }
 return ret;
}
 ...
 const char *name, const char *value)
{
 ...
 if (acl_array_size(a) == 0) {
  acl_array_free(a, 
# 161 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
                      ((void *)0)
# 161 "/acl/lib_acl/src/xml/acl_xml3_util.c"
                          );
  return 
# 162 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
        ((void *)0)
# 162 "/acl/lib_acl/src/xml/acl_xml3_util.c"
            ;
 }
...
const char *acl_xml3_getAttrValueById(ACL_XML3 *xml, const char *id)
{
 ...
 if (attr == 
# 182 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
            ((void *)0)
# 182 "/acl/lib_acl/src/xml/acl_xml3_util.c"
                )
  return 
# 183 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
        ((void *)0)
# 183 "/acl/lib_acl/src/xml/acl_xml3_util.c"
            ;
...
ACL_XML3_NODE *acl_xml3_getElementById(ACL_XML3 *xml, const char *id)
{
 ...
 if (attr == 
# 192 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
            ((void *)0)
# 192 "/acl/lib_acl/src/xml/acl_xml3_util.c"
                )
  return 
# 193 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
        ((void *)0)
# 193 "/acl/lib_acl/src/xml/acl_xml3_util.c"
            ;
 return attr->node;
}
ACL_XML3_NODE *acl_xml3_getElementMeta(ACL_XML3 *xml, const char *tag)
...
# 203 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
                                                             ((void *)0)
# 203 "/acl/lib_acl/src/xml/acl_xml3_util.c"
                                                                 )
   continue;
  if (strcasecmp(tag, node->ltag) == 0)
   return node;
 ...
 return 
# 209 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
       ((void *)0)
# 209 "/acl/lib_acl/src/xml/acl_xml3_util.c"
           ;
}
...
const char *acl_xml3_getEncoding(ACL_XML3 *xml)
{
 ...
 if (node == 
# 216 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
            ((void *)0)
# 216 "/acl/lib_acl/src/xml/acl_xml3_util.c"
                )
  return 
# 217 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
        ((void *)0)
# 217 "/acl/lib_acl/src/xml/acl_xml3_util.c"
            ;
...
const char *acl_xml3_getType(ACL_XML3 *xml)
{
 ...
 if (node == 
# 225 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
            ((void *)0)
# 225 "/acl/lib_acl/src/xml/acl_xml3_util.c"
                )
  return 
# 226 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
        ((void *)0)
# 226 "/acl/lib_acl/src/xml/acl_xml3_util.c"
            ;
...
ACL_XML3_ATTR *acl_xml3_getElementAttr(ACL_XML3_NODE *node, const char *name)
{
 ...
 return 
# 241 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
       ((void *)0)
# 241 "/acl/lib_acl/src/xml/acl_xml3_util.c"
           ;
}
...
const char *acl_xml3_getElementAttrVal(ACL_XML3_NODE *node, const char *name)
{
 ...
 return 
# 251 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
       ((void *)0)
# 251 "/acl/lib_acl/src/xml/acl_xml3_util.c"
           ;
}
...
int acl_xml3_removeElementAttr(ACL_XML3_NODE *node, const char *name)
{
 ...
 if (attr == 
# 258 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
            ((void *)0)
# 258 "/acl/lib_acl/src/xml/acl_xml3_util.c"
                )
  return -1;

 if (acl_array_delete_obj(node->attr_list, attr, 
# 261 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
                                                ((void *)0)
# 261 "/acl/lib_acl/src/xml/acl_xml3_util.c"
                                                    ) != 0)
  return -1;

 if (node->id == attr->value) {
  acl_htable_delete(node->xml->id_table, attr->value, 
# 265 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
                                                     ((void *)0)
# 265 "/acl/lib_acl/src/xml/acl_xml3_util.c"
                                                         );
  node->id = 
# 266 "/acl/lib_acl/src/xml/acl_xml3_util.c" 3 4
            ((void *)0)
# 266 "/acl/lib_acl/src/xml/acl_xml3_util.c"
                ;
 }
