# 1 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c" 2
# 39 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c"
...
{
 if ((xml->curr_node->flag & (1 << 4)) == 0) {
  if (acl_xml_tag_leaf(((char *) (xml->curr_node->ltag)->vbuf.data))) {
   xml->curr_node->flag |= (1 << 4);
  }
 }

 if ((xml->curr_node->flag & (1 << 3)) == 0) {
  if (xml->curr_node->last_ch == '/'
      || acl_xml_tag_selfclosed(((char *) (xml->curr_node->ltag)->vbuf.data)))
  {
   xml->curr_node->flag |= (1 << 3);
  }
 }
}
...
static const char *xml_parse_left_ch(ACL_XML *xml, const char *data)
{
 ...
 if (ch == '!') {
  ...
  xml->curr_node->status = 4;
  data++;
 } else if (ch == '?') {
  xml->curr_node->meta[0] = ch;
  xml->curr_node->flag |= (1 << 0);
  xml->curr_node->status = 12;
  data++;
 } else
  xml->curr_node->status = 5;
...
static const char *xml_parse_left_em(ACL_XML *xml, const char *data)
{
 if (*data == '-') {
  if (xml->curr_node->meta[1] != '-')
   ...
   xml->curr_node->flag |= (1 << 1);
   xml->curr_node->status = 14;
  }

  data++;
 } else {
  if (xml->curr_node->meta[1] == '-') {
   ((&(xml->curr_node->ltag)->vbuf)->ptr < (&(xml->curr_node->ltag)->vbuf)->data + (&(xml->curr_node->ltag)->vbuf)->len ? (int) (*(&(xml->curr_node->ltag)->vbuf)->ptr++ = ('-')) : acl_vbuf_put((&(xml->curr_node->ltag)->vbuf),('-')));
   xml->curr_node->meta[1] = 0;
  }

  xml->curr_node->flag |= (1 << 2);
  xml->curr_node->status = 12;
 }

 ((&(xml->curr_node->ltag)->vbuf)->ptr < (&(xml->curr_node->ltag)->vbuf)->data + (&(xml->curr_node->ltag)->vbuf)->len ? *(&(xml->curr_node->ltag)->vbuf)->ptr = 0 : acl_vbuf_space((&(xml->curr_node->ltag)->vbuf), 1), *(&(xml->curr_node->ltag)->vbuf)->ptr = 0);
...
static const char *xml_parse_cdata(ACL_XML *xml, const char *data)
{
 ...
 while ((ch = *data) != 0) {
  ...
  if (ch == '>') {
   ...
   {
    curr_node->status = 15;
    ((&(curr_node->text)->vbuf)->ptr < (&(curr_node->text)->vbuf)->data + (&(curr_node->text)->vbuf)->len ? *(&(curr_node->text)->vbuf)->ptr = 0 : acl_vbuf_space((&(curr_node->text)->vbuf), 1), *(&(curr_node->text)->vbuf)->ptr = 0);
    return data;
   }
   if (curr_node->meta[0])
    ((&(curr_node->text)->vbuf)->ptr < (&(curr_node->text)->vbuf)->data + (&(curr_node->text)->vbuf)->len ? (int) (*(&(curr_node->text)->vbuf)->ptr++ = (curr_node->meta[0])) : acl_vbuf_put((&(curr_node->text)->vbuf),(curr_node->meta[0])));
   curr_node->meta[0] = 0;
   if (curr_node->meta[1])
    ((&(curr_node->text)->vbuf)->ptr < (&(curr_node->text)->vbuf)->data + (&(curr_node->text)->vbuf)->len ? (int) (*(&(curr_node->text)->vbuf)->ptr++ = (curr_node->meta[1])) : acl_vbuf_put((&(curr_node->text)->vbuf),(curr_node->meta[1])));
   curr_node->meta[1] = 0;
  } else if (ch == ']') {
   if (curr_node->meta[0] == ']') {
    if (curr_node->meta[1] == ']')
     ((&(curr_node->text)->vbuf)->ptr < (&(curr_node->text)->vbuf)->data + (&(curr_node->text)->vbuf)->len ? (int) (*(&(curr_node->text)->vbuf)->ptr++ = (']')) : acl_vbuf_put((&(curr_node->text)->vbuf),(']')));
    else
     curr_node->meta[1] = ']';
   ...
   ((&(curr_node->text)->vbuf)->ptr < (&(curr_node->text)->vbuf)->data + (&(curr_node->text)->vbuf)->len ? (int) (*(&(curr_node->text)->vbuf)->ptr++ = (ch)) : acl_vbuf_put((&(curr_node->text)->vbuf),(ch)));
  }
 }
...
# 188 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c"
static void cdata_prepare(ACL_XML_NODE *curr_node)
{
 char *ptr;

 ((&(curr_node->ltag)->vbuf)->ptr < (&(curr_node->ltag)->vbuf)->data + (&(curr_node->ltag)->vbuf)->len ? *(&(curr_node->ltag)->vbuf)->ptr = 0 : acl_vbuf_space((&(curr_node->ltag)->vbuf), 1), *(&(curr_node->ltag)->vbuf)->ptr = 0);
 ptr = ((char *) (curr_node->ltag)->vbuf.data) + sizeof("[CDATA[") - 1;

 if (*ptr)
  acl_vstring_strcpy(curr_node->text, ptr);
 { (curr_node->ltag)->vbuf.ptr = (curr_node->ltag)->vbuf.data + (sizeof("[CDATA[") - 1); };
 ((&(curr_node->ltag)->vbuf)->ptr < (&(curr_node->ltag)->vbuf)->data + (&(curr_node->ltag)->vbuf)->len ? *(&(curr_node->ltag)->vbuf)->ptr = 0 : acl_vbuf_space((&(curr_node->ltag)->vbuf), 1), *(&(curr_node->ltag)->vbuf)->ptr = 0);
}
...
static const char *xml_parse_meta_tag(ACL_XML *xml, const char *data)
{
 ...
 while ((ch = *data) != 0) {
# 218 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c"
  if ((size_t) ((xml->curr_node->ltag)->vbuf.ptr - (xml->curr_node->ltag)->vbuf.data) >= sizeof("[CDATA[") - 1
   && (*(((char *) (xml->curr_node->ltag)->vbuf.data)) == '[' && (*(((char *) (xml->curr_node->ltag)->vbuf.data) + 1) == 'C' || *(((char *) (xml->curr_node->ltag)->vbuf.data) + 1) == 'c') && (*(((char *) (xml->curr_node->ltag)->vbuf.data) + 2) == 'D' || *(((char *) (xml->curr_node->ltag)->vbuf.data) + 2) == 'd') && (*(((char *) (xml->curr_node->ltag)->vbuf.data) + 3) == 'A' || *(((char *) (xml->curr_node->ltag)->vbuf.data) + 3) == 'a') && (*(((char *) (xml->curr_node->ltag)->vbuf.data) + 4) == 'T' || *(((char *) (xml->curr_node->ltag)->vbuf.data) + 4) == 't') && (*(((char *) (xml->curr_node->ltag)->vbuf.data) + 5) == 'A' || *(((char *) (xml->curr_node->ltag)->vbuf.data) + 5) == 'a') && *(((char *) (xml->curr_node->ltag)->vbuf.data) + 6) == '['))
  {
   cdata_prepare(xml->curr_node);
   xml->curr_node->status = 16;
   xml->curr_node->flag |= (1 << 5);
   break;
  } else if (((ch) == ' ' || (ch) == '\t' || (ch) == '\r' || (ch) == '\n') || ch == '>') {
   xml->curr_node->status = 13;
   data++;
   break;
  }
  ...
  ((&(xml->curr_node->ltag)->vbuf)->ptr < (&(xml->curr_node->ltag)->vbuf)->data + (&(xml->curr_node->ltag)->vbuf)->len ? (int) (*(&(xml->curr_node->ltag)->vbuf)->ptr++ = (ch)) : acl_vbuf_put((&(xml->curr_node->ltag)->vbuf),(ch)));
 }
...
static const char *xml_meta_attr_name(ACL_XML_ATTR *attr, const char *data)
{
 ...
 while ((ch = *data) != 0) {
  if (ch == '=') {
   data++;
   ((&(attr->name)->vbuf)->ptr < (&(attr->name)->vbuf)->data + (&(attr->name)->vbuf)->len ? *(&(attr->name)->vbuf)->ptr = 0 : acl_vbuf_space((&(attr->name)->vbuf), 1), *(&(attr->name)->vbuf)->ptr = 0);
   break;
  }
  if (!((ch) == ' ' || (ch) == '\t' || (ch) == '\r' || (ch) == '\n'))
   ((&(attr->name)->vbuf)->ptr < (&(attr->name)->vbuf)->data + (&(attr->name)->vbuf)->len ? (int) (*(&(attr->name)->vbuf)->ptr++ = (ch)) : acl_vbuf_put((&(attr->name)->vbuf),(ch)));
  data++;
 }
...
static const char *xml_meta_attr_value(ACL_XML_ATTR *attr, const char *data)
{
 ...
 while ((ch = *data) != 0) {
  if (attr->quote) {
   ...
   ((&(attr->value)->vbuf)->ptr < (&(attr->value)->vbuf)->data + (&(attr->value)->vbuf)->len ? (int) (*(&(attr->value)->vbuf)->ptr++ = (ch)) : acl_vbuf_put((&(attr->value)->vbuf),(ch)));
  } else if (((ch) == ' ' || (ch) == '\t' || (ch) == '\r' || (ch) == '\n')) {
   data++;
   break;
  } else
 ...
 ((&(attr->value)->vbuf)->ptr < (&(attr->value)->vbuf)->data + (&(attr->value)->vbuf)->len ? *(&(attr->value)->vbuf)->ptr = 0 : acl_vbuf_space((&(attr->value)->vbuf), 1), *(&(attr->value)->vbuf)->ptr = 0);
 return data;
}
...
static const char *xml_parse_meta_text(ACL_XML *xml, const char *data)
{
 ...
 if ((size_t) ((xml->curr_node->text)->vbuf.ptr - (xml->curr_node->text)->vbuf.data) == 0)
  { while(((*(data)) == ' ' || (*(data)) == '\t' || (*(data)) == '\r' || (*(data)) == '\n')) (data)++; };
 ...
 while ((ch = *data) != 0) {
  if (xml->curr_node->quote) {
   ...
   ((&(xml->curr_node->text)->vbuf)->ptr < (&(xml->curr_node->text)->vbuf)->data + (&(xml->curr_node->text)->vbuf)->len ? (int) (*(&(xml->curr_node->text)->vbuf)->ptr++ = (ch)) : acl_vbuf_put((&(xml->curr_node->text)->vbuf),(ch)));
  } else if (((ch) == '\"' || (ch) == '\'')) {
   ...
   data++;
   xml->curr_node->status = 15;
   if ((xml->curr_node->flag & (1 << 0)) == 0)
    break;

   last = ((char *) (xml->curr_node->text)->vbuf.ptr) - 1;
   if (last < ((char *) (xml->curr_node->text)->vbuf.data) || *last != '?')
    break;

   off = (int) (size_t) ((xml->curr_node->text)->vbuf.ptr - (xml->curr_node->text)->vbuf.data) - 1;
   if (off == 0)
    break;

   { (xml->curr_node->text)->vbuf.ptr = (xml->curr_node->text)->vbuf.data + (off); };
   ((&(xml->curr_node->text)->vbuf)->ptr < (&(xml->curr_node->text)->vbuf)->data + (&(xml->curr_node->text)->vbuf)->len ? *(&(xml->curr_node->text)->vbuf)->ptr = 0 : acl_vbuf_space((&(xml->curr_node->text)->vbuf), 1), *(&(xml->curr_node->text)->vbuf)->ptr = 0);
...
static const char *xml_parse_meta_comment(ACL_XML *xml, const char *data)
{
 ...
 while ((ch = *data) != 0) {
  if (xml->curr_node->quote) {
   ...
   if (xml->curr_node->meta[0] == '-') {
    ((&(xml->curr_node->text)->vbuf)->ptr < (&(xml->curr_node->text)->vbuf)->data + (&(xml->curr_node->text)->vbuf)->len ? (int) (*(&(xml->curr_node->text)->vbuf)->ptr++ = ('-')) : acl_vbuf_put((&(xml->curr_node->text)->vbuf),('-')));
    xml->curr_node->meta[0] = 0;
   }
   if (xml->curr_node->meta[1] == '-') {
    ((&(xml->curr_node->text)->vbuf)->ptr < (&(xml->curr_node->text)->vbuf)->data + (&(xml->curr_node->text)->vbuf)->len ? (int) (*(&(xml->curr_node->text)->vbuf)->ptr++ = ('-')) : acl_vbuf_put((&(xml->curr_node->text)->vbuf),('-')));
...
static const char *xml_parse_left_tag(ACL_XML *xml, const char *data)
{
 ...
 if ((size_t) ((xml->curr_node->ltag)->vbuf.ptr - (xml->curr_node->ltag)->vbuf.data) == 0)
  { while(((*(data)) == ' ' || (*(data)) == '\t' || (*(data)) == '\r' || (*(data)) == '\n')) (data)++; };
 ...
 while ((ch = *data) != 0) {
  ...
  if (ch == '>') {
   ...
   if ((xml->curr_node->flag & (1 << 3))
    && xml->curr_node->last_ch == '/')
   {
    acl_vstring_truncate(xml->curr_node->ltag,
     (size_t) ((xml->curr_node->ltag)->vbuf.ptr - (xml->curr_node->ltag)->vbuf.data) - 1);
    xml->curr_node->status = 7;
   } else
    xml->curr_node->status = 2;
   break;
  } else if (((ch) == ' ' || (ch) == '\t' || (ch) == '\r' || (ch) == '\n')) {
   xml->curr_node->status = 9;
...
static const char *xml_parse_attr(ACL_XML *xml, const char *data)
{
 ...
 if (attr == 
# 482 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c" 3 4
            ((void *)0) 
# 482 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c"
                 || (size_t) ((attr->name)->vbuf.ptr - (attr->name)->vbuf.data) == 0) {
  { while(((*(data)) == ' ' || (*(data)) == '\t' || (*(data)) == '\r' || (*(data)) == '\n')) (data)++; };
  { while(*(data) && (*data == '=')) (data)++; };
 }
 ...
 if (*data == '>') {
  ...
  xml->curr_node->curr_attr = 
# 500 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c" 3 4
                             ((void *)0)
# 500 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c"
                                 ;
  data++;
  return data;
 }
 ...
 if (attr == 
# 516 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c" 3 4
            ((void *)0)
# 516 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c"
                ) {
...
static const char *xml_parse_attr_val(ACL_XML *xml, const char *data)
{
 ...
 if ((size_t) ((attr->value)->vbuf.ptr - (attr->value)->vbuf.data) == 0 && !attr->quote) {
  { while(((*(data)) == ' ' || (*(data)) == '\t' || (*(data)) == '\r' || (*(data)) == '\n')) (data)++; };
  if (((*data) == '\"' || (*data) == '\''))
   attr->quote = *data++;
 }
  ...
  if (attr->quote) {
    ...
    && xml->curr_node->last_ch == '/')
   {
    acl_vstring_truncate(attr->value,
     (size_t) ((attr->value)->vbuf.ptr - (attr->value)->vbuf.data) - 1);
    xml->curr_node->status = 7;
   } else
    xml->curr_node->status = 2;
   break;
 ...
 if (xml->curr_node->status != 10) {
  if ((size_t) ((attr->value)->vbuf.ptr - (attr->value)->vbuf.data) > 0 && xml->decode_buf != 
# 586 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c" 3 4
                                                ((void *)0)
# 586 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c"
                                                    ) {
   { (xml->decode_buf)->vbuf.ptr = (xml->decode_buf)->vbuf.data; ((&(xml->decode_buf)->vbuf)->flags &= ~((1<<0) | (1<<1) | (1<<2))); };
   acl_xml_decode(((char *) (attr->value)->vbuf.data), xml->decode_buf);
   if ((size_t) ((xml->decode_buf)->vbuf.ptr - (xml->decode_buf)->vbuf.data) > 0)
    acl_vstring_strcpy(attr->value, ((char *) (xml->decode_buf)->vbuf.data));
  }


  if (((*(((char *) (attr->name)->vbuf.data)) == 'i' || *(((char *) (attr->name)->vbuf.data)) == 'I') && (*(((char *) (attr->name)->vbuf.data) + 1) == 'd' || *(((char *) (attr->name)->vbuf.data) + 1) == 'D')) && (size_t) ((attr->value)->vbuf.ptr - (attr->value)->vbuf.data) > 0) {
   const char *ptr = ((char *) (attr->value)->vbuf.data);


   if (acl_htable_find(xml->id_table, ptr) == 
# 598 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c" 3 4
                                             ((void *)0)
# 598 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c"
                                                 ) {
  ...
  xml->curr_node->curr_attr = 
# 609 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c" 3 4
                             ((void *)0)
# 609 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c"
                                 ;
 }
...
static const char *xml_parse_text(ACL_XML *xml, const char *data)
{
 ...
 if (xml->curr_node->status != 6)
  return data;

 if ((size_t) ((xml->curr_node->text)->vbuf.ptr - (xml->curr_node->text)->vbuf.data) == 0 || xml->decode_buf == 
# 648 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c" 3 4
                                                         ((void *)0)
# 648 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c"
                                                             )
  return data;

 { (xml->decode_buf)->vbuf.ptr = (xml->decode_buf)->vbuf.data; ((&(xml->decode_buf)->vbuf)->flags &= ~((1<<0) | (1<<1) | (1<<2))); };
 acl_xml_decode(((char *) (xml->curr_node->text)->vbuf.data), xml->decode_buf);
 if ((size_t) ((xml->decode_buf)->vbuf.ptr - (xml->decode_buf)->vbuf.data) > 0)
  acl_vstring_strcpy(xml->curr_node->text, ((char *) (xml->decode_buf)->vbuf.data));
...
static const char *xml_parse_right_lt(ACL_XML *xml, const char *data)
{
 ...
 if (*data == '/') {
  data++;
  xml->curr_node->status = 8;

  return data;
 } else if ((xml->curr_node->flag & (1 << 4))) {
  ((&(xml->curr_node->text)->vbuf)->ptr < (&(xml->curr_node->text)->vbuf)->data + (&(xml->curr_node->text)->vbuf)->len ? (int) (*(&(xml->curr_node->text)->vbuf)->ptr++ = ('<')) : acl_vbuf_put((&(xml->curr_node->text)->vbuf),('<')));
  ((&(xml->curr_node->text)->vbuf)->ptr < (&(xml->curr_node->text)->vbuf)->data + (&(xml->curr_node->text)->vbuf)->len ? (int) (*(&(xml->curr_node->text)->vbuf)->ptr++ = (*data)) : acl_vbuf_put((&(xml->curr_node->text)->vbuf),(*data)));
  ((&(xml->curr_node->text)->vbuf)->ptr < (&(xml->curr_node->text)->vbuf)->data + (&(xml->curr_node->text)->vbuf)->len ? *(&(xml->curr_node->text)->vbuf)->ptr = 0 : acl_vbuf_space((&(xml->curr_node->text)->vbuf), 1), *(&(xml->curr_node->text)->vbuf)->ptr = 0);
  xml->curr_node->status = 11;
  data++;
...
static void update_children_depth(ACL_XML_NODE *parent)
{
 ...
 for ((parent)->iter_head(&(iter), (parent)); (iter).ptr; (parent)->iter_next(&(iter), (parent))) {
...
static int search_match_node(ACL_XML *xml)
{
 ...
 while (parent != xml->root) {
  if (acl_strcasecmp(((char *) (xml->curr_node->rtag)->vbuf.data),
   ((char *) (parent->ltag)->vbuf.data)) == 0)
  {
   acl_vstring_strcpy(parent->rtag,
    ((char *) (xml->curr_node->rtag)->vbuf.data));
   { (xml->curr_node->rtag)->vbuf.ptr = (xml->curr_node->rtag)->vbuf.data; ((&(xml->curr_node->rtag)->vbuf)->flags &= ~((1<<0) | (1<<1) | (1<<2))); };
   ((&(xml->curr_node->rtag)->vbuf)->ptr < (&(xml->curr_node->rtag)->vbuf)->data + (&(xml->curr_node->rtag)->vbuf)->len ? *(&(xml->curr_node->rtag)->vbuf)->ptr = 0 : acl_vbuf_space((&(xml->curr_node->rtag)->vbuf), 1), *(&(xml->curr_node->rtag)->vbuf)->ptr = 0);
   parent->status = 7;
 ...
 if (parent == xml->root) {
  acl_array_free(nodes, 
# 745 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c" 3 4
                       ((void *)0)
# 745 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c"
                           );
  return 0;
 }

 for ((nodes)->iter_tail(&(iter), (nodes)); (iter).ptr; (nodes)->iter_prev(&(iter), (nodes))) {
 ...
 acl_array_free(nodes, 
# 758 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c" 3 4
                      ((void *)0)
# 758 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c"
                          );
...
static const char *xml_parse_right_tag(ACL_XML *xml, const char *data)
{
 ...
 if ((size_t) ((curr_node->rtag)->vbuf.ptr - (curr_node->rtag)->vbuf.data) == 0)
  { while(((*(data)) == ' ' || (*(data)) == '\t' || (*(data)) == '\r' || (*(data)) == '\n')) (data)++; };
 ...
 while ((ch = *data) != 0) {
  ...
  if (!((ch) == ' ' || (ch) == '\t' || (ch) == '\r' || (ch) == '\n'))
   ((&(curr_node->rtag)->vbuf)->ptr < (&(curr_node->rtag)->vbuf)->data + (&(curr_node->rtag)->vbuf)->len ? (int) (*(&(curr_node->rtag)->vbuf)->ptr++ = (ch)) : acl_vbuf_put((&(curr_node->rtag)->vbuf),(ch)));
 }

 ((&(curr_node->rtag)->vbuf)->ptr < (&(curr_node->rtag)->vbuf)->data + (&(curr_node->rtag)->vbuf)->len ? *(&(curr_node->rtag)->vbuf)->ptr = 0 : acl_vbuf_space((&(curr_node->rtag)->vbuf), 1), *(&(curr_node->rtag)->vbuf)->ptr = 0);

 if (curr_node->status != 7)
  return data;

 if (acl_strcasecmp(((char *) (curr_node->ltag)->vbuf.data), ((char *) (curr_node->rtag)->vbuf.data)) != 0) {
  int ret;
  ...
  if (ret == 0) {
   ...
   acl_vstring_strcat(curr_node->text,
    ((char *) (curr_node->rtag)->vbuf.data));
   { (curr_node->rtag)->vbuf.ptr = (curr_node->rtag)->vbuf.data; ((&(curr_node->rtag)->vbuf)->flags &= ~((1<<0) | (1<<1) | (1<<2))); };
   ((&(curr_node->rtag)->vbuf)->ptr < (&(curr_node->rtag)->vbuf)->data + (&(curr_node->rtag)->vbuf)->len ? *(&(curr_node->rtag)->vbuf)->ptr = 0 : acl_vbuf_space((&(curr_node->rtag)->vbuf), 1), *(&(curr_node->rtag)->vbuf)->ptr = 0);
...
static const char *xml_parse_right_gt(ACL_XML *xml, const char *data)
{
 ...
 if (parent == xml->root) {
  if ((xml->curr_node->flag & ((1 << 0) | (1 << 1) | (1 << 2))) == 0)
   xml->root_cnt++;
  xml->curr_node = 
# 826 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c" 3 4
                  ((void *)0)
# 826 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c"
                      ;
 } else
  xml->curr_node = parent;
...
static struct XML_STATUS_MACHINE status_tab[] = {
 { 0, xml_parse_next_left_lt },
 { 1, xml_parse_left_lt },
 { 2, xml_parse_left_gt },
 { 3, xml_parse_left_ch },
 { 4, xml_parse_left_em },
 { 5, xml_parse_left_tag },
 { 6, xml_parse_right_lt },
 { 7, xml_parse_right_gt },
 { 8, xml_parse_right_tag },
 { 9, xml_parse_attr },
 { 10, xml_parse_attr_val },
 { 11, xml_parse_text },
 { 12, xml_parse_meta_tag },
 { 13, xml_parse_meta_text },
 { 14, xml_parse_meta_comment },
 { 15, xml_parse_meta_end },
 { 16, xml_parse_cdata },
};
...
{
 if (data == 
# 855 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c" 3 4
            ((void *)0)
# 855 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c"
                )
  return "";
 else if (*data == 0)
  return data;

 if (!(xml->flag & (1 << 0)) && xml->root_cnt > 0)
  return data;
 ...
 while (*data) {
  if (xml->curr_node == 
# 866 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c" 3 4
                       ((void *)0)
# 866 "/workspace/acl/lib_acl/src/xml/acl_xml_parse.c"
                           ) {
   if (!(xml->flag & (1 << 0))
    && xml->root_cnt > 0)
   {
