# 1 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c" 2
# 29 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c"
...
static char *xml_parse_attr(ACL_XML3 *xml, char *data)
{
 ...
 if (attr == 
# 401 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c" 3 4
            ((void *)0) 
# 401 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c"
                 || attr->name == xml->addr) {
  { while(((*(data)) == ' ' || (*(data)) == '\t' || (*(data)) == '\r' || (*(data)) == '\n')) (data)++; };
  { while(*(data) && (*data == '=')) (data)++; };
 }
...
# 419 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c" 3 4
                             ((void *)0)
# 419 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c"
                                 ;
  *data++ = 0;
 ...
 if (attr == 
# 436 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c" 3 4
            ((void *)0)
# 436 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c"
                ) {
...
# 527 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c" 3 4
                                             ((void *)0)
# 527 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c"
                                                 ) {
  ...
  xml->curr_node->curr_attr = 
# 538 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c" 3 4
                             ((void *)0)
# 538 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c"
                                 ;
 }
...
# 659 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c" 3 4
                       ((void *)0)
# 659 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c"
                           );
  return 0;
 }
 ...
 acl_array_free(nodes, 
# 672 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c" 3 4
                      ((void *)0)
# 672 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c"
                          );
...
static char *xml_parse_right_gt(ACL_XML3 *xml, char *data)
{
 ...
 if (parent == xml->root) {
  if ((xml->curr_node->flag & ((1 << 0) | (1 << 1) | (1 << 2))) == 0)
   xml->root_cnt++;
  xml->curr_node = 
# 750 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c" 3 4
                  ((void *)0)
# 750 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c"
                      ;
 } else
  xml->curr_node = parent;
...
{
 if (data == 
# 778 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c" 3 4
            ((void *)0) 
# 778 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c"
                 || *data == 0)
  return data;
 ...
 while (*data) {
  if (xml->curr_node == 
# 787 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c" 3 4
                       ((void *)0)
# 787 "/workspace/acl/lib_acl/src/xml/acl_xml3_parse.c"
                           ) {
   if (!(xml->flag & (1 << 0))
    && xml->root_cnt > 0)
   {
