# 0 "/acl/lib_acl/src/xml/acl_xml3_parse.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/xml/acl_xml3_parse.c"
...
# 2 "/acl/lib_acl/src/xml/acl_xml3_parse.c" 2
# 29 "/acl/lib_acl/src/xml/acl_xml3_parse.c"
...
static char *xml_parse_attr(ACL_XML3 *xml, char *data)
{
 ...
 if (attr == 
# 401 "/acl/lib_acl/src/xml/acl_xml3_parse.c" 3 4
            ((void *)0) 
# 401 "/acl/lib_acl/src/xml/acl_xml3_parse.c"
                 || attr->name == xml->addr) {
  { while(((*(data)) == ' ' || (*(data)) == '\t' || (*(data)) == '\r' || (*(data)) == '\n')) (data)++; };
  { while(*(data) && (*data == '=')) (data)++; };
 }
...
# 419 "/acl/lib_acl/src/xml/acl_xml3_parse.c" 3 4
                             ((void *)0)
# 419 "/acl/lib_acl/src/xml/acl_xml3_parse.c"
                                 ;
  *data++ = 0;
 ...
 if (attr == 
# 436 "/acl/lib_acl/src/xml/acl_xml3_parse.c" 3 4
            ((void *)0)
# 436 "/acl/lib_acl/src/xml/acl_xml3_parse.c"
                ) {
...
# 527 "/acl/lib_acl/src/xml/acl_xml3_parse.c" 3 4
                                             ((void *)0)
# 527 "/acl/lib_acl/src/xml/acl_xml3_parse.c"
                                                 ) {
  ...
  xml->curr_node->curr_attr = 
# 538 "/acl/lib_acl/src/xml/acl_xml3_parse.c" 3 4
                             ((void *)0)
# 538 "/acl/lib_acl/src/xml/acl_xml3_parse.c"
                                 ;
 }
...
# 659 "/acl/lib_acl/src/xml/acl_xml3_parse.c" 3 4
                       ((void *)0)
# 659 "/acl/lib_acl/src/xml/acl_xml3_parse.c"
                           );
  return 0;
 }
 ...
 acl_array_free(nodes, 
# 672 "/acl/lib_acl/src/xml/acl_xml3_parse.c" 3 4
                      ((void *)0)
# 672 "/acl/lib_acl/src/xml/acl_xml3_parse.c"
                          );
...
static char *xml_parse_right_gt(ACL_XML3 *xml, char *data)
{
 ...
 if (parent == xml->root) {
  if ((xml->curr_node->flag & ((1 << 0) | (1 << 1) | (1 << 2))) == 0)
   xml->root_cnt++;
  xml->curr_node = 
# 750 "/acl/lib_acl/src/xml/acl_xml3_parse.c" 3 4
                  ((void *)0)
# 750 "/acl/lib_acl/src/xml/acl_xml3_parse.c"
                      ;
 } else
  xml->curr_node = parent;
...
{
 if (data == 
# 778 "/acl/lib_acl/src/xml/acl_xml3_parse.c" 3 4
            ((void *)0) 
# 778 "/acl/lib_acl/src/xml/acl_xml3_parse.c"
                 || *data == 0)
  return data;
 ...
 while (*data) {
  if (xml->curr_node == 
# 787 "/acl/lib_acl/src/xml/acl_xml3_parse.c" 3 4
                       ((void *)0)
# 787 "/acl/lib_acl/src/xml/acl_xml3_parse.c"
                           ) {
   if (!(xml->flag & (1 << 0))
    && xml->root_cnt > 0)
   {
