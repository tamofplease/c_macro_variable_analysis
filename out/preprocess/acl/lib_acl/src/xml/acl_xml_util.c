# 1 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 2
# 21 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
static ACL_TOKEN *tag_tree = 
# 21 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                            ((void *)0)
# 21 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                                ;
...
void acl_xml_tag_init(void)
{
 ...
 if (tag_tree == 
# 27 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                ((void *)0)
# 27 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                    )
...
# 38 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                                                     ((void *)0)
# 38 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                                                         );
 }
}
...
int acl_xml_tag_selfclosed(const char *tag)
{
 ...
 if (tag_tree == 
# 47 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                ((void *)0)
# 47 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                    )
  return (0);
...
{
 acl_array_free(a, 
# 69 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                     ((void *)0)
# 69 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                         );
}
...
ACL_XML_NODE *acl_xml_getFirstElementByTagName(ACL_XML *xml, const char *tag)
{
 ...
 for ((xml)->iter_head(&(iter), (xml)); (iter).ptr; (xml)->iter_next(&(iter), (xml))) {
  ...
  if (strcasecmp(tag, ((char *) (node->ltag)->vbuf.data)) == 0)
   return node;
 }

 return 
# 82 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
       ((void *)0)
# 82 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
           ;
}
...
ACL_ARRAY *acl_xml_getElementsByTagName(ACL_XML *xml, const char *tag)
{
 ...
 if (acl_array_size(a) == 0) {
  acl_array_free(a, 
# 97 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                      ((void *)0)
# 97 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                          );
  return 
# 98 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
        ((void *)0)
# 98 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
            ;
 }
...
ACL_ARRAY *acl_xml_getElementsByTags(ACL_XML *xml, const char *tags)
{
 ...
 if (a == 
# 111 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
         ((void *)0)
# 111 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
             ) {
  acl_argv_free(tokens);
  return 
# 113 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
        ((void *)0)
# 113 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
            ;
 }
 ...
 for ((a)->iter_head(&(iter), (a)); (iter).ptr; (a)->iter_next(&(iter), (a))) {
  ...
  while (i >= 0 && (parent = parent->parent) != xml->root) {
   if (strcasecmp(tokens->argv[i], "*") != 0
    && strcasecmp(tokens->argv[i], ((char *) (parent->ltag)->vbuf.data)))
   {
    break;
   }
   i--;
 ...
 if (acl_array_size(ret) == 0) {
  acl_array_free(ret, 
# 139 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                     ((void *)0)
# 139 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                         );
  ret = 
# 140 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
       ((void *)0)
# 140 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
           ;
 }
 return ret;
}
 ...
 const char *name, const char *value)
{
 ...
 for ((xml)->iter_head(&(iter), (xml)); (iter).ptr; (xml)->iter_next(&(iter), (xml))) {
  ...
  for ((node->attr_list)->iter_head(&(iter2), (node->attr_list)); (iter2).ptr; (node->attr_list)->iter_next(&(iter2), (node->attr_list))) {
   ...
   if (strcasecmp(((char *) (attr->name)->vbuf.data), name) == 0
    && strcasecmp(((char *) (attr->value)->vbuf.data), value) == 0)
   {
    acl_array_append(a, node);
    break;
   }
 ...
 if (acl_array_size(a) == 0) {
  acl_array_free(a, 
# 168 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                      ((void *)0)
# 168 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                          );
  return 
# 169 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
        ((void *)0)
# 169 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
            ;
 }
...
const char *acl_xml_getAttrValueById(ACL_XML *xml, const char *id)
{
 ...
 if (attr == 
# 189 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
            ((void *)0)
# 189 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                )
  return 
# 190 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
        ((void *)0)
# 190 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
            ;

 return ((char *) (attr->value)->vbuf.data);
}
...
ACL_XML_NODE *acl_xml_getElementById(ACL_XML *xml, const char *id)
{
 ...
 if (attr == 
# 199 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
            ((void *)0)
# 199 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                )
  return 
# 200 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
        ((void *)0)
# 200 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
            ;
 return attr->node;
}
ACL_XML_NODE *acl_xml_getElementMeta(ACL_XML *xml, const char *tag)
{
 ...
 return 
# 216 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
       ((void *)0)
# 216 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
           ;
}
...
const char *acl_xml_getEncoding(ACL_XML *xml)
{
 ...
 if (node == 
# 223 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
            ((void *)0)
# 223 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                )
  return 
# 224 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
        ((void *)0)
# 224 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
            ;
...
const char *acl_xml_getType(ACL_XML *xml)
{
 ...
 if (node == 
# 232 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
            ((void *)0)
# 232 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                )
  return 
# 233 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
        ((void *)0)
# 233 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
            ;
...
ACL_XML_ATTR *acl_xml_getElementAttr(ACL_XML_NODE *node, const char *name)
{
 ...
 return 
# 248 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
       ((void *)0)
# 248 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
           ;
}
...
const char *acl_xml_getElementAttrVal(ACL_XML_NODE *node, const char *name)
{
 ...
 return 
# 258 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
       ((void *)0)
# 258 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
           ;
}
...
int acl_xml_removeElementAttr(ACL_XML_NODE *node, const char *name)
{
 ...
 if (attr == 
# 265 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
            ((void *)0)
# 265 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                )
  return -1;

 if (acl_array_delete_obj(node->attr_list, attr, 
# 268 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                                                ((void *)0)
# 268 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                                                    ) != 0)
  return -1;

 if (node->id == attr->value) {
  acl_htable_delete(node->xml->id_table, ((char *) (attr->value)->vbuf.data), 
# 272 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                                                          ((void *)0)
# 272 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                                                              );
  node->id = 
# 273 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
            ((void *)0)
# 273 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                ;
 }
 ...
 const char *name, const char *value)
{
 ...
 if (attr) {
  ...
  node->xml->space += (size_t) ((attr->value)->vbuf.ptr - (attr->value)->vbuf.data);
  return attr;
 }

 attr = acl_xml_attr_alloc(node);
 acl_vstring_strcpy(attr->name, name);
 node->xml->space += (size_t) ((attr->name)->vbuf.ptr - (attr->name)->vbuf.data);
 escape_copy(attr->value, value, node->xml);
 node->xml->space += (size_t) ((attr->value)->vbuf.ptr - (attr->value)->vbuf.data);
...
# 331 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
((void) sizeof ((
# 331 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
tag && *tag
# 331 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
...
"tag && *tag"
# 331 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
, "/workspace/acl/lib_acl/src/xml/acl_xml_util.c", 331, __extension__ __PRETTY_FUNCTION__); }))
# 331 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                       ;
 acl_vstring_strcpy(node->ltag, tag);
 xml->space += (size_t) ((node->ltag)->vbuf.ptr - (node->ltag)->vbuf.data);
 if (text && *text) {
  escape_copy(node->text, text, xml);
  xml->space += (size_t) ((node->text)->vbuf.ptr - (node->text)->vbuf.data);
 }
...
# 347 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
((void) sizeof ((
# 347 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
tag && *tag
# 347 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 347 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
...
"tag && *tag"
# 347 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
, "/workspace/acl/lib_acl/src/xml/acl_xml_util.c", 347, __extension__ __PRETTY_FUNCTION__); }))
# 347 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                       ;
 acl_vstring_strcpy(node->ltag, tag);
 xml->space += (size_t) ((node->ltag)->vbuf.ptr - (node->ltag)->vbuf.data);
 if (in != 
# 350 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
          ((void *)0)
# 350 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
              )
...
# 361 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
((void) sizeof ((
# 361 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
name && *name
# 361 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 361 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
...
"name && *name"
# 361 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
, "/workspace/acl/lib_acl/src/xml/acl_xml_util.c", 361, __extension__ __PRETTY_FUNCTION__); }))
# 361 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                         ;
 acl_vstring_strcpy(attr->name, name);
 node->xml->space += (size_t) ((attr->name)->vbuf.ptr - (attr->name)->vbuf.data);
...
# 375 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
__builtin_va_start(
# 375 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
ap
# 375 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
,
# 375 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
...
# 375 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                  ;
 while ((name = 
# 376 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
               __builtin_va_arg(
# 376 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
               ap
# 376 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
               ,
# 376 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
...
# 376 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
  ...
  value = 
# 377 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
         __builtin_va_arg(
# 377 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
         ap
# 377 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
         ,
# 377 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
...
# 378 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
 ((void) sizeof ((
# 378 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
 value
# 378 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 378 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
...
# 378 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
 "value"
# 378 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
 , "/workspace/acl/lib_acl/src/xml/acl_xml_util.c", 378, __extension__ __PRETTY_FUNCTION__); }))
# 378 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                  ;
  acl_xml_node_add_attr(node, name, value);
 }
 
# 381 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
__builtin_va_end(
# 381 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
ap
# 381 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
)
# 381 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
...
void acl_xml_node_set_text(ACL_XML_NODE *node, const char *text)
{
 size_t n1 = (size_t) ((node->text)->vbuf.ptr - (node->text)->vbuf.data), n2;

 if (text != 
# 388 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
            ((void *)0) 
# 388 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                 && *text != 0) {
  escape_copy(node->text, text, node->xml);
  n2 = (size_t) ((node->text)->vbuf.ptr - (node->text)->vbuf.data);
  if (n2 > n1)
...
void acl_xml_node_add_text(ACL_XML_NODE *node, const char *text)
{
 ...
 if (text != 
# 400 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
            ((void *)0) 
# 400 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                 && *text != 0) {
 ...
 size_t off, size_t len)
{
 ...
 int ret;
 char buf[8192];
 size_t n1 = (size_t) ((node->text)->vbuf.ptr - (node->text)->vbuf.data), n2, n;

 if (in == 
# 416 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
          ((void *)0)
# 416 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
              )
  return;

 if (in->type == (1 << 1)
  && acl_vstream_fseek(in, (acl_off_t) off, 
# 420 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                                           0
# 420 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                                                   ) < 0)
 {
  const char *path = ((in)->path ? (in)->path : "");

  acl_msg_error("%s(%d): fseek error: %s, file: %s, from: %lu",
   myname, 425, acl_last_serror(),
...
ACL_VSTRING *acl_xml_build(ACL_XML *xml, ACL_VSTRING *buf)
{
 ...
 if (buf == 
# 469 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
           ((void *)0)
# 469 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
               )
 ...
 for ((xml)->iter_head(&(iter1), (xml)); (iter1).ptr; (xml)->iter_next(&(iter1), (xml))) {
  ...
  if ((((node)->flag & (1 << 5)))) {
   ...
   if ((size_t) ((node->text)->vbuf.ptr - (node->text)->vbuf.data) > 0)
    acl_vstring_strcat(buf, ((char *) (node->text)->vbuf.data));
  } else if ((((node)->flag & (1 << 1)))) {
   acl_vstring_strcat(buf, "<!--");
   acl_vstring_strcat(buf, ((char *) (node->text)->vbuf.data));
  } else if ((node->flag & (1 << 0))) {
   acl_vstring_strcat(buf, "<?");
   acl_vstring_strcat(buf, ((char *) (node->ltag)->vbuf.data));
  ...
  for ((node->attr_list)->iter_head(&(iter2), (node->attr_list)); (iter2).ptr; (node->attr_list)->iter_next(&(iter2), (node->attr_list))) {
   ...
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = (' ')) : acl_vbuf_put((&(buf)->vbuf),(' ')));
   acl_vstring_strcat(buf, ((char *) (attr->name)->vbuf.data));
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = ('=')) : acl_vbuf_put((&(buf)->vbuf),('=')));
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = ('"')) : acl_vbuf_put((&(buf)->vbuf),('"')));
   if ((size_t) ((attr->value)->vbuf.ptr - (attr->value)->vbuf.data) > 0)
    acl_vstring_strcat(buf, ((char *) (attr->value)->vbuf.data));
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = ('"')) : acl_vbuf_put((&(buf)->vbuf),('"')));
  }
  ...
  if ((((node)->flag & (1 << 5)))) {
   ...
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = ('>')) : acl_vbuf_put((&(buf)->vbuf),('>')));
  } else if ((size_t) ((node->text)->vbuf.ptr - (node->text)->vbuf.data) == 0) {
   acl_vstring_strcat(buf, "></");
   acl_vstring_strcat(buf, ((char *) (node->ltag)->vbuf.data));
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = ('>')) : acl_vbuf_put((&(buf)->vbuf),('>')));
  } else {
  ...
  while (node->parent != node->xml->root
   && acl_xml_node_next(node) == 
# 535 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                                ((void *)0)
# 535 "/workspace/acl/lib_acl/src/xml/acl_xml_util.c"
                                    )
  {
   acl_vstring_strcat(buf, "</");
   acl_vstring_strcat(buf, ((char *) (node->parent->ltag)->vbuf.data));
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = ('>')) : acl_vbuf_put((&(buf)->vbuf),('>')));
   node = node->parent;
  }
 }
 ...
 for ((xml)->iter_head(&(iter1), (xml)); (iter1).ptr; (xml)->iter_next(&(iter1), (xml))) {
  ...
  if ((((node)->flag & (1 << 1))))
   acl_vstream_buffed_fprintf(fp, "comment> text: %s\n",
    ((char *) (node->text)->vbuf.data));
  else
   acl_vstream_buffed_fprintf(fp, "tag> %s, text: %s\n",
    ((char *) (node->ltag)->vbuf.data), ((char *) (node->text)->vbuf.data));
  ...
  for ((node->attr_list)->iter_head(&(iter2), (node->attr_list)); (iter2).ptr; (node->attr_list)->iter_next(&(iter2), (node->attr_list))) {
   ...
   acl_vstream_buffed_fprintf(fp, "%sattr> %s: %s\n",
    sep, ((char *) (attr->name)->vbuf.data), ((char *) (attr->value)->vbuf.data));
  }
 }
