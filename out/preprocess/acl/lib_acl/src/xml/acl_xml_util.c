# 0 "/acl/lib_acl/src/xml/acl_xml_util.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/xml/acl_xml_util.c"
...
# 2 "/acl/lib_acl/src/xml/acl_xml_util.c" 2
# 21 "/acl/lib_acl/src/xml/acl_xml_util.c"
static ACL_TOKEN *tag_tree = 
# 21 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                            ((void *)0)
# 21 "/acl/lib_acl/src/xml/acl_xml_util.c"
                                ;
...
void acl_xml_tag_init(void)
{
 ...
 if (tag_tree == 
# 27 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                ((void *)0)
# 27 "/acl/lib_acl/src/xml/acl_xml_util.c"
                    )
...
# 38 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                                                     ((void *)0)
# 38 "/acl/lib_acl/src/xml/acl_xml_util.c"
                                                         );
 }
}
...
int acl_xml_tag_selfclosed(const char *tag)
{
 ...
 if (tag_tree == 
# 47 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                ((void *)0)
# 47 "/acl/lib_acl/src/xml/acl_xml_util.c"
                    )
  return (0);
...
{
 acl_array_free(a, 
# 69 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                     ((void *)0)
# 69 "/acl/lib_acl/src/xml/acl_xml_util.c"
                         );
}
...
ACL_XML_NODE *acl_xml_getFirstElementByTagName(ACL_XML *xml, const char *tag)
{
 ...
 return 
# 82 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
       ((void *)0)
# 82 "/acl/lib_acl/src/xml/acl_xml_util.c"
           ;
}
...
ACL_ARRAY *acl_xml_getElementsByTagName(ACL_XML *xml, const char *tag)
{
 ...
 if (acl_array_size(a) == 0) {
  acl_array_free(a, 
# 97 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                      ((void *)0)
# 97 "/acl/lib_acl/src/xml/acl_xml_util.c"
                          );
  return 
# 98 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
        ((void *)0)
# 98 "/acl/lib_acl/src/xml/acl_xml_util.c"
            ;
 }
...
ACL_ARRAY *acl_xml_getElementsByTags(ACL_XML *xml, const char *tags)
{
 ...
 if (a == 
# 111 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
         ((void *)0)
# 111 "/acl/lib_acl/src/xml/acl_xml_util.c"
             ) {
  acl_argv_free(tokens);
  return 
# 113 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
        ((void *)0)
# 113 "/acl/lib_acl/src/xml/acl_xml_util.c"
            ;
 }
 ...
 if (acl_array_size(ret) == 0) {
  acl_array_free(ret, 
# 139 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                     ((void *)0)
# 139 "/acl/lib_acl/src/xml/acl_xml_util.c"
                         );
  ret = 
# 140 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
       ((void *)0)
# 140 "/acl/lib_acl/src/xml/acl_xml_util.c"
           ;
 }
 return ret;
}
 ...
 const char *name, const char *value)
{
 ...
 if (acl_array_size(a) == 0) {
  acl_array_free(a, 
# 168 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                      ((void *)0)
# 168 "/acl/lib_acl/src/xml/acl_xml_util.c"
                          );
  return 
# 169 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
        ((void *)0)
# 169 "/acl/lib_acl/src/xml/acl_xml_util.c"
            ;
 }
...
const char *acl_xml_getAttrValueById(ACL_XML *xml, const char *id)
{
 ...
 if (attr == 
# 189 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
            ((void *)0)
# 189 "/acl/lib_acl/src/xml/acl_xml_util.c"
                )
  return 
# 190 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
        ((void *)0)
# 190 "/acl/lib_acl/src/xml/acl_xml_util.c"
            ;
...
ACL_XML_NODE *acl_xml_getElementById(ACL_XML *xml, const char *id)
{
 ...
 if (attr == 
# 199 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
            ((void *)0)
# 199 "/acl/lib_acl/src/xml/acl_xml_util.c"
                )
  return 
# 200 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
        ((void *)0)
# 200 "/acl/lib_acl/src/xml/acl_xml_util.c"
            ;
 return attr->node;
}
ACL_XML_NODE *acl_xml_getElementMeta(ACL_XML *xml, const char *tag)
{
 ...
 return 
# 216 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
       ((void *)0)
# 216 "/acl/lib_acl/src/xml/acl_xml_util.c"
           ;
}
...
const char *acl_xml_getEncoding(ACL_XML *xml)
{
 ...
 if (node == 
# 223 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
            ((void *)0)
# 223 "/acl/lib_acl/src/xml/acl_xml_util.c"
                )
  return 
# 224 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
        ((void *)0)
# 224 "/acl/lib_acl/src/xml/acl_xml_util.c"
            ;
...
const char *acl_xml_getType(ACL_XML *xml)
{
 ...
 if (node == 
# 232 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
            ((void *)0)
# 232 "/acl/lib_acl/src/xml/acl_xml_util.c"
                )
  return 
# 233 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
        ((void *)0)
# 233 "/acl/lib_acl/src/xml/acl_xml_util.c"
            ;
...
ACL_XML_ATTR *acl_xml_getElementAttr(ACL_XML_NODE *node, const char *name)
{
 ...
 return 
# 248 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
       ((void *)0)
# 248 "/acl/lib_acl/src/xml/acl_xml_util.c"
           ;
}
...
const char *acl_xml_getElementAttrVal(ACL_XML_NODE *node, const char *name)
{
 ...
 return 
# 258 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
       ((void *)0)
# 258 "/acl/lib_acl/src/xml/acl_xml_util.c"
           ;
}
...
int acl_xml_removeElementAttr(ACL_XML_NODE *node, const char *name)
{
 ...
 if (attr == 
# 265 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
            ((void *)0)
# 265 "/acl/lib_acl/src/xml/acl_xml_util.c"
                )
  return -1;

 if (acl_array_delete_obj(node->attr_list, attr, 
# 268 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                                                ((void *)0)
# 268 "/acl/lib_acl/src/xml/acl_xml_util.c"
                                                    ) != 0)
  return -1;

 if (node->id == attr->value) {
  acl_htable_delete(node->xml->id_table, ((char *) (attr->value)->vbuf.data), 
# 272 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                                                          ((void *)0)
# 272 "/acl/lib_acl/src/xml/acl_xml_util.c"
                                                              );
  node->id = 
# 273 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
            ((void *)0)
# 273 "/acl/lib_acl/src/xml/acl_xml_util.c"
                ;
 }
...
# 331 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
((void) sizeof ((
# 331 "/acl/lib_acl/src/xml/acl_xml_util.c"
tag && *tag
# 331 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
...
"tag && *tag"
# 331 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
, "/acl/lib_acl/src/xml/acl_xml_util.c", 331, __extension__ __PRETTY_FUNCTION__); }))
# 331 "/acl/lib_acl/src/xml/acl_xml_util.c"
                       ;
...
# 347 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
((void) sizeof ((
# 347 "/acl/lib_acl/src/xml/acl_xml_util.c"
tag && *tag
# 347 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 347 "/acl/lib_acl/src/xml/acl_xml_util.c"
...
"tag && *tag"
# 347 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
, "/acl/lib_acl/src/xml/acl_xml_util.c", 347, __extension__ __PRETTY_FUNCTION__); }))
# 347 "/acl/lib_acl/src/xml/acl_xml_util.c"
                       ;
 acl_vstring_strcpy(node->ltag, tag);
 xml->space += (size_t) ((node->ltag)->vbuf.ptr - (node->ltag)->vbuf.data);
 if (in != 
# 350 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
          ((void *)0)
# 350 "/acl/lib_acl/src/xml/acl_xml_util.c"
              )
...
# 361 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
((void) sizeof ((
# 361 "/acl/lib_acl/src/xml/acl_xml_util.c"
name && *name
# 361 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 361 "/acl/lib_acl/src/xml/acl_xml_util.c"
...
"name && *name"
# 361 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
, "/acl/lib_acl/src/xml/acl_xml_util.c", 361, __extension__ __PRETTY_FUNCTION__); }))
# 361 "/acl/lib_acl/src/xml/acl_xml_util.c"
                         ;
 acl_vstring_strcpy(attr->name, name);
 node->xml->space += (size_t) ((attr->name)->vbuf.ptr - (attr->name)->vbuf.data);
...
# 375 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
__builtin_va_start(
# 375 "/acl/lib_acl/src/xml/acl_xml_util.c"
ap
# 375 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
,
# 375 "/acl/lib_acl/src/xml/acl_xml_util.c"
...
# 375 "/acl/lib_acl/src/xml/acl_xml_util.c"
                  ;
 while ((name = 
# 376 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
               __builtin_va_arg(
# 376 "/acl/lib_acl/src/xml/acl_xml_util.c"
               ap
# 376 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
               ,
# 376 "/acl/lib_acl/src/xml/acl_xml_util.c"
...
# 376 "/acl/lib_acl/src/xml/acl_xml_util.c"
  ...
  value = 
# 377 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
         __builtin_va_arg(
# 377 "/acl/lib_acl/src/xml/acl_xml_util.c"
         ap
# 377 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
         ,
# 377 "/acl/lib_acl/src/xml/acl_xml_util.c"
...
# 378 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
 ((void) sizeof ((
# 378 "/acl/lib_acl/src/xml/acl_xml_util.c"
 value
# 378 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 378 "/acl/lib_acl/src/xml/acl_xml_util.c"
...
# 378 "/acl/lib_acl/src/xml/acl_xml_util.c"
 "value"
# 378 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
 , "/acl/lib_acl/src/xml/acl_xml_util.c", 378, __extension__ __PRETTY_FUNCTION__); }))
# 378 "/acl/lib_acl/src/xml/acl_xml_util.c"
                  ;
  acl_xml_node_add_attr(node, name, value);
 }
 
# 381 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
__builtin_va_end(
# 381 "/acl/lib_acl/src/xml/acl_xml_util.c"
ap
# 381 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
)
# 381 "/acl/lib_acl/src/xml/acl_xml_util.c"
...
void acl_xml_node_set_text(ACL_XML_NODE *node, const char *text)
{
 ...
 if (text != 
# 388 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
            ((void *)0) 
# 388 "/acl/lib_acl/src/xml/acl_xml_util.c"
                 && *text != 0) {
...
void acl_xml_node_add_text(ACL_XML_NODE *node, const char *text)
{
 ...
 if (text != 
# 400 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
            ((void *)0) 
# 400 "/acl/lib_acl/src/xml/acl_xml_util.c"
                 && *text != 0) {
 ...
 size_t off, size_t len)
{
 ...
 if (in == 
# 416 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
          ((void *)0)
# 416 "/acl/lib_acl/src/xml/acl_xml_util.c"
              )
  return;

 if (in->type == (1 << 1)
  && acl_vstream_fseek(in, (acl_off_t) off, 
# 420 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                                           0
# 420 "/acl/lib_acl/src/xml/acl_xml_util.c"
                                                   ) < 0)
 {
...
ACL_VSTRING *acl_xml_build(ACL_XML *xml, ACL_VSTRING *buf)
{
 ...
 if (buf == 
# 469 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
           ((void *)0)
# 469 "/acl/lib_acl/src/xml/acl_xml_util.c"
               )
...
# 535 "/acl/lib_acl/src/xml/acl_xml_util.c" 3 4
                                ((void *)0)
# 535 "/acl/lib_acl/src/xml/acl_xml_util.c"
                                    )
  {
   acl_vstring_strcat(buf, "</");
