# 0 "/acl/lib_acl/src/xml/acl_xml2_util.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/xml/acl_xml2_util.c"
...
# 2 "/acl/lib_acl/src/xml/acl_xml2_util.c" 2
# 18 "/acl/lib_acl/src/xml/acl_xml2_util.c"
static ACL_TOKEN *tag_tree = 
# 18 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                            ((void *)0)
# 18 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                                ;
...
void acl_xml2_tag_init(void)
{
 ...
 if (tag_tree == 
# 24 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                ((void *)0)
# 24 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                    )
...
# 35 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                                                     ((void *)0)
# 35 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                                                         );
 }
}
...
int acl_xml2_tag_selfclosed(const char *tag)
{
 ...
 if (tag_tree == 
# 44 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                ((void *)0)
# 44 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                    )
  return (0);
...
{
 acl_array_free(a, 
# 66 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                     ((void *)0)
# 66 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                         );
}
...
ACL_XML2_NODE *acl_xml2_getFirstElementByTagName(ACL_XML2 *xml, const char *tag)
{
 ...
 return 
# 79 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
       ((void *)0)
# 79 "/acl/lib_acl/src/xml/acl_xml2_util.c"
           ;
}
...
ACL_ARRAY *acl_xml2_getElementsByTagName(ACL_XML2 *xml, const char *tag)
{
 ...
 if (acl_array_size(a) == 0) {
  acl_array_free(a, 
# 94 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                      ((void *)0)
# 94 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                          );
  return 
# 95 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
        ((void *)0)
# 95 "/acl/lib_acl/src/xml/acl_xml2_util.c"
            ;
 }
...
ACL_ARRAY *acl_xml2_getElementsByTags(ACL_XML2 *xml, const char *tags)
{
 ...
 if (a == 
# 108 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
         ((void *)0)
# 108 "/acl/lib_acl/src/xml/acl_xml2_util.c"
             ) {
  acl_argv_free(tokens);
  return 
# 110 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
        ((void *)0)
# 110 "/acl/lib_acl/src/xml/acl_xml2_util.c"
            ;
 }
 ...
 if (acl_array_size(ret) == 0) {
  acl_array_free(ret, 
# 134 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                     ((void *)0)
# 134 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                         );
  ret = 
# 135 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
       ((void *)0)
# 135 "/acl/lib_acl/src/xml/acl_xml2_util.c"
           ;
 }
 return ret;
}
 ...
 const char *name, const char *value)
{
 ...
 if (acl_array_size(a) == 0) {
  acl_array_free(a, 
# 163 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                      ((void *)0)
# 163 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                          );
  return 
# 164 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
        ((void *)0)
# 164 "/acl/lib_acl/src/xml/acl_xml2_util.c"
            ;
 }
...
const char *acl_xml2_getAttrValueById(ACL_XML2 *xml, const char *id)
{
 ...
 if (attr == 
# 184 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
            ((void *)0)
# 184 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                )
  return 
# 185 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
        ((void *)0)
# 185 "/acl/lib_acl/src/xml/acl_xml2_util.c"
            ;
...
ACL_XML2_NODE *acl_xml2_getElementById(ACL_XML2 *xml, const char *id)
{
 ...
 if (attr == 
# 194 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
            ((void *)0)
# 194 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                )
  return 
# 195 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
        ((void *)0)
# 195 "/acl/lib_acl/src/xml/acl_xml2_util.c"
            ;
 return attr->node;
}
ACL_XML2_NODE *acl_xml2_getElementMeta(ACL_XML2 *xml, const char *tag)
{
 ...
 return 
# 211 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
       ((void *)0)
# 211 "/acl/lib_acl/src/xml/acl_xml2_util.c"
           ;
}
...
const char *acl_xml2_getEncoding(ACL_XML2 *xml)
{
 ...
 if (node == 
# 218 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
            ((void *)0)
# 218 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                )
  return 
# 219 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
        ((void *)0)
# 219 "/acl/lib_acl/src/xml/acl_xml2_util.c"
            ;
...
const char *acl_xml2_getType(ACL_XML2 *xml)
{
 ...
 if (node == 
# 227 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
            ((void *)0)
# 227 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                )
  return 
# 228 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
        ((void *)0)
# 228 "/acl/lib_acl/src/xml/acl_xml2_util.c"
            ;
...
ACL_XML2_ATTR *acl_xml2_getElementAttr(ACL_XML2_NODE *node, const char *name)
{
 ...
 return 
# 243 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
       ((void *)0)
# 243 "/acl/lib_acl/src/xml/acl_xml2_util.c"
           ;
}
...
const char *acl_xml2_getElementAttrVal(ACL_XML2_NODE *node, const char *name)
{
 ...
 return 
# 253 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
       ((void *)0)
# 253 "/acl/lib_acl/src/xml/acl_xml2_util.c"
           ;
}
...
int acl_xml2_removeElementAttr(ACL_XML2_NODE *node, const char *name)
{
 ...
 if (attr == 
# 260 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
            ((void *)0)
# 260 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                )
  return -1;

 if (acl_array_delete_obj(node->attr_list, attr, 
# 263 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                                                ((void *)0)
# 263 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                                                    ) != 0)
  return -1;

 if (node->id == attr->value) {
  acl_htable_delete(node->xml->id_table, attr->value, 
# 267 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                                                     ((void *)0)
# 267 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                                                         );
  node->id = 
# 268 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
            ((void *)0)
# 268 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                ;
 }

 return 0;
}
# 284 "/acl/lib_acl/src/xml/acl_xml2_util.c"
...
{
 if (text != 
# 299 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
            ((void *)0) 
# 299 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                 && *text != 0) {
...
{
 if (text != 
# 312 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
            ((void *)0) 
# 312 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                 && *text != 0) {
  node->text = ((char *) ((node->xml->vbuf))->vbuf.ptr);
  escape_append(node->xml->vbuf, text, node->xml);
  node->text_size = (ssize_t) (((char *) ((node->xml->vbuf))->vbuf.ptr) - node->text);
 ...
 size_t off, size_t len)
{
 ...
 if (in == 
# 328 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
          ((void *)0)
# 328 "/acl/lib_acl/src/xml/acl_xml2_util.c"
              )
  return;

 if (in->type == (1 << 1)
  && acl_vstream_fseek(in, (acl_off_t) off, 
# 332 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                                           0
# 332 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                                                   ) < 0)
 {
...
# 377 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
((void) sizeof ((
# 377 "/acl/lib_acl/src/xml/acl_xml2_util.c"
tag && *tag
# 377 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
...
"tag && *tag"
# 377 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
, "/acl/lib_acl/src/xml/acl_xml2_util.c", 377, __extension__ __PRETTY_FUNCTION__); }))
# 377 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                       ;
...
# 395 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
((void) sizeof ((
# 395 "/acl/lib_acl/src/xml/acl_xml2_util.c"
tag && *tag
# 395 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 395 "/acl/lib_acl/src/xml/acl_xml2_util.c"
...
"tag && *tag"
# 395 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
, "/acl/lib_acl/src/xml/acl_xml2_util.c", 395, __extension__ __PRETTY_FUNCTION__); }))
# 395 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                       ;
 ...
 if (fp != 
# 402 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
          ((void *)0)
# 402 "/acl/lib_acl/src/xml/acl_xml2_util.c"
              )
...
# 417 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
((void) sizeof ((
# 417 "/acl/lib_acl/src/xml/acl_xml2_util.c"
name && *name
# 417 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 417 "/acl/lib_acl/src/xml/acl_xml2_util.c"
...
"name && *name"
# 417 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
, "/acl/lib_acl/src/xml/acl_xml2_util.c", 417, __extension__ __PRETTY_FUNCTION__); }))
# 417 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                         ;
...
# 443 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
__builtin_va_start(
# 443 "/acl/lib_acl/src/xml/acl_xml2_util.c"
ap
# 443 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
,
# 443 "/acl/lib_acl/src/xml/acl_xml2_util.c"
...
# 443 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                  ;
 while ((name = 
# 444 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
               __builtin_va_arg(
# 444 "/acl/lib_acl/src/xml/acl_xml2_util.c"
               ap
# 444 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
               ,
# 444 "/acl/lib_acl/src/xml/acl_xml2_util.c"
...
# 444 "/acl/lib_acl/src/xml/acl_xml2_util.c"
  ...
  value = 
# 445 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
         __builtin_va_arg(
# 445 "/acl/lib_acl/src/xml/acl_xml2_util.c"
         ap
# 445 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
         ,
# 445 "/acl/lib_acl/src/xml/acl_xml2_util.c"
...
# 446 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
 ((void) sizeof ((
# 446 "/acl/lib_acl/src/xml/acl_xml2_util.c"
 value
# 446 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 446 "/acl/lib_acl/src/xml/acl_xml2_util.c"
...
# 446 "/acl/lib_acl/src/xml/acl_xml2_util.c"
 "value"
# 446 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
 , "/acl/lib_acl/src/xml/acl_xml2_util.c", 446, __extension__ __PRETTY_FUNCTION__); }))
# 446 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                  ;
  acl_xml2_node_add_attr(node, name, value);
 }
 
# 449 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
__builtin_va_end(
# 449 "/acl/lib_acl/src/xml/acl_xml2_util.c"
ap
# 449 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
)
# 449 "/acl/lib_acl/src/xml/acl_xml2_util.c"
...
const char *acl_xml2_build2(const ACL_XML2 *xml, ACL_VSTRING *vbuf)
{
 ...
 if (vbuf == 
# 508 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
            ((void *)0)
# 508 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                )
...
# 603 "/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                                 ((void *)0)
# 603 "/acl/lib_acl/src/xml/acl_xml2_util.c"
                                     )
  {
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('<'))) : acl_vbuf_put((&((vbuf))->vbuf),(('<'))));
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('/'))) : acl_vbuf_put((&((vbuf))->vbuf),(('/'))));
