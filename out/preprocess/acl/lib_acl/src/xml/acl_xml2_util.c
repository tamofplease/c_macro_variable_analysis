# 1 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 2
# 18 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
static ACL_TOKEN *tag_tree = 
# 18 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                            ((void *)0)
# 18 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                                ;
...
void acl_xml2_tag_init(void)
{
 ...
 if (tag_tree == 
# 24 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                ((void *)0)
# 24 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                    )
...
void acl_xml2_tag_add(const char *tag)
{
 if (tag_tree) {
  ...
  do { if (sizeof(buf) > 0) { size_t _n = strlen(tag); _n = _n > (size_t ) sizeof(buf) - 1? (size_t) sizeof(buf) - 1 : _n; memcpy(buf, tag, _n); buf[_n] = 0; } } while (0);
  acl_lowercase(buf);
  acl_token_tree_add(tag_tree, buf, (1 << 0), 
# 35 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                                                     ((void *)0)
# 35 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                                                         );
 }
}
...
int acl_xml2_tag_selfclosed(const char *tag)
{
 ...
 if (tag_tree == 
# 44 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                ((void *)0)
# 44 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                    )
  return (0);
...
{
 acl_array_free(a, 
# 66 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                     ((void *)0)
# 66 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                         );
}
...
ACL_XML2_NODE *acl_xml2_getFirstElementByTagName(ACL_XML2 *xml, const char *tag)
{
 ...
 for ((xml)->iter_head(&(iter), (xml)); (iter).ptr; (xml)->iter_next(&(iter), (xml))) {
 ...
 return 
# 79 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
       ((void *)0)
# 79 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
           ;
}
...
ACL_ARRAY *acl_xml2_getElementsByTagName(ACL_XML2 *xml, const char *tag)
{
 ...
 if (acl_array_size(a) == 0) {
  acl_array_free(a, 
# 94 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                      ((void *)0)
# 94 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                          );
  return 
# 95 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
        ((void *)0)
# 95 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
            ;
 }
...
ACL_ARRAY *acl_xml2_getElementsByTags(ACL_XML2 *xml, const char *tags)
{
 ...
 if (a == 
# 108 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
         ((void *)0)
# 108 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
             ) {
  acl_argv_free(tokens);
  return 
# 110 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
        ((void *)0)
# 110 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
            ;
 }
 ...
 if (acl_array_size(ret) == 0) {
  acl_array_free(ret, 
# 134 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                     ((void *)0)
# 134 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                         );
  ret = 
# 135 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
       ((void *)0)
# 135 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
           ;
 }
 return ret;
}
 ...
 const char *name, const char *value)
{
 ...
 for ((xml)->iter_head(&(iter), (xml)); (iter).ptr; (xml)->iter_next(&(iter), (xml))) {
  ...
  for ((node->attr_list)->iter_head(&(iter2), (node->attr_list)); (iter2).ptr; (node->attr_list)->iter_next(&(iter2), (node->attr_list))) {
 ...
 if (acl_array_size(a) == 0) {
  acl_array_free(a, 
# 163 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                      ((void *)0)
# 163 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                          );
  return 
# 164 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
        ((void *)0)
# 164 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
            ;
 }
...
const char *acl_xml2_getAttrValueById(ACL_XML2 *xml, const char *id)
{
 ...
 if (attr == 
# 184 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
            ((void *)0)
# 184 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                )
  return 
# 185 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
        ((void *)0)
# 185 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
            ;
...
ACL_XML2_NODE *acl_xml2_getElementById(ACL_XML2 *xml, const char *id)
{
 ...
 if (attr == 
# 194 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
            ((void *)0)
# 194 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                )
  return 
# 195 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
        ((void *)0)
# 195 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
            ;
 return attr->node;
}
ACL_XML2_NODE *acl_xml2_getElementMeta(ACL_XML2 *xml, const char *tag)
{
 ...
 return 
# 211 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
       ((void *)0)
# 211 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
           ;
}
...
const char *acl_xml2_getEncoding(ACL_XML2 *xml)
{
 ...
 if (node == 
# 218 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
            ((void *)0)
# 218 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                )
  return 
# 219 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
        ((void *)0)
# 219 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
            ;
...
const char *acl_xml2_getType(ACL_XML2 *xml)
{
 ...
 if (node == 
# 227 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
            ((void *)0)
# 227 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                )
  return 
# 228 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
        ((void *)0)
# 228 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
            ;
...
ACL_XML2_ATTR *acl_xml2_getElementAttr(ACL_XML2_NODE *node, const char *name)
{
 ...
 for ((node->attr_list)->iter_head(&(iter), (node->attr_list)); (iter).ptr; (node->attr_list)->iter_next(&(iter), (node->attr_list))) {
 ...
 return 
# 243 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
       ((void *)0)
# 243 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
           ;
}
...
const char *acl_xml2_getElementAttrVal(ACL_XML2_NODE *node, const char *name)
{
 ...
 return 
# 253 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
       ((void *)0)
# 253 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
           ;
}
...
int acl_xml2_removeElementAttr(ACL_XML2_NODE *node, const char *name)
{
 ...
 if (attr == 
# 260 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
            ((void *)0)
# 260 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                )
  return -1;

 if (acl_array_delete_obj(node->attr_list, attr, 
# 263 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                                                ((void *)0)
# 263 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                                                    ) != 0)
  return -1;

 if (node->id == attr->value) {
  acl_htable_delete(node->xml->id_table, attr->value, 
# 267 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                                                     ((void *)0)
# 267 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                                                         );
  node->id = 
# 268 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
            ((void *)0)
# 268 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                ;
 }

 return 0;
}
# 284 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
...
{
 if (text != 
# 299 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
            ((void *)0) 
# 299 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                 && *text != 0) {
  node->text = ((char *) ((node->xml->vbuf))->vbuf.ptr);
  escape_append(node->xml->vbuf, text, node->xml);
  node->text_size = (ssize_t) (((char *) ((node->xml->vbuf))->vbuf.ptr) - node->text);
  ((&((node->xml->vbuf))->vbuf)->ptr < (&((node->xml->vbuf))->vbuf)->data + (&((node->xml->vbuf))->vbuf)->len ? (int) (*(&((node->xml->vbuf))->vbuf)->ptr++ = (('\0'))) : acl_vbuf_put((&((node->xml->vbuf))->vbuf),(('\0'))));
 } else {
  node->text_size = 0;
...
{
 if (text != 
# 312 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
            ((void *)0) 
# 312 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                 && *text != 0) {
  node->text = ((char *) ((node->xml->vbuf))->vbuf.ptr);
  escape_append(node->xml->vbuf, text, node->xml);
  node->text_size = (ssize_t) (((char *) ((node->xml->vbuf))->vbuf.ptr) - node->text);
 ...
 size_t off, size_t len)
{
 ...
 if (in == 
# 328 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
          ((void *)0)
# 328 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
              )
  return;

 if (in->type == (1 << 1)
  && acl_vstream_fseek(in, (acl_off_t) off, 
# 332 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                                           0
# 332 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                                                   ) < 0)
 {
  const char *path = ((in)->path ? (in)->path : "");

  acl_msg_error("%s(%d): fseek error: %s, file: %s, from: %lu",
   myname, 337, acl_last_serror(),
...
# 377 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
((void) sizeof ((
# 377 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
tag && *tag
# 377 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
...
"tag && *tag"
# 377 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
, "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c", 377, __extension__ __PRETTY_FUNCTION__); }))
# 377 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                       ;

 node->ltag = ((char *) ((xml->vbuf))->vbuf.ptr);
 acl_vstring_strcat((xml->vbuf), (tag));
 node->ltag_size = (ssize_t) (((char *) ((xml->vbuf))->vbuf.ptr) - node->ltag);
 ((&((xml->vbuf))->vbuf)->ptr < (&((xml->vbuf))->vbuf)->data + (&((xml->vbuf))->vbuf)->len ? (int) (*(&((xml->vbuf))->vbuf)->ptr++ = (('\0'))) : acl_vbuf_put((&((xml->vbuf))->vbuf),(('\0'))));
...
# 395 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
((void) sizeof ((
# 395 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
tag && *tag
# 395 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 395 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
...
"tag && *tag"
# 395 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
, "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c", 395, __extension__ __PRETTY_FUNCTION__); }))
# 395 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                       ;
 ...
 if (fp != 
# 402 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
          ((void *)0)
# 402 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
              )
...
# 417 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
((void) sizeof ((
# 417 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
name && *name
# 417 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 417 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
...
"name && *name"
# 417 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
, "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c", 417, __extension__ __PRETTY_FUNCTION__); }))
# 417 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                         ;

 attr->name = ((char *) ((node->xml->vbuf))->vbuf.ptr);
 acl_vstring_strcat((node->xml->vbuf), (name));
 attr->name_size = (ssize_t) (((char *) ((node->xml->vbuf))->vbuf.ptr) - attr->name);
 ((&((node->xml->vbuf))->vbuf)->ptr < (&((node->xml->vbuf))->vbuf)->data + (&((node->xml->vbuf))->vbuf)->len ? (int) (*(&((node->xml->vbuf))->vbuf)->ptr++ = (('\0'))) : acl_vbuf_put((&((node->xml->vbuf))->vbuf),(('\0'))));

 if (value && *value) {
  attr->value = ((char *) ((node->xml->vbuf))->vbuf.ptr);
  escape_append(node->xml->vbuf, value, node->xml);
  attr->value_size = (ssize_t)
   (((char *) ((node->xml->vbuf))->vbuf.ptr) - attr->value);
  ((&((node->xml->vbuf))->vbuf)->ptr < (&((node->xml->vbuf))->vbuf)->data + (&((node->xml->vbuf))->vbuf)->len ? (int) (*(&((node->xml->vbuf))->vbuf)->ptr++ = (('\0'))) : acl_vbuf_put((&((node->xml->vbuf))->vbuf),(('\0'))));
 } else {
  attr->value_size = 0;
...
# 443 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
__builtin_va_start(
# 443 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
ap
# 443 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
,
# 443 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
...
# 443 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                  ;
 while ((name = 
# 444 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
               __builtin_va_arg(
# 444 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
               ap
# 444 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
               ,
# 444 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
...
# 444 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
  ...
  value = 
# 445 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
         __builtin_va_arg(
# 445 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
         ap
# 445 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
         ,
# 445 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
...
# 446 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
 ((void) sizeof ((
# 446 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
 value
# 446 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 446 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
...
# 446 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
 "value"
# 446 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
 , "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c", 446, __extension__ __PRETTY_FUNCTION__); }))
# 446 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                  ;
  acl_xml2_node_add_attr(node, name, value);
 }
 
# 449 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
__builtin_va_end(
# 449 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
ap
# 449 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
)
# 449 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
...
const char *acl_xml2_build2(const ACL_XML2 *xml, ACL_VSTRING *vbuf)
{
 ...
 if (vbuf == 
# 508 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
            ((void *)0)
# 508 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                )
  acl_msg_fatal("%s: vbuf can't be NULL!", myname);
 res = ((char *) ((xml->vbuf))->vbuf.ptr);

 for ((xml)->iter_head(&(iter1), (xml)); (iter1).ptr; (xml)->iter_next(&(iter1), (xml))) {
  if (((&((vbuf)->vbuf))->flags & (1<<1)))
   break;

  node = (ACL_XML2_NODE*) iter1.data;

  if ((((node)->flag & (1 << 5)))) {
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('<'))) : acl_vbuf_put((&((vbuf))->vbuf),(('<'))));
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('!'))) : acl_vbuf_put((&((vbuf))->vbuf),(('!'))));
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('['))) : acl_vbuf_put((&((vbuf))->vbuf),(('['))));
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('C'))) : acl_vbuf_put((&((vbuf))->vbuf),(('C'))));
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('D'))) : acl_vbuf_put((&((vbuf))->vbuf),(('D'))));
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('A'))) : acl_vbuf_put((&((vbuf))->vbuf),(('A'))));
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('T'))) : acl_vbuf_put((&((vbuf))->vbuf),(('T'))));
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('A'))) : acl_vbuf_put((&((vbuf))->vbuf),(('A'))));
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('['))) : acl_vbuf_put((&((vbuf))->vbuf),(('['))));
   if (node->text_size > 0)
    acl_vstring_strcat((vbuf), (node->text));
  } else if ((((node)->flag & (1 << 1)))) {
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('<'))) : acl_vbuf_put((&((vbuf))->vbuf),(('<'))));
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('!'))) : acl_vbuf_put((&((vbuf))->vbuf),(('!'))));
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('-'))) : acl_vbuf_put((&((vbuf))->vbuf),(('-'))));
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('-'))) : acl_vbuf_put((&((vbuf))->vbuf),(('-'))));
   if (node->text_size > 0)
    acl_vstring_strcat((vbuf), (node->text));
  } else if ((node->flag & (1 << 0))) {
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('<'))) : acl_vbuf_put((&((vbuf))->vbuf),(('<'))));
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('?'))) : acl_vbuf_put((&((vbuf))->vbuf),(('?'))));
   if (node->ltag_size > 0)
    acl_vstring_strcat((vbuf), (node->ltag));
  } else if ((node->flag & (1 << 2))) {
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('<'))) : acl_vbuf_put((&((vbuf))->vbuf),(('<'))));
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('!'))) : acl_vbuf_put((&((vbuf))->vbuf),(('!'))));
   if (node->ltag_size > 0)
    acl_vstring_strcat((vbuf), (node->ltag));
  ...
  for ((node->attr_list)->iter_head(&(iter2), (node->attr_list)); (iter2).ptr; (node->attr_list)->iter_next(&(iter2), (node->attr_list))) {
   ...
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = ((' '))) : acl_vbuf_put((&((vbuf))->vbuf),((' '))));
   acl_vstring_strcat((vbuf), (attr->name));
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('='))) : acl_vbuf_put((&((vbuf))->vbuf),(('='))));
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('"'))) : acl_vbuf_put((&((vbuf))->vbuf),(('"'))));
   acl_vstring_strcat((vbuf), (attr->value));
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('"'))) : acl_vbuf_put((&((vbuf))->vbuf),(('"'))));
  }
  ...
  while (node->parent != node->xml->root
   && acl_xml2_node_next(node) == 
# 603 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c" 3 4
                                 ((void *)0)
# 603 "/workspace/acl/lib_acl/src/xml/acl_xml2_util.c"
                                     )
  {
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('<'))) : acl_vbuf_put((&((vbuf))->vbuf),(('<'))));
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('/'))) : acl_vbuf_put((&((vbuf))->vbuf),(('/'))));
   acl_vstring_strcat((vbuf), (node->parent->ltag));
   ((&((vbuf))->vbuf)->ptr < (&((vbuf))->vbuf)->data + (&((vbuf))->vbuf)->len ? (int) (*(&((vbuf))->vbuf)->ptr++ = (('>'))) : acl_vbuf_put((&((vbuf))->vbuf),(('>'))));
   node = node->parent;
  }
 }
