# 1 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c" 2
# 50 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c"
...
static const char *xml_parse_left_em(ACL_XML2 *xml, const char *data)
{
 if (*data == '-') {
  ...
  if (xml->curr_node->meta[1] == '-') {
   if (((&((xml)->vbuf->vbuf))->flags & (1<<1)))
    return data;

   if (xml->curr_node->ltag == xml->dummy)
    xml->curr_node->ltag = ((char *) ((xml)->vbuf)->vbuf.ptr);

   ((&((xml)->vbuf)->vbuf)->ptr < (&((xml)->vbuf)->vbuf)->data + (&((xml)->vbuf)->vbuf)->len ? (int) (*(&((xml)->vbuf)->vbuf)->ptr++ = (('-'))) : acl_vbuf_put((&((xml)->vbuf)->vbuf),(('-'))));
   xml->curr_node->meta[1] = 0;
  }
  ...
  if (ch == '>') {
    ...
    && curr_node->meta[1] == ']')
   {
    ...
    curr_node->text_size = (ssize_t)
     (((char *) ((xml)->vbuf)->vbuf.ptr) - curr_node->text);
    ((&((xml)->vbuf)->vbuf)->ptr < (&((xml)->vbuf)->vbuf)->data + (&((xml)->vbuf)->vbuf)->len ? (int) (*(&((xml)->vbuf)->vbuf)->ptr++ = (('\0'))) : acl_vbuf_put((&((xml)->vbuf)->vbuf),(('\0'))));
    return data;
   }
   if (curr_node->meta[0] == ']') {
    ((&((xml)->vbuf)->vbuf)->ptr < (&((xml)->vbuf)->vbuf)->data + (&((xml)->vbuf)->vbuf)->len ? (int) (*(&((xml)->vbuf)->vbuf)->ptr++ = ((curr_node->meta[0]))) : acl_vbuf_put((&((xml)->vbuf)->vbuf),((curr_node->meta[0]))));
    curr_node->meta[0] = 0;
   }
   if (curr_node->meta[1] == ']') {
    ((&((xml)->vbuf)->vbuf)->ptr < (&((xml)->vbuf)->vbuf)->data + (&((xml)->vbuf)->vbuf)->len ? (int) (*(&((xml)->vbuf)->vbuf)->ptr++ = ((curr_node->meta[1]))) : acl_vbuf_put((&((xml)->vbuf)->vbuf),((curr_node->meta[1]))));
    curr_node->meta[1] = 0;
   }
  } else if (ch == ']') {
   if (curr_node->meta[0] == ']') {
   ...
   ((&((xml)->vbuf)->vbuf)->ptr < (&((xml)->vbuf)->vbuf)->data + (&((xml)->vbuf)->vbuf)->len ? (int) (*(&((xml)->vbuf)->vbuf)->ptr++ = ((ch))) : acl_vbuf_put((&((xml)->vbuf)->vbuf),((ch))));
  }
 }

 ((&((xml)->vbuf)->vbuf)->ptr < (&((xml)->vbuf)->vbuf)->data + (&((xml)->vbuf)->vbuf)->len ? *(&((xml)->vbuf)->vbuf)->ptr = 0 : acl_vbuf_space((&((xml)->vbuf)->vbuf), 1), *(&((xml)->vbuf)->vbuf)->ptr = 0);

 return data;
}
# 211 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c"
static const char *xml_parse_meta_tag(ACL_XML2 *xml, const char *data)
{
 ...
 while ((ch = *data) != 0) {
  if (((char *) ((xml)->vbuf)->vbuf.ptr) - xml->curr_node->ltag >= (ssize_t) (sizeof("[CDATA[") - 1)
   && (*(xml->curr_node->ltag) == '[' && (*(xml->curr_node->ltag + 1) == 'C' || *(xml->curr_node->ltag + 1) == 'c') && (*(xml->curr_node->ltag + 2) == 'D' || *(xml->curr_node->ltag + 2) == 'd') && (*(xml->curr_node->ltag + 3) == 'A' || *(xml->curr_node->ltag + 3) == 'a') && (*(xml->curr_node->ltag + 4) == 'T' || *(xml->curr_node->ltag + 4) == 't') && (*(xml->curr_node->ltag + 5) == 'A' || *(xml->curr_node->ltag + 5) == 't') && *(xml->curr_node->ltag + 6) == '['))
  {
   xml->curr_node->ltag_size = (ssize_t)
    (((char *) ((xml)->vbuf)->vbuf.ptr) - xml->curr_node->ltag);
   ((&((xml)->vbuf)->vbuf)->ptr < (&((xml)->vbuf)->vbuf)->data + (&((xml)->vbuf)->vbuf)->len ? (int) (*(&((xml)->vbuf)->vbuf)->ptr++ = (('\0'))) : acl_vbuf_put((&((xml)->vbuf)->vbuf),(('\0'))));
   xml->curr_node->text = ((char *) ((xml)->vbuf)->vbuf.ptr);
...
static char *xml_meta_attr_value(ACL_XML2_ATTR *attr, char *data)
{
 ...
 if ((xml->flag & (1 << 2)) && attr->value_size > 0) {
  const char *ptr = attr->value;

  attr->value = ((char *) ((xml)->vbuf)->vbuf.ptr);
  (void) acl_xml_decode(ptr, xml->vbuf);
  attr->value_size = (ssize_t) (((char *) ((xml)->vbuf)->vbuf.ptr) - attr->value);
  ((&((xml)->vbuf)->vbuf)->ptr < (&((xml)->vbuf)->vbuf)->data + (&((xml)->vbuf)->vbuf)->len ? (int) (*(&((xml)->vbuf)->vbuf)->ptr++ = (('\0'))) : acl_vbuf_put((&((xml)->vbuf)->vbuf),(('\0'))));
 }
...
static const char *xml_parse_meta_text(ACL_XML2 *xml, const char *data)
{
 ...
 while ((ch = *data) != 0) {
  if (xml->curr_node->quote) {
   ...
   xml->curr_node->text_size = (ssize_t)
    (((char *) ((xml)->vbuf)->vbuf.ptr) - xml->curr_node->text);
 ...
 if (xml->curr_node->status == 15
  && (xml->flag & (1 << 2))
  && xml->curr_node->text_size > 0 && !((&((xml)->vbuf->vbuf))->flags & (1<<1)))
 {
...
static const char *xml_parse_attr(ACL_XML2 *xml, const char *data)
{
 ...
 if (attr == 
# 616 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c" 3 4
            ((void *)0) 
# 616 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c"
                 || attr->name == xml->dummy) {
  { while(((*(data)) == ' ' || (*(data)) == '\t' || (*(data)) == '\r' || (*(data)) == '\n')) (data)++; };
  { while(*(data) && (*data == '=')) (data)++; };
 }
...
# 634 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c" 3 4
                             ((void *)0)
# 634 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c"
                                 ;
  if (((&((xml)->vbuf->vbuf))->flags & (1<<1)))
   return data;
  data++;
 ...
 if (attr == 
# 654 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c" 3 4
            ((void *)0)
# 654 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c"
                ) {
  attr = acl_xml2_attr_alloc(xml->curr_node);
  xml->curr_node->curr_attr = attr;
  attr->name = ((char *) ((xml)->vbuf)->vbuf.ptr);
 }
 ...
 while ((ch = *data) != 0) {
  ...
  if (ch == '=') {
   if (((&((xml)->vbuf->vbuf))->flags & (1<<1)))
    return data;
   data++;
   attr->name_size = (ssize_t) (((char *) ((xml)->vbuf)->vbuf.ptr) - attr->name);
   ((&((xml)->vbuf)->vbuf)->ptr < (&((xml)->vbuf)->vbuf)->data + (&((xml)->vbuf)->vbuf)->len ? (int) (*(&((xml)->vbuf)->vbuf)->ptr++ = (('\0'))) : acl_vbuf_put((&((xml)->vbuf)->vbuf),(('\0'))));
...
static const char *xml_parse_attr_val(ACL_XML2 *xml, const char *data)
{
  ...
  if (attr->quote) {
   if (ch == attr->quote) {
    ...
    attr->value_size = (ssize_t)
     (((char *) ((xml)->vbuf)->vbuf.ptr) - attr->value);
    ((&((xml)->vbuf)->vbuf)->ptr < (&((xml)->vbuf)->vbuf)->data + (&((xml)->vbuf)->vbuf)->len ? (int) (*(&((xml)->vbuf)->vbuf)->ptr++ = (('\0'))) : acl_vbuf_put((&((xml)->vbuf)->vbuf),(('\0'))));
    xml->curr_node->status = 9;
    xml->curr_node->last_ch = ch;
    break;
 ...
 if ((xml->flag & (1 << 2)) && attr->value_size > 1) {
 ...
 if (((*(attr->name) == 'i' || *(attr->name) == 'I') && (*(attr->name + 1) == 'd' || *(attr->name + 1) == 'D')) && *attr->value != 0) {
  const char *ptr = attr->value;


  if (acl_htable_find(xml->id_table, ptr) == 
# 775 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c" 3 4
                                            ((void *)0)
# 775 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c"
                                                ) {
 ...
 xml->curr_node->curr_attr = 
# 786 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c" 3 4
                            ((void *)0)
# 786 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c"
                                ;
...
static const char *xml_parse_text(ACL_XML2 *xml, const char *data)
{
  ...
  && !((&((xml)->vbuf->vbuf))->flags & (1<<1)))
 {
  ...
  xml->curr_node->text_size = (ssize_t)
   (((char *) ((xml)->vbuf)->vbuf.ptr) - xml->curr_node->text);
  txt = ((char *) ((xml)->vbuf)->vbuf.ptr) - 1;

  while (txt >= xml->curr_node->text && ((*txt) == ' ' || (*txt) == '\t' || (*txt) == '\r' || (*txt) == '\n')) {
   *txt-- = 0;
...
static const char *xml_parse_right_lt(ACL_XML2 *xml, const char *data)
{
 ...
 if (*data == '/') {
  ...
  if (((&((xml)->vbuf->vbuf))->flags & (1<<1)))
   return data;
  ((&((xml)->vbuf)->vbuf)->ptr < (&((xml)->vbuf)->vbuf)->data + (&((xml)->vbuf)->vbuf)->len ? (int) (*(&((xml)->vbuf)->vbuf)->ptr++ = ((*data))) : acl_vbuf_put((&((xml)->vbuf)->vbuf),((*data))));
  data++;
  xml->curr_node->status = 11;
...
static int search_match_node(ACL_XML2 *xml)
{
 ...
 while (parent != xml->root) {
  if (acl_strcasecmp(xml->curr_node->rtag, parent->ltag) == 0) {
   parent->rtag = ((char *) ((xml)->vbuf)->vbuf.ptr);
   acl_vstring_strcat((xml)->vbuf, (xml->curr_node->rtag));
   parent->status = 7;
...
# 942 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c" 3 4
                       ((void *)0)
# 942 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c"
                           );
  return 0;
 }
 ...
 acl_array_free(nodes, 
# 955 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c" 3 4
                      ((void *)0)
# 955 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c"
                          );
...
static const char *xml_parse_right_tag(ACL_XML2 *xml, const char *data)
{
 ...
 if (curr_node->rtag == xml->dummy)
  curr_node->rtag = ((char *) ((xml)->vbuf)->vbuf.ptr);
 ...
 while ((ch = *data) != 0) {
  if (ch == '>') {
   ...
   curr_node->rtag_size = (ssize_t)
    (((char *) ((xml)->vbuf)->vbuf.ptr) - curr_node->rtag);
   ((&((xml)->vbuf)->vbuf)->ptr < (&((xml)->vbuf)->vbuf)->data + (&((xml)->vbuf)->vbuf)->len ? (int) (*(&((xml)->vbuf)->vbuf)->ptr++ = (('\0'))) : acl_vbuf_put((&((xml)->vbuf)->vbuf),(('\0'))));
   curr_node->status = 7;
   break;
  }
 ...
 if (acl_strcasecmp(curr_node->ltag, curr_node->rtag) != 0) {
  ...
  if (ret == 0) {
   ...
   curr_node->text = ((char *) ((xml)->vbuf)->vbuf.ptr);
   acl_vstring_strcat((xml)->vbuf, (curr_node->rtag));
...
static const char *xml_parse_right_gt(ACL_XML2 *xml, const char *data)
{
 ...
 if (parent == xml->root) {
  if ((xml->curr_node->flag & ((1 << 0) | (1 << 1) | (1 << 2))) == 0)
   xml->root_cnt++;
  xml->curr_node = 
# 1031 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c" 3 4
                  ((void *)0)
# 1031 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c"
                      ;
 } else
  xml->curr_node = parent;
...
const char *acl_xml2_update(ACL_XML2 *xml, const char *data)
{
 ...
 if (data == 
# 1062 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c" 3 4
            ((void *)0)
# 1062 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c"
                )
  return "";
 else if (*data == 0)
  return data;
 ...
 while (*data) {
  if (xml->curr_node == 
# 1073 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c" 3 4
                       ((void *)0)
# 1073 "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c"
                           ) {
   if (!(xml->flag & (1 << 0))
    && xml->root_cnt > 0)
   {
  ...
  if (((&((xml)->vbuf->vbuf))->flags & (1<<1))) {
   acl_msg_warn("%s(%d), %s: space not enougth!",
    "/workspace/acl/lib_acl/src/xml/acl_xml2_parse.c", 1095, myname);
   break;
  }
 }
