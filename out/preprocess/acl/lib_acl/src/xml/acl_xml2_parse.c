# 0 "/acl/lib_acl/src/xml/acl_xml2_parse.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/xml/acl_xml2_parse.c"
...
# 2 "/acl/lib_acl/src/xml/acl_xml2_parse.c" 2
# 50 "/acl/lib_acl/src/xml/acl_xml2_parse.c"
...
# 211 "/acl/lib_acl/src/xml/acl_xml2_parse.c"
...
static const char *xml_parse_attr(ACL_XML2 *xml, const char *data)
{
 ...
 if (attr == 
# 616 "/acl/lib_acl/src/xml/acl_xml2_parse.c" 3 4
            ((void *)0) 
# 616 "/acl/lib_acl/src/xml/acl_xml2_parse.c"
                 || attr->name == xml->dummy) {
  { while(((*(data)) == ' ' || (*(data)) == '\t' || (*(data)) == '\r' || (*(data)) == '\n')) (data)++; };
  { while(*(data) && (*data == '=')) (data)++; };
 }
...
# 634 "/acl/lib_acl/src/xml/acl_xml2_parse.c" 3 4
                             ((void *)0)
# 634 "/acl/lib_acl/src/xml/acl_xml2_parse.c"
                                 ;
  if (((&((xml)->vbuf->vbuf))->flags & (1<<1)))
   return data;
  data++;
 ...
 if (attr == 
# 654 "/acl/lib_acl/src/xml/acl_xml2_parse.c" 3 4
            ((void *)0)
# 654 "/acl/lib_acl/src/xml/acl_xml2_parse.c"
                ) {
...
# 775 "/acl/lib_acl/src/xml/acl_xml2_parse.c" 3 4
                                            ((void *)0)
# 775 "/acl/lib_acl/src/xml/acl_xml2_parse.c"
                                                ) {
 ...
 xml->curr_node->curr_attr = 
# 786 "/acl/lib_acl/src/xml/acl_xml2_parse.c" 3 4
                            ((void *)0)
# 786 "/acl/lib_acl/src/xml/acl_xml2_parse.c"
                                ;
...
# 942 "/acl/lib_acl/src/xml/acl_xml2_parse.c" 3 4
                       ((void *)0)
# 942 "/acl/lib_acl/src/xml/acl_xml2_parse.c"
                           );
  return 0;
 }
 ...
 acl_array_free(nodes, 
# 955 "/acl/lib_acl/src/xml/acl_xml2_parse.c" 3 4
                      ((void *)0)
# 955 "/acl/lib_acl/src/xml/acl_xml2_parse.c"
                          );
...
static const char *xml_parse_right_gt(ACL_XML2 *xml, const char *data)
{
 ...
 if (parent == xml->root) {
  if ((xml->curr_node->flag & ((1 << 0) | (1 << 1) | (1 << 2))) == 0)
   xml->root_cnt++;
  xml->curr_node = 
# 1031 "/acl/lib_acl/src/xml/acl_xml2_parse.c" 3 4
                  ((void *)0)
# 1031 "/acl/lib_acl/src/xml/acl_xml2_parse.c"
                      ;
 } else
  xml->curr_node = parent;
...
const char *acl_xml2_update(ACL_XML2 *xml, const char *data)
{
 ...
 if (data == 
# 1062 "/acl/lib_acl/src/xml/acl_xml2_parse.c" 3 4
            ((void *)0)
# 1062 "/acl/lib_acl/src/xml/acl_xml2_parse.c"
                )
  return "";
 else if (*data == 0)
  return data;
 ...
 while (*data) {
  if (xml->curr_node == 
# 1073 "/acl/lib_acl/src/xml/acl_xml2_parse.c" 3 4
                       ((void *)0)
# 1073 "/acl/lib_acl/src/xml/acl_xml2_parse.c"
                           ) {
   if (!(xml->flag & (1 << 0))
    && xml->root_cnt > 0)
   {
  ...
  if (((&((xml)->vbuf->vbuf))->flags & (1<<1))) {
   acl_msg_warn("%s(%d), %s: space not enougth!",
    "/acl/lib_acl/src/xml/acl_xml2_parse.c", 1095, myname);
   break;
  }
 }
