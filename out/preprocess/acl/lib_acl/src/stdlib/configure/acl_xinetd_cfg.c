# 0 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
...
# 2 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 2
# 21 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
...
static void __nv_pair_free(void *arg)
{
 ...
 if (pair) {
  if (pair->name)
   do { if (pair->name) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 37, (pair->name)); (pair->name) = 
# 37 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
  ((void *)0)
# 37 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
  ; } } while (0);
  if (pair->values)
   acl_array_free(pair->values, acl_free_fn_glue);
  do { if (pair) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 40, (pair)); (pair) = 
# 40 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
 ((void *)0)
# 40 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ; } } while (0);
 }
}
...
static ACL_XINETD_NV_PAIR *__nv_pair_new(const char *name, const char *value)
{
 ...
 char *data;
# 62 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 pair = (ACL_XINETD_NV_PAIR *) acl_calloc_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 62, 1, sizeof(ACL_XINETD_NV_PAIR));
 if (pair == 
# 63 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
            ((void *)0)
# 63 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                )
  return (
# 64 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
         ((void *)0)
# 64 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
             );
 pair->name = acl_strdup_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 65, (name));
 if (pair->name == 
# 66 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
                  ((void *)0)
# 66 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                      )
  { if (pair) { if (pair->name) do { if (pair->name) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 67, (pair->name)); (pair->name) = 
# 67 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
 ((void *)0)
# 67 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ; } } while (0); if (pair->values) acl_array_free(pair->values, acl_free_fn_glue); do { if (pair) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 67, (pair)); (pair) = 
# 67 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
 ((void *)0)
# 67 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ; } } while (0); } return (
...
# 67 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ...
 data = acl_strdup_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 68, (value));
 if (data == 
# 69 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
            ((void *)0)
# 69 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                )
  { if (pair) { if (pair->name) do { if (pair->name) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 70, (pair->name)); (pair->name) = 
# 70 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
 ((void *)0)
# 70 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ; } } while (0); if (pair->values) acl_array_free(pair->values, acl_free_fn_glue); do { if (pair) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 70, (pair)); (pair) = 
# 70 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
 ((void *)0)
# 70 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ; } } while (0); } return (
...
# 70 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ...
 if (pair->values == 
# 73 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
                    ((void *)0)
# 73 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                        )
  { if (pair) { if (pair->name) do { if (pair->name) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 74, (pair->name)); (pair->name) = 
# 74 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
 ((void *)0)
# 74 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ; } } while (0); if (pair->values) acl_array_free(pair->values, acl_free_fn_glue); do { if (pair) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 74, (pair)); (pair) = 
# 74 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
 ((void *)0)
# 74 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ; } } while (0); } return (
...
# 74 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ...
 if (acl_array_append(pair->values, data) < 0) {
  ...
  acl_msg_error("%s(%d)->%s: acl_array_append err = %s",
    "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 78, myname,
    acl_last_strerror(ebuf, sizeof(ebuf)));
  { if (pair) { if (pair->name) do { if (pair->name) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 80, (pair->name)); (pair->name) = 
# 80 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
 ((void *)0)
# 80 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ; } } while (0); if (pair->values) acl_array_free(pair->values, acl_free_fn_glue); do { if (pair) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 80, (pair)); (pair) = 
# 80 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
 ((void *)0)
# 80 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ; } } while (0); } return (
...
static int __nv_pair_append(ACL_XINETD_NV_PAIR *pair, const char *value)
{
 ...
 char *data = acl_strdup_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 89, (value));

 if (data == 
# 91 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
            ((void *)0)
# 91 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                )
  return (-1);
 if (acl_array_append(pair->values, data) < 0) {
  char ebuf[256];

  do { if (data) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 96, (data)); (data) = 
# 96 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
 ((void *)0)
# 96 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ; } } while (0);
  acl_msg_error("%s(%d)->%s: acl_array_append err=%s",
   "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 98, myname,
   acl_last_strerror(ebuf, sizeof(ebuf)));
  return (-1);
 }
 return (0);
...
static int __xinetd_cfg_parse(ACL_XINETD_CFG_PARSER *xcp, char *line_nonl)
{
 ...
 char *ptr, *ptr_eq;
 char *name = 
# 109 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
             ((void *)0)
# 109 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                 , *value = 
# 109 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
                            ((void *)0)
# 109 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ...
 ptr = line_nonl;
 ptr_eq = 
# 122 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
         ((void *)0)
# 122 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
             ;
 while (*ptr) {
  if (*ptr == '=') {
   *ptr = 0;
 ...
 if (ptr_eq == 
# 135 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
              ((void *)0)
# 135 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                  )
  return (0);
 ...
 pair = 
# 172 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
       ((void *)0)
# 172 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
           ;
 size = acl_array_size(xcp->nv_array);
 for (i = 0; i < size; i++) {
  pair_search = (ACL_XINETD_NV_PAIR *) acl_array_index(xcp->nv_array, i);
  if (pair_search == 
# 176 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
                    ((void *)0)
# 176 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                        )
   break;
 ...
 if (pair == 
# 185 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
            ((void *)0)
# 185 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                ) {
  pair = __nv_pair_new(name, value);
  if (pair == 
# 187 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
             ((void *)0)
# 187 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                 )
   { if (pair) { if (pair->name) do { if (pair->name) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 188, (pair->name)); (pair->name) = 
# 188 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
  ((void *)0)
# 188 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
  ; } } while (0); if (pair->values) acl_array_free(pair->values, acl_free_fn_glue); do { if (pair) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 188, (pair)); (pair) = 
# 188 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
  ((void *)0)
# 188 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
  ; } } while (0); } return (-1); };
  ...
  if (acl_array_append(xcp->nv_array, pair) < 0) {
   ...
   acl_msg_error("%s(%d)->%s: acl_array_append err, serr=%s",
    "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 193, myname,
    acl_last_strerror(ebuf, sizeof(ebuf)));
   return (-1);
  }
  return (0);
...
void acl_xinetd_cfg_free(ACL_XINETD_CFG_PARSER *xcp)
{
 ...
 if (xcp == 
# 207 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
           ((void *)0)
# 207 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
               )
  acl_msg_fatal("%s(%d)->%s: input error",
    "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 209, myname);

 if (xcp->nv_array)
  acl_array_free(xcp->nv_array, __nv_pair_free);
 do { if (xcp) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 213, (xcp)); (xcp) = 
# 213 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
((void *)0)
# 213 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
; } } while (0);
}
...
ACL_XINETD_CFG_PARSER *acl_xinetd_cfg_load(const char *pathname)
{
 ...
 char *content_buf = 
# 219 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
                    ((void *)0)
# 219 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                        ;
 char *pline, *phead;
 ACL_XINETD_CFG_PARSER *xcp = 
# 221 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
                             ((void *)0)
# 221 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                                 ;
 char ebuf[256];
# 243 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 if (pathname == 
# 243 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
                ((void *)0) 
# 243 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                     || *pathname == 0) {
  acl_msg_error("%s(%d)->%s: input error",
    "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 245, myname);
  { if (content_buf) do { if (content_buf) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 246, (content_buf)); (content_buf) = 
# 246 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
 ((void *)0)
# 246 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ; } } while (0); if (xcp) { if (xcp->nv_array) acl_array_free(xcp->nv_array, __nv_pair_free); do { if (xcp) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 246, (xcp)); (xcp) = 
# 246 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
 ((void *)0)
# 246 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ; } } while (0); } return (
...
# 246 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ...
 xcp = (ACL_XINETD_CFG_PARSER *) acl_calloc_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 249, 1, sizeof(ACL_XINETD_CFG_PARSER));
 if (xcp == 
# 250 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
           ((void *)0)
# 250 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
               ) {
  acl_msg_error("%s(%d)->%s: calloc err, serr=%s",
    "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 252, myname,
    acl_last_strerror(ebuf, sizeof(ebuf)));
  { if (content_buf) do { if (content_buf) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 254, (content_buf)); (content_buf) = 
# 254 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
 ((void *)0)
# 254 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ; } } while (0); if (xcp) { if (xcp->nv_array) acl_array_free(xcp->nv_array, __nv_pair_free); do { if (xcp) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 254, (xcp)); (xcp) = 
# 254 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
 ((void *)0)
# 254 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ; } } while (0); } return (
...
# 254 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ...
 if (xcp->nv_array == 
# 258 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
                     ((void *)0)
# 258 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                         ) {
  acl_msg_error("%s(%d)->%s: acl_array_create err, serr=%s",
    "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 260, myname,
    acl_last_strerror(ebuf, sizeof(ebuf)));
  { if (content_buf) do { if (content_buf) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 262, (content_buf)); (content_buf) = 
# 262 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
 ((void *)0)
# 262 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ; } } while (0); if (xcp) { if (xcp->nv_array) acl_array_free(xcp->nv_array, __nv_pair_free); do { if (xcp) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 262, (xcp)); (xcp) = 
# 262 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
 ((void *)0)
# 262 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ; } } while (0); } return (
...
# 262 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ...
 if (content_buf == 
# 266 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
                   ((void *)0)
# 266 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                       ) {
  acl_msg_error("%s(%d)->%s: load file(%s) error(%s)",
    "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 268, myname, pathname,
    acl_last_strerror(ebuf, sizeof(ebuf)));
  { if (content_buf) do { if (content_buf) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 270, (content_buf)); (content_buf) = 
# 270 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
 ((void *)0)
# 270 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ; } } while (0); if (xcp) { if (xcp->nv_array) acl_array_free(xcp->nv_array, __nv_pair_free); do { if (xcp) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 270, (xcp)); (xcp) = 
# 270 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
 ((void *)0)
# 270 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ; } } while (0); } return (
...
# 270 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ...
 while (1) {
  ...
  if (pline == 
# 276 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
              ((void *)0)
# 276 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                  ) {
   break;
  }

  if (__xinetd_cfg_parse(xcp, pline) < 0)
   { if (content_buf) do { if (content_buf) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 281, (content_buf)); (content_buf) = 
# 281 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
  ((void *)0)
# 281 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
  ; } } while (0); if (xcp) { if (xcp->nv_array) acl_array_free(xcp->nv_array, __nv_pair_free); do { if (xcp) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 281, (xcp)); (xcp) = 
# 281 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
  ((void *)0)
# 281 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
  ; } } while (0); } return (
...
# 281 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ...
 { if (content_buf) do { if (content_buf) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 284, (content_buf)); (content_buf) = 
# 284 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
((void *)0)
# 284 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
; } } while (0); return (xcp); };
}
...
const char *acl_xinetd_cfg_get(const ACL_XINETD_CFG_PARSER *xcp, const char *name)
{
 ...
 if (xcp == 
# 293 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
           ((void *)0) 
# 293 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                || xcp->nv_array == 
# 293 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
                                    ((void *)0)
     
# 294 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
    || name == 
# 294 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
               ((void *)0) 
# 294 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                    || *name == 0) {
  acl_msg_error("%s(%d)->%s: input error",
    "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 296, myname);
  return (
# 297 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
         ((void *)0)
# 297 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
             );
 }
 ...
 for (i = 0; i < n; i++) {
  ...
  if (pair == 
# 303 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
             ((void *)0)
# 303 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                 )
   break;
 ...
 return (
# 309 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
        ((void *)0)
# 309 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
            );
}
...
const ACL_ARRAY *acl_xinetd_cfg_get_ex(const ACL_XINETD_CFG_PARSER *xcp, const char *name)
{
 ...
 if (xcp == 
# 318 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
           ((void *)0) 
# 318 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                || xcp->nv_array == 
# 318 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
                                    ((void *)0)
     
# 319 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
    || name == 
# 319 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
               ((void *)0) 
# 319 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                    || *name == 0) {
  acl_msg_error("%s(%d)->%s: input error",
    "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c", 321, myname);
  return (
# 322 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
         ((void *)0)
# 322 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
             );
 }
 ...
 for (i = 0; i < n; i++) {
  pair = (ACL_XINETD_NV_PAIR *) acl_array_index(xcp->nv_array, i);
  if (pair == 
# 328 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
             ((void *)0)
# 328 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                 )
   break;
  if (strcasecmp(name, pair->name) == 0)
   return (pair->values);
 ...
 return (
# 334 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
        ((void *)0)
# 334 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
            );
}
   ...
   char **ppvalue)
{
 ...
 if (xcp == 
# 345 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
           ((void *)0) 
# 345 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                || ppname == 
# 345 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
                             ((void *)0) 
# 345 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
 ...
 *ppname = 
# 348 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
           ((void *)0)
# 348 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
               ;
 *ppvalue = 
# 349 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
           ((void *)0)
# 349 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
               ;

 if (xcp->nv_array == 
# 351 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
                     ((void *)0)
# 351 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                         )
  return (-1);

 pair = (ACL_XINETD_NV_PAIR *) acl_array_index(xcp->nv_array, idx);
 if (pair == 
# 355 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
            ((void *)0)
# 355 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                )
  return (-1);
...
{
 if (xcp == 
# 366 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
           ((void *)0)
# 366 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
               )
  return (-1);
 if (xcp->nv_array == 
# 368 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c" 3 4
                     ((void *)0)
# 368 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_cfg.c"
                         )
  return (0);
