# 0 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c"
...
# 2 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c" 2
# 21 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c"
...
static void __init_conf_str_vars(ACL_CFG_STR_TABLE cst[])
{
  ...
  *(cst[i].target) = acl_strdup_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c", 42, (cst[i].defval));
}
     ...
     const char *value)
{
 ...
 for (i = 0; cst[i].name != 0; i++) {
  if (strcasecmp(cst[i].name, name) == 0) {
   do { if (*(cst[i].target)) { acl_free_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c", 89, (*(cst[i].target))); (*(cst[i].target)) = 
# 89 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c" 3 4
  ((void *)0)
# 89 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c"
  ; } } while (0);
   *(cst[i].target) = acl_strdup_glue("/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c", 90, (value));
  }
 }
}
 ...
 ACL_CFG_INT_TABLE *table)
{
 ...
 if (table == 
# 120 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c" 3 4
             ((void *)0)
# 120 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c"
                 )
  return;
 ...
 if (cfg == 
# 125 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c" 3 4
           ((void *)0)
# 125 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c"
               )
  return;
 ...
 ACL_CFG_INT64_TABLE *table)
{
 ...
 if (table == 
# 143 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c" 3 4
             ((void *)0)
# 143 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c"
                 )
  return;
 ...
 if (cfg == 
# 148 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c" 3 4
           ((void *)0)
# 148 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c"
               )
  return;
 ...
 ACL_CFG_STR_TABLE *table)
{
 ...
 if (table == 
# 166 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c" 3 4
             ((void *)0)
# 166 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c"
                 )
  return;
 ...
 if (cfg == 
# 171 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c" 3 4
           ((void *)0)
# 171 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c"
               )
  return;
 ...
 ACL_CFG_BOOL_TABLE *table)
{
 ...
 if (table == 
# 190 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c" 3 4
             ((void *)0)
# 190 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c"
                 )
  return;
 ...
 if (cfg == 
# 195 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c" 3 4
           ((void *)0)
# 195 "/acl/lib_acl/src/stdlib/configure/acl_xinetd_params.c"
               )
  return;
