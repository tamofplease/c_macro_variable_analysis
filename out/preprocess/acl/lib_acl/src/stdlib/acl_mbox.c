# 0 "/acl/lib_acl/src/stdlib/acl_mbox.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/acl_mbox.c"
...
# 2 "/acl/lib_acl/src/stdlib/acl_mbox.c" 2
# 23 "/acl/lib_acl/src/stdlib/acl_mbox.c"
# 1 "/usr/include/linux/version.h" 1 3 4
# 24 "/acl/lib_acl/src/stdlib/acl_mbox.c" 2
...
# 26 "/acl/lib_acl/src/stdlib/acl_mbox.c" 2
# 35 "/acl/lib_acl/src/stdlib/acl_mbox.c"
...
ACL_MBOX *acl_mbox_create2(unsigned type)
{
 ...
 fds[1] = fds[0];
# 72 "/acl/lib_acl/src/stdlib/acl_mbox.c"
 mbox = (ACL_MBOX *) acl_malloc_glue("/acl/lib_acl/src/stdlib/acl_mbox.c", 72, sizeof(ACL_MBOX));
 mbox->in = fds[0];
 mbox->out = fds[1];
 mbox->nsend = 0;
 mbox->nread = 0;
 ...
 if (type == 1) {
  mbox->lock = (acl_pthread_mutex_t *)
   acl_calloc_glue("/acl/lib_acl/src/stdlib/acl_mbox.c", 81, 1, sizeof(acl_pthread_mutex_t));

  if (pthread_mutex_init(mbox->lock, 
# 83 "/acl/lib_acl/src/stdlib/acl_mbox.c" 3 4
                                        ((void *)0)
# 83 "/acl/lib_acl/src/stdlib/acl_mbox.c"
                                            ) != 0) {
   acl_msg_fatal("%s(%d), %s: pthread_mutex_init error",
    "/acl/lib_acl/src/stdlib/acl_mbox.c", 85, __FUNCTION__);
  }
 } else {
  mbox->lock = 
# 88 "/acl/lib_acl/src/stdlib/acl_mbox.c" 3 4
              ((void *)0)
# 88 "/acl/lib_acl/src/stdlib/acl_mbox.c"
                  ;
 }
...
void acl_mbox_free(ACL_MBOX *mbox, void (*free_fn)(void*))
{
 ...
 if (mbox->lock != 
# 101 "/acl/lib_acl/src/stdlib/acl_mbox.c" 3 4
                  ((void *)0)
# 101 "/acl/lib_acl/src/stdlib/acl_mbox.c"
                      ) {
  pthread_mutex_destroy(mbox->lock);
  do { if (mbox->lock) { acl_free_glue("/acl/lib_acl/src/stdlib/acl_mbox.c", 103, (mbox->lock)); (mbox->lock) = 
# 103 "/acl/lib_acl/src/stdlib/acl_mbox.c" 3 4
 ((void *)0)
# 103 "/acl/lib_acl/src/stdlib/acl_mbox.c"
 ; } } while (0);
 }
 do { if (mbox) { acl_free_glue("/acl/lib_acl/src/stdlib/acl_mbox.c", 105, (mbox)); (mbox) = 
# 105 "/acl/lib_acl/src/stdlib/acl_mbox.c" 3 4
((void *)0)
# 105 "/acl/lib_acl/src/stdlib/acl_mbox.c"
; } } while (0);
}
...
# 135 "/acl/lib_acl/src/stdlib/acl_mbox.c" 3 4
                                                     ((void *)0)
# 135 "/acl/lib_acl/src/stdlib/acl_mbox.c"
                                                         , 
# 135 "/acl/lib_acl/src/stdlib/acl_mbox.c" 3 4
                                                           ((void *)0)
# 135 "/acl/lib_acl/src/stdlib/acl_mbox.c"
 ...
 if (ret == -1) {
  acl_msg_error("%s(%d), %s: mbox write %d error %s", "/acl/lib_acl/src/stdlib/acl_mbox.c",
...
void *acl_mbox_read(ACL_MBOX *mbox, int timeout, int *success)
{
 ...
 if (msg != 
# 157 "/acl/lib_acl/src/stdlib/acl_mbox.c" 3 4
           ((void *)0)
# 157 "/acl/lib_acl/src/stdlib/acl_mbox.c"
               ) {
  if (success) {
   *success = 1;
  }
  ...
  return 
# 166 "/acl/lib_acl/src/stdlib/acl_mbox.c" 3 4
        ((void *)0)
# 166 "/acl/lib_acl/src/stdlib/acl_mbox.c"
            ;
 }
 ...
 if (timeout > 0 && acl_read_poll_wait(mbox->in, timeout) < 0) {
  ...
  if (acl_last_error() == 
# 176 "/acl/lib_acl/src/stdlib/acl_mbox.c" 3 4
                         110
# 176 "/acl/lib_acl/src/stdlib/acl_mbox.c"
                                      ) {
   if (success) {
    *success = 1;
   }
  ...
  return 
# 183 "/acl/lib_acl/src/stdlib/acl_mbox.c" 3 4
        ((void *)0)
# 183 "/acl/lib_acl/src/stdlib/acl_mbox.c"
            ;
 }

 ret = acl_socket_read(mbox->in, &n, sizeof(n), -1, 
# 186 "/acl/lib_acl/src/stdlib/acl_mbox.c" 3 4
                                                   ((void *)0)
# 186 "/acl/lib_acl/src/stdlib/acl_mbox.c"
                                                       , 
# 186 "/acl/lib_acl/src/stdlib/acl_mbox.c" 3 4
                                                         ((void *)0)
# 186 "/acl/lib_acl/src/stdlib/acl_mbox.c"
 ...
 if (ret == -1) {
  ...
  return 
# 191 "/acl/lib_acl/src/stdlib/acl_mbox.c" 3 4
        ((void *)0)
# 191 "/acl/lib_acl/src/stdlib/acl_mbox.c"
            ;
 }
