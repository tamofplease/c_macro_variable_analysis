# 0 "/acl/lib_acl/src/stdlib/acl_readline.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/acl_readline.c"
...
# 2 "/acl/lib_acl/src/stdlib/acl_readline.c" 2
# 20 "/acl/lib_acl/src/stdlib/acl_readline.c"
ACL_VSTRING *acl_readlline(ACL_VSTRING *buf, ACL_VSTREAM *fp, int *lineno)
{
 char *cp;
 size_t start;
...
# 40 "/acl/lib_acl/src/stdlib/acl_readline.c" 3 4
                                              ((*__ctype_b_loc ())[(int) ((
# 40 "/acl/lib_acl/src/stdlib/acl_readline.c"
                                              ((unsigned char)(*cp))
# 40 "/acl/lib_acl/src/stdlib/acl_readline.c" 3 4
...
# 40 "/acl/lib_acl/src/stdlib/acl_readline.c"
  ...
  if ((size_t) ((buf)->vbuf.ptr - (buf)->vbuf.data) > 0) {
   ...
   if (next != '#' && !
# 50 "/acl/lib_acl/src/stdlib/acl_readline.c" 3 4
                      ((*__ctype_b_loc ())[(int) ((
# 50 "/acl/lib_acl/src/stdlib/acl_readline.c"
                      ((unsigned char)(next))
# 50 "/acl/lib_acl/src/stdlib/acl_readline.c" 3 4
                      ))] & (unsigned short int) _ISspace)
# 50 "/acl/lib_acl/src/stdlib/acl_readline.c"
 ...
 if ((size_t) ((buf)->vbuf.ptr - (buf)->vbuf.data) > 0 && 
# 62 "/acl/lib_acl/src/stdlib/acl_readline.c" 3 4
                    ((*__ctype_b_loc ())[(int) ((
# 62 "/acl/lib_acl/src/stdlib/acl_readline.c"
...
# 71 "/acl/lib_acl/src/stdlib/acl_readline.c" 3 4
                             ((void *)0)
# 71 "/acl/lib_acl/src/stdlib/acl_readline.c"
                                 );
}
