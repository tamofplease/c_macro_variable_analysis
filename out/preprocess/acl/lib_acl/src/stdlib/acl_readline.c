# 1 "/workspace/acl/lib_acl/src/stdlib/acl_readline.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/acl_readline.c" 2
# 20 "/workspace/acl/lib_acl/src/stdlib/acl_readline.c"
ACL_VSTRING *acl_readlline(ACL_VSTRING *buf, ACL_VSTREAM *fp, int *lineno)
{
 char *cp;
 size_t start;
 ...
 for (;;) {
  ...
  start = (size_t) ((buf)->vbuf.ptr - (buf)->vbuf.data);
  while ((ch = acl_vstream_getc(fp)) != (-1) && ch != '\n')
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = (ch)) : acl_vbuf_put((&(buf)->vbuf),(ch)));
  if (ch == '\n' && lineno != 0)
   *lineno += 1;

  for (cp = ((char *) (buf)->vbuf.data) + start; cp < ((char *) (buf)->vbuf.ptr) && 
# 40 "/workspace/acl/lib_acl/src/stdlib/acl_readline.c" 3 4
                                              ((*__ctype_b_loc ())[(int) ((
# 40 "/workspace/acl/lib_acl/src/stdlib/acl_readline.c"
                                              ((unsigned char)(*cp))
# 40 "/workspace/acl/lib_acl/src/stdlib/acl_readline.c" 3 4
...
# 40 "/workspace/acl/lib_acl/src/stdlib/acl_readline.c"
                                                              ; cp++)
              ;
  if (cp == ((char *) (buf)->vbuf.ptr) || *cp == '#')
   acl_vstring_truncate(buf, start);

  if (ch == (-1))
   break;
  if ((size_t) ((buf)->vbuf.ptr - (buf)->vbuf.data) > 0) {
   if ((next = acl_vstream_getc(fp)) != (-1))
    acl_vstream_ungetc(fp, next);
   if (next != '#' && !
# 50 "/workspace/acl/lib_acl/src/stdlib/acl_readline.c" 3 4
                      ((*__ctype_b_loc ())[(int) ((
# 50 "/workspace/acl/lib_acl/src/stdlib/acl_readline.c"
                      ((unsigned char)(next))
# 50 "/workspace/acl/lib_acl/src/stdlib/acl_readline.c" 3 4
                      ))] & (unsigned short int) _ISspace)
# 50 "/workspace/acl/lib_acl/src/stdlib/acl_readline.c"
 ...
 if ((size_t) ((buf)->vbuf.ptr - (buf)->vbuf.data) > 0 && 
# 62 "/workspace/acl/lib_acl/src/stdlib/acl_readline.c" 3 4
                    ((*__ctype_b_loc ())[(int) ((
# 62 "/workspace/acl/lib_acl/src/stdlib/acl_readline.c"
                    ((unsigned char)(*((char *) (buf)->vbuf.data)))
# 62 "/workspace/acl/lib_acl/src/stdlib/acl_readline.c" 3 4
                    ))] & (unsigned short int) _ISspace)
# 62 "/workspace/acl/lib_acl/src/stdlib/acl_readline.c"
                                          ) {
  acl_msg_warn("%s: logical line must not start with whitespace: \"%.30s%s\"",
   ((fp)->path ? (fp)->path : ""), ((char *) (buf)->vbuf.data), (size_t) ((buf)->vbuf.ptr - (buf)->vbuf.data) > 30 ? "..." : "");
 ...
 return ((size_t) ((buf)->vbuf.ptr - (buf)->vbuf.data) > 0 ? buf : 
# 71 "/workspace/acl/lib_acl/src/stdlib/acl_readline.c" 3 4
                             ((void *)0)
# 71 "/workspace/acl/lib_acl/src/stdlib/acl_readline.c"
                                 );
}
