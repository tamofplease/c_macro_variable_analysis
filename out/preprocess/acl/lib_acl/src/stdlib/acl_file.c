# 0 "/acl/lib_acl/src/stdlib/acl_file.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/acl_file.c"
...
# 2 "/acl/lib_acl/src/stdlib/acl_file.c" 2
# 16 "/acl/lib_acl/src/stdlib/acl_file.c"
ACL_FILE *acl_fopen(const char *filename, const char *mode)
{
 ACL_FILE *fp;
 ACL_VSTREAM *stream;
 ...
 case 'r':
  oflags = 
# 34 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
          00
# 34 "/acl/lib_acl/src/stdlib/acl_file.c"
                  ;
  break;
 case 'w':
  oflags = 
# 37 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
          01 
# 37 "/acl/lib_acl/src/stdlib/acl_file.c"
                   | 
# 37 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
                     0100 
# 37 "/acl/lib_acl/src/stdlib/acl_file.c"
...
# 37 "/acl/lib_acl/src/stdlib/acl_file.c"
 ...
 case 'a':
  oflags = 
# 40 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
          01 
# 40 "/acl/lib_acl/src/stdlib/acl_file.c"
                   | 
# 40 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
                     0100 
# 40 "/acl/lib_acl/src/stdlib/acl_file.c"
...
# 43 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
 (*__errno_location ()) 
# 43 "/acl/lib_acl/src/stdlib/acl_file.c"
       = 
# 43 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
         22
# 43 "/acl/lib_acl/src/stdlib/acl_file.c"
  ...
  return 
# 45 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        ((void *)0)
# 45 "/acl/lib_acl/src/stdlib/acl_file.c"
            ;
 }
 ...
 while (*++mode && whileflag) {
  ...
  case '+':
   if (oflags & 
# 62 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
               02
# 62 "/acl/lib_acl/src/stdlib/acl_file.c"
                     )
    whileflag = 0;
   else {
    oflags |= 
# 65 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
             02
# 65 "/acl/lib_acl/src/stdlib/acl_file.c"
                   ;
    oflags &= ~(
# 66 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
               00 
# 66 "/acl/lib_acl/src/stdlib/acl_file.c"
                        | 
# 66 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
                          01
# 66 "/acl/lib_acl/src/stdlib/acl_file.c"
  ...
  case 'b':
   ...
   break;
# 130 "/acl/lib_acl/src/stdlib/acl_file.c"
  default:
   
# 131 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
  (*__errno_location ()) 
# 131 "/acl/lib_acl/src/stdlib/acl_file.c"
        = 
# 131 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
          22
# 131 "/acl/lib_acl/src/stdlib/acl_file.c"
   ...
   acl_msg_error("Invalid file open mode");
   return 
# 133 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
         ((void *)0)
# 133 "/acl/lib_acl/src/stdlib/acl_file.c"
             ;
  }
 }
 ...
 if (stream == 
# 138 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
              ((void *)0)
# 138 "/acl/lib_acl/src/stdlib/acl_file.c"
                  )
  return 
# 139 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        ((void *)0)
# 139 "/acl/lib_acl/src/stdlib/acl_file.c"
            ;

 fp = (ACL_FILE*) acl_malloc_glue("/acl/lib_acl/src/stdlib/acl_file.c", 141, sizeof(ACL_FILE));
 fp->fp = stream;
 fp->status = 0;
 fp->errnum = 0;
 return fp;
...
int acl_fclose(ACL_FILE *fp)
{
 ...
 do { if (fp) { acl_free_glue("/acl/lib_acl/src/stdlib/acl_file.c", 158, (fp)); (fp) = 
# 158 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
((void *)0)
# 158 "/acl/lib_acl/src/stdlib/acl_file.c"
; } } while (0);
 if (ret == (-1) || ret < 0)
  return 
# 160 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 160 "/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 return (0);
}
...
size_t acl_fread(void *buf, size_t size, size_t nitems, ACL_FILE *fp)
{
 ...
 if (ret == (-1)) {
  fp->status |= (1 << 0);
  return 
# 182 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 182 "/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 }
 ...
 if (ret == (int) nitems)
  ...
  fp->status |= (1 << 0);
  return 
# 190 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 190 "/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 } else
  return ret;
}
...
char *acl_fgets(char *buf, int size, ACL_FILE *fp)
{
 ...
 if (ret == (-1)) {
  fp->status |= (1 << 0);
  return 
# 205 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        ((void *)0)
# 205 "/acl/lib_acl/src/stdlib/acl_file.c"
            ;
 }
 return buf;
}
...
char *acl_fgets_nonl(char *buf, int size, ACL_FILE *fp)
{
 ...
 if (ret == (-1)) {
  fp->status |= (1 << 0);
  return 
# 220 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        ((void *)0)
# 220 "/acl/lib_acl/src/stdlib/acl_file.c"
            ;
 }
 return buf;
}
...
int acl_fgetc(ACL_FILE *fp)
{
 ...
 if (ret == (-1)) {
  fp->status |= (1 << 0);
  return 
# 234 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 234 "/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 }
 return ret;
}
...
char *acl_gets(char *buf, size_t size)
{
 return acl_vstream_gets((&acl_vstream_fstd[0]), buf, size)
  == (-1) ? 
# 242 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
                      ((void *)0) 
# 242 "/acl/lib_acl/src/stdlib/acl_file.c"
                           : buf;
}
...
char *acl_gets_nonl(char *buf, size_t size)
{
 return acl_vstream_gets_nonl((&acl_vstream_fstd[0]), buf, size)
  == (-1) ? 
# 248 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
                      ((void *)0) 
# 248 "/acl/lib_acl/src/stdlib/acl_file.c"
                           : buf;
}
...
# 261 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
__builtin_va_start(
# 261 "/acl/lib_acl/src/stdlib/acl_file.c"
ap
# 261 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
,
# 261 "/acl/lib_acl/src/stdlib/acl_file.c"
...
# 263 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
__builtin_va_end(
# 263 "/acl/lib_acl/src/stdlib/acl_file.c"
ap
# 263 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
)
# 263 "/acl/lib_acl/src/stdlib/acl_file.c"
...
int acl_vfprintf(ACL_FILE *fp, const char *fmt, va_list ap)
{
 ...
 if (ret == (-1)) {
  fp->status |= (1 << 0);
  return 
# 278 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 278 "/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 }
...
size_t acl_fwrite(const void *ptr, size_t size, size_t nitems, ACL_FILE *fp)
{
 ...
 if (ret == (-1)) {
  fp->status |= (1 << 0);
  return 
# 297 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 297 "/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 }
...
# 308 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
__builtin_va_start(
# 308 "/acl/lib_acl/src/stdlib/acl_file.c"
ap
# 308 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
,
# 308 "/acl/lib_acl/src/stdlib/acl_file.c"
...
# 310 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
__builtin_va_end(
# 310 "/acl/lib_acl/src/stdlib/acl_file.c"
ap
# 310 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
)
# 310 "/acl/lib_acl/src/stdlib/acl_file.c"
...
int acl_vprintf(const char *fmt, va_list ap)
{
 ...
 if (ret == (-1))
  return 
# 321 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 321 "/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 return ret;
}
...
int acl_fputs(const char *s, ACL_FILE *fp)
{
 ...
 if (ret == (-1)) {
  fp->status |= (1 << 0);
  return 
# 335 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 335 "/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 }
...
int acl_putc(int c, ACL_FILE *fp)
{
 ...
 if (ret == (-1)) {
  fp->status |= (1 << 0);
  return 
# 352 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 352 "/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 }
 if (acl_vstream_fflush((&acl_vstream_fstd[1])) == (-1)) {
  fp->status |= (1 << 0);
  return 
# 356 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 356 "/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 }
 return ret;
}
...
int acl_puts(const char *s)
{
 ...
 if (ret == (-1))
  return 
# 367 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 367 "/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 return ret;
}
...
int acl_putchar(int c)
{
 ...
 if (ret == (-1))
  return 
# 378 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 378 "/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 if (acl_vstream_fflush((&acl_vstream_fstd[1])) == (-1))
  return 
# 380 "/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 380 "/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 return ret;
}
