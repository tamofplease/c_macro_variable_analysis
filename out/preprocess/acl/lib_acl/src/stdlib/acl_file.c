# 1 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 2
# 16 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
ACL_FILE *acl_fopen(const char *filename, const char *mode)
{
 ACL_FILE *fp;
 ACL_VSTREAM *stream;
 ...
 case 'r':
  oflags = 
# 34 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
          00
# 34 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
                  ;
  break;
 case 'w':
  oflags = 
# 37 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
          01 
# 37 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
                   | 
# 37 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
                     0100 
# 37 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
...
# 37 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
 ...
 case 'a':
  oflags = 
# 40 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
          01 
# 40 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
                   | 
# 40 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
                     0100 
# 40 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
...
# 43 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
 (*__errno_location ()) 
# 43 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
       = 
# 43 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
         22
# 43 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
  ...
  return 
# 45 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        ((void *)0)
# 45 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
            ;
 }
 ...
 while (*++mode && whileflag) {
  ...
  case '+':
   if (oflags & 
# 62 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
               02
# 62 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
                     )
    whileflag = 0;
   else {
    oflags |= 
# 65 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
             02
# 65 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
                   ;
    oflags &= ~(
# 66 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
               00 
# 66 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
                        | 
# 66 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
                          01
# 66 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
  ...
  case 'b':
   ...
   break;
# 130 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
  default:
   
# 131 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
  (*__errno_location ()) 
# 131 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
        = 
# 131 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
          22
# 131 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
   ...
   acl_msg_error("Invalid file open mode");
   return 
# 133 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
         ((void *)0)
# 133 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
             ;
  }
 }
 ...
 if (stream == 
# 138 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
              ((void *)0)
# 138 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
                  )
  return 
# 139 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        ((void *)0)
# 139 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
            ;

 fp = (ACL_FILE*) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/acl_file.c", 141, sizeof(ACL_FILE));
 fp->fp = stream;
 fp->status = 0;
 fp->errnum = 0;
 return fp;
...
int acl_fclose(ACL_FILE *fp)
{
 int ret = acl_vstream_close(fp->fp);

 do { if (fp) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/acl_file.c", 158, (fp)); (fp) = 
# 158 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
((void *)0)
# 158 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
; } } while (0);
 if (ret == (-1) || ret < 0)
  return 
# 160 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 160 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 return (0);
}
...
size_t acl_fread(void *buf, size_t size, size_t nitems, ACL_FILE *fp)
{
 ...
 if (ret == (-1)) {
  fp->status |= (1 << 0);
  return 
# 182 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 182 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 }
 ...
 if (ret == (int) nitems)
  ...
  fp->status |= (1 << 0);
  return 
# 190 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 190 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 } else
  return ret;
}
...
char *acl_fgets(char *buf, int size, ACL_FILE *fp)
{
 ...
 if (ret == (-1)) {
  fp->status |= (1 << 0);
  return 
# 205 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        ((void *)0)
# 205 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
            ;
 }
 return buf;
}
...
char *acl_fgets_nonl(char *buf, int size, ACL_FILE *fp)
{
 ...
 if (ret == (-1)) {
  fp->status |= (1 << 0);
  return 
# 220 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        ((void *)0)
# 220 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
            ;
 }
 return buf;
}
...
int acl_fgetc(ACL_FILE *fp)
{
 int ret = ( (fp->fp)->read_cnt > 0 ? (fp->fp)->read_cnt--, (fp->fp)->offset++, *(fp->fp)->read_ptr++: (fp->fp)->sys_getc((fp->fp)));
 ...
 if (ret == (-1)) {
  fp->status |= (1 << 0);
  return 
# 234 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 234 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 }
 return ret;
}
...
char *acl_gets(char *buf, size_t size)
{
 return acl_vstream_gets((&acl_vstream_fstd[0]), buf, size)
  == (-1) ? 
# 242 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
                      ((void *)0) 
# 242 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
                           : buf;
}

char *acl_gets_nonl(char *buf, size_t size)
{
 return acl_vstream_gets_nonl((&acl_vstream_fstd[0]), buf, size)
  == (-1) ? 
# 248 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
                      ((void *)0) 
# 248 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
                           : buf;
}

int acl_getchar()
{
 return acl_vstream_getc((&acl_vstream_fstd[0]));
}
...
# 261 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
__builtin_va_start(
# 261 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
ap
# 261 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
,
# 261 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
...
# 263 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
__builtin_va_end(
# 263 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
ap
# 263 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
)
# 263 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
...
int acl_vfprintf(ACL_FILE *fp, const char *fmt, va_list ap)
{
 ...
 if (ret == (-1)) {
  fp->status |= (1 << 0);
  return 
# 278 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 278 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 }
...
size_t acl_fwrite(const void *ptr, size_t size, size_t nitems, ACL_FILE *fp)
{
 ...
 if (ret == (-1)) {
  fp->status |= (1 << 0);
  return 
# 297 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 297 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 }
...
# 308 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
__builtin_va_start(
# 308 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
ap
# 308 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
,
# 308 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
...
# 310 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
__builtin_va_end(
# 310 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
ap
# 310 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
)
# 310 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
...
int acl_vprintf(const char *fmt, va_list ap)
{
 ...
 ret = acl_vstream_vfprintf((&acl_vstream_fstd[1]), fmt, ap);
 if (ret == (-1))
  return 
# 321 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 321 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 return ret;
}
...
int acl_fputs(const char *s, ACL_FILE *fp)
{
 ...
 if (ret == (-1)) {
  fp->status |= (1 << 0);
  return 
# 335 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 335 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 }
...
int acl_putc(int c, ACL_FILE *fp)
{
 ...
 ret = ( (fp->fp)->wbuf_size == 0 ? (acl_vstream_buffed_space((fp->fp)), ((fp->fp)->wbuf[(size_t) (fp->fp)->wbuf_dlen++] = (ch))) : ((fp->fp)->wbuf_dlen == fp->fp->wbuf_size ? (acl_vstream_fflush((fp->fp)) == (-1) ? (-1) : ((fp->fp)->wbuf[(size_t) (fp->fp)->wbuf_dlen++] = (ch))) : ((fp->fp)->wbuf[(size_t) (fp->fp)->wbuf_dlen++] = (ch))));
 if (ret == (-1)) {
  fp->status |= (1 << 0);
  return 
# 352 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 352 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 }
 if (acl_vstream_fflush((&acl_vstream_fstd[1])) == (-1)) {
  fp->status |= (1 << 0);
  return 
# 356 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 356 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 }
 return ret;
}
...
int acl_puts(const char *s)
{
 ...
 ret = acl_vstream_fputs(s, (&acl_vstream_fstd[1]));
 if (ret == (-1))
  return 
# 367 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 367 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 return ret;
}
...
int acl_putchar(int c)
{
 ...
 ret = ( ((&acl_vstream_fstd[1]))->wbuf_size == 0 ? (acl_vstream_buffed_space(((&acl_vstream_fstd[1]))), (((&acl_vstream_fstd[1]))->wbuf[(size_t) ((&acl_vstream_fstd[1]))->wbuf_dlen++] = (ch))) : (((&acl_vstream_fstd[1]))->wbuf_dlen == (&acl_vstream_fstd[1])->wbuf_size ? (acl_vstream_fflush(((&acl_vstream_fstd[1]))) == (-1) ? (-1) : (((&acl_vstream_fstd[1]))->wbuf[(size_t) ((&acl_vstream_fstd[1]))->wbuf_dlen++] = (ch))) : (((&acl_vstream_fstd[1]))->wbuf[(size_t) ((&acl_vstream_fstd[1]))->wbuf_dlen++] = (ch))));
 if (ret == (-1))
  return 
# 378 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 378 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 if (acl_vstream_fflush((&acl_vstream_fstd[1])) == (-1))
  return 
# 380 "/workspace/acl/lib_acl/src/stdlib/acl_file.c" 3 4
        (-1)
# 380 "/workspace/acl/lib_acl/src/stdlib/acl_file.c"
           ;
 return ret;
}
