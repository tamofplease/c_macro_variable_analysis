# 0 "/acl/lib_acl/src/stdlib/sys/acl_process.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/sys/acl_process.c"
...
# 2 "/acl/lib_acl/src/stdlib/sys/acl_process.c" 2
# 22 "/acl/lib_acl/src/stdlib/sys/acl_process.c"
static char *get_tls_buf(void)
{
 ...
 if (buf != 
# 30 "/acl/lib_acl/src/stdlib/sys/acl_process.c" 3 4
           ((void *)0)
# 30 "/acl/lib_acl/src/stdlib/sys/acl_process.c"
               )
  return (buf);
 ...
 if (buf_key == (acl_pthread_key_t) 0xffffffff) {
  ...
  buf = (char*) acl_calloc_glue("/acl/lib_acl/src/stdlib/sys/acl_process.c", 38, 1, 4096);
...
const char *acl_process_path()
{
 ...
 if (ret < 0) {
  ...
  return (
# 56 "/acl/lib_acl/src/stdlib/sys/acl_process.c" 3 4
         ((void *)0)
# 56 "/acl/lib_acl/src/stdlib/sys/acl_process.c"
             );
 }
 return (buf_ptr);
}
...
const char *acl_getcwd()
{
 ...
 if (ptr == 
# 68 "/acl/lib_acl/src/stdlib/sys/acl_process.c" 3 4
           ((void *)0)
# 68 "/acl/lib_acl/src/stdlib/sys/acl_process.c"
               ) {
