# 0 "/acl/lib_acl/src/stdlib/sys/acl_unsafe.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/sys/acl_unsafe.c"
...
# 2 "/acl/lib_acl/src/stdlib/sys/acl_unsafe.c" 2
# 17 "/acl/lib_acl/src/stdlib/sys/acl_unsafe.c"
int acl_unsafe(void)
{
