# 1 "/workspace/acl/lib_acl/src/stdlib/sys/acl_unsafe.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/sys/acl_unsafe.c" 2
# 17 "/workspace/acl/lib_acl/src/stdlib/sys/acl_unsafe.c"
int acl_unsafe(void)
{
