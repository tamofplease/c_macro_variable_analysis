# 1 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c" 2
# 39 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
...
# 383 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
int acl_socket_init(void)
{
 signal(
# 385 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c" 3 4
       13
# 385 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
              , 
# 385 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c" 3 4
                ((__sighandler_t) 1)
# 385 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
...
# 439 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
int acl_socket_read(int fd, void *buf, size_t size,
 int timeout, ACL_VSTREAM *fp, void *arg __attribute__ ((__unused__)))
{
 if (fp != 
# 442 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c" 3 4
          ((void *)0) 
# 442 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
               && fp->read_ready) {
  fp->read_ready = 0;
 } else if (timeout > 0) {
  if (fp != 
# 445 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c" 3 4
           ((void *)0) 
# 445 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
                && (((fp)->flag & (1 << 20)) != 0)) {
...
int acl_socket_write(int fd, const void *buf, size_t size,
 int timeout, ACL_VSTREAM *fp __attribute__ ((__unused__)), void *arg __attribute__ ((__unused__)))
{
 int ret, error;
 ...
 if (error != 
# 476 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c" 3 4
             11
# 476 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
                            ) {
 ...
 if (fp != 
# 484 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c" 3 4
          ((void *)0) 
# 484 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
               && (((fp)->flag & (1 << 20)) != 0)) {
...
int acl_socket_writev(int fd, const struct iovec *vec, int count,
 int timeout, ACL_VSTREAM *fp __attribute__ ((__unused__)), void *arg __attribute__ ((__unused__)))
{
 int ret, error;
 ...
 if (error != 
# 515 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c" 3 4
             11
# 515 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
                            ) {
...
int acl_socket_alive(int fd)
{
 ...
 ret = (int) __sys_recv(fd, buf, sizeof(buf), 
# 553 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c" 3 4
                                             MSG_PEEK
# 553 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
                                                     );
 if (ret == 0 || (ret < 0 && acl_last_error() != 
# 554 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c" 3 4
                                                11
# 554 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
                                                               )) {
  return 0;
 }
 return 1;
