# 0 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
...
# 2 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c" 2
# 39 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
...
# 383 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
int acl_socket_init(void)
{
 signal(
# 385 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c" 3 4
       13
# 385 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
              , 
# 385 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c" 3 4
                ((__sighandler_t) 1)
# 385 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
...
# 439 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
int acl_socket_read(int fd, void *buf, size_t size,
 int timeout, ACL_VSTREAM *fp, void *arg __attribute__ ((__unused__)))
{
 if (fp != 
# 442 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c" 3 4
          ((void *)0) 
# 442 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
               && fp->read_ready) {
  fp->read_ready = 0;
 } else if (timeout > 0) {
  if (fp != 
# 445 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c" 3 4
           ((void *)0) 
# 445 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
                && (((fp)->flag & (1 << 20)) != 0)) {
 ...
 int timeout, ACL_VSTREAM *fp __attribute__ ((__unused__)), void *arg __attribute__ ((__unused__)))
{
 ...
 if (error != 
# 476 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c" 3 4
             11
# 476 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
                            ) {
 ...
 if (fp != 
# 484 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c" 3 4
          ((void *)0) 
# 484 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
               && (((fp)->flag & (1 << 20)) != 0)) {
 ...
 int timeout, ACL_VSTREAM *fp __attribute__ ((__unused__)), void *arg __attribute__ ((__unused__)))
{
 ...
 if (error != 
# 515 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c" 3 4
             11
# 515 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
                            ) {
...
# 553 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c" 3 4
                                             MSG_PEEK
# 553 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
                                                     );
 if (ret == 0 || (ret < 0 && acl_last_error() != 
# 554 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c" 3 4
                                                11
# 554 "/acl/lib_acl/src/stdlib/sys/acl_sys_socket.c"
                                                               )) {
  return 0;
 }
 return 1;
