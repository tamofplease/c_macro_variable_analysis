# 1 "/workspace/acl/lib_acl/src/stdlib/sys/acl_exec_command.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/sys/acl_exec_command.c" 2
# 28 "/workspace/acl/lib_acl/src/stdlib/sys/acl_exec_command.c"
void acl_exec_command(const char *command)
{
 ACL_ARGV *argv;
 ...
 if (command[strspn(command, ok_chars)] == 0) {
  ...
  if (
# 60 "/workspace/acl/lib_acl/src/stdlib/sys/acl_exec_command.c" 3 4
     (*__errno_location ()) 
# 60 "/workspace/acl/lib_acl/src/stdlib/sys/acl_exec_command.c"
           != 
# 60 "/workspace/acl/lib_acl/src/stdlib/sys/acl_exec_command.c" 3 4
              2 
# 60 "/workspace/acl/lib_acl/src/stdlib/sys/acl_exec_command.c"
                     || strchr(argv->argv[0], '/') != 0)
 ...
 acl_msg_fatal("execl %s: %s", "/bin/sh", acl_last_serror());
