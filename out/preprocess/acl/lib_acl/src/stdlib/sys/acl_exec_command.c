# 0 "/acl/lib_acl/src/stdlib/sys/acl_exec_command.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/sys/acl_exec_command.c"
...
# 2 "/acl/lib_acl/src/stdlib/sys/acl_exec_command.c" 2
# 28 "/acl/lib_acl/src/stdlib/sys/acl_exec_command.c"
void acl_exec_command(const char *command)
{
 ACL_ARGV *argv;
 ...
 if (command[strspn(command, ok_chars)] == 0) {
  ...
  if (
# 60 "/acl/lib_acl/src/stdlib/sys/acl_exec_command.c" 3 4
     (*__errno_location ()) 
# 60 "/acl/lib_acl/src/stdlib/sys/acl_exec_command.c"
           != 
# 60 "/acl/lib_acl/src/stdlib/sys/acl_exec_command.c" 3 4
              2 
# 60 "/acl/lib_acl/src/stdlib/sys/acl_exec_command.c"
