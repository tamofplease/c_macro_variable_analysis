# 0 "/acl/lib_acl/src/stdlib/sys/acl_env.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/sys/acl_env.c"
...
# 2 "/acl/lib_acl/src/stdlib/sys/acl_env.c" 2
# 26 "/acl/lib_acl/src/stdlib/sys/acl_env.c"
void acl_clean_env(char **preserve_list)
{
...
char *acl_getenv(const char *name)
{
# 103 "/acl/lib_acl/src/stdlib/sys/acl_env.c"
 return (getenv(name));
...
char *acl_getenv3(const char *name, char *buf, size_t len)
{
 ...
 if (ptr == 
# 115 "/acl/lib_acl/src/stdlib/sys/acl_env.c" 3 4
           ((void *)0)
# 115 "/acl/lib_acl/src/stdlib/sys/acl_env.c"
               )
  return (
# 116 "/acl/lib_acl/src/stdlib/sys/acl_env.c" 3 4
         ((void *)0)
# 116 "/acl/lib_acl/src/stdlib/sys/acl_env.c"
             );
...
int acl_setenv(const char *name, const char *val, int overwrite)
{
# 133 "/acl/lib_acl/src/stdlib/sys/acl_env.c"
...
int acl_putenv(char *str)
{
# 155 "/acl/lib_acl/src/stdlib/sys/acl_env.c"
 return (putenv(str));
...
# 199 "/acl/lib_acl/src/stdlib/sys/acl_env.c"
 ...
 if (buf == 
# 207 "/acl/lib_acl/src/stdlib/sys/acl_env.c" 3 4
           ((void *)0)
# 207 "/acl/lib_acl/src/stdlib/sys/acl_env.c"
               ) {
  if (buf_key == (acl_pthread_key_t) 0xffffffff) {
   acl_msg_error("%s(%d): acl_pthread_tls_get error(%s)",
    myname, 210, acl_last_serror());
   return (
# 211 "/acl/lib_acl/src/stdlib/sys/acl_env.c" 3 4
          ((void *)0)
# 211 "/acl/lib_acl/src/stdlib/sys/acl_env.c"
              );
  }
