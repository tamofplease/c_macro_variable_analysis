# 1 "/workspace/acl/lib_acl/src/stdlib/sys/acl_env.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/sys/acl_env.c" 2
# 26 "/workspace/acl/lib_acl/src/stdlib/sys/acl_env.c"
void acl_clean_env(char **preserve_list)
{
...
char *acl_getenv(const char *name)
{
# 103 "/workspace/acl/lib_acl/src/stdlib/sys/acl_env.c"
 return (getenv(name));
...
char *acl_getenv3(const char *name, char *buf, size_t len)
{
 ...
 if (ptr == 
# 115 "/workspace/acl/lib_acl/src/stdlib/sys/acl_env.c" 3 4
           ((void *)0)
# 115 "/workspace/acl/lib_acl/src/stdlib/sys/acl_env.c"
               )
  return (
# 116 "/workspace/acl/lib_acl/src/stdlib/sys/acl_env.c" 3 4
         ((void *)0)
# 116 "/workspace/acl/lib_acl/src/stdlib/sys/acl_env.c"
             );
 do { if (len > 0) { size_t _n = strlen(ptr); _n = _n > (size_t ) len - 1? (size_t) len - 1 : _n; memcpy(buf, ptr, _n); buf[_n] = 0; } } while (0);
 return (buf);
...
int acl_setenv(const char *name, const char *val, int overwrite)
{
# 133 "/workspace/acl/lib_acl/src/stdlib/sys/acl_env.c"
...
int acl_putenv(char *str)
{
# 155 "/workspace/acl/lib_acl/src/stdlib/sys/acl_env.c"
 return (putenv(str));
...
# 199 "/workspace/acl/lib_acl/src/stdlib/sys/acl_env.c"
 ...
 if (buf == 
# 207 "/workspace/acl/lib_acl/src/stdlib/sys/acl_env.c" 3 4
           ((void *)0)
# 207 "/workspace/acl/lib_acl/src/stdlib/sys/acl_env.c"
               ) {
  if (buf_key == (acl_pthread_key_t) 0xffffffff) {
   acl_msg_error("%s(%d): acl_pthread_tls_get error(%s)",
    myname, 210, acl_last_serror());
   return (
# 211 "/workspace/acl/lib_acl/src/stdlib/sys/acl_env.c" 3 4
          ((void *)0)
# 211 "/workspace/acl/lib_acl/src/stdlib/sys/acl_env.c"
              );
  }
