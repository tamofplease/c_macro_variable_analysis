# 1 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sane_socketpair.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 3 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sane_socketpair.c" 2
# 22 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sane_socketpair.c"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 23 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sane_socketpair.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_sys_patch.h" 1
# 24 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sane_socketpair.c" 2
...
# 30 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sane_socketpair.c" 3 4
 4
# 30 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sane_socketpair.c"
      ,
  0,
 };
 int count;
