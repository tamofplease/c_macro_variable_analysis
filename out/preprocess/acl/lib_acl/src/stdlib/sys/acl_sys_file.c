# 0 "/acl/lib_acl/src/stdlib/sys/acl_sys_file.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/sys/acl_sys_file.c"
...
# 2 "/acl/lib_acl/src/stdlib/sys/acl_sys_file.c" 2
# 357 "/acl/lib_acl/src/stdlib/sys/acl_sys_file.c"
int acl_file_open(const char *filepath, int flags, int mode)
{
...
{
 if (fp != 
# 383 "/acl/lib_acl/src/stdlib/sys/acl_sys_file.c" 3 4
          ((void *)0) 
# 383 "/acl/lib_acl/src/stdlib/sys/acl_sys_file.c"
               && fp->read_ready) {
  fp->read_ready = 0;
 }
