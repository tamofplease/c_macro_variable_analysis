# 1 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_file.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_file.c" 2
# 357 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_file.c"
int acl_file_open(const char *filepath, int flags, int mode)
{
...
int acl_file_read(int fh, void *buf, size_t size,
 int timeout __attribute__ ((__unused__)), ACL_VSTREAM *fp, void *arg __attribute__ ((__unused__)))
{
 if (fp != 
# 383 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_file.c" 3 4
          ((void *)0) 
# 383 "/workspace/acl/lib_acl/src/stdlib/sys/acl_sys_file.c"
               && fp->read_ready) {
  fp->read_ready = 0;
 }
...
int acl_file_write(int fh, const void *buf, size_t size,
 int timeout __attribute__ ((__unused__)), ACL_VSTREAM *fp __attribute__ ((__unused__)),
 void *arg __attribute__ ((__unused__)))
{
 return (int) write(fh, buf, size);
}

int acl_file_writev(int fh, const struct iovec *vector, int count,
 int timeout __attribute__ ((__unused__)), ACL_VSTREAM *fp __attribute__ ((__unused__)),
 void *arg __attribute__ ((__unused__)))
{
...
int acl_file_fflush(int fh, ACL_VSTREAM *fp __attribute__ ((__unused__)),
 void *arg __attribute__ ((__unused__)))
{
 return fsync(fh);
}
...
long long int acl_file_fsize(int fh, ACL_VSTREAM *fp __attribute__ ((__unused__)),
 void *arg __attribute__ ((__unused__)))
{
 struct stat64 sbuf;

 if (fstat64(fh, &sbuf) == -1) {
  return -1;
 }
 return sbuf.st_size;
}
