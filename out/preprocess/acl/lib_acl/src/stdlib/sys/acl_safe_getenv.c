# 0 "/acl/lib_acl/src/stdlib/sys/acl_safe_getenv.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/sys/acl_safe_getenv.c"
...
# 2 "/acl/lib_acl/src/stdlib/sys/acl_safe_getenv.c" 2
# 15 "/acl/lib_acl/src/stdlib/sys/acl_safe_getenv.c"
char *acl_safe_getenv(const char *name)
{
