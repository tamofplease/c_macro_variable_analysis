# 1 "/workspace/acl/lib_acl/src/stdlib/sys/acl_safe_getenv.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/sys/acl_safe_getenv.c" 2
# 15 "/workspace/acl/lib_acl/src/stdlib/sys/acl_safe_getenv.c"
char *acl_safe_getenv(const char *name)
{
