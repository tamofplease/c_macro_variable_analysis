# 0 "/acl/lib_acl/src/stdlib/sys/unix/acl_trace.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/sys/unix/acl_trace.c"
...
# 2 "/acl/lib_acl/src/stdlib/sys/unix/acl_trace.c" 2
# 116 "/acl/lib_acl/src/stdlib/sys/unix/acl_trace.c"
void acl_trace_save(const char *filepath __attribute__ ((__unused__)))
{
}
