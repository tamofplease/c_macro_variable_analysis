# 1 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_core_limit.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_core_limit.c" 2
# 10 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_core_limit.c"
...
# 11 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_core_limit.c" 2
...
# 14 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_core_limit.c" 2

# 1 "/workspace/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 16 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_core_limit.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/unix/acl_core_limit.h" 1
# 17 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_core_limit.c" 2


# 18 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_core_limit.c"
void acl_set_core_limit(long long int max)
{
 ...
 if (prctl(
# 25 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_core_limit.c" 3 4
          4
# 25 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_core_limit.c"
                         , 1) < 0) {
  acl_msg_warn("%s(%d): prctl error(%s)",
   myname, 27, acl_last_serror());
 }


 if (max < 0)
  max = 
# 32 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_core_limit.c" 3 4
       0xffffffffffffffffuLL
# 32 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_core_limit.c"
                    ;

 if (getrlimit(
# 34 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_core_limit.c" 3 4
              RLIMIT_CORE
# 34 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_core_limit.c"
                         , &rlim) == 0) {
  rlim_new.rlim_cur = max;
  rlim_new.rlim_max = max;
  if (setrlimit(
# 37 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_core_limit.c" 3 4
               RLIMIT_CORE
# 37 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_core_limit.c"
                          , &rlim_new) != 0) {

   rlim_new.rlim_cur = rlim.rlim_max;
   rlim_new.rlim_max = rlim.rlim_max;
   if (setrlimit(
# 41 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_core_limit.c" 3 4
                RLIMIT_CORE
# 41 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_core_limit.c"
                           , &rlim_new) != 0)
    acl_msg_warn("%s(%d): can't set core limit: %s",
     myname, 43, acl_last_serror());
  }
 } else {
  rlim.rlim_cur = max;
  rlim.rlim_max = max;
  if (setrlimit(
# 48 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_core_limit.c" 3 4
               RLIMIT_CORE
# 48 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_core_limit.c"
                          , &rlim) != 0)
   acl_msg_warn("%s(%d): can't set core limit: %s",
    myname, 50, acl_last_serror());
 }
}
