# 1 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_timed_wait.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 3 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_timed_wait.c" 2
# 23 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_timed_wait.c"
# 1 "/workspace/acl/lib_acl/src/stdlib/sys/unix/posix_signals.h" 1
# 24 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_timed_wait.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 25 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_timed_wait.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/unix/acl_timed_wait.h" 1
# 26 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_timed_wait.c" 2
...
static void timed_wait_alarm(int unused_sig __attribute__ ((__unused__)))
{
 ...
 int time_limit)
{
 ...
 action.sa_flags = 0;
 action.
# 68 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_timed_wait.c" 3 4
       __sigaction_handler.sa_handler 
# 68 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_timed_wait.c"
                  = timed_wait_alarm;
 if (sigaction(
# 69 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_timed_wait.c" 3 4
              14
# 69 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_timed_wait.c"
                     , &action, &old_action) < 0)
 ...
 if ((wpid = waitpid(pid, statusp, options)) < 0 && timed_wait_expired)
  acl_set_error(
# 79 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_timed_wait.c" 3 4
               110
# 79 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_timed_wait.c"
                        );
 ...
 alarm(0);
 if (sigaction(
# 85 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_timed_wait.c" 3 4
              14
# 85 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_timed_wait.c"
                     , &old_action, (struct sigaction *) 0) < 0)
  acl_msg_fatal("%s: sigaction(SIGALRM): %s", myname,
   acl_last_strerror(tbuf, sizeof(tbuf)));
 if (time_left)
  alarm(time_left);
