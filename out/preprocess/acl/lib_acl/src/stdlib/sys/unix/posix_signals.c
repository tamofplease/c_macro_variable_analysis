# 1 "/workspace/acl/lib_acl/src/stdlib/sys/unix/posix_signals.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 3 "/workspace/acl/lib_acl/src/stdlib/sys/unix/posix_signals.c" 2
# 19 "/workspace/acl/lib_acl/src/stdlib/sys/unix/posix_signals.c"
# 1 "/workspace/acl/lib_acl/src/stdlib/sys/unix/posix_signals.h" 1
# 20 "/workspace/acl/lib_acl/src/stdlib/sys/unix/posix_signals.c" 2
