# 0 "/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c"
...
# 3 "/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c" 2
# 18 "/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c"
# 1 "/acl/lib_acl/src/stdlib/sys/unix/posix_signals.h" 1
# 19 "/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c" 2



# 1 "/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 23 "/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c" 2
# 1 "/acl/lib_acl/include/stdlib/acl_mymalloc.h" 1
# 24 "/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c" 2
# 1 "/acl/lib_acl/include/stdlib/unix/acl_watchdog.h" 1
# 25 "/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c" 2
# 39 "/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c"
 struct ACL_WATCHDOG {
  unsigned timeout;
 ...
 ACL_WATCHDOG_FN action, char *context)
{
 ...
 wp = (ACL_WATCHDOG *) acl_malloc_glue("/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c", 90, sizeof(*wp));
 ...
 sig_action.sa_flags = 
# 99 "/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c" 3 4
                      0x10000000
# 99 "/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c"
                                ;



 sig_action.
# 103 "/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c" 3 4
           __sigaction_handler.sa_handler 
# 103 "/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c"
                      = acl_watchdog_event;
 if (sigaction(
# 104 "/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c" 3 4
              14
# 104 "/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c"
...
void acl_watchdog_destroy(ACL_WATCHDOG *wp)
{
 ...
 if (sigaction(
# 120 "/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c" 3 4
              14
# 120 "/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c"
                     , &wp->saved_action, (struct sigaction *) 0) < 0)
  acl_msg_fatal("%s: sigaction(SIGALRM): %s",
   myname, acl_last_serror());
 if (wp->saved_time)
  alarm(wp->saved_time);
 do { if (wp) { acl_free_glue("/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c", 125, (wp)); (wp) = 
# 125 "/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c" 3 4
((void *)0)
# 125 "/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c"
; } } while (0);
 if (acl_msg_verbose > 1)
