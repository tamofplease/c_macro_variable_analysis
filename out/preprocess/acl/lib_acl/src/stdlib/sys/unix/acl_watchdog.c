# 1 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 3 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c" 2
# 18 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c"
# 1 "/workspace/acl/lib_acl/src/stdlib/sys/unix/posix_signals.h" 1
# 19 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c" 2



# 1 "/workspace/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 23 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_mymalloc.h" 1
# 24 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/unix/acl_watchdog.h" 1
# 25 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c" 2
# 39 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c"
 struct ACL_WATCHDOG {
  unsigned timeout;
  ACL_WATCHDOG_FN action;
  char *context;
  int trip_run;
  ACL_WATCHDOG *saved_watchdog;
...
static void acl_watchdog_event(int unused_sig __attribute__ ((__unused__)))
{
 ...
 ACL_WATCHDOG_FN action, char *context)
{
 ...
 wp = (ACL_WATCHDOG *) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c", 90, sizeof(*wp));
 if ((wp->timeout = timeout / 3) == 0)
 ...
 sig_action.sa_flags = 
# 99 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c" 3 4
                      0x10000000
# 99 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c"
                                ;



 sig_action.
# 103 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c" 3 4
           __sigaction_handler.sa_handler 
# 103 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c"
                      = acl_watchdog_event;
 if (sigaction(
# 104 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c" 3 4
              14
# 104 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c"
                     , &sig_action, &wp->saved_action) < 0)
...
void acl_watchdog_destroy(ACL_WATCHDOG *wp)
{
 ...
 if (sigaction(
# 120 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c" 3 4
              14
# 120 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c"
                     , &wp->saved_action, (struct sigaction *) 0) < 0)
  acl_msg_fatal("%s: sigaction(SIGALRM): %s",
   myname, acl_last_serror());
 if (wp->saved_time)
  alarm(wp->saved_time);
 do { if (wp) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c", 125, (wp)); (wp) = 
# 125 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c" 3 4
((void *)0)
# 125 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_watchdog.c"
; } } while (0);
 if (acl_msg_verbose > 1)
