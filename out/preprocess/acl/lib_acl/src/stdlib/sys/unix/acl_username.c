# 0 "/acl/lib_acl/src/stdlib/sys/unix/acl_username.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/sys/unix/acl_username.c"
...
# 2 "/acl/lib_acl/src/stdlib/sys/unix/acl_username.c" 2
# 16 "/acl/lib_acl/src/stdlib/sys/unix/acl_username.c"
...
# 17 "/acl/lib_acl/src/stdlib/sys/unix/acl_username.c" 2

# 1 "/acl/lib_acl/include/stdlib/unix/acl_username.h" 1
# 19 "/acl/lib_acl/src/stdlib/sys/unix/acl_username.c" 2


# 20 "/acl/lib_acl/src/stdlib/sys/unix/acl_username.c"
const char *acl_username(void)
{
 uid_t uid;
 struct passwd *pwd;
