# 1 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_username.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_username.c" 2
# 16 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_username.c"
...
# 17 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_username.c" 2

# 1 "/workspace/acl/lib_acl/include/stdlib/unix/acl_username.h" 1
# 19 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_username.c" 2


# 20 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_username.c"
const char *acl_username(void)
{
 uid_t uid;
 struct passwd *pwd;
