# 0 "/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c"
...
# 2 "/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c" 2
# 15 "/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c"
...
# 16 "/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c" 2
...
# 17 "/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c" 2



# 1 "/acl/lib_acl/include/stdlib/unix/acl_mychown.h" 1
# 21 "/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c" 2




# 24 "/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c"
int acl_mychown(const char *path, const char *s_owner, const char *s_group)
{
 struct passwd *pwd;
 struct group *grp;
 ...
 if(path == 
# 32 "/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c" 3 4
           ((void *)0) 
# 32 "/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c"
                || s_owner == 
# 32 "/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c" 3 4
                              ((void *)0) 
# 32 "/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c"
...
# 32 "/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c"
 ...
 if ((pwd = getpwnam(s_owner)) != 0) {
  ...
  if(grp == 
# 37 "/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c" 3 4
           ((void *)0)
# 37 "/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c"
               )
   return(-1);
  gid = grp->gr_gid;
...
int acl_myfchown(const int fd, const char *s_owner, const char *s_group)
{
 ...
 if(fd < 0 || s_owner == 
# 58 "/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c" 3 4
                        ((void *)0) 
# 58 "/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c"
                             || s_group == 
# 58 "/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c" 3 4
                                           ((void *)0)
# 58 "/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c"
 ...
 if ((pwd = getpwnam(s_owner)) != 0) {
  ...
  grp = getgrnam(s_group);
  if(grp == 
# 63 "/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c" 3 4
           ((void *)0)
# 63 "/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c"
               )
   return(-1);
  gid = grp->gr_gid;
