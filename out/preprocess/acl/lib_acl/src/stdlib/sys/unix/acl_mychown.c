# 1 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c" 2
# 15 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c"
...
# 16 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c" 2
...
# 17 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c" 2



# 1 "/workspace/acl/lib_acl/include/stdlib/unix/acl_mychown.h" 1
# 21 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c" 2




# 24 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c"
int acl_mychown(const char *path, const char *s_owner, const char *s_group)
{
 struct passwd *pwd;
 struct group *grp;
 ...
 if(path == 
# 32 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c" 3 4
           ((void *)0) 
# 32 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c"
                || s_owner == 
# 32 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c" 3 4
                              ((void *)0) 
# 32 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c"
...
# 32 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c"
 ...
 if ((pwd = getpwnam(s_owner)) != 0) {
  ...
  if(grp == 
# 37 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c" 3 4
           ((void *)0)
# 37 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c"
               )
   return(-1);
  gid = grp->gr_gid;
...
int acl_myfchown(const int fd, const char *s_owner, const char *s_group)
{
 ...
 if(fd < 0 || s_owner == 
# 58 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c" 3 4
                        ((void *)0) 
# 58 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c"
                             || s_group == 
# 58 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c" 3 4
                                           ((void *)0)
# 58 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c"
 ...
 if ((pwd = getpwnam(s_owner)) != 0) {
  ...
  grp = getgrnam(s_group);
  if(grp == 
# 63 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c" 3 4
           ((void *)0)
# 63 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_mychown.c"
               )
   return(-1);
  gid = grp->gr_gid;
