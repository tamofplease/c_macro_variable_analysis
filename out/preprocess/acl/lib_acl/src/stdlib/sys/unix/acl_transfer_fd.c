# 0 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
...
# 2 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 2
# 54 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
int acl_read_fd(int fd, void *ptr, int nbytes, int *recv_fd)
{
 struct msghdr msg;
 struct iovec iov[1];
 ...
 union {
  ...
  char control[
# 66 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                ((((
# 66 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                sizeof(int)
# 66 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
...
# 66 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
 ...
 msg.msg_name = 
# 82 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
               ((void *)0)
# 82 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                   ;
 msg.msg_namelen = 0;
 ...
 if ((cmptr = 
# 95 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
             ((size_t) (
# 95 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
             &msg
# 95 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
...
# 96 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
    && cmptr->cmsg_len == 
# 96 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
...
# 96 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
 ...
 {
  if (cmptr->cmsg_level != 
# 98 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                          1
# 98 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                                    )
   acl_msg_fatal("%s: control level != SOL_SOCKET",
    myname);
  if (cmptr->cmsg_type != 
# 101 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                         SCM_RIGHTS
# 101 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                                   )
  ...
  fdptr = (int *) 
# 107 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                 ((
# 107 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                 cmptr
# 107 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                 )->__cmsg_data)
# 107 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
...
int acl_write_fd(int fd, void *ptr, int nbytes, int send_fd)
{
 ...
 union {
  ...
  char control[
# 135 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                ((((
# 135 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                sizeof(int)
# 135 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                ) + sizeof (size_t) - 1) & (size_t) ~(sizeof (size_t) - 1)) + (((sizeof (struct cmsghdr)) + sizeof (size_t) - 1) & (size_t) ~(sizeof (size_t) - 1)))
# 135 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
 ...
 cmptr = 
# 142 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
        ((size_t) (
# 142 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
        &msg
# 142 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
        )->msg_controllen >= sizeof (struct cmsghdr) ? (struct cmsghdr *) (
# 142 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
...
# 142 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                           ;
 cmptr->cmsg_len = 
# 143 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                  ((((sizeof (struct cmsghdr)) + sizeof (size_t) - 1) & (size_t) ~(sizeof (size_t) - 1)) + (
# 143 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                  sizeof(int)
# 143 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                  ))
# 143 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                                       ;
 cmptr->cmsg_level = 
# 144 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                    1
# 144 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                              ;
 cmptr->cmsg_type = 
# 145 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                   SCM_RIGHTS
# 145 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                             ;
 ...
 fdptr = (int *) 
# 150 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                ((
# 150 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                cmptr
# 150 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                )->__cmsg_data)
# 150 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
 ...
 *fdptr = send_fd;
 ...
 msg.msg_name = 
# 159 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
               ((void *)0)
# 159 "/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                   ;
 msg.msg_namelen = 0;
