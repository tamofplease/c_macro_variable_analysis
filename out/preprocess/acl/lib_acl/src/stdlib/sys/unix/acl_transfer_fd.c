# 1 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 2
# 54 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
int acl_read_fd(int fd, void *ptr, int nbytes, int *recv_fd)
{
 struct msghdr msg;
 struct iovec iov[1];
 ...
 union {
  ...
  char control[
# 66 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                ((((
# 66 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                sizeof(int)
# 66 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
...
# 66 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
 ...
 msg.msg_name = 
# 82 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
               ((void *)0)
# 82 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                   ;
 msg.msg_namelen = 0;
 ...
 if ((cmptr = 
# 95 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
             ((size_t) (
# 95 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
             &msg
# 95 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
...
# 96 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
    && cmptr->cmsg_len == 
# 96 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
...
# 96 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
 ...
 {
  if (cmptr->cmsg_level != 
# 98 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                          1
# 98 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                                    )
   acl_msg_fatal("%s: control level != SOL_SOCKET",
    myname);
  if (cmptr->cmsg_type != 
# 101 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                         SCM_RIGHTS
# 101 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                                   )
  ...
  fdptr = (int *) 
# 107 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                 ((
# 107 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                 cmptr
# 107 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                 )->__cmsg_data)
# 107 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
...
int acl_write_fd(int fd, void *ptr, int nbytes, int send_fd)
{
 ...
 union {
  ...
  char control[
# 135 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                ((((
# 135 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                sizeof(int)
# 135 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                ) + sizeof (size_t) - 1) & (size_t) ~(sizeof (size_t) - 1)) + (((sizeof (struct cmsghdr)) + sizeof (size_t) - 1) & (size_t) ~(sizeof (size_t) - 1)))
# 135 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
 ...
 cmptr = 
# 142 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
        ((size_t) (
# 142 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
        &msg
# 142 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
        )->msg_controllen >= sizeof (struct cmsghdr) ? (struct cmsghdr *) (
# 142 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
...
# 142 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                           ;
 cmptr->cmsg_len = 
# 143 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                  ((((sizeof (struct cmsghdr)) + sizeof (size_t) - 1) & (size_t) ~(sizeof (size_t) - 1)) + (
# 143 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                  sizeof(int)
# 143 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                  ))
# 143 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                                       ;
 cmptr->cmsg_level = 
# 144 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                    1
# 144 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                              ;
 cmptr->cmsg_type = 
# 145 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                   SCM_RIGHTS
# 145 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                             ;
 ...
 fdptr = (int *) 
# 150 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                ((
# 150 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                cmptr
# 150 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
                )->__cmsg_data)
# 150 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
 ...
 *fdptr = send_fd;
 ...
 msg.msg_name = 
# 159 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c" 3 4
               ((void *)0)
# 159 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_transfer_fd.c"
                   ;
 msg.msg_namelen = 0;
