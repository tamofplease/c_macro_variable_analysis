# 0 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
...
# 2 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 2
# 25 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
# 1 "/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 26 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 2
# 1 "/acl/lib_acl/include/stdlib/acl_vstream.h" 1
# 27 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 2
# 1 "/acl/lib_acl/include/stdlib/acl_vstring.h" 1
# 28 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 2
# 1 "/acl/lib_acl/include/stdlib/unix/acl_safe_open.h" 1
# 29 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 2
...
# 44 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
                                       0100 
# 44 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
                                               | 
# 44 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
                                                 0200
# 44 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
...
# 65 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
           ((((
# 65 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
           fstat_st->st_mode
# 65 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
           )) & 0170000) == (0040000))
# 65 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
  ...
  acl_set_error(
# 68 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
               21
# 68 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
                     );
  ...
  acl_set_error(
# 73 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
               1
# 73 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
                    );
 }
# 92 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
 else if (lstat(path, &lstat_st) < 0) {
  if (why)
   acl_vstring_sprintf(why, "file status changed unexpectedly: %s",
    acl_last_strerror(tbuf, sizeof(tbuf)));
  acl_set_error(
# 96 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
               1
# 96 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
                    );
 } else if (
# 97 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
           ((((
# 97 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
           lstat_st.st_mode
# 97 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
           )) & 0170000) == (0120000))
# 97 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
  ...
  acl_set_error(
# 102 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
               1
# 102 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
                    );
  ...
  acl_set_error(
# 112 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
               1
# 112 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
                    );
 }
 ...
 struct stat * st, uid_t user, uid_t group, ACL_VSTRING *why)
{
 ...
 fp = acl_vstream_fopen(path, flags | (
# 141 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
                                      0100 
# 141 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
                                              | 
# 141 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
                                                0200
# 141 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
...
# 156 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
 ...
 struct stat * st, uid_t user, gid_t group, ACL_VSTRING *why)
{
 ...
 switch (flags & (
# 189 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
                 0100 
# 189 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
                         | 
# 189 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
                           0200
# 189 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
 ...
 case 
# 200 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
     0100 
# 200 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
             | 
# 200 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
               0200
# 200 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
  ...
  return (acl_safe_open_create(path, flags, mode,
      st, user, group, why));
# 211 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
 case 
# 211 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
     0100
# 211 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
            :
  fp = acl_safe_open_exist(path, flags, st, why);
  if (fp == 0 && acl_last_error() == 
# 213 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
                                    2
# 213 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
                                          ) {
   fp = acl_safe_open_create(path, flags, mode, st,
      user, group, why);
   if (fp == 0 && acl_last_error() == 
# 216 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
                                     17
# 216 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
                                           )
    fp = acl_safe_open_exist(path, flags, st, why);
  }
  return (fp);
 ...
 return (
# 230 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
        ((void *)0)
# 230 "/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
            );
}
