# 1 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 2
# 25 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 26 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_vstream.h" 1
# 27 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_vstring.h" 1
# 28 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/unix/acl_safe_open.h" 1
# 29 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 2
 ...
 struct stat * fstat_st, ACL_VSTRING *why)
{
 ...
 fp = acl_vstream_fopen(path, flags & ~(
# 44 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
                                       0100 
# 44 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
                                               | 
# 44 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
                                                 0200
# 44 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
 ...
 if (fstat(((fp)->fd.h_file), fstat_st) < 0) {
  acl_msg_fatal("%s: bad open file status: %s", path,
   acl_last_strerror(tbuf, sizeof(tbuf)));
 } else if (
# 65 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
           ((((
# 65 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
           fstat_st->st_mode
# 65 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
           )) & 0170000) == (0040000))
# 65 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
  ...
  acl_set_error(
# 68 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
               21
# 68 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
                     );
  ...
  acl_set_error(
# 73 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
               1
# 73 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
                    );
 }
# 92 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
 else if (lstat(path, &lstat_st) < 0) {
  if (why)
   acl_vstring_sprintf(why, "file status changed unexpectedly: %s",
    acl_last_strerror(tbuf, sizeof(tbuf)));
  acl_set_error(
# 96 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
               1
# 96 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
                    );
 } else if (
# 97 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
           ((((
# 97 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
           lstat_st.st_mode
# 97 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
           )) & 0170000) == (0120000))
# 97 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
  ...
  acl_set_error(
# 102 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
               1
# 102 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
                    );
  ...
  acl_set_error(
# 112 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
               1
# 112 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
                    );
 }
 ...
 struct stat * st, uid_t user, uid_t group, ACL_VSTRING *why)
{
 ...
 fp = acl_vstream_fopen(path, flags | (
# 141 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
                                      0100 
# 141 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
                                              | 
# 141 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
                                                0200
# 141 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
...
# 156 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
 if ((user != (uid_t) -1 || group != (gid_t) -1) && fchown(((fp)->fd.h_file), user, group) < 0) {
 ...
 if (st != 0 && fstat(((fp)->fd.h_file), st) < 0)
 ...
 struct stat * st, uid_t user, gid_t group, ACL_VSTRING *why)
{
 ...
 switch (flags & (
# 189 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
                 0100 
# 189 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
                         | 
# 189 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
                           0200
# 189 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
 ...
 case 
# 200 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
     0100 
# 200 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
             | 
# 200 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
               0200
# 200 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
  ...
  return (acl_safe_open_create(path, flags, mode,
      st, user, group, why));
# 211 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
 case 
# 211 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
     0100
# 211 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
            :
  fp = acl_safe_open_exist(path, flags, st, why);
  if (fp == 0 && acl_last_error() == 
# 213 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
                                    2
# 213 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
                                          ) {
   fp = acl_safe_open_create(path, flags, mode, st,
      user, group, why);
   if (fp == 0 && acl_last_error() == 
# 216 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
                                     17
# 216 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
                                           )
    fp = acl_safe_open_exist(path, flags, st, why);
  }
  return (fp);
 ...
 return (
# 230 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c" 3 4
        ((void *)0)
# 230 "/workspace/acl/lib_acl/src/stdlib/sys/unix/acl_safe_open.c"
            );
}
