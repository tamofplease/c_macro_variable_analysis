# 1 "/workspace/acl/lib_acl/src/stdlib/sys/acl_dll.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/sys/acl_dll.c" 2
# 14 "/workspace/acl/lib_acl/src/stdlib/sys/acl_dll.c"
void* acl_dlopen(const char *dlname)
{
...
# 24 "/workspace/acl/lib_acl/src/stdlib/sys/acl_dll.c" 3 4
                           0 
# 24 "/workspace/acl/lib_acl/src/stdlib/sys/acl_dll.c"
                                      | 
# 24 "/workspace/acl/lib_acl/src/stdlib/sys/acl_dll.c" 3 4
                                        0x00001
# 24 "/workspace/acl/lib_acl/src/stdlib/sys/acl_dll.c"
 ...
 if (handle != 
# 29 "/workspace/acl/lib_acl/src/stdlib/sys/acl_dll.c" 3 4
              ((void *)0)
# 29 "/workspace/acl/lib_acl/src/stdlib/sys/acl_dll.c"
                  )
  dlerror();
 ...
 if (handle == 
# 34 "/workspace/acl/lib_acl/src/stdlib/sys/acl_dll.c" 3 4
              ((void *)0)
# 34 "/workspace/acl/lib_acl/src/stdlib/sys/acl_dll.c"
                  )
  acl_msg_error("%s(%d): open(%s) error(%s)",
   myname, 36, dlname, acl_last_serror());
 return handle;
}
...
const char *acl_dlerror(void)
{
 ...
 return ptr == 
# 62 "/workspace/acl/lib_acl/src/stdlib/sys/acl_dll.c" 3 4
              ((void *)0) 
# 62 "/workspace/acl/lib_acl/src/stdlib/sys/acl_dll.c"
                   ? "" : ptr;
