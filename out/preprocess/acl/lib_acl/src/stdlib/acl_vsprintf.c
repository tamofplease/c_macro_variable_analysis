# 1 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 2
# 30 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...

{
 ...
 digits = (type & 64) ? large_digits : small_digits;
 if (type & 16)
  type &= ~1;
 if (base < 2 || base > 36)
  return 0;
...
static int skip_atoi(const char **s)
{
 ...
 while (
# 142 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
       ((*__ctype_b_loc ())[(int) ((
# 142 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
       (int)(**s)
# 142 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
...
# 157 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
int acl_vsnprintf(char *buf, size_t size, const char *fmt, va_list args)
{
 int len;
 long int num;
 ...
 for (; *fmt ; ++fmt) {
  ...
  field_width = -1;
  if (
# 204 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
     ((*__ctype_b_loc ())[(int) ((
# 204 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
     (int)(*fmt)
# 204 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
     ))] & (unsigned short int) _ISdigit)
# 204 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
   ...
   field_width = 
# 209 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
                __builtin_va_arg(
# 209 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
                args
# 209 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
                ,
# 209 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 209 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
  ...
  if (*fmt == '.') {
   ++fmt;
   if (
# 220 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
      ((*__ctype_b_loc ())[(int) ((
# 220 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
      (int) (*fmt)
# 220 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
      ))] & (unsigned short int) _ISdigit)
# 220 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
    ...
    precision = 
# 225 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
               __builtin_va_arg(
# 225 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
               args
# 225 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
               ,
# 225 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 225 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
  ...
  case 'c':
   ...
   c = (unsigned char) 
# 250 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
                      __builtin_va_arg(
# 250 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
                      args
# 250 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
                      ,
# 250 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 250 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
  ...
  case 's':
   s = 
# 262 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
      __builtin_va_arg(
# 262 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
      args
# 262 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
      ,
# 262 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 262 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
  ...
  case 'p':
   ...
   str = number(str, end,
     (unsigned long) 
# 299 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
                    __builtin_va_arg(
# 299 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
                    args
# 299 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
                    ,
# 299 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 299 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
  ...
  case 'n':
   ...
   if (qualifier == 'l') {
    long * ip = 
# 308 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
               __builtin_va_arg(
# 308 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
               args
# 308 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
               ,
# 308 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 308 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
    ...
    *ip = (long) (str - buf);
    ...
    size_t * ip = 
# 311 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
                 __builtin_va_arg(
# 311 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
                 args
# 311 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
                 ,
# 311 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 311 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
    ...
    *ip = (str - buf);
    ...
    int *ip = 
# 314 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
             __builtin_va_arg(
# 314 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
             args
# 314 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
             ,
# 314 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 314 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
  ...
  if (qualifier == 'L')
   num = 
# 358 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
        __builtin_va_arg(
# 358 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
        args
# 358 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
        ,
# 358 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 358 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
   ...
   num = 
# 360 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
        __builtin_va_arg(
# 360 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
        args
# 360 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
        ,
# 360 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 360 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
   ...
   num = (long) 
# 364 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
               __builtin_va_arg(
# 364 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
               args
# 364 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
               ,
# 364 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 364 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
   ...
   num = (unsigned short) 
# 366 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
                         __builtin_va_arg(
# 366 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
                         args
# 366 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
                         ,
# 366 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 366 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
   ...
   num = 
# 370 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
        __builtin_va_arg(
# 370 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
        args
# 370 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
        ,
# 370 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 395 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
int acl_snprintf(char * buf, size_t size, const char *fmt, ...)
{
 va_list args;
 int i;
...
# 400 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
__builtin_va_start(
# 400 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
args
# 400 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
,
# 400 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 402 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
__builtin_va_end(
# 402 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
args
# 402 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
)
# 402 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 415 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
int acl_vsprintf(char *buf, const char *fmt, va_list args)
{
 return acl_vsnprintf(buf, 0xFFFFFFFFUL, fmt, args);
}
# 427 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
int acl_sprintf(char * buf, const char *fmt, ...)
{
 va_list args;
 int i;
...
# 432 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
__builtin_va_start(
# 432 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
args
# 432 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
,
# 432 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 434 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
__builtin_va_end(
# 434 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
args
# 434 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
)
# 434 "/workspace/acl/lib_acl/src/stdlib/acl_vsprintf.c"
