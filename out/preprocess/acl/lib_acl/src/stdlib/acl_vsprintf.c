# 0 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 2 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 2
# 30 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
static int skip_atoi(const char **s)
{
 ...
 while (
# 142 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
       ((*__ctype_b_loc ())[(int) ((
# 142 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
       (int)(**s)
# 142 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
...
# 157 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
int acl_vsnprintf(char *buf, size_t size, const char *fmt, va_list args)
{
 int len;
 long int num;
 ...
 for (; *fmt ; ++fmt) {
  ...
  field_width = -1;
  if (
# 204 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
     ((*__ctype_b_loc ())[(int) ((
# 204 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
     (int)(*fmt)
# 204 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
     ))] & (unsigned short int) _ISdigit)
# 204 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
   ...
   field_width = 
# 209 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
                __builtin_va_arg(
# 209 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
                args
# 209 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
                ,
# 209 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 209 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
  ...
  if (*fmt == '.') {
   ++fmt;
   if (
# 220 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
      ((*__ctype_b_loc ())[(int) ((
# 220 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
      (int) (*fmt)
# 220 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
      ))] & (unsigned short int) _ISdigit)
# 220 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
    ...
    precision = 
# 225 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
               __builtin_va_arg(
# 225 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
               args
# 225 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
               ,
# 225 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 225 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
  ...
  case 'c':
   ...
   c = (unsigned char) 
# 250 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
                      __builtin_va_arg(
# 250 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
                      args
# 250 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
                      ,
# 250 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 250 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
  ...
  case 's':
   s = 
# 262 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
      __builtin_va_arg(
# 262 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
      args
# 262 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
      ,
# 262 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 262 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
  ...
  case 'p':
   ...
   str = number(str, end,
     (unsigned long) 
# 299 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
                    __builtin_va_arg(
# 299 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
                    args
# 299 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
                    ,
# 299 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 299 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
  ...
  case 'n':
   ...
   if (qualifier == 'l') {
    long * ip = 
# 308 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
               __builtin_va_arg(
# 308 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
               args
# 308 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
               ,
# 308 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 308 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
    ...
    *ip = (long) (str - buf);
    ...
    size_t * ip = 
# 311 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
                 __builtin_va_arg(
# 311 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
                 args
# 311 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
                 ,
# 311 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 311 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
    ...
    *ip = (str - buf);
    ...
    int *ip = 
# 314 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
             __builtin_va_arg(
# 314 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
             args
# 314 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
             ,
# 314 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 314 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
  ...
  if (qualifier == 'L')
   num = 
# 358 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
        __builtin_va_arg(
# 358 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
        args
# 358 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
        ,
# 358 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 358 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
   ...
   num = 
# 360 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
        __builtin_va_arg(
# 360 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
        args
# 360 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
        ,
# 360 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 360 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
   ...
   num = (long) 
# 364 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
               __builtin_va_arg(
# 364 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
               args
# 364 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
               ,
# 364 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 364 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
   ...
   num = (unsigned short) 
# 366 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
                         __builtin_va_arg(
# 366 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
                         args
# 366 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
                         ,
# 366 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 366 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
   ...
   num = 
# 370 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
        __builtin_va_arg(
# 370 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
        args
# 370 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
        ,
# 370 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 395 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
int acl_snprintf(char * buf, size_t size, const char *fmt, ...)
{
 va_list args;
 int i;
...
# 400 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
__builtin_va_start(
# 400 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
args
# 400 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
,
# 400 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 402 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
__builtin_va_end(
# 402 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
args
# 402 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
)
# 402 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 415 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
int acl_vsprintf(char *buf, const char *fmt, va_list args)
{
 return acl_vsnprintf(buf, 0xFFFFFFFFUL, fmt, args);
}
# 427 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
int acl_sprintf(char * buf, const char *fmt, ...)
{
 va_list args;
 int i;
...
# 432 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
__builtin_va_start(
# 432 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
args
# 432 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
,
# 432 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
...
# 434 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
__builtin_va_end(
# 434 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
args
# 434 "/acl/lib_acl/src/stdlib/acl_vsprintf.c" 3 4
)
# 434 "/acl/lib_acl/src/stdlib/acl_vsprintf.c"
