# 1 "/workspace/acl/lib_acl/src/stdlib/acl_vstring_vstream.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/acl_vstring_vstream.c" 2
# 20 "/workspace/acl/lib_acl/src/stdlib/acl_vstring_vstream.c"
int acl_vstring_gets(ACL_VSTRING *vp, ACL_VSTREAM *fp)
{
 int ch;
