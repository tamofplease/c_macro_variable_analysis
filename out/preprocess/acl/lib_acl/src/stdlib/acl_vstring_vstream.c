# 0 "/acl/lib_acl/src/stdlib/acl_vstring_vstream.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/acl_vstring_vstream.c"
...
# 2 "/acl/lib_acl/src/stdlib/acl_vstring_vstream.c" 2
# 20 "/acl/lib_acl/src/stdlib/acl_vstring_vstream.c"
int acl_vstring_gets(ACL_VSTRING *vp, ACL_VSTREAM *fp)
{
 int ch;

 { (vp)->vbuf.ptr = (vp)->vbuf.data; ((&(vp)->vbuf)->flags &= ~((1<<0) | (1<<1) | (1<<2))); };
 while ((ch = ( (fp)->read_cnt > 0 ? (fp)->read_cnt--, (fp)->offset++, *(fp)->read_ptr++: (fp)->sys_getc((fp)))) != (-1)) {
  ((&(vp)->vbuf)->ptr < (&(vp)->vbuf)->data + (&(vp)->vbuf)->len ? (int) (*(&(vp)->vbuf)->ptr++ = (ch)) : acl_vbuf_put((&(vp)->vbuf),(ch)));
  if (ch == '\n')
   break;
 }
 ((&(vp)->vbuf)->ptr < (&(vp)->vbuf)->data + (&(vp)->vbuf)->len ? *(&(vp)->vbuf)->ptr = 0 : acl_vbuf_space((&(vp)->vbuf), 1), *(&(vp)->vbuf)->ptr = 0);
 return (((size_t) ((vp)->vbuf.ptr - (vp)->vbuf.data) > 0 ? ((char *) (vp)->vbuf.ptr)[-1] : (-1)));
}
...
int acl_vstring_gets_nonl(ACL_VSTRING *vp, ACL_VSTREAM *fp)
{
 ...
 { (vp)->vbuf.ptr = (vp)->vbuf.data; ((&(vp)->vbuf)->flags &= ~((1<<0) | (1<<1) | (1<<2))); };
 while ((ch = ( (fp)->read_cnt > 0 ? (fp)->read_cnt--, (fp)->offset++, *(fp)->read_ptr++: (fp)->sys_getc((fp)))) != (-1) && ch != '\n') {
  if (ch == '\r') {
   last = ch;
  } else {
   if (last != 0) {
    ((&(vp)->vbuf)->ptr < (&(vp)->vbuf)->data + (&(vp)->vbuf)->len ? (int) (*(&(vp)->vbuf)->ptr++ = (last)) : acl_vbuf_put((&(vp)->vbuf),(last)));
    last = 0;
   }
   ((&(vp)->vbuf)->ptr < (&(vp)->vbuf)->data + (&(vp)->vbuf)->len ? (int) (*(&(vp)->vbuf)->ptr++ = (ch)) : acl_vbuf_put((&(vp)->vbuf),(ch)));
  }
 ...
 ((&(vp)->vbuf)->ptr < (&(vp)->vbuf)->data + (&(vp)->vbuf)->len ? *(&(vp)->vbuf)->ptr = 0 : acl_vbuf_space((&(vp)->vbuf), 1), *(&(vp)->vbuf)->ptr = 0);
 return (ch == '\n' ? ch : ((size_t) ((vp)->vbuf.ptr - (vp)->vbuf.data) > 0 ? ((char *) (vp)->vbuf.ptr)[-1] : (-1)));
}
...
int acl_vstring_gets_null(ACL_VSTRING *vp, ACL_VSTREAM *fp)
{
 ...
 { (vp)->vbuf.ptr = (vp)->vbuf.data; ((&(vp)->vbuf)->flags &= ~((1<<0) | (1<<1) | (1<<2))); };
 while ((ch = ( (fp)->read_cnt > 0 ? (fp)->read_cnt--, (fp)->offset++, *(fp)->read_ptr++: (fp)->sys_getc((fp)))) != (-1) && ch != 0)
  ((&(vp)->vbuf)->ptr < (&(vp)->vbuf)->data + (&(vp)->vbuf)->len ? (int) (*(&(vp)->vbuf)->ptr++ = (ch)) : acl_vbuf_put((&(vp)->vbuf),(ch)));
 ((&(vp)->vbuf)->ptr < (&(vp)->vbuf)->data + (&(vp)->vbuf)->len ? *(&(vp)->vbuf)->ptr = 0 : acl_vbuf_space((&(vp)->vbuf), 1), *(&(vp)->vbuf)->ptr = 0);
 return (ch == 0 ? ch : ((size_t) ((vp)->vbuf.ptr - (vp)->vbuf.data) > 0 ? ((char *) (vp)->vbuf.ptr)[-1] : (-1)));
}
...
int acl_vstring_gets_bound(ACL_VSTRING *vp, ACL_VSTREAM *fp, ssize_t bound)
{
 ...
 { (vp)->vbuf.ptr = (vp)->vbuf.data; ((&(vp)->vbuf)->flags &= ~((1<<0) | (1<<1) | (1<<2))); };
 while (bound-- > 0 && (ch = ( (fp)->read_cnt > 0 ? (fp)->read_cnt--, (fp)->offset++, *(fp)->read_ptr++: (fp)->sys_getc((fp)))) != (-1)) {
  ((&(vp)->vbuf)->ptr < (&(vp)->vbuf)->data + (&(vp)->vbuf)->len ? (int) (*(&(vp)->vbuf)->ptr++ = (ch)) : acl_vbuf_put((&(vp)->vbuf),(ch)));
  if (ch == '\n')
   break;
 }
...
int acl_vstring_gets_nonl_bound(ACL_VSTRING *vp, ACL_VSTREAM *fp, ssize_t bound)
{
 ...
 { (vp)->vbuf.ptr = (vp)->vbuf.data; ((&(vp)->vbuf)->flags &= ~((1<<0) | (1<<1) | (1<<2))); };
 while (bound-- > 0 && (ch = ( (fp)->read_cnt > 0 ? (fp)->read_cnt--, (fp)->offset++, *(fp)->read_ptr++: (fp)->sys_getc((fp)))) != (-1) && ch != '\n') {
  if (ch == '\r') {
   last = ch;
  } else {
   if (last != 0) {
...
int acl_vstring_gets_null_bound(ACL_VSTRING *vp, ACL_VSTREAM *fp, ssize_t bound)
{
 ...
 { (vp)->vbuf.ptr = (vp)->vbuf.data; ((&(vp)->vbuf)->flags &= ~((1<<0) | (1<<1) | (1<<2))); };
 while (bound-- > 0 && (ch = ( (fp)->read_cnt > 0 ? (fp)->read_cnt--, (fp)->offset++, *(fp)->read_ptr++: (fp)->sys_getc((fp)))) != (-1) && ch != 0)
  ((&(vp)->vbuf)->ptr < (&(vp)->vbuf)->data + (&(vp)->vbuf)->len ? (int) (*(&(vp)->vbuf)->ptr++ = (ch)) : acl_vbuf_put((&(vp)->vbuf),(ch)));
 ((&(vp)->vbuf)->ptr < (&(vp)->vbuf)->data + (&(vp)->vbuf)->len ? *(&(vp)->vbuf)->ptr = 0 : acl_vbuf_space((&(vp)->vbuf), 1), *(&(vp)->vbuf)->ptr = 0);
 return (ch == 0 ? ch : ((size_t) ((vp)->vbuf.ptr - (vp)->vbuf.data) > 0 ? ((char *) (vp)->vbuf.ptr)[-1] : (-1)));
}
