# 1 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_timed_write.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 4 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_timed_write.c" 2
# 22 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_timed_write.c"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 23 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_timed_write.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_sys_patch.h" 1
# 24 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_timed_write.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_iostuff.h" 1
# 25 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_timed_write.c" 2



int acl_timed_write(int fd, void *buf, unsigned len,
 int timeout, void *context __attribute__ ((__unused__)))
{
 int ret;
# 46 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_timed_write.c"
 for (;;) {
  if (timeout > 0 && acl_write_wait(fd, timeout) < 0) {
   return -1;
  }
  ret = acl_socket_write(fd, buf, len, -1, 
# 50 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_timed_write.c" 3 4
                                          ((void *)0)
# 50 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_timed_write.c"
                                              , 
# 50 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_timed_write.c" 3 4
                                                ((void *)0)
# 50 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_timed_write.c"
                                                    );
  if (ret < 0 && timeout > 0 && acl_last_error() == 
# 51 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_timed_write.c" 3 4
                                                   11
# 51 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_timed_write.c"
                                                             ) {
