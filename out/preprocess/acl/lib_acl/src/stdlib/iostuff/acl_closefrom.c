# 1 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_closefrom.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_closefrom.c" 2
# 17 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_closefrom.c"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_iostuff.h" 1
# 18 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_closefrom.c" 2
...
int acl_closefrom(int lowfd)
{
 ...
 if (lowfd < 0) {
  acl_set_error(
# 32 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_closefrom.c" 3 4
               9
# 32 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_closefrom.c"
                    );
  return (-1);
 }
 if (fd_limit > 500)
