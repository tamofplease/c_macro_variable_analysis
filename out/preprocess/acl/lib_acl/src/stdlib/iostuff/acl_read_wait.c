# 1 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 2
# 13 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
# 1 "/usr/include/poll.h" 1 3 4
# 14 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 2
...
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 21 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_mymalloc.h" 1
# 22 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_iostuff.h" 1
# 23 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 2
# 1 "/workspace/acl/lib_acl/src/stdlib/iostuff/../../init/init.h" 1



extern int __acl_var_use_poll;
# 24 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 2



# 1 "/workspace/acl/lib_acl/include/init/acl_init.h" 1
# 28 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 2
# 1 "/workspace/acl/lib_acl/include/thread/acl_pthread.h" 1
# 29 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 2
...
# 30 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 2


# 31 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
...
static EPOLL_CTX *main_epoll_ctx = 
# 38 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                                  ((void *)0)
# 38 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                                      ;
...
static void main_epoll_end(void)
{
 ...
 if (main_epoll_ctx != 
# 44 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                      ((void *)0)
# 44 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                          ) {
  acl_msg_info("%s(%d), %s: close epoll_fd: %d, tid: %lu, %lu",
   "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 46, myname, main_epoll_ctx->epfd,
   (unsigned long) main_epoll_ctx->tid,
   (unsigned long) pthread_self());

  close(main_epoll_ctx->epfd);
  do { if (main_epoll_ctx) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 51, (main_epoll_ctx)); (main_epoll_ctx) = 
# 51 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
 ((void *)0)
# 51 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
 ; } } while (0);
  main_epoll_ctx = 
# 52 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                  ((void *)0)
# 52 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                      ;
 }
}
...
static acl_pthread_once_t epoll_once = 
# 58 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                                      0
# 58 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                                                           ;
...
static void thread_epoll_end(void *ctx)
{
 ...
 acl_msg_info("%s(%d), %s: close epoll_fd: %d, tid: %lu, %lu",
  "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 66, myname, epoll_ctx->epfd,
  (unsigned long) epoll_ctx->tid,
  (unsigned long) pthread_self());

 close(epoll_ctx->epfd);
 do { if (epoll_ctx) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 71, (epoll_ctx)); (epoll_ctx) = 
# 71 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
((void *)0)
# 71 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
; } } while (0);
}

static void thread_epoll_once(void)
{
 if (pthread_key_create(&epoll_key, thread_epoll_end) != 0) {
  abort();
 }
}
...
static EPOLL_CTX *thread_epoll_init(void)
{
 ...
 EPOLL_CTX *epoll_ctx = (EPOLL_CTX*) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 84, sizeof(EPOLL_CTX));

 if (pthread_setspecific(epoll_key, epoll_ctx) != 0)
  abort();

 epoll_ctx->tid = pthread_self();
 epoll_ctx->epfd = epoll_create(1);
 if (epoll_ctx == 
# 91 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                 ((void *)0)
# 91 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                     ) {
  acl_msg_error("%s(%d): epoll_create error: %s",
   myname, 93, acl_last_serror());
  return 
# 94 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
        ((void *)0)
# 94 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
            ;
 }

 if ((unsigned long) pthread_self() == (unsigned long) acl_main_thread_self()) {

  main_epoll_ctx = epoll_ctx;
  atexit(main_epoll_end);

  acl_msg_info("%s(%d): %s, create epoll_fd: %d, tid: %lu, %lu",
   "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 103, myname, epoll_ctx->epfd,
   (unsigned long) epoll_ctx->tid,
   (unsigned long) pthread_self());
 } else {
  acl_msg_info("%s(%d): %s, create epoll_fd: %d, tid: %lu, %lu",
   "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 108, myname, epoll_ctx->epfd,
   (unsigned long) epoll_ctx->tid,
   (unsigned long) pthread_self());
 }
...
int acl_read_epoll_wait(int fd, int delay)
{
 ...
 if (pthread_once(&epoll_once, thread_epoll_once) != 0) {
  abort();
 }
 epoll_ctx = (EPOLL_CTX*) pthread_getspecific(epoll_key);
 if (epoll_ctx == 
# 142 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                 ((void *)0)
# 142 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                     ) {
  epoll_ctx = thread_epoll_init();
  if (epoll_ctx == 
# 144 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                  ((void *)0)
# 144 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                      ) {
 ...
 ee.events = 
# 151 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
              EPOLLIN
# 151 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                     ;
 ee.data.u64 = 0;
 ee.data.fd = fd;

 while (1) {
  if (epoll_ctl(epoll_ctx->epfd, 
# 156 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                                1
# 156 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                                             , fd, &ee) == 0) {
   break;
  }
  ...
  if (ret == 
# 162 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
            17
# 162 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                  ) {
   break;
  }

  if (ret == 
# 166 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
            9 
# 166 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                  || ret == 
# 166 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                            22
# 166 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
 ...
 for (;;) {
  ...
  if (ret == -1) {
   ...
   if (ret == 
# 195 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
             4
# 195 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                      ) {
    acl_msg_warn(">>>>catch EINTR, try again<<<");
    continue;
   } else if (ret == 
# 198 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                    9 
# 198 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                          || ret == 
# 198 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                                    4
# 198 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
   ...
   if (delay == 0) {
    acl_set_error(
# 231 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                 11
# 231 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                           );
   } else {
    acl_set_error(
# 233 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                 62
# 233 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                          );
   }
   ret = -1;
   break;
  } else if ((events[0].events & 
# 237 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                                EPOLLIN
# 237 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                                       ) != 0) {
   ret = 0;
  } else if ((events[0].events & (
# 239 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                                 EPOLLERR 
# 239 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                                          | 
# 239 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                                            EPOLLHUP
# 239 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
   ...
   acl_msg_warn("%s(%d), %s: poll error: %s, fd: %d, "
    "delay: %d, spent: %ld", "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 243,
    myname, acl_last_serror(), fd, delay,
    (long) (time(
# 245 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                ((void *)0)
# 245 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                    ) - begin));
   ret = -1;
  }
  break;
 ...
 ee.data.fd = fd;
 if (epoll_ctl(epoll_ctx->epfd, 
# 254 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                               2
# 254 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                                            , fd, &ee) == -1) {
  acl_msg_error("%s(%d): epoll_ctl error: %s, fd: %d, epfd: %d,"
   " tid: %lu, %lu", myname, 256, acl_last_serror(),
...
int acl_read_poll_wait(int fd, int delay)
{
 ...
 for (;;) {
  ...
  fds.events = 
# 309 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
              0x001 
# 309 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                     | 
# 309 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                       0x010 
# 309 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
...
# 309 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
  ...
  time(&begin);
# 329 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
  delay = left;
  ...
  case -1:
   ...
   if (acl_last_error() == 
# 339 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                          4
# 339 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                                   ) {
    break;
   }
   acl_msg_error("%s(%d), %s: poll error(%s), fd: %d",
    "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 343, myname,
  ...
  case 0:
   ...
   if (delay == 0) {
    acl_set_error(
# 358 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                 11
# 358 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                           );
   } else {
    acl_set_error(
# 360 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                 110
# 360 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                              );
   }
   return -1;
  default:
   if ((fds.revents & 
# 364 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                     0x001
# 364 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                           )) {
    return 0;
   }
   if (fds.revents & (
# 367 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                     0x010 
# 367 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                             | 
# 367 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                               0x008 
# 367 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
...
# 367 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
    ...
    acl_msg_warn("%s(%d), %s: poll error: %s, "
     ...
     "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 370, myname,
     acl_last_serror(), fd, delay,
     (long) (time(
# 372 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                 ((void *)0)
# 372 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                     ) - begin));
    return 0;
   }

   acl_msg_warn("%s(%d), %s: poll error: %s, fd: %d, "
    "delay: %d, spent: %ld", "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 377,
    myname, acl_last_serror(), fd, delay,
    (long) (time(
# 379 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                ((void *)0)
# 379 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                    ) - begin));
   return -1;
  }
 }
}
# 459 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
...
int acl_read_select_wait(int fd, int delay)
{
 ...
 if (
# 479 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
    1024 
# 479 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
               <= (unsigned) fd)
  acl_msg_fatal("%s(%d), %s: descriptor %d does not fit "
   "FD_SETSIZE %d", "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 481, myname,
   (int) fd, 
# 482 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
            1024
# 482 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                      );
# 491 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
 
# 491 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
...
# 492 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
((void) (((
# 492 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
&rfds
# 492 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
...
# 493 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((
# 493 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
&xfds
# 493 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
)->__fds_bits)[0]) : "memory"); } while (0)
# 493 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
...
# 494 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
((void) (((
# 494 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
&xfds
# 494 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
)->__fds_bits)[__extension__ ({ long int __d = (
# 494 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
...
# 524 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
   if (errnum == 
# 524 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                4
# 524 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                         ) {
    continue;
   ...
   acl_msg_error("%s(%d), %s: select error(%s), fd: %d",
    "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 529, myname,
    acl_last_serror(), (int) fd);
   return -1;
  case 0:
   ...
   if (delay == 0) {
    acl_set_error(
# 540 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                 11
# 540 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                           );
   } else {
    acl_set_error(
# 542 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                 110
# 542 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                              );
   }
   return -1;
  default:
