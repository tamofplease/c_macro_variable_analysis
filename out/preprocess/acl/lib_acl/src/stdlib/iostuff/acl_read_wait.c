# 0 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
...
# 2 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 2
# 13 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
# 1 "/usr/include/poll.h" 1 3 4
# 14 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 2
...
# 1 "/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 21 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 2
# 1 "/acl/lib_acl/include/stdlib/acl_mymalloc.h" 1
# 22 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 2
# 1 "/acl/lib_acl/include/stdlib/acl_iostuff.h" 1
# 23 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 2
# 1 "/acl/lib_acl/src/stdlib/iostuff/../../init/init.h" 1



extern int __acl_var_use_poll;
# 24 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 2



# 1 "/acl/lib_acl/include/init/acl_init.h" 1
# 28 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 2
# 1 "/acl/lib_acl/include/thread/acl_pthread.h" 1
# 29 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 2
...
# 30 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 2


# 31 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
...
# 38 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                                  ((void *)0)
# 38 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                                      ;
...
static void main_epoll_end(void)
{
 ...
 if (main_epoll_ctx != 
# 44 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                      ((void *)0)
# 44 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                          ) {
  acl_msg_info("%s(%d), %s: close epoll_fd: %d, tid: %lu, %lu",
   "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 46, myname, main_epoll_ctx->epfd,
   (unsigned long) main_epoll_ctx->tid,
   (unsigned long) pthread_self());

  close(main_epoll_ctx->epfd);
  do { if (main_epoll_ctx) { acl_free_glue("/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 51, (main_epoll_ctx)); (main_epoll_ctx) = 
# 51 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
 ((void *)0)
# 51 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
 ; } } while (0);
  main_epoll_ctx = 
# 52 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                  ((void *)0)
# 52 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                      ;
 }
}
...
# 58 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                                      0
# 58 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                                                           ;
...
static void thread_epoll_end(void *ctx)
{
 ...
 acl_msg_info("%s(%d), %s: close epoll_fd: %d, tid: %lu, %lu",
  "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 66, myname, epoll_ctx->epfd,
  (unsigned long) epoll_ctx->tid,
  (unsigned long) pthread_self());

 close(epoll_ctx->epfd);
 do { if (epoll_ctx) { acl_free_glue("/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 71, (epoll_ctx)); (epoll_ctx) = 
# 71 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
((void *)0)
# 71 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
; } } while (0);
}
...
static EPOLL_CTX *thread_epoll_init(void)
{
 ...
 EPOLL_CTX *epoll_ctx = (EPOLL_CTX*) acl_malloc_glue("/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 84, sizeof(EPOLL_CTX));
 ...
 if (epoll_ctx == 
# 91 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                 ((void *)0)
# 91 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                     ) {
  acl_msg_error("%s(%d): epoll_create error: %s",
   myname, 93, acl_last_serror());
  return 
# 94 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
        ((void *)0)
# 94 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
            ;
 }
 ...
 if ((unsigned long) pthread_self() == (unsigned long) acl_main_thread_self()) {
  ...
  acl_msg_info("%s(%d): %s, create epoll_fd: %d, tid: %lu, %lu",
   "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 103, myname, epoll_ctx->epfd,
   (unsigned long) epoll_ctx->tid,
   (unsigned long) pthread_self());
 } else {
  acl_msg_info("%s(%d): %s, create epoll_fd: %d, tid: %lu, %lu",
   "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 108, myname, epoll_ctx->epfd,
   (unsigned long) epoll_ctx->tid,
   (unsigned long) pthread_self());
 }
...
int acl_read_epoll_wait(int fd, int delay)
{
 ...
 if (epoll_ctx == 
# 142 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                 ((void *)0)
# 142 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                     ) {
  epoll_ctx = thread_epoll_init();
  if (epoll_ctx == 
# 144 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                  ((void *)0)
# 144 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                      ) {
 ...
 ee.events = 
# 151 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
              EPOLLIN
# 151 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                     ;
 ee.data.u64 = 0;
 ee.data.fd = fd;
...
# 156 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                                1
# 156 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                                             , fd, &ee) == 0) {
   break;
  }
  ...
  if (ret == 
# 162 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
            17
# 162 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                  ) {
   break;
  }

  if (ret == 
# 166 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
            9 
# 166 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                  || ret == 
# 166 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                            22
# 166 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
 ...
 for (;;) {
  ...
  if (ret == -1) {
   ...
   if (ret == 
# 195 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
             4
# 195 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                      ) {
    acl_msg_warn(">>>>catch EINTR, try again<<<");
    continue;
   } else if (ret == 
# 198 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                    9 
# 198 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                          || ret == 
# 198 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                                    4
# 198 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
   ...
   if (delay == 0) {
    acl_set_error(
# 231 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                 11
# 231 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                           );
   } else {
    acl_set_error(
# 233 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                 62
# 233 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                          );
   }
   ret = -1;
   break;
  } else if ((events[0].events & 
# 237 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                                EPOLLIN
# 237 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                                       ) != 0) {
   ret = 0;
  } else if ((events[0].events & (
# 239 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                                 EPOLLERR 
# 239 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                                          | 
# 239 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                                            EPOLLHUP
# 239 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
   ...
   acl_msg_warn("%s(%d), %s: poll error: %s, fd: %d, "
    "delay: %d, spent: %ld", "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 243,
    myname, acl_last_serror(), fd, delay,
    (long) (time(
# 245 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                ((void *)0)
# 245 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                    ) - begin));
   ret = -1;
  }
  break;
 ...
 ee.data.fd = fd;
 if (epoll_ctl(epoll_ctx->epfd, 
# 254 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                               2
# 254 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                                            , fd, &ee) == -1) {
...
int acl_read_poll_wait(int fd, int delay)
{
 ...
 for (;;) {
  ...
  fds.events = 
# 309 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
              0x001 
# 309 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                     | 
# 309 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                       0x010 
# 309 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
...
# 309 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
  ...
  time(&begin);
# 329 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
  delay = left;
  ...
  case -1:
   ...
   if (acl_last_error() == 
# 339 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                          4
# 339 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                                   ) {
    break;
   }
   acl_msg_error("%s(%d), %s: poll error(%s), fd: %d",
    "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 343, myname,
  ...
  case 0:
   ...
   if (delay == 0) {
    acl_set_error(
# 358 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                 11
# 358 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                           );
   } else {
    acl_set_error(
# 360 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                 110
# 360 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                              );
   }
   return -1;
  default:
   if ((fds.revents & 
# 364 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                     0x001
# 364 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                           )) {
    return 0;
   }
   if (fds.revents & (
# 367 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                     0x010 
# 367 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                             | 
# 367 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                               0x008 
# 367 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
...
# 367 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
    ...
    acl_msg_warn("%s(%d), %s: poll error: %s, "
     ...
     "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 370, myname,
     acl_last_serror(), fd, delay,
     (long) (time(
# 372 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                 ((void *)0)
# 372 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                     ) - begin));
    return 0;
   }

   acl_msg_warn("%s(%d), %s: poll error: %s, fd: %d, "
    "delay: %d, spent: %ld", "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 377,
    myname, acl_last_serror(), fd, delay,
    (long) (time(
# 379 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                ((void *)0)
# 379 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                    ) - begin));
   return -1;
  }
 }
}
# 459 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
...
int acl_read_select_wait(int fd, int delay)
{
 ...
 if (
# 479 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
    1024 
# 479 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
               <= (unsigned) fd)
  acl_msg_fatal("%s(%d), %s: descriptor %d does not fit "
   "FD_SETSIZE %d", "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 481, myname,
   (int) fd, 
# 482 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
            1024
# 482 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                      );
# 491 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
 
# 491 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
...
# 492 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
((void) (((
# 492 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
&rfds
# 492 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
...
# 493 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
do { unsigned int __i; fd_set *__arr = (
# 493 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
&xfds
# 493 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
); for (__i = 0; __i < sizeof (fd_set) / sizeof (__fd_mask); ++__i) ((__arr)->__fds_bits)[__i] = 0; } while (0)
# 493 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
...
# 494 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
((void) (((
# 494 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
&xfds
# 494 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
)->__fds_bits)[__extension__ ({ long int __d = (
# 494 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
...
# 524 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
   if (errnum == 
# 524 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                4
# 524 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                         ) {
    continue;
   ...
   acl_msg_error("%s(%d), %s: select error(%s), fd: %d",
    "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c", 529, myname,
    acl_last_serror(), (int) fd);
   return -1;
  case 0:
   ...
   if (delay == 0) {
    acl_set_error(
# 540 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                 11
# 540 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                           );
   } else {
    acl_set_error(
# 542 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c" 3 4
                 110
# 542 "/acl/lib_acl/src/stdlib/iostuff/acl_read_wait.c"
                              );
   }
   return -1;
  default:
