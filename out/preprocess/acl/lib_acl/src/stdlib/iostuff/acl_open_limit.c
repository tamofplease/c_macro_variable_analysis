# 1 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_open_limit.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 3 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_open_limit.c" 2
# 18 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_open_limit.c"
...
# 19 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_open_limit.c" 2



# 1 "/workspace/acl/lib_acl/include/stdlib/acl_iostuff.h" 1
# 23 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_open_limit.c" 2
# 37 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_open_limit.c"
...
int acl_open_limit(int limit)
{
 ...
 if (getrlimit(
# 45 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_open_limit.c" 3 4
              RLIMIT_NOFILE
# 45 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_open_limit.c"
                           , &rl) < 0) {
  ...
  acl_msg_warn("%s(%d): getrlimit error: %s, use: %d",
   myname, 51, acl_last_serror(), rlim_cur);
  return rlim_cur;
 ...
 if (limit > 0) {
  if (limit > (int) rl.rlim_max)
   ...
   rl.rlim_cur = limit;
  if (setrlimit(
# 65 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_open_limit.c" 3 4
               RLIMIT_NOFILE
# 65 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_open_limit.c"
                            , &rl) < 0) {
  ...
  rl.rlim_cur = rl.rlim_max;
  if (setrlimit(
# 76 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_open_limit.c" 3 4
               RLIMIT_NOFILE
# 76 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_open_limit.c"
                            , &rl) < 0) {
   acl_msg_warn("%s(%d): setrlimit error: %s,"
    " cur: %d, max: %d", myname, 78,
  ...
  return (int) rl.rlim_cur;
# 95 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_open_limit.c"
}
