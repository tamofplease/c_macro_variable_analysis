# 1 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_duplex_pipe.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_duplex_pipe.c" 2
# 12 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_duplex_pipe.c"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_sys_patch.h" 1
# 13 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_duplex_pipe.c" 2
# 21 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_duplex_pipe.c"
int acl_duplex_pipe(int fds[2])
{



 return (acl_sane_socketpair(
# 26 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_duplex_pipe.c" 3 4
                            1
# 26 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_duplex_pipe.c"
                                   , 
# 26 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_duplex_pipe.c" 3 4
                                     SOCK_STREAM
# 26 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_duplex_pipe.c"
