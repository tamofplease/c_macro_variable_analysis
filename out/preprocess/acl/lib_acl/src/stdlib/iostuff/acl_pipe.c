# 0 "/acl/lib_acl/src/stdlib/iostuff/acl_pipe.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/iostuff/acl_pipe.c"
...
# 2 "/acl/lib_acl/src/stdlib/iostuff/acl_pipe.c" 2
# 69 "/acl/lib_acl/src/stdlib/iostuff/acl_pipe.c"
int acl_pipe(int fds[2])
{
 return (pipe(fds));
}
