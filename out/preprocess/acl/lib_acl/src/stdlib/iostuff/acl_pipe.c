# 1 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_pipe.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_pipe.c" 2
# 69 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_pipe.c"
int acl_pipe(int fds[2])
{
 return (pipe(fds));
}
