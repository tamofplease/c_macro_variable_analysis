# 1 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c" 2
# 28 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c"
int acl_non_blocking(int fd, int on)
{
 int flags;

 int nonb = 
# 32 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c" 3 4
             04000
# 32 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c"
                    ;
# 64 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c"
 if ((flags = fcntl(fd, 
# 64 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c" 3 4
                       3
# 64 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c"
                              )) == -1) {
  acl_msg_error("%s(%d), %s: fcntl(%d, F_GETFL) error: %s",
   "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c", 66, __FUNCTION__,
   fd, acl_last_serror());
  return -1;
 }
 if (fcntl(fd, 
# 70 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c" 3 4
              4
# 70 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c"
                     , on ? flags | nonb : flags & ~nonb) < 0) {
  acl_msg_error("%s(%d), %s: fcntl(%d, F_SETL, nonb) error: %s",
   "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c", 72, __FUNCTION__,
   fd, acl_last_serror());
  return -1;
 }
# 85 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c"
 return flags;
}
...
int acl_is_blocking(int fd)
{
 ...
 int flags;
 if ((flags = fcntl(fd, 
# 92 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c" 3 4
                       3
# 92 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c"
                              , 0)) == -1) {
  acl_msg_error("fcntl(fd, F_GETFL) failed");
  return -1;
 }
 return (flags & 
# 96 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c" 3 4
                04000
# 96 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c"
                       ) == 0 ? 1 : 0;
