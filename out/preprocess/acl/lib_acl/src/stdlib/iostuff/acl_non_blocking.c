# 0 "/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c"
...
# 2 "/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c" 2
# 28 "/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c"
int acl_non_blocking(int fd, int on)
{
 int flags;

 int nonb = 
# 32 "/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c" 3 4
             04000
# 32 "/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c"
                    ;
# 64 "/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c"
 if ((flags = fcntl(fd, 
# 64 "/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c" 3 4
                       3
# 64 "/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c"
                              )) == -1) {
  acl_msg_error("%s(%d), %s: fcntl(%d, F_GETFL) error: %s",
   "/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c", 66, __FUNCTION__,
   fd, acl_last_serror());
  return -1;
 }
 if (fcntl(fd, 
# 70 "/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c" 3 4
              4
# 70 "/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c"
                     , on ? flags | nonb : flags & ~nonb) < 0) {
  acl_msg_error("%s(%d), %s: fcntl(%d, F_SETL, nonb) error: %s",
   "/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c", 72, __FUNCTION__,
   fd, acl_last_serror());
  return -1;
 }
# 85 "/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c"
 return flags;
}
...
int acl_is_blocking(int fd)
{
 ...
 int flags;
 if ((flags = fcntl(fd, 
# 92 "/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c" 3 4
                       3
# 92 "/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c"
                              , 0)) == -1) {
  acl_msg_error("fcntl(fd, F_GETFL) failed");
  return -1;
 }
 return (flags & 
# 96 "/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c" 3 4
                04000
# 96 "/acl/lib_acl/src/stdlib/iostuff/acl_non_blocking.c"
                       ) == 0 ? 1 : 0;
