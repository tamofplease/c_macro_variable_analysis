# 1 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_doze.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_doze.c" 2
# 30 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_doze.c"
void acl_doze(unsigned delay)
{
 ...
 while (select(0, (fd_set *) 0, (fd_set *) 0, (fd_set *) 0, &tv) < 0) {
  if (acl_last_error() != 
# 38 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_doze.c" 3 4
                         4
# 38 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_doze.c"
                                  ) {
   char tbuf[256];
