# 0 "/acl/lib_acl/src/stdlib/iostuff/acl_doze.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/iostuff/acl_doze.c"
...
# 2 "/acl/lib_acl/src/stdlib/iostuff/acl_doze.c" 2
# 30 "/acl/lib_acl/src/stdlib/iostuff/acl_doze.c"
void acl_doze(unsigned delay)
{
 ...
 while (select(0, (fd_set *) 0, (fd_set *) 0, (fd_set *) 0, &tv) < 0) {
  if (acl_last_error() != 
# 38 "/acl/lib_acl/src/stdlib/iostuff/acl_doze.c" 3 4
                         4
# 38 "/acl/lib_acl/src/stdlib/iostuff/acl_doze.c"
                                  ) {
   char tbuf[256];
