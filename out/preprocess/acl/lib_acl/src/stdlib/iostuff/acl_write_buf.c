# 0 "/acl/lib_acl/src/stdlib/iostuff/acl_write_buf.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/iostuff/acl_write_buf.c"
...
# 4 "/acl/lib_acl/src/stdlib/iostuff/acl_write_buf.c" 2
# 25 "/acl/lib_acl/src/stdlib/iostuff/acl_write_buf.c"
int acl_write_buf(int fd, const char *buf, int len, int timeout)
{
 int count;
...
# 32 "/acl/lib_acl/src/stdlib/iostuff/acl_write_buf.c" 3 4
                                            ((void *)0)
# 32 "/acl/lib_acl/src/stdlib/iostuff/acl_write_buf.c"
                                                , 
# 32 "/acl/lib_acl/src/stdlib/iostuff/acl_write_buf.c" 3 4
                                                  ((void *)0)
# 32 "/acl/lib_acl/src/stdlib/iostuff/acl_write_buf.c"
  ...
  if (count < 0) {
   if (acl_last_error() == 
# 34 "/acl/lib_acl/src/stdlib/iostuff/acl_write_buf.c" 3 4
                          11 
# 34 "/acl/lib_acl/src/stdlib/iostuff/acl_write_buf.c"
                                     && timeout > 0)
    continue;
   return -1;
  }
