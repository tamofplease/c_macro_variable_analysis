# 1 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_buf.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 4 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_buf.c" 2
# 25 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_buf.c"
int acl_write_buf(int fd, const char *buf, int len, int timeout)
{
 int count;
 ...
 while (len > 0) {
  if (timeout > 0 && acl_write_wait(fd, timeout) < 0)
   return -1;
  count = acl_socket_write(fd, buf, len, -1, 
# 32 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_buf.c" 3 4
                                            ((void *)0)
# 32 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_buf.c"
                                                , 
# 32 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_buf.c" 3 4
                                                  ((void *)0)
# 32 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_buf.c"
  ...
  if (count < 0) {
   if (acl_last_error() == 
# 34 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_buf.c" 3 4
                          11 
# 34 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_buf.c"
                                     && timeout > 0)
    continue;
   return -1;
  }
