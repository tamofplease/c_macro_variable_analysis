# 1 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 2
# 13 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c"
# 1 "/usr/include/poll.h" 1 3 4
# 14 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 2
...
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 22 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_mymalloc.h" 1
# 23 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_iostuff.h" 1
# 24 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 2
# 1 "/workspace/acl/lib_acl/src/stdlib/iostuff/../../init/init.h" 1



extern int __acl_var_use_poll;
# 25 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 2
...
int acl_write_wait_ms(int fd, int timeout)
{
 ...
 fds.events = 
# 48 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 3 4
             0x004
# 48 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c"
                    ;
 fds.revents = 0;
 fds.fd = fd;

 begin = time(
# 52 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 3 4
             ((void *)0)
# 52 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c"
                 );
 ...
 for (;;) {
  ...
  case -1:
   ...
   if (acl_last_error() == 
# 61 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 3 4
                          4
# 61 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c"
                                   ) {
    continue;
   }
   acl_msg_error("%s(%d), %s: poll error(%s), fd: %d",
    "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c", 65, myname,
    acl_last_serror(), (int) fd);
   return -1;
  case 0:
   if (timeout == 0) {
    acl_set_error(
# 70 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 3 4
                 11
# 70 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c"
                           );
   } else {
    acl_set_error(
# 72 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 3 4
                 110
# 72 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c"
                              );
   }
   end = time(
# 74 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 3 4
             ((void *)0)
# 74 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c"
                 );
   acl_msg_error("%s(%d), %s: poll return 0, delay=%d, "
    "fd=%d, cost=%ld", "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c", 76,
    myname, delay, fd, end - begin);
   return -1;
  default:
   if (fds.revents & 
# 80 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 3 4
                    0x020
# 80 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c"
                            ) {
    acl_msg_error("%s(%d), %s: %s, POLLNVAL, fd=%d",
     "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c", 82, myname,
     acl_last_serror(), (int) fd);
    acl_set_error(
# 84 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 3 4
                 22
# 84 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c"
                           );
    return -1;
   }

   if ((fds.revents & (
# 88 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 3 4
                      0x010 
# 88 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c"
                              | 
# 88 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 3 4
                                0x008
# 88 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c"
    ...
    acl_msg_error("%s(%d), %s: %s, %s, %s, fd=%d",
     "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c", 90, myname,
     acl_last_serror(),
     fds.revents & 
# 92 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 3 4
                  0x010 
# 92 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c"
                          ? "POLLHUP" : "0",
     fds.revents & 
# 93 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 3 4
                  0x008 
# 93 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c"
                          ? "POLLERR" : "0",
     fd);
    acl_set_error(
# 95 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 3 4
                 111
# 95 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c"
                                 );
    return -1;
   }

   if (fds.revents & 
# 99 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 3 4
                    0x004
# 99 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c"
                           ) {
    return 0;
   }
   ...
   acl_msg_warn("%s(%d), %s: %s, revents=%d, %d, %d, %d",
    "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c", 105, myname,
    acl_last_serror(), fds.revents,
    fds.revents & 
# 107 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 3 4
                 0x010
# 107 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c"
                        ,
    fds.revents& 
# 108 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 3 4
                0x008
# 108 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c"
                       ,
    fds.revents& 
# 109 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c" 3 4
                0x020
# 109 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c"
                        );
...
# 193 "/workspace/acl/lib_acl/src/stdlib/iostuff/acl_write_wait.c"
int acl_write_wait(int fd, int timeout)
{
