# 0 "/acl/lib_acl/src/stdlib/acl_mylog.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/acl_mylog.c"
...
# 2 "/acl/lib_acl/src/stdlib/acl_mylog.c" 2
# 55 "/acl/lib_acl/src/stdlib/acl_mylog.c"
# 1 "/acl/lib_acl/src/stdlib/../private/private_fifo.h" 1



# 1 "/acl/lib_acl/include/stdlib/acl_fifo.h" 1
# 5 "/acl/lib_acl/src/stdlib/../private/private_fifo.h" 2
# 1 "/acl/lib_acl/include/stdlib/acl_malloc.h" 1
# 6 "/acl/lib_acl/src/stdlib/../private/private_fifo.h" 2
...
# 56 "/acl/lib_acl/src/stdlib/acl_mylog.c" 2
# 1 "/acl/lib_acl/src/stdlib/../private/private_vstream.h" 1



# 1 "/acl/lib_acl/include/stdlib/acl_vstream.h" 1
# 5 "/acl/lib_acl/src/stdlib/../private/private_vstream.h" 2
...
# 57 "/acl/lib_acl/src/stdlib/acl_mylog.c" 2
# 1 "/acl/lib_acl/src/stdlib/../private/thread.h" 1
# 9 "/acl/lib_acl/src/stdlib/../private/thread.h"
# 1 "/acl/lib_acl/include/thread/acl_pthread.h" 1
# 10 "/acl/lib_acl/src/stdlib/../private/thread.h" 2


int thread_mutex_destroy(acl_pthread_mutex_t *mutex);
# 31 "/acl/lib_acl/src/stdlib/../private/thread.h"
acl_pthread_mutex_t *thread_mutex_create(void);
# 58 "/acl/lib_acl/src/stdlib/acl_mylog.c" 2
...
struct ACL_LOG {
 ...
 int type;
# 87 "/acl/lib_acl/src/stdlib/acl_mylog.c"
 acl_pthread_mutex_t *lock;
 char logpre[256];
...
# 102 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                            ((void *)0)
# 102 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                                ;
...
ACL_ARRAY *acl_log_get_streams(void)
{
 ...
 if (__loggers == 
# 111 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                 ((void *)0)
# 111 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ) {
  return 
# 112 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
        ((void *)0)
# 112 "/acl/lib_acl/src/stdlib/acl_mylog.c"
            ;
 }
...
void acl_log_free_streams(ACL_ARRAY *a)
{
 if (a) {
  acl_array_free(a, 
# 126 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                   ((void *)0)
# 126 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                       );
 }
}
...
# 146 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
((void) sizeof ((
# 146 "/acl/lib_acl/src/stdlib/acl_mylog.c"
lock
# 146 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
...
"lock"
# 146 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
, "/acl/lib_acl/src/stdlib/acl_mylog.c", 146, __extension__ __PRETTY_FUNCTION__); }))
# 146 "/acl/lib_acl/src/stdlib/acl_mylog.c"
            ;

 n1 = pthread_mutexattr_init(&attr);
# 158 "/acl/lib_acl/src/stdlib/acl_mylog.c"
 n2 = pthread_mutexattr_settype(&attr, PTHREAD_MUTEX_RECURSIVE_NP);

 pthread_mutex_init(lock, !n1 && !n2 ? &attr : 
# 160 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                                             ((void *)0)
# 160 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                                                 );
...
# 172 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
((void) sizeof ((
# 172 "/acl/lib_acl/src/stdlib/acl_mylog.c"
fp
# 172 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 172 "/acl/lib_acl/src/stdlib/acl_mylog.c"
...
"fp"
# 172 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
, "/acl/lib_acl/src/stdlib/acl_mylog.c", 172, __extension__ __PRETTY_FUNCTION__); }))
# 172 "/acl/lib_acl/src/stdlib/acl_mylog.c"
              ;

 if (__loggers == 
# 174 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                 ((void *)0)
# 174 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ) {
...
static int open_file_log(const char *filename, const char *logpre)
{
 ...
 int flag = 
# 219 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
             02 
# 219 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                    | 
# 219 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                      0100 
# 219 "/acl/lib_acl/src/stdlib/acl_mylog.c"
...
# 219 "/acl/lib_acl/src/stdlib/acl_mylog.c"
 ...
 int mode = 
# 224 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
             0400 
# 224 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                     | 
# 224 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                       0200
# 224 "/acl/lib_acl/src/stdlib/acl_mylog.c"
...
# 247 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                                02
# 247 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                                      );
...
# 262 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
((void) sizeof ((
# 262 "/acl/lib_acl/src/stdlib/acl_mylog.c"
log
# 262 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 262 "/acl/lib_acl/src/stdlib/acl_mylog.c"
...
"log"
# 262 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
, "/acl/lib_acl/src/stdlib/acl_mylog.c", 262, __extension__ __PRETTY_FUNCTION__); }))
# 262 "/acl/lib_acl/src/stdlib/acl_mylog.c"
               ;
 log->last_open = time(
# 263 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                      ((void *)0)
# 263 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                          );
 log->fp = fp;
...
{
 time_t now = time(
# 282 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                  ((void *)0)
# 282 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                      );
# 292 "/acl/lib_acl/src/stdlib/acl_mylog.c"
 if (log->lock) {
 ...
 if (!(log->flag & (1 << 0))
  ...
  || log->fp == 
# 299 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
               ((void *)0)
  
# 300 "/acl/lib_acl/src/stdlib/acl_mylog.c"
 || log->reopen_inter <= 0) {
 ...
 if (log->fp->path) {
  free(log->fp->path);
  log->fp->path = 
# 315 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                 ((void *)0)
# 315 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ;
 }
# 328 "/acl/lib_acl/src/stdlib/acl_mylog.c"
 private_vstream_close(log->fp);
 
# 329 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
((void) sizeof ((
# 329 "/acl/lib_acl/src/stdlib/acl_mylog.c"
log->path
# 329 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 329 "/acl/lib_acl/src/stdlib/acl_mylog.c"
...
"log->path"
# 329 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
, "/acl/lib_acl/src/stdlib/acl_mylog.c", 329, __extension__ __PRETTY_FUNCTION__); }))
# 329 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ;
 log->fp = private_vstream_connect(log->path, 60, 60);
 log->last_open = time(
# 331 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                      ((void *)0)
# 331 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                          );
 if (log->fp == 
# 332 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
               ((void *)0)
# 332 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                   ) {
  do { if (log->lock) { pthread_mutex_unlock(log->lock); } return (-1); } while (0);
 }
 log->flag &= ~(1 << 0);
 log->last_open = time(
# 336 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                      ((void *)0)
# 336 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                          );
...
static int open_stream_log(const char *addr, const char *logpre, int type)
{
 ...
 if (fp == 
# 357 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
          ((void *)0)
# 357 "/acl/lib_acl/src/stdlib/acl_mylog.c"
              ) {
 ...
 log = (ACL_LOG*) calloc(1, sizeof(ACL_LOG));
 log->last_open = time(
# 364 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                      ((void *)0)
# 364 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                          );
 log->reopen_inter = 60;
 log->fp = fp;
...
# 370 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                             ((void *)0)
# 370 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                                 );
 log->type = type;
 if (logpre && *logpre) {
  snprintf(log->logpre, sizeof(log->logpre), "%s", logpre);
...
# 402 "/acl/lib_acl/src/stdlib/acl_mylog.c"
...
static int open_udp_log(const char *addr, const char *logpre)
{
 ...
 ptr = strchr(ip, ':');
 if (ptr == 
# 441 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
           ((void *)0) 
# 441 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                || *(ptr + 1) == 0) {
 ...
 *ptr++ = 0;
 ...
 port = atoi(sport);
 if (sport == 
# 449 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
             ((void *)0)
# 449 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                 ) {
 ...
 hints.ai_family = 
# 464 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                    0
# 464 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                             ;
 hints.ai_socktype = 
# 465 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                    SOCK_DGRAM
# 465 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                              ;
# 476 "/acl/lib_acl/src/stdlib/acl_mylog.c"
 hints.ai_flags = 
# 476 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                    0x0008 
# 476 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                                | 
# 476 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
...
# 476 "/acl/lib_acl/src/stdlib/acl_mylog.c"
 ...
 if ((err = getaddrinfo(ip, sport, &hints, &res0))) {
  printf("%s(%d), %s: getaddrinfo error %s, peer=%s",
   "/acl/lib_acl/src/stdlib/acl_mylog.c", 481, myname, gai_strerror(err), ip);
  abort();
 }
 ...
 for (res = res0; res != 
# 487 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                        ((void *)0)
# 487 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                            ; res = res->ai_next) {
 ...
 if (fd == (int) -1 || res == 
# 497 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                                       ((void *)0)
# 497 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                                           ) {
  printf("%s(%d), %s: invalid socket, addr: %s\r\n",
   "/acl/lib_acl/src/stdlib/acl_mylog.c", 499, myname, addr);
  abort();
 }
...
# 505 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                                     02
# 505 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                                           , 1024, 0,
   (1 << 0));
 ...
 log->last_open = time(
# 513 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                      ((void *)0)
# 513 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                          );
 log->dest.sa.sa.sa_family = res->ai_family;

 if (res->ai_family == 
# 516 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                      2
# 516 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                             ) {
  log->dest.sa.in.sin_addr.s_addr = inet_addr(ip);
  log->dest.sa.in.sin_port = 
# 518 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                            __bswap_16 (
# 518 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                            port
# 518 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                            )
# 518 "/acl/lib_acl/src/stdlib/acl_mylog.c"
...
# 521 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                           10
# 521 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                                   ) {
  log->dest.sa.in6.sin6_port = 
# 522 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                              __bswap_16 (
# 522 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                              port
# 522 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                              )
# 522 "/acl/lib_acl/src/stdlib/acl_mylog.c"
  ...
  if (inet_pton(res->ai_family, ip,
   ...
   printf("%s(%d), %s: inet_pton error: %s, ip: %s\r\n",
    "/acl/lib_acl/src/stdlib/acl_mylog.c", 527, myname,
    acl_last_serror(), ip);
   abort();
  }
 }
  ...
  printf("%s(%d), %s: invalid sa_family: %d, ip: %s\r\n",
   "/acl/lib_acl/src/stdlib/acl_mylog.c", 535, myname, res->ai_family, ip);
  abort();
 }
 ...
 log->lock = (acl_pthread_mutex_t*)
  calloc(1, sizeof(acl_pthread_mutex_t));
 pthread_mutex_init(log->lock, 
# 544 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                             ((void *)0)
# 544 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                                 );
...
# 566 "/acl/lib_acl/src/stdlib/acl_mylog.c"
...
{
 if (__loggers != 
# 610 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                 ((void *)0)
# 610 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ) {
  ACL_ITER iter;
  for ((__loggers)->iter_head(&(iter), (__loggers)); (iter).ptr; (__loggers)->iter_next(&(iter), (__loggers))) {
   ACL_LOG *log = (ACL_LOG *) iter.data;
...
{
 if (__loggers != 
# 624 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                 ((void *)0)
# 624 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ) {
  ACL_ITER iter;
  for ((__loggers)->iter_head(&(iter), (__loggers)); (iter).ptr; (__loggers)->iter_next(&(iter), (__loggers))) {
   ACL_LOG *log = (ACL_LOG *) iter.data;
...
{
 if (__loggers != 
# 637 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                 ((void *)0)
# 637 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ) {
  ACL_ITER iter;
  for ((__loggers)->iter_head(&(iter), (__loggers)); (iter).ptr; (__loggers)->iter_next(&(iter), (__loggers))) {
   ACL_LOG *log = (ACL_LOG *) iter.data;
...
# 659 "/acl/lib_acl/src/stdlib/acl_mylog.c"
int acl_open_log(const char *recipients, const char *logpre)
{
 const char *myname = "acl_open_log";
 const char *ptr;
 ACL_ARGV *argv = 
# 663 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                 ((void *)0)
# 663 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ;
 ACL_ITER iter;

 if (recipients == 
# 666 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                  ((void *)0) 
# 666 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                       || *recipients == 0) {
  printf("%s(%d): recipients null\n", myname, 667);
  return -1;
 } else if (logpre == 
# 669 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                     ((void *)0) 
# 669 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                          || *logpre == 0) {
 ...
 if (__loggers == 
# 674 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                 ((void *)0)
# 674 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ) {
  __loggers = private_fifo_new();
 }
...
# 719 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
((void) sizeof ((
# 719 "/acl/lib_acl/src/stdlib/acl_mylog.c"
buf
# 719 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 719 "/acl/lib_acl/src/stdlib/acl_mylog.c"
...
"buf"
# 719 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
, "/acl/lib_acl/src/stdlib/acl_mylog.c", 719, __extension__ __PRETTY_FUNCTION__); }))
# 719 "/acl/lib_acl/src/stdlib/acl_mylog.c"
               ;
...
# 724 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
__builtin_va_copy(
# 724 "/acl/lib_acl/src/stdlib/acl_mylog.c"
ap_tmp
# 724 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
,
# 724 "/acl/lib_acl/src/stdlib/acl_mylog.c"
...
# 726 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
((void) sizeof ((
# 726 "/acl/lib_acl/src/stdlib/acl_mylog.c"
ret > 0
# 726 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 726 "/acl/lib_acl/src/stdlib/acl_mylog.c"
...
"ret > 0"
# 726 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
, "/acl/lib_acl/src/stdlib/acl_mylog.c", 726, __extension__ __PRETTY_FUNCTION__); }))
# 726 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                   ;
...
# 733 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 ((void) sizeof ((
# 733 "/acl/lib_acl/src/stdlib/acl_mylog.c"
 buf
# 733 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 733 "/acl/lib_acl/src/stdlib/acl_mylog.c"
...
# 733 "/acl/lib_acl/src/stdlib/acl_mylog.c"
 "buf"
# 733 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 , "/acl/lib_acl/src/stdlib/acl_mylog.c", 733, __extension__ __PRETTY_FUNCTION__); }))
# 733 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                ;
...
# 737 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 __builtin_va_copy(
# 737 "/acl/lib_acl/src/stdlib/acl_mylog.c"
 ap_tmp
# 737 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 ,
# 737 "/acl/lib_acl/src/stdlib/acl_mylog.c"
...
# 739 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 ((void) sizeof ((
# 739 "/acl/lib_acl/src/stdlib/acl_mylog.c"
...
# 739 "/acl/lib_acl/src/stdlib/acl_mylog.c"
 "ret > 0 && ret < (int) left_len"
# 739 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 , "/acl/lib_acl/src/stdlib/acl_mylog.c", 739, __extension__ __PRETTY_FUNCTION__); }))
# 739 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                                            ;
 }
...
# 750 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 ((void) sizeof ((
# 750 "/acl/lib_acl/src/stdlib/acl_mylog.c"
 buf
# 750 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 750 "/acl/lib_acl/src/stdlib/acl_mylog.c"
...
# 750 "/acl/lib_acl/src/stdlib/acl_mylog.c"
 "buf"
# 750 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 , "/acl/lib_acl/src/stdlib/acl_mylog.c", 750, __extension__ __PRETTY_FUNCTION__); }))
# 750 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                ;
 }
...
# 821 "/acl/lib_acl/src/stdlib/acl_mylog.c"
...
# 850 "/acl/lib_acl/src/stdlib/acl_mylog.c"
 } else {
 ...
 const char *fmt, va_list ap)
{
 ...
 if (__log_thread_id) {
  ...
  snprintf(tbuf, sizeof(tbuf), " %s (pid=%d, tid=%llu)(%s): ",
   ...
   (unsigned long long int) pthread_self(), info);
# 900 "/acl/lib_acl/src/stdlib/acl_mylog.c"
 } else {
 ...
 buf = get_buf(tbuf, fmt, ap, log->type == 3
  ? 
# 914 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
   ((void *)0) 
# 914 "/acl/lib_acl/src/stdlib/acl_mylog.c"
        : "\r\n", &len);
...
int acl_write_to_log2(const char *info, const char *fmt, va_list ap)
{
 ...
 if (__loggers == 
# 944 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                 ((void *)0)
# 944 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ) {
  return 0;
 }
...
# 956 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 __builtin_va_copy(
# 956 "/acl/lib_acl/src/stdlib/acl_mylog.c"
 tmp
# 956 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 ,
# 956 "/acl/lib_acl/src/stdlib/acl_mylog.c"
...
# 985 "/acl/lib_acl/src/stdlib/acl_mylog.c"
 return 0;
}
...
# 993 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
__builtin_va_start(
# 993 "/acl/lib_acl/src/stdlib/acl_mylog.c"
ap
# 993 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
,
# 993 "/acl/lib_acl/src/stdlib/acl_mylog.c"
...
# 995 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
__builtin_va_end(
# 995 "/acl/lib_acl/src/stdlib/acl_mylog.c"
ap
# 995 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
)
# 995 "/acl/lib_acl/src/stdlib/acl_mylog.c"
...
void acl_close_log()
{
 ...
 if (__loggers == 
# 1003 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                 ((void *)0)
# 1003 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ) {
  return;
 }
 ...
 while (1) {
  ...
  if (log == 
# 1009 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
            ((void *)0)
# 1009 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                ) {
   break;
  }
  ...
  if (log->fp) {
   if (log->fp->path) {
    free(log->fp->path);
    log->fp->path = 
# 1020 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                   ((void *)0)
# 1020 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                       ;
   }
# 1032 "/acl/lib_acl/src/stdlib/acl_mylog.c"
   private_vstream_close(log->fp);
  }
 ...
 free(__loggers);
 __loggers = 
# 1045 "/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
            ((void *)0)
# 1045 "/acl/lib_acl/src/stdlib/acl_mylog.c"
                ;
}
