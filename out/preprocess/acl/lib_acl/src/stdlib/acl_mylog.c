# 1 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 2
# 55 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
# 1 "/workspace/acl/lib_acl/src/stdlib/../private/private_fifo.h" 1



# 1 "/workspace/acl/lib_acl/include/stdlib/acl_fifo.h" 1
# 5 "/workspace/acl/lib_acl/src/stdlib/../private/private_fifo.h" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_malloc.h" 1
# 6 "/workspace/acl/lib_acl/src/stdlib/../private/private_fifo.h" 2
...
# 56 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 2
# 1 "/workspace/acl/lib_acl/src/stdlib/../private/private_vstream.h" 1



# 1 "/workspace/acl/lib_acl/include/stdlib/acl_vstream.h" 1
# 5 "/workspace/acl/lib_acl/src/stdlib/../private/private_vstream.h" 2
...
# 57 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 2
# 1 "/workspace/acl/lib_acl/src/stdlib/../private/thread.h" 1
# 9 "/workspace/acl/lib_acl/src/stdlib/../private/thread.h"
# 1 "/workspace/acl/lib_acl/include/thread/acl_pthread.h" 1
# 10 "/workspace/acl/lib_acl/src/stdlib/../private/thread.h" 2


int thread_mutex_destroy(acl_pthread_mutex_t *mutex);
# 31 "/workspace/acl/lib_acl/src/stdlib/../private/thread.h"
acl_pthread_mutex_t *thread_mutex_create(void);
# 58 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 2
...
struct ACL_LOG {
 ...
 int type;
# 87 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 acl_pthread_mutex_t *lock;
 char logpre[256];
...
static ACL_FIFO *__loggers = 
# 102 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                            ((void *)0)
# 102 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                                ;
...
ACL_ARRAY *acl_log_get_streams(void)
{
 ...
 if (__loggers == 
# 111 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                 ((void *)0)
# 111 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ) {
  return 
# 112 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
        ((void *)0)
# 112 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
            ;
 }

 a = acl_array_create(1);
 for ((__loggers)->iter_head(&(iter), (__loggers)); (iter).ptr; (__loggers)->iter_next(&(iter), (__loggers))) {
...
void acl_log_free_streams(ACL_ARRAY *a)
{
 if (a) {
  acl_array_free(a, 
# 126 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                   ((void *)0)
# 126 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                       );
 }
}
...
# 146 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
((void) sizeof ((
# 146 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
lock
# 146 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
...
"lock"
# 146 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c", 146, __extension__ __PRETTY_FUNCTION__); }))
# 146 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
            ;

 n1 = pthread_mutexattr_init(&attr);
# 158 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 n2 = pthread_mutexattr_settype(&attr, PTHREAD_MUTEX_RECURSIVE_NP);

 pthread_mutex_init(lock, !n1 && !n2 ? &attr : 
# 160 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                                             ((void *)0)
# 160 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                                                 );
...
# 172 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
((void) sizeof ((
# 172 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
fp
# 172 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 172 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
...
"fp"
# 172 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c", 172, __extension__ __PRETTY_FUNCTION__); }))
# 172 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
              ;

 if (__loggers == 
# 174 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                 ((void *)0)
# 174 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ) {
 ...
 for ((__loggers)->iter_head(&(iter), (__loggers)); (iter).ptr; (__loggers)->iter_next(&(iter), (__loggers))) {
  ...
  if (strcmp(log->path, ((fp)->path ? (fp)->path : "")) == 0) {
 ...
 if (__log_close_onexec) {
  acl_close_on_exec(((fp)->fd.sock), 1);
 }

 log = (ACL_LOG*) calloc(1, sizeof(ACL_LOG));
 log->fp = fp;
 log->path = strdup(((fp)->path ? (fp)->path : ""));
 log->type = 0;
...
static int open_file_log(const char *filename, const char *logpre)
{
 ...
 int flag = 
# 219 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
             02 
# 219 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                    | 
# 219 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                      0100 
# 219 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
...
# 219 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 ...
 int mode = 
# 224 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
             0400 
# 224 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                     | 
# 224 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                       0200
# 224 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 ...
 if (fh == (int) -1) {
  printf("%s(%d): open %s error(%s)", myname, 242,
   filename, acl_last_serror());
  return -1;
 }

 fp = private_vstream_fhopen(fh, 
# 247 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                                02
# 247 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                                      );
 ...
 if (__log_close_onexec) {
  acl_close_on_exec(fh, 1);
 }


 log = (ACL_LOG*) calloc(1, sizeof(ACL_LOG));
 
# 262 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
((void) sizeof ((
# 262 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
log
# 262 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 262 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
...
"log"
# 262 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c", 262, __extension__ __PRETTY_FUNCTION__); }))
# 262 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
               ;
 log->last_open = time(
# 263 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                      ((void *)0)
# 263 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                          );
 log->fp = fp;
...
{
 time_t now = time(
# 282 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                  ((void *)0)
# 282 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                      );
# 292 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 if (log->lock) {
 ...
 if (!(log->flag & (1 << 0))
  ...
  || log->fp == 
# 299 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
               ((void *)0)
  
# 300 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 || log->reopen_inter <= 0) {

  do { if (log->lock) { pthread_mutex_unlock(log->lock); } return (-1); } while (0);
 }
 ...
 if (log->fp->path) {
  free(log->fp->path);
  log->fp->path = 
# 315 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                 ((void *)0)
# 315 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ;
 }
# 328 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 private_vstream_close(log->fp);
 
# 329 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
((void) sizeof ((
# 329 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
log->path
# 329 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 329 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
...
"log->path"
# 329 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c", 329, __extension__ __PRETTY_FUNCTION__); }))
# 329 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ;
 log->fp = private_vstream_connect(log->path, 60, 60);
 log->last_open = time(
# 331 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                      ((void *)0)
# 331 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                          );
 if (log->fp == 
# 332 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
               ((void *)0)
# 332 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                   ) {
  do { if (log->lock) { pthread_mutex_unlock(log->lock); } return (-1); } while (0);
 }
 log->flag &= ~(1 << 0);
 log->last_open = time(
# 336 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                      ((void *)0)
# 336 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                          );
 do { if (log->lock) { pthread_mutex_unlock(log->lock); } return (0); } while (0);
}
...
static int open_stream_log(const char *addr, const char *logpre, int type)
{
 ...
 if (fp == 
# 357 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
          ((void *)0)
# 357 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
              ) {
  printf("%s(%d): connect %s error(%s)\n",
   myname, 359, addr, acl_last_serror());
  return -1;
 }

 log = (ACL_LOG*) calloc(1, sizeof(ACL_LOG));
 log->last_open = time(
# 364 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                      ((void *)0)
# 364 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                          );
 log->reopen_inter = 60;
 log->fp = fp;
 ...
 log->lock = (acl_pthread_mutex_t*)
  calloc(1, sizeof(acl_pthread_mutex_t));
 pthread_mutex_init(log->lock, 
# 370 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                             ((void *)0)
# 370 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                                 );
 log->type = type;
 if (logpre && *logpre) {
  snprintf(log->logpre, sizeof(log->logpre), "%s", logpre);
...
{
 return open_stream_log(addr, logpre, 2);
}

static int open_unix_log(const char *addr, const char *logpre)
{
 return open_stream_log(addr, logpre, 4);
}
# 402 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
static int udp_read(int fd, void *buf, size_t size,
 int timeout __attribute__ ((__unused__)), ACL_VSTREAM *fp __attribute__ ((__unused__)), void *arg)
{
 ...
 return (int) recvfrom(fd, buf, size, 0, sa, (socklen_t*) &log->from_len);

}

static int udp_write(int fd, const void *buf, size_t size,
 int timeout __attribute__ ((__unused__)), ACL_VSTREAM *fp __attribute__ ((__unused__)), void *arg)
{
 ACL_LOG *log = (ACL_LOG*) arg;
 ...
 return (int) sendto(fd, (const char*) buf, size, 0,
   sa, (socklen_t) sizeof(log->dest));
...
static int open_udp_log(const char *addr, const char *logpre)
{
 ...
 ptr = strchr(ip, ':');
 if (ptr == 
# 441 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
           ((void *)0) 
# 441 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                || *(ptr + 1) == 0) {
 ...
 *ptr++ = 0;
 ...
 port = atoi(sport);
 if (sport == 
# 449 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
             ((void *)0)
# 449 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                 ) {
 ...
 for ((__loggers)->iter_head(&(iter), (__loggers)); (iter).ptr; (__loggers)->iter_next(&(iter), (__loggers))) {
  log = (ACL_LOG*) iter.data;
  if (!strcmp(log->path, addr) && log->type == 3) {
   acl_msg_warn("%s(%d): log(%s) has been opened!",
    myname, 458, addr);
   return 0;
  }
 ...
 hints.ai_family = 
# 464 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                    0
# 464 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                             ;
 hints.ai_socktype = 
# 465 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                    SOCK_DGRAM
# 465 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                              ;
# 476 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 hints.ai_flags = 
# 476 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                    0x0008 
# 476 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                                | 
# 476 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
...
# 476 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 ...
 if ((err = getaddrinfo(ip, sport, &hints, &res0))) {
  printf("%s(%d), %s: getaddrinfo error %s, peer=%s",
   "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c", 481, myname, gai_strerror(err), ip);
  abort();
 }
 ...
 for (res = res0; res != 
# 487 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                        ((void *)0)
# 487 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                            ; res = res->ai_next) {
 ...
 if (fd == (int) -1 || res == 
# 497 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                                       ((void *)0)
# 497 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                                           ) {
  printf("%s(%d), %s: invalid socket, addr: %s\r\n",
   "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c", 499, myname, addr);
  abort();
 }

 log = (ACL_LOG*) calloc(1, sizeof(ACL_LOG));

 log->fp = private_vstream_fdopen(fd, 
# 505 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                                     02
# 505 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                                           , 1024, 0,
   (1 << 0));
 ...
 log->last_open = time(
# 513 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                      ((void *)0)
# 513 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                          );
 log->dest.sa.sa.sa_family = res->ai_family;

 if (res->ai_family == 
# 516 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                      2
# 516 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                             ) {
  log->dest.sa.in.sin_addr.s_addr = inet_addr(ip);
  log->dest.sa.in.sin_port = 
# 518 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                            (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 518 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                            port
# 518 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
...
# 518 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 ...
 else if (res->ai_family == 
# 521 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                           10
# 521 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                                   ) {
  log->dest.sa.in6.sin6_port = 
# 522 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                              (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 522 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                              port
# 522 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                              ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 522 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
  ...
  if (inet_pton(res->ai_family, ip,
   ...
   printf("%s(%d), %s: inet_pton error: %s, ip: %s\r\n",
    "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c", 527, myname,
    acl_last_serror(), ip);
   abort();
  }
 }
  ...
  printf("%s(%d), %s: invalid sa_family: %d, ip: %s\r\n",
   "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c", 535, myname, res->ai_family, ip);
  abort();
 }
 ...
 log->lock = (acl_pthread_mutex_t*)
  calloc(1, sizeof(acl_pthread_mutex_t));
 pthread_mutex_init(log->lock, 
# 544 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                             ((void *)0)
# 544 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                                 );
...
# 566 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
...
{
 if (__loggers != 
# 610 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                 ((void *)0)
# 610 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ) {
  ACL_ITER iter;
  for ((__loggers)->iter_head(&(iter), (__loggers)); (iter).ptr; (__loggers)->iter_next(&(iter), (__loggers))) {
   ACL_LOG *log = (ACL_LOG *) iter.data;
...
{
 if (__loggers != 
# 624 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                 ((void *)0)
# 624 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ) {
  ACL_ITER iter;
  for ((__loggers)->iter_head(&(iter), (__loggers)); (iter).ptr; (__loggers)->iter_next(&(iter), (__loggers))) {
   ACL_LOG *log = (ACL_LOG *) iter.data;
...
{
 if (__loggers != 
# 637 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                 ((void *)0)
# 637 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ) {
  ACL_ITER iter;
  for ((__loggers)->iter_head(&(iter), (__loggers)); (iter).ptr; (__loggers)->iter_next(&(iter), (__loggers))) {
   ACL_LOG *log = (ACL_LOG *) iter.data;
...
# 659 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
int acl_open_log(const char *recipients, const char *logpre)
{
 const char *myname = "acl_open_log";
 const char *ptr;
 ACL_ARGV *argv = 
# 663 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                 ((void *)0)
# 663 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ;
 ACL_ITER iter;

 if (recipients == 
# 666 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                  ((void *)0) 
# 666 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                       || *recipients == 0) {
  printf("%s(%d): recipients null\n", myname, 667);
  return -1;
 } else if (logpre == 
# 669 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                     ((void *)0) 
# 669 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                          || *logpre == 0) {
 ...
 if (__loggers == 
# 674 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                 ((void *)0)
# 674 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ) {
  __loggers = private_fifo_new();
 }
...
# 719 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
((void) sizeof ((
# 719 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
buf
# 719 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 719 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
...
"buf"
# 719 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c", 719, __extension__ __PRETTY_FUNCTION__); }))
# 719 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
               ;
...
# 724 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
__builtin_va_copy(
# 724 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
ap_tmp
# 724 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
,
# 724 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
...
# 726 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
((void) sizeof ((
# 726 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
ret > 0
# 726 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 726 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
...
"ret > 0"
# 726 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c", 726, __extension__ __PRETTY_FUNCTION__); }))
# 726 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                   ;
...
# 733 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 ((void) sizeof ((
# 733 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 buf
# 733 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 733 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
...
# 733 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 "buf"
# 733 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 , "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c", 733, __extension__ __PRETTY_FUNCTION__); }))
# 733 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                ;
...
# 737 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 __builtin_va_copy(
# 737 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 ap_tmp
# 737 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 ,
# 737 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
...
# 739 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 ((void) sizeof ((
# 739 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 ret > 0 && ret < (int) left_len
# 739 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 739 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 ret > 0 && ret < (int) left_len
...
# 739 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 "ret > 0 && ret < (int) left_len"
# 739 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 , "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c", 739, __extension__ __PRETTY_FUNCTION__); }))
# 739 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                                            ;
 }
...
# 750 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 ((void) sizeof ((
# 750 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 buf
# 750 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 750 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
...
# 750 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 "buf"
# 750 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 , "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c", 750, __extension__ __PRETTY_FUNCTION__); }))
# 750 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                ;
 }
...
# 821 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
...
# 850 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 } else {
 ...
 if (private_vstream_writen(log->fp, buf, len) == (-1)) {
  log->flag |= (1 << 0);
 } else {
  log->count++;
 }
 ...
 const char *fmt, va_list ap)
{
 ...
 if (__log_thread_id) {
  ...
  snprintf(tbuf, sizeof(tbuf), " %s (pid=%d, tid=%llu)(%s): ",
   ...
   (unsigned long long int) pthread_self(), info);
# 900 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 } else {
 ...
 buf = get_buf(tbuf, fmt, ap, log->type == 3
  ? 
# 914 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
   ((void *)0) 
# 914 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
        : "\r\n", &len);

 if (log->lock && log->type != 3) {
  pthread_mutex_lock(log->lock);
 }
 ...
 if (log->type == 3) {
  ...
  log->count++;
 } else if (private_vstream_writen(log->fp, buf, len) == (-1)) {
  log->flag |= (1 << 0);
 } else {
  log->count++;
 }
...
int acl_write_to_log2(const char *info, const char *fmt, va_list ap)
{
 ...
 if (__loggers == 
# 944 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                 ((void *)0)
# 944 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ) {
  return 0;
 }
...
# 956 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 __builtin_va_copy(
# 956 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 tmp
# 956 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
 ,
# 956 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
...
# 985 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
 return 0;
}
...
# 993 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
__builtin_va_start(
# 993 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
ap
# 993 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
,
# 993 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
...
# 995 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
__builtin_va_end(
# 995 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
ap
# 995 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
)
# 995 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
...
void acl_close_log()
{
 ...
 if (__loggers == 
# 1003 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                 ((void *)0)
# 1003 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                     ) {
  return;
 }
 ...
 while (1) {
  ...
  if (log == 
# 1009 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
            ((void *)0)
# 1009 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                ) {
   break;
  }
  ...
  if (log->fp) {
   if (log->fp->path) {
    free(log->fp->path);
    log->fp->path = 
# 1020 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
                   ((void *)0)
# 1020 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                       ;
   }
# 1032 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
   private_vstream_close(log->fp);
  }
 ...
 free(__loggers);
 __loggers = 
# 1045 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c" 3 4
            ((void *)0)
# 1045 "/workspace/acl/lib_acl/src/stdlib/acl_mylog.c"
                ;
}
