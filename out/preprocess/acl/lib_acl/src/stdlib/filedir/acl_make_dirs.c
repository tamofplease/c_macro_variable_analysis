# 0 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
...
# 2 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 2
# 23 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
# 1 "/acl/lib_acl/src/stdlib/filedir/dir_sys_patch.h" 1
# 24 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 2
...
int acl_make_dirs(const char *path, int perms)
{
 ...
 cp = (unsigned char *) (saved_path = acl_strdup_glue("/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c", 43, (path)));
 ...
 for (;;) {
  ...
  if ((ret = stat(saved_path, &st)) >= 0) {
   if (!
# 58 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 3 4
       ((((
# 58 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
       st.st_mode
# 58 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 3 4
       )) & 0170000) == (0040000))
# 58 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
    ...
    acl_set_error(
# 59 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 3 4
                 20
# 59 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
                        );
    ret = -1;
    break;
   }
   ...
   if (acl_last_error() != 
# 67 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 3 4
                          2
# 67 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
                                )
    break;
# 95 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
   if ((ret = mkdir(saved_path, perms)) < 0) {
    if (acl_last_error() != 
# 96 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 3 4
                           17
# 96 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
                                 )
     break;
    ...
    if ((ret = stat(saved_path, &st)) < 0)
     break;
    if (!
# 101 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 3 4
        ((((
# 101 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
        st.st_mode
# 101 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 3 4
        )) & 0170000) == (0040000))
# 101 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
     ...
     acl_set_error(
# 102 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 3 4
                  20
# 102 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
                         );
     ret = -1;
     break;
    }
 ...
 do { if (saved_path) { acl_free_glue("/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c", 118, (saved_path)); (saved_path) = 
# 118 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 3 4
((void *)0)
# 118 "/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
; } } while (0);
 return (ret);
}
