# 1 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 2
# 23 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
# 1 "/workspace/acl/lib_acl/src/stdlib/filedir/dir_sys_patch.h" 1
# 24 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 2
...
int acl_make_dirs(const char *path, int perms)
{
 ...
 cp = (unsigned char *) (saved_path = acl_strdup_glue("/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c", 43, (path)));
 ...
 for (;;) {
  ...
  if ((ret = stat(saved_path, &st)) >= 0) {
   if (!
# 58 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 3 4
       ((((
# 58 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
       st.st_mode
# 58 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 3 4
       )) & 0170000) == (0040000))
# 58 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
    ...
    acl_set_error(
# 59 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 3 4
                 20
# 59 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
                        );
    ret = -1;
    break;
   }
   ...
   if (acl_last_error() != 
# 67 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 3 4
                          2
# 67 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
                                )
    break;
# 95 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
   if ((ret = mkdir(saved_path, perms)) < 0) {
    if (acl_last_error() != 
# 96 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 3 4
                           17
# 96 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
                                 )
     break;
    ...
    if ((ret = stat(saved_path, &st)) < 0)
     break;
    if (!
# 101 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 3 4
        ((((
# 101 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
        st.st_mode
# 101 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 3 4
        )) & 0170000) == (0040000))
# 101 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
     ...
     acl_set_error(
# 102 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 3 4
                  20
# 102 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
                         );
     ret = -1;
     break;
    }
 ...
 do { if (saved_path) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c", 118, (saved_path)); (saved_path) = 
# 118 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c" 3 4
((void *)0)
# 118 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_make_dirs.c"
; } } while (0);
 return (ret);
}
