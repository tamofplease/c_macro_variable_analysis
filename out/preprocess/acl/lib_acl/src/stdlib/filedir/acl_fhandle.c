# 1 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 2
# 26 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
extern int pthread_mutexattr_settype (pthread_mutexattr_t *__attr, int __kind);
...
static ACL_HTABLE *__fhandle_table = 
# 37 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                                    ((void *)0)
# 37 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
                                        ;
static acl_pthread_mutex_t __fhandle_mutex;
# 64 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
static ACL_FHANDLE *__fhandle_alloc(size_t size, unsigned int oflags)
{
 ...
 if (size < sizeof(ACL_FHANDLE))
  acl_msg_fatal("%s(%d): size(%d) < ACL_FHANDLE's size(%d)",
   myname, 71, (int) size, (int) sizeof(ACL_FHANDLE));

 fs = (ACL_FHANDLE *) acl_calloc_glue("/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c", 73, 1, size);
 fs->tid = pthread_self();
 fs->size = size;
 fs->oflags = oflags;
...
{
 if (fs->fp)
  acl_vstream_close(fs->fp);
 if ((fs->oflags & (1 << 1)) != 0)
  pthread_mutex_destroy(&fs->mutex);
 do { if (fs) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c", 105, (fs)); (fs) = 
# 105 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
((void *)0)
# 105 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
; } } while (0);
}
 ...
 void (*on_close)(ACL_FHANDLE*))
{
 ...
 char *ptr;
 ACL_FHANDLE *fs;
 unsigned int fopen_flags = 
# 118 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                           02 
# 118 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
                                  | 
# 118 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                                    0100
# 118 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
 ...
 do { int __ret; if ((__flags & (1 << 0) ) != 0 && (__ret = acl_thread_mutex_lock((&__fhandle_mutex))) != 0) acl_msg_fatal("%s: lock fs error(%d)", myname, __ret); } while (0);
 ...
 if (fs) {
  ...
  do { int __ret; if ((__flags & (1 << 0) ) != 0 && (__ret = acl_thread_mutex_unlock((&__fhandle_mutex))) != 0) acl_msg_fatal("%s: unlock fs error(%d)", myname, __ret); } while (0);
...
# 169 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
 fs->fp = acl_vstream_fopen(file_path, fopen_flags, 0600, 4096);
 if (fs->fp == 
# 170 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
              ((void *)0)
# 170 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
                  ) {
  do { int __ret; if ((__flags & (1 << 0) ) != 0 && (__ret = acl_thread_mutex_unlock((&__fhandle_mutex))) != 0) acl_msg_fatal("%s: unlock fs error(%d)", myname, __ret); } while (0);
  acl_msg_error("%s(%d): fopen %s error(%s)", myname, 172,
   file_path, acl_last_serror());
  __fhandle_free(fs);
  return (
# 175 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
         ((void *)0)
# 175 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
             );
 }
 ...
 if (fs->fsize == -1) {
  ...
  acl_msg_error("%s(%d): get %s size error(%s)",
   myname, 182, ((fs->fp)->path ? (fs->fp)->path : ""), acl_last_serror());
  __fhandle_free(fs);
  return (
# 184 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
         ((void *)0)
# 184 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
             );
 } else if (on_open) {

  if (on_open(fs, open_arg) < 0) {
   acl_msg_warn("%s(%d): on_create return < 0 for %s",
    myname, 189, ((fs->fp)->path ? (fs->fp)->path : ""));
   do { int __ret; if ((__flags & (1 << 0) ) != 0 && (__ret = acl_thread_mutex_unlock((&__fhandle_mutex))) != 0) acl_msg_fatal("%s: unlock fs error(%d)", myname, __ret); } while (0);
   __fhandle_free(fs);
   return (
# 192 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
          ((void *)0)
# 192 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
              );
  }
 }

 if (acl_htable_enter(__fhandle_table, file_path, fs) == 
# 196 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                                                        ((void *)0)
# 196 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
                                                            )
  acl_msg_fatal("%s(%d): add fpath(%s) to htable error(%s)",
   myname, 198, ((fs->fp)->path ? (fs->fp)->path : ""), acl_last_serror());
 fs->nrefer++;
...
static void __fhandle_close(ACL_FHANDLE *fs)
{
 ...
 acl_ring_detach(&fs->ring);
 (void) acl_htable_delete(__fhandle_table, ((fs->fp)->path ? (fs->fp)->path : ""), 
# 223 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                                                        ((void *)0)
# 223 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
                                                            );
...
void acl_fhandle_close(ACL_FHANDLE *fs, int delay_timeout)
{
 ...
 if (fs->nrefer == 0) {
  ...
  fs->when_free = time(
# 249 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                      ((void *)0)
# 249 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
                          ) + delay_timeout;
  ...
  for ((ring_iter).ptr = (((&__fhandle_free_list))->pred); (ring_iter).ptr != (&__fhandle_free_list); (ring_iter).ptr = (((ring_iter).ptr)->pred)) {
   fhandle_iter = ((ACL_FHANDLE *) (((char *) (ring_iter.ptr)) - 
# 258 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                 __builtin_offsetof (
# 258 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
                 ACL_FHANDLE
# 258 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                 , 
# 258 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
...
# 258 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
  ...
  if ((fs->status & (1 << 1)) != 0)
   acl_fhandle_unlock(fs);
# 285 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
  if (acl_ring_size(&__fhandle_free_list) > __cache_max_size) {

   iter = acl_ring_pop_head(&__fhandle_free_list);
   fs = ((ACL_FHANDLE *) (((char *) (iter)) - 
# 288 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
       __builtin_offsetof (
# 288 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
       ACL_FHANDLE
# 288 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
       , 
# 288 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
...
# 288 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
 ...
 (void) time(&now);
        ...
        for (iter = ((&__fhandle_free_list)->succ); iter != &__fhandle_free_list;) {
  fs = ((ACL_FHANDLE *) (((char *) (iter)) - 
# 305 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
      __builtin_offsetof (
# 305 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
      ACL_FHANDLE
# 305 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
      , 
# 305 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
...
# 305 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
  ...
  if (fs->nrefer > 0) {
   acl_msg_warn("%s: fs(%s)'s nrefer(%d) > 0, which in free list",
    myname, ((fs->fp)->path ? (fs->fp)->path : ""), fs->nrefer);
   iter = ((iter)->succ);
   continue;
  }
  iter_next = ((iter)->succ);
  if (fs->nrefer == 0) {
   !acl_do_debug((__debug_section), (2)) ? (void) 0 : acl_msg_info
    ("%s: fpath: %s, when_free: %ld, now: %ld",
    myname, ((fs->fp)->path ? (fs->fp)->path : ""), fs->when_free, now);
   __fhandle_close(fs);
  }
  iter = iter_next;
 }
...
void acl_fhandle_lock(ACL_FHANDLE *fs)
{
 ...
 acl_pthread_t tid = pthread_self();


 if ((fs->oflags & (1 << 1)) == 0) {
  acl_msg_error("%s(%d): ACL_FHANDLE_O_MLOCK not set", myname, 337);
  return;
 }

 acl_thread_mutex_lock((&fs->mutex));
 fs->status |= (1 << 1);
 ...
 if ((fs->oflags & (1 << 0))
  && (fs->status & (1 << 0)) == 0)
 {
  if (acl_myflock(((fs->fp)->fd.h_file),
   2, 2) == -1)
  {
   acl_msg_fatal("%s: lock file(%s) error(%s)",
    myname, ((fs->fp)->path ? (fs->fp)->path : ""), acl_last_serror());
  }
  fs->status |= (1 << 0);
 }
}
...
void acl_fhandle_unlock(ACL_FHANDLE *fs)
{
 ...
 if (fs->lock_mutex_tid != pthread_self()) {
  acl_msg_warn("%s(%d): thread not locked mutex for %s",
   myname, 370, ((fs->fp)->path ? (fs->fp)->path : ""));
  return;
 } else if ((fs->status & (1 << 1)) == 0) {
  acl_msg_warn("%s(%d): thread not locked mutex for %s",
   myname, 374, ((fs->fp)->path ? (fs->fp)->path : ""));
  return;
 }
 ...
 if (acl_thread_mutex_unlock((&fs->mutex)) != 0)
...
void acl_fhandle_init(int cache_size, int debug_section, unsigned int flags)
{
 ...
 if (__fhandle_table != 
# 409 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                       ((void *)0)
# 409 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
                           ) {
  acl_msg_warn("%s(%d): __fhandle_table not null", myname, 410);
  return;
 }
...
static void __fhandle_close2(ACL_FHANDLE *fs)
{
 ...
 if (fs->nrefer != 0)
  acl_msg_warn("%s: nrefer: %d != 0, name: %s",
   myname, fs->nrefer, ((((fs)->fp)->path ? ((fs)->fp)->path : "")));
 ...
 if ((fs->status & (1 << 1)) != 0) {
  acl_msg_warn("%s: fpath: %s, mutex not release yet",
   myname, ((fs->fp)->path ? (fs->fp)->path : ""));
  acl_thread_mutex_unlock((&fs->mutex));
 }
 fs->status &= ~(1 << 1);
...
void acl_fhandle_end()
{
 ...
 acl_msg_info("%s(%d): close all ACL_FHANDLE now", myname, 469);

 if (__fhandle_table == 
# 471 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                       ((void *)0)
# 471 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
                           ) {
  acl_msg_warn("%s(%d): __fhandle_table null", myname, 472);
  return;
 }
 acl_htable_free(__fhandle_table, (void (*)(void*)) __fhandle_close2);
 pthread_mutex_destroy(&__fhandle_mutex);
 __fhandle_table = 
# 477 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                  ((void *)0)
# 477 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
                      ;
}
