# 0 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
...
# 2 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 2
# 26 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
extern int pthread_mutexattr_settype (pthread_mutexattr_t *__attr, int __kind);
...
# 37 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                                    ((void *)0)
# 37 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
                                        ;
static acl_pthread_mutex_t __fhandle_mutex;
# 64 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
static ACL_FHANDLE *__fhandle_alloc(size_t size, unsigned int oflags)
{
 ...
 fs = (ACL_FHANDLE *) acl_calloc_glue("/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c", 73, 1, size);
 fs->tid = pthread_self();
 fs->size = size;
 fs->oflags = oflags;
...
static void __fhandle_free(ACL_FHANDLE *fs)
{
 ...
 do { if (fs) { acl_free_glue("/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c", 105, (fs)); (fs) = 
# 105 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
((void *)0)
# 105 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
; } } while (0);
}
...
# 118 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                           02 
# 118 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
                                  | 
# 118 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                                    0100
# 118 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
...
# 169 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
 fs->fp = acl_vstream_fopen(file_path, fopen_flags, 0600, 4096);
 if (fs->fp == 
# 170 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
              ((void *)0)
# 170 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
                  ) {
  do { int __ret; if ((__flags & (1 << 0) ) != 0 && (__ret = acl_thread_mutex_unlock((&__fhandle_mutex))) != 0) acl_msg_fatal("%s: unlock fs error(%d)", myname, __ret); } while (0);
  ...
  __fhandle_free(fs);
  return (
# 175 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
         ((void *)0)
# 175 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
             );
 }
 ...
 if (fs->fsize == -1) {
  ...
  __fhandle_free(fs);
  return (
# 184 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
         ((void *)0)
# 184 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
             );
 } else if (on_open) {
  ...
  if (on_open(fs, open_arg) < 0) {
   ...
   __fhandle_free(fs);
   return (
# 192 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
          ((void *)0)
# 192 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
              );
  }
 }

 if (acl_htable_enter(__fhandle_table, file_path, fs) == 
# 196 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                                                        ((void *)0)
# 196 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
                                                            )
...
# 223 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                                                        ((void *)0)
# 223 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
                                                            );
...
void acl_fhandle_close(ACL_FHANDLE *fs, int delay_timeout)
{
 ...
 if (fs->nrefer == 0) {
  ...
  fs->when_free = time(
# 249 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                      ((void *)0)
# 249 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
                          ) + delay_timeout;
...
# 258 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                 __builtin_offsetof (
# 258 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
                 ACL_FHANDLE
# 258 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                 , 
# 258 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
...
# 258 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
  ...
  if ((fs->status & (1 << 1)) != 0)
   acl_fhandle_unlock(fs);
# 285 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
  if (acl_ring_size(&__fhandle_free_list) > __cache_max_size) {

   iter = acl_ring_pop_head(&__fhandle_free_list);
   fs = ((ACL_FHANDLE *) (((char *) (iter)) - 
# 288 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
       __builtin_offsetof (
# 288 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
       ACL_FHANDLE
# 288 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
       , 
# 288 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
...
# 288 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
 ...
 (void) time(&now);
  ...
  fs = ((ACL_FHANDLE *) (((char *) (iter)) - 
# 305 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
      __builtin_offsetof (
# 305 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
      ACL_FHANDLE
# 305 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
      , 
# 305 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
...
void acl_fhandle_init(int cache_size, int debug_section, unsigned int flags)
{
 ...
 if (__fhandle_table != 
# 409 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                       ((void *)0)
# 409 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
                           ) {
...
void acl_fhandle_end()
{
 ...
 if (__fhandle_table == 
# 471 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                       ((void *)0)
# 471 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
                           ) {
 ...
 __fhandle_table = 
# 477 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c" 3 4
                  ((void *)0)
# 477 "/acl/lib_acl/src/stdlib/filedir/acl_fhandle.c"
                      ;
}
