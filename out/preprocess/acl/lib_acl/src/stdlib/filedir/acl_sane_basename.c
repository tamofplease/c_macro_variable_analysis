# 0 "/acl/lib_acl/src/stdlib/filedir/acl_sane_basename.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/filedir/acl_sane_basename.c"
...
# 2 "/acl/lib_acl/src/stdlib/filedir/acl_sane_basename.c" 2
# 19 "/acl/lib_acl/src/stdlib/filedir/acl_sane_basename.c"
char *acl_sane_basename(ACL_VSTRING *bp, const char *path)
{
 ...
 if (bp == 0) {
  ...
  return (
# 30 "/acl/lib_acl/src/stdlib/filedir/acl_sane_basename.c" 3 4
         ((void *)0)
# 30 "/acl/lib_acl/src/stdlib/filedir/acl_sane_basename.c"
             );
 }
...
char *acl_sane_dirname(ACL_VSTRING *bp, const char *path)
{
 ...
 if (bp == 0) {
  ...
  return (
# 80 "/acl/lib_acl/src/stdlib/filedir/acl_sane_basename.c" 3 4
         ((void *)0)
# 80 "/acl/lib_acl/src/stdlib/filedir/acl_sane_basename.c"
             );
 }
