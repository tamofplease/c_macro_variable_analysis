# 1 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_sane_basename.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_sane_basename.c" 2
# 19 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_sane_basename.c"
char *acl_sane_basename(ACL_VSTRING *bp, const char *path)
{
 ...
 if (bp == 0) {
  acl_msg_error("%s(%d): bp null", myname, 29);
  return (
# 30 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_sane_basename.c" 3 4
         ((void *)0)
# 30 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_sane_basename.c"
             );
 }
 ...
 if (path == 0 || *path == 0)
  return (((char *) (acl_vstring_strcpy(bp, "."))->vbuf.data));
 ...
 return (((char *) (acl_vstring_strncpy(bp, first + 1, last - first))->vbuf.data));
}
...
char *acl_sane_dirname(ACL_VSTRING *bp, const char *path)
{
 ...
 if (bp == 0) {
  acl_msg_error("%s(%d): bp null", myname, 79);
  return (
# 80 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_sane_basename.c" 3 4
         ((void *)0)
# 80 "/workspace/acl/lib_acl/src/stdlib/filedir/acl_sane_basename.c"
             );
 }
 ...
 return (((char *) (acl_vstring_strncpy(bp, path, last - path + 1))->vbuf.data));
}
