# 0 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
...
# 2 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 2
# 13 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
const char *acl_split_nameval(char *buf, char **name, char **value)
{
 char *np;
 char *vp;
 char *cp;
 char *ep;
# 32 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
 for (np = buf; *np && (
# 32 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
((*__ctype_b_loc ())[(int) ((
# 32 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
((unsigned char)(*np))
# 32 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
...
# 32 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
 ...
 for (ep = np; *ep && (!
# 35 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
((*__ctype_b_loc ())[(int) ((
# 35 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
((unsigned char)(*ep))
# 35 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
))] & (unsigned short int) _ISspace) 
# 35 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
&& *ep != '='); ep++) {};
 for (cp = ep; *cp && (
# 36 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
((*__ctype_b_loc ())[(int) ((
# 36 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
((unsigned char)(*cp))
# 36 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
))] & (unsigned short int) _ISspace)
# 36 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
 ...
 *ep = 0;
 cp++;
 for (vp = cp; *vp && (
# 41 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
((*__ctype_b_loc ())[(int) ((
# 41 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
((unsigned char)(*vp))
# 41 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
))] & (unsigned short int) _ISspace)
# 41 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
...
# 42 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
((*__ctype_b_loc ())[(int) ((
# 42 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
((unsigned char)(p[-1]))
# 42 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
))] & (unsigned short int) _ISspace)
# 42 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
 ...
 *value = vp;
 return (
# 45 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
        ((void *)0)
# 45 "/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
            );
}
