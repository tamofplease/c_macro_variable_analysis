# 1 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 2
# 13 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
const char *acl_split_nameval(char *buf, char **name, char **value)
{
 char *np;
 char *vp;
 char *cp;
 char *ep;
# 32 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
 for (np = buf; *np && (
# 32 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
((*__ctype_b_loc ())[(int) ((
# 32 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
((unsigned char)(*np))
# 32 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
...
# 32 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
 ...
 for (ep = np; *ep && (!
# 35 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
((*__ctype_b_loc ())[(int) ((
# 35 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
((unsigned char)(*ep))
# 35 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
))] & (unsigned short int) _ISspace) 
# 35 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
&& *ep != '='); ep++) {};
 for (cp = ep; *cp && (
# 36 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
((*__ctype_b_loc ())[(int) ((
# 36 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
((unsigned char)(*cp))
# 36 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
))] & (unsigned short int) _ISspace)
# 36 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
 ...
 *ep = 0;
 cp++;
 for (vp = cp; *vp && (
# 41 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
((*__ctype_b_loc ())[(int) ((
# 41 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
((unsigned char)(*vp))
# 41 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
))] & (unsigned short int) _ISspace)
# 41 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
); vp++) {};
 { char *p; for (p = (vp) + strlen(vp); p > (vp) && 
# 42 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
((*__ctype_b_loc ())[(int) ((
# 42 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
((unsigned char)(p[-1]))
# 42 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
))] & (unsigned short int) _ISspace)
# 42 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
 ...
 *value = vp;
 return (
# 45 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c" 3 4
        ((void *)0)
# 45 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_nameval.c"
            );
}
