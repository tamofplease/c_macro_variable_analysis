# 0 "/acl/lib_acl/src/stdlib/string/acl_str2time.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/string/acl_str2time.c"
...
# 2 "/acl/lib_acl/src/stdlib/string/acl_str2time.c" 2
# 17 "/acl/lib_acl/src/stdlib/string/acl_str2time.c"
time_t acl_str2time_t(const char *str)
{
 struct tm t;

 if (str == 
# 21 "/acl/lib_acl/src/stdlib/string/acl_str2time.c" 3 4
           ((void *)0)
# 21 "/acl/lib_acl/src/stdlib/string/acl_str2time.c"
               )
  return (0);
