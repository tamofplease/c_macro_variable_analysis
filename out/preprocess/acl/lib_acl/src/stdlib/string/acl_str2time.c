# 1 "/workspace/acl/lib_acl/src/stdlib/string/acl_str2time.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/string/acl_str2time.c" 2
# 17 "/workspace/acl/lib_acl/src/stdlib/string/acl_str2time.c"
time_t acl_str2time_t(const char *str)
{
 struct tm t;

 if (str == 
# 21 "/workspace/acl/lib_acl/src/stdlib/string/acl_str2time.c" 3 4
           ((void *)0)
# 21 "/workspace/acl/lib_acl/src/stdlib/string/acl_str2time.c"
               )
  return (0);
