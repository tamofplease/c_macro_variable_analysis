# 0 "/acl/lib_acl/src/stdlib/string/acl_basename.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/string/acl_basename.c"
...
# 3 "/acl/lib_acl/src/stdlib/string/acl_basename.c" 2
# 20 "/acl/lib_acl/src/stdlib/string/acl_basename.c"
const char *acl_safe_basename(const char *path)
{
 const char *result;

 if ((result = strrchr(path, '/')) == 
# 24 "/acl/lib_acl/src/stdlib/string/acl_basename.c" 3 4
                                     ((void *)0)
  
# 25 "/acl/lib_acl/src/stdlib/string/acl_basename.c"
 && (result = strrchr(path, '\\')) == 
# 25 "/acl/lib_acl/src/stdlib/string/acl_basename.c" 3 4
                                      ((void *)0)
# 25 "/acl/lib_acl/src/stdlib/string/acl_basename.c"
                                          )
 {
