# 1 "/workspace/acl/lib_acl/src/stdlib/string/acl_basename.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 3 "/workspace/acl/lib_acl/src/stdlib/string/acl_basename.c" 2
# 20 "/workspace/acl/lib_acl/src/stdlib/string/acl_basename.c"
const char *acl_safe_basename(const char *path)
{
 const char *result;

 if ((result = strrchr(path, '/')) == 
# 24 "/workspace/acl/lib_acl/src/stdlib/string/acl_basename.c" 3 4
                                     ((void *)0)
  
# 25 "/workspace/acl/lib_acl/src/stdlib/string/acl_basename.c"
 && (result = strrchr(path, '\\')) == 
# 25 "/workspace/acl/lib_acl/src/stdlib/string/acl_basename.c" 3 4
                                      ((void *)0)
# 25 "/workspace/acl/lib_acl/src/stdlib/string/acl_basename.c"
                                          )
 {
