# 0 "/acl/lib_acl/src/stdlib/string/acl_alldig.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/string/acl_alldig.c"
...
# 3 "/acl/lib_acl/src/stdlib/string/acl_alldig.c" 2
# 20 "/acl/lib_acl/src/stdlib/string/acl_alldig.c"
int acl_alldig(const char *s)
{
 if (s == 
# 22 "/acl/lib_acl/src/stdlib/string/acl_alldig.c" 3 4
         ((void *)0) 
# 22 "/acl/lib_acl/src/stdlib/string/acl_alldig.c"
              || *s == 0)
  return 0;
 for (; *s != 0; s++)
  if (!
# 25 "/acl/lib_acl/src/stdlib/string/acl_alldig.c" 3 4
      ((*__ctype_b_loc ())[(int) ((
# 25 "/acl/lib_acl/src/stdlib/string/acl_alldig.c"
      ((unsigned char)(*s))
# 25 "/acl/lib_acl/src/stdlib/string/acl_alldig.c" 3 4
...
{
 if (s == 
# 32 "/acl/lib_acl/src/stdlib/string/acl_alldig.c" 3 4
         ((void *)0) 
# 32 "/acl/lib_acl/src/stdlib/string/acl_alldig.c"
              || *s == 0)
  return 0;
 if (*s == '-' || *s == '+')
  s++;
 ...
 while (*s != 0) {
  ...
  if (!
# 46 "/acl/lib_acl/src/stdlib/string/acl_alldig.c" 3 4
      ((*__ctype_b_loc ())[(int) ((
# 46 "/acl/lib_acl/src/stdlib/string/acl_alldig.c"
      ((unsigned char)(*s))
# 46 "/acl/lib_acl/src/stdlib/string/acl_alldig.c" 3 4
      ))] & (unsigned short int) _ISdigit)
# 46 "/acl/lib_acl/src/stdlib/string/acl_alldig.c"
 ...
 while (*s != 0) {
  if (!
# 55 "/acl/lib_acl/src/stdlib/string/acl_alldig.c" 3 4
      ((*__ctype_b_loc ())[(int) ((
# 55 "/acl/lib_acl/src/stdlib/string/acl_alldig.c"
      ((unsigned char)(*s))
# 55 "/acl/lib_acl/src/stdlib/string/acl_alldig.c" 3 4
      ))] & (unsigned short int) _ISdigit)
# 55 "/acl/lib_acl/src/stdlib/string/acl_alldig.c"
