# 1 "/workspace/acl/lib_acl/src/stdlib/string/acl_alldig.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 3 "/workspace/acl/lib_acl/src/stdlib/string/acl_alldig.c" 2
# 20 "/workspace/acl/lib_acl/src/stdlib/string/acl_alldig.c"
int acl_alldig(const char *s)
{
 if (s == 
# 22 "/workspace/acl/lib_acl/src/stdlib/string/acl_alldig.c" 3 4
         ((void *)0) 
# 22 "/workspace/acl/lib_acl/src/stdlib/string/acl_alldig.c"
              || *s == 0)
  return 0;
 for (; *s != 0; s++)
  if (!
# 25 "/workspace/acl/lib_acl/src/stdlib/string/acl_alldig.c" 3 4
      ((*__ctype_b_loc ())[(int) ((
# 25 "/workspace/acl/lib_acl/src/stdlib/string/acl_alldig.c"
      ((unsigned char)(*s))
# 25 "/workspace/acl/lib_acl/src/stdlib/string/acl_alldig.c" 3 4
...
{
 if (s == 
# 32 "/workspace/acl/lib_acl/src/stdlib/string/acl_alldig.c" 3 4
         ((void *)0) 
# 32 "/workspace/acl/lib_acl/src/stdlib/string/acl_alldig.c"
              || *s == 0)
  return 0;
 if (*s == '-' || *s == '+')
  s++;
 ...
 while (*s != 0) {
  ...
  if (!
# 46 "/workspace/acl/lib_acl/src/stdlib/string/acl_alldig.c" 3 4
      ((*__ctype_b_loc ())[(int) ((
# 46 "/workspace/acl/lib_acl/src/stdlib/string/acl_alldig.c"
      ((unsigned char)(*s))
# 46 "/workspace/acl/lib_acl/src/stdlib/string/acl_alldig.c" 3 4
      ))] & (unsigned short int) _ISdigit)
# 46 "/workspace/acl/lib_acl/src/stdlib/string/acl_alldig.c"
 ...
 while (*s != 0) {
  if (!
# 55 "/workspace/acl/lib_acl/src/stdlib/string/acl_alldig.c" 3 4
      ((*__ctype_b_loc ())[(int) ((
# 55 "/workspace/acl/lib_acl/src/stdlib/string/acl_alldig.c"
      ((unsigned char)(*s))
# 55 "/workspace/acl/lib_acl/src/stdlib/string/acl_alldig.c" 3 4
      ))] & (unsigned short int) _ISdigit)
# 55 "/workspace/acl/lib_acl/src/stdlib/string/acl_alldig.c"
