# 1 "/workspace/acl/lib_acl/src/stdlib/string/acl_hex_code.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 3 "/workspace/acl/lib_acl/src/stdlib/string/acl_hex_code.c" 2
# 23 "/workspace/acl/lib_acl/src/stdlib/string/acl_hex_code.c"
