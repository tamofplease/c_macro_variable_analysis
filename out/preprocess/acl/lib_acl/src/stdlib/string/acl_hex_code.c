# 0 "/acl/lib_acl/src/stdlib/string/acl_hex_code.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/string/acl_hex_code.c"
...
# 3 "/acl/lib_acl/src/stdlib/string/acl_hex_code.c" 2
# 23 "/acl/lib_acl/src/stdlib/string/acl_hex_code.c"
...
ACL_VSTRING *acl_hex_encode(ACL_VSTRING *result, const char *in, int len)
{
 ...
 for (cp = ((const unsigned char *)(in)), count = len; count > 0; count--, cp++) {
  ch = *cp;
  ((&(result)->vbuf)->ptr < (&(result)->vbuf)->data + (&(result)->vbuf)->len ? (int) (*(&(result)->vbuf)->ptr++ = (acl_hex_chars[(ch >> 4) & 0xf])) : acl_vbuf_put((&(result)->vbuf),(acl_hex_chars[(ch >> 4) & 0xf])));
  ((&(result)->vbuf)->ptr < (&(result)->vbuf)->data + (&(result)->vbuf)->len ? (int) (*(&(result)->vbuf)->ptr++ = (acl_hex_chars[ch & 0xf])) : acl_vbuf_put((&(result)->vbuf),(acl_hex_chars[ch & 0xf])));
 }
...
ACL_VSTRING *acl_hex_decode(ACL_VSTRING *result, const char *in, int len)
{
 ...
 for (cp = ((const unsigned char *)(in)), count = len; count > 0; cp += 2, count -= 2) {
  ...
  if (hex >= '0' && hex <= '9')
   ...
   return (0);
  ((&(result)->vbuf)->ptr < (&(result)->vbuf)->data + (&(result)->vbuf)->len ? (int) (*(&(result)->vbuf)->ptr++ = (bin)) : acl_vbuf_put((&(result)->vbuf),(bin)));
 }
 ((&(result)->vbuf)->ptr < (&(result)->vbuf)->data + (&(result)->vbuf)->len ? *(&(result)->vbuf)->ptr = 0 : acl_vbuf_space((&(result)->vbuf), 1), *(&(result)->vbuf)->ptr = 0);
 return (result);
}
