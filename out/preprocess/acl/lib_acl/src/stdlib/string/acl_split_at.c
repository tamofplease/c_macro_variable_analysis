# 0 "/acl/lib_acl/src/stdlib/string/acl_split_at.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/string/acl_split_at.c"
...
# 2 "/acl/lib_acl/src/stdlib/string/acl_split_at.c" 2
# 22 "/acl/lib_acl/src/stdlib/string/acl_split_at.c"
