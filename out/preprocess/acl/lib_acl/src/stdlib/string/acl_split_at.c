# 1 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_at.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_at.c" 2
# 22 "/workspace/acl/lib_acl/src/stdlib/string/acl_split_at.c"
