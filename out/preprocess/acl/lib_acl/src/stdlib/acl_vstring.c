# 0 "/acl/lib_acl/src/stdlib/acl_vstring.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/acl_vstring.c"
...
# 2 "/acl/lib_acl/src/stdlib/acl_vstring.c" 2
# 31 "/acl/lib_acl/src/stdlib/acl_vstring.c"
# 1 "/acl/lib_acl/src/stdlib/charmap.h" 1
# 12 "/acl/lib_acl/src/stdlib/charmap.h"
...
# 32 "/acl/lib_acl/src/stdlib/acl_vstring.c" 2
...
static int vstring_extend(ACL_VBUF *bp, ssize_t incr)
{
 ...
 if (vp->maxlen > 0 && (ssize_t) (size_t) ((vp)->vbuf.ptr - (vp)->vbuf.data) >= vp->maxlen) {
  ...
  acl_msg_warn("%s(%d), %s: overflow maxlen: %ld, %ld",
   "/acl/lib_acl/src/stdlib/acl_vstring.c", 47, myname, (long) vp->maxlen,
...

 {
  acl_msg_warn("%s(%d), %s: can't extend fixed buffer",
   "/acl/lib_acl/src/stdlib/acl_vstring.c", 60, myname);
  return (-1);
 }
# 82 "/acl/lib_acl/src/stdlib/acl_vstring.c"
 ...
 if (vp->vbuf.flags & (1<<4)) {
  bp->data = (unsigned char *) acl_slice_pool_realloc("/acl/lib_acl/src/stdlib/acl_vstring.c",
...
# 101 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                            0
# 101 "/acl/lib_acl/src/stdlib/acl_vstring.c"
                                    ) != (acl_off_t) off) {
   acl_msg_fatal("lseek failed: %s, off: %lld",
    acl_last_serror(), off);
  }
  if (acl_file_write(bp->fd, "\0", 1, 0, 
# 105 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                                        ((void *)0)
# 105 "/acl/lib_acl/src/stdlib/acl_vstring.c"
                                            , 
# 105 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                                              ((void *)0)
# 105 "/acl/lib_acl/src/stdlib/acl_vstring.c"
  ...
  bp->data = (unsigned char *) acl_realloc_glue("/acl/lib_acl/src/stdlib/acl_vstring.c", 112, (bp->data), new_len);
 }
...
void acl_vstring_init(ACL_VSTRING *vp, size_t len)
{
 ...
 vp->vbuf.data = (unsigned char *) acl_malloc_glue("/acl/lib_acl/src/stdlib/acl_vstring.c", 149, len);
 ...
 vp->maxlen = 0;
 vp->vbuf.alloc.slice = 
# 161 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                       ((void *)0)
# 161 "/acl/lib_acl/src/stdlib/acl_vstring.c"
                           ;
 vp->vbuf.fd = (int) -1;
...
{
 if (vp->vbuf.data == 
# 170 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                     ((void *)0)
# 170 "/acl/lib_acl/src/stdlib/acl_vstring.c"
                         ) {
  return;
 }
 ...
 if (vp->vbuf.fd != (int) -1) {
  if (vp->maxlen > 0 && munmap(vp->vbuf.data, vp->maxlen) < 0) {
   acl_msg_error("%s(%d), %s: munmap error %s",
    "/acl/lib_acl/src/stdlib/acl_vstring.c", 178, __FUNCTION__,
    acl_last_serror());
  }
 }
  ...
  acl_slice_pool_free("/acl/lib_acl/src/stdlib/acl_vstring.c", 189, vp->vbuf.data);
 } else if ((vp->vbuf.flags & (1<<5)) == 0) {
  do { if (vp->vbuf.data) { acl_free_glue("/acl/lib_acl/src/stdlib/acl_vstring.c", 191, (vp->vbuf.data)); (vp->vbuf.data) = 
# 191 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
 ((void *)0)
# 191 "/acl/lib_acl/src/stdlib/acl_vstring.c"
 ; } } while (0);
 }
 vp->vbuf.data = 
# 193 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                ((void *)0)
# 193 "/acl/lib_acl/src/stdlib/acl_vstring.c"
                    ;
}
...
# 200 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                               ((void *)0)
# 200 "/acl/lib_acl/src/stdlib/acl_vstring.c"
                                   , len);
}
...
ACL_VSTRING *acl_vstring_slice_alloc(ACL_SLICE_POOL *slice, size_t len)
{
 ...
 if (slice) {
  vp = (ACL_VSTRING*) acl_slice_pool_alloc("/acl/lib_acl/src/stdlib/acl_vstring.c", 212,
   slice, sizeof(*vp));
  vp->vbuf.alloc.slice = slice;
  vp->vbuf.data = (unsigned char *) acl_slice_pool_alloc(
   "/acl/lib_acl/src/stdlib/acl_vstring.c", 216, slice, len);
  vp->vbuf.flags = (1<<4);
 } else {
  vp = (ACL_VSTRING *) acl_malloc_glue("/acl/lib_acl/src/stdlib/acl_vstring.c", 219, sizeof(*vp));
  vp->vbuf.alloc.slice = 
# 220 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                        ((void *)0)
# 220 "/acl/lib_acl/src/stdlib/acl_vstring.c"
                            ;
  vp->vbuf.data = (unsigned char *) acl_malloc_glue("/acl/lib_acl/src/stdlib/acl_vstring.c", 221, len);
  vp->vbuf.flags = 0;
 }
...
ACL_VSTRING *acl_vstring_dbuf_alloc(ACL_DBUF_POOL *dbuf, size_t len)
{
 ...
 if (dbuf) {
  ...
  vp = (ACL_VSTRING *) acl_malloc_glue("/acl/lib_acl/src/stdlib/acl_vstring.c", 256, sizeof(*vp));
  vp->vbuf.alloc.dbuf = 
# 257 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                       ((void *)0)
# 257 "/acl/lib_acl/src/stdlib/acl_vstring.c"
                           ;
  vp->vbuf.data = (unsigned char *) acl_malloc_glue("/acl/lib_acl/src/stdlib/acl_vstring.c", 258, len);
  vp->vbuf.flags = 0;
 }
...
# 282 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                                         0
# 282 "/acl/lib_acl/src/stdlib/acl_vstring.c"
                                                 ) != vp->vbuf.len) {
  acl_msg_fatal("lseek failed: %s, off: %ld",
   acl_last_serror(), (long) vp->vbuf.len);
 }
 if (acl_file_write(vp->vbuf.fd, "\0", 1, 0, 
# 286 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                                            ((void *)0)
# 286 "/acl/lib_acl/src/stdlib/acl_vstring.c"
                                                , 
# 286 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                                                  ((void *)0)
# 286 "/acl/lib_acl/src/stdlib/acl_vstring.c"
...
# 292 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                                      ((void *)0)
# 292 "/acl/lib_acl/src/stdlib/acl_vstring.c"
                                          , vp->maxlen,
  
# 293 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
 0x1 
# 293 "/acl/lib_acl/src/stdlib/acl_vstring.c"
           | 
# 293 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
             0x2
# 293 "/acl/lib_acl/src/stdlib/acl_vstring.c"
...
# 294 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                              ((void *) -1)
# 294 "/acl/lib_acl/src/stdlib/acl_vstring.c"
                                        ) {
  acl_msg_fatal("mmap error: %s", acl_last_serror());
 }
# 316 "/acl/lib_acl/src/stdlib/acl_vstring.c"
}
...
# 342 "/acl/lib_acl/src/stdlib/acl_vstring.c"
}

static acl_pthread_once_t __once_control = 
# 344 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                                          0
# 344 "/acl/lib_acl/src/stdlib/acl_vstring.c"
                                                               ;
 ...
 size_t max_len, size_t init_len, size_t offset)
{
 ...
 vp = (ACL_VSTRING *) acl_malloc_glue("/acl/lib_acl/src/stdlib/acl_vstring.c", 370, sizeof(*vp));
 ...
 vp->maxlen = max_len;
 vp->vbuf.alloc.slice = 
# 381 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                       ((void *)0)
# 381 "/acl/lib_acl/src/stdlib/acl_vstring.c"
                           ;
 vp->vbuf.fd = fd;
...
void acl_vstring_free(ACL_VSTRING *vp)
{
 ...
 if (vp->vbuf.flags & (1<<4)) {
  acl_slice_pool_free("/acl/lib_acl/src/stdlib/acl_vstring.c", 401, vp);
 }

 else if (vp->vbuf.fd != (int) -1) {
  do { if (vp) { acl_free_glue("/acl/lib_acl/src/stdlib/acl_vstring.c", 405, (vp)); (vp) = 
# 405 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
 ((void *)0)
# 405 "/acl/lib_acl/src/stdlib/acl_vstring.c"
 ; } } while (0);
 }
  ...
  do { if (vp) { acl_free_glue("/acl/lib_acl/src/stdlib/acl_vstring.c", 413, (vp)); (vp) = 
# 413 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
 ((void *)0)
# 413 "/acl/lib_acl/src/stdlib/acl_vstring.c"
 ; } } while (0);
 }
}
...
# 425 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
__builtin_va_start(
# 425 "/acl/lib_acl/src/stdlib/acl_vstring.c"
ap
# 425 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
,
# 425 "/acl/lib_acl/src/stdlib/acl_vstring.c"
...
# 425 "/acl/lib_acl/src/stdlib/acl_vstring.c"
                ;
 while ((code = 
# 426 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
               __builtin_va_arg(
# 426 "/acl/lib_acl/src/stdlib/acl_vstring.c"
               ap
# 426 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
               ,
# 426 "/acl/lib_acl/src/stdlib/acl_vstring.c"
...
# 426 "/acl/lib_acl/src/stdlib/acl_vstring.c"
  ...
  case 1:
   vp->maxlen = 
# 432 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
               __builtin_va_arg(
# 432 "/acl/lib_acl/src/stdlib/acl_vstring.c"
               ap
# 432 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
               ,
# 432 "/acl/lib_acl/src/stdlib/acl_vstring.c"
...
# 440 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
__builtin_va_end(
# 440 "/acl/lib_acl/src/stdlib/acl_vstring.c"
ap
# 440 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
)
# 440 "/acl/lib_acl/src/stdlib/acl_vstring.c"
...
ACL_VSTRING *acl_vstring_memmove(ACL_VSTRING *vp, const char *src, size_t len)
{
 ...
 if (vp->vbuf.flags & (1<<4)) {
  vp->vbuf.data = (unsigned char *) acl_slice_pool_alloc(
   "/acl/lib_acl/src/stdlib/acl_vstring.c", 552, vp->vbuf.alloc.slice, len);
 } else if (vp->vbuf.flags & (1<<5)) {
...
# 572 "/acl/lib_acl/src/stdlib/acl_vstring.c"
 else {
  vp->vbuf.data = acl_malloc_glue("/acl/lib_acl/src/stdlib/acl_vstring.c", 573, len);
 }
...
char *acl_vstring_memchr(ACL_VSTRING *vp, int ch)
{
 ...
 return 
# 632 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
       ((void *)0)
# 632 "/acl/lib_acl/src/stdlib/acl_vstring.c"
           ;
}
...
char *acl_vstring_strstr(ACL_VSTRING *vp, const char *needle)
{
 ...
 if (vp == 
# 642 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
          ((void *)0) 
# 642 "/acl/lib_acl/src/stdlib/acl_vstring.c"
               || needle == 
# 642 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                            ((void *)0) 
# 642 "/acl/lib_acl/src/stdlib/acl_vstring.c"
                                 || *needle == 0) {
  return 
# 643 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
        ((void *)0)
# 643 "/acl/lib_acl/src/stdlib/acl_vstring.c"
            ;
 }
 ...
 return 
# 664 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
       ((void *)0)
# 664 "/acl/lib_acl/src/stdlib/acl_vstring.c"
           ;
}
...
char *acl_vstring_strcasestr(ACL_VSTRING *vp, const char *needle)
{
 ...
 if (vp == 
# 675 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
          ((void *)0) 
# 675 "/acl/lib_acl/src/stdlib/acl_vstring.c"
               || needle == 
# 675 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                            ((void *)0) 
# 675 "/acl/lib_acl/src/stdlib/acl_vstring.c"
                                 || *needle == 0) {
  return 
# 676 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
        ((void *)0)
# 676 "/acl/lib_acl/src/stdlib/acl_vstring.c"
            ;
 }
 ...
 return 
# 697 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
       ((void *)0)
# 697 "/acl/lib_acl/src/stdlib/acl_vstring.c"
           ;
}
...
char *acl_vstring_rstrstr(ACL_VSTRING *vp, const char *needle)
{
 ...
 if (vp == 
# 707 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
          ((void *)0) 
# 707 "/acl/lib_acl/src/stdlib/acl_vstring.c"
               || needle == 
# 707 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                            ((void *)0) 
# 707 "/acl/lib_acl/src/stdlib/acl_vstring.c"
                                 || *needle == 0) {
  return 
# 708 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
        ((void *)0)
# 708 "/acl/lib_acl/src/stdlib/acl_vstring.c"
            ;
 }
 ...
 return 
# 732 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
       ((void *)0)
# 732 "/acl/lib_acl/src/stdlib/acl_vstring.c"
           ;
}
...
char *acl_vstring_rstrcasestr(ACL_VSTRING *vp, const char *needle)
{
 ...
 if (vp == 
# 743 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
          ((void *)0) 
# 743 "/acl/lib_acl/src/stdlib/acl_vstring.c"
               || needle == 
# 743 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                            ((void *)0) 
# 743 "/acl/lib_acl/src/stdlib/acl_vstring.c"
                                 || *needle == 0) {
  return 
# 744 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
        ((void *)0)
# 744 "/acl/lib_acl/src/stdlib/acl_vstring.c"
            ;
 }
 ...
 return 
# 768 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
       ((void *)0)
# 768 "/acl/lib_acl/src/stdlib/acl_vstring.c"
           ;
}
...
char *acl_vstring_export(ACL_VSTRING *vp)
{
 ...
 vp->vbuf.data = 0;
 do { if (vp) { acl_free_glue("/acl/lib_acl/src/stdlib/acl_vstring.c", 846, (vp)); (vp) = 
# 846 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
((void *)0)
# 846 "/acl/lib_acl/src/stdlib/acl_vstring.c"
; } } while (0);
 return cp;
}
...
ACL_VSTRING *acl_vstring_import(char *str)
{
 ...
 vp = (ACL_VSTRING *) acl_malloc_glue("/acl/lib_acl/src/stdlib/acl_vstring.c", 857, sizeof(*vp));
 vp->vbuf.flags = 0;
 vp->vbuf.alloc.slice = 
# 859 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                       ((void *)0)
# 859 "/acl/lib_acl/src/stdlib/acl_vstring.c"
                           ;
 len = (int) strlen(str);
...
char acl_vstring_charat(ACL_VSTRING *vp, size_t offset)
{
 ...
 if (vp == 
# 889 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
          ((void *)0)
# 889 "/acl/lib_acl/src/stdlib/acl_vstring.c"
              ) {
...
# 905 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
__builtin_va_start(
# 905 "/acl/lib_acl/src/stdlib/acl_vstring.c"
ap
# 905 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
,
# 905 "/acl/lib_acl/src/stdlib/acl_vstring.c"
...
# 907 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
__builtin_va_end(
# 907 "/acl/lib_acl/src/stdlib/acl_vstring.c"
ap
# 907 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
)
# 907 "/acl/lib_acl/src/stdlib/acl_vstring.c"
...
# 927 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
__builtin_va_start(
# 927 "/acl/lib_acl/src/stdlib/acl_vstring.c"
ap
# 927 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
,
# 927 "/acl/lib_acl/src/stdlib/acl_vstring.c"
...
# 929 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
__builtin_va_end(
# 929 "/acl/lib_acl/src/stdlib/acl_vstring.c"
ap
# 929 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
)
# 929 "/acl/lib_acl/src/stdlib/acl_vstring.c"
...
# 951 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
__builtin_va_start(
# 951 "/acl/lib_acl/src/stdlib/acl_vstring.c"
ap
# 951 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
,
# 951 "/acl/lib_acl/src/stdlib/acl_vstring.c"
...
# 953 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
__builtin_va_end(
# 953 "/acl/lib_acl/src/stdlib/acl_vstring.c"
ap
# 953 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
)
# 953 "/acl/lib_acl/src/stdlib/acl_vstring.c"
...
const ACL_VSTRING *acl_buffer_gets_nonl(ACL_VSTRING *vp, const char **src, size_t dlen)
{
 ...
 if (dlen <= 0) {
  acl_msg_warn("%s(%d): dlen(%d) invalid",
   myname, 974, (int) dlen);
  return 
# 975 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
        ((void *)0)
# 975 "/acl/lib_acl/src/stdlib/acl_vstring.c"
            ;
 }

 ptr = memchr(pbegin, '\n', dlen);
 if (ptr == 
# 979 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
           ((void *)0)
# 979 "/acl/lib_acl/src/stdlib/acl_vstring.c"
               ) {
  acl_vstring_memcat(vp, pbegin, dlen);
  ((&(vp)->vbuf)->ptr < (&(vp)->vbuf)->data + (&(vp)->vbuf)->len ? *(&(vp)->vbuf)->ptr = 0 : acl_vbuf_space((&(vp)->vbuf), 1), *(&(vp)->vbuf)->ptr = 0);
  *src += dlen;
  return 
# 983 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
        ((void *)0)
# 983 "/acl/lib_acl/src/stdlib/acl_vstring.c"
            ;
 }
 *src = ptr + 1;
 pend = ptr;
...
const ACL_VSTRING *acl_buffer_gets(ACL_VSTRING *vp, const char **src, size_t dlen)
{
 ...
 if (dlen <= 0) {
  ...
  return 
# 1013 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
        ((void *)0)
# 1013 "/acl/lib_acl/src/stdlib/acl_vstring.c"
            ;
 }

 ptr = memchr(*src, '\n', dlen);
 if (ptr == 
# 1017 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
           ((void *)0)
# 1017 "/acl/lib_acl/src/stdlib/acl_vstring.c"
               ) {
  acl_vstring_memcat(vp, *src, dlen);
  ((&(vp)->vbuf)->ptr < (&(vp)->vbuf)->data + (&(vp)->vbuf)->len ? *(&(vp)->vbuf)->ptr = 0 : acl_vbuf_space((&(vp)->vbuf), 1), *(&(vp)->vbuf)->ptr = 0);
  *src += dlen;
  return 
# 1021 "/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
        ((void *)0)
# 1021 "/acl/lib_acl/src/stdlib/acl_vstring.c"
            ;
 }
