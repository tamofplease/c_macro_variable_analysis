# 1 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 2
# 31 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
# 1 "/workspace/acl/lib_acl/src/stdlib/charmap.h" 1
# 12 "/workspace/acl/lib_acl/src/stdlib/charmap.h"
...
# 32 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 2
...
static int vstring_extend(ACL_VBUF *bp, ssize_t incr)
{
 ...
 if (vp->maxlen > 0 && (ssize_t) (size_t) ((vp)->vbuf.ptr - (vp)->vbuf.data) >= vp->maxlen) {
  { (vp)->vbuf.ptr = (vp)->vbuf.data + (vp->maxlen - 1); };
  ((&(vp)->vbuf)->ptr < (&(vp)->vbuf)->data + (&(vp)->vbuf)->len ? *(&(vp)->vbuf)->ptr = 0 : acl_vbuf_space((&(vp)->vbuf), 1), *(&(vp)->vbuf)->ptr = 0);
  acl_msg_warn("%s(%d), %s: overflow maxlen: %ld, %ld",
   "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c", 47, myname, (long) vp->maxlen,
   (long) (size_t) ((vp)->vbuf.ptr - (vp)->vbuf.data));
  bp->flags |= (1<<1);
  return (-1);
 }
 ...
 if (bp->fd < 0 && (bp->flags & (1<<3)))

 {
  acl_msg_warn("%s(%d), %s: can't extend fixed buffer",
   "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c", 60, myname);
  return (-1);
 }
# 82 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
 ...
 if (vp->vbuf.flags & (1<<4)) {
  bp->data = (unsigned char *) acl_slice_pool_realloc("/workspace/acl/lib_acl/src/stdlib/acl_vstring.c",
   91, bp->alloc.slice, bp->data, new_len);
 } else if (vp->vbuf.flags & (1<<5)) {
  ...
  if (acl_lseek(bp->fd, off, 
# 101 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                            0
# 101 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
                                    ) != (acl_off_t) off) {
   acl_msg_fatal("lseek failed: %s, off: %lld",
    acl_last_serror(), off);
  }
  if (acl_file_write(bp->fd, "\0", 1, 0, 
# 105 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                                        ((void *)0)
# 105 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
                                            , 
# 105 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                                              ((void *)0)
# 105 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
  ...
  bp->data = (unsigned char *) acl_realloc_glue("/workspace/acl/lib_acl/src/stdlib/acl_vstring.c", 112, (bp->data), new_len);
 }
...
void acl_vstring_init(ACL_VSTRING *vp, size_t len)
{
 ...
 vp->vbuf.data = (unsigned char *) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/acl_vstring.c", 149, len);

 vp->vbuf.flags = 0;
 vp->vbuf.len = (int) len;
 { (vp)->vbuf.ptr = (vp)->vbuf.data; ((&(vp)->vbuf)->flags &= ~((1<<0) | (1<<1) | (1<<2))); };
 vp->vbuf.data[0] = 0;
 ...
 vp->maxlen = 0;
 vp->vbuf.alloc.slice = 
# 161 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                       ((void *)0)
# 161 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
                           ;
 vp->vbuf.fd = (int) -1;
...
{
 if (vp->vbuf.data == 
# 170 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                     ((void *)0)
# 170 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
                         ) {
  return;
 }
 ...
 if (vp->vbuf.fd != (int) -1) {
  if (vp->maxlen > 0 && munmap(vp->vbuf.data, vp->maxlen) < 0) {
   acl_msg_error("%s(%d), %s: munmap error %s",
    "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c", 178, __FUNCTION__,
    acl_last_serror());
  }
 }
 ...
 else if (vp->vbuf.flags & (1<<4)) {
  acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/acl_vstring.c", 189, vp->vbuf.data);
 } else if ((vp->vbuf.flags & (1<<5)) == 0) {
  do { if (vp->vbuf.data) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/acl_vstring.c", 191, (vp->vbuf.data)); (vp->vbuf.data) = 
# 191 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
 ((void *)0)
# 191 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
 ; } } while (0);
 }
 vp->vbuf.data = 
# 193 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                ((void *)0)
# 193 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
                    ;
}
...
ACL_VSTRING *acl_vstring_alloc(size_t len)
{
 return acl_vstring_slice_alloc(
# 200 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                               ((void *)0)
# 200 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
                                   , len);
}
...
ACL_VSTRING *acl_vstring_slice_alloc(ACL_SLICE_POOL *slice, size_t len)
{
 ...
 if (slice) {
  vp = (ACL_VSTRING*) acl_slice_pool_alloc("/workspace/acl/lib_acl/src/stdlib/acl_vstring.c", 212,
   slice, sizeof(*vp));
  vp->vbuf.alloc.slice = slice;
  vp->vbuf.data = (unsigned char *) acl_slice_pool_alloc(
   "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c", 216, slice, len);
  vp->vbuf.flags = (1<<4);
 } else {
  vp = (ACL_VSTRING *) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/acl_vstring.c", 219, sizeof(*vp));
  vp->vbuf.alloc.slice = 
# 220 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                        ((void *)0)
# 220 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
                            ;
  vp->vbuf.data = (unsigned char *) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/acl_vstring.c", 221, len);
  vp->vbuf.flags = 0;
 }
...
ACL_VSTRING *acl_vstring_dbuf_alloc(ACL_DBUF_POOL *dbuf, size_t len)
{
 ...
 if (dbuf) {
  ...
  vp = (ACL_VSTRING *) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/acl_vstring.c", 256, sizeof(*vp));
  vp->vbuf.alloc.dbuf = 
# 257 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                       ((void *)0)
# 257 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
                           ;
  vp->vbuf.data = (unsigned char *) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/acl_vstring.c", 258, len);
  vp->vbuf.flags = 0;
 }
...
static void mmap_buf_init(ACL_VSTRING *vp, size_t offset)
{
 ...
 if (acl_lseek(vp->vbuf.fd, vp->vbuf.len, 
# 282 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                                         0
# 282 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
                                                 ) != vp->vbuf.len) {
  acl_msg_fatal("lseek failed: %s, off: %ld",
   acl_last_serror(), (long) vp->vbuf.len);
 }
 if (acl_file_write(vp->vbuf.fd, "\0", 1, 0, 
# 286 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                                            ((void *)0)
# 286 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
                                                , 
# 286 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                                                  ((void *)0)
# 286 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
 ...
 vp->vbuf.data = (unsigned char*) mmap(
# 292 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                                      ((void *)0)
# 292 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
                                          , vp->maxlen,
  
# 293 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
 0x1 
# 293 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
           | 
# 293 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
             0x2
# 293 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
...
# 293 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
                                   , vp->vbuf.fd, offset);
 if ((void *) vp->vbuf.data == 
# 294 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                              ((void *) -1)
# 294 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
                                        ) {
  acl_msg_fatal("mmap error: %s", acl_last_serror());
 }
# 316 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
}
...
# 342 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
}

static acl_pthread_once_t __once_control = 
# 344 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                                          0
# 344 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
                                                               ;
 ...
 size_t max_len, size_t init_len, size_t offset)
{
 ...
 if (offset > 0) {
  ...
  pthread_once(&__once_control, get_pagesize);
 ...
 vp = (ACL_VSTRING *) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/acl_vstring.c", 370, sizeof(*vp));
 ...
 vp->maxlen = max_len;
 vp->vbuf.alloc.slice = 
# 381 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                       ((void *)0)
# 381 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
                           ;
 vp->vbuf.fd = fd;
...
void acl_vstring_free(ACL_VSTRING *vp)
{
 ...
 if (vp->vbuf.flags & (1<<4)) {
  acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/acl_vstring.c", 401, vp);
 }

 else if (vp->vbuf.fd != (int) -1) {
  do { if (vp) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/acl_vstring.c", 405, (vp)); (vp) = 
# 405 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
 ((void *)0)
# 405 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
 ; } } while (0);
 }
  ...
  do { if (vp) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/acl_vstring.c", 413, (vp)); (vp) = 
# 413 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
 ((void *)0)
# 413 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
 ; } } while (0);
 }
}
...
# 425 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
__builtin_va_start(
# 425 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
ap
# 425 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
,
# 425 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
...
# 425 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
                ;
 while ((code = 
# 426 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
               __builtin_va_arg(
# 426 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
               ap
# 426 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
               ,
# 426 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
...
# 426 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
  ...
  case 1:
   vp->maxlen = 
# 432 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
               __builtin_va_arg(
# 432 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
               ap
# 432 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
               ,
# 432 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
...
# 440 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
__builtin_va_end(
# 440 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
ap
# 440 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
)
# 440 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
...
ACL_VSTRING *acl_vstring_truncate(ACL_VSTRING *vp, size_t len)
{
 if (len < (size_t) ((vp)->vbuf.ptr - (vp)->vbuf.data)) {
  { (vp)->vbuf.ptr = (vp)->vbuf.data + ((int) len); };
  ((&(vp)->vbuf)->ptr < (&(vp)->vbuf)->data + (&(vp)->vbuf)->len ? *(&(vp)->vbuf)->ptr = 0 : acl_vbuf_space((&(vp)->vbuf), 1), *(&(vp)->vbuf)->ptr = 0);
 }
 return vp;
}
...
ACL_VSTRING *acl_vstring_memcpy(ACL_VSTRING *vp, const char *src, size_t len)
{
 ...
 if (len > 0) {
  ...
  acl_vbuf_space(&(vp)->vbuf, (ssize_t) len);

  n = ((vp)->vbuf.len - ((vp)->vbuf.ptr - (vp)->vbuf.data));

  if ((size_t) n >= len) {
   n = (ssize_t) len;
  } else {
   acl_msg_warn("%s(%d): space not enough, avail: %ld, "
    "len: %ld", __FUNCTION__, 509,
    (long) n, (long) len);
  }

  if (n > 0) {
   memcpy(((char *) (vp)->vbuf.data), src, n);
   { (vp)->vbuf.ptr = (vp)->vbuf.data + (n); };
  } else {
   acl_msg_warn("%s(%d): no space, avail: 0, len: %ld",
    __FUNCTION__, 518, (long) len);
  }
 }
...
ACL_VSTRING *acl_vstring_memmove(ACL_VSTRING *vp, const char *src, size_t len)
{
 ...
 if (src >= ((char *) (vp)->vbuf.data)
  && (src + len <= ((char *) (vp)->vbuf.data) + ((vp)->vbuf.len)))
 {

  memmove(((char *) (vp)->vbuf.data), src, len);
  { (vp)->vbuf.ptr = (vp)->vbuf.data + ((int) len); };
  ((&(vp)->vbuf)->ptr < (&(vp)->vbuf)->data + (&(vp)->vbuf)->len ? *(&(vp)->vbuf)->ptr = 0 : acl_vbuf_space((&(vp)->vbuf), 1), *(&(vp)->vbuf)->ptr = 0);
  return vp;
 }
 ...
 if (vp->vbuf.flags & (1<<4)) {
  vp->vbuf.data = (unsigned char *) acl_slice_pool_alloc(
   "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c", 552, vp->vbuf.alloc.slice, len);
 } else if (vp->vbuf.flags & (1<<5)) {
...
# 572 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
 else {
  vp->vbuf.data = acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/acl_vstring.c", 573, len);
 }

 memcpy(vp->vbuf.data, src, len);
 { (vp)->vbuf.ptr = (vp)->vbuf.data + ((ssize_t) len); };
 ((&(vp)->vbuf)->ptr < (&(vp)->vbuf)->data + (&(vp)->vbuf)->len ? *(&(vp)->vbuf)->ptr = 0 : acl_vbuf_space((&(vp)->vbuf), 1), *(&(vp)->vbuf)->ptr = 0);
...
ACL_VSTRING *acl_vstring_memcat(ACL_VSTRING *vp, const char *src, size_t len)
{
 if (len > 0) {
  ...
  if ((size_t) n >= len) {
   ...
   acl_msg_warn("%s(%d): space not enough, avail: %ld, "
    "len: %ld", __FUNCTION__, 602,
    (long) n, (long) len);
  }

  if (n > 0 ) {
   memcpy(((char *) (vp)->vbuf.ptr), src, n);
   n += (ssize_t) (size_t) ((vp)->vbuf.ptr - (vp)->vbuf.data);
   { (vp)->vbuf.ptr = (vp)->vbuf.data + (n); };
  } else {
   acl_msg_warn("%s(%d): no space, avail: 0, len: %ld",
    __FUNCTION__, 612, (long) len);
  }
 }
...
char *acl_vstring_memchr(ACL_VSTRING *vp, int ch)
{
 ...
 for (cp = (unsigned char *) ((char *) (vp)->vbuf.data);
  cp < (unsigned char *) ((char *) (vp)->vbuf.ptr); cp++) {
  if (*cp == ch) {
   return (char *) cp;
  }
 }
 return 
# 632 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
       ((void *)0)
# 632 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
           ;
}
...
char *acl_vstring_strstr(ACL_VSTRING *vp, const char *needle)
{
 ...
 if (vp == 
# 642 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
          ((void *)0) 
# 642 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
               || needle == 
# 642 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                            ((void *)0) 
# 642 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
                                 || *needle == 0) {
  return 
# 643 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
        ((void *)0)
# 643 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
            ;
 }
 ...
 return 
# 664 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
       ((void *)0)
# 664 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
           ;
}
...
char *acl_vstring_strcasestr(ACL_VSTRING *vp, const char *needle)
{
 ...
 if (vp == 
# 675 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
          ((void *)0) 
# 675 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
               || needle == 
# 675 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                            ((void *)0) 
# 675 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
                                 || *needle == 0) {
  return 
# 676 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
        ((void *)0)
# 676 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
            ;
 }
 ...
 return 
# 697 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
       ((void *)0)
# 697 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
           ;
}
...
char *acl_vstring_rstrstr(ACL_VSTRING *vp, const char *needle)
{
 ...
 if (vp == 
# 707 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
          ((void *)0) 
# 707 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
               || needle == 
# 707 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                            ((void *)0) 
# 707 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
                                 || *needle == 0) {
  return 
# 708 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
        ((void *)0)
# 708 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
            ;
 }

 needle_end = (const unsigned char *) needle + strlen(needle) - 1;

 for (cp = (unsigned char *) ((char *) (vp)->vbuf.ptr) - 1;
  cp >= (unsigned char *) ((char *) (vp)->vbuf.data); cp--) {
  if (np) {
   if (*cp == *np) {
 ...
 return 
# 732 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
       ((void *)0)
# 732 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
           ;
}
...
char *acl_vstring_rstrcasestr(ACL_VSTRING *vp, const char *needle)
{
 ...
 if (vp == 
# 743 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
          ((void *)0) 
# 743 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
               || needle == 
# 743 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                            ((void *)0) 
# 743 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
                                 || *needle == 0) {
  return 
# 744 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
        ((void *)0)
# 744 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
            ;
 }
 ...
 return 
# 768 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
       ((void *)0)
# 768 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
           ;
}
 ...
 const char *buf, size_t len)
{
 ...
 if (start >= (size_t) ((vp)->vbuf.ptr - (vp)->vbuf.data)) {
  acl_msg_panic("%s(%d): bad start %ld",
   myname, 784, (long) start);
 }




 new_len = (size_t) ((vp)->vbuf.ptr - (vp)->vbuf.data) + len;
 acl_vbuf_space(&(vp)->vbuf, (ssize_t) len);
 ...
 if (len > 0) {
  memmove(((char *) (vp)->vbuf.data) + start + len,
   ((char *) (vp)->vbuf.data) + start,
   (size_t) ((vp)->vbuf.ptr - (vp)->vbuf.data) - start);
  memcpy(((char *) (vp)->vbuf.data) + start, buf, len);
  { (vp)->vbuf.ptr = (vp)->vbuf.data + ((int) new_len); };
  ((&(vp)->vbuf)->ptr < (&(vp)->vbuf)->data + (&(vp)->vbuf)->len ? *(&(vp)->vbuf)->ptr = 0 : acl_vbuf_space((&(vp)->vbuf), 1), *(&(vp)->vbuf)->ptr = 0);
 }
...
ACL_VSTRING *acl_vstring_prepend(ACL_VSTRING *vp, const char *buf, size_t len)
{
 ...
 new_len = (ssize_t) ((size_t) ((vp)->vbuf.ptr - (vp)->vbuf.data) + len);
 acl_vbuf_space(&(vp)->vbuf, (int) len);
 ...
 if (len > 0) {
  memmove(((char *) (vp)->vbuf.data) + len, ((char *) (vp)->vbuf.data),
   (size_t) ((vp)->vbuf.ptr - (vp)->vbuf.data));
  memcpy(((char *) (vp)->vbuf.data), buf, len);
  { (vp)->vbuf.ptr = (vp)->vbuf.data + (new_len); };
  ((&(vp)->vbuf)->ptr < (&(vp)->vbuf)->data + (&(vp)->vbuf)->len ? *(&(vp)->vbuf)->ptr = 0 : acl_vbuf_space((&(vp)->vbuf), 1), *(&(vp)->vbuf)->ptr = 0);
 }
...
char *acl_vstring_export(ACL_VSTRING *vp)
{
 ...
 vp->vbuf.data = 0;
 do { if (vp) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/acl_vstring.c", 846, (vp)); (vp) = 
# 846 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
((void *)0)
# 846 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
; } } while (0);
 return cp;
}
...
ACL_VSTRING *acl_vstring_import(char *str)
{
 ...
 vp = (ACL_VSTRING *) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/acl_vstring.c", 857, sizeof(*vp));
 vp->vbuf.flags = 0;
 vp->vbuf.alloc.slice = 
# 859 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
                       ((void *)0)
# 859 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
                           ;
 len = (int) strlen(str);
 vp->vbuf.data = (unsigned char *) str;
 vp->vbuf.len = len + 1;
 { (vp)->vbuf.ptr = (vp)->vbuf.data + (len); };
 vp->maxlen = 0;
 return vp;
}
...
char acl_vstring_charat(ACL_VSTRING *vp, size_t offset)
{
 ...
 if (vp == 
# 889 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
          ((void *)0)
# 889 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
              ) {
  acl_msg_fatal("%s(%d): invalid input", myname, 890);
 }
 if (offset >= (size_t) ((vp)->vbuf.ptr - (vp)->vbuf.data)) {
  acl_msg_fatal("%s(%d): offset(%d) >= strlen(%d)", myname,
   894, (int) offset, (int) (size_t) ((vp)->vbuf.ptr - (vp)->vbuf.data));
 }
 return ((int) (vp->vbuf).data[offset]);
}
...
# 905 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
__builtin_va_start(
# 905 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
ap
# 905 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
,
# 905 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
...
# 907 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
__builtin_va_end(
# 907 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
ap
# 907 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
)
# 907 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
...
# 927 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
__builtin_va_start(
# 927 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
ap
# 927 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
,
# 927 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
...
# 929 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
__builtin_va_end(
# 929 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
ap
# 929 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
)
# 929 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
...
{
 va_list ap;
 ssize_t old_len = (ssize_t) (size_t) ((vp)->vbuf.ptr - (vp)->vbuf.data);
 ssize_t result_len;


 
# 951 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
__builtin_va_start(
# 951 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
ap
# 951 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
,
# 951 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
...
# 953 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
__builtin_va_end(
# 953 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
ap
# 953 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
)
# 953 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
          ;
 result_len = (ssize_t) (size_t) ((vp)->vbuf.ptr - (vp)->vbuf.data);


 acl_vbuf_space(&(vp)->vbuf, old_len);
 acl_vstring_memcat(vp, ((char *) (vp)->vbuf.data), old_len);


 memmove(((char *) (vp)->vbuf.data), ((char *) (vp)->vbuf.data) + old_len, result_len);
 { (vp)->vbuf.ptr = (vp)->vbuf.data + (result_len); };
 ((&(vp)->vbuf)->ptr < (&(vp)->vbuf)->data + (&(vp)->vbuf)->len ? *(&(vp)->vbuf)->ptr = 0 : acl_vbuf_space((&(vp)->vbuf), 1), *(&(vp)->vbuf)->ptr = 0);
 return vp;
}
...
const ACL_VSTRING *acl_buffer_gets_nonl(ACL_VSTRING *vp, const char **src, size_t dlen)
{
 ...
 if (dlen <= 0) {
  acl_msg_warn("%s(%d): dlen(%d) invalid",
   myname, 974, (int) dlen);
  return 
# 975 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
        ((void *)0)
# 975 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
            ;
 }

 ptr = memchr(pbegin, '\n', dlen);
 if (ptr == 
# 979 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
           ((void *)0)
# 979 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
               ) {
  acl_vstring_memcat(vp, pbegin, dlen);
  ((&(vp)->vbuf)->ptr < (&(vp)->vbuf)->data + (&(vp)->vbuf)->len ? *(&(vp)->vbuf)->ptr = 0 : acl_vbuf_space((&(vp)->vbuf), 1), *(&(vp)->vbuf)->ptr = 0);
  *src += dlen;
  return 
# 983 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
        ((void *)0)
# 983 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
            ;
 }
 *src = ptr + 1;
 pend = ptr;
...
const ACL_VSTRING *acl_buffer_gets(ACL_VSTRING *vp, const char **src, size_t dlen)
{
 ...
 if (dlen <= 0) {
  acl_msg_warn("%s(%d): dlen(%d) invalid",
   myname, 1012, (int) dlen);
  return 
# 1013 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
        ((void *)0)
# 1013 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
            ;
 }

 ptr = memchr(*src, '\n', dlen);
 if (ptr == 
# 1017 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
           ((void *)0)
# 1017 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
               ) {
  acl_vstring_memcat(vp, *src, dlen);
  ((&(vp)->vbuf)->ptr < (&(vp)->vbuf)->data + (&(vp)->vbuf)->len ? *(&(vp)->vbuf)->ptr = 0 : acl_vbuf_space((&(vp)->vbuf), 1), *(&(vp)->vbuf)->ptr = 0);
  *src += dlen;
  return 
# 1021 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c" 3 4
        ((void *)0)
# 1021 "/workspace/acl/lib_acl/src/stdlib/acl_vstring.c"
            ;
 }
