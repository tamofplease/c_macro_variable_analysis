# 0 "/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
...
# 2 "/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c" 2
# 18 "/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
...
# 56 "/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
 ...
 pool = (ACL_DBUF_POOL*) acl_malloc_glue("/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c", 71, sizeof(struct ACL_DBUF_POOL) + sizeof(ACL_DBUF) + size)
                             ;
 ...
 pool->head->next = 
# 79 "/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c" 3 4
                   ((void *)0)
# 79 "/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
                       ;
 pool->head->keep = 1;
 pool->head->used = 0;
 pool->head->size = size;
...
void acl_dbuf_pool_destroy(ACL_DBUF_POOL *pool)
{
 ...
 while (iter) {
  ...
  do { if (tmp) { acl_free_glue("/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c", 103, (tmp)); (tmp) = 
# 103 "/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c" 3 4
 ((void *)0)
# 103 "/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
 ; } } while (0);
 ...
 do { if (pool) { acl_free_glue("/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c", 110, (pool)); (pool) = 
# 110 "/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c" 3 4
((void *)0)
# 110 "/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
; } } while (0);
...
int acl_dbuf_pool_reset(ACL_DBUF_POOL *pool, size_t off)
{
 ...
 while (1) {
  ...
  do { if (tmp) { acl_free_glue("/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c", 166, (tmp)); (tmp) = 
# 166 "/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c" 3 4
 ((void *)0)
# 166 "/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
 ; } } while (0);
...
int acl_dbuf_pool_free(ACL_DBUF_POOL *pool, const void *addr)
{
 ...
 if (iter == 
# 189 "/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c" 3 4
            ((void *)0)
# 189 "/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
                ) {
 ...
 do { if (iter) { acl_free_glue("/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c", 216, (iter)); (iter) = 
# 216 "/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c" 3 4
((void *)0)
# 216 "/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
; } } while (0);
...
static ACL_DBUF *acl_dbuf_alloc(ACL_DBUF_POOL *pool, size_t length)
{
 ...
 ACL_DBUF *dbuf = (ACL_DBUF*) acl_malloc_glue("/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c", 226, sizeof(ACL_DBUF) + length);
...
# 253 "/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c" 3 4
                       ((void *)0)
# 253 "/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
                           )
