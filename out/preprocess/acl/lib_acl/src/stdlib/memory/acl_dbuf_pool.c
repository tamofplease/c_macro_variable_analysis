# 1 "/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c" 2
# 18 "/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
...
# 56 "/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
 ...
 pool = (ACL_DBUF_POOL*) acl_malloc_glue(
                            "/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
# 71 "/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
                         ,
                            72
# 71 "/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
                         , sizeof(struct ACL_DBUF_POOL) + sizeof(ACL_DBUF) + size)
                             ;
 ...
 pool->head->next = 
# 79 "/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c" 3 4
                   ((void *)0)
# 79 "/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
                       ;
 pool->head->keep = 1;
 pool->head->used = 0;
 pool->head->size = size;
...
void acl_dbuf_pool_destroy(ACL_DBUF_POOL *pool)
{
 ...
 while (iter) {
  ...
  do { if (tmp) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c", 103, (tmp)); (tmp) = 
# 103 "/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c" 3 4
 ((void *)0)
# 103 "/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
 ; } } while (0);
 ...
 do { if (pool) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c", 110, (pool)); (pool) = 
# 110 "/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c" 3 4
((void *)0)
# 110 "/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
; } } while (0);
...
int acl_dbuf_pool_reset(ACL_DBUF_POOL *pool, size_t off)
{
 ...
 if (off > pool->off) {
  acl_msg_warn("warning: %s(%d) off(%ld) > pool->off(%ld)",
   __FUNCTION__, 121, (long) off, (long) pool->off);
  return -1;
 ...
 while (1) {
  ...
  do { if (tmp) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c", 166, (tmp)); (tmp) = 
# 166 "/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c" 3 4
 ((void *)0)
# 166 "/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
 ; } } while (0);
...
int acl_dbuf_pool_free(ACL_DBUF_POOL *pool, const void *addr)
{
 ...
 if (iter == 
# 189 "/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c" 3 4
            ((void *)0)
# 189 "/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
                ) {
  acl_msg_warn("warning: %s(%d), not found addr: %p",
   __FUNCTION__, 191, addr);
  return -1;
 }

 if (iter->used < 0) {
  acl_msg_warn("warning: %s(%d), used(%d) < 0",
   __FUNCTION__, 197, iter->used);
  return -1;
 }
 ...
 do { if (iter) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c", 216, (iter)); (iter) = 
# 216 "/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c" 3 4
((void *)0)
# 216 "/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
; } } while (0);
...
static ACL_DBUF *acl_dbuf_alloc(ACL_DBUF_POOL *pool, size_t length)
{
 ...
 ACL_DBUF *dbuf = (ACL_DBUF*) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c", 226, sizeof(ACL_DBUF) + length);
...
# 253 "/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c" 3 4
                       ((void *)0)
# 253 "/workspace/acl/lib_acl/src/stdlib/memory/acl_dbuf_pool.c"
                           )
