# 1 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 2
# 23 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
# 1 "/workspace/acl/lib_acl/src/stdlib/memory/ring.h" 1
# 9 "/workspace/acl/lib_acl/src/stdlib/memory/ring.h"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/7/include/stddef.h" 1 3 4
# 10 "/workspace/acl/lib_acl/src/stdlib/memory/ring.h" 2
...
# 24 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 2
...
{
 if (malloc_hook != 
# 41 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                   ((void *)0)
# 41 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                       )
  __slice_malloc_fn = malloc_hook;
 if (calloc_hook != 
# 43 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                   ((void *)0)
# 43 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                       )
  __slice_calloc_fn = calloc_hook;
 if (realloc_hook != 
# 45 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                    ((void *)0)
# 45 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                        )
  __slice_realloc_fn = realloc_hook;
 if (free_hook != 
# 47 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                 ((void *)0)
# 47 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                     )
...
# 110 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
# 129 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
# 151 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
# 208 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
static void slice3_mbuf_alloc(ACL_SLICE *slice)
{
 ...
 mbuf = (MBUF3*) __slice_malloc_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 222, slice->page_size);
 mbuf->mbuf.slice = slice;
 mbuf->mbuf.nused = 0;
 mbuf->mbuf.signature = 0xdead;
 ptr = mbuf->payload;

 slice->nalloc++;
 mbuf->mslots.slots = 
# 229 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                     ((void *)0)
# 229 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                         ;

 n = slice->page_nslots;
 do { MBUF_SLOTS *mslots = &mbuf->mslots; if (mslots->slots == 
# 232 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void *)0)
# 232 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
) { incr_real = n < slice->page_nslots ? slice->page_nslots : n; mslots->slots = (void **) __slice_malloc_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 232, sizeof(void*) * incr_real); mslots->nslots = incr_real; mslots->islots = 0; } else if (mslots->islots + n >= mslots->nslots) { incr_real = n < slice->page_nslots ? slice->page_nslots : n; mslots->nslots += incr_real; mslots->slots = (void **) __slice_realloc_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 232, mslots->slots, sizeof(void*) * mslots->nslots); } } while (0);
 
# 233 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void) sizeof ((
# 233 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
mbuf->mslots.islots == 0
# 233 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
...
"mbuf->mslots.islots == 0"
# 233 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 233, __extension__ __PRETTY_FUNCTION__); }))
# 233 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                    ;
 ...
 for (i = 0; i < slice->page_nslots; i++) {
   ...
   && ((uintptr_t)ptr & 0x7) != 0)
  {
   acl_msg_fatal("%s(%d): %s, ptr(%lx) invalid",
    myname, 242, slice->name, (long) ptr);
  }

  *((int*) (ptr - 4)) = (int) (ptr - (char*) mbuf);
 ...
 for (i = slice->page_nslots; i < incr_real; i++)
  mbuf->mslots.slots[i] = 
# 251 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                         ((void *)0)
# 251 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                             ;

 do { if (slice3->mbufs == 
# 253 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void *)0)
# 253 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
) { incr_real = 1 > 16 ? 1 : 16; slice3->mbufs = (MBUF3**) __slice_malloc_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 253, sizeof(MBUF3*) * incr_real); slice3->capacity = incr_real; slice3->imbuf_avail = 0; } else if (slice3->slice.nbuf + 1 >= slice3->capacity) { incr_real = 1 > 16 ? 1 : 16; slice3->capacity += incr_real; slice3->mbufs = (MBUF3**) __slice_realloc_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 253, slice3->mbufs, sizeof(MBUF3*) * slice3->capacity); } } while (0);
 for (i = slice->nbuf; i < slice3->capacity; i++)
  slice3->mbufs[i] = 
# 255 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                    ((void *)0)
# 255 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                        ;
...
static void *slice3_alloc(ACL_SLICE *slice)
{
 SLICE3 *slice3 = (SLICE3*) slice;
 MBUF3 *mbuf = 
# 265 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
              ((void *)0)
# 265 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                  ;
 char *ptr;
 int i;
...
# 272 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void) sizeof ((
# 272 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
slice->nbuf > 0 && slice3->mbufs[slice->nbuf - 1]->mslots.islots > 0
# 272 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 272 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
slice->nbuf > 0 && slice3->mbufs[slice->nbuf - 1]->mslots.islots > 0
...
"slice->nbuf > 0 && slice3->mbufs[slice->nbuf - 1]->mslots.islots > 0"
# 272 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 272, __extension__ __PRETTY_FUNCTION__); }))
                                                    
# 273 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                                   ;
 
# 274 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void) sizeof ((
# 274 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
slice3->imbuf_avail >= 0 && slice3->imbuf_avail < slice->nbuf
# 274 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 274 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
slice3->imbuf_avail >= 0 && slice3->imbuf_avail < slice->nbuf
...
"slice3->imbuf_avail >= 0 && slice3->imbuf_avail < slice->nbuf"
# 274 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 274, __extension__ __PRETTY_FUNCTION__); }))
# 274 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                                                         ;
...
# 284 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
 ((void) sizeof ((
# 284 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
 mbuf && mbuf->mslots.islots > 0
# 284 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 284 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
 mbuf && mbuf->mslots.islots > 0
...
# 284 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
 "mbuf && mbuf->mslots.islots > 0"
# 284 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
 , "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 284, __extension__ __PRETTY_FUNCTION__); }))
# 284 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                            ;
 } else {
  mbuf = slice3->mbufs[slice3->imbuf_avail];
  
# 287 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
 ((void) sizeof ((
# 287 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
 mbuf->mslots.islots > 0
# 287 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 287 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
# 287 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
 "mbuf->mslots.islots > 0"
# 287 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
 , "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 287, __extension__ __PRETTY_FUNCTION__); }))
# 287 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                    ;
...
# 292 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
  ((void) sizeof ((
# 292 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
  mbuf->mslots.islots > 0
# 292 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
  ) ? 1 : 0), __extension__ ({ if (
# 292 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
# 292 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
  "mbuf->mslots.islots > 0"
# 292 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
  , "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 292, __extension__ __PRETTY_FUNCTION__); }))
# 292 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                     ;
   slice3->imbuf_avail = i;
  }
  
# 295 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
 ((void) sizeof ((
# 295 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
 mbuf->mslots.islots > 0
# 295 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 295 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
# 295 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
 "mbuf->mslots.islots > 0"
# 295 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
 , "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 295, __extension__ __PRETTY_FUNCTION__); }))
# 295 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                    ;
 }
...
# 308 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void) sizeof ((
# 308 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
mbuf->ibuf + 1 == slice->nbuf
# 308 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 308 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
mbuf->ibuf + 1 == slice->nbuf
...
"mbuf->ibuf + 1 == slice->nbuf"
# 308 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 308, __extension__ __PRETTY_FUNCTION__); }))
# 308 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                         ;
 ...
 __slice_free_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 315, mbuf->mslots.slots);
 __slice_free_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 316, mbuf);
 slice->nbuf--;
 slice->nfree++;
 slice->length -= slice->page_size + sizeof(void*) * slice->page_nslots;
}

static void slice3_free(ACL_SLICE *slice_dummy __attribute__ ((__unused__)), void *buf)
{
 ...
 if (mbuf->mbuf.signature != 0xdead)
  acl_msg_fatal("%s(%d): off (%u), corrupt or unallocated "
   "memory block(0x%x, 0x%x)", myname, 336, off,
   mbuf->mbuf.signature, 0xdead);
...
# 342 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void) sizeof ((
# 342 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
mbuf->ibuf < (int) slice->nbuf
# 342 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 342 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
mbuf->ibuf < (int) slice->nbuf
...
"mbuf->ibuf < (int) slice->nbuf"
# 342 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 342, __extension__ __PRETTY_FUNCTION__); }))
# 342 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                          ;
 
# 343 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void) sizeof ((
# 343 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
mbuf->mslots.islots < mbuf->mslots.nslots
# 343 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 343 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
mbuf->mslots.islots < mbuf->mslots.nslots
...
"mbuf->mslots.islots < mbuf->mslots.nslots"
# 343 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 343, __extension__ __PRETTY_FUNCTION__); }))
# 343 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                                     ;
 ...
 if (mbuf->mbuf.nused == 0 && !(slice->flag & (1 << 10)))
...
static void slice3_destroy(ACL_SLICE *slice)
{
 ...
 __slice_free_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 403, slice3->mbufs);
 __slice_free_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 404, slice3);
}
 ...
 int slice_length, unsigned int flag)
{
 ...
 slice = (SLICE3 *) __slice_calloc_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 438,
   1, sizeof(SLICE3));
 ...
 do { if (slice->mbufs == 
# 447 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void *)0)
# 447 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
) { incr_real = 3202 > 16 ? 3202 : 16; slice->mbufs = (MBUF3**) __slice_malloc_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 447, sizeof(MBUF3*) * incr_real); slice->capacity = incr_real; slice->imbuf_avail = 0; } else if (slice->slice.nbuf + 3202 >= slice->capacity) { incr_real = 3202 > 16 ? 3202 : 16; slice->capacity += incr_real; slice->mbufs = (MBUF3**) __slice_realloc_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 447, slice->mbufs, sizeof(MBUF3*) * slice->capacity); } } while (0);
 ...
 slice->slice.slice_size = slice_length + 4;
...
static void slice2_mbuf_alloc(ACL_SLICE *slice)
{
 ...
 mbuf = (MBUF2*) __slice_malloc_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 495, slice->page_size);
 mbuf->mbuf.slice = slice;
 mbuf->mbuf.nused = 0;
 mbuf->mbuf.signature = 0xdead;
 do { RING *ring = &slice2->mbuf_head; RING *entry = &mbuf->entry; entry->succ = ring->succ; entry->pred = ring; ring->succ->pred = entry; ring->succ = entry; } while (0);
 ptr = mbuf->payload;

 slice->nalloc++;
 n = slice->page_nslots;
 do { MBUF_SLOTS *mslots = &slice2->mslots; if (mslots->slots == 
# 504 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void *)0)
# 504 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
) { incr_real = n < slice->page_nslots ? slice->page_nslots : n; mslots->slots = (void **) __slice_malloc_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 504, sizeof(void*) * incr_real); mslots->nslots = incr_real; mslots->islots = 0; } else if (mslots->islots + n >= mslots->nslots) { incr_real = n < slice->page_nslots ? slice->page_nslots : n; mslots->nslots += incr_real; mslots->slots = (void **) __slice_realloc_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 504, mslots->slots, sizeof(void*) * mslots->nslots); } } while (0);
 ...
 for (i = 0; i < slice->page_nslots; i++) {
  ...
  {
   acl_msg_fatal("%s(%d): %s, ptr(%lx) invalid, "
    "slice_length: %d", myname, 513,
    slice->name, (long) ptr, slice->slice_length);
  }

  *((int*) (ptr - (4 + 4))) = (int) slice2->mslots.islots;
  *((int*) (ptr - 4)) = (int) (ptr - (char*) mbuf);
 ...
 for (i = slice->page_nslots; i < incr_real; i++)
  slice2->mslots.slots[i] = 
# 524 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                           ((void *)0)
# 524 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                               ;
...
static void *slice2_alloc(ACL_SLICE *slice)
{
 ...
 off = *((int*) (ptr - 4));
 if (off < 0)
  acl_msg_fatal("%s(%d): off(%d) invalid", myname, 546, off);
 pos = *((int*) (ptr - (4 + 4)));
 if (pos < 0)
  acl_msg_fatal("%s(%d): pos(%d) invalid", myname, 549, pos);
 ...
 if (mbuf->mbuf.signature != 0xdead) {
  acl_msg_info("%s(%d): %s, off(%d), nused(%d), islots(%d)"
   ...
   ", page_nslots(%d), page_size(%d)", myname, 556,
  ...
  acl_msg_fatal("%s(%d): %s, corrupt or unallocated "
   "memory block(0x%x, 0x%x)", myname, 563,
   slice->name, mbuf->mbuf.signature, 0xdead);
 }
...
static void slice2_mbuf_free(SLICE2 *slice2, MBUF2 *mbuf)
{
 ...
 int i;
 int pos;
# 637 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
 ...
 for (i = slice2->slice.page_nslots - 1; i >= 0; i--) {
  ...
  if ((char*) slice2->mslots.slots[pos] != ptr + (4 + 4))
 ...
 do { RING *entry = &mbuf->entry; RING *succ; RING *pred; succ = entry->succ; pred = entry->pred; if (succ != 
# 669 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void *)0) 
# 669 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
&& pred != 
# 669 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void *)0)
# 669 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
) { pred->succ = succ; succ->pred = pred; entry->succ = entry->pred = 0; } } while (0);
 __slice_free_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 670, mbuf);
 slice2->slice.nbuf--;
 slice2->slice.nfree++;
}

static void slice2_free(ACL_SLICE *slice_dummy __attribute__ ((__unused__)), void *buf)
{
 ...
 off = *((int*) (ptr - 4));
 if (off < 0)
  acl_msg_fatal("%s(%d): off(%d) invalid", myname, 687, off);

 mbuf = (MBUF2 *) (ptr - off);
 if (mbuf->mbuf.signature != 0xdead)
  acl_msg_fatal("%s(%d), (off %d): corrupt or unallocated "
   "memory block(0x%x, 0x%x)", myname, 692, off,
   mbuf->mbuf.signature, 0xdead);
 ...
 if (slice != slice_dummy)
  acl_msg_fatal("%s(%d): %s invalid",
   myname, 700, slice->name);

 if (mbuf->mbuf.nused <= 0)
  acl_msg_fatal("%s(%d): %s, nused(%d) <= 0",
   myname, 704, slice->name, mbuf->mbuf.nused);

 do { MBUF_SLOTS *mslots = &slice2->mslots; if (mslots->slots == 
# 706 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void *)0)
# 706 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
) { incr_real = 1 < slice->page_nslots ? slice->page_nslots : 1; mslots->slots = (void **) __slice_malloc_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 706, sizeof(void*) * incr_real); mslots->nslots = incr_real; mslots->islots = 0; } else if (mslots->islots + 1 >= mslots->nslots) { incr_real = 1 < slice->page_nslots ? slice->page_nslots : 1; mslots->nslots += incr_real; mslots->slots = (void **) __slice_realloc_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 706, mslots->slots, sizeof(void*) * mslots->nslots); } } while (0);
 slice2->mslots.slots[slice2->mslots.islots] = ptr;
 ...
 *((int*) (ptr - (4 + 4))) = (int) slice2->mslots.islots++;
 ...
 mbuf->mbuf.nused--;
 if (mbuf->mbuf.nused == 0 && !(slice->flag & (1 << 10))) {
  if (mbuf->payload > ptr - (4 + 4))
   acl_msg_fatal("%s(%d): %s, ptr overflow",
    myname, 716, slice->name);
...
static int slice2_gc(ACL_SLICE *slice)
{
 ...
 for (iter = ((&slice2->mbuf_head)->succ); iter != &slice2->mbuf_head;) {
  tmp = ((iter)->succ);
  mbuf = ((MBUF2 *) (((char *) (iter)) - 
# 731 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        __builtin_offsetof (
# 731 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
        MBUF2
# 731 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        , 
# 731 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
static int slice2_used(ACL_SLICE *slice)
{
 ...
 for (iter = ((&slice2->mbuf_head)->succ); iter != &slice2->mbuf_head;) {
  mbuf = ((MBUF2 *) (((char *) (iter)) - 
# 750 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        __builtin_offsetof (
# 750 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
        MBUF2
# 750 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        , 
# 750 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
static void slice2_destroy(ACL_SLICE *slice)
{
 ...
 for (iter = ((&slice2->mbuf_head)->succ); iter != &slice2->mbuf_head;) {
  tmp = ((iter)->succ);
  mbuf = ((MBUF2 *) (((char *) (iter)) - 
# 765 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        __builtin_offsetof (
# 765 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
        MBUF2
# 765 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        , 
# 765 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
# 765 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
  ...
  __slice_free_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 766, mbuf);
  iter = tmp;
 }

 if (slice2->mslots.slots)
  __slice_free_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 771, slice2->mslots.slots);
 __slice_free_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 772, slice2);
}
 ...
 int slice_length, unsigned int flag)
{
 SLICE2 *slice = (SLICE2 *) __slice_calloc_fn(
   "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 796, 1, sizeof(SLICE2));
 ...
 slice->mslots.slots = 
# 804 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                      ((void *)0)
# 804 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                          ;
 slice->mslots.nslots = 0;
 slice->mslots.islots = 0;

 do { RING *ring = &slice->mbuf_head; ring->pred = ring->succ = ring; } while (0);


 if ((flag & (1 << 11)) != 0) {
  if ((slice_length + (4 + 4)) % sizeof(uintptr_t) != 0) {
   slice_length = ((slice_length + (4 + 4))
    / sizeof(uintptr_t) + 1) * sizeof(uintptr_t)
    - (4 + 4);
  }
 }
 ...
 slice->slice.slice_length = slice_length;
 slice->slice.slice_size = slice_length + (4 + 4);
 slice->slice.page_size = page_size;
...
static void slice1_mbuf_alloc(ACL_SLICE *slice)
{
 ...
 mbuf = (MBUF1*) __slice_malloc_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 851, slice->page_size);
 mbuf->mbuf.slice = slice;
 mbuf->mbuf.nused = 0;
 mbuf->mbuf.signature = 0xdead;
 do { RING *ring = &slice1->mbuf_head; RING *entry = &mbuf->entry; entry->succ = ring->succ; entry->pred = ring; ring->succ->pred = entry; ring->succ = entry; } while (0);
 ptr = mbuf->payload;

 slice->nalloc++;
 n = slice->page_nslots;
 do { MBUF_SLOTS *mslots = &slice1->mslots; if (mslots->slots == 
# 860 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void *)0)
# 860 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
) { incr_real = n < slice->page_nslots ? slice->page_nslots : n; mslots->slots = (void **) __slice_malloc_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 860, sizeof(void*) * incr_real); mslots->nslots = incr_real; mslots->islots = 0; } else if (mslots->islots + n >= mslots->nslots) { incr_real = n < slice->page_nslots ? slice->page_nslots : n; mslots->nslots += incr_real; mslots->slots = (void **) __slice_realloc_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 860, mslots->slots, sizeof(void*) * mslots->nslots); } } while (0);
 ...
 for (i = slice->page_nslots; i < incr_real; i++)
  slice1->mslots.slots[i] = 
# 869 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                           ((void *)0)
# 869 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                               ;
...
static void slice1_free(ACL_SLICE *slice, void *ptr)
{
 ...
 do { MBUF_SLOTS *mslots = &slice1->mslots; if (mslots->slots == 
# 894 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void *)0)
# 894 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
) { incr_real = 1 < slice->page_nslots ? slice->page_nslots : 1; mslots->slots = (void **) __slice_malloc_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 894, sizeof(void*) * incr_real); mslots->nslots = incr_real; mslots->islots = 0; } else if (mslots->islots + 1 >= mslots->nslots) { incr_real = 1 < slice->page_nslots ? slice->page_nslots : 1; mslots->nslots += incr_real; mslots->slots = (void **) __slice_realloc_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 894, mslots->slots, sizeof(void*) * mslots->nslots); } } while (0);
 slice1->mslots.slots[slice1->mslots.islots++] = ptr;
 slice->used_length -= slice->slice_size;
}
...
static void slice1_mbuf_free(ACL_SLICE *slice, void *buf)
{
 ...
 for (iter = ((&slice1->mbuf_head)->pred); iter != (&slice1->mbuf_head); iter = ((iter)->pred)) {

  mbuf = ((MBUF1 *) (((char *) (iter)) - 
# 911 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        __builtin_offsetof (
# 911 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
        MBUF1
# 911 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        , 
# 911 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
# 911 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
  ...
  if (buf == mbuf->payload) {
   do { RING *entry = &mbuf->entry; RING *succ; RING *pred; succ = entry->succ; pred = entry->pred; if (succ != 
# 913 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
  ((void *)0) 
# 913 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
  && pred != 
# 913 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
  ((void *)0)
# 913 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
  ) { pred->succ = succ; succ->pred = pred; entry->succ = entry->pred = 0; } } while (0);
   __slice_free_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 914, mbuf);
   slice->nbuf--;
   slice->nfree++;
   return;
  }
...
# 926 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void) sizeof ((
# 926 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
p1
# 926 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 926 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
"p1"
# 926 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 926, __extension__ __PRETTY_FUNCTION__); }))
# 926 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
              ;
 
# 927 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void) sizeof ((
# 927 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
p2
# 927 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 927 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
"p2"
# 927 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 927, __extension__ __PRETTY_FUNCTION__); }))
# 927 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
              ;
...
static int slice1_gc(ACL_SLICE *slice)
{
 ...
 if (slice1->mslots.islots > 0) {
  for (i = 0; i < k; i++) {
   ...
   if (slice1->mslots.slots[j + i] == 
# 971 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                                     ((void *)0)
# 971 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                         )
...
static void slice1_destroy(ACL_SLICE *slice)
{
 ...
 for (iter = ((&slice1->mbuf_head)->succ); iter != &slice1->mbuf_head;) {
  tmp = ((iter)->succ);
  mbuf = ((MBUF1 *) (((char *) (iter)) - 
# 988 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        __builtin_offsetof (
# 988 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
        MBUF1
# 988 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        , 
# 988 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
# 988 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
  ...
  __slice_free_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 989, mbuf);
  iter = tmp;
 }
 if (slice1->mslots.slots)
  __slice_free_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 993, slice1->mslots.slots);
 __slice_free_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 994, slice1);
}

static int slice1_used(ACL_SLICE *slice __attribute__ ((__unused__)))
{
 const char *myname = "slice1_used";

 acl_msg_warn("%s(%d): not implement yet!", myname, 1001);
 return 0;
}
...
static ACL_SLICE *slice1_create(int page_size, int slice_length, unsigned int flag)
{
 ...
 slice = (SLICE1 *) __slice_calloc_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 1026,
   1, sizeof(SLICE1));
 ...
 slice->mslots.slots = 
# 1035 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                      ((void *)0)
# 1035 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                          ;
 slice->mslots.nslots = 0;
 slice->mslots.islots = 0;
 ...
 int slice_length, unsigned int flag)
{
 ...
 ACL_SLICE *slice = 
# 1085 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                   ((void *)0)
# 1085 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                       ;
 int size, sys_page_size;


 sys_page_size = getpagesize();
# 1102 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
 ...
 if (size / slice_length < 2) {
  ...
  return 
# 1110 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        ((void *)0)
# 1110 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
            ;
 }
 ...
 if ((flag & (1 << 0)))
  ...
  return 
# 1121 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        ((void *)0)
# 1121 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
            ;
 }
...
void acl_slice_free(void *ptr)
{
 ...
 off = *((int*) ((char*) ptr - 4));
 if (off < 0)
  acl_msg_fatal("%s(%d): off(%d) invalid", myname, 1168, off);
 ...
 unsigned int slice_flag)
{
 ACL_SLICE_POOL *asp = (ACL_SLICE_POOL*)
  __slice_calloc_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 1232, 1, sizeof(*asp));

 asp->base = base;
 asp->nslice = nslice;
 asp->slice_flag = slice_flag;
 asp->slices = (ACL_SLICE**) __slice_calloc_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 1237,
...
void acl_slice_pool_destroy(ACL_SLICE_POOL *asp)
{
 ...
 __slice_free_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 1251, asp->slices);
 __slice_free_fn("/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c", 1252, asp);
}
...
void acl_slice_pool_clean(ACL_SLICE_POOL *asp)
{
 ...
 for (i = 0; i < asp->nslice; i++) {
  acl_slice_destroy(asp->slices[i]);
  asp->slices[i] = 
# 1281 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                  ((void *)0)
# 1281 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                      ;
 }
}
 ...
 ACL_SLICE_POOL *asp, size_t size)
{
 ...
 size += sizeof(size_t);
 if (asp == 
# 1311 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
           ((void *)0) 
# 1311 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                || (int) size >= asp->base * asp->nslice) {
  size += sizeof(size_t);
 ...
 ACL_SLICE_POOL *asp, void *ptr, size_t size)
{
 ...
 if (ptr != 
# 1349 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
           ((void *)0)
# 1349 "/workspace/acl/lib_acl/src/stdlib/memory/acl_slice.c"
               ) {
