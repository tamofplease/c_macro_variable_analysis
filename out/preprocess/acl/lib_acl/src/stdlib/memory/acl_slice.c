# 0 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
# 2 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 2
# 23 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
# 1 "/acl/lib_acl/src/stdlib/memory/ring.h" 1
# 9 "/acl/lib_acl/src/stdlib/memory/ring.h"
# 1 "/usr/lib/gcc/aarch64-linux-gnu/11/include/stddef.h" 1 3 4
# 10 "/acl/lib_acl/src/stdlib/memory/ring.h" 2
...
# 24 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 2
...
{
 if (malloc_hook != 
# 41 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                   ((void *)0)
# 41 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                       )
  __slice_malloc_fn = malloc_hook;
 if (calloc_hook != 
# 43 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                   ((void *)0)
# 43 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                       )
  __slice_calloc_fn = calloc_hook;
 if (realloc_hook != 
# 45 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                    ((void *)0)
# 45 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                        )
  __slice_realloc_fn = realloc_hook;
 if (free_hook != 
# 47 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                 ((void *)0)
# 47 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                     )
...
# 110 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
# 129 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
# 151 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
# 208 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
static void slice3_mbuf_alloc(ACL_SLICE *slice)
{
 ...
 mbuf = (MBUF3*) __slice_malloc_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 222, slice->page_size);
 ...
 slice->nalloc++;
 mbuf->mslots.slots = 
# 229 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                     ((void *)0)
# 229 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                         ;

 n = slice->page_nslots;
 do { MBUF_SLOTS *mslots = &mbuf->mslots; if (mslots->slots == 
# 232 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void *)0)
# 232 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
) { incr_real = n < slice->page_nslots ? slice->page_nslots : n; mslots->slots = (void **) __slice_malloc_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 232, sizeof(void*) * incr_real); mslots->nslots = incr_real; mslots->islots = 0; } else if (mslots->islots + n >= mslots->nslots) { incr_real = n < slice->page_nslots ? slice->page_nslots : n; mslots->nslots += incr_real; mslots->slots = (void **) __slice_realloc_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 232, mslots->slots, sizeof(void*) * mslots->nslots); } } while (0);
 
# 233 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void) sizeof ((
# 233 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
"mbuf->mslots.islots == 0"
# 233 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/acl_slice.c", 233, __extension__ __PRETTY_FUNCTION__); }))
# 233 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                    ;
 ...
 for (i = slice->page_nslots; i < incr_real; i++)
  mbuf->mslots.slots[i] = 
# 251 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                         ((void *)0)
# 251 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                             ;

 do { if (slice3->mbufs == 
# 253 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void *)0)
# 253 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
) { incr_real = 1 > 16 ? 1 : 16; slice3->mbufs = (MBUF3**) __slice_malloc_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 253, sizeof(MBUF3*) * incr_real); slice3->capacity = incr_real; slice3->imbuf_avail = 0; } else if (slice3->slice.nbuf + 1 >= slice3->capacity) { incr_real = 1 > 16 ? 1 : 16; slice3->capacity += incr_real; slice3->mbufs = (MBUF3**) __slice_realloc_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 253, slice3->mbufs, sizeof(MBUF3*) * slice3->capacity); } } while (0);
 for (i = slice->nbuf; i < slice3->capacity; i++)
  slice3->mbufs[i] = 
# 255 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                    ((void *)0)
# 255 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                        ;
...
static void *slice3_alloc(ACL_SLICE *slice)
{
 SLICE3 *slice3 = (SLICE3*) slice;
 MBUF3 *mbuf = 
# 265 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
              ((void *)0)
# 265 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                  ;
 char *ptr;
 int i;
...
# 272 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void) sizeof ((
# 272 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
"slice->nbuf > 0 && slice3->mbufs[slice->nbuf - 1]->mslots.islots > 0"
# 272 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/acl_slice.c", 272, __extension__ __PRETTY_FUNCTION__); }))
                                                    
# 273 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                                   ;
 
# 274 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void) sizeof ((
# 274 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
"slice3->imbuf_avail >= 0 && slice3->imbuf_avail < slice->nbuf"
# 274 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/acl_slice.c", 274, __extension__ __PRETTY_FUNCTION__); }))
# 274 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                                                         ;
...
# 284 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
 ((void) sizeof ((
# 284 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
# 284 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
 "mbuf && mbuf->mslots.islots > 0"
# 284 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
 , "/acl/lib_acl/src/stdlib/memory/acl_slice.c", 284, __extension__ __PRETTY_FUNCTION__); }))
# 284 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                            ;
 } else {
  mbuf = slice3->mbufs[slice3->imbuf_avail];
  
# 287 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
 ((void) sizeof ((
# 287 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
 mbuf->mslots.islots > 0
# 287 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 287 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
# 287 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
 "mbuf->mslots.islots > 0"
# 287 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
 , "/acl/lib_acl/src/stdlib/memory/acl_slice.c", 287, __extension__ __PRETTY_FUNCTION__); }))
# 287 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                    ;
...
# 292 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
  ((void) sizeof ((
# 292 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
  mbuf->mslots.islots > 0
# 292 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
  ) ? 1 : 0), __extension__ ({ if (
# 292 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
# 292 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
  "mbuf->mslots.islots > 0"
# 292 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
  , "/acl/lib_acl/src/stdlib/memory/acl_slice.c", 292, __extension__ __PRETTY_FUNCTION__); }))
# 292 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                     ;
   slice3->imbuf_avail = i;
  }
  
# 295 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
 ((void) sizeof ((
# 295 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
 mbuf->mslots.islots > 0
# 295 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 295 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
# 295 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
 "mbuf->mslots.islots > 0"
# 295 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
 , "/acl/lib_acl/src/stdlib/memory/acl_slice.c", 295, __extension__ __PRETTY_FUNCTION__); }))
# 295 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                    ;
 }
...
# 308 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void) sizeof ((
# 308 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
"mbuf->ibuf + 1 == slice->nbuf"
# 308 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/acl_slice.c", 308, __extension__ __PRETTY_FUNCTION__); }))
# 308 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                         ;
 ...
 __slice_free_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 315, mbuf->mslots.slots);
 __slice_free_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 316, mbuf);
 slice->nbuf--;
 slice->nfree++;
 slice->length -= slice->page_size + sizeof(void*) * slice->page_nslots;
}
...
# 342 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void) sizeof ((
# 342 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
"mbuf->ibuf < (int) slice->nbuf"
# 342 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/acl_slice.c", 342, __extension__ __PRETTY_FUNCTION__); }))
# 342 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                          ;
 
# 343 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void) sizeof ((
# 343 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
"mbuf->mslots.islots < mbuf->mslots.nslots"
# 343 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/acl_slice.c", 343, __extension__ __PRETTY_FUNCTION__); }))
# 343 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                                     ;
...
static void slice3_destroy(ACL_SLICE *slice)
{
 ...
 __slice_free_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 403, slice3->mbufs);
 __slice_free_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 404, slice3);
}
 ...
 int slice_length, unsigned int flag)
{
 ...
 slice = (SLICE3 *) __slice_calloc_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 438,
   1, sizeof(SLICE3));
 ...
 do { if (slice->mbufs == 
# 447 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void *)0)
# 447 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
) { incr_real = 3202 > 16 ? 3202 : 16; slice->mbufs = (MBUF3**) __slice_malloc_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 447, sizeof(MBUF3*) * incr_real); slice->capacity = incr_real; slice->imbuf_avail = 0; } else if (slice->slice.nbuf + 3202 >= slice->capacity) { incr_real = 3202 > 16 ? 3202 : 16; slice->capacity += incr_real; slice->mbufs = (MBUF3**) __slice_realloc_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 447, slice->mbufs, sizeof(MBUF3*) * slice->capacity); } } while (0);
...
static void slice2_mbuf_alloc(ACL_SLICE *slice)
{
 ...
 mbuf = (MBUF2*) __slice_malloc_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 495, slice->page_size);
 mbuf->mbuf.slice = slice;
 mbuf->mbuf.nused = 0;
 mbuf->mbuf.signature = 0xdead;
...
# 504 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void *)0)
# 504 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
) { incr_real = n < slice->page_nslots ? slice->page_nslots : n; mslots->slots = (void **) __slice_malloc_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 504, sizeof(void*) * incr_real); mslots->nslots = incr_real; mslots->islots = 0; } else if (mslots->islots + n >= mslots->nslots) { incr_real = n < slice->page_nslots ? slice->page_nslots : n; mslots->nslots += incr_real; mslots->slots = (void **) __slice_realloc_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 504, mslots->slots, sizeof(void*) * mslots->nslots); } } while (0);
...
# 524 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                           ((void *)0)
# 524 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                               ;
...
static void slice2_mbuf_free(SLICE2 *slice2, MBUF2 *mbuf)
{
 ...
 int i;
 int pos;
# 637 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
# 669 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void *)0) 
# 669 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
&& pred != 
# 669 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void *)0)
# 669 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
) { pred->succ = succ; succ->pred = pred; entry->succ = entry->pred = 0; } } while (0);
 __slice_free_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 670, mbuf);
 slice2->slice.nbuf--;
 slice2->slice.nfree++;
}
...
static void slice2_free(ACL_SLICE *slice_dummy __attribute__ ((__unused__)), void *buf)
{
 ...
 do { MBUF_SLOTS *mslots = &slice2->mslots; if (mslots->slots == 
# 706 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void *)0)
# 706 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
) { incr_real = 1 < slice->page_nslots ? slice->page_nslots : 1; mslots->slots = (void **) __slice_malloc_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 706, sizeof(void*) * incr_real); mslots->nslots = incr_real; mslots->islots = 0; } else if (mslots->islots + 1 >= mslots->nslots) { incr_real = 1 < slice->page_nslots ? slice->page_nslots : 1; mslots->nslots += incr_real; mslots->slots = (void **) __slice_realloc_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 706, mslots->slots, sizeof(void*) * mslots->nslots); } } while (0);
 slice2->mslots.slots[slice2->mslots.islots] = ptr;
...
# 731 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        __builtin_offsetof (
# 731 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
        MBUF2
# 731 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        , 
# 731 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
static int slice2_used(ACL_SLICE *slice)
{
 ...
 for (iter = ((&slice2->mbuf_head)->succ); iter != &slice2->mbuf_head;) {
  mbuf = ((MBUF2 *) (((char *) (iter)) - 
# 750 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        __builtin_offsetof (
# 750 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
        MBUF2
# 750 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        , 
# 750 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
static void slice2_destroy(ACL_SLICE *slice)
{
 ...
 for (iter = ((&slice2->mbuf_head)->succ); iter != &slice2->mbuf_head;) {
  tmp = ((iter)->succ);
  mbuf = ((MBUF2 *) (((char *) (iter)) - 
# 765 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        __builtin_offsetof (
# 765 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
        MBUF2
# 765 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        , 
# 765 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
# 765 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
  ...
  __slice_free_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 766, mbuf);
  iter = tmp;
 }

 if (slice2->mslots.slots)
  __slice_free_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 771, slice2->mslots.slots);
 __slice_free_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 772, slice2);
}
 ...
 int slice_length, unsigned int flag)
{
 SLICE2 *slice = (SLICE2 *) __slice_calloc_fn(
   "/acl/lib_acl/src/stdlib/memory/acl_slice.c", 796, 1, sizeof(SLICE2));
 ...
 slice->mslots.slots = 
# 804 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                      ((void *)0)
# 804 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                          ;
...
static void slice1_mbuf_alloc(ACL_SLICE *slice)
{
 ...
 mbuf = (MBUF1*) __slice_malloc_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 851, slice->page_size);
 mbuf->mbuf.slice = slice;
 mbuf->mbuf.nused = 0;
 mbuf->mbuf.signature = 0xdead;
...
# 860 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void *)0)
# 860 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
) { incr_real = n < slice->page_nslots ? slice->page_nslots : n; mslots->slots = (void **) __slice_malloc_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 860, sizeof(void*) * incr_real); mslots->nslots = incr_real; mslots->islots = 0; } else if (mslots->islots + n >= mslots->nslots) { incr_real = n < slice->page_nslots ? slice->page_nslots : n; mslots->nslots += incr_real; mslots->slots = (void **) __slice_realloc_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 860, mslots->slots, sizeof(void*) * mslots->nslots); } } while (0);
...
# 869 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                           ((void *)0)
# 869 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                               ;
...
static void slice1_free(ACL_SLICE *slice, void *ptr)
{
 ...
 do { MBUF_SLOTS *mslots = &slice1->mslots; if (mslots->slots == 
# 894 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void *)0)
# 894 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
) { incr_real = 1 < slice->page_nslots ? slice->page_nslots : 1; mslots->slots = (void **) __slice_malloc_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 894, sizeof(void*) * incr_real); mslots->nslots = incr_real; mslots->islots = 0; } else if (mslots->islots + 1 >= mslots->nslots) { incr_real = 1 < slice->page_nslots ? slice->page_nslots : 1; mslots->nslots += incr_real; mslots->slots = (void **) __slice_realloc_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 894, mslots->slots, sizeof(void*) * mslots->nslots); } } while (0);
 slice1->mslots.slots[slice1->mslots.islots++] = ptr;
 slice->used_length -= slice->slice_size;
}
...
# 911 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        __builtin_offsetof (
# 911 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
        MBUF1
# 911 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        , 
# 911 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
# 911 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
  ...
  if (buf == mbuf->payload) {
   do { RING *entry = &mbuf->entry; RING *succ; RING *pred; succ = entry->succ; pred = entry->pred; if (succ != 
# 913 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
  ((void *)0) 
# 913 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
  && pred != 
# 913 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
  ((void *)0)
# 913 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
  ) { pred->succ = succ; succ->pred = pred; entry->succ = entry->pred = 0; } } while (0);
   __slice_free_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 914, mbuf);
   slice->nbuf--;
   slice->nfree++;
   return;
  }
...
# 926 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void) sizeof ((
# 926 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
p1
# 926 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 926 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
"p1"
# 926 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/acl_slice.c", 926, __extension__ __PRETTY_FUNCTION__); }))
# 926 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
              ;
 
# 927 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
((void) sizeof ((
# 927 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
p2
# 927 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 927 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
"p2"
# 927 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/acl_slice.c", 927, __extension__ __PRETTY_FUNCTION__); }))
# 927 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
              ;
...
# 971 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                                     ((void *)0)
# 971 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                                         )
...
static void slice1_destroy(ACL_SLICE *slice)
{
 ...
 for (iter = ((&slice1->mbuf_head)->succ); iter != &slice1->mbuf_head;) {
  tmp = ((iter)->succ);
  mbuf = ((MBUF1 *) (((char *) (iter)) - 
# 988 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        __builtin_offsetof (
# 988 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
        MBUF1
# 988 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        , 
# 988 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
...
# 988 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
  ...
  __slice_free_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 989, mbuf);
  iter = tmp;
 }
 if (slice1->mslots.slots)
  __slice_free_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 993, slice1->mslots.slots);
 __slice_free_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 994, slice1);
}
...
static ACL_SLICE *slice1_create(int page_size, int slice_length, unsigned int flag)
{
 ...
 slice = (SLICE1 *) __slice_calloc_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 1026,
   1, sizeof(SLICE1));
 ...
 slice->mslots.slots = 
# 1035 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                      ((void *)0)
# 1035 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                          ;
 slice->mslots.nslots = 0;
 slice->mslots.islots = 0;
 ...
 int slice_length, unsigned int flag)
{
 ...
 ACL_SLICE *slice = 
# 1085 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                   ((void *)0)
# 1085 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                       ;
 int size, sys_page_size;


 sys_page_size = getpagesize();
# 1102 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
 ...
 if (size / slice_length < 2) {
  ...
  return 
# 1110 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        ((void *)0)
# 1110 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
            ;
 }
 ...
 if ((flag & (1 << 0)))
  ...
  return 
# 1121 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
        ((void *)0)
# 1121 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
            ;
 }
 ...
 unsigned int slice_flag)
{
 ACL_SLICE_POOL *asp = (ACL_SLICE_POOL*)
  __slice_calloc_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 1232, 1, sizeof(*asp));

 asp->base = base;
 asp->nslice = nslice;
 asp->slice_flag = slice_flag;
 asp->slices = (ACL_SLICE**) __slice_calloc_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 1237,
...
void acl_slice_pool_destroy(ACL_SLICE_POOL *asp)
{
 ...
 __slice_free_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 1251, asp->slices);
 __slice_free_fn("/acl/lib_acl/src/stdlib/memory/acl_slice.c", 1252, asp);
}
...
void acl_slice_pool_clean(ACL_SLICE_POOL *asp)
{
 ...
 for (i = 0; i < asp->nslice; i++) {
  acl_slice_destroy(asp->slices[i]);
  asp->slices[i] = 
# 1281 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
                  ((void *)0)
# 1281 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
                      ;
 }
}
 ...
 ACL_SLICE_POOL *asp, size_t size)
{
 ...
 size += sizeof(size_t);
 if (asp == 
# 1311 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
           ((void *)0) 
# 1311 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
 ...
 ACL_SLICE_POOL *asp, void *ptr, size_t size)
{
 ...
 if (ptr != 
# 1349 "/acl/lib_acl/src/stdlib/memory/acl_slice.c" 3 4
           ((void *)0)
# 1349 "/acl/lib_acl/src/stdlib/memory/acl_slice.c"
               ) {
