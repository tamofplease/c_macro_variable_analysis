# 1 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 2
# 20 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
# 1 "/workspace/acl/lib_acl/src/stdlib/memory/allocator.h" 1
# 9 "/workspace/acl/lib_acl/src/stdlib/memory/allocator.h"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_stack.h" 1
# 10 "/workspace/acl/lib_acl/src/stdlib/memory/allocator.h" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_allocator.h" 1
# 11 "/workspace/acl/lib_acl/src/stdlib/memory/allocator.h" 2
...
# 21 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 2
# 1 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.h" 1
# 27 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.h"
typedef struct {
 unsigned int bytes;
 unsigned int kb;
} kb_t;
...
# 22 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 2



static const size_t mem_unlimited_size = 2 * 1024 * ((size_t)1024*1024) - 1;
# 36 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
# 51 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
static double toMB(size_t size)
{
 return ((double) size) / ((size_t)1024*1024);
}
...
# 64 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 64 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
pool
# 64 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
...
"pool"
# 64 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 64, __extension__ __PRETTY_FUNCTION__); }))
# 64 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                ;
...
# 75 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 75 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
m
# 75 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 75 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
"m"
# 75 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 75, __extension__ __PRETTY_FUNCTION__); }))
# 75 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
             ;
 if (m->hwater_level < m->level) {
  m->hwater_level = m->level;
  m->hwater_stamp = time(
# 78 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
                        ((void *)0)
# 78 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                            );
 }
}
...
# 87 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 87 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
pool
# 87 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 87 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
"pool"
# 87 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 87, __extension__ __PRETTY_FUNCTION__); }))
# 87 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                ;
 while (pool->meter.idle.level > new_limit
  ...
  { (allocator->TheMeter.idle).level -= (((ACL_MEM_POOL *)pool)->obj_size); }
                                    ;
  { (allocator->TheMeter.alloc).level -= (((ACL_MEM_POOL *) pool)->obj_size); }
                                     ;
  ptr = acl_stack_pop(((ACL_MEM_POOL *) pool)->pstack);
  acl_default_free("/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 97, ptr);
 }
 
# 99 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 99 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
pool->meter.idle.level <= new_limit
# 99 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 99 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
pool->meter.idle.level <= new_limit
...
"pool->meter.idle.level <= new_limit"
# 99 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 99, __extension__ __PRETTY_FUNCTION__); }))
# 99 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                                               ;
}
...
static void memShrink(SQUID_MEM_ALLOCATOR *allocator, size_t new_limit)
{
 ...
 for ((((ACL_ALLOCATOR *) allocator)->pools)->iter_tail(&(iter), (((ACL_ALLOCATOR *) allocator)->pools)); (iter).ptr; (((ACL_ALLOCATOR *) allocator)->pools)->iter_prev(&(iter), (((ACL_ALLOCATOR *) allocator)->pools))) {
...
# 128 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 128 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
allocator->TheMeter.idle.level <= new_limit
# 128 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 128 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
allocator->TheMeter.idle.level <= new_limit
...
"allocator->TheMeter.idle.level <= new_limit"
# 128 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 128, __extension__ __PRETTY_FUNCTION__); }))
# 128 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                                                       ;
}
...
static void memCleanModule(ACL_ALLOCATOR *allocator)
{
 ...
 for ((allocator->pools)->iter_tail(&(iter), (allocator->pools)); (iter).ptr; (allocator->pools)->iter_prev(&(iter), (allocator->pools))) {
 ...
 acl_stack_clean(allocator->pools, 
# 154 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
                                  ((void *)0)
# 154 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                                      );
}
...
# 178 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 178 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
((SQUID_MEM_ALLOCATOR *) allocator)->TheMeter.idle.level <= new_pool_limit
# 178 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 178 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
((SQUID_MEM_ALLOCATOR *) allocator)->TheMeter.idle.level <= new_pool_limit
...
"((SQUID_MEM_ALLOCATOR *) allocator)->TheMeter.idle.level <= new_pool_limit"
# 178 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 178, __extension__ __PRETTY_FUNCTION__); }))
                    
# 179 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                   ;
...
{
 ACL_MEM_POOL *pool = acl_default_calloc("/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 187,
  1, sizeof(MemPool));
...
static void memPoolDestroy(ACL_MEM_POOL * pool)
{
 ...
 for ((pool->pstack)->iter_tail(&(iter), (pool->pstack)); (iter).ptr; (pool->pstack)->iter_prev(&(iter), (pool->pstack))) {
  obj = iter.data;
  if (pool->before_free_fn)
   pool->before_free_fn(obj, pool->pool_ctx);
  acl_default_free("/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 204, obj);
 }

 acl_default_free("/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 207, pool);
}
# 218 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
 ...
 ACL_ALLOCATOR *allocator, ACL_MEM_POOL * pool)
{
 ...
 { (squid_pool->meter.inuse).level++; do { if ((squid_pool->meter.inuse).hwater_level < (squid_pool->meter.inuse).level) memMeterSyncHWater(&(squid_pool->meter.inuse)); } while (0); };
 { if ((&squid_pool->meter.total)->bytes > (0x3FFFFFFF) || 1 > (0x3FFFFFFF)) gb_flush(&squid_pool->meter.total); (&squid_pool->meter.total)->bytes += 1; (&squid_pool->meter.total)->count++; };
 { if ((&squid_allocator->TheMeter.total)->bytes > (0x3FFFFFFF) || pool->obj_size > (0x3FFFFFFF)) gb_flush(&squid_allocator->TheMeter.total); (&squid_allocator->TheMeter.total)->bytes += pool->obj_size; (&squid_allocator->TheMeter.total)->count++; };
 { (squid_allocator->TheMeter.inuse).level += (pool->obj_size); do { if ((squid_allocator->TheMeter.inuse).hwater_level < (squid_allocator->TheMeter.inuse).level) memMeterSyncHWater(&(squid_allocator->TheMeter.inuse)); } while (0); };
 { if ((&squid_allocator->mem_traffic_volume)->bytes > (0x3FFFFFFF) || pool->obj_size > (0x3FFFFFFF)) gb_flush(&squid_allocator->mem_traffic_volume); (&squid_allocator->mem_traffic_volume)->bytes += pool->obj_size; (&squid_allocator->mem_traffic_volume)->count++; };
 allocator->mem_pool_alloc_calls++;

 if (acl_stack_size(pool->pstack) > 0) {
  
# 234 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
 ((void) sizeof ((
# 234 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
# 234 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
 "squid_pool->meter.idle.level"
# 234 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
 , "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 234, __extension__ __PRETTY_FUNCTION__); }))
# 234 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                                         ;
  { (squid_pool->meter.idle).level--; };
  { (squid_allocator->TheMeter.idle).level -= (pool->obj_size); };
  { if ((&squid_pool->meter.saved)->bytes > (0x3FFFFFFF) || 1 > (0x3FFFFFFF)) gb_flush(&squid_pool->meter.saved); (&squid_pool->meter.saved)->bytes += 1; (&squid_pool->meter.saved)->count++; };
  { if ((&squid_allocator->TheMeter.saved)->bytes > (0x3FFFFFFF) || pool->obj_size > (0x3FFFFFFF)) gb_flush(&squid_allocator->TheMeter.saved); (&squid_allocator->TheMeter.saved)->bytes += pool->obj_size; (&squid_allocator->TheMeter.saved)->count++; };
  ...
  (void) (0);
# 256 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
 } else {
  
# 257 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
 ((void) sizeof ((
# 257 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
 !squid_pool->meter.idle.level
# 257 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 257 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
# 257 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
 "!squid_pool->meter.idle.level"
# 257 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
 , "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 257, __extension__ __PRETTY_FUNCTION__); }))
# 257 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                                          ;
  { (squid_pool->meter.alloc).level++; do { if ((squid_pool->meter.alloc).hwater_level < (squid_pool->meter.alloc).level) memMeterSyncHWater(&(squid_pool->meter.alloc)); } while (0); };
  { (squid_allocator->TheMeter.alloc).level += (pool->obj_size); do { if ((squid_allocator->TheMeter.alloc).hwater_level < (squid_allocator->TheMeter.alloc).level) memMeterSyncHWater(&(squid_allocator->TheMeter.alloc)); } while (0); };
# 273 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
# 290 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 290 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
pool && obj
# 290 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 290 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
"pool && obj"
# 290 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 290, __extension__ __PRETTY_FUNCTION__); }))
# 290 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                       ;
 { (squid_pool->meter.inuse).level--; };
 { (squid_allocator->TheMeter.inuse).level -= (pool->obj_size); };
 allocator->mem_pool_free_calls++;
 (void) (0);
# 304 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
 if (squid_allocator->TheMeter.idle.level + pool->obj_size
  <= allocator->mem_idle_limit)
 {
  { (squid_pool->meter.idle).level++; do { if ((squid_pool->meter.idle).hwater_level < (squid_pool->meter.idle).level) memMeterSyncHWater(&(squid_pool->meter.idle)); } while (0); };
  { (squid_allocator->TheMeter.idle).level += (pool->obj_size); do { if ((squid_allocator->TheMeter.idle).hwater_level < (squid_allocator->TheMeter.idle).level) memMeterSyncHWater(&(squid_allocator->TheMeter.idle)); } while (0); };
  ...
  { (squid_allocator->TheMeter.alloc).level -= (pool->obj_size); };
  if (pool->before_free_fn)
   pool->before_free_fn(obj, pool->pool_ctx);
  acl_default_free(filename, line, obj);
 }
 
# 328 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 328 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
squid_pool->meter.idle.level <= squid_pool->meter.alloc.level
# 328 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 328 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
squid_pool->meter.idle.level <= squid_pool->meter.alloc.level
...
"squid_pool->meter.idle.level <= squid_pool->meter.alloc.level"
# 328 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 328, __extension__ __PRETTY_FUNCTION__); }))
                                   
# 329 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                                  ;
}
...
# 334 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 334 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
pool
# 334 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 334 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
"pool"
# 334 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 334, __extension__ __PRETTY_FUNCTION__); }))
# 334 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                ;
...
# 340 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 340 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
pool
# 340 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 340 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
"pool"
# 340 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 340, __extension__ __PRETTY_FUNCTION__); }))
# 340 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                ;
...
# 346 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 346 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
pool
# 346 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 346 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
"pool"
# 346 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 346, __extension__ __PRETTY_FUNCTION__); }))
# 346 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                ;
