# 0 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
# 2 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 2
# 20 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
# 1 "/acl/lib_acl/src/stdlib/memory/allocator.h" 1
# 9 "/acl/lib_acl/src/stdlib/memory/allocator.h"
# 1 "/acl/lib_acl/include/stdlib/acl_stack.h" 1
# 10 "/acl/lib_acl/src/stdlib/memory/allocator.h" 2
# 1 "/acl/lib_acl/include/stdlib/acl_allocator.h" 1
# 11 "/acl/lib_acl/src/stdlib/memory/allocator.h" 2
...
# 21 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 2
# 1 "/acl/lib_acl/src/stdlib/memory/squid_allocator.h" 1
# 27 "/acl/lib_acl/src/stdlib/memory/squid_allocator.h"
typedef struct {
 unsigned int bytes;
 unsigned int kb;
} kb_t;
...
# 22 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 2



static const size_t mem_unlimited_size = 2 * 1024 * ((size_t)1024*1024) - 1;
# 36 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
# 51 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
# 64 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 64 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
pool
# 64 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
...
"pool"
# 64 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 64, __extension__ __PRETTY_FUNCTION__); }))
# 64 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                ;
...
# 75 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 75 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
m
# 75 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 75 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
"m"
# 75 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 75, __extension__ __PRETTY_FUNCTION__); }))
# 75 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
             ;
 if (m->hwater_level < m->level) {
  m->hwater_level = m->level;
  m->hwater_stamp = time(
# 78 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
                        ((void *)0)
# 78 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                            );
 }
}
...
# 87 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 87 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
pool
# 87 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 87 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
"pool"
# 87 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 87, __extension__ __PRETTY_FUNCTION__); }))
# 87 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                ;
 while (pool->meter.idle.level > new_limit
  ...
  acl_default_free("/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 97, ptr);
 }
 
# 99 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 99 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
"pool->meter.idle.level <= new_limit"
# 99 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 99, __extension__ __PRETTY_FUNCTION__); }))
# 99 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                                               ;
}
...
# 128 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 128 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
"allocator->TheMeter.idle.level <= new_limit"
# 128 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 128, __extension__ __PRETTY_FUNCTION__); }))
# 128 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                                                       ;
}
...
# 154 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
                                  ((void *)0)
# 154 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                                      );
}
...
# 178 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 178 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
"((SQUID_MEM_ALLOCATOR *) allocator)->TheMeter.idle.level <= new_pool_limit"
# 178 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 178, __extension__ __PRETTY_FUNCTION__); }))
                    
# 179 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                   ;
...
{
 ACL_MEM_POOL *pool = acl_default_calloc("/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 187,
  1, sizeof(MemPool));
...
static void memPoolDestroy(ACL_MEM_POOL * pool)
{
 ...
 for ((pool->pstack)->iter_tail(&(iter), (pool->pstack)); (iter).ptr; (pool->pstack)->iter_prev(&(iter), (pool->pstack))) {
  ...
  acl_default_free("/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 204, obj);
 }

 acl_default_free("/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 207, pool);
}
# 218 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
# 234 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
 ((void) sizeof ((
# 234 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
# 234 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
 "squid_pool->meter.idle.level"
# 234 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
 , "/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 234, __extension__ __PRETTY_FUNCTION__); }))
# 234 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                                         ;
  { (squid_pool->meter.idle).level--; };
  ...
  (void) (0);
# 256 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
 } else {
  
# 257 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
 ((void) sizeof ((
# 257 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
 !squid_pool->meter.idle.level
# 257 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 257 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
# 257 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
 "!squid_pool->meter.idle.level"
# 257 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
 , "/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 257, __extension__ __PRETTY_FUNCTION__); }))
# 257 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                                          ;
...
# 273 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
# 290 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 290 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
pool && obj
# 290 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 290 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
"pool && obj"
# 290 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 290, __extension__ __PRETTY_FUNCTION__); }))
# 290 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                       ;
 ...
 (void) (0);
# 304 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
# 328 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 328 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
"squid_pool->meter.idle.level <= squid_pool->meter.alloc.level"
# 328 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 328, __extension__ __PRETTY_FUNCTION__); }))
                                   
# 329 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                                  ;
}
...
# 334 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 334 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
pool
# 334 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 334 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
"pool"
# 334 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 334, __extension__ __PRETTY_FUNCTION__); }))
# 334 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                ;
...
# 340 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 340 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
pool
# 340 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 340 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
"pool"
# 340 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 340, __extension__ __PRETTY_FUNCTION__); }))
# 340 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                ;
...
# 346 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
((void) sizeof ((
# 346 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
pool
# 346 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 346 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
...
"pool"
# 346 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/squid_allocator.c", 346, __extension__ __PRETTY_FUNCTION__); }))
# 346 "/acl/lib_acl/src/stdlib/memory/squid_allocator.c"
                ;
