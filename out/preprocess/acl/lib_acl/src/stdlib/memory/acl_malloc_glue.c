# 1 "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 2
# 18 "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c"
...
# 19 "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 2
...
# 49 "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 3 4
((void) sizeof ((
# 49 "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c"
__alloc_stat
# 49 "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 3 4
...
"__alloc_stat"
# 49 "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c", 49, __extension__ __PRETTY_FUNCTION__); }))
# 49 "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c"
                        ;
 pthread_mutex_init(&__fastmutex_stat, 
# 50 "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 3 4
                                     ((void *)0)
# 50 "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c"
                                         );
 __debug_mem = 1;
 return ptr;
}
...
void acl_memory_debug_stop(void)
{
 if (__alloc_stat) {
  free(__alloc_stat);
  __alloc_stat = 
# 59 "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 3 4
                ((void *)0)
# 59 "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c"
                    ;
  __debug_mem = 0;
...
static void __mem_alloc_stat(void)
{
 ...
 if (__alloc_max == 0 || __alloc_stat == 
# 74 "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 3 4
                                        ((void *)0)
# 74 "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c"
                                            )
  return;
...
void acl_memory_stat(void)
{
 ...
 pthread_mutex_lock(&__fastmutex_stat);
 ...
 acl_msg_info("---------------------------------------------------\r\n");
 pthread_mutex_unlock(&__fastmutex_stat);
}
...
void *acl_realloc_glue(const char *filename, int line, void *ptr, size_t size)
{
 ...
 if (__debug_mem) {
  ...
  if (__realloc_fn == acl_default_realloc) {
   ...
   acl_default_memstat(filename, line, ptr, &len, 
# 190 "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 3 4
                                                 ((void *)0)
# 190 "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c"
                                                     );
   __malloc_length -= len;
   __malloc_length += size;
  }
...
void acl_free_glue(const char *filename, int line, void *ptr)
{
 if (__debug_mem) {
  ...
  if (__free_fn == acl_default_free) {
   ...
   acl_default_memstat(filename, line, ptr, &len, 
# 290 "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 3 4
                                                 ((void *)0)
# 290 "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c"
                                                     );
   __malloc_length -= len;
  }
  pthread_mutex_unlock(&__fastmutex_stat);
...
void acl_free_fn_glue(void *ptr)
{
 if (__debug_mem) {
  ...
  if (__free_fn == acl_default_free) {
   ...
   acl_default_memstat("unknown", 0, ptr, &len, 
# 310 "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 3 4
                                               ((void *)0)
# 310 "/workspace/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c"
                                                   );
   __malloc_length -= len;
  }
  pthread_mutex_unlock(&__fastmutex_stat);
