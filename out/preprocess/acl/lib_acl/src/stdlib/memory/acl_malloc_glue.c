# 0 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c"
...
# 2 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 2
# 18 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c"
...
# 19 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 2
...
# 49 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 3 4
((void) sizeof ((
# 49 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c"
__alloc_stat
# 49 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 3 4
...
"__alloc_stat"
# 49 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c", 49, __extension__ __PRETTY_FUNCTION__); }))
# 49 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c"
                        ;
 pthread_mutex_init(&__fastmutex_stat, 
# 50 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 3 4
                                     ((void *)0)
# 50 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c"
                                         );
 __debug_mem = 1;
 return ptr;
}
...
void acl_memory_debug_stop(void)
{
 if (__alloc_stat) {
  free(__alloc_stat);
  __alloc_stat = 
# 59 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 3 4
                ((void *)0)
# 59 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c"
                    ;
  __debug_mem = 0;
...
# 74 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 3 4
                                        ((void *)0)
# 74 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c"
                                            )
  return;
...
# 190 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 3 4
                                                 ((void *)0)
# 190 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c"
                                                     );
   __malloc_length -= len;
   __malloc_length += size;
  }
...
void acl_free_glue(const char *filename, int line, void *ptr)
{
 if (__debug_mem) {
  ...
  if (__free_fn == acl_default_free) {
   ...
   acl_default_memstat(filename, line, ptr, &len, 
# 290 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 3 4
                                                 ((void *)0)
# 290 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c"
                                                     );
   __malloc_length -= len;
  }
  pthread_mutex_unlock(&__fastmutex_stat);
...
# 310 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c" 3 4
                                               ((void *)0)
# 310 "/acl/lib_acl/src/stdlib/memory/acl_malloc_glue.c"
                                                   );
   __malloc_length -= len;
  }
  pthread_mutex_unlock(&__fastmutex_stat);
