# 0 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
...
# 2 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 2
# 15 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
...
# 16 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 2

void mem_pool_create(ACL_ALLOCATOR *allocator)
{
 acl_allocator_pool_add(allocator, "8 Buffer", 8,
  ACL_MEM_TYPE_8_BUF, 
# 20 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                     ((void *)0)
# 20 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
                         , 
# 20 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                           ((void *)0)
# 20 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
...
# 20 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
 ...
 acl_allocator_pool_add(allocator, "16 Buffer", 16,
  ACL_MEM_TYPE_16_BUF, 
# 22 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                      ((void *)0)
# 22 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
                          , 
# 22 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                            ((void *)0)
# 22 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
...
# 22 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
 ...
 acl_allocator_pool_add(allocator, "32 Buffer", 32,
  ACL_MEM_TYPE_32_BUF, 
# 24 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                      ((void *)0)
# 24 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
                          , 
# 24 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                            ((void *)0)
# 24 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
...
# 24 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
 ...
 acl_allocator_pool_add(allocator, "64 Buffer", 64,
  ACL_MEM_TYPE_64_BUF, 
# 26 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                      ((void *)0)
# 26 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
                          , 
# 26 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                            ((void *)0)
# 26 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
...
# 26 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
 ...
 acl_allocator_pool_add(allocator, "128 Buffer", 128,
  ACL_MEM_TYPE_128_BUF, 
# 28 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                       ((void *)0)
# 28 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
                           , 
# 28 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                             ((void *)0)
# 28 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
...
# 28 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
 ...
 acl_allocator_pool_add(allocator, "256 Buffer", 256,
  ACL_MEM_TYPE_256_BUF, 
# 30 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                       ((void *)0)
# 30 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
                           , 
# 30 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                             ((void *)0)
# 30 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
...
# 30 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
 ...
 acl_allocator_pool_add(allocator, "512 Buffer", 512,
  ACL_MEM_TYPE_512_BUF, 
# 32 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                       ((void *)0)
# 32 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
                           , 
# 32 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                             ((void *)0)
# 32 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
...
# 32 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
 ...
 acl_allocator_pool_add(allocator, "1K Buffer", 1024,
  ACL_MEM_TYPE_1K_BUF, 
# 34 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                      ((void *)0)
# 34 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
                          , 
# 34 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                            ((void *)0)
# 34 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
...
# 34 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
 ...
 acl_allocator_pool_add(allocator, "2K Buffer", 2048,
  ACL_MEM_TYPE_2K_BUF, 
# 36 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                      ((void *)0)
# 36 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
                          , 
# 36 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                            ((void *)0)
# 36 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
...
# 36 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
 ...
 acl_allocator_pool_add(allocator, "4K Buffer", 4096,
  ACL_MEM_TYPE_4K_BUF, 
# 38 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                      ((void *)0)
# 38 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
                          , 
# 38 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                            ((void *)0)
# 38 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
...
# 38 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
 ...
 acl_allocator_pool_add(allocator, "8K Buffer", 8192,
  ACL_MEM_TYPE_8K_BUF, 
# 40 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                      ((void *)0)
# 40 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
                          , 
# 40 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                            ((void *)0)
# 40 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
...
# 40 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
 ...
 acl_allocator_pool_add(allocator, "16K Buffer", 16384,
  ACL_MEM_TYPE_16K_BUF, 
# 42 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                       ((void *)0)
# 42 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
                           , 
# 42 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                             ((void *)0)
# 42 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
...
# 42 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
 ...
 acl_allocator_pool_add(allocator, "32K Buffer", 32768,
  ACL_MEM_TYPE_32K_BUF, 
# 44 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                       ((void *)0)
# 44 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
                           , 
# 44 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                             ((void *)0)
# 44 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
...
# 44 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
 ...
 acl_allocator_pool_add(allocator, "64K Buffer", 65536,
  ACL_MEM_TYPE_64K_BUF, 
# 46 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                       ((void *)0)
# 46 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
                           , 
# 46 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                             ((void *)0)
# 46 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
...
# 46 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
 ...
 acl_allocator_pool_add(allocator, "128K Buffer", 131072,
  ACL_MEM_TYPE_128K_BUF, 
# 49 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                        ((void *)0)
# 49 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
                            , 
# 49 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                              ((void *)0)
# 49 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
...
# 49 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
 ...
 acl_allocator_pool_add(allocator, "256K Buffer", 262144,
  ACL_MEM_TYPE_256K_BUF, 
# 51 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                        ((void *)0)
# 51 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
                            , 
# 51 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                              ((void *)0)
# 51 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
...
# 51 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
 ...
 acl_allocator_pool_add(allocator, "512K Buffer", 524288,
  ACL_MEM_TYPE_512K_BUF, 
# 53 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                        ((void *)0)
# 53 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
                            , 
# 53 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                              ((void *)0)
# 53 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
...
# 53 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
 ...
 acl_allocator_pool_add(allocator, "1M Buffer", 1048576,
  ACL_MEM_TYPE_1M_BUF, 
# 55 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                      ((void *)0)
# 55 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
                          , 
# 55 "/acl/lib_acl/src/stdlib/memory/mem_pool.c" 3 4
                            ((void *)0)
# 55 "/acl/lib_acl/src/stdlib/memory/mem_pool.c"
