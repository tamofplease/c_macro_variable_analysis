# 0 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
...
# 2 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 2
# 16 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
# 1 "/acl/lib_acl/src/stdlib/memory/../../private/private_array.h" 1
# 9 "/acl/lib_acl/src/stdlib/memory/../../private/private_array.h"
# 1 "/acl/lib_acl/include/stdlib/acl_iterator.h" 1
# 10 "/acl/lib_acl/src/stdlib/memory/../../private/private_array.h" 2
# 1 "/acl/lib_acl/include/stdlib/acl_array.h" 1
# 11 "/acl/lib_acl/src/stdlib/memory/../../private/private_array.h" 2
...
# 57 "/acl/lib_acl/src/stdlib/memory/../../private/private_array.h"
...
# 17 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 2
# 1 "/acl/lib_acl/src/stdlib/memory/malloc_vars.h" 1
...
# 18 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 2
# 42 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
# 1 "/acl/lib_acl/src/stdlib/memory/../../private/thread.h" 1
# 9 "/acl/lib_acl/src/stdlib/memory/../../private/thread.h"
# 1 "/acl/lib_acl/include/thread/acl_pthread.h" 1
# 10 "/acl/lib_acl/src/stdlib/memory/../../private/thread.h" 2


int thread_mutex_destroy(acl_pthread_mutex_t *mutex);
# 31 "/acl/lib_acl/src/stdlib/memory/../../private/thread.h"
acl_pthread_mutex_t *thread_mutex_create(void);
# 43 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 2

typedef acl_pthread_mutex_t mylock_t;
# 55 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
...
# 1 "/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 72 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 2
...
# 149 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
...
# 156 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                    ((void *)0)
# 156 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                        ;
static acl_pthread_mutex_t *__mem_slice_list_lock = 
# 157 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                                   ((void *)0)
# 157 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                                       ;
...
static void mem_slice_free(ACL_MEM_SLICE *mem_slice)
{
 ...
 if (mem_slice == 
# 168 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                 ((void *)0)
# 168 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                     ) {
...
# 192 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                        ((void *)0)
# 192 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                            );
  mem_slice->list = 
# 193 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                   ((void *)0)
# 193 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                       ;
...
# 198 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                                       ((void *)0)
# 198 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                                           );
  if (__mem_slice_list_lock)
   pthread_mutex_unlock(__mem_slice_list_lock);

  acl_default_free("/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c", 202, mem_slice);
 }
}

static ACL_MEM_SLICE *__main_mem_slice = 
# 206 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                        ((void *)0)
# 206 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                            ;
...
static void main_thread_slice_free(void)
{
 if (__main_mem_slice) {
  ...
  __main_mem_slice = 
# 213 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                    ((void *)0)
# 213 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                        ;
 }
}
...
# 222 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                         ((void *)0)
# 222 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                             );
  __mem_slice_list = 
# 223 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                    ((void *)0)
# 223 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                        ;
 }
 if (__mem_slice_list_lock) {
  thread_mutex_destroy(__mem_slice_list_lock);
  __mem_slice_list_lock = 
# 227 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                         ((void *)0)
# 227 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                             ;
 }
}
...
# 238 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                          ((void *)0)
# 238 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                              );
...
# 246 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                        0
# 246 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                                             ;
...
static ACL_MEM_SLICE *mem_slice_create(void)
{
 ...
 if (mem_slice != 
# 261 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                 ((void *)0)
# 261 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                     )
  return mem_slice;

 mem_slice = (ACL_MEM_SLICE*)
  acl_default_calloc("/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c", 265, 1, sizeof(ACL_MEM_SLICE));
 if (mem_slice == 
# 266 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                 ((void *)0)
# 266 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                     )
...
# 274 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
((void *)0)
# 274 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
);
...
static void tls_mem_free(const char *filename, int line, void *ptr)
{
 ...
 { if (ptr == 0) { acl_msg_panic("%s(%d), %s: in %s(%d), null pointer input", "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c", 295, __FUNCTION__, filename, line); } real_ptr = (MBLOCK *) ((char *) ptr - 
# 295 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
__builtin_offsetof (
# 295 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
MBLOCK
# 295 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
, 
# 295 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
...
# 295 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
); if (real_ptr->signature != 0xdead) { acl_msg_panic("%s(%d)(CHECK_IN_PTR2): corrupt or unallocated memory block(%d, 0x%x, 0x%x)", filename, line, (int) real_ptr->length, real_ptr->signature, 0xdead); } if ((len = real_ptr->length) < 1) { acl_msg_panic("%s(%d), %s: in %s(%d) corrupt memory block length", "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c", 295, __FUNCTION__, filename, line); } };
...
static void *tls_mem_alloc(const char *filename, int line, size_t len)
{
 ...
 if (mem_slice == 
# 316 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                 ((void *)0)
# 316 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                     ) {
...
# 336 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                         __builtin_offsetof (
# 336 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                         MBLOCK
# 336 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                         , 
# 336 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
...
static void *tls_mem_realloc(const char *filename, int line, void *ptr, size_t size)
{
 ...
 if (ptr == 
# 366 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
           ((void *)0)
# 366 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
               )
  return buf;
 { if (ptr == 0) { acl_msg_panic("%s(%d), %s: in %s(%d), null pointer input", "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c", 368, __FUNCTION__, filename, line); } old_real_ptr = (MBLOCK *) ((char *) ptr - 
# 368 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
__builtin_offsetof (
# 368 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
MBLOCK
# 368 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
, 
# 368 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
...
# 417 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
 ((void *)0)
# 417 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
 ; } else { (ptr) = 
# 417 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
 ((void *)0)
# 417 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
 ; } } while (0);
  if (ptr == 
# 418 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
            ((void *)0)
# 418 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                )
   break;
  acl_slice_pool_free("/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c", 420, ptr);
  n++;
 }
...
void acl_mem_slice_destroy(void)
{
 ...
 if (mem_slice == 
# 443 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                 ((void *)0)
# 443 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                     )
  return;

 mem_slice_free(mem_slice);
 pthread_setspecific(__mem_slice_key, 
# 447 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                         ((void *)0)
# 447 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                             );
 if ((unsigned long) pthread_self() == acl_main_thread_self())
  __main_mem_slice = 
# 449 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                    ((void *)0)
# 449 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                        ;
}
...
void acl_mem_slice_delay_destroy(void)
{
 ...
 if (__mem_slice_list_lock == 
# 457 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                             ((void *)0)
# 457 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                 )
  return;
 ...
 for (i = 0; i < n; i++) {
  ...
  if (mem_slice == 
# 465 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                  ((void *)0)
# 465 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                      )
   break;
  ...
  if (acl_slice_pool_used(mem_slice->slice_pool) <= 0) {
   ...
   acl_slice_pool_destroy(mem_slice->slice_pool);
   private_array_destroy(mem_slice->list, 
# 474 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                         ((void *)0)
# 474 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                             );
   mem_slice->list = 
# 475 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                    ((void *)0)
# 475 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                        ;


   private_array_delete_obj(__mem_slice_list, mem_slice, 
# 478 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                                        ((void *)0)
# 478 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                                            );
   acl_default_free("/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c", 479, mem_slice);
  } else
   mem_slice_gc(mem_slice);
 }
 ...
 int nalloc_gc, unsigned int slice_flag)
{
 ...
 if (__mem_slice_key != (acl_pthread_key_t) -1) {
  ...
  return 
# 495 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
        ((void *)0)
# 495 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
            ;
 }
 ...
 mem_slice = mem_slice_create();
 if (mem_slice == 
# 510 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                 ((void *)0)
# 510 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                     )
 ...
 if (__mem_slice_list == 
# 520 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                        ((void *)0)
# 520 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                            )
  acl_msg_fatal("%s(%d): __mem_slice_list null", myname, 521);
 if (__mem_slice_list_lock == 
# 522 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                             ((void *)0)
# 522 "/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                 )
