# 1 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 2
# 16 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
# 1 "/workspace/acl/lib_acl/src/stdlib/memory/../../private/private_array.h" 1
# 9 "/workspace/acl/lib_acl/src/stdlib/memory/../../private/private_array.h"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_iterator.h" 1
# 10 "/workspace/acl/lib_acl/src/stdlib/memory/../../private/private_array.h" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_array.h" 1
# 11 "/workspace/acl/lib_acl/src/stdlib/memory/../../private/private_array.h" 2
...
# 57 "/workspace/acl/lib_acl/src/stdlib/memory/../../private/private_array.h"
...
# 17 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 2
# 1 "/workspace/acl/lib_acl/src/stdlib/memory/malloc_vars.h" 1
...
# 18 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 2
# 42 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
# 1 "/workspace/acl/lib_acl/src/stdlib/memory/../../private/thread.h" 1
# 9 "/workspace/acl/lib_acl/src/stdlib/memory/../../private/thread.h"
# 1 "/workspace/acl/lib_acl/include/thread/acl_pthread.h" 1
# 10 "/workspace/acl/lib_acl/src/stdlib/memory/../../private/thread.h" 2


int thread_mutex_destroy(acl_pthread_mutex_t *mutex);
# 31 "/workspace/acl/lib_acl/src/stdlib/memory/../../private/thread.h"
acl_pthread_mutex_t *thread_mutex_create(void);
# 43 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 2

typedef acl_pthread_mutex_t mylock_t;
# 55 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
struct ACL_MEM_SLICE {
 ACL_SLICE_POOL *slice_pool;
 mylock_t lock;
 ACL_ARRAY *list;
 acl_pthread_key_t tls_key;
 unsigned long tid;
 unsigned int nalloc;
 unsigned int nalloc_gc;
 unsigned int slice_flag;
 ACL_ARRAY *slice_list;
 acl_pthread_mutex_t *slice_list_lock;
 int delay_free;
...
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 72 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 2
...
# 149 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
static acl_pthread_key_t __mem_slice_key;
static int __mem_base = 8;
static int __mem_nslice = 1024;
static int __mem_nalloc_gc = 100;
static int __mem_list_init_size = 1000;
static unsigned int __mem_slice_flag = (1 << 1) | (1 << 10);

static ACL_ARRAY *__mem_slice_list = 
# 156 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                    ((void *)0)
# 156 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                        ;
static acl_pthread_mutex_t *__mem_slice_list_lock = 
# 157 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                                   ((void *)0)
# 157 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                                       ;
...
static void mem_slice_free(ACL_MEM_SLICE *mem_slice)
{
 ...
 if (mem_slice == 
# 168 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                 ((void *)0)
# 168 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                     ) {
  acl_msg_info("%s(%d): mem_slice null", myname, 169);
  return;
 }
 ...
 if ((n = acl_slice_pool_used(mem_slice->slice_pool)) > 0) {
  acl_msg_info("%s(%d): thread(%ld) mem slice busy slices: %d, delay free it",
   myname, 178, mem_slice->tid, n);

  if (__mem_slice_list_lock)
   pthread_mutex_lock(__mem_slice_list_lock);
  mem_slice->delay_free = 1;
  if (__mem_slice_list_lock)
   pthread_mutex_unlock(__mem_slice_list_lock);


  acl_slice_pool_gc(mem_slice->slice_pool);
 } else {
  acl_msg_info("%s(%d): thread(%ld) free mem slice now",
   myname, 190, mem_slice->tid);
  acl_slice_pool_destroy(mem_slice->slice_pool);
  private_array_destroy(mem_slice->list, 
# 192 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                        ((void *)0)
# 192 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                            );
  mem_slice->list = 
# 193 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                   ((void *)0)
# 193 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                       ;


  if (__mem_slice_list_lock)
   pthread_mutex_lock(__mem_slice_list_lock);
  private_array_delete_obj(__mem_slice_list, mem_slice, 
# 198 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                                       ((void *)0)
# 198 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                                           );
  if (__mem_slice_list_lock)
   pthread_mutex_unlock(__mem_slice_list_lock);

  acl_default_free("/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c", 202, mem_slice);
 }
}

static ACL_MEM_SLICE *__main_mem_slice = 
# 206 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                        ((void *)0)
# 206 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                            ;
...
static void main_thread_slice_free(void)
{
 if (__main_mem_slice) {
  ...
  __main_mem_slice = 
# 213 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                    ((void *)0)
# 213 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                        ;
 }
}
...
{
 if (__mem_slice_list) {
  private_array_destroy(__mem_slice_list, 
# 222 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                         ((void *)0)
# 222 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                             );
  __mem_slice_list = 
# 223 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                    ((void *)0)
# 223 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                        ;
 }
 if (__mem_slice_list_lock) {
  thread_mutex_destroy(__mem_slice_list_lock);
  __mem_slice_list_lock = 
# 227 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                         ((void *)0)
# 227 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                             ;
 }
}
...
{
 unsigned long curr_tid = (unsigned long) pthread_self();
 unsigned long main_tid = (unsigned long) acl_main_thread_self();

 if (curr_tid == main_tid) {
  pthread_key_create(&__mem_slice_key, 
# 238 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                          ((void *)0)
# 238 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                              );

  atexit(main_thread_slice_free);

 } else
  pthread_key_create(&__mem_slice_key, (void (*)(void*)) mem_slice_free);
}

static acl_pthread_once_t once_control = 
# 246 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                        0
# 246 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                                             ;
...
static ACL_MEM_SLICE *mem_slice_create(void)
{
 ...
 pthread_once(&once_control, slice_key_init);
 ...
 if (__mem_slice_key == (acl_pthread_key_t) -1)
  acl_msg_fatal("%s(%d): __mem_slice_key(%ld) invalid,"
   ...
   myname, 258, (long int) __mem_slice_key);

 mem_slice = pthread_getspecific(__mem_slice_key);
 if (mem_slice != 
# 261 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                 ((void *)0)
# 261 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                     )
  return mem_slice;

 mem_slice = (ACL_MEM_SLICE*)
  acl_default_calloc("/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c", 265, 1, sizeof(ACL_MEM_SLICE));
 if (mem_slice == 
# 266 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                 ((void *)0)
# 266 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                     )
  acl_msg_fatal("%s(%d): can't alloc for mem_slice(%s)",
   myname, 268, acl_last_serror());

 mem_slice->slice_pool = acl_slice_pool_create(__mem_base,
   __mem_nslice, __mem_slice_flag);
 mem_slice->tid = (unsigned long) pthread_self();
 mem_slice->list = private_array_create(__mem_list_init_size);
 pthread_mutex_init(&(mem_slice)->lock, 
# 274 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
((void *)0)
# 274 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
);
 mem_slice->tls_key = __mem_slice_key;
 mem_slice->nalloc_gc = __mem_nalloc_gc;
 mem_slice->slice_flag = __mem_slice_flag;

 pthread_setspecific(__mem_slice_key, mem_slice);
 ...
 acl_msg_info("%s(%d): thread(%ld) set myown mem_slice(%p)",
  myname, 285, (long) mem_slice->tid, mem_slice);
...
static void tls_mem_free(const char *filename, int line, void *ptr)
{
 ...
 { if (ptr == 0) { acl_msg_panic("%s(%d), %s: in %s(%d), null pointer input", "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c", 295, __FUNCTION__, filename, line); } real_ptr = (MBLOCK *) ((char *) ptr - 
# 295 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
__builtin_offsetof (
# 295 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
MBLOCK
# 295 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
, 
# 295 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
...
# 295 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
); if (real_ptr->signature != 0xdead) { acl_msg_panic("%s(%d)(CHECK_IN_PTR2): corrupt or unallocated memory block(%d, 0x%x, 0x%x)", filename, line, (int) real_ptr->length, real_ptr->signature, 0xdead); } if ((len = real_ptr->length) < 1) { acl_msg_panic("%s(%d), %s: in %s(%d) corrupt memory block length", "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c", 295, __FUNCTION__, filename, line); } };


 if (real_ptr->mem_slice->tid != (unsigned long) pthread_self()) {



  pthread_mutex_lock(&(real_ptr->mem_slice)->lock);
  do { if ((real_ptr->mem_slice->list)->count >= (real_ptr->mem_slice->list)->capacity) private_array_grow((real_ptr->mem_slice->list), (real_ptr->mem_slice->list)->count + 16); (real_ptr->mem_slice->list)->items[(real_ptr->mem_slice->list)->count++] = (real_ptr); } while (0);
  pthread_mutex_unlock(&(real_ptr->mem_slice)->lock);
 } else
...
static void *tls_mem_alloc(const char *filename, int line, size_t len)
{
 ...
 ACL_MEM_SLICE *mem_slice = pthread_getspecific(__mem_slice_key);
 char *ptr;
 MBLOCK *real_ptr;

 if (mem_slice == 
# 316 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                 ((void *)0)
# 316 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                     ) {
 ...
 real_ptr = (MBLOCK *) acl_slice_pool_alloc(filename, line,
   mem_slice->slice_pool, (
# 336 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                         __builtin_offsetof (
# 336 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                         MBLOCK
# 336 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                         , 
# 336 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
...
# 336 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
 ...
 { real_ptr->signature = 0xdead; real_ptr->mem_slice = mem_slice; real_ptr->length = len; ptr = real_ptr->u.payload; };
 return ptr;
}
...
static void *tls_mem_realloc(const char *filename, int line, void *ptr, size_t size)
{
 ...
 if (ptr == 
# 366 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
           ((void *)0)
# 366 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
               )
  return buf;
 { if (ptr == 0) { acl_msg_panic("%s(%d), %s: in %s(%d), null pointer input", "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c", 368, __FUNCTION__, filename, line); } old_real_ptr = (MBLOCK *) ((char *) ptr - 
# 368 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
__builtin_offsetof (
# 368 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
MBLOCK
# 368 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
, 
# 368 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
...
# 368 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
); if (old_real_ptr->signature != 0xdead) { acl_msg_panic("%s(%d)(CHECK_IN_PTR2): corrupt or unallocated memory block(%d, 0x%x, 0x%x)", filename, line, (int) old_real_ptr->length, old_real_ptr->signature, 0xdead); } if ((old_len = old_real_ptr->length) < 1) { acl_msg_panic("%s(%d), %s: in %s(%d) corrupt memory block length", "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c", 368, __FUNCTION__, filename, line); } };
 memcpy(buf, ptr, old_len > size ? size : old_len);
 if (old_real_ptr->mem_slice->tid != (unsigned long) pthread_self()) {
  pthread_mutex_lock(&(old_real_ptr->mem_slice)->lock);
  do { if ((old_real_ptr->mem_slice->list)->count >= (old_real_ptr->mem_slice->list)->capacity) private_array_grow((old_real_ptr->mem_slice->list), (old_real_ptr->mem_slice->list)->count + 16); (old_real_ptr->mem_slice->list)->items[(old_real_ptr->mem_slice->list)->count++] = (old_real_ptr); } while (0);
  pthread_mutex_unlock(&(old_real_ptr->mem_slice)->lock);
 } else
...
static int mem_slice_gc(ACL_MEM_SLICE *mem_slice)
{
 ...
 pthread_mutex_lock(&(mem_slice)->lock);
 while (1) {
  void *ptr;
  do { if ((mem_slice->list)->count > 0) { (mem_slice->list)->count--; (ptr) = (mem_slice->list)->items[(mem_slice->list)->count]; (mem_slice->list)->items[(mem_slice->list)->count] = 
# 417 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
 ((void *)0)
# 417 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
 ; } else { (ptr) = 
# 417 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
 ((void *)0)
# 417 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
 ; } } while (0);
  if (ptr == 
# 418 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
            ((void *)0)
# 418 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                )
   break;
  acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c", 420, ptr);
  n++;
 }
 pthread_mutex_unlock(&(mem_slice)->lock);

 if ((mem_slice->slice_flag & (1 << 10)) == 0)
  acl_slice_pool_gc(mem_slice->slice_pool);
 return n;
}
...
void acl_mem_slice_destroy(void)
{
 ...
 if (mem_slice == 
# 443 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                 ((void *)0)
# 443 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                     )
  return;

 mem_slice_free(mem_slice);
 pthread_setspecific(__mem_slice_key, 
# 447 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                         ((void *)0)
# 447 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                             );
 if ((unsigned long) pthread_self() == acl_main_thread_self())
  __main_mem_slice = 
# 449 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                    ((void *)0)
# 449 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                        ;
}
...
void acl_mem_slice_delay_destroy(void)
{
 ...
 if (__mem_slice_list_lock == 
# 457 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                             ((void *)0)
# 457 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                 )
  return;
 ...
 for (i = 0; i < n; i++) {
  ...
  if (mem_slice == 
# 465 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                  ((void *)0)
# 465 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                      )
   break;
  ...
  if (acl_slice_pool_used(mem_slice->slice_pool) <= 0) {
   acl_msg_info("%s(%d): thread(%ld) free mem slice now",
    myname, 471, mem_slice->tid);

   acl_slice_pool_destroy(mem_slice->slice_pool);
   private_array_destroy(mem_slice->list, 
# 474 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                         ((void *)0)
# 474 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                             );
   mem_slice->list = 
# 475 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                    ((void *)0)
# 475 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                        ;


   private_array_delete_obj(__mem_slice_list, mem_slice, 
# 478 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                                                        ((void *)0)
# 478 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                                            );
   acl_default_free("/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c", 479, mem_slice);
  } else
   mem_slice_gc(mem_slice);
 }
 ...
 int nalloc_gc, unsigned int slice_flag)
{
 ...
 if (__mem_slice_key != (acl_pthread_key_t) -1) {
  acl_msg_error("%s(%d): has been init", myname, 494);
  return 
# 495 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
        ((void *)0)
# 495 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
            ;
 }
 ...
 mem_slice = mem_slice_create();
 if (mem_slice == 
# 510 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                 ((void *)0)
# 510 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                     )
  acl_msg_fatal("%s(%d): mem_slice null", myname, 511);
 ...
 if (__mem_slice_list == 
# 520 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                        ((void *)0)
# 520 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                            )
  acl_msg_fatal("%s(%d): __mem_slice_list null", myname, 521);
 if (__mem_slice_list_lock == 
# 522 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c" 3 4
                             ((void *)0)
# 522 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_slice.c"
                                 )
  acl_msg_fatal("%s(%d): __mem_slice_list_lock null", myname, 523);
 ...
 acl_mem_hook(tls_mem_alloc,
  ...
  tls_mem_memdup,
  tls_mem_free);
 acl_msg_info("%s(%d): use ACL_MEM_SLICE, with tls", myname, 538);
 return mem_slice;
}
...
void acl_mem_slice_set(ACL_MEM_SLICE *mem_slice)
{
 ...
 acl_mem_hook(tls_mem_alloc,
  ...
  tls_mem_memdup,
  tls_mem_free);
 acl_msg_info("%s(%d): set ACL_MEM_SLICE, with tls", myname, 571);
}
