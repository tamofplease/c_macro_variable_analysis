# 1 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 2
# 13 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
...
# 14 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 2
...
# 15 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 2
# 40 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
...
# 41 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 2

static acl_pthread_mutex_t __lock;
# 51 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 52 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 2


static int __use_lock = 0;
static ACL_ALLOCATOR *__var_allocator = 
# 55 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
                                       ((void *)0)
# 55 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
                                           ;
...
{
 if (__use_lock == 0) {
  pthread_mutex_init(&__lock, 
# 199 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
 ((void *)0)
# 199 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
 );
  __use_lock = 1;
 }
...
{
 if (__var_allocator == 
# 235 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
                       ((void *)0)
# 235 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
                           )
...
{
 if (__use_lock) {
  thread_mutex_destroy(&__lock);
  __use_lock = 0;
 }

 if (__var_allocator != 
# 251 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
                       ((void *)0)
# 251 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
                           ) {
  acl_allocator_free(__var_allocator);
  __var_allocator = 
# 253 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
                   ((void *)0)
# 253 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
                       ;
 }
...
void acl_mempool_ctl(int name, ...)
{
 ...
 if (__var_allocator == 
# 265 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
                       ((void *)0)
# 265 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
                           )
  acl_msg_fatal("%s(%d): call acl_mempool_create first", myname, 266);

 
# 268 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
__builtin_va_start(
# 268 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
ap
# 268 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
,
# 268 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
...
# 268 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
 ...
 for (; name != 0; name = 
# 270 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
                                           __builtin_va_arg(
# 270 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
                                           ap
# 270 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
                                           ,
# 270 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
...
# 270 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
  ...
  case 1:
   n = 
# 273 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
      __builtin_va_arg(
# 273 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
      ap
# 273 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
      ,
# 273 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
...
# 273 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
  ...
  case 2:
   n = 
# 280 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
      __builtin_va_arg(
# 280 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
      ap
# 280 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
      ,
# 280 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
...
# 288 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
__builtin_va_end(
# 288 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
ap
# 288 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
)
# 288 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
...
int acl_mempool_total_allocated()
{
 ...
 if (__var_allocator == 
# 295 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
                       ((void *)0)
# 295 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
                           )
  return (0);
 if (__use_lock)
  pthread_mutex_lock(&__lock);
