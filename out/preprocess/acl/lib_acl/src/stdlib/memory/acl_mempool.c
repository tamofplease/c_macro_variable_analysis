# 0 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
...
# 2 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 2
# 13 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
...
# 14 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 2
...
# 15 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 2
# 40 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
...
# 41 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 2

static acl_pthread_mutex_t __lock;
# 51 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
# 1 "/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 52 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 2


static int __use_lock = 0;
static ACL_ALLOCATOR *__var_allocator = 
# 55 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
                                       ((void *)0)
# 55 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
                                           ;
...
# 199 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
 ((void *)0)
# 199 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
 );
  __use_lock = 1;
 }
...
{
 if (__var_allocator == 
# 235 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
                       ((void *)0)
# 235 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
                           )
...
void acl_mempool_close(void)
{
 ...
 if (__var_allocator != 
# 251 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
                       ((void *)0)
# 251 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
                           ) {
  acl_allocator_free(__var_allocator);
  __var_allocator = 
# 253 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
                   ((void *)0)
# 253 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
                       ;
 }
...
void acl_mempool_ctl(int name, ...)
{
 ...
 if (__var_allocator == 
# 265 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
                       ((void *)0)
# 265 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
                           )
  acl_msg_fatal("%s(%d): call acl_mempool_create first", myname, 266);

 
# 268 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
__builtin_va_start(
# 268 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
ap
# 268 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
,
# 268 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
...
# 268 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
 ...
 for (; name != 0; name = 
# 270 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
                                           __builtin_va_arg(
# 270 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
                                           ap
# 270 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
                                           ,
# 270 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
...
# 270 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
  ...
  case 1:
   n = 
# 273 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
      __builtin_va_arg(
# 273 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
      ap
# 273 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
      ,
# 273 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
...
# 273 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
  ...
  case 2:
   n = 
# 280 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
      __builtin_va_arg(
# 280 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
      ap
# 280 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
      ,
# 280 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
...
# 288 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
__builtin_va_end(
# 288 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
ap
# 288 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
)
# 288 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
...
int acl_mempool_total_allocated()
{
 ...
 if (__var_allocator == 
# 295 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c" 3 4
                       ((void *)0)
# 295 "/acl/lib_acl/src/stdlib/memory/acl_mempool.c"
                           )
  return (0);
 if (__use_lock)
  pthread_mutex_lock(&__lock);
