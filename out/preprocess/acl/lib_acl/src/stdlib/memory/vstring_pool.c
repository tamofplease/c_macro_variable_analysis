# 1 "/workspace/acl/lib_acl/src/stdlib/memory/vstring_pool.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/memory/vstring_pool.c" 2
# 17 "/workspace/acl/lib_acl/src/stdlib/memory/vstring_pool.c"
...
# 18 "/workspace/acl/lib_acl/src/stdlib/memory/vstring_pool.c" 2

static const char label[] = "vstring";

static ACL_ALLOCATOR *__var_allocator;
static int __len = 1024;
# 73 "/workspace/acl/lib_acl/src/stdlib/memory/vstring_pool.c"
static void after_alloc_fn(void *obj, void *pool_ctx __attribute__ ((__unused__)))
{
 ACL_VSTRING *vp = (ACL_VSTRING *) obj;
 char *buf;

 buf = acl_allocator_membuf_alloc("/workspace/acl/lib_acl/src/stdlib/memory/vstring_pool.c", 78,
...
static void before_free_fn(void *obj, void *pool_ctx __attribute__ ((__unused__)))
{
 ACL_VSTRING *vp = (ACL_VSTRING *) obj;

 acl_allocator_membuf_free("/workspace/acl/lib_acl/src/stdlib/memory/vstring_pool.c", 92,
  __var_allocator, vp->vbuf.data);
 vp->vbuf.data = 
# 94 "/workspace/acl/lib_acl/src/stdlib/memory/vstring_pool.c" 3 4
                ((void *)0)
# 94 "/workspace/acl/lib_acl/src/stdlib/memory/vstring_pool.c"
                    ;
}
...
void vstring_pool_create(ACL_ALLOCATOR *allocator)
{
 ...
 acl_allocator_pool_add(allocator, label, sizeof(ACL_VSTRING),
  ACL_MEM_TYPE_VSTRING, after_alloc_fn, before_free_fn, 
# 102 "/workspace/acl/lib_acl/src/stdlib/memory/vstring_pool.c" 3 4
                                                       ((void *)0)
# 102 "/workspace/acl/lib_acl/src/stdlib/memory/vstring_pool.c"
                                                           );
}
