# 0 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
...
# 2 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 2
# 28 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
static char __FILENAME_UNKNOWN[] = "unknown file";
static size_t __malloc_limit = 100000000;
# 38 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
...
# 100 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
static char empty_string[] = "";
# 141 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
void acl_default_memstat(const char *filename, int line,
 void *ptr, size_t *len, size_t *real_len)
{
 MBLOCK *real_ptr;
 const char *pname = 
# 145 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
                    ((void *)0)
# 145 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
                        ;
 size_t old_len;

 if (filename && *filename)
  do { pname = strrchr(filename, '/'); if (pname == 
# 149 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
 ((void *)0)
# 149 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
...
# 153 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
__builtin_offsetof (
# 153 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
MBLOCK
# 153 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
, 
# 153 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
...
# 153 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 ...
 if (real_len)
  *real_len = (
# 157 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
             __builtin_offsetof (
# 157 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
             MBLOCK
# 157 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
             , 
# 157 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
...
# 173 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
((void) sizeof ((
# 173 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
len > 0
# 173 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
...
"len > 0"
# 173 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c", 173, __extension__ __PRETTY_FUNCTION__); }))
# 173 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
                   ;
 __malloc_limit = len;
}
...
void *acl_default_malloc(const char *filename, int line, size_t len)
{
 ...
 MBLOCK *real_ptr;
 const char *pname = 
# 188 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
                    ((void *)0)
# 188 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
                        ;
 ...
 if (filename && *filename)
  do { pname = strrchr(filename, '/'); if (pname == 
# 196 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
 ((void *)0)
# 196 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 ) pname = filename; else pname++; } while (0);
 else
  pname = __FILENAME_UNKNOWN;
 ...
 new_len = (
# 207 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
          __builtin_offsetof (
# 207 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
          MBLOCK
# 207 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
          , 
# 207 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
...
# 230 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 if ((real_ptr = (MBLOCK *) malloc(new_len)) == 0) {
  acl_msg_error("%s(%d)->%s: malloc: insufficient memory: %s, "
   "new_len: %d", pname, line, myname,
   strerror(
# 233 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
           (*__errno_location ())
# 233 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
                ), (int) new_len);
  return 0;
 }
...
# 254 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
((void) sizeof ((
# 254 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
ptr
# 254 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 254 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
...
"ptr"
# 254 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
, "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c", 254, __extension__ __PRETTY_FUNCTION__); }))
# 254 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
               ;
 memset(ptr, 0x0, n);
 return ptr;
 ...
 void *ptr, size_t len)
{
 ...
 const char *pname = 
# 267 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
                    ((void *)0)
# 267 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
                        ;

 if (filename && *filename)
  do { pname = strrchr(filename, '/'); if (pname == 
# 270 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
 ((void *)0)
# 270 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 ) pname = filename; else pname++; } while (0);
 else
  pname = __FILENAME_UNKNOWN;
 ...
 if (ptr == 
# 286 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
           ((void *)0)
# 286 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
               )
  return acl_default_malloc(pname, line, len);

 { if (ptr == 0) acl_msg_fatal("%s(%d): null pointer input", pname, line); real_ptr = (MBLOCK *) (((char*)ptr) - 
# 289 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
__builtin_offsetof (
# 289 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
MBLOCK
# 289 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
, 
# 289 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
...
# 289 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 ...
 new_len = (
# 291 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
          __builtin_offsetof (
# 291 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
          MBLOCK
# 291 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
          , 
# 291 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
...
# 315 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
...
# 317 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
                                (*__errno_location ())
# 317 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
                                     ));
...
void acl_default_free(const char *filename, int line, void *ptr)
{
 ...
 size_t len;
 const char *pname = 
# 335 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
                    ((void *)0)
# 335 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
                        ;

 if (filename && *filename)
  do { pname = strrchr(filename, '/'); if (pname == 
# 338 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
 ((void *)0)
# 338 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 ) pname = filename; else pname++; } while (0);
 else
  pname = __FILENAME_UNKNOWN;

 if (ptr == 
# 342 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
           ((void *)0)
# 342 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
               ) {
 ...
 if (ptr != empty_string) {
  ...
  { if (ptr == 0) acl_msg_fatal("%s(%d): null pointer input", pname, line); real_ptr = (MBLOCK *) (((char*)ptr) - 
# 350 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
 __builtin_offsetof (
# 350 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 MBLOCK
# 350 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
 , 
# 350 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
...
# 364 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
  free((char *) real_ptr);
...
char *acl_default_strdup(const char *filename, int line, const char *str)
{
 ...
 const char *pname = 
# 376 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
                    ((void *)0)
# 376 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
                        ;

 if (filename && *filename)
  do { pname = strrchr(filename, '/'); if (pname == 
# 379 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
 ((void *)0)
# 379 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 ) pname = filename; else pname++; } while (0);
 else
  pname = __FILENAME_UNKNOWN;
 ...
 const char *str, size_t len)
{
 ...
 char *cp;
 const char *pname = 
# 407 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
                    ((void *)0)
# 407 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
                        ;

 if (filename && *filename)
  do { pname = strrchr(filename, '/'); if (pname == 
# 410 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
 ((void *)0)
# 410 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 ) pname = filename; else pname++; } while (0);
 else
  pname = __FILENAME_UNKNOWN;
 ...
 const void *ptr, size_t len)
{
 ...
 const char *pname = 
# 441 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
                    ((void *)0)
# 441 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
                        ;

 if (filename && *filename)
  do { pname = strrchr(filename, '/'); if (pname == 
# 444 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
 ((void *)0)
# 444 "/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 ) pname = filename; else pname++; } while (0);
 else
  pname = __FILENAME_UNKNOWN;
