# 1 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 2
# 28 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
static char __FILENAME_UNKNOWN[] = "unknown file";
static size_t __malloc_limit = 100000000;
# 38 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
...
# 100 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
static char empty_string[] = "";
# 141 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
void acl_default_memstat(const char *filename, int line,
 void *ptr, size_t *len, size_t *real_len)
{
 MBLOCK *real_ptr;
 const char *pname = 
# 145 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
                    ((void *)0)
# 145 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
                        ;
 size_t old_len;

 if (filename && *filename)
  do { pname = strrchr(filename, '/'); if (pname == 
# 149 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
 ((void *)0)
# 149 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 ) pname = filename; else pname++; } while (0);
 else
  pname = __FILENAME_UNKNOWN;

 { if (ptr == 0) acl_msg_fatal("%s(%d): null pointer input", pname, line); real_ptr = (MBLOCK *) (((char*)ptr) - 
# 153 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
__builtin_offsetof (
# 153 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
MBLOCK
# 153 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
, 
# 153 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
...
# 153 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
); if (real_ptr->signature != 0xdead) acl_msg_fatal("%s(%d): corrupt or unallocated block(%d, 0x%x, 0x%x)", pname, line, (int) real_ptr->length, (int) real_ptr->signature, 0xdead); if ((old_len = real_ptr->length) < 1) acl_msg_fatal("%s(%d): corrupt memory block length", pname, line); };
 if (len)
  *len = real_ptr->length;
 if (real_len)
  *real_len = (
# 157 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
             __builtin_offsetof (
# 157 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
             MBLOCK
# 157 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
             , 
# 157 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
...
# 173 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
((void) sizeof ((
# 173 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
len > 0
# 173 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
...
"len > 0"
# 173 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c", 173, __extension__ __PRETTY_FUNCTION__); }))
# 173 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
                   ;
 __malloc_limit = len;
}
...
void *acl_default_malloc(const char *filename, int line, size_t len)
{
 ...
 MBLOCK *real_ptr;
 const char *pname = 
# 188 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
                    ((void *)0)
# 188 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
                        ;
 ...
 if (filename && *filename)
  do { pname = strrchr(filename, '/'); if (pname == 
# 196 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
 ((void *)0)
# 196 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 ) pname = filename; else pname++; } while (0);
 else
  pname = __FILENAME_UNKNOWN;
 ...
 new_len = (
# 207 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
          __builtin_offsetof (
# 207 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
          MBLOCK
# 207 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
          , 
# 207 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
...
# 207 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 ...
 if (new_len <= 0)
  acl_msg_fatal("%s(%d): new_len(%d) <= 0",
   myname, 210, (int) new_len);
 else if (new_len >= __malloc_limit) {
  acl_msg_warn("%s(%d): new_len(%d) too large",
   myname, 213, (int) new_len);
  acl_trace_info();
 }
# 230 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 if ((real_ptr = (MBLOCK *) malloc(new_len)) == 0) {
  acl_msg_error("%s(%d)->%s: malloc: insufficient memory: %s, "
   "new_len: %d", pname, line, myname,
   strerror(
# 233 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
           (*__errno_location ())
# 233 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
                ), (int) new_len);
  return 0;
 }


 { real_ptr->signature = 0xdead; real_ptr->length = len; ptr = real_ptr->u.payload; };
 return ptr;
}
...
# 254 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
((void) sizeof ((
# 254 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
ptr
# 254 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 254 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
...
"ptr"
# 254 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c", 254, __extension__ __PRETTY_FUNCTION__); }))
# 254 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
               ;
 memset(ptr, 0x0, n);
 return ptr;
 ...
 void *ptr, size_t len)
{
 ...
 const char *pname = 
# 267 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
                    ((void *)0)
# 267 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
                        ;

 if (filename && *filename)
  do { pname = strrchr(filename, '/'); if (pname == 
# 270 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
 ((void *)0)
# 270 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 ) pname = filename; else pname++; } while (0);
 else
  pname = __FILENAME_UNKNOWN;
 ...
 if (ptr == 
# 286 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
           ((void *)0)
# 286 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
               )
  return acl_default_malloc(pname, line, len);

 { if (ptr == 0) acl_msg_fatal("%s(%d): null pointer input", pname, line); real_ptr = (MBLOCK *) (((char*)ptr) - 
# 289 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
__builtin_offsetof (
# 289 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
MBLOCK
# 289 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
, 
# 289 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
...
# 289 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
); if (real_ptr->signature != 0xdead) acl_msg_fatal("%s(%d): corrupt or unallocated block(%d, 0x%x, 0x%x)", pname, line, (int) real_ptr->length, (int) real_ptr->signature, 0xdead); real_ptr->signature = 0; if ((old_len = real_ptr->length) < 1) acl_msg_fatal("%s(%d): corrupt memory block length", pname, line); };

 new_len = (
# 291 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
          __builtin_offsetof (
# 291 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
          MBLOCK
# 291 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
          , 
# 291 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
...
# 291 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 ...
 if (new_len <= 0)
  acl_msg_fatal("%s(%d): new_len(%d) <= 0",
   myname, 294, (int) new_len);
 else if (new_len >= __malloc_limit) {
  acl_msg_warn("%s(%d): new_len(%d) too large",
   myname, 297, (int) new_len);
  acl_trace_info();
 }
# 315 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 if ((real_ptr = (MBLOCK *) realloc((char *) real_ptr, new_len)) == 0)
  acl_msg_fatal("%s(%d)->%s: realloc: insufficient memory: %s",
   pname, line, myname, strerror(
# 317 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
                                (*__errno_location ())
# 317 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
                                     ));
...
void acl_default_free(const char *filename, int line, void *ptr)
{
 ...
 size_t len;
 const char *pname = 
# 335 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
                    ((void *)0)
# 335 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
                        ;

 if (filename && *filename)
  do { pname = strrchr(filename, '/'); if (pname == 
# 338 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
 ((void *)0)
# 338 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 ) pname = filename; else pname++; } while (0);
 else
  pname = __FILENAME_UNKNOWN;

 if (ptr == 
# 342 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
           ((void *)0)
# 342 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
               ) {
 ...
 if (ptr != empty_string) {
  ...
  { if (ptr == 0) acl_msg_fatal("%s(%d): null pointer input", pname, line); real_ptr = (MBLOCK *) (((char*)ptr) - 
# 350 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
 __builtin_offsetof (
# 350 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 MBLOCK
# 350 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
 , 
# 350 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
...
# 350 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 ); if (real_ptr->signature != 0xdead) acl_msg_fatal("%s(%d): corrupt or unallocated block(%d, 0x%x, 0x%x)", pname, line, (int) real_ptr->length, (int) real_ptr->signature, 0xdead); real_ptr->signature = 0; if ((len = real_ptr->length) < 1) acl_msg_fatal("%s(%d): corrupt memory block length", pname, line); };
# 364 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
  free((char *) real_ptr);
...
char *acl_default_strdup(const char *filename, int line, const char *str)
{
 ...
 const char *pname = 
# 376 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
                    ((void *)0)
# 376 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
                        ;

 if (filename && *filename)
  do { pname = strrchr(filename, '/'); if (pname == 
# 379 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
 ((void *)0)
# 379 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 ) pname = filename; else pname++; } while (0);
 else
  pname = __FILENAME_UNKNOWN;
 ...
 const char *str, size_t len)
{
 ...
 char *cp;
 const char *pname = 
# 407 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
                    ((void *)0)
# 407 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
                        ;

 if (filename && *filename)
  do { pname = strrchr(filename, '/'); if (pname == 
# 410 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
 ((void *)0)
# 410 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 ) pname = filename; else pname++; } while (0);
 else
  pname = __FILENAME_UNKNOWN;
 ...
 const void *ptr, size_t len)
{
 ...
 const char *pname = 
# 441 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
                    ((void *)0)
# 441 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
                        ;

 if (filename && *filename)
  do { pname = strrchr(filename, '/'); if (pname == 
# 444 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c" 3 4
 ((void *)0)
# 444 "/workspace/acl/lib_acl/src/stdlib/memory/acl_default_malloc.c"
 ) pname = filename; else pname++; } while (0);
 else
  pname = __FILENAME_UNKNOWN;
