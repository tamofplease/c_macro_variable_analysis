# 0 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
...
# 2 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 2
# 17 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
# 1 "/acl/lib_acl/src/stdlib/memory/squid_allocator.h" 1
# 9 "/acl/lib_acl/src/stdlib/memory/squid_allocator.h"
# 1 "/acl/lib_acl/include/stdlib/acl_allocator.h" 1
# 10 "/acl/lib_acl/src/stdlib/memory/squid_allocator.h" 2
...
# 12 "/acl/lib_acl/src/stdlib/memory/squid_allocator.h" 2
...
# 18 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 2
...
static ACL_MEM_POOL *pool_create(void)
{
 ...
 return 
# 35 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
       ((void *)0)
# 35 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
           ;
}
 ...
 ACL_ALLOCATOR *allocator __attribute__ ((__unused__)), ACL_MEM_POOL * pool __attribute__ ((__unused__)))
{
 ...
 return 
# 58 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
       ((void *)0)
# 58 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
           ;
}
...
ACL_ALLOCATOR *allocator_alloc(size_t size)
{
 ...
 allocator = (ACL_ALLOCATOR *) acl_default_calloc("/acl/lib_acl/src/stdlib/memory/acl_allocator.c", 106,
   1, size);
...
# 145 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
__builtin_va_start(
# 145 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
ap
# 145 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
,
# 145 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
...
# 145 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                  ;
 for (; name != 0; name = 
# 146 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                                             __builtin_va_arg(
# 146 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                                             ap
# 146 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                                             ,
# 146 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
...
# 146 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
  ...
  case 1:
   __min_gross_size = 
# 149 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                     __builtin_va_arg(
# 149 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                     ap
# 149 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                     ,
# 149 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
...
# 149 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
  ...
  case 2:
   __max_gross_size = 
# 152 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                     __builtin_va_arg(
# 152 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                     ap
# 152 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                     ,
# 152 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
...
# 159 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
__builtin_va_end(
# 159 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
ap
# 159 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
)
# 159 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
...
void acl_allocator_free(ACL_ALLOCATOR *allocator)
{
 ...
 while (1) {
  ...
  if (pool == 
# 174 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
             ((void *)0)
# 174 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                 )
   break;
...
# 179 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                                    ((void *)0)
# 179 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                                        );
 acl_default_free("/acl/lib_acl/src/stdlib/memory/acl_allocator.c", 180, allocator);
}
...
void acl_allocator_pool_remove(ACL_ALLOCATOR *allocator, ACL_MEM_POOL *pool)
{
 ...
 if (allocator == 
# 217 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                 ((void *)0) 
# 217 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                      || pool == 
# 217 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                                 ((void *)0)
# 217 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
...
# 223 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                                    ((void *)0)
# 223 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                                        ;
   allocator->pool_destroy_fn(data);
   acl_stack_delete(allocator->pools, iter.i, 
# 225 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                                             ((void *)0)
# 225 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                                                 );
   break;
  }
 }
...
# 355 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                                                         ((void *)0)
# 355 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                                                             );
...
# 368 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                                                      ((void *)0)
# 368 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                                                          );
 type = memBufFindSizeType(gross_size, 
# 369 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                                      ((void *)0)
# 369 "/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                                          );
