# 1 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 2
# 17 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
# 1 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.h" 1
# 9 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.h"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_allocator.h" 1
# 10 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.h" 2
...
# 12 "/workspace/acl/lib_acl/src/stdlib/memory/squid_allocator.h" 2
...
# 18 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 2


static size_t __min_gross_size = 0;
static size_t __max_gross_size = 1048576;
...
static ACL_MEM_POOL *pool_create(void)
{
 ...
 return 
# 35 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
       ((void *)0)
# 35 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
           ;
}

static void pool_destroy(ACL_MEM_POOL * pool __attribute__ ((__unused__)))
{
...
static void pool_clean(ACL_ALLOCATOR *allocator __attribute__ ((__unused__)))
{
...
static void *mem_alloc(const char *filename, int line,
 ACL_ALLOCATOR *allocator __attribute__ ((__unused__)), ACL_MEM_POOL * pool __attribute__ ((__unused__)))
{
 const char *myname = "mem_alloc";

 acl_msg_fatal("%s: not supported, %s(%d)", myname, filename , line);
 return 
# 58 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
       ((void *)0)
# 58 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
           ;
}

static void mem_free(const char *filename, int line,
 ACL_ALLOCATOR *allocator __attribute__ ((__unused__)),
 ACL_MEM_POOL *pool __attribute__ ((__unused__)), void *obj __attribute__ ((__unused__)))
{
...
static int pool_ifused(const ACL_MEM_POOL *pool __attribute__ ((__unused__)))
{
...
static int pool_inuse_count(const ACL_MEM_POOL *pool __attribute__ ((__unused__)))
{
...
static size_t pool_inuse_size(const ACL_MEM_POOL *pool __attribute__ ((__unused__)))
{
...
static size_t pool_total_allocated(ACL_ALLOCATOR *pool __attribute__ ((__unused__)))
{
...
ACL_ALLOCATOR *allocator_alloc(size_t size)
{
 ...
 allocator = (ACL_ALLOCATOR *) acl_default_calloc("/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c", 106,
   1, size);
...
# 145 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
__builtin_va_start(
# 145 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
ap
# 145 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
,
# 145 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
...
# 145 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                  ;
 for (; name != 0; name = 
# 146 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                                             __builtin_va_arg(
# 146 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                                             ap
# 146 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                                             ,
# 146 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
...
# 146 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
  ...
  case 1:
   __min_gross_size = 
# 149 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                     __builtin_va_arg(
# 149 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                     ap
# 149 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                     ,
# 149 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
...
# 149 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
  ...
  case 2:
   __max_gross_size = 
# 152 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                     __builtin_va_arg(
# 152 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                     ap
# 152 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                     ,
# 152 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
...
# 159 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
__builtin_va_end(
# 159 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
ap
# 159 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
)
# 159 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
...
void acl_allocator_free(ACL_ALLOCATOR *allocator)
{
 ...
 while (1) {
  ...
  if (pool == 
# 174 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
             ((void *)0)
# 174 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                 )
   break;
  allocator->pool_destroy_fn(pool);
 }

 acl_stack_destroy(allocator->pools, 
# 179 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                                    ((void *)0)
# 179 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                                        );
 acl_default_free("/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c", 180, allocator);
}
 ...
 void (*before_free_fn)(void *obj, void *pool_ctx), void *pool_ctx)
{
 ...
 do { if (type >= ACL_MEM_TYPE_MAX) acl_msg_fatal("%s: type(%d) > ACL_MEM_TYPE_MAX(%d)", myname, type, ACL_MEM_TYPE_MAX); } while (0);
...
void acl_allocator_pool_remove(ACL_ALLOCATOR *allocator, ACL_MEM_POOL *pool)
{
 ...
 if (allocator == 
# 217 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                 ((void *)0) 
# 217 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                      || pool == 
# 217 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                                 ((void *)0)
# 217 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
 ...
 for ((allocator->pools)->iter_head(&(iter), (allocator->pools)); (iter).ptr; (allocator->pools)->iter_next(&(iter), (allocator->pools))) {
  data = (ACL_MEM_POOL*) iter.data;
  if (data == pool) {
   allocator->MemPools[pool->type] = 
# 223 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                                    ((void *)0)
# 223 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                                        ;
   allocator->pool_destroy_fn(data);
   acl_stack_delete(allocator->pools, iter.i, 
# 225 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                                             ((void *)0)
# 225 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                                                 );
   break;
  }
 }
 ...
 ACL_ALLOCATOR *allocator, void *oldbuf, size_t size)
{
 ...
 if (oldbuf) {
  ...
  acl_default_memstat(filename, line, oldbuf, &data_size, 
# 355 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                                                         ((void *)0)
# 355 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                                                             );
 ...
 ACL_ALLOCATOR *allocator, void *buf)
{
 ...
 acl_default_memstat(filename, line, buf, &gross_size, 
# 368 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                                                      ((void *)0)
# 368 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                                                          );
 type = memBufFindSizeType(gross_size, 
# 369 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c" 3 4
                                      ((void *)0)
# 369 "/workspace/acl/lib_acl/src/stdlib/memory/acl_allocator.c"
                                          );
