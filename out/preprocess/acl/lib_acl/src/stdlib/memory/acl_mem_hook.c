# 1 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_hook.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_hook.c" 2
# 17 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_hook.c"
...
# 18 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_hook.c" 2
  ...
  void (*free_hook)(const char*, int, void*))
{
 ...
 if (malloc_hook == 
# 29 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_hook.c" 3 4
                   ((void *)0)
# 29 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_hook.c"
                       ) {
  acl_msg_error("%s(%d): malloc_hook null", myname, 30);
 } else if (calloc_hook == 
# 31 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_hook.c" 3 4
                          ((void *)0)
# 31 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_hook.c"
                              ) {
  acl_msg_error("%s(%d): calloc_hook null", myname, 32);
 } else if (realloc_hook == 
# 33 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_hook.c" 3 4
                           ((void *)0)
# 33 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_hook.c"
                               ) {
  acl_msg_error("%s(%d): realloc_hook null", myname, 34);
 } else if (strdup_hook == 
# 35 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_hook.c" 3 4
                          ((void *)0)
# 35 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_hook.c"
                              ) {
  acl_msg_error("%s(%d): strdup_hook null", myname, 36);
 } else if (strndup_hook == 
# 37 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_hook.c" 3 4
                           ((void *)0)
# 37 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_hook.c"
                               ) {
  acl_msg_error("%s(%d): strncup_hook null", myname, 38);
 } else if (memdup_hook == 
# 39 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_hook.c" 3 4
                          ((void *)0)
# 39 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_hook.c"
                              ) {
  acl_msg_error("%s(%d): memdup_hook null", myname, 40);
 } else if (free_hook == 
# 41 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_hook.c" 3 4
                        ((void *)0)
# 41 "/workspace/acl/lib_acl/src/stdlib/memory/acl_mem_hook.c"
                            ) {
  acl_msg_error("%s(%d): free_hook null", myname, 42);
 } else {
