# 0 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
...
# 2 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 2
# 27 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
...
static void vstream_parse_args(ACL_VSTREAM_POPEN_ARGS *args, va_list ap)
{
 ...
 while ((key = 
# 69 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
              __builtin_va_arg(
# 69 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
              ap
# 69 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
              ,
# 69 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
...
# 69 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
  ...
  case 2:
   ...
   args->argv = 
# 76 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
               __builtin_va_arg(
# 76 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
               ap
# 76 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
               ,
# 76 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
...
# 76 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
  ...
  case 1:
   ...
   args->command = 
# 83 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
                  __builtin_va_arg(
# 83 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
                  ap
# 83 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
                  ,
# 83 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
...
# 83 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
  ...
  case 5:
   args->env = 
# 86 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
              __builtin_va_arg(
# 86 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
              ap
# 86 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
              ,
# 86 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
...
# 86 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
  ...
  case 8:
   args->export = 
# 89 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
                 __builtin_va_arg(
# 89 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
                 ap
# 89 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
                 ,
# 89 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
...
# 89 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
  ...
  case 6:
   args->shell = 
# 92 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
                __builtin_va_arg(
# 92 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
                ap
# 92 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
                ,
# 92 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
...
# 92 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
  ...
  case 3:
   ...
   args->uid = 
# 100 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
              __builtin_va_arg(
# 100 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
              ap
# 100 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
              ,
# 100 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
...
# 100 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
  ...
  case 4:
   ...
   args->gid = 
# 108 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
              __builtin_va_arg(
# 108 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
              ap
# 108 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
              ,
# 108 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
...
# 108 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
  ...
  case 7:
   args->waitpid_fn = 
# 112 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
                     __builtin_va_arg(
# 112 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
                     ap
# 112 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
                     ,
# 112 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
...
static char *dump_cmdline(const ACL_VSTREAM_POPEN_ARGS *args)
{
 ...
 if (args->argv) {
  ...
  for (i = 0; args->argv[i] != 
# 143 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
                              ((void *)0)
# 143 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
                                  ; i++) {
   if (i > 0) {
...
# 184 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
__builtin_va_start(
# 184 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
ap
# 184 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
,
# 184 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
...
# 186 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
__builtin_va_end(
# 186 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
ap
# 186 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
)
# 186 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
 ...
 case 0:
  ...
  return 
# 259 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
        ((void *)0)
# 259 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
            ;
 default:
  if (close(sockfd[0])) {
   acl_msg_warn("close: %s", acl_last_serror());
...
int acl_vstream_pclose(ACL_VSTREAM *fp)
{
 ...
 if (fp->errnum == 
# 294 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
                  110
# 294 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
                               ) {
  acl_msg_warn("%s(%d): timeout, kill child(%d), cmdline='%s'",
   __FUNCTION__, 296, saved_pid,
   fp->context ? (char*) fp->context : "unknown");
  kill(saved_pid, 
# 298 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
                 15
# 298 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
                        );
 }

 fp->pid = 0;
 if (fp->context) {
  do { if (fp->context) { acl_free_glue("/acl/lib_acl/src/stdlib/acl_vstream_popen.c", 303, (fp->context)); (fp->context) = 
# 303 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
 ((void *)0)
# 303 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
 ; } } while (0);
 }
...
# 316 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
                      (*__errno_location ()) 
# 316 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
                            == 
# 316 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
                               4
# 316 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
 ...
 return pid == -1 ? -1 : 
# 318 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
                        (((signed char) (((
# 318 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
                        wait_status
# 318 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
                        ) & 0x7f) + 1) >> 1) > 0) 
# 318 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
...
# 319 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
 ((
# 319 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
 wait_status
# 319 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c" 3 4
 ) & 0x7f) 
# 319 "/acl/lib_acl/src/stdlib/acl_vstream_popen.c"
