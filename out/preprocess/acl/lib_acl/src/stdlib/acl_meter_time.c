# 1 "/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c" 2
# 18 "/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c"
...
{
 do { if (ptr) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c", 25, (ptr)); (ptr) = 
# 25 "/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c" 3 4
((void *)0)
# 25 "/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c"
; } } while (0);
}

static void *__tls = 
# 28 "/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c" 3 4
                    ((void *)0)
# 28 "/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c"
                        ;
...
{
 if (__tls) {
  do { if (__tls) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c", 34, (__tls)); (__tls) = 
# 34 "/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c" 3 4
 ((void *)0)
# 34 "/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c"
 ; } } while (0);
  __tls = 
# 35 "/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c" 3 4
         ((void *)0)
# 35 "/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c"
             ;
 }
}
...
# 52 "/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c" 3 4
                                        0
# 52 "/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c"
                                                             ;
static void *tls_calloc(size_t len)
{
 ...
 if (ptr == 
# 59 "/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c" 3 4
           ((void *)0)
# 59 "/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c"
               ) {
  ptr = acl_calloc_glue("/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c", 60, 1, len);
...
double acl_meter_time(const char *filename, int line, const char *info)
{
 ...
 if (ctx->init_done == 0) {
  ctx->init_done = 1;
  gettimeofday(&ctx->stamp, 
# 81 "/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c" 3 4
                           ((void *)0)
# 81 "/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c"
                               );
 }

 gettimeofday(&now, 
# 84 "/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c" 3 4
                   ((void *)0)
# 84 "/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c"
                       );
 ...
 gettimeofday(&ctx->stamp, 
# 100 "/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c" 3 4
                          ((void *)0)
# 100 "/workspace/acl/lib_acl/src/stdlib/acl_meter_time.c"
                              );
 return (f);
}
