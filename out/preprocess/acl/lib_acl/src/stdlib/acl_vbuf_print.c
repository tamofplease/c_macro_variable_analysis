# 0 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
...
# 2 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 2
# 81 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
ACL_VBUF *acl_vbuf_print(ACL_VBUF *bp, const char *format, va_list ap)
{
 ...
 char fmt[128 + 1];
 int i;
# 103 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
...
# 125 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
  i = 0;
  fmt[i++] = *cp++;
  if (*cp == '-')
   fmt[i++] = *cp++;
  ...
  if (*cp == '*') {
   width = 
# 134 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
          __builtin_va_arg(
# 134 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
          ap
# 134 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
          ,
# 134 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
...
# 134 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
   ...
   for (width = 0; 
# 139 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                  ((*__ctype_b_loc ())[(int) ((
# 139 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
                  ((unsigned char)(ch = *cp))
# 139 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
...
# 139 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
  ...
  if (*cp == '*') {
   prec = 
# 148 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
         __builtin_va_arg(
# 148 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
         ap
# 148 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
         ,
# 148 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
...
# 148 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
   ...
   for (prec = 0; 
# 153 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                 ((*__ctype_b_loc ())[(int) ((
# 153 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
                 ((unsigned char)(ch = *cp))
# 153 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                 ))] & (unsigned short int) _ISdigit)
# 153 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
...
# 178 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
  if (*cp == 'l') {
   if (*(cp + 1) == 'l') {
    fmt[i++] = *cp++;
    fmt[i++] = *cp++;
  ...
  case 's':
   s = 
# 207 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
      __builtin_va_arg(
# 207 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
      ap
# 207 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
      ,
# 207 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
...
# 234 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                                  __builtin_va_arg(
# 234 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
                                  ap
# 234 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                                  ,
# 234 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
...
# 234 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
    ...
    sprintf((char *) bp->ptr, fmt, 
# 236 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                                  __builtin_va_arg(
# 236 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
                                  ap
# 236 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                                  ,
# 236 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
...
# 236 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
    ...
    sprintf((char *) bp->ptr, fmt, 
# 238 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                                  __builtin_va_arg(
# 238 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
                                  ap
# 238 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                                  ,
# 238 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
...
# 238 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
  ...
  case 'g':
   ...
   sprintf((char *) bp->ptr, fmt, 
# 253 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                                 __builtin_va_arg(
# 253 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
                                 ap
# 253 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                                 ,
# 253 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
...
# 253 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
  ...
  case 'p':
   ...
   sprintf((char *) bp->ptr, fmt, 
# 265 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                                 __builtin_va_arg(
# 265 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
                                 ap
# 265 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                                 ,
# 265 "/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
