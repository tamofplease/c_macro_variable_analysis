# 1 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 2
# 81 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
ACL_VBUF *acl_vbuf_print(ACL_VBUF *bp, const char *format, va_list ap)
{
 ...
 char fmt[128 + 1];
 int i;
# 103 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
 for (cp = (const unsigned char *) format; *cp; cp++) {
  if (*cp != '%') {
   ((bp)->ptr < (bp)->data + (bp)->len ? (int) (*(bp)->ptr++ = (*cp)) : acl_vbuf_put((bp),(*cp)));
   continue;
  } else if (cp[1] == '%') {
   ((bp)->ptr < (bp)->data + (bp)->len ? (int) (*(bp)->ptr++ = (*cp++)) : acl_vbuf_put((bp),(*cp++)));
   continue;
  }
# 125 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
  i = 0;
  fmt[i++] = *cp++;
  if (*cp == '-')
   fmt[i++] = *cp++;
  ...
  if (*cp == '*') {
   width = 
# 134 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
          __builtin_va_arg(
# 134 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
          ap
# 134 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
          ,
# 134 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
...
# 134 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
   ...
   for (width = 0; 
# 139 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                  ((*__ctype_b_loc ())[(int) ((
# 139 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
                  ((unsigned char)(ch = *cp))
# 139 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
...
# 139 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
    ...
    width = width * 10 + ch - '0';
    fmt[i++] = ch;
    do { if (i >= 128) acl_msg_fatal("fmt overflow: i: %d MAX: %d", (i), (128)); } while (0);
   }
  }
  if (*cp == '.')
   fmt[i++] = *cp++;
  if (*cp == '*') {
   prec = 
# 148 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
         __builtin_va_arg(
# 148 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
         ap
# 148 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
         ,
# 148 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
...
# 148 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
   ...
   for (prec = 0; 
# 153 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                 ((*__ctype_b_loc ())[(int) ((
# 153 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
                 ((unsigned char)(ch = *cp))
# 153 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                 ))] & (unsigned short int) _ISdigit)
# 153 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
...
# 178 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
  if (*cp == 'l') {
   if (*(cp + 1) == 'l') {
    fmt[i++] = *cp++;
    fmt[i++] = *cp++;
  ...
  case 's':
   s = 
# 207 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
      __builtin_va_arg(
# 207 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
      ap
# 207 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
      ,
# 207 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
...
# 207 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
   ...
   if (prec > 0 || (width > 0 &&
    ...
    if (acl_vbuf_space(bp, (width > prec
     ? width : prec) + ((8 * sizeof(long long int)) / 2))) {
     return bp;
    }

    sprintf((char *) bp->ptr, fmt, s ? s : null);
    { while ((bp)->ptr < (bp)->data + (bp)->len && *(bp)->ptr) { (bp)->ptr++; } };
   } else {
    { const unsigned char *_cp = (const unsigned char *) (s ? s : null); int _ch; while ((_ch = *_cp++) != 0) { (((bp))->ptr < ((bp))->data + ((bp))->len ? (int) (*((bp))->ptr++ = (_ch)) : acl_vbuf_put(((bp)),(_ch))); } };
   }
   break;
  case 'c':
  case 'd':
  ...
  case 'X':
   ...
   if (long_flag == 0)
    sprintf((char *) bp->ptr, fmt, 
# 234 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                                  __builtin_va_arg(
# 234 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
                                  ap
# 234 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                                  ,
# 234 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
...
# 234 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
    ...
    sprintf((char *) bp->ptr, fmt, 
# 236 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                                  __builtin_va_arg(
# 236 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
                                  ap
# 236 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                                  ,
# 236 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
...
# 236 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
    ...
    sprintf((char *) bp->ptr, fmt, 
# 238 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                                  __builtin_va_arg(
# 238 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
                                  ap
# 238 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                                  ,
# 238 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
...
# 238 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
  ...
  case 'g':
   if (acl_vbuf_space(bp, (width > prec
    ? width : prec) + ((8 * sizeof(double)) / 2 + 308))) {

    return bp;
   }
   sprintf((char *) bp->ptr, fmt, 
# 253 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                                 __builtin_va_arg(
# 253 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
                                 ap
# 253 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                                 ,
# 253 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
...
# 253 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
   ...
   break;
  case 'm':
   { const unsigned char *_cp = (const unsigned char *) (acl_last_serror()); int _ch; while ((_ch = *_cp++) != 0) { (((bp))->ptr < ((bp))->data + ((bp))->len ? (int) (*((bp))->ptr++ = (_ch)) : acl_vbuf_put(((bp)),(_ch))); } };
   break;
  case 'p':
   if (acl_vbuf_space(bp, (width > prec
    ? width : prec) + ((8 * sizeof(char *)) / 2))) {

    return bp;
   }
   sprintf((char *) bp->ptr, fmt, 
# 265 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                                 __builtin_va_arg(
# 265 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
                                 ap
# 265 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c" 3 4
                                 ,
# 265 "/workspace/acl/lib_acl/src/stdlib/acl_vbuf_print.c"
