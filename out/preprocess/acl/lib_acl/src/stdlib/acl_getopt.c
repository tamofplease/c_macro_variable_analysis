# 0 "/acl/lib_acl/src/stdlib/acl_getopt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/acl_getopt.c"
...
# 2 "/acl/lib_acl/src/stdlib/acl_getopt.c" 2
# 15 "/acl/lib_acl/src/stdlib/acl_getopt.c"
# 1 "/acl/lib_acl/include/stdlib/acl_getopt.h" 1
# 16 "/acl/lib_acl/src/stdlib/acl_getopt.c" 2

char *acl_optarg = 
# 17 "/acl/lib_acl/src/stdlib/acl_getopt.c" 3 4
                  ((void *)0)
# 17 "/acl/lib_acl/src/stdlib/acl_getopt.c"
                      ;
int acl_optind = 0;

static char *scan = 
# 20 "/acl/lib_acl/src/stdlib/acl_getopt.c" 3 4
                   ((void *)0)
# 20 "/acl/lib_acl/src/stdlib/acl_getopt.c"
                       ;

void acl_getopt_init(void)
{
 scan = 
# 24 "/acl/lib_acl/src/stdlib/acl_getopt.c" 3 4
       ((void *)0)
# 24 "/acl/lib_acl/src/stdlib/acl_getopt.c"
           ;
}
...
int acl_getopt(int argc, char * argv[], const char *optstring)
{
 ...
 acl_optarg = 
# 32 "/acl/lib_acl/src/stdlib/acl_getopt.c" 3 4
             ((void *)0)
# 32 "/acl/lib_acl/src/stdlib/acl_getopt.c"
                 ;

 if (scan == 
# 34 "/acl/lib_acl/src/stdlib/acl_getopt.c" 3 4
            ((void *)0) 
# 34 "/acl/lib_acl/src/stdlib/acl_getopt.c"
                 || *scan == '\0') {
  if (acl_optind == 0)
   acl_optind++;
  ...
  if (acl_optind >= argc || argv[acl_optind][0] != '-' || argv[acl_optind][1] == '\0')
   return(
# 39 "/acl/lib_acl/src/stdlib/acl_getopt.c" 3 4
         (-1)
# 39 "/acl/lib_acl/src/stdlib/acl_getopt.c"
            );
  if (strcmp(argv[acl_optind], "--")==0) {
   acl_optind++;
   return(
# 42 "/acl/lib_acl/src/stdlib/acl_getopt.c" 3 4
         (-1)
# 42 "/acl/lib_acl/src/stdlib/acl_getopt.c"
            );
  }
 ...
 if (place == 
# 52 "/acl/lib_acl/src/stdlib/acl_getopt.c" 3 4
             ((void *)0) 
# 52 "/acl/lib_acl/src/stdlib/acl_getopt.c"
                  || c == ':') {
 ...
 if (*place == ':') {
  if (*scan != '\0') {
   acl_optarg = scan;
   scan = 
# 61 "/acl/lib_acl/src/stdlib/acl_getopt.c" 3 4
         ((void *)0)
# 61 "/acl/lib_acl/src/stdlib/acl_getopt.c"
             ;
