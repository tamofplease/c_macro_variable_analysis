# 1 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c" 2
# 15 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_getopt.h" 1
# 16 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c" 2

char *acl_optarg = 
# 17 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c" 3 4
                  ((void *)0)
# 17 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c"
                      ;
int acl_optind = 0;

static char *scan = 
# 20 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c" 3 4
                   ((void *)0)
# 20 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c"
                       ;

void acl_getopt_init(void)
{
 scan = 
# 24 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c" 3 4
       ((void *)0)
# 24 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c"
           ;
}
...
int acl_getopt(int argc, char * argv[], const char *optstring)
{
 ...
 acl_optarg = 
# 32 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c" 3 4
             ((void *)0)
# 32 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c"
                 ;

 if (scan == 
# 34 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c" 3 4
            ((void *)0) 
# 34 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c"
                 || *scan == '\0') {
  if (acl_optind == 0)
   acl_optind++;
  ...
  if (acl_optind >= argc || argv[acl_optind][0] != '-' || argv[acl_optind][1] == '\0')
   return(
# 39 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c" 3 4
         (-1)
# 39 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c"
            );
  if (strcmp(argv[acl_optind], "--")==0) {
   acl_optind++;
   return(
# 42 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c" 3 4
         (-1)
# 42 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c"
            );
  }
 ...
 if (place == 
# 52 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c" 3 4
             ((void *)0) 
# 52 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c"
                  || c == ':') {
 ...
 if (*place == ':') {
  if (*scan != '\0') {
   acl_optarg = scan;
   scan = 
# 61 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c" 3 4
         ((void *)0)
# 61 "/workspace/acl/lib_acl/src/stdlib/acl_getopt.c"
             ;
