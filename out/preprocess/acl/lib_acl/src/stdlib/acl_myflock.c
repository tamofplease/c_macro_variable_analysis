# 1 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c" 2
# 32 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c"
...
# 33 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c" 2





# 37 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c"
int acl_myflock(int fd, int lock_style, int operation)
{
 int status = 0;
...
# 56 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
  8
# 56 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c"
         , 
# 56 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
           1
# 56 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c"
...
# 56 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c"
                           , -1,
   -1, 
# 57 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
      1 
# 57 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c"
              | 
# 57 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
                4
# 57 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c"
...
# 75 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
  2
# 75 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c"
         , 
# 75 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
           0
# 75 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c"
...
# 76 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c"
 };

  memset((char *) &lock, 0, sizeof(lock));
  lock.l_type = lock_ops[operation & ~4];
  request = (operation & 4) ? 
# 80 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
                                               6 
# 80 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c"
                                                       : 
# 80 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
                                                         7
# 80 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c"
  ...
  while ((status = fcntl(fd, request, &lock)) < 0
   && request == 
# 82 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
                7
   
# 83 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c"
  && (acl_last_error() == 
# 83 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
                          4
       
# 84 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c"
      || acl_last_error() == 
# 84 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
                             37
    
# 85 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c"
   || acl_last_error() == 
# 85 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
                          35
# 85 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c"
                                 ))
   sleep(1);
 ...
 if (status < 0 && (operation & 4) != 0) {
  char error = acl_last_error();
  if (error == 
# 100 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
              11 
# 100 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c"
                         || error == 
# 100 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
                                     11 
# 100 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c"
...
# 100 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c"
   ...
   acl_set_error(
# 101 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
                11
# 101 "/workspace/acl/lib_acl/src/stdlib/acl_myflock.c"
                          );
 }
