# 0 "/acl/lib_acl/src/stdlib/acl_myflock.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/acl_myflock.c"
...
# 2 "/acl/lib_acl/src/stdlib/acl_myflock.c" 2
# 32 "/acl/lib_acl/src/stdlib/acl_myflock.c"
...
# 33 "/acl/lib_acl/src/stdlib/acl_myflock.c" 2





# 37 "/acl/lib_acl/src/stdlib/acl_myflock.c"
int acl_myflock(int fd, int lock_style, int operation)
{
 int status = 0;
...
# 56 "/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
  8
# 56 "/acl/lib_acl/src/stdlib/acl_myflock.c"
         , 
# 56 "/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
           1
# 56 "/acl/lib_acl/src/stdlib/acl_myflock.c"
...
# 56 "/acl/lib_acl/src/stdlib/acl_myflock.c"
                           , -1,
   -1, 
# 57 "/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
      1 
# 57 "/acl/lib_acl/src/stdlib/acl_myflock.c"
              | 
# 57 "/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
                4
# 57 "/acl/lib_acl/src/stdlib/acl_myflock.c"
...
# 75 "/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
  2
# 75 "/acl/lib_acl/src/stdlib/acl_myflock.c"
         , 
# 75 "/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
           0
# 75 "/acl/lib_acl/src/stdlib/acl_myflock.c"
...
# 76 "/acl/lib_acl/src/stdlib/acl_myflock.c"
 };

  memset((char *) &lock, 0, sizeof(lock));
  lock.l_type = lock_ops[operation & ~4];
  request = (operation & 4) ? 
# 80 "/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
                                               6 
# 80 "/acl/lib_acl/src/stdlib/acl_myflock.c"
                                                       : 
# 80 "/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
                                                         7
# 80 "/acl/lib_acl/src/stdlib/acl_myflock.c"
  ...
  while ((status = fcntl(fd, request, &lock)) < 0
   && request == 
# 82 "/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
                7
   
# 83 "/acl/lib_acl/src/stdlib/acl_myflock.c"
  && (acl_last_error() == 
# 83 "/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
                          4
       
# 84 "/acl/lib_acl/src/stdlib/acl_myflock.c"
      || acl_last_error() == 
# 84 "/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
                             37
    
# 85 "/acl/lib_acl/src/stdlib/acl_myflock.c"
   || acl_last_error() == 
# 85 "/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
                          35
# 85 "/acl/lib_acl/src/stdlib/acl_myflock.c"
                                 ))
   sleep(1);
 ...
 if (status < 0 && (operation & 4) != 0) {
  ...
  if (error == 
# 100 "/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
              11 
# 100 "/acl/lib_acl/src/stdlib/acl_myflock.c"
                         || error == 
# 100 "/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
                                     11 
# 100 "/acl/lib_acl/src/stdlib/acl_myflock.c"
...
# 100 "/acl/lib_acl/src/stdlib/acl_myflock.c"
   ...
   acl_set_error(
# 101 "/acl/lib_acl/src/stdlib/acl_myflock.c" 3 4
                11
# 101 "/acl/lib_acl/src/stdlib/acl_myflock.c"
                          );
 }
