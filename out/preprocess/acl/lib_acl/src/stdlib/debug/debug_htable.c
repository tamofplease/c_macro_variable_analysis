# 1 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c" 2
# 27 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c"
...
# 28 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c" 2
...
struct DEBUG_HTABLE {
 ...
 int init_size;
 int used;
 DEBUG_HTABLE_INFO **data;
 DEBUG_HASH_FN hash_fn;
};
...
# 74 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c"
static int debug_htable_size(DEBUG_HTABLE *table, unsigned size)
{
 ...
 if(table->data == 
# 81 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c" 3 4
                  ((void *)0)
# 81 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c"
                      )
  return(-1);
...
static int debug_htable_grow(DEBUG_HTABLE *table)
{
 ...
 while (old_size-- > 0) {
  for (ht = *h0++; ht; ht = next) {
   ...
   { DEBUG_HTABLE_INFO **_h = table->data + n; ht->prev = 0; if ((ht->next = *_h) != 0) (*_h)->prev = ht; *_h = ht; table->used++; };
  }
 }
...
DEBUG_HTABLE *debug_htable_create(int size)
{
 ...
 if(table == 
# 130 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c" 3 4
            ((void *)0)
# 130 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c"
                )
  return (
# 131 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c" 3 4
         ((void *)0)
# 131 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c"
             );
 ...
 if(ret < 0) {
  free(table);
  return(
# 138 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c" 3 4
        ((void *)0)
# 138 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c"
            );
 }
...
DEBUG_HTABLE_INFO *debug_htable_enter(DEBUG_HTABLE *table, const char *key, char *value)
{
 ...
 if (table->used >= table->size) {
  ...
  if(ret < 0) {
   return(
# 160 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c" 3 4
         ((void *)0)
# 160 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c"
             );
  }
 }
 ...
 if (ht == 
# 173 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c" 3 4
          ((void *)0)
# 173 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c"
              ) {
  return(
# 174 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c" 3 4
        ((void *)0)
# 174 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c"
            );
 }

 ht->key = strdup(key);
 if (ht->key == 
# 178 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c" 3 4
               ((void *)0)
# 178 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c"
                   ) {
  free(ht);
  return(
# 180 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c" 3 4
        ((void *)0)
# 180 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c"
            );
 }
...
char *debug_htable_find(DEBUG_HTABLE *table, const char *key)
{
 ...
 if (table == 
# 196 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c" 3 4
             ((void *)0) 
# 196 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c"
                  || key == 
# 196 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c" 3 4
                            ((void *)0)
# 196 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c"
  ...
  return (
# 197 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c" 3 4
         ((void *)0)
# 197 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c"
             );
 ...
 return (
# 209 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c" 3 4
        ((void *)0)
# 209 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c"
            );
}
...
DEBUG_HTABLE_INFO *debug_htable_locate(DEBUG_HTABLE *table, const char *key)
{
 ...
 if(table == 
# 219 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c" 3 4
            ((void *)0) 
# 219 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c"
                 || key == 
# 219 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c" 3 4
                           ((void *)0)
# 219 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c"
  ...
  return (
# 220 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c" 3 4
         ((void *)0)
# 220 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c"
             );
 ...
 return (
# 232 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c" 3 4
        ((void *)0)
# 232 "/workspace/acl/lib_acl/src/stdlib/debug/debug_htable.c"
            );
}
