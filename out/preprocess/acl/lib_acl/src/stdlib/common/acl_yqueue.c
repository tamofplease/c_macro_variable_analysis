# 1 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c" 2
# 15 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c"
...
ACL_YQUEUE *acl_yqueue_new(void)
{
 ...
 self = (ACL_YQUEUE *) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c", 37, sizeof(ACL_YQUEUE));
 memset(self, 0, sizeof(ACL_YQUEUE));
 self->begin_chunk = (chunk_t *) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c", 39, sizeof(chunk_t));
 memset(self->begin_chunk, 0, sizeof(chunk_t));
 self->begin_pos = 0;
 self->back_chunk = 
# 42 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c" 3 4
                    ((void *)0)
# 42 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c"
                        ;
 self->back_pos = 0;
 self->end_chunk = self->begin_chunk;
 self->end_pos = 0;
 self->spare_chunk = acl_atomic_new();
 acl_atomic_set(self->spare_chunk, 
# 47 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c" 3 4
                                  ((void *)0)
# 47 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c"
                                      );
...
# 55 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c" 3 4
((void) sizeof ((
# 55 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c"
chunk
# 55 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c" 3 4
...
"chunk"
# 55 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c", 55, __extension__ __PRETTY_FUNCTION__); }))
# 55 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c"
                 ;
...
void acl_yqueue_free(ACL_YQUEUE *self, void(*free_fn)(void*))
{
 ...
 do {
  ...
  if (self->begin_chunk == self->end_chunk) {
   do { if (self->begin_chunk) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c", 88, (self->begin_chunk)); (self->begin_chunk) = 
# 88 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c" 3 4
  ((void *)0)
# 88 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c"
  ; } } while (0);
   break;
  }
  ...
  do { if (o) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c", 94, (o)); (o) = 
# 94 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c" 3 4
 ((void *)0)
# 94 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c"
 ; } } while (0);

 } while (1);

 cs = (chunk_t *) acl_atomic_xchg(self->spare_chunk, 
# 98 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c" 3 4
                                                    ((void *)0)
# 98 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c"
                                                        );
 if (cs)
  do { if (cs) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c", 100, (cs)); (cs) = 
# 100 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c" 3 4
 ((void *)0)
# 100 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c"
 ; } } while (0);

 acl_atomic_free(self->spare_chunk);
 do { if (self) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c", 103, (self)); (self) = 
# 103 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c" 3 4
((void *)0)
# 103 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c"
; } } while (0);
}
...
void acl_yqueue_push(ACL_YQUEUE *self)
{
 ...
 sc = (chunk_t *) acl_atomic_xchg(self->spare_chunk, 
# 128 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c" 3 4
                                                    ((void *)0)
# 128 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c"
                                                        );
 ...
 if (sc) {
  ...
  self->end_chunk->next =
   (chunk_t *) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c", 135, sizeof(chunk_t));
  memset(self->end_chunk->next, 0, sizeof(chunk_t));
  
# 137 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c" 3 4
 ((void) sizeof ((
# 137 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c"
 self->end_chunk
# 137 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 137 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c"
...
# 137 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c"
 "self->end_chunk"
# 137 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c" 3 4
 , "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c", 137, __extension__ __PRETTY_FUNCTION__); }))
# 137 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c"
                            ;
...
# 155 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c" 3 4
                           ((void *)0)
# 155 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c"
                               ;
  self->begin_pos = 0;
  memset(o, 0, sizeof(chunk_t));
  cs = (chunk_t *) acl_atomic_xchg(self->spare_chunk, o);
  if (cs)
   do { if (cs) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c", 160, (cs)); (cs) = 
# 160 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c" 3 4
  ((void *)0)
# 160 "/workspace/acl/lib_acl/src/stdlib/common/acl_yqueue.c"
  ; } } while (0);
 }
}
