# 0 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
...
# 2 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 2
# 17 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
...
static void *fifo_iter_head(ACL_ITER *iter, struct ACL_FIFO *fifo)
{
 ...
 iter->dlen = -1;
 iter->key = 
# 42 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
            ((void *)0)
# 42 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                ;
 iter->klen = -1;
 iter->i = 0;
 iter->size = fifo->cnt;
...
# 47 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                               ((void *)0)
# 47 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                                   ;
 return iter->ptr;
}
...
# 56 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                                    ((void *)0)
# 56 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                                        ;
 if (ptr) {
  iter->data = ptr->data;
  iter->i++;
  ...
  iter->data = 
# 61 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
              ((void *)0)
# 61 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                  ;
 }
 return iter;
}
...
static void *fifo_iter_tail(ACL_ITER *iter, struct ACL_FIFO *fifo)
{
 ...
 iter->dlen = -1;
 iter->key = 
# 71 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
             ((void *)0)
# 71 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                 ;
 iter->klen = -1;
 iter->i = fifo->cnt - 1;
 iter->size = fifo->cnt;
 ...
 iter->data = ptr ? ptr->data : 
# 76 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                               ((void *)0)
# 76 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                                   ;
 return iter->ptr;
}
...
# 85 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                                    ((void *)0)
# 85 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                                        ;
 if (ptr) {
  iter->data = ptr->data;
  iter->i--;
  ...
  iter->data = 
# 90 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
              ((void *)0)
# 90 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                  ;
 }
 return iter;
}
...
# 97 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                                                ((void *)0)
# 97 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                                                    ;
}
...
{
 fifo->head = 
# 102 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                   ((void *)0)
# 102 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                       ;
 fifo->tail = 
# 103 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                   ((void *)0)
# 103 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                       ;
 fifo->cnt = 0;
 fifo->slice = 
# 105 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                   ((void *)0)
# 105 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                       ;
...
# 120 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                     ((void *)0)
# 120 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                         );
}
...
ACL_FIFO *acl_fifo_new1(ACL_SLICE_POOL *slice)
{
 ...
 if (slice) {
  fifo = (ACL_FIFO *) acl_slice_pool_alloc("/acl/lib_acl/src/stdlib/common/acl_fifo.c", 128,
    slice, sizeof(*fifo));
  fifo->slice = slice;
 } else {
  fifo = (ACL_FIFO *) acl_malloc_glue("/acl/lib_acl/src/stdlib/common/acl_fifo.c", 132, sizeof(*fifo));
  fifo->slice = 
# 133 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
               ((void *)0)
# 133 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                   ;
 }
 fifo->head = 
# 135 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
             ((void *)0)
# 135 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                 ;
 fifo->tail = 
# 136 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
             ((void *)0)
# 136 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                 ;
 fifo->cnt = 0;
...
# 155 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                                      ((void *)0)
# 155 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                                          ) {
  if (free_fn) {
   free_fn(data);
  }
 ...
 if (fifo->slice) {
  acl_slice_pool_free("/acl/lib_acl/src/stdlib/common/acl_fifo.c", 161, fifo);
 } else {
  do { if (fifo) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_fifo.c", 163, (fifo)); (fifo) = 
# 163 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
 ((void *)0)
# 163 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
 ; } } while (0);
 }
}
...
ACL_FIFO_INFO *acl_fifo_push_back(ACL_FIFO *fifo, void *data)
{
 ...
 if (fifo->slice) {
  info = (ACL_FIFO_INFO *) acl_slice_pool_alloc("/acl/lib_acl/src/stdlib/common/acl_fifo.c", 172,
    fifo->slice, sizeof(*info));
 } else {
  info = (ACL_FIFO_INFO *) acl_malloc_glue("/acl/lib_acl/src/stdlib/common/acl_fifo.c", 175, sizeof(*info));
 }
 info->data = data;

 if (fifo->tail == 
# 179 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                  ((void *)0)
# 179 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                      ) {
  info->prev = info->next = 
# 180 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                           ((void *)0)
# 180 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                               ;
  ...
  info->prev = fifo->tail;
  info->next = 
# 185 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
              ((void *)0)
# 185 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                  ;
  fifo->tail = info;
 }
...
ACL_FIFO_INFO *acl_fifo_push_front(ACL_FIFO *fifo, void *data)
{
 ...
 if (fifo->slice) {
  info = (ACL_FIFO_INFO *) acl_slice_pool_alloc("/acl/lib_acl/src/stdlib/common/acl_fifo.c", 198,
    fifo->slice, sizeof(*info));
 } else {
  info = (ACL_FIFO_INFO*) acl_malloc_glue("/acl/lib_acl/src/stdlib/common/acl_fifo.c", 201, sizeof(*info));
 }
 info->data = data;

 if (fifo->head == 
# 205 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                  ((void *)0)
# 205 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                      ) {
  info->prev = info->next = 
# 206 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                           ((void *)0)
# 206 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                               ;
  fifo->head = fifo->tail = info;
 } else {
  info->next = fifo->head;
  fifo->head->prev = info;
  info->prev = 
# 211 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
              ((void *)0)
# 211 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                  ;
  fifo->head = info;
 }
...
void *acl_fifo_pop_front(ACL_FIFO *fifo)
{
 ...
 if (fifo->head == 
# 224 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                  ((void *)0)
# 224 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                      ) {
  return 
# 225 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
        ((void *)0)
# 225 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
            ;
 }
 ...
 if (fifo->head->next) {
  fifo->head->next->prev = 
# 230 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                          ((void *)0)
# 230 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                              ;
  fifo->head = fifo->head->next;
 } else {
  fifo->head = fifo->tail = 
# 233 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                           ((void *)0)
# 233 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                               ;
 }
 ...
 if (fifo->slice) {
  acl_slice_pool_free("/acl/lib_acl/src/stdlib/common/acl_fifo.c", 239, info);
 } else {
  do { if (info) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_fifo.c", 241, (info)); (info) = 
# 241 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
 ((void *)0)
# 241 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
 ; } } while (0);
 }
...
void *acl_fifo_pop_back(ACL_FIFO *fifo)
{
 ...
 if (fifo->tail == 
# 253 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                  ((void *)0)
# 253 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                      ) {
  return 
# 254 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
        ((void *)0)
# 254 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
            ;
 }
 ...
 if (fifo->tail->prev) {
  fifo->tail->prev->next = 
# 259 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                          ((void *)0)
# 259 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                              ;
  fifo->tail = fifo->tail->prev;
 } else {
  fifo->head = fifo->tail = 
# 262 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                           ((void *)0)
# 262 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                               ;
 }
 data = info->data;
 if (fifo->slice) {
  acl_slice_pool_free("/acl/lib_acl/src/stdlib/common/acl_fifo.c", 266, info);
 } else {
  do { if (info) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_fifo.c", 268, (info)); (info) = 
# 268 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
 ((void *)0)
# 268 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
 ; } } while (0);
 }
 fifo->cnt--;
 return data;
...
int acl_fifo_delete(ACL_FIFO *fifo, const void *data)
{
 ...
 while (iter) {
  if (iter->data == data) {
   ...
   if (fifo->slice) {
    acl_slice_pool_free("/acl/lib_acl/src/stdlib/common/acl_fifo.c", 291, iter);
   } else {
    do { if (iter) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_fifo.c", 293, (iter)); (iter) = 
# 293 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
   ((void *)0)
# 293 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
   ; } } while (0);
   }
   fifo->cnt--;
   return 1;
...
void *acl_fifo_head(ACL_FIFO *fifo)
{
 if (fifo->head) {
  ...
  return 
# 309 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
        ((void *)0)
# 309 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
            ;
 }
}
...
void *acl_fifo_tail(ACL_FIFO *fifo)
{
 if (fifo->tail) {
  ...
  return 
# 318 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
        ((void *)0)
# 318 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
            ;
 }
}
...
# 326 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                                           ((void *)0)
# 326 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                                               ) {
  if (free_fn) {
   free_fn(info);
  }
 ...
 if (fifo->slice) {
  acl_slice_pool_free("/acl/lib_acl/src/stdlib/common/acl_fifo.c", 332, fifo);
 } else {
  do { if (fifo) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_fifo.c", 334, (fifo)); (fifo) = 
# 334 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
 ((void *)0)
# 334 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
 ; } } while (0);
 }
}
...
{
 if (fifo->tail == 
# 340 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                  ((void *)0)
# 340 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                      ) {
  info->prev = info->next = 
# 341 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                           ((void *)0)
# 341 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                               ;
  fifo->head = fifo->tail = info;
 } else {
  fifo->tail->next = info;
  info->prev = fifo->tail;
  info->next = 
# 346 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
              ((void *)0)
# 346 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                  ;
  fifo->tail = info;
 }
...
ACL_FIFO_INFO *acl_fifo_pop_info(ACL_FIFO *fifo)
{
 ...
 if (fifo->head == 
# 357 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                  ((void *)0)
# 357 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                      ) {
  return 
# 358 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
        ((void *)0)
# 358 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
            ;
 }
 ...
 if (fifo->head->next) {
  fifo->head->next->prev = 
# 363 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                          ((void *)0)
# 363 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                              ;
  fifo->head = fifo->head->next;
 } else {
  fifo->head = fifo->tail = 
# 366 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                           ((void *)0)
# 366 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                               ;
 }
...
void acl_fifo_delete_info(ACL_FIFO *fifo, ACL_FIFO_INFO *info)
{
 ...
 if (fifo->slice) {
  acl_slice_pool_free("/acl/lib_acl/src/stdlib/common/acl_fifo.c", 387, info);
 } else {
  do { if (info) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_fifo.c", 389, (info)); (info) = 
# 389 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
 ((void *)0)
# 389 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
 ; } } while (0);
 }
 fifo->cnt--;
}
...
ACL_FIFO_INFO *acl_fifo_head_info(ACL_FIFO *fifo)
{
 if (fifo->head) {
  ...
  return 
# 399 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
        ((void *)0)
# 399 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
            ;
 }
}
...
ACL_FIFO_INFO *acl_fifo_tail_info(ACL_FIFO *fifo)
{
 if (fifo->tail) {
  ...
  return 
# 408 "/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
        ((void *)0)
# 408 "/acl/lib_acl/src/stdlib/common/acl_fifo.c"
            ;
 }
}
