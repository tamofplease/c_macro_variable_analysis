# 1 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 2
# 17 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
...
static void *fifo_iter_head(ACL_ITER *iter, struct ACL_FIFO *fifo)
{
 ...
 iter->dlen = -1;
 iter->key = 
# 42 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
            ((void *)0)
# 42 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                ;
 iter->klen = -1;
 iter->i = 0;
 iter->size = fifo->cnt;
 iter->ptr = ptr = fifo->head;
 iter->data = ptr ? ptr->data : 
# 47 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                               ((void *)0)
# 47 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                                   ;
 return iter->ptr;
}

static void *fifo_iter_next(ACL_ITER *iter, struct ACL_FIFO *fifo __attribute__ ((__unused__)))
{
 ACL_FIFO_INFO *ptr;

 ptr = (ACL_FIFO_INFO*) iter->ptr;
 iter->ptr = ptr = ptr ? ptr->next : 
# 56 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                                    ((void *)0)
# 56 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                                        ;
 if (ptr) {
  iter->data = ptr->data;
  iter->i++;
  ...
  iter->data = 
# 61 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
              ((void *)0)
# 61 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                  ;
 }
 return iter;
}
...
static void *fifo_iter_tail(ACL_ITER *iter, struct ACL_FIFO *fifo)
{
 ...
 iter->dlen = -1;
 iter->key = 
# 71 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
             ((void *)0)
# 71 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                 ;
 iter->klen = -1;
 iter->i = fifo->cnt - 1;
 iter->size = fifo->cnt;
 ...
 iter->data = ptr ? ptr->data : 
# 76 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                               ((void *)0)
# 76 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                                   ;
 return iter->ptr;
}

static void *fifo_iter_prev(ACL_ITER *iter, struct ACL_FIFO *fifo __attribute__ ((__unused__)))
{
 ACL_FIFO_INFO *ptr;

 ptr = (ACL_FIFO_INFO*) iter->ptr;
 iter->ptr = ptr = ptr ? ptr->prev : 
# 85 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                                    ((void *)0)
# 85 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                                        ;
 if (ptr) {
  iter->data = ptr->data;
  iter->i--;
  ...
  iter->data = 
# 90 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
              ((void *)0)
# 90 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                  ;
 }
 return iter;
}

static ACL_FIFO_INFO *fifo_iter_info(ACL_ITER *iter, struct ACL_FIFO *fifo __attribute__ ((__unused__)))
{
 return iter->ptr ? (ACL_FIFO_INFO*) iter->ptr : 
# 97 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                                                ((void *)0)
# 97 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                                                    ;
}
...
{
 fifo->head = 
# 102 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                   ((void *)0)
# 102 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                       ;
 fifo->tail = 
# 103 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                   ((void *)0)
# 103 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                       ;
 fifo->cnt = 0;
 fifo->slice = 
# 105 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                   ((void *)0)
# 105 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                       ;
...
ACL_FIFO *acl_fifo_new(void)
{
 return acl_fifo_new1(
# 120 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                     ((void *)0)
# 120 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                         );
}
...
ACL_FIFO *acl_fifo_new1(ACL_SLICE_POOL *slice)
{
 ...
 if (slice) {
  fifo = (ACL_FIFO *) acl_slice_pool_alloc("/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c", 128,
    slice, sizeof(*fifo));
  fifo->slice = slice;
 } else {
  fifo = (ACL_FIFO *) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c", 132, sizeof(*fifo));
  fifo->slice = 
# 133 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
               ((void *)0)
# 133 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                   ;
 }
 fifo->head = 
# 135 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
             ((void *)0)
# 135 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                 ;
 fifo->tail = 
# 136 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
             ((void *)0)
# 136 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                 ;
 fifo->cnt = 0;
...
void acl_fifo_free(ACL_FIFO *fifo, void (*free_fn)(void *))
{
 ...
 while ((data = acl_fifo_pop_front(fifo)) != 
# 155 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                                      ((void *)0)
# 155 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                                          ) {
  if (free_fn) {
   free_fn(data);
  }
 ...
 if (fifo->slice) {
  acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c", 161, fifo);
 } else {
  do { if (fifo) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c", 163, (fifo)); (fifo) = 
# 163 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
 ((void *)0)
# 163 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
 ; } } while (0);
 }
}
...
ACL_FIFO_INFO *acl_fifo_push_back(ACL_FIFO *fifo, void *data)
{
 ...
 if (fifo->slice) {
  info = (ACL_FIFO_INFO *) acl_slice_pool_alloc("/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c", 172,
    fifo->slice, sizeof(*info));
 } else {
  info = (ACL_FIFO_INFO *) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c", 175, sizeof(*info));
 }
 info->data = data;

 if (fifo->tail == 
# 179 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                  ((void *)0)
# 179 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                      ) {
  info->prev = info->next = 
# 180 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                           ((void *)0)
# 180 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                               ;
  ...
  info->prev = fifo->tail;
  info->next = 
# 185 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
              ((void *)0)
# 185 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                  ;
  fifo->tail = info;
 }
...
ACL_FIFO_INFO *acl_fifo_push_front(ACL_FIFO *fifo, void *data)
{
 ...
 if (fifo->slice) {
  info = (ACL_FIFO_INFO *) acl_slice_pool_alloc("/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c", 198,
    fifo->slice, sizeof(*info));
 } else {
  info = (ACL_FIFO_INFO*) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c", 201, sizeof(*info));
 }
 info->data = data;

 if (fifo->head == 
# 205 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                  ((void *)0)
# 205 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                      ) {
  info->prev = info->next = 
# 206 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                           ((void *)0)
# 206 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                               ;
  fifo->head = fifo->tail = info;
 } else {
  info->next = fifo->head;
  fifo->head->prev = info;
  info->prev = 
# 211 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
              ((void *)0)
# 211 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                  ;
  fifo->head = info;
 }
...
void *acl_fifo_pop_front(ACL_FIFO *fifo)
{
 ...
 if (fifo->head == 
# 224 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                  ((void *)0)
# 224 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                      ) {
  return 
# 225 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
        ((void *)0)
# 225 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
            ;
 }
 ...
 if (fifo->head->next) {
  fifo->head->next->prev = 
# 230 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                          ((void *)0)
# 230 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                              ;
  fifo->head = fifo->head->next;
 } else {
  fifo->head = fifo->tail = 
# 233 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                           ((void *)0)
# 233 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                               ;
 }
 ...
 if (fifo->slice) {
  acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c", 239, info);
 } else {
  do { if (info) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c", 241, (info)); (info) = 
# 241 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
 ((void *)0)
# 241 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
 ; } } while (0);
 }
...
void *acl_fifo_pop_back(ACL_FIFO *fifo)
{
 ...
 if (fifo->tail == 
# 253 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                  ((void *)0)
# 253 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                      ) {
  return 
# 254 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
        ((void *)0)
# 254 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
            ;
 }
 ...
 if (fifo->tail->prev) {
  fifo->tail->prev->next = 
# 259 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                          ((void *)0)
# 259 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                              ;
  fifo->tail = fifo->tail->prev;
 } else {
  fifo->head = fifo->tail = 
# 262 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                           ((void *)0)
# 262 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                               ;
 }
 data = info->data;
 if (fifo->slice) {
  acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c", 266, info);
 } else {
  do { if (info) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c", 268, (info)); (info) = 
# 268 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
 ((void *)0)
# 268 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
 ; } } while (0);
 }
 fifo->cnt--;
 return data;
...
int acl_fifo_delete(ACL_FIFO *fifo, const void *data)
{
 ...
 while (iter) {
  if (iter->data == data) {
   ...
   if (fifo->slice) {
    acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c", 291, iter);
   } else {
    do { if (iter) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c", 293, (iter)); (iter) = 
# 293 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
   ((void *)0)
# 293 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
   ; } } while (0);
   }
   fifo->cnt--;
   return 1;
...
void *acl_fifo_head(ACL_FIFO *fifo)
{
 if (fifo->head) {
  ...
  return 
# 309 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
        ((void *)0)
# 309 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
            ;
 }
}
...
void *acl_fifo_tail(ACL_FIFO *fifo)
{
 if (fifo->tail) {
  ...
  return 
# 318 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
        ((void *)0)
# 318 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
            ;
 }
}
...
void acl_fifo_free2(ACL_FIFO *fifo, void (*free_fn)(ACL_FIFO_INFO *))
{
 ...
 while ((info = acl_fifo_pop_info(fifo)) != 
# 326 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                                           ((void *)0)
# 326 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                                               ) {
  if (free_fn) {
   free_fn(info);
  }
 ...
 if (fifo->slice) {
  acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c", 332, fifo);
 } else {
  do { if (fifo) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c", 334, (fifo)); (fifo) = 
# 334 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
 ((void *)0)
# 334 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
 ; } } while (0);
 }
}
...
{
 if (fifo->tail == 
# 340 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                  ((void *)0)
# 340 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                      ) {
  info->prev = info->next = 
# 341 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                           ((void *)0)
# 341 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                               ;
  fifo->head = fifo->tail = info;
 } else {
  fifo->tail->next = info;
  info->prev = fifo->tail;
  info->next = 
# 346 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
              ((void *)0)
# 346 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                  ;
  fifo->tail = info;
 }
...
ACL_FIFO_INFO *acl_fifo_pop_info(ACL_FIFO *fifo)
{
 ...
 if (fifo->head == 
# 357 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                  ((void *)0)
# 357 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                      ) {
  return 
# 358 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
        ((void *)0)
# 358 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
            ;
 }
 ...
 if (fifo->head->next) {
  fifo->head->next->prev = 
# 363 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                          ((void *)0)
# 363 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                              ;
  fifo->head = fifo->head->next;
 } else {
  fifo->head = fifo->tail = 
# 366 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
                           ((void *)0)
# 366 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
                               ;
 }
...
void acl_fifo_delete_info(ACL_FIFO *fifo, ACL_FIFO_INFO *info)
{
 ...
 if (fifo->slice) {
  acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c", 387, info);
 } else {
  do { if (info) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c", 389, (info)); (info) = 
# 389 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
 ((void *)0)
# 389 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
 ; } } while (0);
 }
 fifo->cnt--;
}
...
ACL_FIFO_INFO *acl_fifo_head_info(ACL_FIFO *fifo)
{
 if (fifo->head) {
  ...
  return 
# 399 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
        ((void *)0)
# 399 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
            ;
 }
}
...
ACL_FIFO_INFO *acl_fifo_tail_info(ACL_FIFO *fifo)
{
 if (fifo->tail) {
  ...
  return 
# 408 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c" 3 4
        ((void *)0)
# 408 "/workspace/acl/lib_acl/src/stdlib/common/acl_fifo.c"
            ;
 }
}
