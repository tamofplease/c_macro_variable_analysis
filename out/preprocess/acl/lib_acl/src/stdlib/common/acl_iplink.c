# 1 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 2
# 27 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
static int _check_ip_addr(const char *pstrip)
{
 ...
 if (pstrip == 
# 32 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
              ((void *)0) 
# 32 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
                   || *pstrip == 0)
  return(-1);
 ...
 while(*ptr) {
  if (*ptr == '.') {
   if (!
# 40 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
       ((*__ctype_b_loc ())[(int) ((
# 40 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
       (int)*(ptr + 1)
# 40 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
...
# 43 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
             ((*__ctype_b_loc ())[(int) ((
# 43 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
             (int)*ptr
# 43 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
             ))] & (unsigned short int) _ISdigit)
# 43 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
...
void acl_iplink_free(ACL_DLINK *lnk)
{
 if (lnk)
  acl_dlink_free(lnk);
}
...
ACL_DITEM *acl_iplink_lookup_bin(const ACL_DLINK *plink, unsigned int ip)
{
 return acl_dlink_lookup(plink, ip);
}

ACL_DITEM *acl_iplink_lookup_str(const ACL_DLINK *plink, const char *ipstr)
{
 unsigned int ip;

 ip = (unsigned int) 
# 81 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                    __bswap_32 (
# 81 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
                    inet_addr(ipstr)
# 81 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                    )
# 81 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
 ...
 const char *pstrip_begin, const char *pstrip_end )
{
 ...
 if (_check_ip_addr(pstrip_begin) < 0) {
  ...
  return 
# 99 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
        ((void *)0)
# 99 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
            ;
 }
 if (_check_ip_addr(pstrip_end) < 0) {
  acl_msg_error("%s: invalid ip end(%s)", myname, pstrip_end);
  return 
# 103 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
        ((void *)0)
# 103 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
            ;
 }

 ip_begin = (unsigned int) 
# 106 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                          __bswap_32 (
# 106 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
                          inet_addr(pstrip_begin)
# 106 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                          )
# 106 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
                                                        ;
 ip_end = (unsigned int) 
# 107 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                          __bswap_32 (
# 107 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
                          inet_addr(pstrip_end)
# 107 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                          )
# 107 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
                                                      ;
...
int acl_iplink_delete_by_ip(ACL_DLINK *plink, const char *pstrip_begin)
{
 unsigned int ip;
 ...
 ip = (unsigned int) 
# 119 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                    __bswap_32 (
# 119 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
                    inet_addr(pstrip_begin)
# 119 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                    )
# 119 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
 ...
 const char *pstrip_begin, const char *pstrip_end)
{
 ...
 if (_check_ip_addr(pstrip_id) < 0
  ...
  return 
# 136 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
        ((void *)0)
# 136 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
            ;

 ip_begin = (unsigned int) 
# 138 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                          __bswap_32 (
# 138 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
                          inet_addr(pstrip_begin)
# 138 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                          )
# 138 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
                                                        ;
 ip_end = (unsigned int) 
# 139 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                          __bswap_32 (
# 139 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
                          inet_addr(pstrip_end)
# 139 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                          )
# 139 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
...
static char *__sane_inet_ntoa(unsigned int src, char *dst, size_t size)
{
 ...
 if (size < 16)
  return(
# 156 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
        ((void *)0)
# 156 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
            );
...
# 174 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
 return(dst);
}
...
int acl_iplink_list(const ACL_DLINK *plink)
{
 ...
 for (i = 0; i < n; i++) {
  ...
  if (item == 
# 187 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
             ((void *)0)
# 187 "/workspace/acl/lib_acl/src/stdlib/common/acl_iplink.c"
                 )
   break;
