# 0 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
...
# 2 "/acl/lib_acl/src/stdlib/common/acl_iplink.c" 2
# 27 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
static int _check_ip_addr(const char *pstrip)
{
 ...
 if (pstrip == 
# 32 "/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
              ((void *)0) 
# 32 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
                   || *pstrip == 0)
  return(-1);
 ...
 while(*ptr) {
  if (*ptr == '.') {
   if (!
# 40 "/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
       ((*__ctype_b_loc ())[(int) ((
# 40 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
       (int)*(ptr + 1)
# 40 "/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
...
# 43 "/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
             ((*__ctype_b_loc ())[(int) ((
# 43 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
             (int)*ptr
# 43 "/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
             ))] & (unsigned short int) _ISdigit)
# 43 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
...
ACL_DITEM *acl_iplink_lookup_str(const ACL_DLINK *plink, const char *ipstr)
{
 ...
 ip = (unsigned int) 
# 81 "/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                    __bswap_32 (
# 81 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
                    inet_addr(ipstr)
# 81 "/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                    )
# 81 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
 ...
 const char *pstrip_begin, const char *pstrip_end )
{
 ...
 if (_check_ip_addr(pstrip_begin) < 0) {
  ...
  return 
# 99 "/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
        ((void *)0)
# 99 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
            ;
 }
 if (_check_ip_addr(pstrip_end) < 0) {
  acl_msg_error("%s: invalid ip end(%s)", myname, pstrip_end);
  return 
# 103 "/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
        ((void *)0)
# 103 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
            ;
 }

 ip_begin = (unsigned int) 
# 106 "/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                          __bswap_32 (
# 106 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
...
# 106 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
                                                        ;
 ip_end = (unsigned int) 
# 107 "/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                          __bswap_32 (
# 107 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
...
int acl_iplink_delete_by_ip(ACL_DLINK *plink, const char *pstrip_begin)
{
 ...
 ip = (unsigned int) 
# 119 "/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                    __bswap_32 (
# 119 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
                    inet_addr(pstrip_begin)
# 119 "/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                    )
# 119 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
 ...
 const char *pstrip_begin, const char *pstrip_end)
{
 ...
 if (_check_ip_addr(pstrip_id) < 0
  ...
  return 
# 136 "/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
        ((void *)0)
# 136 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
            ;

 ip_begin = (unsigned int) 
# 138 "/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                          __bswap_32 (
# 138 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
                          inet_addr(pstrip_begin)
# 138 "/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                          )
# 138 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
                                                        ;
 ip_end = (unsigned int) 
# 139 "/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                          __bswap_32 (
# 139 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
                          inet_addr(pstrip_end)
# 139 "/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
                          )
# 139 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
...
static char *__sane_inet_ntoa(unsigned int src, char *dst, size_t size)
{
 ...
 if (size < 16)
  return(
# 156 "/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
        ((void *)0)
# 156 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
            );
...
# 174 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
 return(dst);
}
...
int acl_iplink_list(const ACL_DLINK *plink)
{
 ...
 for (i = 0; i < n; i++) {
  ...
  if (item == 
# 187 "/acl/lib_acl/src/stdlib/common/acl_iplink.c" 3 4
             ((void *)0)
# 187 "/acl/lib_acl/src/stdlib/common/acl_iplink.c"
                 )
   break;
