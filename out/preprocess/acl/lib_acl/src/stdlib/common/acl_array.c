# 0 "/acl/lib_acl/src/stdlib/common/acl_array.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/common/acl_array.c"
...
# 2 "/acl/lib_acl/src/stdlib/common/acl_array.c" 2
# 16 "/acl/lib_acl/src/stdlib/common/acl_array.c"
# 1 "/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 17 "/acl/lib_acl/src/stdlib/common/acl_array.c" 2
# 1 "/acl/lib_acl/include/stdlib/acl_mymalloc.h" 1
# 18 "/acl/lib_acl/src/stdlib/common/acl_array.c" 2
# 1 "/acl/lib_acl/include/stdlib/acl_dbuf_pool.h" 1
# 19 "/acl/lib_acl/src/stdlib/common/acl_array.c" 2
# 1 "/acl/lib_acl/include/stdlib/acl_array.h" 1
# 20 "/acl/lib_acl/src/stdlib/common/acl_array.c" 2
...
static void *array_pop_back(struct ACL_ARRAY *a)
{
 ...
 if (a->count <= 0)
  return 
# 35 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
        ((void *)0)
# 35 "/acl/lib_acl/src/stdlib/common/acl_array.c"
            ;
 a->count--;
 obj = a->items[a->count];
 return obj;
...
static void *array_pop_front(struct ACL_ARRAY *a)
{
 ...
 if (a->count <= 0)
  return 
# 47 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
        ((void *)0)
# 47 "/acl/lib_acl/src/stdlib/common/acl_array.c"
            ;
 obj = a->items[0];
 a->count--;
 for (i = 0; i < a->count; i++)
...
static void *array_iter_head(ACL_ITER *iter, struct ACL_ARRAY *a)
{
 iter->dlen = -1;
 iter->key = 
# 61 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
            ((void *)0)
# 61 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                ;
 iter->klen = 0;
 iter->i = 0;
 iter->size = a->count;
 if (a->items == 
# 65 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
                ((void *)0) 
# 65 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                     || a->count <= 0)
...
static void *array_iter_tail(ACL_ITER *iter, struct ACL_ARRAY *a)
{
 iter->dlen = -1;
 iter->key = 
# 90 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
            ((void *)0)
# 90 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                ;
 iter->klen = 0;
 iter->i = a->count - 1;
 iter->size = a->count;
 if (a->items == 
# 94 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
                ((void *)0) 
# 94 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                     || iter->i < 0)
  iter->ptr = iter->data = 0;
 else
  iter->data = iter->ptr = a->items[iter->i];
...
static void acl_array_grow(ACL_ARRAY *a, int min_capacity)
{
 ...
 if (a->items == 
# 134 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
                ((void *)0)
# 134 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                    ) {
  if (a->dbuf == 
# 135 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
                ((void *)0)
# 135 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                    ) {
   a->items = (void**)
    acl_malloc_glue("/acl/lib_acl/src/stdlib/common/acl_array.c", 137, a->capacity * sizeof(void*));
  } else {
   a->items = (void**) acl_dbuf_pool_alloc(a->dbuf,
     a->capacity * sizeof(void*));
  }
 } else if (a->dbuf == 
# 142 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
                      ((void *)0)
# 142 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                          ) {
  a->items = (void**) acl_realloc_glue("/acl/lib_acl/src/stdlib/common/acl_array.c", 143, (a->items), a->capacity * sizeof(void*))
                                ;
 } else if (a->count > 0) {
...
# 162 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
                                        ((void *)0)
# 162 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                                            );
}
...
ACL_ARRAY *acl_array_dbuf_create(int init_size, ACL_DBUF_POOL *dbuf)
{
 ...
 if (dbuf != 
# 169 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
            ((void *)0)
# 169 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                ) {
  a = (ACL_ARRAY *) acl_dbuf_pool_calloc(dbuf,
    sizeof(ACL_ARRAY));
  a->dbuf = dbuf;
 } else {
  a = (ACL_ARRAY *) acl_calloc_glue("/acl/lib_acl/src/stdlib/common/acl_array.c", 174, 1, sizeof(ACL_ARRAY));
  a->dbuf = 
# 175 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
           ((void *)0)
# 175 "/acl/lib_acl/src/stdlib/common/acl_array.c"
               ;
 }
...
void acl_array_clean(ACL_ARRAY *a, void (*free_fn)(void *))
{
 ...
 for(idx = 0; idx < a->count; idx++) {
  if(free_fn != 
# 200 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
               ((void *)0) 
# 200 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                    && a->items[idx] != 
# 200 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
                                        ((void *)0)
# 200 "/acl/lib_acl/src/stdlib/common/acl_array.c"
   ...
   free_fn(a->items[idx]);
  a->items[idx] = 
# 202 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
                 ((void *)0)
# 202 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                     ;
 }
 a->count = 0;
}
...
void acl_array_free(ACL_ARRAY *a, void (*free_fn)(void *))
{
 ...
 if (a->items)
  do { if (a->items) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_array.c", 215, (a->items)); (a->items) = 
# 215 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
 ((void *)0)
# 215 "/acl/lib_acl/src/stdlib/common/acl_array.c"
 ; } } while (0);
 do { if (a) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_array.c", 216, (a)); (a) = 
# 216 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
((void *)0)
# 216 "/acl/lib_acl/src/stdlib/common/acl_array.c"
; } } while (0);
}
...
# 280 "/acl/lib_acl/src/stdlib/common/acl_array.c"
...
int acl_array_delete_idx(ACL_ARRAY *a, int position, void (*free_fn)(void *))
{
 ...
 if (position < 0 || position >= a->count)
  return -1;
 if (free_fn != 
# 298 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
               ((void *)0) 
# 298 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                    && a->items[position] != 
# 298 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
                                             ((void *)0)
# 298 "/acl/lib_acl/src/stdlib/common/acl_array.c"
 ...
 a->items[position] = 
# 300 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
                     ((void *)0)
# 300 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                         ;
...
int acl_array_delete(ACL_ARRAY *a, int idx, void (*free_fn)(void*))
{
 if (idx < 0 || idx >= a->count)
  return -1;
 if (free_fn != 
# 312 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
               ((void *)0) 
# 312 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                    && a->items[idx] != 
# 312 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
                                        ((void *)0)
# 312 "/acl/lib_acl/src/stdlib/common/acl_array.c"
...
int acl_array_delete_obj(ACL_ARRAY *a, void *obj, void (*free_fn)(void *))
{
 ...
 if (free_fn != 
# 332 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
               ((void *)0) 
# 332 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                    && obj != 
# 332 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
                              ((void *)0)
# 332 "/acl/lib_acl/src/stdlib/common/acl_array.c"
 ...
 a->items[idx] = 
# 338 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
                ((void *)0)
# 338 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                    ;
 ret = acl_array_delete_idx(a, position, 
# 339 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
                                        ((void *)0)
# 339 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                                            );
 if (ret < 0)
  return -1;
 return ret;
 ...
 void (*free_fn)(void*))
{
 ...
 if (free_fn != 
# 359 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
               ((void *)0)
# 359 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                   ) {
  for (i = ibegin; i <= iend; i++) {
   if (a->items[i] != 
# 361 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
                     ((void *)0)
# 361 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                         )
    free_fn(a->items[i]);
   a->items[i] = 
# 363 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
                ((void *)0)
# 363 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                    ;
  }
 }
...
int acl_array_mv_idx(ACL_ARRAY *a, int ito, int ifrom, void (*free_fn)(void *))
{
 ...
 if (free_fn != 
# 390 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
               ((void *)0)
# 390 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                   ) {
  for (i = i_obj; i < i_src; i++) {
   if (a->items[i] != 
# 392 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
                     ((void *)0)
# 392 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                         )
    free_fn(a->items[i]);
   a->items[i] = 
# 394 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
                ((void *)0)
# 394 "/acl/lib_acl/src/stdlib/common/acl_array.c"
                    ;
  }
 }
...
void acl_array_pre_append(ACL_ARRAY *a, int app_count)
{
 ...
 if (app_count <= 0)
  acl_msg_fatal("%s(%d)->%s: invalid input",
    "/acl/lib_acl/src/stdlib/common/acl_array.c", 418, myname);
...
void *acl_array_index(const ACL_ARRAY *a, int idx)
{
 if (idx < 0 || idx > a->count - 1)
  return 
# 427 "/acl/lib_acl/src/stdlib/common/acl_array.c" 3 4
        ((void *)0)
# 427 "/acl/lib_acl/src/stdlib/common/acl_array.c"
            ;
