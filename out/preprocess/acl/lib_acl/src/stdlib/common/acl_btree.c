# 1 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
# 14 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
...
# 15 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 2
# 27 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
...
# 75 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
static void btree_validate(ACL_BTREE *t)
{
 const char *myname = "btree_validate";

 if (t->magic != 0x10101010)
  acl_msg_fatal("%s(%d): magic(%u) invalid", myname, 80, t->magic);
# 91 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
}
...
{
 if (x == 
# 99 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 99 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  return (
# 100 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 100 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
             );
 }
 while(x->left) {
  x = x->left;
...
{
 if (x == 
# 110 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 110 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  return (
# 111 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 111 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
             );
 }
 while(x->right) {
  x = x->right;
...
static BTREE_NODE *btree_successor(BTREE_NODE *x)
{
 ...
 if (x->right != 
# 123 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
                ((void *)0)
# 123 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
                    ) {
 ...
 y = x->parent;
 while (y != 
# 128 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
            ((void *)0) 
# 128 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
                 && x == y->right) {
  x = y;
  y = y->parent;
 }
...
{
 while (x != 
# 138 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
            ((void *)0) 
# 138 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
                 && key != x->key) {
  if (key < x->key) {
   x = x->left;
  } else {
...
static void btree_insert_node(ACL_BTREE *tree, BTREE_NODE *z)
{
 ...
 btree_validate(tree);
 y = 
# 154 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
    ((void *)0)
# 154 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
        ;
 x = tree->root;
 while (x != 
# 156 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
            ((void *)0)
# 156 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
                ) {
  y = x;
  if (z->key == x->key)
 ...
 z->parent = y;
 if (y == 
# 169 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 169 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  tree->root = z;
 } else if (z->key < y->key) {
  y->left = z;
...
static BTREE_NODE *btree_delete_node(ACL_BTREE *tree, BTREE_NODE *z)
{
 ...
 btree_validate(tree);
 if (z->left == 
# 185 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
               ((void *)0) 
# 185 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
                    || z->right == 
# 185 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
                                   ((void *)0)
# 185 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
 ...
 if (y->left != 
# 191 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
               ((void *)0)
# 191 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
                   ) {
  x = y->left;
 } else {
  x = y->right;
 ...
 if (x != 
# 197 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 197 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  x->parent = y->parent;
 }

 if (y->parent == 
# 201 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
                 ((void *)0)
# 201 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
                     ) {
  tree->root = x;
...
{
 ACL_BTREE *t = (ACL_BTREE*) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c", 224, sizeof(ACL_BTREE));

 if (t) {
  t->count = 0;
  t->magic = 0x10101010;
  t->root = 
# 229 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
            ((void *)0)
# 229 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
                ;
  t->slice = acl_slice_create("acl_btree", 0,
   sizeof(BTREE_NODE), (1 << 0));
  return (t);
 }
 return (
# 234 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
        ((void *)0)
# 234 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
            );
}
...
int acl_btree_destroy(ACL_BTREE *tree)
{
 ...
 btree_validate(tree);
 if (tree->root != 
# 242 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
                  ((void *)0)
# 242 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
                      ) {
  acl_msg_error("%s(%d): Tree not empty", myname, 243);
  return (-1);
 }

 acl_slice_destroy(tree->slice);
 do { if (tree) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c", 248, (tree)); (tree) = 
# 248 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
((void *)0)
# 248 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
; } } while (0);
 return (0);
}
...
void *acl_btree_find(ACL_BTREE *tree, unsigned int key)
{
 ...
 if (x != 
# 258 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 258 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  return (x->data);
 }
 return (
# 261 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
        ((void *)0)
# 261 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
            );
}
...
int acl_btree_add(ACL_BTREE *tree, unsigned int key, void *data)
{
 ...
 x = btree_search(tree->root, key);
 if (x != 
# 271 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 271 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
 ...
 x->data = data;
 x->parent = 
# 280 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
            ((void *)0)
# 280 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
                ;
 x->left = 
# 281 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
            ((void *)0)
# 281 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
                ;
 x->right = 
# 282 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
            ((void *)0)
# 282 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
                ;
 x->magic = 0x01010101;
...
void *acl_btree_remove(ACL_BTREE *tree, unsigned int key)
{
 ...
 x = btree_search(tree->root, key);
 if (x == 
# 297 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 297 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  acl_msg_error("%s(%d): Item not on tree - key %u\n",
   myname, 299, key);
  return (
# 300 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 300 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
             );
 }
...
int acl_btree_get_min_key(ACL_BTREE *tree, unsigned int *key)
{
 ...
 btree_validate(tree);
 if (tree->root == 
# 321 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
                  ((void *)0)
# 321 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
                      ) {
  return (-1);
 }
 ...
 if (x == 
# 326 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 326 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  return (-1);
 }
...
int acl_btree_get_max_key(ACL_BTREE *tree, unsigned int *key)
{
 ...
 btree_validate(tree);
 if (tree->root == 
# 339 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
                  ((void *)0)
# 339 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
                      ) {
  return (-1);
 }
 ...
 if (x == 
# 344 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 344 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  return (-1);
 }
 ...
 unsigned int cur_key, unsigned int *next_key)
{
 ...
 if (x == 
# 359 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 359 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  return (-1);
 }
 ...
 x = btree_successor(x);
 if (x == 
# 364 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 364 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  return (-1);
 }
...
static int btree_depth(BTREE_NODE *x)
{
 ...
 if (x == 
# 376 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 376 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  return (0);
 }
...
static void btree_dump_node(BTREE_NODE *x, int depth, int c, int w)
{
 ...
 if (x == 
# 399 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 399 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  return;
 }
 ...
 fflush(
# 410 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
       stdout
# 410 "/workspace/acl/lib_acl/src/stdlib/common/acl_btree.c"
             );
