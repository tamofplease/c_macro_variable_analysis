# 0 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
# 14 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
...
# 15 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 2
# 27 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
...
# 75 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
...
# 91 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
}
...
{
 if (x == 
# 99 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 99 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  return (
# 100 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 100 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
             );
 }
 while(x->left) {
  x = x->left;
...
{
 if (x == 
# 110 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 110 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  return (
# 111 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 111 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
             );
 }
 while(x->right) {
  x = x->right;
...
static BTREE_NODE *btree_successor(BTREE_NODE *x)
{
 ...
 if (x->right != 
# 123 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
                ((void *)0)
# 123 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
                    ) {
 ...
 y = x->parent;
 while (y != 
# 128 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
            ((void *)0) 
# 128 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
                 && x == y->right) {
  x = y;
  y = y->parent;
 }
...
{
 while (x != 
# 138 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
            ((void *)0) 
# 138 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
                 && key != x->key) {
  if (key < x->key) {
   x = x->left;
  } else {
...
static void btree_insert_node(ACL_BTREE *tree, BTREE_NODE *z)
{
 ...
 btree_validate(tree);
 y = 
# 154 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
    ((void *)0)
# 154 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
        ;
 x = tree->root;
 while (x != 
# 156 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
            ((void *)0)
# 156 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
                ) {
  y = x;
  if (z->key == x->key)
 ...
 z->parent = y;
 if (y == 
# 169 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 169 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  tree->root = z;
 } else if (z->key < y->key) {
  y->left = z;
...
static BTREE_NODE *btree_delete_node(ACL_BTREE *tree, BTREE_NODE *z)
{
 ...
 btree_validate(tree);
 if (z->left == 
# 185 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
               ((void *)0) 
# 185 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
                    || z->right == 
# 185 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
                                   ((void *)0)
# 185 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
 ...
 if (y->left != 
# 191 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
               ((void *)0)
# 191 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
                   ) {
  x = y->left;
 } else {
  x = y->right;
 ...
 if (x != 
# 197 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 197 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  x->parent = y->parent;
 }

 if (y->parent == 
# 201 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
                 ((void *)0)
# 201 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
                     ) {
  tree->root = x;
...
{
 ACL_BTREE *t = (ACL_BTREE*) acl_malloc_glue("/acl/lib_acl/src/stdlib/common/acl_btree.c", 224, sizeof(ACL_BTREE));

 if (t) {
  t->count = 0;
  t->magic = 0x10101010;
  t->root = 
# 229 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
            ((void *)0)
# 229 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
                ;
 ...
 return (
# 234 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
        ((void *)0)
# 234 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
            );
}
...
int acl_btree_destroy(ACL_BTREE *tree)
{
 ...
 btree_validate(tree);
 if (tree->root != 
# 242 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
                  ((void *)0)
# 242 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
                      ) {
 ...
 do { if (tree) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_btree.c", 248, (tree)); (tree) = 
# 248 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
((void *)0)
# 248 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
; } } while (0);
 return (0);
}
...
void *acl_btree_find(ACL_BTREE *tree, unsigned int key)
{
 ...
 if (x != 
# 258 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 258 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  return (x->data);
 }
 return (
# 261 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
        ((void *)0)
# 261 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
            );
}
...
int acl_btree_add(ACL_BTREE *tree, unsigned int key, void *data)
{
 ...
 x = btree_search(tree->root, key);
 if (x != 
# 271 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 271 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
 ...
 x->data = data;
 x->parent = 
# 280 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
            ((void *)0)
# 280 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
                ;
 x->left = 
# 281 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
            ((void *)0)
# 281 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
                ;
 x->right = 
# 282 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
            ((void *)0)
# 282 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
                ;
 x->magic = 0x01010101;
...
void *acl_btree_remove(ACL_BTREE *tree, unsigned int key)
{
 ...
 x = btree_search(tree->root, key);
 if (x == 
# 297 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 297 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  acl_msg_error("%s(%d): Item not on tree - key %u\n",
   myname, 299, key);
  return (
# 300 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 300 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
             );
 }
...
int acl_btree_get_min_key(ACL_BTREE *tree, unsigned int *key)
{
 ...
 btree_validate(tree);
 if (tree->root == 
# 321 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
                  ((void *)0)
# 321 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
                      ) {
  return (-1);
 }
 ...
 if (x == 
# 326 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 326 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  return (-1);
 }
...
int acl_btree_get_max_key(ACL_BTREE *tree, unsigned int *key)
{
 ...
 btree_validate(tree);
 if (tree->root == 
# 339 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
                  ((void *)0)
# 339 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
                      ) {
  return (-1);
 }
 ...
 if (x == 
# 344 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 344 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  return (-1);
 }
 ...
 unsigned int cur_key, unsigned int *next_key)
{
 ...
 if (x == 
# 359 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 359 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  return (-1);
 }
 ...
 x = btree_successor(x);
 if (x == 
# 364 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 364 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  return (-1);
 }
...
static int btree_depth(BTREE_NODE *x)
{
 ...
 if (x == 
# 376 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 376 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  return (0);
 }
...
static void btree_dump_node(BTREE_NODE *x, int depth, int c, int w)
{
 ...
 if (x == 
# 399 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
         ((void *)0)
# 399 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
             ) {
  return;
 }
 ...
 fflush(
# 410 "/acl/lib_acl/src/stdlib/common/acl_btree.c" 3 4
       stdout
# 410 "/acl/lib_acl/src/stdlib/common/acl_btree.c"
             );
