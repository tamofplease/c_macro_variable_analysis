# 1 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 4 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 2
# 25 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
static void *binhash_iter_head(ACL_ITER *iter, struct ACL_BINHASH *table)
{
 ACL_BINHASH_INFO *ptr = 
# 27 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
                        ((void *)0)
# 27 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
                            ;
 ...
 iter->ptr = 
# 32 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
            ((void *)0)
# 32 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
                ;

 for (; iter->i < iter->size; iter->i++) {
  if (table->data[iter->i] != 
# 35 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
                             ((void *)0)
# 35 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
                                 ) {
 ...
 if (ptr) {
  ...
  iter->data = 
# 46 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
              ((void *)0)
# 46 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
                  ;
  iter->key = 
# 47 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
             ((void *)0)
# 47 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
                 ;
  iter->klen = 0;
 }
 return (iter->ptr);
...
static void *binhash_iter_next(ACL_ITER *iter, struct ACL_BINHASH *table)
{
 ...
 for (iter->i++; iter->i < iter->size; iter->i++) {
  if (table->data[iter->i] != 
# 71 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
                             ((void *)0)
# 71 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
                                 ) {
   iter->ptr = ptr = table->data[iter->i];
   break;
  }
 ...
 if (ptr) {
  ...
  iter->data = 
# 82 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
              ((void *)0)
# 82 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
                  ;
  iter->key = 
# 83 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
             ((void *)0)
# 83 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
                 ;
  iter->klen = 0;
 }
 return (iter->ptr);
...
{
 ACL_BINHASH_INFO *ptr = 
# 93 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
                        ((void *)0)
# 93 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
                            ;
 ...
 iter->size = table->size;
 iter->ptr = 
# 98 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
            ((void *)0)
# 98 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
                ;

 for (; iter->i >= 0; iter->i--) {
  if (table->data[iter->i] != 
# 101 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
                             ((void *)0)
# 101 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
                                 ) {
   iter->ptr = ptr = table->data[iter->i];
   break;
  }
 ...
 if (ptr) {
  ...
  iter->data = 
# 112 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
              ((void *)0)
# 112 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
                  ;
  iter->key = 
# 113 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
             ((void *)0)
# 113 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
                 ;
  iter->klen = 0;
 }
 return (iter->ptr);
...
static void *binhash_iter_prev(ACL_ITER *iter, struct ACL_BINHASH *table)
{
 ...
 if (ptr) {
  iter->ptr = ptr = ptr->next;
  if (ptr != 
# 128 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
            ((void *)0)
# 128 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
                ) {
   iter->data = ptr->value;
   iter->key = (const char*) ptr->key.c_key;
   iter->klen = ptr->key_len;
 ...
 for (iter->i--; iter->i >= 0; iter->i--) {
  if (table->data[iter->i] != 
# 137 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
                             ((void *)0)
# 137 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
                                 ) {
   iter->ptr = ptr = table->data[iter->i];
   break;
  }
 ...
 iter->data = ptr ? ptr->value : 
# 143 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
                                ((void *)0)
# 143 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
                                    ;
 return (iter->ptr);
}
...
static ACL_BINHASH_INFO *binhash_iter_info(ACL_ITER *iter, struct ACL_BINHASH *table __attribute__ ((__unused__)))
{
 return (iter->ptr ? (ACL_BINHASH_INFO*) iter->ptr : 
# 151 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
                                                    ((void *)0)
# 151 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
                                                        );
}
...
# 191 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
static void binhash_size(ACL_BINHASH *table, unsigned size)
{
 ...
 table->data = h = (ACL_BINHASH_INFO **)
  acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c", 198, size * sizeof(ACL_BINHASH_INFO *));
 table->size = size;
 table->used = 0;
...
ACL_BINHASH *acl_binhash_create(int size, unsigned int flag)
{
 ...
 table = (ACL_BINHASH *) acl_calloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c", 213, 1, sizeof(ACL_BINHASH));
...
static void acl_binhash_grow(ACL_BINHASH *table)
{
 ...
 while (old_size-- > 0) {
  for (ht = *h++; ht; ht = next) {
   ...
   { ACL_BINHASH_INFO **_h = table->data + n; ht->prev = 0; if ((ht->next = *_h) != 0) (*_h)->prev = ht; *_h = ht; table->used++; };
  }
 }
 do { if (old_entries) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c", 260, (old_entries)); (old_entries) = 
# 260 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
((void *)0)
# 260 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
; } } while (0);
}
...
ACL_BINHASH_INFO *acl_binhash_enter(ACL_BINHASH *table, const void *key, int key_len, void *value)
{
 ...
 for (ht = table->data[n]; ht; ht = ht->next) {
  ...
  if (key_len == ht->key_len && (((const char*)p1)[0] == ((const char*)p2)[0] && memcmp(p1,p2,key_len) == 0)) {
   table->status = 2;
   return (ht);
  }
 }
 ...
 if (table->slice)
  ...
  ht = (ACL_BINHASH_INFO *) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c", 288, sizeof(ACL_BINHASH_INFO));

 if ((table->flag & (1 << 0)))
  ht->key.c_key = key;
 else
  ht->key.key = acl_memdup_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c", 293, (key), key_len);
 ht->key_len = key_len;
 ht->value = value;
 { ACL_BINHASH_INFO **_h = table->data + n; ht->prev = 0; if ((ht->next = *_h) != 0) (*_h)->prev = ht; *_h = ht; table->used++; };
 table->status = 0;
...
void *acl_binhash_find(ACL_BINHASH *table, const void *key, int key_len)
{
 ...
 for (ht = table->data[n]; ht; ht = ht->next) {
  if (key_len == ht->key_len && (((const char*)key)[0] == ((const char*)ht->key.c_key)[0] && memcmp(key,ht->key.c_key,key_len) == 0)) {
   table->status = 0;
   return (ht->value);
  }
 }
 ...
 for (ht = *h; ht; ht = ht->next) {
  if (key_len == ht->key_len && (((const char*)key)[0] == ((const char*)ht->key.c_key)[0] && memcmp(key,ht->key.c_key,key_len) == 0)) {
   ...
   if (free_fn)
    (*free_fn) (ht->value);
   if (!(table->flag & (1 << 0)))
    do { if (ht->key.key) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c", 360, (ht->key.key)); (ht->key.key) = 
# 360 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
   ((void *)0)
# 360 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
   ; } } while (0);
   if (table->slice)
    acl_slice_free2(table->slice, ht);
   else
    do { if (ht) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c", 364, (ht)); (ht) = 
# 364 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
   ((void *)0)
# 364 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
   ; } } while (0);
   table->used--;
   table->status = 0;
   return (0);
 ...
 while (i-- > 0) {
  for (ht = *h++; ht; ht = next) {
   ...
   if (free_fn)
    (*free_fn) (ht->value);
   if (!(table->flag & (1 << 0)))
    do { if (ht->key.key) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c", 389, (ht->key.key)); (ht->key.key) = 
# 389 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
   ((void *)0)
# 389 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
   ; } } while (0);
   if (!table->slice)
    do { if (ht) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c", 391, (ht)); (ht) = 
# 391 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
   ((void *)0)
# 391 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
   ; } } while (0);
 ...
 do { if (table->data) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c", 399, (table->data)); (table->data) = 
# 399 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
((void *)0)
# 399 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
; } } while (0);
 if (table->slice)
  acl_slice_destroy(table->slice);
 do { if (table) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c", 402, (table)); (table) = 
# 402 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
((void *)0)
# 402 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
; } } while (0);
}
...
ACL_BINHASH_INFO **acl_binhash_list(ACL_BINHASH *table)
{
 ...
 list = (ACL_BINHASH_INFO **) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c", 428, sizeof(*list) * (table->used + 1));
...
const ACL_BINHASH_INFO *acl_binhash_iter_head(ACL_BINHASH *table, ACL_BINHASH_ITER *iter)
{
 ...
 iter->h = table->data;
 iter->ptr = 
# 464 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
            ((void *)0)
# 464 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
                ;
...
const ACL_BINHASH_INFO *acl_binhash_iter_next(ACL_BINHASH_ITER *iter)
{
 if (iter->ptr) {
  ...
  if (iter->ptr != 
# 480 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
                  ((void *)0)
# 480 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
                      )
   return (iter->ptr);
 }
...
const ACL_BINHASH_INFO *acl_binhash_iter_tail(ACL_BINHASH *table, ACL_BINHASH_ITER *iter)
{
 ...
 iter->h = table->data;
 iter->ptr = 
# 499 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
            ((void *)0)
# 499 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
                ;
...
const ACL_BINHASH_INFO *acl_binhash_iter_prev(ACL_BINHASH_ITER *iter)
{
 if (iter->ptr) {
  iter->ptr = iter->ptr->next;
  if (iter->ptr != 
# 515 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c" 3 4
                  ((void *)0)
# 515 "/workspace/acl/lib_acl/src/stdlib/common/acl_binhash.c"
                      )
   return (iter->ptr);
 }
