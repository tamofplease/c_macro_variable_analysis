# 0 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
...
# 2 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 2
# 27 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
static void argv_extend(ACL_ARGV *argvp)
{
 ...
 if (argvp->dbuf) {
  ...
  argvp->argv = (char **) acl_realloc_glue("/acl/lib_acl/src/stdlib/common/acl_argv.c", 40, ((char *) argvp->argv), (new_len + 1) * sizeof(char *))
                                  ;
 argvp->len = new_len;
}
...
static void argv_push_front(struct ACL_ARGV *argvp, const char *s)
{
 ...
 if (argvp->dbuf)
  ...
  argvp->argv[0] = acl_strdup_glue("/acl/lib_acl/src/stdlib/common/acl_argv.c", 64, (s));
 argvp->argc++;
}
...
static char *argv_pop_back(struct ACL_ARGV *argvp)
{
 if (argvp->argc <= 0)
  return (
# 71 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
         ((void *)0)
# 71 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
             );
...
static char *argv_pop_front(struct ACL_ARGV *argvp)
{
 ...
 if (argvp->argc <= 0)
  return (
# 81 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
         ((void *)0)
# 81 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
             );
 s = argvp->argv[0];
 argvp->argc--;
...
static void *argv_iter_head(ACL_ITER *iter, struct ACL_ARGV *argv)
{
 iter->dlen = -1;
 iter->key = 
# 95 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
            ((void *)0)
# 95 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
                ;
 iter->klen = -1;
...
static void *argv_iter_tail(ACL_ITER *iter, struct ACL_ARGV *argv)
{
 iter->dlen = -1;
 iter->key = 
# 123 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
            ((void *)0)
# 123 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
                ;
 iter->klen = -1;
...
ACL_ARGV *acl_argv_free(ACL_ARGV *argvp)
{
 ...
 for (cpp = argvp->argv; cpp < argvp->argv + argvp->argc; cpp++) {
  if (argvp->dbuf)
   ...
   do { if (*cpp) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_argv.c", 157, (*cpp)); (*cpp) = 
# 157 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
  ((void *)0)
# 157 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
  ; } } while (0);
 }
 if (argvp->dbuf) {
  acl_dbuf_pool_free(argvp->dbuf, argvp->argv);
  ...
  do { if (argvp->argv) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_argv.c", 163, (argvp->argv)); (argvp->argv) = 
# 163 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
 ((void *)0)
# 163 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
 ; } } while (0);
  do { if (argvp) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_argv.c", 164, (argvp)); (argvp) = 
# 164 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
 ((void *)0)
# 164 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
 ; } } while (0);
 }
 return 
# 166 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
       ((void *)0)
# 166 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
           ;
}
...
# 173 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
                             ((void *)0)
# 173 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
                                 );
}
...
ACL_ARGV *acl_argv_alloc2(int len, ACL_DBUF_POOL *dbuf)
{
 ...
 if (dbuf) {
  ...
  argvp = (ACL_ARGV *) acl_malloc_glue("/acl/lib_acl/src/stdlib/common/acl_argv.c", 187, sizeof(*argvp));
  argvp->dbuf = 
# 188 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
               ((void *)0)
# 188 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
                   ;
 }
 argvp->len = 0;
 ...
 if (argvp->dbuf)
  ...
  argvp->argv = (char **)
   acl_malloc_glue("/acl/lib_acl/src/stdlib/common/acl_argv.c", 197, (sane_len + 1) * sizeof(char *));
 argvp->len = sane_len;
 argvp->argc = 0;
 argvp->argv[0] = 0;
...
# 225 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
__builtin_va_start(
# 225 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
ap
# 225 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
,
# 225 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
...
# 225 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
                   ;
 while ((arg = 
# 226 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
              __builtin_va_arg(
# 226 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
              ap
# 226 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
              ,
# 226 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
...
# 226 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
  ...
  if (argvp->dbuf)
   ...
   argvp->argv[argvp->argc++] = acl_strdup_glue("/acl/lib_acl/src/stdlib/common/acl_argv.c", 233, (arg));
 }
 
# 235 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
__builtin_va_end(
# 235 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
ap
# 235 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
)
# 235 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
...
void acl_argv_addv(ACL_ARGV *argvp, va_list ap)
{
 ...
 while ((arg = 
# 245 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
              __builtin_va_arg(
# 245 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
              ap
# 245 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
              ,
# 245 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
...
# 245 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
  ...
  if (argvp->dbuf)
   ...
   argvp->argv[argvp->argc++] = acl_strdup_glue("/acl/lib_acl/src/stdlib/common/acl_argv.c", 252, (arg));
 }
 argvp->argv[argvp->argc] = 0;
}
...
# 268 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
__builtin_va_start(
# 268 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
ap
# 268 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
,
# 268 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
...
# 268 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
                   ;
 while ((arg = 
# 269 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
              __builtin_va_arg(
# 269 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
              ap
# 269 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
              ,
# 269 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
...
# 269 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
  ...
  if ((len = 
# 270 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
            __builtin_va_arg(
# 270 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
            ap
# 270 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
            ,
# 270 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
...
# 270 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
  ...
  if (argvp->dbuf)
   ...
   argvp->argv[argvp->argc++] = acl_strndup_glue("/acl/lib_acl/src/stdlib/common/acl_argv.c", 278, (arg), len);
 }
 
# 280 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
__builtin_va_end(
# 280 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
ap
# 280 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
)
# 280 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
...
void acl_argv_addnv(ACL_ARGV *argvp, va_list ap)
{
 ...
 while ((arg = 
# 292 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
              __builtin_va_arg(
# 292 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
              ap
# 292 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
              ,
# 292 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
...
# 292 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
  ...
  if ((len = 
# 293 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
            __builtin_va_arg(
# 293 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
            ap
# 293 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
            ,
# 293 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
...
# 293 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
  ...
  if (argvp->dbuf)
   ...
   argvp->argv[argvp->argc++] = acl_strndup_glue("/acl/lib_acl/src/stdlib/common/acl_argv.c", 301, (arg), len);
 }
 argvp->argv[argvp->argc] = 0;
}
...
int acl_argv_set(ACL_ARGV *argvp, int idx, const char *value)
{
 if (idx < 0 || idx >= argvp->argc)
  return -1;
 if (value == 
# 310 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
             ((void *)0)
# 310 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
                 )
  return -1;
 ...
 if (argvp->dbuf)
  ...
  do { if (argvp->argv[idx]) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_argv.c", 316, (argvp->argv[idx])); (argvp->argv[idx]) = 
# 316 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
 ((void *)0)
# 316 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
 ; } } while (0);
  argvp->argv[idx] = acl_strdup_glue("/acl/lib_acl/src/stdlib/common/acl_argv.c", 317, (value));
 }
...
{
 if (argvp == 
# 333 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
             ((void *)0) 
# 333 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
                  || idx < 0 || idx > argvp->argc - 1)
  return(
# 334 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
        ((void *)0)
# 334 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
            );
...
{
 if (argvp == 
# 341 "/acl/lib_acl/src/stdlib/common/acl_argv.c" 3 4
             ((void *)0)
# 341 "/acl/lib_acl/src/stdlib/common/acl_argv.c"
                 )
  return -1;
