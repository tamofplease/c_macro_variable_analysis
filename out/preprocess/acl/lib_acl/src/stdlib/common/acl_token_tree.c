# 0 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
...
# 2 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 2
# 27 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
char *acl_token_delim_tab_new(const char *delim)
{
 char *delim_tab = (char*) acl_calloc_glue("/acl/lib_acl/src/stdlib/common/acl_token_tree.c", 29, 256, sizeof(char));
...
void acl_token_delim_tab_free(char *delim_tab)
{
 do { if (delim_tab) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_token_tree.c", 42, (delim_tab)); (delim_tab) = 
# 42 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
((void *)0)
# 42 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
; } } while (0);
}
...
static ACL_TOKEN *iter_head(ACL_ITER *it, ACL_TOKEN *token)
{
 it->dlen = -1;
 it->key = 
# 49 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
           ((void *)0)
# 49 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
               ;
 it->klen = -1;
...
# 56 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
((void) sizeof ((
# 56 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
token->parent == 
# 56 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
...
"token->parent == NULL"
# 56 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
, "/acl/lib_acl/src/stdlib/common/acl_token_tree.c", 56, __extension__ __PRETTY_FUNCTION__); }))
# 56 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                 ;
...
# 65 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
((void) sizeof ((
# 65 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
token
# 65 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
...
"token"
# 65 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
, "/acl/lib_acl/src/stdlib/common/acl_token_tree.c", 65, __extension__ __PRETTY_FUNCTION__); }))
# 65 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                 ;
 ...
 for (i = 0; i < 256; i++) {
  if (token->tokens[i] != 
# 70 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                         ((void *)0)
# 70 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                             ) {
   it->i = i;
 ...
 while (parent != 
# 83 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                 ((void *)0)
# 83 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                     ) {
  for (; i < 256; i++) {
   if (parent->tokens[i] != 
# 85 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                           ((void *)0)
# 85 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                               ) {
    it->i = i;
 ...
 it->ptr = it->data = 
# 97 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                     ((void *)0)
# 97 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                         ;
 it->i = 0;
 return 
# 99 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
       ((void *)0)
# 99 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
           ;
}
...
static ACL_TOKEN *iter_next(ACL_ITER *it, ACL_TOKEN *token __attribute__ ((__unused__)))
{
 ...
 while (1) {
  ...
  if (curr == 
# 108 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
             ((void *)0)
# 108 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                 )
   return 
# 109 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
         ((void *)0)
# 109 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
             ;
  if (curr->flag & (1 << 0))
   return curr;
 }
...
ACL_TOKEN *acl_token_new(void)
{
 ACL_TOKEN *token = (ACL_TOKEN*) acl_calloc_glue("/acl/lib_acl/src/stdlib/common/acl_token_tree.c", 117, 1, sizeof(ACL_TOKEN));
 int i;

 for (i = 0; i < 256; i++)
  token->tokens[i] = 
# 121 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                    ((void *)0)
# 121 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                        ;
...
void acl_token_free(ACL_TOKEN *token)
{
 do { if (token) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_token_tree.c", 131, (token)); (token) = 
# 131 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
((void *)0)
# 131 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
; } } while (0);
}
...
# 143 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                               ((void *)0)
# 143 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                   ) {
...
# 170 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                   ((void *)0)
# 170 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                       ;

 buf = (ACL_VSTRING*) acl_pthread_tls_get(&buf_key);
 if (buf == 
# 173 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
           ((void *)0)
# 173 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
               ) {
  if (buf_key == (acl_pthread_key_t) 0xffffffff) {
   if (__buf_unsafe == 
# 175 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                      ((void *)0)
# 175 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                          )
...
# 196 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                 ((void *)0)
# 196 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                     ;
 ...
 if ((flag & (1 << 1)) && (flag & (1 << 2))) {
  ...
  return 
# 202 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
        ((void *)0)
# 202 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
            ;
 }
 ...
 while (*ptr) {
  ...
  if (token == 
# 207 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
              ((void *)0)
# 207 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                  ) {
   token = acl_token_new();
   token->ch = *ptr;
 ...
 const char *word, const char *word_map, unsigned int flag)
{
 ...
 ACL_TOKEN *iter = tree, *token = 
# 237 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                 ((void *)0)
# 237 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                     ;
 ...
 if ((flag & (1 << 1)) && (flag & (1 << 2))) {
  ...
  return 
# 243 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
        ((void *)0)
# 243 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
            ;
 }
 ...
 while (*ptr) {
  token = iter->tokens[*ptr];
  if (token == 
# 248 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
              ((void *)0)
# 248 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                  ) {
   token = acl_token_new();
   token->ch = *ptr_map;
   iter->tokens[*ptr] = token;
...
ACL_TOKEN *acl_token_tree_word_match(ACL_TOKEN *tree, const char *word)
{
 const unsigned char *ptr = (const unsigned char*) word;
 ACL_TOKEN *iter = tree, *token = 
# 275 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                 ((void *)0)
# 275 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                     ;

 while (*ptr) {
  token = iter->tokens[*ptr];
  if (token == 
# 279 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
              ((void *)0)
# 279 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                  )
   return 
# 280 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
         ((void *)0)
# 280 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
             ;
  iter = token;
  ptr++;
 }
 ...
 if (token && (token->flag & (1 << 0)))
  ...
  return 
# 288 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
        ((void *)0)
# 288 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
            ;
}
...
void *acl_token_tree_word_remove(ACL_TOKEN *tree, const char *word)
{
 ...
 if (token == 
# 297 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
             ((void *)0)
# 297 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                 )
  return 
# 298 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
        ((void *)0)
# 298 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
            ;

 token->ctx = 
# 300 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
             ((void *)0)
# 300 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                 ;

 for (i = 0; i < 256; i++) {
  if (token->tokens[i] != 
# 303 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                         ((void *)0)
# 303 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                             ) {
   token->flag = 0;
   return 
# 305 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
         ((void *)0)
# 305 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
             ;
  }
 }

 token->parent->tokens[token->ch] = 
# 309 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                   ((void *)0)
# 309 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                       ;
 ctx = token->ctx;
...
# 318 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                        ((void *)0)
# 318 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                            ;
 int i, is_word;
 ...
 while (**ptr) {
  ...
  if (token == 
# 330 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
              ((void *)0)
# 330 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                  ) {
   if (last)
    return last;
   ...
   if (token == 
# 337 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
               ((void *)0)
# 337 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                   ) {
    (*ptr)++;
    if (**ptr == 0)
     return last;
  ...
  if (token == 
# 366 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
              ((void *)0)
# 366 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                  ) {
   if (last)
    return last;
...
{
 ACL_TOKEN *iter = tree, *token, *last = 
# 386 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                        ((void *)0)
# 386 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                            ;
 int is_word;
 ...
 while (**ptr) {
  ...
  if (token == 
# 396 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
              ((void *)0)
# 396 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                  ) {
   if (last)
    return last;
   ...
   if (token == 
# 403 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
               ((void *)0)
# 403 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                   ) {
    (*ptr)++;
    if (**ptr == 0)
     return last;
  ...
  if (token == 
# 431 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
              ((void *)0)
# 431 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                  ) {
   if (last)
    return last;
...
{
 ACL_TOKEN *iter = tree, *token, *last = 
# 450 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                        ((void *)0)
# 450 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                            ;
 int is_word;
 ...
 while (**ptr) {
  ...
  if (token == 
# 457 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
              ((void *)0)
# 457 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                  ) {
   if (last)
    return last;
   ...
   if (token == 
# 464 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
               ((void *)0)
# 464 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                   ) {
    (*ptr)++;
    if (**ptr == 0)
     return last;
  ...
  if (token == 
# 492 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
              ((void *)0)
# 492 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                  ) {
   if (last)
    return last;
...
ACL_TOKEN *acl_token_tree_create2(const char *s, const char *sep)
{
 ...
 tree = acl_token_new();
 if (s == 
# 577 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
         ((void *)0) 
# 577 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
              || *s == 0)
  return tree;
...
# 594 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                              ((void *)0)
# 594 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                                  );
  if (token == 
# 595 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
              ((void *)0)
# 595 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                  ) {
...
void acl_token_tree_load_deny(const char *filepath, ACL_TOKEN *tree)
{
 ...
 if (fp == 
# 632 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
          ((void *)0)
# 632 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
              ) {
 ...
 while (1) {
  ...
  if (ptr == 
# 640 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
            ((void *)0)
# 640 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                )
   break;
  ptr = strchr(buf, '|');
  if (ptr) {
...
# 652 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                     ((void *)0)
# 652 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                         );
 }
...
void acl_token_tree_load_pass(const char *filepath, ACL_TOKEN *tree)
{
 ...
 fp = acl_fopen(filepath, "r");
 if (fp == 
# 668 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
          ((void *)0)
# 668 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
              ) {
  acl_msg_warn("%s(%d): %s open error(%s)",
 ...
 while (1) {
  ptr = acl_fgets_nonl(buf, sizeof(buf), fp);
  if (ptr == 
# 676 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
            ((void *)0)
# 676 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                )
   break;
  ptr = strchr(buf, ':');
  if (ptr) {
   *ptr++ = 0;
   ...
   flag = (1 << 0) | (1 << 1);
  acl_token_tree_add(tree, buf, flag, 
# 688 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                     ((void *)0)
# 688 "/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                         );
 }
