# 1 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 2
# 27 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
char *acl_token_delim_tab_new(const char *delim)
{
 char *delim_tab = (char*) acl_calloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c", 29, 256, sizeof(char));
...
void acl_token_delim_tab_free(char *delim_tab)
{
 do { if (delim_tab) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c", 42, (delim_tab)); (delim_tab) = 
# 42 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
((void *)0)
# 42 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
; } } while (0);
}
...
static ACL_TOKEN *iter_head(ACL_ITER *it, ACL_TOKEN *token)
{
 it->dlen = -1;
 it->key = 
# 49 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
           ((void *)0)
# 49 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
               ;
 it->klen = -1;
...
# 56 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
((void) sizeof ((
# 56 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
token->parent == 
# 56 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
...
"token->parent == NULL"
# 56 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c", 56, __extension__ __PRETTY_FUNCTION__); }))
# 56 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                 ;
...
# 65 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
((void) sizeof ((
# 65 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
token
# 65 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
...
"token"
# 65 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
, "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c", 65, __extension__ __PRETTY_FUNCTION__); }))
# 65 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                 ;
 ...
 for (i = 0; i < 256; i++) {
  if (token->tokens[i] != 
# 70 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                         ((void *)0)
# 70 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                             ) {
   it->i = i;
 ...
 while (parent != 
# 83 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                 ((void *)0)
# 83 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                     ) {
  for (; i < 256; i++) {
   if (parent->tokens[i] != 
# 85 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                           ((void *)0)
# 85 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                               ) {
    it->i = i;
 ...
 it->ptr = it->data = 
# 97 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                     ((void *)0)
# 97 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                         ;
 it->i = 0;
 return 
# 99 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
       ((void *)0)
# 99 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
           ;
}

static ACL_TOKEN *iter_next(ACL_ITER *it, ACL_TOKEN *token __attribute__ ((__unused__)))
{
 ...
 while (1) {
  ...
  if (curr == 
# 108 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
             ((void *)0)
# 108 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                 )
   return 
# 109 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
         ((void *)0)
# 109 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
             ;
  if (curr->flag & (1 << 0))
   return curr;
 }
...
ACL_TOKEN *acl_token_new(void)
{
 ACL_TOKEN *token = (ACL_TOKEN*) acl_calloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c", 117, 1, sizeof(ACL_TOKEN));
 int i;

 for (i = 0; i < 256; i++)
  token->tokens[i] = 
# 121 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                    ((void *)0)
# 121 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                        ;
...
void acl_token_free(ACL_TOKEN *token)
{
 do { if (token) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c", 131, (token)); (token) = 
# 131 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
((void *)0)
# 131 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
; } } while (0);
}
...
# 143 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                               ((void *)0)
# 143 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                   ) {
  ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = (iter->ch)) : acl_vbuf_put((&(buf)->vbuf),(iter->ch)));
  iter = iter->parent;
 }

 ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? *(&(buf)->vbuf)->ptr = 0 : acl_vbuf_space((&(buf)->vbuf), 1), *(&(buf)->vbuf)->ptr = 0);

 pend = ((char *) (buf)->vbuf.ptr) - 1;
 ptr = ((char *) (buf)->vbuf.data);
 i = 0;
 n = (int) (pend - ptr + 1) / 2;
...
const char *acl_token_name1(ACL_TOKEN *token)
{
 static acl_pthread_key_t buf_key =
  (acl_pthread_key_t) 0xffffffff;
 ACL_VSTRING *buf;
 static ACL_VSTRING *__buf_unsafe = 
# 170 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                   ((void *)0)
# 170 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                       ;

 buf = (ACL_VSTRING*) acl_pthread_tls_get(&buf_key);
 if (buf == 
# 173 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
           ((void *)0)
# 173 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
               ) {
  if (buf_key == (acl_pthread_key_t) 0xffffffff) {
   if (__buf_unsafe == 
# 175 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                      ((void *)0)
# 175 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                          )
 ...
 unsigned int flag, const void *ctx)
{
 ...
 ACL_TOKEN *iter = tree, *token = 
# 196 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                 ((void *)0)
# 196 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                     ;

 if ((flag & (1 << 1)) && (flag & (1 << 2))) {
  acl_msg_error("%s(%d): word(%s)'s flag(%u) is"
   " ACL_TOKEN_F_DENY | ACL_TOKEN_F_PASS",
   myname, 201, word, flag);
  return 
# 202 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
        ((void *)0)
# 202 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
            ;
 }
 ...
 while (*ptr) {
  ...
  if (token == 
# 207 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
              ((void *)0)
# 207 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                  ) {
   token = acl_token_new();
   token->ch = *ptr;
 ...
 const char *word, const char *word_map, unsigned int flag)
{
 ...
 ACL_TOKEN *iter = tree, *token = 
# 237 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                 ((void *)0)
# 237 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                     ;

 if ((flag & (1 << 1)) && (flag & (1 << 2))) {
  acl_msg_error("%s(%d): word(%s)'s flag(%u) is "
   "ACL_TOKEN_F_DENY | ACL_TOKEN_F_PASS",
   myname, 242, word, flag);
  return 
# 243 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
        ((void *)0)
# 243 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
            ;
 }
 ...
 while (*ptr) {
  token = iter->tokens[*ptr];
  if (token == 
# 248 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
              ((void *)0)
# 248 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                  ) {
   token = acl_token_new();
   token->ch = *ptr_map;
   iter->tokens[*ptr] = token;
   ...
   acl_msg_fatal("%s(%d): token->ch(%d) != %d", myname,
    258, token->tokens[*ptr]->ch, *ptr_map);
  } else {
   ptr++;
   ptr_map++;
   iter = token;
...
ACL_TOKEN *acl_token_tree_word_match(ACL_TOKEN *tree, const char *word)
{
 const unsigned char *ptr = (const unsigned char*) word;
 ACL_TOKEN *iter = tree, *token = 
# 275 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                 ((void *)0)
# 275 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                     ;

 while (*ptr) {
  token = iter->tokens[*ptr];
  if (token == 
# 279 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
              ((void *)0)
# 279 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                  )
   return 
# 280 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
         ((void *)0)
# 280 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
             ;
  iter = token;
  ptr++;
 }

 if (token && (token->flag & (1 << 0)))
  return token;
 else
  return 
# 288 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
        ((void *)0)
# 288 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
            ;
}
...
void *acl_token_tree_word_remove(ACL_TOKEN *tree, const char *word)
{
 ...
 if (token == 
# 297 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
             ((void *)0)
# 297 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                 )
  return 
# 298 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
        ((void *)0)
# 298 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
            ;

 token->ctx = 
# 300 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
             ((void *)0)
# 300 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                 ;

 for (i = 0; i < 256; i++) {
  if (token->tokens[i] != 
# 303 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                         ((void *)0)
# 303 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                             ) {
   token->flag = 0;
   return 
# 305 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
         ((void *)0)
# 305 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
             ;
  }
 }

 token->parent->tokens[token->ch] = 
# 309 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                   ((void *)0)
# 309 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                       ;
 ctx = token->ctx;
...
{
 ACL_TOKEN *iter = tree, *token, *last = 
# 318 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                        ((void *)0)
# 318 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                            ;
 int i, is_word;
 ...
 while (**ptr) {
  ...
  if (token == 
# 330 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
              ((void *)0)
# 330 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                  ) {
   if (last)
    return last;
   ...
   if (token == 
# 337 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
               ((void *)0)
# 337 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                   ) {
    (*ptr)++;
    if (**ptr == 0)
     return last;
  ...
  if (token == 
# 366 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
              ((void *)0)
# 366 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                  ) {
   if (last)
    return last;

   iter = tree;
  } else if ((token->flag & (1 << 0))) {
   last = token;
   iter = token;
  } else
   iter = token;
...
{
 ACL_TOKEN *iter = tree, *token, *last = 
# 386 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                        ((void *)0)
# 386 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                            ;
 int is_word;
 ...
 while (**ptr) {
  ...
  if (token == 
# 396 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
              ((void *)0)
# 396 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                  ) {
   if (last)
    return last;
   ...
   if (token == 
# 403 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
               ((void *)0)
# 403 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                   ) {
    (*ptr)++;
    if (**ptr == 0)
     return last;
  ...
  if (token == 
# 431 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
              ((void *)0)
# 431 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                  ) {
   if (last)
    return last;
...
{
 ACL_TOKEN *iter = tree, *token, *last = 
# 450 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                        ((void *)0)
# 450 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                            ;
 int is_word;
 ...
 while (**ptr) {
  ...
  if (token == 
# 457 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
              ((void *)0)
# 457 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                  ) {
   if (last)
    return last;
   ...
   if (token == 
# 464 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
               ((void *)0)
# 464 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                   ) {
    (*ptr)++;
    if (**ptr == 0)
     return last;
  ...
  if (token == 
# 492 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
              ((void *)0)
# 492 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                  ) {
   if (last)
    return last;
...
static void acl_token_name_walk(ACL_TOKEN *token, void *arg)
{
 ...
 if ((size_t) ((buf)->vbuf.ptr - (buf)->vbuf.data) > 0)
  ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = (';')) : acl_vbuf_put((&(buf)->vbuf),(';')));
 acl_vstring_strcat(buf, ((char *) (name)->vbuf.data));
...
ACL_TOKEN *acl_token_tree_create2(const char *s, const char *sep)
{
 ...
 tree = acl_token_new();
 if (s == 
# 577 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
         ((void *)0) 
# 577 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
              || *s == 0)
  return tree;
 ...
 for ((argv)->iter_head(&(iter), (argv)); (iter).ptr; (argv)->iter_next(&(iter), (argv))) {
  ...
  token = acl_token_tree_add(tree, word, flag, 
# 594 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                              ((void *)0)
# 594 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                                  );
  if (token == 
# 595 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
              ((void *)0)
# 595 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                  ) {
...
void acl_token_tree_load_deny(const char *filepath, ACL_TOKEN *tree)
{
 ...
 if (fp == 
# 632 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
          ((void *)0)
# 632 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
              ) {
  acl_msg_warn("%s(%d): %s open error(%s)",
   myname, 634, filepath, acl_last_serror());
  return;
 }
 ...
 while (1) {
  ...
  if (ptr == 
# 640 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
            ((void *)0)
# 640 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                )
   break;
  ptr = strchr(buf, '|');
  if (ptr) {
   *ptr++ = 0;
   ...
   flag = (1 << 0) | (1 << 2);
  acl_token_tree_add(tree, buf, flag, 
# 652 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                     ((void *)0)
# 652 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                         );
 }
...
void acl_token_tree_load_pass(const char *filepath, ACL_TOKEN *tree)
{
 ...
 fp = acl_fopen(filepath, "r");
 if (fp == 
# 668 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
          ((void *)0)
# 668 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
              ) {
  acl_msg_warn("%s(%d): %s open error(%s)",
   myname, 670, filepath, acl_last_serror());
  return;
 }
 ...
 while (1) {
  ptr = acl_fgets_nonl(buf, sizeof(buf), fp);
  if (ptr == 
# 676 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
            ((void *)0)
# 676 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                )
   break;
  ptr = strchr(buf, ':');
  if (ptr) {
   *ptr++ = 0;
   ...
   flag = (1 << 0) | (1 << 1);
  acl_token_tree_add(tree, buf, flag, 
# 688 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c" 3 4
                                     ((void *)0)
# 688 "/workspace/acl/lib_acl/src/stdlib/common/acl_token_tree.c"
                                         );
 }
