# 1 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 2
# 23 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
static void dlink_free_callback(void *arg)
{
 ACL_DITEM *pitem;

 if(arg == 
# 27 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
          ((void *)0)
# 27 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
              )
  return;
 pitem = (ACL_DITEM *) arg;
 pitem->pnode = 
# 30 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
               ((void *)0)
# 30 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                   ;

 do { if (pitem) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c", 32, (pitem)); (pitem) = 
# 32 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
((void *)0)
# 32 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
; } } while (0);
}
# 52 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
static int scope_pos(const ACL_ARRAY *a, long long int n)
{
 ...
 idx = 0;
 while(lidx <= hidx) {
# 73 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
  midx = (lidx + hidx)/2;
  ridx = midx + 1;
  if(ridx > hidx) {
...
static int begin_pos(const ACL_ARRAY *a, long long int n)
{
 return scope_pos(a, n);
}

static int end_pos(const ACL_ARRAY *a, long long int n)
{
 return scope_pos(a, n);
}
# 144 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
 ...
 long long int begin, long long int end)
{
 ...
 pitem = (ACL_DITEM *) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c", 150, sizeof(ACL_DITEM));
 if(pitem == 
# 151 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
            ((void *)0)
# 151 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                )
  return 
# 152 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 152 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
 pitem->begin = begin;
 pitem->end = end;
 ret = acl_array_succ_insert(a, idx_position, pitem);
 if(ret < 0) {
  do { if (pitem) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c", 157, (pitem)); (pitem) = 
# 157 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
 ((void *)0)
# 157 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
 ; } } while (0);
  return 
# 158 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 158 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
 }
 pitem->pnode = 
# 160 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
               ((void *)0)
# 160 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                   ;

 return pitem;
}

static ACL_DITEM *dlink_append(ACL_ARRAY *a, long long int begin, long long int end)
{
 ACL_DITEM *pitem;
 int ret;

 pitem = (ACL_DITEM *) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c", 170, sizeof(ACL_DITEM));
 if(pitem == 
# 171 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
            ((void *)0)
# 171 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                )
  return 
# 172 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 172 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
 pitem->begin = begin;
 pitem->end = end;
 ret = acl_array_append(a, pitem);
 if(ret < 0) {
  do { if (pitem) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c", 177, (pitem)); (pitem) = 
# 177 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
 ((void *)0)
# 177 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
 ; } } while (0);
  return 
# 178 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 178 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
 }
 pitem->pnode = 
# 180 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
               ((void *)0)
# 180 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                   ;

 return pitem;
}

static ACL_DITEM *dlink_prepend(ACL_ARRAY *a, long long int begin, long long int end)
{
 ACL_DITEM *pitem;
 int ret;

 pitem = (ACL_DITEM *) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c", 190, sizeof(ACL_DITEM));
 if(pitem == 
# 191 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
            ((void *)0)
# 191 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                )
  return 
# 192 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 192 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
 pitem->begin = begin;
 pitem->end = end;
 ret = acl_array_prepend(a, pitem);
 if(ret < 0) {
  do { if (pitem) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c", 197, (pitem)); (pitem) = 
# 197 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
 ((void *)0)
# 197 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
 ; } } while (0);
  return 
# 198 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 198 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
 }
 pitem->pnode = 
# 200 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
               ((void *)0)
# 200 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                   ;
...
static ACL_DITEM *dlink_add(ACL_ARRAY *a, long long int begin, long long int end)
{
 ...
 if(begin > end)
  return 
# 228 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 228 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;

 idx_begin = begin_pos(a, begin);
 if(idx_begin < 0 || idx_begin >= acl_array_size(a))
  return 
# 232 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 232 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;

 idx_end = end_pos(a, end);
 if(idx_end < 0 || idx_end >= acl_array_size(a))
  return 
# 236 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 236 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;

 if(idx_begin > idx_end)
  return 
# 239 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 239 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
...
# 281 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
   pitem = dlink_succ_insert(a, idx_begin, begin, end);
   return pitem;
  }
# 292 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
...
# 324 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
 if (begin < pitem_left->begin) {
...
# 342 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
 if (begin <= pitem_left->end + 1) {
# 361 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
  if (end > pitem_right->end) {
# 371 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
   pitem_right->end = end;
  }
# 383 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
  pitem_right->begin = pitem_left->begin;

  ret = dlink_node_merge(a, idx_begin, idx_end);
  if(ret < 0)
   return 
# 387 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
         ((void *)0)
# 387 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
             ;

  return pitem_right;
 }
# 405 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
 if (end > pitem_right->end) {
# 415 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
  pitem_right->end = end;
 }
# 427 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
 pitem_right->begin = begin;

 ret = dlink_node_merge(a, idx_begin + 1, idx_end);
 if(ret < 0)
  return 
# 431 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 431 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
...
ACL_DLINK *acl_dlink_create(int nsize)
{
 ...
 plink = (ACL_DLINK *) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c", 460, sizeof(ACL_DLINK));
 plink->parray = 
# 461 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
                ((void *)0)
# 461 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                    ;
 plink->call_back_data = 
# 462 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
                        ((void *)0)
# 462 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                            ;
 nsize = nsize > 0 ? nsize : 1;
 plink->parray = acl_array_create(nsize);
 if(plink->parray == 
# 465 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
                    ((void *)0)
# 465 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                        ) {
  do { if (plink) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c", 466, (plink)); (plink) = 
# 466 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
 ((void *)0)
# 466 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
 ; } } while (0);
  return 
# 467 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 467 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
 }
...
{
 if(plink == 
# 480 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
            ((void *)0)
# 480 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                )
  return;
 if(plink->parray)
  acl_array_free(plink->parray, dlink_free_callback);
 do { if (plink) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c", 484, (plink)); (plink) = 
# 484 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
((void *)0)
# 484 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
; } } while (0);
}

ACL_DITEM *acl_dlink_lookup_by_item(const ACL_DLINK *plink, ACL_DITEM *pitem)
{
 return acl_dlink_lookup2_by_item(plink, pitem, 
# 489 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
                                               ((void *)0)
# 489 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                                                   );
}
...
ACL_DITEM *acl_dlink_lookup2_by_item(const ACL_DLINK *plink, ACL_DITEM *pitem, int *pidx)
{
 ...
 return 
# 504 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
       ((void *)0)
# 504 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
           ;
}

ACL_DITEM *acl_dlink_lookup(const ACL_DLINK *plink, long long int n)
{
 return acl_dlink_lookup2(plink, n, 
# 509 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
                                   ((void *)0)
# 509 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                                       );
}

ACL_DITEM *acl_dlink_lookup2(const ACL_DLINK *plink, long long int n, int *pidx)
{
 int lidx, midx, hidx;
 ...
 return 
# 536 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
       ((void *)0)
# 536 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
           ;
}

ACL_DITEM *acl_dlink_lookup_range(const ACL_DLINK *plink, long long int begin,
 long long int end, int *pidx)
{
 ACL_DITEM *ditem;

 if (end < begin)
  return 
# 545 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 545 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
 ditem = acl_dlink_lookup2(plink, begin, pidx);
 if (ditem == 
# 547 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
             ((void *)0)
# 547 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                 )
  return 
# 548 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 548 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
 if (ditem->end >= end)
  return ditem;
 return 
# 551 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
       ((void *)0)
# 551 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
           ;
}
 ...
 long long int off, int *pidx)
{
 ...
 return 
# 571 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
       ((void *)0)
# 571 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
           ;
}
 ...
 long long int off, int *pidx)
{
 ...
 return 
# 591 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
       ((void *)0)
# 591 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
           ;
}

ACL_DITEM *acl_dlink_insert(ACL_DLINK *plink, long long int begin, long long int end)
{
 if (begin > end) {
  long long int tmp;
...
int acl_dlink_delete(ACL_DLINK *plink, long long int n)
{
 ...
 if (ditem == 
# 619 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
             ((void *)0)
# 619 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                 )
  return -1;
...
int acl_dlink_delete_range(ACL_DLINK *plink, long long int begin, long long int end)
{
 ACL_ARRAY *parray = plink->parray;
 ...
 low = 0;
 pitem_low = 
# 642 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
            ((void *)0)
# 642 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                ;
 ...
 for (i = 0; i < size; i++) {
  ...
  if (begin <= pitem->begin) {
   ...
   long long int tmp_begin, tmp_end;
...
ACL_DITEM *acl_dlink_modify(ACL_DLINK *plink, long long int begin, long long int end)
{
 if (begin > end) {
  long long int tmp;
...
int acl_dlink_list(const ACL_DLINK *plink)
{
 ...
 if(plink == 
# 781 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
            ((void *)0) 
# 781 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                 || plink->parray == 
# 781 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
                                     ((void *)0)
# 781 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
 ...
 for (i = 0; i < n; i++) {
  ...
  if (item == 
# 789 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
             ((void *)0)
# 789 "/workspace/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                 )
   break;
