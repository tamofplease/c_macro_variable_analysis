# 0 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
...
# 2 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 2
# 23 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
static void dlink_free_callback(void *arg)
{
 ACL_DITEM *pitem;

 if(arg == 
# 27 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
          ((void *)0)
# 27 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
              )
  return;
 pitem = (ACL_DITEM *) arg;
 pitem->pnode = 
# 30 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
               ((void *)0)
# 30 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                   ;

 do { if (pitem) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_dlink.c", 32, (pitem)); (pitem) = 
# 32 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
((void *)0)
# 32 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
; } } while (0);
}
# 52 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
static int scope_pos(const ACL_ARRAY *a, long long int n)
{
 ...
 idx = 0;
 while(lidx <= hidx) {
# 73 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
  midx = (lidx + hidx)/2;
  ridx = midx + 1;
  if(ridx > hidx) {
...
# 144 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
 ...
 long long int begin, long long int end)
{
 ...
 pitem = (ACL_DITEM *) acl_malloc_glue("/acl/lib_acl/src/stdlib/common/acl_dlink.c", 150, sizeof(ACL_DITEM));
 if(pitem == 
# 151 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
            ((void *)0)
# 151 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                )
  return 
# 152 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 152 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
 pitem->begin = begin;
 pitem->end = end;
 ret = acl_array_succ_insert(a, idx_position, pitem);
 if(ret < 0) {
  do { if (pitem) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_dlink.c", 157, (pitem)); (pitem) = 
# 157 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
 ((void *)0)
# 157 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
 ; } } while (0);
  return 
# 158 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 158 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
 }
 pitem->pnode = 
# 160 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
               ((void *)0)
# 160 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                   ;
...
static ACL_DITEM *dlink_append(ACL_ARRAY *a, long long int begin, long long int end)
{
 ...
 pitem = (ACL_DITEM *) acl_malloc_glue("/acl/lib_acl/src/stdlib/common/acl_dlink.c", 170, sizeof(ACL_DITEM));
 if(pitem == 
# 171 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
            ((void *)0)
# 171 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                )
  return 
# 172 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 172 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
 pitem->begin = begin;
 pitem->end = end;
 ret = acl_array_append(a, pitem);
 if(ret < 0) {
  do { if (pitem) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_dlink.c", 177, (pitem)); (pitem) = 
# 177 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
 ((void *)0)
# 177 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
 ; } } while (0);
  return 
# 178 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 178 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
 }
 pitem->pnode = 
# 180 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
               ((void *)0)
# 180 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                   ;
...
static ACL_DITEM *dlink_prepend(ACL_ARRAY *a, long long int begin, long long int end)
{
 ...
 pitem = (ACL_DITEM *) acl_malloc_glue("/acl/lib_acl/src/stdlib/common/acl_dlink.c", 190, sizeof(ACL_DITEM));
 if(pitem == 
# 191 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
            ((void *)0)
# 191 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                )
  return 
# 192 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 192 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
 pitem->begin = begin;
 pitem->end = end;
 ret = acl_array_prepend(a, pitem);
 if(ret < 0) {
  do { if (pitem) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_dlink.c", 197, (pitem)); (pitem) = 
# 197 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
 ((void *)0)
# 197 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
 ; } } while (0);
  return 
# 198 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 198 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
 }
 pitem->pnode = 
# 200 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
               ((void *)0)
# 200 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                   ;
...
static ACL_DITEM *dlink_add(ACL_ARRAY *a, long long int begin, long long int end)
{
 ...
 if(begin > end)
  return 
# 228 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 228 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;

 idx_begin = begin_pos(a, begin);
 if(idx_begin < 0 || idx_begin >= acl_array_size(a))
  return 
# 232 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 232 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;

 idx_end = end_pos(a, end);
 if(idx_end < 0 || idx_end >= acl_array_size(a))
  return 
# 236 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 236 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;

 if(idx_begin > idx_end)
  return 
# 239 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 239 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
...
# 281 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
   pitem = dlink_succ_insert(a, idx_begin, begin, end);
   return pitem;
  }
# 292 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
...
# 324 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
 if (begin < pitem_left->begin) {
...
# 342 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
 if (begin <= pitem_left->end + 1) {
# 361 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
  if (end > pitem_right->end) {
# 371 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
   pitem_right->end = end;
  }
# 383 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
  pitem_right->begin = pitem_left->begin;

  ret = dlink_node_merge(a, idx_begin, idx_end);
  if(ret < 0)
   return 
# 387 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
         ((void *)0)
# 387 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
             ;

  return pitem_right;
 }
# 405 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
 if (end > pitem_right->end) {
# 415 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
  pitem_right->end = end;
 }
# 427 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
 pitem_right->begin = begin;

 ret = dlink_node_merge(a, idx_begin + 1, idx_end);
 if(ret < 0)
  return 
# 431 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 431 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
...
ACL_DLINK *acl_dlink_create(int nsize)
{
 ...
 plink = (ACL_DLINK *) acl_malloc_glue("/acl/lib_acl/src/stdlib/common/acl_dlink.c", 460, sizeof(ACL_DLINK));
 plink->parray = 
# 461 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
                ((void *)0)
# 461 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                    ;
 plink->call_back_data = 
# 462 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
                        ((void *)0)
# 462 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                            ;
 nsize = nsize > 0 ? nsize : 1;
 plink->parray = acl_array_create(nsize);
 if(plink->parray == 
# 465 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
                    ((void *)0)
# 465 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                        ) {
  do { if (plink) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_dlink.c", 466, (plink)); (plink) = 
# 466 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
 ((void *)0)
# 466 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
 ; } } while (0);
  return 
# 467 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 467 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
 }
...
{
 if(plink == 
# 480 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
            ((void *)0)
# 480 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                )
  return;
 if(plink->parray)
  acl_array_free(plink->parray, dlink_free_callback);
 do { if (plink) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_dlink.c", 484, (plink)); (plink) = 
# 484 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
((void *)0)
# 484 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
; } } while (0);
}
...
# 489 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
                                               ((void *)0)
# 489 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                                                   );
}
...
ACL_DITEM *acl_dlink_lookup2_by_item(const ACL_DLINK *plink, ACL_DITEM *pitem, int *pidx)
{
 ...
 return 
# 504 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
       ((void *)0)
# 504 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
           ;
}
...
# 509 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
                                   ((void *)0)
# 509 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                                       );
}
...
ACL_DITEM *acl_dlink_lookup2(const ACL_DLINK *plink, long long int n, int *pidx)
{
 ...
 return 
# 536 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
       ((void *)0)
# 536 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
           ;
}
 ...
 long long int end, int *pidx)
{
 ...
 if (end < begin)
  return 
# 545 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 545 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
 ditem = acl_dlink_lookup2(plink, begin, pidx);
 if (ditem == 
# 547 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
             ((void *)0)
# 547 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                 )
  return 
# 548 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
        ((void *)0)
# 548 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
            ;
 if (ditem->end >= end)
  return ditem;
 return 
# 551 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
       ((void *)0)
# 551 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
           ;
}
 ...
 long long int off, int *pidx)
{
 ...
 return 
# 571 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
       ((void *)0)
# 571 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
           ;
}
 ...
 long long int off, int *pidx)
{
 ...
 return 
# 591 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
       ((void *)0)
# 591 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
           ;
}
...
int acl_dlink_delete(ACL_DLINK *plink, long long int n)
{
 ...
 if (ditem == 
# 619 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
             ((void *)0)
# 619 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                 )
  return -1;
...
int acl_dlink_delete_range(ACL_DLINK *plink, long long int begin, long long int end)
{
 ...
 low = 0;
 pitem_low = 
# 642 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
            ((void *)0)
# 642 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                ;
...
int acl_dlink_list(const ACL_DLINK *plink)
{
 ...
 if(plink == 
# 781 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
            ((void *)0) 
# 781 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                 || plink->parray == 
# 781 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
                                     ((void *)0)
# 781 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
 ...
 for (i = 0; i < n; i++) {
  ...
  if (item == 
# 789 "/acl/lib_acl/src/stdlib/common/acl_dlink.c" 3 4
             ((void *)0)
# 789 "/acl/lib_acl/src/stdlib/common/acl_dlink.c"
                 )
   break;
