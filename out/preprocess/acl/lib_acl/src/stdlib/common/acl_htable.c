# 1 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 2
# 25 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
static void *htable_iter_head(ACL_ITER *iter, ACL_HTABLE *table)
{
 ACL_HTABLE_INFO *ptr = 
# 27 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                       ((void *)0)
# 27 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                           ;
 ...
 iter->ptr = 
# 33 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
            ((void *)0)
# 33 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                ;

 for (; iter->i < iter->size; iter->i++) {
  if (table->data[iter->i] != 
# 36 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                             ((void *)0)
# 36 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                                 ) {
 ...
 if (ptr) {
  ...
  iter->data = 
# 46 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
              ((void *)0)
# 46 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                  ;
  iter->key = 
# 47 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
             ((void *)0)
# 47 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                 ;
 }
 return (iter->ptr);
}
...
static void *htable_iter_next(ACL_ITER *iter, ACL_HTABLE *table)
{
 ...
 if (ptr) {
  ...
  if (ptr != 
# 61 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
            ((void *)0)
# 61 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                ) {
   iter->data = ptr->value;
   iter->key = ptr->key.c_key;
   return (iter->ptr);
 ...
 for (iter->i++; iter->i < iter->size; iter->i++) {
  if (table->data[iter->i] != 
# 69 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                             ((void *)0)
# 69 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                                 ) {
   iter->ptr = ptr = table->data[iter->i];
   break;
  }
 ...
 if (ptr) {
  ...
  iter->data = 
# 79 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
              ((void *)0)
# 79 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                  ;
  iter->key = 
# 80 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
             ((void *)0)
# 80 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                 ;
 }
 return (iter->ptr);
}
...
{
 ACL_HTABLE_INFO *ptr = 
# 89 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                       ((void *)0)
# 89 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                           ;
 ...
 iter->size = table->size;
 iter->ptr = 
# 95 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
            ((void *)0)
# 95 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                ;

 for (; iter->i >= 0; iter->i--) {
  if (table->data[iter->i] != 
# 98 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                             ((void *)0)
# 98 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                                 ) {
   iter->ptr = ptr = table->data[iter->i];
   break;
  }
 ...
 if (ptr) {
  ...
  iter->data = 
# 108 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
              ((void *)0)
# 108 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                  ;
  iter->key = 
# 109 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
             ((void *)0)
# 109 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                 ;
 }
 return (iter->ptr);
}
...
static void *htable_iter_prev(ACL_ITER *iter, ACL_HTABLE *table)
{
 ...
 if (ptr) {
  iter->ptr = ptr = ptr->next;
  if (ptr != 
# 123 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
            ((void *)0)
# 123 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                ) {
   iter->data = ptr->value;
   iter->key = ptr->key.c_key;
   return (iter->ptr);
 ...
 for (iter->i--; iter->i >= 0; iter->i--) {
  if (table->data[iter->i] != 
# 131 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                             ((void *)0)
# 131 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                                 ) {
   iter->ptr = ptr = table->data[iter->i];
   break;
  }
 ...
 if (ptr) {
  ...
  iter->data = 
# 141 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
              ((void *)0)
# 141 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                  ;
  iter->key = 
# 142 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
             ((void *)0)
# 142 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                 ;
 }
 return (iter->ptr);
}
...
static ACL_HTABLE_INFO *htable_iter_info(ACL_ITER *iter, struct ACL_HTABLE *table __attribute__ ((__unused__)))
{
 return (iter->ptr ? (ACL_HTABLE_INFO*) iter->ptr : 
# 151 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                                                   ((void *)0)
# 151 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                                                       );
}
...
# 189 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
static int htable_size(ACL_HTABLE *table, unsigned size)
{
 ...
 if (table->slice)
  table->data = h = (ACL_HTABLE_INFO **)
   acl_slice_pool_alloc("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 197, table->slice,
     size * sizeof(ACL_HTABLE_INFO *));
 else
  table->data = h = (ACL_HTABLE_INFO **)
   acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 201, size * sizeof(ACL_HTABLE_INFO *));
 if(table->data == 
# 202 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                  ((void *)0)
# 202 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                      )
  return(-1);
...
static int htable_grow(ACL_HTABLE *table)
{
 ...
 while (old_size-- > 0) {
  for (ht = *h0++; ht; ht = next) {
   ...
   { ACL_HTABLE_INFO **_h = table->data + n; ht->prev = 0; if ((ht->next = *_h) != 0) (*_h)->prev = ht; *_h = ht; table->used++; };
  }
 }

 if (table->slice)
  acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 240, old_entries);
 else
  do { if (old_entries) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 242, (old_entries)); (old_entries) = 
# 242 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
 ((void *)0)
# 242 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
 ; } } while (0);
 return(0);
}
# 253 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
static int __init_table_rwlock(ACL_HTABLE *table, int enable)
{
 ...
 if (enable && table->rwlock == 
# 259 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                               ((void *)0)
# 259 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                                   ) {
  if (table->slice)
   table->rwlock = acl_slice_pool_calloc("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 261,
      table->slice, 1, sizeof(acl_pthread_mutex_t));
  else
   table->rwlock = acl_calloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 264, 1, sizeof(acl_pthread_mutex_t));
  if (table->rwlock == 
# 265 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                      ((void *)0)
# 265 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                          ) {
   acl_msg_error("%s(%s): calloc error(%s)",
    "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", myname, acl_last_strerror(tbuf, sizeof(tbuf)));
   return (-1);
  }

  ret = pthread_mutex_init(table->rwlock, 
# 271 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                                   ((void *)0)
# 271 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                                       );
  if (ret) {
   acl_msg_error("%s(%d): init rwlock error(%s)",
    "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 274, acl_strerror(ret, tbuf, sizeof(tbuf)));
   if (table->slice)
    acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 276, table->rwlock);
   else
    do { if (table->rwlock) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 278, (table->rwlock)); (table->rwlock) = 
# 278 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
   ((void *)0)
# 278 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
   ; } } while (0);
   return (-1);
  }
  ...
  if (table->slice)
   acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 284, table->rwlock);
  else
   do { if (table->rwlock) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 286, (table->rwlock)); (table->rwlock) = 
# 286 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
  ((void *)0)
# 286 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
  ; } } while (0);
  table->rwlock = 
# 287 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                 ((void *)0)
# 287 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                     ;
 }
...
ACL_HTABLE *acl_htable_create(int size, unsigned int flag)
{
 return (acl_htable_create3(size, flag, 
# 297 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                                       ((void *)0)
# 297 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                                           ));
}
...
ACL_HTABLE *acl_htable_create3(int size, unsigned int flag, ACL_SLICE_POOL *slice)
{
 ...
 if (slice) {
  table = (ACL_HTABLE *) acl_slice_pool_calloc("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 306,
    slice, 1, sizeof(ACL_HTABLE));
  if (table == 
# 308 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
              ((void *)0)
# 308 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                  )
   return (
# 309 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
          ((void *)0)
# 309 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
              );
  table->slice = slice;
 } else {
  table = (ACL_HTABLE *) acl_calloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 312, 1, sizeof(ACL_HTABLE));
  if (table == 
# 313 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
              ((void *)0)
# 313 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                  )
   return (
# 314 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
          ((void *)0)
# 314 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
              );
  table->slice = 
# 315 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                ((void *)0)
# 315 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                    ;
 }
 ...
 if(ret < 0) {
  if (table->slice)
   acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 324, table);
  else
   do { if (table) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 326, (table)); (table) = 
# 326 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
  ((void *)0)
# 326 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
  ; } } while (0);
  return(
# 327 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
        ((void *)0)
# 327 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
            );
 }
 ...
 if ((flag & (1 << 1))) {
  ...
  if (ret < 0) {
   if (table->slice)
    acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 342, table);
   else
    do { if (table) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 344, (table)); (table) = 
# 344 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
   ((void *)0)
# 344 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
   ; } } while (0);
   return (
# 345 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
          ((void *)0)
# 345 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
              );
  }
 } else
  table->rwlock = 
# 348 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                 ((void *)0)
# 348 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                     ;

 return (table);
}
# 403 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
void acl_htable_ctl(ACL_HTABLE *table, int name, ...)
{
 ...
 if (table == 
# 408 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
             ((void *)0)
# 408 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                 )
  return;

 
# 411 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
__builtin_va_start(
# 411 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
ap
# 411 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
,
# 411 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
...
# 411 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                  ;
 for (; name != 0; name = 
# 412 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                                          __builtin_va_arg(
# 412 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                                          ap
# 412 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                                          ,
# 412 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
...
# 412 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
  ...
  case 2:
   table->hash_fn = 
# 415 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                   __builtin_va_arg(
# 415 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                   ap
# 415 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                   ,
# 415 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
...
# 415 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                                          ;
   if (table->hash_fn == 
# 416 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                        ((void *)0)
# 416 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                            )
    table->hash_fn = __def_hash_fn;
   break;
  case 1:
   if (__init_table_rwlock(table, 
# 420 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                                 __builtin_va_arg(
# 420 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                                 ap
# 420 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                                 ,
# 420 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
...
# 428 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
__builtin_va_end(
# 428 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
ap
# 428 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
)
# 428 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
...
{
 if (table == 
# 433 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
             ((void *)0)
# 433 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                 )
  return (1);
 return (table->status);
}
...
ACL_HTABLE_INFO *acl_htable_enter(ACL_HTABLE *table, const char *key_in, void *value)
{
 ...
 unsigned hash, n;
 char *keybuf = 
# 454 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
               ((void *)0)
# 454 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                   ;
 const char *key;
# 469 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
 if ((table->flag & (1 << 3))) {
  if (table->slice)
   keybuf = acl_slice_pool_strdup("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 471,
     table->slice, key_in);
  else
   keybuf = acl_strdup_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 474, (key_in));
 ...
 if (table->used >= table->size) {
  ...
  if(ret < 0) {
   do { if (keybuf) { if (table->slice) acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 486, keybuf); else do { if (keybuf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 486, (keybuf)); (keybuf) = 
# 486 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
  ((void *)0)
# 486 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
  ; } } while (0); } return (
# 486 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
  ((void *)0)
# 486 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
 ...
 for (ht = table->data[n]; ht; ht = ht->next) {
  if ((key == ht->key.c_key || (key[0] == ht->key.c_key[0] && strcmp(key,ht->key.c_key) == 0))) {
   table->status = 2;
   acl_msg_info("%s(%d): duplex key(%s) exist",
    myname, 496, key);
   do { if (keybuf) { if (table->slice) acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 497, keybuf); else do { if (keybuf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 497, (keybuf)); (keybuf) = 
# 497 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
  ((void *)0)
# 497 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
  ; } } while (0); } return (ht); } while (0);
  }
 }

 if (table->slice)
  ht = (ACL_HTABLE_INFO*) acl_slice_pool_alloc("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 502,
    table->slice, sizeof(ACL_HTABLE_INFO));
 else
  ht = (ACL_HTABLE_INFO *) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 505, sizeof(ACL_HTABLE_INFO));
 if (ht == 
# 506 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
          ((void *)0)
# 506 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
              ) {
  acl_msg_error("%s(%d): alloc error", myname, 507);
  do { if (keybuf) { if (table->slice) acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 508, keybuf); else do { if (keybuf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 508, (keybuf)); (keybuf) = 
# 508 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
 ((void *)0)
# 508 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
 ; } } while (0); } return (
# 508 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
 ((void *)0)
# 508 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
 ...
 if ((table->flag & (1 << 0)))
  ...
  if (table->slice)
   ht->key.key = acl_slice_pool_strdup("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 515,
      table->slice, key);
  else
   ht->key.key = acl_strdup_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 518, (key));
  if (ht->key.key == 
# 519 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                    ((void *)0)
# 519 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                        ) {
   acl_msg_error("%s(%d): alloc error", myname, 520);
   if (table->slice)
    acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 522, ht);
   else
    do { if (ht) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 524, (ht)); (ht) = 
# 524 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
   ((void *)0)
# 524 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
   ; } } while (0);
   do { if (keybuf) { if (table->slice) acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 525, keybuf); else do { if (keybuf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 525, (keybuf)); (keybuf) = 
# 525 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
  ((void *)0)
# 525 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
  ; } } while (0); } return (
# 525 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
  ((void *)0)
# 525 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
 ...
 ht->value = value;
 { ACL_HTABLE_INFO **_h = table->data + n; ht->prev = 0; if ((ht->next = *_h) != 0) (*_h)->prev = ht; *_h = ht; table->used++; };
 do { if (keybuf) { if (table->slice) acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 532, keybuf); else do { if (keybuf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 532, (keybuf)); (keybuf) = 
# 532 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
((void *)0)
# 532 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
; } } while (0); } return (ht); } while (0);
}
 ...
 void (*callback)(ACL_HTABLE_INFO *ht, void *arg), void *arg)
{
 ...
 unsigned hash, n;
 char *keybuf = 
# 542 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
               ((void *)0)
# 542 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                   ;
 const char *key;
# 557 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
 if ((table->flag & (1 << 3))) {
  if (table->slice)
   keybuf = acl_slice_pool_strdup("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 559,
     table->slice, key_in);
  else
   keybuf = acl_strdup_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 562, (key_in));
  acl_lowercase(keybuf);
  key = keybuf;
 } else
  key = key_in;
 ...
 table->status = 0;
 do { int _ret; if (table->rwlock && (_ret = pthread_mutex_lock(table->rwlock))) { acl_msg_fatal("%s(%d): write lock error(%s)", "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 571, strerror(_ret)); } } while (0);

 if (table->used >= table->size) {
  ret = htable_grow(table);
  if(ret < 0) {
   do { int _ret; if (table->rwlock && (_ret = pthread_mutex_unlock(table->rwlock))) { acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 576, strerror(_ret)); } } while (0);
   do { if (keybuf) { if (table->slice) acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 577, keybuf); else do { if (keybuf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 577, (keybuf)); (keybuf) = 
# 577 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
  ((void *)0)
# 577 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
 ...
 for (ht = table->data[n]; ht; ht = ht->next) {
  if ((key == ht->key.c_key || (key[0] == ht->key.c_key[0] && strcmp(key,ht->key.c_key) == 0))) {
   ...
   if (callback)
    callback(ht, arg);
   do { int _ret; if (table->rwlock && (_ret = pthread_mutex_unlock(table->rwlock))) { acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 590, strerror(_ret)); } } while (0);
   do { if (keybuf) { if (table->slice) acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 591, keybuf); else do { if (keybuf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 591, (keybuf)); (keybuf) = 
# 591 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
  ((void *)0)
# 591 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
  ; } } while (0); } return (0); } while (0);
  }
 }

 if (table->slice)
  ht = (ACL_HTABLE_INFO*) acl_slice_pool_alloc("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 596,
    table->slice, sizeof(ACL_HTABLE_INFO));
 else
  ht = (ACL_HTABLE_INFO *) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 599, sizeof(ACL_HTABLE_INFO));

 if ((table->flag & (1 << 0)))
  ht->key.c_key = key;
 else if (table->slice)
  ht->key.key = acl_slice_pool_strdup("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 604,
     table->slice, key);
 else
  ht->key.key = acl_strdup_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 607, (key));
 ...
 do { int _ret; if (table->rwlock && (_ret = pthread_mutex_unlock(table->rwlock))) { acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 616, strerror(_ret)); } } while (0);

 do { if (keybuf) { if (table->slice) acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 618, keybuf); else do { if (keybuf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 618, (keybuf)); (keybuf) = 
# 618 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
((void *)0)
# 618 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
; } } while (0); } return (0); } while (0);
}
...
void *acl_htable_find(ACL_HTABLE *table, const char *key)
{
 ...
 return ht != 
# 626 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
             ((void *)0) 
# 626 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                  ? ht->value : 
# 626 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                                ((void *)0)
# 626 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
 ...
 void (*callback)(void *value, void *arg), void *arg)
{
 ...
 unsigned n;
 char *keybuf = 
# 634 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
               ((void *)0)
# 634 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                   ;
 const char *key;
# 649 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
 if ((table->flag & (1 << 3))) {
  if (table->slice)
   keybuf = acl_slice_pool_strdup("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 651,
     table->slice, key_in);
  else
   keybuf = acl_strdup_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 654, (key_in));
  acl_lowercase(keybuf);
  key = keybuf;
 } else
  key = key_in;
 ...
 do { int _ret; if (table->rwlock && (_ret = pthread_mutex_lock(table->rwlock))) { acl_msg_fatal("%s(%d): read lock error(%s)", "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 662, strerror(_ret)); } } while (0);
 ...
 for (ht = table->data[n]; ht; ht = ht->next) {
  if ((key == ht->key.c_key || (key[0] == ht->key.c_key[0] && strcmp(key,ht->key.c_key) == 0))) {
   ...
   if (!(table->flag & (1 << 2))) {
    do { int _ret; if (table->rwlock && (_ret = pthread_mutex_unlock(table->rwlock))) { acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 672, strerror(_ret)); } } while (0);
    do { if (keybuf) { if (table->slice) acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 673, keybuf); else do { if (keybuf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 673, (keybuf)); (keybuf) = 
# 673 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
   ((void *)0)
# 673 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
   ; } } while (0); } return (0); } while (0);
   }
   if (ht == table->data[n]) {
    do { int _ret; if (table->rwlock && (_ret = pthread_mutex_unlock(table->rwlock))) { acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 676, strerror(_ret)); } } while (0);
    do { if (keybuf) { if (table->slice) acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 677, keybuf); else do { if (keybuf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 677, (keybuf)); (keybuf) = 
# 677 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
   ((void *)0)
# 677 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
   ; } } while (0); } return (0); } while (0);
   }
   if (ht->next) {
    ...
    ht->prev->next = 
# 683 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                    ((void *)0)
# 683 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                        ;
   }
   table->data[n]->prev = ht;
   ht->prev = 
# 686 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
             ((void *)0)
# 686 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                 ;
   ht->next = table->data[n];
   table->data[n] = ht;

   do { int _ret; if (table->rwlock && (_ret = pthread_mutex_unlock(table->rwlock))) { acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 690, strerror(_ret)); } } while (0);
   do { if (keybuf) { if (table->slice) acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 691, keybuf); else do { if (keybuf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 691, (keybuf)); (keybuf) = 
# 691 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
  ((void *)0)
# 691 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
  ; } } while (0); } return (0); } while (0);
  }
 }

 do { int _ret; if (table->rwlock && (_ret = pthread_mutex_unlock(table->rwlock))) { acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 695, strerror(_ret)); } } while (0);

 do { if (keybuf) { if (table->slice) acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 697, keybuf); else do { if (keybuf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 697, (keybuf)); (keybuf) = 
# 697 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
((void *)0)
# 697 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
; } } while (0); } return (-1); } while (0);
}
...
ACL_HTABLE_INFO *acl_htable_locate(ACL_HTABLE *table, const char *key_in)
{
 ...
 unsigned n;
 char *keybuf = 
# 706 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
               ((void *)0)
# 706 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                   ;
 const char *key;
# 721 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
 if ((table->flag & (1 << 3))) {
  if (table->slice)
   keybuf = acl_slice_pool_strdup("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 723,
     table->slice, key_in);
  else
   keybuf = acl_strdup_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 726, (key_in));
  acl_lowercase(keybuf);
  key = keybuf;
 } else
  key = key_in;
 ...
 for (ht = table->data[n]; ht; ht = ht->next) {
  if ((key == ht->key.c_key || (key[0] == ht->key.c_key[0] && strcmp(key,ht->key.c_key) == 0))) {
   if (!(table->flag & (1 << 2)))
    do { if (keybuf) { if (table->slice) acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 739, keybuf); else do { if (keybuf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 739, (keybuf)); (keybuf) = 
# 739 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
   ((void *)0)
# 739 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
   ; } } while (0); } return (ht); } while (0);
   if (ht == table->data[n])
    do { if (keybuf) { if (table->slice) acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 741, keybuf); else do { if (keybuf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 741, (keybuf)); (keybuf) = 
# 741 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
   ((void *)0)
# 741 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
   ; } } while (0); } return (ht); } while (0);
   if (ht->next) {
    ht->prev->next = ht->next;
    ht->next->prev = ht->prev;
    ...
    ht->prev->next = 
# 746 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                    ((void *)0)
# 746 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                        ;
   }
   table->data[n]->prev = ht;
   ht->prev = 
# 749 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
             ((void *)0)
# 749 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                 ;
   ht->next = table->data[n];
   table->data[n] = ht;
   do { if (keybuf) { if (table->slice) acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 752, keybuf); else do { if (keybuf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 752, (keybuf)); (keybuf) = 
# 752 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
  ((void *)0)
# 752 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
  ; } } while (0); } return (ht); } while (0);
  }
 }

 do { if (keybuf) { if (table->slice) acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 756, keybuf); else do { if (keybuf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 756, (keybuf)); (keybuf) = 
# 756 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
((void *)0)
# 756 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
; } } while (0); } return (
# 756 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
((void *)0)
# 756 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
 ...
 void (*callback)(ACL_HTABLE_INFO *ht, void *arg), void *arg)
{
 ...
 unsigned n;
 char *keybuf = 
# 764 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
               ((void *)0)
# 764 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                   ;
 const char *key;
# 779 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
 if ((table->flag & (1 << 3))) {
  if (table->slice)
   keybuf = acl_slice_pool_strdup("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 781,
     table->slice, key_in);
  else
   keybuf = acl_strdup_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 784, (key_in));
  acl_lowercase(keybuf);
  key = keybuf;
 } else
  key = key_in;
 ...
 do { int _ret; if (table->rwlock && (_ret = pthread_mutex_lock(table->rwlock))) { acl_msg_fatal("%s(%d): read lock error(%s)", "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 792, strerror(_ret)); } } while (0);
 ...
 for (ht = table->data[n]; ht; ht = ht->next) {
  if ((key == ht->key.c_key || (key[0] == ht->key.c_key[0] && strcmp(key,ht->key.c_key) == 0))) {
   if (callback)
    callback(ht, arg);
   do { int _ret; if (table->rwlock && (_ret = pthread_mutex_unlock(table->rwlock))) { acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 800, strerror(_ret)); } } while (0);
   do { if (keybuf) { if (table->slice) acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 801, keybuf); else do { if (keybuf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 801, (keybuf)); (keybuf) = 
# 801 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
  ((void *)0)
# 801 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
  ; } } while (0); } return (0); } while (0);
  }
 }

 do { int _ret; if (table->rwlock && (_ret = pthread_mutex_unlock(table->rwlock))) { acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 805, strerror(_ret)); } } while (0);

 do { if (keybuf) { if (table->slice) acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 807, keybuf); else do { if (keybuf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 807, (keybuf)); (keybuf) = 
# 807 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
((void *)0)
# 807 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
; } } while (0); } return (-1); } while (0);
}
 ...
 void (*free_fn) (void *))
{
 ...
 if (!(table->flag & (1 << 0))) {
  if (table->slice)
   acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 823, ht->key.key);
  else
   do { if (ht->key.key) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 825, (ht->key.key)); (ht->key.key) = 
# 825 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
  ((void *)0)
# 825 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
  ; } } while (0);
 }
 if (free_fn && ht->value)
  (*free_fn) (ht->value);
 if (table->slice)
  acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 830, ht);
 else
  do { if (ht) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 832, (ht)); (ht) = 
# 832 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
 ((void *)0)
# 832 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
 ; } } while (0);
 table->used--;
}
 ...
 void (*free_fn) (void *))
{
 ...
 ACL_HTABLE_INFO **h;
 char *keybuf = 
# 844 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
               ((void *)0)
# 844 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                   ;
 const char *key;
# 859 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
 if ((table->flag & (1 << 3))) {
  if (table->slice)
   keybuf = acl_slice_pool_strdup("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 861,
     table->slice, key_in);
  else
   keybuf = acl_strdup_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 864, (key_in));
  acl_lowercase(keybuf);
  key = keybuf;
 } else
  key = key_in;
 ...
 do { int _ret; if (table->rwlock && (_ret = pthread_mutex_lock(table->rwlock))) { acl_msg_fatal("%s(%d): write lock error(%s)", "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 872, strerror(_ret)); } } while (0);
 ...
 for (ht = *h; ht; ht = ht->next) {
  if ((key == ht->key.c_key || (key[0] == ht->key.c_key[0] && strcmp(key,ht->key.c_key) == 0))) {
   ...
   do { int _ret; if (table->rwlock && (_ret = pthread_mutex_unlock(table->rwlock))) { acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 880, strerror(_ret)); } } while (0);
   do { if (keybuf) { if (table->slice) acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 881, keybuf); else do { if (keybuf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 881, (keybuf)); (keybuf) = 
# 881 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
  ((void *)0)
# 881 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
  ; } } while (0); } return (0); } while (0);
  }
 }

 do { int _ret; if (table->rwlock && (_ret = pthread_mutex_unlock(table->rwlock))) { acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 885, strerror(_ret)); } } while (0);
 do { if (keybuf) { if (table->slice) acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 886, keybuf); else do { if (keybuf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 886, (keybuf)); (keybuf) = 
# 886 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
((void *)0)
# 886 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
; } } while (0); } return (-1); } while (0);
}
...
void acl_htable_free(ACL_HTABLE *table, void (*free_fn) (void *))
{
 ...
 while (i-- > 0) {
  for (ht = *h++; ht; ht = next) {
   ...
   if (!(table->flag & (1 << 0))) {
    if (table->slice)
     acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 903,
      ht->key.key);
    else
     do { if (ht->key.key) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 906, (ht->key.key)); (ht->key.key) = 
# 906 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
    ((void *)0)
# 906 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
    ; } } while (0);
   }
   if (free_fn && ht->value)
    (*free_fn) (ht->value);
   if (table->slice)
    acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 911, ht);
   else
    do { if (ht) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 913, (ht)); (ht) = 
# 913 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
   ((void *)0)
# 913 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
   ; } } while (0);
  }
 }

 if (table->slice)
  acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 918, table->data);
 else
  do { if (table->data) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 920, (table->data)); (table->data) = 
# 920 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
 ((void *)0)
# 920 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
 ; } } while (0);
 table->data = 0;
 if (table->rwlock) {
  pthread_mutex_destroy(table->rwlock);
  if (table->slice)
   acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 925, table->rwlock);
  else
   do { if (table->rwlock) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 927, (table->rwlock)); (table->rwlock) = 
# 927 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
  ((void *)0)
# 927 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
  ; } } while (0);
 }

 if (table->slice)
  acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 931, table);
 else
  do { if (table) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 933, (table)); (table) = 
# 933 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
 ((void *)0)
# 933 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
 ; } } while (0);
}
...
int acl_htable_reset(ACL_HTABLE *table, void (*free_fn) (void *))
{
 ...
 do { int _ret; if (table->rwlock && (_ret = pthread_mutex_lock(table->rwlock))) { acl_msg_fatal("%s(%d): write lock error(%s)", "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 944, strerror(_ret)); } } while (0);
 ...
 while (i-- > 0) {
  for (ht = *h++; ht; ht = next) {
   ...
   if (!(table->flag & (1 << 0))) {
    if (table->slice)
     acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 953, ht->key.key);
    else
     do { if (ht->key.key) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 955, (ht->key.key)); (ht->key.key) = 
# 955 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
    ((void *)0)
# 955 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
    ; } } while (0);
   }
   if (free_fn && ht->value)
    (*free_fn) (ht->value);
   if (table->slice)
    acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 960, ht);
   else
    do { if (ht) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 962, (ht)); (ht) = 
# 962 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
   ((void *)0)
# 962 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
   ; } } while (0);
  }
 }
 if (table->slice)
  acl_slice_pool_free("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 966, table->data);
 else
  do { if (table->data) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 968, (table->data)); (table->data) = 
# 968 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
 ((void *)0)
# 968 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
 ; } } while (0);
 ret = htable_size(table, table->init_size < 13 ? 13 : table->init_size);

 do { int _ret; if (table->rwlock && (_ret = pthread_mutex_unlock(table->rwlock))) { acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 971, strerror(_ret)); } } while (0);
 return (ret);
}
...
const ACL_HTABLE_INFO *acl_htable_iter_head(ACL_HTABLE *table, ACL_HTABLE_ITER *iter)
{
 ...
 iter->h = table->data;
 iter->ptr = 
# 980 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
            ((void *)0)
# 980 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                ;
...
const ACL_HTABLE_INFO *acl_htable_iter_next(ACL_HTABLE_ITER *iter)
{
 if (iter->ptr) {
  ...
  if (iter->ptr != 
# 996 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                  ((void *)0)
# 996 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                      )
   return (iter->ptr);
 }
...
const ACL_HTABLE_INFO *acl_htable_iter_tail(ACL_HTABLE *table, ACL_HTABLE_ITER *iter)
{
 ...
 iter->h = table->data;
 iter->ptr = 
# 1015 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
            ((void *)0)
# 1015 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                ;
...
const ACL_HTABLE_INFO *acl_htable_iter_prev(ACL_HTABLE_ITER *iter)
{
 if (iter->ptr) {
  iter->ptr = iter->ptr->next;
  if (iter->ptr != 
# 1031 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c" 3 4
                  ((void *)0)
# 1031 "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c"
                      )
   return (iter->ptr);
 }
...
void acl_htable_walk(ACL_HTABLE *table, void (*action)(ACL_HTABLE_INFO *, void *), void *arg)
{
 ...
 do { int _ret; if (table->rwlock && (_ret = pthread_mutex_lock(table->rwlock))) { acl_msg_fatal("%s(%d): read lock error(%s)", "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 1053, strerror(_ret)); } } while (0);
 while (i-- > 0)
  for (ht = *h++; ht; ht = ht->next)
   (*action) (ht, arg);
 do { int _ret; if (table->rwlock && (_ret = pthread_mutex_unlock(table->rwlock))) { acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 1057, strerror(_ret)); } } while (0);
}
...
ACL_HTABLE_INFO **acl_htable_list(const ACL_HTABLE *table)
{
 ...
 if (table != 0) {
  list = (ACL_HTABLE_INFO **) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 1091, sizeof(*list) * (table->used + 1));
  for (i = 0; i < table->size; i++)
   for (member = table->data[i]; member != 0; member = member->next)
    list[count++] = member;
 } else {
  list = (ACL_HTABLE_INFO **) acl_malloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 1096, sizeof(*list));
 }
 list[count] = 0;
 return (list);
}
...
void acl_htable_stat(const ACL_HTABLE *table)
{
 ...
 do { int _ret; if (table->rwlock && (_ret = pthread_mutex_lock(table->rwlock))) { acl_msg_fatal("%s(%d): read lock error(%s)", "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 1107, strerror(_ret)); } } while (0);
 ...
 do { int _ret; if (table->rwlock && (_ret = pthread_mutex_unlock(table->rwlock))) { acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/stdlib/common/acl_htable.c", 1129, strerror(_ret)); } } while (0);
}
