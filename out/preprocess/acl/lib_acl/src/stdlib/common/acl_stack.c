# 0 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
...
# 2 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 2
# 19 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
...
static void *stack_pop_front(struct ACL_STACK *s)
{
 ...
 if (s->count < 1)
  return (
# 40 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
         ((void *)0)
# 40 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
             );
...
static void *stack_iter_head(ACL_ITER *iter, struct ACL_STACK *s)
{
 iter->dlen = -1;
 iter->key = 
# 55 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
            ((void *)0)
# 55 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
                ;
 iter->klen = -1;
 iter->i = 0;
 iter->size = s->count;;
 if (s->items == 
# 59 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
                ((void *)0) 
# 59 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
                     || s->count <= 0)
  iter->ptr = 
# 60 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
             ((void *)0)
# 60 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
                 ;
 else
  iter->ptr = s->items[0];
...
static void *stack_iter_tail(ACL_ITER *iter, struct ACL_STACK *s)
{
 iter->dlen = -1;
 iter->key = 
# 85 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
            ((void *)0)
# 85 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
                ;
 iter->klen = -1;
 iter->i = s->count - 1;
 iter->size = s->count;
 if (s->items == 
# 89 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
                ((void *)0) 
# 89 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
                     || iter->i < 0)
  iter->data = iter->ptr = 0;
 else
  iter->data = iter->ptr = s->items[iter->i];
...
static void stack_grow(ACL_STACK *s, int min_capacity)
{
 ...
 s->capacity += delta;
 if (s->items) {
  s->items = (void **) acl_default_realloc("/acl/lib_acl/src/stdlib/common/acl_stack.c", 130,
    s->items, s->capacity * sizeof(void *));
  ptr = "realloc";
 } else {
  s->items = (void **) acl_default_malloc("/acl/lib_acl/src/stdlib/common/acl_stack.c", 134,
    s->capacity * sizeof(void *));
  ptr = "malloc";
 }

 if (s->items == 
# 139 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
                ((void *)0)
# 139 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
                    ) {
  char ebuf[256];
...
ACL_STACK *acl_stack_create(int init_size)
{
 ...
 s = (ACL_STACK *) acl_default_calloc("/acl/lib_acl/src/stdlib/common/acl_stack.c", 165, 1, sizeof(ACL_STACK));
 if (s == 
# 166 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
         ((void *)0)
# 166 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
             ) {
  char ebuf[256];
...
void acl_stack_clean(ACL_STACK *s, void (*free_fn)(void *))
{
 ...
 for (i = 0; i < s->count; i++) {
  if (free_fn != 
# 191 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
                ((void *)0) 
# 191 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
                     && s->items[i] != 
# 191 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
                                       ((void *)0)
# 191 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
   ...
   free_fn(s->items[i]);
  s->items[i] = 
# 193 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
               ((void *)0)
# 193 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
                   ;
 }

 acl_default_free("/acl/lib_acl/src/stdlib/common/acl_stack.c", 196, s->items);
 s->items = 
# 197 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
           ((void *)0)
# 197 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
               ;
 s->count = 0;
}
...
void acl_stack_destroy(ACL_STACK *s, void (*free_fn)(void *))
{
 ...
 acl_default_free("/acl/lib_acl/src/stdlib/common/acl_stack.c", 205, s);
}

void acl_stack_append(ACL_STACK *s, void *obj)
{
 if (s == 
# 210 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
         ((void *)0) 
# 210 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
              || obj == 
# 210 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
                        ((void *)0)
# 210 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
...
void acl_stack_prepend(ACL_STACK *s, void *obj)
{
 ...
 if (s == 
# 221 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
         ((void *)0) 
# 221 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
              || obj == 
# 221 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
                        ((void *)0)
# 221 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
...
void acl_stack_delete(ACL_STACK *s, int position, void (*free_fn)(void *))
{
 ...
 if (s == 
# 236 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
         ((void *)0) 
# 236 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
              || position < 0 || position >= s->count)
  return;
 if (free_fn != 
# 238 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
               ((void *)0) 
# 238 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
                    && s->items[position] != 
# 238 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
                                             ((void *)0)
# 238 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
 ...
 s->items[position] = 
# 240 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
                     ((void *)0)
# 240 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
                         ;
...
void acl_stack_delete_obj(ACL_STACK *s, void *obj, void (*free_fn)(void *))
{
 ...
 if (s == 
# 251 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
         ((void *)0) 
# 251 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
              || obj == 
# 251 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
                        ((void *)0)
# 251 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
 ...
 if (position == -1)
  return;
 if (free_fn != 
# 263 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
               ((void *)0) 
# 263 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
                    && obj != 
# 263 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
                              ((void *)0)
# 263 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
 ...
 s->items[i] = 
# 267 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
              ((void *)0)
# 267 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
                  ;
 acl_stack_delete(s, position, 
# 268 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
                              ((void *)0)
# 268 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
                                  );
}
...
{
 if (s == 
# 273 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
         ((void *)0) 
# 273 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
              || idx < 0 || idx > s->count - 1)
  return (
# 274 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
         ((void *)0)
# 274 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
             );
...
{
 if (s == 
# 281 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
         ((void *)0)
# 281 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
             )
  return (-1);
 return (s->count);
}
...
{
 if (s == 
# 288 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
         ((void *)0)
# 288 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
             )
  return (
# 289 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
         ((void *)0)
# 289 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
             );

 if (s->count < 1)
  return (
# 292 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
         ((void *)0)
# 292 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
             );
...
{
 if (s == 
# 299 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
         ((void *)0)
# 299 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
             )
  return (
# 300 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
         ((void *)0)
# 300 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
             );

 if (s->count < 1)
  return (
# 303 "/acl/lib_acl/src/stdlib/common/acl_stack.c" 3 4
         ((void *)0)
# 303 "/acl/lib_acl/src/stdlib/common/acl_stack.c"
             );
