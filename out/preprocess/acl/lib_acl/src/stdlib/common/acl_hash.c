# 1 "/workspace/acl/lib_acl/src/stdlib/common/acl_hash.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/common/acl_hash.c" 2
# 15 "/workspace/acl/lib_acl/src/stdlib/common/acl_hash.c"
...
# 114 "/workspace/acl/lib_acl/src/stdlib/common/acl_hash.c"
...
unsigned acl_hash_crc32(const void *buf, size_t len)
{
 ...
 crc = crc ^ 0xffffffffL;
 while (len >= 8) {
  crc = crc32_table[((int)crc ^ (*ptr++)) & 0xff] ^ (crc >> 8);; crc = crc32_table[((int)crc ^ (*ptr++)) & 0xff] ^ (crc >> 8);;; crc = crc32_table[((int)crc ^ (*ptr++)) & 0xff] ^ (crc >> 8);; crc = crc32_table[((int)crc ^ (*ptr++)) & 0xff] ^ (crc >> 8);;;; crc = crc32_table[((int)crc ^ (*ptr++)) & 0xff] ^ (crc >> 8);; crc = crc32_table[((int)crc ^ (*ptr++)) & 0xff] ^ (crc >> 8);;; crc = crc32_table[((int)crc ^ (*ptr++)) & 0xff] ^ (crc >> 8);; crc = crc32_table[((int)crc ^ (*ptr++)) & 0xff] ^ (crc >> 8);;;;;
  len -= 8;
 }
 if (len > 0)
  do {
   crc = crc32_table[((int)crc ^ (*ptr++)) & 0xff] ^ (crc >> 8);;
  } while (--len > 0);
 return (unsigned) crc ^ 0xffffffffL;
}
# 309 "/workspace/acl/lib_acl/src/stdlib/common/acl_hash.c"
...
{
 const unsigned char* ptr = (const unsigned char *) buf;
 unsigned long long int crc = 0xffffffffffffffffll;
...
unsigned acl_hash_test(const void *buf, size_t len __attribute__ ((__unused__)))
{
...
# 452 "/workspace/acl/lib_acl/src/stdlib/common/acl_hash.c"
unsigned acl_hash_func2(const void *buf, size_t len)
{
...
# 479 "/workspace/acl/lib_acl/src/stdlib/common/acl_hash.c"
unsigned acl_hash_func3(const void *buf, size_t len)
{
...
# 585 "/workspace/acl/lib_acl/src/stdlib/common/acl_hash.c"
unsigned acl_hash_func5(const void *buf, size_t len)
{
