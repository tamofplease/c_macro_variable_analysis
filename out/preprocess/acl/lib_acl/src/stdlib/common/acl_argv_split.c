# 0 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
...
# 2 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 2
# 21 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
ACL_ARGV *acl_argv_split(const char *str, const char *delim)
{
 return acl_argv_split3(str, delim, 
# 23 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
                                   ((void *)0)
# 23 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
                                       );
}
 ...
 ACL_DBUF_POOL *dbuf)
{
 ...
 char *saved_string =
  dbuf ? acl_dbuf_pool_strdup(dbuf, str) : acl_strdup_glue("/acl/lib_acl/src/stdlib/common/acl_argv_split.c", 31, (str));
 ...
 if (dbuf)
  ...
  do { if (saved_string) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_argv_split.c", 41, (saved_string)); (saved_string) = 
# 41 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
 ((void *)0)
# 41 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
 ; } } while (0);
 return argvp;
}
...
# 49 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
                                       ((void *)0)
# 49 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
                                           );
}
 ...
 size_t n, ACL_DBUF_POOL *dbuf)
{
 ...
 char *saved_string = dbuf ?
  acl_dbuf_pool_strdup(dbuf, str) : acl_strdup_glue("/acl/lib_acl/src/stdlib/common/acl_argv_split.c", 57, (str));
 char *bp = saved_string;
 char *arg;
 ...
 if (dbuf)
  ...
  do { if (saved_string) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_argv_split.c", 67, (saved_string)); (saved_string) = 
# 67 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
 ((void *)0)
# 67 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
 ; } } while (0);
 return argvp;
}
 ...
 const char *delim)
{
 char *saved_string = argvp->dbuf ?
  acl_dbuf_pool_strdup(argvp->dbuf, str) : acl_strdup_glue("/acl/lib_acl/src/stdlib/common/acl_argv_split.c", 77, (str));
 char *bp = saved_string;
 char *arg;
 ...
 if (argvp->dbuf)
  ...
  do { if (saved_string) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_argv_split.c", 87, (saved_string)); (saved_string) = 
# 87 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
 ((void *)0)
# 87 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
 ; } } while (0);
 return argvp;
}
...
{
 char *saved_string = argvp->dbuf ?
  acl_dbuf_pool_strdup(argvp->dbuf, str) : acl_strdup_glue("/acl/lib_acl/src/stdlib/common/acl_argv_split.c", 98, (str));
 char *bp = saved_string;
 char *arg;
 ...
 if (argvp->dbuf)
  ...
  do { if (saved_string) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_argv_split.c", 108, (saved_string)); (saved_string) = 
# 108 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
 ((void *)0)
# 108 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
 ; } } while (0);
 return argvp;
}
...
# 114 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
                                         ((void *)0)
# 114 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
                                             );
}
...
# 141 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
                                  ((void *)0)
# 141 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
                                      );
...
# 156 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
                               ((void *)0)
# 156 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
                                   ) {
   if ((size_t) ((buf)->vbuf.ptr - (buf)->vbuf.data) > 0) {
    acl_argv_add(argvp, ((char *) (buf)->vbuf.data), 
# 158 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
                                 ((void *)0)
# 158 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
                                     );
    { (buf)->vbuf.ptr = (buf)->vbuf.data; ((&(buf)->vbuf)->flags &= ~((1<<0) | (1<<1) | (1<<2))); };
   }
  } else {
 ...
 if ((size_t) ((buf)->vbuf.ptr - (buf)->vbuf.data) > 0)
  acl_argv_add(argvp, ((char *) (buf)->vbuf.data), 
# 170 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
                               ((void *)0)
# 170 "/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
                                   );
