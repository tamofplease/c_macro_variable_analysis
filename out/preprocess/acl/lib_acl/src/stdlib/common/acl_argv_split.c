# 1 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 2
# 21 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
ACL_ARGV *acl_argv_split(const char *str, const char *delim)
{
 return acl_argv_split3(str, delim, 
# 23 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
                                   ((void *)0)
# 23 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
                                       );
}
 ...
 ACL_DBUF_POOL *dbuf)
{
 ...
 char *saved_string =
  dbuf ? acl_dbuf_pool_strdup(dbuf, str) : acl_strdup_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c", 31, (str));
 char *bp = saved_string;
 char *arg;

 while ((arg = acl_strtok(&bp, delim)) != 0)
  acl_argv_add(argvp, arg, (char *) 0);
 acl_argv_terminate(argvp);
 if (dbuf)
  acl_dbuf_pool_free(dbuf, saved_string);
 else
  do { if (saved_string) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c", 41, (saved_string)); (saved_string) = 
# 41 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
 ((void *)0)
# 41 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
 ; } } while (0);
 return argvp;
}
...
ACL_ARGV *acl_argv_splitn(const char *str, const char *delim, size_t n)
{
 return acl_argv_splitn4(str, delim, n, 
# 49 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
                                       ((void *)0)
# 49 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
                                           );
}
 ...
 size_t n, ACL_DBUF_POOL *dbuf)
{
 ...
 char *saved_string = dbuf ?
  acl_dbuf_pool_strdup(dbuf, str) : acl_strdup_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c", 57, (str));
 char *bp = saved_string;
 char *arg;

 while (n-- > 0 && (arg = acl_strtok(&bp, delim)) != 0)
  acl_argv_add(argvp, arg, (char *) 0);
 acl_argv_terminate(argvp);
 if (dbuf)
  acl_dbuf_pool_free(dbuf, saved_string);
 else
  do { if (saved_string) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c", 67, (saved_string)); (saved_string) = 
# 67 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
 ((void *)0)
# 67 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
 ; } } while (0);
 return argvp;
}
 ...
 const char *delim)
{
 char *saved_string = argvp->dbuf ?
  acl_dbuf_pool_strdup(argvp->dbuf, str) : acl_strdup_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c", 77, (str));
 char *bp = saved_string;
 char *arg;
 ...
 if (argvp->dbuf)
  ...
  do { if (saved_string) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c", 87, (saved_string)); (saved_string) = 
# 87 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
 ((void *)0)
# 87 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
 ; } } while (0);
 return argvp;
}
...
{
 char *saved_string = argvp->dbuf ?
  acl_dbuf_pool_strdup(argvp->dbuf, str) : acl_strdup_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c", 98, (str));
 char *bp = saved_string;
 char *arg;
 ...
 if (argvp->dbuf)
  ...
  do { if (saved_string) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c", 108, (saved_string)); (saved_string) = 
# 108 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
 ((void *)0)
# 108 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
 ; } } while (0);
 return argvp;
}
...
ACL_ARGV *acl_argv_quote_split(const char *str, const char *delim)
{
 return acl_argv_quote_split4(str, delim, 
# 114 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
                                         ((void *)0)
# 114 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
                                             );
}
  ...
  if (quote) {
   if (backslash) {
    ...
    if ((size_t) ((buf)->vbuf.ptr - (buf)->vbuf.data) > 0) {
     acl_argv_add(argvp, ((char *) (buf)->vbuf.data), 
# 141 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
                                  ((void *)0)
# 141 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
                                      );
...
# 156 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
                               ((void *)0)
# 156 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
                                   ) {
   if ((size_t) ((buf)->vbuf.ptr - (buf)->vbuf.data) > 0) {
    acl_argv_add(argvp, ((char *) (buf)->vbuf.data), 
# 158 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
                                 ((void *)0)
# 158 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
                                     );
    { (buf)->vbuf.ptr = (buf)->vbuf.data; ((&(buf)->vbuf)->flags &= ~((1<<0) | (1<<1) | (1<<2))); };
   }
  } else {
 ...
 if ((size_t) ((buf)->vbuf.ptr - (buf)->vbuf.data) > 0)
  acl_argv_add(argvp, ((char *) (buf)->vbuf.data), 
# 170 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c" 3 4
                               ((void *)0)
# 170 "/workspace/acl/lib_acl/src/stdlib/common/acl_argv_split.c"
                                   );
