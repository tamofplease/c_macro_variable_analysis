# 0 "/acl/lib_acl/src/stdlib/common/acl_ypipe.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/common/acl_ypipe.c"
...
# 2 "/acl/lib_acl/src/stdlib/common/acl_ypipe.c" 2
# 13 "/acl/lib_acl/src/stdlib/common/acl_ypipe.c"
struct ACL_YPIPE {
 ACL_YQUEUE *queue;
 void **w;
 void **r;
...
ACL_YPIPE *acl_ypipe_new(void)
{
 ACL_YPIPE *self = (ACL_YPIPE *) acl_calloc_glue("/acl/lib_acl/src/stdlib/common/acl_ypipe.c", 25, 1, sizeof(ACL_YPIPE));
 void **item;
...
void acl_ypipe_free(ACL_YPIPE *self, void(*free_data_fun)(void*))
{
 ...
 do { if (self) { acl_free_glue("/acl/lib_acl/src/stdlib/common/acl_ypipe.c", 43, (self)); (self) = 
# 43 "/acl/lib_acl/src/stdlib/common/acl_ypipe.c" 3 4
((void *)0)
# 43 "/acl/lib_acl/src/stdlib/common/acl_ypipe.c"
; } } while (0);
}
...
void *acl_ypipe_read(ACL_YPIPE *self)
{
 ...
 if (!acl_ypipe_check_read(self))
  return 
# 51 "/acl/lib_acl/src/stdlib/common/acl_ypipe.c" 3 4
        ((void *)0)
# 51 "/acl/lib_acl/src/stdlib/common/acl_ypipe.c"
            ;
...
# 90 "/acl/lib_acl/src/stdlib/common/acl_ypipe.c" 3 4
                                                   ((void *)0)
# 90 "/acl/lib_acl/src/stdlib/common/acl_ypipe.c"
                                                       );
