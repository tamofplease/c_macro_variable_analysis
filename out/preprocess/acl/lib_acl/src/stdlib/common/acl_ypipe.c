# 1 "/workspace/acl/lib_acl/src/stdlib/common/acl_ypipe.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/common/acl_ypipe.c" 2
# 13 "/workspace/acl/lib_acl/src/stdlib/common/acl_ypipe.c"
struct ACL_YPIPE {
 ACL_YQUEUE *queue;
 void **w;
 void **r;
...
ACL_YPIPE *acl_ypipe_new(void)
{
 ACL_YPIPE *self = (ACL_YPIPE *) acl_calloc_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_ypipe.c", 25, 1, sizeof(ACL_YPIPE));
 void **item;
...
void acl_ypipe_free(ACL_YPIPE *self, void(*free_data_fun)(void*))
{
 ...
 do { if (self) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/common/acl_ypipe.c", 43, (self)); (self) = 
# 43 "/workspace/acl/lib_acl/src/stdlib/common/acl_ypipe.c" 3 4
((void *)0)
# 43 "/workspace/acl/lib_acl/src/stdlib/common/acl_ypipe.c"
; } } while (0);
}
...
void *acl_ypipe_read(ACL_YPIPE *self)
{
 ...
 if (!acl_ypipe_check_read(self))
  return 
# 51 "/workspace/acl/lib_acl/src/stdlib/common/acl_ypipe.c" 3 4
        ((void *)0)
# 51 "/workspace/acl/lib_acl/src/stdlib/common/acl_ypipe.c"
            ;
...
int acl_ypipe_check_read(ACL_YPIPE *self)
{
 ...
 self->r = (void **) acl_atomic_cas(self->c, front, 
# 90 "/workspace/acl/lib_acl/src/stdlib/common/acl_ypipe.c" 3 4
                                                   ((void *)0)
# 90 "/workspace/acl/lib_acl/src/stdlib/common/acl_ypipe.c"
                                                       );
