# 0 "/acl/lib_acl/src/stdlib/acl_vbuf.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/acl_vbuf.c"
...
# 2 "/acl/lib_acl/src/stdlib/acl_vbuf.c" 2
# 21 "/acl/lib_acl/src/stdlib/acl_vbuf.c"
...
{
 return acl_vstring_put_ready(bp) ? (-1) : ((bp)->ptr < (bp)->data + (bp)->len ? (int) (*(bp)->ptr++ = (ch)) : acl_vbuf_put((bp),(ch)));
}
