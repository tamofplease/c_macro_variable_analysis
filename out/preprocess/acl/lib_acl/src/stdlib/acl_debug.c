# 0 "/acl/lib_acl/src/stdlib/acl_debug.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/stdlib/acl_debug.c"
...
# 2 "/acl/lib_acl/src/stdlib/acl_debug.c" 2
# 21 "/acl/lib_acl/src/stdlib/acl_debug.c"
static int __max_sections = 1000;

static int *__debug_levels = 
# 23 "/acl/lib_acl/src/stdlib/acl_debug.c" 3 4
                            ((void *)0)
# 23 "/acl/lib_acl/src/stdlib/acl_debug.c"
                                ;

void acl_debug_end()
{
 if (__debug_levels != 
# 27 "/acl/lib_acl/src/stdlib/acl_debug.c" 3 4
                      ((void *)0)
# 27 "/acl/lib_acl/src/stdlib/acl_debug.c"
                          ) {
  do { if (__debug_levels) { acl_free_glue("/acl/lib_acl/src/stdlib/acl_debug.c", 28, (__debug_levels)); (__debug_levels) = 
# 28 "/acl/lib_acl/src/stdlib/acl_debug.c" 3 4
 ((void *)0)
# 28 "/acl/lib_acl/src/stdlib/acl_debug.c"
 ; } } while (0);
  __debug_levels = 
# 29 "/acl/lib_acl/src/stdlib/acl_debug.c" 3 4
                  ((void *)0)
# 29 "/acl/lib_acl/src/stdlib/acl_debug.c"
                      ;
 }
}
...
void acl_debug_init2(const char *str, int max_debug_level)
{
 ...
 char *buf = acl_strdup_glue("/acl/lib_acl/src/stdlib/acl_debug.c", 42, (str)), *tmp;
 ACL_ARGV *tokens;

 tmp = acl_strtrim(buf);
 if (*tmp == 0) {
  do { if (buf) { acl_free_glue("/acl/lib_acl/src/stdlib/acl_debug.c", 47, (buf)); (buf) = 
# 47 "/acl/lib_acl/src/stdlib/acl_debug.c" 3 4
 ((void *)0)
# 47 "/acl/lib_acl/src/stdlib/acl_debug.c"
 ; } } while (0);
  return;
 }
 tokens = acl_argv_split(tmp, ";,");
 do { if (buf) { acl_free_glue("/acl/lib_acl/src/stdlib/acl_debug.c", 51, (buf)); (buf) = 
# 51 "/acl/lib_acl/src/stdlib/acl_debug.c" 3 4
((void *)0)
# 51 "/acl/lib_acl/src/stdlib/acl_debug.c"
; } } while (0);

 __max_sections = max_debug_level > 100 ? max_debug_level : 100;

 if (__debug_levels)
  do { if (__debug_levels) { acl_free_glue("/acl/lib_acl/src/stdlib/acl_debug.c", 56, (__debug_levels)); (__debug_levels) = 
# 56 "/acl/lib_acl/src/stdlib/acl_debug.c" 3 4
 ((void *)0)
# 56 "/acl/lib_acl/src/stdlib/acl_debug.c"
 ; } } while (0);

 __debug_levels = (int*) acl_calloc_glue("/acl/lib_acl/src/stdlib/acl_debug.c", 58, __max_sections, sizeof(int));
...
{
 if (__debug_levels == 
# 103 "/acl/lib_acl/src/stdlib/acl_debug.c" 3 4
                      ((void *)0)
# 103 "/acl/lib_acl/src/stdlib/acl_debug.c"
                          )
  return (0);
