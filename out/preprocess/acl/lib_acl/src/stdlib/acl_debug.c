# 1 "/workspace/acl/lib_acl/src/stdlib/acl_debug.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/stdlib/acl_debug.c" 2
# 21 "/workspace/acl/lib_acl/src/stdlib/acl_debug.c"
static int __max_sections = 1000;

static int *__debug_levels = 
# 23 "/workspace/acl/lib_acl/src/stdlib/acl_debug.c" 3 4
                            ((void *)0)
# 23 "/workspace/acl/lib_acl/src/stdlib/acl_debug.c"
                                ;

void acl_debug_end()
{
 if (__debug_levels != 
# 27 "/workspace/acl/lib_acl/src/stdlib/acl_debug.c" 3 4
                      ((void *)0)
# 27 "/workspace/acl/lib_acl/src/stdlib/acl_debug.c"
                          ) {
  do { if (__debug_levels) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/acl_debug.c", 28, (__debug_levels)); (__debug_levels) = 
# 28 "/workspace/acl/lib_acl/src/stdlib/acl_debug.c" 3 4
 ((void *)0)
# 28 "/workspace/acl/lib_acl/src/stdlib/acl_debug.c"
 ; } } while (0);
  __debug_levels = 
# 29 "/workspace/acl/lib_acl/src/stdlib/acl_debug.c" 3 4
                  ((void *)0)
# 29 "/workspace/acl/lib_acl/src/stdlib/acl_debug.c"
                      ;
 }
}
...
void acl_debug_init(const char *ptr)
{
 acl_debug_init2(ptr, 1000);
}

void acl_debug_init2(const char *str, int max_debug_level)
{
 int i, level_all = -1, section, level;
 char *buf = acl_strdup_glue("/workspace/acl/lib_acl/src/stdlib/acl_debug.c", 42, (str)), *tmp;
 ACL_ARGV *tokens;

 tmp = acl_strtrim(buf);
 if (*tmp == 0) {
  do { if (buf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/acl_debug.c", 47, (buf)); (buf) = 
# 47 "/workspace/acl/lib_acl/src/stdlib/acl_debug.c" 3 4
 ((void *)0)
# 47 "/workspace/acl/lib_acl/src/stdlib/acl_debug.c"
 ; } } while (0);
  return;
 }
 tokens = acl_argv_split(tmp, ";,");
 do { if (buf) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/acl_debug.c", 51, (buf)); (buf) = 
# 51 "/workspace/acl/lib_acl/src/stdlib/acl_debug.c" 3 4
((void *)0)
# 51 "/workspace/acl/lib_acl/src/stdlib/acl_debug.c"
; } } while (0);

 __max_sections = max_debug_level > 100 ? max_debug_level : 100;

 if (__debug_levels)
  do { if (__debug_levels) { acl_free_glue("/workspace/acl/lib_acl/src/stdlib/acl_debug.c", 56, (__debug_levels)); (__debug_levels) = 
# 56 "/workspace/acl/lib_acl/src/stdlib/acl_debug.c" 3 4
 ((void *)0)
# 56 "/workspace/acl/lib_acl/src/stdlib/acl_debug.c"
 ; } } while (0);

 __debug_levels = (int*) acl_calloc_glue("/workspace/acl/lib_acl/src/stdlib/acl_debug.c", 58, __max_sections, sizeof(int));
...
{
 if (__debug_levels == 
# 103 "/workspace/acl/lib_acl/src/stdlib/acl_debug.c" 3 4
                      ((void *)0)
# 103 "/workspace/acl/lib_acl/src/stdlib/acl_debug.c"
                          )
  return (0);
