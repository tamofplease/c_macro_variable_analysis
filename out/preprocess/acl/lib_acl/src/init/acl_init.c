# 0 "/acl/lib_acl/src/init/acl_init.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/init/acl_init.c"
...
# 2 "/acl/lib_acl/src/init/acl_init.c" 2
# 26 "/acl/lib_acl/src/init/acl_init.c"
# 1 "/acl/lib_acl/src/init/init.h" 1



extern int __acl_var_use_poll;
# 27 "/acl/lib_acl/src/init/acl_init.c" 2
...
# 37 "/acl/lib_acl/src/init/acl_init.c" 3 4
                          ((void *)0)
# 37 "/acl/lib_acl/src/init/acl_init.c"
                              ;
 if (buf) {
...
# 54 "/acl/lib_acl/src/init/acl_init.c"
...
void acl_lib_init(void)
{
 ...
 signal(
# 77 "/acl/lib_acl/src/init/acl_init.c" 3 4
       13
# 77 "/acl/lib_acl/src/init/acl_init.c"
              , 
# 77 "/acl/lib_acl/src/init/acl_init.c" 3 4
                ((__sighandler_t) 1)
# 77 "/acl/lib_acl/src/init/acl_init.c"
...
# 135 "/acl/lib_acl/src/init/acl_init.c"
