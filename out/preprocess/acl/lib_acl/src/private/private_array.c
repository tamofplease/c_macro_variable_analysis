# 0 "/acl/lib_acl/src/private/private_array.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/private/private_array.c"
...
# 2 "/acl/lib_acl/src/private/private_array.c" 2
# 11 "/acl/lib_acl/src/private/private_array.c"
...
# 12 "/acl/lib_acl/src/private/private_array.c" 2
...
static void *array_iter_head(ACL_ITER *iter, struct ACL_ARRAY *a)
{
 iter->dlen = -1;
 iter->key = 
# 18 "/acl/lib_acl/src/private/private_array.c" 3 4
            ((void *)0)
# 18 "/acl/lib_acl/src/private/private_array.c"
                ;
 iter->klen = 0;
 iter->i = 0;
 iter->size = a->count;
 if (a->items == 
# 22 "/acl/lib_acl/src/private/private_array.c" 3 4
                ((void *)0)
# 22 "/acl/lib_acl/src/private/private_array.c"
                    )
...
static void *array_iter_tail(ACL_ITER *iter, struct ACL_ARRAY *a)
{
 iter->dlen = -1;
 iter->key = 
# 48 "/acl/lib_acl/src/private/private_array.c" 3 4
            ((void *)0)
# 48 "/acl/lib_acl/src/private/private_array.c"
                ;
 iter->klen = 0;
 iter->i = a->count - 1;
 iter->size = a->count;
 if (a->items == 
# 52 "/acl/lib_acl/src/private/private_array.c" 3 4
                ((void *)0)
# 52 "/acl/lib_acl/src/private/private_array.c"
                    )
  iter->ptr = iter->data = 0;
 else if (iter->i < 0)
  iter->data = iter->ptr = 0;
...
# 109 "/acl/lib_acl/src/private/private_array.c" 3 4
((void) sizeof ((
# 109 "/acl/lib_acl/src/private/private_array.c"
app_count > 0
# 109 "/acl/lib_acl/src/private/private_array.c" 3 4
...
"app_count > 0"
# 109 "/acl/lib_acl/src/private/private_array.c" 3 4
, "/acl/lib_acl/src/private/private_array.c", 109, __extension__ __PRETTY_FUNCTION__); }))
# 109 "/acl/lib_acl/src/private/private_array.c"
                         ;
...
# 119 "/acl/lib_acl/src/private/private_array.c" 3 4
((void) sizeof ((
# 119 "/acl/lib_acl/src/private/private_array.c"
a
# 119 "/acl/lib_acl/src/private/private_array.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 119 "/acl/lib_acl/src/private/private_array.c"
...
"a"
# 119 "/acl/lib_acl/src/private/private_array.c" 3 4
, "/acl/lib_acl/src/private/private_array.c", 119, __extension__ __PRETTY_FUNCTION__); }))
# 119 "/acl/lib_acl/src/private/private_array.c"
             ;
...
void private_array_clean(ACL_ARRAY *a, void (*free_fn)(void *))
{
 ...
 for (idx = 0; idx < a->count; idx++) {
  if(free_fn != 
# 138 "/acl/lib_acl/src/private/private_array.c" 3 4
               ((void *)0) 
# 138 "/acl/lib_acl/src/private/private_array.c"
                    && a->items[idx] != 
# 138 "/acl/lib_acl/src/private/private_array.c" 3 4
                                        ((void *)0)
# 138 "/acl/lib_acl/src/private/private_array.c"
   ...
   free_fn(a->items[idx]);
  a->items[idx] = 
# 140 "/acl/lib_acl/src/private/private_array.c" 3 4
                 ((void *)0)
# 140 "/acl/lib_acl/src/private/private_array.c"
                     ;
 }
 a->count = 0;
}
...
void *private_array_pop(ACL_ARRAY *a)
{
 ...
 if (a->count <= 0)
  return (
# 166 "/acl/lib_acl/src/private/private_array.c" 3 4
         ((void *)0)
# 166 "/acl/lib_acl/src/private/private_array.c"
             );
 a->count--;
 ptr = a->items[a->count];
 a->items[a->count] = 
# 169 "/acl/lib_acl/src/private/private_array.c" 3 4
                     ((void *)0)
# 169 "/acl/lib_acl/src/private/private_array.c"
                         ;
 return (ptr);
}
...
{
 if (a == 
# 175 "/acl/lib_acl/src/private/private_array.c" 3 4
         ((void *)0)
# 175 "/acl/lib_acl/src/private/private_array.c"
             )
  return (-1);
 if (idx < 0 || idx >= a->count)
  return (-1);
 if (free_fn != 
# 179 "/acl/lib_acl/src/private/private_array.c" 3 4
               ((void *)0) 
# 179 "/acl/lib_acl/src/private/private_array.c"
                    && a->items[idx] != 
# 179 "/acl/lib_acl/src/private/private_array.c" 3 4
                                        ((void *)0)
# 179 "/acl/lib_acl/src/private/private_array.c"
...
int private_array_delete_obj(ACL_ARRAY *a, void *obj, void (*free_fn)(void*))
{
 ...
 if (a == 
# 191 "/acl/lib_acl/src/private/private_array.c" 3 4
         ((void *)0) 
# 191 "/acl/lib_acl/src/private/private_array.c"
              || obj == 
# 191 "/acl/lib_acl/src/private/private_array.c" 3 4
                        ((void *)0)
# 191 "/acl/lib_acl/src/private/private_array.c"
...
void *private_array_index(const ACL_ARRAY *a, int idx)
{
 if(idx < 0 || idx > a->count - 1)
  return(
# 204 "/acl/lib_acl/src/private/private_array.c" 3 4
        ((void *)0)
# 204 "/acl/lib_acl/src/private/private_array.c"
            );
...
{
 if(a == 
# 211 "/acl/lib_acl/src/private/private_array.c" 3 4
        ((void *)0)
# 211 "/acl/lib_acl/src/private/private_array.c"
            )
  return(-1);
 return(a->count);
}
