# 1 "/workspace/acl/lib_acl/src/private/private_vstream.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/private/private_vstream.c" 2
# 39 "/workspace/acl/lib_acl/src/private/private_vstream.c"
# 1 "/workspace/acl/lib_acl/src/private/private_array.h" 1
# 9 "/workspace/acl/lib_acl/src/private/private_array.h"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_iterator.h" 1
# 10 "/workspace/acl/lib_acl/src/private/private_array.h" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_array.h" 1
# 11 "/workspace/acl/lib_acl/src/private/private_array.h" 2
...
# 57 "/workspace/acl/lib_acl/src/private/private_array.h"
...
# 40 "/workspace/acl/lib_acl/src/private/private_vstream.c" 2
# 1 "/workspace/acl/lib_acl/src/private/private_vstream.h" 1



# 1 "/workspace/acl/lib_acl/include/stdlib/acl_vstream.h" 1
# 5 "/workspace/acl/lib_acl/src/private/private_vstream.h" 2
...
ACL_VSTREAM *private_vstream_fhopen(int fh, unsigned int oflags);
ACL_VSTREAM *private_vstream_fdopen(int fd, unsigned int oflags,
...
# 41 "/workspace/acl/lib_acl/src/private/private_vstream.c" 2



static int __sys_getc(ACL_VSTREAM *stream);

static int __read_wait(int fd, int timeout)
{
 fd_set read_fds;
 fd_set except_fds;
 struct timeval tv;
...
# 57 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((1024 
# 57 "/workspace/acl/lib_acl/src/private/private_vstream.c"
> (unsigned) fd
# 57 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (1024 
# 57 "/workspace/acl/lib_acl/src/private/private_vstream.c"
> (unsigned) fd
# 57 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
) ; else __assert_fail (
# 57 "/workspace/acl/lib_acl/src/private/private_vstream.c"
"FD_SETSIZE > (unsigned) fd"
# 57 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/workspace/acl/lib_acl/src/private/private_vstream.c", 57, __extension__ __PRETTY_FUNCTION__); }))
# 57 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                      ;
# 66 "/workspace/acl/lib_acl/src/private/private_vstream.c"
 
# 66 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
...
# 67 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) (((
# 67 "/workspace/acl/lib_acl/src/private/private_vstream.c"
&read_fds
# 67 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
)->__fds_bits)[__extension__ ({ long int __d = (
# 67 "/workspace/acl/lib_acl/src/private/private_vstream.c"
fd
# 67 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
...
# 68 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((
# 68 "/workspace/acl/lib_acl/src/private/private_vstream.c"
&except_fds
# 68 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
)->__fds_bits)[0]) : "memory"); } while (0)
# 68 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
# 69 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) (((
# 69 "/workspace/acl/lib_acl/src/private/private_vstream.c"
&except_fds
# 69 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
)->__fds_bits)[__extension__ ({ long int __d = (
# 69 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
# 69 "/workspace/acl/lib_acl/src/private/private_vstream.c"
 ...
 for (;;) {
  ...
  case -1:
   if (acl_last_error() != 
# 82 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                          4
# 82 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                   )
    return -1;
   continue;
  case 0:
   acl_set_error(
# 86 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                110
# 86 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                             );
   return (-1);
  default:
   return (0);
...
{
 if (stream == 
# 96 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
              ((void *)0)
# 96 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                  )
  return (-1);

 if (stream->type == (1 << 1)) {
  if (((stream)->fd.h_file) == (int) -1)
   return (-1);
 } else if (((stream)->fd.sock) == (int) -1)
  return (-1);

AGAIN:
 if (stream->rw_timeout > 0 && __read_wait(((stream)->fd.sock),
  stream->rw_timeout) < 0)
 {
  stream->errnum = acl_last_error();

  if (stream->errnum != 
# 111 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                       110
# 111 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                    ) {
   stream->flag |= (1 << 10);
  } else {
   stream->flag |= (1 << 12);
 ...
 if (stream->type == (1 << 1)) {
  stream->read_cnt = stream->fread_fn(((stream)->fd.h_file),
  ...
  stream->read_cnt = stream->read_fn(((stream)->fd.sock),
   stream->read_buf, (size_t) stream->read_buf_len,
   stream->rw_timeout, stream, stream->context);
 if (stream->read_cnt < 0) {
  stream->errnum = acl_last_error();
  if (stream->errnum == 
# 134 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                       4
# 134 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                ) {
   goto AGAIN;
  } else if (stream->errnum == 
# 136 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                              110
# 136 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                           ) {
   stream->flag |= (1 << 12);
  } else if (stream->errnum != 
# 138 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                              11
   
# 139 "/workspace/acl/lib_acl/src/private/private_vstream.c"
  && stream->errnum != 
# 139 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                       11
# 139 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                 )
  {
...
static int __sys_getc(ACL_VSTREAM *stream)
{
 ...
 if (stream->read_cnt <= 0)
  ...
  return (( (stream)->read_cnt > 0 ? (stream)->read_cnt--, (stream)->offset++, *(stream)->read_ptr++: (stream)->sys_getc((stream))));
}

int private_vstream_getc(ACL_VSTREAM *stream)
{
 if (stream == 
# 173 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
              ((void *)0)
# 173 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                  )
  return ((-1));
 if (stream->read_cnt <= 0) {
...
# 199 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 199 "/workspace/acl/lib_acl/src/private/private_vstream.c"
stream && vptr && maxlen > 0
# 199 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
...
"stream && vptr && maxlen > 0"
# 199 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/workspace/acl/lib_acl/src/private/private_vstream.c", 199, __extension__ __PRETTY_FUNCTION__); }))
# 199 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                        ;


 
# 202 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 202 "/workspace/acl/lib_acl/src/private/private_vstream.c"
stream->read_cnt >= 0
# 202 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 202 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
"stream->read_cnt >= 0"
# 202 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/workspace/acl/lib_acl/src/private/private_vstream.c", 202, __extension__ __PRETTY_FUNCTION__); }))
# 202 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                 ;
...
int private_vstream_gets(ACL_VSTREAM *stream, void *vptr, size_t maxlen)
{
 ...
 if (stream == 
# 233 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
              ((void *)0) 
# 233 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                   || vptr == 
# 233 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                              ((void *)0) 
# 233 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
int private_vstream_gets_nonl(ACL_VSTREAM *stream, void *vptr, size_t maxlen)
{
 ...
 if (stream == 
# 263 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
              ((void *)0) 
# 263 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                   || vptr == 
# 263 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                              ((void *)0) 
# 263 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
int private_vstream_readn(ACL_VSTREAM *stream, void *vptr, size_t maxlen)
{
 ...
 if (stream == 
# 303 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
              ((void *)0) 
# 303 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                   || vptr == 
# 303 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                              ((void *)0) 
# 303 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
int private_vstream_read(ACL_VSTREAM *stream, void *vptr, size_t maxlen)
{
 ...
 if (stream == 
# 333 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
              ((void *)0) 
# 333 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                   || vptr == 
# 333 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                              ((void *)0) 
# 333 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
# 336 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 336 "/workspace/acl/lib_acl/src/private/private_vstream.c"
stream->read_cnt >= 0
# 336 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 336 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
"stream->read_cnt >= 0"
# 336 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/workspace/acl/lib_acl/src/private/private_vstream.c", 336, __extension__ __PRETTY_FUNCTION__); }))
# 336 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                 ;
 ptr = (unsigned char *) vptr;
 if (stream->read_cnt > 0) {
...
# 360 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 360 "/workspace/acl/lib_acl/src/private/private_vstream.c"
stream && vptr && dlen > 0
# 360 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 360 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
"stream && vptr && dlen > 0"
# 360 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/workspace/acl/lib_acl/src/private/private_vstream.c", 360, __extension__ __PRETTY_FUNCTION__); }))
# 360 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                      ;
...
TAG_AGAIN:
 ...
 if (stream->type == (1 << 1)) {
  if ((stream->oflags & 
# 371 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                       02000
# 371 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                               )) {
  ...
  } else if ((stream->flag & (1 << 3))
   && stream->offset != stream->sys_offset)
  {
   stream->sys_offset = acl_lseek(((stream)->fd.h_file),
    stream->offset, 
# 382 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                   0
# 382 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                           );
  ...
  n = stream->fwrite_fn(((stream)->fd.h_file), vptr, dlen,
   stream->rw_timeout, stream, stream->context);
  if (n > 0) {
   stream->sys_offset += n;
   stream->offset = stream->sys_offset;
  ...
  n = stream->write_fn(((stream)->fd.sock), vptr, dlen,
   stream->rw_timeout, stream, stream->context);
 if (n < 0) {
  if (acl_last_error() == 
# 400 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                         4
# 400 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                  ) {
   if (++neintr >= 5)
    return ((-1));
  ...
  if (acl_last_error() == 
# 407 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                         11
   
# 408 "/workspace/acl/lib_acl/src/private/private_vstream.c"
  || acl_last_error() == 
# 408 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                         11
# 408 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                        )
  {
   acl_set_error(
# 410 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                11
# 410 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                          );
  }
...
static int __loop_writen(ACL_VSTREAM *stream, const void *vptr, ssize_t dlen)
{
 ...
 while (dlen > 0) {
  ...
  if (n <= 0) {
   if (acl_last_error() == 
# 429 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                          4
    
# 430 "/workspace/acl/lib_acl/src/private/private_vstream.c"
   || acl_last_error() == 
# 430 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                          11
# 430 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                    )
   {
...
# 437 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
 ((void) sizeof ((
# 437 "/workspace/acl/lib_acl/src/private/private_vstream.c"
 n <= dlen
# 437 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 437 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
# 437 "/workspace/acl/lib_acl/src/private/private_vstream.c"
 "n <= dlen"
# 437 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
 , "/workspace/acl/lib_acl/src/private/private_vstream.c", 437, __extension__ __PRETTY_FUNCTION__); }))
# 437 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                  ;
...
# 448 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 448 "/workspace/acl/lib_acl/src/private/private_vstream.c"
stream && vptr && dlen > 0
# 448 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 448 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
"stream && vptr && dlen > 0"
# 448 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/workspace/acl/lib_acl/src/private/private_vstream.c", 448, __extension__ __PRETTY_FUNCTION__); }))
# 448 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                      ;

 if (stream->wbuf_dlen > 0) {
  if (private_vstream_fflush(stream) == (-1))
   return ((-1));
 }
...
# 465 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 465 "/workspace/acl/lib_acl/src/private/private_vstream.c"
stream && vptr && dlen > 0
# 465 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 465 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
"stream && vptr && dlen > 0"
# 465 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/workspace/acl/lib_acl/src/private/private_vstream.c", 465, __extension__ __PRETTY_FUNCTION__); }))
# 465 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                      ;

 if (stream->wbuf == 
# 467 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                    ((void *)0)
# 467 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                        ) {
 ...
 if (dlen >= (size_t) stream->wbuf_size) {
  if (private_vstream_fflush(stream) == (-1))
   return ((-1));
  else if (__loop_writen(stream, vptr, dlen) == (-1))
   return ((-1));
  else
   return (int) (dlen);
...
# 496 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 496 "/workspace/acl/lib_acl/src/private/private_vstream.c"
stream
# 496 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 496 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
"stream"
# 496 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/workspace/acl/lib_acl/src/private/private_vstream.c", 496, __extension__ __PRETTY_FUNCTION__); }))
# 496 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                  ;
 if (stream->wbuf == 
# 497 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                    ((void *)0) 
# 497 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                         || stream->wbuf_dlen == 0)
  return 0;
 ...
 while (stream->wbuf_dlen > 0) {
  ...
  if (n <= 0) {
   if (acl_last_error() == 
# 504 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                          4
       
# 505 "/workspace/acl/lib_acl/src/private/private_vstream.c"
      || acl_last_error() == 
# 505 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                             11
# 505 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                       ) {
    continue;
...
# 515 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 515 "/workspace/acl/lib_acl/src/private/private_vstream.c"
stream->wbuf_dlen >= 0
# 515 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 515 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
"stream->wbuf_dlen >= 0"
# 515 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/workspace/acl/lib_acl/src/private/private_vstream.c", 515, __extension__ __PRETTY_FUNCTION__); }))
# 515 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                  ;
...
# 524 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 524 "/workspace/acl/lib_acl/src/private/private_vstream.c"
fh != (int) -1
# 524 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 524 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
"fh != ACL_FILE_INVALID"
# 524 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/workspace/acl/lib_acl/src/private/private_vstream.c", 524, __extension__ __PRETTY_FUNCTION__); }))
# 524 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                  ;

 fp = private_vstream_fdopen((int) -1, oflags,
  4096, 0, (1 << 1));
 if (fp == 
# 528 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
          ((void *)0)
# 528 "/workspace/acl/lib_acl/src/private/private_vstream.c"
              )
  return (
# 529 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
         ((void *)0)
# 529 "/workspace/acl/lib_acl/src/private/private_vstream.c"
             );
...
{
 ACL_VSTREAM *stream = 
# 543 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                      ((void *)0)
# 543 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                          ;

 stream = (ACL_VSTREAM *) calloc(1, sizeof(ACL_VSTREAM));
 
# 546 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 546 "/workspace/acl/lib_acl/src/private/private_vstream.c"
stream
# 546 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 546 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
"stream"
# 546 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/workspace/acl/lib_acl/src/private/private_vstream.c", 546, __extension__ __PRETTY_FUNCTION__); }))
# 546 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                  ;
 ...
 if ((fdtype & (1 << 3))
  ...
  fdtype |= (1 << 2);
  stream->read_buf = 
# 556 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                    ((void *)0)
# 556 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                        ;
 }

 stream->read_buf = (unsigned char *) malloc(buflen + 1);
 
# 560 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 560 "/workspace/acl/lib_acl/src/private/private_vstream.c"
stream->read_buf
# 560 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 560 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
"stream->read_buf"
# 560 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/workspace/acl/lib_acl/src/private/private_vstream.c", 560, __extension__ __PRETTY_FUNCTION__); }))
# 560 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                            ;
 ...
 stream->addr_peer = 
# 593 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                     ((void *)0)
# 593 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                         ;
 stream->addr_local = 
# 594 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                     ((void *)0)
# 594 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                         ;
 stream->path = 
# 595 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                     ((void *)0)
# 595 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                         ;

 stream->close_handle_lnk = private_array_create(5);
 
# 598 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 598 "/workspace/acl/lib_acl/src/private/private_vstream.c"
stream->close_handle_lnk
# 598 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 598 "/workspace/acl/lib_acl/src/private/private_vstream.c"
stream->close_handle_lnk
...
"stream->close_handle_lnk"
# 598 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/workspace/acl/lib_acl/src/private/private_vstream.c", 598, __extension__ __PRETTY_FUNCTION__); }))
# 598 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                    ;
 ...
 int mode, size_t buflen)
{
 ...
 oflags |= 
# 611 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
          0
# 611 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                     ;
 ...
 if (fh == (int) -1)
  return (
# 621 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
         ((void *)0)
# 621 "/workspace/acl/lib_acl/src/private/private_vstream.c"
             );

 fp = private_vstream_fdopen((int) -1,
  oflags, buflen, 0, (1 << 1));
 if (fp == 
# 625 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
          ((void *)0)
# 625 "/workspace/acl/lib_acl/src/private/private_vstream.c"
              )
  return (
# 626 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
         ((void *)0)
# 626 "/workspace/acl/lib_acl/src/private/private_vstream.c"
             );

 fp->fd.h_file = fh;
 snprintf(fp->addr_peer, 256, "%s", path);
 return (fp);
}
...
# 639 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
__builtin_va_start(
# 639 "/workspace/acl/lib_acl/src/private/private_vstream.c"
ap
# 639 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
,
# 639 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
# 639 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                  ;
 for (; name != 0; name = 
# 640 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                                           __builtin_va_arg(
# 640 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                           ap
# 640 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                                           ,
# 640 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
# 640 "/workspace/acl/lib_acl/src/private/private_vstream.c"
  ...
  case 1:
   stream->read_fn = 
# 643 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                    __builtin_va_arg(
# 643 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                    ap
# 643 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                    ,
# 643 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
# 643 "/workspace/acl/lib_acl/src/private/private_vstream.c"
  ...
  case 2:
   stream->write_fn = 
# 646 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                     __builtin_va_arg(
# 646 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                     ap
# 646 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                     ,
# 646 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
# 646 "/workspace/acl/lib_acl/src/private/private_vstream.c"
  ...
  case 6:
   stream->context = 
# 649 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                    __builtin_va_arg(
# 649 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                    ap
# 649 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                    ,
# 649 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
# 649 "/workspace/acl/lib_acl/src/private/private_vstream.c"
  ...
  case 3:
   ptr = 
# 652 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
        __builtin_va_arg(
# 652 "/workspace/acl/lib_acl/src/private/private_vstream.c"
        ap
# 652 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
        ,
# 652 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
# 652 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                         ;
   snprintf(stream->addr_peer, 256, "%s", ptr);
   break;
  case 4:
   ((stream)->fd.sock) = 
# 656 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                             __builtin_va_arg(
# 656 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                             ap
# 656 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                             ,
# 656 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
# 656 "/workspace/acl/lib_acl/src/private/private_vstream.c"
  ...
  case 5:
   stream->rw_timeout = 
# 659 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                       __builtin_va_arg(
# 659 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                       ap
# 659 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                       ,
# 659 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
# 659 "/workspace/acl/lib_acl/src/private/private_vstream.c"
  ...
  case 7:
   n = 
# 662 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
      __builtin_va_arg(
# 662 "/workspace/acl/lib_acl/src/private/private_vstream.c"
      ap
# 662 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
      ,
# 662 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
# 670 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
  ((void) sizeof ((
# 670 "/workspace/acl/lib_acl/src/private/private_vstream.c"
  0
# 670 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
  ) ? 1 : 0), __extension__ ({ if (
# 670 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
# 670 "/workspace/acl/lib_acl/src/private/private_vstream.c"
  "0"
# 670 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
  , "/workspace/acl/lib_acl/src/private/private_vstream.c", 670, __extension__ __PRETTY_FUNCTION__); }))
# 670 "/workspace/acl/lib_acl/src/private/private_vstream.c"
               ;
   break;
  }
...
# 674 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
__builtin_va_end(
# 674 "/workspace/acl/lib_acl/src/private/private_vstream.c"
ap
# 674 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
)
# 674 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
{
 return (private_vstream_connect_ex(addr, 0,
   conn_timeout, rw_timeout, 8192, 
# 681 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                                  ((void *)0)
# 681 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                      ));
}
...
# 691 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 691 "/workspace/acl/lib_acl/src/private/private_vstream.c"
addr && *addr
# 691 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 691 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
"addr && *addr"
# 691 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/workspace/acl/lib_acl/src/private/private_vstream.c", 691, __extension__ __PRETTY_FUNCTION__); }))
# 691 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                         ;
 ptr = strchr(addr, ':');
 if (ptr)
  fd = acl_inet_connect_ex(addr, 0,
 ...
 if (fd == (int) -1)
  return (
# 708 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
         ((void *)0)
# 708 "/workspace/acl/lib_acl/src/private/private_vstream.c"
             );
 stream = private_vstream_fdopen(fd, (1 << 2), rw_bufsize,
   rw_timeout, (1 << 0));
 
# 711 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 711 "/workspace/acl/lib_acl/src/private/private_vstream.c"
stream
# 711 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 711 "/workspace/acl/lib_acl/src/private/private_vstream.c"
...
"stream"
# 711 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/workspace/acl/lib_acl/src/private/private_vstream.c", 711, __extension__ __PRETTY_FUNCTION__); }))
# 711 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                  ;

 if (stream->addr_peer == 
# 713 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                         ((void *)0)
# 713 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                             )
  stream->addr_peer = malloc(256);
 if (acl_getpeername(((stream)->fd.sock), stream->addr_peer,
  256) < 0)
 {
  snprintf(stream->addr_peer, 256, "%s", addr);
 }
...
void private_vstream_free(ACL_VSTREAM *stream)
{
 ...
 if (stream->close_handle_lnk != 
# 732 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                                ((void *)0)
# 732 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                    ) {
  ...
  for (i = n - 1; i >= 0; i++) {
   ...
   if (close_handle == 
# 743 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                      ((void *)0)
# 743 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                          )
    break;
   if (close_handle->close_fn == 
# 745 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                                ((void *)0)
# 745 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                    )
    continue;
   ...
   private_array_delete(stream->close_handle_lnk, i, 
# 751 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                                                    ((void *)0)
# 751 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                                        );
   close_handle->close_fn(stream, close_handle->context);
   free(close_handle);
  }
  private_array_destroy(stream->close_handle_lnk, 
# 755 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                                                 ((void *)0)
# 755 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                                     );
 }

 if (stream->read_buf != 
# 758 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                        ((void *)0)
# 758 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                            )
  free(stream->read_buf);

 ((stream)->fd.sock) = (int) -1;
 ((stream)->fd.h_file) = (int) -1;
 if (stream->addr_peer)
...
int private_vstream_close(ACL_VSTREAM *stream)
{
 ...
 if (stream->close_handle_lnk != 
# 783 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                                ((void *)0)
# 783 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                    ) {
  ACL_VSTREAM_CLOSE_HANDLE *close_handle;
  int i, n = private_array_size(stream->close_handle_lnk);
  ...
  for (i = n - 1; i >= 0; i--) {
   close_handle = (ACL_VSTREAM_CLOSE_HANDLE *)
    private_array_index(stream->close_handle_lnk, i);
   if (close_handle == 
# 794 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                      ((void *)0)
# 794 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                          )
    continue;
   if (close_handle->close_fn == 
# 796 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                                ((void *)0)
# 796 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                    )
    continue;
   ...
   private_array_delete(stream->close_handle_lnk, i, 
# 802 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                                                    ((void *)0)
# 802 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                                        );
   close_handle->close_fn(stream, close_handle->context);
   free(close_handle);
  }
  private_array_destroy(stream->close_handle_lnk, 
# 806 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                                                 ((void *)0)
# 806 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                                                     );
 }

 if (((stream)->fd.sock) != (int) -1 && stream->close_fn)
  ret = stream->close_fn(((stream)->fd.sock));
 else if (((stream)->fd.h_file) != (int) -1 && stream->fclose_fn)
  ret = stream->fclose_fn(((stream)->fd.h_file));
 if (stream->read_buf != 
# 813 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                        ((void *)0)
# 813 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                            )
  free(stream->read_buf);
 if (stream->wbuf != 
# 815 "/workspace/acl/lib_acl/src/private/private_vstream.c" 3 4
                    ((void *)0)
# 815 "/workspace/acl/lib_acl/src/private/private_vstream.c"
                        )
  free(stream->wbuf);
 if (stream->addr_peer)
  free(stream->addr_peer);
