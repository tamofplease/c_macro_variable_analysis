# 0 "/acl/lib_acl/src/private/private_vstream.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/private/private_vstream.c"
...
# 2 "/acl/lib_acl/src/private/private_vstream.c" 2
# 39 "/acl/lib_acl/src/private/private_vstream.c"
# 1 "/acl/lib_acl/src/private/private_array.h" 1
# 9 "/acl/lib_acl/src/private/private_array.h"
# 1 "/acl/lib_acl/include/stdlib/acl_iterator.h" 1
# 10 "/acl/lib_acl/src/private/private_array.h" 2
# 1 "/acl/lib_acl/include/stdlib/acl_array.h" 1
# 11 "/acl/lib_acl/src/private/private_array.h" 2
...
# 57 "/acl/lib_acl/src/private/private_array.h"
...
# 40 "/acl/lib_acl/src/private/private_vstream.c" 2
# 1 "/acl/lib_acl/src/private/private_vstream.h" 1



# 1 "/acl/lib_acl/include/stdlib/acl_vstream.h" 1
# 5 "/acl/lib_acl/src/private/private_vstream.h" 2
...
# 41 "/acl/lib_acl/src/private/private_vstream.c" 2
...
# 57 "/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((1024 
# 57 "/acl/lib_acl/src/private/private_vstream.c"
> (unsigned) fd
# 57 "/acl/lib_acl/src/private/private_vstream.c" 3 4
...
# 57 "/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/acl/lib_acl/src/private/private_vstream.c", 57, __extension__ __PRETTY_FUNCTION__); }))
# 57 "/acl/lib_acl/src/private/private_vstream.c"
                                      ;
# 66 "/acl/lib_acl/src/private/private_vstream.c"
 
# 66 "/acl/lib_acl/src/private/private_vstream.c" 3 4
...
# 67 "/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) (((
# 67 "/acl/lib_acl/src/private/private_vstream.c"
&read_fds
# 67 "/acl/lib_acl/src/private/private_vstream.c" 3 4
...
# 68 "/acl/lib_acl/src/private/private_vstream.c" 3 4
do { unsigned int __i; fd_set *__arr = (
# 68 "/acl/lib_acl/src/private/private_vstream.c"
&except_fds
# 68 "/acl/lib_acl/src/private/private_vstream.c" 3 4
); for (__i = 0; __i < sizeof (fd_set) / sizeof (__fd_mask); ++__i) ((__arr)->__fds_bits)[__i] = 0; } while (0)
# 68 "/acl/lib_acl/src/private/private_vstream.c"
...
# 69 "/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) (((
# 69 "/acl/lib_acl/src/private/private_vstream.c"
&except_fds
# 69 "/acl/lib_acl/src/private/private_vstream.c" 3 4
)->__fds_bits)[__extension__ ({ long int __d = (
# 69 "/acl/lib_acl/src/private/private_vstream.c"
...
# 69 "/acl/lib_acl/src/private/private_vstream.c"
 ...
 for (;;) {
  ...
  case -1:
   if (acl_last_error() != 
# 82 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                          4
# 82 "/acl/lib_acl/src/private/private_vstream.c"
                                   )
    return -1;
   continue;
  case 0:
   acl_set_error(
# 86 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                110
# 86 "/acl/lib_acl/src/private/private_vstream.c"
                             );
   return (-1);
  default:
   return (0);
...
{
 if (stream == 
# 96 "/acl/lib_acl/src/private/private_vstream.c" 3 4
              ((void *)0)
# 96 "/acl/lib_acl/src/private/private_vstream.c"
                  )
  return (-1);
...
AGAIN:
  ...
  stream->rw_timeout) < 0)
 {
  ...
  if (stream->errnum != 
# 111 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                       110
# 111 "/acl/lib_acl/src/private/private_vstream.c"
                                    ) {
   stream->flag |= (1 << 10);
  } else {
   stream->flag |= (1 << 12);
 ...
 if (stream->read_cnt < 0) {
  stream->errnum = acl_last_error();
  if (stream->errnum == 
# 134 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                       4
# 134 "/acl/lib_acl/src/private/private_vstream.c"
                                ) {
   goto AGAIN;
  } else if (stream->errnum == 
# 136 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                              110
# 136 "/acl/lib_acl/src/private/private_vstream.c"
                                           ) {
   stream->flag |= (1 << 12);
  } else if (stream->errnum != 
# 138 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                              11
   
# 139 "/acl/lib_acl/src/private/private_vstream.c"
  && stream->errnum != 
# 139 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                       11
# 139 "/acl/lib_acl/src/private/private_vstream.c"
                                 )
  {
...
{
 if (stream == 
# 173 "/acl/lib_acl/src/private/private_vstream.c" 3 4
              ((void *)0)
# 173 "/acl/lib_acl/src/private/private_vstream.c"
                  )
  return ((-1));
 if (stream->read_cnt <= 0) {
...
# 199 "/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 199 "/acl/lib_acl/src/private/private_vstream.c"
...
"stream && vptr && maxlen > 0"
# 199 "/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/acl/lib_acl/src/private/private_vstream.c", 199, __extension__ __PRETTY_FUNCTION__); }))
# 199 "/acl/lib_acl/src/private/private_vstream.c"
                                        ;


 
# 202 "/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 202 "/acl/lib_acl/src/private/private_vstream.c"
stream->read_cnt >= 0
# 202 "/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 202 "/acl/lib_acl/src/private/private_vstream.c"
...
"stream->read_cnt >= 0"
# 202 "/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/acl/lib_acl/src/private/private_vstream.c", 202, __extension__ __PRETTY_FUNCTION__); }))
# 202 "/acl/lib_acl/src/private/private_vstream.c"
                                 ;
...
int private_vstream_gets(ACL_VSTREAM *stream, void *vptr, size_t maxlen)
{
 ...
 if (stream == 
# 233 "/acl/lib_acl/src/private/private_vstream.c" 3 4
              ((void *)0) 
# 233 "/acl/lib_acl/src/private/private_vstream.c"
                   || vptr == 
# 233 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                              ((void *)0) 
# 233 "/acl/lib_acl/src/private/private_vstream.c"
...
int private_vstream_gets_nonl(ACL_VSTREAM *stream, void *vptr, size_t maxlen)
{
 ...
 if (stream == 
# 263 "/acl/lib_acl/src/private/private_vstream.c" 3 4
              ((void *)0) 
# 263 "/acl/lib_acl/src/private/private_vstream.c"
                   || vptr == 
# 263 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                              ((void *)0) 
# 263 "/acl/lib_acl/src/private/private_vstream.c"
...
int private_vstream_readn(ACL_VSTREAM *stream, void *vptr, size_t maxlen)
{
 ...
 if (stream == 
# 303 "/acl/lib_acl/src/private/private_vstream.c" 3 4
              ((void *)0) 
# 303 "/acl/lib_acl/src/private/private_vstream.c"
                   || vptr == 
# 303 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                              ((void *)0) 
# 303 "/acl/lib_acl/src/private/private_vstream.c"
...
int private_vstream_read(ACL_VSTREAM *stream, void *vptr, size_t maxlen)
{
 ...
 if (stream == 
# 333 "/acl/lib_acl/src/private/private_vstream.c" 3 4
              ((void *)0) 
# 333 "/acl/lib_acl/src/private/private_vstream.c"
                   || vptr == 
# 333 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                              ((void *)0) 
# 333 "/acl/lib_acl/src/private/private_vstream.c"
...
# 336 "/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 336 "/acl/lib_acl/src/private/private_vstream.c"
stream->read_cnt >= 0
# 336 "/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 336 "/acl/lib_acl/src/private/private_vstream.c"
...
"stream->read_cnt >= 0"
# 336 "/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/acl/lib_acl/src/private/private_vstream.c", 336, __extension__ __PRETTY_FUNCTION__); }))
# 336 "/acl/lib_acl/src/private/private_vstream.c"
                                 ;
 ptr = (unsigned char *) vptr;
 if (stream->read_cnt > 0) {
...
# 360 "/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 360 "/acl/lib_acl/src/private/private_vstream.c"
stream && vptr && dlen > 0
# 360 "/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 360 "/acl/lib_acl/src/private/private_vstream.c"
...
"stream && vptr && dlen > 0"
# 360 "/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/acl/lib_acl/src/private/private_vstream.c", 360, __extension__ __PRETTY_FUNCTION__); }))
# 360 "/acl/lib_acl/src/private/private_vstream.c"
                                      ;
...
TAG_AGAIN:
 ...
 if (stream->type == (1 << 1)) {
  if ((stream->oflags & 
# 371 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                       02000
# 371 "/acl/lib_acl/src/private/private_vstream.c"
                               )) {
   ...
   && stream->offset != stream->sys_offset)
  {
   stream->sys_offset = acl_lseek(((stream)->fd.h_file),
    stream->offset, 
# 382 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                   0
# 382 "/acl/lib_acl/src/private/private_vstream.c"
                           );
 ...
 if (n < 0) {
  if (acl_last_error() == 
# 400 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                         4
# 400 "/acl/lib_acl/src/private/private_vstream.c"
                                  ) {
   if (++neintr >= 5)
    return ((-1));
  ...
  if (acl_last_error() == 
# 407 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                         11
   
# 408 "/acl/lib_acl/src/private/private_vstream.c"
  || acl_last_error() == 
# 408 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                         11
# 408 "/acl/lib_acl/src/private/private_vstream.c"
                                        )
  {
   acl_set_error(
# 410 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                11
# 410 "/acl/lib_acl/src/private/private_vstream.c"
                          );
  }
...
static int __loop_writen(ACL_VSTREAM *stream, const void *vptr, ssize_t dlen)
{
 ...
 while (dlen > 0) {
  ...
  if (n <= 0) {
   if (acl_last_error() == 
# 429 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                          4
    
# 430 "/acl/lib_acl/src/private/private_vstream.c"
   || acl_last_error() == 
# 430 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                          11
# 430 "/acl/lib_acl/src/private/private_vstream.c"
                                    )
   {
...
# 437 "/acl/lib_acl/src/private/private_vstream.c" 3 4
 ((void) sizeof ((
# 437 "/acl/lib_acl/src/private/private_vstream.c"
 n <= dlen
# 437 "/acl/lib_acl/src/private/private_vstream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 437 "/acl/lib_acl/src/private/private_vstream.c"
...
# 437 "/acl/lib_acl/src/private/private_vstream.c"
 "n <= dlen"
# 437 "/acl/lib_acl/src/private/private_vstream.c" 3 4
 , "/acl/lib_acl/src/private/private_vstream.c", 437, __extension__ __PRETTY_FUNCTION__); }))
# 437 "/acl/lib_acl/src/private/private_vstream.c"
                  ;
...
# 448 "/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 448 "/acl/lib_acl/src/private/private_vstream.c"
stream && vptr && dlen > 0
# 448 "/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 448 "/acl/lib_acl/src/private/private_vstream.c"
...
"stream && vptr && dlen > 0"
# 448 "/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/acl/lib_acl/src/private/private_vstream.c", 448, __extension__ __PRETTY_FUNCTION__); }))
# 448 "/acl/lib_acl/src/private/private_vstream.c"
                                      ;
...
# 465 "/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 465 "/acl/lib_acl/src/private/private_vstream.c"
stream && vptr && dlen > 0
# 465 "/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 465 "/acl/lib_acl/src/private/private_vstream.c"
...
"stream && vptr && dlen > 0"
# 465 "/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/acl/lib_acl/src/private/private_vstream.c", 465, __extension__ __PRETTY_FUNCTION__); }))
# 465 "/acl/lib_acl/src/private/private_vstream.c"
                                      ;

 if (stream->wbuf == 
# 467 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                    ((void *)0)
# 467 "/acl/lib_acl/src/private/private_vstream.c"
                        ) {
...
# 496 "/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 496 "/acl/lib_acl/src/private/private_vstream.c"
stream
# 496 "/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 496 "/acl/lib_acl/src/private/private_vstream.c"
...
"stream"
# 496 "/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/acl/lib_acl/src/private/private_vstream.c", 496, __extension__ __PRETTY_FUNCTION__); }))
# 496 "/acl/lib_acl/src/private/private_vstream.c"
                  ;
 if (stream->wbuf == 
# 497 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                    ((void *)0) 
# 497 "/acl/lib_acl/src/private/private_vstream.c"
                         || stream->wbuf_dlen == 0)
  return 0;
 ...
 while (stream->wbuf_dlen > 0) {
  ...
  if (n <= 0) {
   if (acl_last_error() == 
# 504 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                          4
       
# 505 "/acl/lib_acl/src/private/private_vstream.c"
      || acl_last_error() == 
# 505 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                             11
# 505 "/acl/lib_acl/src/private/private_vstream.c"
                                       ) {
    continue;
...
# 515 "/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 515 "/acl/lib_acl/src/private/private_vstream.c"
stream->wbuf_dlen >= 0
# 515 "/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 515 "/acl/lib_acl/src/private/private_vstream.c"
...
"stream->wbuf_dlen >= 0"
# 515 "/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/acl/lib_acl/src/private/private_vstream.c", 515, __extension__ __PRETTY_FUNCTION__); }))
# 515 "/acl/lib_acl/src/private/private_vstream.c"
                                  ;
...
# 524 "/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 524 "/acl/lib_acl/src/private/private_vstream.c"
fh != (int) -1
# 524 "/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 524 "/acl/lib_acl/src/private/private_vstream.c"
...
"fh != ACL_FILE_INVALID"
# 524 "/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/acl/lib_acl/src/private/private_vstream.c", 524, __extension__ __PRETTY_FUNCTION__); }))
# 524 "/acl/lib_acl/src/private/private_vstream.c"
                                  ;
 ...
 fp = private_vstream_fdopen((int) -1, oflags,
  4096, 0, (1 << 1));
 if (fp == 
# 528 "/acl/lib_acl/src/private/private_vstream.c" 3 4
          ((void *)0)
# 528 "/acl/lib_acl/src/private/private_vstream.c"
              )
  return (
# 529 "/acl/lib_acl/src/private/private_vstream.c" 3 4
         ((void *)0)
# 529 "/acl/lib_acl/src/private/private_vstream.c"
             );
...
{
 ACL_VSTREAM *stream = 
# 543 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                      ((void *)0)
# 543 "/acl/lib_acl/src/private/private_vstream.c"
                          ;

 stream = (ACL_VSTREAM *) calloc(1, sizeof(ACL_VSTREAM));
 
# 546 "/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 546 "/acl/lib_acl/src/private/private_vstream.c"
stream
# 546 "/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 546 "/acl/lib_acl/src/private/private_vstream.c"
...
"stream"
# 546 "/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/acl/lib_acl/src/private/private_vstream.c", 546, __extension__ __PRETTY_FUNCTION__); }))
# 546 "/acl/lib_acl/src/private/private_vstream.c"
                  ;
 ...
 if ((fdtype & (1 << 3))
  ...
  fdtype |= (1 << 2);
  stream->read_buf = 
# 556 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                    ((void *)0)
# 556 "/acl/lib_acl/src/private/private_vstream.c"
                        ;
 }

 stream->read_buf = (unsigned char *) malloc(buflen + 1);
 
# 560 "/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 560 "/acl/lib_acl/src/private/private_vstream.c"
stream->read_buf
# 560 "/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 560 "/acl/lib_acl/src/private/private_vstream.c"
...
"stream->read_buf"
# 560 "/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/acl/lib_acl/src/private/private_vstream.c", 560, __extension__ __PRETTY_FUNCTION__); }))
# 560 "/acl/lib_acl/src/private/private_vstream.c"
                            ;
 ...
 stream->addr_peer = 
# 593 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                     ((void *)0)
# 593 "/acl/lib_acl/src/private/private_vstream.c"
                         ;
 stream->addr_local = 
# 594 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                     ((void *)0)
# 594 "/acl/lib_acl/src/private/private_vstream.c"
                         ;
 stream->path = 
# 595 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                     ((void *)0)
# 595 "/acl/lib_acl/src/private/private_vstream.c"
                         ;

 stream->close_handle_lnk = private_array_create(5);
 
# 598 "/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 598 "/acl/lib_acl/src/private/private_vstream.c"
...
"stream->close_handle_lnk"
# 598 "/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/acl/lib_acl/src/private/private_vstream.c", 598, __extension__ __PRETTY_FUNCTION__); }))
# 598 "/acl/lib_acl/src/private/private_vstream.c"
                                    ;
 ...
 int mode, size_t buflen)
{
 ...
 oflags |= 
# 611 "/acl/lib_acl/src/private/private_vstream.c" 3 4
          0
# 611 "/acl/lib_acl/src/private/private_vstream.c"
                     ;
 ...
 if (fh == (int) -1)
  return (
# 621 "/acl/lib_acl/src/private/private_vstream.c" 3 4
         ((void *)0)
# 621 "/acl/lib_acl/src/private/private_vstream.c"
             );

 fp = private_vstream_fdopen((int) -1,
  oflags, buflen, 0, (1 << 1));
 if (fp == 
# 625 "/acl/lib_acl/src/private/private_vstream.c" 3 4
          ((void *)0)
# 625 "/acl/lib_acl/src/private/private_vstream.c"
              )
  return (
# 626 "/acl/lib_acl/src/private/private_vstream.c" 3 4
         ((void *)0)
# 626 "/acl/lib_acl/src/private/private_vstream.c"
             );
...
# 639 "/acl/lib_acl/src/private/private_vstream.c" 3 4
__builtin_va_start(
# 639 "/acl/lib_acl/src/private/private_vstream.c"
ap
# 639 "/acl/lib_acl/src/private/private_vstream.c" 3 4
,
# 639 "/acl/lib_acl/src/private/private_vstream.c"
...
# 639 "/acl/lib_acl/src/private/private_vstream.c"
                  ;
 for (; name != 0; name = 
# 640 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                                           __builtin_va_arg(
# 640 "/acl/lib_acl/src/private/private_vstream.c"
                                           ap
# 640 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                                           ,
# 640 "/acl/lib_acl/src/private/private_vstream.c"
...
# 640 "/acl/lib_acl/src/private/private_vstream.c"
  ...
  case 1:
   stream->read_fn = 
# 643 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                    __builtin_va_arg(
# 643 "/acl/lib_acl/src/private/private_vstream.c"
                    ap
# 643 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                    ,
# 643 "/acl/lib_acl/src/private/private_vstream.c"
...
# 643 "/acl/lib_acl/src/private/private_vstream.c"
  ...
  case 2:
   stream->write_fn = 
# 646 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                     __builtin_va_arg(
# 646 "/acl/lib_acl/src/private/private_vstream.c"
                     ap
# 646 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                     ,
# 646 "/acl/lib_acl/src/private/private_vstream.c"
...
# 646 "/acl/lib_acl/src/private/private_vstream.c"
  ...
  case 6:
   stream->context = 
# 649 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                    __builtin_va_arg(
# 649 "/acl/lib_acl/src/private/private_vstream.c"
                    ap
# 649 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                    ,
# 649 "/acl/lib_acl/src/private/private_vstream.c"
...
# 649 "/acl/lib_acl/src/private/private_vstream.c"
  ...
  case 3:
   ptr = 
# 652 "/acl/lib_acl/src/private/private_vstream.c" 3 4
        __builtin_va_arg(
# 652 "/acl/lib_acl/src/private/private_vstream.c"
        ap
# 652 "/acl/lib_acl/src/private/private_vstream.c" 3 4
        ,
# 652 "/acl/lib_acl/src/private/private_vstream.c"
...
# 652 "/acl/lib_acl/src/private/private_vstream.c"
  ...
  case 4:
   ((stream)->fd.sock) = 
# 656 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                             __builtin_va_arg(
# 656 "/acl/lib_acl/src/private/private_vstream.c"
                             ap
# 656 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                             ,
# 656 "/acl/lib_acl/src/private/private_vstream.c"
...
# 656 "/acl/lib_acl/src/private/private_vstream.c"
  ...
  case 5:
   stream->rw_timeout = 
# 659 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                       __builtin_va_arg(
# 659 "/acl/lib_acl/src/private/private_vstream.c"
                       ap
# 659 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                       ,
# 659 "/acl/lib_acl/src/private/private_vstream.c"
...
# 659 "/acl/lib_acl/src/private/private_vstream.c"
  ...
  case 7:
   n = 
# 662 "/acl/lib_acl/src/private/private_vstream.c" 3 4
      __builtin_va_arg(
# 662 "/acl/lib_acl/src/private/private_vstream.c"
      ap
# 662 "/acl/lib_acl/src/private/private_vstream.c" 3 4
      ,
# 662 "/acl/lib_acl/src/private/private_vstream.c"
...
# 670 "/acl/lib_acl/src/private/private_vstream.c" 3 4
  ((void) sizeof ((
# 670 "/acl/lib_acl/src/private/private_vstream.c"
  0
# 670 "/acl/lib_acl/src/private/private_vstream.c" 3 4
  ) ? 1 : 0), __extension__ ({ if (
# 670 "/acl/lib_acl/src/private/private_vstream.c"
...
# 670 "/acl/lib_acl/src/private/private_vstream.c"
  "0"
# 670 "/acl/lib_acl/src/private/private_vstream.c" 3 4
  , "/acl/lib_acl/src/private/private_vstream.c", 670, __extension__ __PRETTY_FUNCTION__); }))
# 670 "/acl/lib_acl/src/private/private_vstream.c"
               ;
   break;
  }
...
# 674 "/acl/lib_acl/src/private/private_vstream.c" 3 4
__builtin_va_end(
# 674 "/acl/lib_acl/src/private/private_vstream.c"
ap
# 674 "/acl/lib_acl/src/private/private_vstream.c" 3 4
)
# 674 "/acl/lib_acl/src/private/private_vstream.c"
...
# 681 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                                  ((void *)0)
# 681 "/acl/lib_acl/src/private/private_vstream.c"
                                      ));
}
...
# 691 "/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 691 "/acl/lib_acl/src/private/private_vstream.c"
addr && *addr
# 691 "/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 691 "/acl/lib_acl/src/private/private_vstream.c"
...
"addr && *addr"
# 691 "/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/acl/lib_acl/src/private/private_vstream.c", 691, __extension__ __PRETTY_FUNCTION__); }))
# 691 "/acl/lib_acl/src/private/private_vstream.c"
                         ;
 ptr = strchr(addr, ':');
 if (ptr)
 ...
 if (fd == (int) -1)
  return (
# 708 "/acl/lib_acl/src/private/private_vstream.c" 3 4
         ((void *)0)
# 708 "/acl/lib_acl/src/private/private_vstream.c"
             );
 stream = private_vstream_fdopen(fd, (1 << 2), rw_bufsize,
   rw_timeout, (1 << 0));
 
# 711 "/acl/lib_acl/src/private/private_vstream.c" 3 4
((void) sizeof ((
# 711 "/acl/lib_acl/src/private/private_vstream.c"
stream
# 711 "/acl/lib_acl/src/private/private_vstream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 711 "/acl/lib_acl/src/private/private_vstream.c"
...
"stream"
# 711 "/acl/lib_acl/src/private/private_vstream.c" 3 4
, "/acl/lib_acl/src/private/private_vstream.c", 711, __extension__ __PRETTY_FUNCTION__); }))
# 711 "/acl/lib_acl/src/private/private_vstream.c"
                  ;

 if (stream->addr_peer == 
# 713 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                         ((void *)0)
# 713 "/acl/lib_acl/src/private/private_vstream.c"
                             )
...
# 732 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                                ((void *)0)
# 732 "/acl/lib_acl/src/private/private_vstream.c"
                                    ) {
  ...
  for (i = n - 1; i >= 0; i++) {
   ...
   if (close_handle == 
# 743 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                      ((void *)0)
# 743 "/acl/lib_acl/src/private/private_vstream.c"
                          )
    break;
   if (close_handle->close_fn == 
# 745 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                                ((void *)0)
# 745 "/acl/lib_acl/src/private/private_vstream.c"
                                    )
    continue;
...
# 751 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                                                    ((void *)0)
# 751 "/acl/lib_acl/src/private/private_vstream.c"
                                                        );
   close_handle->close_fn(stream, close_handle->context);
   free(close_handle);
  }
  private_array_destroy(stream->close_handle_lnk, 
# 755 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                                                 ((void *)0)
# 755 "/acl/lib_acl/src/private/private_vstream.c"
                                                     );
 }

 if (stream->read_buf != 
# 758 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                        ((void *)0)
# 758 "/acl/lib_acl/src/private/private_vstream.c"
                            )
...
int private_vstream_close(ACL_VSTREAM *stream)
{
 ...
 if (stream->close_handle_lnk != 
# 783 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                                ((void *)0)
# 783 "/acl/lib_acl/src/private/private_vstream.c"
                                    ) {
  ACL_VSTREAM_CLOSE_HANDLE *close_handle;
  int i, n = private_array_size(stream->close_handle_lnk);
  ...
  for (i = n - 1; i >= 0; i--) {
   close_handle = (ACL_VSTREAM_CLOSE_HANDLE *)
    private_array_index(stream->close_handle_lnk, i);
   if (close_handle == 
# 794 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                      ((void *)0)
# 794 "/acl/lib_acl/src/private/private_vstream.c"
                          )
    continue;
   if (close_handle->close_fn == 
# 796 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                                ((void *)0)
# 796 "/acl/lib_acl/src/private/private_vstream.c"
                                    )
    continue;
   ...
   private_array_delete(stream->close_handle_lnk, i, 
# 802 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                                                    ((void *)0)
# 802 "/acl/lib_acl/src/private/private_vstream.c"
                                                        );
   close_handle->close_fn(stream, close_handle->context);
   free(close_handle);
  }
  private_array_destroy(stream->close_handle_lnk, 
# 806 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                                                 ((void *)0)
# 806 "/acl/lib_acl/src/private/private_vstream.c"
                                                     );
 }
 ...
 if (stream->read_buf != 
# 813 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                        ((void *)0)
# 813 "/acl/lib_acl/src/private/private_vstream.c"
                            )
  free(stream->read_buf);
 if (stream->wbuf != 
# 815 "/acl/lib_acl/src/private/private_vstream.c" 3 4
                    ((void *)0)
# 815 "/acl/lib_acl/src/private/private_vstream.c"
                        )
  free(stream->wbuf);
 if (stream->addr_peer)
  free(stream->addr_peer);
