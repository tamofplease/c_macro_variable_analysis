# 1 "/workspace/acl/lib_acl/src/private/private_fifo.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/private/private_fifo.c" 2
# 13 "/workspace/acl/lib_acl/src/private/private_fifo.c"
# 1 "/workspace/acl/lib_acl/src/private/private_fifo.h" 1



# 1 "/workspace/acl/lib_acl/include/stdlib/acl_fifo.h" 1
# 5 "/workspace/acl/lib_acl/src/private/private_fifo.h" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_malloc.h" 1
# 6 "/workspace/acl/lib_acl/src/private/private_fifo.h" 2
...
# 14 "/workspace/acl/lib_acl/src/private/private_fifo.c" 2
...
static void *fifo_iter_head(ACL_ITER *iter, struct ACL_FIFO *fifo)
{
 ...
 iter->dlen = -1;
 iter->key = 
# 20 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
            ((void *)0)
# 20 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                ;
 iter->klen = -1;
 iter->i = 0;
 iter->size = fifo->cnt;
...
# 25 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
                               ((void *)0)
# 25 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                                   ;
 return (iter->ptr);
}
...
# 34 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
                                    ((void *)0)
# 34 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                                        ;
 if (ptr) {
  iter->data = ptr->data;
  iter->i++;
  ...
  iter->data = 
# 39 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
              ((void *)0)
# 39 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                  ;
 return (iter);
}
...
static void *fifo_iter_tail(ACL_ITER *iter, struct ACL_FIFO *fifo)
{
 ...
 iter->dlen = -1;
 iter->key = 
# 48 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
            ((void *)0)
# 48 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                ;
 iter->klen = -1;
 iter->i = fifo->cnt - 1;
 iter->size = fifo->cnt;
 ...
 iter->data = ptr ? ptr->data : 
# 53 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
                               ((void *)0)
# 53 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                                   ;
 return (iter->ptr);
}
...
# 62 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
                                    ((void *)0)
# 62 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                                        ;
 if (ptr) {
  iter->data = ptr->data;
  iter->i--;
  ...
  iter->data = 
# 67 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
              ((void *)0)
# 67 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                  ;
 return (iter);
}
...
# 73 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
                                                 ((void *)0)
# 73 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                                                     );
}
...
{
 fifo->head = 
# 78 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
             ((void *)0)
# 78 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                 ;
 fifo->tail = 
# 79 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
             ((void *)0)
# 79 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                 ;
 fifo->cnt = 0;
...
# 94 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
((void) sizeof ((
# 94 "/workspace/acl/lib_acl/src/private/private_fifo.c"
fifo
# 94 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
...
"fifo"
# 94 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
, "/workspace/acl/lib_acl/src/private/private_fifo.c", 94, __extension__ __PRETTY_FUNCTION__); }))
# 94 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                ;

 fifo->head = 
# 96 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
             ((void *)0)
# 96 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                 ;
 fifo->tail = 
# 97 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
             ((void *)0)
# 97 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                 ;
 fifo->cnt = 0;
...
void private_fifo_free(ACL_FIFO *fifo, void (*free_fn)(void *))
{
 ...
 while ((data = private_fifo_pop(fifo)) != 
# 112 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
                                          ((void *)0)
# 112 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                                              ) {
  if (free_fn)
   free_fn(data);
 }
...
# 124 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
((void) sizeof ((
# 124 "/workspace/acl/lib_acl/src/private/private_fifo.c"
info
# 124 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 124 "/workspace/acl/lib_acl/src/private/private_fifo.c"
...
"info"
# 124 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
, "/workspace/acl/lib_acl/src/private/private_fifo.c", 124, __extension__ __PRETTY_FUNCTION__); }))
# 124 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                ;
 ...
 if (fifo->tail == 
# 128 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
                  ((void *)0)
# 128 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                      ) {
  info->prev = info->next = 
# 129 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
                           ((void *)0)
# 129 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                               ;
  ...
  info->prev = fifo->tail;
  info->next = 
# 134 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
              ((void *)0)
# 134 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                  ;
  fifo->tail = info;
 }
...
void *private_fifo_pop(ACL_FIFO *fifo)
{
 ...
 if (fifo->head == 
# 147 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
                  ((void *)0)
# 147 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                      )
  return (
# 148 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
         ((void *)0)
# 148 "/workspace/acl/lib_acl/src/private/private_fifo.c"
             );

 info = fifo->head;
 if (fifo->head->next) {
  fifo->head->next->prev = 
# 152 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
                          ((void *)0)
# 152 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                              ;
  fifo->head = fifo->head->next;
 } else {
  fifo->head = fifo->tail = 
# 155 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
                           ((void *)0)
# 155 "/workspace/acl/lib_acl/src/private/private_fifo.c"
                               ;
 }
 data = info->data;
 free(info);
...
void *private_fifo_head(ACL_FIFO *fifo)
{
 if (fifo->head)
  ...
  return (
# 183 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
         ((void *)0)
# 183 "/workspace/acl/lib_acl/src/private/private_fifo.c"
             );
}
...
void *private_fifo_tail(ACL_FIFO *fifo)
{
 if (fifo->tail)
  ...
  return (
# 191 "/workspace/acl/lib_acl/src/private/private_fifo.c" 3 4
         ((void *)0)
# 191 "/workspace/acl/lib_acl/src/private/private_fifo.c"
             );
}
