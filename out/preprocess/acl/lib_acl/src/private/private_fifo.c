# 0 "/acl/lib_acl/src/private/private_fifo.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/private/private_fifo.c"
...
# 2 "/acl/lib_acl/src/private/private_fifo.c" 2
# 13 "/acl/lib_acl/src/private/private_fifo.c"
# 1 "/acl/lib_acl/src/private/private_fifo.h" 1



# 1 "/acl/lib_acl/include/stdlib/acl_fifo.h" 1
# 5 "/acl/lib_acl/src/private/private_fifo.h" 2
# 1 "/acl/lib_acl/include/stdlib/acl_malloc.h" 1
# 6 "/acl/lib_acl/src/private/private_fifo.h" 2
...
# 14 "/acl/lib_acl/src/private/private_fifo.c" 2
...
static void *fifo_iter_head(ACL_ITER *iter, struct ACL_FIFO *fifo)
{
 ...
 iter->dlen = -1;
 iter->key = 
# 20 "/acl/lib_acl/src/private/private_fifo.c" 3 4
            ((void *)0)
# 20 "/acl/lib_acl/src/private/private_fifo.c"
                ;
 iter->klen = -1;
 iter->i = 0;
 iter->size = fifo->cnt;
...
# 25 "/acl/lib_acl/src/private/private_fifo.c" 3 4
                               ((void *)0)
# 25 "/acl/lib_acl/src/private/private_fifo.c"
                                   ;
 return (iter->ptr);
}
...
# 34 "/acl/lib_acl/src/private/private_fifo.c" 3 4
                                    ((void *)0)
# 34 "/acl/lib_acl/src/private/private_fifo.c"
                                        ;
 if (ptr) {
  iter->data = ptr->data;
  iter->i++;
  ...
  iter->data = 
# 39 "/acl/lib_acl/src/private/private_fifo.c" 3 4
              ((void *)0)
# 39 "/acl/lib_acl/src/private/private_fifo.c"
                  ;
 return (iter);
}
...
static void *fifo_iter_tail(ACL_ITER *iter, struct ACL_FIFO *fifo)
{
 ...
 iter->dlen = -1;
 iter->key = 
# 48 "/acl/lib_acl/src/private/private_fifo.c" 3 4
            ((void *)0)
# 48 "/acl/lib_acl/src/private/private_fifo.c"
                ;
 iter->klen = -1;
 iter->i = fifo->cnt - 1;
 iter->size = fifo->cnt;
 ...
 iter->data = ptr ? ptr->data : 
# 53 "/acl/lib_acl/src/private/private_fifo.c" 3 4
                               ((void *)0)
# 53 "/acl/lib_acl/src/private/private_fifo.c"
                                   ;
 return (iter->ptr);
}
...
# 62 "/acl/lib_acl/src/private/private_fifo.c" 3 4
                                    ((void *)0)
# 62 "/acl/lib_acl/src/private/private_fifo.c"
                                        ;
 if (ptr) {
  iter->data = ptr->data;
  iter->i--;
  ...
  iter->data = 
# 67 "/acl/lib_acl/src/private/private_fifo.c" 3 4
              ((void *)0)
# 67 "/acl/lib_acl/src/private/private_fifo.c"
                  ;
 return (iter);
}
...
# 73 "/acl/lib_acl/src/private/private_fifo.c" 3 4
                                                 ((void *)0)
# 73 "/acl/lib_acl/src/private/private_fifo.c"
                                                     );
}
...
{
 fifo->head = 
# 78 "/acl/lib_acl/src/private/private_fifo.c" 3 4
             ((void *)0)
# 78 "/acl/lib_acl/src/private/private_fifo.c"
                 ;
 fifo->tail = 
# 79 "/acl/lib_acl/src/private/private_fifo.c" 3 4
             ((void *)0)
# 79 "/acl/lib_acl/src/private/private_fifo.c"
                 ;
 fifo->cnt = 0;
...
# 94 "/acl/lib_acl/src/private/private_fifo.c" 3 4
((void) sizeof ((
# 94 "/acl/lib_acl/src/private/private_fifo.c"
fifo
# 94 "/acl/lib_acl/src/private/private_fifo.c" 3 4
...
"fifo"
# 94 "/acl/lib_acl/src/private/private_fifo.c" 3 4
, "/acl/lib_acl/src/private/private_fifo.c", 94, __extension__ __PRETTY_FUNCTION__); }))
# 94 "/acl/lib_acl/src/private/private_fifo.c"
                ;

 fifo->head = 
# 96 "/acl/lib_acl/src/private/private_fifo.c" 3 4
             ((void *)0)
# 96 "/acl/lib_acl/src/private/private_fifo.c"
                 ;
 fifo->tail = 
# 97 "/acl/lib_acl/src/private/private_fifo.c" 3 4
             ((void *)0)
# 97 "/acl/lib_acl/src/private/private_fifo.c"
                 ;
 fifo->cnt = 0;
...
# 112 "/acl/lib_acl/src/private/private_fifo.c" 3 4
                                          ((void *)0)
# 112 "/acl/lib_acl/src/private/private_fifo.c"
                                              ) {
  if (free_fn)
   free_fn(data);
 }
...
# 124 "/acl/lib_acl/src/private/private_fifo.c" 3 4
((void) sizeof ((
# 124 "/acl/lib_acl/src/private/private_fifo.c"
info
# 124 "/acl/lib_acl/src/private/private_fifo.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 124 "/acl/lib_acl/src/private/private_fifo.c"
...
"info"
# 124 "/acl/lib_acl/src/private/private_fifo.c" 3 4
, "/acl/lib_acl/src/private/private_fifo.c", 124, __extension__ __PRETTY_FUNCTION__); }))
# 124 "/acl/lib_acl/src/private/private_fifo.c"
                ;
 ...
 if (fifo->tail == 
# 128 "/acl/lib_acl/src/private/private_fifo.c" 3 4
                  ((void *)0)
# 128 "/acl/lib_acl/src/private/private_fifo.c"
                      ) {
  info->prev = info->next = 
# 129 "/acl/lib_acl/src/private/private_fifo.c" 3 4
                           ((void *)0)
# 129 "/acl/lib_acl/src/private/private_fifo.c"
                               ;
  ...
  info->prev = fifo->tail;
  info->next = 
# 134 "/acl/lib_acl/src/private/private_fifo.c" 3 4
              ((void *)0)
# 134 "/acl/lib_acl/src/private/private_fifo.c"
                  ;
  fifo->tail = info;
 }
...
void *private_fifo_pop(ACL_FIFO *fifo)
{
 ...
 if (fifo->head == 
# 147 "/acl/lib_acl/src/private/private_fifo.c" 3 4
                  ((void *)0)
# 147 "/acl/lib_acl/src/private/private_fifo.c"
                      )
  return (
# 148 "/acl/lib_acl/src/private/private_fifo.c" 3 4
         ((void *)0)
# 148 "/acl/lib_acl/src/private/private_fifo.c"
             );

 info = fifo->head;
 if (fifo->head->next) {
  fifo->head->next->prev = 
# 152 "/acl/lib_acl/src/private/private_fifo.c" 3 4
                          ((void *)0)
# 152 "/acl/lib_acl/src/private/private_fifo.c"
                              ;
  fifo->head = fifo->head->next;
 } else {
  fifo->head = fifo->tail = 
# 155 "/acl/lib_acl/src/private/private_fifo.c" 3 4
                           ((void *)0)
# 155 "/acl/lib_acl/src/private/private_fifo.c"
                               ;
 }
 data = info->data;
 free(info);
...
void *private_fifo_head(ACL_FIFO *fifo)
{
 if (fifo->head)
  ...
  return (
# 183 "/acl/lib_acl/src/private/private_fifo.c" 3 4
         ((void *)0)
# 183 "/acl/lib_acl/src/private/private_fifo.c"
             );
}
...
void *private_fifo_tail(ACL_FIFO *fifo)
{
 if (fifo->tail)
  ...
  return (
# 191 "/acl/lib_acl/src/private/private_fifo.c" 3 4
         ((void *)0)
# 191 "/acl/lib_acl/src/private/private_fifo.c"
             );
}
