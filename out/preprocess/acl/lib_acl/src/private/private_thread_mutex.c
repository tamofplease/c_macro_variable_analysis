# 0 "/acl/lib_acl/src/private/private_thread_mutex.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/private/private_thread_mutex.c"
...
# 2 "/acl/lib_acl/src/private/private_thread_mutex.c" 2
# 16 "/acl/lib_acl/src/private/private_thread_mutex.c"
# 1 "/acl/lib_acl/src/private/sem.h" 1
# 17 "/acl/lib_acl/src/private/private_thread_mutex.c" 2
# 1 "/acl/lib_acl/src/private/thread.h" 1
# 9 "/acl/lib_acl/src/private/thread.h"
# 1 "/acl/lib_acl/include/thread/acl_pthread.h" 1
# 10 "/acl/lib_acl/src/private/thread.h" 2


int thread_mutex_destroy(acl_pthread_mutex_t *mutex);
# 31 "/acl/lib_acl/src/private/thread.h"
acl_pthread_mutex_t *thread_mutex_create(void);
# 18 "/acl/lib_acl/src/private/private_thread_mutex.c" 2
# 86 "/acl/lib_acl/src/private/private_thread_mutex.c"
acl_pthread_mutex_t *thread_mutex_create(void)
{
 acl_pthread_mutex_t *mutex;
 int ret;
...
# 92 "/acl/lib_acl/src/private/private_thread_mutex.c" 3 4
((void) sizeof ((
# 92 "/acl/lib_acl/src/private/private_thread_mutex.c"
mutex
# 92 "/acl/lib_acl/src/private/private_thread_mutex.c" 3 4
...
"mutex"
# 92 "/acl/lib_acl/src/private/private_thread_mutex.c" 3 4
, "/acl/lib_acl/src/private/private_thread_mutex.c", 92, __extension__ __PRETTY_FUNCTION__); }))
# 92 "/acl/lib_acl/src/private/private_thread_mutex.c"
                 ;
 if ((ret = pthread_mutex_init(mutex, 
# 93 "/acl/lib_acl/src/private/private_thread_mutex.c" 3 4
                                     ((void *)0)
# 93 "/acl/lib_acl/src/private/private_thread_mutex.c"
                                         )) != 0) {
  printf("pthread_mutex_init error %s\r\n", strerror(ret));
  free(mutex);
  return 
# 96 "/acl/lib_acl/src/private/private_thread_mutex.c" 3 4
        ((void *)0)
# 96 "/acl/lib_acl/src/private/private_thread_mutex.c"
            ;
 }
