# 1 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 3 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c" 2
# 36 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c"
...
int acl_sane_accept(int sock, struct sockaddr * sa, socklen_t *len)
{
 static int accept_ok_errors[] = {
  
# 48 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 11
# 48 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c"
           ,
  
# 49 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 111
# 49 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c"
                 ,
  
# 50 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 104
# 50 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c"
               ,
  
# 51 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 112
# 51 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c"
              ,
  
# 52 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 113
# 52 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c"
                 ,
  
# 53 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 4
# 53 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c"
          ,
  
# 54 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 100
# 54 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c"
             ,
  
# 55 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 101
# 55 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c"
                ,
  
# 56 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 107
# 56 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c"
             ,
  
# 57 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 11
# 57 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c"
                ,
  
# 58 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 105
# 58 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c"
            ,
  
# 59 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 103
# 59 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c"
                 ,
  0,
 };
 int fd;
# 93 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c"
 ...
 if (fd == (int) -1) {
  ...
  for (; (err = accept_ok_errors[count]) != 0; count++) {
   if (error == err) {
    acl_set_error(
# 100 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
                 11
# 100 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c"
                           );
    break;
   }
  }
 }
# 114 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c"
 else if (sa && (sa->sa_family == 
# 114 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
                                 2 
# 114 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c"
                                         || sa->sa_family == 
# 114 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
...
int acl_accept(int sock, char *buf, size_t size, int* sock_type)
{
 ACL_SOCKADDR addr;
 ...
 if (sock_type != 
# 146 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
                 ((void *)0)
# 146 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c"
                     )
  *sock_type = sa->sa_family;

 if (buf == 
# 149 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
           ((void *)0) 
# 149 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c"
                || size == 0)
  return fd;
 ...
 if (sa->sa_family == 
# 155 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
                     1
# 155 "/workspace/acl/lib_acl/src/net/listen/acl_sane_accept.c"
                            ) {
  if (acl_getsockname(fd, buf, size) < 0) {
   buf[0] = 0;
   acl_msg_error("%s(%d): getsockname error=%s",
    __FUNCTION__, 159, acl_last_serror());
  }
  return fd;
 }
 ...
 if (acl_inet_ntop(sa, buf, size) == 0) {
  if (acl_getpeername(fd, buf, size) == -1) {
   acl_msg_error("%s(%d): getpeername error=%s",
    __FUNCTION__, 172, acl_last_serror());
  }
 }
 return fd;
}
