# 0 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
...
# 3 "/acl/lib_acl/src/net/listen/acl_sane_accept.c" 2
# 36 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
...
# 48 "/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 11
# 48 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
           ,
  
# 49 "/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 111
# 49 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
                 ,
  
# 50 "/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 104
# 50 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
               ,
  
# 51 "/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 112
# 51 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
              ,
  
# 52 "/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 113
# 52 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
                 ,
  
# 53 "/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 4
# 53 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
          ,
  
# 54 "/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 100
# 54 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
             ,
  
# 55 "/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 101
# 55 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
                ,
  
# 56 "/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 107
# 56 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
             ,
  
# 57 "/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 11
# 57 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
                ,
  
# 58 "/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 105
# 58 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
            ,
  
# 59 "/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
 103
# 59 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
                 ,
  0,
 };
 int fd;
# 93 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
 ...
 if (fd == (int) -1) {
  ...
  for (; (err = accept_ok_errors[count]) != 0; count++) {
   if (error == err) {
    acl_set_error(
# 100 "/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
                 11
# 100 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
                           );
    break;
   }
  }
 }
# 114 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
 else if (sa && (sa->sa_family == 
# 114 "/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
                                 2 
# 114 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
                                         || sa->sa_family == 
# 114 "/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
...
int acl_accept(int sock, char *buf, size_t size, int* sock_type)
{
 ...
 if (sock_type != 
# 146 "/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
                 ((void *)0)
# 146 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
                     )
  *sock_type = sa->sa_family;

 if (buf == 
# 149 "/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
           ((void *)0) 
# 149 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
                || size == 0)
  return fd;
 ...
 if (sa->sa_family == 
# 155 "/acl/lib_acl/src/net/listen/acl_sane_accept.c" 3 4
                     1
# 155 "/acl/lib_acl/src/net/listen/acl_sane_accept.c"
                            ) {
