# 1 "/workspace/acl/lib_acl/src/net/listen/acl_unix_listen.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 3 "/workspace/acl/lib_acl/src/net/listen/acl_unix_listen.c" 2
# 25 "/workspace/acl/lib_acl/src/net/listen/acl_unix_listen.c"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_sys_patch.h" 1
# 26 "/workspace/acl/lib_acl/src/net/listen/acl_unix_listen.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 27 "/workspace/acl/lib_acl/src/net/listen/acl_unix_listen.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_iostuff.h" 1
# 28 "/workspace/acl/lib_acl/src/net/listen/acl_unix_listen.c" 2
# 1 "/workspace/acl/lib_acl/include/net/acl_sane_inet.h" 1
# 29 "/workspace/acl/lib_acl/src/net/listen/acl_unix_listen.c" 2
# 1 "/workspace/acl/lib_acl/include/net/acl_listen.h" 1
# 30 "/workspace/acl/lib_acl/src/net/listen/acl_unix_listen.c" 2
...
int acl_unix_listen(const char *addr, int backlog, unsigned flag)
{
 ...
 sun.sun_family = 
# 42 "/workspace/acl/lib_acl/src/net/listen/acl_unix_listen.c" 3 4
                 1
# 42 "/workspace/acl/lib_acl/src/net/listen/acl_unix_listen.c"
                        ;
 ...
 if (len >= size || len == 0) {
  acl_msg_error("%s(%d), %s: invalid addr len=%ld, unix path=%s",
   "/workspace/acl/lib_acl/src/net/listen/acl_unix_listen.c", 62, __FUNCTION__, (long) len, addr);
  return (int) -1;
 }
 ...
 if ((sock = socket(
# 74 "/workspace/acl/lib_acl/src/net/listen/acl_unix_listen.c" 3 4
                   1
# 74 "/workspace/acl/lib_acl/src/net/listen/acl_unix_listen.c"
                          , 
# 74 "/workspace/acl/lib_acl/src/net/listen/acl_unix_listen.c" 3 4
                            SOCK_STREAM
# 74 "/workspace/acl/lib_acl/src/net/listen/acl_unix_listen.c"
  ...
  acl_msg_error("%s(%d), %s: socket: %s",
   "/workspace/acl/lib_acl/src/net/listen/acl_unix_listen.c", 76, __FUNCTION__, acl_last_serror());
  return (int) -1;
 }
 ...
 if (bind(sock, (struct sockaddr *) & sun, (socklen_t) size) < 0) {
  acl_msg_error("%s(%d), %s: bind: %s: %s", "/workspace/acl/lib_acl/src/net/listen/acl_unix_listen.c", 90,
 ...
 if (path == sun.sun_path && chmod(addr, 0666) < 0) {
  acl_msg_warn("%s(%d), %s: chmod socket %s: %s", "/workspace/acl/lib_acl/src/net/listen/acl_unix_listen.c",
   102, __FUNCTION__, addr, acl_last_serror());
 }
 ...
 if (listen(sock, backlog) < 0) {
  acl_msg_error("%s(%d), %s: listen %s error %s", "/workspace/acl/lib_acl/src/net/listen/acl_unix_listen.c",
   110, __FUNCTION__, addr, acl_last_serror());
