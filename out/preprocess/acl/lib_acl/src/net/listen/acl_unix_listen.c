# 0 "/acl/lib_acl/src/net/listen/acl_unix_listen.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/listen/acl_unix_listen.c"
...
# 3 "/acl/lib_acl/src/net/listen/acl_unix_listen.c" 2
# 25 "/acl/lib_acl/src/net/listen/acl_unix_listen.c"
# 1 "/acl/lib_acl/include/stdlib/acl_sys_patch.h" 1
# 26 "/acl/lib_acl/src/net/listen/acl_unix_listen.c" 2
# 1 "/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 27 "/acl/lib_acl/src/net/listen/acl_unix_listen.c" 2
# 1 "/acl/lib_acl/include/stdlib/acl_iostuff.h" 1
# 28 "/acl/lib_acl/src/net/listen/acl_unix_listen.c" 2
# 1 "/acl/lib_acl/include/net/acl_sane_inet.h" 1
# 29 "/acl/lib_acl/src/net/listen/acl_unix_listen.c" 2
# 1 "/acl/lib_acl/include/net/acl_listen.h" 1
# 30 "/acl/lib_acl/src/net/listen/acl_unix_listen.c" 2
...
int acl_unix_listen(const char *addr, int backlog, unsigned flag)
{
 ...
 sun.sun_family = 
# 42 "/acl/lib_acl/src/net/listen/acl_unix_listen.c" 3 4
                 1
# 42 "/acl/lib_acl/src/net/listen/acl_unix_listen.c"
                        ;
 ...
 if (len >= size || len == 0) {
  acl_msg_error("%s(%d), %s: invalid addr len=%ld, unix path=%s",
   "/acl/lib_acl/src/net/listen/acl_unix_listen.c", 62, __FUNCTION__, (long) len, addr);
  return (int) -1;
 }
 ...
 if ((sock = socket(
# 74 "/acl/lib_acl/src/net/listen/acl_unix_listen.c" 3 4
                   1
# 74 "/acl/lib_acl/src/net/listen/acl_unix_listen.c"
                          , 
# 74 "/acl/lib_acl/src/net/listen/acl_unix_listen.c" 3 4
                            SOCK_STREAM
# 74 "/acl/lib_acl/src/net/listen/acl_unix_listen.c"
  ...
  acl_msg_error("%s(%d), %s: socket: %s",
   "/acl/lib_acl/src/net/listen/acl_unix_listen.c", 76, __FUNCTION__, acl_last_serror());
  return (int) -1;
 }
 ...
 if (bind(sock, (struct sockaddr *) & sun, (socklen_t) size) < 0) {
  acl_msg_error("%s(%d), %s: bind: %s: %s", "/acl/lib_acl/src/net/listen/acl_unix_listen.c", 90,
 ...
 if (path == sun.sun_path && chmod(addr, 0666) < 0) {
  acl_msg_warn("%s(%d), %s: chmod socket %s: %s", "/acl/lib_acl/src/net/listen/acl_unix_listen.c",
 ...
 if (listen(sock, backlog) < 0) {
  acl_msg_error("%s(%d), %s: listen %s error %s", "/acl/lib_acl/src/net/listen/acl_unix_listen.c",
