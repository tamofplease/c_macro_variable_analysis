# 0 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
...
# 3 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 2
# 23 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
# 1 "/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 24 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 2
# 1 "/acl/lib_acl/include/stdlib/acl_iostuff.h" 1
# 25 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 2
# 1 "/acl/lib_acl/include/net/acl_listen.h" 1
# 26 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 2
...
int acl_fifo_listen(const char *path, int permissions, int block_mode)
{
 ...
 int fd;
 int count;
# 51 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
 if (unlink(path) && acl_last_error() != 
# 51 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 3 4
                                        2
# 51 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
                                              ) {
 ...
 case 0:
  if ((fd = open(path, 
# 63 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 3 4
                      02 
# 63 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
                             | 
# 63 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 3 4
                               04000
# 63 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
  ...
  if (acl_readable(fd) == 0) {
   open_mode = 
# 69 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 3 4
              02 
# 69 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
                     | 
# 69 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 3 4
                       04000
# 69 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
  ...
  open_mode = 
# 73 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 3 4
             00 
# 73 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
                      | 
# 73 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 3 4
                        04000
# 73 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
 ...
 if (
# 103 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 3 4
    ((((
# 103 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
    st.st_mode
# 103 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 3 4
    )) & 0170000) == (0010000)) 
# 103 "/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
