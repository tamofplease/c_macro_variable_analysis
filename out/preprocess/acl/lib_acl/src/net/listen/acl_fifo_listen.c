# 1 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 3 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 2
# 23 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 24 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_iostuff.h" 1
# 25 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 2
# 1 "/workspace/acl/lib_acl/include/net/acl_listen.h" 1
# 26 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 2
...
int acl_fifo_listen(const char *path, int permissions, int block_mode)
{
 ...
 char buf[100], tbuf[256];
 static int open_mode = 0;
 struct stat st;
 int fd;
 int count;
# 51 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
 if (unlink(path) && acl_last_error() != 
# 51 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 3 4
                                        2
# 51 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
                                              ) {
 ...
 case 0:
  if ((fd = open(path, 
# 63 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 3 4
                      02 
# 63 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
                             | 
# 63 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 3 4
                               04000
# 63 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
  ...
  if (acl_readable(fd) == 0) {
   open_mode = 
# 69 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 3 4
              02 
# 69 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
                     | 
# 69 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 3 4
                       04000
# 69 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
  ...
  open_mode = 
# 73 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 3 4
             00 
# 73 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
                      | 
# 73 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 3 4
                        04000
# 73 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
 ...
 if (
# 103 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 3 4
    ((((
# 103 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
    st.st_mode
# 103 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c" 3 4
    )) & 0170000) == (0010000)) 
# 103 "/workspace/acl/lib_acl/src/net/listen/acl_fifo_listen.c"
