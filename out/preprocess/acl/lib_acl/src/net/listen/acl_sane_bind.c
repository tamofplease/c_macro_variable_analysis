# 0 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
...
# 3 "/acl/lib_acl/src/net/listen/acl_sane_bind.c" 2
# 28 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
int acl_inet_bind(const struct addrinfo *res, unsigned flag)
{
 int fd;
 int on;
 ...
 if (fd == (int) -1) {
  acl_msg_error("%s(%d): create socket %s",
   "/acl/lib_acl/src/net/listen/acl_sane_bind.c", 36, acl_last_serror());
  return (int) -1;
 }

 if (flag & 1 << 3) {
# 50 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
 } else {
  on = 1;
  if (setsockopt(fd, 
# 52 "/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                    1
# 52 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                              , 
# 52 "/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                                2
# 52 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
   ...
   acl_msg_warn("%s(%d): setsockopt(SO_REUSEADDR): %s",
    "/acl/lib_acl/src/net/listen/acl_sane_bind.c", 56, acl_last_serror());
  }
 }
...
# 63 "/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                          1
# 63 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                                    , 
# 63 "/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                                      15
# 63 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
  ...
  if (ret < 0)
   acl_msg_warn("%s(%d): setsocket(SO_REUSEPORT): %s",
    "/acl/lib_acl/src/net/listen/acl_sane_bind.c", 67, acl_last_serror());
 }
 ...
 if (bind(fd, res->ai_addr, res->ai_addrlen) < 0) {
  ...
  acl_msg_error("%s(%d): bind error %s",
   "/acl/lib_acl/src/net/listen/acl_sane_bind.c", 80, acl_last_serror());
  return (int) -1;
 }
...
int acl_unix_dgram_bind(const char *addr, unsigned flag)
{
 ...
 sun.sun_family = 
# 96 "/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                 1
# 96 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                        ;
 ...
 if (len >= size || len == 0) {
  acl_msg_error("%s(%d), %s: invalid addr len=%ld, unix path=%s",
   "/acl/lib_acl/src/net/listen/acl_sane_bind.c", 116, __FUNCTION__, (long) len, addr);
  return (int) -1;
 }
 ...
 if ((sock = socket(
# 129 "/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                   1
# 129 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                          , 
# 129 "/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                            SOCK_DGRAM
# 129 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
...
# 155 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
 ...
 int socktype, int family)
{
 ...
 if (addrlen == 0) {
  acl_msg_error("%s(%d), %s: acl_inet_pton error, addr=%s",
   "/acl/lib_acl/src/net/listen/acl_sane_bind.c", 179, __FUNCTION__, addr);
  return (int) -1;
 }

 res.ai_flags = 
# 183 "/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                  0x0004
# 183 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                                ;
 ...
 int socktype, int *family)
{
 ...
 if (res0 == 
# 200 "/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
            ((void *)0)
# 200 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                ) {
  acl_msg_error("%s(%d), %s: host_addrinfo NULL, addr=%s",
   "/acl/lib_acl/src/net/listen/acl_sane_bind.c", 202, __FUNCTION__, addr);
  return (int) -1;
 }
 ...
 for (res = res0; res != 
# 208 "/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                        ((void *)0)
# 208 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                            ; res = res->ai_next) {
 ...
 int socktype, int *family_ptr)
{
 int fd;
 int family = 
# 226 "/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
             0
# 226 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                      ;

 if (acl_valid_ipv4_hostaddr(addr, 0)) {
  family = 
# 229 "/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
          2
# 229 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                 ;
  fd = bind_addr(addr, flag, socktype, 
# 230 "/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                                      2
# 230 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                                             );
 } else if (acl_valid_ipv6_hostaddr(addr, 0)) {
  family = 
# 232 "/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
          10
# 232 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                  ;
  fd = bind_addr(addr, flag, socktype, 
# 233 "/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                                      10
# 233 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                                              );
 } else {
 ...
 if (fd == (int) -1) {
  acl_msg_error("%s(%d): bind %s error %s, family=%s",
   "/acl/lib_acl/src/net/listen/acl_sane_bind.c", 244, addr, acl_last_serror(),
   family == 
# 245 "/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
            2 
# 245 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                    ? "PF_INET" : (family == 
# 245 "/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                                             10 
# 245 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
...
int acl_udp_bind3(const char *addr, unsigned flag, int *family)
{
 ...
 if (acl_valid_unix(addr)) {
  ...
  if (fd >= 0 && family) {
   *family = 
# 265 "/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
            1
# 265 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                   ;
  }
  return fd;
 }
...
# 271 "/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                                 SOCK_DGRAM
# 271 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                                           , family);
}
...
# 276 "/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                                 ((void *)0)
# 276 "/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                                     );
}
