# 1 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 3 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c" 2
# 28 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
int acl_inet_bind(const struct addrinfo *res, unsigned flag)
{
 int fd;
 int on;
 ...
 if (fd == (int) -1) {
  acl_msg_error("%s(%d): create socket %s",
   "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c", 36, acl_last_serror());
  return (int) -1;
 }

 if (flag & 1 << 3) {
# 50 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
 } else {
  on = 1;
  if (setsockopt(fd, 
# 52 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                    1
# 52 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                              , 
# 52 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                                2
# 52 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
   ...
   acl_msg_warn("%s(%d): setsockopt(SO_REUSEADDR): %s",
    "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c", 56, acl_last_serror());
  }
 }
...
# 63 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                          1
# 63 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                                    , 
# 63 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                                      15
# 63 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
  ...
  if (ret < 0)
   acl_msg_warn("%s(%d): setsocket(SO_REUSEPORT): %s",
    "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c", 67, acl_last_serror());
 }
 ...
 if (bind(fd, res->ai_addr, res->ai_addrlen) < 0) {
  ...
  acl_msg_error("%s(%d): bind error %s",
   "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c", 80, acl_last_serror());
  return (int) -1;
 }
...
int acl_unix_dgram_bind(const char *addr, unsigned flag)
{
 ...
 sun.sun_family = 
# 96 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                 1
# 96 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                        ;
 ...
 if (len >= size || len == 0) {
  acl_msg_error("%s(%d), %s: invalid addr len=%ld, unix path=%s",
   "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c", 116, __FUNCTION__, (long) len, addr);
  return (int) -1;
 }
 ...
 if ((sock = socket(
# 129 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                   1
# 129 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                          , 
# 129 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                            SOCK_DGRAM
# 129 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
...
# 155 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
...
static int bind_addr(const char *addr, unsigned flag,
 int socktype, int family)
{
 struct addrinfo res;
 ACL_SOCKADDR in;
 ...
 if (addrlen == 0) {
  acl_msg_error("%s(%d), %s: acl_inet_pton error, addr=%s",
   "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c", 179, __FUNCTION__, addr);
  return (int) -1;
 }

 res.ai_flags = 
# 183 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                  0x0004
# 183 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                                ;
...
static int find_bind(const char *addr, unsigned flag,
 int socktype, int *family)
{
 ...
 if (res0 == 
# 200 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
            ((void *)0)
# 200 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                ) {
  acl_msg_error("%s(%d), %s: host_addrinfo NULL, addr=%s",
   "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c", 202, __FUNCTION__, addr);
  return (int) -1;
 }
 ...
 for (res = res0; res != 
# 208 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                        ((void *)0)
# 208 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                            ; res = res->ai_next) {
 ...
 int socktype, int *family_ptr)
{
 int fd;
 int family = 
# 226 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
             0
# 226 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                      ;

 if (acl_valid_ipv4_hostaddr(addr, 0)) {
  family = 
# 229 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
          2
# 229 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                 ;
  fd = bind_addr(addr, flag, socktype, 
# 230 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                                      2
# 230 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                                             );
 } else if (acl_valid_ipv6_hostaddr(addr, 0)) {
  family = 
# 232 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
          10
# 232 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                  ;
  fd = bind_addr(addr, flag, socktype, 
# 233 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                                      10
# 233 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                                              );
 } else {
 ...
 if (fd == (int) -1) {
  acl_msg_error("%s(%d): bind %s error %s, family=%s",
   "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c", 244, addr, acl_last_serror(),
   family == 
# 245 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
            2 
# 245 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                    ? "PF_INET" : (family == 
# 245 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                                             10 
# 245 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
...
int acl_udp_bind3(const char *addr, unsigned flag, int *family)
{
 ...
 if (acl_valid_unix(addr)) {
  int fd = acl_unix_dgram_bind(addr, flag);
  if (fd >= 0 && family) {
   *family = 
# 265 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
            1
# 265 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                   ;
  }
  return fd;
 }
 ...
 return acl_sane_bind(addr, flag, 
# 271 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                                 SOCK_DGRAM
# 271 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                                           , family);
}

int acl_udp_bind(const char *addr, unsigned flag)
{
 return acl_udp_bind3(addr, flag, 
# 276 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c" 3 4
                                 ((void *)0)
# 276 "/workspace/acl/lib_acl/src/net/listen/acl_sane_bind.c"
                                     );
}
