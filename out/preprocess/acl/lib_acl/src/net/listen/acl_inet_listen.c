# 0 "/acl/lib_acl/src/net/listen/acl_inet_listen.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/listen/acl_inet_listen.c"
...
# 2 "/acl/lib_acl/src/net/listen/acl_inet_listen.c" 2
# 36 "/acl/lib_acl/src/net/listen/acl_inet_listen.c"
int acl_inet_listen(const char *addr, int backlog, unsigned flag)
{
 int sock = acl_sane_bind(addr, flag, 
# 38 "/acl/lib_acl/src/net/listen/acl_inet_listen.c" 3 4
                                            SOCK_STREAM
# 38 "/acl/lib_acl/src/net/listen/acl_inet_listen.c"
                                                       , 
# 38 "/acl/lib_acl/src/net/listen/acl_inet_listen.c" 3 4
                                                         ((void *)0)
# 38 "/acl/lib_acl/src/net/listen/acl_inet_listen.c"
 ...
 if (sock == (int) -1) {
  acl_msg_error("%s(%d), %s: bind %s error %s", "/acl/lib_acl/src/net/listen/acl_inet_listen.c",
...
# 49 "/acl/lib_acl/src/net/listen/acl_inet_listen.c" 3 4
                            IPPROTO_TCP
# 49 "/acl/lib_acl/src/net/listen/acl_inet_listen.c"
                                       , 
# 49 "/acl/lib_acl/src/net/listen/acl_inet_listen.c" 3 4
                                         23
# 49 "/acl/lib_acl/src/net/listen/acl_inet_listen.c"
 ...
 if (listen(sock, backlog) < 0) {
  ...
  acl_msg_error("%s(%d), %s: listen %s error %s", "/acl/lib_acl/src/net/listen/acl_inet_listen.c",
...
# 74 "/acl/lib_acl/src/net/listen/acl_inet_listen.c" 3 4
                                     ((void *)0)
# 74 "/acl/lib_acl/src/net/listen/acl_inet_listen.c"
                                         , 0);
}
...
int acl_inet_accept_ex(int listen_fd, char *ipbuf, size_t size)
{
 ...
 if (ipbuf != 
# 92 "/acl/lib_acl/src/net/listen/acl_inet_listen.c" 3 4
             ((void *)0) 
# 92 "/acl/lib_acl/src/net/listen/acl_inet_listen.c"
