# 1 "/workspace/acl/lib_acl/src/net/listen/acl_inet_listen.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/net/listen/acl_inet_listen.c" 2
# 36 "/workspace/acl/lib_acl/src/net/listen/acl_inet_listen.c"
int acl_inet_listen(const char *addr, int backlog, unsigned flag)
{
 int sock = acl_sane_bind(addr, flag, 
# 38 "/workspace/acl/lib_acl/src/net/listen/acl_inet_listen.c" 3 4
                                            SOCK_STREAM
# 38 "/workspace/acl/lib_acl/src/net/listen/acl_inet_listen.c"
                                                       , 
# 38 "/workspace/acl/lib_acl/src/net/listen/acl_inet_listen.c" 3 4
                                                         ((void *)0)
# 38 "/workspace/acl/lib_acl/src/net/listen/acl_inet_listen.c"
 ...
 if (sock == (int) -1) {
  acl_msg_error("%s(%d), %s: bind %s error %s", "/workspace/acl/lib_acl/src/net/listen/acl_inet_listen.c",
   42, __FUNCTION__, addr, acl_last_serror());
  return (int) -1;
 }
...
# 49 "/workspace/acl/lib_acl/src/net/listen/acl_inet_listen.c" 3 4
                            IPPROTO_TCP
# 49 "/workspace/acl/lib_acl/src/net/listen/acl_inet_listen.c"
                                       , 
# 49 "/workspace/acl/lib_acl/src/net/listen/acl_inet_listen.c" 3 4
                                         23
# 49 "/workspace/acl/lib_acl/src/net/listen/acl_inet_listen.c"
  ...
  if (ret < 0) {
   acl_msg_warn("%s(%d): setsocket(TCP_FASTOPEN): %s",
    __FUNCTION__, 53, acl_last_serror());
  }
 }
 ...
 if (listen(sock, backlog) < 0) {
  ...
  acl_msg_error("%s(%d), %s: listen %s error %s", "/workspace/acl/lib_acl/src/net/listen/acl_inet_listen.c",
   64, __FUNCTION__, addr, acl_last_serror());
  return (int) -1;
 }
...
int acl_inet_accept(int listen_fd)
{
 return acl_inet_accept_ex(listen_fd, 
# 74 "/workspace/acl/lib_acl/src/net/listen/acl_inet_listen.c" 3 4
                                     ((void *)0)
# 74 "/workspace/acl/lib_acl/src/net/listen/acl_inet_listen.c"
                                         , 0);
}

int acl_inet_accept_ex(int listen_fd, char *ipbuf, size_t size)
{
 ACL_SOCKADDR sa;
 ...
 if (ipbuf != 
# 92 "/workspace/acl/lib_acl/src/net/listen/acl_inet_listen.c" 3 4
             ((void *)0) 
# 92 "/workspace/acl/lib_acl/src/net/listen/acl_inet_listen.c"
                  && size > 0 && !acl_inet_ntop(&sa.sa, ipbuf, size))
  ipbuf[0] = 0;
