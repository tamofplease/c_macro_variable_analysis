# 1 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 2
# 37 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
const char *acl_inet_ntop4(const unsigned char *src, char *dst, size_t size)
{
 ...
 if (size < MIN_SIZE)
  return 
# 44 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
        ((void *)0)
# 44 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
            ;
...
const char *acl_inet_ntoa(const struct in_addr in, char *buf, size_t size)
{
 ...
 sin.sin_family = 
# 76 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                 2
# 76 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
                        ;
 memcpy(&sin.sin_addr, &in, sizeof(sin.sin_addr));

 if (!acl_inet_ntop((const struct sockaddr*) &sin, buf, size)) {
  return 
# 80 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
        ((void *)0)
# 80 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
            ;
 } else {
  return buf;
 }
...
const char *acl_inet6_ntoa(const struct in6_addr in6, char *buf, size_t size)
{
 ...
 sin6.sin6_family = 
# 94 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                   10
# 94 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
                           ;
 memcpy(&sin6.sin6_addr, &in6, sizeof(sin6.sin6_addr));

 if (!acl_inet_ntop((const struct sockaddr*) &sin6, buf, size)) {
  return 
# 98 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
        ((void *)0)
# 98 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
            ;
 } else {
  return buf;
 }
...
int acl_ipv4_addr_valid(const char *addr)
{
 ...
 if (addr == 
# 125 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
            ((void *)0) 
# 125 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
                 || *addr == 0)
  return (0);
 k = 3;
 while (*ptr && *ptr != '.') {
...
{
 if (sa->sa_family == 
# 193 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                     2
# 193 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
                            ) {
  int port;
  char ip[64];
  struct sockaddr_in *in = (struct sockaddr_in*) sa;

  if (!inet_ntop(sa->sa_family, &in->sin_addr, ip, 64)) {
   return 0;
  }

  port = 
# 202 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
        (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 202 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
        in->sin_port
# 202 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
...
# 202 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
                           ;
  if (port > 0) {
   snprintf(buf, size, "%s%c%d", ip, '|', port);
  } else {
...
# 210 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                            10
# 210 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
                                    ) {
  ...
  int port;
  char ip[64], ifname[
# 216 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                          16
# 216 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
                                     ], *ptr;
  struct sockaddr_in6 *in6 = (struct sockaddr_in6*) sa;

  (void) ptr;

  if (!inet_ntop(sa->sa_family, &in6->sin6_addr, ip, 64)) {
   return 0;
  }
  ...
  if (ptr == 
# 227 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
            ((void *)0)
# 227 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
                ) {
   ifname[0] = 0;
  }
  ...
  port = 
# 234 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
        (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 234 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
        in6->sin6_port
# 234 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
        ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 234 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
...
# 255 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                            1
# 255 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
                                   ) {
  struct sockaddr_un *un = (struct sockaddr_un *) sa;

  do { if (size > 0) { size_t _n = strlen(un->sun_path); _n = _n > (size_t ) size - 1? (size_t) size - 1 : _n; memcpy(buf, un->sun_path, _n); buf[_n] = 0; } } while (0);
...
{
 if (af == 
# 268 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
          2
# 268 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
                 ) {
  char buf[256], *ptr;
  int port = 0;
  struct sockaddr_in *in;
  ...
  in->sin_port = 
# 287 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                  (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 287 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
                  port
# 287 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                  ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 287 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
                             ;
  dst->sa_family = 
# 288 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                  2
# 288 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
                         ;
  return sizeof(struct sockaddr_in);

 } else if (af == 
# 291 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                 10
# 291 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
                         ) {
# 304 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
  int port = 0;
  char buf[256], *ptr;
  struct sockaddr_in6 *in6;
  ...
  in6->sin6_family = 
# 323 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                    10
# 323 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
                            ;
  in6->sin6_port = 
# 324 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                    (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 324 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
                    port
# 324 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                    ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 324 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
...
# 340 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                 1
# 340 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
                        ) {
  ...
  dst->sa_family = 
# 348 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                  1
# 348 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
                         ;



  do { if (len > 0) { size_t _n = strlen(src); _n = _n > (size_t ) len - 1? (size_t) len - 1 : _n; memcpy(un->sun_path, src, _n); un->sun_path[_n] = 0; } } while (0);
  return sizeof(struct sockaddr_un);

 } else {
  acl_msg_error("%s(%d): invalid af=%d", __FUNCTION__, 356, af);
  return 0;
 }
}
...
size_t acl_sane_pton(const char *src, struct sockaddr *dst)
{
 ...
 if (acl_valid_ipv4_hostaddr(src, 0)) {
  af = 
# 366 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
      2
# 366 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
             ;
 } else if (acl_valid_ipv6_hostaddr(src, 0)) {
  af = 
# 368 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
      10
# 368 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
              ;
 } else if (acl_valid_unix(src)) {
  af = 
# 370 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
      1
# 370 "/workspace/acl/lib_acl/src/net/acl_sane_inet.c"
             ;
 } else {
  return 0;
 }
