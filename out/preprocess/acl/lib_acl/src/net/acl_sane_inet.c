# 0 "/acl/lib_acl/src/net/acl_sane_inet.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/acl_sane_inet.c"
...
# 2 "/acl/lib_acl/src/net/acl_sane_inet.c" 2
# 37 "/acl/lib_acl/src/net/acl_sane_inet.c"
const char *acl_inet_ntop4(const unsigned char *src, char *dst, size_t size)
{
 ...
 if (size < MIN_SIZE)
  return 
# 44 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
        ((void *)0)
# 44 "/acl/lib_acl/src/net/acl_sane_inet.c"
            ;
...
const char *acl_inet_ntoa(const struct in_addr in, char *buf, size_t size)
{
 ...
 sin.sin_family = 
# 76 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                 2
# 76 "/acl/lib_acl/src/net/acl_sane_inet.c"
                        ;
 memcpy(&sin.sin_addr, &in, sizeof(sin.sin_addr));

 if (!acl_inet_ntop((const struct sockaddr*) &sin, buf, size)) {
  return 
# 80 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
        ((void *)0)
# 80 "/acl/lib_acl/src/net/acl_sane_inet.c"
            ;
 } else {
  return buf;
 }
...
const char *acl_inet6_ntoa(const struct in6_addr in6, char *buf, size_t size)
{
 ...
 sin6.sin6_family = 
# 94 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                   10
# 94 "/acl/lib_acl/src/net/acl_sane_inet.c"
                           ;
 memcpy(&sin6.sin6_addr, &in6, sizeof(sin6.sin6_addr));

 if (!acl_inet_ntop((const struct sockaddr*) &sin6, buf, size)) {
  return 
# 98 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
        ((void *)0)
# 98 "/acl/lib_acl/src/net/acl_sane_inet.c"
            ;
 } else {
  return buf;
 }
...
int acl_ipv4_addr_valid(const char *addr)
{
 ...
 if (addr == 
# 125 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
            ((void *)0) 
# 125 "/acl/lib_acl/src/net/acl_sane_inet.c"
                 || *addr == 0)
  return (0);
 k = 3;
 while (*ptr && *ptr != '.') {
...
{
 if (sa->sa_family == 
# 193 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                     2
# 193 "/acl/lib_acl/src/net/acl_sane_inet.c"
                            ) {
  int port;
  char ip[64];
  ...
  port = 
# 202 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
        __bswap_16 (
# 202 "/acl/lib_acl/src/net/acl_sane_inet.c"
        in->sin_port
# 202 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
        )
# 202 "/acl/lib_acl/src/net/acl_sane_inet.c"
...
# 210 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                            10
# 210 "/acl/lib_acl/src/net/acl_sane_inet.c"
                                    ) {
  ...
  int port;
  char ip[64], ifname[
# 216 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                          16
# 216 "/acl/lib_acl/src/net/acl_sane_inet.c"
                                     ], *ptr;
  ...
  if (ptr == 
# 227 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
            ((void *)0)
# 227 "/acl/lib_acl/src/net/acl_sane_inet.c"
                ) {
   ifname[0] = 0;
  }
  ...
  port = 
# 234 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
        __bswap_16 (
# 234 "/acl/lib_acl/src/net/acl_sane_inet.c"
        in6->sin6_port
# 234 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
        )
# 234 "/acl/lib_acl/src/net/acl_sane_inet.c"
...
# 255 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                            1
# 255 "/acl/lib_acl/src/net/acl_sane_inet.c"
                                   ) {
...
{
 if (af == 
# 268 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
          2
# 268 "/acl/lib_acl/src/net/acl_sane_inet.c"
                 ) {
  char buf[256], *ptr;
  int port = 0;
  struct sockaddr_in *in;
  ...
  in->sin_port = 
# 287 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                  __bswap_16 (
# 287 "/acl/lib_acl/src/net/acl_sane_inet.c"
                  port
# 287 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                  )
# 287 "/acl/lib_acl/src/net/acl_sane_inet.c"
                             ;
  dst->sa_family = 
# 288 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                  2
# 288 "/acl/lib_acl/src/net/acl_sane_inet.c"
                         ;
  return sizeof(struct sockaddr_in);

 } else if (af == 
# 291 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                 10
# 291 "/acl/lib_acl/src/net/acl_sane_inet.c"
                         ) {
# 304 "/acl/lib_acl/src/net/acl_sane_inet.c"
  int port = 0;
  char buf[256], *ptr;
  struct sockaddr_in6 *in6;
  ...
  in6->sin6_family = 
# 323 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                    10
# 323 "/acl/lib_acl/src/net/acl_sane_inet.c"
                            ;
  in6->sin6_port = 
# 324 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                    __bswap_16 (
# 324 "/acl/lib_acl/src/net/acl_sane_inet.c"
                    port
# 324 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                    )
# 324 "/acl/lib_acl/src/net/acl_sane_inet.c"
...
# 340 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                 1
# 340 "/acl/lib_acl/src/net/acl_sane_inet.c"
                        ) {
  ...
  dst->sa_family = 
# 348 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
                  1
# 348 "/acl/lib_acl/src/net/acl_sane_inet.c"
                         ;
...
size_t acl_sane_pton(const char *src, struct sockaddr *dst)
{
 ...
 if (acl_valid_ipv4_hostaddr(src, 0)) {
  af = 
# 366 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
      2
# 366 "/acl/lib_acl/src/net/acl_sane_inet.c"
             ;
 } else if (acl_valid_ipv6_hostaddr(src, 0)) {
  af = 
# 368 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
      10
# 368 "/acl/lib_acl/src/net/acl_sane_inet.c"
              ;
 } else if (acl_valid_unix(src)) {
  af = 
# 370 "/acl/lib_acl/src/net/acl_sane_inet.c" 3 4
      1
# 370 "/acl/lib_acl/src/net/acl_sane_inet.c"
             ;
 } else {
  return 0;
 }
