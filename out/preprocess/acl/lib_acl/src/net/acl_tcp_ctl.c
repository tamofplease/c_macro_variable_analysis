# 0 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
...
# 2 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 2
# 29 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
void acl_tcp_set_rcvbuf(int fd, int size)
{
 ...
 if (n != 
# 35 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
         2 
# 35 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
                 && n != 
# 35 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                         10
# 35 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
 ...
 if (setsockopt(fd, 
# 41 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                   1
# 41 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
                             , 
# 41 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                               8
# 41 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
...
void acl_tcp_set_sndbuf(int fd, int size)
{
 ...
 if (n != 
# 55 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
         2 
# 55 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
                 && n != 
# 55 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                         10
# 55 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
 ...
 if (setsockopt(fd, 
# 61 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                   1
# 61 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
                             , 
# 61 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                               7
# 61 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
...
int acl_tcp_get_rcvbuf(int fd)
{
 ...
 if (n != 
# 77 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
         2 
# 77 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
                 && n != 
# 77 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                         10
# 77 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
 ...
 if (getsockopt(fd, 
# 84 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                   1
# 84 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
                             , 
# 84 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                               8
# 84 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
...
int acl_tcp_get_sndbuf(int fd)
{
 ...
 if (n != 
# 103 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
         2 
# 103 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
                 && n != 
# 103 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                         10
# 103 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
 ...
 len = (socklen_t) sizeof(size);
 if (getsockopt(fd, 
# 110 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                   1
# 110 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
                             , 
# 110 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                               7
# 110 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
...
void acl_tcp_nodelay(int fd, int onoff)
{
 ...
 if (n != 
# 131 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
         2 
# 131 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
                 && n != 
# 131 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                         10
# 131 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
 ...
 if (setsockopt(fd, 
# 137 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                   IPPROTO_TCP
# 137 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
                              , 
# 137 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                                1
# 137 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
...
int acl_get_tcp_nodelay(int fd)
{
 ...
 if (n != 
# 153 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
         2 
# 153 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
                 && n != 
# 153 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                         10
# 153 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
 ...
 if (getsockopt(fd, 
# 161 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                   IPPROTO_TCP
# 161 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
                              , 
# 161 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                                1
# 161 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
...
void acl_tcp_so_linger(int fd, int onoff, int timeout)
{
 ...
 if (n != 
# 177 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
         2 
# 177 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
                 && n != 
# 177 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                         10
# 177 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
 ...
 if (setsockopt(fd, 
# 185 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                   1
# 185 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
                             , 
# 185 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                               13
# 185 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
...
int acl_get_tcp_solinger(int fd)
{
 ...
 if (n != 
# 200 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
         2 
# 200 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
                 && n != 
# 200 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                         10
# 200 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
 ...
 memset(&l, 0, sizeof(l));
 if (getsockopt(fd, 
# 207 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                   1
# 207 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
                             , 
# 207 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                               13
# 207 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
...
void acl_tcp_defer_accept(int fd, int timeout)
{
 ...
 if (timeout < 0)
  timeout = 0;
 if (setsockopt(fd, 
# 223 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                   IPPROTO_TCP
# 223 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
                              , 
# 223 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                                9
# 223 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
...
void acl_tcp_fastopen(int fd, int on)
{
 ...
 if (on)
  on = 1;
 if (setsockopt(fd, 
# 242 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                   IPPROTO_TCP
# 242 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
                              , 
# 242 "/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                                23
# 242 "/acl/lib_acl/src/net/acl_tcp_ctl.c"
