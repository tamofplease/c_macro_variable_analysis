# 1 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 2
# 29 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
void acl_tcp_set_rcvbuf(int fd, int size)
{
 ...
 if (n != 
# 35 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
         2 
# 35 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
                 && n != 
# 35 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                         10
# 35 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
 ...
 if (setsockopt(fd, 
# 41 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                   1
# 41 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
                             , 
# 41 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                               8
# 41 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
  ...
  acl_msg_error("%s(%d): size(%d), setsockopt error(%s)",
   myname, 45, size, acl_last_serror());
 }
}
...
void acl_tcp_set_sndbuf(int fd, int size)
{
 ...
 if (n != 
# 55 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
         2 
# 55 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
                 && n != 
# 55 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                         10
# 55 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
 ...
 if (setsockopt(fd, 
# 61 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                   1
# 61 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
                             , 
# 61 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                               7
# 61 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
...
int acl_tcp_get_rcvbuf(int fd)
{
 ...
 if (n != 
# 77 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
         2 
# 77 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
                 && n != 
# 77 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                         10
# 77 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
 ...
 if (getsockopt(fd, 
# 84 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                   1
# 84 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
                             , 
# 84 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                               8
# 84 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
  ...
  (char *) &size, &len) < 0)
 {
  acl_msg_error("%s(%d): size(%d), getsockopt error(%s)",
   myname, 88, size, acl_last_serror());
  return -1;
 }
...
int acl_tcp_get_sndbuf(int fd)
{
 ...
 if (n != 
# 103 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
         2 
# 103 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
                 && n != 
# 103 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                         10
# 103 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
 ...
 len = (socklen_t) sizeof(size);
 if (getsockopt(fd, 
# 110 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                   1
# 110 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
                             , 
# 110 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                               7
# 110 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
                                        , (char *) &size, &len) < 0) {
  acl_msg_error("%s(%d): size(%d), getsockopt error(%s)",
   myname, 112, size, acl_last_serror());
  return -1;
 }
...
void acl_tcp_nodelay(int fd, int onoff)
{
 ...
 if (n != 
# 131 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
         2 
# 131 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
                 && n != 
# 131 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                         10
# 131 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
 ...
 if (setsockopt(fd, 
# 137 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                   IPPROTO_TCP
# 137 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
                              , 
# 137 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                                1
# 137 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
  ...
  acl_msg_error("%s(%d): set nodelay error(%s), onoff(%d)",
   myname, 141, acl_last_serror(), onoff);
 }
}
...
int acl_get_tcp_nodelay(int fd)
{
 ...
 if (n != 
# 153 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
         2 
# 153 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
                 && n != 
# 153 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                         10
# 153 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
 ...
 if (getsockopt(fd, 
# 161 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                   IPPROTO_TCP
# 161 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
                              , 
# 161 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                                1
# 161 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
...
void acl_tcp_so_linger(int fd, int onoff, int timeout)
{
 ...
 if (n != 
# 177 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
         2 
# 177 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
                 && n != 
# 177 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                         10
# 177 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
 ...
 if (setsockopt(fd, 
# 185 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                   1
# 185 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
                             , 
# 185 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                               13
# 185 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
...
int acl_get_tcp_solinger(int fd)
{
 ...
 if (n != 
# 200 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
         2 
# 200 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
                 && n != 
# 200 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                         10
# 200 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
 ...
 memset(&l, 0, sizeof(l));
 if (getsockopt(fd, 
# 207 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                   1
# 207 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
                             , 
# 207 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                               13
# 207 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
...
void acl_tcp_defer_accept(int fd, int timeout)
{
 ...
 if (timeout < 0)
  timeout = 0;
 if (setsockopt(fd, 
# 223 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                   IPPROTO_TCP
# 223 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
                              , 
# 223 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                                9
# 223 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
...
void acl_tcp_fastopen(int fd, int on)
{
 ...
 if (on)
  on = 1;
 if (setsockopt(fd, 
# 242 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                   IPPROTO_TCP
# 242 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
                              , 
# 242 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c" 3 4
                                23
# 242 "/workspace/acl/lib_acl/src/net/acl_tcp_ctl.c"
