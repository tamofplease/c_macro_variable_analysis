# 1 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 2
# 25 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
...
ACL_RES *acl_res_new(const char *dns_ip, unsigned short dns_port)
{
 ...
 if (dns_ip == 
# 38 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
              ((void *)0) 
# 38 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
                   || *dns_ip == 0) {
  acl_msg_error("%s(%d), %s: dns_ip invalid",
   "/workspace/acl/lib_acl/src/net/dns/acl_res.c", 40, __FUNCTION__);
  return 
# 41 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
        ((void *)0)
# 41 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
            ;
 }
 ...
 res = acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_res.c", 48, 1, sizeof(ACL_RES));
 res->cur_qid = (unsigned short) time(
# 49 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                                     ((void *)0)
# 49 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
                                         );

 do { if (sizeof(res->dns_ip) > 0) { size_t _n = strlen(dns_ip); _n = _n > (size_t ) sizeof(res->dns_ip) - 1? (size_t) sizeof(res->dns_ip) - 1 : _n; memcpy(res->dns_ip, dns_ip, _n); res->dns_ip[_n] = 0; } } while (0);
...
{
 if (res) {
  do { if (res) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_res.c", 64, (res)); (res) = 
# 64 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
 ((void *)0)
# 64 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
 ; } } while (0);
 }
}
 ...
 char *buf, int size)
{
 ...
 fd = socket(
# 75 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
            2
# 75 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
                   , 
# 75 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                     SOCK_DGRAM
# 75 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
 ...
 if (fd == (int) -1) {
  acl_msg_error("%s(%d), %s: socket create error=%s",
   "/workspace/acl/lib_acl/src/net/dns/acl_res.c", 78, __FUNCTION__, acl_last_serror());
  return -1;
 }

 memset(&addr, 0, sizeof(addr));
 addr.sin_family = 
# 83 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                       2
# 83 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
                              ;
 addr.sin_port = 
# 84 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                       (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 84 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
                       res->dns_port
# 84 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
...
{
 ACL_VSTREAM *stream = 
# 116 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                      ((void *)0)
# 116 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
                          ;
 char addr[256], *pbuf = 
# 117 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                         ((void *)0)
# 117 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
                             , *ptr, tbuf[3];
 unsigned short nsz, n;
 int ret;
# 130 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
 snprintf(addr, sizeof(addr), "%s:%d", res->dns_ip, res->dns_port);
 stream = acl_vstream_connect(addr, 0, res->conn_timeout,
   res->rw_timeout, 1024);
 if (stream == 
# 133 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
              ((void *)0)
# 133 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
                  ) {
  res->errnum = -104;
  do { if (pbuf) do { if (pbuf) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_res.c", 135, (pbuf)); (pbuf) = 
# 135 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
 ((void *)0)
# 135 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
 ; } } while (0); if (stream) acl_vstream_close(stream); return (-1); } while (0);
 }

 pbuf = acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_res.c", 138, 1, dlen + 2);
 nsz = 
# 139 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
      (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 139 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
      (short) dlen
# 139 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
      ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 139 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
 ...
 if (ret == (-1)) {
  res->errnum = -100;
  do { if (pbuf) do { if (pbuf) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_res.c", 148, (pbuf)); (pbuf) = 
# 148 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
 ((void *)0)
# 148 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
 ; } } while (0); if (stream) acl_vstream_close(stream); return (-1); } while (0);
 }
 ...
 if (ret == (-1)) {
  res->errnum = -101;
  do { if (pbuf) do { if (pbuf) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_res.c", 156, (pbuf)); (pbuf) = 
# 156 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
 ((void *)0)
# 156 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
 ; } } while (0); if (stream) acl_vstream_close(stream); return (-1); } while (0);
 }

 nsz = 
# 159 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
      (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 159 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
      n
# 159 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
      ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 159 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
 ...
 if (ret == (-1)) {
  res->errnum = -101;
  do { if (pbuf) do { if (pbuf) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_res.c", 165, (pbuf)); (pbuf) = 
# 165 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
 ((void *)0)
# 165 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
 ; } } while (0); if (stream) acl_vstream_close(stream); return (-1); } while (0);
 }

 do { if (pbuf) do { if (pbuf) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_res.c", 168, (pbuf)); (pbuf) = 
# 168 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
((void *)0)
# 168 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
; } } while (0); if (stream) acl_vstream_close(stream); return (ret); } while (0);
 ...
 const char *domain, int type)
{
 ...
 if (res == 
# 194 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
           ((void *)0)
# 194 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
               ) {
  acl_msg_error("%s(%d), %s: res NULL",
   "/workspace/acl/lib_acl/src/net/dns/acl_res.c", 196, __FUNCTION__);
  return 
# 197 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
        ((void *)0)
# 197 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
            ;
 }
 if (domain == 
# 199 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
              ((void *)0) 
# 199 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
                   || *domain == 0) {
  acl_msg_error("%s(%d), %s: domain %s", "/workspace/acl/lib_acl/src/net/dns/acl_res.c", 200,
   __FUNCTION__, domain ? "empty" : "null");
  return 
# 202 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
        ((void *)0)
# 202 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
            ;
 }
 ...
 if (type == 
# 208 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
            10
# 208 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
                    ) {
  ret = (ssize_t) acl_rfc1035_build_query4aaaa(domain, buf,
   sizeof(buf), res->cur_qid++, 
# 210 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                               ((void *)0)
# 210 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
                                   );
 } else {
  ret = (ssize_t) acl_rfc1035_build_query4a(domain, buf,
   sizeof(buf), res->cur_qid++, 
# 213 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                               ((void *)0)
# 213 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
                                   );
 }
 ...
 if (ret == 0) {
  acl_msg_error("%s(%d), %s: build a query error",
   "/workspace/acl/lib_acl/src/net/dns/acl_res.c", 223, __FUNCTION__);
  return 
# 224 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
        ((void *)0)
# 224 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
            ;
 }
 ...
 res->tm_spent = time(
# 229 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                     ((void *)0)
# 229 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
                         ) - begin;

 if (ret <= 0) {
  return 
# 232 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
        ((void *)0)
# 232 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
            ;
 }

 answers = acl_rfc1035_response_unpack(buf, ret);
 if (answers == 
# 236 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
               ((void *)0)
# 236 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
                   ) {
  res->errnum = -103;
  return 
# 238 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
        ((void *)0)
# 238 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
            ;
 } else if (answers->ancount == 0) {
  acl_rfc1035_message_destroy(answers);
  res->errnum = -103;
  return 
# 242 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
        ((void *)0)
# 242 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
            ;
 }
 ...
 for (i = 0; i < answers->ancount; i++) {
  if (answers->answer[i].type == 1) {
   phost = acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_res.c", 249, 1, sizeof(ACL_HOSTNAME));

   memcpy(&phost->saddr.in.sin_addr,
    answers->answer[i].rdata, 4);
   if (!inet_ntop(
# 253 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                 2
# 253 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
                        , &phost->saddr.in.sin_addr,
    phost->ip, sizeof(phost->ip))) {

    do { if (phost) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_res.c", 256, (phost)); (phost) = 
# 256 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
   ((void *)0)
# 256 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
   ; } } while (0);
    continue;
   }

   phost->saddr.sa.sa_family = 
# 260 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                              2
# 260 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
                                     ;
  ...
  } else if (answers->answer[i].type == 28) {
   phost = acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_res.c", 267, 1, sizeof(ACL_HOSTNAME));

   memcpy(&phost->saddr.in6.sin6_addr,
    answers->answer[i].rdata, 16);
   if (!inet_ntop(
# 271 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                 10
# 271 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
                         , &phost->saddr.in6.sin6_addr,
    phost->ip, sizeof(phost->ip))) {

    do { if (phost) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_res.c", 274, (phost)); (phost) = 
# 274 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
   ((void *)0)
# 274 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
   ; } } while (0);
    continue;
   }

   phost->saddr.sa.sa_family = 
# 278 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                              10
# 278 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
                                      ;
   phost->ttl = answers->answer[i].ttl;
   phost->type = 1;
   (void) acl_array_append(dns_db->h_db, phost);
   ...
   acl_msg_error("%s(%d), %s: answer type %d, domain %s",
    "/workspace/acl/lib_acl/src/net/dns/acl_res.c", 286, __FUNCTION__,
...
ACL_DNS_DB *acl_res_lookup(ACL_RES *res, const char *domain)
{
 return acl_res_lookup_with_type(res, domain, 
# 297 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                                             2
# 297 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
                                                    );
}
...
{
 return acl_res_lookup_with_type(res, domain, 
# 303 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                                             10
# 303 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
                                                     );
}
...
const char *acl_res_strerror(int errnum)
{
 ...
 static const struct __ERRMSG errmsg[] = {
  ...
  { -104, "connect error" },
  { 0, 
# 320 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
      ((void *)0) 
# 320 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
           },
 };
...
{
 if (res == 
# 334 "/workspace/acl/lib_acl/src/net/dns/acl_res.c" 3 4
           ((void *)0)
# 334 "/workspace/acl/lib_acl/src/net/dns/acl_res.c"
               ) {
