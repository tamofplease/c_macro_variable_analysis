# 0 "/acl/lib_acl/src/net/dns/acl_res.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/dns/acl_res.c"
...
# 2 "/acl/lib_acl/src/net/dns/acl_res.c" 2
# 25 "/acl/lib_acl/src/net/dns/acl_res.c"
...
ACL_RES *acl_res_new(const char *dns_ip, unsigned short dns_port)
{
 ...
 if (dns_ip == 
# 38 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
              ((void *)0) 
# 38 "/acl/lib_acl/src/net/dns/acl_res.c"
                   || *dns_ip == 0) {
  acl_msg_error("%s(%d), %s: dns_ip invalid",
   "/acl/lib_acl/src/net/dns/acl_res.c", 40, __FUNCTION__);
  return 
# 41 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
        ((void *)0)
# 41 "/acl/lib_acl/src/net/dns/acl_res.c"
            ;
 }
 ...
 res = acl_calloc_glue("/acl/lib_acl/src/net/dns/acl_res.c", 48, 1, sizeof(ACL_RES));
 res->cur_qid = (unsigned short) time(
# 49 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                                     ((void *)0)
# 49 "/acl/lib_acl/src/net/dns/acl_res.c"
                                         );
...
{
 if (res) {
  do { if (res) { acl_free_glue("/acl/lib_acl/src/net/dns/acl_res.c", 64, (res)); (res) = 
# 64 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
 ((void *)0)
# 64 "/acl/lib_acl/src/net/dns/acl_res.c"
 ; } } while (0);
 }
}
 ...
 char *buf, int size)
{
 ...
 fd = socket(
# 75 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
            2
# 75 "/acl/lib_acl/src/net/dns/acl_res.c"
                   , 
# 75 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                     SOCK_DGRAM
# 75 "/acl/lib_acl/src/net/dns/acl_res.c"
 ...
 if (fd == (int) -1) {
  acl_msg_error("%s(%d), %s: socket create error=%s",
   "/acl/lib_acl/src/net/dns/acl_res.c", 78, __FUNCTION__, acl_last_serror());
  return -1;
 }

 memset(&addr, 0, sizeof(addr));
 addr.sin_family = 
# 83 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                       2
# 83 "/acl/lib_acl/src/net/dns/acl_res.c"
                              ;
 addr.sin_port = 
# 84 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                       __bswap_16 (
# 84 "/acl/lib_acl/src/net/dns/acl_res.c"
                       res->dns_port
# 84 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                       )
# 84 "/acl/lib_acl/src/net/dns/acl_res.c"
...
{
 ACL_VSTREAM *stream = 
# 116 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                      ((void *)0)
# 116 "/acl/lib_acl/src/net/dns/acl_res.c"
                          ;
 char addr[256], *pbuf = 
# 117 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                         ((void *)0)
# 117 "/acl/lib_acl/src/net/dns/acl_res.c"
                             , *ptr, tbuf[3];
 unsigned short nsz, n;
 int ret;
# 130 "/acl/lib_acl/src/net/dns/acl_res.c"
 snprintf(addr, sizeof(addr), "%s:%d", res->dns_ip, res->dns_port);
 stream = acl_vstream_connect(addr, 0, res->conn_timeout,
   res->rw_timeout, 1024);
 if (stream == 
# 133 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
              ((void *)0)
# 133 "/acl/lib_acl/src/net/dns/acl_res.c"
                  ) {
  res->errnum = -104;
  do { if (pbuf) do { if (pbuf) { acl_free_glue("/acl/lib_acl/src/net/dns/acl_res.c", 135, (pbuf)); (pbuf) = 
# 135 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
 ((void *)0)
# 135 "/acl/lib_acl/src/net/dns/acl_res.c"
 ; } } while (0); if (stream) acl_vstream_close(stream); return (-1); } while (0);
 }

 pbuf = acl_calloc_glue("/acl/lib_acl/src/net/dns/acl_res.c", 138, 1, dlen + 2);
 nsz = 
# 139 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
      __bswap_16 (
# 139 "/acl/lib_acl/src/net/dns/acl_res.c"
      (short) dlen
# 139 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
      )
# 139 "/acl/lib_acl/src/net/dns/acl_res.c"
 ...
 if (ret == (-1)) {
  res->errnum = -100;
  do { if (pbuf) do { if (pbuf) { acl_free_glue("/acl/lib_acl/src/net/dns/acl_res.c", 148, (pbuf)); (pbuf) = 
# 148 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
 ((void *)0)
# 148 "/acl/lib_acl/src/net/dns/acl_res.c"
 ; } } while (0); if (stream) acl_vstream_close(stream); return (-1); } while (0);
 }
 ...
 if (ret == (-1)) {
  res->errnum = -101;
  do { if (pbuf) do { if (pbuf) { acl_free_glue("/acl/lib_acl/src/net/dns/acl_res.c", 156, (pbuf)); (pbuf) = 
# 156 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
 ((void *)0)
# 156 "/acl/lib_acl/src/net/dns/acl_res.c"
 ; } } while (0); if (stream) acl_vstream_close(stream); return (-1); } while (0);
 }

 nsz = 
# 159 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
      __bswap_16 (
# 159 "/acl/lib_acl/src/net/dns/acl_res.c"
      n
# 159 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
      )
# 159 "/acl/lib_acl/src/net/dns/acl_res.c"
 ...
 if (ret == (-1)) {
  res->errnum = -101;
  do { if (pbuf) do { if (pbuf) { acl_free_glue("/acl/lib_acl/src/net/dns/acl_res.c", 165, (pbuf)); (pbuf) = 
# 165 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
 ((void *)0)
# 165 "/acl/lib_acl/src/net/dns/acl_res.c"
 ; } } while (0); if (stream) acl_vstream_close(stream); return (-1); } while (0);
 }

 do { if (pbuf) do { if (pbuf) { acl_free_glue("/acl/lib_acl/src/net/dns/acl_res.c", 168, (pbuf)); (pbuf) = 
# 168 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
((void *)0)
# 168 "/acl/lib_acl/src/net/dns/acl_res.c"
 ...
 const char *domain, int type)
{
 ...
 if (res == 
# 194 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
           ((void *)0)
# 194 "/acl/lib_acl/src/net/dns/acl_res.c"
               ) {
  acl_msg_error("%s(%d), %s: res NULL",
   "/acl/lib_acl/src/net/dns/acl_res.c", 196, __FUNCTION__);
  return 
# 197 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
        ((void *)0)
# 197 "/acl/lib_acl/src/net/dns/acl_res.c"
            ;
 }
 if (domain == 
# 199 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
              ((void *)0) 
# 199 "/acl/lib_acl/src/net/dns/acl_res.c"
                   || *domain == 0) {
  acl_msg_error("%s(%d), %s: domain %s", "/acl/lib_acl/src/net/dns/acl_res.c", 200,
   __FUNCTION__, domain ? "empty" : "null");
  return 
# 202 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
        ((void *)0)
# 202 "/acl/lib_acl/src/net/dns/acl_res.c"
            ;
 }
 ...
 if (type == 
# 208 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
            10
# 208 "/acl/lib_acl/src/net/dns/acl_res.c"
                    ) {
  ret = (ssize_t) acl_rfc1035_build_query4aaaa(domain, buf,
   sizeof(buf), res->cur_qid++, 
# 210 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                               ((void *)0)
# 210 "/acl/lib_acl/src/net/dns/acl_res.c"
                                   );
 } else {
  ret = (ssize_t) acl_rfc1035_build_query4a(domain, buf,
   sizeof(buf), res->cur_qid++, 
# 213 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                               ((void *)0)
# 213 "/acl/lib_acl/src/net/dns/acl_res.c"
                                   );
 }
 ...
 if (ret == 0) {
  acl_msg_error("%s(%d), %s: build a query error",
   "/acl/lib_acl/src/net/dns/acl_res.c", 223, __FUNCTION__);
  return 
# 224 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
        ((void *)0)
# 224 "/acl/lib_acl/src/net/dns/acl_res.c"
            ;
 }
 ...
 res->tm_spent = time(
# 229 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                     ((void *)0)
# 229 "/acl/lib_acl/src/net/dns/acl_res.c"
                         ) - begin;

 if (ret <= 0) {
  return 
# 232 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
        ((void *)0)
# 232 "/acl/lib_acl/src/net/dns/acl_res.c"
            ;
 }

 answers = acl_rfc1035_response_unpack(buf, ret);
 if (answers == 
# 236 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
               ((void *)0)
# 236 "/acl/lib_acl/src/net/dns/acl_res.c"
                   ) {
  res->errnum = -103;
  return 
# 238 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
        ((void *)0)
# 238 "/acl/lib_acl/src/net/dns/acl_res.c"
            ;
 } else if (answers->ancount == 0) {
  acl_rfc1035_message_destroy(answers);
  res->errnum = -103;
  return 
# 242 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
        ((void *)0)
# 242 "/acl/lib_acl/src/net/dns/acl_res.c"
            ;
 }
 ...
 for (i = 0; i < answers->ancount; i++) {
  if (answers->answer[i].type == 1) {
   phost = acl_calloc_glue("/acl/lib_acl/src/net/dns/acl_res.c", 249, 1, sizeof(ACL_HOSTNAME));

   memcpy(&phost->saddr.in.sin_addr,
    answers->answer[i].rdata, 4);
   if (!inet_ntop(
# 253 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                 2
# 253 "/acl/lib_acl/src/net/dns/acl_res.c"
                        , &phost->saddr.in.sin_addr,
    phost->ip, sizeof(phost->ip))) {

    do { if (phost) { acl_free_glue("/acl/lib_acl/src/net/dns/acl_res.c", 256, (phost)); (phost) = 
# 256 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
   ((void *)0)
# 256 "/acl/lib_acl/src/net/dns/acl_res.c"
   ; } } while (0);
    continue;
   }

   phost->saddr.sa.sa_family = 
# 260 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                              2
# 260 "/acl/lib_acl/src/net/dns/acl_res.c"
                                     ;
   ...
   phost = acl_calloc_glue("/acl/lib_acl/src/net/dns/acl_res.c", 267, 1, sizeof(ACL_HOSTNAME));

   memcpy(&phost->saddr.in6.sin6_addr,
    answers->answer[i].rdata, 16);
   if (!inet_ntop(
# 271 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                 10
# 271 "/acl/lib_acl/src/net/dns/acl_res.c"
                         , &phost->saddr.in6.sin6_addr,
    phost->ip, sizeof(phost->ip))) {

    do { if (phost) { acl_free_glue("/acl/lib_acl/src/net/dns/acl_res.c", 274, (phost)); (phost) = 
# 274 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
   ((void *)0)
# 274 "/acl/lib_acl/src/net/dns/acl_res.c"
   ; } } while (0);
    continue;
   }

   phost->saddr.sa.sa_family = 
# 278 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                              10
# 278 "/acl/lib_acl/src/net/dns/acl_res.c"
                                      ;
   phost->ttl = answers->answer[i].ttl;
   phost->type = 1;
   (void) acl_array_append(dns_db->h_db, phost);
   ...
   acl_msg_error("%s(%d), %s: answer type %d, domain %s",
    "/acl/lib_acl/src/net/dns/acl_res.c", 286, __FUNCTION__,
...
# 297 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                                             2
# 297 "/acl/lib_acl/src/net/dns/acl_res.c"
                                                    );
}
...
{
 return acl_res_lookup_with_type(res, domain, 
# 303 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
                                             10
# 303 "/acl/lib_acl/src/net/dns/acl_res.c"
                                                     );
}
...
const char *acl_res_strerror(int errnum)
{
 ...
 static const struct __ERRMSG errmsg[] = {
  ...
  { -104, "connect error" },
  { 0, 
# 320 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
      ((void *)0) 
# 320 "/acl/lib_acl/src/net/dns/acl_res.c"
           },
 };
...
{
 if (res == 
# 334 "/acl/lib_acl/src/net/dns/acl_res.c" 3 4
           ((void *)0)
# 334 "/acl/lib_acl/src/net/dns/acl_res.c"
               ) {
