# 0 "/acl/lib_acl/src/net/dns/res_util.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/dns/res_util.c"
...
# 2 "/acl/lib_acl/src/net/dns/res_util.c" 2
# 11 "/acl/lib_acl/src/net/dns/res_util.c"
# 1 "/acl/lib_acl/src/net/dns/util.h" 1
# 9 "/acl/lib_acl/src/net/dns/util.h"
ACL_ARGV *res_a_create(const ACL_RFC1035_RR *answer, int n);
# 12 "/acl/lib_acl/src/net/dns/res_util.c" 2
...
ACL_ARGV *res_a_create(const ACL_RFC1035_RR *answer, int n)
{
 ...
 if (n <= 0)
  return (
# 21 "/acl/lib_acl/src/net/dns/res_util.c" 3 4
         ((void *)0)
# 21 "/acl/lib_acl/src/net/dns/res_util.c"
             );
 ...
 for (i = 0; i < n; i++) {
  if (answer[i].type == 1) {
   ...
   if (inet_ntop(
# 28 "/acl/lib_acl/src/net/dns/res_util.c" 3 4
                2
# 28 "/acl/lib_acl/src/net/dns/res_util.c"
                       , &sin_addr, ip, sizeof(ip))) {
    acl_argv_add(a, ip, 
# 29 "/acl/lib_acl/src/net/dns/res_util.c" 3 4
                       ((void *)0)
# 29 "/acl/lib_acl/src/net/dns/res_util.c"
                           );
   }
  }
 }
