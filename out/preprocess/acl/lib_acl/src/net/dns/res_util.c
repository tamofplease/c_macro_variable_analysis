# 1 "/workspace/acl/lib_acl/src/net/dns/res_util.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/net/dns/res_util.c" 2
# 11 "/workspace/acl/lib_acl/src/net/dns/res_util.c"
# 1 "/workspace/acl/lib_acl/src/net/dns/util.h" 1
# 9 "/workspace/acl/lib_acl/src/net/dns/util.h"
ACL_ARGV *res_a_create(const ACL_RFC1035_RR *answer, int n);
# 12 "/workspace/acl/lib_acl/src/net/dns/res_util.c" 2
...
ACL_ARGV *res_a_create(const ACL_RFC1035_RR *answer, int n)
{
 ...
 if (n <= 0)
  return (
# 21 "/workspace/acl/lib_acl/src/net/dns/res_util.c" 3 4
         ((void *)0)
# 21 "/workspace/acl/lib_acl/src/net/dns/res_util.c"
             );
 ...
 for (i = 0; i < n; i++) {
  if (answer[i].type == 1) {
   ...
   if (inet_ntop(
# 28 "/workspace/acl/lib_acl/src/net/dns/res_util.c" 3 4
                2
# 28 "/workspace/acl/lib_acl/src/net/dns/res_util.c"
                       , &sin_addr, ip, sizeof(ip))) {
    acl_argv_add(a, ip, 
# 29 "/workspace/acl/lib_acl/src/net/dns/res_util.c" 3 4
                       ((void *)0)
# 29 "/workspace/acl/lib_acl/src/net/dns/res_util.c"
                           );
   }
  }
 }
