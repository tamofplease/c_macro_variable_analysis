# 1 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 2
# 40 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
static size_t rfc1035_header_pack(char *buf, size_t sz, ACL_RFC1035_MESSAGE * hdr)
{
 ...
 s = 
# 51 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 51 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
    hdr->id
# 51 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
...
# 51 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 t |= hdr->rcode;
 s = 
# 62 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 62 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
    t
# 62 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 62 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 off += sizeof(s);
 s = 
# 65 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 65 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
    hdr->qdcount
# 65 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 65 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 off += sizeof(s);
 s = 
# 68 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 68 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
    hdr->ancount
# 68 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 68 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 off += sizeof(s);
 s = 
# 71 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 71 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
    hdr->nscount
# 71 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 71 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 off += sizeof(s);
 s = 
# 74 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 74 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
    hdr->arcount
# 74 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 74 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
...
# 91 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
static int rfc1035_label_pack(char *buf, size_t sz, const char *label)
{
 ...
 if (label) {
  if (strchr(label, '.') != 
# 98 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
                           ((void *)0)
# 98 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
                               ) {
...
# 126 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
static int rfc1035_name_pack(char *buf, size_t sz, const char *name)
{
 ...
 copy = acl_strdup_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 133, (name));



 ptr = copy;
 for (t = acl_strtok(&ptr, "."); t; t = acl_strtok(&ptr, ".")) {
  off += rfc1035_label_pack(buf + off, sz - off, t);
 }
 do { if (copy) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 141, (copy)); (copy) = 
# 141 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
((void *)0)
# 141 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
; } } while (0);
 off += rfc1035_label_pack(buf + off, sz - off, 
# 142 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
                                               ((void *)0)
# 142 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
                                                   );
 if (off > (int) sz) {
 ...
 unsigned short type, unsigned short tclass)
{
 ...
 s = 
# 164 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 164 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
    type
# 164 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 164 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 s = 
# 168 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 168 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
    tclass
# 168 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 168 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
...
# 195 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 unsigned short *rdlength, char *name, size_t ns, int rdepth)
{
 ...
 do {
  ...
  if (c > 191) {
   ...
   s = 
# 222 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
      (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 222 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
      s
# 222 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
      ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 222 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
...
const char *acl_rfc1035_strerror(int errnum)
{
 ...
 static const struct __ERRMSG errmsg[] = {
  ...
  { -1, 
# 294 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
       ((void *)0) 
# 294 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
            },
 };
...
# 299 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
                             ((void *)0)
# 299 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
                                 ; i++) {
...
# 310 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
(*__errno_location ()) 
# 310 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
      = n;
}
...
# 355 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
static int rfc1035_rr_pack(const ACL_RFC1035_RR *RR, char *buf, size_t sz)
{
 ...
 s = 
# 363 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 363 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
    RR->type
# 363 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 363 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 s = 
# 367 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 367 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
    RR->tclass
# 367 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 367 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 i = 
# 371 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    __bswap_32 (
# 371 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
    RR->ttl
# 371 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    )
# 371 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 case 16:
  ...
  s = 
# 388 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
     (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 388 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
     s
# 388 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
     ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 388 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 default:
  s = 
# 392 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
     (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 392 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
     RR->rdlength
# 392 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
     ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 392 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 ACL_RFC1035_QUERY *query)
{
 ...
 if (query) {
  query->qtype = qtype;
  query->qclass = qclass;
  do { if (sizeof(query->name) > 0) { size_t _n = strlen(hostname); _n = _n > (size_t ) sizeof(query->name) - 1? (size_t) sizeof(query->name) - 1 : _n; memcpy(query->name, hostname, _n); query->name[_n] = 0; } } while (0);
 }
...
{
 return rfc1035_build_query(hostname, buf, sz, qid, 1,
    1, query);
}
...
size_t acl_rfc1035_build_query4aaaa(const char *hostname, char *buf, size_t sz,
 unsigned short qid, ACL_RFC1035_QUERY *query)
{
 return rfc1035_build_query(hostname, buf, sz, qid, 28,
   1, query);
}
...
size_t acl_rfc1035_build_query4mx(const char *hostname, char *buf, size_t sz,
 unsigned short qid, ACL_RFC1035_QUERY *query)
{
 return rfc1035_build_query(hostname, buf, sz, qid, 15,
   1, query);
}
 ...
 size_t sz, unsigned short qid, ACL_RFC1035_QUERY * query)
{
 ...
 memset(&h, '\0', sizeof(h));
 i = (unsigned int) 
# 475 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
                   __bswap_32 (
# 475 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
                   addr.s_addr
# 475 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
                   )
# 475 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 if (query) {
  query->qtype = 12;
  query->qclass = 1;
  do { if (sizeof(query->name) > 0) { size_t _n = strlen(rev); _n = _n > (size_t ) sizeof(query->name) - 1? (size_t) sizeof(query->name) - 1 : _n; memcpy(query->name, rev, _n); query->name[_n] = 0; } } while (0);
 }
...
{
 unsigned short s = 
# 505 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
                   (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 505 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
                   qid
# 505 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
                   ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 505 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
...
# 526 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 ACL_RFC1035_MESSAGE *h)
{
 ...
 h->id = 
# 549 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
        (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 549 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
        s
# 549 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
        ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 549 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 t = 
# 553 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 553 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
    s
# 553 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
    ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 553 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 (*off) += sizeof(s);
 h->qdcount = 
# 569 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
             (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 569 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
             s
# 569 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
             ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 569 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 (*off) += sizeof(s);
 h->ancount = 
# 573 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
             (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 573 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
             s
# 573 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
             ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 573 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 (*off) += sizeof(s);
 h->nscount = 
# 577 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
             (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 577 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
             s
# 577 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
             ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 577 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 (*off) += sizeof(s);
 h->arcount = 
# 581 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
             (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 581 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
             s
# 581 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
             ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 581 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
...
# 599 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
static int rfc1035_query_unpack(const char *buf, size_t sz, size_t *off,
 ACL_RFC1035_QUERY *query)
{
 unsigned short s;

 if (rfc1035_name_unpack(buf, sz, off, 
# 604 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
                                      ((void *)0)
# 604 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
                                          , query->name,
  256, 0)) {
 ...
 *off += 2;
 query->qtype = 
# 620 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
               (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 620 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
               s
# 620 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
               ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 620 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 *off += 2;
 query->qclass = 
# 624 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
                (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 624 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
                s
# 624 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
                ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 624 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
...
# 639 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
static int rfc1035_rr_unpack(const char *buf, size_t sz, size_t *off, ACL_RFC1035_RR *RR)
{
 ...
 if (rfc1035_name_unpack(buf, sz, off, 
# 647 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
                                      ((void *)0)
# 647 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
                                          , RR->name,
  256, 0)) {
 ...
 (*off) += sizeof(s);
 RR->type = 
# 666 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
           (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 666 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
           s
# 666 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
           ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 666 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 (*off) += sizeof(s);
 RR->tclass = 
# 670 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
             (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 670 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
             s
# 670 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
             ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 670 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 (*off) += sizeof(i);
 RR->ttl = 
# 674 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
          __bswap_32 (
# 674 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
          i
# 674 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
          )
# 674 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 (*off) += sizeof(s);
 rdlength = 
# 678 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
           (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 678 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
           s
# 678 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
           ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 678 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ...
 case 12:
 case 11:
  RR->rdata = (char*) acl_malloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 698, 256);
  rdata_off = *off;
  RR->rdlength = 0;
  ...
  if (rdata_off > ((*off) + rdlength)) {
   ...
   (void) 0;
   do { if (RR->rdata) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 713, (RR->rdata)); (RR->rdata) = 
# 713 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
  ((void *)0)
# 713 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
  ; } } while (0);
   memset(RR, '\0', sizeof(*RR));
   return 1;
  }
 ...
 case 15:
 default:
  RR->rdata = (char*) acl_malloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 722, rdlength);
 ...
 *nr = 0;
 ...
 if (count == 0) {
  return 
# 746 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
        ((void *)0)
# 746 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
            ;
 }

 rr = (ACL_RFC1035_RR*) acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 749, count, sizeof(ACL_RFC1035_RR));
 for (i = 0; i < count; i++) {
  if (*off >= sz) {
   (void) 0;
   break;
 ...
 if (*nr == 0) {
  do { if (rr) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 764, (rr)); (rr) = 
# 764 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
 ((void *)0)
# 764 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ; } } while (0);
  return 
# 765 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
        ((void *)0)
# 765 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
            ;
 }
...
# 777 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
(*__errno_location ()) 
# 777 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
      = 0;
 msg = (ACL_RFC1035_MESSAGE*) acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 778, 1, sizeof(*msg));

 if (rfc1035_header_unpack(buf + off, sz - off, &off, msg)) {
  (void) 0;
  rfc1035_set_errno(15);
  acl_rfc1035_message_destroy(msg);
  return 
# 784 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
        ((void *)0)
# 784 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
            ;
 }
 ...
 if (msg->qdcount != 1) {
  ...
  acl_msg_warn("%s(%d): invalid qdcount=%d > 0",
   __FUNCTION__, 798, (int) msg->qdcount);
 }

 msg->query = (ACL_RFC1035_QUERY*) acl_calloc_glue(
                            "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
# 801 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
                                   ,
                            802
# 801 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
                                   , (int) msg->qdcount, sizeof(ACL_RFC1035_QUERY))
                             ;

 for (i = 0; i < (int) msg->qdcount; i++) {
  if (rfc1035_query_unpack(buf, sz, &off, &msg->query[i])) {
   acl_msg_error("%s(%d): unpack error", __FUNCTION__, 806);
   acl_rfc1035_message_destroy(msg);
   return 
# 808 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
         ((void *)0)
# 808 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
             ;
  }
 }

 msg->answer = rfc1035_unpack2rr(buf, sz, &off, msg->ancount, &nr);
 msg->ancount = (unsigned short) nr;
 ...
 if (msg->nscount > 0) {
  ...
  if (msg->authority == 
# 819 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
                       ((void *)0)
# 819 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
                           ) {
   acl_msg_error("%s(%d): nscount=%d, authority null",
    __FUNCTION__, 821, (int) msg->nscount);
   acl_rfc1035_message_destroy(msg);
   return 
# 823 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
         ((void *)0)
# 823 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
             ;
  }
 }
 ...
 if (msg->arcount > 0) {
  ...
  if (msg->additional == 
# 831 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
                        ((void *)0)
# 831 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
                            ) {
   acl_msg_error("%s(%d): arcount=%d, addrional null",
    __FUNCTION__, 833, (int) msg->arcount);
   acl_rfc1035_message_destroy(msg);
   return 
# 835 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
         ((void *)0)
# 835 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
             ;
  }
 }
...
# 848 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
(*__errno_location ()) 
# 848 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
      = 0;
 msg = (ACL_RFC1035_MESSAGE*) acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 849, 1, sizeof(*msg));
 ...
 if (rfc1035_header_unpack(buf + off, sz - off, &off, msg)) {
  ...
  acl_rfc1035_message_destroy(msg);
  return 
# 855 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
        ((void *)0)
# 855 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
            ;
 }
 ...
 if (msg->rcode) {
  ...
  acl_rfc1035_message_destroy(msg);
  return 
# 862 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
        ((void *)0)
# 862 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
            ;
 }
 ...
 if (msg->qdcount != 1) {
  ...
  acl_rfc1035_message_destroy(msg);
  return 
# 870 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
        ((void *)0)
# 870 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
            ;
 }

 msg->query = (ACL_RFC1035_QUERY*) acl_calloc_glue(
                            "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
# 873 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
                                   ,
                            874
# 873 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
                                   , (int) msg->qdcount, sizeof(ACL_RFC1035_QUERY))
...
static void rfc1035_rr_destroy(ACL_RFC1035_RR * rr, int n)
{
 ...
 if (rr == 
# 893 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
          ((void *)0)
# 893 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
              ) {
  return;
 }
 ...
 if (n <= 0) {
  ...
  do { if (rr) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 899, (rr)); (rr) = 
# 899 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
 ((void *)0)
# 899 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ; } } while (0);
  return;
 }
 ...
 while (n--) {
  if (rr[n].rdata) {
   do { if (rr[n].rdata) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 905, (rr[n].rdata)); (rr[n].rdata) = 
# 905 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
  ((void *)0)
# 905 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
  ; } } while (0);
  }
 }

 do { if (rr) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 909, (rr)); (rr) = 
# 909 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
((void *)0)
# 909 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
; } } while (0);
}
...
void acl_rfc1035_message_destroy(ACL_RFC1035_MESSAGE *msg)
{
 ...
 if (msg->query) {
  do { if (msg->query) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 919, (msg->query)); (msg->query) = 
# 919 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
 ((void *)0)
# 919 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ; } } while (0);
 }
 ...
 do { if (msg) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 934, (msg)); (msg) = 
# 934 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
((void *)0)
# 934 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
; } } while (0);
}
...
static size_t save_addr2rr(int type, const char *src, ACL_RFC1035_RR *rr)
{
 if (type == 1) {
  ...
  rr->rdlength = 4;
  nip = inet_addr(src);
  rr->rdata = (char*) acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 983, 1, rr->rdlength);
  ...
  do { if (sizeof(buf) > 0) { size_t _n = strlen(src); _n = _n > (size_t ) sizeof(buf) - 1? (size_t) sizeof(buf) - 1 : _n; memcpy(buf, src, _n); buf[_n] = 0; } } while (0);
  ...
  in6.sin6_family = 
# 999 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
                   10
# 999 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
                           ;
  in6.sin6_port = 
# 1000 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
                   (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 1000 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
                   0
# 1000 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
                   ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 1000 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
  ...
  if (ptr && *ptr && !(in6.sin6_scope_id = if_nametoindex(ptr))) {
   acl_msg_error("%s(%d): if_nametoindex error %s",
    __FUNCTION__, 1005, acl_last_serror());
   return 0;
  }

  if (inet_pton(
# 1009 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
               10
# 1009 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
                       , buf, &in6.sin6_addr) == 0) {
   acl_msg_error("%s(%d): invalid addr=%s",
    __FUNCTION__, 1011, src);
   return 0;
  }

  rr->rdlength = sizeof(in6.sin6_addr);
  rr->rdata = (char*) acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 1016, 1, rr->rdlength);
...
size_t acl_rfc1035_build_reply(const ACL_RFC1035_REPLY *reply, char *buf, size_t sz)
{
 ...
 if (reply->ips == 
# 1036 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
                  ((void *)0) 
# 1036 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
                       || reply->ips->argc <= 0) {
  return 0;
 }
 ...
 offset += rfc1035_header_pack(buf + offset, sz - offset, &h);
 offset += rfc1035_question_pack(buf + offset, sz - offset,
   reply->hostname, reply->ip_type, 1);

 if (reply->cname && *reply->cname) {
  memset(&rr, 0, sizeof(rr));
  do { if (sizeof(rr.name) > 0) { size_t _n = strlen(reply->hostname); _n = _n > (size_t ) sizeof(rr.name) - 1? (size_t) sizeof(rr.name) - 1 : _n; memcpy(rr.name, reply->hostname, _n); rr.name[_n] = 0; } } while (0);
  rr.type = 5;
  rr.tclass = 1;
  rr.ttl = reply->ttl;
  rr.rdlength = (unsigned short) strlen(reply->cname);
  rr.rdata = acl_strdup_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 1066, (reply->cname));
  offset += rfc1035_rr_pack(&rr, buf + offset, sz - offset);
  do { if (rr.rdata) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 1068, (rr.rdata)); (rr.rdata) = 
# 1068 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
 ((void *)0)
# 1068 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ; } } while (0);
  rr.rdata = 
# 1069 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
            ((void *)0)
# 1069 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
                ;
 }
 ...
 for (i = 0; i < reply->ips->argc; i++) {
  ...
  if (!save_addr2rr(reply->ip_type, reply->ips->argv[i], &rr)) {
   acl_msg_error("%s(%d): invalid ip=%s",
    __FUNCTION__ , 1081, reply->ips->argv[i]);
   return 0;
  }

  offset += rfc1035_rr_pack(&rr, buf + offset, sz - offset);
  do { if (rr.rdata) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 1086, (rr.rdata)); (rr.rdata) = 
# 1086 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
 ((void *)0)
# 1086 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ; } } while (0);
 }

 if (h.nscount) {
  memset(&rr, 0, sizeof(rr));
  do { if (sizeof(rr.name) > 0) { size_t _n = strlen(reply->domain_root); _n = _n > (size_t ) sizeof(rr.name) - 1? (size_t) sizeof(rr.name) - 1 : _n; memcpy(rr.name, reply->domain_root, _n); rr.name[_n] = 0; } } while (0);
  rr.type = 2;
  rr.tclass = 1;
  rr.ttl = reply->ttl;
  rr.rdlength = (unsigned short) strlen(reply->dns_name);
  rr.rdata = acl_strdup_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 1096, (reply->dns_name));
  offset += rfc1035_rr_pack(&rr, buf + offset, sz - offset);
  do { if (rr.rdata) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 1098, (rr.rdata)); (rr.rdata) = 
# 1098 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
 ((void *)0)
# 1098 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ; } } while (0);
 }

 if (h.arcount) {
  memset(&rr, 0, sizeof(rr));
  do { if (sizeof(rr.name) > 0) { size_t _n = strlen(reply->dns_name); _n = _n > (size_t ) sizeof(rr.name) - 1? (size_t) sizeof(rr.name) - 1 : _n; memcpy(rr.name, reply->dns_name, _n); rr.name[_n] = 0; } } while (0);
  rr.type = reply->ip_type;
  rr.tclass = 1;
  rr.ttl = reply->ttl;
  ...
  if (!save_addr2rr(reply->ip_type, reply->dns_ip, &rr)) {
   acl_msg_error("%s(%d): invalid ip=%s",
    __FUNCTION__ , 1110, reply->dns_ip);
   return 0;
  }

  offset += rfc1035_rr_pack(&rr, buf + offset, sz - offset);
  do { if (rr.rdata) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c", 1115, (rr.rdata)); (rr.rdata) = 
# 1115 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c" 3 4
 ((void *)0)
# 1115 "/workspace/acl/lib_acl/src/net/dns/acl_rfc1035.c"
 ; } } while (0);
 }
