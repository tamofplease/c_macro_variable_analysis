# 0 "/acl/lib_acl/src/net/dns/acl_netdb.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/dns/acl_netdb.c"
...
# 2 "/acl/lib_acl/src/net/dns/acl_netdb.c" 2
# 33 "/acl/lib_acl/src/net/dns/acl_netdb.c"
const ACL_HOSTNAME *acl_netdb_index(const ACL_DNS_DB *db, int n)
{
 ACL_HOSTNAME *h_hostname;

 if (db == 
# 37 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
          ((void *)0) 
# 37 "/acl/lib_acl/src/net/dns/acl_netdb.c"
               || n < 0) {
  acl_msg_error("%s, %s(%d): input error",
   "/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 39);
  return 
# 40 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 40 "/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }

 if (db->size == 0) {
  acl_msg_error("%s, %s(%d): dns db size is 0",
   "/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 45);
  return 
# 46 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 46 "/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }
 if (n >= db->size) {
  acl_msg_error("%s, %s(%d): index(%d) > size(%d)",
   "/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 50, n, db->size);
  return 
# 51 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 51 "/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }
...
const ACL_SOCKADDR *acl_netdb_index_saddr(ACL_DNS_DB *db, int n)
{
 ...
 if (db == 
# 62 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
          ((void *)0) 
# 62 "/acl/lib_acl/src/net/dns/acl_netdb.c"
               || n < 0) {
  acl_msg_error("%s, %s(%d): input error",
   "/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 64);
  return 
# 65 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 65 "/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }
 if (db->size == 0) {
  acl_msg_error("%s, %s(%d): dns db size is 0",
   "/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 69);
  return 
# 70 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 70 "/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }
 if (n >= db->size) {
  acl_msg_error("%s, %s(%d): index(%d) > size(%d)",
   "/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 74, n, db->size);
  return 
# 75 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 75 "/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }
...
const char *acl_netdb_index_ip(const ACL_DNS_DB *db, int n)
{
 ...
 if (db == 
# 86 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
          ((void *)0) 
# 86 "/acl/lib_acl/src/net/dns/acl_netdb.c"
               || n < 0) {
  acl_msg_error("%s, %s(%d): input error",
   "/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 88);
  return 
# 89 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 89 "/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }
 if (db->size == 0) {
  acl_msg_error("%s, %s(%d): dns db size is 0",
   "/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 93);
  return 
# 94 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 94 "/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }
 if (n >= db->size) {
  acl_msg_error("%s, %s(%d): index(%d) > size(%d)",
   "/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 98, n, db->size);
  return 
# 99 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 99 "/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }
 h_hostname = (ACL_HOSTNAME *) acl_array_index(db->h_db, n);
...
void acl_netdb_refer_oper(ACL_DNS_DB *db, int idx, int value)
{
 ...
 if (db == 
# 109 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
          ((void *)0) 
# 109 "/acl/lib_acl/src/net/dns/acl_netdb.c"
               || idx < 0) {
  acl_msg_error("%s, %s(%d): input error",
   "/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 111);
  return;
 }

 if (db->size == 0) {
  acl_msg_error("%s, %s(%d): dns db size is 0",
   "/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 117);
  return;
 }
 if (idx >= db->size) {
  acl_msg_error("%s, %s(%d): index(%d) > size(%d)",
   "/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 122, idx, db->size);
  return;
 }
...
{
 if (db == 
# 141 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
          ((void *)0)
# 141 "/acl/lib_acl/src/net/dns/acl_netdb.c"
              ) {
  acl_msg_error("%s, %s(%d): input invalid",
   "/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 143);
  return -1;
 }
...
{
 do { if (ctx) { acl_free_glue("/acl/lib_acl/src/net/dns/acl_netdb.c", 152, (ctx)); (ctx) = 
# 152 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
((void *)0)
# 152 "/acl/lib_acl/src/net/dns/acl_netdb.c"
; } } while (0);
}
...
{
 if (db == 
# 157 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
          ((void *)0)
# 157 "/acl/lib_acl/src/net/dns/acl_netdb.c"
              )
  return;
 if (db->h_db)
  acl_array_free(db->h_db, free_dns_db);
 do { if (db) { acl_free_glue("/acl/lib_acl/src/net/dns/acl_netdb.c", 161, (db)); (db) = 
# 161 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
((void *)0)
# 161 "/acl/lib_acl/src/net/dns/acl_netdb.c"
; } } while (0);
}
...
# 187 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                                                ((void *)0)
# 187 "/acl/lib_acl/src/net/dns/acl_netdb.c"
                                                    ;
}
...
ACL_DNS_DB *acl_netdb_new(const char *domain)
{
 ...
 db = acl_calloc_glue("/acl/lib_acl/src/net/dns/acl_netdb.c", 199, 1, sizeof(ACL_DNS_DB));
...
static int ip2addr(const char *ip, unsigned short port, ACL_SOCKADDR *saddr)
{
 ...
 if (acl_valid_ipv4_hostaddr(ip, 0)) {
  saddr->sa.sa_family = 
# 224 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                       2
# 224 "/acl/lib_acl/src/net/dns/acl_netdb.c"
                              ;
  saddr->in.sin_port = 
# 225 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                       __bswap_16 (
# 225 "/acl/lib_acl/src/net/dns/acl_netdb.c"
                       port
# 225 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                       )
# 225 "/acl/lib_acl/src/net/dns/acl_netdb.c"
  ...
  if (inet_pton(
# 227 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
               2
# 227 "/acl/lib_acl/src/net/dns/acl_netdb.c"
  ...
  saddr->sa.sa_family = 
# 235 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                        10
# 235 "/acl/lib_acl/src/net/dns/acl_netdb.c"
                                ;
  saddr->in6.sin6_port = 
# 236 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                        __bswap_16 (
# 236 "/acl/lib_acl/src/net/dns/acl_netdb.c"
                        port
# 236 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                        )
# 236 "/acl/lib_acl/src/net/dns/acl_netdb.c"
                                   ;
  if (inet_pton(
# 237 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
               10
# 237 "/acl/lib_acl/src/net/dns/acl_netdb.c"
...
void acl_netdb_add_addr(ACL_DNS_DB *db, const char *ip, int hport)
{
 ...
 if (db == 
# 253 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
          ((void *)0) 
# 253 "/acl/lib_acl/src/net/dns/acl_netdb.c"
               || db->h_db == 
# 253 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                              ((void *)0) 
# 253 "/acl/lib_acl/src/net/dns/acl_netdb.c"
...
# 253 "/acl/lib_acl/src/net/dns/acl_netdb.c"
 ...
 phost = acl_calloc_glue("/acl/lib_acl/src/net/dns/acl_netdb.c", 266, 1, sizeof(ACL_HOSTNAME));
...
ACL_DNS_DB *acl_netdb_clone(const ACL_DNS_DB *db)
{
 ...
 if (db == 
# 281 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
          ((void *)0) 
# 281 "/acl/lib_acl/src/net/dns/acl_netdb.c"
               || db->h_db == 
# 281 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                              ((void *)0)
# 281 "/acl/lib_acl/src/net/dns/acl_netdb.c"
  ...
  return 
# 282 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 282 "/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;

 n = acl_array_size(db->h_db);
 if (n <= 0) {
  acl_msg_error("%s, %s(%d): h_db's size(%d) <= 0",
   "/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 287, n);
  return 
# 288 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 288 "/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }
...
# 296 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
 ((void) sizeof ((
# 296 "/acl/lib_acl/src/net/dns/acl_netdb.c"
 phost
# 296 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
...
# 296 "/acl/lib_acl/src/net/dns/acl_netdb.c"
 "phost"
# 296 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
 , "/acl/lib_acl/src/net/dns/acl_netdb.c", 296, __extension__ __PRETTY_FUNCTION__); }))
# 296 "/acl/lib_acl/src/net/dns/acl_netdb.c"
                  ;

  h_host = acl_calloc_glue("/acl/lib_acl/src/net/dns/acl_netdb.c", 298, 1, sizeof(ACL_HOSTNAME));
...
# 312 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                                SOCK_DGRAM
# 312 "/acl/lib_acl/src/net/dns/acl_netdb.c"
                                          , 
# 312 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                                            0
# 312 "/acl/lib_acl/src/net/dns/acl_netdb.c"
 ...
 int family, int *h_error)
{
 ...
 if (ip2addr(name, 0, &saddr)) {
  ACL_HOSTNAME *h_host = acl_calloc_glue("/acl/lib_acl/src/net/dns/acl_netdb.c", 334, 1, sizeof(ACL_HOSTNAME));
 ...
 if (res0 == 
# 344 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
            ((void *)0)
# 344 "/acl/lib_acl/src/net/dns/acl_netdb.c"
                ) {
  acl_netdb_free(db);
  return 
# 346 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 346 "/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }

 for (res = res0; res != 
# 349 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                        ((void *)0)
# 349 "/acl/lib_acl/src/net/dns/acl_netdb.c"
                            ; res = res->ai_next) {
  ...
  if (res->ai_family == 
# 356 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                       2
# 356 "/acl/lib_acl/src/net/dns/acl_netdb.c"
                              ) {
   if (inet_ntop(res->ai_family, &sa->in.sin_addr,
    ip, sizeof(ip)) == 
# 358 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                      ((void *)0)
# 358 "/acl/lib_acl/src/net/dns/acl_netdb.c"
                          ) {
...
# 365 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                              10
# 365 "/acl/lib_acl/src/net/dns/acl_netdb.c"
                                      ) {
   if (inet_ntop(res->ai_family, &sa->in6.sin6_addr,
    ip, sizeof(ip)) == 
# 367 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                      ((void *)0)
# 367 "/acl/lib_acl/src/net/dns/acl_netdb.c"
                          ) {
  ...
  h_host = (ACL_HOSTNAME*) acl_calloc_glue("/acl/lib_acl/src/net/dns/acl_netdb.c", 378, 1, sizeof(ACL_HOSTNAME));
  memcpy(&h_host->saddr, &saddr, sizeof(h_host->saddr));
 ...
 acl_netdb_free(db);
 return 
# 394 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
       ((void *)0)
# 394 "/acl/lib_acl/src/net/dns/acl_netdb.c"
           ;
}
...
static ACL_DNS_ERROR __dns_errlist[] = {
 ...
 { 
# 404 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
  1
# 404 "/acl/lib_acl/src/net/dns/acl_netdb.c"
                , "The specified host is unknown" },
 { 
# 405 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
  2
# 405 "/acl/lib_acl/src/net/dns/acl_netdb.c"
           , "A temporary error occurred on an authoritative name server.  Try again later." },
 { 
# 406 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
  3
# 406 "/acl/lib_acl/src/net/dns/acl_netdb.c"
             , "A non-recoverable name server error occurred" },
 { 
# 407 "/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
  4
# 407 "/acl/lib_acl/src/net/dns/acl_netdb.c"
