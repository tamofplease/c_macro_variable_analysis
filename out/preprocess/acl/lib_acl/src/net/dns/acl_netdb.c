# 1 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 2
# 33 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
const ACL_HOSTNAME *acl_netdb_index(const ACL_DNS_DB *db, int n)
{
 ACL_HOSTNAME *h_hostname;

 if (db == 
# 37 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
          ((void *)0) 
# 37 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
               || n < 0) {
  acl_msg_error("%s, %s(%d): input error",
   "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 39);
  return 
# 40 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 40 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }

 if (db->size == 0) {
  acl_msg_error("%s, %s(%d): dns db size is 0",
   "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 45);
  return 
# 46 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 46 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }
 if (n >= db->size) {
  acl_msg_error("%s, %s(%d): index(%d) > size(%d)",
   "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 50, n, db->size);
  return 
# 51 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 51 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }
...
const ACL_SOCKADDR *acl_netdb_index_saddr(ACL_DNS_DB *db, int n)
{
 ...
 if (db == 
# 62 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
          ((void *)0) 
# 62 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
               || n < 0) {
  acl_msg_error("%s, %s(%d): input error",
   "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 64);
  return 
# 65 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 65 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }
 if (db->size == 0) {
  acl_msg_error("%s, %s(%d): dns db size is 0",
   "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 69);
  return 
# 70 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 70 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }
 if (n >= db->size) {
  acl_msg_error("%s, %s(%d): index(%d) > size(%d)",
   "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 74, n, db->size);
  return 
# 75 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 75 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }
...
const char *acl_netdb_index_ip(const ACL_DNS_DB *db, int n)
{
 ...
 if (db == 
# 86 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
          ((void *)0) 
# 86 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
               || n < 0) {
  acl_msg_error("%s, %s(%d): input error",
   "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 88);
  return 
# 89 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 89 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }
 if (db->size == 0) {
  acl_msg_error("%s, %s(%d): dns db size is 0",
   "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 93);
  return 
# 94 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 94 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }
 if (n >= db->size) {
  acl_msg_error("%s, %s(%d): index(%d) > size(%d)",
   "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 98, n, db->size);
  return 
# 99 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 99 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }
 h_hostname = (ACL_HOSTNAME *) acl_array_index(db->h_db, n);
...
void acl_netdb_refer_oper(ACL_DNS_DB *db, int idx, int value)
{
 ...
 if (db == 
# 109 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
          ((void *)0) 
# 109 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
               || idx < 0) {
  acl_msg_error("%s, %s(%d): input error",
   "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 111);
  return;
 }

 if (db->size == 0) {
  acl_msg_error("%s, %s(%d): dns db size is 0",
   "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 117);
  return;
 }
 if (idx >= db->size) {
  acl_msg_error("%s, %s(%d): index(%d) > size(%d)",
   "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 122, idx, db->size);
  return;
 }
...
{
 if (db == 
# 141 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
          ((void *)0)
# 141 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
              ) {
  acl_msg_error("%s, %s(%d): input invalid",
   "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 143);
  return -1;
 }
...
{
 do { if (ctx) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", 152, (ctx)); (ctx) = 
# 152 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
((void *)0)
# 152 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
; } } while (0);
}
...
{
 if (db == 
# 157 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
          ((void *)0)
# 157 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
              )
  return;
 if (db->h_db)
  acl_array_free(db->h_db, free_dns_db);
 do { if (db) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", 161, (db)); (db) = 
# 161 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
((void *)0)
# 161 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
; } } while (0);
}
...
static const ACL_HOST_INFO *netdb_iter_info(ACL_ITER *iter,
 struct ACL_DNS_DB *db __attribute__ ((__unused__)))
{
 return iter->ptr ? (ACL_HOST_INFO*) iter->ptr : 
# 187 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                                                ((void *)0)
# 187 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
                                                    ;
}
...
ACL_DNS_DB *acl_netdb_new(const char *domain)
{
 ...
 db = acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", 199, 1, sizeof(ACL_DNS_DB));
...
static int ip2addr(const char *ip, unsigned short port, ACL_SOCKADDR *saddr)
{
 ...
 if (acl_valid_ipv4_hostaddr(ip, 0)) {
  saddr->sa.sa_family = 
# 224 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                       2
# 224 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
                              ;
  saddr->in.sin_port = 
# 225 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                       (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 225 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
                       port
# 225 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
...
# 225 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
  ...
  if (inet_pton(
# 227 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
               2
# 227 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
                      , ip, &saddr->in.sin_addr) == 1) {
   return 1;
  }
  ...
  saddr->sa.sa_family = 
# 235 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                        10
# 235 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
                                ;
  saddr->in6.sin6_port = 
# 236 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                        (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 236 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
                        port
# 236 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                        ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 236 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
                                   ;
  if (inet_pton(
# 237 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
               10
# 237 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
                       , ip, &saddr->in6.sin6_addr) == 1) {
   return 1;
  }
  acl_msg_error("%s(%d): invalid ip=%s",
   __FUNCTION__, 241, ip);
...
void acl_netdb_add_addr(ACL_DNS_DB *db, const char *ip, int hport)
{
 ...
 if (db == 
# 253 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
          ((void *)0) 
# 253 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
               || db->h_db == 
# 253 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                              ((void *)0) 
# 253 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
...
# 253 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
  ...
  acl_msg_error("%s(%d): input invalid", __FUNCTION__, 254);
  return;
 }
 ...
 phost = acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", 266, 1, sizeof(ACL_HOSTNAME));
...
ACL_DNS_DB *acl_netdb_clone(const ACL_DNS_DB *db)
{
 ...
 if (db == 
# 281 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
          ((void *)0) 
# 281 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
               || db->h_db == 
# 281 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                              ((void *)0)
# 281 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
  ...
  return 
# 282 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 282 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;

 n = acl_array_size(db->h_db);
 if (n <= 0) {
  acl_msg_error("%s, %s(%d): h_db's size(%d) <= 0",
   "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", __FUNCTION__, 287, n);
  return 
# 288 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 288 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }
...
# 296 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
 ((void) sizeof ((
# 296 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
 phost
# 296 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
...
# 296 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
 "phost"
# 296 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
 , "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", 296, __extension__ __PRETTY_FUNCTION__); }))
# 296 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
                  ;

  h_host = acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", 298, 1, sizeof(ACL_HOSTNAME));
  memcpy(&h_host->saddr, &phost->saddr, sizeof(h_host->saddr));
  do { if (sizeof(h_host->ip) > 0) { size_t _n = strlen(phost->ip); _n = _n > (size_t ) sizeof(h_host->ip) - 1? (size_t) sizeof(h_host->ip) - 1 : _n; memcpy(h_host->ip, phost->ip, _n); h_host->ip[_n] = 0; } } while (0);
...
ACL_DNS_DB *acl_gethostbyname(const char *name, int *h_error)
{
 return acl_gethostbyname2(name, 
# 312 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                                SOCK_DGRAM
# 312 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
                                          , 
# 312 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                                            0
# 312 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
 ...
 int family, int *h_error)
{
 ...
 if (ip2addr(name, 0, &saddr)) {
  ACL_HOSTNAME *h_host = acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", 334, 1, sizeof(ACL_HOSTNAME));

  memcpy(&h_host->saddr, &saddr, sizeof(h_host->saddr));
  do { if (sizeof(h_host->ip) > 0) { size_t _n = strlen(name); _n = _n > (size_t ) sizeof(h_host->ip) - 1? (size_t) sizeof(h_host->ip) - 1 : _n; memcpy(h_host->ip, name, _n); h_host->ip[_n] = 0; } } while (0);
 ...
 if (res0 == 
# 344 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
            ((void *)0)
# 344 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
                ) {
  acl_netdb_free(db);
  return 
# 346 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
        ((void *)0)
# 346 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
            ;
 }

 for (res = res0; res != 
# 349 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                        ((void *)0)
# 349 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
                            ; res = res->ai_next) {
  ...
  if (res->ai_family == 
# 356 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                       2
# 356 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
                              ) {
   if (inet_ntop(res->ai_family, &sa->in.sin_addr,
    ip, sizeof(ip)) == 
# 358 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                      ((void *)0)
# 358 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
                          ) {
...
# 365 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                              10
# 365 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
                                      ) {
   if (inet_ntop(res->ai_family, &sa->in6.sin6_addr,
    ip, sizeof(ip)) == 
# 367 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
                      ((void *)0)
# 367 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
                          ) {
  ...
  h_host = (ACL_HOSTNAME*) acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_netdb.c", 378, 1, sizeof(ACL_HOSTNAME));
  memcpy(&h_host->saddr, &saddr, sizeof(h_host->saddr));
  do { if (sizeof(h_host->ip) > 0) { size_t _n = strlen(ip); _n = _n > (size_t ) sizeof(h_host->ip) - 1? (size_t) sizeof(h_host->ip) - 1 : _n; memcpy(h_host->ip, ip, _n); h_host->ip[_n] = 0; } } while (0);
  h_host->hport = 0;
 ...
 acl_netdb_free(db);
 return 
# 394 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
       ((void *)0)
# 394 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
           ;
}
...
static ACL_DNS_ERROR __dns_errlist[] = {
 ...
 { 
# 404 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
  1
# 404 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
                , "The specified host is unknown" },
 { 
# 405 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
  2
# 405 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
           , "A temporary error occurred on an authoritative name server.  Try again later." },
 { 
# 406 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
  3
# 406 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
             , "A non-recoverable name server error occurred" },
 { 
# 407 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c" 3 4
  4
# 407 "/workspace/acl/lib_acl/src/net/dns/acl_netdb.c"
