# 0 "/acl/lib_acl/src/net/dns/acl_dns.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/dns/acl_dns.c"
...
# 2 "/acl/lib_acl/src/net/dns/acl_dns.c" 2
# 28 "/acl/lib_acl/src/net/dns/acl_dns.c"
# 1 "/acl/lib_acl/src/net/dns/../../aio/aio.h" 1
# 9 "/acl/lib_acl/src/net/dns/../../aio/aio.h"
# 1 "/acl/lib_acl/include/stdlib/acl_vstream.h" 1
# 10 "/acl/lib_acl/src/net/dns/../../aio/aio.h" 2
# 1 "/acl/lib_acl/include/stdlib/acl_vstring.h" 1
# 11 "/acl/lib_acl/src/net/dns/../../aio/aio.h" 2
# 1 "/acl/lib_acl/include/stdlib/acl_array.h" 1
# 12 "/acl/lib_acl/src/net/dns/../../aio/aio.h" 2
# 1 "/acl/lib_acl/include/net/acl_dns.h" 1
# 13 "/acl/lib_acl/src/net/dns/../../aio/aio.h" 2
# 1 "/acl/lib_acl/include/aio/acl_aio.h" 1
# 14 "/acl/lib_acl/src/net/dns/../../aio/aio.h" 2
 ...
 int timeout __attribute__ ((__unused__)), ACL_VSTREAM *stream __attribute__ ((__unused__)), void *arg)
{
 ...
 if (ret < 0) {
  acl_msg_error("%s, %s(%d): recvfrom error %s",
   "/acl/lib_acl/src/net/dns/acl_dns.c", __FUNCTION__, 76, acl_last_serror());
 }
 return ret;
}
 ...
 int timeout __attribute__ ((__unused__)), ACL_VSTREAM *stream __attribute__ ((__unused__)), void *arg)
{
 ...
 if (addr == 
# 103 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
            ((void *)0)
# 103 "/acl/lib_acl/src/net/dns/acl_dns.c"
                ) {
 ...
 if (ret < 0) {
  acl_msg_error("%s, %s(%d): sendto error %s",
   "/acl/lib_acl/src/net/dns/acl_dns.c", __FUNCTION__, 119, acl_last_serror());
 }
 return ret;
}
 ...
 unsigned int *ttl_min)
{
 ...
 for (i = 0; i < res->ancount; i++) {
  if (res->answer[i].type == 1) {
   phost = acl_calloc_glue("/acl/lib_acl/src/net/dns/acl_dns.c", 140, 1, sizeof(ACL_HOSTNAME));
   phost->type = 0;
   ...
   saddr->sa.sa_family = 
# 159 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                        2
# 159 "/acl/lib_acl/src/net/dns/acl_dns.c"
                               ;

   if (!inet_ntop(
# 161 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                 2
# 161 "/acl/lib_acl/src/net/dns/acl_dns.c"
                        , &saddr->in.sin_addr,
   ...
   phost = acl_calloc_glue("/acl/lib_acl/src/net/dns/acl_dns.c", 176, 1, sizeof(ACL_HOSTNAME));
   phost->type = 1;

   memcpy(&phost->saddr.in6.sin6_addr,
    res->answer[i].rdata, 16);
   if (!inet_ntop(
# 181 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                 10
# 181 "/acl/lib_acl/src/net/dns/acl_dns.c"
                         , &phost->saddr.in6.sin6_addr,
    phost->ip, sizeof(phost->ip))) {

    do { if (phost) { acl_free_glue("/acl/lib_acl/src/net/dns/acl_dns.c", 184, (phost)); (phost) = 
# 184 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
   ((void *)0)
# 184 "/acl/lib_acl/src/net/dns/acl_dns.c"
   ; } } while (0);
    continue;
   }
...
# 189 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                              10
# 189 "/acl/lib_acl/src/net/dns/acl_dns.c"
                                      ;
   ...
   phost = acl_calloc_glue("/acl/lib_acl/src/net/dns/acl_dns.c", 200, 1, sizeof(ACL_HOSTNAME));
   phost->type = 2;
...
static int dns_safe_addr_check(ACL_DNS *dns)
{
 ...
 inet_ntop(
# 235 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
          2
# 235 "/acl/lib_acl/src/net/dns/acl_dns.c"
...
static int dns_safe_net_check(ACL_DNS *dns)
{
 ...
 inet_ntop(
# 259 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
          2
# 259 "/acl/lib_acl/src/net/dns/acl_dns.c"
                 , &dns->addr_from.addr.in.sin_addr, from, sizeof(from));
...
static void dns_lookup_error(ACL_DNS *dns, ACL_RFC1035_MESSAGE *res)
{
 ...
 ACL_DNS_REQ *req;
    ...
    if (res == 
# 269 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
              ((void *)0)
# 269 "/acl/lib_acl/src/net/dns/acl_dns.c"
                  ) {
 ...
 if (dns->aio == 
# 274 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                ((void *)0)
# 274 "/acl/lib_acl/src/net/dns/acl_dns.c"
                    ) {
...
# 288 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                                ((void *)0)
# 288 "/acl/lib_acl/src/net/dns/acl_dns.c"
                                                    );


  req->callback(
# 291 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
               ((void *)0)
# 291 "/acl/lib_acl/src/net/dns/acl_dns.c"
                   , req->ctx, res->rcode, res);


  do { if (req) { acl_free_glue("/acl/lib_acl/src/net/dns/acl_dns.c", 294, (req)); (req) = 
# 294 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
 ((void *)0)
# 294 "/acl/lib_acl/src/net/dns/acl_dns.c"
 ; } } while (0);
 }
}
...
static void dns_lookup_ok(ACL_DNS *dns, ACL_RFC1035_MESSAGE *res)
{
 ...
 req = acl_htable_find(dns->lookup_table, key);
 if (req == 
# 309 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
           ((void *)0)
# 309 "/acl/lib_acl/src/net/dns/acl_dns.c"
               ) {
  return;
 }
 ...
 if (dns->aio != 
# 314 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                ((void *)0)
# 314 "/acl/lib_acl/src/net/dns/acl_dns.c"
                    ) {
  acl_aio_cancel_timer(dns->aio, dns->lookup_timeout, req);
 } else {
 ...
 acl_htable_delete(dns->lookup_table, req->key, 
# 321 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                               ((void *)0)
# 321 "/acl/lib_acl/src/net/dns/acl_dns.c"
                                                   );
 ...
 do { if (req) { acl_free_glue("/acl/lib_acl/src/net/dns/acl_dns.c", 333, (req)); (req) = 
# 333 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
((void *)0)
# 333 "/acl/lib_acl/src/net/dns/acl_dns.c"
; } } while (0);



 if (dns->dns_cache == 
# 337 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                      ((void *)0) 
# 337 "/acl/lib_acl/src/net/dns/acl_dns.c"
                           || ttl_min <= 0
  || acl_cache2_enter(dns->dns_cache, res->query->name,
   dns_db, ttl_min) == 
# 339 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                      ((void *)0)
# 339 "/acl/lib_acl/src/net/dns/acl_dns.c"
                          ) {
 ...
 char *data, int dlen)
{
 ...
 if (res == 
# 354 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
           ((void *)0)
# 354 "/acl/lib_acl/src/net/dns/acl_dns.c"
               ) {
  return 0;
...
static int dns_lookup_close(ACL_ASTREAM *server __attribute__ ((__unused__)), void *ctx __attribute__ ((__unused__)))
{
 ...
 dns->astream = 
# 414 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
               ((void *)0)
# 414 "/acl/lib_acl/src/net/dns/acl_dns.c"
                   ;
...
static int dns_stream_open(ACL_DNS *dns)
{
 ...
 if (stream == 
# 433 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
              ((void *)0)
# 433 "/acl/lib_acl/src/net/dns/acl_dns.c"
                  ) {
  acl_msg_error("%s(%d), %s: acl_vstream_bind error=%s",
   "/acl/lib_acl/src/net/dns/acl_dns.c", 435, __FUNCTION__, acl_last_serror());
  dns->astream = 
# 436 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                ((void *)0)
# 436 "/acl/lib_acl/src/net/dns/acl_dns.c"
                    ;
  return -1;
 } else if (dns->aio == 
# 438 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                       ((void *)0)
# 438 "/acl/lib_acl/src/net/dns/acl_dns.c"
                           ) {
 ...
 const ACL_DNS_REQ *req)
{
 ...
 case 1:
  ret = acl_rfc1035_build_query4a(domain, buf, sizeof(buf),
    req->qid, 
# 472 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
             ((void *)0)
# 472 "/acl/lib_acl/src/net/dns/acl_dns.c"
                 );
  break;
 case 28:
  ret = acl_rfc1035_build_query4aaaa(domain, buf, sizeof(buf),
    req->qid, 
# 476 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
             ((void *)0)
# 476 "/acl/lib_acl/src/net/dns/acl_dns.c"
                 );
  break;
 case 15:
  ret = acl_rfc1035_build_query4mx(domain, buf, sizeof(buf),
    req->qid, 
# 480 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
             ((void *)0)
# 480 "/acl/lib_acl/src/net/dns/acl_dns.c"
                 );
  break;
 default:
 ...
 if (dns->astream != 
# 489 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                    ((void *)0)
# 489 "/acl/lib_acl/src/net/dns/acl_dns.c"
                        ) {
  acl_aio_writen(dns->astream, buf, (int) ret);
 } else {
  acl_msg_warn("%s(%d), %s: astream null, wait for a while",
   "/acl/lib_acl/src/net/dns/acl_dns.c", 493, __FUNCTION__);
 }
}
...
# 535 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                                    ((void *)0)
# 535 "/acl/lib_acl/src/net/dns/acl_dns.c"
                                                        );


 req->callback(
# 538 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
              ((void *)0)
# 538 "/acl/lib_acl/src/net/dns/acl_dns.c"
                  , req->ctx, -16, 
# 538 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                                   ((void *)0)
# 538 "/acl/lib_acl/src/net/dns/acl_dns.c"
 ...
 do { if (req) { acl_free_glue("/acl/lib_acl/src/net/dns/acl_dns.c", 541, (req)); (req) = 
# 541 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
((void *)0)
# 541 "/acl/lib_acl/src/net/dns/acl_dns.c"
; } } while (0);
}
...
int acl_dns_init(ACL_DNS *dns, ACL_AIO *aio, int timeout)
{
 ...
 if (dns_stream_open(dns) == -1) {
  acl_msg_error("%s(%d), %s: dns_stream_open error=%s",
   "/acl/lib_acl/src/net/dns/acl_dns.c", 565, __FUNCTION__, acl_last_serror());
  return -1;
 }
...
ACL_DNS *acl_dns_create(ACL_AIO *aio, int timeout)
{
 ACL_DNS *dns = (ACL_DNS*) acl_calloc_glue("/acl/lib_acl/src/net/dns/acl_dns.c", 576, 1, sizeof(ACL_DNS));

 if (acl_dns_init(dns, aio, timeout) == -1) {
  do { if (dns) { acl_free_glue("/acl/lib_acl/src/net/dns/acl_dns.c", 579, (dns)); (dns) = 
# 579 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
 ((void *)0)
# 579 "/acl/lib_acl/src/net/dns/acl_dns.c"
 ; } } while (0);
  acl_msg_error("%s(%d), %s: acl_dns_init error",
   "/acl/lib_acl/src/net/dns/acl_dns.c", 581, __FUNCTION__);
  return 
# 582 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
        ((void *)0)
# 582 "/acl/lib_acl/src/net/dns/acl_dns.c"
            ;
 }
 dns->flag |= (1 << 0);
 return dns;
...
void acl_dns_close(ACL_DNS *dns)
{
 ...
 for ((dns->lookup_table)->iter_head(&(iter), (dns->lookup_table)); (iter).ptr; (dns->lookup_table)->iter_next(&(iter), (dns->lookup_table))) {
  ...
  do { if (req) { acl_free_glue("/acl/lib_acl/src/net/dns/acl_dns.c", 594, (req)); (req) = 
# 594 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
 ((void *)0)
# 594 "/acl/lib_acl/src/net/dns/acl_dns.c"
 ; } } while (0);
 }

 if (dns->aio) {
  dns->aio->dns = 
# 598 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                 ((void *)0)
# 598 "/acl/lib_acl/src/net/dns/acl_dns.c"
                     ;


  dns->aio = 
# 601 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
            ((void *)0)
# 601 "/acl/lib_acl/src/net/dns/acl_dns.c"
                ;
 }

 acl_htable_free(dns->lookup_table, 
# 604 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                   ((void *)0)
# 604 "/acl/lib_acl/src/net/dns/acl_dns.c"
                                       );
 dns->lookup_table = 
# 605 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                    ((void *)0)
# 605 "/acl/lib_acl/src/net/dns/acl_dns.c"
                        ;
 if (dns->dns_cache) {
  acl_cache2_free(dns->dns_cache);
  dns->dns_cache = 
# 608 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                  ((void *)0)
# 608 "/acl/lib_acl/src/net/dns/acl_dns.c"
                      ;
 }
 if (dns->astream != 
# 610 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                    ((void *)0)
# 610 "/acl/lib_acl/src/net/dns/acl_dns.c"
                        ) {
  acl_aio_iocp_close(dns->astream);
  dns->astream = 
# 612 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                ((void *)0)
# 612 "/acl/lib_acl/src/net/dns/acl_dns.c"
                    ;
 }
 ...
 if (dns->groups) {
  for ((dns->groups)->iter_head(&(iter), (dns->groups)); (iter).ptr; (dns->groups)->iter_next(&(iter), (dns->groups))) {
   ...
   do { if (tmp) { acl_free_glue("/acl/lib_acl/src/net/dns/acl_dns.c", 622, (tmp)); (tmp) = 
# 622 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
  ((void *)0)
# 622 "/acl/lib_acl/src/net/dns/acl_dns.c"
  ; } } while (0);
  }
  acl_array_free(dns->groups, 
# 624 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                ((void *)0)
# 624 "/acl/lib_acl/src/net/dns/acl_dns.c"
                                    );
 }

 if ((dns->flag & (1 << 0))) {
  do { if (dns) { acl_free_glue("/acl/lib_acl/src/net/dns/acl_dns.c", 628, (dns)); (dns) = 
# 628 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
 ((void *)0)
# 628 "/acl/lib_acl/src/net/dns/acl_dns.c"
 ; } } while (0);
 } else {
  dns->flag = 0;
 }
...
{
 if (dns->dns_cache == 
# 659 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                      ((void *)0) 
# 659 "/acl/lib_acl/src/net/dns/acl_dns.c"
                           && limit > 0) {
 ...
 unsigned short dns_port, int mask_length)
{
 ...
 addr = (ACL_DNS_ADDR*) acl_calloc_glue("/acl/lib_acl/src/net/dns/acl_dns.c", 675, 1, sizeof(ACL_DNS_ADDR));
...
# 684 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                __bswap_16 (
# 684 "/acl/lib_acl/src/net/dns/acl_dns.c"
                                dns_port
# 684 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                )
# 684 "/acl/lib_acl/src/net/dns/acl_dns.c"
...
# 686 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                2
# 686 "/acl/lib_acl/src/net/dns/acl_dns.c"
                                       ;
...
# 705 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                     ((void *)0)
# 705 "/acl/lib_acl/src/net/dns/acl_dns.c"
                                         );
   do { if (addr) { acl_free_glue("/acl/lib_acl/src/net/dns/acl_dns.c", 706, (addr)); (addr) = 
# 706 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
  ((void *)0)
# 706 "/acl/lib_acl/src/net/dns/acl_dns.c"
  ; } } while (0);
   break;
  }
 }
...
void acl_dns_add_host(ACL_DNS *dns, const char *domain, const char *ip_list)
{
 ...
 if (dns->dns_cache == 
# 738 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                      ((void *)0)
# 738 "/acl/lib_acl/src/net/dns/acl_dns.c"
                          ) {
 ...
 for ((argv)->iter_head(&(iter), (argv)); (iter).ptr; (argv)->iter_next(&(iter), (argv))) {
  ...
  ACL_HOSTNAME *phost = acl_calloc_glue("/acl/lib_acl/src/net/dns/acl_dns.c", 748, 1, sizeof(ACL_HOSTNAME));
  ...
  phost->saddr.sa.sa_family = 
# 751 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                   2
# 751 "/acl/lib_acl/src/net/dns/acl_dns.c"
                                          ;
...
# 756 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                                                 ((void *)0)
# 756 "/acl/lib_acl/src/net/dns/acl_dns.c"
                                                                     ) {
 ...
 const char *ip_list, const char *excepts)
{
 ...
 if (dns->groups == 
# 770 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                   ((void *)0)
# 770 "/acl/lib_acl/src/net/dns/acl_dns.c"
                       ) {
 ...
 dmgrp = (ACL_DOMAIN_GROUP*) acl_calloc_glue("/acl/lib_acl/src/net/dns/acl_dns.c", 783, 1, sizeof(ACL_DOMAIN_GROUP));
 ...
 if (refer == 
# 789 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
             ((void *)0) 
# 789 "/acl/lib_acl/src/net/dns/acl_dns.c"
                  || *refer == 0) {
 ...
 if (excepts) {
  ...
  dmgrp->excepts = 
# 798 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                  ((void *)0)
# 798 "/acl/lib_acl/src/net/dns/acl_dns.c"
                      ;
 }
 ...
 void *ctx)
{
 ...
 if (dns->groups) {
  ACL_DOMAIN_GROUP *dmgrp = 
# 825 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                           ((void *)0)
# 825 "/acl/lib_acl/src/net/dns/acl_dns.c"
                               ;
  ACL_ITER iter;
  for ((dns->groups)->iter_head(&(iter), (dns->groups)); (iter).ptr; (dns->groups)->iter_next(&(iter), (dns->groups))) {
   ACL_ITER iter2;
...
# 867 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                          ((void *)0)
# 867 "/acl/lib_acl/src/net/dns/acl_dns.c"
                                              );
   return;
  }
 }
 ...
 if (req != 
# 877 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
           ((void *)0)
# 877 "/acl/lib_acl/src/net/dns/acl_dns.c"
               ) {
  acl_msg_warn("%s(%d): key(%s) exist",
   __FUNCTION__, 879, key);
  callback(
# 880 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
          ((void *)0)
# 880 "/acl/lib_acl/src/net/dns/acl_dns.c"
              , ctx, -17, 
# 880 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                        ((void *)0)
# 880 "/acl/lib_acl/src/net/dns/acl_dns.c"
 ...
 req = (ACL_DNS_REQ*) acl_calloc_glue("/acl/lib_acl/src/net/dns/acl_dns.c", 885, 1, sizeof(ACL_DNS_REQ));
 req->dns = dns;
...
# 894 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                                     ((void *)0)
# 894 "/acl/lib_acl/src/net/dns/acl_dns.c"
                                                         ) {
...
{
 if (req == 
# 910 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
           ((void *)0) 
# 910 "/acl/lib_acl/src/net/dns/acl_dns.c"
                || req->dns == 
# 910 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                               ((void *)0)
# 910 "/acl/lib_acl/src/net/dns/acl_dns.c"
 ...
 acl_htable_delete(req->dns->lookup_table, req->key, 
# 914 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                                    ((void *)0)
# 914 "/acl/lib_acl/src/net/dns/acl_dns.c"
                                                        );
 do { if (req) { acl_free_glue("/acl/lib_acl/src/net/dns/acl_dns.c", 915, (req)); (req) = 
# 915 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
((void *)0)
# 915 "/acl/lib_acl/src/net/dns/acl_dns.c"
; } } while (0);
}
...
# 955 "/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                             ((void *)0)
# 955 "/acl/lib_acl/src/net/dns/acl_dns.c"
                                 ; ++i) {
