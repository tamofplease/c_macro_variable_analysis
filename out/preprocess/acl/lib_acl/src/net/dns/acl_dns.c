# 1 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 2
# 28 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
# 1 "/workspace/acl/lib_acl/src/net/dns/../../aio/aio.h" 1
# 9 "/workspace/acl/lib_acl/src/net/dns/../../aio/aio.h"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_vstream.h" 1
# 10 "/workspace/acl/lib_acl/src/net/dns/../../aio/aio.h" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_vstring.h" 1
# 11 "/workspace/acl/lib_acl/src/net/dns/../../aio/aio.h" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_array.h" 1
# 12 "/workspace/acl/lib_acl/src/net/dns/../../aio/aio.h" 2
# 1 "/workspace/acl/lib_acl/include/net/acl_dns.h" 1
# 13 "/workspace/acl/lib_acl/src/net/dns/../../aio/aio.h" 2
# 1 "/workspace/acl/lib_acl/include/aio/acl_aio.h" 1
# 14 "/workspace/acl/lib_acl/src/net/dns/../../aio/aio.h" 2
...
static int dns_read(int fd, void *buf, size_t size,
 int timeout __attribute__ ((__unused__)), ACL_VSTREAM *stream __attribute__ ((__unused__)), void *arg)
{
 ...
 if (ret < 0) {
  acl_msg_error("%s, %s(%d): recvfrom error %s",
   "/workspace/acl/lib_acl/src/net/dns/acl_dns.c", __FUNCTION__, 76, acl_last_serror());
 }
 return ret;
}
...
static int dns_write(int fd, const void *buf, size_t size,
 int timeout __attribute__ ((__unused__)), ACL_VSTREAM *stream __attribute__ ((__unused__)), void *arg)
{
 ACL_DNS *dns = (ACL_DNS*) arg;
 int ret;
 ...
 if (dns->dns_list->count <= 0) {
  acl_msg_fatal("%s(%d): dns_list's size(%d) invalid",
   __FUNCTION__, 93, dns->dns_list->count);
 }
 ...
 if (addr == 
# 103 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
            ((void *)0)
# 103 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                ) {
 ...
 if (ret < 0) {
  acl_msg_error("%s, %s(%d): sendto error %s",
   "/workspace/acl/lib_acl/src/net/dns/acl_dns.c", __FUNCTION__, 119, acl_last_serror());
 }
 return ret;
}
 ...
 unsigned int *ttl_min)
{
 ...
 for (i = 0; i < res->ancount; i++) {
  if (res->answer[i].type == 1) {
   phost = acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 140, 1, sizeof(ACL_HOSTNAME));
   phost->type = 0;
   ...
   saddr->sa.sa_family = 
# 159 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                        2
# 159 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                               ;

   if (!inet_ntop(
# 161 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                 2
# 161 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                        , &saddr->in.sin_addr,
  ...
  } else if (res->answer[i].type == 28) {
   phost = acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 176, 1, sizeof(ACL_HOSTNAME));
   phost->type = 1;

   memcpy(&phost->saddr.in6.sin6_addr,
    res->answer[i].rdata, 16);
   if (!inet_ntop(
# 181 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                 10
# 181 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                         , &phost->saddr.in6.sin6_addr,
    phost->ip, sizeof(phost->ip))) {

    do { if (phost) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 184, (phost)); (phost) = 
# 184 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
   ((void *)0)
# 184 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
   ; } } while (0);
    continue;
   }


   phost->saddr.sa.sa_family = 
# 189 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                              10
# 189 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                                      ;
  ...
  } else if (res->answer[i].type == 5) {
   phost = acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 200, 1, sizeof(ACL_HOSTNAME));
   phost->type = 2;
...
static int dns_safe_addr_check(ACL_DNS *dns)
{
 ...
 for ((dns->dns_list)->iter_head(&(iter), (dns->dns_list)); (iter).ptr; (dns->dns_list)->iter_next(&(iter), (dns->dns_list))) {
 ...
 inet_ntop(
# 235 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
          2
# 235 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                 , &dns->addr_from.addr.in.sin_addr, from, sizeof(from));
 acl_msg_warn("%s(%d): invalid from=%s", __FUNCTION__, 236, from);
...
static int dns_safe_net_check(ACL_DNS *dns)
{
 ...
 inet_ntop(
# 259 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
          2
# 259 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                 , &dns->addr_from.addr.in.sin_addr, from, sizeof(from));
 acl_msg_warn("%s(%d): invalid from=%s", __FUNCTION__, 260, from);
 return -1;
}
...
static void dns_lookup_error(ACL_DNS *dns, ACL_RFC1035_MESSAGE *res)
{
 ...
 ACL_DNS_REQ *req;
    ...
    if (res == 
# 269 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
              ((void *)0)
# 269 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                  ) {
  acl_msg_info("%s(%d): res NULL", __FUNCTION__, 270);
        return;
    }

 if (dns->aio == 
# 274 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                ((void *)0)
# 274 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                    ) {
  acl_msg_info("%s(%d): the dns is closed", __FUNCTION__, 275);
  return;
 }
 ...
 if (req) {
  ...
  acl_htable_delete(dns->lookup_table, req->key, 
# 288 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                                ((void *)0)
# 288 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                                                    );


  req->callback(
# 291 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
               ((void *)0)
# 291 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                   , req->ctx, res->rcode, res);


  do { if (req) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 294, (req)); (req) = 
# 294 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
 ((void *)0)
# 294 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
 ; } } while (0);
 }
}
...
static void dns_lookup_ok(ACL_DNS *dns, ACL_RFC1035_MESSAGE *res)
{
 ...
 req = acl_htable_find(dns->lookup_table, key);
 if (req == 
# 309 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
           ((void *)0)
# 309 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
               ) {
  return;
 }
 ...
 if (dns->aio != 
# 314 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                ((void *)0)
# 314 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                    ) {
  acl_aio_cancel_timer(dns->aio, dns->lookup_timeout, req);
 } else {
  acl_msg_warn("%s(%d): the dns is closed", __FUNCTION__, 317);
 }


 acl_htable_delete(dns->lookup_table, req->key, 
# 321 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                               ((void *)0)
# 321 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                                                   );
 ...
 do { if (req) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 333, (req)); (req) = 
# 333 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
((void *)0)
# 333 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
; } } while (0);



 if (dns->dns_cache == 
# 337 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                      ((void *)0) 
# 337 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                           || ttl_min <= 0
  || acl_cache2_enter(dns->dns_cache, res->query->name,
   dns_db, ttl_min) == 
# 339 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                      ((void *)0)
# 339 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                          ) {
...
static int dns_lookup_callback(ACL_ASTREAM *astream __attribute__ ((__unused__)), void *ctx,
 char *data, int dlen)
{
 ...
 if (res == 
# 354 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
           ((void *)0)
# 354 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
               ) {
  return 0;
...
static void dns_stream_reopen_timer(int event_type __attribute__ ((__unused__)),
 ACL_EVENT *event __attribute__ ((__unused__)), void *ctx)
{
 ACL_DNS *dns = (ACL_DNS*) ctx;
 ...
 if (dns_stream_open(dns) == 0) {
  ...
  acl_msg_warn("%s(%d): the dns is closed", __FUNCTION__, 399);
 }
}



static int dns_lookup_close(ACL_ASTREAM *server __attribute__ ((__unused__)), void *ctx __attribute__ ((__unused__)))
{
 ...
 dns->astream = 
# 414 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
               ((void *)0)
# 414 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                   ;


 if (dns->aio) {
  acl_msg_warn("%s(%d): dns socket closed %s, re-open it in timer",
   myname, 419, acl_last_serror());
  acl_aio_request_timer(dns->aio, dns_stream_reopen_timer, dns,
   2* 1000000, 0);
 }
 return -1;
...
static int dns_stream_open(ACL_DNS *dns)
{
 ...
 if (stream == 
# 433 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
              ((void *)0)
# 433 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                  ) {
  acl_msg_error("%s(%d), %s: acl_vstream_bind error=%s",
   "/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 435, __FUNCTION__, acl_last_serror());
  dns->astream = 
# 436 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                ((void *)0)
# 436 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                    ;
  return -1;
 } else if (dns->aio == 
# 438 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                       ((void *)0)
# 438 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                           ) {
  acl_msg_error("%s(%d): dns->aio = NULL", __FUNCTION__, 439);
  return -1;
 }
 ...
 const ACL_DNS_REQ *req)
{
 ...
 case 1:
  ret = acl_rfc1035_build_query4a(domain, buf, sizeof(buf),
    req->qid, 
# 472 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
             ((void *)0)
# 472 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                 );
  break;
 case 28:
  ret = acl_rfc1035_build_query4aaaa(domain, buf, sizeof(buf),
    req->qid, 
# 476 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
             ((void *)0)
# 476 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                 );
  break;
 case 15:
  ret = acl_rfc1035_build_query4mx(domain, buf, sizeof(buf),
    req->qid, 
# 480 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
             ((void *)0)
# 480 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                 );
  break;
 default:
  acl_msg_error("%s(%d): not support type=%d",
   __FUNCTION__, 484, req->type);
  return;
 }


 if (dns->astream != 
# 489 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                    ((void *)0)
# 489 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                        ) {
  acl_aio_writen(dns->astream, buf, (int) ret);
 } else {
  acl_msg_warn("%s(%d), %s: astream null, wait for a while",
   "/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 493, __FUNCTION__);
 }
}



static void dns_lookup_timeout(int event_type, ACL_EVENT *event __attribute__ ((__unused__)),
 void *context)
{
 ...
 if (event_type != (1 << 5)) {
  acl_msg_warn("%s(%d): invalid event_type(%d)",
   __FUNCTION__, 507, event_type);
 }

 if (++req->nretry <= dns->retry_limit) {
  char domain[256 + 16], *ptr;
  int i;

  do { if (sizeof(domain) > 0) { size_t _n = strlen(req->key); _n = _n > (size_t ) sizeof(domain) - 1? (size_t) sizeof(domain) - 1 : _n; memcpy(domain, req->key, _n); domain[_n] = 0; } } while (0);
  ptr = strchr(domain, ':');
  if (ptr) {
   *ptr = 0;
  }
  ...
  if (dns->aio) {
   ...
   acl_msg_error("%s(%d): dns->aio NULL", __FUNCTION__, 529);
  }
  return;
 }


 acl_htable_delete(req->dns->lookup_table, req->key, 
# 535 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                                    ((void *)0)
# 535 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                                                        );


 req->callback(
# 538 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
              ((void *)0)
# 538 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                  , req->ctx, -16, 
# 538 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                                   ((void *)0)
# 538 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
 ...
 do { if (req) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 541, (req)); (req) = 
# 541 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
((void *)0)
# 541 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
; } } while (0);
}
...
int acl_dns_init(ACL_DNS *dns, ACL_AIO *aio, int timeout)
{
 ...
 if (dns_stream_open(dns) == -1) {
  acl_msg_error("%s(%d), %s: dns_stream_open error=%s",
   "/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 565, __FUNCTION__, acl_last_serror());
  return -1;
 }
...
ACL_DNS *acl_dns_create(ACL_AIO *aio, int timeout)
{
 ACL_DNS *dns = (ACL_DNS*) acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 576, 1, sizeof(ACL_DNS));

 if (acl_dns_init(dns, aio, timeout) == -1) {
  do { if (dns) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 579, (dns)); (dns) = 
# 579 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
 ((void *)0)
# 579 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
 ; } } while (0);
  acl_msg_error("%s(%d), %s: acl_dns_init error",
   "/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 581, __FUNCTION__);
  return 
# 582 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
        ((void *)0)
# 582 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
            ;
 }
 dns->flag |= (1 << 0);
 return dns;
...
void acl_dns_close(ACL_DNS *dns)
{
 ...
 for ((dns->lookup_table)->iter_head(&(iter), (dns->lookup_table)); (iter).ptr; (dns->lookup_table)->iter_next(&(iter), (dns->lookup_table))) {
  ACL_DNS_REQ *req = (ACL_DNS_REQ*) iter.data;
  do { if (req) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 594, (req)); (req) = 
# 594 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
 ((void *)0)
# 594 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
 ; } } while (0);
 }

 if (dns->aio) {
  dns->aio->dns = 
# 598 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                 ((void *)0)
# 598 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                     ;


  dns->aio = 
# 601 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
            ((void *)0)
# 601 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                ;
 }

 acl_htable_free(dns->lookup_table, 
# 604 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                   ((void *)0)
# 604 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                                       );
 dns->lookup_table = 
# 605 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                    ((void *)0)
# 605 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                        ;
 if (dns->dns_cache) {
  acl_cache2_free(dns->dns_cache);
  dns->dns_cache = 
# 608 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                  ((void *)0)
# 608 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                      ;
 }
 if (dns->astream != 
# 610 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                    ((void *)0)
# 610 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                        ) {
  acl_aio_iocp_close(dns->astream);
  dns->astream = 
# 612 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                ((void *)0)
# 612 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                    ;
 }
 acl_array_free(dns->dns_list, acl_free_fn_glue);

 if (dns->groups) {
  for ((dns->groups)->iter_head(&(iter), (dns->groups)); (iter).ptr; (dns->groups)->iter_next(&(iter), (dns->groups))) {
   ACL_DOMAIN_GROUP *tmp = (ACL_DOMAIN_GROUP*) iter.data;
   if (tmp->excepts) {
    acl_argv_free(tmp->excepts);
   }
   do { if (tmp) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 622, (tmp)); (tmp) = 
# 622 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
  ((void *)0)
# 622 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
  ; } } while (0);
  }
  acl_array_free(dns->groups, 
# 624 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                ((void *)0)
# 624 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                                    );
 }

 if ((dns->flag & (1 << 0))) {
  do { if (dns) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 628, (dns)); (dns) = 
# 628 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
 ((void *)0)
# 628 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
 ; } } while (0);
 } else {
  dns->flag = 0;
 }
...
static void cache_free_fn(const ACL_CACHE2_INFO *info __attribute__ ((__unused__)), void *arg)
{
...
{
 if (dns->dns_cache == 
# 659 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                      ((void *)0) 
# 659 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                           && limit > 0) {
 ...
 unsigned short dns_port, int mask_length)
{
 ...
 if (mask_length >= 32 || mask_length <= 0) {
  acl_msg_error("%s(%d): mask_length(%d) invalid",
   __FUNCTION__, 671, mask_length);
  return;
 }

 addr = (ACL_DNS_ADDR*) acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 675, 1, sizeof(ACL_DNS_ADDR));
 addr->mask_length = mask_length;



 do { if (sizeof(addr->ip) > 0) { size_t _n = strlen(dns_ip); _n = _n > (size_t ) sizeof(addr->ip) - 1? (size_t) sizeof(addr->ip) - 1 : _n; memcpy(addr->ip, dns_ip, _n); addr->ip[_n] = 0; } } while (0);
 addr->port = dns_port;

 memset(&addr->addr, 0, sizeof(addr->addr));
 addr->addr.in.sin_port = 
# 684 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 684 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                                dns_port
# 684 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
...
# 686 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                2
# 686 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                                       ;
...
void acl_dns_del_dns(ACL_DNS *dns, const char *ip, unsigned short port)
{
 ...
 for (i = 0; i < size; i++) {
  ...
  if (strcmp(addr->ip, ip) && addr->port == port) {
   acl_array_delete(dns->dns_list, i, 
# 705 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                     ((void *)0)
# 705 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                                         );
   do { if (addr) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 706, (addr)); (addr) = 
# 706 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
  ((void *)0)
# 706 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
  ; } } while (0);
   break;
  }
 }
...
void acl_dns_clear_dns(ACL_DNS *dns)
{
 acl_array_clean(dns->dns_list, acl_free_fn_glue);
}
...
void acl_dns_add_host(ACL_DNS *dns, const char *domain, const char *ip_list)
{
 ...
 if (dns->dns_cache == 
# 738 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                      ((void *)0)
# 738 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                          ) {
 ...
 for ((argv)->iter_head(&(iter), (argv)); (iter).ptr; (argv)->iter_next(&(iter), (argv))) {
  ...
  ACL_HOSTNAME *phost = acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 748, 1, sizeof(ACL_HOSTNAME));

  do { if (sizeof(phost->ip) > 0) { size_t _n = strlen(ip); _n = _n > (size_t ) sizeof(phost->ip) - 1? (size_t) sizeof(phost->ip) - 1 : _n; memcpy(phost->ip, ip, _n); phost->ip[_n] = 0; } } while (0);
  phost->saddr.sa.sa_family = 
# 751 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                   2
# 751 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                                          ;
  phost->saddr.in.sin_addr.s_addr = inet_addr(ip);
  (void) acl_array_append(dns_db->h_db, phost);
 }

 if (acl_cache2_enter(dns->dns_cache, dns_db->name, dns_db, 0) == 
# 756 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                                                 ((void *)0)
# 756 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                                                                     ) {
  acl_msg_fatal("%s(%d): add domain(%s) error(%s)",
   __FUNCTION__, 758, domain, acl_last_serror());
  acl_netdb_free(dns_db);
 }
 acl_argv_free(argv);
}
 ...
 const char *ip_list, const char *excepts)
{
 ...
 if (dns->groups == 
# 770 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                   ((void *)0)
# 770 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                       ) {
 ...
 for ((dns->groups)->iter_head(&(iter), (dns->groups)); (iter).ptr; (dns->groups)->iter_next(&(iter), (dns->groups))) {
  ...
  if (strcasecmp(dmgrp->group, group) == 0) {
   acl_msg_warn("%s(%d): group(%s) already exist",
    __FUNCTION__, 778, group);
   return;
  }
 }

 dmgrp = (ACL_DOMAIN_GROUP*) acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 783, 1, sizeof(ACL_DOMAIN_GROUP));

 do { if (sizeof(dmgrp->group) > 0) { size_t _n = strlen(group); _n = _n > (size_t ) sizeof(dmgrp->group) - 1? (size_t) sizeof(dmgrp->group) - 1 : _n; memcpy(dmgrp->group, group, _n); dmgrp->group[_n] = 0; } } while (0);
 acl_lowercase(dmgrp->group);
 dmgrp->group_len = (int) strlen(dmgrp->group);

 if (refer == 
# 789 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
             ((void *)0) 
# 789 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                  || *refer == 0) {
  do { if (sizeof(dmgrp->domain) > 0) { size_t _n = strlen(dmgrp->group); _n = _n > (size_t ) sizeof(dmgrp->domain) - 1? (size_t) sizeof(dmgrp->domain) - 1 : _n; memcpy(dmgrp->domain, dmgrp->group, _n); dmgrp->domain[_n] = 0; } } while (0);
 } else {
  do { if (sizeof(dmgrp->domain) > 0) { size_t _n = strlen(refer); _n = _n > (size_t ) sizeof(dmgrp->domain) - 1? (size_t) sizeof(dmgrp->domain) - 1 : _n; memcpy(dmgrp->domain, refer, _n); dmgrp->domain[_n] = 0; } } while (0);
 ...
 if (excepts) {
  ...
  dmgrp->excepts = 
# 798 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                  ((void *)0)
# 798 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                      ;
 }
...
void acl_dns_lookup(ACL_DNS *dns, const char *domain_in,
 ...
 void *ctx)
{
 acl_dns_lookup2(dns, domain_in, 1, callback, ctx);
}
 ...
 void *ctx)
{
 ...
 if (dns->groups) {
  ACL_DOMAIN_GROUP *dmgrp = 
# 825 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                           ((void *)0)
# 825 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                               ;
  ACL_ITER iter;
  for ((dns->groups)->iter_head(&(iter), (dns->groups)); (iter).ptr; (dns->groups)->iter_next(&(iter), (dns->groups))) {
   ACL_ITER iter2;
   ...
   for ((tmp->excepts)->iter_head(&(iter2), (tmp->excepts)); (iter2).ptr; (tmp->excepts)->iter_next(&(iter2), (tmp->excepts))) {
...
END_FOREACH_TAG:
  if (dmgrp) {
   do { if (sizeof(domain) > 0) { size_t _n = strlen(dmgrp->domain); _n = _n > (size_t ) sizeof(domain) - 1? (size_t) sizeof(domain) - 1 : _n; memcpy(domain, dmgrp->domain, _n); domain[_n] = 0; } } while (0);
  } else {
   do { if (sizeof(domain) > 0) { size_t _n = strlen(domain_in); _n = _n > (size_t ) sizeof(domain) - 1? (size_t) sizeof(domain) - 1 : _n; memcpy(domain, domain_in, _n); domain[_n] = 0; } } while (0);
  }
 } else {
  do { if (sizeof(domain) > 0) { size_t _n = strlen(domain_in); _n = _n > (size_t ) sizeof(domain) - 1? (size_t) sizeof(domain) - 1 : _n; memcpy(domain, domain_in, _n); domain[_n] = 0; } } while (0);
 }
 ...
 if (dns->dns_cache) {
  ...
  if (dns_db) {
   callback(dns_db, ctx, 1, 
# 867 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                          ((void *)0)
# 867 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                                              );
   return;
  }
 }
 ...
 if (req != 
# 877 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
           ((void *)0)
# 877 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
               ) {
  acl_msg_warn("%s(%d): key(%s) exist",
   __FUNCTION__, 879, key);
  callback(
# 880 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
          ((void *)0)
# 880 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
              , ctx, -17, 
# 880 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                        ((void *)0)
# 880 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
 ...
 req = (ACL_DNS_REQ*) acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 885, 1, sizeof(ACL_DNS_REQ));
 req->dns = dns;
 req->callback = callback;
 req->ctx = ctx;
 req->type = type;
 req->qid = dns->qid++;
 do { if (sizeof(req->key) > 0) { size_t _n = strlen(key); _n = _n > (size_t ) sizeof(req->key) - 1? (size_t) sizeof(req->key) - 1 : _n; memcpy(req->key, key, _n); req->key[_n] = 0; } } while (0);


 if (acl_htable_enter(dns->lookup_table, key, req) == 
# 894 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                                     ((void *)0)
# 894 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                                                         ) {
  acl_msg_fatal("%s(%d): enter htable error(%s)",
   __FUNCTION__, 896, acl_last_serror());
 }
...
{
 if (req == 
# 910 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
           ((void *)0) 
# 910 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                || req->dns == 
# 910 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                               ((void *)0)
# 910 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                                   ) {
  acl_msg_error("%s(%d): input error", __FUNCTION__, 911);
  return;
 }
 acl_htable_delete(req->dns->lookup_table, req->key, 
# 914 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                                                    ((void *)0)
# 914 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                                                        );
 do { if (req) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_dns.c", 915, (req)); (req) = 
# 915 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
((void *)0)
# 915 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
; } } while (0);
}
...
const char *acl_dns_serror(int errnum)
{
 ...
 static const struct __ERRMSG errmsg[] = {
  ...
  { -6, "The domain should not exist" },
  { -7, "The domain's RR should not exist" },
  { -8, "The domain's RR should exist" },
  { -9, "The dns is not authority" },
  { -10, "The domain name is not in the zone" },
  { -10 + 1, "Unknown Error" },
  { -10 + 2, "Unknown Error" },
  { -10 + 3, "Unknown Error" },
  { -10 + 4, "Unknown Error" },
  { -15, "The DNS reply message is corrupt or could "
   "not be safely parsed." },
  { -16, "The DNS reply timeout" },
  { -17, "The same DNS search exist" },
  { -18, "Can't build query packet" },
  { 0, 0 }
 };
 static const char *unknown = "Unknown Error";
 size_t i;

 for (i = 0; errmsg[i].msg != 
# 955 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c" 3 4
                             ((void *)0)
# 955 "/workspace/acl/lib_acl/src/net/dns/acl_dns.c"
                                 ; ++i) {
