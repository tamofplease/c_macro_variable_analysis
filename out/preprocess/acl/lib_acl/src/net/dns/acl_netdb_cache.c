# 1 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 2
# 25 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
static acl_pthread_mutex_t __cache_mutex;
static ACL_HTABLE *__cache_table = 
# 26 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                                  ((void *)0)
# 26 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                                      ;
...
static int __cache_timeout = 300;
...
static void cache_lock(void)
{
 ...
 status = pthread_mutex_lock(&__cache_mutex);
 if (status) {
...
static int cache_trylock(void)
{
 ...
 status = pthread_mutex_trylock(&__cache_mutex);
 if (status == 0)
  return (0);
 else {
  return (-1);
...
static void cache_unlock(void)
{
 ...
 status = pthread_mutex_unlock(&__cache_mutex);
 if (status) {
  acl_msg_fatal("%s: pthread_mutex_lock error(%s)",
    myname, acl_last_strerror(buf, sizeof(buf)));
 }
...
static void free_cache_fn(char *value)
{
 ...
 acl_htable_delete(__cache_table, cache->name, 
# 84 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                                              ((void *)0)
# 84 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                                                  );
 do { if (cache) { acl_free_glue("/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c", 85, (cache)); (cache) = 
# 85 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
((void *)0)
# 85 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
; } } while (0);
}
...
static void cache_timer_fn(void)
{
 ...
 current = time(
# 94 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
               ((void *)0)
# 94 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                   );

 for ((iter).ptr = (((&__cache_ring))->succ); (iter).ptr != (&__cache_ring); (iter).ptr = (((iter).ptr)->succ)) {
  cache = ((CACHE *) (((char *) (iter.ptr)) - 
# 97 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
         __builtin_offsetof (
# 97 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
         CACHE
# 97 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
         , 
# 97 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
...
void acl_netdb_cache_push(const ACL_DNS_DB *h_dns_db, int timeout)
{
 ...
 if (__cache_table == 
# 117 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                     ((void *)0)
# 117 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                         )
  return;

 if (h_dns_db == 
# 120 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                ((void *)0) 
# 120 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                     || h_dns_db->h_db == 
# 120 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                                          ((void *)0)
# 120 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                                              ) {
  acl_msg_error("%s(%d): input invalid", myname, 121);
  return;
 }
 if (__cache_table == 
# 124 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                     ((void *)0)
# 124 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                         ) {
  acl_msg_error("%s(%d): acl_netdb_cache_init first", myname, 125);
 }
 if (h_dns_db->name[0] == 0) {
  acl_msg_error("%s(%d): host name empty", myname, 128);
  return;
 }
 if (h_dns_db->size <= 0) {
  acl_msg_error("%s(%d): size(%d) <= 0", myname, 132, h_dns_db->size);
  return;
 }
 if (h_dns_db->size != acl_array_size(h_dns_db->h_db)) {
  acl_msg_fatal("%s(%d): size(%d) != array size(%d)",
    myname, 137, h_dns_db->size,
 ...
 if (cache == 
# 149 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
             ((void *)0)
# 149 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                 ) {
  cache = (CACHE *) acl_calloc_glue("/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c", 150, 1, sizeof(CACHE));
  if (cache == 
# 151 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
              ((void *)0)
# 151 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                  ) {
   cache_unlock();
   acl_msg_error("%s(%d): calloc error(%s)",
    myname, 154, acl_last_strerror(buf, sizeof(buf)));
   return;
  }

  if (acl_htable_enter(__cache_table, h_dns_db->name, (char *) cache) == 
# 158 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                                                                        ((void *)0)
# 158 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                                                                            ) {
   cache_unlock();
   acl_msg_error("%s(%d): add to htable error(%s)",
    myname, 161, acl_last_strerror(buf, sizeof(buf)));
   return;
  }

  acl_ring_prepend(&__cache_ring, &cache->ring_entry);

  do { if (sizeof(cache->name) > 0) { size_t _n = strlen(h_dns_db->name); _n = _n > (size_t ) sizeof(cache->name) - 1? (size_t) sizeof(cache->name) - 1 : _n; memcpy(cache->name, h_dns_db->name, _n); cache->name[_n] = 0; } } while (0);
 } else {


  if (cache->h_dns_db != 
# 171 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                        ((void *)0)
# 171 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                            )
   acl_netdb_free(cache->h_dns_db);
  cache->h_dns_db = 
# 173 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                   ((void *)0)
# 173 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                       ;
  acl_ring_detach(&cache->ring_entry);
  acl_ring_prepend(&__cache_ring, &cache->ring_entry);
 }

 cache->tm_timeout = time(
# 178 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                         ((void *)0)
# 178 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                             ) + timeout > 0 ? timeout : __cache_timeout;
 cache->h_dns_db = acl_netdb_clone(h_dns_db);
 if (cache->h_dns_db == 
# 180 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                       ((void *)0)
# 180 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                           ) {
...
ACL_DNS_DB *acl_netdb_cache_lookup(const char *name)
{
 ...
 char buf[256];
 ACL_DNS_DB *h_dns_db = 
# 192 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                       ((void *)0)
# 192 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                           ;

 if (__cache_table == 
# 194 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                     ((void *)0) 
# 194 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                          || name == 
# 194 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                                     ((void *)0)
# 194 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
  ...
  return (
# 195 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
         ((void *)0)
# 195 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
             );

 if (__use_trylock) {
  if (cache_trylock() < 0)
   return (
# 199 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
          ((void *)0)
# 199 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
              );
 } else
  cache_lock();
 ...
 if (cache == 
# 209 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
             ((void *)0)
# 209 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                 ) {
  cache_unlock();
  return (
# 211 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
         ((void *)0)
# 211 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
             );
 }

 if (cache->h_dns_db == 
# 214 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                       ((void *)0)
# 214 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                           ) {
  acl_msg_error("%s, %s(%d): h_dns_db null",
    "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c", myname, 216);
  free_cache_fn((char *) cache);
  cache_unlock();
  return (
# 219 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
         ((void *)0)
# 219 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
             );
 }
 ...
 if (time(
# 224 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
         ((void *)0)
# 224 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
             ) >= cache->tm_timeout) {
  free_cache_fn((char *) cache);
  cache_unlock();
  return (
# 227 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
         ((void *)0)
# 227 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
             );
 }
 ...
 if (h_dns_db == 
# 233 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                ((void *)0)
# 233 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                    ) {
  acl_msg_error("%s, %s(%d): calloc error(%s)",
    "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c", myname, 235,
    acl_last_strerror(buf, sizeof(buf)));
  cache_unlock();
  return (
# 238 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
         ((void *)0)
# 238 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
             );
 }
...
void acl_netdb_cache_del_host(const char *name)
{
 ...
 if (__cache_table == 
# 250 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                     ((void *)0)
# 250 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                         )
  return;
...
void acl_netdb_cache_init(int timeout, int thread_safe)
{
 ...
 if (thread_safe) {
  status = pthread_mutex_init(&__cache_mutex, 
# 270 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                                                 ((void *)0)
# 270 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                                                     );
  if (status) {
 ...
 if (__cache_table == 
# 280 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                     ((void *)0)
# 280 "/workspace/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                         )
