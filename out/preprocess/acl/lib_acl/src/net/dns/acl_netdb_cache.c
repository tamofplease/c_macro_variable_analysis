# 0 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
...
# 2 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 2
# 25 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
static acl_pthread_mutex_t __cache_mutex;
static ACL_HTABLE *__cache_table = 
# 26 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                                  ((void *)0)
# 26 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                                      ;
...
# 84 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                                              ((void *)0)
# 84 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                                                  );
 do { if (cache) { acl_free_glue("/acl/lib_acl/src/net/dns/acl_netdb_cache.c", 85, (cache)); (cache) = 
# 85 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
((void *)0)
# 85 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
; } } while (0);
}
...
static void cache_timer_fn(void)
{
 ...
 current = time(
# 94 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
               ((void *)0)
# 94 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                   );

 for ((iter).ptr = (((&__cache_ring))->succ); (iter).ptr != (&__cache_ring); (iter).ptr = (((iter).ptr)->succ)) {
  cache = ((CACHE *) (((char *) (iter.ptr)) - 
# 97 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
         __builtin_offsetof (
# 97 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
         CACHE
# 97 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
         , 
# 97 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
...
void acl_netdb_cache_push(const ACL_DNS_DB *h_dns_db, int timeout)
{
 ...
 if (__cache_table == 
# 117 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                     ((void *)0)
# 117 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                         )
  return;

 if (h_dns_db == 
# 120 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                ((void *)0) 
# 120 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                     || h_dns_db->h_db == 
# 120 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                                          ((void *)0)
# 120 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
 ...
 if (__cache_table == 
# 124 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                     ((void *)0)
# 124 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                         ) {
 ...
 if (cache == 
# 149 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
             ((void *)0)
# 149 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                 ) {
  cache = (CACHE *) acl_calloc_glue("/acl/lib_acl/src/net/dns/acl_netdb_cache.c", 150, 1, sizeof(CACHE));
  if (cache == 
# 151 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
              ((void *)0)
# 151 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                  ) {
   cache_unlock();
...
# 158 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                                                                        ((void *)0)
# 158 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                                                                            ) {
   cache_unlock();
  ...
  if (cache->h_dns_db != 
# 171 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                        ((void *)0)
# 171 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                            )
   acl_netdb_free(cache->h_dns_db);
  cache->h_dns_db = 
# 173 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                   ((void *)0)
# 173 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                       ;
  acl_ring_detach(&cache->ring_entry);
  acl_ring_prepend(&__cache_ring, &cache->ring_entry);
 }
...
# 178 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                         ((void *)0)
# 178 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                             ) + timeout > 0 ? timeout : __cache_timeout;
 cache->h_dns_db = acl_netdb_clone(h_dns_db);
 if (cache->h_dns_db == 
# 180 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                       ((void *)0)
# 180 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                           ) {
...
ACL_DNS_DB *acl_netdb_cache_lookup(const char *name)
{
 ...
 char buf[256];
 ACL_DNS_DB *h_dns_db = 
# 192 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                       ((void *)0)
# 192 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                           ;

 if (__cache_table == 
# 194 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                     ((void *)0) 
# 194 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                          || name == 
# 194 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                                     ((void *)0)
# 194 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
  ...
  return (
# 195 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
         ((void *)0)
# 195 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
             );

 if (__use_trylock) {
  if (cache_trylock() < 0)
   return (
# 199 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
          ((void *)0)
# 199 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
              );
 } else
  cache_lock();
 ...
 if (cache == 
# 209 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
             ((void *)0)
# 209 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                 ) {
  cache_unlock();
  return (
# 211 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
         ((void *)0)
# 211 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
             );
 }

 if (cache->h_dns_db == 
# 214 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                       ((void *)0)
# 214 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                           ) {
  acl_msg_error("%s, %s(%d): h_dns_db null",
    "/acl/lib_acl/src/net/dns/acl_netdb_cache.c", myname, 216);
  free_cache_fn((char *) cache);
  cache_unlock();
  return (
# 219 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
         ((void *)0)
# 219 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
             );
 }
 ...
 if (time(
# 224 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
         ((void *)0)
# 224 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
             ) >= cache->tm_timeout) {
  free_cache_fn((char *) cache);
  cache_unlock();
  return (
# 227 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
         ((void *)0)
# 227 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
             );
 }
 ...
 if (h_dns_db == 
# 233 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                ((void *)0)
# 233 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                    ) {
  acl_msg_error("%s, %s(%d): calloc error(%s)",
    "/acl/lib_acl/src/net/dns/acl_netdb_cache.c", myname, 235,
    acl_last_strerror(buf, sizeof(buf)));
  cache_unlock();
  return (
# 238 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
         ((void *)0)
# 238 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
             );
 }
...
void acl_netdb_cache_del_host(const char *name)
{
 ...
 if (__cache_table == 
# 250 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                     ((void *)0)
# 250 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                         )
  return;
...
# 270 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                                                 ((void *)0)
# 270 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                                                     );
  if (status) {
 ...
 if (__cache_table == 
# 280 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c" 3 4
                     ((void *)0)
# 280 "/acl/lib_acl/src/net/dns/acl_netdb_cache.c"
                         )
