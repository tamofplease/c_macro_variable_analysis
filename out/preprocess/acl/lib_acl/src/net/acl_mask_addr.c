# 0 "/acl/lib_acl/src/net/acl_mask_addr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/acl_mask_addr.c"
...
# 3 "/acl/lib_acl/src/net/acl_mask_addr.c" 2
# 21 "/acl/lib_acl/src/net/acl_mask_addr.c"
void acl_mask_addr(unsigned char *addr_bytes,
 unsigned addr_byte_count, unsigned network_bits)
{
 unsigned char *p;

 if (network_bits > addr_byte_count * 8) {
  acl_msg_panic("mask_addr: address byte count %d too small for"
   " bit count %d", addr_byte_count, network_bits);
 }

 p = addr_bytes + network_bits / 8;
 network_bits %= 8;
