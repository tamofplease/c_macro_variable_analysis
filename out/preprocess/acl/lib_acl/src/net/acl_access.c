# 1 "/workspace/acl/lib_acl/src/net/acl_access.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/net/acl_access.c" 2
# 19 "/workspace/acl/lib_acl/src/net/acl_access.c"
static ACL_DLINK *__host_allow_link = 
# 19 "/workspace/acl/lib_acl/src/net/acl_access.c" 3 4
                                      ((void *)0)
# 19 "/workspace/acl/lib_acl/src/net/acl_access.c"
                                          ;
...
static void __access_init(void)
{
 ...
 if (__host_allow_link == 
# 31 "/workspace/acl/lib_acl/src/net/acl_access.c" 3 4
                         ((void *)0)
# 31 "/workspace/acl/lib_acl/src/net/acl_access.c"
                             ) {
  char tbuf[256];
  __log_fn("FATAL, %s(%d)->%s: call acl_iplink_create error=%s",
    "/workspace/acl/lib_acl/src/net/acl_access.c", 34, myname,
...
int acl_access_add(const char *data, const char *sep1, const char *sep2)
{
 ...
 if (data == 
# 52 "/workspace/acl/lib_acl/src/net/acl_access.c" 3 4
            ((void *)0) 
# 52 "/workspace/acl/lib_acl/src/net/acl_access.c"
                 || *data == 0) {
  __log_fn("%s, %s(%d): input invalid",
   "/workspace/acl/lib_acl/src/net/acl_access.c", myname, 54);
  return (0);
 }
 ...
 if (__host_allow_link == 
# 71 "/workspace/acl/lib_acl/src/net/acl_access.c" 3 4
                         ((void *)0)
# 71 "/workspace/acl/lib_acl/src/net/acl_access.c"
                             )
  __access_init();

 items = acl_argv_split(data, sep1);
 if (items == 
# 75 "/workspace/acl/lib_acl/src/net/acl_access.c" 3 4
             ((void *)0)
# 75 "/workspace/acl/lib_acl/src/net/acl_access.c"
                 ) {
  char tbuf[256];
  __log_fn("%s, %s(%d): acl_argv_split error(%s)",
   "/workspace/acl/lib_acl/src/net/acl_access.c", myname, 78, acl_last_strerror(tbuf, sizeof(tbuf)));
  exit (1);
 }
# 96 "/workspace/acl/lib_acl/src/net/acl_access.c"
 for (i = 0; i < items->argc; i++) {
  psrc = acl_argv_index(items, i);
  do { if (sizeof(buf) - 1 > 0) { size_t _n = strlen(psrc); _n = _n > (size_t ) sizeof(buf) - 1 - 1? (size_t) sizeof(buf) - 1 - 1 : _n; memcpy(buf, psrc, _n); buf[_n] = 0; } } while (0);
  ptr = buf;

  from = acl_strtok(&ptr, sep2);
  if (from == 
# 102 "/workspace/acl/lib_acl/src/net/acl_access.c" 3 4
             ((void *)0) 
# 102 "/workspace/acl/lib_acl/src/net/acl_access.c"
                  || *from == 0) {
   __log_fn("%s, %s(%d): invalid data(%s)",
    "/workspace/acl/lib_acl/src/net/acl_access.c", myname, 104, psrc);
   continue;
  }

  do { char *_tmp; while (*from == ' ' || *from == '\t') from++; _tmp = from; while (*_tmp) { if (*_tmp == ' ' || *_tmp == '\t') { *_tmp = 0; break; } _tmp++; } } while (0);
  if (*from == 0)
   continue;

  to = acl_strtok(&ptr, sep2);
  if (to == 
# 113 "/workspace/acl/lib_acl/src/net/acl_access.c" 3 4
           ((void *)0) 
# 113 "/workspace/acl/lib_acl/src/net/acl_access.c"
                || *to == 0) {
   __log_fn("%s, %s(%d): invalid data(%s)",
    "/workspace/acl/lib_acl/src/net/acl_access.c", myname, 115, psrc);
   continue;
  }

  do { char *_tmp; while (*to == ' ' || *to == '\t') to++; _tmp = to; while (*_tmp) { if (*_tmp == ' ' || *_tmp == '\t') { *_tmp = 0; break; } _tmp++; } } while (0);
  if (*to == 0)
   continue;

  if (acl_msg_verbose)
   __log_fn("add access: from(%s), to(%s)", from, to);
  if (acl_iplink_insert(__host_allow_link, from, to) == 
# 125 "/workspace/acl/lib_acl/src/net/acl_access.c" 3 4
                                                       ((void *)0)
# 125 "/workspace/acl/lib_acl/src/net/acl_access.c"
                                                           )
   __log_fn("%s, %s(%d): acl_iplink_insert error(%s)",
    "/workspace/acl/lib_acl/src/net/acl_access.c", myname, 127, psrc);
 }
...
int acl_access_cfg(ACL_XINETD_CFG_PARSER *xcp, const char *name)
{
 ...
 if (p_array == 
# 143 "/workspace/acl/lib_acl/src/net/acl_access.c" 3 4
               ((void *)0)
# 143 "/workspace/acl/lib_acl/src/net/acl_access.c"
                   ) {
  __log_fn("%s(%d)->%s: host allow all",
    "/workspace/acl/lib_acl/src/net/acl_access.c", 145, myname);
  return (0);
 }
 ...
 for (i = 0; i < n; i++) {
  ...
  if (pctr == 
# 152 "/workspace/acl/lib_acl/src/net/acl_access.c" 3 4
             ((void *)0)
# 152 "/workspace/acl/lib_acl/src/net/acl_access.c"
                 )
   break;
  acl_access_add(pctr, ",", ":");
 }
...
{
 if (log_fn != 
# 162 "/workspace/acl/lib_acl/src/net/acl_access.c" 3 4
              ((void *)0)
# 162 "/workspace/acl/lib_acl/src/net/acl_access.c"
                  )
  __log_fn = log_fn;
}
...
int acl_access_permit(const char *addr)
{
 ...
 if (__host_allow_all)
  return (1);
 if (__host_allow_link == 
# 172 "/workspace/acl/lib_acl/src/net/acl_access.c" 3 4
                         ((void *)0)
# 172 "/workspace/acl/lib_acl/src/net/acl_access.c"
                             )
  return (1);

 do { if (sizeof(ip) > 0) { size_t _n = strlen(addr); _n = _n > (size_t ) sizeof(ip) - 1? (size_t) sizeof(ip) - 1 : _n; memcpy(ip, addr, _n); ip[_n] = 0; } } while (0);
 ptr = strchr(ip, ':');
 if (ptr)
  *ptr = 0;
 if (acl_iplink_lookup_str(__host_allow_link, ip) != 
# 179 "/workspace/acl/lib_acl/src/net/acl_access.c" 3 4
                                                    ((void *)0)
# 179 "/workspace/acl/lib_acl/src/net/acl_access.c"
                                                        )
  return (1);
