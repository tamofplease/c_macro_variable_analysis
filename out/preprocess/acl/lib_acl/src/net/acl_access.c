# 0 "/acl/lib_acl/src/net/acl_access.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/acl_access.c"
...
# 2 "/acl/lib_acl/src/net/acl_access.c" 2
# 19 "/acl/lib_acl/src/net/acl_access.c"
static ACL_DLINK *__host_allow_link = 
# 19 "/acl/lib_acl/src/net/acl_access.c" 3 4
                                      ((void *)0)
# 19 "/acl/lib_acl/src/net/acl_access.c"
                                          ;
...
static void __access_init(void)
{
 ...
 if (__host_allow_link == 
# 31 "/acl/lib_acl/src/net/acl_access.c" 3 4
                         ((void *)0)
# 31 "/acl/lib_acl/src/net/acl_access.c"
                             ) {
  char tbuf[256];
  __log_fn("FATAL, %s(%d)->%s: call acl_iplink_create error=%s",
    "/acl/lib_acl/src/net/acl_access.c", 34, myname,
...
int acl_access_add(const char *data, const char *sep1, const char *sep2)
{
 ...
 if (data == 
# 52 "/acl/lib_acl/src/net/acl_access.c" 3 4
            ((void *)0) 
# 52 "/acl/lib_acl/src/net/acl_access.c"
                 || *data == 0) {
  __log_fn("%s, %s(%d): input invalid",
   "/acl/lib_acl/src/net/acl_access.c", myname, 54);
  return (0);
 }
 ...
 if (__host_allow_link == 
# 71 "/acl/lib_acl/src/net/acl_access.c" 3 4
                         ((void *)0)
# 71 "/acl/lib_acl/src/net/acl_access.c"
                             )
  __access_init();

 items = acl_argv_split(data, sep1);
 if (items == 
# 75 "/acl/lib_acl/src/net/acl_access.c" 3 4
             ((void *)0)
# 75 "/acl/lib_acl/src/net/acl_access.c"
                 ) {
  char tbuf[256];
  __log_fn("%s, %s(%d): acl_argv_split error(%s)",
   "/acl/lib_acl/src/net/acl_access.c", myname, 78, acl_last_strerror(tbuf, sizeof(tbuf)));
  exit (1);
 }
# 96 "/acl/lib_acl/src/net/acl_access.c"
 for (i = 0; i < items->argc; i++) {
  ...
  if (from == 
# 102 "/acl/lib_acl/src/net/acl_access.c" 3 4
             ((void *)0) 
# 102 "/acl/lib_acl/src/net/acl_access.c"
                  || *from == 0) {
   __log_fn("%s, %s(%d): invalid data(%s)",
    "/acl/lib_acl/src/net/acl_access.c", myname, 104, psrc);
   continue;
  }
  ...
  if (to == 
# 113 "/acl/lib_acl/src/net/acl_access.c" 3 4
           ((void *)0) 
# 113 "/acl/lib_acl/src/net/acl_access.c"
                || *to == 0) {
   __log_fn("%s, %s(%d): invalid data(%s)",
    "/acl/lib_acl/src/net/acl_access.c", myname, 115, psrc);
   continue;
  }
...
# 125 "/acl/lib_acl/src/net/acl_access.c" 3 4
                                                       ((void *)0)
# 125 "/acl/lib_acl/src/net/acl_access.c"
                                                           )
   __log_fn("%s, %s(%d): acl_iplink_insert error(%s)",
    "/acl/lib_acl/src/net/acl_access.c", myname, 127, psrc);
 }
...
int acl_access_cfg(ACL_XINETD_CFG_PARSER *xcp, const char *name)
{
 ...
 if (p_array == 
# 143 "/acl/lib_acl/src/net/acl_access.c" 3 4
               ((void *)0)
# 143 "/acl/lib_acl/src/net/acl_access.c"
                   ) {
  __log_fn("%s(%d)->%s: host allow all",
    "/acl/lib_acl/src/net/acl_access.c", 145, myname);
  return (0);
 }
 ...
 for (i = 0; i < n; i++) {
  ...
  if (pctr == 
# 152 "/acl/lib_acl/src/net/acl_access.c" 3 4
             ((void *)0)
# 152 "/acl/lib_acl/src/net/acl_access.c"
                 )
   break;
  acl_access_add(pctr, ",", ":");
 }
...
{
 if (log_fn != 
# 162 "/acl/lib_acl/src/net/acl_access.c" 3 4
              ((void *)0)
# 162 "/acl/lib_acl/src/net/acl_access.c"
                  )
  __log_fn = log_fn;
}
...
int acl_access_permit(const char *addr)
{
 ...
 if (__host_allow_all)
  return (1);
 if (__host_allow_link == 
# 172 "/acl/lib_acl/src/net/acl_access.c" 3 4
                         ((void *)0)
# 172 "/acl/lib_acl/src/net/acl_access.c"
                             )
  return (1);
...
# 179 "/acl/lib_acl/src/net/acl_access.c" 3 4
                                                    ((void *)0)
# 179 "/acl/lib_acl/src/net/acl_access.c"
                                                        )
  return (1);
