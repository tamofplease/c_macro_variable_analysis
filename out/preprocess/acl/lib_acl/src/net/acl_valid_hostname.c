# 1 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 3 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c" 2
# 25 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c"
int acl_valid_hostname(const char *name, int gripe)
{
 ...
 for (cp = name; (ch = *(const unsigned char *) cp) != 0; cp++) {
  if (
# 47 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
     ((*__ctype_b_loc ())[(int) ((
# 47 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c"
     ((unsigned char)(ch))
# 47 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
...
# 47 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c"
   ...
   if (!
# 57 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
       ((*__ctype_b_loc ())[(int) ((
# 57 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c"
       ((unsigned char)(ch))
# 57 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
...
int acl_valid_unix(const char *addr)
{
 ...
 if (addr == 
# 111 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
            ((void *)0) 
# 111 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c"
                 || strlen(addr) < 2) {
  return 0;
 }
...
static int valid_ipv4_wildcard(const char *addr)
{
 ...
 ptr = strchr(s4, '|');
 if (ptr == 
# 185 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
           ((void *)0)
# 185 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c"
               )
  ptr = strchr(s4, ':');
 if (ptr)
  *ptr++ = 0;
...
int acl_valid_hostaddr(const char *addr, int gripe)
{
 ...
 if ((acl_alldig((addr)) && atoi((addr)) > 0))
  return 1;

 if (((*addr) == '|' || (*addr) == ':') && (acl_alldig((addr + 1)) && atoi((addr + 1)) > 0))
  return 1;

 if (*addr == '*' && ((*(addr + 1)) == '|' || (*(addr + 1)) == ':') && (acl_alldig((addr + 2)) && atoi((addr + 2)) > 0))
  return 1;
...
int acl_valid_ipv4_hostaddr(const char *addr_in, int gripe)
{
 ...
 if ((ptr = strrchr(addr, '|')) != 
# 246 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
                                           ((void *)0)
# 246 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c"
                                               ) {
  *ptr = 0;
 } else if ((ptr = strrchr(addr, ':')) != 
# 248 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
                                         ((void *)0)
# 248 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c"
                                             ) {
  *ptr = 0;
 }
 ...
 for (cp = addr; (ch = *(unsigned const char *) cp) != 0; cp++) {
  if (
# 259 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
     ((*__ctype_b_loc ())[(int) ((
# 259 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c"
     ((unsigned char)(ch))
# 259 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
     ))] & (unsigned short int) _ISdigit)
# 259 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c"
...
int acl_valid_ipv6_hostaddr(const char *addr_in, int gripe)
{
 ...
 do { if (sizeof(addr) > 0) { size_t _n = strlen(addr_in); _n = _n > (size_t ) sizeof(addr) - 1? (size_t) sizeof(addr) - 1 : _n; memcpy(addr, addr_in, _n); addr[_n] = 0; } } while (0);
 if ((ptr = strrchr(addr, '|')) != 
# 317 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
                                           ((void *)0)
# 317 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c"
                                               ) {
  *ptr = 0;
 }

 if ((ptr = strrchr(addr, '%')) != 
# 321 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
                                  ((void *)0)
# 321 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c"
                                      ) {
  *ptr = 0;
 }

 cp = (const unsigned char *) addr;
# 340 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c"
 for (;;) {
  switch (*cp) {
  case 0:
  ...
  case ':':
   ...
   if (field == 0 && len == 0 && 
# 369 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
                                ((*__ctype_b_loc ())[(int) ((
# 369 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c"
                                ((unsigned char)(cp[1]))
# 369 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
                                ))] & (unsigned short int) _ISalnum)
# 369 "/workspace/acl/lib_acl/src/net/acl_valid_hostname.c"
