# 0 "/acl/lib_acl/src/net/acl_valid_hostname.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/acl_valid_hostname.c"
...
# 3 "/acl/lib_acl/src/net/acl_valid_hostname.c" 2
# 25 "/acl/lib_acl/src/net/acl_valid_hostname.c"
int acl_valid_hostname(const char *name, int gripe)
{
 ...
 for (cp = name; (ch = *(const unsigned char *) cp) != 0; cp++) {
  if (
# 47 "/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
     ((*__ctype_b_loc ())[(int) ((
# 47 "/acl/lib_acl/src/net/acl_valid_hostname.c"
     ((unsigned char)(ch))
# 47 "/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
...
# 47 "/acl/lib_acl/src/net/acl_valid_hostname.c"
   ...
   if (!
# 57 "/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
       ((*__ctype_b_loc ())[(int) ((
# 57 "/acl/lib_acl/src/net/acl_valid_hostname.c"
       ((unsigned char)(ch))
# 57 "/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
...
int acl_valid_unix(const char *addr)
{
 ...
 if (addr == 
# 111 "/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
            ((void *)0) 
# 111 "/acl/lib_acl/src/net/acl_valid_hostname.c"
                 || strlen(addr) < 2) {
  return 0;
 }
...
static int valid_ipv4_wildcard(const char *addr)
{
 ...
 ptr = strchr(s4, '|');
 if (ptr == 
# 185 "/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
           ((void *)0)
# 185 "/acl/lib_acl/src/net/acl_valid_hostname.c"
               )
  ptr = strchr(s4, ':');
 if (ptr)
  *ptr++ = 0;
...
int acl_valid_ipv4_hostaddr(const char *addr_in, int gripe)
{
 ...
 if ((ptr = strrchr(addr, '|')) != 
# 246 "/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
                                           ((void *)0)
# 246 "/acl/lib_acl/src/net/acl_valid_hostname.c"
                                               ) {
  *ptr = 0;
 } else if ((ptr = strrchr(addr, ':')) != 
# 248 "/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
                                         ((void *)0)
# 248 "/acl/lib_acl/src/net/acl_valid_hostname.c"
                                             ) {
  *ptr = 0;
 }
 ...
 for (cp = addr; (ch = *(unsigned const char *) cp) != 0; cp++) {
  if (
# 259 "/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
     ((*__ctype_b_loc ())[(int) ((
# 259 "/acl/lib_acl/src/net/acl_valid_hostname.c"
     ((unsigned char)(ch))
# 259 "/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
     ))] & (unsigned short int) _ISdigit)
# 259 "/acl/lib_acl/src/net/acl_valid_hostname.c"
...
int acl_valid_ipv6_hostaddr(const char *addr_in, int gripe)
{
 ...
 do { if (sizeof(addr) > 0) { size_t _n = strlen(addr_in); _n = _n > (size_t ) sizeof(addr) - 1? (size_t) sizeof(addr) - 1 : _n; memcpy(addr, addr_in, _n); addr[_n] = 0; } } while (0);
 if ((ptr = strrchr(addr, '|')) != 
# 317 "/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
                                           ((void *)0)
# 317 "/acl/lib_acl/src/net/acl_valid_hostname.c"
                                               ) {
  *ptr = 0;
 }

 if ((ptr = strrchr(addr, '%')) != 
# 321 "/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
                                  ((void *)0)
# 321 "/acl/lib_acl/src/net/acl_valid_hostname.c"
                                      ) {
  *ptr = 0;
 }

 cp = (const unsigned char *) addr;
# 340 "/acl/lib_acl/src/net/acl_valid_hostname.c"
 for (;;) {
  switch (*cp) {
  case 0:
  ...
  case ':':
   ...
   if (field == 0 && len == 0 && 
# 369 "/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
                                ((*__ctype_b_loc ())[(int) ((
# 369 "/acl/lib_acl/src/net/acl_valid_hostname.c"
                                ((unsigned char)(cp[1]))
# 369 "/acl/lib_acl/src/net/acl_valid_hostname.c" 3 4
                                ))] & (unsigned short int) _ISalnum)
# 369 "/acl/lib_acl/src/net/acl_valid_hostname.c"
