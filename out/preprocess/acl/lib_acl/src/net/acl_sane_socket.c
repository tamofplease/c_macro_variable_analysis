# 1 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c" 2
# 24 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c"
int acl_getpeername(int fd, char *buf, size_t size)
{
 ACL_SOCKADDR addr;
 ...
 if (fd == (int) -1 || buf == 
# 30 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
                                       ((void *)0) 
# 30 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c"
                                            || size <= 0) {
  return -1;
 }
 ...
 if (sa->sa_family == 
# 41 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
                     1
# 41 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c"
                            ) {
  memset(&addr, 0, sizeof(addr));
  len = sizeof(addr);
...
int acl_getsockname(int fd, char *buf, size_t size)
{
 ACL_SOCKADDR addr;
 struct sockaddr *sa = (struct sockaddr*) &addr;
 socklen_t len = sizeof(addr);
 ...
 if (fd == (int) -1 || buf == 
# 64 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
                                       ((void *)0) 
# 64 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c"
                                            || size <= 0) {
  return -1;
 }
...
int acl_getsocktype(int fd)
{
 ...
 if (getsockopt(fd, 
# 86 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
                   1
# 86 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c"
                             , 
# 86 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
                               3
# 86 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c"
...
int acl_getsockfamily(int fd)
{
 ...
 if (sa->sa_family == 
# 108 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
                     1
# 108 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c"
                            ) {
  return 
# 109 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
        1
# 109 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c"
               ;
 }
 ...
 if (sa->sa_family == 
# 114 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
                     2 
# 114 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c"
                             || sa->sa_family == 
# 114 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
                                                 10
# 114 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c"
...
int acl_check_socket(int fd)
{
 ...
 ret = getsockopt(fd, 
# 128 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
                     1
# 128 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c"
                               , 
# 128 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
                                 30
# 128 "/workspace/acl/lib_acl/src/net/acl_sane_socket.c"
