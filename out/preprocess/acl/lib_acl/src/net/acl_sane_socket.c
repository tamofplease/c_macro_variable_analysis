# 0 "/acl/lib_acl/src/net/acl_sane_socket.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/acl_sane_socket.c"
...
# 2 "/acl/lib_acl/src/net/acl_sane_socket.c" 2
# 24 "/acl/lib_acl/src/net/acl_sane_socket.c"
int acl_getpeername(int fd, char *buf, size_t size)
{
 ...
 if (fd == (int) -1 || buf == 
# 30 "/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
                                       ((void *)0) 
# 30 "/acl/lib_acl/src/net/acl_sane_socket.c"
                                            || size <= 0) {
  return -1;
 }
 ...
 if (sa->sa_family == 
# 41 "/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
                     1
# 41 "/acl/lib_acl/src/net/acl_sane_socket.c"
                            ) {
  memset(&addr, 0, sizeof(addr));
  len = sizeof(addr);
...
int acl_getsockname(int fd, char *buf, size_t size)
{
 ...
 if (fd == (int) -1 || buf == 
# 64 "/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
                                       ((void *)0) 
# 64 "/acl/lib_acl/src/net/acl_sane_socket.c"
                                            || size <= 0) {
  return -1;
 }
...
int acl_getsocktype(int fd)
{
 ...
 if (getsockopt(fd, 
# 86 "/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
                   1
# 86 "/acl/lib_acl/src/net/acl_sane_socket.c"
                             , 
# 86 "/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
                               3
# 86 "/acl/lib_acl/src/net/acl_sane_socket.c"
...
int acl_getsockfamily(int fd)
{
 ...
 if (sa->sa_family == 
# 108 "/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
                     1
# 108 "/acl/lib_acl/src/net/acl_sane_socket.c"
                            ) {
  return 
# 109 "/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
        1
# 109 "/acl/lib_acl/src/net/acl_sane_socket.c"
               ;
 }
 ...
 if (sa->sa_family == 
# 114 "/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
                     2 
# 114 "/acl/lib_acl/src/net/acl_sane_socket.c"
                             || sa->sa_family == 
# 114 "/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
                                                 10
# 114 "/acl/lib_acl/src/net/acl_sane_socket.c"
...
int acl_check_socket(int fd)
{
 ...
 ret = getsockopt(fd, 
# 128 "/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
                     1
# 128 "/acl/lib_acl/src/net/acl_sane_socket.c"
                               , 
# 128 "/acl/lib_acl/src/net/acl_sane_socket.c" 3 4
                                 30
# 128 "/acl/lib_acl/src/net/acl_sane_socket.c"
