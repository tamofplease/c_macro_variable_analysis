# 0 "/acl/lib_acl/src/net/connect/acl_sane_connect.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/connect/acl_sane_connect.c"
...
# 2 "/acl/lib_acl/src/net/connect/acl_sane_connect.c" 2
# 24 "/acl/lib_acl/src/net/connect/acl_sane_connect.c"
...
{
 int on;
# 46 "/acl/lib_acl/src/net/connect/acl_sane_connect.c"
 if (sa->sa_family == 
# 46 "/acl/lib_acl/src/net/connect/acl_sane_connect.c" 3 4
                     2 
# 46 "/acl/lib_acl/src/net/connect/acl_sane_connect.c"
                             || sa->sa_family == 
# 46 "/acl/lib_acl/src/net/connect/acl_sane_connect.c" 3 4
...
# 46 "/acl/lib_acl/src/net/connect/acl_sane_connect.c"
 ...
 if (setsockopt(sock, 
# 62 "/acl/lib_acl/src/net/connect/acl_sane_connect.c" 3 4
                     1
# 62 "/acl/lib_acl/src/net/connect/acl_sane_connect.c"
                               , 
# 62 "/acl/lib_acl/src/net/connect/acl_sane_connect.c" 3 4
                                 2
# 62 "/acl/lib_acl/src/net/connect/acl_sane_connect.c"
