# 0 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
...
# 2 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 2
# 37 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
static int bind_local(int sock, int family, const struct addrinfo *res0)
{
 const struct addrinfo *res;

 for (res = res0; res != 
# 41 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                        ((void *)0)
# 41 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                            ; res = res->ai_next) {
 ...
 const struct addrinfo *local0, int blocking, int timeout)
{
 ...
 on = 1;
 if (setsockopt(sock, 
# 80 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                     1
# 80 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                               , 
# 80 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                                 2
# 80 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
  ...
  acl_msg_warn("%s(%d): setsockopt(SO_REUSEADDR): %s",
   "/acl/lib_acl/src/net/connect/acl_inet_connect.c", 84, acl_last_serror());
 }

 if (local0 != 
# 87 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
              ((void *)0) 
# 87 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
 ...
 if (acl_sane_connect(sock, peer->ai_addr, peer->ai_addrlen) < 0) {
  ...
  len = sizeof(err);
  if (getsockopt(sock, 
# 132 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                      1
# 132 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                                , 
# 132 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                                  4
# 132 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                                          ,
   (char *) &err, &len) < 0) {
# 148 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
   acl_socket_close(sock);
  ...
  if (errnum == 
# 163 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
               115 
# 163 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                               || errnum == 
# 163 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                                            106
# 163 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
 ...
 const char *service, struct addrinfo *ai_buf, ACL_SOCKADDR *in_buf)
{
 ...
 if (family != 
# 195 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
              2 
# 195 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                      && family != 
# 195 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                                   10
# 195 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
  ...
  if (acl_valid_ipv6_hostaddr(name, 0)) {
   family = 
# 197 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
           10
# 197 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                   ;
  } else if (acl_valid_ipv4_hostaddr(name, 0)) {
   family = 
# 199 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
           2
# 199 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                  ;
  } else {
   return 
# 201 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
         ((void *)0)
# 201 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
             ;
  }
 }
 ...
 if (addrlen == 0) {
  acl_msg_warn("%s(%d), %s: acl_inet_pton error, name=%s",
   "/acl/lib_acl/src/net/connect/acl_inet_connect.c", 208, __FUNCTION__, name);
  return 
# 209 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
        ((void *)0)
# 209 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
            ;
 }

 if (family == 
# 212 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
              2
# 212 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                     ) {
  in_buf->in.sin_port = 
# 213 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                         __bswap_16 (
# 213 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                         atoi(service)
# 213 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                         )
# 213 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
...
# 215 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                         __bswap_16 (
# 215 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                         atoi(service)
# 215 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                         )
# 215 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
 ...
 ai_buf->ai_flags = 
# 218 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                      0x0004
# 218 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                                    ;
 ai_buf->ai_family = family;
 ai_buf->ai_socktype = 
# 220 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                      SOCK_STREAM
# 220 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                                 ;
...
static struct addrinfo *resolve_addr(const char *name, const char *service)
{
 ...
 hints.ai_family = 
# 233 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                    0
# 233 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                             ;
 hints.ai_socktype = 
# 234 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                    SOCK_STREAM
# 234 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                               ;
# 247 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
 hints.ai_flags = 
# 247 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                    0x0008 
# 247 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                                | 
# 247 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
...
# 247 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
 ...
 acl_msg_error("%s(%d), %s: getaddrinfo error %s, peer=%s",
  "/acl/lib_acl/src/net/connect/acl_inet_connect.c", 255, __FUNCTION__, gai_strerror(err), name);
 return 
# 256 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
       ((void *)0)
# 256 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
           ;
}
...
static int parse_addr(const char *addr, struct addr_res *res)
{
 ...
 res->peer_family = 
# 276 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                   0
# 276 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                            ;
 ...
 ptr = strchr(res->buf, '@');
 if (ptr != 
# 281 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
           ((void *)0)
# 281 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
               ) {
  *ptr = 0;
  local = *++ptr == 0 ? 
# 283 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                       ((void *)0) 
# 283 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                            : ptr;
 } else {
  local = 
# 285 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
         ((void *)0)
# 285 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
             ;
 }
 ...
 if (acl_valid_ipv6_hostaddr(peer, 0)) {
  ptr = strrchr(peer, '|');
  res->peer_family = 
# 290 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                    10
# 290 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                            ;
 } else if (acl_valid_ipv4_hostaddr(peer, 0)) {
  ptr = strrchr(peer, '|');
  if (ptr == 
# 293 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
            ((void *)0)
# 293 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                ) {
   ptr = strrchr(peer, ':');
  }
  res->peer_family = 
# 296 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                    2
# 296 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                           ;
 ...
 if (ptr == 
# 301 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
           ((void *)0)
# 301 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
               ) {
  acl_msg_error("%s, %s(%d): invalid addr(%s)",
   "/acl/lib_acl/src/net/connect/acl_inet_connect.c", __FUNCTION__, 303, addr);
  return -1;
 }
 ...
 *ptr++ = 0;
 ...
 if (atoi(res->peer_port) <= 0) {
  acl_msg_error("%s, %s(%d): invalid port(%s)",
   "/acl/lib_acl/src/net/connect/acl_inet_connect.c", __FUNCTION__, 312, res->peer_port);
  return -1;
 }

 if (strlen(peer) == 0) {
  acl_msg_error("%s, %s(%d): ip buf's length is 0",
   "/acl/lib_acl/src/net/connect/acl_inet_connect.c", __FUNCTION__, 318);
  return -1;
 }
 ...
 if (res->peer_res0 == 
# 324 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                      ((void *)0) 
# 324 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                           && (res->peer_res0 =
   resolve_addr(peer, res->peer_port)) == 
# 325 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                                         ((void *)0)
# 325 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                                             ) {
  return -1;
 }

 if (local == 
# 329 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
             ((void *)0)
# 329 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                 ) {
  res->local_res0 = 
# 330 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                   ((void *)0)
# 330 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                       ;
 } else if ((res->local_res0 = try_numeric_addr(
# 331 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                                               0
# 331 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                                                        , local, "0",
   &res->local_buf, &res->local_in)) == 
# 332 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                                       ((void *)0)
# 332 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                                           ) {
...
# 359 "/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                                  ((void *)0) 
# 359 "/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                                       ; res = res->ai_next) {
 ...
 if (sock == (int) -1) {
  acl_msg_error("%s(%d) %s: connect %s error %s", "/acl/lib_acl/src/net/connect/acl_inet_connect.c",
