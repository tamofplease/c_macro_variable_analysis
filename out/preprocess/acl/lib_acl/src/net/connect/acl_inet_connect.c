# 1 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 2
# 37 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
static int bind_local(int sock, int family, const struct addrinfo *res0)
{
 const struct addrinfo *res;

 for (res = res0; res != 
# 41 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                        ((void *)0)
# 41 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                            ; res = res->ai_next) {
...
static int connect_one(const struct addrinfo *peer,
 const struct addrinfo *local0, int blocking, int timeout)
{
 ...
 if (sock == (int) -1) {
  acl_msg_error("%s(%d): create socket error: %s",
   __FUNCTION__, 70, acl_last_serror());
  return (int) -1;
 }
 ...
 on = 1;
 if (setsockopt(sock, 
# 80 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                     1
# 80 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                               , 
# 80 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                                 2
# 80 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
  ...
  acl_msg_warn("%s(%d): setsockopt(SO_REUSEADDR): %s",
   "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c", 84, acl_last_serror());
 }

 if (local0 != 
# 87 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
              ((void *)0) 
# 87 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                   && bind_local(sock, peer->ai_family, local0) < 0) {
  acl_msg_error("%s(%d): bind local error %s, fd=%d",
   __FUNCTION__, 89, acl_last_serror(), sock);
 ...
 if (acl_sane_connect(sock, peer->ai_addr, peer->ai_addrlen) < 0) {
  ...
  len = sizeof(err);
  if (getsockopt(sock, 
# 132 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                      1
# 132 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                                , 
# 132 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                                  4
# 132 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                                          ,
   (char *) &err, &len) < 0) {
# 148 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
   acl_socket_close(sock);
  ...
  if (errnum == 
# 163 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
               115 
# 163 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                               || errnum == 
# 163 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                                            106
# 163 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
 ...
 const char *service, struct addrinfo *ai_buf, ACL_SOCKADDR *in_buf)
{
 ...
 if (family != 
# 195 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
              2 
# 195 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                      && family != 
# 195 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                                   10
# 195 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
  ...
  if (acl_valid_ipv6_hostaddr(name, 0)) {
   family = 
# 197 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
           10
# 197 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                   ;
  } else if (acl_valid_ipv4_hostaddr(name, 0)) {
   family = 
# 199 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
           2
# 199 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                  ;
  } else {
   return 
# 201 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
         ((void *)0)
# 201 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
             ;
  }
 }
 ...
 if (addrlen == 0) {
  acl_msg_warn("%s(%d), %s: acl_inet_pton error, name=%s",
   "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c", 208, __FUNCTION__, name);
  return 
# 209 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
        ((void *)0)
# 209 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
            ;
 }

 if (family == 
# 212 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
              2
# 212 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                     ) {
  in_buf->in.sin_port = 
# 213 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                         (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 213 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                         atoi(service)
# 213 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
...
# 213 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
  ...
  in_buf->in6.sin6_port = 
# 215 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                         (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 215 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                         atoi(service)
# 215 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                         ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 215 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
 ...
 ai_buf->ai_flags = 
# 218 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                      0x0004
# 218 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                                    ;
 ai_buf->ai_family = family;
 ai_buf->ai_socktype = 
# 220 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                      SOCK_STREAM
# 220 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                                 ;
...
static struct addrinfo *resolve_addr(const char *name, const char *service)
{
 ...
 hints.ai_family = 
# 233 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                    0
# 233 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                             ;
 hints.ai_socktype = 
# 234 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                    SOCK_STREAM
# 234 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                               ;
# 247 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
 hints.ai_flags = 
# 247 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                    0x0008 
# 247 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                                | 
# 247 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
...
# 247 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
 ...
 acl_msg_error("%s(%d), %s: getaddrinfo error %s, peer=%s",
  "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c", 255, __FUNCTION__, gai_strerror(err), name);
 return 
# 256 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
       ((void *)0)
# 256 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
           ;
}
...
static int parse_addr(const char *addr, struct addr_res *res)
{
 ...
 res->peer_family = 
# 276 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                   0
# 276 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                            ;
 ...
 ptr = strchr(res->buf, '@');
 if (ptr != 
# 281 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
           ((void *)0)
# 281 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
               ) {
  *ptr = 0;
  local = *++ptr == 0 ? 
# 283 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                       ((void *)0) 
# 283 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                            : ptr;
 } else {
  local = 
# 285 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
         ((void *)0)
# 285 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
             ;
 }
 ...
 if (acl_valid_ipv6_hostaddr(peer, 0)) {
  ptr = strrchr(peer, '|');
  res->peer_family = 
# 290 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                    10
# 290 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                            ;
 } else if (acl_valid_ipv4_hostaddr(peer, 0)) {
  ptr = strrchr(peer, '|');
  if (ptr == 
# 293 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
            ((void *)0)
# 293 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                ) {
   ptr = strrchr(peer, ':');
  }
  res->peer_family = 
# 296 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                    2
# 296 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                           ;
 } else if (!(ptr = strrchr(res->buf, '|'))) {
  ptr = strrchr(res->buf, ':');
 }

 if (ptr == 
# 301 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
           ((void *)0)
# 301 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
               ) {
  acl_msg_error("%s, %s(%d): invalid addr(%s)",
   "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c", __FUNCTION__, 303, addr);
  return -1;
 }
 ...
 *ptr++ = 0;
 ...
 if (atoi(res->peer_port) <= 0) {
  acl_msg_error("%s, %s(%d): invalid port(%s)",
   "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c", __FUNCTION__, 312, res->peer_port);
  return -1;
 }

 if (strlen(peer) == 0) {
  acl_msg_error("%s, %s(%d): ip buf's length is 0",
   "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c", __FUNCTION__, 318);
  return -1;
 }
 ...
 if (res->peer_res0 == 
# 324 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                      ((void *)0) 
# 324 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                           && (res->peer_res0 =
   resolve_addr(peer, res->peer_port)) == 
# 325 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                                         ((void *)0)
# 325 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                                             ) {
  return -1;
 }

 if (local == 
# 329 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
             ((void *)0)
# 329 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                 ) {
  res->local_res0 = 
# 330 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                   ((void *)0)
# 330 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                       ;
 } else if ((res->local_res0 = try_numeric_addr(
# 331 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                                               0
# 331 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                                                        , local, "0",
   &res->local_buf, &res->local_in)) == 
# 332 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                                       ((void *)0)
# 332 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                                           ) {
 ...
 int timeout, int *h_error)
{
 ...
 for (res = ares.peer_res0; res != 
# 359 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c" 3 4
                                  ((void *)0) 
# 359 "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c"
                                       ; res = res->ai_next) {
 ...
 if (sock == (int) -1) {
  acl_msg_error("%s(%d) %s: connect %s error %s", "/workspace/acl/lib_acl/src/net/connect/acl_inet_connect.c",
   368, __FUNCTION__, addr, acl_last_serror());
 }
