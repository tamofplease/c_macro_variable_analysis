# 0 "/acl/lib_acl/src/net/connect/acl_timed_connect.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/connect/acl_timed_connect.c"
...
# 2 "/acl/lib_acl/src/net/connect/acl_timed_connect.c" 2
# 24 "/acl/lib_acl/src/net/connect/acl_timed_connect.c"
...
# 50 "/acl/lib_acl/src/net/connect/acl_timed_connect.c" 3 4
(*__errno_location ()) 
# 50 "/acl/lib_acl/src/net/connect/acl_timed_connect.c"
      = acl_last_error();


 if (
# 53 "/acl/lib_acl/src/net/connect/acl_timed_connect.c" 3 4
    (*__errno_location ()) 
# 53 "/acl/lib_acl/src/net/connect/acl_timed_connect.c"
          != 
# 53 "/acl/lib_acl/src/net/connect/acl_timed_connect.c" 3 4
             115
# 53 "/acl/lib_acl/src/net/connect/acl_timed_connect.c"
...
# 66 "/acl/lib_acl/src/net/connect/acl_timed_connect.c"
 ...
 len = sizeof(err);
 if (getsockopt(sock, 
# 75 "/acl/lib_acl/src/net/connect/acl_timed_connect.c" 3 4
                     1
# 75 "/acl/lib_acl/src/net/connect/acl_timed_connect.c"
                               , 
# 75 "/acl/lib_acl/src/net/connect/acl_timed_connect.c" 3 4
                                 4
# 75 "/acl/lib_acl/src/net/connect/acl_timed_connect.c"
                                         , (char *) &err, &len) < 0) {
# 87 "/acl/lib_acl/src/net/connect/acl_timed_connect.c"
  return -1;
 }
