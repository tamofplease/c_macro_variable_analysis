# 1 "/workspace/acl/lib_acl/src/net/connect/acl_timed_connect.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/net/connect/acl_timed_connect.c" 2
# 24 "/workspace/acl/lib_acl/src/net/connect/acl_timed_connect.c"
int acl_timed_connect(int sock, const struct sockaddr *sa,
 socklen_t len, int timeout)
{
 return acl_timed_connect_ms(sock, sa, len, timeout * 1000);
}

int acl_timed_connect_ms(int sock, const struct sockaddr *sa,
 socklen_t len, int timeout)
{
 int err;
...
# 50 "/workspace/acl/lib_acl/src/net/connect/acl_timed_connect.c" 3 4
(*__errno_location ()) 
# 50 "/workspace/acl/lib_acl/src/net/connect/acl_timed_connect.c"
      = acl_last_error();


 if (
# 53 "/workspace/acl/lib_acl/src/net/connect/acl_timed_connect.c" 3 4
    (*__errno_location ()) 
# 53 "/workspace/acl/lib_acl/src/net/connect/acl_timed_connect.c"
          != 
# 53 "/workspace/acl/lib_acl/src/net/connect/acl_timed_connect.c" 3 4
             115
# 53 "/workspace/acl/lib_acl/src/net/connect/acl_timed_connect.c"
...
# 66 "/workspace/acl/lib_acl/src/net/connect/acl_timed_connect.c"
 ...
 len = sizeof(err);
 if (getsockopt(sock, 
# 75 "/workspace/acl/lib_acl/src/net/connect/acl_timed_connect.c" 3 4
                     1
# 75 "/workspace/acl/lib_acl/src/net/connect/acl_timed_connect.c"
                               , 
# 75 "/workspace/acl/lib_acl/src/net/connect/acl_timed_connect.c" 3 4
                                 4
# 75 "/workspace/acl/lib_acl/src/net/connect/acl_timed_connect.c"
                                         , (char *) &err, &len) < 0) {
# 87 "/workspace/acl/lib_acl/src/net/connect/acl_timed_connect.c"
  return -1;
 }
