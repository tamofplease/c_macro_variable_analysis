# 1 "/workspace/acl/lib_acl/src/net/connect/acl_unix_connect.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 3 "/workspace/acl/lib_acl/src/net/connect/acl_unix_connect.c" 2
# 23 "/workspace/acl/lib_acl/src/net/connect/acl_unix_connect.c"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_msg.h" 1
# 24 "/workspace/acl/lib_acl/src/net/connect/acl_unix_connect.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_iostuff.h" 1
# 25 "/workspace/acl/lib_acl/src/net/connect/acl_unix_connect.c" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_sys_patch.h" 1
# 26 "/workspace/acl/lib_acl/src/net/connect/acl_unix_connect.c" 2
# 1 "/workspace/acl/lib_acl/include/net/acl_connect.h" 1
# 27 "/workspace/acl/lib_acl/src/net/connect/acl_unix_connect.c" 2



int acl_unix_connect(const char *addr, int block_mode, int timeout)
{
 ...
 sun.sun_family = 
# 39 "/workspace/acl/lib_acl/src/net/connect/acl_unix_connect.c" 3 4
                 1
# 39 "/workspace/acl/lib_acl/src/net/connect/acl_unix_connect.c"
                        ;
 ...
 if (len >= size || len == 0) {
  acl_msg_error("%s(%d), %s: invalid addr len=%ld, unix path=%s",
   "/workspace/acl/lib_acl/src/net/connect/acl_unix_connect.c", 56, __FUNCTION__, (long) len, addr);
  return (int) -1;
 }
 ...
 if ((sock = socket(
# 66 "/workspace/acl/lib_acl/src/net/connect/acl_unix_connect.c" 3 4
                   1
# 66 "/workspace/acl/lib_acl/src/net/connect/acl_unix_connect.c"
                          , 
# 66 "/workspace/acl/lib_acl/src/net/connect/acl_unix_connect.c" 3 4
                            SOCK_STREAM
# 66 "/workspace/acl/lib_acl/src/net/connect/acl_unix_connect.c"
  ...
  acl_msg_error("%s(%d): socket: %s",
   __FUNCTION__, 68, acl_last_serror());
  return (int) -1;
 }
 ...
 if (acl_sane_connect(sock, (struct sockaddr *) & sun,
  (socklen_t) size) < 0 && acl_last_error() != 
# 91 "/workspace/acl/lib_acl/src/net/connect/acl_unix_connect.c" 3 4
                                              115
# 91 "/workspace/acl/lib_acl/src/net/connect/acl_unix_connect.c"
                                                         ) {
