# 1 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 2
# 19 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
static const ACL_IFADDR *iter_head(ACL_ITER *iter, struct ACL_IFCONF *ifconf)
{
 iter->dlen = -1;
 iter->key = 
# 22 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
             ((void *)0)
# 22 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                 ;
 iter->klen = -1;
 ...
 if (iter->i >= ifconf->length) {
  iter->data = iter->ptr = 
# 27 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                          ((void *)0)
# 27 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                              ;
  return iter->ptr;
 }
...
static const ACL_IFADDR *iter_next(ACL_ITER *iter, struct ACL_IFCONF *ifconf)
{
 ...
 if (iter->i >= ifconf->length)
  iter->data = iter->ptr = 
# 40 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                          ((void *)0)
# 40 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                              ;
 else
...
static const ACL_IFADDR *iter_tail(ACL_ITER *iter, struct ACL_IFCONF *ifconf)
{
 iter->dlen = -1;
 iter->key = 
# 49 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
             ((void *)0)
# 49 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                 ;
 iter->klen = -1;
 ...
 if (iter->i < 0)
  iter->data = iter->ptr = 
# 55 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                          ((void *)0)
# 55 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                              ;
 else
...
static const ACL_IFADDR *iter_prev(ACL_ITER *iter, struct ACL_IFCONF *ifconf)
{
 ...
 if (iter->i < 0)
  iter->data = iter->ptr = 
# 65 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                          ((void *)0)
# 65 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                              ;
 else
  iter->data = iter->ptr = &ifconf->addrs[iter->i];
 return iter->ptr;
...
{
 ACL_IFADDR *addr = (ACL_IFADDR *) acl_calloc_glue("/workspace/acl/lib_acl/src/net/acl_ifconf.c", 73, 1, sizeof(ACL_IFADDR));

 do { if (sizeof(addr->name) > 0) { size_t _n = strlen((ifaddr->name)); _n = _n > (size_t ) sizeof(addr->name) - 1? (size_t) sizeof(addr->name) - 1 : _n; memcpy((addr->name), (ifaddr->name), _n); (addr->name)[_n] = 0; } } while (0);
 ...
 if (port >= 0) {
  ...
  if (ifaddr->saddr.sa.sa_family == 
# 82 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                                   2
# 82 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                                          ) {
   addr->saddr.in.sin_port = 
# 83 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                            (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 83 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                            port
# 83 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
...
# 83 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
  ...
  } else if (ifaddr->saddr.sa.sa_family == 
# 86 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                                          10
# 86 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                                                  ) {
   addr->saddr.in6.sin6_port = 
# 87 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                              (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 87 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                              port
# 87 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                              ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 87 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
  ...
  do { if (sizeof(addr->addr) > 0) { size_t _n = strlen((buf)); _n = _n > (size_t ) sizeof(addr->addr) - 1? (size_t) sizeof(addr->addr) - 1 : _n; memcpy((addr->addr), (buf), _n); (addr->addr)[_n] = 0; } } while (0);
 } else {
  do { if (sizeof(addr->addr) > 0) { size_t _n = strlen((ifaddr->addr)); _n = _n > (size_t ) sizeof(addr->addr) - 1? (size_t) sizeof(addr->addr) - 1 : _n; memcpy((addr->addr), (ifaddr->addr), _n); (addr->addr)[_n] = 0; } } while (0);
 }
...
{
 do { if (sizeof(to->name) > 0) { size_t _n = strlen((from->name)); _n = _n > (size_t ) sizeof(to->name) - 1? (size_t) sizeof(to->name) - 1 : _n; memcpy((to->name), (from->name), _n); (to->name)[_n] = 0; } } while (0);



 do { if (sizeof(to->addr) > 0) { size_t _n = strlen((from->addr)); _n = _n > (size_t ) sizeof(to->addr) - 1? (size_t) sizeof(to->addr) - 1 : _n; memcpy((to->addr), (from->addr), _n); (to->addr)[_n] = 0; } } while (0);
 memcpy(&to->saddr, &from->saddr, sizeof(ACL_SOCKADDR));
}

static ACL_IFCONF *ifconf_create(int max)
{
 ACL_IFCONF *ifconf = (ACL_IFCONF*) acl_malloc_glue("/workspace/acl/lib_acl/src/net/acl_ifconf.c", 119, sizeof(ACL_IFCONF));
 ifconf->length = max;
 ifconf->addrs = (ACL_IFADDR*) acl_calloc_glue("/workspace/acl/lib_acl/src/net/acl_ifconf.c", 121, max, sizeof(ACL_IFADDR));
...
# 138 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 2
...
# 145 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 2


# 146 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
ACL_IFCONF *acl_get_ifaddrs(void)
{
 struct ifaddrs* ifaddrs, *ifa;
 char host[
# 149 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
          1025
# 149 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                    ];
 ACL_IFCONF *ifconf;
 ACL_ARRAY *addrs;
 ACL_ITER iter;
 ...
 if (getifaddrs(&ifaddrs) == -1) {
  acl_msg_error("%s(%d): getifaddrs error=%s",
   __FUNCTION__, 157, acl_last_serror());
  return 
# 158 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
        ((void *)0)
# 158 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
            ;
 }
 ...
 for (ifa = ifaddrs; ifa != 
# 163 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                           ((void *)0)
# 163 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                               ; ifa = ifa->ifa_next) {
  ACL_IFADDR *addr;
  int family, n;
  size_t len;
  ...
  if (ifa->ifa_addr == 
# 168 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                      ((void *)0)
# 168 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                          ) {
   continue;
  }

  if (!(ifa->ifa_flags & 
# 172 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                        IFF_UP
# 172 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                              )
   && !(ifa->ifa_flags & 
# 173 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                        IFF_RUNNING
# 173 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                                   )) {
   continue;
  }
  ...
  if (family == 
# 179 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
               2
# 179 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                      ) {
   len = sizeof(struct sockaddr_in);

  } else if (family == 
# 182 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                      10
# 182 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                              ) {
  ...
  n = getnameinfo(ifa->ifa_addr, (socklen_t) len, host, 
# 189 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                                                       1025
# 189 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                                                                 ,
    
# 190 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
   ((void *)0)
# 190 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
       , 0, 
# 190 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
            1
# 190 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
  ...
  if (n != 0) {
   acl_msg_error("%s(%d): getnameinfo error=%s, "
    "ifa_name=%s", __FUNCTION__, 193,
    gai_strerror(n), ifa->ifa_name);
   continue;
  }

  addr = (ACL_IFADDR *) acl_calloc_glue("/workspace/acl/lib_acl/src/net/acl_ifconf.c", 198, 1, sizeof(ACL_IFADDR));
  do { if (sizeof(addr->name) > 0) { size_t _n = strlen((ifa->ifa_name)); _n = _n > (size_t ) sizeof(addr->name) - 1? (size_t) sizeof(addr->name) - 1 : _n; memcpy((addr->name), (ifa->ifa_name), _n); (addr->name)[_n] = 0; } } while (0);
  do { if (sizeof(addr->addr) > 0) { size_t _n = strlen((host)); _n = _n > (size_t ) sizeof(addr->addr) - 1? (size_t) sizeof(addr->addr) - 1 : _n; memcpy((addr->addr), (host), _n); (addr->addr)[_n] = 0; } } while (0);
 ...
 if (acl_array_size(addrs) <= 0) {
  acl_array_free(addrs, 
# 209 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                       ((void *)0)
# 209 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                           );
  return 
# 210 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
        ((void *)0)
# 210 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
            ;
 }
 ...
 for ((addrs)->iter_head(&(iter), (addrs)); (iter).ptr; (addrs)->iter_next(&(iter), (addrs))) {
  ...
  do { if (ifaddr) { acl_free_glue("/workspace/acl/lib_acl/src/net/acl_ifconf.c", 219, (ifaddr)); (ifaddr) = 
# 219 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
 ((void *)0)
# 219 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
 ; } } while (0);
  i++;
 }

 acl_array_free(addrs, 
# 223 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                      ((void *)0)
# 223 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                          );
 return ifconf;
}
# 444 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
void acl_free_ifaddrs(ACL_IFCONF *ifconf)
{
 if (ifconf == 
# 446 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
              ((void *)0)
# 446 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                  )
  return;

 do { if (ifconf->addrs) { acl_free_glue("/workspace/acl/lib_acl/src/net/acl_ifconf.c", 449, (ifconf->addrs)); (ifconf->addrs) = 
# 449 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
((void *)0)
# 449 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
; } } while (0);
 do { if (ifconf) { acl_free_glue("/workspace/acl/lib_acl/src/net/acl_ifconf.c", 450, (ifconf)); (ifconf) = 
# 450 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
((void *)0)
# 450 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
; } } while (0);
}
...
static int match_ipv4(const char *pattern, const char *ip)
{
 ...
 if ((!strcmp((pattern), "*") || !strcmp((pattern), "*.*.*.*") || !strcmp((pattern), "0.0.0.0"))) {
  return 1;
 }
 ...
 for ((ip_tokens)->iter_head(&(iter), (ip_tokens)); (iter).ptr; (ip_tokens)->iter_next(&(iter), (ip_tokens))) {
...
# 512 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
static ACL_IFADDR *ipv4_clone(const char *pattern, const ACL_IFADDR *ifaddr)
{
 ...
 if (acl_alldig(pattern)) {
  if ((port = atoi(pattern)) < 0)
   return 
# 521 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
         ((void *)0)
# 521 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
             ;
 ...
 do { if (sizeof(buf) > 0) { size_t _n = strlen(pattern); _n = _n > (size_t ) sizeof(buf) - 1? (size_t) sizeof(buf) - 1 : _n; memcpy(buf, pattern, _n); buf[_n] = 0; } } while (0);
 if ((ptr = strrchr(buf, '|')) || (ptr = strrchr(buf, ':')))
  *ptr++ = 0;
 else
  ptr = 
# 531 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
       ((void *)0)
# 531 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
           ;

 if (((*(pattern) == ':' || *(pattern) == '|')) || (*(pattern) == '*' && (*((pattern) + 1) == ':' || *((pattern) + 1) == '|'))) {
 ...
 if (!match_ipv4(buf, ifaddr->addr))
  return 
# 541 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
        ((void *)0)
# 541 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
            ;
...
static ACL_IFADDR *ipv6_clone(const char *pattern, const ACL_IFADDR *ifaddr)
{
 ...
 if (acl_alldig(pattern)) {
  if ((port = atoi(pattern)) <= 0)
   return 
# 563 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
         ((void *)0)
# 563 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
             ;
  ...
  *ptr++ = 0;
  ...
  ptr = 
# 573 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
       ((void *)0)
# 573 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
           ;
 ...
 if (!acl_valid_ipv6_hostaddr(buf, 0))
  return 
# 583 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
        ((void *)0)
# 583 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
            ;
 if (!!strcmp(buf, ifaddr->addr))
  return 
# 585 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
        ((void *)0)
# 585 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
            ;
 ...
 const ACL_IFADDR *ifaddr, ACL_ARRAY *addrs)
{
 ...
 for ((patterns)->iter_head(&(iter), (patterns)); (iter).ptr; (patterns)->iter_next(&(iter), (patterns))) {
  const char *pattern = (const char *) iter.data;
  const struct sockaddr *sa = &ifaddr->saddr.sa;

  if (sa->sa_family == 
# 604 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                      2
# 604 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                             ) {
...
# 610 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                           10
# 610 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                                   ) {
...
ACL_IFCONF *acl_ifconf_search(const char *patterns)
{
 ...
 if (ifconf == 
# 627 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
              ((void *)0)
# 627 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                  ) {
  acl_msg_error("%s(%d), %s:  acl_get_ifaddrs error %s",
   "/workspace/acl/lib_acl/src/net/acl_ifconf.c", 629, __FUNCTION__, acl_last_serror());
  return 
# 630 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
        ((void *)0)
# 630 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
            ;
 }
 ...
 for ((patterns_tokens)->iter_head(&(iter), (patterns_tokens)); (iter).ptr; (patterns_tokens)->iter_next(&(iter), (patterns_tokens))) {
  const char *pattern = (const char *) iter.data;
  ACL_IFADDR *ifaddr;
  ...
  ifaddr = (ACL_IFADDR *) acl_calloc_glue("/workspace/acl/lib_acl/src/net/acl_ifconf.c", 652, 1, sizeof(ACL_IFADDR));

  do { if (sizeof(ifaddr->name) > 0) { size_t _n = strlen((pattern)); _n = _n > (size_t ) sizeof(ifaddr->name) - 1? (size_t) sizeof(ifaddr->name) - 1 : _n; memcpy((ifaddr->name), (pattern), _n); (ifaddr->name)[_n] = 0; } } while (0);
  do { if (sizeof(ifaddr->addr) > 0) { size_t _n = strlen((pattern)); _n = _n > (size_t ) sizeof(ifaddr->addr) - 1? (size_t) sizeof(ifaddr->addr) - 1 : _n; memcpy((ifaddr->addr), (pattern), _n); (ifaddr->addr)[_n] = 0; } } while (0);
  ifaddr->saddr.sa.sa_family = 
# 656 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                              1
# 656 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                                     ;
  do { if (sizeof(ifaddr->saddr.un.sun_path) > 0) { size_t _n = strlen((pattern)); _n = _n > (size_t ) sizeof(ifaddr->saddr.un.sun_path) - 1? (size_t) sizeof(ifaddr->saddr.un.sun_path) - 1 : _n; memcpy((ifaddr->saddr.un.sun_path), (pattern), _n); (ifaddr->saddr.un.sun_path)[_n] = 0; } } while (0);
 ...
 if (acl_array_size(addrs) <= 0) {
  acl_array_free(addrs, acl_free_fn_glue);
  return 
# 667 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
        ((void *)0)
# 667 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
            ;
 }
 ...
 for ((addrs)->iter_head(&(iter), (addrs)); (iter).ptr; (addrs)->iter_next(&(iter), (addrs))) {
  const ACL_IFADDR *ifaddr = (const ACL_IFADDR *) iter.data;
  if (acl_htable_find(table, ifaddr->addr) == 
# 678 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                                             ((void *)0)
# 678 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                                                 ) {
   ifaddr_copy(&ifconf2->addrs[ifconf2->length], ifaddr);
   ifconf2->length++;
   acl_htable_enter(table, ifaddr->addr, 
# 681 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                                        ((void *)0)
# 681 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                                            );
  }
 }

 acl_htable_free(table, 
# 685 "/workspace/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                       ((void *)0)
# 685 "/workspace/acl/lib_acl/src/net/acl_ifconf.c"
                           );
 acl_array_free(addrs, acl_free_fn_glue);
 return ifconf2;
}
