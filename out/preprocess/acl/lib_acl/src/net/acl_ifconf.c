# 0 "/acl/lib_acl/src/net/acl_ifconf.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/acl_ifconf.c"
...
# 2 "/acl/lib_acl/src/net/acl_ifconf.c" 2
# 19 "/acl/lib_acl/src/net/acl_ifconf.c"
static const ACL_IFADDR *iter_head(ACL_ITER *iter, struct ACL_IFCONF *ifconf)
{
 iter->dlen = -1;
 iter->key = 
# 22 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
             ((void *)0)
# 22 "/acl/lib_acl/src/net/acl_ifconf.c"
                 ;
 iter->klen = -1;
 ...
 if (iter->i >= ifconf->length) {
  iter->data = iter->ptr = 
# 27 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                          ((void *)0)
# 27 "/acl/lib_acl/src/net/acl_ifconf.c"
                              ;
  return iter->ptr;
 }
...
static const ACL_IFADDR *iter_next(ACL_ITER *iter, struct ACL_IFCONF *ifconf)
{
 ...
 if (iter->i >= ifconf->length)
  iter->data = iter->ptr = 
# 40 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                          ((void *)0)
# 40 "/acl/lib_acl/src/net/acl_ifconf.c"
                              ;
 else
...
static const ACL_IFADDR *iter_tail(ACL_ITER *iter, struct ACL_IFCONF *ifconf)
{
 iter->dlen = -1;
 iter->key = 
# 49 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
             ((void *)0)
# 49 "/acl/lib_acl/src/net/acl_ifconf.c"
                 ;
 iter->klen = -1;
 ...
 if (iter->i < 0)
  iter->data = iter->ptr = 
# 55 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                          ((void *)0)
# 55 "/acl/lib_acl/src/net/acl_ifconf.c"
                              ;
 else
...
static const ACL_IFADDR *iter_prev(ACL_ITER *iter, struct ACL_IFCONF *ifconf)
{
 ...
 if (iter->i < 0)
  iter->data = iter->ptr = 
# 65 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                          ((void *)0)
# 65 "/acl/lib_acl/src/net/acl_ifconf.c"
                              ;
 else
  iter->data = iter->ptr = &ifconf->addrs[iter->i];
 return iter->ptr;
...
{
 ACL_IFADDR *addr = (ACL_IFADDR *) acl_calloc_glue("/acl/lib_acl/src/net/acl_ifconf.c", 73, 1, sizeof(ACL_IFADDR));
...
# 82 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                                   2
# 82 "/acl/lib_acl/src/net/acl_ifconf.c"
                                          ) {
   addr->saddr.in.sin_port = 
# 83 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                            __bswap_16 (
# 83 "/acl/lib_acl/src/net/acl_ifconf.c"
                            port
# 83 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                            )
# 83 "/acl/lib_acl/src/net/acl_ifconf.c"
...
# 86 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                                          10
# 86 "/acl/lib_acl/src/net/acl_ifconf.c"
                                                  ) {
   addr->saddr.in6.sin6_port = 
# 87 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                              __bswap_16 (
# 87 "/acl/lib_acl/src/net/acl_ifconf.c"
                              port
# 87 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                              )
# 87 "/acl/lib_acl/src/net/acl_ifconf.c"
...
{
 ACL_IFCONF *ifconf = (ACL_IFCONF*) acl_malloc_glue("/acl/lib_acl/src/net/acl_ifconf.c", 119, sizeof(ACL_IFCONF));
 ifconf->length = max;
 ifconf->addrs = (ACL_IFADDR*) acl_calloc_glue("/acl/lib_acl/src/net/acl_ifconf.c", 121, max, sizeof(ACL_IFADDR));
...
# 138 "/acl/lib_acl/src/net/acl_ifconf.c" 2
...
# 145 "/acl/lib_acl/src/net/acl_ifconf.c" 2


# 146 "/acl/lib_acl/src/net/acl_ifconf.c"
ACL_IFCONF *acl_get_ifaddrs(void)
{
 struct ifaddrs* ifaddrs, *ifa;
 char host[
# 149 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
          1025
# 149 "/acl/lib_acl/src/net/acl_ifconf.c"
                    ];
 ACL_IFCONF *ifconf;
 ACL_ARRAY *addrs;
 ACL_ITER iter;
 ...
 if (getifaddrs(&ifaddrs) == -1) {
  ...
  return 
# 158 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
        ((void *)0)
# 158 "/acl/lib_acl/src/net/acl_ifconf.c"
            ;
 }
 ...
 for (ifa = ifaddrs; ifa != 
# 163 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                           ((void *)0)
# 163 "/acl/lib_acl/src/net/acl_ifconf.c"
                               ; ifa = ifa->ifa_next) {
  ACL_IFADDR *addr;
  int family, n;
  size_t len;
  ...
  if (ifa->ifa_addr == 
# 168 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                      ((void *)0)
# 168 "/acl/lib_acl/src/net/acl_ifconf.c"
                          ) {
   continue;
  }

  if (!(ifa->ifa_flags & 
# 172 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                        IFF_UP
# 172 "/acl/lib_acl/src/net/acl_ifconf.c"
                              )
   && !(ifa->ifa_flags & 
# 173 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                        IFF_RUNNING
# 173 "/acl/lib_acl/src/net/acl_ifconf.c"
                                   )) {
   continue;
  }
  ...
  if (family == 
# 179 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
               2
# 179 "/acl/lib_acl/src/net/acl_ifconf.c"
                      ) {
   len = sizeof(struct sockaddr_in);

  } else if (family == 
# 182 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                      10
# 182 "/acl/lib_acl/src/net/acl_ifconf.c"
                              ) {
...
# 189 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                                                       1025
# 189 "/acl/lib_acl/src/net/acl_ifconf.c"
                                                                 ,
    
# 190 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
   ((void *)0)
# 190 "/acl/lib_acl/src/net/acl_ifconf.c"
       , 0, 
# 190 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
            1
# 190 "/acl/lib_acl/src/net/acl_ifconf.c"
  ...
  addr = (ACL_IFADDR *) acl_calloc_glue("/acl/lib_acl/src/net/acl_ifconf.c", 198, 1, sizeof(ACL_IFADDR));
...
# 209 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                       ((void *)0)
# 209 "/acl/lib_acl/src/net/acl_ifconf.c"
                           );
  return 
# 210 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
        ((void *)0)
# 210 "/acl/lib_acl/src/net/acl_ifconf.c"
            ;
 }
 ...
 for ((addrs)->iter_head(&(iter), (addrs)); (iter).ptr; (addrs)->iter_next(&(iter), (addrs))) {
  ...
  do { if (ifaddr) { acl_free_glue("/acl/lib_acl/src/net/acl_ifconf.c", 219, (ifaddr)); (ifaddr) = 
# 219 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
 ((void *)0)
# 219 "/acl/lib_acl/src/net/acl_ifconf.c"
 ; } } while (0);
  i++;
 }

 acl_array_free(addrs, 
# 223 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                      ((void *)0)
# 223 "/acl/lib_acl/src/net/acl_ifconf.c"
                          );
 return ifconf;
}
# 444 "/acl/lib_acl/src/net/acl_ifconf.c"
void acl_free_ifaddrs(ACL_IFCONF *ifconf)
{
 if (ifconf == 
# 446 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
              ((void *)0)
# 446 "/acl/lib_acl/src/net/acl_ifconf.c"
                  )
  return;

 do { if (ifconf->addrs) { acl_free_glue("/acl/lib_acl/src/net/acl_ifconf.c", 449, (ifconf->addrs)); (ifconf->addrs) = 
# 449 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
((void *)0)
# 449 "/acl/lib_acl/src/net/acl_ifconf.c"
; } } while (0);
 do { if (ifconf) { acl_free_glue("/acl/lib_acl/src/net/acl_ifconf.c", 450, (ifconf)); (ifconf) = 
# 450 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
((void *)0)
# 450 "/acl/lib_acl/src/net/acl_ifconf.c"
; } } while (0);
}
...
# 512 "/acl/lib_acl/src/net/acl_ifconf.c"
static ACL_IFADDR *ipv4_clone(const char *pattern, const ACL_IFADDR *ifaddr)
{
 ...
 if (acl_alldig(pattern)) {
  if ((port = atoi(pattern)) < 0)
   return 
# 521 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
         ((void *)0)
# 521 "/acl/lib_acl/src/net/acl_ifconf.c"
             ;
  ...
  *ptr++ = 0;
  ...
  ptr = 
# 531 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
       ((void *)0)
# 531 "/acl/lib_acl/src/net/acl_ifconf.c"
           ;
 ...
 if (!match_ipv4(buf, ifaddr->addr))
  return 
# 541 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
        ((void *)0)
# 541 "/acl/lib_acl/src/net/acl_ifconf.c"
            ;
...
static ACL_IFADDR *ipv6_clone(const char *pattern, const ACL_IFADDR *ifaddr)
{
 ...
 if (acl_alldig(pattern)) {
  if ((port = atoi(pattern)) <= 0)
   return 
# 563 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
         ((void *)0)
# 563 "/acl/lib_acl/src/net/acl_ifconf.c"
             ;
  ...
  *ptr++ = 0;
  ...
  ptr = 
# 573 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
       ((void *)0)
# 573 "/acl/lib_acl/src/net/acl_ifconf.c"
           ;
 ...
 if (!acl_valid_ipv6_hostaddr(buf, 0))
  return 
# 583 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
        ((void *)0)
# 583 "/acl/lib_acl/src/net/acl_ifconf.c"
            ;
 if (!!strcmp(buf, ifaddr->addr))
  return 
# 585 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
        ((void *)0)
# 585 "/acl/lib_acl/src/net/acl_ifconf.c"
            ;
 ...
 const ACL_IFADDR *ifaddr, ACL_ARRAY *addrs)
{
 ...
 for ((patterns)->iter_head(&(iter), (patterns)); (iter).ptr; (patterns)->iter_next(&(iter), (patterns))) {
  ...
  if (sa->sa_family == 
# 604 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                      2
# 604 "/acl/lib_acl/src/net/acl_ifconf.c"
                             ) {
...
# 610 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                           10
# 610 "/acl/lib_acl/src/net/acl_ifconf.c"
                                   ) {
...
ACL_IFCONF *acl_ifconf_search(const char *patterns)
{
 ...
 if (ifconf == 
# 627 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
              ((void *)0)
# 627 "/acl/lib_acl/src/net/acl_ifconf.c"
                  ) {
  acl_msg_error("%s(%d), %s:  acl_get_ifaddrs error %s",
   "/acl/lib_acl/src/net/acl_ifconf.c", 629, __FUNCTION__, acl_last_serror());
  return 
# 630 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
        ((void *)0)
# 630 "/acl/lib_acl/src/net/acl_ifconf.c"
            ;
 }
 ...
 for ((patterns_tokens)->iter_head(&(iter), (patterns_tokens)); (iter).ptr; (patterns_tokens)->iter_next(&(iter), (patterns_tokens))) {
  ...
  ifaddr = (ACL_IFADDR *) acl_calloc_glue("/acl/lib_acl/src/net/acl_ifconf.c", 652, 1, sizeof(ACL_IFADDR));
...
# 656 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                              1
# 656 "/acl/lib_acl/src/net/acl_ifconf.c"
                                     ;
 ...
 if (acl_array_size(addrs) <= 0) {
  ...
  return 
# 667 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
        ((void *)0)
# 667 "/acl/lib_acl/src/net/acl_ifconf.c"
            ;
 }
...
# 678 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                                             ((void *)0)
# 678 "/acl/lib_acl/src/net/acl_ifconf.c"
                                                 ) {
   ifaddr_copy(&ifconf2->addrs[ifconf2->length], ifaddr);
   ifconf2->length++;
   acl_htable_enter(table, ifaddr->addr, 
# 681 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                                        ((void *)0)
# 681 "/acl/lib_acl/src/net/acl_ifconf.c"
                                            );
  }
 }

 acl_htable_free(table, 
# 685 "/acl/lib_acl/src/net/acl_ifconf.c" 3 4
                       ((void *)0)
# 685 "/acl/lib_acl/src/net/acl_ifconf.c"
                           );
 acl_array_free(addrs, acl_free_fn_glue);
 return ifconf2;
}
