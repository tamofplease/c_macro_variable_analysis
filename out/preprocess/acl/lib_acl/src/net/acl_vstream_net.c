# 0 "/acl/lib_acl/src/net/acl_vstream_net.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/acl_vstream_net.c"
...
# 2 "/acl/lib_acl/src/net/acl_vstream_net.c" 2
# 35 "/acl/lib_acl/src/net/acl_vstream_net.c"
ACL_VSTREAM *acl_vstream_listen_ex(const char *addr, int qlen,
 unsigned flag, int io_bufsize, int io_timeout)
{
 ...
 if (addr == 0 || *addr == 0 || qlen <= 0) {
  ...
  return 
# 44 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
        ((void *)0)
# 44 "/acl/lib_acl/src/net/acl_vstream_net.c"
            ;
 }
 ...
 if (acl_valid_unix(addr)) {
  ...
  if (listenfd == (int) -1) {
   return 
# 52 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
         ((void *)0)
# 52 "/acl/lib_acl/src/net/acl_vstream_net.c"
             ;
  }
  ...
  if (sstream == 
# 61 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
                ((void *)0)
# 61 "/acl/lib_acl/src/net/acl_vstream_net.c"
                    ) {
   acl_socket_close(listenfd);
   acl_msg_error("%s: open vstream error, addr(%s)",
    __FUNCTION__, addr);
   return 
# 65 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
         ((void *)0)
# 65 "/acl/lib_acl/src/net/acl_vstream_net.c"
             ;
  }
 ...
 if (listenfd == (int) -1) {
  ...
  return 
# 77 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
        ((void *)0)
# 77 "/acl/lib_acl/src/net/acl_vstream_net.c"
            ;
 }
...
# 109 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
                                              ((void *)0)
# 109 "/acl/lib_acl/src/net/acl_vstream_net.c"
                                                  );
# 136 "/acl/lib_acl/src/net/acl_vstream_net.c"
 if (connfd == (int) -1) {
  return 
# 137 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
        ((void *)0)
# 137 "/acl/lib_acl/src/net/acl_vstream_net.c"
            ;
 }

 if (addr != 
# 140 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
            ((void *)0) 
# 140 "/acl/lib_acl/src/net/acl_vstream_net.c"
                 && size > 0) {
  do { if (size > 0) { size_t _n = strlen(buf); _n = _n > (size_t ) size - 1? (size_t) size - 1 : _n; memcpy(addr, buf, _n); addr[_n] = 0; } } while (0);
 }

 if (cstream == 
# 144 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
               ((void *)0)
# 144 "/acl/lib_acl/src/net/acl_vstream_net.c"
                   ) {
...
# 167 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
                                      ((void *)0)
# 167 "/acl/lib_acl/src/net/acl_vstream_net.c"
                                          , ipbuf, bsize);
}
 ...
 int connect_timeout, int rw_timeout, int rw_bufsize, int *error)
{
 ...
 if (addr == 
# 179 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
            ((void *)0) 
# 179 "/acl/lib_acl/src/net/acl_vstream_net.c"
                 || *addr == 0) {
  acl_msg_error("%s: addr null", myname);
  return 
# 181 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
        ((void *)0)
# 181 "/acl/lib_acl/src/net/acl_vstream_net.c"
            ;
 }
 ...
 if (connfd == (int) -1) {
  return 
# 195 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
        ((void *)0)
# 195 "/acl/lib_acl/src/net/acl_vstream_net.c"
            ;
 }
 ...
 if (client == 
# 200 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
              ((void *)0)
# 200 "/acl/lib_acl/src/net/acl_vstream_net.c"
                  ) {
  acl_socket_close(connfd);
  return 
# 202 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
        ((void *)0)
# 202 "/acl/lib_acl/src/net/acl_vstream_net.c"
            ;
 }
 ...
 case 
# 212 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
     1
# 212 "/acl/lib_acl/src/net/acl_vstream_net.c"
            :
  client->type |= (1 << 8);
  break;

 case 
# 216 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
     2
# 216 "/acl/lib_acl/src/net/acl_vstream_net.c"
            :
  client->type |= (1 << 6);
  break;

 case 
# 220 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
     10
# 220 "/acl/lib_acl/src/net/acl_vstream_net.c"
             :
  client->type |= (1 << 7);
  break;
...
# 257 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
                          ((void *)0)
# 257 "/acl/lib_acl/src/net/acl_vstream_net.c"
                              );
}
...
# 297 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
                                      1
# 297 "/acl/lib_acl/src/net/acl_vstream_net.c"
                                             ) {
 ...
 int timeout __attribute__ ((__unused__)), ACL_VSTREAM *stream, void *arg __attribute__ ((__unused__)))
{
 ...
 if (stream->sa_peer_len == 0) {
  acl_msg_error("%s, %s(%d): peer addr null",
   __FUNCTION__, "/acl/lib_acl/src/net/acl_vstream_net.c", 314);
  return -1;
 }
...
ACL_VSTREAM *acl_vstream_bind(const char *addr, int rw_timeout, unsigned flag)
{
 ...
 if (sock == (int) -1) {
  acl_msg_error("%s(%d), %s: bind addr %s error %s", "/acl/lib_acl/src/net/acl_vstream_net.c",
   333, __FUNCTION__, addr, acl_last_serror());
  return 
# 334 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
        ((void *)0)
# 334 "/acl/lib_acl/src/net/acl_vstream_net.c"
            ;
 }

 stream = acl_vstream_fdopen(sock, 
# 337 "/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
                                  02
# 337 "/acl/lib_acl/src/net/acl_vstream_net.c"
                                        , 4096, -1, (1 << 0));
