# 1 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 2
# 35 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
ACL_VSTREAM *acl_vstream_listen_ex(const char *addr, int qlen,
 unsigned flag, int io_bufsize, int io_timeout)
{
 ...
 if (addr == 0 || *addr == 0 || qlen <= 0) {
  ...
  return 
# 44 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
        ((void *)0)
# 44 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
            ;
 }
 ...
 if (acl_valid_unix(addr)) {
  ...
  if (listenfd == (int) -1) {
   return 
# 52 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
         ((void *)0)
# 52 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
             ;
  }

  acl_non_blocking(listenfd, flag & 1 ?
   1 : 0);
  ...
  if (sstream == 
# 61 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
                ((void *)0)
# 61 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
                    ) {
   acl_socket_close(listenfd);
   acl_msg_error("%s: open vstream error, addr(%s)",
    __FUNCTION__, addr);
   return 
# 65 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
         ((void *)0)
# 65 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
             ;
  }
 ...
 if (listenfd == (int) -1) {
  ...
  return 
# 77 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
        ((void *)0)
# 77 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
            ;
 }
 sstream = acl_vstream_fdopen(listenfd, (1 << 2),
  io_bufsize, io_timeout, (1 << 3));
...
ACL_VSTREAM *acl_vstream_listen(const char *addr, int qlen)
{
 return acl_vstream_listen_ex(addr, qlen, 0, 0, 0);
}
 ...
 ACL_VSTREAM *cstream, char *addr, int size)
{
 ...
 connfd = acl_accept(servfd, buf, sizeof(buf), 
# 109 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
                                              ((void *)0)
# 109 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
                                                  );
# 136 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
 if (connfd == (int) -1) {
  return 
# 137 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
        ((void *)0)
# 137 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
            ;
 }

 if (addr != 
# 140 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
            ((void *)0) 
# 140 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
                 && size > 0) {
  do { if (size > 0) { size_t _n = strlen(buf); _n = _n > (size_t ) size - 1? (size_t) size - 1 : _n; memcpy(addr, buf, _n); addr[_n] = 0; } } while (0);
 }

 if (cstream == 
# 144 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
               ((void *)0)
# 144 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
                   ) {
  ...
  do { ACL_VSTREAM *__stream_ptr = cstream; __stream_ptr->fd.sock = connfd; } while (0);
 }
...
{
 return acl_vstream_accept_ex(sstream, 
# 167 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
                                      ((void *)0)
# 167 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
                                          , ipbuf, bsize);
}
 ...
 int connect_timeout, int rw_timeout, int rw_bufsize, int *error)
{
 ...
 if (addr == 
# 179 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
            ((void *)0) 
# 179 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
                 || *addr == 0) {
  acl_msg_error("%s: addr null", myname);
  return 
# 181 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
        ((void *)0)
# 181 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
            ;
 }
 ...
 if (connfd == (int) -1) {
  return 
# 195 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
        ((void *)0)
# 195 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
            ;
 }

 client = acl_vstream_fdopen(connfd, (1 << 2),
      rw_bufsize, rw_timeout, (1 << 0));
 if (client == 
# 200 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
              ((void *)0)
# 200 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
                  ) {
  acl_socket_close(connfd);
  return 
# 202 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
        ((void *)0)
# 202 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
            ;
 }
 ...
 case 
# 212 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
     1
# 212 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
            :
  client->type |= (1 << 8);
  break;

 case 
# 216 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
     2
# 216 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
            :
  client->type |= (1 << 6);
  break;

 case 
# 220 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
     10
# 220 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
             :
  client->type |= (1 << 7);
  break;
 ...
 if (acl_getpeername(((client)->fd.sock), buf, sizeof(buf)) < 0) {
 ...
 int rw_bufsize, int *error)
{
 ...
 if (conn) {
  ((conn)->flag &= ~(1 << 20));
  do { ACL_VSTREAM *__stream_ptr = conn; __stream_ptr->rw_timeout = rw_timeout; } while (0);
 }
 return conn;
}
 ...
 int connect_timeout, int rw_timeout, int rw_bufsize)
{
 return acl_vstream_connect_ex(addr, block_mode, connect_timeout,
   rw_timeout, rw_bufsize, 
# 257 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
                          ((void *)0)
# 257 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
                              );
}
...
static int udp_read(int fd, void *buf, size_t size,
 int timeout __attribute__ ((__unused__)), ACL_VSTREAM *stream, void *arg __attribute__ ((__unused__)))
{
 ACL_SOCKADDR sa;
 ...
 if (sa.sa.sa_family == 0) {
  ...
  if (n > 0 && stream->sa_local
     && stream->sa_local->sa_family == 
# 297 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
                                      1
# 297 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
                                             ) {
 ...
 int timeout __attribute__ ((__unused__)), ACL_VSTREAM *stream, void *arg __attribute__ ((__unused__)))
{
 ...
 if (stream->sa_peer_len == 0) {
  acl_msg_error("%s, %s(%d): peer addr null",
   __FUNCTION__, "/workspace/acl/lib_acl/src/net/acl_vstream_net.c", 314);
  return -1;
 }
...
{
 ACL_VSTREAM *stream;
 int sock = acl_udp_bind(addr, flag);
 ACL_SOCKADDR saddr;
 socklen_t len = sizeof(saddr);

 if (sock == (int) -1) {
  acl_msg_error("%s(%d), %s: bind addr %s error %s", "/workspace/acl/lib_acl/src/net/acl_vstream_net.c",
   333, __FUNCTION__, addr, acl_last_serror());
  return 
# 334 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
        ((void *)0)
# 334 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
            ;
 }

 stream = acl_vstream_fdopen(sock, 
# 337 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c" 3 4
                                  02
# 337 "/workspace/acl/lib_acl/src/net/acl_vstream_net.c"
                                        , 4096, -1, (1 << 0));
