# 0 "/acl/lib_acl/src/net/acl_host_port.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/net/acl_host_port.c"
...
# 3 "/acl/lib_acl/src/net/acl_host_port.c" 2
# 33 "/acl/lib_acl/src/net/acl_host_port.c"
...
# 62 "/acl/lib_acl/src/net/acl_host_port.c" 3 4
                                             ((void *)0)
# 62 "/acl/lib_acl/src/net/acl_host_port.c"
                                                 );
  *port = def_service ? def_service : 
# 63 "/acl/lib_acl/src/net/acl_host_port.c" 3 4
                                     ((void *)0)
# 63 "/acl/lib_acl/src/net/acl_host_port.c"
                                         ;
 }

 if (*host == 0)
  return "missing host information";
# 78 "/acl/lib_acl/src/net/acl_host_port.c"
 if (*host != def_host
 ...
 if (*port == 0)
  return 
# 86 "/acl/lib_acl/src/net/acl_host_port.c" 3 4
        ((void *)0)
# 86 "/acl/lib_acl/src/net/acl_host_port.c"
            ;

 if (*port != def_service && 
# 88 "/acl/lib_acl/src/net/acl_host_port.c" 3 4
                            ((*__ctype_b_loc ())[(int) ((
# 88 "/acl/lib_acl/src/net/acl_host_port.c"
                            ((unsigned char)(**port))
# 88 "/acl/lib_acl/src/net/acl_host_port.c" 3 4
...
# 88 "/acl/lib_acl/src/net/acl_host_port.c"
 ...
 return 
# 91 "/acl/lib_acl/src/net/acl_host_port.c" 3 4
       ((void *)0)
# 91 "/acl/lib_acl/src/net/acl_host_port.c"
           ;
}
...
# 97 "/acl/lib_acl/src/net/acl_host_port.c" 3 4
                                                           ((void *)0)
# 97 "/acl/lib_acl/src/net/acl_host_port.c"
                                                               );

 if (ptr != 
# 99 "/acl/lib_acl/src/net/acl_host_port.c" 3 4
           ((void *)0)
# 99 "/acl/lib_acl/src/net/acl_host_port.c"
               ) {
  acl_msg_error("%s(%d), %s: invalid addr %s, %s",
   "/acl/lib_acl/src/net/acl_host_port.c", 101, __FUNCTION__, buf, ptr);
  return -1;
 }

 if (*port != 
# 105 "/acl/lib_acl/src/net/acl_host_port.c" 3 4
             ((void *)0) 
# 105 "/acl/lib_acl/src/net/acl_host_port.c"
                  && atoi(*port) < 0) {
  acl_msg_error("%s(%d), %s: invalid port: %s, addr: %s",
   "/acl/lib_acl/src/net/acl_host_port.c", 107, __FUNCTION__,
   *port ? *port : "null", buf);
  return -1;
 }
  ...
  *host = 0;
 if (*host == 
# 114 "/acl/lib_acl/src/net/acl_host_port.c" 3 4
             ((void *)0)
# 114 "/acl/lib_acl/src/net/acl_host_port.c"
                 )
...
# 126 "/acl/lib_acl/src/net/acl_host_port.c" 3 4
                                      0
# 126 "/acl/lib_acl/src/net/acl_host_port.c"
                                               );
}
...
struct addrinfo *acl_host_addrinfo2(const char *addr, int type, int family)
{
 ...
 char *buf = acl_strdup_glue("/acl/lib_acl/src/net/acl_host_port.c", 133, (addr));
 char *host = 
# 134 "/acl/lib_acl/src/net/acl_host_port.c" 3 4
             ((void *)0)
# 134 "/acl/lib_acl/src/net/acl_host_port.c"
                 , *port = 
# 134 "/acl/lib_acl/src/net/acl_host_port.c" 3 4
                           ((void *)0)
# 134 "/acl/lib_acl/src/net/acl_host_port.c"
 ...
 if (host_port(buf, &host, &port) < 0) {
  do { if (buf) { acl_free_glue("/acl/lib_acl/src/net/acl_host_port.c", 137, (buf)); (buf) = 
# 137 "/acl/lib_acl/src/net/acl_host_port.c" 3 4
 ((void *)0)
# 137 "/acl/lib_acl/src/net/acl_host_port.c"
 ; } } while (0);
  return 
# 138 "/acl/lib_acl/src/net/acl_host_port.c" 3 4
        ((void *)0)
# 138 "/acl/lib_acl/src/net/acl_host_port.c"
            ;
 }
...
# 154 "/acl/lib_acl/src/net/acl_host_port.c"
 hints.ai_flags = 
# 154 "/acl/lib_acl/src/net/acl_host_port.c" 3 4
                    0x0008 
# 154 "/acl/lib_acl/src/net/acl_host_port.c"
                                | 
# 154 "/acl/lib_acl/src/net/acl_host_port.c" 3 4
...
# 154 "/acl/lib_acl/src/net/acl_host_port.c"
 ...
 if ((err = getaddrinfo(host, port, &hints, &res0))) {
  acl_msg_error("%s(%d): getaddrinfo error %s, host=%s, addr=%s",
   "/acl/lib_acl/src/net/acl_host_port.c", 158, gai_strerror(err), host, addr);
  do { if (buf) { acl_free_glue("/acl/lib_acl/src/net/acl_host_port.c", 159, (buf)); (buf) = 
# 159 "/acl/lib_acl/src/net/acl_host_port.c" 3 4
 ((void *)0)
# 159 "/acl/lib_acl/src/net/acl_host_port.c"
 ; } } while (0);
  return 
# 160 "/acl/lib_acl/src/net/acl_host_port.c" 3 4
        ((void *)0)
# 160 "/acl/lib_acl/src/net/acl_host_port.c"
            ;
 }

 do { if (buf) { acl_free_glue("/acl/lib_acl/src/net/acl_host_port.c", 163, (buf)); (buf) = 
# 163 "/acl/lib_acl/src/net/acl_host_port.c" 3 4
((void *)0)
# 163 "/acl/lib_acl/src/net/acl_host_port.c"
; } } while (0);
 return res0;
}
