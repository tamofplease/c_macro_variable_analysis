# 1 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 3 "/workspace/acl/lib_acl/src/net/acl_host_port.c" 2
# 33 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
 ...
 char **port, char *def_service)
{
  ...
  *host = *buf ? buf : (def_host ? def_host : 
# 62 "/workspace/acl/lib_acl/src/net/acl_host_port.c" 3 4
                                             ((void *)0)
# 62 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
                                                 );
  *port = def_service ? def_service : 
# 63 "/workspace/acl/lib_acl/src/net/acl_host_port.c" 3 4
                                     ((void *)0)
# 63 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
                                         ;
 }

 if (*host == 0)
  return "missing host information";
# 78 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
 if (*host != def_host
     && !acl_valid_hostname(*host, 0)
     && !acl_valid_hostaddr(*host, 0)) {
 ...
 if (*port == 0)
  return 
# 86 "/workspace/acl/lib_acl/src/net/acl_host_port.c" 3 4
        ((void *)0)
# 86 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
            ;

 if (*port != def_service && 
# 88 "/workspace/acl/lib_acl/src/net/acl_host_port.c" 3 4
                            ((*__ctype_b_loc ())[(int) ((
# 88 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
                            ((unsigned char)(**port))
# 88 "/workspace/acl/lib_acl/src/net/acl_host_port.c" 3 4
...
# 88 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
 ...
 return 
# 91 "/workspace/acl/lib_acl/src/net/acl_host_port.c" 3 4
       ((void *)0)
# 91 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
           ;
}
...
# 97 "/workspace/acl/lib_acl/src/net/acl_host_port.c" 3 4
                                                           ((void *)0)
# 97 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
                                                               );

 if (ptr != 
# 99 "/workspace/acl/lib_acl/src/net/acl_host_port.c" 3 4
           ((void *)0)
# 99 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
               ) {
  acl_msg_error("%s(%d), %s: invalid addr %s, %s",
   "/workspace/acl/lib_acl/src/net/acl_host_port.c", 101, __FUNCTION__, buf, ptr);
  return -1;
 }

 if (*port != 
# 105 "/workspace/acl/lib_acl/src/net/acl_host_port.c" 3 4
             ((void *)0) 
# 105 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
                  && atoi(*port) < 0) {
  acl_msg_error("%s(%d), %s: invalid port: %s, addr: %s",
   "/workspace/acl/lib_acl/src/net/acl_host_port.c", 107, __FUNCTION__,
   *port ? *port : "null", buf);
  return -1;
 }
  ...
  *host = 0;
 if (*host == 
# 114 "/workspace/acl/lib_acl/src/net/acl_host_port.c" 3 4
             ((void *)0)
# 114 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
                 )
...
struct addrinfo *acl_host_addrinfo(const char *addr, int type)
{
 return acl_host_addrinfo2(addr, type, 
# 126 "/workspace/acl/lib_acl/src/net/acl_host_port.c" 3 4
                                      0
# 126 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
                                               );
}
...
struct addrinfo *acl_host_addrinfo2(const char *addr, int type, int family)
{
 ...
 char *buf = acl_strdup_glue("/workspace/acl/lib_acl/src/net/acl_host_port.c", 133, (addr));
 char *host = 
# 134 "/workspace/acl/lib_acl/src/net/acl_host_port.c" 3 4
             ((void *)0)
# 134 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
                 , *port = 
# 134 "/workspace/acl/lib_acl/src/net/acl_host_port.c" 3 4
                           ((void *)0)
# 134 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
 ...
 if (host_port(buf, &host, &port) < 0) {
  do { if (buf) { acl_free_glue("/workspace/acl/lib_acl/src/net/acl_host_port.c", 137, (buf)); (buf) = 
# 137 "/workspace/acl/lib_acl/src/net/acl_host_port.c" 3 4
 ((void *)0)
# 137 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
 ; } } while (0);
  return 
# 138 "/workspace/acl/lib_acl/src/net/acl_host_port.c" 3 4
        ((void *)0)
# 138 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
            ;
 }
...
# 154 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
 hints.ai_flags = 
# 154 "/workspace/acl/lib_acl/src/net/acl_host_port.c" 3 4
                    0x0008 
# 154 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
                                | 
# 154 "/workspace/acl/lib_acl/src/net/acl_host_port.c" 3 4
...
# 154 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
 ...
 if ((err = getaddrinfo(host, port, &hints, &res0))) {
  acl_msg_error("%s(%d): getaddrinfo error %s, host=%s, addr=%s",
   "/workspace/acl/lib_acl/src/net/acl_host_port.c", 158, gai_strerror(err), host, addr);
  do { if (buf) { acl_free_glue("/workspace/acl/lib_acl/src/net/acl_host_port.c", 159, (buf)); (buf) = 
# 159 "/workspace/acl/lib_acl/src/net/acl_host_port.c" 3 4
 ((void *)0)
# 159 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
 ; } } while (0);
  return 
# 160 "/workspace/acl/lib_acl/src/net/acl_host_port.c" 3 4
        ((void *)0)
# 160 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
            ;
 }

 do { if (buf) { acl_free_glue("/workspace/acl/lib_acl/src/net/acl_host_port.c", 163, (buf)); (buf) = 
# 163 "/workspace/acl/lib_acl/src/net/acl_host_port.c" 3 4
((void *)0)
# 163 "/workspace/acl/lib_acl/src/net/acl_host_port.c"
; } } while (0);
 return res0;
}
