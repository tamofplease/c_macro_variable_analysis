# 0 "/acl/lib_acl/src/json/acl_json.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/json/acl_json.c"
...
# 2 "/acl/lib_acl/src/json/acl_json.c" 2
# 14 "/acl/lib_acl/src/json/acl_json.c"
static ACL_JSON_NODE *node_iter_head(ACL_ITER *it, ACL_JSON_NODE *node)
{
 ...
 it->dlen = -1;
 it->key = 
# 19 "/acl/lib_acl/src/json/acl_json.c" 3 4
          ((void *)0)
# 19 "/acl/lib_acl/src/json/acl_json.c"
              ;
 it->klen = -1;
 ...
 if ((ring_ptr = ((&node->children)->succ)) == &node->children) {
  it->ptr = it->data = 
# 26 "/acl/lib_acl/src/json/acl_json.c" 3 4
                      ((void *)0)
# 26 "/acl/lib_acl/src/json/acl_json.c"
                          ;
  return 
# 27 "/acl/lib_acl/src/json/acl_json.c" 3 4
        ((void *)0)
# 27 "/acl/lib_acl/src/json/acl_json.c"
            ;
 }
 it->ptr = ((ACL_JSON_NODE *) (((char *) (ring_ptr)) - 
# 29 "/acl/lib_acl/src/json/acl_json.c" 3 4
          __builtin_offsetof (
# 29 "/acl/lib_acl/src/json/acl_json.c"
          ACL_JSON_NODE
# 29 "/acl/lib_acl/src/json/acl_json.c" 3 4
          , 
# 29 "/acl/lib_acl/src/json/acl_json.c"
...
static ACL_JSON_NODE *node_iter_next(ACL_ITER *it, ACL_JSON_NODE *node)
{
 ...
 if ((ring_ptr = ((&child->node)->succ)) == &node->children) {
  it->ptr = it->data = 
# 41 "/acl/lib_acl/src/json/acl_json.c" 3 4
                      ((void *)0)
# 41 "/acl/lib_acl/src/json/acl_json.c"
                          ;
  return 
# 42 "/acl/lib_acl/src/json/acl_json.c" 3 4
        ((void *)0)
# 42 "/acl/lib_acl/src/json/acl_json.c"
            ;
 }
 it->i++;
 it->ptr = ((ACL_JSON_NODE *) (((char *) (ring_ptr)) - 
# 45 "/acl/lib_acl/src/json/acl_json.c" 3 4
          __builtin_offsetof (
# 45 "/acl/lib_acl/src/json/acl_json.c"
          ACL_JSON_NODE
# 45 "/acl/lib_acl/src/json/acl_json.c" 3 4
          , 
# 45 "/acl/lib_acl/src/json/acl_json.c"
...
static ACL_JSON_NODE *node_iter_tail(ACL_ITER *it, ACL_JSON_NODE *node)
{
 ...
 it->dlen = -1;
 it->key = 
# 55 "/acl/lib_acl/src/json/acl_json.c" 3 4
          ((void *)0)
# 55 "/acl/lib_acl/src/json/acl_json.c"
              ;
 it->klen = -1;
 ...
 if ((ring_ptr = ((&node->children)->pred)) == &node->children) {
  it->ptr = it->data = 
# 62 "/acl/lib_acl/src/json/acl_json.c" 3 4
                      ((void *)0)
# 62 "/acl/lib_acl/src/json/acl_json.c"
                          ;
  return 
# 63 "/acl/lib_acl/src/json/acl_json.c" 3 4
        ((void *)0)
# 63 "/acl/lib_acl/src/json/acl_json.c"
            ;
 }

 it->ptr = ((ACL_JSON_NODE *) (((char *) (ring_ptr)) - 
# 66 "/acl/lib_acl/src/json/acl_json.c" 3 4
          __builtin_offsetof (
# 66 "/acl/lib_acl/src/json/acl_json.c"
          ACL_JSON_NODE
# 66 "/acl/lib_acl/src/json/acl_json.c" 3 4
          , 
# 66 "/acl/lib_acl/src/json/acl_json.c"
...
static ACL_JSON_NODE *node_iter_prev(ACL_ITER *it, ACL_JSON_NODE *node)
{
 ...
 if ((ring_ptr = ((&child->node)->pred)) == &node->children) {
  it->ptr = it->data = 
# 78 "/acl/lib_acl/src/json/acl_json.c" 3 4
                      ((void *)0)
# 78 "/acl/lib_acl/src/json/acl_json.c"
                          ;
  return 
# 79 "/acl/lib_acl/src/json/acl_json.c" 3 4
        ((void *)0)
# 79 "/acl/lib_acl/src/json/acl_json.c"
            ;
 }
 it->i++;
 it->ptr = ((ACL_JSON_NODE *) (((char *) (ring_ptr)) - 
# 82 "/acl/lib_acl/src/json/acl_json.c" 3 4
          __builtin_offsetof (
# 82 "/acl/lib_acl/src/json/acl_json.c"
          ACL_JSON_NODE
# 82 "/acl/lib_acl/src/json/acl_json.c" 3 4
          , 
# 82 "/acl/lib_acl/src/json/acl_json.c"
...
ACL_JSON_NODE *acl_json_node_alloc(ACL_JSON *json)
{
 ...
 node->tag_node = 
# 99 "/acl/lib_acl/src/json/acl_json.c" 3 4
                  ((void *)0)
# 99 "/acl/lib_acl/src/json/acl_json.c"
                      ;
 node->parent = 
# 100 "/acl/lib_acl/src/json/acl_json.c" 3 4
                  ((void *)0)
# 100 "/acl/lib_acl/src/json/acl_json.c"
                      ;
 node->type = 0;
 node->depth = 0;
 node->quote = 0;
...
# 125 "/acl/lib_acl/src/json/acl_json.c" 3 4
                                                      ((void *)0)
# 125 "/acl/lib_acl/src/json/acl_json.c"
                                                          ) {
  node_next = ((ACL_JSON_NODE *) (((char *) (next)) - 
# 126 "/acl/lib_acl/src/json/acl_json.c" 3 4
             __builtin_offsetof (
# 126 "/acl/lib_acl/src/json/acl_json.c"
             ACL_JSON_NODE
# 126 "/acl/lib_acl/src/json/acl_json.c" 3 4
             , 
# 126 "/acl/lib_acl/src/json/acl_json.c"
...
ACL_JSON_NODE *acl_json_node_next(ACL_JSON_NODE *node)
{
 ...
 if (ring_ptr == &node->node)
  return 
# 159 "/acl/lib_acl/src/json/acl_json.c" 3 4
        ((void *)0)
# 159 "/acl/lib_acl/src/json/acl_json.c"
            ;
 parent = node->parent;
 
# 161 "/acl/lib_acl/src/json/acl_json.c" 3 4
((void) sizeof ((
# 161 "/acl/lib_acl/src/json/acl_json.c"
parent != 
# 161 "/acl/lib_acl/src/json/acl_json.c" 3 4
...
"parent != NULL"
# 161 "/acl/lib_acl/src/json/acl_json.c" 3 4
, "/acl/lib_acl/src/json/acl_json.c", 161, __extension__ __PRETTY_FUNCTION__); }))
# 161 "/acl/lib_acl/src/json/acl_json.c"
                          ;
 if (ring_ptr == &parent->children)
  return 
# 163 "/acl/lib_acl/src/json/acl_json.c" 3 4
        ((void *)0)
# 163 "/acl/lib_acl/src/json/acl_json.c"
            ;
 return ((ACL_JSON_NODE *) (((char *) (ring_ptr)) - 
# 164 "/acl/lib_acl/src/json/acl_json.c" 3 4
       __builtin_offsetof (
# 164 "/acl/lib_acl/src/json/acl_json.c"
       ACL_JSON_NODE
# 164 "/acl/lib_acl/src/json/acl_json.c" 3 4
       , 
# 164 "/acl/lib_acl/src/json/acl_json.c"
...
ACL_JSON_NODE *acl_json_node_prev(ACL_JSON_NODE *node)
{
 ...
 if (ring_ptr == &node->node)
  return 
# 173 "/acl/lib_acl/src/json/acl_json.c" 3 4
        ((void *)0)
# 173 "/acl/lib_acl/src/json/acl_json.c"
            ;
 parent = node->parent;
 
# 175 "/acl/lib_acl/src/json/acl_json.c" 3 4
((void) sizeof ((
# 175 "/acl/lib_acl/src/json/acl_json.c"
parent != 
# 175 "/acl/lib_acl/src/json/acl_json.c" 3 4
((void *)0)) ? 1 : 0), __extension__ ({ if (
# 175 "/acl/lib_acl/src/json/acl_json.c"
...
"parent != NULL"
# 175 "/acl/lib_acl/src/json/acl_json.c" 3 4
, "/acl/lib_acl/src/json/acl_json.c", 175, __extension__ __PRETTY_FUNCTION__); }))
# 175 "/acl/lib_acl/src/json/acl_json.c"
                          ;
 if (ring_ptr == &parent->children)
  return 
# 177 "/acl/lib_acl/src/json/acl_json.c" 3 4
        ((void *)0)
# 177 "/acl/lib_acl/src/json/acl_json.c"
            ;

 return ((ACL_JSON_NODE *) (((char *) (ring_ptr)) - 
# 179 "/acl/lib_acl/src/json/acl_json.c" 3 4
       __builtin_offsetof (
# 179 "/acl/lib_acl/src/json/acl_json.c"
       ACL_JSON_NODE
# 179 "/acl/lib_acl/src/json/acl_json.c" 3 4
       , 
# 179 "/acl/lib_acl/src/json/acl_json.c"
...
static ACL_JSON_NODE *json_iter_head(ACL_ITER *it, ACL_JSON *json)
{
 ...
 it->dlen = -1;
 it->key = 
# 191 "/acl/lib_acl/src/json/acl_json.c" 3 4
          ((void *)0)
# 191 "/acl/lib_acl/src/json/acl_json.c"
              ;
 it->klen = -1;
 ...
 if (ring_ptr== &json->root->children) {
  it->ptr = it->data = 
# 199 "/acl/lib_acl/src/json/acl_json.c" 3 4
                      ((void *)0)
# 199 "/acl/lib_acl/src/json/acl_json.c"
                          ;
  return 
# 200 "/acl/lib_acl/src/json/acl_json.c" 3 4
        ((void *)0)
# 200 "/acl/lib_acl/src/json/acl_json.c"
            ;
 }
 it->ptr = ((ACL_JSON_NODE *) (((char *) (ring_ptr)) - 
# 202 "/acl/lib_acl/src/json/acl_json.c" 3 4
          __builtin_offsetof (
# 202 "/acl/lib_acl/src/json/acl_json.c"
          ACL_JSON_NODE
# 202 "/acl/lib_acl/src/json/acl_json.c" 3 4
          , 
# 202 "/acl/lib_acl/src/json/acl_json.c"
...
static ACL_JSON_NODE *json_iter_next(ACL_ITER *it, ACL_JSON *json)
{
 ...
 if (ring_ptr != &node->children) {
  it->i++;
  it->ptr = ((ACL_JSON_NODE *) (((char *) (ring_ptr)) - 
# 220 "/acl/lib_acl/src/json/acl_json.c" 3 4
           __builtin_offsetof (
# 220 "/acl/lib_acl/src/json/acl_json.c"
           ACL_JSON_NODE
# 220 "/acl/lib_acl/src/json/acl_json.c" 3 4
           , 
# 220 "/acl/lib_acl/src/json/acl_json.c"
...
# 220 "/acl/lib_acl/src/json/acl_json.c"
 ...
 if (ring_ptr != &parent->children) {
  it->i++;
  it->ptr = ((ACL_JSON_NODE *) (((char *) (ring_ptr)) - 
# 231 "/acl/lib_acl/src/json/acl_json.c" 3 4
           __builtin_offsetof (
# 231 "/acl/lib_acl/src/json/acl_json.c"
           ACL_JSON_NODE
# 231 "/acl/lib_acl/src/json/acl_json.c" 3 4
           , 
# 231 "/acl/lib_acl/src/json/acl_json.c"
...
# 231 "/acl/lib_acl/src/json/acl_json.c"
 ...
 do {
  ...
  if (parent == 
# 244 "/acl/lib_acl/src/json/acl_json.c" 3 4
               ((void *)0)
# 244 "/acl/lib_acl/src/json/acl_json.c"
                   )
   acl_msg_fatal("%s(%d): parent null", "/acl/lib_acl/src/json/acl_json.c", 245);

  if (ring_ptr != &parent->children) {
   it->i++;
   it->ptr = ((ACL_JSON_NODE *) (((char *) (ring_ptr)) - 
# 249 "/acl/lib_acl/src/json/acl_json.c" 3 4
            __builtin_offsetof (
# 249 "/acl/lib_acl/src/json/acl_json.c"
            ACL_JSON_NODE
# 249 "/acl/lib_acl/src/json/acl_json.c" 3 4
            , 
# 249 "/acl/lib_acl/src/json/acl_json.c"
...
# 249 "/acl/lib_acl/src/json/acl_json.c"
 ...
 it->ptr = it->data = 
# 257 "/acl/lib_acl/src/json/acl_json.c" 3 4
                     ((void *)0)
# 257 "/acl/lib_acl/src/json/acl_json.c"
                         ;
 return 
# 258 "/acl/lib_acl/src/json/acl_json.c" 3 4
       ((void *)0)
# 258 "/acl/lib_acl/src/json/acl_json.c"
           ;
}
...
static ACL_JSON_NODE *json_iter_tail(ACL_ITER *it, ACL_JSON *json)
{
 ...
 it->dlen = -1;
 it->key = 
# 266 "/acl/lib_acl/src/json/acl_json.c" 3 4
          ((void *)0)
# 266 "/acl/lib_acl/src/json/acl_json.c"
              ;
 it->klen = -1;
 ...
 if (ring_ptr== &json->root->children) {
  it->ptr = it->data = 
# 274 "/acl/lib_acl/src/json/acl_json.c" 3 4
                      ((void *)0)
# 274 "/acl/lib_acl/src/json/acl_json.c"
                          ;
  return 
# 275 "/acl/lib_acl/src/json/acl_json.c" 3 4
        ((void *)0)
# 275 "/acl/lib_acl/src/json/acl_json.c"
            ;
 }
 it->ptr = ((ACL_JSON_NODE *) (((char *) (ring_ptr)) - 
# 277 "/acl/lib_acl/src/json/acl_json.c" 3 4
          __builtin_offsetof (
# 277 "/acl/lib_acl/src/json/acl_json.c"
          ACL_JSON_NODE
# 277 "/acl/lib_acl/src/json/acl_json.c" 3 4
          , 
# 277 "/acl/lib_acl/src/json/acl_json.c"
...
static ACL_JSON_NODE *json_iter_prev(ACL_ITER *it, ACL_JSON *json)
{
 ...
 if (ring_ptr != &node->children) {
  it->i++;
  it->ptr = ((ACL_JSON_NODE *) (((char *) (ring_ptr)) - 
# 294 "/acl/lib_acl/src/json/acl_json.c" 3 4
           __builtin_offsetof (
# 294 "/acl/lib_acl/src/json/acl_json.c"
           ACL_JSON_NODE
# 294 "/acl/lib_acl/src/json/acl_json.c" 3 4
           , 
# 294 "/acl/lib_acl/src/json/acl_json.c"
...
# 294 "/acl/lib_acl/src/json/acl_json.c"
 ...
 if (ring_ptr != &parent->children) {
  it->i++;
  it->ptr = ((ACL_JSON_NODE *) (((char *) (ring_ptr)) - 
# 305 "/acl/lib_acl/src/json/acl_json.c" 3 4
           __builtin_offsetof (
# 305 "/acl/lib_acl/src/json/acl_json.c"
           ACL_JSON_NODE
# 305 "/acl/lib_acl/src/json/acl_json.c" 3 4
           , 
# 305 "/acl/lib_acl/src/json/acl_json.c"
...
# 305 "/acl/lib_acl/src/json/acl_json.c"
 ...
 do {
  ...
  parent = acl_json_node_parent(parent);
  if (parent == 
# 317 "/acl/lib_acl/src/json/acl_json.c" 3 4
               ((void *)0)
# 317 "/acl/lib_acl/src/json/acl_json.c"
                   )
   acl_msg_fatal("%s(%d): parent null", "/acl/lib_acl/src/json/acl_json.c", 318);

  if (ring_ptr != &parent->children) {
   it->i++;
   it->ptr = ((ACL_JSON_NODE *) (((char *) (ring_ptr)) - 
# 322 "/acl/lib_acl/src/json/acl_json.c" 3 4
            __builtin_offsetof (
# 322 "/acl/lib_acl/src/json/acl_json.c"
            ACL_JSON_NODE
# 322 "/acl/lib_acl/src/json/acl_json.c" 3 4
            , 
# 322 "/acl/lib_acl/src/json/acl_json.c"
...
# 322 "/acl/lib_acl/src/json/acl_json.c"
 ...
 it->ptr = it->data = 
# 330 "/acl/lib_acl/src/json/acl_json.c" 3 4
                     ((void *)0)
# 330 "/acl/lib_acl/src/json/acl_json.c"
                         ;
 return 
# 331 "/acl/lib_acl/src/json/acl_json.c" 3 4
       ((void *)0)
# 331 "/acl/lib_acl/src/json/acl_json.c"
           ;
}
...
# 336 "/acl/lib_acl/src/json/acl_json.c" 3 4
                           ((void *)0)
# 336 "/acl/lib_acl/src/json/acl_json.c"
                               );
}
...
ACL_JSON *acl_json_dbuf_alloc(ACL_DBUF_POOL *dbuf)
{
 ...
 if (dbuf == 
# 343 "/acl/lib_acl/src/json/acl_json.c" 3 4
            ((void *)0)
# 343 "/acl/lib_acl/src/json/acl_json.c"
                ) {
  ...
  json = (ACL_JSON*) acl_dbuf_pool_calloc(dbuf, sizeof(ACL_JSON));
  json->dbuf_inner = 
# 349 "/acl/lib_acl/src/json/acl_json.c" 3 4
                    ((void *)0)
# 349 "/acl/lib_acl/src/json/acl_json.c"
                        ;
 }
...
# 366 "/acl/lib_acl/src/json/acl_json.c"
 json->root->left_ch = 0;
...
# 395 "/acl/lib_acl/src/json/acl_json.c" 3 4
              __builtin_offsetof (
# 395 "/acl/lib_acl/src/json/acl_json.c"
              ACL_JSON_NODE
# 395 "/acl/lib_acl/src/json/acl_json.c" 3 4
              , 
# 395 "/acl/lib_acl/src/json/acl_json.c"
...
ACL_JSON *acl_json_dbuf_create(ACL_DBUF_POOL *dbuf, ACL_JSON_NODE *node)
{
 ...
 json->dbuf = dbuf;
    json->dbuf_inner = 
# 421 "/acl/lib_acl/src/json/acl_json.c" 3 4
                      ((void *)0)
# 421 "/acl/lib_acl/src/json/acl_json.c"
                          ;
...
{
 if (json->dbuf_inner != 
# 472 "/acl/lib_acl/src/json/acl_json.c" 3 4
                        ((void *)0)
# 472 "/acl/lib_acl/src/json/acl_json.c"
                            )
