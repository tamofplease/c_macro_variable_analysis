# 1 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 2
# 16 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
ACL_JSON_NODE *acl_json_getFirstElementByTagName(
 ACL_JSON *json, const char *tag)
{
 ACL_ITER iter;

 for ((json)->iter_head(&(iter), (json)); (iter).ptr; (json)->iter_next(&(iter), (json))) {
 ...
 return 
# 27 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
       ((void *)0)
# 27 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
           ;
}
...
{
 acl_array_free(a, 
# 32 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
                     ((void *)0)
# 32 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
                         );
}
...
ACL_ARRAY *acl_json_getElementsByTagName(ACL_JSON *json, const char *tag)
{
 ...
 if (acl_array_size(a) == 0) {
  acl_array_free(a, 
# 48 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
                      ((void *)0)
# 48 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
                          );
  return 
# 49 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
        ((void *)0)
# 49 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
            ;
 }
...
ACL_ARRAY *acl_json_getElementsByTags(ACL_JSON *json, const char *tags)
{
 ...
 if (a == 
# 64 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
         ((void *)0)
# 64 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
             ) {
  acl_argv_free(tokens);
  return 
# 66 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
        ((void *)0)
# 66 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
            ;
 }
...
# 77 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
                                  ((void *)0)
# 77 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
                                      ) {
   if (node->left_ch != 0) {
    node = node->parent;
   } else if (strcasecmp((tokens->argv[i]), ("*"))
    && strcasecmp((tokens->argv[i]), (((char *) (node->ltag)->vbuf.data)))) {
 ...
 if (acl_array_size(result) == 0) {
  acl_array_free(result, 
# 98 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
                        ((void *)0)
# 98 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
                            );
  result = 
# 99 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
          ((void *)0)
# 99 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
              ;
 }
 return result;
}
...
ACL_JSON_NODE *acl_json_create_array_int64(ACL_JSON *json, long long int value)
{
 ACL_JSON_NODE *node = acl_json_node_alloc(json);
...
static void json_escape_append(ACL_VSTRING *buf, const char *src)
{
 ...
 while (*ptr) {
  if (*ptr == '"' || *ptr == '\\') {
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = ('\\')) : acl_vbuf_put((&(buf)->vbuf),('\\')));
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = (*ptr)) : acl_vbuf_put((&(buf)->vbuf),(*ptr)));
  } else if (*ptr == '\b') {
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = ('\\')) : acl_vbuf_put((&(buf)->vbuf),('\\')));
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = ('b')) : acl_vbuf_put((&(buf)->vbuf),('b')));
  } else if (*ptr == '\f') {
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = ('\\')) : acl_vbuf_put((&(buf)->vbuf),('\\')));
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = ('f')) : acl_vbuf_put((&(buf)->vbuf),('f')));
  } else if (*ptr == '\n') {
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = ('\\')) : acl_vbuf_put((&(buf)->vbuf),('\\')));
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = ('n')) : acl_vbuf_put((&(buf)->vbuf),('n')));
  } else if (*ptr == '\r') {
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = ('\\')) : acl_vbuf_put((&(buf)->vbuf),('\\')));
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = ('r')) : acl_vbuf_put((&(buf)->vbuf),('r')));
  } else if (*ptr == '\t') {
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = ('\\')) : acl_vbuf_put((&(buf)->vbuf),('\\')));
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = ('t')) : acl_vbuf_put((&(buf)->vbuf),('t')));
  } else
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = (*ptr)) : acl_vbuf_put((&(buf)->vbuf),(*ptr)));
  ptr++;
 }
 ...
 int (*callback)(ACL_JSON *, ACL_VSTRING *, void *), void *ctx)
{
 ...
 ACL_RING *ring_ptr = ((&json->root->children)->succ);
 ...
 if (ring_ptr == &json->root->children) {
  ...
  node = ((ACL_JSON_NODE *) (((char *) (ring_ptr)) - 
# 318 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
        __builtin_offsetof (
# 318 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
        ACL_JSON_NODE
# 318 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
        , 
# 318 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
...
# 318 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
 ...
 if (json->root->left_ch > 0)
  ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = (json->root->left_ch)) : acl_vbuf_put((&(buf)->vbuf),(json->root->left_ch)));

 for ((json)->iter_head(&(iter), (json)); (iter).ptr; (json)->iter_next(&(iter), (json))) {
  if ((size_t) ((buf)->vbuf.ptr - (buf)->vbuf.data) >= length && callback != 
# 332 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
                                                   ((void *)0)
# 332 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
                                                       ) {
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? *(&(buf)->vbuf)->ptr = 0 : acl_vbuf_space((&(buf)->vbuf), 1), *(&(buf)->vbuf)->ptr = 0);
  ...
  if (prev != 
# 343 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
             ((void *)0)
# 343 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
                 ) {
   if ((json->flag & (1 << 1)))
  ...
  if (node->tag_node != 
# 351 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
                       ((void *)0)
# 351 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
                           ) {
   if ((size_t) ((node->ltag)->vbuf.ptr - (node->ltag)->vbuf.data) > 0) {
    json_escape_append(buf, ((char *) (node->ltag)->vbuf.data));
    ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = (':')) : acl_vbuf_put((&(buf)->vbuf),(':')));
    if ((json->flag & (1 << 1)))
     ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = (' ')) : acl_vbuf_put((&(buf)->vbuf),(' ')));
   }
   ...
   if (node->left_ch != 0)
    ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = (node->left_ch)) : acl_vbuf_put((&(buf)->vbuf),(node->left_ch)));
  }


  else if ((size_t) ((node->ltag)->vbuf.ptr - (node->ltag)->vbuf.data) > 0) {
   json_escape_append(buf, ((char *) (node->ltag)->vbuf.data));
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = (':')) : acl_vbuf_put((&(buf)->vbuf),(':')));
   if ((json->flag & (1 << 1)))
    ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = (' ')) : acl_vbuf_put((&(buf)->vbuf),(' ')));

   switch (node->type & ~(1 << 12)) {
   case (1 << 8):
   ...
   case (1 << 9):
    ...
    break;
   default:
    json_escape_append(buf, ((char *) (node->text)->vbuf.data));
    break;
   }
  }


  else if ((size_t) ((node->text)->vbuf.ptr - (node->text)->vbuf.data) > 0 && node->parent
...
# 417 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
  if (acl_ring_size(&node->children) > 0) {
   continue;
  } else if (acl_json_node_next(node) != 
# 419 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
                                        ((void *)0)
# 419 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
                                            ) {
   if (node->right_ch > 0)
    ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = (node->right_ch)) : acl_vbuf_put((&(buf)->vbuf),(node->right_ch)));
   continue;
  }
  ...
  while (acl_json_node_next(node) == 
# 433 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
                                    ((void *)0)
# 433 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
                                        ) {
 ...
 if (json->root->right_ch > 0)
  ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = (json->root->right_ch)) : acl_vbuf_put((&(buf)->vbuf),(json->root->right_ch)));

 ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? *(&(buf)->vbuf)->ptr = 0 : acl_vbuf_space((&(buf)->vbuf), 1), *(&(buf)->vbuf)->ptr = 0);
 if ((size_t) ((buf)->vbuf.ptr - (buf)->vbuf.data) > 0 && callback != 
# 449 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
                                            ((void *)0)
# 449 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
                                                ) {
  if (callback(json, buf, ctx) < 0) {
   acl_vstring_free(buf);
   return;
 ...
 if (callback != 
# 459 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
                ((void *)0)
# 459 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
                    )
  (void) callback(json, 
# 460 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
                       ((void *)0)
# 460 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
                           , ctx);
}
...
ACL_VSTRING *acl_json_build(ACL_JSON *json, ACL_VSTRING *buf)
{
 ...
 if (buf == 
# 469 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
           ((void *)0)
# 469 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
               )
 ...
 if (ring_ptr == &json->root->children) {
  ...
  node = ((ACL_JSON_NODE *) (((char *) (ring_ptr)) - 
# 480 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
        __builtin_offsetof (
# 480 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
        ACL_JSON_NODE
# 480 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
        , 
# 480 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
...
# 480 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
 ...
 for ((json)->iter_head(&(iter), (json)); (iter).ptr; (json)->iter_next(&(iter), (json))) {
  ...
  prev = acl_json_node_prev(node);
  if (prev != 
# 496 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
             ((void *)0)
# 496 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
                 ) {
   if ((json->flag & (1 << 1)))
    acl_vstring_strcat(buf, ", ");
   else
  ...
  if (node->tag_node != 
# 504 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
                       ((void *)0)
# 504 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
                           ) {
   if ((size_t) ((node->ltag)->vbuf.ptr - (node->ltag)->vbuf.data) > 0) {
    json_escape_append(buf, ((char *) (node->ltag)->vbuf.data));
    ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = (':')) : acl_vbuf_put((&(buf)->vbuf),(':')));
...
# 550 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
  else if (node->parent && node->parent->type == (1 << 10)
   && (node->type & ((1 << 3)
       | (1 << 2) | (1 << 1)
       | (1 << 4) | (1 << 0))))
...
# 585 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
  if (acl_ring_size(&node->children) > 0)
   continue;
  else if (acl_json_node_next(node) != 
# 587 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
                                      ((void *)0)
# 587 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
                                          ) {
   if (node->right_ch > 0)
    ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = (node->right_ch)) : acl_vbuf_put((&(buf)->vbuf),(node->right_ch)));
   continue;
  ...
  while (acl_json_node_next(node) == 
# 600 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
                                    ((void *)0)
# 600 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
                                        ) {
   if (node->parent == json->root)
    break;
...
ACL_VSTRING *acl_json_node_build(ACL_JSON_NODE *node, ACL_VSTRING *buf)
{
 ...
 if (buf == 
# 624 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
           ((void *)0)
# 624 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
               )
  buf = acl_vstring_alloc(256);

 if (node == node->json->root && node->tag_node != 
# 627 "/workspace/acl/lib_acl/src/json/acl_json_util.c" 3 4
                                                  ((void *)0)
# 627 "/workspace/acl/lib_acl/src/json/acl_json_util.c"
                                                      )
  node = node->tag_node;
 else
