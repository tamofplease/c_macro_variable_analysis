# 0 "/acl/lib_acl/src/json/acl_json_util.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/json/acl_json_util.c"
...
# 2 "/acl/lib_acl/src/json/acl_json_util.c" 2
# 16 "/acl/lib_acl/src/json/acl_json_util.c"
ACL_JSON_NODE *acl_json_getFirstElementByTagName(
 ACL_JSON *json, const char *tag)
{
 ACL_ITER iter;
 ...
 return 
# 27 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
       ((void *)0)
# 27 "/acl/lib_acl/src/json/acl_json_util.c"
           ;
}
...
{
 acl_array_free(a, 
# 32 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
                     ((void *)0)
# 32 "/acl/lib_acl/src/json/acl_json_util.c"
                         );
}
...
ACL_ARRAY *acl_json_getElementsByTagName(ACL_JSON *json, const char *tag)
{
 ...
 if (acl_array_size(a) == 0) {
  acl_array_free(a, 
# 48 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
                      ((void *)0)
# 48 "/acl/lib_acl/src/json/acl_json_util.c"
                          );
  return 
# 49 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
        ((void *)0)
# 49 "/acl/lib_acl/src/json/acl_json_util.c"
            ;
 }
...
ACL_ARRAY *acl_json_getElementsByTags(ACL_JSON *json, const char *tags)
{
 ...
 if (a == 
# 64 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
         ((void *)0)
# 64 "/acl/lib_acl/src/json/acl_json_util.c"
             ) {
  acl_argv_free(tokens);
  return 
# 66 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
        ((void *)0)
# 66 "/acl/lib_acl/src/json/acl_json_util.c"
            ;
 }
...
# 77 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
                                  ((void *)0)
# 77 "/acl/lib_acl/src/json/acl_json_util.c"
                                      ) {
   if (node->left_ch != 0) {
    node = node->parent;
...
# 98 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
                        ((void *)0)
# 98 "/acl/lib_acl/src/json/acl_json_util.c"
                            );
  result = 
# 99 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
          ((void *)0)
# 99 "/acl/lib_acl/src/json/acl_json_util.c"
              ;
 }
 return result;
}
...
# 318 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
        __builtin_offsetof (
# 318 "/acl/lib_acl/src/json/acl_json_util.c"
        ACL_JSON_NODE
# 318 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
        , 
# 318 "/acl/lib_acl/src/json/acl_json_util.c"
...
# 332 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
                                                   ((void *)0)
# 332 "/acl/lib_acl/src/json/acl_json_util.c"
                                                       ) {
   ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? *(&(buf)->vbuf)->ptr = 0 : acl_vbuf_space((&(buf)->vbuf), 1), *(&(buf)->vbuf)->ptr = 0);
  ...
  if (prev != 
# 343 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
             ((void *)0)
# 343 "/acl/lib_acl/src/json/acl_json_util.c"
                 ) {
   if ((json->flag & (1 << 1)))
  ...
  if (node->tag_node != 
# 351 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
                       ((void *)0)
# 351 "/acl/lib_acl/src/json/acl_json_util.c"
                           ) {
...
# 417 "/acl/lib_acl/src/json/acl_json_util.c"
  if (acl_ring_size(&node->children) > 0) {
   continue;
  } else if (acl_json_node_next(node) != 
# 419 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
                                        ((void *)0)
# 419 "/acl/lib_acl/src/json/acl_json_util.c"
                                            ) {
   if (node->right_ch > 0)
...
# 433 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
                                    ((void *)0)
# 433 "/acl/lib_acl/src/json/acl_json_util.c"
                                        ) {
...
# 449 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
                                            ((void *)0)
# 449 "/acl/lib_acl/src/json/acl_json_util.c"
                                                ) {
  if (callback(json, buf, ctx) < 0) {
   acl_vstring_free(buf);
   return;
 ...
 if (callback != 
# 459 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
                ((void *)0)
# 459 "/acl/lib_acl/src/json/acl_json_util.c"
                    )
  (void) callback(json, 
# 460 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
                       ((void *)0)
# 460 "/acl/lib_acl/src/json/acl_json_util.c"
                           , ctx);
}
...
ACL_VSTRING *acl_json_build(ACL_JSON *json, ACL_VSTRING *buf)
{
 ...
 if (buf == 
# 469 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
           ((void *)0)
# 469 "/acl/lib_acl/src/json/acl_json_util.c"
               )
 ...
 if (ring_ptr == &json->root->children) {
  ...
  node = ((ACL_JSON_NODE *) (((char *) (ring_ptr)) - 
# 480 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
        __builtin_offsetof (
# 480 "/acl/lib_acl/src/json/acl_json_util.c"
        ACL_JSON_NODE
# 480 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
        , 
# 480 "/acl/lib_acl/src/json/acl_json_util.c"
...
# 480 "/acl/lib_acl/src/json/acl_json_util.c"
 ...
 for ((json)->iter_head(&(iter), (json)); (iter).ptr; (json)->iter_next(&(iter), (json))) {
  ...
  prev = acl_json_node_prev(node);
  if (prev != 
# 496 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
             ((void *)0)
# 496 "/acl/lib_acl/src/json/acl_json_util.c"
                 ) {
   if ((json->flag & (1 << 1)))
    acl_vstring_strcat(buf, ", ");
   else
  ...
  if (node->tag_node != 
# 504 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
                       ((void *)0)
# 504 "/acl/lib_acl/src/json/acl_json_util.c"
                           ) {
   if ((size_t) ((node->ltag)->vbuf.ptr - (node->ltag)->vbuf.data) > 0) {
    json_escape_append(buf, ((char *) (node->ltag)->vbuf.data));
    ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = (':')) : acl_vbuf_put((&(buf)->vbuf),(':')));
...
# 550 "/acl/lib_acl/src/json/acl_json_util.c"
...
# 585 "/acl/lib_acl/src/json/acl_json_util.c"
  if (acl_ring_size(&node->children) > 0)
   continue;
  else if (acl_json_node_next(node) != 
# 587 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
                                      ((void *)0)
# 587 "/acl/lib_acl/src/json/acl_json_util.c"
                                          ) {
   if (node->right_ch > 0)
    ((&(buf)->vbuf)->ptr < (&(buf)->vbuf)->data + (&(buf)->vbuf)->len ? (int) (*(&(buf)->vbuf)->ptr++ = (node->right_ch)) : acl_vbuf_put((&(buf)->vbuf),(node->right_ch)));
   continue;
  ...
  while (acl_json_node_next(node) == 
# 600 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
                                    ((void *)0)
# 600 "/acl/lib_acl/src/json/acl_json_util.c"
                                        ) {
   if (node->parent == json->root)
    break;
...
ACL_VSTRING *acl_json_node_build(ACL_JSON_NODE *node, ACL_VSTRING *buf)
{
 ...
 if (buf == 
# 624 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
           ((void *)0)
# 624 "/acl/lib_acl/src/json/acl_json_util.c"
               )
  buf = acl_vstring_alloc(256);

 if (node == node->json->root && node->tag_node != 
# 627 "/acl/lib_acl/src/json/acl_json_util.c" 3 4
                                                  ((void *)0)
# 627 "/acl/lib_acl/src/json/acl_json_util.c"
                                                      )
  node = node->tag_node;
 else
