# 1 "/workspace/acl/lib_acl/src/json/acl_json_parse.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/json/acl_json_parse.c" 2
# 20 "/workspace/acl/lib_acl/src/json/acl_json_parse.c"
...
static const char *json_obj(ACL_JSON *json, const char *data)
{
 ...
 if ((size_t) ((json->curr_node->ltag)->vbuf.ptr - (json->curr_node->ltag)->vbuf.data) > 0)
...
# 110 "/workspace/acl/lib_acl/src/json/acl_json_parse.c" 3 4
((void) sizeof ((
# 110 "/workspace/acl/lib_acl/src/json/acl_json_parse.c"
parent
# 110 "/workspace/acl/lib_acl/src/json/acl_json_parse.c" 3 4
...
"parent"
# 110 "/workspace/acl/lib_acl/src/json/acl_json_parse.c" 3 4
, "/workspace/acl/lib_acl/src/json/acl_json_parse.c", 110, __extension__ __PRETTY_FUNCTION__); }))
# 110 "/workspace/acl/lib_acl/src/json/acl_json_parse.c"
                  ;
 ...
 if (((*data) == '\"' || (*data) == '\'') && json->curr_node->quote == 0)
  json->curr_node->quote = *data++;

 json->curr_node->type = (1 << 14);
...
static const char *json_tag(ACL_JSON *json, const char *data)
{
 ...
 while ((ch = *data) != 0) {
  ...
  if (node->quote) {
   if (node->backslash) {
    if (ch == 'b')
     ((&(node->ltag)->vbuf)->ptr < (&(node->ltag)->vbuf)->data + (&(node->ltag)->vbuf)->len ? (int) (*(&(node->ltag)->vbuf)->ptr++ = ('\b')) : acl_vbuf_put((&(node->ltag)->vbuf),('\b')));
    else if (ch == 'f')
     ((&(node->ltag)->vbuf)->ptr < (&(node->ltag)->vbuf)->data + (&(node->ltag)->vbuf)->len ? (int) (*(&(node->ltag)->vbuf)->ptr++ = ('\f')) : acl_vbuf_put((&(node->ltag)->vbuf),('\f')));
    else if (ch == 'n')
     ((&(node->ltag)->vbuf)->ptr < (&(node->ltag)->vbuf)->data + (&(node->ltag)->vbuf)->len ? (int) (*(&(node->ltag)->vbuf)->ptr++ = ('\n')) : acl_vbuf_put((&(node->ltag)->vbuf),('\n')));
    else if (ch == 'r')
     ((&(node->ltag)->vbuf)->ptr < (&(node->ltag)->vbuf)->data + (&(node->ltag)->vbuf)->len ? (int) (*(&(node->ltag)->vbuf)->ptr++ = ('\r')) : acl_vbuf_put((&(node->ltag)->vbuf),('\r')));
    else if (ch == 't')
     ((&(node->ltag)->vbuf)->ptr < (&(node->ltag)->vbuf)->data + (&(node->ltag)->vbuf)->len ? (int) (*(&(node->ltag)->vbuf)->ptr++ = ('\t')) : acl_vbuf_put((&(node->ltag)->vbuf),('\t')));
    else
     ((&(node->ltag)->vbuf)->ptr < (&(node->ltag)->vbuf)->data + (&(node->ltag)->vbuf)->len ? (int) (*(&(node->ltag)->vbuf)->ptr++ = (ch)) : acl_vbuf_put((&(node->ltag)->vbuf),(ch)));
    node->backslash = 0;
   }
 ...
 if ((size_t) ((node->ltag)->vbuf.ptr - (node->ltag)->vbuf.data) > 0)
  ((&(node->ltag)->vbuf)->ptr < (&(node->ltag)->vbuf)->data + (&(node->ltag)->vbuf)->len ? *(&(node->ltag)->vbuf)->ptr = 0 : acl_vbuf_space((&(node->ltag)->vbuf), 1), *(&(node->ltag)->vbuf)->ptr = 0);
...
static const char *json_string(ACL_JSON *json, const char *data)
{
 ACL_JSON_NODE *node = json->curr_node;
 int ch;
# 416 "/workspace/acl/lib_acl/src/json/acl_json_parse.c"
 while ((ch = *data) != 0) {

  if (node->quote) {
   if (node->backslash) {
    if (ch == 'b')
     ((&(node->text)->vbuf)->ptr < (&(node->text)->vbuf)->data + (&(node->text)->vbuf)->len ? (int) (*(&(node->text)->vbuf)->ptr++ = ('\b')) : acl_vbuf_put((&(node->text)->vbuf),('\b')));
    else if (ch == 'f')
     ((&(node->text)->vbuf)->ptr < (&(node->text)->vbuf)->data + (&(node->text)->vbuf)->len ? (int) (*(&(node->text)->vbuf)->ptr++ = ('\f')) : acl_vbuf_put((&(node->text)->vbuf),('\f')));
    else if (ch == 'n')
     ((&(node->text)->vbuf)->ptr < (&(node->text)->vbuf)->data + (&(node->text)->vbuf)->len ? (int) (*(&(node->text)->vbuf)->ptr++ = ('\n')) : acl_vbuf_put((&(node->text)->vbuf),('\n')));
    else if (ch == 'r')
     ((&(node->text)->vbuf)->ptr < (&(node->text)->vbuf)->data + (&(node->text)->vbuf)->len ? (int) (*(&(node->text)->vbuf)->ptr++ = ('\r')) : acl_vbuf_put((&(node->text)->vbuf),('\r')));
    else if (ch == 't')
     ((&(node->text)->vbuf)->ptr < (&(node->text)->vbuf)->data + (&(node->text)->vbuf)->len ? (int) (*(&(node->text)->vbuf)->ptr++ = ('\t')) : acl_vbuf_put((&(node->text)->vbuf),('\t')));
    else
     ((&(node->text)->vbuf)->ptr < (&(node->text)->vbuf)->data + (&(node->text)->vbuf)->len ? (int) (*(&(node->text)->vbuf)->ptr++ = (ch)) : acl_vbuf_put((&(node->text)->vbuf),(ch)));
    node->backslash = 0;
   }
 ...
 if ((size_t) ((node->text)->vbuf.ptr - (node->text)->vbuf.data) > 0)
  ((&(node->text)->vbuf)->ptr < (&(node->text)->vbuf)->data + (&(node->text)->vbuf)->len ? *(&(node->text)->vbuf)->ptr = 0 : acl_vbuf_space((&(node->text)->vbuf), 1), *(&(node->text)->vbuf)->ptr = 0);
...
static const char *json_strend(ACL_JSON *json, const char *data)
{
 ...
 if (node->parent && node->parent->type == (1 << 10)) {
  if (node->quote == 0) {
   const char* txt = ((char *) (node->text)->vbuf.data);

   if (!strcasecmp((txt), (("null"))))
    node->type = (1 << 3)
     | (1 << 12);
   else if (!strcasecmp((txt), (("true"))) || !strcasecmp((txt), (("false"))))
    node->type = (1 << 2)
     | (1 << 12);
   else if ((acl_alldig((txt)) || ((*(txt) == '-' || *(txt) == '+') && *((txt) + 1) != 0 && acl_alldig((txt) + 1))))
    node->type = (1 << 1)
     | (1 << 12);
...
# 607 "/workspace/acl/lib_acl/src/json/acl_json_parse.c" 3 4
((void) sizeof ((
# 607 "/workspace/acl/lib_acl/src/json/acl_json_parse.c"
parent
# 607 "/workspace/acl/lib_acl/src/json/acl_json_parse.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 607 "/workspace/acl/lib_acl/src/json/acl_json_parse.c"
...
"parent"
# 607 "/workspace/acl/lib_acl/src/json/acl_json_parse.c" 3 4
, "/workspace/acl/lib_acl/src/json/acl_json_parse.c", 607, __extension__ __PRETTY_FUNCTION__); }))
# 607 "/workspace/acl/lib_acl/src/json/acl_json_parse.c"
                  ;
...
static struct JSON_STATUS_MACHINE status_tab[] = {
 { ACL_JSON_S_ROOT, json_root },
 { ACL_JSON_S_OBJ, json_obj },
 { ACL_JSON_S_MEMBER, json_member },
 { ACL_JSON_S_ARRAY, json_array },
 { ACL_JSON_S_ELEMENT, json_element },
 { ACL_JSON_S_PAIR, json_pair },
 { ACL_JSON_S_NEXT, json_brother },
 { ACL_JSON_S_TAG, json_tag },
 { ACL_JSON_S_VALUE, json_value },
 { ACL_JSON_S_COLON, json_colon },
...
const char* acl_json_update(ACL_JSON *json, const char *data)
{
 ...
 if (data == 
# 676 "/workspace/acl/lib_acl/src/json/acl_json_parse.c" 3 4
            ((void *)0)
# 676 "/workspace/acl/lib_acl/src/json/acl_json_parse.c"
                )
  return "";
