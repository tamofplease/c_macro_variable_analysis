# 1 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 2
# 20 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_array.h" 1
# 21 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 2
# 1 "/workspace/acl/lib_acl/src/aio/../event/events.h" 1
# 10 "/workspace/acl/lib_acl/src/aio/../event/events.h"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_ring.h" 1
# 11 "/workspace/acl/lib_acl/src/aio/../event/events.h" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_vstream.h" 1
# 12 "/workspace/acl/lib_acl/src/aio/../event/events.h" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_fifo.h" 1
# 13 "/workspace/acl/lib_acl/src/aio/../event/events.h" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_avl.h" 1
# 14 "/workspace/acl/lib_acl/src/aio/../event/events.h" 2
# 1 "/workspace/acl/lib_acl/include/thread/acl_thread.h" 1
# 15 "/workspace/acl/lib_acl/src/aio/../event/events.h" 2
# 1 "/workspace/acl/lib_acl/include/event/acl_events.h" 1
# 16 "/workspace/acl/lib_acl/src/aio/../event/events.h" 2

# 1 "/workspace/acl/lib_acl/src/aio/../event/events_dog.h" 1
# 11 "/workspace/acl/lib_acl/src/aio/../event/events_dog.h"
...
# 18 "/workspace/acl/lib_acl/src/aio/../event/events.h" 2
# 1 "/workspace/acl/lib_acl/src/aio/../event/fdmap.h" 1
...
# 19 "/workspace/acl/lib_acl/src/aio/../event/events.h" 2
# 1 "/workspace/acl/lib_acl/src/aio/../event/events_define.h" 1
# 10 "/workspace/acl/lib_acl/src/aio/../event/events_define.h"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_mymalloc.h" 1
# 11 "/workspace/acl/lib_acl/src/aio/../event/events_define.h" 2
# 20 "/workspace/acl/lib_acl/src/aio/../event/events.h" 2
# 1 "/workspace/acl/lib_acl/src/aio/../event/events_epoll.h" 1
# 27 "/workspace/acl/lib_acl/src/aio/../event/events_epoll.h"
...
# 28 "/workspace/acl/lib_acl/src/aio/../event/events_epoll.h" 2
# 87 "/workspace/acl/lib_acl/src/aio/../event/events_epoll.h"

# 87 "/workspace/acl/lib_acl/src/aio/../event/events_epoll.h"
typedef struct epoll_event EVENT_BUFFER;
# 21 "/workspace/acl/lib_acl/src/aio/../event/events.h" 2
# 1 "/workspace/acl/lib_acl/src/aio/../event/events_devpoll.h" 1
# 22 "/workspace/acl/lib_acl/src/aio/../event/events.h" 2
# 36 "/workspace/acl/lib_acl/src/aio/../event/events.h"
struct ACL_EVENT_FDTABLE {
 ...
 long long int r_ttl;
 long long int w_ttl;
 long long int r_timeout;
 long long int w_timeout;
 int event_type;
 int listener;
 int flag;
# 60 "/workspace/acl/lib_acl/src/aio/../event/events.h"
 int fdidx;
 int fdidx_ready;
...
struct ACL_EVENT {
 ...
 long long int present;
 long long int last_check;
 long long int check_inter;
 long long int last_debug;
 ...
 long long int (*timer_request)(ACL_EVENT *, ACL_EVENT_NOTIFY_TIME,
  void *, long long int, int);

 long long int (*timer_cancel)(ACL_EVENT *ev,
...
# 183 "/workspace/acl/lib_acl/src/aio/../event/events.h"
...
# 218 "/workspace/acl/lib_acl/src/aio/../event/events.h"
...
# 288 "/workspace/acl/lib_acl/src/aio/../event/events.h"
void event_timer_create(ACL_EVENT *eventp);
void event_timer_free(ACL_EVENT *eventp);
long long int event_timer_when(ACL_EVENT *eventp);
long long int event_timer_request(ACL_EVENT *ev, ACL_EVENT_NOTIFY_TIME callback,
 void *context, long long int delay, int keep);
long long int event_timer_cancel(ACL_EVENT *ev, ACL_EVENT_NOTIFY_TIME callback,
 void *context);
...
long long int event_timer_request_thr(ACL_EVENT *ev,
 ACL_EVENT_NOTIFY_TIME callback, void *context,
 long long int delay, int keep);
long long int event_timer_cancel_thr(ACL_EVENT *ev,
 ACL_EVENT_NOTIFY_TIME callback, void *context);
...
# 22 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 2
# 1 "/workspace/acl/lib_acl/src/aio/aio.h" 1
# 10 "/workspace/acl/lib_acl/src/aio/aio.h"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_vstring.h" 1
# 11 "/workspace/acl/lib_acl/src/aio/aio.h" 2

# 1 "/workspace/acl/lib_acl/include/net/acl_dns.h" 1
# 13 "/workspace/acl/lib_acl/src/aio/aio.h" 2
# 1 "/workspace/acl/lib_acl/include/aio/acl_aio.h" 1
# 14 "/workspace/acl/lib_acl/src/aio/aio.h" 2
...
# 69 "/workspace/acl/lib_acl/src/aio/aio.h"
int aio_timeout_callback(ACL_ASTREAM *astream);
void aio_close_callback(ACL_ASTREAM *astream);


void aio_delay_check(ACL_AIO *aio);
# 23 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 2

static int accept_callback(ACL_ASTREAM *astream __attribute__ ((__unused__)),
...
static int listen_callback(ACL_ASTREAM *astream __attribute__ ((__unused__)),
 void *context __attribute__ ((__unused__)))
{
...
{
 if (stream == 
# 44 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
              ((void *)0)
# 44 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                  ) {
  return 
# 45 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
        ((void *)0)
# 45 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
            ;
 }
 return stream->aio;
}
...
# 59 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                                  ((void *)0)
# 59 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                                      ;
}
...
ACL_ASTREAM *acl_aio_open(ACL_AIO *aio, ACL_VSTREAM *stream)
{
 ...
 acl_non_blocking(((stream)->fd.sock), 1);

 astream = acl_malloc_glue("/workspace/acl/lib_acl/src/aio/acl_aio_stream.c", 68, sizeof(ACL_ASTREAM));

 astream->aio = aio;
 astream->stream = stream;
 stream->rw_timeout = 0;

 acl_vstring_init(&astream->strbuf, 4096);
 astream->timeout = 0;
 astream->nrefer = 0;
 astream->flag = (1 << 5);
 ...
 astream->read_nested_limit = 10;
 astream->read_ready_fn = 
# 82 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                         ((void *)0)
# 82 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                             ;
 astream->count = 0;
 astream->line_length = 0;
 astream->keep_read = aio->keep_read;


 if ((stream->type & (1 << 2))) {
  if (stream->read_buf == 
# 89 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                         ((void *)0)
# 89 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                             ) {
 ...
 astream->write_nested_limit = 10;


 astream->accept_fn = accept_callback;
 astream->listen_fn = listen_callback;
 astream->context = 
# 105 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                   ((void *)0)
# 105 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                       ;
...
ACL_VSTREAM *acl_aio_cancel(ACL_ASTREAM *astream)
{
 ...
 do { if (astream) { acl_free_glue("/workspace/acl/lib_acl/src/aio/acl_aio_stream.c", 132, (astream)); (astream) = 
# 132 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
((void *)0)
# 132 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
; } } while (0);
 return stream;
}
...
int acl_aio_refer_value(ACL_ASTREAM * astream)
{
 ...
 if (astream == 
# 140 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
               ((void *)0)
# 140 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                   ) {
  acl_msg_error("%s(%d): astream null", myname, 141);
  return -1;
 }
...
{
 if (astream->stream == 
# 163 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                       ((void *)0)
# 163 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                           ) {
  return;
 }

 if ((astream->flag & (1 << 1)) != 0) {
  astream->flag &= ~(1 << 1);
  acl_event_disable_read(aio->event, astream->stream);
 }
 if ((astream->flag & (1 << 2)) != 0) {
  astream->flag &= ~(1 << 2);
...
static void close_astream(ACL_ASTREAM *astream)
{
 ...
 acl_array_free(astream->read_handles, 
# 196 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                                         ((void *)0)
# 196 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                                             );
 acl_array_free(astream->write_handles, 
# 197 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                                          ((void *)0)
# 197 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                                              );
 acl_array_free(astream->close_handles, 
# 198 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                                          ((void *)0)
# 198 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                                              );
 acl_array_free(astream->timeo_handles, 
# 199 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                                          ((void *)0)
# 199 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                                              );
 acl_array_free(astream->connect_handles, 
# 200 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                                            ((void *)0)
# 200 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                                                );

 do { if (astream) { acl_free_glue("/workspace/acl/lib_acl/src/aio/acl_aio_stream.c", 202, (astream)); (astream) = 
# 202 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
((void *)0)
# 202 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
; } } while (0);
}
...
static void aio_delay_close(ACL_ASTREAM *astream)
{
 if (astream->nrefer > 0) {
  ...
  if ((astream->flag & (1 << 3)) == 0) {
   astream->aio->dead_streams->push_back(
    astream->aio->dead_streams, astream);
   astream->flag |= (1 << 3);
  }
  return;
 } else if (astream->stream == 
# 217 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                              ((void *)0)
# 217 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                                  ) {
...
# 226 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
((void) sizeof ((
# 226 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
astream->nrefer > 0
# 226 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
...
"astream->nrefer > 0"
# 226 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
, "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c", 226, __extension__ __PRETTY_FUNCTION__); }))
# 226 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                               ;
 aio_close_callback(astream);
 astream->nrefer--;
...
void aio_delay_check(ACL_AIO *aio)
{
 ...
 while (1) {
  ...
  if (astream == 
# 241 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                ((void *)0)
# 241 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                    ) {
   break;
  }
...
# 327 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
void acl_aio_flush_on_close(ACL_ASTREAM *astream, int yes)
{
 if (yes) {
  astream->flag |= (1 << 5);
...
void acl_aio_iocp_close(ACL_ASTREAM *astream)
{
 ...
 for ((aio->dead_streams)->iter_head(&(iter), (aio->dead_streams)); (iter).ptr; (aio->dead_streams)->iter_next(&(iter), (aio->dead_streams))) {
  ACL_ASTREAM *s = (ACL_ASTREAM*) iter.data;
  if (s == astream) {
   acl_msg_fatal("%s(%d): flag: %d, size: %d",
    myname, 359, astream->flag, iter.size);
  }
 }
...
# 422 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
}
...
# 431 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
((void) sizeof ((
# 431 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
callback
# 431 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 431 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
"callback"
# 431 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
, "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c", 431, __extension__ __PRETTY_FUNCTION__); }))
# 431 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                    ;

 for ((&astream->reader_fifo)->iter_head(&(iter), (&astream->reader_fifo)); (iter).ptr; (&astream->reader_fifo)->iter_next(&(iter), (&astream->reader_fifo))) {
 ...
 handle = acl_malloc_glue("/workspace/acl/lib_acl/src/aio/acl_aio_stream.c", 442, sizeof(AIO_READ_HOOK));
 handle->callback = callback;
 handle->ctx = ctx;
 handle->disable = 0;
 if (acl_array_append(astream->read_handles, handle) < 0) {
  acl_msg_fatal("%s(%d), %s: add to array error",
   "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c", 448, myname);
 }
}
...
# 459 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
((void) sizeof ((
# 459 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
callback
# 459 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 459 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
"callback"
# 459 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
, "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c", 459, __extension__ __PRETTY_FUNCTION__); }))
# 459 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                    ;

 for ((&astream->writer_fifo)->iter_head(&(iter), (&astream->writer_fifo)); (iter).ptr; (&astream->writer_fifo)->iter_next(&(iter), (&astream->writer_fifo))) {
 ...
 handle = acl_malloc_glue("/workspace/acl/lib_acl/src/aio/acl_aio_stream.c", 470, sizeof(AIO_WRITE_HOOK));
 handle->callback = callback;
 handle->ctx = ctx;
 handle->disable = 0;
 if (acl_array_append(astream->write_handles, handle) < 0) {
  acl_msg_fatal("%s(%d), %s: add to array error",
   "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c", 476, myname);
 }
}
...
# 487 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
((void) sizeof ((
# 487 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
callback
# 487 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 487 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
"callback"
# 487 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
, "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c", 487, __extension__ __PRETTY_FUNCTION__); }))
# 487 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                    ;

 for ((astream->close_handles)->iter_head(&(iter), (astream->close_handles)); (iter).ptr; (astream->close_handles)->iter_next(&(iter), (astream->close_handles))) {
 ...
 handle = acl_malloc_glue("/workspace/acl/lib_acl/src/aio/acl_aio_stream.c", 498, sizeof(AIO_CLOSE_HOOK));
 handle->callback = callback;
 handle->ctx = ctx;
 handle->disable = 0;
 if (acl_array_append(astream->close_handles, handle) < 0) {
  acl_msg_fatal("%s(%d), %s: add to array error",
   "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c", 504, myname);
 }
}
...
# 515 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
((void) sizeof ((
# 515 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
callback
# 515 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 515 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
"callback"
# 515 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
, "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c", 515, __extension__ __PRETTY_FUNCTION__); }))
# 515 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                    ;

 for ((astream->timeo_handles)->iter_head(&(iter), (astream->timeo_handles)); (iter).ptr; (astream->timeo_handles)->iter_next(&(iter), (astream->timeo_handles))) {
 ...
 handle = acl_malloc_glue("/workspace/acl/lib_acl/src/aio/acl_aio_stream.c", 526, sizeof(AIO_TIMEO_HOOK));
 handle->callback = callback;
 handle->ctx = ctx;
 handle->disable = 0;
 if (acl_array_append(astream->timeo_handles, handle) < 0) {
  acl_msg_fatal("%s(%d), %s: add to array error",
   "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c", 532, myname);
 }
}
...
# 543 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
((void) sizeof ((
# 543 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
callback
# 543 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 543 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
"callback"
# 543 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
, "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c", 543, __extension__ __PRETTY_FUNCTION__); }))
# 543 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                    ;

 for ((astream->connect_handles)->iter_head(&(iter), (astream->connect_handles)); (iter).ptr; (astream->connect_handles)->iter_next(&(iter), (astream->connect_handles))) {
 ...
 handle = acl_malloc_glue("/workspace/acl/lib_acl/src/aio/acl_aio_stream.c", 554, sizeof(AIO_TIMEO_HOOK));
 handle->callback = callback;
 handle->ctx = ctx;
 handle->disable = 0;
 if (acl_array_append(astream->connect_handles, handle) < 0) {
  acl_msg_fatal("%s(%d), %s: add to array error",
   "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c", 560, myname);
 }
}
 ...
 ACL_AIO_READ_FN callback, void *ctx)
{
 ...
 for ((astream->read_handles)->iter_head(&(iter), (astream->read_handles)); (iter).ptr; (astream->read_handles)->iter_next(&(iter), (astream->read_handles))) {
  AIO_READ_HOOK *handle = (AIO_READ_HOOK *) iter.data;
  if (handle->callback == callback && handle->ctx == ctx) {
   handle->disable = 1;
   handle->ctx = 
# 573 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                ((void *)0)
# 573 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                    ;
   return;
  }
 }
 for ((&astream->reader_fifo)->iter_head(&(iter), (&astream->reader_fifo)); (iter).ptr; (&astream->reader_fifo)->iter_next(&(iter), (&astream->reader_fifo))) {
  ...
  if (handle->callback == callback && handle->ctx == ctx) {
   handle->disable = 1;
   handle->ctx = 
# 581 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                ((void *)0)
# 581 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                    ;
   break;
  }
 }
 ...
 ACL_AIO_WRITE_FN callback, void *ctx)
{
 ...
 for ((astream->write_handles)->iter_head(&(iter), (astream->write_handles)); (iter).ptr; (astream->write_handles)->iter_next(&(iter), (astream->write_handles))) {
  AIO_WRITE_HOOK *handle = (AIO_WRITE_HOOK *) iter.data;
  if (handle->callback == callback && handle->ctx == ctx) {
   handle->disable = 1;
   handle->ctx = 
# 596 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                ((void *)0)
# 596 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                    ;
   return;
  }
 }
 for ((&astream->writer_fifo)->iter_head(&(iter), (&astream->writer_fifo)); (iter).ptr; (&astream->writer_fifo)->iter_next(&(iter), (&astream->writer_fifo))) {
  ...
  if (handle->callback == callback && handle->ctx == ctx) {
   handle->disable = 1;
   handle->ctx = 
# 604 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                ((void *)0)
# 604 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                    ;
   break;
  }
 }
 ...
 ACL_AIO_CLOSE_FN callback, void *ctx)
{
 ...
 for ((astream->close_handles)->iter_head(&(iter), (astream->close_handles)); (iter).ptr; (astream->close_handles)->iter_next(&(iter), (astream->close_handles))) {
  ...
  if (handle->callback == callback && handle->ctx == ctx) {
   handle->disable = 1;
   handle->ctx = 
# 619 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                ((void *)0)
# 619 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                    ;
   break;
  }
 }
 ...
 ACL_AIO_TIMEO_FN callback, void *ctx)
{
 ...
 for ((astream->timeo_handles)->iter_head(&(iter), (astream->timeo_handles)); (iter).ptr; (astream->timeo_handles)->iter_next(&(iter), (astream->timeo_handles))) {
  ...
  if (handle->callback == callback && handle->ctx == ctx) {
   handle->disable = 1;
   handle->ctx = 
# 634 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                ((void *)0)
# 634 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                    ;
   break;
  }
 }
 ...
 ACL_AIO_CONNECT_FN callback, void *ctx)
{
 ...
 for ((astream->connect_handles)->iter_head(&(iter), (astream->connect_handles)); (iter).ptr; (astream->connect_handles)->iter_next(&(iter), (astream->connect_handles))) {
  ...
  if (handle->callback == callback && handle->ctx == ctx) {
   handle->disable = 1;
   handle->ctx = 
# 649 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                ((void *)0)
# 649 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                    ;
   break;
  }
 }
...
{
 do { if (handle) { acl_free_glue("/workspace/acl/lib_acl/src/aio/acl_aio_stream.c", 657, (handle)); (handle) = 
# 657 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
((void *)0)
# 657 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
; } } while (0);
}
...
void acl_aio_clean_read_hooks(ACL_ASTREAM *astream)
{
 ...
 while (1) {
  AIO_READ_HOOK *handle = astream->reader_fifo.pop_back(
   &astream->reader_fifo);
  if (handle == 
# 666 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
               ((void *)0)
# 666 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                   ) {
   break;
  }
  free_handle(handle);
...
void acl_aio_clean_write_hooks(ACL_ASTREAM *astream)
{
 ...
 while (1) {
  AIO_WRITE_HOOK *handle = astream->writer_fifo.pop_back(
   &astream->writer_fifo);
  if (handle == 
# 680 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
               ((void *)0)
# 680 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                   ) {
   break;
  }
  free_handle(handle);
 ...
 while (1) {
  ACL_VSTRING *str = (ACL_VSTRING*) acl_fifo_pop_front(
   &astream->write_fifo);
  if (str == 
# 688 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
            ((void *)0)
# 688 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                ) {
   break;
  }
...
void acl_aio_ctl(ACL_ASTREAM *astream, int name, ...)
{
 ...
 if (astream == 
# 743 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
               ((void *)0)
# 743 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                   ) {
...
# 748 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
__builtin_va_start(
# 748 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
ap
# 748 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
,
# 748 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 748 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
 ...
 for (; name != 0; name = 
# 750 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                                       __builtin_va_arg(
# 750 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                                       ap
# 750 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                                       ,
# 750 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 750 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
  ...
  case 1:
   accept_fn = 
# 753 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
              __builtin_va_arg(
# 753 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
              ap
# 753 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
              ,
# 753 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 753 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
  ...
  case 2:
   listen_fn = 
# 761 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
              __builtin_va_arg(
# 761 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
              ap
# 761 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
              ,
# 761 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 761 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
  ...
  case 3:
   astream->context = 
# 769 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                     __builtin_va_arg(
# 769 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                     ap
# 769 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                     ,
# 769 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 769 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
  ...
  case 4:
   astream->timeout = 
# 772 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                     __builtin_va_arg(
# 772 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                     ap
# 772 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                     ,
# 772 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 772 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
  ...
  case 5:
   astream->line_length = 
# 775 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                         __builtin_va_arg(
# 775 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                         ap
# 775 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                         ,
# 775 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 775 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
  ...
  case 10:
   stream = 
# 778 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
           __builtin_va_arg(
# 778 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
           ap
# 778 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
           ,
# 778 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 778 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
   ...
   break;
  case 11:
   astream->read_nested_limit = 
# 782 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                               __builtin_va_arg(
# 782 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                               ap
# 782 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                               ,
# 782 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 788 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                                __builtin_va_arg(
# 788 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                                ap
# 788 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                                ,
# 788 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 788 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
  ...
  case 13:
   astream->keep_read = 
# 793 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                       __builtin_va_arg(
# 793 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                       ap
# 793 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                       ,
# 793 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 793 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
  ...
  case 14:
   read_fn = 
# 796 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
            __builtin_va_arg(
# 796 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
            ap
# 796 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
            ,
# 796 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 796 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                                       ;
   ctx = 
# 797 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
        __builtin_va_arg(
# 797 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
        ap
# 797 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
        ,
# 797 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 797 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
  ...
  case 15:
   read_fn = 
# 801 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
            __builtin_va_arg(
# 801 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
            ap
# 801 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
            ,
# 801 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 801 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                                       ;
   ctx = 
# 802 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
        __builtin_va_arg(
# 802 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
        ap
# 802 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
        ,
# 802 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 802 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
  ...
  case 16:
   write_fn = 
# 806 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
             __builtin_va_arg(
# 806 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
             ap
# 806 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
             ,
# 806 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 806 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                                         ;
   ctx = 
# 807 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
        __builtin_va_arg(
# 807 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
        ap
# 807 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
        ,
# 807 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 807 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
  ...
  case 17:
   write_fn = 
# 811 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
             __builtin_va_arg(
# 811 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
             ap
# 811 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
             ,
# 811 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 811 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                                         ;
   ctx = 
# 812 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
        __builtin_va_arg(
# 812 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
        ap
# 812 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
        ,
# 812 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 812 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
  ...
  case 18:
   close_fn = 
# 816 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
             __builtin_va_arg(
# 816 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
             ap
# 816 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
             ,
# 816 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 816 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                                         ;
   ctx = 
# 817 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
        __builtin_va_arg(
# 817 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
        ap
# 817 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
        ,
# 817 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 817 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
  ...
  case 19:
   close_fn = 
# 821 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
             __builtin_va_arg(
# 821 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
             ap
# 821 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
             ,
# 821 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 821 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                                         ;
   ctx = 
# 822 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
        __builtin_va_arg(
# 822 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
        ap
# 822 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
        ,
# 822 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 822 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
  ...
  case 20:
   timeo_fn = 
# 826 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
             __builtin_va_arg(
# 826 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
             ap
# 826 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
             ,
# 826 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 826 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                                         ;
   ctx = 
# 827 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
        __builtin_va_arg(
# 827 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
        ap
# 827 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
        ,
# 827 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 827 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
  ...
  case 21:
   timeo_fn = 
# 831 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
             __builtin_va_arg(
# 831 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
             ap
# 831 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
             ,
# 831 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 831 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                                         ;
   ctx = 
# 832 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
        __builtin_va_arg(
# 832 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
        ap
# 832 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
        ,
# 832 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 832 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
  ...
  case 22:
   connect_fn = 
# 836 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
               __builtin_va_arg(
# 836 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
               ap
# 836 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
               ,
# 836 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 836 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                                             ;
   ctx = 
# 837 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
        __builtin_va_arg(
# 837 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
        ap
# 837 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
        ,
# 837 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 837 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
  ...
  case 23:
   connect_fn = 
# 841 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
               __builtin_va_arg(
# 841 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
               ap
# 841 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
               ,
# 841 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 841 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                                             ;
   ctx = 
# 842 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
        __builtin_va_arg(
# 842 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
        ap
# 842 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
        ,
# 842 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
# 852 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
__builtin_va_end(
# 852 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
ap
# 852 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
)
# 852 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
...
ACL_VSTREAM *acl_aio_vstream(ACL_ASTREAM *astream)
{
 ...
 return 
# 861 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
       ((void *)0)
# 861 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
           ;
}
...
int acl_aio_isset(ACL_ASTREAM *astream)
{
 ...
 if (astream == 
# 874 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
               ((void *)0)
# 874 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                   ) {
  acl_msg_fatal("%s: input invalid", myname);
 } else if (astream->stream == 
# 876 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c" 3 4
                              ((void *)0)
# 876 "/workspace/acl/lib_acl/src/aio/acl_aio_stream.c"
                                  ) {
  return 0;
 }
