# 1 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 2
# 20 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
# 1 "/workspace/acl/lib_acl/src/aio/aio.h" 1
# 9 "/workspace/acl/lib_acl/src/aio/aio.h"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_vstream.h" 1
# 10 "/workspace/acl/lib_acl/src/aio/aio.h" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_vstring.h" 1
...
# 21 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 2
# 45 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
static int write_complete_callback(ACL_ASTREAM *astream)
{
 ...
 if (astream->write_handles) {
  ...
  while (1) {
   ...
   if (handle == 
# 63 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
                ((void *)0)
# 63 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
                    ) {
    break;
   }
  ...
  for ((&astream->writer_fifo)->iter_tail(&(iter), (&astream->writer_fifo)); (iter).ptr; (&astream->writer_fifo)->iter_prev(&(iter), (&astream->writer_fifo))) {
...
static int __try_fflush(ACL_ASTREAM *astream)
{
 ...
 while (1) {
  ...
  if (str == 
# 106 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
            ((void *)0)
# 106 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
                ) {
...
# 123 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
  dlen = (int) (size_t) ((str)->vbuf.ptr - (str)->vbuf.data) - astream->write_offset;
  ptr = ((char *) (str)->vbuf.data) + astream->write_offset;

  n = acl_vstream_write(astream->stream, ptr, dlen);
  if (n == (-1)) {
   if (acl_last_error() != 
# 128 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
                          11
# 128 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
                                    ) {
    astream->flag |= (1 << 4);
    return -1;
   }
  ...
  str = acl_fifo_pop_front(&astream->write_fifo);
...
static void __writen_notify_callback(int event_type, ACL_EVENT *event __attribute__ ((__unused__)),
 ACL_VSTREAM *stream __attribute__ ((__unused__)), void *context)
{
 ...
 do { if (((astream)->flag & (1 << 2)) != 0) { (astream)->flag &= ~(1 << 2); (astream)->can_write_fn = 
# 180 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
((void *)0)
# 180 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
; (astream)->can_write_ctx = 
# 180 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
((void *)0)
# 180 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
; acl_event_disable_write((astream)->aio->event, (astream)->stream); } } while (0);

 if ((event_type & (1 << 4)) != 0) {

  do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 184 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
 ((void *)0)
# 184 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
 ; ((astream))->can_write_ctx = 
# 184 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
 ((void *)0)
# 184 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
 ; acl_event_disable_write(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
  return;
  ...
  if (aio_timeout_callback(astream) < 0) {
   do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 190 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 190 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
  ; ((astream))->can_write_ctx = 
# 190 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 190 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
  ; acl_event_disable_write(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
   ...
   do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 195 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 195 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
  ; ((astream))->can_write_ctx = 
# 195 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 195 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
  ; acl_event_disable_write(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
   ...
   do { if (((astream)->flag & (1 << 2)) == 0) { (astream)->flag |= (1 << 2); acl_event_enable_write((astream)->aio->event, (astream)->stream, (astream)->timeout, __writen_notify_callback, (astream)); } } while (0);
  }
 ...
 if (nleft < 0) {
  ...
  do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 213 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
 ((void *)0)
# 213 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
 ; ((astream))->can_write_ctx = 
# 213 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
 ((void *)0)
# 213 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
 ; acl_event_disable_write(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
  ...
  if (ret < 0) {
   ...
   do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 221 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 221 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
  ; ((astream))->can_write_ctx = 
# 221 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 221 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
  ; acl_event_disable_write(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
   ...
   do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 226 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 226 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
  ; ((astream))->can_write_ctx = 
# 226 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 226 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
 ...
 if (astream->write_nested >= astream->write_nested_limit) {
  ...
  if (acl_msg_verbose) {
   acl_msg_warn("%s(%d): write_nested(%d) >= max(%d)",
    myname, 252, astream->write_nested,
  ...
  astream->write_nested--;
  do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 264 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
 ((void *)0)
# 264 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
 ; ((astream))->can_write_ctx = 
# 264 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
 ((void *)0)
# 264 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
 ...
 else if ((n = acl_vstream_write(astream->stream, data, dlen)) == dlen)
 {
  ...
  if (write_complete_callback(astream) < 0) {
   ...
   do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 282 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 282 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
  ; ((astream))->can_write_ctx = 
# 282 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 282 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
  ; acl_event_disable_write(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
   ...
   do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 289 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 289 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
  ; ((astream))->can_write_ctx = 
# 289 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 289 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
  ...
  if (acl_last_error() != 
# 296 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
                         11
# 296 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
                                   ) {
   astream->write_nested--;
   do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 298 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 298 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
  ; ((astream))->can_write_ctx = 
# 298 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 298 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
 ...
 acl_fifo_push_back(&astream->write_fifo, str);
...
void acl_aio_vfprintf(ACL_ASTREAM *astream, const char *fmt, va_list ap)
{
 ...
 if (astream->write_nested >= astream->write_nested_limit) {
  ...
  astream->write_nested--;
  do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 358 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
 ((void *)0)
# 358 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
 ; ((astream))->can_write_ctx = 
# 358 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
 ((void *)0)
# 358 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
 ; acl_event_disable_write(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
  ...
  const char *ptr = ((char *) (str)->vbuf.data);
  len = (int) (size_t) ((str)->vbuf.ptr - (str)->vbuf.data);
  n = acl_vstream_write(astream->stream, ptr, len);
  if (n == (-1)) {
   if (acl_last_error() != 
# 368 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
                          11
# 368 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
                                    ) {
    astream->flag |= (1 << 4);
    astream->write_nested--;
    do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 371 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
   ((void *)0)
# 371 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
   ; ((astream))->can_write_ctx = 
# 371 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
   ((void *)0)
# 371 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
   ...
   if (ret < 0) {
    do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 386 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
   ((void *)0)
# 386 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
   ; ((astream))->can_write_ctx = 
# 386 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
   ((void *)0)
# 386 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
   ; acl_event_disable_write(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
    ...
    do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 390 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
   ((void *)0)
# 390 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
   ; ((astream))->can_write_ctx = 
# 390 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
   ((void *)0)
# 390 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
...
# 409 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
((void) sizeof ((
# 409 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
n >= 0
# 409 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
...
"n >= 0"
# 409 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
, "/workspace/acl/lib_acl/src/aio/acl_aio_write.c", 409, __extension__ __PRETTY_FUNCTION__); }))
# 409 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
                  ;

 len = (int) (size_t) ((str)->vbuf.ptr - (str)->vbuf.data);
 if (n < len) {
  acl_vstring_memmove(str, ((char *) (str)->vbuf.data) + n, len - n);
 }


 acl_fifo_push_back(&astream->write_fifo, str);
 astream->write_left += (int) (size_t) ((str)->vbuf.ptr - (str)->vbuf.data);
...
# 428 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
__builtin_va_start(
# 428 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
ap
# 428 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
,
# 428 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
...
# 430 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
__builtin_va_end(
# 430 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
ap
# 430 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
)
# 430 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
...
# 439 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
((void) sizeof ((
# 439 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
vector
# 439 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 439 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
...
"vector"
# 439 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
, "/workspace/acl/lib_acl/src/aio/acl_aio_write.c", 439, __extension__ __PRETTY_FUNCTION__); }))
# 439 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
                  ;
 
# 440 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
((void) sizeof ((
# 440 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
count
# 440 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 440 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
...
"count"
# 440 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
, "/workspace/acl/lib_acl/src/aio/acl_aio_write.c", 440, __extension__ __PRETTY_FUNCTION__); }))
# 440 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
                 ;
 ...
 if (astream->write_nested >= astream->write_nested_limit) {
  ...
  if (acl_msg_verbose)
   acl_msg_warn("%s(%d): write_nested(%d) >= max(%d)",
    myname, 454, astream->write_nested,
    astream->write_nested_limit);
  n = 0;
  ...
  astream->write_nested--;
  do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 465 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
 ((void *)0)
# 465 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
 ; ((astream))->can_write_ctx = 
# 465 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
 ((void *)0)
# 465 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
 ; acl_event_disable_write(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
  ...
  if (acl_last_error() != 
# 480 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
                         11
# 480 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
                                   ) {
   astream->flag |= (1 << 4);
   astream->write_nested--;
   do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 483 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 483 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
  ; ((astream))->can_write_ctx = 
# 483 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 483 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
...
# 507 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
 ((void) sizeof ((
# 507 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
 n == 0
# 507 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 507 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
...
# 507 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
 "n == 0"
# 507 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
 , "/workspace/acl/lib_acl/src/aio/acl_aio_write.c", 507, __extension__ __PRETTY_FUNCTION__); }))
# 507 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
                   ;
  ret = write_complete_callback(astream);
  astream->write_nested--;
  ...
  if (ret < 0) {
   ...
   do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 513 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 513 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
  ; ((astream))->can_write_ctx = 
# 513 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 513 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
  ; acl_event_disable_write(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
   ...
   do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 517 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 517 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
  ; ((astream))->can_write_ctx = 
# 517 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 517 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
...
size_t acl_aio_send_pending(ACL_ASTREAM *astream)
{
 ...
 for ((&astream->write_fifo)->iter_head(&(iter), (&astream->write_fifo)); (iter).ptr; (&astream->write_fifo)->iter_next(&(iter), (&astream->write_fifo))) {
  ACL_VSTRING *buf = (ACL_VSTRING*) iter.data;
  n += (size_t) ((buf)->vbuf.ptr - (buf)->vbuf.data);
 }
...
static void can_write_callback(int event_type, ACL_EVENT *event __attribute__ ((__unused__)),
 ACL_VSTREAM *stream __attribute__ ((__unused__)), void *context)
{
 ...
 do { if (((astream)->flag & (1 << 2)) != 0) { (astream)->flag &= ~(1 << 2); (astream)->can_write_fn = 
# 578 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
((void *)0)
# 578 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
; (astream)->can_write_ctx = 
# 578 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
((void *)0)
# 578 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
; acl_event_disable_write((astream)->aio->event, (astream)->stream); } } while (0);
 ...
 if ((event_type & (1 << 4)) != 0) {
  do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 581 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
 ((void *)0)
# 581 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
 ; ((astream))->can_write_ctx = 
# 581 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
 ((void *)0)
# 581 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
 ; acl_event_disable_write(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
  ...
  if (aio_timeout_callback(astream) < 0) {
   do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 585 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 585 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
  ; ((astream))->can_write_ctx = 
# 585 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 585 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
  ; acl_event_disable_write(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
   ...
   do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 590 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 590 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
  ; ((astream))->can_write_ctx = 
# 590 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
  ((void *)0)
# 590 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
  ; acl_event_disable_write(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
   ...
   do { if (((astream)->flag & (1 << 2)) == 0) { (astream)->flag |= (1 << 2); acl_event_enable_write((astream)->aio->event, (astream)->stream, (astream)->timeout, can_write_callback, (astream)); } } while (0);
  }

  return;
 }

 if (astream->can_write_fn == 
# 598 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
                             ((void *)0)
# 598 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
                                 ) {
 ...
 if (astream->can_write_fn(astream, astream->can_write_ctx) < 0) {
  astream->nrefer--;
  do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 606 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
 ((void *)0)
# 606 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
 ; ((astream))->can_write_ctx = 
# 606 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
 ((void *)0)
# 606 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
 ; acl_event_disable_write(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
  ...
  astream->nrefer--;
  do { do { if ((((astream))->flag & (1 << 2)) != 0) { ((astream))->flag &= ~(1 << 2); ((astream))->can_write_fn = 
# 609 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
 ((void *)0)
# 609 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
 ; ((astream))->can_write_ctx = 
# 609 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
 ((void *)0)
# 609 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
...
void acl_aio_disable_write(ACL_ASTREAM *astream)
{
 ...
 astream->flag &= ~(1 << 2);
        astream->can_write_fn = 
# 633 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
                               ((void *)0)
# 633 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
                                   ;
        astream->can_write_ctx = 
# 634 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
                                ((void *)0)
# 634 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
                                    ;
...
int acl_aio_iswset(ACL_ASTREAM *astream)
{
 ...
 if (astream == 
# 645 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
               ((void *)0)
# 645 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
                   ) {
  acl_msg_fatal("%s: input invalid", myname);
 }

 if (astream->stream == 
# 649 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c" 3 4
                       ((void *)0)
# 649 "/workspace/acl/lib_acl/src/aio/acl_aio_write.c"
                           ) {
  return 0;
 }
