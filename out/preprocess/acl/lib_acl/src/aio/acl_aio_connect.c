# 0 "/acl/lib_acl/src/aio/acl_aio_connect.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/aio/acl_aio_connect.c"
...
# 2 "/acl/lib_acl/src/aio/acl_aio_connect.c" 2
# 20 "/acl/lib_acl/src/aio/acl_aio_connect.c"
...
# 21 "/acl/lib_acl/src/aio/acl_aio_connect.c" 2
...
# 22 "/acl/lib_acl/src/aio/acl_aio_connect.c" 2
# 55 "/acl/lib_acl/src/aio/acl_aio_connect.c"
...
# 89 "/acl/lib_acl/src/aio/acl_aio_connect.c"
 if ((event_type & (1 << 4)) != 0) {
  acl_aio_iocp_close(conn);
  return;
 }
...
# 96 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
  1
# 96 "/acl/lib_acl/src/aio/acl_aio_connect.c"
            , 
# 96 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
              4
# 96 "/acl/lib_acl/src/aio/acl_aio_connect.c"
...
# 113 "/acl/lib_acl/src/aio/acl_aio_connect.c"
 if (
# 113 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
    (*__errno_location ()) 
# 113 "/acl/lib_acl/src/aio/acl_aio_connect.c"
          == 0 || 
# 113 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
...
# 113 "/acl/lib_acl/src/aio/acl_aio_connect.c"
 ...
 if (conn->connect_handles) {
  ...
  while (1) {
   ...
   if (handle == 
# 153 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                ((void *)0)
# 153 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                    ) {
    break;
   }
...
ACL_ASTREAM *acl_aio_connect(ACL_AIO *aio, const char *addr, int timeout)
{
 ...
 if (aio == 
# 187 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
           ((void *)0) 
# 187 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                || addr == 
# 187 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                           ((void *)0) 
# 187 "/acl/lib_acl/src/aio/acl_aio_connect.c"
...
# 205 "/acl/lib_acl/src/aio/acl_aio_connect.c"
 cstream = acl_vstream_connect(addr, 1,
   0, 0, aio->rbuf_size);


 if (cstream == 
# 209 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
               ((void *)0)
# 209 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                   ) {
  acl_msg_error("%s: connect addr(%s) error", myname, addr);
  return 
# 211 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
        ((void *)0)
# 211 "/acl/lib_acl/src/aio/acl_aio_connect.c"
            ;
 }
 ...
 if (conn == 
# 217 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
            ((void *)0)
# 217 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                ) {
...
static void resolve_ctx_free(RESOLVE_CTX *ctx)
{
 ...
 do { if (ctx) { acl_free_glue("/acl/lib_acl/src/aio/acl_aio_connect.c", 260, (ctx)); (ctx) = 
# 260 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
((void *)0)
# 260 "/acl/lib_acl/src/aio/acl_aio_connect.c"
; } } while (0);
}
...
# 277 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                            ((void *)0)
# 277 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                                ) {
 ...
 acl_set_error(
# 282 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
              111
# 282 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                              );

 memset(&conn_ctx, 0, sizeof(conn_ctx));
 conn_ctx.conn = 
# 285 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                ((void *)0)
# 285 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                    ;
...
static int connect_timeout(ACL_ASTREAM *conn, void *context)
{
 ...
 if (try_connect_one(ctx) != 
# 308 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                            ((void *)0)
# 308 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                                ) {
 ...
 acl_set_error(
# 313 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
              110
# 313 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                           );

 memset(&conn_ctx, 0, sizeof(conn_ctx));
 conn_ctx.conn = 
# 316 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                ((void *)0)
# 316 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                    ;
 conn_ctx.ctx = ctx->context;
 memcpy(&conn_ctx.ns_addr, &ctx->ns_addr, sizeof(ACL_SOCKADDR));
 memcpy(&conn_ctx.serv_addr, &ctx->serv_addr, sizeof(ACL_SOCKADDR));
...
# 363 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
 ((void) sizeof ((
# 363 "/acl/lib_acl/src/aio/acl_aio_connect.c"
 ip && *ip
# 363 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
...
# 363 "/acl/lib_acl/src/aio/acl_aio_connect.c"
 "ip && *ip"
# 363 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
 , "/acl/lib_acl/src/aio/acl_aio_connect.c", 363, __extension__ __PRETTY_FUNCTION__); }))
# 363 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                      ;
  ...
  if (ctx->conn == 
# 371 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                  ((void *)0)
# 371 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                      ) {
   continue;
  }
 ...
 return 
# 381 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
       ((void *)0)
# 381 "/acl/lib_acl/src/aio/acl_aio_connect.c"
           ;
}
 ...
 const ACL_RFC1035_MESSAGE *msg)
{
 ...
 if (db == 
# 395 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
          ((void *)0)
# 395 "/acl/lib_acl/src/aio/acl_aio_connect.c"
              ) {
...
# 408 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                                      ((void *)0)
# 408 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                                          );
 }
 ...
 if (try_connect_one(ctx) == 
# 419 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                            ((void *)0)
# 419 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                                ) {
  acl_set_error(
# 420 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
               111
# 420 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                               );
  conn_ctx.status = 2;
  ctx->callback(&conn_ctx);
  resolve_ctx_free(ctx);
 ...
 ACL_AIO_CONNECT_ADDR_FN callback, void *context)
{
 ...
 ptr = strrchr(buf, '|');
 if (ptr == 
# 436 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
           ((void *)0)
# 436 "/acl/lib_acl/src/aio/acl_aio_connect.c"
               ) {
  ptr = strrchr(buf, ':');
 }
 if (ptr == 
# 439 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
           ((void *)0) 
# 439 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                || *(ptr + 1) == 0) {
  acl_msg_error("%s(%d), %s: invalid addr=%s",
   "/acl/lib_acl/src/aio/acl_aio_connect.c", 441, __FUNCTION__, addr);
  return -1;
 }
 *ptr++ = 0;
 port = atoi(ptr);
 if (port <= 0 || port > 65535) {
  acl_msg_error("%s(%d), %s: invalid port=%d, addr=%s",
   "/acl/lib_acl/src/aio/acl_aio_connect.c", 448, __FUNCTION__, port, addr);
  return -1;
 }

 ctx = (RESOLVE_CTX *) acl_calloc_glue("/acl/lib_acl/src/aio/acl_aio_connect.c", 452, 1, sizeof(RESOLVE_CTX));
 ctx->aio = aio;
...
# 471 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                                                     ((void *)0)
# 471 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                                                         ) {
   resolve_ctx_free(ctx);
   return -1;
  }
...
# 483 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                       ((void *)0)
# 483 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                           ) {
  acl_msg_error("%s(%d), %s: call acl_aio_set_dns first",
   "/acl/lib_acl/src/aio/acl_aio_connect.c", 485, __FUNCTION__);
  return -1;
 } else {
...
# 500 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                             ((void *)0)
# 500 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                                 ;
}
...
# 505 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                               ((void *)0)
# 505 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                                   ;
}
...
{
 return ctx ? ctx->conn : 
# 510 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                         ((void *)0)
# 510 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                             ;
}
...
{
 return ctx ? ctx->ctx : 
# 515 "/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                        ((void *)0)
# 515 "/acl/lib_acl/src/aio/acl_aio_connect.c"
                            ;
}
