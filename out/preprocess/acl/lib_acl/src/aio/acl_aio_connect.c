# 1 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 2
# 20 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
...
# 21 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 2
...
# 22 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 2
# 55 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
 ...
 ACL_VSTREAM *stream __attribute__ ((__unused__)), void *context)
{
 ...
 do { if (((conn)->flag & (1 << 2)) != 0) { (conn)->flag &= ~(1 << 2); acl_event_disable_write((conn)->aio->event, (conn)->stream); } } while (0);


 if ((event_type & (1 << 6)) != 0) {
  if (aio_timeout_callback(conn) < 0) {
   acl_aio_iocp_close(conn);
  } else if (conn->flag & (1 << 0)) {
...
# 89 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
 if ((event_type & (1 << 4)) != 0) {
  acl_aio_iocp_close(conn);
  return;
 }
 ...
 errlen = sizeof(err);
 ret = getsockopt(((acl_aio_vstream(conn))->fd.sock),
   
# 96 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
  1
# 96 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
            , 
# 96 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
              4
# 96 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
...
# 113 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
 if (
# 113 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
    (*__errno_location ()) 
# 113 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
          == 0 || 
# 113 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
...
# 113 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
 ...
 if (conn->connect_handles) {
  ...
  for ((conn->connect_handles)->iter_tail(&(iter), (conn->connect_handles)); (iter).ptr; (conn->connect_handles)->iter_prev(&(iter), (conn->connect_handles))) {
   AIO_CONNECT_HOOK *handle = (AIO_CONNECT_HOOK*) iter.data;
   if (handle->disable) {
    continue;
   }
   acl_fifo_push_back(&connect_handles, handle);
  }

  while (1) {
   AIO_CONNECT_HOOK *handle = acl_fifo_pop_front(&connect_handles);
   if (handle == 
# 153 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                ((void *)0)
# 153 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                    ) {
    break;
   }
...
ACL_ASTREAM *acl_aio_connect(ACL_AIO *aio, const char *addr, int timeout)
{
 ...
 if (aio == 
# 187 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
           ((void *)0) 
# 187 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                || addr == 
# 187 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                           ((void *)0) 
# 187 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
...
# 205 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
 cstream = acl_vstream_connect(addr, 1,
   0, 0, aio->rbuf_size);


 if (cstream == 
# 209 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
               ((void *)0)
# 209 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                   ) {
  acl_msg_error("%s: connect addr(%s) error", myname, addr);
  return 
# 211 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
        ((void *)0)
# 211 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
            ;
 }
 ...
 if (conn == 
# 217 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
            ((void *)0)
# 217 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                ) {
 ...
 acl_aio_ctl(conn, 4, timeout, 0);

 do { if (((conn)->flag & (1 << 2)) == 0) { (conn)->flag |= (1 << 2); acl_event_enable_write((conn)->aio->event, (conn)->stream, (conn)->timeout, __connect_notify_callback, (conn)); } } while (0);
 return conn;
}
...
static void resolve_ctx_free(RESOLVE_CTX *ctx)
{
 ...
 do { if (ctx) { acl_free_glue("/workspace/acl/lib_acl/src/aio/acl_aio_connect.c", 260, (ctx)); (ctx) = 
# 260 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
((void *)0)
# 260 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
; } } while (0);
}
...
static int connect_failed(ACL_ASTREAM *conn __attribute__ ((__unused__)), void *context)
{
 ...
 if (try_connect_one(ctx) != 
# 277 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                            ((void *)0)
# 277 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                                ) {
 ...
 acl_set_error(
# 282 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
              111
# 282 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                              );

 memset(&conn_ctx, 0, sizeof(conn_ctx));
 conn_ctx.conn = 
# 285 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                ((void *)0)
# 285 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                    ;
...
static int connect_timeout(ACL_ASTREAM *conn, void *context)
{
 ...
 if (try_connect_one(ctx) != 
# 308 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                            ((void *)0)
# 308 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                                ) {
 ...
 acl_set_error(
# 313 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
              110
# 313 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                           );

 memset(&conn_ctx, 0, sizeof(conn_ctx));
 conn_ctx.conn = 
# 316 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                ((void *)0)
# 316 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                    ;
 conn_ctx.ctx = ctx->context;
 memcpy(&conn_ctx.ns_addr, &ctx->ns_addr, sizeof(ACL_SOCKADDR));
 memcpy(&conn_ctx.serv_addr, &ctx->serv_addr, sizeof(ACL_SOCKADDR));
...
# 363 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
 ((void) sizeof ((
# 363 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
 ip && *ip
# 363 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
...
# 363 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
 "ip && *ip"
# 363 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
 , "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c", 363, __extension__ __PRETTY_FUNCTION__); }))
# 363 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                      ;
  ...
  if (ctx->conn == 
# 371 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                  ((void *)0)
# 371 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                      ) {
   continue;
  }
 ...
 return 
# 381 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
       ((void *)0)
# 381 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
           ;
}
 ...
 const ACL_RFC1035_MESSAGE *msg)
{
 ...
 if (db == 
# 395 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
          ((void *)0)
# 395 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
              ) {
 ...
 for ((db)->iter_head(&(iter), (db)); (iter).ptr; (db)->iter_next(&(iter), (db))) {
  const ACL_HOST_INFO *info = (const ACL_HOST_INFO *) iter.data;
  acl_argv_add(ctx->ip_list, info->ip, 
# 408 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                                      ((void *)0)
# 408 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                                          );
 }
 ...
 if (try_connect_one(ctx) == 
# 419 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                            ((void *)0)
# 419 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                                ) {
  acl_set_error(
# 420 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
               111
# 420 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                               );
  conn_ctx.status = 2;
  ctx->callback(&conn_ctx);
  resolve_ctx_free(ctx);
 ...
 ACL_AIO_CONNECT_ADDR_FN callback, void *context)
{
 ...
 do { if (sizeof(buf) > 0) { size_t _n = strlen(addr); _n = _n > (size_t ) sizeof(buf) - 1? (size_t) sizeof(buf) - 1 : _n; memcpy(buf, addr, _n); buf[_n] = 0; } } while (0);
 ptr = strrchr(buf, '|');
 if (ptr == 
# 436 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
           ((void *)0)
# 436 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
               ) {
  ptr = strrchr(buf, ':');
 }
 if (ptr == 
# 439 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
           ((void *)0) 
# 439 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                || *(ptr + 1) == 0) {
  acl_msg_error("%s(%d), %s: invalid addr=%s",
   "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c", 441, __FUNCTION__, addr);
  return -1;
 }
 *ptr++ = 0;
 port = atoi(ptr);
 if (port <= 0 || port > 65535) {
  acl_msg_error("%s(%d), %s: invalid port=%d, addr=%s",
   "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c", 448, __FUNCTION__, port, addr);
  return -1;
 }

 ctx = (RESOLVE_CTX *) acl_calloc_glue("/workspace/acl/lib_acl/src/aio/acl_aio_connect.c", 452, 1, sizeof(RESOLVE_CTX));
 ctx->aio = aio;
 ...
 if (acl_is_ip(buf) || acl_valid_unix(buf)) {
  ...
  if (acl_sane_pton(addr, (struct sockaddr *)&sa) == 0) {
   acl_msg_error("%s(%d): invalid addr=%s",
    __FUNCTION__, 466, addr);
   resolve_ctx_free(ctx);
   return -1;
  }

  if ((conn = acl_aio_connect(aio, addr, timeout)) == 
# 471 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                                                     ((void *)0)
# 471 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                                                         ) {
   resolve_ctx_free(ctx);
   return -1;
  }
...
# 483 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                       ((void *)0)
# 483 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                           ) {
  acl_msg_error("%s(%d), %s: call acl_aio_set_dns first",
   "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c", 485, __FUNCTION__);
  return -1;
 } else {
...
int acl_astream_get_status(const ACL_ASTREAM_CTX *ctx)
{
 return ctx ? ctx->status : -1;
}

const ACL_SOCKADDR *acl_astream_get_ns_addr(const ACL_ASTREAM_CTX *ctx)
{
 return ctx ? &ctx->ns_addr : 
# 500 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                             ((void *)0)
# 500 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                                 ;
}

const ACL_SOCKADDR *acl_astream_get_serv_addr(const ACL_ASTREAM_CTX *ctx)
{
 return ctx ? &ctx->serv_addr : 
# 505 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                               ((void *)0)
# 505 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                                   ;
}
...
{
 return ctx ? ctx->conn : 
# 510 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                         ((void *)0)
# 510 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                             ;
}
...
{
 return ctx ? ctx->ctx : 
# 515 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c" 3 4
                        ((void *)0)
# 515 "/workspace/acl/lib_acl/src/aio/acl_aio_connect.c"
                            ;
}
