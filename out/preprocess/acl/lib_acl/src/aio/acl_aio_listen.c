# 1 "/workspace/acl/lib_acl/src/aio/acl_aio_listen.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/aio/acl_aio_listen.c" 2
# 20 "/workspace/acl/lib_acl/src/aio/acl_aio_listen.c"
...
# 21 "/workspace/acl/lib_acl/src/aio/acl_aio_listen.c" 2
...
# 22 "/workspace/acl/lib_acl/src/aio/acl_aio_listen.c" 2

static void __accept_notify_callback(int event_type,
 ACL_EVENT *event __attribute__ ((__unused__)), ACL_VSTREAM *stream, void *context)
{
 ...
 for (i = 0; i < astream->accept_nloop; i++) {
  ...
  cstream = acl_vstream_accept(stream, 
# 51 "/workspace/acl/lib_acl/src/aio/acl_aio_listen.c" 3 4
                                      ((void *)0)
# 51 "/workspace/acl/lib_acl/src/aio/acl_aio_listen.c"
                                          , 0);
  if (cstream == 
# 52 "/workspace/acl/lib_acl/src/aio/acl_aio_listen.c" 3 4
                ((void *)0)
# 52 "/workspace/acl/lib_acl/src/aio/acl_aio_listen.c"
                    ) {
   int ret;

   ret = acl_last_error();
   if (ret == 
# 56 "/workspace/acl/lib_acl/src/aio/acl_aio_listen.c" 3 4
             11 
# 56 "/workspace/acl/lib_acl/src/aio/acl_aio_listen.c"
                        || ret == 
# 56 "/workspace/acl/lib_acl/src/aio/acl_aio_listen.c" 3 4
                                  103
# 56 "/workspace/acl/lib_acl/src/aio/acl_aio_listen.c"
...
void acl_aio_accept(ACL_ASTREAM *astream)
{
 ...
 if (astream == 
# 84 "/workspace/acl/lib_acl/src/aio/acl_aio_listen.c" 3 4
               ((void *)0)
# 84 "/workspace/acl/lib_acl/src/aio/acl_aio_listen.c"
                   ) {
...
void acl_aio_listen(ACL_ASTREAM *astream)
{
 ...
 if (astream == 
# 122 "/workspace/acl/lib_acl/src/aio/acl_aio_listen.c" 3 4
               ((void *)0)
# 122 "/workspace/acl/lib_acl/src/aio/acl_aio_listen.c"
                   ) {
  acl_msg_fatal("%s: input invalid", myname);
 }
