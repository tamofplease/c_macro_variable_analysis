# 0 "/acl/lib_acl/src/aio/acl_aio.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/aio/acl_aio.c"
...
# 2 "/acl/lib_acl/src/aio/acl_aio.c" 2
# 20 "/acl/lib_acl/src/aio/acl_aio.c"
# 1 "/acl/lib_acl/include/stdlib/acl_array.h" 1
# 21 "/acl/lib_acl/src/aio/acl_aio.c" 2
...
# 22 "/acl/lib_acl/src/aio/acl_aio.c" 2
...
# 23 "/acl/lib_acl/src/aio/acl_aio.c" 2
...
# 45 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
                                  ((void *)0)
# 45 "/acl/lib_acl/src/aio/acl_aio.c"
                                      );
 do { if (aio) { acl_free_glue("/acl/lib_acl/src/aio/acl_aio.c", 46, (aio)); (aio) = 
# 46 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
((void *)0)
# 46 "/acl/lib_acl/src/aio/acl_aio.c"
; } } while (0);
}
...
ACL_AIO *acl_aio_create2(int event_mode, unsigned int nMsg)
{
 ...
 default:
  ...
  event = 
# 75 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
         ((void *)0)
# 75 "/acl/lib_acl/src/aio/acl_aio.c"
             ;
  break;
 }
...
ACL_AIO *acl_aio_create3(ACL_EVENT *event)
{
 ACL_AIO *aio = acl_calloc_glue("/acl/lib_acl/src/aio/acl_aio.c", 83, 1, sizeof(ACL_AIO));
...
# 109 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
((void) sizeof ((
# 109 "/acl/lib_acl/src/aio/acl_aio.c"
dns_list && *dns_list
# 109 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
...
"dns_list && *dns_list"
# 109 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
, "/acl/lib_acl/src/aio/acl_aio.c", 109, __extension__ __PRETTY_FUNCTION__); }))
# 109 "/acl/lib_acl/src/aio/acl_aio.c"
                                 ;
 tokens = acl_argv_split(dns_list, ",; \t\r\n");
 if (tokens == 
# 111 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
              ((void *)0)
# 111 "/acl/lib_acl/src/aio/acl_aio.c"
                  ) {
  acl_msg_error("%s(%d), %s: invalid dns_list=%s",
   "/acl/lib_acl/src/aio/acl_aio.c", 113, __FUNCTION__, dns_list);
  return -1;
 }

 if (aio->dns == 
# 117 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
                ((void *)0)
# 117 "/acl/lib_acl/src/aio/acl_aio.c"
                    ) {
  aio->dns = acl_dns_create(aio, timeout);
  if (aio->dns == 
# 119 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
                 ((void *)0)
# 119 "/acl/lib_acl/src/aio/acl_aio.c"
                     ) {
   acl_msg_error("%s(%d), %s: acl_dns_create error=%s",
    "/acl/lib_acl/src/aio/acl_aio.c", 121, __FUNCTION__,
    acl_last_serror());
   return -1;
  }
 ...
 for ((tokens)->iter_head(&(iter), (tokens)); (iter).ptr; (tokens)->iter_next(&(iter), (tokens))) {
  ...
  if (ptr == 
# 133 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
            ((void *)0)
# 133 "/acl/lib_acl/src/aio/acl_aio.c"
                ) {
   ptr = strrchr(ip, ':');
  }
  if (ptr && *(ptr + 1) != 0) {
...
void acl_aio_del_dns(ACL_AIO *aio, const char *dns_list)
{
 ...
 if (aio->dns == 
# 154 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
                ((void *)0)
# 154 "/acl/lib_acl/src/aio/acl_aio.c"
                    ) {
  return;
 }

 
# 158 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
((void) sizeof ((
# 158 "/acl/lib_acl/src/aio/acl_aio.c"
dns_list && *dns_list
# 158 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 158 "/acl/lib_acl/src/aio/acl_aio.c"
...
"dns_list && *dns_list"
# 158 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
, "/acl/lib_acl/src/aio/acl_aio.c", 158, __extension__ __PRETTY_FUNCTION__); }))
# 158 "/acl/lib_acl/src/aio/acl_aio.c"
                                 ;
 tokens = acl_argv_split(dns_list, ",; \t\r\n");
 if (tokens == 
# 160 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
              ((void *)0)
# 160 "/acl/lib_acl/src/aio/acl_aio.c"
                  ) {
  acl_msg_error("%s(%d), %s: invalid dns_list=%s",
   "/acl/lib_acl/src/aio/acl_aio.c", 162, __FUNCTION__, dns_list);
  return;
 }
 ...
 for ((tokens)->iter_head(&(iter), (tokens)); (iter).ptr; (tokens)->iter_next(&(iter), (tokens))) {
  ...
  if (ptr == 
# 171 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
            ((void *)0)
# 171 "/acl/lib_acl/src/aio/acl_aio.c"
                ) {
   ptr = strrchr(ip, ':');
  }
  if (ptr && *(ptr + 1) != 0) {
...
{
 if (aio == 
# 262 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
           ((void *)0) 
# 262 "/acl/lib_acl/src/aio/acl_aio.c"
                || aio->event == 
# 262 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
                                 ((void *)0)
# 262 "/acl/lib_acl/src/aio/acl_aio.c"
...
# 263 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
 (*__errno_location ()) 
# 263 "/acl/lib_acl/src/aio/acl_aio.c"
       = 
# 263 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
         22
# 263 "/acl/lib_acl/src/aio/acl_aio.c"
...
ACL_EVENT *acl_aio_event(ACL_AIO *aio)
{
 ...
 return 
# 274 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
       ((void *)0)
# 274 "/acl/lib_acl/src/aio/acl_aio.c"
           ;
}
 ...
 void *context, long long int idle_limit, int keep)
{
 ...
 if (aio == 
# 289 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
           ((void *)0) 
# 289 "/acl/lib_acl/src/aio/acl_aio.c"
                || aio->event == 
# 289 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
                                 ((void *)0) 
# 289 "/acl/lib_acl/src/aio/acl_aio.c"
...
long long int acl_aio_cancel_timer(ACL_AIO *aio, ACL_EVENT_NOTIFY_TIME timer_fn, void *context)
{
 ...
 if (aio == 
# 302 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
           ((void *)0) 
# 302 "/acl/lib_acl/src/aio/acl_aio.c"
                || aio->event == 
# 302 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
                                 ((void *)0) 
# 302 "/acl/lib_acl/src/aio/acl_aio.c"
 ...
 void *context, int onoff)
{
 ...
 if (aio == 
# 315 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
           ((void *)0) 
# 315 "/acl/lib_acl/src/aio/acl_aio.c"
                || aio->event == 
# 315 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
                                 ((void *)0)
# 315 "/acl/lib_acl/src/aio/acl_aio.c"
...
int acl_aio_timer_ifkeep(ACL_AIO *aio, ACL_EVENT_NOTIFY_TIME callback, void *context)
{
 ...
 if (aio == 
# 326 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
           ((void *)0) 
# 326 "/acl/lib_acl/src/aio/acl_aio.c"
                || aio->event == 
# 326 "/acl/lib_acl/src/aio/acl_aio.c" 3 4
                                 ((void *)0)
# 326 "/acl/lib_acl/src/aio/acl_aio.c"
