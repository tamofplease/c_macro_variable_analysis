# 1 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 2
# 20 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_array.h" 1
# 21 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 2
...
# 22 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 2
...
# 23 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 2
...
void acl_aio_free2(ACL_AIO *aio, int keep)
{
 ...
 acl_array_free(aio->dead_streams, 
# 45 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
                                  ((void *)0)
# 45 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
                                      );
 do { if (aio) { acl_free_glue("/workspace/acl/lib_acl/src/aio/acl_aio.c", 46, (aio)); (aio) = 
# 46 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
((void *)0)
# 46 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
; } } while (0);
}
...
ACL_AIO *acl_aio_create2(int event_mode, unsigned int nMsg)
{
 ...
 default:
  acl_msg_fatal("%s(%d): event_mode(%d) not support",
   myname, 74, event_mode);
  event = 
# 75 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
         ((void *)0)
# 75 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
             ;
  break;
 }
...
ACL_AIO *acl_aio_create3(ACL_EVENT *event)
{
 ACL_AIO *aio = acl_calloc_glue("/workspace/acl/lib_acl/src/aio/acl_aio.c", 83, 1, sizeof(ACL_AIO));
...
# 109 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
((void) sizeof ((
# 109 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
dns_list && *dns_list
# 109 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
...
"dns_list && *dns_list"
# 109 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
, "/workspace/acl/lib_acl/src/aio/acl_aio.c", 109, __extension__ __PRETTY_FUNCTION__); }))
# 109 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
                                 ;
 tokens = acl_argv_split(dns_list, ",; \t\r\n");
 if (tokens == 
# 111 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
              ((void *)0)
# 111 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
                  ) {
  acl_msg_error("%s(%d), %s: invalid dns_list=%s",
   "/workspace/acl/lib_acl/src/aio/acl_aio.c", 113, __FUNCTION__, dns_list);
  return -1;
 }

 if (aio->dns == 
# 117 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
                ((void *)0)
# 117 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
                    ) {
  aio->dns = acl_dns_create(aio, timeout);
  if (aio->dns == 
# 119 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
                 ((void *)0)
# 119 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
                     ) {
   acl_msg_error("%s(%d), %s: acl_dns_create error=%s",
    "/workspace/acl/lib_acl/src/aio/acl_aio.c", 121, __FUNCTION__,
    acl_last_serror());
   return -1;
  }
 ...
 for ((tokens)->iter_head(&(iter), (tokens)); (iter).ptr; (tokens)->iter_next(&(iter), (tokens))) {
  ...
  if (ptr == 
# 133 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
            ((void *)0)
# 133 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
                ) {
   ptr = strrchr(ip, ':');
  }
  if (ptr && *(ptr + 1) != 0) {
...
void acl_aio_del_dns(ACL_AIO *aio, const char *dns_list)
{
 ...
 if (aio->dns == 
# 154 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
                ((void *)0)
# 154 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
                    ) {
  return;
 }

 
# 158 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
((void) sizeof ((
# 158 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
dns_list && *dns_list
# 158 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 158 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
...
"dns_list && *dns_list"
# 158 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
, "/workspace/acl/lib_acl/src/aio/acl_aio.c", 158, __extension__ __PRETTY_FUNCTION__); }))
# 158 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
                                 ;
 tokens = acl_argv_split(dns_list, ",; \t\r\n");
 if (tokens == 
# 160 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
              ((void *)0)
# 160 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
                  ) {
  acl_msg_error("%s(%d), %s: invalid dns_list=%s",
   "/workspace/acl/lib_acl/src/aio/acl_aio.c", 162, __FUNCTION__, dns_list);
  return;
 }
 ...
 for ((tokens)->iter_head(&(iter), (tokens)); (iter).ptr; (tokens)->iter_next(&(iter), (tokens))) {
  ...
  if (ptr == 
# 171 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
            ((void *)0)
# 171 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
                ) {
   ptr = strrchr(ip, ':');
  }
  if (ptr && *(ptr + 1) != 0) {
...
{
 if (aio == 
# 262 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
           ((void *)0) 
# 262 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
                || aio->event == 
# 262 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
                                 ((void *)0)
# 262 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
...
# 263 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
 (*__errno_location ()) 
# 263 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
       = 
# 263 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
         22
# 263 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
...
ACL_EVENT *acl_aio_event(ACL_AIO *aio)
{
 ...
 return 
# 274 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
       ((void *)0)
# 274 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
           ;
}
...
long long int acl_aio_request_timer(ACL_AIO *aio, ACL_EVENT_NOTIFY_TIME timer_fn,
 void *context, long long int idle_limit, int keep)
{
 const char *myname = "acl_aio_request_timer";

 if (aio == 
# 289 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
           ((void *)0) 
# 289 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
                || aio->event == 
# 289 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
                                 ((void *)0) 
# 289 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
...
long long int acl_aio_cancel_timer(ACL_AIO *aio, ACL_EVENT_NOTIFY_TIME timer_fn, void *context)
{
 const char *myname = "acl_aio_cancel_timer";

 if (aio == 
# 302 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
           ((void *)0) 
# 302 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
                || aio->event == 
# 302 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
                                 ((void *)0) 
# 302 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
 ...
 void *context, int onoff)
{
 ...
 if (aio == 
# 315 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
           ((void *)0) 
# 315 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
                || aio->event == 
# 315 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
                                 ((void *)0)
# 315 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
...
int acl_aio_timer_ifkeep(ACL_AIO *aio, ACL_EVENT_NOTIFY_TIME callback, void *context)
{
 ...
 if (aio == 
# 326 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
           ((void *)0) 
# 326 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
                || aio->event == 
# 326 "/workspace/acl/lib_acl/src/aio/acl_aio.c" 3 4
                                 ((void *)0)
# 326 "/workspace/acl/lib_acl/src/aio/acl_aio.c"
