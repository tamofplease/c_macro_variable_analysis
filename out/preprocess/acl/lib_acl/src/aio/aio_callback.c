# 1 "/workspace/acl/lib_acl/src/aio/aio_callback.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/aio/aio_callback.c" 2
# 17 "/workspace/acl/lib_acl/src/aio/aio_callback.c"
...
# 18 "/workspace/acl/lib_acl/src/aio/aio_callback.c" 2
...
int aio_timeout_callback(ACL_ASTREAM *astream)
{
 ...
 if (astream->timeo_handles) {
  ...
  for ((astream->timeo_handles)->iter_tail(&(iter), (astream->timeo_handles)); (iter).ptr; (astream->timeo_handles)->iter_prev(&(iter), (astream->timeo_handles))) {
   AIO_TIMEO_HOOK *handle = (AIO_TIMEO_HOOK*) iter.data;
   if (handle->disable) {
    continue;
   }

   acl_fifo_push_back(&timeo_handles, handle);
  }

  while (1) {
   AIO_TIMEO_HOOK *handle = acl_fifo_pop_front(&timeo_handles);
   if (handle == 
# 49 "/workspace/acl/lib_acl/src/aio/aio_callback.c" 3 4
                ((void *)0)
# 49 "/workspace/acl/lib_acl/src/aio/aio_callback.c"
                    ) {
    break;
   }
...
void aio_close_callback(ACL_ASTREAM *astream)
{
 ...
 if (astream->close_handles) {
  ...
  for ((astream->close_handles)->iter_tail(&(iter), (astream->close_handles)); (iter).ptr; (astream->close_handles)->iter_prev(&(iter), (astream->close_handles))) {
   AIO_CLOSE_HOOK *handle = (AIO_CLOSE_HOOK*) iter.data;
   if (handle->disable) {
    continue;
   }

   acl_fifo_push_back(&close_handles, handle);
  }

  while (1) {
   AIO_CLOSE_HOOK *handle = acl_fifo_pop_front(&close_handles);
   void *ctx;

   if (handle == 
# 95 "/workspace/acl/lib_acl/src/aio/aio_callback.c" 3 4
                ((void *)0)
# 95 "/workspace/acl/lib_acl/src/aio/aio_callback.c"
                    ) {
    break;
   }
   ...
   handle->disable = 1;
   handle->ctx = 
# 102 "/workspace/acl/lib_acl/src/aio/aio_callback.c" 3 4
                ((void *)0)
# 102 "/workspace/acl/lib_acl/src/aio/aio_callback.c"
                    ;
