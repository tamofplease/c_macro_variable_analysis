# 0 "/acl/lib_acl/src/aio/aio_callback.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/aio/aio_callback.c"
...
# 2 "/acl/lib_acl/src/aio/aio_callback.c" 2
# 17 "/acl/lib_acl/src/aio/aio_callback.c"
...
# 18 "/acl/lib_acl/src/aio/aio_callback.c" 2
...
int aio_timeout_callback(ACL_ASTREAM *astream)
{
 ...
 if (astream->timeo_handles) {
  ...
  while (1) {
   ...
   if (handle == 
# 49 "/acl/lib_acl/src/aio/aio_callback.c" 3 4
                ((void *)0)
# 49 "/acl/lib_acl/src/aio/aio_callback.c"
                    ) {
    break;
   }
...
void aio_close_callback(ACL_ASTREAM *astream)
{
 ...
 if (astream->close_handles) {
  ...
  while (1) {
   ...
   if (handle == 
# 95 "/acl/lib_acl/src/aio/aio_callback.c" 3 4
                ((void *)0)
# 95 "/acl/lib_acl/src/aio/aio_callback.c"
                    ) {
    break;
   }
   ...
   handle->disable = 1;
   handle->ctx = 
# 102 "/acl/lib_acl/src/aio/aio_callback.c" 3 4
                ((void *)0)
# 102 "/acl/lib_acl/src/aio/aio_callback.c"
                    ;
