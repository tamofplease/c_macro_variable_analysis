# 1 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 2
# 20 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
...
# 22 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 2
# 70 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
static void main_read_callback(int event_type, ACL_EVENT *event __attribute__ ((__unused__)),
...
static int read_complete_callback(ACL_ASTREAM *astream, char *data, int len)
{
 ...
 { (&astream->strbuf)->vbuf.ptr = (&astream->strbuf)->vbuf.data; ((&(&astream->strbuf)->vbuf)->flags &= ~((1<<0) | (1<<1) | (1<<2))); };
 ...
 if (astream->read_handles) {
  ...
  while (1) {
   ...
   if (handle == 
# 105 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
                ((void *)0)
# 105 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
                    ) {
    break;
   }
  ...
  for ((&astream->reader_fifo)->iter_tail(&(iter), (&astream->reader_fifo)); (iter).ptr; (&astream->reader_fifo)->iter_prev(&(iter), (&astream->reader_fifo))) {
...
# 136 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
static int __gets_peek(ACL_ASTREAM *astream)
{
 ...
 if (n == (-1)) {
  ...
  if (astream->stream->errnum == 
# 144 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
                                11
# 144 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
                                               )
  ...
  {
   do { if (((astream)->flag & (1 << 1)) == 0) { (astream)->flag |= (1 << 1); (astream)->aio->event->enable_read_fn((astream)->aio->event, (astream)->stream, (astream)->timeout, main_read_callback, (astream)); } } while (0);
   return 0;
  }
  ...
  if ((size_t) ((&astream->strbuf)->vbuf.ptr - (&astream->strbuf)->vbuf.data) > 0) {
   char *ptr = ((char *) (&astream->strbuf)->vbuf.data);
   int len = (int) (size_t) ((&astream->strbuf)->vbuf.ptr - (&astream->strbuf)->vbuf.data);

   (void) read_complete_callback(astream, ptr, len);
  }

  astream->flag |= (1 << 4);
  do { do { if ((((astream))->flag & (1 << 1)) != 0) { ((astream))->flag &= ~(1 << 1); ((astream))->can_read_fn = 
# 165 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 165 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; ((astream))->can_read_ctx = 
# 165 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 165 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; ((astream))->aio->event->disable_read_fn(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
  return -1;
 } else if (ready) {
  char *ptr = ((char *) (&astream->strbuf)->vbuf.data);
  int len = (int) (size_t) ((&astream->strbuf)->vbuf.ptr - (&astream->strbuf)->vbuf.data);
  ...
  if (n < 0 || (astream->flag & (1 << 0))) {
   do { do { if ((((astream))->flag & (1 << 1)) != 0) { ((astream))->flag &= ~(1 << 1); ((astream))->can_read_fn = 
# 178 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 178 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
  ; ((astream))->can_read_ctx = 
# 178 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 178 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
...
static void __gets_notify_callback(int event_type, ACL_ASTREAM *astream)
{
 ...
 if (astream->keep_read == 0) {
  do { if (((astream)->flag & (1 << 1)) != 0) { (astream)->flag &= ~(1 << 1); (astream)->can_read_fn = 
# 200 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 200 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; (astream)->can_read_ctx = 
# 200 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 200 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; (astream)->aio->event->disable_read_fn((astream)->aio->event, (astream)->stream); } } while (0);
 }
 ...
 if ((event_type & (1 << 4)) != 0) {
  ...
  int ret;
  acl_non_blocking(((astream->stream)->fd.sock),
   1);
  do {
  ...
  do { do { if ((((astream))->flag & (1 << 1)) != 0) { ((astream))->flag &= ~(1 << 1); ((astream))->can_read_fn = 
# 218 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 218 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; ((astream))->can_read_ctx = 
# 218 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 218 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; ((astream))->aio->event->disable_read_fn(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
  return;
 } else if ((event_type & (1 << 6)) != 0) {



  if (aio_timeout_callback(astream) < 0) {
   do { do { if ((((astream))->flag & (1 << 1)) != 0) { ((astream))->flag &= ~(1 << 1); ((astream))->can_read_fn = 
# 225 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 225 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
  ; ((astream))->can_read_ctx = 
# 225 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 225 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
  ; ((astream))->aio->event->disable_read_fn(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
  } else if (astream->flag & (1 << 0)) {



   do { do { if ((((astream))->flag & (1 << 1)) != 0) { ((astream))->flag &= ~(1 << 1); ((astream))->can_read_fn = 
# 230 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 230 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
  ; ((astream))->can_read_ctx = 
# 230 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 230 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
...
static void __aio_gets(ACL_ASTREAM *astream, int nonl)
{
 ...
 if (astream->stream == 
# 262 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
                       ((void *)0)
# 262 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
                           ) {
...
# 338 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
static int __read_peek(ACL_ASTREAM *astream)
{
 ...
 if (n == (-1)) {
  ...
  if (astream->stream->errnum == 
# 347 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
                                11
# 347 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
                                               )
  ...
  astream->flag |= (1 << 4);
  do { do { if ((((astream))->flag & (1 << 1)) != 0) { ((astream))->flag &= ~(1 << 1); ((astream))->can_read_fn = 
# 366 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 366 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; ((astream))->can_read_ctx = 
# 366 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 366 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; ((astream))->aio->event->disable_read_fn(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
  ...
  if (n < 0 || astream->flag & (1 << 0)) {
   do { do { if ((((astream))->flag & (1 << 1)) != 0) { ((astream))->flag &= ~(1 << 1); ((astream))->can_read_fn = 
# 379 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 379 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
  ; ((astream))->can_read_ctx = 
# 379 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 379 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
...
static void __read_notify_callback(int event_type, ACL_ASTREAM *astream)
{
 ...
 if (astream->keep_read == 0) {
  do { if (((astream)->flag & (1 << 1)) != 0) { (astream)->flag &= ~(1 << 1); (astream)->can_read_fn = 
# 401 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 401 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; (astream)->can_read_ctx = 
# 401 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 401 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ...
 if ((event_type & (1 << 4)) != 0) {
  ...
  do { do { if ((((astream))->flag & (1 << 1)) != 0) { ((astream))->flag &= ~(1 << 1); ((astream))->can_read_fn = 
# 417 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 417 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; ((astream))->can_read_ctx = 
# 417 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 417 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; ((astream))->aio->event->disable_read_fn(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
  ...
  if (aio_timeout_callback(astream) < 0) {
   ...
   do { do { if ((((astream))->flag & (1 << 1)) != 0) { ((astream))->flag &= ~(1 << 1); ((astream))->can_read_fn = 
# 425 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 425 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
  ; ((astream))->can_read_ctx = 
# 425 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 425 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
  ; ((astream))->aio->event->disable_read_fn(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
   ...
   do { do { if ((((astream))->flag & (1 << 1)) != 0) { ((astream))->flag &= ~(1 << 1); ((astream))->can_read_fn = 
# 430 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 430 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
  ; ((astream))->can_read_ctx = 
# 430 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 430 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
...
void acl_aio_read(ACL_ASTREAM *astream)
{
 ...
 if (astream->stream == 
# 458 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
                       ((void *)0)
# 458 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
                           ) {
...
# 512 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
static int __readn_peek(ACL_ASTREAM *astream)
{
 const char *myname = "__readn_peek";
 int n, ready = 0;

 n = (int) (size_t) ((&astream->strbuf)->vbuf.ptr - (&astream->strbuf)->vbuf.data);
 ...
 if (n == (-1)) {
  ...
  if (astream->stream->errnum == 
# 529 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
                                11
# 529 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
                                               )
  ...
  astream->flag |= (1 << 4);
  do { do { if ((((astream))->flag & (1 << 1)) != 0) { ((astream))->flag &= ~(1 << 1); ((astream))->can_read_fn = 
# 552 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 552 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; ((astream))->can_read_ctx = 
# 552 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 552 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; ((astream))->aio->event->disable_read_fn(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
  ...
  if (n < 0 || astream->flag & (1 << 0)) {
   do { do { if ((((astream))->flag & (1 << 1)) != 0) { ((astream))->flag &= ~(1 << 1); ((astream))->can_read_fn = 
# 567 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 567 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
  ; ((astream))->can_read_ctx = 
# 567 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 567 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
...
static void __readn_notify_callback(int event_type, ACL_ASTREAM *astream)
{
 ...
 if (astream->keep_read == 0) {
  do { if (((astream)->flag & (1 << 1)) != 0) { (astream)->flag &= ~(1 << 1); (astream)->can_read_fn = 
# 589 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 589 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; (astream)->can_read_ctx = 
# 589 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 589 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ...
 if ((event_type & (1 << 4)) != 0) {
  ...
  do { do { if ((((astream))->flag & (1 << 1)) != 0) { ((astream))->flag &= ~(1 << 1); ((astream))->can_read_fn = 
# 605 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 605 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; ((astream))->can_read_ctx = 
# 605 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 605 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; ((astream))->aio->event->disable_read_fn(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
  ...
  if (aio_timeout_callback(astream) < 0) {
   do { do { if ((((astream))->flag & (1 << 1)) != 0) { ((astream))->flag &= ~(1 << 1); ((astream))->can_read_fn = 
# 612 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 612 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
  ; ((astream))->can_read_ctx = 
# 612 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 612 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
  ; ((astream))->aio->event->disable_read_fn(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
   ...
   do { do { if ((((astream))->flag & (1 << 1)) != 0) { ((astream))->flag &= ~(1 << 1); ((astream))->can_read_fn = 
# 617 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 617 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
  ; ((astream))->can_read_ctx = 
# 617 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 617 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ...
 if (astream->stream == 
# 628 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
                       ((void *)0)
# 628 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
                           ) {
...
void acl_aio_readn(ACL_ASTREAM *astream, int count)
{
 ...
 acl_vbuf_space(&(&astream->strbuf)->vbuf, count);
...
ACL_VSTRING *acl_aio_gets_peek(ACL_ASTREAM *astream)
{
 ...
 if ((astream->flag & (1 << 3))) {
  return 
# 704 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
        ((void *)0)
# 704 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
            ;
 }

 if (acl_vstream_gets_peek(astream->stream,
  &astream->strbuf, &ready) == (-1)

  && astream->stream->errnum != 
# 710 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
                               11

  
# 712 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 && astream->stream->errnum != 
# 712 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
                               11
# 712 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
                                              )
 {
  ...
  if ((size_t) ((&astream->strbuf)->vbuf.ptr - (&astream->strbuf)->vbuf.data) > 0) {
   ...
   return 
# 718 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
         ((void *)0)
# 718 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
             ;
  }
 } else if (ready) {
  return &astream->strbuf;
  ...
  return 
# 723 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
        ((void *)0)
# 723 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
            ;
 }
}
...
ACL_VSTRING *acl_aio_gets_nonl_peek(ACL_ASTREAM *astream)
{
 ...
 if ((astream->flag & (1 << 3))) {
  return 
# 732 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
        ((void *)0)
# 732 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
            ;
 }
 ...
 if (acl_vstream_gets_nonl_peek(astream->stream,
  ...
  && astream->stream->errnum != 
# 738 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
                               11

  
# 740 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 && astream->stream->errnum != 
# 740 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
                               11
# 740 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
                                              ) {
  ...
  if ((size_t) ((&astream->strbuf)->vbuf.ptr - (&astream->strbuf)->vbuf.data) > 0) {
   ...
   return 
# 746 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
         ((void *)0)
# 746 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
             ;
  }
 } else if (ready) {
  return &astream->strbuf;
  ...
  return 
# 751 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
        ((void *)0)
# 751 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
            ;
 }
}
...
ACL_VSTRING *acl_aio_read_peek(ACL_ASTREAM *astream, int *count)
{
  ...
  *count = 0;
  return 
# 761 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
        ((void *)0)
# 761 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
            ;
 }
 ...
 if (n == (-1)
  ...
  && astream->stream->errnum != 
# 768 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
                               11

  
# 770 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 && astream->stream->errnum != 
# 770 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
                               11
# 770 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
                                              ) {
  ...
  *count = 0;
  if ((size_t) ((&astream->strbuf)->vbuf.ptr - (&astream->strbuf)->vbuf.data) > 0) {
   ...
   return 
# 777 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
         ((void *)0)
# 777 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
             ;
  }
 }
 ...
 *count = n;
 ...
 if (n > 0) {
  ...
  return 
# 786 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
        ((void *)0)
# 786 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
            ;
 }
}
...
ACL_VSTRING *acl_aio_readn_peek(ACL_ASTREAM *astream, int *count)
{
  ...
  *count = 0;
  return 
# 796 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
        ((void *)0)
# 796 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
            ;
 }
 ...
 if (ret == (-1)
  ...
  && astream->stream->errnum != 
# 804 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
                               11

  
# 806 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 && astream->stream->errnum != 
# 806 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
                               11
# 806 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
                                              ) {
  ...
  *count = 0;
  ...
  if ((size_t) ((&astream->strbuf)->vbuf.ptr - (&astream->strbuf)->vbuf.data) > 0) {
   ...
   return 
# 813 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
         ((void *)0)
# 813 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
             ;
  }
 }
 ...
 *count = ret;
 ...
 if (ready) {
  ...
  return 
# 822 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
        ((void *)0)
# 822 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
            ;
 }
}
...
static void can_read_callback(int event_type, ACL_EVENT *event __attribute__ ((__unused__)),
 ACL_VSTREAM *stream __attribute__ ((__unused__)), void *context)
{
 ACL_ASTREAM *astream = (ACL_ASTREAM*) context;
 ...
 if (astream->keep_read == 0) {
  do { if (((astream)->flag & (1 << 1)) != 0) { (astream)->flag &= ~(1 << 1); (astream)->can_read_fn = 
# 837 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 837 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; (astream)->can_read_ctx = 
# 837 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 837 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ...
 if ((event_type & (1 << 6)) != 0) {
  if (aio_timeout_callback(astream) < 0) {
   do { do { if ((((astream))->flag & (1 << 1)) != 0) { ((astream))->flag &= ~(1 << 1); ((astream))->can_read_fn = 
# 842 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 842 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
  ; ((astream))->can_read_ctx = 
# 842 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 842 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
  ; ((astream))->aio->event->disable_read_fn(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
   ...
   do { do { if ((((astream))->flag & (1 << 1)) != 0) { ((astream))->flag &= ~(1 << 1); ((astream))->can_read_fn = 
# 847 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 847 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
  ; ((astream))->can_read_ctx = 
# 847 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
  ((void *)0)
# 847 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
  ; ((astream))->aio->event->disable_read_fn(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
   ...
   do { if (((astream)->flag & (1 << 1)) == 0) { (astream)->flag |= (1 << 1); (astream)->aio->event->enable_read_fn((astream)->aio->event, (astream)->stream, (astream)->timeout, can_read_callback, (astream)); } } while (0);
  }
  return;
 }
 ...
 if (astream->can_read_fn(astream, astream->can_read_ctx) < 0) {
  astream->nrefer--;
  do { do { if ((((astream))->flag & (1 << 1)) != 0) { ((astream))->flag &= ~(1 << 1); ((astream))->can_read_fn = 
# 857 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 857 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; ((astream))->can_read_ctx = 
# 857 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 857 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; ((astream))->aio->event->disable_read_fn(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
  ...
  astream->nrefer--;
  do { do { if ((((astream))->flag & (1 << 1)) != 0) { ((astream))->flag &= ~(1 << 1); ((astream))->can_read_fn = 
# 860 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 860 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; ((astream))->can_read_ctx = 
# 860 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 860 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ...
 ACL_AIO_NOTIFY_FN can_read_fn, void *context)
{
 ...
 if ((ret = acl_vstream_can_read(astream->stream)) == (-1)) {
  do { do { if ((((astream))->flag & (1 << 1)) != 0) { ((astream))->flag &= ~(1 << 1); ((astream))->can_read_fn = 
# 888 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 888 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; ((astream))->can_read_ctx = 
# 888 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
 ((void *)0)
# 888 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
 ; ((astream))->aio->event->disable_read_fn(((astream))->aio->event, ((astream))->stream); } } while (0); (astream)->flag |= (1 << 0); acl_aio_iocp_close((astream)); } while (0);
  ...
  can_read_callback((1 << 0), astream->aio->event,
...
void acl_aio_disable_read(ACL_ASTREAM *astream)
{
 ...
 astream->flag &= ~(1 << 1);
 astream->can_read_fn = 
# 905 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
                       ((void *)0)
# 905 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
                           ;
 astream->can_read_ctx = 
# 906 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
                        ((void *)0)
# 906 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
                            ;
 if (astream->stream) {
...
{
 if (astream->stream == 
# 914 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c" 3 4
                       ((void *)0)
# 914 "/workspace/acl/lib_acl/src/aio/acl_aio_read.c"
                           ) {
  return 0;
 }
