# 0 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
...
# 2 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 2
# 38 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
...
# 124 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
...
# 139 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                           ((void *)0)
# 139 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                               )
  acl_msg_fatal("%s, %s(%d): poller_fn is null!",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 141);

 !acl_do_debug(((0 + 3)), (2)) ? (void) 0 : acl_msg_info ("%s(%d): poller(tid=%lu) started.",
  myname, 144, (unsigned long) id);
 loop_count = 0;
 pre_loop_t = time(
# 146 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                  ((void *)0)
# 146 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                      );
 ...
 for (;;) {
  ...
  now_t = time(
# 157 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
              ((void *)0)
# 157 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                  );
  loop_count++;
  if (loop_count >= max_loop_persec) {
   ...
   if (now_t - pre_loop_t <= wait_sec) {
    ...
    now_t = time(
# 166 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                ((void *)0)
# 166 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                    );
   }
 ...
 return 
# 190 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
       ((void *)0)
# 190 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
           ;
}
...
static thread_cond *thread_cond_create(void)
{
 thread_cond *cond = (thread_cond*)
  acl_calloc_glue("/acl/lib_acl/src/thread/acl_pthread_pool.c", 196, 1, sizeof(thread_cond));

 if (pthread_cond_init(&cond->cond, 
# 198 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                       ((void *)0)
# 198 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                           ) != 0)
  abort();
 return cond;
}
...
static void thread_cond_free(thread_cond *cond)
{
 ...
 do { if (cond) { acl_free_glue("/acl/lib_acl/src/thread/acl_pthread_pool.c", 206, (cond)); (cond) = 
# 206 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
((void *)0)
# 206 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
; } } while (0);
}

static thread_worker *worker_create(acl_pthread_pool_t *thr_pool)
{
 thread_worker *thr = (thread_worker*) acl_calloc_glue("/acl/lib_acl/src/thread/acl_pthread_pool.c", 211, 1, sizeof(thread_worker))
                         ;
...
# 227 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                            ((void *)0)
# 227 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                ) {
...
static void worker_free(acl_pthread_pool_t *thr_pool, thread_worker *thr)
{
 ...
 do { if (thr) { acl_free_glue("/acl/lib_acl/src/thread/acl_pthread_pool.c", 241, (thr)); (thr) = 
# 241 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
((void *)0)
# 241 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
; } } while (0);
}
 ...
 thread_worker *thr, acl_pthread_job_t *job)
{
 ...
 if (status != 0) {
  ...
  acl_msg_fatal("%s(%d), %s: unlock error: %s, tid: %lu",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 258, myname, acl_last_serror(),
...
# 265 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
 ((void *)0)
# 265 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
  ...
  if (now >= thr_pool->schedule_warn) {
   acl_msg_warn("%s(%d), %s: schedule: %lld >= %lld, qlen=%d",
    "/acl/lib_acl/src/thread/acl_pthread_pool.c", 269, myname,
    now, thr_pool->schedule_warn, thr_pool->qlen);
  }
 }
# 305 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
 if (!job->fixed)
  do { if (job) { acl_free_glue("/acl/lib_acl/src/thread/acl_pthread_pool.c", 306, (job)); (job) = 
# 306 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
 ((void *)0)
# 306 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
 ; } } while (0);
 ...
 if (status != 0) {
  ...
  acl_msg_fatal("%s(%d), %s: lock error: %s, sid: %lu",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 317, myname, acl_last_serror(),
   (unsigned long) pthread_self());
 }
}
...
# 332 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                           ((void *)0)
# 332 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                               ) {
  thr_pool->thr_first = thr;
  thr->next = 
# 334 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
             ((void *)0)
# 334 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                 ;
  thr->prev = 
# 335 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
             ((void *)0)
# 335 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                 ;
 } else {
  thr_pool->thr_first->prev = thr;
  thr->next = thr_pool->thr_first;
  thr->prev = 
# 339 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
             ((void *)0)
# 339 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                 ;
  thr_pool->thr_first = thr;
 }
 ...
 while (1) {
  ...
  if (thr->idle > 0) {
   gettimeofday(&tv, 
# 348 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                    ((void *)0)
# 348 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                        );
  ...
  if (status == 
# 381 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
               110
# 381 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                            ) {
   idle_count++;
  ...
  acl_msg_warn("%s(%d), %s: tid: %lu, cond timewait error: %s",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 394, myname, (unsigned long)
 ...
 if (thr_pool->thr_first == thr) {
  if (thr->next)
   thr->next->prev = 
# 403 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                    ((void *)0)
# 403 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                        ;
...
# 429 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                ((void *)0)
# 429 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                    ) {
  if (thr_pool->worker_init_fn(thr_pool->worker_init_arg) < 0) {
   acl_msg_error("%s(%d), %s: thread(%lu) init error",
    "/acl/lib_acl/src/thread/acl_pthread_pool.c", 432, myname,
    (unsigned long) pthread_self());
   pthread_mutex_lock(&thr_pool->worker_mutex);
   thr_pool->count--;
   pthread_mutex_unlock(&thr_pool->worker_mutex);
   return 
# 437 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
         ((void *)0)
# 437 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
             ;
  }
 }
 ...
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s(%d), %s: lock failed: %s", "/acl/lib_acl/src/thread/acl_pthread_pool.c",
 ...
 for (;;) {
  ...
  if (thr->job_first != 
# 456 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                       ((void *)0)
# 456 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                           ) {
   job = thr->job_first;
   thr->job_first = job->next;
   if (thr->job_last == job)
    thr->job_last = 
# 460 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                   ((void *)0)
# 460 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                       ;
   thr->qlen--;
...
# 467 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                 ((void *)0)
# 467 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                     ) {
   job = thr_pool->job_first;
   thr_pool->job_first = job->next;
   if (thr_pool->job_last == job)
    thr_pool->job_last = 
# 471 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                        ((void *)0)
# 471 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                            ;
   thr_pool->qlen--;
  ...
  if (thr->job_first != 
# 477 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                       ((void *)0) 
# 477 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                            || thr_pool->job_first != 
# 477 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                                      ((void *)0)
# 477 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
...
# 494 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                ((void *)0)
# 494 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                    )
 ...
 if (status != 0) {
  ...
  acl_msg_fatal("%s, %s(%d): unlock error(%s)",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 508, acl_last_serror());
 }

 return 
# 511 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
       ((void *)0)
# 511 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
           ;
}
 ...
 acl_pthread_job_t *job)
{
 ...
 if (thr_pool->thr_first == thr) {
  if (thr->next)
   thr->next->prev = 
# 527 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                    ((void *)0)
# 527 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                        ;
  thr_pool->thr_first = thr->next;
 } else {
  if (thr->next)
 ...
 if (status != 0) {
  ...
  acl_msg_fatal("%s(%d), %s: pthread_mutex_unlock: %s",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 541, myname, acl_last_serror());
 }
 ...
 if (status != 0) {
  ...
  acl_msg_error("%s(%d), %s: pthread_cond_signal: %s",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 548, myname, acl_last_serror());
 }
...
static void job_add(acl_pthread_pool_t *thr_pool, acl_pthread_job_t *job)
{
 ...
 job->next = 
# 561 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
            ((void *)0)
# 561 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                ;

 if (thr_pool->schedule_warn > 0)
  do { struct timeval t; gettimeofday(&t, 
# 564 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
 ((void *)0)
# 564 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
 ...
 if (status != 0) {
  ...
  acl_msg_fatal("%s(%d), %s: pthread_mutex_lock: %s",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 572, myname, acl_last_serror());
 }
 ...
 if (thr_pool->job_first == 
# 583 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                           ((void *)0)
# 583 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                               )
 ...
 if (thr_pool->count < thr_pool->parallelism) {
  ...
  if (status == 0)
   ...
   acl_msg_error("%s(%d), %s: pthread_create: %s",
    "/acl/lib_acl/src/thread/acl_pthread_pool.c", 602, myname, acl_last_serror());
  }
  ...
  if (status != 0) {
   (acl_set_error(status));
   acl_msg_fatal("%s(%d), %s: pthread_mutex_unlock: %s",
    "/acl/lib_acl/src/thread/acl_pthread_pool.c", 609, myname, acl_last_serror());
  }
  return;
 }
 ...
 if (thr_pool->qlen > thr_pool->qlen_warn) {
  time_t now = time(
# 617 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                   ((void *)0)
# 617 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                       );

  if (now - thr_pool->last_warn >= 2) {
   thr_pool->last_warn = now;
   acl_msg_warn("%s(%d), %s: OVERLOADED! max_thread: %d,"
    " qlen: %d, idle: %d", "/acl/lib_acl/src/thread/acl_pthread_pool.c", 622,
    myname, thr_pool->parallelism, thr_pool->qlen,
    thr_pool->idle);
  }
  if (thr_pool->overload_wait > 0) {
   acl_msg_warn("%s(%d), %s: sleep %d seconds", "/acl/lib_acl/src/thread/acl_pthread_pool.c",
 ...
 if (status != 0) {
  ...
  acl_msg_error("%s(%d), %s: pthread_mutex_unlock: %s",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 637, myname, acl_last_serror());
 }
}
 ...
 void (*run_fn)(void *), void *run_arg)
{
 ...
 if (thr_pool->valid != 0x0decca62)
  acl_msg_fatal("%s(%d), %s: thr_pool invalid",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 652, myname);
 if (run_fn == 
# 653 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
              ((void *)0)
# 653 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                  )
  acl_msg_fatal("%s(%d), %s: run_fn null",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 655, myname);
# 684 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
 ...
 acl_pthread_job_t *job)
{
 ...
 if (thr_pool->valid != 0x0decca62)
  acl_msg_fatal("%s(%d), %s: thr_pool invalid",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 696, myname);
 if (job == 
# 697 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
           ((void *)0)
# 697 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
               )
  acl_msg_fatal("%s(%d), %s: job null",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 699, myname);
...
void acl_pthread_pool_bat_add_begin(acl_pthread_pool_t *thr_pool)
{
 ...
 if (thr_pool->valid != 0x0decca62)
  acl_msg_fatal("%s(%d), %s: invalid thr_pool->valid",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 711, myname);
 ...
 if (status != 0) {
  ...
  acl_msg_fatal("%s(%d), %s: pthread_mutex_lock, serr = %s",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 719, myname, acl_last_serror());
 }
}
...
static void job_append(acl_pthread_pool_t *thr_pool, acl_pthread_job_t *job)
{
 ...
 job->next = 
# 729 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
            ((void *)0)
# 729 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                ;

 if (thr_pool->thr_iter != 
# 731 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                          ((void *)0)
# 731 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                              ) {
  ...
  for (thr_pool->thr_iter = thr_pool->thr_iter->next;
   thr_pool->thr_iter != 
# 746 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                        ((void *)0)
# 746 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                            ;
   thr_pool->thr_iter = thr_pool->thr_iter->next)
  {
 ...
 if (thr_pool->job_first == 
# 763 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                           ((void *)0)
# 763 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                               )
  thr_pool->job_first = job;
 else
  thr_pool->job_last->next = job;
 ...
 if (thr_pool->count < thr_pool->parallelism) {
  ...
  (acl_set_error(status));
  acl_msg_error("%s(%d), %s: pthread_create: %s",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 784, myname, acl_last_serror());
  return;
 }
 ...
 if (thr_pool->qlen > thr_pool->qlen_warn) {
  time_t now = time(
# 791 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                   ((void *)0)
# 791 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                       );

  if (now - thr_pool->last_warn >= 2) {
   thr_pool->last_warn = now;
   acl_msg_warn("%s(%d), %s: OVERLOADED! max_thread: %d"
    ", qlen: %d, idle: %d", "/acl/lib_acl/src/thread/acl_pthread_pool.c", 796,
    myname, thr_pool->parallelism, thr_pool->qlen,
    thr_pool->idle);
  }
  if (thr_pool->overload_wait > 0) {
...
# 817 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                                           ((void *)0)
# 817 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                                               )
  acl_msg_fatal("%s(%d), %s: invalid thr_pool or run_fn",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 819, myname);
# 849 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
  job = acl_pthread_pool_alloc_job(run_fn, run_arg, 0);
 ...
 acl_pthread_job_t *job)
{
 ...
 if (thr_pool->valid != 0x0decca62)
  acl_msg_fatal("%s(%d), %s: invalid thr_pool->valid",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 861, myname);
...
void acl_pthread_pool_bat_add_end(acl_pthread_pool_t *thr_pool)
{
 ...
 if (thr_pool->valid != 0x0decca62)
  acl_msg_fatal("%s(%d), %s: invalid thr_pool->valid",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 874, myname);
 ...
 for (; thr_iter != 
# 881 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                   ((void *)0) 
# 881 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                        ; thr_iter = next) {
  ...
  if (thr_iter->qlen > 0) {
   ...
   if (thr_pool->thr_first == thr_iter) {
    if (thr_iter->next)
     thr_iter->prev = 
# 889 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                     ((void *)0)
# 889 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                         ;
   ...
   acl_msg_fatal("%s(%d), %s: pthread_cond_signal: %s",
    "/acl/lib_acl/src/thread/acl_pthread_pool.c", 903, myname, acl_last_serror());
  }
   ...
   (acl_set_error(status));
   acl_msg_fatal("%s(%d), %s: pthread_cond_signal: %s",
    "/acl/lib_acl/src/thread/acl_pthread_pool.c", 918, myname, acl_last_serror());
  } else
   next = thr_iter->next;
 }
 ...
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s(%d), %s: pthread_mutex_unlock: %s",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 927, myname, acl_last_serror());
 }

 thr_pool->thr_iter = 
# 930 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                     ((void *)0)
# 930 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                         ;
}
...
static void thread_pool_init(acl_pthread_pool_t *thr_pool)
{
 ...
 thr_pool->poller_running = 0;
 thr_pool->job_first = 
# 938 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                              ((void *)0)
# 938 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                  ;
 thr_pool->job_last = 
# 939 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                              ((void *)0)
# 939 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                  ;
 thr_pool->job_slot_first = 
# 940 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                              ((void *)0)
# 940 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                  ;
 thr_pool->job_slot_last = 
# 941 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                              ((void *)0)
# 941 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                  ;
 thr_pool->job_nslot = 0;
 thr_pool->thr_first = 
# 943 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                              ((void *)0)
# 943 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                  ;
 thr_pool->thr_iter = 
# 944 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                              ((void *)0)
# 944 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                  ;
 thr_pool->qlen = 0;
 ...
 thr_pool->cond_first = 
# 951 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                              ((void *)0)
# 951 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                  ;
}
...
acl_pthread_pool_t *acl_pthread_pool_create(const acl_pthread_pool_attr_t *attr)
{
 ...
 thr_pool = acl_calloc_glue("/acl/lib_acl/src/thread/acl_pthread_pool.c", 989, 1, sizeof(*thr_pool));
 status = pthread_attr_init(&thr_pool->attr);
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s(%d), %s: pthread_attr_init: %s",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 994, myname, acl_last_serror());
 }
...
# 1002 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
  PTHREAD_CREATE_DETACHED
# 1002 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                             );
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s(%d), %s: pthread_attr_setdetachstate: %s",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1006, myname, acl_last_serror());
 }


 status = pthread_attr_setscope(&thr_pool->attr, 
# 1010 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                                PTHREAD_SCOPE_SYSTEM
# 1010 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                                                    );
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s(%d), %s: pthread_attr_setscope: %s",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1014, myname, acl_last_serror());
 }


 status = pthread_mutex_init(&thr_pool->worker_mutex, 
# 1018 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                                         ((void *)0)
# 1018 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                                             );
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s(%d), %s: pthread_mutex_init: %s",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1022, myname, acl_last_serror());
 }

 status = pthread_cond_init(&thr_pool->cond, 
# 1025 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                                ((void *)0)
# 1025 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                                    );
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s(%d), %s: pthread_cond_init: %s",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1029, myname, acl_last_serror());
 }
# 1041 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
 status = pthread_mutex_init(&thr_pool->poller_mutex, 
# 1041 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                                         ((void *)0)
# 1041 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                                             );
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s(%d), %s: pthread_mutex_init: %s",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1045, myname, acl_last_serror());
 }
 status = pthread_cond_init(&thr_pool->poller_cond, 
# 1047 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                                       ((void *)0)
# 1047 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                                           );
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s(%d), %s: pthread_cond_init: %s",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1051, myname, acl_last_serror());
 }
 ...
 thr_pool->idle_timeout = (attr && attr->idle_timeout > 0) ?
  attr->idle_timeout : 0;
 thr_pool->poller_fn = 
# 1061 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                      ((void *)0)
# 1061 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                          ;
 thr_pool->poller_arg = 
# 1062 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                       ((void *)0)
# 1062 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                           ;

 thr_pool->worker_init_fn = 
# 1064 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                           ((void *)0)
# 1064 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                               ;
 thr_pool->worker_init_arg = 
# 1065 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                            ((void *)0)
# 1065 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                ;
 thr_pool->worker_free_fn = 
# 1066 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                           ((void *)0)
# 1066 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                               ;
 thr_pool->worker_free_arg = 
# 1067 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                            ((void *)0)
# 1067 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                ;
...
int acl_pthread_pool_set_timewait(acl_pthread_pool_t *thr_pool, int timewait)
{
 ...
 if (thr_pool == 
# 1083 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                ((void *)0) 
# 1083 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                     || thr_pool->valid != 0x0decca62
  || timewait < 0)
 {
  acl_msg_error("%s(%d), %s: invalid input",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1087, myname);
  return -1;
 }
 ...
 int (*init_fn)(void *), void *init_arg)
{
 ...
 if (thr_pool == 
# 1100 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                ((void *)0) 
# 1100 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                     || thr_pool->valid != 0x0decca62) {
  acl_msg_error("%s(%d), %s: input invalid",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1102, myname);
  return 
# 1103 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
        22
# 1103 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                  ;
 }
 ...
 void (*free_fn)(void *), void *free_arg)
{
 ...
 if (thr_pool == 
# 1117 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                ((void *)0) 
# 1117 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                     || thr_pool->valid != 0x0decca62) {
  acl_msg_error("%s(%d), %s: input invalid",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1119, myname);
  return 
# 1120 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
        22
# 1120 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                  ;
 }
...
static int wait_poller_exit(acl_pthread_pool_t *thr_pool)
{
 ...
 if (status != 0) {
  ...
  acl_msg_error("%s, %s(%d): pthread_mutex_lock: %s",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1144, acl_last_serror());
  return status;
 }
 ...
 while (thr_pool->poller_running != 0) {
  gettimeofday(&tv, 
# 1151 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                   ((void *)0)
# 1151 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                       );
  ...
  if (status == 
# 1159 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
               110
# 1159 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                            ) {
   ...
   acl_msg_error("%s, %s(%d): pthread_cond_wait: %s",
    "/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1166, acl_last_serror());
   return status;
  }
 }
 ...
 if (status != 0) {
  ...
  acl_msg_error("%s, %s(%d): pthread_mutex_unlock error(%s)",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1177, acl_last_serror());
 }
...
static int wait_worker_exit(acl_pthread_pool_t *thr_pool)
{
 ...
 if (status != 0) {
  ...
  acl_msg_error("%s(%d), %s: pthread_mutex_lock: %s",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1192, myname, acl_last_serror());
  return status;
 }
 ...
 if (thr_pool->count < 0) {
  acl_msg_error("%s(%d), %s: count: %d",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1200, myname, thr_pool->count);
 ...
 if (thr_pool->thr_first != 
# 1215 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                           ((void *)0)
# 1215 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                               ) {
  thread_worker *thr;
...
# 1221 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                        ((void *)0)
# 1221 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                            ; thr = thr->next)
 ...
 while (thr_pool->count > 0) {
  ...
  if (status == 
# 1237 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
               110
# 1237 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                            ) {
   !acl_do_debug(((0 + 3)), (2)) ? (void) 0 : acl_msg_info
   ...
   acl_msg_error("%s(%d), %s: pthread_cond_timedwait"
    " err: %s", "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1244, myname,
    acl_last_serror());
   return status;
  }
 }
 ...
 if (status != 0) {
  ...
  acl_msg_error("%s(%d), %s: pthread_mutex_unlock err: %s",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1254, myname, acl_last_serror());
 }
...
int acl_pthread_pool_destroy(acl_pthread_pool_t *thr_pool)
{
 ...
 if (thr_pool == 
# 1269 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                ((void *)0) 
# 1269 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                     || thr_pool->valid != 0x0decca62) {
  acl_msg_error("%s(%d), %s: input invalid",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1271, myname);
  return 
# 1272 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
        22
# 1272 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                  ;
 }
 ...
 if (status != 0) {
  ...
  acl_msg_error("%s, %s(%d): wait_poller_exit: %s, ret: %d",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1281, acl_last_serror(), status);
  return status;
 }
 ...
 if (status != 0) {
  ...
  acl_msg_error("%s, %s(%d): wait_worker_exit: %s, ret: %d",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1293, acl_last_serror(), status);
  return status;
 }

 for (job = thr_pool->job_slot_first; job != 
# 1297 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                            ((void *)0)
# 1297 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                                ;) {
...
# 1312 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                               ((void *)0)
# 1312 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                   ;) {
 ...
 do { if (thr_pool) { acl_free_glue("/acl/lib_acl/src/thread/acl_pthread_pool.c", 1326, (thr_pool)); (thr_pool) = 
# 1326 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
((void *)0)
# 1326 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
; } } while (0);
...
int acl_pthread_pool_stop(acl_pthread_pool_t *thr_pool)
{
 ...
 if (thr_pool == 
# 1342 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                ((void *)0) 
# 1342 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                     || thr_pool->valid != 0x0decca62) {
  acl_msg_error("%s(%d), %s: input invalid",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1344, myname);
  return 
# 1345 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
        22
# 1345 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                  ;
 }
 ...
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_error("%s, %s(%d): wait_poller_exit: %s, ret: %d",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1354, acl_last_serror(), status);
  return status;
 }
 ...
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_error("%s, %s(%d): wait_worker_exit: %s, ret: %d",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1366, acl_last_serror(), status);
  return status;
 }
...
# 1385 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                                              ((void *)0)
# 1385 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                                                  ) {
  acl_msg_error("%s(%d), %s: input invalid",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1387, myname);
  return;
 }
...
int acl_pthread_pool_start_poller(acl_pthread_pool_t *thr_pool)
{
 ...
 if (thr_pool->valid != 0x0decca62) {
  acl_msg_error("%s(%d), %s: input invalid",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1403, myname);
  return -1;
 }

 if (thr_pool->poller_fn == 
# 1407 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                           ((void *)0)
# 1407 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                               ) {
  acl_msg_warn("%s, %s(%d): poller_fn null, needn't call %s",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1409, myname);
  return -1;
 }
 ...
 if (status != 0) {
  ...
  acl_msg_error("%s, %s(%d): lock poller_mutex error(%s)",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1417, acl_last_serror());
  return -1;
 }

 if (thr_pool->poller_running) {
  acl_msg_error("%s, %s(%d): server is running",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1423);
  return -1;
 }
 ...
 if (status != 0) {
  ...
  acl_msg_error("%s, %s(%d): unlock poller_mutex error(%s)",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1431, acl_last_serror());
  return -1;
 }
 ...
 if (status != 0) {
  ...
  acl_msg_error("%s(%d), %s: pthread_create poller: %s",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1442, myname, acl_last_serror());
  return status;
 }
 ...
 void (*run_fn)(void *), void *run_arg)
{
 ...
 if (dispatch_arg == 
# 1455 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                    ((void *)0) 
# 1455 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                         || run_fn == 
# 1455 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                      ((void *)0)
# 1455 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
  ...
  acl_msg_fatal("%s(%d), %s: invalid input",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1457, myname);
 ...
 void (*run_fn)(void *), void *run_arg)
{
 ...
 if (dispatch_arg == 
# 1471 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                    ((void *)0) 
# 1471 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                         || run_fn == 
# 1471 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                      ((void *)0)
# 1471 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
  ...
  acl_msg_fatal("%s(%d), %s: invalid input",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1473, myname);
...
int acl_pthread_pool_size(acl_pthread_pool_t *thr_pool)
{
 ...
 if (status) {
  acl_msg_error("%s(%d), %s: pthread_mutex_lock error(%s)",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1494, myname, strerror(status));
  return -1;
 }
 ...
 if (status) {
  acl_msg_error("%s(%d), %s: pthread_mutex_unlock error(%s)",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1502, myname, strerror(status));
  return -1;
 }
...
int acl_pthread_pool_idle(acl_pthread_pool_t *thr_pool)
{
 ...
 if (status) {
  acl_msg_error("%s(%d), %s: pthread_mutex_lock error(%s)",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1517, myname, strerror(status));
  return -1;
 }
 ...
 if (status) {
  acl_msg_error("%s(%d), %s: pthread_mutex_unlock error(%s)",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1526, myname, strerror(status));
  return -1;
 }
...
int acl_pthread_pool_busy(acl_pthread_pool_t *thr_pool)
{
 ...
 if (status) {
  acl_msg_error("%s(%d), %s: pthread_mutex_lock error(%s)",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1541, myname, strerror(status));
  return -1;
 }
 ...
 if (status) {
  acl_msg_error("%s(%d), %s: pthread_mutex_unlock error(%s)",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1550, myname, strerror(status));
  return -1;
 }

 if (n < 0)
  acl_msg_error("%s(%d), %s: threads's count(%d) < idle(%d)",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1556, myname, thr_pool->count,
   thr_pool->idle);
 return n;
}
...
int acl_pthread_pool_qlen(acl_pthread_pool_t *thr_pool)
{
 ...
 if (status) {
  acl_msg_error("%s(%d), %s: pthread_mutex_lock error(%s)",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1569, myname, strerror(status));
  return -1;
 }
 ...
 if (status) {
  acl_msg_error("%s(%d), %s: pthread_mutex_unlock error(%s)",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1578, myname, strerror(status));
  return -1;
 }

 if (n < 0)
  acl_msg_error("%s(%d), %s: threads's count(%d) < idle(%d)",
   "/acl/lib_acl/src/thread/acl_pthread_pool.c", 1584, myname, thr_pool->count,
   thr_pool->idle);
 return n;
}
 ...
 void *run_arg, int fixed)
{
 acl_pthread_job_t *job = (acl_pthread_job_t*)
  acl_malloc_glue("/acl/lib_acl/src/thread/acl_pthread_pool.c", 1626, sizeof(acl_pthread_job_t));

 job->worker_fn = run_fn;
 job->worker_arg = run_arg;
 job->next = 
# 1630 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                  ((void *)0)
# 1630 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
                      ;
 job->fixed = fixed;
 return job;
}
...
void acl_pthread_pool_free_job(acl_pthread_job_t *job)
{
 do { if (job) { acl_free_glue("/acl/lib_acl/src/thread/acl_pthread_pool.c", 1637, (job)); (job) = 
# 1637 "/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
((void *)0)
# 1637 "/acl/lib_acl/src/thread/acl_pthread_pool.c"
; } } while (0);
}
