# 1 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 2
# 38 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
...
typedef struct thread_worker {
 ...
 int quit;
 int idle;
 long long int wait_base;
 long long int wait_sec;
 long long int wait_nsec;
 long long int wait_count;
 acl_pthread_job_t *job_first;
 acl_pthread_job_t *job_last;
 int qlen;
 thread_cond *cond;
 acl_pthread_mutex_t *mutex;
} thread_worker;
...
struct acl_pthread_pool_t {
 acl_pthread_mutex_t worker_mutex;
 acl_pthread_cond_t cond;
 acl_pthread_mutex_t poller_mutex;
 acl_pthread_cond_t poller_cond;
 acl_pthread_attr_t attr;
 acl_pthread_job_t *job_first;
 acl_pthread_job_t *job_last;
 acl_pthread_job_t *job_slot_first;
 acl_pthread_job_t *job_slot_last;
 ...
 int idle;
 int idle_timeout;
 long long int schedule_warn;
 long long int schedule_wait;
 int overload_wait;
 time_t last_warn;
 int (*poller_fn)(void *arg);
 void *poller_arg;
 int (*worker_init_fn)(void *arg);
 void *worker_init_arg;
 void (*worker_free_fn)(void *arg);
 void *worker_free_arg;
};
# 124 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
static void *poller_thread(void *arg)
{
 ...
 if (thr_pool->poller_fn == 
# 139 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                           ((void *)0)
# 139 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                               )
  acl_msg_fatal("%s, %s(%d): poller_fn is null!",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 141);

 !acl_do_debug(((0 + 3)), (2)) ? (void) 0 : acl_msg_info ("%s(%d): poller(tid=%lu) started.",
  myname, 144, (unsigned long) id);
 loop_count = 0;
 pre_loop_t = time(
# 146 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                  ((void *)0)
# 146 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                      );

 if (pthread_mutex_lock(&thr_pool->poller_mutex) != 0)
  abort();
 ...
 for (;;) {
  ...
  now_t = time(
# 157 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
              ((void *)0)
# 157 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                  );
  loop_count++;
  if (loop_count >= max_loop_persec) {
   ...
   if (now_t - pre_loop_t <= wait_sec) {
    ...
    now_t = time(
# 166 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                ((void *)0)
# 166 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                    );
   }
 ...
 !acl_do_debug(((0 + 3)), (2)) ? (void) 0 : acl_msg_info ("%s(%d): poller(%lu) thread quit.",
  myname, 178, (unsigned long) id);

 thr_pool->poller_running = 0;

 if (pthread_cond_broadcast(&thr_pool->poller_cond) != 0)
  abort();

 !acl_do_debug(((0 + 3)), (3)) ? (void) 0 : acl_msg_info ("poller broadcast ok");
 if (pthread_mutex_unlock(&thr_pool->poller_mutex) != 0)
  abort();
 !acl_do_debug(((0 + 3)), (3)) ? (void) 0 : acl_msg_info ("poller unlock ok");

 return 
# 190 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
       ((void *)0)
# 190 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
           ;
}
...
static thread_cond *thread_cond_create(void)
{
 thread_cond *cond = (thread_cond*)
  acl_calloc_glue("/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 196, 1, sizeof(thread_cond));

 if (pthread_cond_init(&cond->cond, 
# 198 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                       ((void *)0)
# 198 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                           ) != 0)
  abort();
 return cond;
}
...
static void thread_cond_free(thread_cond *cond)
{
 ...
 do { if (cond) { acl_free_glue("/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 206, (cond)); (cond) = 
# 206 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
((void *)0)
# 206 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
; } } while (0);
}

static thread_worker *worker_create(acl_pthread_pool_t *thr_pool)
{
 thread_worker *thr = (thread_worker*) acl_calloc_glue(
                        "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
# 211 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                       ,
                        212
# 211 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                       , 1, sizeof(thread_worker))
                         ;

 thr->id = (unsigned long) pthread_self();
 thr->idle = thr_pool->idle_timeout;
 if (thr->idle > 0 && thr_pool->schedule_wait > 0) {
  thr->wait_sec = thr_pool->schedule_wait / 1000;
  thr->wait_nsec = (thr_pool->schedule_wait * 1000000)
   % 1000000000;
  thr->wait_count = (1000 * thr->idle)
 ...
 if (thr_pool->cond_first != 
# 227 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                            ((void *)0)
# 227 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                ) {
...
static void worker_free(acl_pthread_pool_t *thr_pool, thread_worker *thr)
{
 ...
 do { if (thr) { acl_free_glue("/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 241, (thr)); (thr) = 
# 241 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
((void *)0)
# 241 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
; } } while (0);
}
 ...
 thread_worker *thr, acl_pthread_job_t *job)
{
 ...
 status = pthread_mutex_unlock(thr->mutex);
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s(%d), %s: unlock error: %s, tid: %lu",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 258, myname, acl_last_serror(),
 ...
 if (job->start > 0) {
  ...
  do { struct timeval t; gettimeofday(&t, 
# 265 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
 ((void *)0)
# 265 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
 ); (now) = ((long long int) t.tv_sec) * 1000 + ((long long int) t.tv_usec / 1000); } while (0);
  now -= job->start;
  if (now >= thr_pool->schedule_warn) {
   acl_msg_warn("%s(%d), %s: schedule: %lld >= %lld, qlen=%d",
    "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 269, myname,
    now, thr_pool->schedule_warn, thr_pool->qlen);
  }
 }
# 305 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
 if (!job->fixed)
  do { if (job) { acl_free_glue("/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 306, (job)); (job) = 
# 306 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
 ((void *)0)
# 306 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
 ; } } while (0);
 ...
 status = pthread_mutex_lock(thr->mutex);
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s(%d), %s: lock error: %s, sid: %lu",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 317, myname, acl_last_serror(),
   (unsigned long) pthread_self());
 }
}
...
# 332 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                           ((void *)0)
# 332 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                               ) {
  thr_pool->thr_first = thr;
  thr->next = 
# 334 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
             ((void *)0)
# 334 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                 ;
  thr->prev = 
# 335 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
             ((void *)0)
# 335 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                 ;
 } else {
  thr_pool->thr_first->prev = thr;
  thr->next = thr_pool->thr_first;
  thr->prev = 
# 339 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
             ((void *)0)
# 339 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                 ;
  thr_pool->thr_first = thr;
 }
 ...
 while (1) {
  ...
  if (thr->idle > 0) {
   gettimeofday(&tv, 
# 348 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                    ((void *)0)
# 348 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                        );
   timeout.tv_sec = tv.tv_sec + (time_t) thr->wait_sec;
   n = tv.tv_usec * 1000 + thr->wait_nsec;
   if (n >= 1000000000) {
    timeout.tv_sec += 1;
    timeout.tv_nsec = (long) n - 1000000000;
   } else
    timeout.tv_nsec = (long) n;

   status = pthread_cond_timedwait(&thr->cond->cond,
     thr->mutex, &timeout);
  } else
   status = pthread_cond_wait(&thr->cond->cond,
     thr->mutex);
  ...
  if (status == 
# 381 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
               110
# 381 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                            ) {
   idle_count++;
  ...
  acl_msg_warn("%s(%d), %s: tid: %lu, cond timewait error: %s",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 394, myname, (unsigned long)
   pthread_self(), acl_last_serror());
  break;
 }
 ...
 if (thr_pool->thr_first == thr) {
  if (thr->next)
   thr->next->prev = 
# 403 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                    ((void *)0)
# 403 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                        ;
...
static void *worker_thread(void* arg)
{
 ...
 if (thr_pool->worker_init_fn != 
# 429 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                ((void *)0)
# 429 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                    ) {
  if (thr_pool->worker_init_fn(thr_pool->worker_init_arg) < 0) {
   acl_msg_error("%s(%d), %s: thread(%lu) init error",
    "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 432, myname,
    (unsigned long) pthread_self());
   pthread_mutex_lock(&thr_pool->worker_mutex);
   thr_pool->count--;
   pthread_mutex_unlock(&thr_pool->worker_mutex);
   return 
# 437 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
         ((void *)0)
# 437 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
             ;
  }
 }
 ...
 status = pthread_mutex_lock(&thr_pool->worker_mutex);
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s(%d), %s: lock failed: %s", "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c",
   447, myname, acl_last_serror());
 }
 ...
 for (;;) {
  ...
  if (thr->job_first != 
# 456 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                       ((void *)0)
# 456 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                           ) {
   job = thr->job_first;
   thr->job_first = job->next;
   if (thr->job_last == job)
    thr->job_last = 
# 460 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                   ((void *)0)
# 460 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                       ;
   thr->qlen--;
  ...
  else if (thr_pool->job_first != 
# 467 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                 ((void *)0)
# 467 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                     ) {
   job = thr_pool->job_first;
   thr_pool->job_first = job->next;
   if (thr_pool->job_last == job)
    thr_pool->job_last = 
# 471 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                        ((void *)0)
# 471 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                            ;
   thr_pool->qlen--;
  ...
  if (thr->job_first != 
# 477 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                       ((void *)0) 
# 477 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                            || thr_pool->job_first != 
# 477 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                                      ((void *)0)
# 477 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
 ...
 !acl_do_debug(((0 + 3)), (2)) ? (void) 0 : acl_msg_info ("%s(%d): thread(%lu) exit now",
  myname, 492, (unsigned long) pthread_self());

 if (thr_pool->worker_free_fn != 
# 494 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                ((void *)0)
# 494 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                    )
 ...
 if (thr_pool->quit)
  pthread_cond_signal(&thr_pool->cond);

 status = pthread_mutex_unlock(mutex);
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s, %s(%d): unlock error(%s)",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 508, acl_last_serror());
 }

 return 
# 511 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
       ((void *)0)
# 511 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
           ;
}
 ...
 acl_pthread_job_t *job)
{
 ...
 if (thr_pool->thr_first == thr) {
  if (thr->next)
   thr->next->prev = 
# 527 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                    ((void *)0)
# 527 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                        ;
  thr_pool->thr_first = thr->next;
 } else {
  if (thr->next)
 ...
 status = pthread_mutex_unlock(&thr_pool->worker_mutex);
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s(%d), %s: pthread_mutex_unlock: %s",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 541, myname, acl_last_serror());
 }
 ...
 if (status != 0) {
  ...
  acl_msg_error("%s(%d), %s: pthread_cond_signal: %s",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 548, myname, acl_last_serror());
 }
...
static void job_add(acl_pthread_pool_t *thr_pool, acl_pthread_job_t *job)
{
 ...
 job->next = 
# 561 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
            ((void *)0)
# 561 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                ;

 if (thr_pool->schedule_warn > 0)
  do { struct timeval t; gettimeofday(&t, 
# 564 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
 ((void *)0)
# 564 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
 ); (job->start) = ((long long int) t.tv_sec) * 1000 + ((long long int) t.tv_usec / 1000); } while (0);
 else
  job->start = 0;
 ...
 if (status != 0) {
  ...
  acl_msg_fatal("%s(%d), %s: pthread_mutex_lock: %s",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 572, myname, acl_last_serror());
 }
 ...
 if (thr_pool->job_first == 
# 583 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                           ((void *)0)
# 583 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                               )
 ...
 if (thr_pool->count < thr_pool->parallelism) {
  ...
  status = pthread_create(&id, &thr_pool->attr,
  ...
  if (status == 0)
   ...
   acl_msg_error("%s(%d), %s: pthread_create: %s",
    "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 602, myname, acl_last_serror());
  }
  ...
  if (status != 0) {
   (acl_set_error(status));
   acl_msg_fatal("%s(%d), %s: pthread_mutex_unlock: %s",
    "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 609, myname, acl_last_serror());
  }
  return;
 }
 ...
 if (thr_pool->qlen > thr_pool->qlen_warn) {
  time_t now = time(
# 617 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                   ((void *)0)
# 617 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                       );

  if (now - thr_pool->last_warn >= 2) {
   thr_pool->last_warn = now;
   acl_msg_warn("%s(%d), %s: OVERLOADED! max_thread: %d,"
    " qlen: %d, idle: %d", "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 622,
    myname, thr_pool->parallelism, thr_pool->qlen,
    thr_pool->idle);
  }
  if (thr_pool->overload_wait > 0) {
   acl_msg_warn("%s(%d), %s: sleep %d seconds", "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c",
    628, myname, thr_pool->overload_wait);
 ...
 if (status != 0) {
  ...
  acl_msg_error("%s(%d), %s: pthread_mutex_unlock: %s",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 637, myname, acl_last_serror());
 }
}
 ...
 void (*run_fn)(void *), void *run_arg)
{
 ...
 if (thr_pool->valid != 0x0decca62)
  acl_msg_fatal("%s(%d), %s: thr_pool invalid",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 652, myname);
 if (run_fn == 
# 653 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
              ((void *)0)
# 653 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                  )
  acl_msg_fatal("%s(%d), %s: run_fn null",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 655, myname);
# 684 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
 ...
 acl_pthread_job_t *job)
{
 ...
 if (thr_pool->valid != 0x0decca62)
  acl_msg_fatal("%s(%d), %s: thr_pool invalid",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 696, myname);
 if (job == 
# 697 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
           ((void *)0)
# 697 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
               )
  acl_msg_fatal("%s(%d), %s: job null",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 699, myname);
...
void acl_pthread_pool_bat_add_begin(acl_pthread_pool_t *thr_pool)
{
 ...
 if (thr_pool->valid != 0x0decca62)
  acl_msg_fatal("%s(%d), %s: invalid thr_pool->valid",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 711, myname);
 ...
 if (status != 0) {
  ...
  acl_msg_fatal("%s(%d), %s: pthread_mutex_lock, serr = %s",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 719, myname, acl_last_serror());
 }
}
...
static void job_append(acl_pthread_pool_t *thr_pool, acl_pthread_job_t *job)
{
 ...
 job->next = 
# 729 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
            ((void *)0)
# 729 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                ;

 if (thr_pool->thr_iter != 
# 731 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                          ((void *)0)
# 731 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                              ) {
  ...
  for (thr_pool->thr_iter = thr_pool->thr_iter->next;
   thr_pool->thr_iter != 
# 746 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                        ((void *)0)
# 746 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                            ;
   thr_pool->thr_iter = thr_pool->thr_iter->next)
  {
 ...
 if (thr_pool->job_first == 
# 763 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                           ((void *)0)
# 763 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                               )
  thr_pool->job_first = job;
 else
  thr_pool->job_last->next = job;
 ...
 if (thr_pool->count < thr_pool->parallelism) {
  ...
  (acl_set_error(status));
  acl_msg_error("%s(%d), %s: pthread_create: %s",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 784, myname, acl_last_serror());
  return;
 }
 ...
 if (thr_pool->qlen > thr_pool->qlen_warn) {
  time_t now = time(
# 791 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                   ((void *)0)
# 791 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                       );

  if (now - thr_pool->last_warn >= 2) {
   thr_pool->last_warn = now;
   acl_msg_warn("%s(%d), %s: OVERLOADED! max_thread: %d"
    ", qlen: %d, idle: %d", "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 796,
    myname, thr_pool->parallelism, thr_pool->qlen,
    thr_pool->idle);
  }
  if (thr_pool->overload_wait > 0) {
   acl_msg_warn("%s(%d), %s: sleep %d seconds", "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c",
           802, myname, thr_pool->overload_wait);
   sleep(thr_pool->overload_wait);
  }
 }
}
 ...
 void (*run_fn)(void *), void *run_arg)
{
 ...
 if (thr_pool->valid != 0x0decca62 || run_fn == 
# 817 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                                           ((void *)0)
# 817 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                                               )
  acl_msg_fatal("%s(%d), %s: invalid thr_pool or run_fn",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 819, myname);
# 849 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
  job = acl_pthread_pool_alloc_job(run_fn, run_arg, 0);
 ...
 acl_pthread_job_t *job)
{
 ...
 if (thr_pool->valid != 0x0decca62)
  acl_msg_fatal("%s(%d), %s: invalid thr_pool->valid",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 861, myname);
...
void acl_pthread_pool_bat_add_end(acl_pthread_pool_t *thr_pool)
{
 ...
 if (thr_pool->valid != 0x0decca62)
  acl_msg_fatal("%s(%d), %s: invalid thr_pool->valid",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 874, myname);
 ...
 for (; thr_iter != 
# 881 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                   ((void *)0) 
# 881 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                        ; thr_iter = next) {
  ...
  if (thr_iter->qlen > 0) {
   ...
   if (thr_pool->thr_first == thr_iter) {
    if (thr_iter->next)
     thr_iter->prev = 
# 889 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                     ((void *)0)
# 889 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                         ;
   ...
   status = pthread_cond_signal(&thr_iter->cond->cond);
   if (status == 0)
    continue;

   (acl_set_error(status));
   acl_msg_fatal("%s(%d), %s: pthread_cond_signal: %s",
    "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 903, myname, acl_last_serror());
  }
   ...
   (acl_set_error(status));
   acl_msg_fatal("%s(%d), %s: pthread_cond_signal: %s",
    "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 918, myname, acl_last_serror());
  } else
   next = thr_iter->next;
 }
 ...
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s(%d), %s: pthread_mutex_unlock: %s",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 927, myname, acl_last_serror());
 }

 thr_pool->thr_iter = 
# 930 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                     ((void *)0)
# 930 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                         ;
}
...
static void thread_pool_init(acl_pthread_pool_t *thr_pool)
{
 ...
 thr_pool->poller_running = 0;
 thr_pool->job_first = 
# 938 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                              ((void *)0)
# 938 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                  ;
 thr_pool->job_last = 
# 939 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                              ((void *)0)
# 939 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                  ;
 thr_pool->job_slot_first = 
# 940 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                              ((void *)0)
# 940 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                  ;
 thr_pool->job_slot_last = 
# 941 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                              ((void *)0)
# 941 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                  ;
 thr_pool->job_nslot = 0;
 thr_pool->thr_first = 
# 943 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                              ((void *)0)
# 943 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                  ;
 thr_pool->thr_iter = 
# 944 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                              ((void *)0)
# 944 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                  ;
 thr_pool->qlen = 0;
 ...
 thr_pool->cond_first = 
# 951 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                              ((void *)0)
# 951 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                  ;
}
...
acl_pthread_pool_t *acl_pthread_pool_create(const acl_pthread_pool_attr_t *attr)
{
 ...
 thr_pool = acl_calloc_glue("/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 989, 1, sizeof(*thr_pool));
 status = pthread_attr_init(&thr_pool->attr);
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s(%d), %s: pthread_attr_init: %s",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 994, myname, acl_last_serror());
 }

 if (attr && attr->stack_size > 0)
  pthread_attr_setstacksize(&thr_pool->attr,
   attr->stack_size);

 status = pthread_attr_setdetachstate(&thr_pool->attr,
   
# 1002 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
  PTHREAD_CREATE_DETACHED
# 1002 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                             );
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s(%d), %s: pthread_attr_setdetachstate: %s",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1006, myname, acl_last_serror());
 }


 status = pthread_attr_setscope(&thr_pool->attr, 
# 1010 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                                PTHREAD_SCOPE_SYSTEM
# 1010 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                                                    );
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s(%d), %s: pthread_attr_setscope: %s",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1014, myname, acl_last_serror());
 }


 status = pthread_mutex_init(&thr_pool->worker_mutex, 
# 1018 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                                         ((void *)0)
# 1018 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                                             );
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s(%d), %s: pthread_mutex_init: %s",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1022, myname, acl_last_serror());
 }

 status = pthread_cond_init(&thr_pool->cond, 
# 1025 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                                ((void *)0)
# 1025 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                                    );
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s(%d), %s: pthread_cond_init: %s",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1029, myname, acl_last_serror());
 }
# 1041 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
 status = pthread_mutex_init(&thr_pool->poller_mutex, 
# 1041 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                                         ((void *)0)
# 1041 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                                             );
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s(%d), %s: pthread_mutex_init: %s",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1045, myname, acl_last_serror());
 }
 status = pthread_cond_init(&thr_pool->poller_cond, 
# 1047 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                                       ((void *)0)
# 1047 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                                           );
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_fatal("%s(%d), %s: pthread_cond_init: %s",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1051, myname, acl_last_serror());
 }

 thread_pool_init(thr_pool);

 thr_pool->parallelism = (attr && attr->threads_limit > 0) ?
  attr->threads_limit : 100;
 thr_pool->qlen_warn = thr_pool->parallelism * 10;
 thr_pool->idle_timeout = (attr && attr->idle_timeout > 0) ?
  attr->idle_timeout : 0;
 thr_pool->poller_fn = 
# 1061 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                      ((void *)0)
# 1061 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                          ;
 thr_pool->poller_arg = 
# 1062 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                       ((void *)0)
# 1062 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                           ;

 thr_pool->worker_init_fn = 
# 1064 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                           ((void *)0)
# 1064 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                               ;
 thr_pool->worker_init_arg = 
# 1065 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                            ((void *)0)
# 1065 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                ;
 thr_pool->worker_free_fn = 
# 1066 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                           ((void *)0)
# 1066 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                               ;
 thr_pool->worker_free_arg = 
# 1067 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                            ((void *)0)
# 1067 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                ;

 thr_pool->valid = 0x0decca62;
...
int acl_pthread_pool_set_timewait(acl_pthread_pool_t *thr_pool, int timewait)
{
 ...
 if (thr_pool == 
# 1083 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                ((void *)0) 
# 1083 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                     || thr_pool->valid != 0x0decca62
  || timewait < 0)
 {
  acl_msg_error("%s(%d), %s: invalid input",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1087, myname);
  return -1;
 }
 ...
 int (*init_fn)(void *), void *init_arg)
{
 ...
 if (thr_pool == 
# 1100 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                ((void *)0) 
# 1100 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                     || thr_pool->valid != 0x0decca62) {
  acl_msg_error("%s(%d), %s: input invalid",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1102, myname);
  return 
# 1103 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
        22
# 1103 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                  ;
 }
 ...
 void (*free_fn)(void *), void *free_arg)
{
 ...
 if (thr_pool == 
# 1117 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                ((void *)0) 
# 1117 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                     || thr_pool->valid != 0x0decca62) {
  acl_msg_error("%s(%d), %s: input invalid",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1119, myname);
  return 
# 1120 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
        22
# 1120 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                  ;
 }
...
static int wait_poller_exit(acl_pthread_pool_t *thr_pool)
{
 ...
 !acl_do_debug(((0 + 3)), (3)) ? (void) 0 : acl_msg_info ("%s: begin to lock", myname);

 thr_pool->poller_quit = 1;

 status = pthread_mutex_lock(&thr_pool->poller_mutex);
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_error("%s, %s(%d): pthread_mutex_lock: %s",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1144, acl_last_serror());
  return status;
 }

 !acl_do_debug(((0 + 3)), (3)) ? (void) 0 : acl_msg_info ("%s: begin to wait cond", myname);

 while (thr_pool->poller_running != 0) {
  gettimeofday(&tv, 
# 1151 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                   ((void *)0)
# 1151 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                       );
  ...
  status = pthread_cond_timedwait(&thr_pool->poller_cond,
    &thr_pool->poller_mutex, &timeout);
  if (status == 
# 1159 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
               110
# 1159 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                            ) {
   !acl_do_debug(((0 + 3)), (3)) ? (void) 0 : acl_msg_info
    ("%s: nwait=%d", myname, nwait);
  } else if (status != 0) {
   (acl_set_error(status));
   pthread_mutex_unlock(&thr_pool->poller_mutex);
   acl_msg_error("%s, %s(%d): pthread_cond_wait: %s",
    "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1166, acl_last_serror());
   return status;
  }
 }

 !acl_do_debug(((0 + 3)), (3)) ? (void) 0 : acl_msg_info ("%s: begin to unlock", myname);

 status = pthread_mutex_unlock(&thr_pool->poller_mutex);
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_error("%s, %s(%d): pthread_mutex_unlock error(%s)",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1177, acl_last_serror());
 }
...
static int wait_worker_exit(acl_pthread_pool_t *thr_pool)
{
 ...
 if (status != 0) {
  ...
  acl_msg_error("%s(%d), %s: pthread_mutex_lock: %s",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1192, myname, acl_last_serror());
  return status;
 }
 ...
 if (thr_pool->count < 0) {
  acl_msg_error("%s(%d), %s: count: %d",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1200, myname, thr_pool->count);
  (void) pthread_mutex_unlock(&thr_pool->worker_mutex);
  return -1;
 } else if (thr_pool->count == 0) {
  !acl_do_debug(((0 + 3)), (2)) ? (void) 0 : acl_msg_info ("%s: count: 0", myname);
  (void) pthread_mutex_unlock(&thr_pool->worker_mutex);
  return 0;
 }
 ...
 if (thr_pool->thr_first != 
# 1215 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                           ((void *)0)
# 1215 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                               ) {
  thread_worker *thr;

  !acl_do_debug(((0 + 3)), (2)) ? (void) 0 : acl_msg_info ("%s: idle: %d, notifying",
   myname, thr_pool->idle);

  for (thr = thr_pool->thr_first; thr != 
# 1221 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                        ((void *)0)
# 1221 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                            ; thr = thr->next)
 ...
 while (thr_pool->count > 0) {
  ...
  !acl_do_debug(((0 + 3)), (2)) ? (void) 0 : acl_msg_info
  ...
  status = pthread_cond_wait(&thr_pool->cond,
    &thr_pool->worker_mutex);
  if (status == 
# 1237 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
               110
# 1237 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                            ) {
   !acl_do_debug(((0 + 3)), (2)) ? (void) 0 : acl_msg_info
   ...
   acl_msg_error("%s(%d), %s: pthread_cond_timedwait"
    " err: %s", "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1244, myname,
    acl_last_serror());
   return status;
  }
 }
 ...
 if (status != 0) {
  ...
  acl_msg_error("%s(%d), %s: pthread_mutex_unlock err: %s",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1254, myname, acl_last_serror());
 }
...
int acl_pthread_pool_destroy(acl_pthread_pool_t *thr_pool)
{
 ...
 if (thr_pool == 
# 1269 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                ((void *)0) 
# 1269 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                     || thr_pool->valid != 0x0decca62) {
  acl_msg_error("%s(%d), %s: input invalid",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1271, myname);
  return 
# 1272 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
        22
# 1272 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                  ;
 }
 ...
 if (status != 0) {
  ...
  acl_msg_error("%s, %s(%d): wait_poller_exit: %s, ret: %d",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1281, acl_last_serror(), status);
  return status;
 }

 !acl_do_debug(((0 + 3)), (2)) ? (void) 0 : acl_msg_info
  ("%s(%d): poller thread exits ok, worker count: %d",
   myname, 1287, thr_pool->count);

 status = wait_worker_exit(thr_pool);
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_error("%s, %s(%d): wait_worker_exit: %s, ret: %d",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1293, acl_last_serror(), status);
  return status;
 }

 for (job = thr_pool->job_slot_first; job != 
# 1297 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                            ((void *)0)
# 1297 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                                ;) {
 ...
 !acl_do_debug(((0 + 3)), (2)) ? (void) 0 : acl_msg_info
  ("%s(%d): worker threads exit ok, conter: %d",
   myname, 1306, thr_pool->count);

 sleep(1);
 s1 = pthread_mutex_destroy(&thr_pool->poller_mutex);
 s2 = pthread_cond_destroy(&thr_pool->poller_cond);

 for (; thr_pool->cond_first != 
# 1312 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                               ((void *)0)
# 1312 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                   ;) {
 ...
 do { if (thr_pool) { acl_free_glue("/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1326, (thr_pool)); (thr_pool) = 
# 1326 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
((void *)0)
# 1326 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
; } } while (0);
...
int acl_pthread_pool_stop(acl_pthread_pool_t *thr_pool)
{
 ...
 if (thr_pool == 
# 1342 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                ((void *)0) 
# 1342 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                     || thr_pool->valid != 0x0decca62) {
  acl_msg_error("%s(%d), %s: input invalid",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1344, myname);
  return 
# 1345 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
        22
# 1345 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                  ;
 }
 ...
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_error("%s, %s(%d): wait_poller_exit: %s, ret: %d",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1354, acl_last_serror(), status);
  return status;
 }

 !acl_do_debug(((0 + 3)), (2)) ? (void) 0 : acl_msg_info
  ("%s(%d): poller thread exits ok, worker count: %d",
   myname, 1360, thr_pool->count);

 status = wait_worker_exit(thr_pool);
 if (status != 0) {
  (acl_set_error(status));
  acl_msg_error("%s, %s(%d): wait_worker_exit: %s, ret: %d",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1366, acl_last_serror(), status);
  return status;
 }
 ...
 int (*poller_fn)(void *), void *poller_arg)
{
 ...
 if (thr_pool->valid != 0x0decca62 || poller_fn == 
# 1385 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                                              ((void *)0)
# 1385 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                                                                  ) {
  acl_msg_error("%s(%d), %s: input invalid",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1387, myname);
  return;
 }
...
int acl_pthread_pool_start_poller(acl_pthread_pool_t *thr_pool)
{
 ...
 if (thr_pool->valid != 0x0decca62) {
  acl_msg_error("%s(%d), %s: input invalid",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1403, myname);
  return -1;
 }

 if (thr_pool->poller_fn == 
# 1407 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                           ((void *)0)
# 1407 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                               ) {
  acl_msg_warn("%s, %s(%d): poller_fn null, needn't call %s",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1409, myname);
  return -1;
 }
 ...
 if (status != 0) {
  ...
  acl_msg_error("%s, %s(%d): lock poller_mutex error(%s)",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1417, acl_last_serror());
  return -1;
 }

 if (thr_pool->poller_running) {
  acl_msg_error("%s, %s(%d): server is running",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1423);
  return -1;
 }
 ...
 if (status != 0) {
  ...
  acl_msg_error("%s, %s(%d): unlock poller_mutex error(%s)",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", myname, 1431, acl_last_serror());
  return -1;
 }
 ...
 if (status != 0) {
  ...
  acl_msg_error("%s(%d), %s: pthread_create poller: %s",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1442, myname, acl_last_serror());
  return status;
 }
 ...
 void (*run_fn)(void *), void *run_arg)
{
 ...
 if (dispatch_arg == 
# 1455 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                    ((void *)0) 
# 1455 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                         || run_fn == 
# 1455 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                      ((void *)0)
# 1455 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
  ...
  acl_msg_fatal("%s(%d), %s: invalid input",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1457, myname);
 ...
 void (*run_fn)(void *), void *run_arg)
{
 ...
 if (dispatch_arg == 
# 1471 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                    ((void *)0) 
# 1471 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                         || run_fn == 
# 1471 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                                      ((void *)0)
# 1471 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
  ...
  acl_msg_fatal("%s(%d), %s: invalid input",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1473, myname);
...
int acl_pthread_pool_size(acl_pthread_pool_t *thr_pool)
{
 ...
 if (status) {
  acl_msg_error("%s(%d), %s: pthread_mutex_lock error(%s)",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1494, myname, strerror(status));
  return -1;
 }
 ...
 if (status) {
  acl_msg_error("%s(%d), %s: pthread_mutex_unlock error(%s)",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1502, myname, strerror(status));
  return -1;
 }
...
int acl_pthread_pool_idle(acl_pthread_pool_t *thr_pool)
{
 ...
 if (status) {
  acl_msg_error("%s(%d), %s: pthread_mutex_lock error(%s)",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1517, myname, strerror(status));
  return -1;
 }
 ...
 if (status) {
  acl_msg_error("%s(%d), %s: pthread_mutex_unlock error(%s)",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1526, myname, strerror(status));
  return -1;
 }
...
int acl_pthread_pool_busy(acl_pthread_pool_t *thr_pool)
{
 ...
 if (status) {
  acl_msg_error("%s(%d), %s: pthread_mutex_lock error(%s)",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1541, myname, strerror(status));
  return -1;
 }
 ...
 if (status) {
  acl_msg_error("%s(%d), %s: pthread_mutex_unlock error(%s)",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1550, myname, strerror(status));
  return -1;
 }

 if (n < 0)
  acl_msg_error("%s(%d), %s: threads's count(%d) < idle(%d)",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1556, myname, thr_pool->count,
   thr_pool->idle);
 return n;
}
...
int acl_pthread_pool_qlen(acl_pthread_pool_t *thr_pool)
{
 ...
 if (status) {
  acl_msg_error("%s(%d), %s: pthread_mutex_lock error(%s)",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1569, myname, strerror(status));
  return -1;
 }
 ...
 if (status) {
  acl_msg_error("%s(%d), %s: pthread_mutex_unlock error(%s)",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1578, myname, strerror(status));
  return -1;
 }

 if (n < 0)
  acl_msg_error("%s(%d), %s: threads's count(%d) < idle(%d)",
   "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1584, myname, thr_pool->count,
   thr_pool->idle);
 return n;
}
 ...
 void *run_arg, int fixed)
{
 acl_pthread_job_t *job = (acl_pthread_job_t*)
  acl_malloc_glue("/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1626, sizeof(acl_pthread_job_t));

 job->worker_fn = run_fn;
 job->worker_arg = run_arg;
 job->next = 
# 1630 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
                  ((void *)0)
# 1630 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
                      ;
 job->fixed = fixed;
 return job;
}
...
void acl_pthread_pool_free_job(acl_pthread_job_t *job)
{
 do { if (job) { acl_free_glue("/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c", 1637, (job)); (job) = 
# 1637 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c" 3 4
((void *)0)
# 1637 "/workspace/acl/lib_acl/src/thread/acl_pthread_pool.c"
; } } while (0);
}
