# 0 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
...
# 2 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 2
# 122 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
...
static void free_header(void *arg)
{
 ...
 if (header_ptr == 
# 139 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                  ((void *)0)
# 139 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                      )
  return;

 for ((iter).ptr = (((header_ptr))->succ); (iter).ptr != (header_ptr); (iter).ptr = (((iter).ptr)->succ)) {
  tmp = ((acl_pthread_nested_mutex_t *) (((char *) (iter.ptr)) - 
# 143 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
       __builtin_offsetof (
# 143 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
...
# 143 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                                    ...
                                    ;
  if (tmp->mutex != 
# 145 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                   ((void *)0) 
# 145 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                        && tmp->nrefer > 0)
...
# 155 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                                                     0
# 155 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                                                                          ;
...
# 160 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                                                 ((void *)0)
# 160 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                                                     ;
 ACL_RING *header_ptr;

 if (mutex == 
# 163 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
             ((void *)0)
# 163 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                 )
  return -1;
 ...
 if (header_ptr == 
# 171 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                  ((void *)0)
# 171 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                      ) {
  header_ptr = (ACL_RING*) acl_malloc_glue("/acl/lib_acl/src/thread/acl_pthread_mutex.c", 172, sizeof(ACL_RING));
 ...
 for ((iter).ptr = (((header_ptr))->succ); (iter).ptr != (header_ptr); (iter).ptr = (((iter).ptr)->succ)) {
  tmp = ((acl_pthread_nested_mutex_t *) (((char *) (iter.ptr)) - 
# 178 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
       __builtin_offsetof (
# 178 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
       acl_pthread_nested_mutex_t
# 178 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
       , 
# 178 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
...
# 178 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
 ...
 if (nested_mutex == 
# 186 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                    ((void *)0)
# 186 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                        ) {
  nested_mutex = (acl_pthread_nested_mutex_t*)
   acl_malloc_glue("/acl/lib_acl/src/thread/acl_pthread_mutex.c", 188, sizeof(acl_pthread_nested_mutex_t));
...
int acl_thread_mutex_unlock(acl_pthread_mutex_t *mutex)
{
 ACL_RING_ITER iter;
 acl_pthread_nested_mutex_t *tmp, *nested_mutex = 
# 201 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                                                 ((void *)0)
# 201 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                                                     ;
 ACL_RING *header_ptr = pthread_getspecific(__header_key);

 if (mutex == 
# 204 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
             ((void *)0) 
# 204 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                  || header_ptr == 
# 204 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                                   ((void *)0)
# 204 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
 ...
 for ((iter).ptr = (((header_ptr))->succ); (iter).ptr != (header_ptr); (iter).ptr = (((iter).ptr)->succ)) {
  tmp = ((acl_pthread_nested_mutex_t *) (((char *) (iter.ptr)) - 
# 208 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
       __builtin_offsetof (
# 208 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
       acl_pthread_nested_mutex_t
# 208 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
       , 
# 208 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
...
# 208 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
 ...
 if (nested_mutex == 
# 216 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                    ((void *)0)
# 216 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                        )
  return -1;
...
# 219 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
 ((void *)0) 
# 219 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
 && pred != 
# 219 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
 ((void *)0)
# 219 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
...
# 219 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
 ; } } while (0);
  do { if (nested_mutex) { acl_free_glue("/acl/lib_acl/src/thread/acl_pthread_mutex.c", 220, (nested_mutex)); (nested_mutex) = 
# 220 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
 ((void *)0)
# 220 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
 ; } } while (0);
...
int acl_thread_mutex_nested(acl_pthread_mutex_t *mutex)
{
 ACL_RING_ITER iter;
 acl_pthread_nested_mutex_t *tmp, *nested_mutex = 
# 230 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                                                 ((void *)0)
# 230 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                                                     ;
 ACL_RING *header_ptr = pthread_getspecific(__header_key);

 if (mutex == 
# 233 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
             ((void *)0) 
# 233 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                  || header_ptr == 
# 233 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                                   ((void *)0)
# 233 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
 ...
 for ((iter).ptr = (((header_ptr))->succ); (iter).ptr != (header_ptr); (iter).ptr = (((iter).ptr)->succ)) {
  tmp = ((acl_pthread_nested_mutex_t *) (((char *) (iter.ptr)) - 
# 237 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
       __builtin_offsetof (
# 237 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
       acl_pthread_nested_mutex_t
# 237 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
       , 
# 237 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
...
# 237 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
 ...
 if (nested_mutex == 
# 245 "/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                    ((void *)0)
# 245 "/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                        )
  return 0;
