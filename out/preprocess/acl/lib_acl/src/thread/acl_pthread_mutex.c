# 1 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 2
# 122 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
...
static void free_header(void *arg)
{
 ...
 if (header_ptr == 
# 139 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                  ((void *)0)
# 139 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                      )
  return;

 for ((iter).ptr = (((header_ptr))->succ); (iter).ptr != (header_ptr); (iter).ptr = (((iter).ptr)->succ)) {
  tmp = ((acl_pthread_nested_mutex_t *) (((char *) (iter.ptr)) - 
# 143 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
       __builtin_offsetof (
# 143 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
       acl_pthread_nested_mutex_t
# 143 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
       , 
# 143 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
       ring
...
# 143 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                                    ...
                                    ;
  if (tmp->mutex != 
# 145 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                   ((void *)0) 
# 145 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                        && tmp->nrefer > 0)
...
{
 pthread_key_create(&__header_key, free_header);
}

static acl_pthread_once_t thread_mutex_once_control = 
# 155 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                                                     0
# 155 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                                                                          ;

int acl_thread_mutex_lock(acl_pthread_mutex_t *mutex)
{
 ACL_RING_ITER iter;
 acl_pthread_nested_mutex_t *tmp, *nested_mutex = 
# 160 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                                                 ((void *)0)
# 160 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                                                     ;
 ACL_RING *header_ptr;

 if (mutex == 
# 163 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
             ((void *)0)
# 163 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                 )
  return -1;

 pthread_once(&thread_mutex_once_control,
  acl_thread_mutex_init_once);

 header_ptr = pthread_getspecific(__header_key);

 if (header_ptr == 
# 171 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                  ((void *)0)
# 171 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                      ) {
  header_ptr = (ACL_RING*) acl_malloc_glue("/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c", 172, sizeof(ACL_RING));
  acl_ring_init(header_ptr);
  pthread_setspecific(__header_key, header_ptr);
 }

 for ((iter).ptr = (((header_ptr))->succ); (iter).ptr != (header_ptr); (iter).ptr = (((iter).ptr)->succ)) {
  tmp = ((acl_pthread_nested_mutex_t *) (((char *) (iter.ptr)) - 
# 178 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
       __builtin_offsetof (
# 178 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
       acl_pthread_nested_mutex_t
# 178 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
       , 
# 178 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
...
# 178 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
 ...
 if (nested_mutex == 
# 186 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                    ((void *)0)
# 186 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                        ) {
  nested_mutex = (acl_pthread_nested_mutex_t*)
   acl_malloc_glue("/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c", 188, sizeof(acl_pthread_nested_mutex_t));
  pthread_mutex_lock(mutex);
  nested_mutex->mutex = mutex;
  nested_mutex->nrefer = 1;
  do { ACL_RING *ring_ptr = (header_ptr), *entry_ptr = (&nested_mutex->ring); entry_ptr->succ = ring_ptr->succ; entry_ptr->pred = ring_ptr; entry_ptr->parent = ring_ptr->parent; ring_ptr->succ->pred = entry_ptr; ring_ptr->succ = entry_ptr; ring_ptr->parent->len++; } while (0);
 } else
  nested_mutex->nrefer++;
 return 0;
}
...
int acl_thread_mutex_unlock(acl_pthread_mutex_t *mutex)
{
 ACL_RING_ITER iter;
 acl_pthread_nested_mutex_t *tmp, *nested_mutex = 
# 201 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                                                 ((void *)0)
# 201 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                                                     ;
 ACL_RING *header_ptr = pthread_getspecific(__header_key);

 if (mutex == 
# 204 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
             ((void *)0) 
# 204 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                  || header_ptr == 
# 204 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                                   ((void *)0)
# 204 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
 ...
 for ((iter).ptr = (((header_ptr))->succ); (iter).ptr != (header_ptr); (iter).ptr = (((iter).ptr)->succ)) {
  tmp = ((acl_pthread_nested_mutex_t *) (((char *) (iter.ptr)) - 
# 208 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
       __builtin_offsetof (
# 208 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
       acl_pthread_nested_mutex_t
# 208 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
       , 
# 208 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
...
# 208 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
 ...
 if (nested_mutex == 
# 216 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                    ((void *)0)
# 216 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                        )
  return -1;
 if (--nested_mutex->nrefer == 0) {
  do { ACL_RING *succ, *pred, *entry_ptr = (&nested_mutex->ring); succ = entry_ptr->succ; pred = entry_ptr->pred; if (succ != 
# 219 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
 ((void *)0) 
# 219 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
 && pred != 
# 219 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
 ((void *)0)
# 219 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
 ) { pred->succ = succ; succ->pred = pred; entry_ptr->parent->len--; entry_ptr->succ = entry_ptr->pred = 
# 219 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
 ((void *)0)
# 219 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
 ; } } while (0);
  do { if (nested_mutex) { acl_free_glue("/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c", 220, (nested_mutex)); (nested_mutex) = 
# 220 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
 ((void *)0)
# 220 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
 ; } } while (0);
...
int acl_thread_mutex_nested(acl_pthread_mutex_t *mutex)
{
 ACL_RING_ITER iter;
 acl_pthread_nested_mutex_t *tmp, *nested_mutex = 
# 230 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                                                 ((void *)0)
# 230 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                                                     ;
 ACL_RING *header_ptr = pthread_getspecific(__header_key);

 if (mutex == 
# 233 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
             ((void *)0) 
# 233 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                  || header_ptr == 
# 233 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                                   ((void *)0)
# 233 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
 ...
 for ((iter).ptr = (((header_ptr))->succ); (iter).ptr != (header_ptr); (iter).ptr = (((iter).ptr)->succ)) {
  tmp = ((acl_pthread_nested_mutex_t *) (((char *) (iter.ptr)) - 
# 237 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
       __builtin_offsetof (
# 237 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
       acl_pthread_nested_mutex_t
# 237 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
       , 
# 237 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
...
# 237 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
 ...
 if (nested_mutex == 
# 245 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c" 3 4
                    ((void *)0)
# 245 "/workspace/acl/lib_acl/src/thread/acl_pthread_mutex.c"
                        )
  return 0;
