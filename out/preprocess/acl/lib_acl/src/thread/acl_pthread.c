# 0 "/acl/lib_acl/src/thread/acl_pthread.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/thread/acl_pthread.c"
...
# 2 "/acl/lib_acl/src/thread/acl_pthread.c" 2
# 20 "/acl/lib_acl/src/thread/acl_pthread.c"
# 1 "/acl/lib_acl/src/thread/../private/private_fifo.h" 1



# 1 "/acl/lib_acl/include/stdlib/acl_fifo.h" 1
# 5 "/acl/lib_acl/src/thread/../private/private_fifo.h" 2
# 1 "/acl/lib_acl/include/stdlib/acl_malloc.h" 1
# 6 "/acl/lib_acl/src/thread/../private/private_fifo.h" 2
...
# 21 "/acl/lib_acl/src/thread/acl_pthread.c" 2
# 523 "/acl/lib_acl/src/thread/acl_pthread.c"
...
# 529 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                                                         0
# 529 "/acl/lib_acl/src/thread/acl_pthread.c"
                                                                              ;
...
static void pthread_atexit_done(void *arg)
{
 ...
 while (1) {
  ...
  if (id_ptr == 
# 538 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               ((void *)0)
# 538 "/acl/lib_acl/src/thread/acl_pthread.c"
                   )
   break;
  if (id_ptr->free_fn)
   id_ptr->free_fn(id_ptr->arg);
  acl_default_free("/acl/lib_acl/src/thread/acl_pthread.c", 542, id_ptr);
 }
 private_fifo_free(id_list, 
# 544 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                           ((void *)0)
# 544 "/acl/lib_acl/src/thread/acl_pthread.c"
                               );
}
...
int acl_pthread_atexit_add(void *arg, void (*free_fn)(void *))
{
 ...
 if (arg == 
# 558 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
           ((void *)0)
# 558 "/acl/lib_acl/src/thread/acl_pthread.c"
               ) {
  acl_set_error(
# 559 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               22
# 559 "/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return 
# 560 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        22
# 560 "/acl/lib_acl/src/thread/acl_pthread.c"
                  ;
 }
 ...
 id = (pthread_atexit_t*) acl_default_malloc("/acl/lib_acl/src/thread/acl_pthread.c",
  570, sizeof(pthread_atexit_t));
 if (id == 
# 571 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
          ((void *)0)
# 571 "/acl/lib_acl/src/thread/acl_pthread.c"
              ) {
  acl_msg_error("%s(%d): malloc error(%s)",
   myname, 573, acl_last_serror());
  acl_set_error(
# 574 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               12
# 574 "/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return 
# 575 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        12
# 575 "/acl/lib_acl/src/thread/acl_pthread.c"
                  ;
 }
 id->free_fn = free_fn;
 id->arg = arg;
 ...
 if (id_list == 
# 581 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               ((void *)0)
# 581 "/acl/lib_acl/src/thread/acl_pthread.c"
                   ) {
...
int acl_pthread_atexit_remove(void *arg, void (*free_fn)(void*))
{
 ...
 if (arg == 
# 600 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
           ((void *)0)
# 600 "/acl/lib_acl/src/thread/acl_pthread.c"
               ) {
  acl_set_error(
# 601 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               22
# 601 "/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return -1;
 }
 if (__pthread_atexit_key == (acl_pthread_key_t) 0xffffffff) {
  ...
  acl_set_error(
# 607 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               22
# 607 "/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return -1;
 }
 id_list = (ACL_FIFO*) pthread_getspecific(__pthread_atexit_key);
 if (id_list == 
# 611 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               ((void *)0)
# 611 "/acl/lib_acl/src/thread/acl_pthread.c"
                   ) {
 ...
 for ((id_list)->iter_head(&(iter), (id_list)); (iter).ptr; (id_list)->iter_next(&(iter), (id_list))) {
  ...
  if (id_ptr->free_fn == free_fn && id_ptr->arg == arg) {
   ...
   acl_default_free("/acl/lib_acl/src/thread/acl_pthread.c", 625, id_ptr);
   break;
  }
 }
 return 0;
...
# 641 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                                                  0
# 641 "/acl/lib_acl/src/thread/acl_pthread.c"
                                                                       ;
static acl_pthread_key_t __tls_ctx_key = (acl_pthread_key_t) 0xffffffff;
static TLS_CTX *__main_tls_ctx = 
# 643 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                                ((void *)0)
# 643 "/acl/lib_acl/src/thread/acl_pthread.c"
                                    ;
...
int acl_pthread_tls_set_max(int max)
{
 if (max <= 0) {
  acl_set_error(
# 648 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               22
# 648 "/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return 
# 649 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        22
# 649 "/acl/lib_acl/src/thread/acl_pthread.c"
                  ;
 } else {
  acl_tls_ctx_max = max;
  return 0;
...
static void tls_ctx_free(void *ctx)
{
 ...
 for (i = 0; i < acl_tls_ctx_max; i++) {
  if (tls_ctxes[i].ptr != 
# 669 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                         ((void *)0) 
# 669 "/acl/lib_acl/src/thread/acl_pthread.c"
                              && tls_ctxes[i].free_fn != 
# 669 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                                                         ((void *)0)
# 669 "/acl/lib_acl/src/thread/acl_pthread.c"
 ...
 acl_default_free("/acl/lib_acl/src/thread/acl_pthread.c", 673, tls_ctxes);
}
...
void *acl_pthread_tls_get(acl_pthread_key_t *key_ptr)
{
 ...
 if (__tls_ctx_key == (acl_pthread_key_t) 0xffffffff) {
  ...
  return 
# 713 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        ((void *)0)
# 713 "/acl/lib_acl/src/thread/acl_pthread.c"
            ;
 }
 tls_ctxes = (TLS_CTX*) pthread_getspecific(__tls_ctx_key);
 if (tls_ctxes == 
# 716 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                 ((void *)0)
# 716 "/acl/lib_acl/src/thread/acl_pthread.c"
                     ) {

  tls_ctxes = (TLS_CTX*) acl_default_malloc("/acl/lib_acl/src/thread/acl_pthread.c", 718,
    acl_tls_ctx_max * sizeof(TLS_CTX));
  if (pthread_setspecific(__tls_ctx_key, tls_ctxes) != 0) {
   acl_default_free("/acl/lib_acl/src/thread/acl_pthread.c", 721, tls_ctxes);
   acl_msg_error("%s(%d): pthread_setspecific: %s, tid(%lu)",
    myname, 723, acl_last_serror(),
    (unsigned long) pthread_self());
   return 
# 725 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
         ((void *)0)
# 725 "/acl/lib_acl/src/thread/acl_pthread.c"
             ;
  }
  ...
  for (i = 0; i < acl_tls_ctx_max; i++) {
   ...
   tls_ctxes[i].ptr = 
# 730 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                     ((void *)0)
# 730 "/acl/lib_acl/src/thread/acl_pthread.c"
                         ;
   tls_ctxes[i].free_fn = 
# 731 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                         ((void *)0)
# 731 "/acl/lib_acl/src/thread/acl_pthread.c"
                             ;
  }
 ...
 if ((long) (*key_ptr) > 0 && (long) (*key_ptr) < acl_tls_ctx_max) {
  ...
  return 
# 754 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        ((void *)0)
# 754 "/acl/lib_acl/src/thread/acl_pthread.c"
            ;
 }
  ...
  *key_ptr = (acl_pthread_key_t) 0xffffffff;
  acl_set_error(
# 767 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               12
# 767 "/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return 
# 768 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        ((void *)0)
# 768 "/acl/lib_acl/src/thread/acl_pthread.c"
            ;
 }
 ...
 tls_ctxes[i].free_fn = 
# 773 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                       ((void *)0)
# 773 "/acl/lib_acl/src/thread/acl_pthread.c"
                           ;
 tls_ctxes[i].ptr = 
# 774 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                   ((void *)0)
# 774 "/acl/lib_acl/src/thread/acl_pthread.c"
                       ;
 *key_ptr = (acl_pthread_key_t) i;
 return 
# 776 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
       ((void *)0)
# 776 "/acl/lib_acl/src/thread/acl_pthread.c"
           ;
}
 ...
 void (*free_fn)(void *))
{
 ...
 if ((long) key >= acl_tls_ctx_max) {
  acl_msg_error("%s(%d): key(%ld) invalid",
   myname, 787, (long) key);
  acl_set_error(
# 788 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               22
# 788 "/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return 
# 789 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        22
# 789 "/acl/lib_acl/src/thread/acl_pthread.c"
                  ;
 }
 ...
 if (__tls_ctx_key == (acl_pthread_key_t) 0xffffffff) {
  ...
  acl_set_error(
# 795 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               12
# 795 "/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return 
# 796 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        12
# 796 "/acl/lib_acl/src/thread/acl_pthread.c"
                  ;
 }
 tls_ctxes = (TLS_CTX*) pthread_getspecific(__tls_ctx_key);
 if (tls_ctxes == 
# 799 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                 ((void *)0)
# 799 "/acl/lib_acl/src/thread/acl_pthread.c"
                     ) {
 ...
 if (tls_ctxes[(long) key].key != key) {
  acl_msg_error("%s(%d): key(%ld) invalid",
   myname, 806, (long) key);
  acl_set_error(
# 807 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               22
# 807 "/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return 
# 808 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        22
# 808 "/acl/lib_acl/src/thread/acl_pthread.c"
                  ;
 }

 if (tls_ctxes[(long) key].ptr != 
# 811 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                                 ((void *)0) 
# 811 "/acl/lib_acl/src/thread/acl_pthread.c"
...
int acl_pthread_tls_del(acl_pthread_key_t key)
{
 ...
 if ((long) key >= acl_tls_ctx_max) {
  acl_msg_error("%s(%d): key(%ld) invalid",
   myname, 826, (long) key);
  acl_set_error(
# 827 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               22
# 827 "/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return 
# 828 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        22
# 828 "/acl/lib_acl/src/thread/acl_pthread.c"
                  ;
 }
 ...
 if (__tls_ctx_key == (acl_pthread_key_t) 0xffffffff) {
  ...
  acl_set_error(
# 834 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               12
# 834 "/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return 
# 835 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        12
# 835 "/acl/lib_acl/src/thread/acl_pthread.c"
                  ;
 }

 tls_ctxes = (TLS_CTX*) pthread_getspecific(__tls_ctx_key);
 if (tls_ctxes == 
# 839 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                 ((void *)0)
# 839 "/acl/lib_acl/src/thread/acl_pthread.c"
                     ) {
  acl_msg_error("%s(%d): __tls_ctx_key(%ld) no exist",
 ...
 if (tls_ctxes[(long) key].key != key) {
  ...
  acl_set_error(
# 848 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               22
# 848 "/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return 
# 849 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        22
# 849 "/acl/lib_acl/src/thread/acl_pthread.c"
                  ;
 }

 tls_ctxes[(long) key].free_fn = 
# 852 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                                ((void *)0)
# 852 "/acl/lib_acl/src/thread/acl_pthread.c"
                                    ;
 tls_ctxes[(long) key].ptr = 
# 853 "/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                            ((void *)0)
# 853 "/acl/lib_acl/src/thread/acl_pthread.c"
                                ;
