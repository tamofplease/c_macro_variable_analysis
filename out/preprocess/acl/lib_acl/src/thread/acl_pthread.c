# 1 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 2
# 20 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
# 1 "/workspace/acl/lib_acl/src/thread/../private/private_fifo.h" 1



# 1 "/workspace/acl/lib_acl/include/stdlib/acl_fifo.h" 1
# 5 "/workspace/acl/lib_acl/src/thread/../private/private_fifo.h" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_malloc.h" 1
# 6 "/workspace/acl/lib_acl/src/thread/../private/private_fifo.h" 2
...
# 21 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 2
# 523 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
typedef struct pthread_atexit {
 void (*free_fn)(void *);
 void *arg;
} pthread_atexit_t;

static acl_pthread_key_t __pthread_atexit_key = (acl_pthread_key_t ) 0xffffffff;
static acl_pthread_once_t __pthread_atexit_control_once = 
# 529 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                                                         0
# 529 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                                                                              ;
...
static void pthread_atexit_done(void *arg)
{
 ...
 while (1) {
  ...
  if (id_ptr == 
# 538 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               ((void *)0)
# 538 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                   )
   break;
  if (id_ptr->free_fn)
   id_ptr->free_fn(id_ptr->arg);
  acl_default_free("/workspace/acl/lib_acl/src/thread/acl_pthread.c", 542, id_ptr);
 }
 private_fifo_free(id_list, 
# 544 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                           ((void *)0)
# 544 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                               );
}

static void pthread_atexit_init(void)
{
 pthread_key_create(&__pthread_atexit_key, pthread_atexit_done);
}
...
int acl_pthread_atexit_add(void *arg, void (*free_fn)(void *))
{
 ...
 if (arg == 
# 558 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
           ((void *)0)
# 558 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
               ) {
  acl_set_error(
# 559 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               22
# 559 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return 
# 560 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        22
# 560 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                  ;
 }
 pthread_once(&__pthread_atexit_control_once, pthread_atexit_init);
 if (__pthread_atexit_key == (acl_pthread_key_t) 0xffffffff) {
  acl_msg_error("%s(%d): __pthread_atexit_key(%ld) invalid",
   myname, 565, (long int) __pthread_atexit_key);
  return -1;
 }

 id = (pthread_atexit_t*) acl_default_malloc("/workspace/acl/lib_acl/src/thread/acl_pthread.c",
  570, sizeof(pthread_atexit_t));
 if (id == 
# 571 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
          ((void *)0)
# 571 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
              ) {
  acl_msg_error("%s(%d): malloc error(%s)",
   myname, 573, acl_last_serror());
  acl_set_error(
# 574 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               12
# 574 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return 
# 575 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        12
# 575 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                  ;
 }
 id->free_fn = free_fn;
 id->arg = arg;

 id_list = (ACL_FIFO*) pthread_getspecific(__pthread_atexit_key);
 if (id_list == 
# 581 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               ((void *)0)
# 581 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                   ) {
  id_list = private_fifo_new();
  if (pthread_setspecific(__pthread_atexit_key, id_list) != 0) {
   acl_msg_error("%s(%d): pthread_setspecific: %s, key(%ld)",
    myname, 585, acl_last_serror(),
...
int acl_pthread_atexit_remove(void *arg, void (*free_fn)(void*))
{
 ...
 if (arg == 
# 600 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
           ((void *)0)
# 600 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
               ) {
  acl_set_error(
# 601 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               22
# 601 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return -1;
 }
 if (__pthread_atexit_key == (acl_pthread_key_t) 0xffffffff) {
  acl_msg_error("%s(%d): __pthread_atexit_key(%ld)  invalid",
   myname, 606, (long int) __pthread_atexit_key);
  acl_set_error(
# 607 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               22
# 607 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return -1;
 }
 id_list = (ACL_FIFO*) pthread_getspecific(__pthread_atexit_key);
 if (id_list == 
# 611 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               ((void *)0)
# 611 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                   ) {
  acl_msg_error("%s(%d): __pthread_atexit_key(%ld) no exist"
   " in tid(%lu)", myname, 613,
   (long int) __pthread_atexit_key,
   (unsigned long) pthread_self());
  return -1;
 }

 for ((id_list)->iter_head(&(iter), (id_list)); (iter).ptr; (id_list)->iter_next(&(iter), (id_list))) {
  pthread_atexit_t *id_ptr = (pthread_atexit_t*) iter.data;

  if (id_ptr->free_fn == free_fn && id_ptr->arg == arg) {
   ACL_FIFO_INFO *id_info = (id_list)->iter_info(&(iter), (id_list));
   private_delete_info(id_list, id_info);
   acl_default_free("/workspace/acl/lib_acl/src/thread/acl_pthread.c", 625, id_ptr);
   break;
  }
 }
 return 0;
...
static acl_pthread_once_t __tls_ctx_control_once = 
# 641 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                                                  0
# 641 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                                                                       ;
static acl_pthread_key_t __tls_ctx_key = (acl_pthread_key_t) 0xffffffff;
static TLS_CTX *__main_tls_ctx = 
# 643 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                                ((void *)0)
# 643 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                                    ;
...
int acl_pthread_tls_set_max(int max)
{
 if (max <= 0) {
  acl_set_error(
# 648 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               22
# 648 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return 
# 649 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        22
# 649 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                  ;
 } else {
  acl_tls_ctx_max = max;
  return 0;
...
static void tls_ctx_free(void *ctx)
{
 ...
 for (i = 0; i < acl_tls_ctx_max; i++) {
  if (tls_ctxes[i].ptr != 
# 669 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                         ((void *)0) 
# 669 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                              && tls_ctxes[i].free_fn != 
# 669 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                                                         ((void *)0)
# 669 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
 ...
 acl_default_free("/workspace/acl/lib_acl/src/thread/acl_pthread.c", 673, tls_ctxes);
}
...
static void dummy_free(void *ctx __attribute__ ((__unused__)))
{
}
...
static void tls_ctx_once_init(void)
{
 ...
 {
  pthread_key_create(&__tls_ctx_key, dummy_free);

  atexit(main_tls_ctx_free);

 } else
  pthread_key_create(&__tls_ctx_key, tls_ctx_free);
}
...
void *acl_pthread_tls_get(acl_pthread_key_t *key_ptr)
{
 ...
 pthread_once(&__tls_ctx_control_once, tls_ctx_once_init);
 if (__tls_ctx_key == (acl_pthread_key_t) 0xffffffff) {
  acl_msg_error("%s(%d): __tls_ctx_key invalid, tid(%lu)",
   myname, 712, (unsigned long) pthread_self());
  return 
# 713 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        ((void *)0)
# 713 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
            ;
 }
 tls_ctxes = (TLS_CTX*) pthread_getspecific(__tls_ctx_key);
 if (tls_ctxes == 
# 716 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                 ((void *)0)
# 716 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                     ) {

  tls_ctxes = (TLS_CTX*) acl_default_malloc("/workspace/acl/lib_acl/src/thread/acl_pthread.c", 718,
    acl_tls_ctx_max * sizeof(TLS_CTX));
  if (pthread_setspecific(__tls_ctx_key, tls_ctxes) != 0) {
   acl_default_free("/workspace/acl/lib_acl/src/thread/acl_pthread.c", 721, tls_ctxes);
   acl_msg_error("%s(%d): pthread_setspecific: %s, tid(%lu)",
    myname, 723, acl_last_serror(),
    (unsigned long) pthread_self());
   return 
# 725 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
         ((void *)0)
# 725 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
             ;
  }

  for (i = 0; i < acl_tls_ctx_max; i++) {
   tls_ctxes[i].key = (acl_pthread_key_t) 0xffffffff;
   tls_ctxes[i].ptr = 
# 730 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                     ((void *)0)
# 730 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                         ;
   tls_ctxes[i].free_fn = 
# 731 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                         ((void *)0)
# 731 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                             ;
  }
 ...
 if ((long) (*key_ptr) > 0 && (long) (*key_ptr) < acl_tls_ctx_max) {
  ...
  acl_msg_warn("%s(%d): tls_ctxes[%ld].key(%ld)!= key(%ld)",
   myname, 752, (long) (*key_ptr),
   (long) tls_ctxes[(long) (*key_ptr)].key, (long) (*key_ptr));
  return 
# 754 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        ((void *)0)
# 754 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
            ;
 }


 for (i = 0; i < acl_tls_ctx_max; i++) {
  if (tls_ctxes[i].key == (acl_pthread_key_t) 0xffffffff)
   break;
 }


 if (i == acl_tls_ctx_max) {
  acl_msg_error("%s(%d): no space for tls key", myname, 765);
  *key_ptr = (acl_pthread_key_t) 0xffffffff;
  acl_set_error(
# 767 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               12
# 767 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return 
# 768 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        ((void *)0)
# 768 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
            ;
 }
 ...
 tls_ctxes[i].free_fn = 
# 773 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                       ((void *)0)
# 773 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                           ;
 tls_ctxes[i].ptr = 
# 774 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                   ((void *)0)
# 774 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                       ;
 *key_ptr = (acl_pthread_key_t) i;
 return 
# 776 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
       ((void *)0)
# 776 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
           ;
}
 ...
 void (*free_fn)(void *))
{
 ...
 if ((long) key >= acl_tls_ctx_max) {
  acl_msg_error("%s(%d): key(%ld) invalid",
   myname, 787, (long) key);
  acl_set_error(
# 788 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               22
# 788 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return 
# 789 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        22
# 789 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                  ;
 }

 if (__tls_ctx_key == (acl_pthread_key_t) 0xffffffff) {
  acl_msg_error("%s(%d): __tls_ctx_key invalid, tid(%lu)",
   myname, 794, (unsigned long) pthread_self());
  acl_set_error(
# 795 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               12
# 795 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return 
# 796 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        12
# 796 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                  ;
 }
 tls_ctxes = (TLS_CTX*) pthread_getspecific(__tls_ctx_key);
 if (tls_ctxes == 
# 799 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                 ((void *)0)
# 799 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                     ) {
  acl_msg_error("%s(%d): __tls_ctx_key(%ld) no exist",
   myname, 801, (long) __tls_ctx_key);
  return -1;
 }
 if (tls_ctxes[(long) key].key != key) {
  acl_msg_error("%s(%d): key(%ld) invalid",
   myname, 806, (long) key);
  acl_set_error(
# 807 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               22
# 807 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return 
# 808 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        22
# 808 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                  ;
 }

 if (tls_ctxes[(long) key].ptr != 
# 811 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                                 ((void *)0) 
# 811 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                                      && tls_ctxes[(long) key].free_fn != 
# 811 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                                                                          ((void *)0)
# 811 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                                                                              )
...
int acl_pthread_tls_del(acl_pthread_key_t key)
{
 ...
 if ((long) key >= acl_tls_ctx_max) {
  acl_msg_error("%s(%d): key(%ld) invalid",
   myname, 826, (long) key);
  acl_set_error(
# 827 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               22
# 827 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return 
# 828 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        22
# 828 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                  ;
 }

 if (__tls_ctx_key == (acl_pthread_key_t) 0xffffffff) {
  acl_msg_error("%s(%d): __tls_ctx_key invalid, tid(%lu)",
   myname, 833, (unsigned long) pthread_self());
  acl_set_error(
# 834 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               12
# 834 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return 
# 835 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        12
# 835 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                  ;
 }

 tls_ctxes = (TLS_CTX*) pthread_getspecific(__tls_ctx_key);
 if (tls_ctxes == 
# 839 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                 ((void *)0)
# 839 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                     ) {
  acl_msg_error("%s(%d): __tls_ctx_key(%ld) no exist",
   myname, 841, (long int) __tls_ctx_key);
  return -1;
 }

 if (tls_ctxes[(long) key].key != key) {
  acl_msg_error("%s(%d): key(%ld) invalid",
   myname, 847, (long int) key);
  acl_set_error(
# 848 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
               22
# 848 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                         );
  return 
# 849 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
        22
# 849 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                  ;
 }

 tls_ctxes[(long) key].free_fn = 
# 852 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                                ((void *)0)
# 852 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                                    ;
 tls_ctxes[(long) key].ptr = 
# 853 "/workspace/acl/lib_acl/src/thread/acl_pthread.c" 3 4
                            ((void *)0)
# 853 "/workspace/acl/lib_acl/src/thread/acl_pthread.c"
                                ;
 tls_ctxes[(long) key].key = (acl_pthread_key_t) 0xffffffff;
 return 0;
}
