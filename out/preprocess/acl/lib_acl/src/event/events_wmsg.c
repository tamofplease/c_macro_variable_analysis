# 0 "/acl/lib_acl/src/event/events_wmsg.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/event/events_wmsg.c"
...
# 2 "/acl/lib_acl/src/event/events_wmsg.c" 2
# 24 "/acl/lib_acl/src/event/events_wmsg.c"
...
# 25 "/acl/lib_acl/src/event/events_wmsg.c" 2
