# 1 "/workspace/acl/lib_acl/src/event/events.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/event/events.c" 2
...
# 9 "/workspace/acl/lib_acl/src/event/events.c" 2
...
void event_check_fds(ACL_EVENT *ev)
{
 ...
 for (i = 0; i < 5000 && ev->fdpos < ev->fdcnt; i++, ev->fdpos++) {
  ...
  if ((fdp->stream->flag & ((1 << 10) | (1 << 11) | (1 << 12))) != 0) {
   fdp->stream->flag &= ~((1 << 10) | (1 << 11) | (1 << 12));
   fdp->event_type |= (1 << 4);
   fdp->fdidx_ready = ev->ready_cnt;
   ev->ready[ev->ready_cnt++] = fdp;
  } else if ((fdp->flag & (1 << 1))) {
   if (((fdp->stream) == 
# 27 "/workspace/acl/lib_acl/src/event/events.c" 3 4
      ((void *)0) 
# 27 "/workspace/acl/lib_acl/src/event/events.c"
      ? -1 : (fdp->stream)->read_cnt) > 0) {
...
# 75 "/workspace/acl/lib_acl/src/event/events.c" 3 4
             ((void *)0) 
# 75 "/workspace/acl/lib_acl/src/event/events.c"
             ? -1 : (fdp->stream)->read_cnt) > 0) {
    fdp->stream->read_ready = 0;
    fdp->event_type |= (1 << 0);
    fdp->fdidx_ready = ev->ready_cnt;
...
void event_fire(ACL_EVENT *ev)
{
 ACL_EVENT_FDTABLE *fdp;
 int i, type;
 long long int r_timeout, w_timeout;
 ...
 for (i = 0; i < ev->ready_cnt; i++) {
  ...
  if (fdp == 
# 115 "/workspace/acl/lib_acl/src/event/events.c" 3 4
            ((void *)0) 
# 115 "/workspace/acl/lib_acl/src/event/events.c"
                 || fdp->stream == 
# 115 "/workspace/acl/lib_acl/src/event/events.c" 3 4
                                   ((void *)0)
# 115 "/workspace/acl/lib_acl/src/event/events.c"
  ...
  if ((type & ((1 << 0) | (1 << 1)))) {
   ...
   if (ready[i] && ready[i]->stream
    && (ready[i]->stream->read_ready ||
      ((ready[i]->stream) == 
# 171 "/workspace/acl/lib_acl/src/event/events.c" 3 4
     ((void *)0) 
# 171 "/workspace/acl/lib_acl/src/event/events.c"
     ? -1 : (ready[i]->stream)->read_cnt) > 0))
   {
    ev->read_ready++;
   }
  }
  ...
  if (ready[i] == 
# 178 "/workspace/acl/lib_acl/src/event/events.c" 3 4
                 ((void *)0)
# 178 "/workspace/acl/lib_acl/src/event/events.c"
                     )
   continue;
...
int event_thr_prepare(ACL_EVENT *ev)
{
 ...
 for (i = 0; i < ev->fdcnt; i++) {
  ...
  if (fdp->stream->flag & ((1 << 10) | (1 << 11) | (1 << 12))) {
   fdp->stream->flag &= ~((1 << 10) | (1 << 11) | (1 << 12));
   fdp->event_type |= (1 << 4);
   fdp->fdidx_ready = ev->ready_cnt;
   ev->ready[ev->ready_cnt++] = fdp;
...
# 221 "/workspace/acl/lib_acl/src/event/events.c" 3 4
             ((void *)0) 
# 221 "/workspace/acl/lib_acl/src/event/events.c"
             ? -1 : (fdp->stream)->read_cnt) > 0) {
    fdp->stream->read_ready = 0;
    fdp->event_type = (1 << 0);
    fdp->fdidx_ready = ev->ready_cnt;
...
void event_thr_fire(ACL_EVENT *ev)
{
 ...
 for (i = 0; i < ev->ready_cnt; i++) {
  ...
  if (fdp == 
# 262 "/workspace/acl/lib_acl/src/event/events.c" 3 4
            ((void *)0) 
# 262 "/workspace/acl/lib_acl/src/event/events.c"
                 || fdp->stream == 
# 262 "/workspace/acl/lib_acl/src/event/events.c" 3 4
                                   ((void *)0)
# 262 "/workspace/acl/lib_acl/src/event/events.c"
  ...
  if ((type & ((1 << 0) | (1 << 1)))) {
   ...
   callback((1 << 0), ev, stream, context);
  } else if ((type & ((1 << 2) | (1 << 3)))) {
   fdp->event_type &= ~((1 << 2) | (1 << 3));
   callback = fdp->w_callback;
   context = fdp->w_context;
   ev->disable_readwrite_fn(ev, stream);
   callback((1 << 2), ev, stream, context);
  } else if ((type & (1 << 6))) {
   fdp->event_type &= ~(1 << 6);
   if (fdp->r_callback) {
    callback = fdp->r_callback;
    ...
    callback = 
# 290 "/workspace/acl/lib_acl/src/event/events.c" 3 4
              ((void *)0)
# 290 "/workspace/acl/lib_acl/src/event/events.c"
                  ;
    context = 
# 291 "/workspace/acl/lib_acl/src/event/events.c" 3 4
             ((void *)0)
# 291 "/workspace/acl/lib_acl/src/event/events.c"
                 ;
   }
   if (!fdp->listener)
    ev->disable_readwrite_fn(ev, stream);
   ...
   if (fdp->r_callback) {
    ...
    callback = 
# 307 "/workspace/acl/lib_acl/src/event/events.c" 3 4
              ((void *)0)
# 307 "/workspace/acl/lib_acl/src/event/events.c"
                  ;
    context = 
# 308 "/workspace/acl/lib_acl/src/event/events.c" 3 4
             ((void *)0)
# 308 "/workspace/acl/lib_acl/src/event/events.c"
                 ;
   }
   if (!fdp->listener)
    ev->disable_readwrite_fn(ev, stream);
   if (callback)
    callback((1 << 4), ev, stream, context);
  }
 }
