# 0 "/acl/lib_acl/src/event/events.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/event/events.c"
...
# 2 "/acl/lib_acl/src/event/events.c" 2
...
# 9 "/acl/lib_acl/src/event/events.c" 2
...
void event_check_fds(ACL_EVENT *ev)
{
 ...
 for (i = 0; i < 5000 && ev->fdpos < ev->fdcnt; i++, ev->fdpos++) {
  ...
  if ((fdp->stream->flag & ((1 << 10) | (1 << 11) | (1 << 12))) != 0) {
   ...
   if (((fdp->stream) == 
# 27 "/acl/lib_acl/src/event/events.c" 3 4
      ((void *)0) 
# 27 "/acl/lib_acl/src/event/events.c"
...
# 75 "/acl/lib_acl/src/event/events.c" 3 4
             ((void *)0) 
# 75 "/acl/lib_acl/src/event/events.c"
             ? -1 : (fdp->stream)->read_cnt) > 0) {
    fdp->stream->read_ready = 0;
    fdp->event_type |= (1 << 0);
    fdp->fdidx_ready = ev->ready_cnt;
...
void event_fire(ACL_EVENT *ev)
{
 ...
 for (i = 0; i < ev->ready_cnt; i++) {
  ...
  if (fdp == 
# 115 "/acl/lib_acl/src/event/events.c" 3 4
            ((void *)0) 
# 115 "/acl/lib_acl/src/event/events.c"
                 || fdp->stream == 
# 115 "/acl/lib_acl/src/event/events.c" 3 4
                                   ((void *)0)
# 115 "/acl/lib_acl/src/event/events.c"
  ...
  if ((type & ((1 << 0) | (1 << 1)))) {
   ...
   if (ready[i] && ready[i]->stream
    && (ready[i]->stream->read_ready ||
      ((ready[i]->stream) == 
# 171 "/acl/lib_acl/src/event/events.c" 3 4
     ((void *)0) 
# 171 "/acl/lib_acl/src/event/events.c"
  ...
  if (ready[i] == 
# 178 "/acl/lib_acl/src/event/events.c" 3 4
                 ((void *)0)
# 178 "/acl/lib_acl/src/event/events.c"
                     )
   continue;
...
# 221 "/acl/lib_acl/src/event/events.c" 3 4
             ((void *)0) 
# 221 "/acl/lib_acl/src/event/events.c"
             ? -1 : (fdp->stream)->read_cnt) > 0) {
    fdp->stream->read_ready = 0;
    fdp->event_type = (1 << 0);
    fdp->fdidx_ready = ev->ready_cnt;
...
void event_thr_fire(ACL_EVENT *ev)
{
 ...
 for (i = 0; i < ev->ready_cnt; i++) {
  ...
  if (fdp == 
# 262 "/acl/lib_acl/src/event/events.c" 3 4
            ((void *)0) 
# 262 "/acl/lib_acl/src/event/events.c"
                 || fdp->stream == 
# 262 "/acl/lib_acl/src/event/events.c" 3 4
                                   ((void *)0)
# 262 "/acl/lib_acl/src/event/events.c"
  ...
  if ((type & ((1 << 0) | (1 << 1)))) {
   ...
   if (fdp->r_callback) {
    ...
    callback = 
# 290 "/acl/lib_acl/src/event/events.c" 3 4
              ((void *)0)
# 290 "/acl/lib_acl/src/event/events.c"
                  ;
    context = 
# 291 "/acl/lib_acl/src/event/events.c" 3 4
             ((void *)0)
# 291 "/acl/lib_acl/src/event/events.c"
                 ;
   }
   if (!fdp->listener)
    ev->disable_readwrite_fn(ev, stream);
   ...
   if (fdp->r_callback) {
    ...
    callback = 
# 307 "/acl/lib_acl/src/event/events.c" 3 4
              ((void *)0)
# 307 "/acl/lib_acl/src/event/events.c"
                  ;
    context = 
# 308 "/acl/lib_acl/src/event/events.c" 3 4
             ((void *)0)
# 308 "/acl/lib_acl/src/event/events.c"
                 ;
   }
   if (!fdp->listener)
    ev->disable_readwrite_fn(ev, stream);
