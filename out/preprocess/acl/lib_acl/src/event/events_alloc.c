# 0 "/acl/lib_acl/src/event/events_alloc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/event/events_alloc.c"
...
# 2 "/acl/lib_acl/src/event/events_alloc.c" 2
# 13 "/acl/lib_acl/src/event/events_alloc.c"
...
# 14 "/acl/lib_acl/src/event/events_alloc.c" 2
...
{
 do { if (eventp) { acl_free_glue("/acl/lib_acl/src/event/events_alloc.c", 137, (eventp)); (eventp) = 
# 137 "/acl/lib_acl/src/event/events_alloc.c" 3 4
((void *)0)
# 137 "/acl/lib_acl/src/event/events_alloc.c"
; } } while (0);
}
...
ACL_EVENT *event_alloc(size_t size)
{
 ...
 if (size < sizeof(ACL_EVENT))
  acl_msg_fatal("%s(%d): size(%d) too small",
   myname, 147, (int) size);
 eventp = acl_calloc_glue("/acl/lib_acl/src/event/events_alloc.c", 148, 1, size);
 ...
 eventp->init_fn = 
# 151 "/acl/lib_acl/src/event/events_alloc.c" 3 4
                               ((void *)0)
# 151 "/acl/lib_acl/src/event/events_alloc.c"
                                   ;
