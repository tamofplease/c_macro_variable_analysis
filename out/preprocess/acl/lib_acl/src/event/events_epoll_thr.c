# 0 "/acl/lib_acl/src/event/events_epoll_thr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/event/events_epoll_thr.c"
...
# 2 "/acl/lib_acl/src/event/events_epoll_thr.c" 2
# 31 "/acl/lib_acl/src/event/events_epoll_thr.c"
# 1 "/acl/lib_acl/src/event/events_define.h" 1
# 10 "/acl/lib_acl/src/event/events_define.h"
# 1 "/acl/lib_acl/include/stdlib/acl_mymalloc.h" 1
# 11 "/acl/lib_acl/src/event/events_define.h" 2
# 32 "/acl/lib_acl/src/event/events_epoll_thr.c" 2
...
# 37 "/acl/lib_acl/src/event/events_epoll_thr.c" 2
# 1 "/acl/lib_acl/src/event/events_fdtable.h" 1
...
# 1 "/acl/lib_acl/include/event/acl_events.h" 1
# 9 "/acl/lib_acl/src/event/events_fdtable.h" 2


# 10 "/acl/lib_acl/src/event/events_fdtable.h"
...
# 38 "/acl/lib_acl/src/event/events_epoll_thr.c" 2
# 1 "/acl/lib_acl/src/event/events.h" 1
# 10 "/acl/lib_acl/src/event/events.h"
# 1 "/acl/lib_acl/include/stdlib/acl_ring.h" 1
# 11 "/acl/lib_acl/src/event/events.h" 2
# 1 "/acl/lib_acl/include/stdlib/acl_vstream.h" 1
# 12 "/acl/lib_acl/src/event/events.h" 2
# 1 "/acl/lib_acl/include/stdlib/acl_fifo.h" 1
# 13 "/acl/lib_acl/src/event/events.h" 2
# 1 "/acl/lib_acl/include/stdlib/acl_avl.h" 1
# 14 "/acl/lib_acl/src/event/events.h" 2
# 1 "/acl/lib_acl/include/thread/acl_thread.h" 1
# 15 "/acl/lib_acl/src/event/events.h" 2


# 1 "/acl/lib_acl/src/event/events_dog.h" 1
# 11 "/acl/lib_acl/src/event/events_dog.h"
...
# 18 "/acl/lib_acl/src/event/events.h" 2
# 1 "/acl/lib_acl/src/event/fdmap.h" 1
...
# 19 "/acl/lib_acl/src/event/events.h" 2

# 1 "/acl/lib_acl/src/event/events_epoll.h" 1
# 87 "/acl/lib_acl/src/event/events_epoll.h"
typedef struct epoll_event EVENT_BUFFER;
# 21 "/acl/lib_acl/src/event/events.h" 2
# 1 "/acl/lib_acl/src/event/events_devpoll.h" 1
# 22 "/acl/lib_acl/src/event/events.h" 2
# 36 "/acl/lib_acl/src/event/events.h"
struct ACL_EVENT_FDTABLE {
 ...
 int listener;
 int flag;
# 60 "/acl/lib_acl/src/event/events.h"
 int fdidx;
 int fdidx_ready;
...
# 183 "/acl/lib_acl/src/event/events.h"
...
# 218 "/acl/lib_acl/src/event/events.h"
...
# 288 "/acl/lib_acl/src/event/events.h"
...
# 39 "/acl/lib_acl/src/event/events_epoll_thr.c" 2
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 if (fdp == 
# 58 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
           ((void *)0)
# 58 "/acl/lib_acl/src/event/events_epoll_thr.c"
               ) {
  ...
  acl_msg_panic("%s(%d), %s: fd %d: multiple I/O request",
   "/acl/lib_acl/src/event/events_epoll_thr.c", 67, myname, fd);
 else {
  fdp->listener = 0;
  fdp->stream = fp;
 }
 ...
 if (((fp) == 
# 94 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
    ((void *)0) 
# 94 "/acl/lib_acl/src/event/events_epoll_thr.c"
 ...
 ev.events = 
# 104 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
            EPOLLIN 
# 104 "/acl/lib_acl/src/event/events_epoll_thr.c"
                    | 
# 104 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                      EPOLLHUP 
# 104 "/acl/lib_acl/src/event/events_epoll_thr.c"
...
# 104 "/acl/lib_acl/src/event/events_epoll_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&evthr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/acl/lib_acl/src/event/events_epoll_thr.c", 109, strerror(status)); } while (0);

 fdp->fdidx = eventp->fdcnt;
 eventp->fdtabs[eventp->fdcnt++] = fdp;

 if (fdp->flag & (1 << 10)) {
# 132 "/acl/lib_acl/src/event/events_epoll_thr.c"
  { struct timeval _tv; gettimeofday(&_tv, 
# 132 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
 ((void *)0)
# 132 "/acl/lib_acl/src/event/events_epoll_thr.c"
  ...
  do { acl_pthread_mutex_t *mutex_ptr = (&evthr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_epoll_thr.c", 136, strerror(status)); } while (0);
...
# 147 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                             1
# 147 "/acl/lib_acl/src/event/events_epoll_thr.c"
                                          , fd, &ev) < 0) {
  if (
# 148 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
     (*__errno_location ()) 
# 148 "/acl/lib_acl/src/event/events_epoll_thr.c"
           == 
# 148 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
              17
# 148 "/acl/lib_acl/src/event/events_epoll_thr.c"
...
# 151 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
          (*__errno_location ()) 
# 151 "/acl/lib_acl/src/event/events_epoll_thr.c"
                == 
# 151 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                   9 
# 151 "/acl/lib_acl/src/event/events_epoll_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&evthr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_epoll_thr.c", 161, strerror(status)); } while (0);
}
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 fdp = (ACL_EVENT_FDTABLE*) fp->fdp;
 if (fdp == 
# 175 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
           ((void *)0)
# 175 "/acl/lib_acl/src/event/events_epoll_thr.c"
               ) {
  fdp = event_fdtable_alloc();
  fdp->stream = fp;
  fdp->listener = 1;
  ...
  acl_msg_panic("%s(%d)->%s: fd %d: multiple I/O request",
   "/acl/lib_acl/src/event/events_epoll_thr.c", 184, myname, fd);
 else {
  fdp->stream = fp;
  fdp->listener = 1;
 }
 ...
 ev.events = 
# 209 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
            EPOLLIN 
# 209 "/acl/lib_acl/src/event/events_epoll_thr.c"
                    | 
# 209 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                      EPOLLHUP 
# 209 "/acl/lib_acl/src/event/events_epoll_thr.c"
...
# 209 "/acl/lib_acl/src/event/events_epoll_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&evthr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/acl/lib_acl/src/event/events_epoll_thr.c", 213, strerror(status)); } while (0);

 fdp->fdidx = eventp->fdcnt;
 eventp->fdtabs[eventp->fdcnt++] = fdp;

 if (epoll_ctl(evthr->handle, 
# 218 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                             1
# 218 "/acl/lib_acl/src/event/events_epoll_thr.c"
                                          , fd, &ev) < 0) {
  if (
# 219 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
     (*__errno_location ()) 
# 219 "/acl/lib_acl/src/event/events_epoll_thr.c"
           == 
# 219 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
              17
# 219 "/acl/lib_acl/src/event/events_epoll_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&evthr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_epoll_thr.c", 227, strerror(status)); } while (0);
}
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 fdp = (ACL_EVENT_FDTABLE*) fp->fdp;
 if (fdp == 
# 247 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
           ((void *)0)
# 247 "/acl/lib_acl/src/event/events_epoll_thr.c"
               ) {
  fdp = event_fdtable_alloc();
  fdp->listener = 0;
  fdp->stream = fp;
  ...
  acl_msg_panic("%s(%d)->%s: fd %d: multiple I/O request",
   "/acl/lib_acl/src/event/events_epoll_thr.c", 256, myname, fd);
 else {
  fdp->listener = 0;
  fdp->stream = fp;
 }
 ...
 ev.events = 
# 281 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
            EPOLLOUT 
# 281 "/acl/lib_acl/src/event/events_epoll_thr.c"
                     | 
# 281 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                       EPOLLHUP 
# 281 "/acl/lib_acl/src/event/events_epoll_thr.c"
...
# 281 "/acl/lib_acl/src/event/events_epoll_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&evthr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/acl/lib_acl/src/event/events_epoll_thr.c", 285, strerror(status)); } while (0);
 ...
 if (fd_ready) {
  if (epoll_ctl(evthr->handle, 
# 291 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                              1
# 291 "/acl/lib_acl/src/event/events_epoll_thr.c"
                                           , fd, &ev) < 0) {
   if (
# 292 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
      (*__errno_location ()) 
# 292 "/acl/lib_acl/src/event/events_epoll_thr.c"
            == 
# 292 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
               17
# 292 "/acl/lib_acl/src/event/events_epoll_thr.c"
...
# 295 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
           (*__errno_location ()) 
# 295 "/acl/lib_acl/src/event/events_epoll_thr.c"
                 == 
# 295 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                    9 
# 295 "/acl/lib_acl/src/event/events_epoll_thr.c"
  ...
  do { acl_pthread_mutex_t *mutex_ptr = (&evthr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_epoll_thr.c", 306, strerror(status)); } while (0);
  return;
 }

 if (epoll_ctl(evthr->handle, 
# 310 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                             1
# 310 "/acl/lib_acl/src/event/events_epoll_thr.c"
                                          , fd, &ev) < 0) {
  if (
# 311 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
     (*__errno_location ()) 
# 311 "/acl/lib_acl/src/event/events_epoll_thr.c"
           == 
# 311 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
              17
# 311 "/acl/lib_acl/src/event/events_epoll_thr.c"
...
# 314 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
          (*__errno_location ()) 
# 314 "/acl/lib_acl/src/event/events_epoll_thr.c"
                == 
# 314 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                   9 
# 314 "/acl/lib_acl/src/event/events_epoll_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&evthr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_epoll_thr.c", 324, strerror(status)); } while (0);
}
...
static void event_disable_readwrite(ACL_EVENT *eventp, ACL_VSTREAM *stream)
{
 ...
 dummy.events = 
# 337 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
               EPOLLHUP 
# 337 "/acl/lib_acl/src/event/events_epoll_thr.c"
                        | 
# 337 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                          EPOLLERR
# 337 "/acl/lib_acl/src/event/events_epoll_thr.c"
 ...
 dummy.data.u64 = 0;
 dummy.data.ptr = 
# 339 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                 ((void *)0)
# 339 "/acl/lib_acl/src/event/events_epoll_thr.c"
                     ;
 ...
 if (fdp == 
# 344 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
           ((void *)0)
# 344 "/acl/lib_acl/src/event/events_epoll_thr.c"
               ) {
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/acl/lib_acl/src/event/events_epoll_thr.c", 364, strerror(status)); } while (0);
 ...
 if (fdp->flag & (1 << 1)) {
  stream->nrefer--;
  dummy.events |= 
# 373 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                 EPOLLIN
# 373 "/acl/lib_acl/src/event/events_epoll_thr.c"
                        ;
 }
 ...
 if (fdp->flag & (1 << 2)) {
  stream->nrefer--;
  dummy.events |= 
# 378 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                 EPOLLOUT
# 378 "/acl/lib_acl/src/event/events_epoll_thr.c"
                         ;
 }

 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_epoll_thr.c", 381, strerror(status)); } while (0);

 if ((fdp->flag & (1 << 10)) != 0)
  fdp->flag &= ~(1 << 10);
 else if (epoll_ctl(event_thr->handle, 
# 385 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                                      2
# 385 "/acl/lib_acl/src/event/events_epoll_thr.c"
                                                   ,
   sockfd, &dummy) < 0)
 {
  if (
# 388 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
     (*__errno_location ()) 
# 388 "/acl/lib_acl/src/event/events_epoll_thr.c"
           == 
# 388 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
              2
# 388 "/acl/lib_acl/src/event/events_epoll_thr.c"
...
static int event_isrset(ACL_EVENT *eventp __attribute__ ((__unused__)), ACL_VSTREAM *stream)
{
 ...
 fdp = (ACL_EVENT_FDTABLE *) stream->fdp;
 if (fdp == 
# 405 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
           ((void *)0)
# 405 "/acl/lib_acl/src/event/events_epoll_thr.c"
               )
  return (0);
...
static int event_iswset(ACL_EVENT *eventp __attribute__ ((__unused__)), ACL_VSTREAM *stream)
{
 ...
 fdp = (ACL_EVENT_FDTABLE *) stream->fdp;
 if (fdp == 
# 416 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
           ((void *)0)
# 416 "/acl/lib_acl/src/event/events_epoll_thr.c"
               )
  return (0);
...
static int event_isxset(ACL_EVENT *eventp __attribute__ ((__unused__)), ACL_VSTREAM *stream)
{
 ...
 fdp = (ACL_EVENT_FDTABLE *) stream->fdp;
 if (fdp == 
# 427 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
           ((void *)0)
# 427 "/acl/lib_acl/src/event/events_epoll_thr.c"
               )
  return (0);
...
static void event_loop(ACL_EVENT *eventp)
{
 ...
 { struct timeval _tv; gettimeofday(&_tv, 
# 446 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
((void *)0)
# 446 "/acl/lib_acl/src/event/events_epoll_thr.c"
); (eventp->present) = ((long long int) _tv.tv_sec) * 1000000 + ((long long int) _tv.tv_usec); };

 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tm_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/acl/lib_acl/src/event/events_epoll_thr.c", 448, strerror(status)); } while (0);
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tm_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_epoll_thr.c", 465, strerror(status)); } while (0);

 eventp->ready_cnt = 0;

 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/acl/lib_acl/src/event/events_epoll_thr.c", 469, strerror(status)); } while (0);
 ...
 if (eventp->present - eventp->last_check >= eventp->check_inter) {
  ...
  if (event_thr_prepare(eventp) == 0) {
   ...
   do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_epoll_thr.c", 479, strerror(status)); } while (0);
  ...
  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_epoll_thr.c", 489, strerror(status)); } while (0);

  if (eventp->ready_cnt > 0) {
   delay = 0;
  }
 } else {
  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_epoll_thr.c", 495, strerror(status)); } while (0);
 }
 ...
 if (nready < 0) {
  if (acl_last_error() != 
# 504 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                         4
# 504 "/acl/lib_acl/src/event/events_epoll_thr.c"
                                  ) {
   acl_msg_fatal("%s(%d), %s: event_loop: epoll: %s",
    "/acl/lib_acl/src/event/events_epoll_thr.c", 506, myname, acl_last_serror());
  }
  goto TAG_DONE;
 } else if (nready == 0) {
  goto TAG_DONE;
 ...
 for (bp = event_thr->ebuf; bp < event_thr->ebuf + nready; bp++) {
  ...
  if ((bp->events & 
# 519 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                   EPOLLIN
# 519 "/acl/lib_acl/src/event/events_epoll_thr.c"
                          ) != 0) {
...
# 530 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                          EPOLLOUT
# 530 "/acl/lib_acl/src/event/events_epoll_thr.c"
                                  ) != 0) {
   fdp->event_type |= (1 << 2);
   fdp->fdidx_ready = eventp->ready_cnt;
   eventp->ready[eventp->ready_cnt++] = fdp;
  } else if ((bp->events & (
# 534 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                           EPOLLERR 
# 534 "/acl/lib_acl/src/event/events_epoll_thr.c"
                                    | 
# 534 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                                      EPOLLHUP
# 534 "/acl/lib_acl/src/event/events_epoll_thr.c"
...
static void event_free(ACL_EVENT *eventp)
{
 ...
 if (eventp == 
# 563 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
              ((void *)0)
# 563 "/acl/lib_acl/src/event/events_epoll_thr.c"
                  )
  acl_msg_fatal("%s, %s(%d): eventp null",
   "/acl/lib_acl/src/event/events_epoll_thr.c", myname, 565);
 ...
 do { if (event_thr->ebuf) { acl_free_glue("/acl/lib_acl/src/event/events_epoll_thr.c", 570, (event_thr->ebuf)); (event_thr->ebuf) = 
# 570 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
((void *)0)
# 570 "/acl/lib_acl/src/event/events_epoll_thr.c"
; } } while (0);
 close(event_thr->handle);
 do { if (eventp) { acl_free_glue("/acl/lib_acl/src/event/events_epoll_thr.c", 572, (eventp)); (eventp) = 
# 572 "/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
((void *)0)
# 572 "/acl/lib_acl/src/event/events_epoll_thr.c"
; } } while (0);
}
...
ACL_EVENT *event_epoll_alloc_thr(int fdsize __attribute__ ((__unused__)))
{
 ...
 event_thr->ebuf = (EVENT_BUFFER *) acl_calloc_glue("/acl/lib_acl/src/event/events_epoll_thr.c", 606, event_thr->fdslots + 1, sizeof(EVENT_BUFFER))
                        ;

 acl_msg_info("%s(%d), %s, use %s", "/acl/lib_acl/src/event/events_epoll_thr.c", 609, __FUNCTION__,
