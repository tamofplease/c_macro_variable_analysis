# 1 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 2
# 31 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
# 1 "/workspace/acl/lib_acl/src/event/events_define.h" 1
# 10 "/workspace/acl/lib_acl/src/event/events_define.h"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_mymalloc.h" 1
# 11 "/workspace/acl/lib_acl/src/event/events_define.h" 2
# 32 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 2
...
# 37 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 2
# 1 "/workspace/acl/lib_acl/src/event/events_fdtable.h" 1
...
# 1 "/workspace/acl/lib_acl/include/event/acl_events.h" 1
# 9 "/workspace/acl/lib_acl/src/event/events_fdtable.h" 2


# 10 "/workspace/acl/lib_acl/src/event/events_fdtable.h"
...
# 38 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 2
# 1 "/workspace/acl/lib_acl/src/event/events.h" 1
# 10 "/workspace/acl/lib_acl/src/event/events.h"
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_ring.h" 1
# 11 "/workspace/acl/lib_acl/src/event/events.h" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_vstream.h" 1
# 12 "/workspace/acl/lib_acl/src/event/events.h" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_fifo.h" 1
# 13 "/workspace/acl/lib_acl/src/event/events.h" 2
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_avl.h" 1
# 14 "/workspace/acl/lib_acl/src/event/events.h" 2
# 1 "/workspace/acl/lib_acl/include/thread/acl_thread.h" 1
# 15 "/workspace/acl/lib_acl/src/event/events.h" 2


# 1 "/workspace/acl/lib_acl/src/event/events_dog.h" 1
# 11 "/workspace/acl/lib_acl/src/event/events_dog.h"
...
# 18 "/workspace/acl/lib_acl/src/event/events.h" 2
# 1 "/workspace/acl/lib_acl/src/event/fdmap.h" 1
...
# 19 "/workspace/acl/lib_acl/src/event/events.h" 2

# 1 "/workspace/acl/lib_acl/src/event/events_epoll.h" 1
# 87 "/workspace/acl/lib_acl/src/event/events_epoll.h"
typedef struct epoll_event EVENT_BUFFER;
# 21 "/workspace/acl/lib_acl/src/event/events.h" 2
# 1 "/workspace/acl/lib_acl/src/event/events_devpoll.h" 1
# 22 "/workspace/acl/lib_acl/src/event/events.h" 2
# 36 "/workspace/acl/lib_acl/src/event/events.h"
struct ACL_EVENT_FDTABLE {
 ...
 int listener;
 int flag;
# 60 "/workspace/acl/lib_acl/src/event/events.h"
 int fdidx;
 int fdidx_ready;
...
# 183 "/workspace/acl/lib_acl/src/event/events.h"
...
# 218 "/workspace/acl/lib_acl/src/event/events.h"
...
# 288 "/workspace/acl/lib_acl/src/event/events.h"
...
# 39 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 2
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 if (fdp == 
# 58 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
           ((void *)0)
# 58 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
               ) {
  ...
  fp->fdp = (void *) fdp;
 } else if (fdp->flag & (1 << 2))
  acl_msg_panic("%s(%d), %s: fd %d: multiple I/O request",
   "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 67, myname, fd);
 else {
  fdp->listener = 0;
  fdp->stream = fp;
 }
 ...
 if (timeout > 0) {
  fdp->r_timeout = ((long long int) timeout) * 1000000;
 ...
 if (((fp) == 
# 94 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
    ((void *)0) 
# 94 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
    ? -1 : (fp)->read_cnt) > 0 || fp->read_ready
  || (fp->flag & ((1 << 10) | (1 << 11) | (1 << 12))))
 {
  fdp->flag |= (1 << 10);
 } else
  fdp->flag &= ~(1 << 10);
 ...
 ev.events = 
# 104 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
            EPOLLIN 
# 104 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                    | 
# 104 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                      EPOLLHUP 
# 104 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
...
# 104 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&evthr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 109, strerror(status)); } while (0);

 fdp->fdidx = eventp->fdcnt;
 eventp->fdtabs[eventp->fdcnt++] = fdp;

 if (fdp->flag & (1 << 10)) {
# 132 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
  { struct timeval _tv; gettimeofday(&_tv, 
# 132 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
 ((void *)0)
# 132 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
 ); (eventp->last_check) = ((long long int) _tv.tv_sec) * 1000000 + ((long long int) _tv.tv_usec); };
  eventp->last_check -= eventp->check_inter;


  do { acl_pthread_mutex_t *mutex_ptr = (&evthr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 136, strerror(status)); } while (0);
 ...
 if (epoll_ctl(evthr->handle, 
# 147 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                             1
# 147 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                                          , fd, &ev) < 0) {
  if (
# 148 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
     (*__errno_location ()) 
# 148 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
           == 
# 148 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
              17
# 148 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
...
# 151 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
          (*__errno_location ()) 
# 151 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                == 
# 151 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                   9 
# 151 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                         && acl_getsockfamily(fd) < 0) {
   acl_msg_error("%s: epool_ctl: %s, fd: %d",
    myname, acl_last_serror(), fd);
   do { ACL_VSTREAM *__stream_ptr = fp; __stream_ptr->fd.sock = (int) -1; } while (0);
   fp->flag |= (1 << 10);
  } else
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&evthr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 161, strerror(status)); } while (0);
}
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 fdp = (ACL_EVENT_FDTABLE*) fp->fdp;
 if (fdp == 
# 175 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
           ((void *)0)
# 175 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
               ) {
  fdp = event_fdtable_alloc();
  fdp->stream = fp;
  fdp->listener = 1;
  ...
  acl_msg_panic("%s(%d)->%s: fd %d: multiple I/O request",
   "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 184, myname, fd);
 else {
  fdp->stream = fp;
  fdp->listener = 1;
 }
 ...
 ev.events = 
# 209 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
            EPOLLIN 
# 209 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                    | 
# 209 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                      EPOLLHUP 
# 209 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
...
# 209 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&evthr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 213, strerror(status)); } while (0);

 fdp->fdidx = eventp->fdcnt;
 eventp->fdtabs[eventp->fdcnt++] = fdp;

 if (epoll_ctl(evthr->handle, 
# 218 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                             1
# 218 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                                          , fd, &ev) < 0) {
  if (
# 219 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
     (*__errno_location ()) 
# 219 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
           == 
# 219 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
              17
# 219 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&evthr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 227, strerror(status)); } while (0);
}
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 fdp = (ACL_EVENT_FDTABLE*) fp->fdp;
 if (fdp == 
# 247 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
           ((void *)0)
# 247 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
               ) {
  fdp = event_fdtable_alloc();
  fdp->listener = 0;
  fdp->stream = fp;
  ...
  fp->fdp = (void *) fdp;
 } else if (fdp->flag & (1 << 1))
  acl_msg_panic("%s(%d)->%s: fd %d: multiple I/O request",
   "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 256, myname, fd);
 else {
  fdp->listener = 0;
  fdp->stream = fp;
 }
 ...
 if (timeout > 0) {
  fdp->w_timeout = ((long long int) timeout) * 1000000;
 ...
 ev.events = 
# 281 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
            EPOLLOUT 
# 281 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                     | 
# 281 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                       EPOLLHUP 
# 281 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
...
# 281 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&evthr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 285, strerror(status)); } while (0);
 ...
 if (fd_ready) {
  if (epoll_ctl(evthr->handle, 
# 291 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                              1
# 291 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                                           , fd, &ev) < 0) {
   if (
# 292 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
      (*__errno_location ()) 
# 292 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
            == 
# 292 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
               17
# 292 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
...
# 295 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
           (*__errno_location ()) 
# 295 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                 == 
# 295 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                    9 
# 295 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
  ...
  do { acl_pthread_mutex_t *mutex_ptr = (&evthr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 306, strerror(status)); } while (0);
  return;
 }

 if (epoll_ctl(evthr->handle, 
# 310 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                             1
# 310 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                                          , fd, &ev) < 0) {
  if (
# 311 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
     (*__errno_location ()) 
# 311 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
           == 
# 311 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
              17
# 311 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
...
# 314 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
          (*__errno_location ()) 
# 314 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                == 
# 314 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                   9 
# 314 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&evthr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 324, strerror(status)); } while (0);
}
...
static void event_disable_readwrite(ACL_EVENT *eventp, ACL_VSTREAM *stream)
{
 ...
 dummy.events = 
# 337 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
               EPOLLHUP 
# 337 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                        | 
# 337 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                          EPOLLERR
# 337 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
 ...
 dummy.data.u64 = 0;
 dummy.data.ptr = 
# 339 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                 ((void *)0)
# 339 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                     ;

 sockfd = ((stream)->fd.sock);

 fdp = (ACL_EVENT_FDTABLE *) stream->fdp;
 if (fdp == 
# 344 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
           ((void *)0)
# 344 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
               ) {
  acl_msg_error("%s(%d): fdp null", myname, 345);
  return;
 }
 ...
 if (fdp->fdidx == -1)
  acl_msg_fatal("%s(%d): fdidx(%d) invalid",
   myname, 358, fdp->fdidx);

 if (eventp->fdtabs[fdp->fdidx] != fdp)
  acl_msg_fatal("%s(%d): fdidx(%d)'s fdp invalid",
   myname, 362, fdp->fdidx);

 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 364, strerror(status)); } while (0);
 ...
 if (fdp->flag & (1 << 1)) {
  stream->nrefer--;
  dummy.events |= 
# 373 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                 EPOLLIN
# 373 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                        ;
 }
 ...
 if (fdp->flag & (1 << 2)) {
  stream->nrefer--;
  dummy.events |= 
# 378 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                 EPOLLOUT
# 378 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                         ;
 }

 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 381, strerror(status)); } while (0);

 if ((fdp->flag & (1 << 10)) != 0)
  fdp->flag &= ~(1 << 10);
 else if (epoll_ctl(event_thr->handle, 
# 385 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                                      2
# 385 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                                                   ,
   sockfd, &dummy) < 0)
 {
  if (
# 388 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
     (*__errno_location ()) 
# 388 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
           == 
# 388 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
              2
# 388 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
...
static int event_isrset(ACL_EVENT *eventp __attribute__ ((__unused__)), ACL_VSTREAM *stream)
{
 ACL_EVENT_FDTABLE *fdp;

 fdp = (ACL_EVENT_FDTABLE *) stream->fdp;
 if (fdp == 
# 405 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
           ((void *)0)
# 405 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
               )
  return (0);
...
static int event_iswset(ACL_EVENT *eventp __attribute__ ((__unused__)), ACL_VSTREAM *stream)
{
 ACL_EVENT_FDTABLE *fdp;

 fdp = (ACL_EVENT_FDTABLE *) stream->fdp;
 if (fdp == 
# 416 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
           ((void *)0)
# 416 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
               )
  return (0);
...
static int event_isxset(ACL_EVENT *eventp __attribute__ ((__unused__)), ACL_VSTREAM *stream)
{
 ACL_EVENT_FDTABLE *fdp;

 fdp = (ACL_EVENT_FDTABLE *) stream->fdp;
 if (fdp == 
# 427 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
           ((void *)0)
# 427 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
               )
  return (0);
...
static void event_loop(ACL_EVENT *eventp)
{
 ...
 { struct timeval _tv; gettimeofday(&_tv, 
# 446 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
((void *)0)
# 446 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
); (eventp->present) = ((long long int) _tv.tv_sec) * 1000000 + ((long long int) _tv.tv_usec); };

 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tm_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 448, strerror(status)); } while (0);
 ...
 if (when >= 0) {
  long long int n = when - eventp->present;
  if (n <= 0) {
   delay = 0;
  } else if (n < delay) {
   delay = n;
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tm_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 465, strerror(status)); } while (0);

 eventp->ready_cnt = 0;

 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 469, strerror(status)); } while (0);
 ...
 if (eventp->present - eventp->last_check >= eventp->check_inter) {
  ...
  if (event_thr_prepare(eventp) == 0) {
   ...
   do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 479, strerror(status)); } while (0);

   if (eventp->ready_cnt == 0) {
    acl_doze(delay > 1000 ? delay / 1000 : 1);
   }
  ...
  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 489, strerror(status)); } while (0);

  if (eventp->ready_cnt > 0) {
   delay = 0;
  }
 } else {
  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 495, strerror(status)); } while (0);
 }
 ...
 if (nready < 0) {
  if (acl_last_error() != 
# 504 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                         4
# 504 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                                  ) {
   acl_msg_fatal("%s(%d), %s: event_loop: epoll: %s",
    "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 506, myname, acl_last_serror());
  }
  goto TAG_DONE;
 } else if (nready == 0) {
  goto TAG_DONE;
 ...
 for (bp = event_thr->ebuf; bp < event_thr->ebuf + nready; bp++) {
  ...
  if ((fdp->event_type & ((1 << 4) | (1 << 6)))) {
   continue;
  }

  if ((bp->events & 
# 519 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                   EPOLLIN
# 519 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                          ) != 0) {
   if ((fdp->event_type & (1 << 0)) == 0) {
    fdp->event_type |= (1 << 0);
...
# 530 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                          EPOLLOUT
# 530 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                                  ) != 0) {
   fdp->event_type |= (1 << 2);
   fdp->fdidx_ready = eventp->ready_cnt;
   eventp->ready[eventp->ready_cnt++] = fdp;
  } else if ((bp->events & (
# 534 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                           EPOLLERR 
# 534 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                                    | 
# 534 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
                                      EPOLLHUP
# 534 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
...
static void event_free(ACL_EVENT *eventp)
{
 ...
 if (eventp == 
# 563 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
              ((void *)0)
# 563 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                  )
  acl_msg_fatal("%s, %s(%d): eventp null",
   "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", myname, 565);

 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tm_mutex); (void) pthread_mutex_destroy(mutex_ptr); } while (0);
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); (void) pthread_mutex_destroy(mutex_ptr); } while (0);

 do { if (event_thr->ebuf) { acl_free_glue("/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 570, (event_thr->ebuf)); (event_thr->ebuf) = 
# 570 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
((void *)0)
# 570 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
; } } while (0);
 close(event_thr->handle);
 do { if (eventp) { acl_free_glue("/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 572, (eventp)); (eventp) = 
# 572 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c" 3 4
((void *)0)
# 572 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
; } } while (0);
}

ACL_EVENT *event_epoll_alloc_thr(int fdsize __attribute__ ((__unused__)))
{
 ...
 event_thr->event.event.event_mode = 2;
 ...
 do { acl_pthread_mutexattr_t attr; acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tm_mutex); pthread_mutexattr_init(&attr); pthread_mutexattr_settype(&attr, PTHREAD_MUTEX_RECURSIVE_NP); pthread_mutex_init(mutex_ptr, &attr); pthread_mutexattr_destroy(&attr); } while (0);
 do { acl_pthread_mutexattr_t attr; acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); pthread_mutexattr_init(&attr); pthread_mutexattr_settype(&attr, PTHREAD_MUTEX_RECURSIVE_NP); pthread_mutex_init(mutex_ptr, &attr); pthread_mutexattr_destroy(&attr); } while (0);

 event_thr->handle = epoll_create(fdsize);
 event_thr->fdslots = __default_max_events;
 event_thr->ebuf = (EVENT_BUFFER *) acl_calloc_glue(
                       "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
# 606 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                                    ,
                       607
# 606 "/workspace/acl/lib_acl/src/event/events_epoll_thr.c"
                                    , event_thr->fdslots + 1, sizeof(EVENT_BUFFER))
                        ;

 acl_msg_info("%s(%d), %s, use %s", "/workspace/acl/lib_acl/src/event/events_epoll_thr.c", 609, __FUNCTION__,
