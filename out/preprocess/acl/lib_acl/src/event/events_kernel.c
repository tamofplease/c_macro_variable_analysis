# 0 "/acl/lib_acl/src/event/events_kernel.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/event/events_kernel.c"
...
# 2 "/acl/lib_acl/src/event/events_kernel.c" 2
# 36 "/acl/lib_acl/src/event/events_kernel.c"
...
# 37 "/acl/lib_acl/src/event/events_kernel.c" 2
...
# 41 "/acl/lib_acl/src/event/events_kernel.c" 2
# 1 "/acl/lib_acl/src/event/events_devpoll.h" 1
# 42 "/acl/lib_acl/src/event/events_kernel.c" 2
# 1 "/acl/lib_acl/src/event/events_kqueue.h" 1
# 43 "/acl/lib_acl/src/event/events_kernel.c" 2
...
# 44 "/acl/lib_acl/src/event/events_kernel.c" 2
...
# 45 "/acl/lib_acl/src/event/events_kernel.c" 2
...
# 1 "/acl/lib_acl/include/stdlib/acl_meter_time.h" 1
# 64 "/acl/lib_acl/src/event/events_kernel.c" 2
...
static void stream_on_close(ACL_VSTREAM *stream, void *arg)
{
 ...
 if (fdp == 
# 73 "/acl/lib_acl/src/event/events_kernel.c" 3 4
           ((void *)0)
# 73 "/acl/lib_acl/src/event/events_kernel.c"
               ) {
  return;
 }
...
# 81 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLHUP 
# 81 "/acl/lib_acl/src/event/events_kernel.c"
 | 
# 81 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLERR
# 81 "/acl/lib_acl/src/event/events_kernel.c"
...
# 115 "/acl/lib_acl/src/event/events_kernel.c"
 if (err < 0) {
...
# 144 "/acl/lib_acl/src/event/events_kernel.c" 3 4
                                     ((void *)0)
# 144 "/acl/lib_acl/src/event/events_kernel.c"
                                         ;
 }
 ...
 stream->fdp = 
# 149 "/acl/lib_acl/src/event/events_kernel.c" 3 4
              ((void *)0)
# 149 "/acl/lib_acl/src/event/events_kernel.c"
                  ;
}
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 if (fdp == 
# 159 "/acl/lib_acl/src/event/events_kernel.c" 3 4
           ((void *)0)
# 159 "/acl/lib_acl/src/event/events_kernel.c"
               ) {
...
# 178 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 ((void) sizeof ((
# 178 "/acl/lib_acl/src/event/events_kernel.c"
 (fdp->flag & (1 << 1))
# 178 "/acl/lib_acl/src/event/events_kernel.c" 3 4
...
# 178 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 , "/acl/lib_acl/src/event/events_kernel.c", 178, __extension__ __PRETTY_FUNCTION__); }))
# 178 "/acl/lib_acl/src/event/events_kernel.c"
                                                  ;
...
# 207 "/acl/lib_acl/src/event/events_kernel.c" 3 4
                          ((void *)0) 
# 207 "/acl/lib_acl/src/event/events_kernel.c"
                          ? -1 : (stream)->read_cnt) > 0)
  eventp->read_ready++;
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 if (fdp == 
# 248 "/acl/lib_acl/src/event/events_kernel.c" 3 4
           ((void *)0)
# 248 "/acl/lib_acl/src/event/events_kernel.c"
               ) {
  fdp = event_fdtable_alloc();
...
# 264 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 ((void) sizeof ((
# 264 "/acl/lib_acl/src/event/events_kernel.c"
 (fdp->flag & (1 << 2))
# 264 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 264 "/acl/lib_acl/src/event/events_kernel.c"
...
# 264 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 , "/acl/lib_acl/src/event/events_kernel.c", 264, __extension__ __PRETTY_FUNCTION__); }))
# 264 "/acl/lib_acl/src/event/events_kernel.c"
                                                   ;
...
static void event_disable_read(ACL_EVENT *eventp, ACL_VSTREAM *stream)
{
 ...
 if (fdp == 
# 307 "/acl/lib_acl/src/event/events_kernel.c" 3 4
           ((void *)0)
# 307 "/acl/lib_acl/src/event/events_kernel.c"
               ) {
...
DEL_READ_TAG:
 ...
 fdp->r_timeout = 0;
 fdp->r_callback = 
# 340 "/acl/lib_acl/src/event/events_kernel.c" 3 4
                  ((void *)0)
# 340 "/acl/lib_acl/src/event/events_kernel.c"
                      ;
...
# 363 "/acl/lib_acl/src/event/events_kernel.c" 3 4
                                   ((void *)0)
# 363 "/acl/lib_acl/src/event/events_kernel.c"
                                       ;
 }
 fdp->fdidx_ready = -1;
}
...
static void event_disable_write(ACL_EVENT *eventp, ACL_VSTREAM *stream)
{
 ...
 if (fdp == 
# 376 "/acl/lib_acl/src/event/events_kernel.c" 3 4
           ((void *)0)
# 376 "/acl/lib_acl/src/event/events_kernel.c"
               ) {
...
DEL_WRITE_TAG:
 ...
 fdp->w_timeout = 0;
 fdp->w_callback = 
# 408 "/acl/lib_acl/src/event/events_kernel.c" 3 4
                  ((void *)0)
# 408 "/acl/lib_acl/src/event/events_kernel.c"
                      ;
 ...
 if (fdp->fdidx_ready >= 0
  ...
  eventp->ready[fdp->fdidx_ready] = 
# 430 "/acl/lib_acl/src/event/events_kernel.c" 3 4
                                   ((void *)0)
# 430 "/acl/lib_acl/src/event/events_kernel.c"
                                       ;
 }
 fdp->fdidx_ready = -1;
}
...
static void event_disable_readwrite(ACL_EVENT *eventp, ACL_VSTREAM *stream)
{
 ...
 if (fdp == 
# 445 "/acl/lib_acl/src/event/events_kernel.c" 3 4
           ((void *)0)
# 445 "/acl/lib_acl/src/event/events_kernel.c"
               ) {
  return;
 }
 ...
 if (fdp->flag == 0 || fdp->fdidx < 0 || fdp->fdidx >= eventp->fdcnt) {
  ...
  event_fdtable_free(fdp);
  stream->fdp = 
# 453 "/acl/lib_acl/src/event/events_kernel.c" 3 4
               ((void *)0)
# 453 "/acl/lib_acl/src/event/events_kernel.c"
                   ;
  return;
 }
 ...
 do { struct epoll_event dummy; memset(&dummy, 0, sizeof(dummy)); dummy.events = ((0)) | 
# 467 "/acl/lib_acl/src/event/events_kernel.c" 3 4
EPOLLHUP 
# 467 "/acl/lib_acl/src/event/events_kernel.c"
| 
# 467 "/acl/lib_acl/src/event/events_kernel.c" 3 4
EPOLLERR
# 467 "/acl/lib_acl/src/event/events_kernel.c"
...
# 477 "/acl/lib_acl/src/event/events_kernel.c"
 if (err < 0) {
 ...
 if (fdp->fdidx_ready >= 0
     ...
     && eventp->ready[fdp->fdidx_ready] == fdp) {
  eventp->ready[fdp->fdidx_ready] = 
# 488 "/acl/lib_acl/src/event/events_kernel.c" 3 4
                                   ((void *)0)
# 488 "/acl/lib_acl/src/event/events_kernel.c"
                                       ;
 }
 fdp->fdidx_ready = -1;
 event_fdtable_free(fdp);
 stream->fdp = 
# 492 "/acl/lib_acl/src/event/events_kernel.c" 3 4
              ((void *)0)
# 492 "/acl/lib_acl/src/event/events_kernel.c"
                  ;
}
...
# 508 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLIN 
# 508 "/acl/lib_acl/src/event/events_kernel.c"
 | 
# 508 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLOUT
# 508 "/acl/lib_acl/src/event/events_kernel.c"
...
# 508 "/acl/lib_acl/src/event/events_kernel.c"
  ...
  do { struct epoll_event dummy; memset(&dummy, 0, sizeof(dummy)); dummy.events = ((
# 511 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLIN
# 511 "/acl/lib_acl/src/event/events_kernel.c"
 )) | 
# 511 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLHUP 
# 511 "/acl/lib_acl/src/event/events_kernel.c"
...
static void enable_write(EVENT_KERNEL *ev, ACL_EVENT_FDTABLE *fdp)
{
 ...
 if ((fdp->flag & (1 << 1))) {
  ...
  do { struct epoll_event dummy; memset(&dummy, 0, sizeof(dummy)); dummy.events = ((
# 532 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLIN 
# 532 "/acl/lib_acl/src/event/events_kernel.c"
 | 
# 532 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLOUT
# 532 "/acl/lib_acl/src/event/events_kernel.c"
...
# 532 "/acl/lib_acl/src/event/events_kernel.c"
  ...
  do { struct epoll_event dummy; memset(&dummy, 0, sizeof(dummy)); dummy.events = ((
# 535 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLOUT
# 535 "/acl/lib_acl/src/event/events_kernel.c"
 )) | 
# 535 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLHUP 
# 535 "/acl/lib_acl/src/event/events_kernel.c"
...
static int disable_read(EVENT_KERNEL *ev, ACL_EVENT_FDTABLE *fdp)
{
 ...
 if ((fdp->flag & (1 << 2))) {
  ...
  do { struct epoll_event dummy; memset(&dummy, 0, sizeof(dummy)); dummy.events = ((
# 559 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLOUT
# 559 "/acl/lib_acl/src/event/events_kernel.c"
 )) | 
# 559 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLHUP 
# 559 "/acl/lib_acl/src/event/events_kernel.c"
...
# 559 "/acl/lib_acl/src/event/events_kernel.c"
  ...
  do { struct epoll_event dummy; memset(&dummy, 0, sizeof(dummy)); dummy.events = ((0)) | 
# 563 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLHUP 
# 563 "/acl/lib_acl/src/event/events_kernel.c"
 | 
# 563 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLERR
# 563 "/acl/lib_acl/src/event/events_kernel.c"
...
static int disable_write(EVENT_KERNEL *ev, ACL_EVENT_FDTABLE *fdp)
{
 ...
 if ((fdp->flag & (1 << 1))) {
  ...
  do { struct epoll_event dummy; memset(&dummy, 0, sizeof(dummy)); dummy.events = ((
# 595 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLIN
# 595 "/acl/lib_acl/src/event/events_kernel.c"
 )) | 
# 595 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLHUP 
# 595 "/acl/lib_acl/src/event/events_kernel.c"
...
# 595 "/acl/lib_acl/src/event/events_kernel.c"
  ...
  do { struct epoll_event dummy; memset(&dummy, 0, sizeof(dummy)); dummy.events = ((0)) | 
# 602 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLHUP 
# 602 "/acl/lib_acl/src/event/events_kernel.c"
 | 
# 602 "/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLERR
# 602 "/acl/lib_acl/src/event/events_kernel.c"
...
static void event_set_all(ACL_EVENT *eventp)
{
 ...
 while (1) {
  ...
  if (r == 
# 636 "/acl/lib_acl/src/event/events_kernel.c" 3 4
          ((void *)0)
# 636 "/acl/lib_acl/src/event/events_kernel.c"
              )
   break;
  fdp = ((ACL_EVENT_FDTABLE *) (((char *) (r)) - 
# 638 "/acl/lib_acl/src/event/events_kernel.c" 3 4
       __builtin_offsetof (
# 638 "/acl/lib_acl/src/event/events_kernel.c"
       ACL_EVENT_FDTABLE
# 638 "/acl/lib_acl/src/event/events_kernel.c" 3 4
       , 
# 638 "/acl/lib_acl/src/event/events_kernel.c"
...
# 673 "/acl/lib_acl/src/event/events_kernel.c" 3 4
((void *)0)
# 673 "/acl/lib_acl/src/event/events_kernel.c"
 ...
 if (nready < 0) {
  if (acl_last_error() != 
# 716 "/acl/lib_acl/src/event/events_kernel.c" 3 4
                         4
# 716 "/acl/lib_acl/src/event/events_kernel.c"
                                  ) {
   acl_msg_error("%s(%d), %s: select: %s", "/acl/lib_acl/src/event/events_kernel.c",
...
# 743 "/acl/lib_acl/src/event/events_kernel.c"
  fdp = (ACL_EVENT_FDTABLE *) ((bp)->data.ptr);
  if (fdp == 
# 744 "/acl/lib_acl/src/event/events_kernel.c" 3 4
            ((void *)0) 
# 744 "/acl/lib_acl/src/event/events_kernel.c"
                 || fdp->stream == 
# 744 "/acl/lib_acl/src/event/events_kernel.c" 3 4
                                   ((void *)0)
# 744 "/acl/lib_acl/src/event/events_kernel.c"
  ...
  if ((fdp->flag & (1 << 1))
      && (((bp)->events) & 
# 758 "/acl/lib_acl/src/event/events_kernel.c" 3 4
        EPOLLIN
# 758 "/acl/lib_acl/src/event/events_kernel.c"
        )) {
  ...
  if ((fdp->flag & (1 << 2))
      && (((bp)->events) & 
# 782 "/acl/lib_acl/src/event/events_kernel.c" 3 4
        EPOLLOUT
# 782 "/acl/lib_acl/src/event/events_kernel.c"
        )) {
  ...
  if ((((bp)->events) & (
# 794 "/acl/lib_acl/src/event/events_kernel.c" 3 4
     EPOLLERR 
# 794 "/acl/lib_acl/src/event/events_kernel.c"
     | 
# 794 "/acl/lib_acl/src/event/events_kernel.c" 3 4
     EPOLLHUP
# 794 "/acl/lib_acl/src/event/events_kernel.c"
...
static int event_isrset(ACL_EVENT *eventp __attribute__ ((__unused__)), ACL_VSTREAM *stream)
{
 ...
 return fdp == 
# 823 "/acl/lib_acl/src/event/events_kernel.c" 3 4
              ((void *)0) 
# 823 "/acl/lib_acl/src/event/events_kernel.c"
                   ? 0 : (fdp->flag & (1 << 1));
}
...
static int event_iswset(ACL_EVENT *eventp __attribute__ ((__unused__)), ACL_VSTREAM *stream)
{
 ...
 return fdp == 
# 830 "/acl/lib_acl/src/event/events_kernel.c" 3 4
              ((void *)0) 
# 830 "/acl/lib_acl/src/event/events_kernel.c"
                   ? 0 : (fdp->flag & (1 << 2));
...
static int event_isxset(ACL_EVENT *eventp __attribute__ ((__unused__)), ACL_VSTREAM *stream)
{
 ...
 return fdp == 
# 838 "/acl/lib_acl/src/event/events_kernel.c" 3 4
              ((void *)0) 
# 838 "/acl/lib_acl/src/event/events_kernel.c"
                   ? 0 : (fdp->flag & (1 << 3));
}
...
static void event_free(ACL_EVENT *eventp)
{
 ...
 do { if (ev->event_buf) { acl_free_glue("/acl/lib_acl/src/event/events_kernel.c", 848, (ev->event_buf)); (ev->event_buf) = 
# 848 "/acl/lib_acl/src/event/events_kernel.c" 3 4
((void *)0)
# 848 "/acl/lib_acl/src/event/events_kernel.c"
; } } while (0);
 close(ev->event_fd);
 do { if (ev) { acl_free_glue("/acl/lib_acl/src/event/events_kernel.c", 850, (ev)); (ev) = 
# 850 "/acl/lib_acl/src/event/events_kernel.c" 3 4
((void *)0)
# 850 "/acl/lib_acl/src/event/events_kernel.c"
; } } while (0);
}
...
ACL_EVENT *event_new_kernel(int fdsize __attribute__ ((__unused__)))
{
 ...
 ev->event_buf = (EVENT_BUFFER *)
  acl_calloc_glue("/acl/lib_acl/src/event/events_kernel.c", 885, ev->event_fdslots + 1, sizeof(EVENT_BUFFER));
