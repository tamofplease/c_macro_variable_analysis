# 1 "/workspace/acl/lib_acl/src/event/events_kernel.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/event/events_kernel.c" 2
# 36 "/workspace/acl/lib_acl/src/event/events_kernel.c"
...
# 37 "/workspace/acl/lib_acl/src/event/events_kernel.c" 2
...
# 41 "/workspace/acl/lib_acl/src/event/events_kernel.c" 2
# 1 "/workspace/acl/lib_acl/src/event/events_devpoll.h" 1
# 42 "/workspace/acl/lib_acl/src/event/events_kernel.c" 2
# 1 "/workspace/acl/lib_acl/src/event/events_kqueue.h" 1
# 43 "/workspace/acl/lib_acl/src/event/events_kernel.c" 2
...
# 44 "/workspace/acl/lib_acl/src/event/events_kernel.c" 2
...
# 45 "/workspace/acl/lib_acl/src/event/events_kernel.c" 2
...
# 1 "/workspace/acl/lib_acl/include/stdlib/acl_meter_time.h" 1
# 64 "/workspace/acl/lib_acl/src/event/events_kernel.c" 2
...
static void stream_on_close(ACL_VSTREAM *stream, void *arg)
{
 ...
 int sockfd = ((stream)->fd.sock);
 int err = 0, ret = 0;

 if (fdp == 
# 73 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
           ((void *)0)
# 73 "/workspace/acl/lib_acl/src/event/events_kernel.c"
               ) {
  return;
 }
...
# 81 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLHUP 
# 81 "/workspace/acl/lib_acl/src/event/events_kernel.c"
 | 
# 81 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLERR
# 81 "/workspace/acl/lib_acl/src/event/events_kernel.c"
...
# 115 "/workspace/acl/lib_acl/src/event/events_kernel.c"
 if (err < 0) {
  acl_msg_error("%s: %s: %s, err(%d), fd(%d), ret(%d)",
   myname, "epoll_ctl EPOLL_CTL_DEL", acl_last_serror(),
   err, sockfd, ret);
 }
 ...
 if (ev->event.maxfd == ((fdp->stream)->fd.sock)) {
  ev->event.maxfd = (int) -1;
 }
 ...
 if (fdp->fdidx_ready >= 0
  ...
  ev->event.ready[fdp->fdidx_ready] = 
# 144 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
                                     ((void *)0)
# 144 "/workspace/acl/lib_acl/src/event/events_kernel.c"
                                         ;
 }
 ...
 stream->fdp = 
# 149 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
              ((void *)0)
# 149 "/workspace/acl/lib_acl/src/event/events_kernel.c"
                  ;
}
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 if (fdp == 
# 159 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
           ((void *)0)
# 159 "/workspace/acl/lib_acl/src/event/events_kernel.c"
               ) {
 ...
 } else if ((fdp->flag & (1 << 4))) {
  goto END;
 } else if ((fdp->flag & (1 << 6))) {



  
# 178 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 ((void) sizeof ((
# 178 "/workspace/acl/lib_acl/src/event/events_kernel.c"
 (fdp->flag & (1 << 1))
# 178 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
...
# 178 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 , "/workspace/acl/lib_acl/src/event/events_kernel.c", 178, __extension__ __PRETTY_FUNCTION__); }))
# 178 "/workspace/acl/lib_acl/src/event/events_kernel.c"
                                                  ;
...
END:
 ...
 if (stream->read_ready || ((stream) == 
# 207 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
                          ((void *)0) 
# 207 "/workspace/acl/lib_acl/src/event/events_kernel.c"
                          ? -1 : (stream)->read_cnt) > 0)
  eventp->read_ready++;
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 fdp->listener = acl_is_listening_socket(((stream)->fd.sock));
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 if (fdp == 
# 248 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
           ((void *)0)
# 248 "/workspace/acl/lib_acl/src/event/events_kernel.c"
               ) {
  fdp = event_fdtable_alloc();
 ...
 } else if ((fdp->flag & (1 << 5))) {
  goto END;
 } else if ((fdp->flag & (1 << 7))) {
  
# 264 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 ((void) sizeof ((
# 264 "/workspace/acl/lib_acl/src/event/events_kernel.c"
 (fdp->flag & (1 << 2))
# 264 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 264 "/workspace/acl/lib_acl/src/event/events_kernel.c"
...
# 264 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 , "/workspace/acl/lib_acl/src/event/events_kernel.c", 264, __extension__ __PRETTY_FUNCTION__); }))
# 264 "/workspace/acl/lib_acl/src/event/events_kernel.c"
                                                   ;
...
static void event_disable_read(ACL_EVENT *eventp, ACL_VSTREAM *stream)
{
 ...
 if (fdp == 
# 307 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
           ((void *)0)
# 307 "/workspace/acl/lib_acl/src/event/events_kernel.c"
               ) {
  acl_msg_warn("%s(%d): fdp null", myname, 308);
  return;
 }
 if (fdp->fdidx < 0 || fdp->fdidx >= eventp->fdcnt) {
  acl_msg_warn("%s(%d): sockfd(%d)'s fdidx(%d) invalid, fdcnt: %d",
   myname, 313, ((stream)->fd.sock),
   fdp->fdidx, eventp->fdcnt);
  return;
 }
 if ((fdp->flag & (1 << 6))) {
...
DEL_READ_TAG:
 ...
 fdp->r_timeout = 0;
 fdp->r_callback = 
# 340 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
                  ((void *)0)
# 340 "/workspace/acl/lib_acl/src/event/events_kernel.c"
                      ;
 fdp->event_type &= ~((1 << 0) | (1 << 1));
 ...
 if (eventp->maxfd == ((fdp->stream)->fd.sock)) {
  eventp->maxfd = (int) -1;
 }
...
# 363 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
                                   ((void *)0)
# 363 "/workspace/acl/lib_acl/src/event/events_kernel.c"
                                       ;
 }
 fdp->fdidx_ready = -1;
}
...
static void event_disable_write(ACL_EVENT *eventp, ACL_VSTREAM *stream)
{
 ...
 if (fdp == 
# 376 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
           ((void *)0)
# 376 "/workspace/acl/lib_acl/src/event/events_kernel.c"
               ) {
  acl_msg_warn("%s(%d): fdp null", myname, 377);
  return;
 }
 if (fdp->fdidx < 0 || fdp->fdidx >= eventp->fdcnt) {
  acl_msg_warn("%s(%d): sockfd(%d)'s fdidx(%d) invalid",
   myname, 382, ((stream)->fd.sock), fdp->fdidx);
  return;
 }
 if ((fdp->flag & (1 << 7))) {
  return;
...
DEL_WRITE_TAG:
 ...
 fdp->w_timeout = 0;
 fdp->w_callback = 
# 408 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
                  ((void *)0)
# 408 "/workspace/acl/lib_acl/src/event/events_kernel.c"
                      ;
 fdp->event_type &= ~((1 << 2) | (1 << 3));
 ...
 if (eventp->maxfd == ((stream)->fd.sock)) {
  eventp->maxfd = (int) -1;
 }
 ...
 if (fdp->fdidx_ready >= 0
  ...
  eventp->ready[fdp->fdidx_ready] = 
# 430 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
                                   ((void *)0)
# 430 "/workspace/acl/lib_acl/src/event/events_kernel.c"
                                       ;
 }
 fdp->fdidx_ready = -1;
}
...
static void event_disable_readwrite(ACL_EVENT *eventp, ACL_VSTREAM *stream)
{
 ...
 if (fdp == 
# 445 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
           ((void *)0)
# 445 "/workspace/acl/lib_acl/src/event/events_kernel.c"
               ) {
  return;
 }
 ...
 if (fdp->flag == 0 || fdp->fdidx < 0 || fdp->fdidx >= eventp->fdcnt) {
  ...
  event_fdtable_free(fdp);
  stream->fdp = 
# 453 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
               ((void *)0)
# 453 "/workspace/acl/lib_acl/src/event/events_kernel.c"
                   ;
  return;
 }
 ...
 do { struct epoll_event dummy; memset(&dummy, 0, sizeof(dummy)); dummy.events = ((0)) | 
# 467 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
EPOLLHUP 
# 467 "/workspace/acl/lib_acl/src/event/events_kernel.c"
| 
# 467 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
EPOLLERR
# 467 "/workspace/acl/lib_acl/src/event/events_kernel.c"
...
# 477 "/workspace/acl/lib_acl/src/event/events_kernel.c"
 if (err < 0) {
  acl_msg_error("%s: %s: %s", myname, "epoll_ctl EPOLL_CTL_DEL",
   acl_last_serror());
 }
 ...
 if (fdp->fdidx_ready >= 0
     ...
     && eventp->ready[fdp->fdidx_ready] == fdp) {
  eventp->ready[fdp->fdidx_ready] = 
# 488 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
                                   ((void *)0)
# 488 "/workspace/acl/lib_acl/src/event/events_kernel.c"
                                       ;
 }
 fdp->fdidx_ready = -1;
 event_fdtable_free(fdp);
 stream->fdp = 
# 492 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
              ((void *)0)
# 492 "/workspace/acl/lib_acl/src/event/events_kernel.c"
                  ;
}
...
# 508 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLIN 
# 508 "/workspace/acl/lib_acl/src/event/events_kernel.c"
 | 
# 508 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLOUT
# 508 "/workspace/acl/lib_acl/src/event/events_kernel.c"
...
# 508 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLERR
# 508 "/workspace/acl/lib_acl/src/event/events_kernel.c"
 ; dummy.data.ptr = ((fdp)); (((err))) = epoll_ctl(((ev->event_fd)), (
# 508 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 3
# 508 "/workspace/acl/lib_acl/src/event/events_kernel.c"
 ), (((sockfd))), &dummy); } while (0);
  ...
  do { struct epoll_event dummy; memset(&dummy, 0, sizeof(dummy)); dummy.events = ((
# 511 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLIN
# 511 "/workspace/acl/lib_acl/src/event/events_kernel.c"
 )) | 
# 511 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLHUP 
# 511 "/workspace/acl/lib_acl/src/event/events_kernel.c"
...
# 511 "/workspace/acl/lib_acl/src/event/events_kernel.c"
 ...
 if (err < 0) {
  acl_msg_error("%s: %s: %s, err(%d), fd(%d)", myname,
   "epoll_ctl EPOLL_CTL_ADD", acl_last_serror(), err, sockfd);
 }
}
...
static void enable_write(EVENT_KERNEL *ev, ACL_EVENT_FDTABLE *fdp)
{
 ...
 if ((fdp->flag & (1 << 1))) {
  ...
  do { struct epoll_event dummy; memset(&dummy, 0, sizeof(dummy)); dummy.events = ((
# 532 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLIN 
# 532 "/workspace/acl/lib_acl/src/event/events_kernel.c"
 | 
# 532 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLOUT
# 532 "/workspace/acl/lib_acl/src/event/events_kernel.c"
...
# 532 "/workspace/acl/lib_acl/src/event/events_kernel.c"
  ...
  do { struct epoll_event dummy; memset(&dummy, 0, sizeof(dummy)); dummy.events = ((
# 535 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLOUT
# 535 "/workspace/acl/lib_acl/src/event/events_kernel.c"
 )) | 
# 535 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLHUP 
# 535 "/workspace/acl/lib_acl/src/event/events_kernel.c"
...
static int disable_read(EVENT_KERNEL *ev, ACL_EVENT_FDTABLE *fdp)
{
 ...
 if ((fdp->flag & (1 << 2))) {
  ...
  do { struct epoll_event dummy; memset(&dummy, 0, sizeof(dummy)); dummy.events = ((
# 559 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLOUT
# 559 "/workspace/acl/lib_acl/src/event/events_kernel.c"
 )) | 
# 559 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLHUP 
# 559 "/workspace/acl/lib_acl/src/event/events_kernel.c"
...
# 559 "/workspace/acl/lib_acl/src/event/events_kernel.c"
  ...
  do { struct epoll_event dummy; memset(&dummy, 0, sizeof(dummy)); dummy.events = ((0)) | 
# 563 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLHUP 
# 563 "/workspace/acl/lib_acl/src/event/events_kernel.c"
 | 
# 563 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLERR
# 563 "/workspace/acl/lib_acl/src/event/events_kernel.c"
...
# 563 "/workspace/acl/lib_acl/src/event/events_kernel.c"
 ...
 if (err < 0) {
  acl_msg_error("%s: %s: %s, err(%d), fd(%d), ret(%d)", myname,
   "epoll_ctl EPOLL_CTL_DEL", acl_last_serror(), err, sockfd, ret);
 }
 return ret;
}
...
static int disable_write(EVENT_KERNEL *ev, ACL_EVENT_FDTABLE *fdp)
{
 ...
 if ((fdp->flag & (1 << 1))) {
  ...
  do { struct epoll_event dummy; memset(&dummy, 0, sizeof(dummy)); dummy.events = ((
# 595 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLIN
# 595 "/workspace/acl/lib_acl/src/event/events_kernel.c"
 )) | 
# 595 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLHUP 
# 595 "/workspace/acl/lib_acl/src/event/events_kernel.c"
...
# 595 "/workspace/acl/lib_acl/src/event/events_kernel.c"
  ...
  do { struct epoll_event dummy; memset(&dummy, 0, sizeof(dummy)); dummy.events = ((0)) | 
# 602 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLHUP 
# 602 "/workspace/acl/lib_acl/src/event/events_kernel.c"
 | 
# 602 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
 EPOLLERR
# 602 "/workspace/acl/lib_acl/src/event/events_kernel.c"
...
static void event_set_all(ACL_EVENT *eventp)
{
 ...
 while (1) {
  ...
  if (r == 
# 636 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
          ((void *)0)
# 636 "/workspace/acl/lib_acl/src/event/events_kernel.c"
              )
   break;
  fdp = ((ACL_EVENT_FDTABLE *) (((char *) (r)) - 
# 638 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
       __builtin_offsetof (
# 638 "/workspace/acl/lib_acl/src/event/events_kernel.c"
       ACL_EVENT_FDTABLE
# 638 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
       , 
# 638 "/workspace/acl/lib_acl/src/event/events_kernel.c"
...
# 673 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
((void *)0)
# 673 "/workspace/acl/lib_acl/src/event/events_kernel.c"
 ...
 if (eventp->fdcnt == 0) {
  if (eventp->ready_cnt == 0) {
   acl_doze(delay > 1000 ? (int) delay / 1000 : 10);
  }
 ...
 do { (nready) = epoll_wait(ev->event_fd, (ev->event_buf), (ev->event_fdslots), ((int) (delay / 1000)) < 0 ? -1 : ((int) (delay / 1000))); } while (0)
                                          ;

 if (eventp->nested++ > 0) {
  acl_msg_error("%s(%d): recursive call, nested: %d",
   myname, 712, eventp->nested);
  exit (1);
 }
 if (nready < 0) {
  if (acl_last_error() != 
# 716 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
                         4
# 716 "/workspace/acl/lib_acl/src/event/events_kernel.c"
                                  ) {
   acl_msg_error("%s(%d), %s: select: %s", "/workspace/acl/lib_acl/src/event/events_kernel.c",
    718, myname, acl_last_serror());
   exit (1);
  }
...
# 743 "/workspace/acl/lib_acl/src/event/events_kernel.c"
  fdp = (ACL_EVENT_FDTABLE *) ((bp)->data.ptr);
  if (fdp == 
# 744 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
            ((void *)0) 
# 744 "/workspace/acl/lib_acl/src/event/events_kernel.c"
                 || fdp->stream == 
# 744 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
                                   ((void *)0)
# 744 "/workspace/acl/lib_acl/src/event/events_kernel.c"
  ...
  if ((fdp->flag & (1 << 1))
      && (((bp)->events) & 
# 758 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
        EPOLLIN
# 758 "/workspace/acl/lib_acl/src/event/events_kernel.c"
        )) {

   if ((fdp->event_type & ((1 << 0)
    | (1 << 2))) == 0) {
  ...
  if ((fdp->flag & (1 << 2))
      && (((bp)->events) & 
# 782 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
        EPOLLOUT
# 782 "/workspace/acl/lib_acl/src/event/events_kernel.c"
        )) {
  ...
  if ((((bp)->events) & (
# 794 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
     EPOLLERR 
# 794 "/workspace/acl/lib_acl/src/event/events_kernel.c"
     | 
# 794 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
     EPOLLHUP
# 794 "/workspace/acl/lib_acl/src/event/events_kernel.c"
...
static int event_isrset(ACL_EVENT *eventp __attribute__ ((__unused__)), ACL_VSTREAM *stream)
{
 ...
 return fdp == 
# 823 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
              ((void *)0) 
# 823 "/workspace/acl/lib_acl/src/event/events_kernel.c"
                   ? 0 : (fdp->flag & (1 << 1));
}
...
static int event_iswset(ACL_EVENT *eventp __attribute__ ((__unused__)), ACL_VSTREAM *stream)
{
 ...
 return fdp == 
# 830 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
              ((void *)0) 
# 830 "/workspace/acl/lib_acl/src/event/events_kernel.c"
                   ? 0 : (fdp->flag & (1 << 2));
...
static int event_isxset(ACL_EVENT *eventp __attribute__ ((__unused__)), ACL_VSTREAM *stream)
{
 ...
 return fdp == 
# 838 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
              ((void *)0) 
# 838 "/workspace/acl/lib_acl/src/event/events_kernel.c"
                   ? 0 : (fdp->flag & (1 << 3));
}
...
static void event_free(ACL_EVENT *eventp)
{
 ...
 do { if (ev->event_buf) { acl_free_glue("/workspace/acl/lib_acl/src/event/events_kernel.c", 848, (ev->event_buf)); (ev->event_buf) = 
# 848 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
((void *)0)
# 848 "/workspace/acl/lib_acl/src/event/events_kernel.c"
; } } while (0);
 close(ev->event_fd);
 do { if (ev) { acl_free_glue("/workspace/acl/lib_acl/src/event/events_kernel.c", 850, (ev)); (ev) = 
# 850 "/workspace/acl/lib_acl/src/event/events_kernel.c" 3 4
((void *)0)
# 850 "/workspace/acl/lib_acl/src/event/events_kernel.c"
; } } while (0);
}

ACL_EVENT *event_new_kernel(int fdsize __attribute__ ((__unused__)))
{
 ACL_EVENT *eventp;
 EVENT_KERNEL *ev;
 ...
 snprintf(eventp->name, sizeof(eventp->name), "events - %s", "epoll");
 eventp->event_mode = 2;
 eventp->use_thread = 0;
 ...
 do { ev->event_fd = epoll_create(fdsize); } while (0);
 acl_close_on_exec(ev->event_fd, 1);
 ev->event_fdslots = __default_max_events;
 ev->event_buf = (EVENT_BUFFER *)
  acl_calloc_glue("/workspace/acl/lib_acl/src/event/events_kernel.c", 885, ev->event_fdslots + 1, sizeof(EVENT_BUFFER));
