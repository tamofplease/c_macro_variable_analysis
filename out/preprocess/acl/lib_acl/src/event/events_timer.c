# 1 "/workspace/acl/lib_acl/src/event/events_timer.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/event/events_timer.c" 2
# 22 "/workspace/acl/lib_acl/src/event/events_timer.c"
...
# 23 "/workspace/acl/lib_acl/src/event/events_timer.c" 2
...
# 62 "/workspace/acl/lib_acl/src/event/events_timer.c"
static int avl_cmp_fn(const void *v1, const void *v2)
{
 ...
 long long int ret = n1->when - n2->when;
...
void event_timer_create(ACL_EVENT *eventp)
{
 eventp->timers = (EVENT_TIMERS*) acl_malloc_glue("/workspace/acl/lib_acl/src/event/events_timer.c", 79, sizeof(EVENT_TIMERS));
 eventp->timers->table = acl_htable_create(1024, 0);
 avl_create(&eventp->timers->avl, avl_cmp_fn, sizeof(TIMER_INFO),
     
# 82 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
    __builtin_offsetof (
# 82 "/workspace/acl/lib_acl/src/event/events_timer.c"
    TIMER_NODE
# 82 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
    , 
# 82 "/workspace/acl/lib_acl/src/event/events_timer.c"
...
void event_timer_free(ACL_EVENT *eventp)
{
 ...
 while (node) {
  next = avl_walk(&eventp->timers->avl, node, (1));
  do { if (node) { acl_free_glue("/workspace/acl/lib_acl/src/event/events_timer.c", 98, (node)); (node) = 
# 98 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
 ((void *)0)
# 98 "/workspace/acl/lib_acl/src/event/events_timer.c"
 ; } } while (0);
  node = next;
 }

 acl_htable_free(eventp->timers->table, acl_free_fn_glue);
 do { if (eventp->timers) { acl_free_glue("/workspace/acl/lib_acl/src/event/events_timer.c", 103, (eventp->timers)); (eventp->timers) = 
# 103 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
((void *)0)
# 103 "/workspace/acl/lib_acl/src/event/events_timer.c"
; } } while (0);
}
...
{
 if (node->tail == 
# 110 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
                  ((void *)0)
# 110 "/workspace/acl/lib_acl/src/event/events_timer.c"
                      ) {
  info->prev = info->next = 
# 111 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
                           ((void *)0)
# 111 "/workspace/acl/lib_acl/src/event/events_timer.c"
                               ;
  ...
  info->prev = node->tail;
  info->next = 
# 116 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
              ((void *)0)
# 116 "/workspace/acl/lib_acl/src/event/events_timer.c"
                  ;
  node->tail = info;
 }
 info->node = node;
...
# 127 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
((void) sizeof ((
# 127 "/workspace/acl/lib_acl/src/event/events_timer.c"
node
# 127 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
...
"node"
# 127 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
, "/workspace/acl/lib_acl/src/event/events_timer.c", 127, __extension__ __PRETTY_FUNCTION__); }))
# 127 "/workspace/acl/lib_acl/src/event/events_timer.c"
                ;
 if (info->prev) {
 ...
 info->node = 
# 138 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
             ((void *)0)
# 138 "/workspace/acl/lib_acl/src/event/events_timer.c"
                 ;

 if (node->head == 
# 140 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
                  ((void *)0)
# 140 "/workspace/acl/lib_acl/src/event/events_timer.c"
                      ) {
  avl_remove(&eventp->timers->avl, node);
  do { if (node) { acl_free_glue("/workspace/acl/lib_acl/src/event/events_timer.c", 142, (node)); (node) = 
# 142 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
 ((void *)0)
# 142 "/workspace/acl/lib_acl/src/event/events_timer.c"
 ; } } while (0);
  return 1;
 }
 return 0;
...
long long int event_timer_request(ACL_EVENT *eventp, ACL_EVENT_NOTIFY_TIME callback,
 void *context, long long int delay, int keep)
{
 TIMER_INFO *info;
 TIMER_NODE *node, iter;
 char key[128]; snprintf(key, sizeof(key), "%p.%p", callback, context);;


 { struct timeval _tv; gettimeofday(&_tv, 
# 156 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
((void *)0)
# 156 "/workspace/acl/lib_acl/src/event/events_timer.c"
 ...
 if (info == 
# 165 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
            ((void *)0)
# 165 "/workspace/acl/lib_acl/src/event/events_timer.c"
                ) {

  info = (TIMER_INFO *) acl_calloc_glue("/workspace/acl/lib_acl/src/event/events_timer.c", 167, 1, sizeof(TIMER_INFO));
  
# 168 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
 ((void) sizeof ((
# 168 "/workspace/acl/lib_acl/src/event/events_timer.c"
 info
# 168 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 168 "/workspace/acl/lib_acl/src/event/events_timer.c"
...
# 168 "/workspace/acl/lib_acl/src/event/events_timer.c"
 "info"
# 168 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
 , "/workspace/acl/lib_acl/src/event/events_timer.c", 168, __extension__ __PRETTY_FUNCTION__); }))
# 168 "/workspace/acl/lib_acl/src/event/events_timer.c"
                 ;
  info->delay = delay;
  info->keep = keep;
 ...
 node = (TIMER_NODE*) avl_find(&eventp->timers->avl, &iter, 
# 183 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
                                                           ((void *)0)
# 183 "/workspace/acl/lib_acl/src/event/events_timer.c"
                                                               );
 if (node == 
# 184 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
            ((void *)0)
# 184 "/workspace/acl/lib_acl/src/event/events_timer.c"
                ) {
  node = (TIMER_NODE*) acl_calloc_glue("/workspace/acl/lib_acl/src/event/events_timer.c", 185, 1, sizeof(TIMER_NODE));
  node->when = iter.when;
...
static long long int timer_cancel(ACL_EVENT *eventp, TIMER_INFO *info)
{
 ...
 { struct timeval _tv; gettimeofday(&_tv, 
# 211 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
((void *)0)
# 211 "/workspace/acl/lib_acl/src/event/events_timer.c"
); (eventp->present) = ((long long int) _tv.tv_sec) * 1000000 + ((long long int) _tv.tv_usec); };

 acl_htable_delete_entry(eventp->timers->table, info->entry, 
# 213 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
                                                            ((void *)0)
# 213 "/workspace/acl/lib_acl/src/event/events_timer.c"
                                                                );
 
# 214 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
((void) sizeof ((
# 214 "/workspace/acl/lib_acl/src/event/events_timer.c"
info->node
# 214 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 214 "/workspace/acl/lib_acl/src/event/events_timer.c"
...
"info->node"
# 214 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
, "/workspace/acl/lib_acl/src/event/events_timer.c", 214, __extension__ __PRETTY_FUNCTION__); }))
# 214 "/workspace/acl/lib_acl/src/event/events_timer.c"
                      ;
 ...
 if (first == node) {
  first = avl_walk(&eventp->timers->avl, first, (1));
 ...
 do { if (info) { acl_free_glue("/workspace/acl/lib_acl/src/event/events_timer.c", 235, (info)); (info) = 
# 235 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
((void *)0)
# 235 "/workspace/acl/lib_acl/src/event/events_timer.c"
; } } while (0);

 return time_left;
}

long long int event_timer_cancel(ACL_EVENT *eventp,
 ACL_EVENT_NOTIFY_TIME callback, void *context)
{
 TIMER_INFO *info;
 char key[128]; snprintf(key, sizeof(key), "%p.%p", callback, context);;
 ...
 info = (TIMER_INFO*) acl_htable_find(eventp->timers->table, key);
 if (info == 
# 247 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
            ((void *)0)
# 247 "/workspace/acl/lib_acl/src/event/events_timer.c"
                ) {
  return -1;
 }
...
void event_timer_trigger(ACL_EVENT *eventp)
{
 ...
 { struct timeval _tv; gettimeofday(&_tv, 
# 285 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
((void *)0)
# 285 "/workspace/acl/lib_acl/src/event/events_timer.c"
); (eventp->present) = ((long long int) _tv.tv_sec) * 1000000 + ((long long int) _tv.tv_usec); };
 ...
 while (iter) {
  ...
  iter = avl_walk(&eventp->timers->avl, iter, (1));
 }




 while ((ring = acl_ring_pop_head(&eventp->timers_ready)) != 
# 305 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
                                                            ((void *)0)
# 305 "/workspace/acl/lib_acl/src/event/events_timer.c"
                                                                ) {
  info = ((TIMER_INFO *) ((char *) (ring) - 
# 306 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
             __builtin_offsetof (
# 306 "/workspace/acl/lib_acl/src/event/events_timer.c"
             TIMER_INFO
# 306 "/workspace/acl/lib_acl/src/event/events_timer.c" 3 4
             , 
# 306 "/workspace/acl/lib_acl/src/event/events_timer.c"
