# 0 "/acl/lib_acl/src/event/events_timer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/event/events_timer.c"
...
# 2 "/acl/lib_acl/src/event/events_timer.c" 2
# 22 "/acl/lib_acl/src/event/events_timer.c"
...
# 23 "/acl/lib_acl/src/event/events_timer.c" 2
...
# 62 "/acl/lib_acl/src/event/events_timer.c"
...
void event_timer_create(ACL_EVENT *eventp)
{
 eventp->timers = (EVENT_TIMERS*) acl_malloc_glue("/acl/lib_acl/src/event/events_timer.c", 79, sizeof(EVENT_TIMERS));
 eventp->timers->table = acl_htable_create(1024, 0);
 avl_create(&eventp->timers->avl, avl_cmp_fn, sizeof(TIMER_INFO),
     
# 82 "/acl/lib_acl/src/event/events_timer.c" 3 4
    __builtin_offsetof (
# 82 "/acl/lib_acl/src/event/events_timer.c"
    TIMER_NODE
# 82 "/acl/lib_acl/src/event/events_timer.c" 3 4
    , 
# 82 "/acl/lib_acl/src/event/events_timer.c"
...
void event_timer_free(ACL_EVENT *eventp)
{
 ...
 while (node) {
  ...
  do { if (node) { acl_free_glue("/acl/lib_acl/src/event/events_timer.c", 98, (node)); (node) = 
# 98 "/acl/lib_acl/src/event/events_timer.c" 3 4
 ((void *)0)
# 98 "/acl/lib_acl/src/event/events_timer.c"
 ; } } while (0);
  node = next;
 }

 acl_htable_free(eventp->timers->table, acl_free_fn_glue);
 do { if (eventp->timers) { acl_free_glue("/acl/lib_acl/src/event/events_timer.c", 103, (eventp->timers)); (eventp->timers) = 
# 103 "/acl/lib_acl/src/event/events_timer.c" 3 4
((void *)0)
# 103 "/acl/lib_acl/src/event/events_timer.c"
; } } while (0);
}
...
{
 if (node->tail == 
# 110 "/acl/lib_acl/src/event/events_timer.c" 3 4
                  ((void *)0)
# 110 "/acl/lib_acl/src/event/events_timer.c"
                      ) {
  info->prev = info->next = 
# 111 "/acl/lib_acl/src/event/events_timer.c" 3 4
                           ((void *)0)
# 111 "/acl/lib_acl/src/event/events_timer.c"
                               ;
  ...
  info->prev = node->tail;
  info->next = 
# 116 "/acl/lib_acl/src/event/events_timer.c" 3 4
              ((void *)0)
# 116 "/acl/lib_acl/src/event/events_timer.c"
                  ;
  node->tail = info;
 }
 info->node = node;
...
# 127 "/acl/lib_acl/src/event/events_timer.c" 3 4
((void) sizeof ((
# 127 "/acl/lib_acl/src/event/events_timer.c"
node
# 127 "/acl/lib_acl/src/event/events_timer.c" 3 4
...
"node"
# 127 "/acl/lib_acl/src/event/events_timer.c" 3 4
, "/acl/lib_acl/src/event/events_timer.c", 127, __extension__ __PRETTY_FUNCTION__); }))
# 127 "/acl/lib_acl/src/event/events_timer.c"
                ;
 if (info->prev) {
 ...
 info->node = 
# 138 "/acl/lib_acl/src/event/events_timer.c" 3 4
             ((void *)0)
# 138 "/acl/lib_acl/src/event/events_timer.c"
                 ;

 if (node->head == 
# 140 "/acl/lib_acl/src/event/events_timer.c" 3 4
                  ((void *)0)
# 140 "/acl/lib_acl/src/event/events_timer.c"
                      ) {
  avl_remove(&eventp->timers->avl, node);
  do { if (node) { acl_free_glue("/acl/lib_acl/src/event/events_timer.c", 142, (node)); (node) = 
# 142 "/acl/lib_acl/src/event/events_timer.c" 3 4
 ((void *)0)
# 142 "/acl/lib_acl/src/event/events_timer.c"
 ; } } while (0);
  return 1;
 }
 return 0;
...
# 156 "/acl/lib_acl/src/event/events_timer.c" 3 4
((void *)0)
# 156 "/acl/lib_acl/src/event/events_timer.c"
 ...
 if (info == 
# 165 "/acl/lib_acl/src/event/events_timer.c" 3 4
            ((void *)0)
# 165 "/acl/lib_acl/src/event/events_timer.c"
                ) {

  info = (TIMER_INFO *) acl_calloc_glue("/acl/lib_acl/src/event/events_timer.c", 167, 1, sizeof(TIMER_INFO));
  
# 168 "/acl/lib_acl/src/event/events_timer.c" 3 4
 ((void) sizeof ((
# 168 "/acl/lib_acl/src/event/events_timer.c"
 info
# 168 "/acl/lib_acl/src/event/events_timer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 168 "/acl/lib_acl/src/event/events_timer.c"
...
# 168 "/acl/lib_acl/src/event/events_timer.c"
 "info"
# 168 "/acl/lib_acl/src/event/events_timer.c" 3 4
 , "/acl/lib_acl/src/event/events_timer.c", 168, __extension__ __PRETTY_FUNCTION__); }))
# 168 "/acl/lib_acl/src/event/events_timer.c"
                 ;
  info->delay = delay;
  info->keep = keep;
...
# 183 "/acl/lib_acl/src/event/events_timer.c" 3 4
                                                           ((void *)0)
# 183 "/acl/lib_acl/src/event/events_timer.c"
                                                               );
 if (node == 
# 184 "/acl/lib_acl/src/event/events_timer.c" 3 4
            ((void *)0)
# 184 "/acl/lib_acl/src/event/events_timer.c"
                ) {
  node = (TIMER_NODE*) acl_calloc_glue("/acl/lib_acl/src/event/events_timer.c", 185, 1, sizeof(TIMER_NODE));
  node->when = iter.when;
...
static long long int timer_cancel(ACL_EVENT *eventp, TIMER_INFO *info)
{
 ...
 { struct timeval _tv; gettimeofday(&_tv, 
# 211 "/acl/lib_acl/src/event/events_timer.c" 3 4
((void *)0)
# 211 "/acl/lib_acl/src/event/events_timer.c"
); (eventp->present) = ((long long int) _tv.tv_sec) * 1000000 + ((long long int) _tv.tv_usec); };

 acl_htable_delete_entry(eventp->timers->table, info->entry, 
# 213 "/acl/lib_acl/src/event/events_timer.c" 3 4
                                                            ((void *)0)
# 213 "/acl/lib_acl/src/event/events_timer.c"
                                                                );
 
# 214 "/acl/lib_acl/src/event/events_timer.c" 3 4
((void) sizeof ((
# 214 "/acl/lib_acl/src/event/events_timer.c"
info->node
# 214 "/acl/lib_acl/src/event/events_timer.c" 3 4
) ? 1 : 0), __extension__ ({ if (
# 214 "/acl/lib_acl/src/event/events_timer.c"
...
"info->node"
# 214 "/acl/lib_acl/src/event/events_timer.c" 3 4
, "/acl/lib_acl/src/event/events_timer.c", 214, __extension__ __PRETTY_FUNCTION__); }))
# 214 "/acl/lib_acl/src/event/events_timer.c"
                      ;
 ...
 do { if (info) { acl_free_glue("/acl/lib_acl/src/event/events_timer.c", 235, (info)); (info) = 
# 235 "/acl/lib_acl/src/event/events_timer.c" 3 4
((void *)0)
# 235 "/acl/lib_acl/src/event/events_timer.c"
; } } while (0);
 ...
 ACL_EVENT_NOTIFY_TIME callback, void *context)
{
 ...
 info = (TIMER_INFO*) acl_htable_find(eventp->timers->table, key);
 if (info == 
# 247 "/acl/lib_acl/src/event/events_timer.c" 3 4
            ((void *)0)
# 247 "/acl/lib_acl/src/event/events_timer.c"
                ) {
  return -1;
 }
...
void event_timer_trigger(ACL_EVENT *eventp)
{
 ...
 { struct timeval _tv; gettimeofday(&_tv, 
# 285 "/acl/lib_acl/src/event/events_timer.c" 3 4
((void *)0)
# 285 "/acl/lib_acl/src/event/events_timer.c"
); (eventp->present) = ((long long int) _tv.tv_sec) * 1000000 + ((long long int) _tv.tv_usec); };
...
# 305 "/acl/lib_acl/src/event/events_timer.c" 3 4
                                                            ((void *)0)
# 305 "/acl/lib_acl/src/event/events_timer.c"
                                                                ) {
  info = ((TIMER_INFO *) ((char *) (ring) - 
# 306 "/acl/lib_acl/src/event/events_timer.c" 3 4
             __builtin_offsetof (
# 306 "/acl/lib_acl/src/event/events_timer.c"
             TIMER_INFO
# 306 "/acl/lib_acl/src/event/events_timer.c" 3 4
             , 
# 306 "/acl/lib_acl/src/event/events_timer.c"
