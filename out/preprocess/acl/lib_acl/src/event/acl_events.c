# 0 "/acl/lib_acl/src/event/acl_events.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/event/acl_events.c"
...
# 2 "/acl/lib_acl/src/event/acl_events.c" 2
# 24 "/acl/lib_acl/src/event/acl_events.c"
...
# 25 "/acl/lib_acl/src/event/acl_events.c" 2
...
# 26 "/acl/lib_acl/src/event/acl_events.c" 2
# 1 "/acl/lib_acl/src/event/events_devpoll.h" 1
# 27 "/acl/lib_acl/src/event/acl_events.c" 2
# 1 "/acl/lib_acl/src/event/events_iocp.h" 1
# 28 "/acl/lib_acl/src/event/acl_events.c" 2
# 1 "/acl/lib_acl/src/event/events_wmsg.h" 1
# 29 "/acl/lib_acl/src/event/acl_events.c" 2
...
# 30 "/acl/lib_acl/src/event/acl_events.c" 2
 ...
 int delay_sec, int delay_usec)
{
 ...
 eventp->fdtabs = (ACL_EVENT_FDTABLE **)
  acl_calloc_glue("/acl/lib_acl/src/event/acl_events.c", 40, fdsize, sizeof(ACL_EVENT_FDTABLE *));
 eventp->ready = (ACL_EVENT_FDTABLE **)
  acl_calloc_glue("/acl/lib_acl/src/event/acl_events.c", 42, fdsize, sizeof(ACL_EVENT_FDTABLE *));
...
# 53 "/acl/lib_acl/src/event/acl_events.c" 3 4
((void *)0)
# 53 "/acl/lib_acl/src/event/acl_events.c"
); (eventp->present) = ((long long int) _tv.tv_sec) * 1000000 + ((long long int) _tv.tv_usec); };
 { struct timeval _tv; gettimeofday(&_tv, 
# 54 "/acl/lib_acl/src/event/acl_events.c" 3 4
((void *)0)
# 54 "/acl/lib_acl/src/event/acl_events.c"
...
ACL_EVENT *acl_event_new_select(int delay_sec, int delay_usec)
{
 ...
 fdsize = event_limit(
# 88 "/acl/lib_acl/src/event/acl_events.c" 3 4
                     1024
# 88 "/acl/lib_acl/src/event/acl_events.c"
                               );
...
ACL_EVENT *acl_event_new_select_thr(int delay_sec, int delay_usec)
{
 ...
 fdsize = event_limit(
# 99 "/acl/lib_acl/src/event/acl_events.c" 3 4
                     1024
# 99 "/acl/lib_acl/src/event/acl_events.c"
                               );
...
ACL_EVENT *acl_event_new_poll(int delay_sec, int delay_usec)
{
 ...
 event_init(eventp, fdsize, delay_sec, delay_usec);
 return eventp;
# 123 "/acl/lib_acl/src/event/acl_events.c"
}
...
ACL_EVENT *acl_event_new_poll_thr(int delay_sec, int delay_usec)
{
 ...
 event_init(eventp, fdsize, delay_sec, delay_usec);
 return eventp;
# 143 "/acl/lib_acl/src/event/acl_events.c"
}
...
ACL_EVENT *acl_event_new_kernel(int delay_sec, int delay_usec)
{
 ...
 event_init(eventp, fdsize, delay_sec, delay_usec);
 return eventp;
# 171 "/acl/lib_acl/src/event/acl_events.c"
}
...
ACL_EVENT *acl_event_new_kernel_thr(int delay_sec, int delay_usec)
{
 ...
 event_init(eventp, fdsize, delay_sec, delay_usec);
 return eventp;
# 195 "/acl/lib_acl/src/event/acl_events.c"
}

ACL_EVENT *acl_event_new_wmsg(unsigned int nMsg)
{
# 208 "/acl/lib_acl/src/event/acl_events.c"
 const char *myname = "acl_event_new_kernel";

 (void) nMsg;
 acl_msg_fatal("%s(%d): not support!", myname, 211);
 return 
# 212 "/acl/lib_acl/src/event/acl_events.c" 3 4
       ((void *)0)
# 212 "/acl/lib_acl/src/event/acl_events.c"
           ;
 ...
 int delay_sec, int delay_usec)
{
 ...
 ACL_EVENT *eventp = 
# 220 "/acl/lib_acl/src/event/acl_events.c" 3 4
                    ((void *)0)
# 220 "/acl/lib_acl/src/event/acl_events.c"
                        ;
...
void acl_event_free(ACL_EVENT *eventp)
{
 ...
 do { if (eventp->fdtabs) { acl_free_glue("/acl/lib_acl/src/event/acl_events.c", 290, (eventp->fdtabs)); (eventp->fdtabs) = 
# 290 "/acl/lib_acl/src/event/acl_events.c" 3 4
((void *)0)
# 290 "/acl/lib_acl/src/event/acl_events.c"
; } } while (0);
 do { if (eventp->ready) { acl_free_glue("/acl/lib_acl/src/event/acl_events.c", 291, (eventp->ready)); (eventp->ready) = 
# 291 "/acl/lib_acl/src/event/acl_events.c" 3 4
((void *)0)
# 291 "/acl/lib_acl/src/event/acl_events.c"
; } } while (0);
 free_fn(eventp);
}
