# 0 "/acl/lib_acl/src/event/events_kernel_thr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/event/events_kernel_thr.c"
...
# 2 "/acl/lib_acl/src/event/events_kernel_thr.c" 2
# 31 "/acl/lib_acl/src/event/events_kernel_thr.c"
...
# 32 "/acl/lib_acl/src/event/events_kernel_thr.c" 2
...
# 36 "/acl/lib_acl/src/event/events_kernel_thr.c" 2
# 1 "/acl/lib_acl/src/event/events_devpoll.h" 1
# 37 "/acl/lib_acl/src/event/events_kernel_thr.c" 2
# 1 "/acl/lib_acl/src/event/events_kqueue.h" 1
# 38 "/acl/lib_acl/src/event/events_kernel_thr.c" 2
...
# 39 "/acl/lib_acl/src/event/events_kernel_thr.c" 2
...
# 40 "/acl/lib_acl/src/event/events_kernel_thr.c" 2
...
# 41 "/acl/lib_acl/src/event/events_kernel_thr.c" 2
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 if (fdp == 
# 63 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
           ((void *)0)
# 63 "/acl/lib_acl/src/event/events_kernel_thr.c"
               ) {
  ...
  acl_msg_panic("%s(%d), %s: fd %d: multiple I/O request",
   "/acl/lib_acl/src/event/events_kernel_thr.c", 73, myname, sockfd);
 } else {
  fdp->listener = 0;
  fdp->stream = stream;
 }
 ...
 if ((fdp->flag & (1 << 1)) == 0) {
  ...
  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/acl/lib_acl/src/event/events_kernel_thr.c", 96, strerror(status)); } while (0);
...
# 106 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
 EPOLLIN
# 106 "/acl/lib_acl/src/event/events_kernel_thr.c"
 )) | 
# 106 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
 EPOLLHUP 
# 106 "/acl/lib_acl/src/event/events_kernel_thr.c"
...
# 106 "/acl/lib_acl/src/event/events_kernel_thr.c"
  ...
  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_kernel_thr.c", 108, strerror(status)); } while (0);
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 fdp = (ACL_EVENT_FDTABLE*) stream->fdp;
 if (fdp == 
# 135 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
           ((void *)0)
# 135 "/acl/lib_acl/src/event/events_kernel_thr.c"
               ) {
  fdp = event_fdtable_alloc();
  fdp->stream = stream;
  fdp->listener = 1;
  ...
  acl_msg_panic("%s(%d)->%s: fd %d: multiple I/O request",
   "/acl/lib_acl/src/event/events_kernel_thr.c", 145, myname, sockfd);
 } else {
  fdp->stream = stream;
  fdp->listener = 1;
 }
 ...
 if ((fdp->flag & (1 << 1)) == 0) {
  ...
  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/acl/lib_acl/src/event/events_kernel_thr.c", 168, strerror(status)); } while (0);
  ...
  do { struct epoll_event dummy; memset(&dummy, 0, sizeof(dummy)); dummy.events = ((
# 177 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
 EPOLLIN
# 177 "/acl/lib_acl/src/event/events_kernel_thr.c"
 )) | 
# 177 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
 EPOLLHUP 
# 177 "/acl/lib_acl/src/event/events_kernel_thr.c"
...
# 177 "/acl/lib_acl/src/event/events_kernel_thr.c"
  ...
  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_kernel_thr.c", 179, strerror(status)); } while (0);
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 fdp = (ACL_EVENT_FDTABLE*) stream->fdp;
 if (fdp == 
# 200 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
           ((void *)0)
# 200 "/acl/lib_acl/src/event/events_kernel_thr.c"
               ) {
  fdp = event_fdtable_alloc();
  fdp->listener = 0;
  fdp->stream = stream;
  ...
  acl_msg_panic("%s(%d)->%s: fd %d: multiple I/O request",
   "/acl/lib_acl/src/event/events_kernel_thr.c", 209, myname, sockfd);
 } else {
  fdp->listener = 0;
  fdp->stream = stream;
 }
 ...
 if ((fdp->flag & (1 << 2)) == 0) {
  ...
  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/acl/lib_acl/src/event/events_kernel_thr.c", 232, strerror(status)); } while (0);
  ...
  do { struct epoll_event dummy; memset(&dummy, 0, sizeof(dummy)); dummy.events = ((
# 241 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
 EPOLLOUT
# 241 "/acl/lib_acl/src/event/events_kernel_thr.c"
 )) | 
# 241 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
 EPOLLHUP 
# 241 "/acl/lib_acl/src/event/events_kernel_thr.c"
...
# 241 "/acl/lib_acl/src/event/events_kernel_thr.c"
  ...
  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_kernel_thr.c", 243, strerror(status)); } while (0);
...
static void event_disable_readwrite(ACL_EVENT *eventp, ACL_VSTREAM *stream)
{
 ...
 fdp = (ACL_EVENT_FDTABLE *) stream->fdp;
 if (fdp == 
# 271 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
           ((void *)0)
# 271 "/acl/lib_acl/src/event/events_kernel_thr.c"
               ) {
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/acl/lib_acl/src/event/events_kernel_thr.c", 291, strerror(status)); } while (0);
...
# 303 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
EPOLLHUP 
# 303 "/acl/lib_acl/src/event/events_kernel_thr.c"
| 
# 303 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
EPOLLERR
# 303 "/acl/lib_acl/src/event/events_kernel_thr.c"
...
# 321 "/acl/lib_acl/src/event/events_kernel_thr.c"
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_kernel_thr.c", 321, strerror(status)); } while (0);
...
static int event_isrset(ACL_EVENT *eventp __attribute__ ((__unused__)), ACL_VSTREAM *stream)
{
 ...
 fdp = (ACL_EVENT_FDTABLE *) stream->fdp;
 if (fdp == 
# 335 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
           ((void *)0)
# 335 "/acl/lib_acl/src/event/events_kernel_thr.c"
               ) {
  return 0;
 }
...
static int event_iswset(ACL_EVENT *eventp __attribute__ ((__unused__)), ACL_VSTREAM *stream)
{
 ...
 fdp = (ACL_EVENT_FDTABLE *) stream->fdp;
 if (fdp == 
# 347 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
           ((void *)0)
# 347 "/acl/lib_acl/src/event/events_kernel_thr.c"
               ) {
  return 0;
 }
...
static int event_isxset(ACL_EVENT *eventp __attribute__ ((__unused__)), ACL_VSTREAM *stream)
{
 ...
 fdp = (ACL_EVENT_FDTABLE *) stream->fdp;
 if (fdp == 
# 359 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
           ((void *)0)
# 359 "/acl/lib_acl/src/event/events_kernel_thr.c"
               ) {
  return 0;
 }
...
# 380 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
((void *)0)
# 380 "/acl/lib_acl/src/event/events_kernel_thr.c"
); (eventp->present) = ((long long int) _tv.tv_sec) * 1000000 + ((long long int) _tv.tv_usec); };

 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tm_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/acl/lib_acl/src/event/events_kernel_thr.c", 382, strerror(status)); } while (0);
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tm_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_kernel_thr.c", 399, strerror(status)); } while (0);
 ...
 if (eventp->present - eventp->last_check >= eventp->check_inter) {
  ...
  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/acl/lib_acl/src/event/events_kernel_thr.c", 406, strerror(status)); } while (0);

  if (event_thr_prepare(eventp) == 0) {
   do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_kernel_thr.c", 409, strerror(status)); } while (0);
  ...
  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_kernel_thr.c", 419, strerror(status)); } while (0);
 ...
 if (nready < 0) {
  if (acl_last_error() != 
# 432 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
                         4
# 432 "/acl/lib_acl/src/event/events_kernel_thr.c"
                                  ) {
   acl_msg_fatal("%s(%d), %s: event_loop: select: %s",
    "/acl/lib_acl/src/event/events_kernel_thr.c", 434, myname, acl_last_serror());
  }
  goto TAG_DONE;
 } else if (nready == 0) {
  goto TAG_DONE;
...
# 462 "/acl/lib_acl/src/event/events_kernel_thr.c"
  ...
  if ((fdp->flag & (1 << 1))
   && (((bp)->events) & 
# 469 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
     EPOLLIN
# 469 "/acl/lib_acl/src/event/events_kernel_thr.c"
     )) {
   ...
   && (((bp)->events) & 
# 483 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
     EPOLLOUT
# 483 "/acl/lib_acl/src/event/events_kernel_thr.c"
     )) {
...
static void event_free(ACL_EVENT *eventp)
{
 ...
 if (eventp == 
# 517 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
              ((void *)0)
# 517 "/acl/lib_acl/src/event/events_kernel_thr.c"
                  )
  acl_msg_fatal("%s, %s(%d): eventp null",
   "/acl/lib_acl/src/event/events_kernel_thr.c", myname, 519);
 ...
 do { if (event_thr->event_buf) { acl_free_glue("/acl/lib_acl/src/event/events_kernel_thr.c", 527, (event_thr->event_buf)); (event_thr->event_buf) = 
# 527 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
((void *)0)
# 527 "/acl/lib_acl/src/event/events_kernel_thr.c"
; } } while (0);
 close(event_thr->event_fd);
 do { if (eventp) { acl_free_glue("/acl/lib_acl/src/event/events_kernel_thr.c", 529, (eventp)); (eventp) = 
# 529 "/acl/lib_acl/src/event/events_kernel_thr.c" 3 4
((void *)0)
# 529 "/acl/lib_acl/src/event/events_kernel_thr.c"
; } } while (0);
}
...
ACL_EVENT *event_new_kernel_thr(int fdsize __attribute__ ((__unused__)))
{
 ...
 event_thr->event_buf = (EVENT_BUFFER *)
  acl_calloc_glue("/acl/lib_acl/src/event/events_kernel_thr.c", 564, event_thr->event_fdslots + 1, sizeof(EVENT_BUFFER));
