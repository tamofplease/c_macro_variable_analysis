# 1 "/workspace/acl/lib_acl/src/event/events_fdtable.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/event/events_fdtable.c" 2
# 18 "/workspace/acl/lib_acl/src/event/events_fdtable.c"
...
# 19 "/workspace/acl/lib_acl/src/event/events_fdtable.c" 2
...
# 20 "/workspace/acl/lib_acl/src/event/events_fdtable.c" 2

ACL_EVENT_FDTABLE *event_fdtable_alloc()
{
 ACL_EVENT_FDTABLE *fdp = acl_calloc_glue("/workspace/acl/lib_acl/src/event/events_fdtable.c", 23, 1, sizeof(ACL_EVENT_FDTABLE));
 fdp->fdidx = -1;
 fdp->fdidx_ready = -1;
 return (fdp);
}
...
{
 do { if (fdp) { acl_free_glue("/workspace/acl/lib_acl/src/event/events_fdtable.c", 31, (fdp)); (fdp) = 
# 31 "/workspace/acl/lib_acl/src/event/events_fdtable.c" 3 4
((void *)0)
# 31 "/workspace/acl/lib_acl/src/event/events_fdtable.c"
; } } while (0);
}
