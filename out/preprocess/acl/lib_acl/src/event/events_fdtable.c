# 0 "/acl/lib_acl/src/event/events_fdtable.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/event/events_fdtable.c"
...
# 2 "/acl/lib_acl/src/event/events_fdtable.c" 2
# 18 "/acl/lib_acl/src/event/events_fdtable.c"
...
# 19 "/acl/lib_acl/src/event/events_fdtable.c" 2
...
# 20 "/acl/lib_acl/src/event/events_fdtable.c" 2

ACL_EVENT_FDTABLE *event_fdtable_alloc()
{
 ACL_EVENT_FDTABLE *fdp = acl_calloc_glue("/acl/lib_acl/src/event/events_fdtable.c", 23, 1, sizeof(ACL_EVENT_FDTABLE));
 fdp->fdidx = -1;
 fdp->fdidx_ready = -1;
 return (fdp);
}
...
{
 do { if (fdp) { acl_free_glue("/acl/lib_acl/src/event/events_fdtable.c", 31, (fdp)); (fdp) = 
# 31 "/acl/lib_acl/src/event/events_fdtable.c" 3 4
((void *)0)
# 31 "/acl/lib_acl/src/event/events_fdtable.c"
; } } while (0);
}
