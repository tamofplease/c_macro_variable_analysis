# 1 "/workspace/acl/lib_acl/src/event/acl_timer.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/event/acl_timer.c" 2
# 12 "/workspace/acl/lib_acl/src/event/acl_timer.c"
...
# 13 "/workspace/acl/lib_acl/src/event/acl_timer.c" 2
...
# 23 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
                             ((void *)0)
# 23 "/workspace/acl/lib_acl/src/event/acl_timer.c"
                                 ;

 { struct timeval _tv; gettimeofday(&_tv, 
# 25 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
((void *)0)
# 25 "/workspace/acl/lib_acl/src/event/acl_timer.c"
); (timer->present) = ((long long int) _tv.tv_sec) * 1000000 + ((long long int) _tv.tv_usec); };

 for ((iter).ptr = (((&timer->timer_header))->succ); (iter).ptr != (&timer->timer_header); (iter).ptr = (((iter).ptr)->succ)) {
  pTimerItem = ((ACL_TIMER_INFO *) ((char *) (iter.ptr) - 
# 28 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
              __builtin_offsetof (
# 28 "/workspace/acl/lib_acl/src/event/acl_timer.c"
              ACL_TIMER_INFO
# 28 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
              , 
# 28 "/workspace/acl/lib_acl/src/event/acl_timer.c"
...
# 28 "/workspace/acl/lib_acl/src/event/acl_timer.c"
 ...
 if (iter.ptr == &timer->timer_header) {
  pTimerItem = (ACL_TIMER_INFO*)
   acl_calloc_glue("/workspace/acl/lib_acl/src/event/acl_timer.c", 39, 1, sizeof(ACL_TIMER_INFO));
  pTimerItem->when = timer->present + delay;
  pTimerItem->obj = obj;
 }

 for ((iter).ptr = (((&timer->timer_header))->succ); (iter).ptr != (&timer->timer_header); (iter).ptr = (((iter).ptr)->succ)) {
  ACL_TIMER_INFO *pItem = ((ACL_TIMER_INFO *) ((char *) (iter.ptr) - 
# 45 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
                         __builtin_offsetof (
# 45 "/workspace/acl/lib_acl/src/event/acl_timer.c"
                         ACL_TIMER_INFO
# 45 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
                         , 
# 45 "/workspace/acl/lib_acl/src/event/acl_timer.c"
...
{
 ACL_RING_ITER iter;
 long long int time_left = -1;

 { struct timeval _tv; gettimeofday(&_tv, 
# 59 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
((void *)0)
# 59 "/workspace/acl/lib_acl/src/event/acl_timer.c"
); (timer->present) = ((long long int) _tv.tv_sec) * 1000000 + ((long long int) _tv.tv_usec); };

 for ((iter).ptr = (((&timer->timer_header))->succ); (iter).ptr != (&timer->timer_header); (iter).ptr = (((iter).ptr)->succ)) {
  ACL_TIMER_INFO *pItem = ((ACL_TIMER_INFO *) ((char *) (iter.ptr) - 
# 62 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
                         __builtin_offsetof (
# 62 "/workspace/acl/lib_acl/src/event/acl_timer.c"
                         ACL_TIMER_INFO
# 62 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
                         , 
# 62 "/workspace/acl/lib_acl/src/event/acl_timer.c"
...
# 62 "/workspace/acl/lib_acl/src/event/acl_timer.c"
  ...
  if (pItem->obj == obj) {
   if ((time_left = pItem->when - timer->present) < 0)
    time_left = 0;
   acl_ring_detach(iter.ptr);
   do { if (pItem) { acl_free_glue("/workspace/acl/lib_acl/src/event/acl_timer.c", 67, (pItem)); (pItem) = 
# 67 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
  ((void *)0)
# 67 "/workspace/acl/lib_acl/src/event/acl_timer.c"
  ; } } while (0);
   break;
  }
 }
...
void *acl_timer_popup(ACL_TIMER* timer)
{
 ...
 { struct timeval _tv; gettimeofday(&_tv, 
# 81 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
((void *)0)
# 81 "/workspace/acl/lib_acl/src/event/acl_timer.c"
); (timer->present) = ((long long int) _tv.tv_sec) * 1000000 + ((long long int) _tv.tv_usec); };

 pTimerItem = (((&timer->timer_header)->succ) != (&timer->timer_header) ? ((ACL_TIMER_INFO *) ((char *) (((&timer->timer_header)->succ)) - 
# 83 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
             __builtin_offsetof (
# 83 "/workspace/acl/lib_acl/src/event/acl_timer.c"
             ACL_TIMER_INFO
# 83 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
             , 
# 83 "/workspace/acl/lib_acl/src/event/acl_timer.c"
...
# 83 "/workspace/acl/lib_acl/src/event/acl_timer.c"
 ...
 if (pTimerItem == 
# 84 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
                  ((void *)0)
# 84 "/workspace/acl/lib_acl/src/event/acl_timer.c"
                      )
  return (
# 85 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
         ((void *)0)
# 85 "/workspace/acl/lib_acl/src/event/acl_timer.c"
             );

 if (pTimerItem->when > timer->present)
  return (
# 88 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
         ((void *)0)
# 88 "/workspace/acl/lib_acl/src/event/acl_timer.c"
             );

 acl_ring_detach(&pTimerItem->entry);
 obj = pTimerItem->obj;
 do { if (pTimerItem) { acl_free_glue("/workspace/acl/lib_acl/src/event/acl_timer.c", 92, (pTimerItem)); (pTimerItem) = 
# 92 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
((void *)0)
# 92 "/workspace/acl/lib_acl/src/event/acl_timer.c"
; } } while (0);
...
long long int acl_timer_left(ACL_TIMER* timer)
{
 ...
 { struct timeval _tv; gettimeofday(&_tv, 
# 102 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
((void *)0)
# 102 "/workspace/acl/lib_acl/src/event/acl_timer.c"
); (timer->present) = ((long long int) _tv.tv_sec) * 1000000 + ((long long int) _tv.tv_usec); };

 pTimerItem = (((&timer->timer_header)->succ) != (&timer->timer_header) ? ((ACL_TIMER_INFO *) ((char *) (((&timer->timer_header)->succ)) - 
# 104 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
             __builtin_offsetof (
# 104 "/workspace/acl/lib_acl/src/event/acl_timer.c"
             ACL_TIMER_INFO
# 104 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
             , 
# 104 "/workspace/acl/lib_acl/src/event/acl_timer.c"
...
# 104 "/workspace/acl/lib_acl/src/event/acl_timer.c"
 ...
 if (pTimerItem != 
# 105 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
                  ((void *)0)
# 105 "/workspace/acl/lib_acl/src/event/acl_timer.c"
                      ) {
...
void acl_timer_walk(ACL_TIMER *timer, void (*action)(ACL_TIMER_INFO *, void *), void *arg)
{
 ...
 for ((iter).ptr = (((&timer->timer_header))->succ); (iter).ptr != (&timer->timer_header); (iter).ptr = (((iter).ptr)->succ)) {
  info = ((ACL_TIMER_INFO *) ((char *) (iter.ptr) - 
# 126 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
        __builtin_offsetof (
# 126 "/workspace/acl/lib_acl/src/event/acl_timer.c"
        ACL_TIMER_INFO
# 126 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
        , 
# 126 "/workspace/acl/lib_acl/src/event/acl_timer.c"
...
static const void *timer_iter_head(ACL_ITER *iter, struct ACL_TIMER *timer)
{
 ...
 iter->dlen = -1;
 iter->key = 
# 136 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
            ((void *)0)
# 136 "/workspace/acl/lib_acl/src/event/acl_timer.c"
                ;
 iter->klen = -1;
 iter->i = 0;
 iter->size = timer->timer_header.len;
 iter->ptr = ((&timer->timer_header)->succ);
 if (iter->ptr == &timer->timer_header) {
  iter->data = iter->ptr = 
# 142 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
                          ((void *)0)
# 142 "/workspace/acl/lib_acl/src/event/acl_timer.c"
                              ;
  return (
# 143 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
         ((void *)0)
# 143 "/workspace/acl/lib_acl/src/event/acl_timer.c"
             );
 }
 info = ((ACL_TIMER_INFO *) ((char *) (iter->ptr) - 
# 145 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
       __builtin_offsetof (
# 145 "/workspace/acl/lib_acl/src/event/acl_timer.c"
       ACL_TIMER_INFO
# 145 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
       , 
# 145 "/workspace/acl/lib_acl/src/event/acl_timer.c"
...
static const void *timer_iter_next(ACL_ITER *iter, struct ACL_TIMER *timer)
{
 ...
 iter->i++;
 iter->ptr = (((ACL_RING*) iter->ptr)->succ);
 if (iter->ptr == &timer->timer_header) {
  iter->data = iter->ptr = 
# 157 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
                          ((void *)0)
# 157 "/workspace/acl/lib_acl/src/event/acl_timer.c"
                              ;
  return (
# 158 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
         ((void *)0)
# 158 "/workspace/acl/lib_acl/src/event/acl_timer.c"
             );
 }
 info = ((ACL_TIMER_INFO *) ((char *) (iter->ptr) - 
# 160 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
       __builtin_offsetof (
# 160 "/workspace/acl/lib_acl/src/event/acl_timer.c"
       ACL_TIMER_INFO
# 160 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
       , 
# 160 "/workspace/acl/lib_acl/src/event/acl_timer.c"
...
static const void *timer_iter_tail(ACL_ITER *iter, struct ACL_TIMER *timer)
{
 ...
 iter->dlen = -1;
 iter->key = 
# 170 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
            ((void *)0)
# 170 "/workspace/acl/lib_acl/src/event/acl_timer.c"
                ;
 iter->klen = -1;
 iter->size = timer->timer_header.len;
 iter->i = iter->size - 1;
 iter->ptr = ((&timer->timer_header)->pred);
 if (iter->ptr == &timer->timer_header) {
  iter->data = iter->ptr = 
# 176 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
                          ((void *)0)
# 176 "/workspace/acl/lib_acl/src/event/acl_timer.c"
                              ;
  return (
# 177 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
         ((void *)0)
# 177 "/workspace/acl/lib_acl/src/event/acl_timer.c"
             );
 }
 info = ((ACL_TIMER_INFO *) ((char *) (iter->ptr) - 
# 179 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
       __builtin_offsetof (
# 179 "/workspace/acl/lib_acl/src/event/acl_timer.c"
       ACL_TIMER_INFO
# 179 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
       , 
# 179 "/workspace/acl/lib_acl/src/event/acl_timer.c"
...
static const void *timer_iter_prev(ACL_ITER *iter, struct ACL_TIMER *timer)
{
 ...
 iter->i--;
 iter->ptr = (((ACL_RING*) iter->ptr)->pred);
 if (iter->ptr == &timer->timer_header) {
  iter->data = iter->ptr = 
# 192 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
                          ((void *)0)
# 192 "/workspace/acl/lib_acl/src/event/acl_timer.c"
                              ;
  return (
# 193 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
         ((void *)0)
# 193 "/workspace/acl/lib_acl/src/event/acl_timer.c"
             );
 }
 info = ((ACL_TIMER_INFO *) ((char *) (iter->ptr) - 
# 195 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
       __builtin_offsetof (
# 195 "/workspace/acl/lib_acl/src/event/acl_timer.c"
       ACL_TIMER_INFO
# 195 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
       , 
# 195 "/workspace/acl/lib_acl/src/event/acl_timer.c"
...
static const ACL_TIMER_INFO *timer_iter_info(ACL_ITER *iter, struct ACL_TIMER *timer)
{
 ...
 if (iter->ptr == 
# 204 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
                 ((void *)0) 
# 204 "/workspace/acl/lib_acl/src/event/acl_timer.c"
                      || iter->ptr == &timer->timer_header)
  return (
# 205 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
         ((void *)0)
# 205 "/workspace/acl/lib_acl/src/event/acl_timer.c"
             );

 info = ((ACL_TIMER_INFO *) ((char *) (iter->ptr) - 
# 207 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
       __builtin_offsetof (
# 207 "/workspace/acl/lib_acl/src/event/acl_timer.c"
       ACL_TIMER_INFO
# 207 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
       , 
# 207 "/workspace/acl/lib_acl/src/event/acl_timer.c"
...
ACL_TIMER *acl_timer_new()
{
 ...
 timer = (ACL_TIMER*) acl_calloc_glue("/workspace/acl/lib_acl/src/event/acl_timer.c", 215, 1, sizeof(ACL_TIMER));
...
void acl_timer_free(ACL_TIMER* timer, void (*free_fn)(void *))
{
 ...
 while ((info = (((&timer->timer_header)->succ) != (&timer->timer_header) ? ((ACL_TIMER_INFO *) ((char *) (((&timer->timer_header)->succ)) - 
# 235 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
               __builtin_offsetof (
# 235 "/workspace/acl/lib_acl/src/event/acl_timer.c"
               ACL_TIMER_INFO
# 235 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
               , 
# 235 "/workspace/acl/lib_acl/src/event/acl_timer.c"
...
# 235 "/workspace/acl/lib_acl/src/event/acl_timer.c"
  ...
  do { if (info) { acl_free_glue("/workspace/acl/lib_acl/src/event/acl_timer.c", 239, (info)); (info) = 
# 239 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
 ((void *)0)
# 239 "/workspace/acl/lib_acl/src/event/acl_timer.c"
 ; } } while (0);
 }

 do { if (timer) { acl_free_glue("/workspace/acl/lib_acl/src/event/acl_timer.c", 242, (timer)); (timer) = 
# 242 "/workspace/acl/lib_acl/src/event/acl_timer.c" 3 4
((void *)0)
# 242 "/workspace/acl/lib_acl/src/event/acl_timer.c"
; } } while (0);
}
