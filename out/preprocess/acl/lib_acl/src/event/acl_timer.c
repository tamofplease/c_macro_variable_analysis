# 0 "/acl/lib_acl/src/event/acl_timer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/event/acl_timer.c"
...
# 2 "/acl/lib_acl/src/event/acl_timer.c" 2
# 12 "/acl/lib_acl/src/event/acl_timer.c"
...
# 13 "/acl/lib_acl/src/event/acl_timer.c" 2
...
# 23 "/acl/lib_acl/src/event/acl_timer.c" 3 4
                             ((void *)0)
# 23 "/acl/lib_acl/src/event/acl_timer.c"
                                 ;

 { struct timeval _tv; gettimeofday(&_tv, 
# 25 "/acl/lib_acl/src/event/acl_timer.c" 3 4
((void *)0)
# 25 "/acl/lib_acl/src/event/acl_timer.c"
...
# 28 "/acl/lib_acl/src/event/acl_timer.c" 3 4
              __builtin_offsetof (
# 28 "/acl/lib_acl/src/event/acl_timer.c"
              ACL_TIMER_INFO
# 28 "/acl/lib_acl/src/event/acl_timer.c" 3 4
              , 
# 28 "/acl/lib_acl/src/event/acl_timer.c"
...
# 28 "/acl/lib_acl/src/event/acl_timer.c"
 ...
 if (iter.ptr == &timer->timer_header) {
  pTimerItem = (ACL_TIMER_INFO*)
   acl_calloc_glue("/acl/lib_acl/src/event/acl_timer.c", 39, 1, sizeof(ACL_TIMER_INFO));
  pTimerItem->when = timer->present + delay;
  pTimerItem->obj = obj;
 }
...
# 45 "/acl/lib_acl/src/event/acl_timer.c" 3 4
                         __builtin_offsetof (
# 45 "/acl/lib_acl/src/event/acl_timer.c"
                         ACL_TIMER_INFO
# 45 "/acl/lib_acl/src/event/acl_timer.c" 3 4
                         , 
# 45 "/acl/lib_acl/src/event/acl_timer.c"
...
long long int acl_timer_cancel(ACL_TIMER* timer, void *obj)
{
 ...
 { struct timeval _tv; gettimeofday(&_tv, 
# 59 "/acl/lib_acl/src/event/acl_timer.c" 3 4
((void *)0)
# 59 "/acl/lib_acl/src/event/acl_timer.c"
); (timer->present) = ((long long int) _tv.tv_sec) * 1000000 + ((long long int) _tv.tv_usec); };

 for ((iter).ptr = (((&timer->timer_header))->succ); (iter).ptr != (&timer->timer_header); (iter).ptr = (((iter).ptr)->succ)) {
  ACL_TIMER_INFO *pItem = ((ACL_TIMER_INFO *) ((char *) (iter.ptr) - 
# 62 "/acl/lib_acl/src/event/acl_timer.c" 3 4
                         __builtin_offsetof (
# 62 "/acl/lib_acl/src/event/acl_timer.c"
                         ACL_TIMER_INFO
# 62 "/acl/lib_acl/src/event/acl_timer.c" 3 4
                         , 
# 62 "/acl/lib_acl/src/event/acl_timer.c"
...
# 62 "/acl/lib_acl/src/event/acl_timer.c"
  ...
  if (pItem->obj == obj) {
   if ((time_left = pItem->when - timer->present) < 0)
    time_left = 0;
   acl_ring_detach(iter.ptr);
   do { if (pItem) { acl_free_glue("/acl/lib_acl/src/event/acl_timer.c", 67, (pItem)); (pItem) = 
# 67 "/acl/lib_acl/src/event/acl_timer.c" 3 4
  ((void *)0)
# 67 "/acl/lib_acl/src/event/acl_timer.c"
  ; } } while (0);
   break;
  }
 }
...
void *acl_timer_popup(ACL_TIMER* timer)
{
 ...
 { struct timeval _tv; gettimeofday(&_tv, 
# 81 "/acl/lib_acl/src/event/acl_timer.c" 3 4
((void *)0)
# 81 "/acl/lib_acl/src/event/acl_timer.c"
); (timer->present) = ((long long int) _tv.tv_sec) * 1000000 + ((long long int) _tv.tv_usec); };

 pTimerItem = (((&timer->timer_header)->succ) != (&timer->timer_header) ? ((ACL_TIMER_INFO *) ((char *) (((&timer->timer_header)->succ)) - 
# 83 "/acl/lib_acl/src/event/acl_timer.c" 3 4
             __builtin_offsetof (
# 83 "/acl/lib_acl/src/event/acl_timer.c"
             ACL_TIMER_INFO
# 83 "/acl/lib_acl/src/event/acl_timer.c" 3 4
             , 
# 83 "/acl/lib_acl/src/event/acl_timer.c"
...
# 83 "/acl/lib_acl/src/event/acl_timer.c"
 ...
 if (pTimerItem == 
# 84 "/acl/lib_acl/src/event/acl_timer.c" 3 4
                  ((void *)0)
# 84 "/acl/lib_acl/src/event/acl_timer.c"
                      )
  return (
# 85 "/acl/lib_acl/src/event/acl_timer.c" 3 4
         ((void *)0)
# 85 "/acl/lib_acl/src/event/acl_timer.c"
             );

 if (pTimerItem->when > timer->present)
  return (
# 88 "/acl/lib_acl/src/event/acl_timer.c" 3 4
         ((void *)0)
# 88 "/acl/lib_acl/src/event/acl_timer.c"
             );

 acl_ring_detach(&pTimerItem->entry);
 obj = pTimerItem->obj;
 do { if (pTimerItem) { acl_free_glue("/acl/lib_acl/src/event/acl_timer.c", 92, (pTimerItem)); (pTimerItem) = 
# 92 "/acl/lib_acl/src/event/acl_timer.c" 3 4
((void *)0)
# 92 "/acl/lib_acl/src/event/acl_timer.c"
; } } while (0);
...
long long int acl_timer_left(ACL_TIMER* timer)
{
 ...
 { struct timeval _tv; gettimeofday(&_tv, 
# 102 "/acl/lib_acl/src/event/acl_timer.c" 3 4
((void *)0)
# 102 "/acl/lib_acl/src/event/acl_timer.c"
); (timer->present) = ((long long int) _tv.tv_sec) * 1000000 + ((long long int) _tv.tv_usec); };

 pTimerItem = (((&timer->timer_header)->succ) != (&timer->timer_header) ? ((ACL_TIMER_INFO *) ((char *) (((&timer->timer_header)->succ)) - 
# 104 "/acl/lib_acl/src/event/acl_timer.c" 3 4
             __builtin_offsetof (
# 104 "/acl/lib_acl/src/event/acl_timer.c"
             ACL_TIMER_INFO
# 104 "/acl/lib_acl/src/event/acl_timer.c" 3 4
             , 
# 104 "/acl/lib_acl/src/event/acl_timer.c"
...
# 104 "/acl/lib_acl/src/event/acl_timer.c"
 ...
 if (pTimerItem != 
# 105 "/acl/lib_acl/src/event/acl_timer.c" 3 4
                  ((void *)0)
# 105 "/acl/lib_acl/src/event/acl_timer.c"
                      ) {
...
# 126 "/acl/lib_acl/src/event/acl_timer.c" 3 4
        __builtin_offsetof (
# 126 "/acl/lib_acl/src/event/acl_timer.c"
        ACL_TIMER_INFO
# 126 "/acl/lib_acl/src/event/acl_timer.c" 3 4
        , 
# 126 "/acl/lib_acl/src/event/acl_timer.c"
...
static const void *timer_iter_head(ACL_ITER *iter, struct ACL_TIMER *timer)
{
 ...
 iter->dlen = -1;
 iter->key = 
# 136 "/acl/lib_acl/src/event/acl_timer.c" 3 4
            ((void *)0)
# 136 "/acl/lib_acl/src/event/acl_timer.c"
                ;
 iter->klen = -1;
 iter->i = 0;
 ...
 if (iter->ptr == &timer->timer_header) {
  iter->data = iter->ptr = 
# 142 "/acl/lib_acl/src/event/acl_timer.c" 3 4
                          ((void *)0)
# 142 "/acl/lib_acl/src/event/acl_timer.c"
                              ;
  return (
# 143 "/acl/lib_acl/src/event/acl_timer.c" 3 4
         ((void *)0)
# 143 "/acl/lib_acl/src/event/acl_timer.c"
             );
 }
 info = ((ACL_TIMER_INFO *) ((char *) (iter->ptr) - 
# 145 "/acl/lib_acl/src/event/acl_timer.c" 3 4
       __builtin_offsetof (
# 145 "/acl/lib_acl/src/event/acl_timer.c"
       ACL_TIMER_INFO
# 145 "/acl/lib_acl/src/event/acl_timer.c" 3 4
       , 
# 145 "/acl/lib_acl/src/event/acl_timer.c"
...
static const void *timer_iter_next(ACL_ITER *iter, struct ACL_TIMER *timer)
{
 ...
 if (iter->ptr == &timer->timer_header) {
  iter->data = iter->ptr = 
# 157 "/acl/lib_acl/src/event/acl_timer.c" 3 4
                          ((void *)0)
# 157 "/acl/lib_acl/src/event/acl_timer.c"
                              ;
  return (
# 158 "/acl/lib_acl/src/event/acl_timer.c" 3 4
         ((void *)0)
# 158 "/acl/lib_acl/src/event/acl_timer.c"
             );
 }
 info = ((ACL_TIMER_INFO *) ((char *) (iter->ptr) - 
# 160 "/acl/lib_acl/src/event/acl_timer.c" 3 4
       __builtin_offsetof (
# 160 "/acl/lib_acl/src/event/acl_timer.c"
       ACL_TIMER_INFO
# 160 "/acl/lib_acl/src/event/acl_timer.c" 3 4
       , 
# 160 "/acl/lib_acl/src/event/acl_timer.c"
...
static const void *timer_iter_tail(ACL_ITER *iter, struct ACL_TIMER *timer)
{
 ...
 iter->dlen = -1;
 iter->key = 
# 170 "/acl/lib_acl/src/event/acl_timer.c" 3 4
            ((void *)0)
# 170 "/acl/lib_acl/src/event/acl_timer.c"
                ;
 iter->klen = -1;
 iter->size = timer->timer_header.len;
 iter->i = iter->size - 1;
 ...
 if (iter->ptr == &timer->timer_header) {
  iter->data = iter->ptr = 
# 176 "/acl/lib_acl/src/event/acl_timer.c" 3 4
                          ((void *)0)
# 176 "/acl/lib_acl/src/event/acl_timer.c"
                              ;
  return (
# 177 "/acl/lib_acl/src/event/acl_timer.c" 3 4
         ((void *)0)
# 177 "/acl/lib_acl/src/event/acl_timer.c"
             );
 }
 info = ((ACL_TIMER_INFO *) ((char *) (iter->ptr) - 
# 179 "/acl/lib_acl/src/event/acl_timer.c" 3 4
       __builtin_offsetof (
# 179 "/acl/lib_acl/src/event/acl_timer.c"
       ACL_TIMER_INFO
# 179 "/acl/lib_acl/src/event/acl_timer.c" 3 4
       , 
# 179 "/acl/lib_acl/src/event/acl_timer.c"
...
static const void *timer_iter_prev(ACL_ITER *iter, struct ACL_TIMER *timer)
{
 ...
 if (iter->ptr == &timer->timer_header) {
  iter->data = iter->ptr = 
# 192 "/acl/lib_acl/src/event/acl_timer.c" 3 4
                          ((void *)0)
# 192 "/acl/lib_acl/src/event/acl_timer.c"
                              ;
  return (
# 193 "/acl/lib_acl/src/event/acl_timer.c" 3 4
         ((void *)0)
# 193 "/acl/lib_acl/src/event/acl_timer.c"
             );
 }
 info = ((ACL_TIMER_INFO *) ((char *) (iter->ptr) - 
# 195 "/acl/lib_acl/src/event/acl_timer.c" 3 4
       __builtin_offsetof (
# 195 "/acl/lib_acl/src/event/acl_timer.c"
       ACL_TIMER_INFO
# 195 "/acl/lib_acl/src/event/acl_timer.c" 3 4
       , 
# 195 "/acl/lib_acl/src/event/acl_timer.c"
...
static const ACL_TIMER_INFO *timer_iter_info(ACL_ITER *iter, struct ACL_TIMER *timer)
{
 ...
 if (iter->ptr == 
# 204 "/acl/lib_acl/src/event/acl_timer.c" 3 4
                 ((void *)0) 
# 204 "/acl/lib_acl/src/event/acl_timer.c"
                      || iter->ptr == &timer->timer_header)
  return (
# 205 "/acl/lib_acl/src/event/acl_timer.c" 3 4
         ((void *)0)
# 205 "/acl/lib_acl/src/event/acl_timer.c"
             );

 info = ((ACL_TIMER_INFO *) ((char *) (iter->ptr) - 
# 207 "/acl/lib_acl/src/event/acl_timer.c" 3 4
       __builtin_offsetof (
# 207 "/acl/lib_acl/src/event/acl_timer.c"
       ACL_TIMER_INFO
# 207 "/acl/lib_acl/src/event/acl_timer.c" 3 4
       , 
# 207 "/acl/lib_acl/src/event/acl_timer.c"
...
ACL_TIMER *acl_timer_new()
{
 ...
 timer = (ACL_TIMER*) acl_calloc_glue("/acl/lib_acl/src/event/acl_timer.c", 215, 1, sizeof(ACL_TIMER));
...
# 235 "/acl/lib_acl/src/event/acl_timer.c" 3 4
               __builtin_offsetof (
# 235 "/acl/lib_acl/src/event/acl_timer.c"
               ACL_TIMER_INFO
# 235 "/acl/lib_acl/src/event/acl_timer.c" 3 4
               , 
# 235 "/acl/lib_acl/src/event/acl_timer.c"
...
# 235 "/acl/lib_acl/src/event/acl_timer.c"
  ...
  do { if (info) { acl_free_glue("/acl/lib_acl/src/event/acl_timer.c", 239, (info)); (info) = 
# 239 "/acl/lib_acl/src/event/acl_timer.c" 3 4
 ((void *)0)
# 239 "/acl/lib_acl/src/event/acl_timer.c"
 ; } } while (0);
 }

 do { if (timer) { acl_free_glue("/acl/lib_acl/src/event/acl_timer.c", 242, (timer)); (timer) = 
# 242 "/acl/lib_acl/src/event/acl_timer.c" 3 4
((void *)0)
# 242 "/acl/lib_acl/src/event/acl_timer.c"
; } } while (0);
}
