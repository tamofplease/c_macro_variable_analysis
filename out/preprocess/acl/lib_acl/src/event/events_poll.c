# 1 "/workspace/acl/lib_acl/src/event/events_poll.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/event/events_poll.c" 2
# 28 "/workspace/acl/lib_acl/src/event/events_poll.c"
...
# 29 "/workspace/acl/lib_acl/src/event/events_poll.c" 2



# 1 "/usr/include/poll.h" 1 3 4
# 33 "/workspace/acl/lib_acl/src/event/events_poll.c" 2
...
# 37 "/workspace/acl/lib_acl/src/event/events_poll.c" 2
...
# 38 "/workspace/acl/lib_acl/src/event/events_poll.c" 2
...
static void stream_on_close(ACL_VSTREAM *stream, void *arg)
{
 ...
 if (fdp == 
# 52 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
           ((void *)0)
# 52 "/workspace/acl/lib_acl/src/event/events_poll.c"
               ) {
  return;
 }
...
# 82 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                                     ((void *)0)
# 82 "/workspace/acl/lib_acl/src/event/events_poll.c"
                                         ;
 }
 fdp->fdidx_ready = -1;
 event_fdtable_free(fdp);
 stream->fdp = 
# 86 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
              ((void *)0)
# 86 "/workspace/acl/lib_acl/src/event/events_poll.c"
                  ;
}
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 if (fdp == 
# 96 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
           ((void *)0)
# 96 "/workspace/acl/lib_acl/src/event/events_poll.c"
               ) {
 ...
 if ((fdp->flag & (1 << 2))) {
  ...
  ev->fds[fdp->fdidx].events |= 
# 114 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                               0x001 
# 114 "/workspace/acl/lib_acl/src/event/events_poll.c"
                                      | 
# 114 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                                        0x010 
# 114 "/workspace/acl/lib_acl/src/event/events_poll.c"
...
# 114 "/workspace/acl/lib_acl/src/event/events_poll.c"
  ...
  ev->fds[fdp->fdidx].events = 
# 121 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                              0x001 
# 121 "/workspace/acl/lib_acl/src/event/events_poll.c"
                                     | 
# 121 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                                       0x010 
# 121 "/workspace/acl/lib_acl/src/event/events_poll.c"
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 if (fdp == 
# 174 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
           ((void *)0)
# 174 "/workspace/acl/lib_acl/src/event/events_poll.c"
               ) {
  fdp = event_fdtable_alloc();
 ...
 if ((fdp->flag & (1 << 1))) {
  ...
  ev->fds[fdp->fdidx].events |= 
# 193 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                               0x004 
# 193 "/workspace/acl/lib_acl/src/event/events_poll.c"
                                       | 
# 193 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                                         0x010 
# 193 "/workspace/acl/lib_acl/src/event/events_poll.c"
...
# 193 "/workspace/acl/lib_acl/src/event/events_poll.c"
  ...
  ev->fds[fdp->fdidx].events = 
# 200 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                              0x004 
# 200 "/workspace/acl/lib_acl/src/event/events_poll.c"
                                      | 
# 200 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                                        0x010 
# 200 "/workspace/acl/lib_acl/src/event/events_poll.c"
...
static void event_disable_read(ACL_EVENT *eventp, ACL_VSTREAM *stream)
{
 ...
 if (fdp == 
# 233 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
           ((void *)0)
# 233 "/workspace/acl/lib_acl/src/event/events_poll.c"
               ) {
  acl_msg_warn("%s(%d): fdp null", myname, 234);
  return;
 }

 if (fdp->fdidx < 0 || fdp->fdidx >= eventp->fdcnt) {
  acl_msg_warn("%s(%d): sockfd(%d)'s fdidx(%d) invalid",
   myname, 240, sockfd, fdp->fdidx);
  return;
 }
 ...
 fdp->r_timeout = 0;
 fdp->r_callback = 
# 252 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                  ((void *)0)
# 252 "/workspace/acl/lib_acl/src/event/events_poll.c"
                      ;
 ...
 if ((fdp->flag & (1 << 2))) {
  ...
  ev->fds[fdp->fdidx].events = 
# 260 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                              0x004 
# 260 "/workspace/acl/lib_acl/src/event/events_poll.c"
                                      | 
# 260 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                                        0x010 
# 260 "/workspace/acl/lib_acl/src/event/events_poll.c"
...
# 279 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                                   ((void *)0)
# 279 "/workspace/acl/lib_acl/src/event/events_poll.c"
                                       ;
 }
 fdp->fdidx_ready = -1;
...
static void event_disable_write(ACL_EVENT *eventp, ACL_VSTREAM *stream)
{
 ...
 if (fdp == 
# 295 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
           ((void *)0)
# 295 "/workspace/acl/lib_acl/src/event/events_poll.c"
               ) {
  acl_msg_warn("%s(%d): fdp null", myname, 296);
  return;
 }

 if (fdp->fdidx < 0 || fdp->fdidx >= eventp->fdcnt) {
  acl_msg_warn("%s(%d): sockfd(%d)'s fdidx(%d) invalid",
   myname, 302, sockfd, fdp->fdidx);
  return;
 }
 ...
 fdp->w_timeout = 0;
 fdp->w_callback = 
# 314 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                  ((void *)0)
# 314 "/workspace/acl/lib_acl/src/event/events_poll.c"
                      ;
 ...
 if ((fdp->flag & (1 << 1))) {
  ...
  ev->fds[fdp->fdidx].events = 
# 322 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                              0x001 
# 322 "/workspace/acl/lib_acl/src/event/events_poll.c"
                                     | 
# 322 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                                       0x010 
# 322 "/workspace/acl/lib_acl/src/event/events_poll.c"
...
# 322 "/workspace/acl/lib_acl/src/event/events_poll.c"
 ...
 if (fdp->fdidx_ready >= 0
  ...
  eventp->ready[fdp->fdidx_ready] = 
# 342 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                                   ((void *)0)
# 342 "/workspace/acl/lib_acl/src/event/events_poll.c"
                                       ;
 }
 fdp->fdidx_ready = -1;
...
static void event_disable_readwrite(ACL_EVENT *eventp, ACL_VSTREAM *stream)
{
 ...
 if (fdp == 
# 358 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
           ((void *)0)
# 358 "/workspace/acl/lib_acl/src/event/events_poll.c"
               ) {
  return;
 }
 ...
 if (fdp->flag == 0 || fdp->fdidx < 0 || fdp->fdidx >= eventp->fdcnt) {
  ...
  event_fdtable_free(fdp);
  stream->fdp = 
# 367 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
               ((void *)0)
# 367 "/workspace/acl/lib_acl/src/event/events_poll.c"
                   ;
  return;
 }
 ...
 if (fdp->fdidx_ready >= 0
  ...
  && eventp->ready[fdp->fdidx_ready] == fdp) {
  eventp->ready[fdp->fdidx_ready] = 
# 385 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                                   ((void *)0)
# 385 "/workspace/acl/lib_acl/src/event/events_poll.c"
                                       ;
 }
 fdp->fdidx_ready = -1;
 ...
 event_fdtable_free(fdp);
 stream->fdp = 
# 391 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
              ((void *)0)
# 391 "/workspace/acl/lib_acl/src/event/events_poll.c"
                  ;
}
...
# 409 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
((void *)0)
# 409 "/workspace/acl/lib_acl/src/event/events_poll.c"
 ...
 if (nready < 0) {
  ...
  if (acl_last_error() != 
# 458 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                         4
# 458 "/workspace/acl/lib_acl/src/event/events_poll.c"
                                  ) {
   acl_msg_error("%s(%d), %s: select: %s", "/workspace/acl/lib_acl/src/event/events_poll.c",
    460, myname, acl_last_serror());
   exit (1);
  }
  goto TAG_DONE;
 } else if (nready == 0) {
 ...
 for (i = 0; i < eventp->fdcnt; i++) {
  ...
  if (fdp == 
# 472 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
            ((void *)0) 
# 472 "/workspace/acl/lib_acl/src/event/events_poll.c"
                 || fdp->stream == 
# 472 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                                   ((void *)0)
# 472 "/workspace/acl/lib_acl/src/event/events_poll.c"
  ...
  if ((fdp->flag & (1 << 1)) && (revents & 
# 486 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                                                         0x001
# 486 "/workspace/acl/lib_acl/src/event/events_poll.c"
                                                               ) ) {
  ...
  if ((fdp->flag & (1 << 2))
   && (revents & 
# 512 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                0x004
# 512 "/workspace/acl/lib_acl/src/event/events_poll.c"
                       )) {
  ...
  if (!fdp->event_type && (revents & (
# 527 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                                     0x010 
# 527 "/workspace/acl/lib_acl/src/event/events_poll.c"
                                             | 
# 527 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
                                               0x008
# 527 "/workspace/acl/lib_acl/src/event/events_poll.c"
...
static int event_isrset(ACL_EVENT *eventp __attribute__ ((__unused__)), ACL_VSTREAM *stream)
{
 ...
 return fdp == 
# 550 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
              ((void *)0) 
# 550 "/workspace/acl/lib_acl/src/event/events_poll.c"
                   ? 0 : (fdp->flag & (1 << 1));
}
...
static int event_iswset(ACL_EVENT *eventp __attribute__ ((__unused__)), ACL_VSTREAM *stream)
{
 ...
 return fdp == 
# 557 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
              ((void *)0) 
# 557 "/workspace/acl/lib_acl/src/event/events_poll.c"
                   ? 0 : (fdp->flag & (1 << 2));
...
static int event_isxset(ACL_EVENT *eventp __attribute__ ((__unused__)), ACL_VSTREAM *stream)
{
 ...
 return fdp == 
# 565 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
              ((void *)0) 
# 565 "/workspace/acl/lib_acl/src/event/events_poll.c"
                   ? 0 : (fdp->flag & (1 << 3));
}
...
static void event_free(ACL_EVENT *eventp)
{
 ...
 do { if (ev->fds) { acl_free_glue("/workspace/acl/lib_acl/src/event/events_poll.c", 573, (ev->fds)); (ev->fds) = 
# 573 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
((void *)0)
# 573 "/workspace/acl/lib_acl/src/event/events_poll.c"
; } } while (0);
 do { if (ev) { acl_free_glue("/workspace/acl/lib_acl/src/event/events_poll.c", 574, (ev)); (ev) = 
# 574 "/workspace/acl/lib_acl/src/event/events_poll.c" 3 4
((void *)0)
# 574 "/workspace/acl/lib_acl/src/event/events_poll.c"
; } } while (0);
}
...
ACL_EVENT *event_new_poll(int fdsize)
{
 ...
 ev->fds = (struct pollfd *)
  acl_calloc_glue("/workspace/acl/lib_acl/src/event/events_poll.c", 606, fdsize + 1, sizeof(struct pollfd));
