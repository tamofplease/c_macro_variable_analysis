# 1 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 2
# 27 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
...
# 28 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 2


# 1 "/usr/include/poll.h" 1 3 4
# 31 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 2
...
# 33 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 2
...
# 34 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 2
...
# 35 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 2
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 fdp = stream->fdp;
 if (fdp == 
# 53 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
           ((void *)0)
# 53 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
               ) {
  ...
  acl_msg_panic("%s(%d)->%s: fd %d: multiple I/O request",
   "/workspace/acl/lib_acl/src/event/events_poll_thr.c", 60, myname, sockfd);
 } else {
  fdp->listener = 0;
  fdp->stream = stream;
 }
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/workspace/acl/lib_acl/src/event/events_poll_thr.c", 86, strerror(status)); } while (0);

 fdp->fdidx = eventp->fdcnt;
 eventp->fdtabs[eventp->fdcnt++] = fdp;

 event_thr->fds[fdp->fdidx].fd = sockfd;
 event_thr->fds[fdp->fdidx].events = 
# 92 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
                                    0x001 
# 92 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
                                           | 
# 92 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
                                             0x010 
# 92 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
...
# 92 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_poll_thr.c", 99, strerror(status)); } while (0);
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 fdp = stream->fdp;
 if (fdp == 
# 118 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
           ((void *)0)
# 118 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
               ) {
  fdp = event_fdtable_alloc();
  fdp->listener = 1;
  fdp->stream = stream;
  ...
  acl_msg_panic("%s(%d)->%s: fd %d: multiple I/O request",
   "/workspace/acl/lib_acl/src/event/events_poll_thr.c", 125, myname, sockfd);
 } else {
  fdp->listener = 1;
  fdp->stream = stream;
 }
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/workspace/acl/lib_acl/src/event/events_poll_thr.c", 151, strerror(status)); } while (0);
 ...
 event_thr->fds[fdp->fdidx].fd = sockfd;
 event_thr->fds[fdp->fdidx].events = 
# 157 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
                                    0x001 
# 157 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
                                           | 
# 157 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
                                             0x010 
# 157 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
...
# 157 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_poll_thr.c", 164, strerror(status)); } while (0);
}
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 if (fdp == 
# 177 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
           ((void *)0)
# 177 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
               ) {
  fdp = event_fdtable_alloc();
  fdp->listener = 0;
  fdp->stream = stream;
  ...
  acl_msg_panic("%s(%d)->%s: fd %d: multiple I/O request",
   "/workspace/acl/lib_acl/src/event/events_poll_thr.c", 184, myname, sockfd);
 } else {
  fdp->listener = 0;
  fdp->stream = stream;
 }
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/workspace/acl/lib_acl/src/event/events_poll_thr.c", 210, strerror(status)); } while (0);
 ...
 event_thr->fds[fdp->fdidx].fd = sockfd;
 event_thr->fds[fdp->fdidx].events = 
# 216 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
                                    0x004 
# 216 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
                                            | 
# 216 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
                                              0x010 
# 216 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
...
# 216 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_poll_thr.c", 223, strerror(status)); } while (0);
...
static void event_disable_readwrite(ACL_EVENT *eventp, ACL_VSTREAM *stream)
{
 ...
 fdp = (ACL_EVENT_FDTABLE *) stream->fdp;
 if (fdp == 
# 242 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
           ((void *)0)
# 242 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
               ) {
  acl_msg_error("%s(%d): fdp null", myname, 243);
  return;
 }
 ...
 if (fdp->fdidx == -1) {
  acl_msg_fatal("%s(%d): fdidx(%d) invalid",
   myname, 255, fdp->fdidx);
 }

 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/workspace/acl/lib_acl/src/event/events_poll_thr.c", 258, strerror(status)); } while (0);
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_poll_thr.c", 277, strerror(status)); } while (0);
...
static int event_isrset(ACL_EVENT *eventp __attribute__ ((__unused__)), ACL_VSTREAM *stream)
{
 ...
 fdp = (ACL_EVENT_FDTABLE *) stream->fdp;
 if (fdp == 
# 294 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
           ((void *)0)
# 294 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
               ) {
  return 0;
 }

 return (fdp->flag & (1 << 1)) == 0 ? 0 : 1;
}
...
static int event_iswset(ACL_EVENT *eventp __attribute__ ((__unused__)), ACL_VSTREAM *stream)
{
 ...
 fdp = (ACL_EVENT_FDTABLE *) stream->fdp;
 if (fdp == 
# 306 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
           ((void *)0)
# 306 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
               ) {
  return 0;
 }

 return (fdp->flag & (1 << 2)) == 0 ? 0 : 1;
}
...
static int event_isxset(ACL_EVENT *eventp __attribute__ ((__unused__)), ACL_VSTREAM *stream)
{
 ...
 fdp = (ACL_EVENT_FDTABLE *) stream->fdp;
 if (fdp == 
# 318 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
           ((void *)0)
# 318 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
               ) {
  return 0;
 }

 return (fdp->flag & (1 << 3)) == 0 ? 0 : 1;
}
...
# 339 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
((void *)0)
# 339 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
); (eventp->present) = ((long long int) _tv.tv_sec) * 1000000 + ((long long int) _tv.tv_usec); };
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tm_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/workspace/acl/lib_acl/src/event/events_poll_thr.c", 340, strerror(status)); } while (0);
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tm_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_poll_thr.c", 357, strerror(status)); } while (0);
 ...
 if (eventp->present - eventp->last_check >= eventp->check_inter) {
  ...
  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/workspace/acl/lib_acl/src/event/events_poll_thr.c", 364, strerror(status)); } while (0);

  if (event_thr_prepare(eventp) == 0) {

   do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_poll_thr.c", 368, strerror(status)); } while (0);
  ...
  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_poll_thr.c", 382, strerror(status)); } while (0);

  if (eventp->ready_cnt > 0) {
   delay = 0;
  }
 } else {
  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/workspace/acl/lib_acl/src/event/events_poll_thr.c", 388, strerror(status)); } while (0);

  memcpy(event_thr->fdset, event_thr->fds,
   eventp->fdcnt * sizeof(struct pollfd));
  fdcnt = eventp->fdcnt;

  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_poll_thr.c", 394, strerror(status)); } while (0);
 }
 ...
 if (nready < 0) {
  if (acl_last_error() != 
# 402 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
                         4
# 402 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
                                  ) {
   acl_msg_fatal("%s(%d), %s: event_loop: poll: %s",
    "/workspace/acl/lib_acl/src/event/events_poll_thr.c", 404, myname, acl_last_serror());
  }
  goto TAG_DONE;
 } else if (nready == 0) {
  goto TAG_DONE;
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/workspace/acl/lib_acl/src/event/events_poll_thr.c", 411, strerror(status)); } while (0);

 for (i = 0; i < fdcnt; i++) {
  fdp = acl_fdmap_ctx(event_thr->fdmap, event_thr->fdset[i].fd);
  if (fdp == 
# 415 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
            ((void *)0) 
# 415 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
                 || fdp->stream == 
# 415 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
                                   ((void *)0)
# 415 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
  ...
  if ((revents & 
# 423 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
                0x001
# 423 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
                      ) != 0) {
...
# 436 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
                       0x004
# 436 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
                              ) != 0) {
   fdp->event_type |= (1 << 2);
   fdp->fdidx_ready = eventp->ready_cnt;
   eventp->ready[eventp->ready_cnt++] = fdp;
  } else if ((revents & (
# 440 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
                        0x010 
# 440 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
                                | 
# 440 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
                                  0x008
# 440 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_poll_thr.c", 447, strerror(status)); } while (0);
...
static void event_free(ACL_EVENT *eventp)
{
 ...
 if (eventp == 
# 471 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
              ((void *)0)
# 471 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
                  )
  acl_msg_fatal("%s, %s(%d): eventp null",
   "/workspace/acl/lib_acl/src/event/events_poll_thr.c", myname, 473);
 ...
 do { if (event_thr->fdset) { acl_free_glue("/workspace/acl/lib_acl/src/event/events_poll_thr.c", 479, (event_thr->fdset)); (event_thr->fdset) = 
# 479 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
((void *)0)
# 479 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
; } } while (0);
 do { if (event_thr->fds) { acl_free_glue("/workspace/acl/lib_acl/src/event/events_poll_thr.c", 480, (event_thr->fds)); (event_thr->fds) = 
# 480 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
((void *)0)
# 480 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
; } } while (0);
 do { if (eventp) { acl_free_glue("/workspace/acl/lib_acl/src/event/events_poll_thr.c", 481, (eventp)); (eventp) = 
# 481 "/workspace/acl/lib_acl/src/event/events_poll_thr.c" 3 4
((void *)0)
# 481 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
; } } while (0);
}
...
ACL_EVENT *event_poll_alloc_thr(int fdsize)
{
 ...
 event_thr->event.event.event_mode = 1;
 ...
 event_thr->fds = (struct pollfd *) acl_calloc_glue(
                        "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
# 513 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
                                    ,
                        514
# 513 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
                                    , fdsize + 1, sizeof(struct pollfd))
                         ;
 event_thr->fdset = (struct pollfd *) acl_calloc_glue(
                        "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
# 515 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
                                      ,
                        516
# 515 "/workspace/acl/lib_acl/src/event/events_poll_thr.c"
                                      , fdsize + 1, sizeof(struct pollfd))
