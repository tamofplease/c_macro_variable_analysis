# 0 "/acl/lib_acl/src/event/events_select_thr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/event/events_select_thr.c"
...
# 2 "/acl/lib_acl/src/event/events_select_thr.c" 2
# 31 "/acl/lib_acl/src/event/events_select_thr.c"
# 1 "/acl/lib_acl/src/event/events_dog.h" 1
# 9 "/acl/lib_acl/src/event/events_dog.h"
# 1 "/acl/lib_acl/include/event/acl_events.h" 1
# 10 "/acl/lib_acl/src/event/events_dog.h" 2
...
# 32 "/acl/lib_acl/src/event/events_select_thr.c" 2
...
# 20 "/acl/lib_acl/src/event/events.h" 2
# 1 "/acl/lib_acl/src/event/events_epoll.h" 1
# 27 "/acl/lib_acl/src/event/events_epoll.h"
...
# 28 "/acl/lib_acl/src/event/events_epoll.h" 2
...
# 33 "/acl/lib_acl/src/event/events_select_thr.c" 2
...
# 34 "/acl/lib_acl/src/event/events_select_thr.c" 2
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/acl/lib_acl/src/event/events_select_thr.c", 52, strerror(status)); } while (0);
 ...
 if (
# 58 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
    ((((
# 58 "/acl/lib_acl/src/event/events_select_thr.c"
    &event_thr->wmask
# 58 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
...
# 58 "/acl/lib_acl/src/event/events_select_thr.c"
  ...
  acl_msg_panic("%s(%d), %s: fd %d: multiple I/O request",
   "/acl/lib_acl/src/event/events_select_thr.c", 60, myname, sockfd);
 }

 fdp = stream->fdp;
 if (fdp == 
# 64 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
           ((void *)0)
# 64 "/acl/lib_acl/src/event/events_select_thr.c"
               ) {
 ...
 if (fdp->flag & (1 << 2)) {
  acl_msg_panic("%s(%d)->%s: fd %d: multiple I/O request",
   "/acl/lib_acl/src/event/events_select_thr.c", 73, myname, sockfd);
 }
 ...
 if ((fdp->flag & (1 << 1)) == 0) {
  ...
  if (
# 79 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
     ((((
# 79 "/acl/lib_acl/src/event/events_select_thr.c"
     &event_thr->rmask
# 79 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
     )->__fds_bits)[__extension__ ({ long int __d = (
# 79 "/acl/lib_acl/src/event/events_select_thr.c"
...
# 79 "/acl/lib_acl/src/event/events_select_thr.c"
   ...
   acl_msg_fatal("%s, %s(%d): sockfd(%d) has been in rmask",
    myname, "/acl/lib_acl/src/event/events_select_thr.c", 81, sockfd);
  }

  
# 84 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
 ((void) (((
# 84 "/acl/lib_acl/src/event/events_select_thr.c"
 &event_thr->xmask
# 84 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
 )->__fds_bits)[__extension__ ({ long int __d = (
# 84 "/acl/lib_acl/src/event/events_select_thr.c"
...
# 85 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
 ((void) (((
# 85 "/acl/lib_acl/src/event/events_select_thr.c"
 &event_thr->rmask
# 85 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
 )->__fds_bits)[__extension__ ({ long int __d = (
# 85 "/acl/lib_acl/src/event/events_select_thr.c"
...
# 85 "/acl/lib_acl/src/event/events_select_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_select_thr.c", 112, strerror(status)); } while (0);
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/acl/lib_acl/src/event/events_select_thr.c", 131, strerror(status)); } while (0);
 ...
 if (
# 137 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
    ((((
# 137 "/acl/lib_acl/src/event/events_select_thr.c"
    &event_thr->wmask
# 137 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
    )->__fds_bits)[__extension__ ({ long int __d = (
# 137 "/acl/lib_acl/src/event/events_select_thr.c"
...
# 137 "/acl/lib_acl/src/event/events_select_thr.c"
  ...
  acl_msg_panic("%s(%d), %s: fd %d: multiple I/O request",
   "/acl/lib_acl/src/event/events_select_thr.c", 139, myname, sockfd);
 }

 fdp = stream->fdp;
 if (fdp == 
# 143 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
           ((void *)0)
# 143 "/acl/lib_acl/src/event/events_select_thr.c"
               ) {
  fdp = event_fdtable_alloc();
  fdp->listener = 1;
 } else {
 ...
 if (fdp->flag & (1 << 2)) {
  acl_msg_panic("%s(%d)->%s: fd %d: multiple I/O request",
   "/acl/lib_acl/src/event/events_select_thr.c", 152, myname, sockfd);
 }
 ...
 if ((fdp->flag & (1 << 1)) == 0) {
  ...
  if (
# 158 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
     ((((
# 158 "/acl/lib_acl/src/event/events_select_thr.c"
     &event_thr->rmask
# 158 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
     )->__fds_bits)[__extension__ ({ long int __d = (
# 158 "/acl/lib_acl/src/event/events_select_thr.c"
...
# 158 "/acl/lib_acl/src/event/events_select_thr.c"
   ...
   acl_msg_fatal("%s, %s(%d): sockfd(%d) has been in rmask",
    myname, "/acl/lib_acl/src/event/events_select_thr.c", 160, sockfd);
  }

  
# 163 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
 ((void) (((
# 163 "/acl/lib_acl/src/event/events_select_thr.c"
 &event_thr->xmask
# 163 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
 )->__fds_bits)[__extension__ ({ long int __d = (
# 163 "/acl/lib_acl/src/event/events_select_thr.c"
...
# 164 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
 ((void) (((
# 164 "/acl/lib_acl/src/event/events_select_thr.c"
 &event_thr->rmask
# 164 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
 )->__fds_bits)[__extension__ ({ long int __d = (
# 164 "/acl/lib_acl/src/event/events_select_thr.c"
...
# 164 "/acl/lib_acl/src/event/events_select_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_select_thr.c", 191, strerror(status)); } while (0);
}
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/acl/lib_acl/src/event/events_select_thr.c", 204, strerror(status)); } while (0);
 ...
 if (
# 210 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
    ((((
# 210 "/acl/lib_acl/src/event/events_select_thr.c"
    &event_thr->rmask
# 210 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
    )->__fds_bits)[__extension__ ({ long int __d = (
# 210 "/acl/lib_acl/src/event/events_select_thr.c"
...
# 210 "/acl/lib_acl/src/event/events_select_thr.c"
  ...
  acl_msg_panic("%s(%d), %s: fd %d: multiple I/O request",
   "/acl/lib_acl/src/event/events_select_thr.c", 212, myname, sockfd);
 }

 fdp = stream->fdp;
 if (fdp == 
# 216 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
           ((void *)0)
# 216 "/acl/lib_acl/src/event/events_select_thr.c"
               ) {
  fdp = event_fdtable_alloc();
 }
 ...
 if (fdp->flag & (1 << 1)) {
  acl_msg_panic("%s(%d)->%s: fd %d: multiple I/O request",
   "/acl/lib_acl/src/event/events_select_thr.c", 222, myname, sockfd);
 }
 ...
 if ((fdp->flag & (1 << 2)) == 0) {
  ...
  if (
# 229 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
     ((((
# 229 "/acl/lib_acl/src/event/events_select_thr.c"
     &event_thr->wmask
# 229 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
     )->__fds_bits)[__extension__ ({ long int __d = (
# 229 "/acl/lib_acl/src/event/events_select_thr.c"
...
# 229 "/acl/lib_acl/src/event/events_select_thr.c"
   ...
   acl_msg_fatal("%s, %s(%d): sockfd(%d) has been in wmask",
    myname, "/acl/lib_acl/src/event/events_select_thr.c", 231, sockfd);
  }

  
# 234 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
 ((void) (((
# 234 "/acl/lib_acl/src/event/events_select_thr.c"
 &event_thr->xmask
# 234 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
 )->__fds_bits)[__extension__ ({ long int __d = (
# 234 "/acl/lib_acl/src/event/events_select_thr.c"
...
# 235 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
 ((void) (((
# 235 "/acl/lib_acl/src/event/events_select_thr.c"
 &event_thr->wmask
# 235 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
 )->__fds_bits)[__extension__ ({ long int __d = (
# 235 "/acl/lib_acl/src/event/events_select_thr.c"
...
# 235 "/acl/lib_acl/src/event/events_select_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_select_thr.c", 263, strerror(status)); } while (0);
...
static void event_disable_readwrite(ACL_EVENT *eventp, ACL_VSTREAM *stream)
{
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/acl/lib_acl/src/event/events_select_thr.c", 282, strerror(status)); } while (0);
 if (!
# 283 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
     ((((
# 283 "/acl/lib_acl/src/event/events_select_thr.c"
     &event_thr->xmask
# 283 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
     )->__fds_bits)[__extension__ ({ long int __d = (
# 283 "/acl/lib_acl/src/event/events_select_thr.c"
...
# 283 "/acl/lib_acl/src/event/events_select_thr.c"
  ...
  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_select_thr.c", 284, strerror(status)); } while (0);
  return;
 }
 fdp = (ACL_EVENT_FDTABLE *) stream->fdp;
 if (fdp == 
# 288 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
           ((void *)0)
# 288 "/acl/lib_acl/src/event/events_select_thr.c"
               ) {
  acl_msg_error("%s(%d): fdp null", myname, 289);
  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_select_thr.c", 290, strerror(status)); } while (0);
  return;
 }
...
# 299 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
((void) (((
# 299 "/acl/lib_acl/src/event/events_select_thr.c"
&event_thr->xmask
# 299 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
)->__fds_bits)[__extension__ ({ long int __d = (
# 299 "/acl/lib_acl/src/event/events_select_thr.c"
...
# 300 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
((void) (((
# 300 "/acl/lib_acl/src/event/events_select_thr.c"
&event_thr->rmask
# 300 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
)->__fds_bits)[__extension__ ({ long int __d = (
# 300 "/acl/lib_acl/src/event/events_select_thr.c"
...
# 301 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
((void) (((
# 301 "/acl/lib_acl/src/event/events_select_thr.c"
&event_thr->wmask
# 301 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
)->__fds_bits)[__extension__ ({ long int __d = (
# 301 "/acl/lib_acl/src/event/events_select_thr.c"
...
# 321 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
                                   ((void *)0)
# 321 "/acl/lib_acl/src/event/events_select_thr.c"
                                       ;
 }
 event_fdtable_free(fdp);
 stream->fdp = 
# 324 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
              ((void *)0)
# 324 "/acl/lib_acl/src/event/events_select_thr.c"
                  ;
 stream->nrefer--;
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_select_thr.c", 326, strerror(status)); } while (0);
}
...
static int event_isrset(ACL_EVENT *eventp, ACL_VSTREAM *stream)
{
 ...
 return 
# 333 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
       ((((
# 333 "/acl/lib_acl/src/event/events_select_thr.c"
       &event_thr->rmask
# 333 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
       )->__fds_bits)[__extension__ ({ long int __d = (
# 333 "/acl/lib_acl/src/event/events_select_thr.c"
...
static int event_iswset(ACL_EVENT *eventp, ACL_VSTREAM *stream)
{
 ...
 return 
# 340 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
       ((((
# 340 "/acl/lib_acl/src/event/events_select_thr.c"
       &event_thr->wmask
# 340 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
       )->__fds_bits)[__extension__ ({ long int __d = (
# 340 "/acl/lib_acl/src/event/events_select_thr.c"
...
static int event_isxset(ACL_EVENT *eventp, ACL_VSTREAM *stream)
{
 ...
 return 
# 347 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
       ((((
# 347 "/acl/lib_acl/src/event/events_select_thr.c"
       &event_thr->xmask
# 347 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
       )->__fds_bits)[__extension__ ({ long int __d = (
# 347 "/acl/lib_acl/src/event/events_select_thr.c"
...
# 368 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
((void *)0)
# 368 "/acl/lib_acl/src/event/events_select_thr.c"
); (eventp->present) = ((long long int) _tv.tv_sec) * 1000000 + ((long long int) _tv.tv_usec); };

 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tm_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/acl/lib_acl/src/event/events_select_thr.c", 370, strerror(status)); } while (0);
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tm_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_select_thr.c", 386, strerror(status)); } while (0);

 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/acl/lib_acl/src/event/events_select_thr.c", 388, strerror(status)); } while (0);

 eventp->ready_cnt = 0;

 if (event_thr_prepare(eventp) == 0) {
  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_select_thr.c", 393, strerror(status)); } while (0);
 ...
 if (eventp->ready_cnt > 0) {
  ...
  tvp = 
# 417 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
       ((void *)0)
# 417 "/acl/lib_acl/src/event/events_select_thr.c"
           ;
 }
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_select_thr.c", 424, strerror(status)); } while (0);
 ...
 if (nready < 0) {
  if (acl_last_error() != 
# 430 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
                         4
# 430 "/acl/lib_acl/src/event/events_select_thr.c"
                                  ) {
   acl_msg_fatal("%s(%d), %s: event_loop: select: %s",
    "/acl/lib_acl/src/event/events_select_thr.c", 432, myname, acl_last_serror());
  }
  goto TAG_DONE;
 } else if (nready == 0) {
  goto TAG_DONE;
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/acl/lib_acl/src/event/events_select_thr.c", 439, strerror(status)); } while (0);
 ...
 for (i = 0; i < eventp->fdcnt; i++) {
  ...
  if (
# 451 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
     ((((
# 451 "/acl/lib_acl/src/event/events_select_thr.c"
     &xmask
# 451 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
     )->__fds_bits)[__extension__ ({ long int __d = (
# 451 "/acl/lib_acl/src/event/events_select_thr.c"
...
# 451 "/acl/lib_acl/src/event/events_select_thr.c"
  ...
  if (
# 458 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
     ((((
# 458 "/acl/lib_acl/src/event/events_select_thr.c"
     &rmask
# 458 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
     )->__fds_bits)[__extension__ ({ long int __d = (
# 458 "/acl/lib_acl/src/event/events_select_thr.c"
...
# 471 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
                               ((((
# 471 "/acl/lib_acl/src/event/events_select_thr.c"
                               &wmask
# 471 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
                               )->__fds_bits)[__extension__ ({ long int __d = (
# 471 "/acl/lib_acl/src/event/events_select_thr.c"
...
# 471 "/acl/lib_acl/src/event/events_select_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/acl/lib_acl/src/event/events_select_thr.c", 478, strerror(status)); } while (0);
...
static void event_free(ACL_EVENT *eventp)
{
 ...
 if (eventp == 
# 502 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
              ((void *)0)
# 502 "/acl/lib_acl/src/event/events_select_thr.c"
                  )
  acl_msg_fatal("%s, %s(%d): eventp null",
    "/acl/lib_acl/src/event/events_select_thr.c", myname, 504);
 ...
 do { if (eventp) { acl_free_glue("/acl/lib_acl/src/event/events_select_thr.c", 509, (eventp)); (eventp) = 
# 509 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
((void *)0)
# 509 "/acl/lib_acl/src/event/events_select_thr.c"
; } } while (0);
}
...
# 537 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
       do { unsigned int __i; fd_set *__arr = (
# 537 "/acl/lib_acl/src/event/events_select_thr.c"
       &event_thr->rmask
# 537 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
...
# 538 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
       do { unsigned int __i; fd_set *__arr = (
# 538 "/acl/lib_acl/src/event/events_select_thr.c"
       &event_thr->wmask
# 538 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
       ); for (__i = 0; __i < sizeof (fd_set) / sizeof (__fd_mask); ++__i) ((__arr)->__fds_bits)[__i] = 0; } while (0)
# 538 "/acl/lib_acl/src/event/events_select_thr.c"
...
# 539 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
       do { unsigned int __i; fd_set *__arr = (
# 539 "/acl/lib_acl/src/event/events_select_thr.c"
       &event_thr->xmask
# 539 "/acl/lib_acl/src/event/events_select_thr.c" 3 4
       ); for (__i = 0; __i < sizeof (fd_set) / sizeof (__fd_mask); ++__i) ((__arr)->__fds_bits)[__i] = 0; } while (0)
# 539 "/acl/lib_acl/src/event/events_select_thr.c"
