# 1 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 2
# 31 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
# 1 "/workspace/acl/lib_acl/src/event/events_dog.h" 1
# 9 "/workspace/acl/lib_acl/src/event/events_dog.h"
# 1 "/workspace/acl/lib_acl/include/event/acl_events.h" 1
# 10 "/workspace/acl/lib_acl/src/event/events_dog.h" 2
...
# 32 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 2
...
# 20 "/workspace/acl/lib_acl/src/event/events.h" 2
# 1 "/workspace/acl/lib_acl/src/event/events_epoll.h" 1
# 27 "/workspace/acl/lib_acl/src/event/events_epoll.h"
...
# 28 "/workspace/acl/lib_acl/src/event/events_epoll.h" 2
...
# 33 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 2
...
# 34 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 2
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/workspace/acl/lib_acl/src/event/events_select_thr.c", 52, strerror(status)); } while (0);
 ...
 if (
# 58 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
    ((((
# 58 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
    &event_thr->wmask
# 58 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
...
# 58 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
  ...
  acl_msg_panic("%s(%d), %s: fd %d: multiple I/O request",
   "/workspace/acl/lib_acl/src/event/events_select_thr.c", 60, myname, sockfd);
 }

 fdp = stream->fdp;
 if (fdp == 
# 64 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
           ((void *)0)
# 64 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
               ) {
 ...
 if (fdp->flag & (1 << 2)) {
  acl_msg_panic("%s(%d)->%s: fd %d: multiple I/O request",
   "/workspace/acl/lib_acl/src/event/events_select_thr.c", 73, myname, sockfd);
 }
 ...
 if ((fdp->flag & (1 << 1)) == 0) {
  ...
  if (
# 79 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
     ((((
# 79 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
     &event_thr->rmask
# 79 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
     )->__fds_bits)[__extension__ ({ long int __d = (
# 79 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
# 79 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
   ...
   acl_msg_fatal("%s, %s(%d): sockfd(%d) has been in rmask",
    myname, "/workspace/acl/lib_acl/src/event/events_select_thr.c", 81, sockfd);
  }

  
# 84 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
 ((void) (((
# 84 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
 &event_thr->xmask
# 84 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
 )->__fds_bits)[__extension__ ({ long int __d = (
# 84 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
# 85 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
 ((void) (((
# 85 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
 &event_thr->rmask
# 85 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
 )->__fds_bits)[__extension__ ({ long int __d = (
# 85 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
# 85 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
  ...
  if (eventp->maxfd != (int) -1 && eventp->maxfd < sockfd) {
   eventp->maxfd = sockfd;
  }
 }
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_select_thr.c", 112, strerror(status)); } while (0);
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/workspace/acl/lib_acl/src/event/events_select_thr.c", 131, strerror(status)); } while (0);
 ...
 if (
# 137 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
    ((((
# 137 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
    &event_thr->wmask
# 137 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
    )->__fds_bits)[__extension__ ({ long int __d = (
# 137 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
# 137 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
  ...
  acl_msg_panic("%s(%d), %s: fd %d: multiple I/O request",
   "/workspace/acl/lib_acl/src/event/events_select_thr.c", 139, myname, sockfd);
 }

 fdp = stream->fdp;
 if (fdp == 
# 143 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
           ((void *)0)
# 143 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
               ) {
  fdp = event_fdtable_alloc();
  fdp->listener = 1;
 } else {
 ...
 if (fdp->flag & (1 << 2)) {
  acl_msg_panic("%s(%d)->%s: fd %d: multiple I/O request",
   "/workspace/acl/lib_acl/src/event/events_select_thr.c", 152, myname, sockfd);
 }
 ...
 if ((fdp->flag & (1 << 1)) == 0) {
  ...
  if (
# 158 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
     ((((
# 158 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
     &event_thr->rmask
# 158 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
     )->__fds_bits)[__extension__ ({ long int __d = (
# 158 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
# 158 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
   ...
   acl_msg_fatal("%s, %s(%d): sockfd(%d) has been in rmask",
    myname, "/workspace/acl/lib_acl/src/event/events_select_thr.c", 160, sockfd);
  }

  
# 163 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
 ((void) (((
# 163 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
 &event_thr->xmask
# 163 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
 )->__fds_bits)[__extension__ ({ long int __d = (
# 163 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
# 164 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
 ((void) (((
# 164 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
 &event_thr->rmask
# 164 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
 )->__fds_bits)[__extension__ ({ long int __d = (
# 164 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
# 164 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_select_thr.c", 191, strerror(status)); } while (0);
}
 ...
 int timeout, ACL_EVENT_NOTIFY_RDWR callback, void *context)
{
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/workspace/acl/lib_acl/src/event/events_select_thr.c", 204, strerror(status)); } while (0);
 ...
 if (
# 210 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
    ((((
# 210 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
    &event_thr->rmask
# 210 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
    )->__fds_bits)[__extension__ ({ long int __d = (
# 210 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
# 210 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
  ...
  acl_msg_panic("%s(%d), %s: fd %d: multiple I/O request",
   "/workspace/acl/lib_acl/src/event/events_select_thr.c", 212, myname, sockfd);
 }

 fdp = stream->fdp;
 if (fdp == 
# 216 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
           ((void *)0)
# 216 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
               ) {
  fdp = event_fdtable_alloc();
 }
 ...
 if (fdp->flag & (1 << 1)) {
  acl_msg_panic("%s(%d)->%s: fd %d: multiple I/O request",
   "/workspace/acl/lib_acl/src/event/events_select_thr.c", 222, myname, sockfd);
 }
 ...
 if ((fdp->flag & (1 << 2)) == 0) {
  ...
  if (
# 229 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
     ((((
# 229 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
     &event_thr->wmask
# 229 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
     )->__fds_bits)[__extension__ ({ long int __d = (
# 229 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
# 229 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
   ...
   acl_msg_fatal("%s, %s(%d): sockfd(%d) has been in wmask",
    myname, "/workspace/acl/lib_acl/src/event/events_select_thr.c", 231, sockfd);
  }

  
# 234 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
 ((void) (((
# 234 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
 &event_thr->xmask
# 234 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
 )->__fds_bits)[__extension__ ({ long int __d = (
# 234 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
# 235 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
 ((void) (((
# 235 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
 &event_thr->wmask
# 235 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
 )->__fds_bits)[__extension__ ({ long int __d = (
# 235 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
# 235 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_select_thr.c", 263, strerror(status)); } while (0);
...
static void event_disable_readwrite(ACL_EVENT *eventp, ACL_VSTREAM *stream)
{
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/workspace/acl/lib_acl/src/event/events_select_thr.c", 282, strerror(status)); } while (0);
 if (!
# 283 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
     ((((
# 283 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
     &event_thr->xmask
# 283 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
     )->__fds_bits)[__extension__ ({ long int __d = (
# 283 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
# 283 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
  ...
  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_select_thr.c", 284, strerror(status)); } while (0);
  return;
 }
 fdp = (ACL_EVENT_FDTABLE *) stream->fdp;
 if (fdp == 
# 288 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
           ((void *)0)
# 288 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
               ) {
  acl_msg_error("%s(%d): fdp null", myname, 289);
  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_select_thr.c", 290, strerror(status)); } while (0);
  return;
 }

 if (fdp->fdidx == -1) {
  acl_msg_fatal("%s(%d): fdidx(%d) invalid",
   myname, 296, fdp->fdidx);
 }

 
# 299 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
((void) (((
# 299 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
&event_thr->xmask
# 299 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
)->__fds_bits)[__extension__ ({ long int __d = (
# 299 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
# 300 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
((void) (((
# 300 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
&event_thr->rmask
# 300 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
)->__fds_bits)[__extension__ ({ long int __d = (
# 300 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
# 301 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
((void) (((
# 301 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
&event_thr->wmask
# 301 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
)->__fds_bits)[__extension__ ({ long int __d = (
# 301 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
# 301 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
 ...
 if (eventp->fdtabs[fdp->fdidx] == fdp) {
  ...
  acl_msg_fatal("%s(%d): fdidx(%d)'s fdp invalid",
   myname, 315, fdp->fdidx);
 }

 if (fdp->fdidx_ready > 0
     && fdp->fdidx_ready < eventp->ready_cnt
     && eventp->ready[fdp->fdidx_ready] == fdp) {
  eventp->ready[fdp->fdidx_ready] = 
# 321 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
                                   ((void *)0)
# 321 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
                                       ;
 }
 event_fdtable_free(fdp);
 stream->fdp = 
# 324 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
              ((void *)0)
# 324 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
                  ;
 stream->nrefer--;
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_select_thr.c", 326, strerror(status)); } while (0);
}
...
static int event_isrset(ACL_EVENT *eventp, ACL_VSTREAM *stream)
{
 ...
 return 
# 333 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
       ((((
# 333 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
       &event_thr->rmask
# 333 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
       )->__fds_bits)[__extension__ ({ long int __d = (
# 333 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
static int event_iswset(ACL_EVENT *eventp, ACL_VSTREAM *stream)
{
 ...
 return 
# 340 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
       ((((
# 340 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
       &event_thr->wmask
# 340 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
       )->__fds_bits)[__extension__ ({ long int __d = (
# 340 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
static int event_isxset(ACL_EVENT *eventp, ACL_VSTREAM *stream)
{
 ...
 return 
# 347 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
       ((((
# 347 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
       &event_thr->xmask
# 347 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
       )->__fds_bits)[__extension__ ({ long int __d = (
# 347 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
# 368 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
((void *)0)
# 368 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
); (eventp->present) = ((long long int) _tv.tv_sec) * 1000000 + ((long long int) _tv.tv_usec); };

 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tm_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/workspace/acl/lib_acl/src/event/events_select_thr.c", 370, strerror(status)); } while (0);
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tm_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_select_thr.c", 386, strerror(status)); } while (0);

 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/workspace/acl/lib_acl/src/event/events_select_thr.c", 388, strerror(status)); } while (0);

 eventp->ready_cnt = 0;

 if (event_thr_prepare(eventp) == 0) {
  do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_select_thr.c", 393, strerror(status)); } while (0);

  if (eventp->ready_cnt == 0) {
   acl_doze(delay > 1000 ? (int) delay / 1000 : 1);
  }
 ...
 if (eventp->ready_cnt > 0) {
  ...
  tvp = 
# 417 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
       ((void *)0)
# 417 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
           ;
 }
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_select_thr.c", 424, strerror(status)); } while (0);
 ...
 if (nready < 0) {
  if (acl_last_error() != 
# 430 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
                         4
# 430 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
                                  ) {
   acl_msg_fatal("%s(%d), %s: event_loop: select: %s",
    "/workspace/acl/lib_acl/src/event/events_select_thr.c", 432, myname, acl_last_serror());
  }
  goto TAG_DONE;
 } else if (nready == 0) {
  goto TAG_DONE;
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_lock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): lock error(%s)", "/workspace/acl/lib_acl/src/event/events_select_thr.c", 439, strerror(status)); } while (0);
 ...
 for (i = 0; i < eventp->fdcnt; i++) {
  ...
  sockfd = ((fdp->stream)->fd.sock);

  if (
# 451 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
     ((((
# 451 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
     &xmask
# 451 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
     )->__fds_bits)[__extension__ ({ long int __d = (
# 451 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
# 451 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
  ...
  if (
# 458 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
     ((((
# 458 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
     &rmask
# 458 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
     )->__fds_bits)[__extension__ ({ long int __d = (
# 458 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
# 471 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
                               ((((
# 471 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
                               &wmask
# 471 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
                               )->__fds_bits)[__extension__ ({ long int __d = (
# 471 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
# 471 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
 ...
 do { acl_pthread_mutex_t *mutex_ptr = (&event_thr->event.tb_mutex); int status = pthread_mutex_unlock(mutex_ptr); if (status != 0) acl_msg_fatal("%s(%d): unlock error(%s)", "/workspace/acl/lib_acl/src/event/events_select_thr.c", 478, strerror(status)); } while (0);
...
static void event_free(ACL_EVENT *eventp)
{
 ...
 if (eventp == 
# 502 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
              ((void *)0)
# 502 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
                  )
  acl_msg_fatal("%s, %s(%d): eventp null",
    "/workspace/acl/lib_acl/src/event/events_select_thr.c", myname, 504);
 ...
 do { if (eventp) { acl_free_glue("/workspace/acl/lib_acl/src/event/events_select_thr.c", 509, (eventp)); (eventp) = 
# 509 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
((void *)0)
# 509 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
; } } while (0);
}
...
ACL_EVENT *event_new_select_thr(void)
{
 ...
 event_thr->event.event.event_mode = 0;
...
# 537 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
       do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((
# 537 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
       &event_thr->rmask
# 537 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
...
# 538 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
       do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((
# 538 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
       &event_thr->wmask
# 538 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
       )->__fds_bits)[0]) : "memory"); } while (0)
# 538 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
...
# 539 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
       do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((
# 539 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
       &event_thr->xmask
# 539 "/workspace/acl/lib_acl/src/event/events_select_thr.c" 3 4
       )->__fds_bits)[0]) : "memory"); } while (0)
# 539 "/workspace/acl/lib_acl/src/event/events_select_thr.c"
