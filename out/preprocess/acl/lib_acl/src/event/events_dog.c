# 0 "/acl/lib_acl/src/event/events_dog.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/acl/lib_acl/src/event/events_dog.c"
...
# 2 "/acl/lib_acl/src/event/events_dog.c" 2
# 20 "/acl/lib_acl/src/event/events_dog.c"
...
# 21 "/acl/lib_acl/src/event/events_dog.c" 2
...
static void event_dog_close(EVENT_DOG *evdog)
{
 ...
 evdog->sstream = 
# 46 "/acl/lib_acl/src/event/events_dog.c" 3 4
                 ((void *)0)
# 46 "/acl/lib_acl/src/event/events_dog.c"
                     ;
 evdog->server = 
# 47 "/acl/lib_acl/src/event/events_dog.c" 3 4
                ((void *)0)
# 47 "/acl/lib_acl/src/event/events_dog.c"
                    ;
 evdog->client = 
# 48 "/acl/lib_acl/src/event/events_dog.c" 3 4
                ((void *)0)
# 48 "/acl/lib_acl/src/event/events_dog.c"
                    ;
}
 ...
 ACL_VSTREAM *stream, void *context)
{
 ...
 if (evdog->client != stream)
  acl_msg_fatal("%s(%d), %s: stream != evdog->client",
   "/acl/lib_acl/src/event/events_dog.c", 60, myname);
...
static void event_dog_open(EVENT_DOG *evdog)
{
 ...
 if (evdog->sstream == 
# 80 "/acl/lib_acl/src/event/events_dog.c" 3 4
                      ((void *)0)
# 80 "/acl/lib_acl/src/event/events_dog.c"
                          )
 ...
 evdog->server = acl_vstream_connect(((evdog->sstream)->addr_local ? (evdog->sstream)->addr_local : ""),
   0, 0, 0, 1024);
 if (evdog->server == 
# 86 "/acl/lib_acl/src/event/events_dog.c" 3 4
                     ((void *)0)
# 86 "/acl/lib_acl/src/event/events_dog.c"
                         )
 ...
 if (evdog->client == 
# 95 "/acl/lib_acl/src/event/events_dog.c" 3 4
                     ((void *)0)
# 95 "/acl/lib_acl/src/event/events_dog.c"
                         )
 ...
 acl_vstream_close(evdog->sstream);
 evdog->sstream = 
# 104 "/acl/lib_acl/src/event/events_dog.c" 3 4
                 ((void *)0)
# 104 "/acl/lib_acl/src/event/events_dog.c"
                     ;
...
EVENT_DOG *event_dog_create(ACL_EVENT *eventp, int thread_mode)
{
 ...
 evdog = (EVENT_DOG*) acl_calloc_glue("/acl/lib_acl/src/event/events_dog.c", 119, 1, sizeof(EVENT_DOG));
 evdog->eventp = eventp;
...
ACL_VSTREAM *event_dog_client(EVENT_DOG *evdog)
{
 if (evdog && evdog->client)
  return (evdog->client);
 return 
# 131 "/acl/lib_acl/src/event/events_dog.c" 3 4
       ((void *)0)
# 131 "/acl/lib_acl/src/event/events_dog.c"
           ;
}
...
{
 event_dog_close(evdog);
 do { if (evdog) { acl_free_glue("/acl/lib_acl/src/event/events_dog.c", 151, (evdog)); (evdog) = 
# 151 "/acl/lib_acl/src/event/events_dog.c" 3 4
((void *)0)
# 151 "/acl/lib_acl/src/event/events_dog.c"
; } } while (0);
}
