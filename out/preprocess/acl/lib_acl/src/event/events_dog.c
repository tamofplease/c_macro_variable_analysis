# 1 "/workspace/acl/lib_acl/src/event/events_dog.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/workspace/acl/lib_acl/src/event/events_dog.c" 2
# 20 "/workspace/acl/lib_acl/src/event/events_dog.c"
...
# 21 "/workspace/acl/lib_acl/src/event/events_dog.c" 2
...
static void event_dog_close(EVENT_DOG *evdog)
{
 ...
 evdog->sstream = 
# 46 "/workspace/acl/lib_acl/src/event/events_dog.c" 3 4
                 ((void *)0)
# 46 "/workspace/acl/lib_acl/src/event/events_dog.c"
                     ;
 evdog->server = 
# 47 "/workspace/acl/lib_acl/src/event/events_dog.c" 3 4
                ((void *)0)
# 47 "/workspace/acl/lib_acl/src/event/events_dog.c"
                    ;
 evdog->client = 
# 48 "/workspace/acl/lib_acl/src/event/events_dog.c" 3 4
                ((void *)0)
# 48 "/workspace/acl/lib_acl/src/event/events_dog.c"
                    ;
}

static void read_fn(int event_type __attribute__ ((__unused__)), ACL_EVENT *event,
 ACL_VSTREAM *stream, void *context)
{
 ...
 if (evdog->client != stream)
  acl_msg_fatal("%s(%d), %s: stream != evdog->client",
   "/workspace/acl/lib_acl/src/event/events_dog.c", 60, myname);

 evdog->client->rw_timeout = 1;
 if (acl_vstream_readn(evdog->client, buf, 1) == (-1)) {
...
static void event_dog_open(EVENT_DOG *evdog)
{
 ...
 if (evdog->sstream == 
# 80 "/workspace/acl/lib_acl/src/event/events_dog.c" 3 4
                      ((void *)0)
# 80 "/workspace/acl/lib_acl/src/event/events_dog.c"
                          )
  acl_msg_fatal("%s(%d): listen on addr(%s) error(%s)",
   myname, 82, addr, acl_last_serror());

 evdog->server = acl_vstream_connect(((evdog->sstream)->addr_local ? (evdog->sstream)->addr_local : ""),
   0, 0, 0, 1024);
 if (evdog->server == 
# 86 "/workspace/acl/lib_acl/src/event/events_dog.c" 3 4
                     ((void *)0)
# 86 "/workspace/acl/lib_acl/src/event/events_dog.c"
                         )
  acl_msg_fatal("%s(%d): connect to addr(%s) error(%s)",
   myname, 88, addr, acl_last_serror());

 if (acl_vstream_writen(evdog->server, buf, 1) == (-1))
  acl_msg_fatal("%s(%d): pre write error(%s)",
   myname, 92, acl_last_serror());

 evdog->client = acl_vstream_accept(evdog->sstream, buf, sizeof(buf));
 if (evdog->client == 
# 95 "/workspace/acl/lib_acl/src/event/events_dog.c" 3 4
                     ((void *)0)
# 95 "/workspace/acl/lib_acl/src/event/events_dog.c"
                         )
  acl_msg_fatal("%s(%d): accept error(%s)",
   myname, 97, acl_last_serror());

 if (acl_vstream_readn(evdog->client, buf, 1) == (-1))
  acl_msg_fatal("%s(%d): pre read error(%s)",
   myname, 101, acl_last_serror());

 acl_vstream_close(evdog->sstream);
 evdog->sstream = 
# 104 "/workspace/acl/lib_acl/src/event/events_dog.c" 3 4
                 ((void *)0)
# 104 "/workspace/acl/lib_acl/src/event/events_dog.c"
                     ;
...
EVENT_DOG *event_dog_create(ACL_EVENT *eventp, int thread_mode)
{
 ...
 evdog = (EVENT_DOG*) acl_calloc_glue("/workspace/acl/lib_acl/src/event/events_dog.c", 119, 1, sizeof(EVENT_DOG));
 evdog->eventp = eventp;
...
ACL_VSTREAM *event_dog_client(EVENT_DOG *evdog)
{
 if (evdog && evdog->client)
  return (evdog->client);
 return 
# 131 "/workspace/acl/lib_acl/src/event/events_dog.c" 3 4
       ((void *)0)
# 131 "/workspace/acl/lib_acl/src/event/events_dog.c"
           ;
}
...
void event_dog_notify(EVENT_DOG *evdog)
{
 ...
 if (acl_vstream_writen(evdog->server, buf, 1) == (-1)) {
  acl_msg_error("%s(%d): notify error, reset", myname, 143);
  event_dog_reopen(evdog);
 }
}
...
{
 event_dog_close(evdog);
 do { if (evdog) { acl_free_glue("/workspace/acl/lib_acl/src/event/events_dog.c", 151, (evdog)); (evdog) = 
# 151 "/workspace/acl/lib_acl/src/event/events_dog.c" 3 4
((void *)0)
# 151 "/workspace/acl/lib_acl/src/event/events_dog.c"
; } } while (0);
}
