# 0 "/ejdb/src/jbi/jbi_consumer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/ejdb/src/jbi/jbi_consumer.c"
...
# 2 "/ejdb/src/jbi/jbi_consumer.c" 2

iwrc jbi_consumer(struct _JBEXEC *ctx, IWKV_cursor cur, int64_t id, int64_t *step, 
# 3 "/ejdb/src/jbi/jbi_consumer.c" 3 4
                                                                                  _Bool 
# 3 "/ejdb/src/jbi/jbi_consumer.c"
                                                                                       *matched, iwrc err) {
  if (!id) {
    return err;
  }
...
start:
  {
    ...
    if (rc == IWKV_ERROR_NOTFOUND) {
      rc = 0;
      if (ctx->midx.idx) {
        iwlog2(IWLOG_ERROR, 0, "/ejdb/src/jbi/jbi_consumer.c", 28, ("Orphaned index entry." "\n\tCollection db: %" 
# 28 "/ejdb/src/jbi/jbi_consumer.c" 3 4
       "u" 
# 28 "/ejdb/src/jbi/jbi_consumer.c"
       "\n\tIndex db: %" 
# 28 "/ejdb/src/jbi/jbi_consumer.c" 3 4
       "u" 
# 28 "/ejdb/src/jbi/jbi_consumer.c"
...
# 28 "/ejdb/src/jbi/jbi_consumer.c" 3 4
       "l" "d"
# 28 "/ejdb/src/jbi/jbi_consumer.c"
       ), ctx->jbc->dbid, ctx->midx.idx->dbid, id)


                                                                                      ;
      } else {
        iwlog2(IWLOG_ERROR, 0, "/ejdb/src/jbi/jbi_consumer.c", 33, ("Orphaned index entry." "\n\tCollection db: %" 
# 33 "/ejdb/src/jbi/jbi_consumer.c" 3 4
       "u" 
# 33 "/ejdb/src/jbi/jbi_consumer.c"
       "\n\tEntry id: %" 
# 33 "/ejdb/src/jbi/jbi_consumer.c" 3 4
       "l" "d"
# 33 "/ejdb/src/jbi/jbi_consumer.c"
    ...
    if (vsz > ctx->jblbufsz) {
      size_t nsize = ((vsz) > (ctx->jblbufsz * 2) ? (vsz) : (ctx->jblbufsz * 2));
      void *nbuf = realloc(ctx->jblbuf, nsize);
      if (!nbuf) {
        rc = iwrc_set_errno(IW_ERROR_ALLOC, 
# 45 "/ejdb/src/jbi/jbi_consumer.c" 3 4
                                           (*__errno_location ())
# 45 "/ejdb/src/jbi/jbi_consumer.c"
                                                );
        goto finish;
      }
      ctx->jblbuf = nbuf;
  ...
  rc = jbl_from_buf_keep_onstack(&jbl, ctx->jblbuf, vsz); if (__builtin_expect((!!(rc)), 0)) goto finish;
  ...
  if (!ctx->istep) {
    ...
    if (aux->apply || aux->apply_placeholder || aux->projection) {
      ...
      if (!pool) {
        ...
        if (!pool) {
          rc = iwrc_set_errno(IW_ERROR_ALLOC, 
# 78 "/ejdb/src/jbi/jbi_consumer.c" 3 4
                                             (*__errno_location ())
# 78 "/ejdb/src/jbi/jbi_consumer.c"
                                                  );
          goto finish;
        }
      }
      rc = jbl_to_node(&jbl, &root, 
# 82 "/ejdb/src/jbi/jbi_consumer.c" 3 4
     1
# 82 "/ejdb/src/jbi/jbi_consumer.c"
     , pool); if (__builtin_expect((!!(rc)), 0)) goto finish;
      doc.node = root;
      if (aux->qmode & ((jqp_query_mode_t) 0x04U)) {
        if (cur) {
        ...
        struct _JBL sn = { 0 };
        rc = jql_apply(q, root, pool); if (__builtin_expect((!!(rc)), 0)) goto finish;
        rc = _jbl_from_node(&sn, root); if (__builtin_expect((!!(rc)), 0)) goto finish;
        if (cur) {
      ...
      if (__builtin_expect((!!(rc)), 0)) goto finish;
      if (aux->projection) {
        rc = jql_project(q, root, pool, ctx); if (__builtin_expect((!!(rc)), 0)) goto finish;
      }
    } else if (aux->qmode & ((jqp_query_mode_t) 0x04U)) {
      if (cur) {
        rc = jb_cursor_del(ctx->jbc, cur, id, &jbl);
      } else {
        rc = jb_del(ctx->jbc, &jbl, id);
    ...
    if (!(aux->qmode & (((jqp_query_mode_t) 0x01U)))) {
      do {
        ctx->istep = 1;
