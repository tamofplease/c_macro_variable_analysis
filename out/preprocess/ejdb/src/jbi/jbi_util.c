# 0 "/ejdb/src/jbi/jbi_util.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/ejdb/src/jbi/jbi_util.c"
...
void jbi_jbl_fill_ikey(JBIDX idx, JBL jbv, IWKV_val *ikey, char numbuf[static 32]) {
  ...
  ejdb_idx_mode_t itype = (idx->mode & ~(((ejdb_idx_mode_t) 0x01U)));
  ikey->size = 0;
  ikey->data = 0;
    ...
    case ((ejdb_idx_mode_t) 0x04U):
      switch (jbvt) {
        case JBV_STR:
          ...
          break;
        case JBV_I64:
          ikey->size = (size_t) iwitoa(jbl_get_i64(jbv), numbuf, 32);
          ikey->data = numbuf;
          break;
        case JBV_BOOL:
          if (jbl_get_i32(jbv)) {
    ...
    case ((ejdb_idx_mode_t) 0x04U):
      switch (jqvt) {
        case JQVAL_STR:
          ...
          break;
        case JQVAL_I64:
          ikey->size = (size_t) iwitoa(jqval->vi64, numbuf, 32);
          break;
        case JQVAL_BOOL:
          if (jqval->vbool) {
            ikey->size = sizeof("true");
    ...
    case ((ejdb_idx_mode_t) 0x04U):
      switch (jbvt) {
        case JBV_STR:
          ...
          break;
        case JBV_I64:
          ikey->size = (size_t) iwitoa(node->vi64, numbuf, 32);
          break;
        case JBV_BOOL:
          if (node->vbool) {
            ikey->size = sizeof("true");
...
# 237 "/ejdb/src/jbi/jbi_util.c" 3 4
_Bool 
# 237 "/ejdb/src/jbi/jbi_util.c"
    jbi_node_expr_matched(JQP_AUX *aux, JBIDX idx, IWKV_cursor cur, JQP_EXPR *expr, iwrc *rcp) {
  size_t sz;
  char skey[1024];
  char *kbuf = skey;
  
# 241 "/ejdb/src/jbi/jbi_util.c" 3 4
 _Bool 
# 241 "/ejdb/src/jbi/jbi_util.c"
      ret = 
# 241 "/ejdb/src/jbi/jbi_util.c" 3 4
            0
# 241 "/ejdb/src/jbi/jbi_util.c"
  ...
  if (!(idx->mode & (((ejdb_idx_mode_t) 0x04U) | ((ejdb_idx_mode_t) 0x08U) | ((ejdb_idx_mode_t) 0x10U)))) {
    return 
# 245 "/ejdb/src/jbi/jbi_util.c" 3 4
          0
# 245 "/ejdb/src/jbi/jbi_util.c"
               ;
  }
...
# 255 "/ejdb/src/jbi/jbi_util.c" 3 4
                                         (*__errno_location ())
# 255 "/ejdb/src/jbi/jbi_util.c"
                                              );
      goto finish;
    }
    rc = iwkv_cursor_copy_key(cur, kbuf, sizeof(skey) - 1, &sz, 0);
  ...
  if (idx->mode & ((ejdb_idx_mode_t) 0x04U)) {
    kbuf[sz] = '\0';
    lv.type = JQVAL_STR;
    lv.vstr = kbuf;
  } else if (idx->mode & ((ejdb_idx_mode_t) 0x08U)) {
    memcpy(&lv.vi64, kbuf, sizeof(lv.vi64));
    lv.type = JQVAL_I64;
  } else if (idx->mode & ((ejdb_idx_mode_t) 0x10U)) {
    kbuf[sz] = '\0';
    lv.type = JQVAL_F64;
