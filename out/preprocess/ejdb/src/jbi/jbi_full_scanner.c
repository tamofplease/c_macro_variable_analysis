# 0 "/ejdb/src/jbi/jbi_full_scanner.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/ejdb/src/jbi/jbi_full_scanner.c"
...
# 2 "/ejdb/src/jbi/jbi_full_scanner.c" 2

iwrc jbi_full_scanner(struct _JBEXEC *ctx, JB_SCAN_CONSUMER consumer) {
  
# 4 "/ejdb/src/jbi/jbi_full_scanner.c" 3 4
 _Bool 
# 4 "/ejdb/src/jbi/jbi_full_scanner.c"
      matched;
  IWKV_cursor cur;
  int64_t step = 1;
  ...
  while (step && !(rc = iwkv_cursor_to(cur, step > 0 ? ctx->cursor_step : cursor_reverse_step))) {
    ...
    if (!step) {
      ...
      if (sz != sizeof(id)) {
        ...
        iwlog3(IWLOG_ERROR, (rc), "/ejdb/src/jbi/jbi_full_scanner.c", 26, "");
        break;
      }
      step = 1;
      matched = 
# 30 "/ejdb/src/jbi/jbi_full_scanner.c" 3 4
               0
# 30 "/ejdb/src/jbi/jbi_full_scanner.c"
                    ;
