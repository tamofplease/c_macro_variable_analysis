# 0 "/ejdb/src/jbi/jbi_dup_scanner.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/ejdb/src/jbi/jbi_dup_scanner.c"
...
# 2 "/ejdb/src/jbi/jbi_dup_scanner.c" 2

static iwrc _jbi_consume_eq(struct _JBEXEC *ctx, JQVAL *jqval, JB_SCAN_CONSUMER consumer) {
  iwrc rc;
  
# 5 "/ejdb/src/jbi/jbi_dup_scanner.c" 3 4
 _Bool 
# 5 "/ejdb/src/jbi/jbi_dup_scanner.c"
      matched;
  IWKV_cursor cur;
  char numbuf[32];
  ...
  key.compound = 
# 17 "/ejdb/src/jbi/jbi_dup_scanner.c" 3 4
                (-9223372036854775807L -1)
# 17 "/ejdb/src/jbi/jbi_dup_scanner.c"
                         ;
  if (!key.size) {
  ...
  do {
    ...
    if (!step) {
      int64_t id;
      rc = iwkv_cursor_is_matched_key(cur, &key, &matched, &id); if (__builtin_expect((!!(rc)), 0)) goto finish;
      if (!matched) {
        break;
      }
      step = 1;
      rc = consumer(ctx, 0, id, &step, &matched, 0); if (__builtin_expect((!!(rc)), 0)) goto finish;
    }
...
# 65 "/ejdb/src/jbi/jbi_dup_scanner.c" 3 4
 _Bool 
# 65 "/ejdb/src/jbi/jbi_dup_scanner.c"
      matched;
  char jqvarrbuf[512];
  char numbuf[32];
  ...
  struct _JBMIDX *midx = &ctx->midx;
  JBIDX idx = midx->idx;
  IWKV_val key = { .compound = 
# 74 "/ejdb/src/jbi/jbi_dup_scanner.c" 3 4
                              (-9223372036854775807L -1) 
# 74 "/ejdb/src/jbi/jbi_dup_scanner.c"
                                        };
...
# 89 "/ejdb/src/jbi/jbi_dup_scanner.c" 3 4
                                         (*__errno_location ())
# 89 "/ejdb/src/jbi/jbi_dup_scanner.c"
                                              );
  }
  ...
  for (int c = 0; c < i && !rc; ++c) {
    ...
    rc = iwkv_cursor_open(idx->idb, &cur, IWKV_CURSOR_GE, &key); if (__builtin_expect((!!(rc)), 0)) goto finish;
    do {
      if (step > 0) {
        --step;
      } else if (step < 0) {
    ...
    } while (step && !(rc = iwkv_cursor_to(cur, IWKV_CURSOR_PREV)));
  }
...
static iwrc _jbi_consume_scan(struct _JBEXEC *ctx, JQVAL *jqval, JB_SCAN_CONSUMER consumer) {
  ...
  key.compound = (midx->cursor_step == IWKV_CURSOR_PREV) ? 
# 153 "/ejdb/src/jbi/jbi_dup_scanner.c" 3 4
                                                          (-9223372036854775807L -1) 
# 153 "/ejdb/src/jbi/jbi_dup_scanner.c"
                                                                    : 
# 153 "/ejdb/src/jbi/jbi_dup_scanner.c" 3 4
...
# 153 "/ejdb/src/jbi/jbi_dup_scanner.c"
  ...
  if ((rc == IWKV_ERROR_NOTFOUND) && ((expr1_op == JQP_OP_LT) || (expr1_op == JQP_OP_LTE))) {
    iwkv_cursor_close(&cur);
    key.compound = 
# 158 "/ejdb/src/jbi/jbi_dup_scanner.c" 3 4
                  (9223372036854775807L)
# 158 "/ejdb/src/jbi/jbi_dup_scanner.c"
                           ;
    midx->cursor_init = IWKV_CURSOR_BEFORE_FIRST;
    midx->cursor_step = IWKV_CURSOR_NEXT;
    rc = iwkv_cursor_open(idx->idb, &cur, midx->cursor_init, 0); if (__builtin_expect((!!(rc)), 0)) goto finish;
    if (!midx->expr2) {
  ...
  if (midx->cursor_init < IWKV_CURSOR_NEXT) {
    rc = iwkv_cursor_to(cur, midx->cursor_step); if (__builtin_expect((!!(rc)), 0)) goto finish;
  }
...
# 183 "/ejdb/src/jbi/jbi_dup_scanner.c" 3 4
     _Bool 
# 183 "/ejdb/src/jbi/jbi_dup_scanner.c"
          matched = 
# 183 "/ejdb/src/jbi/jbi_dup_scanner.c" 3 4
                    0
# 183 "/ejdb/src/jbi/jbi_dup_scanner.c"
                         ;
      rc = iwkv_cursor_copy_key(cur, 0, 0, &sz, &id); if (__builtin_expect((!!(rc)), 0)) goto finish;
      if ( midx->expr2
...
# 200 "/ejdb/src/jbi/jbi_dup_scanner.c" 3 4
                                   1
# 200 "/ejdb/src/jbi/jbi_dup_scanner.c"
                                       ;
        }
        prev_id = step < 1 ? 0 : id;
      }
...
static iwrc _jbi_consume_noxpr_scan(struct _JBEXEC *ctx, JB_SCAN_CONSUMER consumer) {
  ...
  rc = iwkv_cursor_open(midx->idx->idb, &cur, midx->cursor_init, 0); if (__builtin_expect((!!(rc)), 0)) goto finish;
  if (midx->cursor_init < IWKV_CURSOR_NEXT) {
    rc = iwkv_cursor_to(cur, midx->cursor_step); if (__builtin_expect((!!(rc)), 0)) goto finish;
  }
  do {
...
# 238 "/ejdb/src/jbi/jbi_dup_scanner.c" 3 4
     _Bool 
# 238 "/ejdb/src/jbi/jbi_dup_scanner.c"
          matched;
      rc = iwkv_cursor_copy_key(cur, 0, 0, &sz, &id); if (__builtin_expect((!!(rc)), 0)) goto finish;
      step = 1;
      if (id != prev_id) {
  ...
  switch (midx->expr1->op->value) {
    ...
    case JQP_OP_IN:
      if (jqval->type == JQVAL_JBLNODE) {
        ...
        iwlog3(IWLOG_ERROR, (IW_ERROR_ASSERTION), "/ejdb/src/jbi/jbi_dup_scanner.c", 274, "");
