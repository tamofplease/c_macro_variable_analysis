# 0 "/ejdb/src/jbi/jbi_uniq_scanner.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/ejdb/src/jbi/jbi_uniq_scanner.c"
...
# 2 "/ejdb/src/jbi/jbi_uniq_scanner.c" 2


# 3 "/ejdb/src/jbi/jbi_uniq_scanner.c" 3 4
_Static_assert
# 3 "/ejdb/src/jbi/jbi_uniq_scanner.c"
            (10 <= 32, "IW_VNUMBUFSZ <= JBNUMBUF_SIZE");
...
# 9 "/ejdb/src/jbi/jbi_uniq_scanner.c" 3 4
 _Bool 
# 9 "/ejdb/src/jbi/jbi_uniq_scanner.c"
      matched;
  ...
  do { (id) = 0; int64_t _base_ = 1; int _i_ = 0; while (1) { if (((const signed char*) (numbuf))[_i_] >= 0) { (id) += _base_ * ((const signed char*) (numbuf))[_i_]; break; } (id) += _base_ * ~(((const signed char*) (numbuf))[_i_]); _base_ <<= 7; _i_++; } } while (0);
...
# 35 "/ejdb/src/jbi/jbi_uniq_scanner.c" 3 4
 _Bool 
# 35 "/ejdb/src/jbi/jbi_uniq_scanner.c"
      matched;
  char numbuf[32];
...
# 118 "/ejdb/src/jbi/jbi_uniq_scanner.c" 3 4
     _Bool 
# 118 "/ejdb/src/jbi/jbi_uniq_scanner.c"
          matched = 
# 118 "/ejdb/src/jbi/jbi_uniq_scanner.c" 3 4
                    0
# 118 "/ejdb/src/jbi/jbi_uniq_scanner.c"
                         ;
      rc = iwkv_cursor_copy_val(cur, &numbuf, 10, &sz); if (__builtin_expect((!!(rc)), 0)) goto finish;
      if (sz > 10) {
        rc = IWKV_ERROR_CORRUPTED;
        iwlog3(IWLOG_ERROR, (rc), "/ejdb/src/jbi/jbi_uniq_scanner.c", 122, "");
        break;
      }
      do { (id) = 0; int64_t _base_ = 1; int _i_ = 0; while (1) { if (((const signed char*) (numbuf))[_i_] >= 0) { (id) += _base_ * ((const signed char*) (numbuf))[_i_]; break; } (id) += _base_ * ~(((const signed char*) (numbuf))[_i_]); _base_ <<= 7; _i_++; } } while (0);
      if ( midx->expr2
...
# 141 "/ejdb/src/jbi/jbi_uniq_scanner.c" 3 4
                                 1
# 141 "/ejdb/src/jbi/jbi_uniq_scanner.c"
                                     ;
      }
    }
...
# 178 "/ejdb/src/jbi/jbi_uniq_scanner.c" 3 4
     _Bool 
# 178 "/ejdb/src/jbi/jbi_uniq_scanner.c"
          matched;
      rc = iwkv_cursor_copy_val(cur, &numbuf, 10, &sz); if (__builtin_expect((!!(rc)), 0)) goto finish;
      if (sz > 10) {
        rc = IWKV_ERROR_CORRUPTED;
        iwlog3(IWLOG_ERROR, (rc), "/ejdb/src/jbi/jbi_uniq_scanner.c", 182, "");
        break;
      }
      do { (id) = 0; int64_t _base_ = 1; int _i_ = 0; while (1) { if (((const signed char*) (numbuf))[_i_] >= 0) { (id) += _base_ * ((const signed char*) (numbuf))[_i_]; break; } (id) += _base_ * ~(((const signed char*) (numbuf))[_i_]); _base_ <<= 7; _i_++; } } while (0);
      if (__builtin_expect((!!(rc)), 0)) goto finish;
  ...
  switch (midx->expr1->op->value) {
    ...
    case JQP_OP_IN:
      if (jqval->type == JQVAL_JBLNODE) {
        ...
        iwlog3(IWLOG_ERROR, (IW_ERROR_ASSERTION), "/ejdb/src/jbi/jbi_uniq_scanner.c", 218, "");
