# 0 "/mydumper/src/myloader_jobs_manager.c"
# 1 "/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/mydumper/src/myloader_jobs_manager.c"
# 17 "/mydumper/src/myloader_jobs_manager.c"
...
MYSQL * mysql_real_connect_dns_srv(MYSQL *mysql,
                                          ...
                                          const char *db,
                                          unsigned long client_flag);
# 18 "/mydumper/src/myloader_jobs_manager.c" 2
...
# 19 "/mydumper/src/myloader_jobs_manager.c" 2
...
# 20 "/mydumper/src/myloader_jobs_manager.c" 2
...
# 24 "/mydumper/src/myloader_jobs_manager.c" 2
...
# 25 "/mydumper/src/myloader_jobs_manager.c" 2
# 1 "/mydumper/src/myloader.h" 1
# 26 "/mydumper/src/myloader_jobs_manager.c" 2
...
# 27 "/mydumper/src/myloader_jobs_manager.c" 2
...
# 28 "/mydumper/src/myloader_jobs_manager.c" 2
...
# 29 "/mydumper/src/myloader_jobs_manager.c" 2
...
# 30 "/mydumper/src/myloader_jobs_manager.c" 2
...
# 31 "/mydumper/src/myloader_jobs_manager.c" 2
...
# 32 "/mydumper/src/myloader_jobs_manager.c" 2
...
# 33 "/mydumper/src/myloader_jobs_manager.c" 2
...
# 34 "/mydumper/src/myloader_jobs_manager.c" 2
...
# 43 "/mydumper/src/myloader_jobs_manager.c" 3 4
                         ((void *)0)
# 43 "/mydumper/src/myloader_jobs_manager.c"
                             ;
static GMutex *index_mutex=
# 44 "/mydumper/src/myloader_jobs_manager.c" 3 4
                          ((void *)0)
# 44 "/mydumper/src/myloader_jobs_manager.c"
                              ;
...
gboolean process_index(struct thread_data * td){
  ...
  if ( max_threads_for_index_creation > index_threads_counter){
    ...
    if (job != 
# 75 "/mydumper/src/myloader_jobs_manager.c" 3 4
              ((void *)0)
# 75 "/mydumper/src/myloader_jobs_manager.c"
                  ){
...
void sync_threads(guint *counter, GMutex *mutex){
  if ((__extension__ ({ _Static_assert (sizeof *(counter) == sizeof (gint), "Expression evaluates to false"); (void) (0 ? *(counter) ^ *(counter) : 1); __atomic_fetch_sub ((counter), 1, 5) == 1; }))){
...
# 106 "/mydumper/src/myloader_jobs_manager.c" 3 4
                          ((void *)0)
# 106 "/mydumper/src/myloader_jobs_manager.c"
                              );
  g_mutex_unlock(init_mutex);
  td->current_database=
# 108 "/mydumper/src/myloader_jobs_manager.c" 3 4
                      ((void *)0)
# 108 "/mydumper/src/myloader_jobs_manager.c"
                          ;

  m_connect(td->thrconn, "myloader", 
# 110 "/mydumper/src/myloader_jobs_manager.c" 3 4
                                    ((void *)0)
# 110 "/mydumper/src/myloader_jobs_manager.c"
                                        );
  ...
  g_async_queue_push(conf->ready, ((gpointer) (glong) (1)));

  if (db){
    td->current_database=db;
    if (execute_use(td, "Initializing thread")){
      g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Changing to database: %s %s", td->current_database,db);
      exit(
# 124 "/mydumper/src/myloader_jobs_manager.c" 3 4
          1
# 124 "/mydumper/src/myloader_jobs_manager.c"
                      );
    }
  }

  g_log (((gchar*) 0), G_LOG_LEVEL_DEBUG, "Thread %d: Starting import", td->thread_id);
  process_stream_queue(td);
  struct control_job *job = 
# 130 "/mydumper/src/myloader_jobs_manager.c" 3 4
                           ((void *)0)
# 130 "/mydumper/src/myloader_jobs_manager.c"
                               ;
  gboolean cont=(!(0));
  ...
  g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Thread %d: Starting post import task over table", td->thread_id);
  cont=(!(0));
  while (cont){
  ...
  mysql_thread_end();
  g_log (((gchar*) 0), G_LOG_LEVEL_DEBUG, "Thread %d ending", td->thread_id);
  return 
# 171 "/mydumper/src/myloader_jobs_manager.c" 3 4
        ((void *)0)
# 171 "/mydumper/src/myloader_jobs_manager.c"
            ;
}

GThread **threads = 
# 174 "/mydumper/src/myloader_jobs_manager.c" 3 4
                   ((void *)0)
# 174 "/mydumper/src/myloader_jobs_manager.c"
                       ;
struct thread_data *td = 
# 175 "/mydumper/src/myloader_jobs_manager.c" 3 4
                        ((void *)0)
# 175 "/mydumper/src/myloader_jobs_manager.c"
                            ;

void initialize_loader_threads(struct configuration *conf){
  guint n=0;
  threads = (GThread * *) (__extension__ ({ gsize __n = (gsize) (num_threads); gsize __s = sizeof (GThread *); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 179 "/mydumper/src/myloader_jobs_manager.c" 3 4
           (0x7fffffffffffffffL * 2UL + 1UL) 
# 179 "/mydumper/src/myloader_jobs_manager.c"
           / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  td = (struct thread_data *) (__extension__ ({ gsize __n = (gsize) (num_threads); gsize __s = sizeof (struct thread_data); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 180 "/mydumper/src/myloader_jobs_manager.c" 3 4
      (0x7fffffffffffffffL * 2UL + 1UL) 
# 180 "/mydumper/src/myloader_jobs_manager.c"
      / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  for (n = 0; n < num_threads; n++) {
    td[n].conf = conf;
    td[n].thread_id = n + 1;
    threads[n] =
        g_thread_create((GThreadFunc)loader_thread, &td[n], (!(0)), 
# 185 "/mydumper/src/myloader_jobs_manager.c" 3 4
                                                                 ((void *)0)
# 185 "/mydumper/src/myloader_jobs_manager.c"
                                                                     );
