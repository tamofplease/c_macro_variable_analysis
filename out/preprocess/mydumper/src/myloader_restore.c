# 0 "/mydumper/src/myloader_restore.c"
# 1 "/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/mydumper/src/myloader_restore.c"
# 17 "/mydumper/src/myloader_restore.c"
...
MYSQL * mysql_real_connect_dns_srv(MYSQL *mysql,
                                          ...
                                          const char *db,
                                          unsigned long client_flag);
# 18 "/mydumper/src/myloader_restore.c" 2
...
# 19 "/mydumper/src/myloader_restore.c" 2
...
# 20 "/mydumper/src/myloader_restore.c" 2
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                              ...
                                                              ;
# 26 "/mydumper/src/myloader_restore.c" 2
...
# 28 "/mydumper/src/myloader_restore.c" 2
...
enum file_type {
  ...
  DO_NOT_ENQUEUE,
  INTERMEDIATE_ENDED };
# 30 "/mydumper/src/myloader_restore.c" 2
...
# 31 "/mydumper/src/myloader_restore.c" 2
...
# 32 "/mydumper/src/myloader_restore.c" 2
extern guint errors;
...
# 42 "/mydumper/src/myloader_restore.c" 3 4
                                                                                          ((void *)0)
# 42 "/mydumper/src/myloader_restore.c"
                                                                                              },
    {
# 43 "/mydumper/src/myloader_restore.c" 3 4
    ((void *)0)
# 43 "/mydumper/src/myloader_restore.c"
...
int restore_data_in_gstring_by_statement(struct thread_data *td, GString *data, gboolean is_schema, guint *query_counter)
{
  if (mysql_real_query(td->thrconn, data->str, data->len)) {
    if (is_schema)
      g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Thread %d: Error restoring: %s %s", td->thread_id, data->str, mysql_error(td->thrconn));
    else
      g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Thread %d: Error restoring: %s", td->thread_id, mysql_error(td->thrconn));
    errors++;
    return 1;
  }
...
int restore_data_in_gstring(struct thread_data *td, GString *data, gboolean is_schema, guint *query_counter)
{
  ...
  int r=0;
  if (data != 
# 80 "/mydumper/src/myloader_restore.c" 3 4
             ((void *)0) 
# 80 "/mydumper/src/myloader_restore.c"
                  && data->len > 4){
                  ...
                  GString *data, gboolean is_schema, guint *query_counter, guint offset_line)
{
  ...
  do {
    ...
    do {
      ...
      next_line=g_strstr_len(current_line, -1, "\n");
      current_offset_line++;
    } while (current_rows < rows && next_line != 
# 119 "/mydumper/src/myloader_restore.c" 3 4
                                                ((void *)0)
# 119 "/mydumper/src/myloader_restore.c"
                                                    );
    ...
    r+=tr;
    if (tr > 0){
      g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Error occurs between lines: %d and %d in a splited INSERT: %s",offset_line,current_offset_line,mysql_error(td->thrconn));
    }
    offset_line=current_offset_line+1;
    current_line++;
  } while (next_line != 
# 130 "/mydumper/src/myloader_restore.c" 3 4
                       ((void *)0)
# 130 "/mydumper/src/myloader_restore.c"
                           );
  g_string_free(new_insert,(!(0)));
...
void *send_file_to_fifo(gchar *compressed_filename){
  ...
  FILE *file=
# 141 "/mydumper/src/myloader_restore.c" 3 4
            ((void *)0)
# 141 "/mydumper/src/myloader_restore.c"
                ;
  gboolean is_compressed = (0);
  gchar *path = g_build_filename(directory, compressed_filename, 
# 143 "/mydumper/src/myloader_restore.c" 3 4
                                                                ((void *)0)
# 143 "/mydumper/src/myloader_restore.c"
                                                                    );
  ...
  do {
    ...
    if (l!=strlen(buffer))
      g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Incomplete data transferred to FIFO: %s", fifo_name);
  } while (eof == (0));
  fclose(fd);
  return 
# 160 "/mydumper/src/myloader_restore.c" 3 4
        ((void *)0)
# 160 "/mydumper/src/myloader_restore.c"
            ;
}
...
int restore_data_from_file(struct thread_data *td, char *database, char *table,
  ...
  FILE *infile=
# 165 "/mydumper/src/myloader_restore.c" 3 4
              ((void *)0)
# 165 "/mydumper/src/myloader_restore.c"
                  ;
  int r=0;
  gboolean is_compressed = (0);
  gboolean eof = (0);
...
# 172 "/mydumper/src/myloader_restore.c" 3 4
                                                     ((void *)0)
# 172 "/mydumper/src/myloader_restore.c"
                                                         );
  ml_open(&infile,path,&is_compressed);
# 183 "/mydumper/src/myloader_restore.c"
  if (!infile) {
    g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "cannot open file %s (%d)", filename, 
# 184 "/mydumper/src/myloader_restore.c" 3 4
   (*__errno_location ())
# 184 "/mydumper/src/myloader_restore.c"
   );
    errors++;
    return 1;
  }
        ...
        if (rows > 0 && g_strrstr_len(data->str,6,"INSERT"))
          ...
          if (g_strrstr_len(data->str,10,"LOAD DATA ")){
            ...
            if (has_compession_extension(fff)){
              ...
              g_thread_create((GThreadFunc)send_file_to_fifo, fff, (!(0)), 
# 209 "/mydumper/src/myloader_restore.c" 3 4
                                                                        ((void *)0)
# 209 "/mydumper/src/myloader_restore.c"
                                                                            );
        ...
        r+=tr;
        if (tr > 0){
            g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Error occurs between lines: %d and %d on file %s: %s",preline,line,filename,mysql_error(td->thrconn));
        }
        g_string_set_size(data, 0);
        preline=line+1;
      }
...
# 225 "/mydumper/src/myloader_restore.c" 3 4
     (*__errno_location ())
# 225 "/mydumper/src/myloader_restore.c"
     );
      errors++;
      return r;
    }
  ...
  if (!is_schema && (commit_count > 1) && mysql_query(td->thrconn, "COMMIT")) {
    g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Error committing data for %s.%s from file %s: %s", database, table, filename, mysql_error(td->thrconn))
                                                                   ;
    errors++;
  }
