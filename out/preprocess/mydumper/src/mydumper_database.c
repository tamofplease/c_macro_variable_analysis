# 0 "/mydumper/src/mydumper_database.c"
# 1 "/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/mydumper/src/mydumper_database.c"
# 17 "/mydumper/src/mydumper_database.c"
...
MYSQL * mysql_real_connect_dns_srv(MYSQL *mysql,
                                          ...
                                          const char *db,
                                          unsigned long client_flag);
# 18 "/mydumper/src/mydumper_database.c" 2
...
# 19 "/mydumper/src/mydumper_database.c" 2
# 1 "/mydumper/src/mydumper_common.h" 1
# 21 "/mydumper/src/mydumper_common.h"
...
void free_common();
# 20 "/mydumper/src/mydumper_database.c" 2
# 1 "/mydumper/src/mydumper_database.h" 1
# 18 "/mydumper/src/mydumper_database.h"
struct database {
  char *name;
  char *filename;
  char *escaped;
...
void free_databases();
# 21 "/mydumper/src/mydumper_database.c" 2

GHashTable *database_hash = 
# 22 "/mydumper/src/mydumper_database.c" 3 4
                           ((void *)0)
# 22 "/mydumper/src/mydumper_database.c"
                               ;
GMutex * database_hash_mutex = 
# 23 "/mydumper/src/mydumper_database.c" 3 4
                              ((void *)0)
# 23 "/mydumper/src/mydumper_database.c"
                                  ;
...
# 36 "/mydumper/src/mydumper_database.c" 3 4
                     (0x7fffffffffffffffL * 2UL + 1UL) 
# 36 "/mydumper/src/mydumper_database.c"
...
# 57 "/mydumper/src/mydumper_database.c"
...
gboolean get_database(MYSQL *conn, char *database_name, struct database ** database){
  ...
  *database=g_hash_table_lookup(database_hash,database_name);
  if (*database == 
# 66 "/mydumper/src/mydumper_database.c" 3 4
                  ((void *)0)
# 66 "/mydumper/src/mydumper_database.c"
                      ){
    *database=new_database(conn,database_name,(0));
    g_mutex_unlock(database_hash_mutex);
    return (!(0));
  }
  g_mutex_unlock(database_hash_mutex);
