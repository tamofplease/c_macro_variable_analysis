# 0 "/mydumper/src/tables_skiplist.c"
# 1 "/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/mydumper/src/tables_skiplist.c"
# 15 "/mydumper/src/tables_skiplist.c"
...
# 16 "/mydumper/src/tables_skiplist.c" 2


GSequence *tables_skiplist = 
# 18 "/mydumper/src/tables_skiplist.c" 3 4
                            ((void *)0)
# 18 "/mydumper/src/tables_skiplist.c"
                                ;
...
void read_tables_skiplist(const gchar *filename, guint *errors) {
  ...
  GIOChannel *tables_skiplist_channel = 
# 36 "/mydumper/src/tables_skiplist.c" 3 4
                                       ((void *)0)
# 36 "/mydumper/src/tables_skiplist.c"
                                           ;
  gchar *buf = 
# 37 "/mydumper/src/tables_skiplist.c" 3 4
              ((void *)0)
# 37 "/mydumper/src/tables_skiplist.c"
                  ;
  GError *error = 
# 38 "/mydumper/src/tables_skiplist.c" 3 4
                 ((void *)0)
# 38 "/mydumper/src/tables_skiplist.c"
                     ;

  if (!tables_skiplist) {
    tables_skiplist = g_sequence_new(
# 41 "/mydumper/src/tables_skiplist.c" 3 4
                                    ((void *)0)
# 41 "/mydumper/src/tables_skiplist.c"
                                        );
  };
  ...
  if (!tables_skiplist_channel) {
    g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "cannot read/open file %s, %s\n", filename, error->message);
    (*errors)++;
    return;
  };
  ...
  do {
    g_io_channel_read_line(tables_skiplist_channel, &buf, 
# 54 "/mydumper/src/tables_skiplist.c" 3 4
                                                         ((void *)0)
# 54 "/mydumper/src/tables_skiplist.c"
                                                             , 
# 54 "/mydumper/src/tables_skiplist.c" 3 4
                                                               ((void *)0)
# 54 "/mydumper/src/tables_skiplist.c"
...
# 54 "/mydumper/src/tables_skiplist.c"
  ...
  g_io_channel_shutdown(tables_skiplist_channel, (0), 
# 60 "/mydumper/src/tables_skiplist.c" 3 4
                                                       ((void *)0)
# 60 "/mydumper/src/tables_skiplist.c"
                                                           );

  g_sequence_sort(tables_skiplist, tables_skiplist_cmp, 
# 62 "/mydumper/src/tables_skiplist.c" 3 4
                                                       ((void *)0)
# 62 "/mydumper/src/tables_skiplist.c"
                                                           );
  g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Omit list file contains %d tables to skip\n", g_sequence_get_length(tables_skiplist))
                                                   ;
  return;
}
...
gboolean check_skiplist(char *database, char *table) {
  ...
  gboolean b = g_sequence_lookup(tables_skiplist,
                        k,
                        tables_skiplist_cmp, 
# 74 "/mydumper/src/tables_skiplist.c" 3 4
                                            ((void *)0)
# 74 "/mydumper/src/tables_skiplist.c"
                                                ) != 
# 74 "/mydumper/src/tables_skiplist.c" 3 4
                                                     ((void *)0)
# 74 "/mydumper/src/tables_skiplist.c"
