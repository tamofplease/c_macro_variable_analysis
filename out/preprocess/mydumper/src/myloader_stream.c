# 0 "/mydumper/src/myloader_stream.c"
# 1 "/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/mydumper/src/myloader_stream.c"
# 17 "/mydumper/src/myloader_stream.c"
...
MYSQL * mysql_real_connect_dns_srv(MYSQL *mysql,
                                          ...
                                          const char *db,
                                          unsigned long client_flag);
# 18 "/mydumper/src/myloader_stream.c" 2
...
# 19 "/mydumper/src/myloader_stream.c" 2
...
# 20 "/mydumper/src/myloader_stream.c" 2
...
# 21 "/mydumper/src/myloader_stream.c" 2
...
# 22 "/mydumper/src/myloader_stream.c" 2
...
# 23 "/mydumper/src/myloader_stream.c" 2
...
# 29 "/mydumper/src/myloader_stream.c" 3 4
                        ((void *)0)
# 29 "/mydumper/src/myloader_stream.c"
                            ;

void *process_stream();

void initialize_stream (struct configuration *c){
  stream_thread = g_thread_create((GThreadFunc)process_stream, c, (!(0)), 
# 34 "/mydumper/src/myloader_stream.c" 3 4
                                                                       ((void *)0)
# 34 "/mydumper/src/myloader_stream.c"
                                                                           );
}
...
int read_stream_line(char *buffer, gboolean *eof,FILE *file,int c_to_read){
    size_t bytes = fread(buffer, sizeof(char), c_to_read, 
# 42 "/mydumper/src/myloader_stream.c" 3 4
                                                         stdin
# 42 "/mydumper/src/myloader_stream.c"
                                                              );
    if( !bytes ){
      if (file != 
# 44 "/mydumper/src/myloader_stream.c" 3 4
                 ((void *)0) 
# 44 "/mydumper/src/myloader_stream.c"
                      && feof(file)){
        *eof = (!(0));
        buffer[0] = '\0';
        m_close(file);
...
void flush(char *buffer, int from, int to, FILE *file){
  if (file)
    if (m_write(file,&(buffer[from]),to-from+1) != to-from+1)
      g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "error on writing");
}
...
void *process_stream(struct configuration *stream_conf){
  char * filename=
# 75 "/mydumper/src/myloader_stream.c" 3 4
                 ((void *)0)
# 75 "/mydumper/src/myloader_stream.c"
                     ,*real_filename=
# 75 "/mydumper/src/myloader_stream.c" 3 4
                                     ((void *)0)
# 75 "/mydumper/src/myloader_stream.c"
...
# 75 "/mydumper/src/myloader_stream.c"
                                                                  ;
  char *buffer=(char *) (__extension__ ({ gsize __n = (gsize) (1000000); gsize __s = sizeof (char); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 76 "/mydumper/src/myloader_stream.c" 3 4
              (0x7fffffffffffffffL * 2UL + 1UL) 
# 76 "/mydumper/src/myloader_stream.c"
              / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  FILE *file=
# 77 "/mydumper/src/myloader_stream.c" 3 4
            ((void *)0)
# 77 "/mydumper/src/myloader_stream.c"
                ;
  gboolean eof=(0);
  ...
  do {
read_more: buffer_len=read_stream_line(&(buffer[diff]),&eof,file,1000000 -1-diff)+diff;
      ...
      while (pos < buffer_len){
        ...
        if (g_str_has_prefix(&(buffer[line_from]),"\n-- ")){
          if (buffer[last_pos] == '\n'){
            ...
            real_filename = g_build_filename(directory,filename,
# 115 "/mydumper/src/myloader_stream.c" 3 4
                                                               ((void *)0)
# 115 "/mydumper/src/myloader_stream.c"
                                                                   );
            if (has_mydumper_suffix(filename)){
              ...
              if (g_file_test(real_filename, G_FILE_TEST_EXISTS)){
                g_log (((gchar*) 0), G_LOG_LEVEL_DEBUG, "Stream Thread: File exists in datadir: %s", real_filename);
                last_pos++;
                file = 
# 125 "/mydumper/src/myloader_stream.c" 3 4
                      ((void *)0)
# 125 "/mydumper/src/myloader_stream.c"
                          ;
              }else{
              ...
              g_log (((gchar*) 0), G_LOG_LEVEL_DEBUG, "Not a mydumper file: %s", filename);
            }
  ...
  for (n = 0; n < num_threads ; n++) {
    ...
    g_async_queue_push(stream_conf->post_table_queue, new_job(JOB_SHUTDOWN,
# 159 "/mydumper/src/myloader_stream.c" 3 4
                                                                          ((void *)0)
# 159 "/mydumper/src/myloader_stream.c"
                                                                              ,
# 159 "/mydumper/src/myloader_stream.c" 3 4
                                                                               ((void *)0)
# 159 "/mydumper/src/myloader_stream.c"
                                                                                   ));
    g_async_queue_push(stream_conf->post_queue, new_job(JOB_SHUTDOWN,
# 160 "/mydumper/src/myloader_stream.c" 3 4
                                                                    ((void *)0)
# 160 "/mydumper/src/myloader_stream.c"
                                                                        ,
# 160 "/mydumper/src/myloader_stream.c" 3 4
                                                                         ((void *)0)
# 160 "/mydumper/src/myloader_stream.c"
                                                                             ));
    g_async_queue_push(stream_conf->view_queue, new_job(JOB_SHUTDOWN,
# 161 "/mydumper/src/myloader_stream.c" 3 4
                                                                    ((void *)0)
# 161 "/mydumper/src/myloader_stream.c"
                                                                        ,
# 161 "/mydumper/src/myloader_stream.c" 3 4
                                                                         ((void *)0)
# 161 "/mydumper/src/myloader_stream.c"
  ...
  return 
# 163 "/mydumper/src/myloader_stream.c" 3 4
        ((void *)0)
# 163 "/mydumper/src/myloader_stream.c"
            ;
}
