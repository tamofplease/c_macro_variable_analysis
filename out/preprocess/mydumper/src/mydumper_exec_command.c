# 0 "/mydumper/src/mydumper_exec_command.c"
# 1 "/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/mydumper/src/mydumper_exec_command.c"
# 17 "/mydumper/src/mydumper_exec_command.c"
...
# 18 "/mydumper/src/mydumper_exec_command.c" 2
...
MYSQL * mysql_real_connect_dns_srv(MYSQL *mysql,
                                          ...
                                          const char *db,
                                          unsigned long client_flag);
# 19 "/mydumper/src/mydumper_exec_command.c" 2
...
# 20 "/mydumper/src/mydumper_exec_command.c" 2
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                              ...
                                                              ;
# 24 "/mydumper/src/mydumper_exec_command.c" 2
...
# 30 "/mydumper/src/mydumper_exec_command.c" 2
...
# 31 "/mydumper/src/mydumper_exec_command.c" 2



# 33 "/mydumper/src/mydumper_exec_command.c"
extern int 
# 33 "/mydumper/src/mydumper_exec_command.c" 3 4
          (*__errno_location ())
# 33 "/mydumper/src/mydumper_exec_command.c"
               ;
...
GThread **exec_command_thread = 
# 39 "/mydumper/src/mydumper_exec_command.c" 3 4
                               ((void *)0)
# 39 "/mydumper/src/mydumper_exec_command.c"
                                   ;
extern gchar *exec_command;
guint num_exec_threads = 4;

GHashTable* pid_file_table=
# 43 "/mydumper/src/mydumper_exec_command.c" 3 4
                          ((void *)0)
# 43 "/mydumper/src/mydumper_exec_command.c"
                              ;
...
void *process_exec_command(void *data){
  ...
  char * filename=
# 68 "/mydumper/src/mydumper_exec_command.c" 3 4
                 ((void *)0)
# 68 "/mydumper/src/mydumper_exec_command.c"
                     ;
  char * bin=g_strndup(exec_command,len);
  gchar ** arguments=g_strsplit(space," ", 0);
  gchar ** volatile c_arg=
# 71 "/mydumper/src/mydumper_exec_command.c" 3 4
                         ((void *)0)
# 71 "/mydumper/src/mydumper_exec_command.c"
                             ;
  guint i=0;
  GList *filename_pos=
# 73 "/mydumper/src/mydumper_exec_command.c" 3 4
                     ((void *)0)
# 73 "/mydumper/src/mydumper_exec_command.c"
                         ;
  GList *iter;
  c_arg=g_strdupv(arguments);
  for(i=0; i<g_strv_length(c_arg); i++){
    if (g_strcmp0(c_arg[i],"FILENAME") == 0){
      int *c=(int *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (int); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 78 "/mydumper/src/mydumper_exec_command.c" 3 4
            (0x7fffffffffffffffL * 2UL + 1UL) 
# 78 "/mydumper/src/mydumper_exec_command.c"
  ...
  for(;;){
    ...
    iter=filename_pos;
    while (iter!=
# 91 "/mydumper/src/mydumper_exec_command.c" 3 4
                ((void *)0)
# 91 "/mydumper/src/mydumper_exec_command.c"
                    ){
  ...
  return 
# 97 "/mydumper/src/mydumper_exec_command.c" 3 4
        ((void *)0)
# 97 "/mydumper/src/mydumper_exec_command.c"
            ;
}
...
static GOptionEntry exec_entries[] = {
    {"exec-threads", 0, 0, G_OPTION_ARG_INT, &num_exec_threads,
     "", 
# 103 "/mydumper/src/mydumper_exec_command.c" 3 4
        ((void *)0)
# 103 "/mydumper/src/mydumper_exec_command.c"
            },
    {
# 104 "/mydumper/src/mydumper_exec_command.c" 3 4
    ((void *)0)
# 104 "/mydumper/src/mydumper_exec_command.c"
...
void initialize_exec_command(){
  ...
  exec_command_thread=(GThread * *) (__extension__ ({ gsize __n = (gsize) (num_exec_threads); gsize __s = sizeof (GThread *); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 112 "/mydumper/src/mydumper_exec_command.c" 3 4
                     (0x7fffffffffffffffL * 2UL + 1UL) 
# 112 "/mydumper/src/mydumper_exec_command.c"
                     / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; })) ;
  guint i;
  pid_file_table=g_hash_table_new_full ( g_str_hash, g_str_equal, &g_free, &g_free );

  for(i=0;i<num_exec_threads;i++){
    exec_command_thread[i]=g_thread_create((GThreadFunc)process_exec_command, stream_queue, (!(0)), 
# 117 "/mydumper/src/mydumper_exec_command.c" 3 4
                                                                                                 ((void *)0)
# 117 "/mydumper/src/mydumper_exec_command.c"
                                                                                                     );
  }
}
