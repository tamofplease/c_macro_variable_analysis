# 0 "/mydumper/src/myloader_restore_job.c"
# 1 "/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/mydumper/src/myloader_restore_job.c"
# 17 "/mydumper/src/myloader_restore_job.c"
...
MYSQL * mysql_real_connect_dns_srv(MYSQL *mysql,
                                          ...
                                          const char *db,
                                          unsigned long client_flag);
# 18 "/mydumper/src/myloader_restore_job.c" 2
...
# 19 "/mydumper/src/myloader_restore_job.c" 2
...
# 20 "/mydumper/src/myloader_restore_job.c" 2
...
# 23 "/mydumper/src/myloader_restore_job.c" 2
# 1 "/mydumper/src/myloader.h" 1
# 24 "/mydumper/src/myloader_restore_job.c" 2
...
# 25 "/mydumper/src/myloader_restore_job.c" 2
# 1 "/usr/include/glib-2.0/glib-unix.h" 1
# 27 "/usr/include/glib-2.0/glib-unix.h"
...
# 28 "/usr/include/glib-2.0/glib-unix.h" 2
...
# 30 "/usr/include/glib-2.0/glib-unix.h" 2
...
# 98 "/usr/include/aarch64-linux-gnu/bits/fcntl2.h" 3 4
...
# 32 "/usr/include/glib-2.0/glib-unix.h" 2
...
# 56 "/usr/include/glib-2.0/glib-unix.h"
...
guint g_unix_signal_add (gint signum,
                                    GSourceFunc handler,
                                    gpointer user_data);
# 95 "/usr/include/glib-2.0/glib-unix.h"
...
# 26 "/mydumper/src/myloader_restore_job.c" 2
...
# 28 "/mydumper/src/myloader_restore_job.c" 2
...
gboolean shutdown_triggered=(0);
GAsyncQueue *file_list_to_do=
# 36 "/mydumper/src/myloader_restore_job.c" 3 4
                            ((void *)0)
# 36 "/mydumper/src/myloader_restore_job.c"
                                ;
static GMutex *progress_mutex = 
# 37 "/mydumper/src/myloader_restore_job.c" 3 4
                               ((void *)0)
# 37 "/mydumper/src/myloader_restore_job.c"
                                   ;
static GMutex *single_threaded_create_table = 
# 38 "/mydumper/src/myloader_restore_job.c" 3 4
                                             ((void *)0)
# 38 "/mydumper/src/myloader_restore_job.c"
                                                 ;
...
void initialize_restore_job(gchar * purge_mode_str){
  ...
  if (purge_mode_str){
    if (!strcmp(purge_mode_str,"TRUNCATE")){
      ...
      do { g_log (((gchar*) 0), G_LOG_LEVEL_ERROR, "Purge mode unknown"); for (;;) ; } while (0);
    }
...
struct data_restore_job * new_data_restore_job_internal( guint index, guint part, guint sub_part){
  struct data_restore_job *drj = (struct data_restore_job *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (struct data_restore_job); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 65 "/mydumper/src/myloader_restore_job.c" 3 4
                                (0x7fffffffffffffffL * 2UL + 1UL) 
# 65 "/mydumper/src/myloader_restore_job.c"
...
struct schema_restore_job * new_schema_restore_job_internal( char * database, GString * statement, const char *object){
  struct schema_restore_job *rj = (struct schema_restore_job *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (struct schema_restore_job); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 73 "/mydumper/src/myloader_restore_job.c" 3 4
                                 (0x7fffffffffffffffL * 2UL + 1UL) 
# 73 "/mydumper/src/myloader_restore_job.c"
                                 / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
...
struct restore_job * new_restore_job( char * filename, struct db_table * dbt, enum restore_job_type type){
  struct restore_job *rj = (struct restore_job *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (struct restore_job); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 81 "/mydumper/src/myloader_restore_job.c" 3 4
                          (0x7fffffffffffffffL * 2UL + 1UL) 
# 81 "/mydumper/src/myloader_restore_job.c"
                          / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
...
void free_restore_job(struct restore_job * rj){
  ...
  if (rj->filename != 
# 102 "/mydumper/src/myloader_restore_job.c" 3 4
                     ((void *)0) 
# 102 "/mydumper/src/myloader_restore_job.c"
                          ) g_free(rj->filename);


  if (rj != 
# 105 "/mydumper/src/myloader_restore_job.c" 3 4
           ((void *)0) 
# 105 "/mydumper/src/myloader_restore_job.c"
                ) g_free(rj);
}
...
int overwrite_table(MYSQL *conn,gchar * database, gchar * table){
  ...
  gchar *query=
# 117 "/mydumper/src/myloader_restore_job.c" 3 4
              ((void *)0)
# 117 "/mydumper/src/myloader_restore_job.c"
                  ;
  if (purge_mode == DROP) {
    g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Dropping table or view (if exists) `%s`.`%s`", database, table)
                              ;
    ...
    g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Truncating table `%s`.`%s`", database, table);
    ...
    if (truncate_or_delete_failed)
      g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "Truncate failed, we are going to try to create table or view");
  } else if (purge_mode == DELETE) {
    g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Deleting content of table `%s`.`%s`", database, table);
    query= g_strdup_printf("DELETE FROM `%s`.`%s`", database, table);
    truncate_or_delete_failed= mysql_query(conn, query);
    if (truncate_or_delete_failed)
      g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "Delete failed, we are going to try to create table or view");
  }
  g_free(query);
...
# 146 "/mydumper/src/myloader_restore_job.c" 3 4
                               ((void *)0)
# 146 "/mydumper/src/myloader_restore_job.c"
                                   ){
    GMutex *resume_mutex = (GMutex *)g_async_queue_try_pop(td->conf->pause_resume);
    if (resume_mutex != 
# 148 "/mydumper/src/myloader_restore_job.c" 3 4
                       ((void *)0)
# 148 "/mydumper/src/myloader_restore_job.c"
                           ){
      g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Thread %d: Stop", td->thread_id);
      g_mutex_lock(resume_mutex);
      g_mutex_unlock(resume_mutex);
      g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Thread %d: Resumming", td->thread_id);
      resume_mutex=
# 153 "/mydumper/src/myloader_restore_job.c" 3 4
                  ((void *)0)
# 153 "/mydumper/src/myloader_restore_job.c"
                      ;
    }
  }
  ...
  switch (rj->type) {
    case JOB_RESTORE_STRING:
      g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Thread %d restoring %s `%s`.`%s` from %s", td->thread_id, rj->data.srj->object, dbt->real_database, dbt->real_table, rj->filename)
                                                                  ;
      restore_data_in_gstring(td, rj->data.srj->statement, (0), &query_counter);
    ...
    case JOB_RESTORE_SCHEMA_STRING:
      ...
      g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Thread %d restoring table `%s`.`%s` from %s", td->thread_id, dbt->real_database, dbt->real_table, rj->filename)
                                                                  ;
      int truncate_or_delete_failed=0;
      if (overwrite_tables)
      ...
      if ((purge_mode == TRUNCATE || purge_mode == DELETE) && !truncate_or_delete_failed){
        g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Skipping table creation `%s`.`%s` from %s", dbt->real_database, dbt->real_table, rj->filename);
      }else{
        g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Thread %d: Creating table `%s`.`%s` from content in %s", td->thread_id, dbt->real_database, dbt->real_table, rj->filename);
        if (restore_data_in_gstring(td, rj->data.srj->statement, (0), &query_counter)){
          g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Thread %d issue restoring %s: %s",td->thread_id,rj->filename, mysql_error(td->thrconn));
        }
        g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Thread %d: Creating table `%s`.`%s` from content in %s COMPLETED", td->thread_id, dbt->real_database, dbt->real_table, rj->filename);
      }
      dbt->schema_state=CREATED;
      if (serial_tbl_creation) g_mutex_unlock(single_threaded_create_table);
      g_mutex_lock(dbt->mutex);
      for(i=0; i<g_list_length(dbt->restore_job_list); i++){
        g_async_queue_push(td->conf->stream_queue, ((gpointer) (glong) (DATA)));
      }
    ...
    case JOB_RESTORE_FILENAME:
      ...
      progress++;
      g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Thread %d restoring `%s`.`%s` part %d of %d from %s. Progress %llu of %llu. Using %d of %d threads.", td->thread_id, dbt->real_database, dbt->real_table, rj->data.drj->index, dbt->count, rj->filename, progress,total_data_sql_files, dbt->current_threads, dbt->max_threads)
                                                                                                                                                                          ;
      ...
      if (stream && dbt->schema_state!=CREATED){
        ...
        while (dbt->schema_state!=CREATED && i<10000){
          ...
          i++;
          if (i % 1000 == 0)
            g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Waiting table to be created %s", rj->filename);
        }
        if (dbt->schema_state!=CREATED){
          g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Table has not been created in more than 10 seconds");
          exit(
# 214 "/mydumper/src/myloader_restore_job.c" 3 4
              1
# 214 "/mydumper/src/myloader_restore_job.c"
                          );
        }
      }
      if (restore_data_from_file(td, dbt->real_database, dbt->real_table, rj->filename, (0)) > 0){
        g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Thread %d issue restoring %s: %s",td->thread_id,rj->filename, mysql_error(td->thrconn));
      }
      (__extension__ ({ _Static_assert (sizeof *(&(dbt->remaining_jobs)) == sizeof (gint), "Expression evaluates to false"); (void) (0 ? *(&(dbt->remaining_jobs)) ^ *(&(dbt->remaining_jobs)) : 1); __atomic_fetch_sub ((&(dbt->remaining_jobs)), 1, 5) == 1; }));
      g_free(rj->data.drj);
      break;
    case JOB_RESTORE_SCHEMA_FILENAME:
      g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Thread %d restoring %s on `%s` from %s", td->thread_id, rj->data.srj->object, rj->data.srj->database, rj->filename)
                                                     ;
      restore_data_from_file(td, rj->data.srj->database, 
# 226 "/mydumper/src/myloader_restore_job.c" 3 4
                                                        ((void *)0)
# 226 "/mydumper/src/myloader_restore_job.c"
                                                            , rj->filename, (!(0)) );
      free_schema_restore_job(rj->data.srj);
      break;
    default:
      g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Something very bad happened!");
      exit(
# 231 "/mydumper/src/myloader_restore_job.c" 3 4
          1
# 231 "/mydumper/src/myloader_restore_job.c"
                      );
    }
cleanup:
  if (rj != 
# 234 "/mydumper/src/myloader_restore_job.c" 3 4
           ((void *)0) 
# 234 "/mydumper/src/myloader_restore_job.c"
                ) free_restore_job(rj);
}


GMutex **pause_mutex_per_thread=
# 238 "/mydumper/src/myloader_restore_job.c" 3 4
                               ((void *)0)
# 238 "/mydumper/src/myloader_restore_job.c"
                                   ;

gboolean sig_triggered(void * user_data, int signal) {
  guint i=0;
  GAsyncQueue *queue=
# 242 "/mydumper/src/myloader_restore_job.c" 3 4
                    ((void *)0)
# 242 "/mydumper/src/myloader_restore_job.c"
                        ;
  if (signal == 
# 243 "/mydumper/src/myloader_restore_job.c" 3 4
               15
# 243 "/mydumper/src/myloader_restore_job.c"
                      ){
    shutdown_triggered = (!(0));
  }else{
    if (pause_mutex_per_thread == 
# 246 "/mydumper/src/myloader_restore_job.c" 3 4
                                 ((void *)0)
# 246 "/mydumper/src/myloader_restore_job.c"
                                     ){
      pause_mutex_per_thread=(GMutex * *) (__extension__ ({ gsize __n = (gsize) (num_threads); gsize __s = sizeof (GMutex *); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 247 "/mydumper/src/myloader_restore_job.c" 3 4
                            (0x7fffffffffffffffL * 2UL + 1UL) 
# 247 "/mydumper/src/myloader_restore_job.c"
                            / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; })) ;
      for(i=0;i<num_threads;i++){
        pause_mutex_per_thread[i]=g_mutex_new();
      }
    }
    if (((struct configuration *)user_data)->pause_resume == 
# 252 "/mydumper/src/myloader_restore_job.c" 3 4
                                                            ((void *)0)
# 252 "/mydumper/src/myloader_restore_job.c"
                                                                )
    ...
    fprintf(
# 259 "/mydumper/src/myloader_restore_job.c" 3 4
           stdout
# 259 "/mydumper/src/myloader_restore_job.c"
                 , "Ctrl+c detected! Are you sure you want to cancel(Y/N)?");
    int c=0;
    while (1){
      do{
        c=fgetc(
# 263 "/mydumper/src/myloader_restore_job.c" 3 4
               stdin
# 263 "/mydumper/src/myloader_restore_job.c"
                    );
      }while (c=='\n');
      if ( c == 'N' || c == 'n'){
        for(i=0;i<num_threads;i++)
  ...
  g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Writing resume.partial file");
  gchar *filename;
  gchar *p=g_strdup("resume.partial"),*p2=g_strdup("resume");

  void *outfile = fopen(p, "w");
  filename = g_async_queue_pop(file_list_to_do);
  while(g_strcmp0(filename,"NO_MORE_FILES")!=0){
    g_log (((gchar*) 0), G_LOG_LEVEL_DEBUG, "Adding %s to resume file", filename);
    fprintf(outfile, "%s\n", filename);
    filename=g_async_queue_pop(file_list_to_do);
  }
  fclose(outfile);
  if (rename(p, p2) != 0){
    g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Error renaming resume.partial to resume");
  }
  g_free(p);
  g_free(p2);
  g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Shutting down gracefully completed.");
  return (0);
}

gboolean sig_triggered_int(void * user_data) {
  return sig_triggered(user_data,
# 301 "/mydumper/src/myloader_restore_job.c" 3 4
                                2
# 301 "/mydumper/src/myloader_restore_job.c"
                                      );
}
gboolean sig_triggered_term(void * user_data) {
  return sig_triggered(user_data,
# 304 "/mydumper/src/myloader_restore_job.c" 3 4
                                15
# 304 "/mydumper/src/myloader_restore_job.c"
                                       );
}

GMainLoop * loop=
# 307 "/mydumper/src/myloader_restore_job.c" 3 4
                ((void *)0)
# 307 "/mydumper/src/myloader_restore_job.c"
                    ;

void *signal_thread(void *data) {
  g_unix_signal_add(
# 310 "/mydumper/src/myloader_restore_job.c" 3 4
                   2
# 310 "/mydumper/src/myloader_restore_job.c"
                         , sig_triggered_int, data);
  g_unix_signal_add(
# 311 "/mydumper/src/myloader_restore_job.c" 3 4
                   15
# 311 "/mydumper/src/myloader_restore_job.c"
                          , sig_triggered_term, data);
  loop = g_main_loop_new (
# 312 "/mydumper/src/myloader_restore_job.c" 3 4
                         ((void *)0)
# 312 "/mydumper/src/myloader_restore_job.c"
                             , (!(0)));
  g_main_loop_run (loop);
  return 
# 314 "/mydumper/src/myloader_restore_job.c" 3 4
        ((void *)0)
# 314 "/mydumper/src/myloader_restore_job.c"
            ;
}
