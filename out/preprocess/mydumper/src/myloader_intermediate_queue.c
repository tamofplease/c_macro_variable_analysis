# 0 "/mydumper/src/myloader_intermediate_queue.c"
# 1 "/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/mydumper/src/myloader_intermediate_queue.c"
# 17 "/mydumper/src/myloader_intermediate_queue.c"
...
MYSQL * mysql_real_connect_dns_srv(MYSQL *mysql,
                                          ...
                                          const char *db,
                                          unsigned long client_flag);
# 18 "/mydumper/src/myloader_intermediate_queue.c" 2
...
# 19 "/mydumper/src/myloader_intermediate_queue.c" 2
...
# 20 "/mydumper/src/myloader_intermediate_queue.c" 2
...
# 21 "/mydumper/src/myloader_intermediate_queue.c" 2
...
# 22 "/mydumper/src/myloader_intermediate_queue.c" 2
...
# 23 "/mydumper/src/myloader_intermediate_queue.c" 2
...
# 24 "/mydumper/src/myloader_intermediate_queue.c" 2
...
# 25 "/mydumper/src/myloader_intermediate_queue.c" 2
extern gchar *db;
...
gboolean intermediate_queue_ended = (0);
GAsyncQueue *intermediate_queue = 
# 36 "/mydumper/src/myloader_intermediate_queue.c" 3 4
                                 ((void *)0)
# 36 "/mydumper/src/myloader_intermediate_queue.c"
                                     ;
GThread *stream_intermediate_thread = 
# 37 "/mydumper/src/myloader_intermediate_queue.c" 3 4
                                     ((void *)0)
# 37 "/mydumper/src/myloader_intermediate_queue.c"
                                         ;

void *intermediate_thread();
struct configuration *intermediate_conf = 
# 40 "/mydumper/src/myloader_intermediate_queue.c" 3 4
                                         ((void *)0)
# 40 "/mydumper/src/myloader_intermediate_queue.c"
                                             ;

void initialize_intermediate_queue (struct configuration *c){
  intermediate_conf=c;
  intermediate_queue = g_async_queue_new();
  intermediate_queue_ended=(0);
  stream_intermediate_thread = g_thread_create((GThreadFunc)intermediate_thread, 
# 46 "/mydumper/src/myloader_intermediate_queue.c" 3 4
                                                                                ((void *)0)
# 46 "/mydumper/src/myloader_intermediate_queue.c"
                                                                                    , (!(0)), 
# 46 "/mydumper/src/myloader_intermediate_queue.c" 3 4
                                                                                            ((void *)0)
# 46 "/mydumper/src/myloader_intermediate_queue.c"
...
void intermediate_queue_new(gchar *filename){
  struct intermediate_filename * iflnm=(struct intermediate_filename *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (struct intermediate_filename); gpointer __p; if (__s == 1) __p = g_malloc0 (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 50 "/mydumper/src/myloader_intermediate_queue.c" 3 4
                                      (0x7fffffffffffffffL * 2UL + 1UL) 
# 50 "/mydumper/src/myloader_intermediate_queue.c"
...
void intermediate_queue_end(){
  ...
  g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Intermediate queue: Sending END job");
  g_thread_join(stream_intermediate_thread);
  g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Intermediate thread: SHUTDOWN");
  intermediate_queue_ended=(!(0));
}
    ...
    switch (ft){
      ...
      case RESUME:
        if (stream){
          ...
          exit(
# 137 "/mydumper/src/myloader_intermediate_queue.c" 3 4
              1
# 137 "/mydumper/src/myloader_intermediate_queue.c"
                          );
        }
        break;
      case IGNORED:
        g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "Filename %s has been ignored", filename);
        break;
      case LOAD_DATA:
        break;
      case SHUTDOWN:
...
void process_stream_filename(struct intermediate_filename * iflnm){
  ...
  if (current_ft == INCOMPLETE ){
    if (iflnm->iterations > 5){
      g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "Max renqueing reached for: %s", iflnm->filename);
    }else{
      g_log (((gchar*) 0), G_LOG_LEVEL_DEBUG, "Requeuing in intermediate queue %u: %s", iflnm->iterations, iflnm->filename);
  ...
  if (current_ft != SCHEMA_VIEW &&
    ...
    g_async_queue_push(intermediate_conf->stream_queue, ((gpointer) (glong) (current_ft)));
}
...
void enqueue_all_index_jobs(struct configuration *conf){
  ...
  struct db_table * dbt;
  while (iter != 
# 183 "/mydumper/src/myloader_intermediate_queue.c" 3 4
                ((void *)0)
# 183 "/mydumper/src/myloader_intermediate_queue.c"
                    ){
    dbt = iter->data;
...
void *intermediate_thread(){
  struct intermediate_filename * iflnm=
# 198 "/mydumper/src/myloader_intermediate_queue.c" 3 4
                                       ((void *)0)
# 198 "/mydumper/src/myloader_intermediate_queue.c"
                                           ;
  do{
    ...
    if ( g_strcmp0(iflnm->filename,"END") == 0 ){
      ...
      g_free(iflnm);
      iflnm=
# 208 "/mydumper/src/myloader_intermediate_queue.c" 3 4
           ((void *)0)
# 208 "/mydumper/src/myloader_intermediate_queue.c"
               ;
      break;
    }
    process_stream_filename(iflnm);
  } while (iflnm != 
# 212 "/mydumper/src/myloader_intermediate_queue.c" 3 4
                   ((void *)0)
# 212 "/mydumper/src/myloader_intermediate_queue.c"
                       );
  guint n=0;
  ...
  g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Intermediate thread ended");

  g_async_queue_push(intermediate_conf->stream_queue, ((gpointer) (glong) (INTERMEDIATE_ENDED)));
  return 
# 222 "/mydumper/src/myloader_intermediate_queue.c" 3 4
        ((void *)0)
# 222 "/mydumper/src/myloader_intermediate_queue.c"
            ;
}
