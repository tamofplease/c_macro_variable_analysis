# 0 "/mydumper/src/server_detect.c"
# 1 "/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/mydumper/src/server_detect.c"
# 18 "/mydumper/src/server_detect.c"
...
# 19 "/mydumper/src/server_detect.c" 2
...
# 20 "/mydumper/src/server_detect.c" 2

# 1 "/mydumper/src/server_detect.h" 1
# 20 "/mydumper/src/server_detect.h"
...
MYSQL * mysql_real_connect_dns_srv(MYSQL *mysql,
                                          ...
                                          const char *db,
                                          unsigned long client_flag);
# 21 "/mydumper/src/server_detect.h" 2
...
int get_secondary();
int get_revision();
# 22 "/mydumper/src/server_detect.c" 2

int detect_server(MYSQL *conn) {
  pcre *re = 
# 24 "/mydumper/src/server_detect.c" 3 4
            ((void *)0)
# 24 "/mydumper/src/server_detect.c"
                ;
  const char *error;
  int erroroffset;
  int ovector[9] = {0};
  ...
  g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Server version reported as: %s", db_version);

  re = pcre_compile("TiDB", 0, &error, &erroroffset, 
# 34 "/mydumper/src/server_detect.c" 3 4
                                                               ((void *)0)
# 34 "/mydumper/src/server_detect.c"
                                                                   );
  if (!re) {
    g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Regular expression fail: %s", error);
    exit(
# 37 "/mydumper/src/server_detect.c" 3 4
        1
# 37 "/mydumper/src/server_detect.c"
                    );
  }

  rc = pcre_exec(re, 
# 40 "/mydumper/src/server_detect.c" 3 4
                    ((void *)0)
# 40 "/mydumper/src/server_detect.c"
                        , db_version, strlen(db_version), 0, 0, ovector, 9);
  pcre_free(re);
  ...
  re = pcre_compile("^([3-9]\\.[0-9]+\\.[0-9]+)", 0, &error, &erroroffset, 
# 47 "/mydumper/src/server_detect.c" 3 4
                                                                ((void *)0)
# 47 "/mydumper/src/server_detect.c"
                                                                    );
  if (!re) {
    g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Regular expression fail: %s", error);
    exit(
# 50 "/mydumper/src/server_detect.c" 3 4
        1
# 50 "/mydumper/src/server_detect.c"
                    );
  }

  rc = pcre_exec(re, 
# 53 "/mydumper/src/server_detect.c" 3 4
                    ((void *)0)
# 53 "/mydumper/src/server_detect.c"
                        , db_version, strlen(db_version), 0, 0, ovector, 9);
  pcre_free(re);
  ...
  re = pcre_compile("^(20[0-9]{2}\\.(0[1-9]|1[012])\\.[0-9]+)", 0, &error, &erroroffset, 
# 60 "/mydumper/src/server_detect.c" 3 4
                                                                  ((void *)0)
# 60 "/mydumper/src/server_detect.c"
                                                                      );
  if (!re) {
    g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Regular expression fail: %s", error);
    exit(
# 63 "/mydumper/src/server_detect.c" 3 4
        1
# 63 "/mydumper/src/server_detect.c"
                    );
  }

  rc = pcre_exec(re, 
# 66 "/mydumper/src/server_detect.c" 3 4
                    ((void *)0)
# 66 "/mydumper/src/server_detect.c"
                        , db_version, strlen(db_version), 0, 0, ovector, 9);
  pcre_free(re);
  ...
  re = pcre_compile("^([0-9]{1,2}\\.[0-9]+\\.[0-9]+)", 0, &error, &erroroffset, 
# 73 "/mydumper/src/server_detect.c" 3 4
                                                                  ((void *)0)
# 73 "/mydumper/src/server_detect.c"
                                                                      );
  if (!re) {
    g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Regular expression fail: %s", error);
    exit(
# 76 "/mydumper/src/server_detect.c" 3 4
        1
# 76 "/mydumper/src/server_detect.c"
                    );
  }

  rc = pcre_exec(re, 
# 79 "/mydumper/src/server_detect.c" 3 4
                    ((void *)0)
# 79 "/mydumper/src/server_detect.c"
                        , db_version, strlen(db_version), 0, 0, ovector, 9);
  pcre_free(re);
...
void detect_server_version(MYSQL * conn) {
  ...
  major=strtol(sver[0], 
# 110 "/mydumper/src/server_detect.c" 3 4
                       ((void *)0)
# 110 "/mydumper/src/server_detect.c"
                           , 10);
  secondary=strtol(sver[1], 
# 111 "/mydumper/src/server_detect.c" 3 4
                           ((void *)0)
# 111 "/mydumper/src/server_detect.c"
                               , 10);
  revision=strtol(sver[2], 
# 112 "/mydumper/src/server_detect.c" 3 4
                          ((void *)0)
# 112 "/mydumper/src/server_detect.c"
                              , 10);
  g_strfreev(sver);
