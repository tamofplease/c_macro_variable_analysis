# 0 "/mydumper/src/regex.c"
# 1 "/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/mydumper/src/regex.c"
# 17 "/mydumper/src/regex.c"
...
# 23 "/mydumper/src/regex.c" 2

const char * filename_regex="^[\\w\\-_ ]+$";

static pcre *re = 
# 26 "/mydumper/src/regex.c" 3 4
                 ((void *)0)
# 26 "/mydumper/src/regex.c"
                     ;
static pcre *filename_re = 
# 27 "/mydumper/src/regex.c" 3 4
                          ((void *)0)
# 27 "/mydumper/src/regex.c"
                              ;

char *regex = 
# 29 "/mydumper/src/regex.c" 3 4
             ((void *)0)
# 29 "/mydumper/src/regex.c"
                 ;
...
# 34 "/mydumper/src/regex.c" 3 4
                                                  ((void *)0)
# 34 "/mydumper/src/regex.c"
                                                      },
    {
# 35 "/mydumper/src/regex.c" 3 4
    ((void *)0)
# 35 "/mydumper/src/regex.c"
...
gboolean check_filename_regex(char *word) {
  ...
  int ovector[9] = {0};
  int rc = pcre_exec(filename_re, 
# 45 "/mydumper/src/regex.c" 3 4
                                 ((void *)0)
# 45 "/mydumper/src/regex.c"
                                     , word, strlen(word), 0, 0, ovector, 9);
  return (rc > 0) ? (!(0)) : (0);
}
...
void init_regex(pcre **r, const char *str){
  ...
  if (!*r) {
    *r = pcre_compile(str, 
# 53 "/mydumper/src/regex.c" 3 4
                          0x00000001 
# 53 "/mydumper/src/regex.c"
                                        | 
# 53 "/mydumper/src/regex.c" 3 4
                                          0x00000002
# 53 "/mydumper/src/regex.c"
                                                        , &error,
                      &erroroffset, 
# 54 "/mydumper/src/regex.c" 3 4
                                   ((void *)0)
# 54 "/mydumper/src/regex.c"
                                       );
    if (!*r) {
      g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Regular expression fail: %s", error);
      exit(
# 57 "/mydumper/src/regex.c" 3 4
          1
# 57 "/mydumper/src/regex.c"
                      );
    }
  }
}
...
gboolean check_regex(pcre *tre, char *database, char *table) {
  ...
  rc = pcre_exec(tre, 
# 75 "/mydumper/src/regex.c" 3 4
                     ((void *)0)
# 75 "/mydumper/src/regex.c"
                         , p, strlen(p), 0, 0, ovector, 9);
  g_free(p);
