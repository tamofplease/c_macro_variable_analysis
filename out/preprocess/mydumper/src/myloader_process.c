# 0 "/mydumper/src/myloader_process.c"
# 1 "/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/mydumper/src/myloader_process.c"
# 17 "/mydumper/src/myloader_process.c"
...
MYSQL * mysql_real_connect_dns_srv(MYSQL *mysql,
                                          ...
                                          const char *db,
                                          unsigned long client_flag);
# 18 "/mydumper/src/myloader_process.c" 2
...
# 19 "/mydumper/src/myloader_process.c" 2
...
# 20 "/mydumper/src/myloader_process.c" 2
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                              ...
                                                              ;
# 28 "/mydumper/src/myloader_process.c" 2
...
# 30 "/mydumper/src/myloader_process.c" 2
...
# 31 "/mydumper/src/myloader_process.c" 2
...
# 32 "/mydumper/src/myloader_process.c" 2
...
# 33 "/mydumper/src/myloader_process.c" 2
...
# 34 "/mydumper/src/myloader_process.c" 2
# 1 "/mydumper/src/myloader_control_job.h" 1
# 21 "/mydumper/src/myloader_control_job.h"
# 1 "/mydumper/src/myloader.h" 1
# 22 "/mydumper/src/myloader_control_job.h" 2
...
# 35 "/mydumper/src/myloader_process.c" 2
...
# 36 "/mydumper/src/myloader_process.c" 2
...
struct db_table* append_new_db_table(char * filename, gchar * database, gchar *table, guint64 number_rows, GString *alter_table_statement){
  if ( database == 
# 54 "/mydumper/src/myloader_process.c" 3 4
                  ((void *)0) 
# 54 "/mydumper/src/myloader_process.c"
                       || table == 
# 54 "/mydumper/src/myloader_process.c" 3 4
                                   ((void *)0)
# 54 "/mydumper/src/myloader_process.c"
                                       ){
    g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "It was not possible to process file: %s, database: %s table: %s",filename, database, table);
    exit(
# 56 "/mydumper/src/myloader_process.c" 3 4
        1
# 56 "/mydumper/src/myloader_process.c"
                    );
  }
  struct database *real_db_name=get_db_hash(database,database);
  if (real_db_name == 
# 59 "/mydumper/src/myloader_process.c" 3 4
                     ((void *)0)
# 59 "/mydumper/src/myloader_process.c"
                         ){
    do { g_log (((gchar*) 0), G_LOG_LEVEL_ERROR, "It was not possible to process file: %s. %s was not found and real_db_name is null. Restore without schema-create files is not supported",filename,database); for (;;) ; } while (0);
    exit(
# 61 "/mydumper/src/myloader_process.c" 3 4
        1
# 61 "/mydumper/src/myloader_process.c"
                    );
  }
  gchar *lkey=build_dbt_key(database, table);
  struct db_table * dbt=g_hash_table_lookup(conf->table_hash,lkey);
  if (dbt == 
# 65 "/mydumper/src/myloader_process.c" 3 4
            ((void *)0)
# 65 "/mydumper/src/myloader_process.c"
                ){
    g_mutex_lock(conf->table_hash_mutex);

    dbt=g_hash_table_lookup(conf->table_hash,lkey);
    if (dbt == 
# 69 "/mydumper/src/myloader_process.c" 3 4
              ((void *)0)
# 69 "/mydumper/src/myloader_process.c"
                  ){
      dbt=(struct db_table *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (struct db_table); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= 
# 70 "/mydumper/src/myloader_process.c" 3 4
         (0x7fffffffffffffffL * 2UL + 1UL) 
# 70 "/mydumper/src/myloader_process.c"
      ...
      dbt->restore_job_list = 
# 78 "/mydumper/src/myloader_process.c" 3 4
                             ((void *)0)
# 78 "/mydumper/src/myloader_process.c"
                                 ;
      ...
      dbt->start_data_time=
# 84 "/mydumper/src/myloader_process.c" 3 4
                          ((void *)0)
# 84 "/mydumper/src/myloader_process.c"
                              ;
      dbt->finish_data_time=
# 85 "/mydumper/src/myloader_process.c" 3 4
                           ((void *)0)
# 85 "/mydumper/src/myloader_process.c"
                               ;
      dbt->start_index_time=
# 86 "/mydumper/src/myloader_process.c" 3 4
                           ((void *)0)
# 86 "/mydumper/src/myloader_process.c"
                               ;
      dbt->finish_time=
# 87 "/mydumper/src/myloader_process.c" 3 4
                      ((void *)0)
# 87 "/mydumper/src/myloader_process.c"
                          ;
      dbt->completed=(0);
      dbt->schema_state=NOT_CREATED;

      dbt->index_enqueued=(0);
      dbt->constraints=
# 92 "/mydumper/src/myloader_process.c" 3 4
                      ((void *)0)
# 92 "/mydumper/src/myloader_process.c"
                          ;
      dbt->count=0;
...
# 103 "/mydumper/src/myloader_process.c" 3 4
                                  ((void *)0)
# 103 "/mydumper/src/myloader_process.c"
                                      ) dbt->indexes=alter_table_statement;
    ...
    g_mutex_unlock(conf->table_hash_mutex);
      ...
      if (number_rows>0) dbt->rows=number_rows;
      if (alter_table_statement != 
# 113 "/mydumper/src/myloader_process.c" 3 4
                                  ((void *)0)
# 113 "/mydumper/src/myloader_process.c"
                                      ) dbt->indexes=alter_table_statement;
  }
  return dbt;
}
...
void free_dbt(struct db_table * dbt){
  ...
  dbt->constraints = 
# 123 "/mydumper/src/myloader_process.c" 3 4
                    ((void *)0)
# 123 "/mydumper/src/myloader_process.c"
                        ;
...
void free_table_hash(GHashTable *table_hash){
  ...
  if (table_hash){
    ...
    struct db_table *dbt=
# 135 "/mydumper/src/myloader_process.c" 3 4
                        ((void *)0)
# 135 "/mydumper/src/myloader_process.c"
                            ;
...
void load_schema(struct db_table *dbt, gchar *filename){
  ...
  if (!infile) {
    g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "cannot open schema file %s (%d)", filename, 
# 162 "/mydumper/src/myloader_process.c" 3 4
   (*__errno_location ())
# 162 "/mydumper/src/myloader_process.c"
   );
    errors++;
    return;
  }
          ...
          if (g_strrstr(data->str,"/*!40")){
            ...
            if (flag & 2){
              if (flag & 8){
                ...
                g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Fast index creation will be use for table: %s.%s",dbt->real_database,dbt->real_table);
              }else{
                g_string_free(alter_table_statement,(!(0)));
                alter_table_statement=
# 205 "/mydumper/src/myloader_process.c" 3 4
                                     ((void *)0)
# 205 "/mydumper/src/myloader_process.c"
                                         ;
              }
              ...
              if (flag & 4){
                ...
                dbt->constraints=alter_table_constraint_statement;
                 ...
                 g_string_free(alter_table_constraint_statement,(!(0)));
              }
              g_string_set_size(data, 0);
            }else{
              g_string_free(alter_table_statement,(!(0)));
  ...
  if (stream && no_delete == (0)){
    m_remove(
# 239 "/mydumper/src/myloader_process.c" 3 4
            ((void *)0)
# 239 "/mydumper/src/myloader_process.c"
                ,filename);
  }
  g_string_free(data,(!(0)));
...
void get_database_table_part_name_from_filename(const gchar *filename, gchar **database, gchar **table, guint *part, guint *sub_part){
  ...
  if (g_strv_length(split_db_tbl)>=2) {
    ...
    if (g_strv_length(split_db_tbl)>=3) {
      *part=g_ascii_strtoull(split_db_tbl[2], 
# 259 "/mydumper/src/myloader_process.c" 3 4
                                             ((void *)0)
# 259 "/mydumper/src/myloader_process.c"
                                                 , 10);
    }else {
      *part=0;
    }
    if (g_strv_length(split_db_tbl)>3) *sub_part=g_ascii_strtoull(split_db_tbl[3], 
# 263 "/mydumper/src/myloader_process.c" 3 4
                                                                                  ((void *)0)
# 263 "/mydumper/src/myloader_process.c"
                                                                                      , 10);
  }else {
    *database=
# 265 "/mydumper/src/myloader_process.c" 3 4
             ((void *)0)
# 265 "/mydumper/src/myloader_process.c"
                 ;
    *table=
# 266 "/mydumper/src/myloader_process.c" 3 4
          ((void *)0)
# 266 "/mydumper/src/myloader_process.c"
              ;
    *part=0;
    *sub_part=0;
  }
...
void get_database_table_name_from_filename(const gchar *filename, const gchar * suffix, gchar **database, gchar **table){
  ...
  if (g_strv_length(split_db_tbl)==2){
    ...
    *database=
# 288 "/mydumper/src/myloader_process.c" 3 4
             ((void *)0)
# 288 "/mydumper/src/myloader_process.c"
                 ;
    *table=
# 289 "/mydumper/src/myloader_process.c" 3 4
          ((void *)0)
# 289 "/mydumper/src/myloader_process.c"
              ;
  }
  g_strfreev(split_db_tbl);
}
...
gchar * get_database_name_from_content(const gchar *filename){
  ...
  if (!infile) {
    g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "cannot open database schema file %s (%d)", filename, 
# 308 "/mydumper/src/myloader_process.c" 3 4
   (*__errno_location ())
# 308 "/mydumper/src/myloader_process.c"
   );
    errors++;
    return 
# 310 "/mydumper/src/myloader_process.c" 3 4
          ((void *)0)
# 310 "/mydumper/src/myloader_process.c"
              ;
  }
  gchar *real_database=
# 312 "/mydumper/src/myloader_process.c" 3 4
                      ((void *)0)
# 312 "/mydumper/src/myloader_process.c"
                          ;
  guint line;
  while (eof == (0)) {
    if (read_data(infile, is_compressed, data, &eof, &line)) {
...
void process_tablespace_filename(char * filename) {
  struct restore_job *rj = new_schema_restore_job(filename, JOB_RESTORE_SCHEMA_FILENAME, 
# 336 "/mydumper/src/myloader_process.c" 3 4
                                                                                        ((void *)0)
# 336 "/mydumper/src/myloader_process.c"
                                                                                            , 
# 336 "/mydumper/src/myloader_process.c" 3 4
                                                                                              ((void *)0)
# 336 "/mydumper/src/myloader_process.c"
...
# 337 "/mydumper/src/myloader_process.c" 3 4
                                                                 ((void *)0)
# 337 "/mydumper/src/myloader_process.c"
                                                                     ));
}
...
void process_database_filename(char * filename, const char *object) {
  ...
  if (db_kname!=
# 345 "/mydumper/src/myloader_process.c" 3 4
               ((void *)0)
# 345 "/mydumper/src/myloader_process.c"
                   ){
    if (db)
      db_vname=db;
    else
      if (g_str_has_prefix(db_kname,"mydumper_"))
        db_vname=get_database_name_from_content(g_build_filename(directory,filename,
# 350 "/mydumper/src/myloader_process.c" 3 4
                                                                                   ((void *)0)
# 350 "/mydumper/src/myloader_process.c"
                                                                                       ));
  }else{
    g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "It was not possible to process db file: %s",filename);
    exit(
# 353 "/mydumper/src/myloader_process.c" 3 4
        1
# 353 "/mydumper/src/myloader_process.c"
                    );
  }

  g_log (((gchar*) 0), G_LOG_LEVEL_DEBUG, "Adding database: %s -> %s", db_kname, db_vname);
  get_db_hash(db_kname, db_vname);

  if (!db){
    struct restore_job *rj = new_schema_restore_job(filename, JOB_RESTORE_SCHEMA_FILENAME, 
# 360 "/mydumper/src/myloader_process.c" 3 4
                                                                                          ((void *)0)
# 360 "/mydumper/src/myloader_process.c"
                                                                                              , db_vname, 
# 360 "/mydumper/src/myloader_process.c" 3 4
                                                                                                          ((void *)0)
# 360 "/mydumper/src/myloader_process.c"
                                                                                                              , object);
    g_async_queue_push(conf->database_queue, new_job(JOB_RESTORE,rj,
# 361 "/mydumper/src/myloader_process.c" 3 4
                                                                   ((void *)0)
# 361 "/mydumper/src/myloader_process.c"
                                                                       ));
  }
}
...
gboolean process_table_filename(char * filename){
  ...
  struct db_table *dbt=
# 367 "/mydumper/src/myloader_process.c" 3 4
                      ((void *)0)
# 367 "/mydumper/src/myloader_process.c"
                          ;
  get_database_table_name_from_filename(filename,"-schema.sql",&db_name,&table_name);
  if (db_name == 
# 369 "/mydumper/src/myloader_process.c" 3 4
                ((void *)0) 
# 369 "/mydumper/src/myloader_process.c"
                     || table_name == 
# 369 "/mydumper/src/myloader_process.c" 3 4
                                      ((void *)0)
# 369 "/mydumper/src/myloader_process.c"
                                          ){
      g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "It was not possible to process file: %s (1)",filename);
      exit(
# 371 "/mydumper/src/myloader_process.c" 3 4
          1
# 371 "/mydumper/src/myloader_process.c"
                      );
  }
  struct database *real_db_name=get_db_hash(db_name,db_name);
  if (real_db_name==
# 374 "/mydumper/src/myloader_process.c" 3 4
                   ((void *)0)
# 374 "/mydumper/src/myloader_process.c"
                       ){
    g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "It was not possible to process file: %s (1) because real_db_name isn't found. We might renqueue it, take into account that restores without schema-create files are not supported",filename);
    return (0);
  }
  g_mutex_lock(conf->table_list_mutex);
  if (!eval_table(real_db_name->name, table_name)){
    g_mutex_unlock(conf->table_list_mutex);
    g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "Skiping table: `%s`.`%s`",real_db_name->name, table_name);
    return (!(0));
  }
  g_mutex_unlock(conf->table_list_mutex);
  dbt=append_new_db_table(
# 385 "/mydumper/src/myloader_process.c" 3 4
                         ((void *)0)
# 385 "/mydumper/src/myloader_process.c"
...
# 385 "/mydumper/src/myloader_process.c"
  ...
  load_schema(dbt, g_build_filename(directory,filename,
# 387 "/mydumper/src/myloader_process.c" 3 4
                                                      ((void *)0)
# 387 "/mydumper/src/myloader_process.c"
                                                          ));
  return (!(0));
...
gboolean process_metadata_filename(char * filename){
  ...
  if (db_name == 
# 395 "/mydumper/src/myloader_process.c" 3 4
                ((void *)0) 
# 395 "/mydumper/src/myloader_process.c"
                     || table_name == 
# 395 "/mydumper/src/myloader_process.c" 3 4
                                      ((void *)0)
# 395 "/mydumper/src/myloader_process.c"
      ...
      g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "It was not possible to process file: %s (1)",filename);
      exit(
# 397 "/mydumper/src/myloader_process.c" 3 4
          1
# 397 "/mydumper/src/myloader_process.c"
                      );
  }
  struct database *real_db_name=get_db_hash(db_name,db_name);
  if (real_db_name==
# 400 "/mydumper/src/myloader_process.c" 3 4
                   ((void *)0)
# 400 "/mydumper/src/myloader_process.c"
                       ){
    g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "It was not possible to process file: %s (2) because real_db_name isn't found. We might renqueue it, take into account that restores without schema-create files are not supported",filename);
    return (0);
  }
  void *infile;
  gboolean is_compressed = (0);
  gchar *path = g_build_filename(directory, filename, 
# 406 "/mydumper/src/myloader_process.c" 3 4
                                                     ((void *)0)
# 406 "/mydumper/src/myloader_process.c"
                                                         );
  ...
  if (!infile) {
    g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "cannot open metadata file %s (%d)", path, 
# 417 "/mydumper/src/myloader_process.c" 3 4
   (*__errno_location ())
# 417 "/mydumper/src/myloader_process.c"
   );
    errors++;
    return (!(0));
  }
  ...
  append_new_db_table(
# 423 "/mydumper/src/myloader_process.c" 3 4
                     ((void *)0)
# 423 "/mydumper/src/myloader_process.c"
                         , db_name, table_name,g_ascii_strtoull(cs, 
# 423 "/mydumper/src/myloader_process.c" 3 4
                                                                    ((void *)0)
# 423 "/mydumper/src/myloader_process.c"
                                                                        , 10),
...
gboolean process_schema_view_filename(gchar *filename) {
    gchar *database=
# 433 "/mydumper/src/myloader_process.c" 3 4
                   ((void *)0)
# 433 "/mydumper/src/myloader_process.c"
                       , *table_name=
# 433 "/mydumper/src/myloader_process.c" 3 4
                                     ((void *)0)
# 433 "/mydumper/src/myloader_process.c"
                                         ;
    struct database *real_db_name=
# 434 "/mydumper/src/myloader_process.c" 3 4
                                 ((void *)0)
# 434 "/mydumper/src/myloader_process.c"
                                     ;
    get_database_table_from_file(filename,"-schema",&database,&table_name);
    if (database == 
# 436 "/mydumper/src/myloader_process.c" 3 4
                   ((void *)0)
# 436 "/mydumper/src/myloader_process.c"
                       ){
      g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Database is null on: %s",filename);
    }
    real_db_name=get_db_hash(database,database);
    if (real_db_name==
# 440 "/mydumper/src/myloader_process.c" 3 4
                     ((void *)0)
# 440 "/mydumper/src/myloader_process.c"
                         ){
      g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "It was not possible to process file: %s (3) because real_db_name isn't found. We might renqueue it, take into account that restores without schema-create files are not supported",filename);
      return (0);
    }
  g_mutex_lock(conf->table_list_mutex);
  if (!eval_table(real_db_name->name, table_name)){
    g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "File %s has been filter out",filename);
    return (!(0));
  }
  g_mutex_unlock(conf->table_list_mutex);
  ...
  struct restore_job *rj = new_schema_restore_job(filename, JOB_RESTORE_SCHEMA_FILENAME, 
# 455 "/mydumper/src/myloader_process.c" 3 4
                                                                                        ((void *)0)
# 455 "/mydumper/src/myloader_process.c"
                                                                                            , real_db_name->name, 
# 455 "/mydumper/src/myloader_process.c" 3 4
                                                                                                                  ((void *)0)
# 455 "/mydumper/src/myloader_process.c"
...
gboolean process_schema_filename(gchar *filename, const char * object) {
    gchar *database=
# 461 "/mydumper/src/myloader_process.c" 3 4
                   ((void *)0)
# 461 "/mydumper/src/myloader_process.c"
                       , *table_name=
# 461 "/mydumper/src/myloader_process.c" 3 4
                                     ((void *)0)
# 461 "/mydumper/src/myloader_process.c"
                                         ;
    struct database *real_db_name=
# 462 "/mydumper/src/myloader_process.c" 3 4
                                 ((void *)0)
# 462 "/mydumper/src/myloader_process.c"
                                     ;
    get_database_table_from_file(filename,"-schema",&database,&table_name);
    if (database == 
# 464 "/mydumper/src/myloader_process.c" 3 4
                   ((void *)0)
# 464 "/mydumper/src/myloader_process.c"
                       ){
      g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Database is null on: %s",filename);
    }
    real_db_name=get_db_hash(database,database);
    if (real_db_name==
# 468 "/mydumper/src/myloader_process.c" 3 4
                     ((void *)0)
# 468 "/mydumper/src/myloader_process.c"
                         ){
      g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "It was not possible to process file: %s (3) because real_db_name isn't found. We might renqueue it, take into account that restores without schema-create files are not supported",filename);
      return (0);
    }
  ...
  g_mutex_unlock(conf->table_list_mutex);
    struct restore_job *rj = new_schema_restore_job(filename, JOB_RESTORE_SCHEMA_FILENAME, 
# 478 "/mydumper/src/myloader_process.c" 3 4
                                                                                          ((void *)0)
# 478 "/mydumper/src/myloader_process.c"
                                                                                              , real_db_name->name, 
# 478 "/mydumper/src/myloader_process.c" 3 4
                                                                                                                    ((void *)0)
# 478 "/mydumper/src/myloader_process.c"
...
gboolean process_data_filename(char * filename){
  ...
  if (db_name == 
# 502 "/mydumper/src/myloader_process.c" 3 4
                ((void *)0) 
# 502 "/mydumper/src/myloader_process.c"
                     || table_name == 
# 502 "/mydumper/src/myloader_process.c" 3 4
                                      ((void *)0)
# 502 "/mydumper/src/myloader_process.c"
                                          ){
    g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "It was not possible to process file: %s (3)",filename);
    exit(
# 504 "/mydumper/src/myloader_process.c" 3 4
        1
# 504 "/mydumper/src/myloader_process.c"
                    );
  }
  struct database *real_db_name=get_db_hash(db_name,db_name);
  if (real_db_name==
# 507 "/mydumper/src/myloader_process.c" 3 4
                   ((void *)0)
# 507 "/mydumper/src/myloader_process.c"
                       ){
    g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "It was not possible to process file: %s (3) because real_db_name isn't found. We might renqueue it, take into account that restores without schema-create files are not supported",filename);
    return (0);
  }
  g_mutex_lock(conf->table_list_mutex);
  if (real_db_name!=
# 512 "/mydumper/src/myloader_process.c" 3 4
                   ((void *)0) 
# 512 "/mydumper/src/myloader_process.c"
                        && !eval_table(real_db_name->name, table_name)){
    g_mutex_unlock(conf->table_list_mutex);
    g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "Skiping table: `%s`.`%s`",real_db_name->name, table_name);
    return (!(0));
  }
  g_mutex_unlock(conf->table_list_mutex);
  struct db_table *dbt=append_new_db_table(filename, db_name, table_name,0,
# 518 "/mydumper/src/myloader_process.c" 3 4
                                                                          ((void *)0)
# 518 "/mydumper/src/myloader_process.c"
                                                                              );
  struct restore_job *rj = new_data_restore_job( g_strdup(filename), JOB_RESTORE_FILENAME, dbt, part, sub_part);
  g_mutex_lock(dbt->mutex);
  (__extension__ ({ _Static_assert (sizeof *(&(dbt->remaining_jobs)) == sizeof (gint), "Expression evaluates to false"); (void) (0 ? *(&(dbt->remaining_jobs)) ^ (1) : 1); (gint) __atomic_fetch_add ((&(dbt->remaining_jobs)), (1), 5); }));
  dbt->count++;
