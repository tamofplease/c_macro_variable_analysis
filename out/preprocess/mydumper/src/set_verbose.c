# 0 "/mydumper/src/set_verbose.c"
# 1 "/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/mydumper/src/set_verbose.c"
# 21 "/mydumper/src/set_verbose.c"
...
# 22 "/mydumper/src/set_verbose.c" 2
...
# 23 "/mydumper/src/set_verbose.c" 2
...
# 24 "/mydumper/src/set_verbose.c" 2
...
# 7 "/usr/include/aarch64-linux-gnu/bits/types/clock_t.h" 3 4
...
# 25 "/mydumper/src/set_verbose.c" 2
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                              ...
                                                              ;
# 30 "/mydumper/src/set_verbose.c" 2
...
# 31 "/mydumper/src/set_verbose.c" 2
...
# 33 "/mydumper/src/set_verbose.c" 2
...
void write_log_file(const gchar *log_domain, GLogLevelFlags log_level,
                    const gchar *message, gpointer user_data);
# 35 "/mydumper/src/set_verbose.c" 2
...
# 47 "/mydumper/src/set_verbose.c" 3 4
                          ((void *)0)
# 47 "/mydumper/src/set_verbose.c"
                              , log_handlers[x]);
      log_handlers[x] = 0;
    }
  }
...
void set_verbose(guint verbosity) {
  if (logfile) {
    logoutfile = fopen(logfile, "w");
    if (!logoutfile) {
      g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Could not open log file '%s' for writing: %d", logfile, 
# 58 "/mydumper/src/set_verbose.c" 3 4
     (*__errno_location ())
# 58 "/mydumper/src/set_verbose.c"
     )
                       ;
      exit(
# 60 "/mydumper/src/set_verbose.c" 3 4
          1
# 60 "/mydumper/src/set_verbose.c"
                      );
    }
  }
  ...
  switch (verbosity) {
  case 0:
    log_handlers[0] = g_log_set_handler(
        
# 69 "/mydumper/src/set_verbose.c" 3 4
       ((void *)0)
# 69 "/mydumper/src/set_verbose.c"
           , (GLogLevelFlags)(G_LOG_LEVEL_MASK),
        no_log, 
# 70 "/mydumper/src/set_verbose.c" 3 4
               ((void *)0)
# 70 "/mydumper/src/set_verbose.c"
                   );
    break;
  case 1:
    log_handlers[0] = g_log_set_handler(
        
# 74 "/mydumper/src/set_verbose.c" 3 4
       ((void *)0)
# 74 "/mydumper/src/set_verbose.c"
           , (GLogLevelFlags)(G_LOG_LEVEL_WARNING | G_LOG_LEVEL_MESSAGE),
        no_log, 
# 75 "/mydumper/src/set_verbose.c" 3 4
               ((void *)0)
# 75 "/mydumper/src/set_verbose.c"
                   );
    if (logfile)
      log_handlers[1] = g_log_set_handler(
          
# 78 "/mydumper/src/set_verbose.c" 3 4
         ((void *)0)
# 78 "/mydumper/src/set_verbose.c"
             , (GLogLevelFlags)(G_LOG_LEVEL_ERROR | G_LOG_LEVEL_CRITICAL),
          write_log_file, 
# 79 "/mydumper/src/set_verbose.c" 3 4
                         ((void *)0)
# 79 "/mydumper/src/set_verbose.c"
                             );
    break;
  case 2:
    log_handlers[0] = g_log_set_handler(
        
# 83 "/mydumper/src/set_verbose.c" 3 4
       ((void *)0)
# 83 "/mydumper/src/set_verbose.c"
           , (GLogLevelFlags)(G_LOG_LEVEL_MESSAGE),
        no_log, 
# 84 "/mydumper/src/set_verbose.c" 3 4
               ((void *)0)
# 84 "/mydumper/src/set_verbose.c"
                   );
    if (logfile)
      log_handlers[1] = g_log_set_handler(
          
# 87 "/mydumper/src/set_verbose.c" 3 4
         ((void *)0)
# 87 "/mydumper/src/set_verbose.c"
             ,
          (GLogLevelFlags)(G_LOG_LEVEL_WARNING | G_LOG_LEVEL_ERROR |
                           G_LOG_LEVEL_WARNING | G_LOG_LEVEL_ERROR |
                           G_LOG_LEVEL_CRITICAL),
          write_log_file, 
# 91 "/mydumper/src/set_verbose.c" 3 4
                         ((void *)0)
# 91 "/mydumper/src/set_verbose.c"
                             );
    break;
  default:
    if (logfile)
...
# 96 "/mydumper/src/set_verbose.c" 3 4
         ((void *)0)
# 96 "/mydumper/src/set_verbose.c"
             , (GLogLevelFlags)(G_LOG_LEVEL_MASK),
          write_log_file, 
# 97 "/mydumper/src/set_verbose.c" 3 4
                         ((void *)0)
# 97 "/mydumper/src/set_verbose.c"
                             );
    break;
  }
}
