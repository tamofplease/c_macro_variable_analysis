# 0 "/mydumper/src/myloader_directory.c"
# 1 "/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/mydumper/src/myloader_directory.c"
# 18 "/mydumper/src/myloader_directory.c"
...
# 19 "/mydumper/src/myloader_directory.c" 2
...
# 20 "/mydumper/src/myloader_directory.c" 2
...
# 21 "/mydumper/src/myloader_directory.c" 2
...
# 22 "/mydumper/src/myloader_directory.c" 2
...
# 23 "/mydumper/src/myloader_directory.c" 2
...
# 24 "/mydumper/src/myloader_directory.c" 2
...
void *process_directory(struct configuration *conf){
  GError *error = 
# 30 "/mydumper/src/myloader_directory.c" 3 4
                 ((void *)0)
# 30 "/mydumper/src/myloader_directory.c"
                     ;
  const gchar *filename = 
# 31 "/mydumper/src/myloader_directory.c" 3 4
                         ((void *)0)
# 31 "/mydumper/src/myloader_directory.c"
                             ;
  if (resume){
    g_log (((gchar*) 0), G_LOG_LEVEL_MESSAGE, "Using resume file");
    FILE *file = fopen("resume", "r");
    GString *data=g_string_sized_new(256);
    gboolean eof = (0);
    guint line=0;
    read_data(file, (0), data, &eof, &line);
    gchar **split=
# 39 "/mydumper/src/myloader_directory.c" 3 4
                 ((void *)0)
# 39 "/mydumper/src/myloader_directory.c"
                     ;
    guint i=0;
    while (!eof){
      read_data(file, (0), data, &eof, &line);
      ...
      for (i=0; i<g_strv_length(split);i++){
        if (strlen(split[i])>2){
          filename=split[i];
          g_log (((gchar*) 0), G_LOG_LEVEL_DEBUG, "Resuming file: %s", filename);
  ...
  for (n = 0; n < num_threads ; n++) {
    g_async_queue_push(conf->data_queue, new_job(JOB_SHUTDOWN,
# 63 "/mydumper/src/myloader_directory.c" 3 4
                                                                   ((void *)0)
# 63 "/mydumper/src/myloader_directory.c"
                                                                       ,
# 63 "/mydumper/src/myloader_directory.c" 3 4
                                                                        ((void *)0)
# 63 "/mydumper/src/myloader_directory.c"
                                                                            ));
    g_async_queue_push(conf->post_table_queue, new_job(JOB_SHUTDOWN,
# 64 "/mydumper/src/myloader_directory.c" 3 4
                                                                   ((void *)0)
# 64 "/mydumper/src/myloader_directory.c"
                                                                       ,
# 64 "/mydumper/src/myloader_directory.c" 3 4
                                                                        ((void *)0)
# 64 "/mydumper/src/myloader_directory.c"
                                                                            ));
    g_async_queue_push(conf->post_queue, new_job(JOB_SHUTDOWN,
# 65 "/mydumper/src/myloader_directory.c" 3 4
                                                                   ((void *)0)
# 65 "/mydumper/src/myloader_directory.c"
                                                                       ,
# 65 "/mydumper/src/myloader_directory.c" 3 4
                                                                        ((void *)0)
# 65 "/mydumper/src/myloader_directory.c"
                                                                            ));
    g_async_queue_push(conf->view_queue, new_job(JOB_SHUTDOWN,
# 66 "/mydumper/src/myloader_directory.c" 3 4
                                                                   ((void *)0)
# 66 "/mydumper/src/myloader_directory.c"
                                                                       ,
# 66 "/mydumper/src/myloader_directory.c" 3 4
                                                                        ((void *)0)
# 66 "/mydumper/src/myloader_directory.c"
  ...
  return 
# 68 "/mydumper/src/myloader_directory.c" 3 4
        ((void *)0)
# 68 "/mydumper/src/myloader_directory.c"
            ;
}
