# 0 "/mydumper/src/connection.c"
# 1 "/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/mydumper/src/connection.c"
# 18 "/mydumper/src/connection.c"
...
# 19 "/mydumper/src/connection.c" 2
...
# 69 "/usr/include/aarch64-linux-gnu/sys/types.h" 3 4
...
# 20 "/mydumper/src/connection.c" 2
...
# 21 "/mydumper/src/connection.c" 2
...
# 22 "/mydumper/src/connection.c" 2
...
# 23 "/mydumper/src/connection.c" 2

# 1 "/mydumper/src/config.h" 1
# 25 "/mydumper/src/connection.c" 2
# 1 "/mydumper/src/connection.h" 1
# 19 "/mydumper/src/connection.h"
...
MYSQL * mysql_real_connect_dns_srv(MYSQL *mysql,
                                          ...
                                          const char *db,
                                          unsigned long client_flag);
# 20 "/mydumper/src/connection.h" 2
...
# 26 "/mydumper/src/connection.c" 2

char *hostname = 
# 27 "/mydumper/src/connection.c" 3 4
                ((void *)0)
# 27 "/mydumper/src/connection.c"
                    ;
char *username = 
# 28 "/mydumper/src/connection.c" 3 4
                ((void *)0)
# 28 "/mydumper/src/connection.c"
                    ;
char *password = 
# 29 "/mydumper/src/connection.c" 3 4
                ((void *)0)
# 29 "/mydumper/src/connection.c"
                    ;
char *socket_path = 
# 30 "/mydumper/src/connection.c" 3 4
                   ((void *)0)
# 30 "/mydumper/src/connection.c"
                       ;
guint port = 0;
gboolean askPassword = (0);

GOptionEntry connection_entries[] = {
    {"host", 'h', 0, G_OPTION_ARG_STRING, &hostname, "The host to connect to",
     
# 36 "/mydumper/src/connection.c" 3 4
    ((void *)0)
# 36 "/mydumper/src/connection.c"
        },
    {"user", 'u', 0, G_OPTION_ARG_STRING, &username,
     "Username with the necessary privileges", 
# 38 "/mydumper/src/connection.c" 3 4
                                              ((void *)0)
# 38 "/mydumper/src/connection.c"
                                                  },
    {"password", 'p', 0, G_OPTION_ARG_STRING, &password, "User password", 
# 39 "/mydumper/src/connection.c" 3 4
                                                                         ((void *)0)
# 39 "/mydumper/src/connection.c"
                                                                             },
    {"ask-password", 'a', 0, G_OPTION_ARG_NONE, &askPassword,
     "Prompt For User password", 
# 41 "/mydumper/src/connection.c" 3 4
                                ((void *)0)
# 41 "/mydumper/src/connection.c"
                                    },
    {"port", 'P', 0, G_OPTION_ARG_INT, &port, "TCP/IP port to connect to",
     
# 43 "/mydumper/src/connection.c" 3 4
    ((void *)0)
# 43 "/mydumper/src/connection.c"
        },
    {"socket", 'S', 0, G_OPTION_ARG_STRING, &socket_path,
     "UNIX domain socket file to use for connection", 
# 45 "/mydumper/src/connection.c" 3 4
                                                     ((void *)0)
# 45 "/mydumper/src/connection.c"
                                                         },
    {
# 46 "/mydumper/src/connection.c" 3 4
    ((void *)0)
# 46 "/mydumper/src/connection.c"
...
void configure_connection(MYSQL *conn, const char *name) {
  if (defaults_file != 
# 68 "/mydumper/src/connection.c" 3 4
                      ((void *)0)
# 68 "/mydumper/src/connection.c"
                          ) {
...
# 72 "/mydumper/src/connection.c" 3 4
                                             ((void *)0)
# 72 "/mydumper/src/connection.c"
                                                 );
  if (compress_protocol)
    mysql_options(conn, MYSQL_OPT_COMPRESS, 
# 74 "/mydumper/src/connection.c" 3 4
                                           ((void *)0)
# 74 "/mydumper/src/connection.c"
                                               );
# 92 "/mydumper/src/connection.c"
  unsigned int i;
  if (ssl) {
    i = SSL_MODE_REQUIRED;
    ...
    if (ssl_mode) {
      if (g_ascii_strncasecmp(ssl_mode, "DISABLED", 16) == 0) {
        ...
        g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Unsupported ssl-mode specified: %s\n", ssl_mode);
        exit(
# 115 "/mydumper/src/connection.c" 3 4
            1
# 115 "/mydumper/src/connection.c"
                        );
      }
      mysql_options(conn, MYSQL_OPT_SSL_MODE, &i);
    }
...
void m_connect(MYSQL *conn, const gchar *app, gchar *schema){
  ...
  if (!mysql_real_connect(conn, hostname, username, password, schema, port,
                          socket_path, 0)) {
    g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "Error connection to database: %s", mysql_error(conn));
    exit(
# 147 "/mydumper/src/connection.c" 3 4
        1
# 147 "/mydumper/src/connection.c"
                    );
  }
}
...
void hide_password(int argc, char *argv[]){
  if (password != 
# 152 "/mydumper/src/connection.c" 3 4
                 ((void *)0)
# 152 "/mydumper/src/connection.c"
                     ){
    int i=1;
    for(i=1; i < argc; i++){
      gchar * p= g_strstr_len(argv[i],-1,password);
      if (p != 
# 156 "/mydumper/src/connection.c" 3 4
              ((void *)0)
# 156 "/mydumper/src/connection.c"
                  ){
...
void ask_password(){
  ...
  if (sizeof(password) == 0 || (password == 
# 172 "/mydumper/src/connection.c" 3 4
                                           ((void *)0) 
# 172 "/mydumper/src/connection.c"
                                                && askPassword)) {
