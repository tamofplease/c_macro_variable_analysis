# 0 "src/backend/executor/cypher_set.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/executor/cypher_set.c"
# 20 "src/backend/executor/cypher_set.c"
...
# 21 "src/backend/executor/cypher_set.c" 2

# 1 "/usr/include/postgresql/11/server/access/sysattr.h" 1
# 23 "src/backend/executor/cypher_set.c" 2
...
# 24 "src/backend/executor/cypher_set.c" 2
...
# 25 "src/backend/executor/cypher_set.c" 2
...
# 26 "src/backend/executor/cypher_set.c" 2
...
# 27 "src/backend/executor/cypher_set.c" 2
...
# 28 "src/backend/executor/cypher_set.c" 2
...
# 158 "/usr/include/postgresql/11/server/nodes/extensible.h"
          missing_ok);
# 29 "src/backend/executor/cypher_set.c" 2
...
# 32 "src/backend/executor/cypher_set.c" 2
...
# 33 "src/backend/executor/cypher_set.c" 2
...
# 34 "src/backend/executor/cypher_set.c" 2
...
# 35 "src/backend/executor/cypher_set.c" 2
...
# 37 "src/backend/executor/cypher_set.c" 2
...
Oid create_label(char *graph_name, char *label_name, char label_type,
                 List *parents);
# 38 "src/backend/executor/cypher_set.c" 2
...
# 39 "src/backend/executor/cypher_set.c" 2
...
# 40 "src/backend/executor/cypher_set.c" 2
...
# 41 "src/backend/executor/cypher_set.c" 2
...
# 61 "src/backend/executor/cypher_set.c" 3 4
                                                     ((void *)0)
# 61 "src/backend/executor/cypher_set.c"
                                                         ,
                                                      
# 62 "src/backend/executor/cypher_set.c" 3 4
                                                     ((void *)0)
# 62 "src/backend/executor/cypher_set.c"
                                                         ,
                                                      
# 63 "src/backend/executor/cypher_set.c" 3 4
                                                     ((void *)0)
# 63 "src/backend/executor/cypher_set.c"
                                                         ,
                                                      
# 64 "src/backend/executor/cypher_set.c" 3 4
                                                     ((void *)0)
# 64 "src/backend/executor/cypher_set.c"
                                                         ,
                                                      
# 65 "src/backend/executor/cypher_set.c" 3 4
                                                     ((void *)0)
# 65 "src/backend/executor/cypher_set.c"
                                                         ,
                                                      
# 66 "src/backend/executor/cypher_set.c" 3 4
                                                     ((void *)0)
# 66 "src/backend/executor/cypher_set.c"
                                                         ,
                                                      
# 67 "src/backend/executor/cypher_set.c" 3 4
                                                     ((void *)0)
# 67 "src/backend/executor/cypher_set.c"
                                                         ,
                                                      
# 68 "src/backend/executor/cypher_set.c" 3 4
                                                     ((void *)0)
# 68 "src/backend/executor/cypher_set.c"
                                                         };
                             ...
                             int eflags)
{
    ...
    ((void)
# 77 "src/backend/executor/cypher_set.c" 3 4
   1
# 77 "src/backend/executor/cypher_set.c"
   );
...
# 101 "src/backend/executor/cypher_set.c"
...
{
    HeapTuple tuple = 
# 113 "src/backend/executor/cypher_set.c" 3 4
                     ((void *)0)
# 113 "src/backend/executor/cypher_set.c"
                         ;
    LockTupleMode lockmode;
    HeapUpdateFailureData hufd;
    ...
    lock_result = heap_lock_tuple(resultRelInfo->ri_RelationDesc, old_tuple,
                                  GetCurrentCommandId(
# 126 "src/backend/executor/cypher_set.c" 3 4
                                                     0
# 126 "src/backend/executor/cypher_set.c"
                                                          ), lockmode,
                                  LockWaitBlock, 
# 127 "src/backend/executor/cypher_set.c" 3 4
                                                0
# 127 "src/backend/executor/cypher_set.c"
                                                     , &buffer, &hufd);
...
# 137 "src/backend/executor/cypher_set.c" 3 4
                                                             ((void *)0)
# 137 "src/backend/executor/cypher_set.c"
                                                                 )
        {
        ...
        update_result = heap_update(resultRelInfo->ri_RelationDesc,
                                    &(tuple->t_self), tuple,
                                    GetCurrentCommandId(
# 145 "src/backend/executor/cypher_set.c" 3 4
                                                       1
# 145 "src/backend/executor/cypher_set.c"
                                                           ),
                                    estate->es_crosscheck_snapshot, 
# 146 "src/backend/executor/cypher_set.c" 3 4
                                                                   1
# 146 "src/backend/executor/cypher_set.c"
                                                                       , &hufd,
                                    &lockmode);

        if (update_result != HeapTupleMayBeUpdated)
        {
            do { if (errstart(20, "src/backend/executor/cypher_set.c", 151, __func__, 
# 151 "src/backend/executor/cypher_set.c" 3 4
           ((void *)0)
# 151 "src/backend/executor/cypher_set.c"
           )) errfinish (errcode((((('X') - '0') & 0x3F) + (((('X') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("Entity failed to be updated: %i", update_result)); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                              ;
        }
...
# 159 "src/backend/executor/cypher_set.c" 3 4
                                 0
# 159 "src/backend/executor/cypher_set.c"
                                      , 
# 159 "src/backend/executor/cypher_set.c" 3 4
                                        ((void *)0)
# 159 "src/backend/executor/cypher_set.c"
...
# 185 "src/backend/executor/cypher_set.c" 3 4
             ((void *)0) 
# 185 "src/backend/executor/cypher_set.c"
             || (slot)->tts_isempty));
}
...
static 
# 193 "src/backend/executor/cypher_set.c" 3 4
      _Bool 
# 193 "src/backend/executor/cypher_set.c"
           check_path(agtype_value *path, graphid updated_id)
{
    int i;
    ...
    for (i = 0; i < path->val.array.num_elems; i++)
    {
        ...
        agtype_value *id = get_agtype_value_object_value(elem, "id", sizeof("id") - 1);

        if (updated_id == id->val.int_value)
        {
            return 
# 205 "src/backend/executor/cypher_set.c" 3 4
                  1
# 205 "src/backend/executor/cypher_set.c"
                      ;
        }
    }

    return 
# 209 "src/backend/executor/cypher_set.c" 3 4
          0
# 209 "src/backend/executor/cypher_set.c"
               ;
}
                                            ...
                                            agtype *updated_entity)
{
    ...
    agtype_parse_state *parse_state = 
# 222 "src/backend/executor/cypher_set.c" 3 4
                                     ((void *)0)
# 222 "src/backend/executor/cypher_set.c"
                                         ;
    agtype_value *r;
    agtype_value *parsed_agtype_value = 
# 224 "src/backend/executor/cypher_set.c" 3 4
                                       ((void *)0)
# 224 "src/backend/executor/cypher_set.c"
                                           ;
    agtype *prop_agtype;
    int i;
    ...
    tok = agtype_iterator_next(&it, r, 
# 232 "src/backend/executor/cypher_set.c" 3 4
                                      1
# 232 "src/backend/executor/cypher_set.c"
                                          );

    parsed_agtype_value = push_agtype_value(&parse_state, tok,
                                            tok < WAGT_BEGIN_ARRAY ? r : 
# 235 "src/backend/executor/cypher_set.c" 3 4
                                                                        ((void *)0)
# 235 "src/backend/executor/cypher_set.c"
                                                                            );
    ...
    for (i = 0; i < path->val.array.num_elems; i++)
    {
        ...
        {
            do { if (errstart(20, "src/backend/executor/cypher_set.c", 247, __func__, 
# 247 "src/backend/executor/cypher_set.c" 3 4
           ((void *)0)
# 247 "src/backend/executor/cypher_set.c"
           )) errfinish (errcode((((('0') - '0') & 0x3F) + (((('A') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("unsupported agtype found in a path")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                          ;
        }


        id = get_agtype_value_object_value(elem, "id", sizeof("id") - 1);
    ...
    parsed_agtype_value = push_agtype_value(&parse_state, WAGT_END_ARRAY, 
# 270 "src/backend/executor/cypher_set.c" 3 4
                                                                         ((void *)0)
# 270 "src/backend/executor/cypher_set.c"
                                                                             );
                             ...
                             agtype *updated_entity)
{
    ...
    for (i = 0; i < scanTupleSlot->tts_tupleDescriptor->natts; i++)
    {
        ...
        if (scanTupleSlot->tts_tupleDescriptor->attrs[i].atttypid != get_AGTYPEOID())
        {
            continue;
        }
        ...
        original_entity = ((agtype *)pg_detoast_datum((struct varlena *) ((Pointer) (scanTupleSlot->tts_values[i]))));


        if (!(((&original_entity->root)->header & 0x10000000) != 0))
        {
            continue;
        }
        ...
        if (original_entity_value->type == AGTV_PATH)
        {
            ...
            if (check_path(original_entity_value, id))
            {
                ...
                scanTupleSlot->tts_values[i] = ((Datum) (agtype_value_to_agtype(new_path)));
            }
        }
    }
}
...
static void process_update_list(CustomScanState *node)
{
    ...
    EState *estate = css->css.ss.ps.state;
    int *luindex = 
# 338 "src/backend/executor/cypher_set.c" 3 4
                  ((void *)0)
# 338 "src/backend/executor/cypher_set.c"
                      ;
    int lidx = 0;


    luindex = palloc0(sizeof(int) * scanTupleSlot->tts_nvalid);
# 352 "src/backend/executor/cypher_set.c"
    for ((lc) = list_head(css->set_list->set_items); (lc) != 
# 352 "src/backend/executor/cypher_set.c" 3 4
   ((void *)0)
# 352 "src/backend/executor/cypher_set.c"
   ; (lc) = ((lc)->next))
    {
        cypher_update_item *update_item = 
# 354 "src/backend/executor/cypher_set.c" 3 4
                                         ((void *)0)
# 354 "src/backend/executor/cypher_set.c"
                                             ;

        update_item = (cypher_update_item *)((lc)->data.ptr_value);
    ...
    for ((lc) = list_head(css->set_list->set_items); (lc) != 
# 367 "src/backend/executor/cypher_set.c" 3 4
   ((void *)0)
# 367 "src/backend/executor/cypher_set.c"
   ; (lc) = ((lc)->next))
    {
...
# 380 "src/backend/executor/cypher_set.c" 3 4
       _Bool 
# 380 "src/backend/executor/cypher_set.c"
            remove_property;
        char *label_name;
        cypher_update_item *update_item;
        Datum new_entity;
        ...
        if (scanTupleSlot->tts_tupleDescriptor->attrs[update_item->entity_position -1].atttypid != get_AGTYPEOID())
        {
            do { if (errstart(20, "src/backend/executor/cypher_set.c", 400, __func__, 
# 400 "src/backend/executor/cypher_set.c" 3 4
           ((void *)0)
# 400 "src/backend/executor/cypher_set.c"
           )) errfinish (errcode((((('0') - '0') & 0x3F) + (((('A') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("age %s clause can only update agtype", clause_name)); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)


                                          ;
        }

        original_entity = ((agtype *)pg_detoast_datum((struct varlena *) ((Pointer) (scanTupleSlot->tts_values[update_item->entity_position - 1]))));
        original_entity_value = get_ith_agtype_value_from_container(&original_entity->root, 0);

        if (original_entity_value->type != AGTV_VERTEX &&
            original_entity_value->type != AGTV_EDGE)
        {
            do { if (errstart(20, "src/backend/executor/cypher_set.c", 412, __func__, 
# 412 "src/backend/executor/cypher_set.c" 3 4
           ((void *)0)
# 412 "src/backend/executor/cypher_set.c"
           )) errfinish (errcode((((('0') - '0') & 0x3F) + (((('A') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("age %s clause can only update vertex and edges", clause_name)); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
        ...
        original_properties = get_agtype_value_object_value(original_entity_value, "properties", sizeof("properties") - 1)
                                                                         ;
        ...
        {
            remove_property = 
# 435 "src/backend/executor/cypher_set.c" 3 4
                             1
# 435 "src/backend/executor/cypher_set.c"
                                 ;
        }
        else
        {
        ...
        {
            new_property_value = 
# 448 "src/backend/executor/cypher_set.c" 3 4
                                ((void *)0)
# 448 "src/backend/executor/cypher_set.c"
                                    ;
        }
        else
        {
            new_property_value = ((agtype *)pg_detoast_datum((struct varlena *) ((Pointer) (scanTupleSlot->tts_values[update_item->prop_position - 1]))));
        }
        ...
        slot = ExecInitExtraTupleSlot(estate, ((resultRelInfo->ri_RelationDesc)->rd_att));
        ...
        if (original_entity_value->type == AGTV_VERTEX)
        {
            new_entity = make_vertex(((Datum) (id->val.int_value)),
                                     ((Datum) (label_name)),
                                     ((Datum) (agtype_value_to_agtype(altered_properties))));

            slot = populate_vertex_tts(slot, id, altered_properties);
        }
        else if (original_entity_value->type == AGTV_EDGE)
        {
            agtype_value *startid = get_agtype_value_object_value(original_entity_value, "start_id", sizeof("start_id") - 1);
            agtype_value *endid = get_agtype_value_object_value(original_entity_value, "end_id", sizeof("end_id") - 1);

            new_entity = make_edge(((Datum) (id->val.int_value)),
        ...
        {
            do { if (errstart(20, "src/backend/executor/cypher_set.c", 499, __func__, 
# 499 "src/backend/executor/cypher_set.c" 3 4
           ((void *)0)
# 499 "src/backend/executor/cypher_set.c"
           )) errfinish (errcode((((('0') - '0') & 0x3F) + (((('A') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("age %s clause can only update vertex and edges", clause_name)); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
        ...
        update_all_paths(node,
                         id->val.int_value, ((agtype *)pg_detoast_datum((struct varlena *) ((Pointer) (new_entity)))));
        ...
        if (luindex[update_item->entity_position - 1] == lidx)
        {
            ...
            ScanKeyInit(&scan_keys[0], 1, 3, 467,
...
# 540 "src/backend/executor/cypher_set.c" 3 4
               ((void *)0)
# 540 "src/backend/executor/cypher_set.c"
               ))
            {
        ...
        relation_close(resultRelInfo->ri_RelationDesc,3);
...
static TupleTableSlot *exec_cypher_set(CustomScanState *node)
{
    ...
    if (((slot) == 
# 575 "src/backend/executor/cypher_set.c" 3 4
       ((void *)0) 
# 575 "src/backend/executor/cypher_set.c"
       || (slot)->tts_isempty))
    {
        return 
# 577 "src/backend/executor/cypher_set.c" 3 4
              ((void *)0)
# 577 "src/backend/executor/cypher_set.c"
                  ;
    }
    ...
    if ((css->flags & 0x0001))
    {
        ...
        return 
# 592 "src/backend/executor/cypher_set.c" 3 4
              ((void *)0)
# 592 "src/backend/executor/cypher_set.c"
                  ;
    }
...
static void rescan_cypher_set(CustomScanState *node)
{
    ...
    char *clause_name = css->set_list->clause_name;
     ...
     do { if (errstart(20, "src/backend/executor/cypher_set.c", 617, __func__, 
# 617 "src/backend/executor/cypher_set.c" 3 4
    ((void *)0)
# 617 "src/backend/executor/cypher_set.c"
    )) errfinish (errcode((((('0') - '0') & 0x3F) + (((('A') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("cypher %s clause cannot be rescaned", clause_name), errhint("its unsafe to use joins in a query with a Cypher %s clause", clause_name)); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
...
Node *create_cypher_set_plan_state(CustomScan *cscan)
{
    ...
    ((void)
# 638 "src/backend/executor/cypher_set.c" 3 4
   1
# 638 "src/backend/executor/cypher_set.c"
   );
