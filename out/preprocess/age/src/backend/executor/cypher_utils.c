# 0 "src/backend/executor/cypher_utils.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/executor/cypher_utils.c"
# 25 "src/backend/executor/cypher_utils.c"
...
# 26 "src/backend/executor/cypher_utils.c" 2
...
# 28 "src/backend/executor/cypher_utils.c" 2
# 1 "/usr/include/postgresql/11/server/access/sysattr.h" 1
# 29 "src/backend/executor/cypher_utils.c" 2
...
# 30 "src/backend/executor/cypher_utils.c" 2
# 1 "/usr/include/postgresql/11/server/access/multixact.h" 1
# 40 "/usr/include/postgresql/11/server/access/multixact.h"
typedef enum
{
...
# 59 "/usr/include/postgresql/11/server/access/multixact.h"
typedef struct MultiXactMember
{
 TransactionId xid;
 MultiXactStatus status;
} MultiXactMember;
# 76 "/usr/include/postgresql/11/server/access/multixact.h"
...
extern 
# 111 "/usr/include/postgresql/11/server/access/multixact.h" 3 4
      _Bool 
# 111 "/usr/include/postgresql/11/server/access/multixact.h"
...
# 114 "/usr/include/postgresql/11/server/access/multixact.h" 3 4
      _Bool 
# 114 "/usr/include/postgresql/11/server/access/multixact.h"
           allow_old, 
# 114 "/usr/include/postgresql/11/server/access/multixact.h" 3 4
                      _Bool 
# 114 "/usr/include/postgresql/11/server/access/multixact.h"
                           isLockOnly);
extern 
# 115 "/usr/include/postgresql/11/server/access/multixact.h" 3 4
      _Bool 
# 115 "/usr/include/postgresql/11/server/access/multixact.h"
           MultiXactIdPrecedes(MultiXactId multi1, MultiXactId multi2);
extern 
# 116 "/usr/include/postgresql/11/server/access/multixact.h" 3 4
      _Bool 
# 116 "/usr/include/postgresql/11/server/access/multixact.h"
...
# 131 "/usr/include/postgresql/11/server/access/multixact.h" 3 4
    _Bool 
# 131 "/usr/include/postgresql/11/server/access/multixact.h"
         is_startup);
extern void MultiXactGetCheckptMulti(
# 132 "/usr/include/postgresql/11/server/access/multixact.h" 3 4
                                    _Bool 
# 132 "/usr/include/postgresql/11/server/access/multixact.h"
                                         is_shutdown,
...
extern char *mxid_to_string(MultiXactId multi, int nmembers,
      MultiXactMember *members);
# 31 "src/backend/executor/cypher_utils.c" 2
...
# 158 "/usr/include/postgresql/11/server/nodes/extensible.h"
          missing_ok);
# 32 "src/backend/executor/cypher_utils.c" 2
...
# 33 "src/backend/executor/cypher_utils.c" 2
...
# 78 "/usr/include/postgresql/11/server/nodes/nodeFuncs.h"
                                                                   (*walker) (),
          void *context);
# 35 "src/backend/executor/cypher_utils.c" 2
...
# 37 "src/backend/executor/cypher_utils.c" 2
...
# 38 "src/backend/executor/cypher_utils.c" 2
# 1 "/usr/include/postgresql/11/server/storage/procarray.h" 1
# 18 "/usr/include/postgresql/11/server/storage/procarray.h"
# 1 "/usr/include/postgresql/11/server/storage/standby.h" 1
# 17 "/usr/include/postgresql/11/server/storage/standby.h"
# 1 "/usr/include/postgresql/11/server/storage/standbydefs.h" 1
# 23 "/usr/include/postgresql/11/server/storage/standbydefs.h"
...
# 29 "/usr/include/postgresql/11/server/storage/standbydefs.h" 3 4
        _Bool 
# 29 "/usr/include/postgresql/11/server/storage/standbydefs.h"
             relcacheInitFileInval);
# 38 "/usr/include/postgresql/11/server/storage/standbydefs.h"
...
# 51 "/usr/include/postgresql/11/server/storage/standbydefs.h" 3 4
_Bool 
# 51 "/usr/include/postgresql/11/server/storage/standbydefs.h"
      subxid_overflow;
 TransactionId nextXid;
...
# 67 "/usr/include/postgresql/11/server/storage/standbydefs.h" 3 4
_Bool 
# 67 "/usr/include/postgresql/11/server/storage/standbydefs.h"
      relcacheInitFileInval;
 int nmsgs;
 SharedInvalidationMessage msgs[];
} xl_invalidations;
# 18 "/usr/include/postgresql/11/server/storage/standby.h" 2
...
# 20 "/usr/include/postgresql/11/server/storage/standby.h" 2
...
# 49 "/usr/include/postgresql/11/server/storage/standby.h"
...
# 70 "/usr/include/postgresql/11/server/storage/standby.h"
typedef struct RunningTransactionsData
{
 int xcnt;
 int subxcnt;
 
# 74 "/usr/include/postgresql/11/server/storage/standby.h" 3 4
_Bool 
# 74 "/usr/include/postgresql/11/server/storage/standby.h"
      subxid_overflow;
 TransactionId nextXid;
 TransactionId oldestRunningXid;
 TransactionId latestCompletedXid;
...
# 89 "/usr/include/postgresql/11/server/storage/standby.h" 3 4
     _Bool 
# 89 "/usr/include/postgresql/11/server/storage/standby.h"
          relcacheInitFileInval);
# 19 "/usr/include/postgresql/11/server/storage/procarray.h" 2
# 58 "/usr/include/postgresql/11/server/storage/procarray.h"
...
extern 
# 83 "/usr/include/postgresql/11/server/storage/procarray.h" 3 4
      _Bool 
# 83 "/usr/include/postgresql/11/server/storage/procarray.h"
           ProcArrayInstallImportedXmin(TransactionId xmin,
        VirtualTransactionId *sourcevxid);
extern 
# 85 "/usr/include/postgresql/11/server/storage/procarray.h" 3 4
      _Bool 
# 85 "/usr/include/postgresql/11/server/storage/procarray.h"
           ProcArrayInstallRestoredXmin(TransactionId xmin, PGPROC *proc);

extern RunningTransactions GetRunningTransactionData(void);

extern 
# 89 "/usr/include/postgresql/11/server/storage/procarray.h" 3 4
      _Bool 
# 89 "/usr/include/postgresql/11/server/storage/procarray.h"
           TransactionIdIsInProgress(TransactionId xid);
extern 
# 90 "/usr/include/postgresql/11/server/storage/procarray.h" 3 4
      _Bool 
# 90 "/usr/include/postgresql/11/server/storage/procarray.h"
           TransactionIdIsActive(TransactionId xid);
extern TransactionId GetOldestXmin(Relation rel, int flags);
extern TransactionId GetOldestActiveTransactionId(void);
extern TransactionId GetOldestSafeDecodingTransactionId(
# 93 "/usr/include/postgresql/11/server/storage/procarray.h" 3 4
                                                       _Bool 
# 93 "/usr/include/postgresql/11/server/storage/procarray.h"
                                                            catalogOnly);

extern VirtualTransactionId *GetVirtualXIDsDelayingChkpt(int *nvxids);
extern VirtualTransactionId *GetVirtualXIDsDelayingChkptEnd(int *nvxids);
extern 
# 97 "/usr/include/postgresql/11/server/storage/procarray.h" 3 4
      _Bool 
# 97 "/usr/include/postgresql/11/server/storage/procarray.h"
           HaveVirtualXIDsDelayingChkpt(VirtualTransactionId *vxids,
           int nvxids);
extern 
# 99 "/usr/include/postgresql/11/server/storage/procarray.h" 3 4
      _Bool 
# 99 "/usr/include/postgresql/11/server/storage/procarray.h"
           HaveVirtualXIDsDelayingChkptEnd(VirtualTransactionId *vxids,
           int nvxids);
...
extern 
# 105 "/usr/include/postgresql/11/server/storage/procarray.h" 3 4
      _Bool 
# 105 "/usr/include/postgresql/11/server/storage/procarray.h"
           IsBackendPid(int pid);

extern VirtualTransactionId *GetCurrentVirtualXIDs(TransactionId limitXmin,
       
# 108 "/usr/include/postgresql/11/server/storage/procarray.h" 3 4
      _Bool 
# 108 "/usr/include/postgresql/11/server/storage/procarray.h"
           excludeXmin0, 
# 108 "/usr/include/postgresql/11/server/storage/procarray.h" 3 4
                         _Bool 
# 108 "/usr/include/postgresql/11/server/storage/procarray.h"
                              allDbs, int excludeVacuum,
       int *nvxids);
...
# 113 "/usr/include/postgresql/11/server/storage/procarray.h" 3 4
          _Bool 
# 113 "/usr/include/postgresql/11/server/storage/procarray.h"
               conflictPending);

extern 
# 115 "/usr/include/postgresql/11/server/storage/procarray.h" 3 4
      _Bool 
# 115 "/usr/include/postgresql/11/server/storage/procarray.h"
...
# 118 "/usr/include/postgresql/11/server/storage/procarray.h" 3 4
                                                                      _Bool 
# 118 "/usr/include/postgresql/11/server/storage/procarray.h"
                                                                           conflictPending);
extern int CountUserBackends(Oid roleid);
extern 
# 120 "/usr/include/postgresql/11/server/storage/procarray.h" 3 4
      _Bool 
# 120 "/usr/include/postgresql/11/server/storage/procarray.h"
...
# 128 "/usr/include/postgresql/11/server/storage/procarray.h" 3 4
                                   _Bool 
# 128 "/usr/include/postgresql/11/server/storage/procarray.h"
                                        already_locked);

extern void ProcArrayGetReplicationSlotXmin(TransactionId *xmin,
        TransactionId *catalog_xmin);
# 39 "src/backend/executor/cypher_utils.c" 2
...
# 40 "src/backend/executor/cypher_utils.c" 2
...
# 42 "src/backend/executor/cypher_utils.c" 2
...
Oid create_label(char *graph_name, char *label_name, char label_type,
                 List *parents);
# 43 "src/backend/executor/cypher_utils.c" 2
...
# 44 "src/backend/executor/cypher_utils.c" 2
...
# 45 "src/backend/executor/cypher_utils.c" 2
...
# 47 "src/backend/executor/cypher_utils.c" 2
...
# 60 "src/backend/executor/cypher_utils.c" 3 4
                                        ((void *)0)
# 60 "src/backend/executor/cypher_utils.c"
                                            );
    ...
    {
        rv = makeRangeVar(graph_name, "_ag_label_vertex", -1);
    }
    else
    {
    ...
    label_relation = parserOpenTable(pstate, rv, 3);


    InitResultRelInfo(resultRelInfo, label_relation,
                      list_length(estate->es_range_table), 
# 77 "src/backend/executor/cypher_utils.c" 3 4
                                                          ((void *)0)
# 77 "src/backend/executor/cypher_utils.c"
                                                              ,
                      estate->es_instrument);


    ExecOpenIndices(resultRelInfo, 
# 81 "src/backend/executor/cypher_utils.c" 3 4
                                  0
# 81 "src/backend/executor/cypher_utils.c"
                                       );
...
void destroy_entity_result_rel_info(ResultRelInfo *result_rel_info)
{
    ...
    relation_close(result_rel_info->ri_RelationDesc,3);
}
...
# 101 "src/backend/executor/cypher_utils.c" 3 4
   _Bool 
# 101 "src/backend/executor/cypher_utils.c"
        properties_isnull;

    if (id == 
# 103 "src/backend/executor/cypher_utils.c" 3 4
             ((void *)0)
# 103 "src/backend/executor/cypher_utils.c"
                 )
    {
        do { if (errstart(20, "src/backend/executor/cypher_utils.c", 105, __func__, 
# 105 "src/backend/executor/cypher_utils.c" 3 4
       ((void *)0)
# 105 "src/backend/executor/cypher_utils.c"
       )) errfinish (errcode((((('0') - '0') & 0x3F) + (((('A') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("vertex id field cannot be NULL")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                  ;
    }

    properties_isnull = properties == 
# 109 "src/backend/executor/cypher_utils.c" 3 4
                                     ((void *)0)
# 109 "src/backend/executor/cypher_utils.c"
                                         ;

    elemTupleSlot->tts_values[1 - 1] = ((Datum) (id->val.int_value));
    elemTupleSlot->tts_isnull[1 - 1] = 
# 112 "src/backend/executor/cypher_utils.c" 3 4
                                                0
# 112 "src/backend/executor/cypher_utils.c"
                                                     ;

    elemTupleSlot->tts_values[2 - 1] =
        ((Datum) (agtype_value_to_agtype(properties)));
    elemTupleSlot->tts_isnull[2 - 1] = properties_isnull;
...
# 125 "src/backend/executor/cypher_utils.c" 3 4
   _Bool 
# 125 "src/backend/executor/cypher_utils.c"
        properties_isnull;

    if (id == 
# 127 "src/backend/executor/cypher_utils.c" 3 4
             ((void *)0)
# 127 "src/backend/executor/cypher_utils.c"
                 )
    {
        do { if (errstart(20, "src/backend/executor/cypher_utils.c", 129, __func__, 
# 129 "src/backend/executor/cypher_utils.c" 3 4
       ((void *)0)
# 129 "src/backend/executor/cypher_utils.c"
       )) errfinish (errcode((((('0') - '0') & 0x3F) + (((('A') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("edge id field cannot be NULL")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                ;
    }
    if (startid == 
# 132 "src/backend/executor/cypher_utils.c" 3 4
                  ((void *)0)
# 132 "src/backend/executor/cypher_utils.c"
                      )
    {
        do { if (errstart(20, "src/backend/executor/cypher_utils.c", 134, __func__, 
# 134 "src/backend/executor/cypher_utils.c" 3 4
       ((void *)0)
# 134 "src/backend/executor/cypher_utils.c"
       )) errfinish (errcode((((('0') - '0') & 0x3F) + (((('A') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("edge start_id field cannot be NULL")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                      ;
    }

    if (endid == 
# 138 "src/backend/executor/cypher_utils.c" 3 4
                ((void *)0)
# 138 "src/backend/executor/cypher_utils.c"
                    )
    {
        do { if (errstart(20, "src/backend/executor/cypher_utils.c", 140, __func__, 
# 140 "src/backend/executor/cypher_utils.c" 3 4
       ((void *)0)
# 140 "src/backend/executor/cypher_utils.c"
       )) errfinish (errcode((((('0') - '0') & 0x3F) + (((('A') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("edge end_id field cannot be NULL")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                    ;
    }

    properties_isnull = properties == 
# 144 "src/backend/executor/cypher_utils.c" 3 4
                                     ((void *)0)
# 144 "src/backend/executor/cypher_utils.c"
                                         ;

    elemTupleSlot->tts_values[1 - 1] =
        ((Datum) (id->val.int_value));
    elemTupleSlot->tts_isnull[1 - 1] = 
# 148 "src/backend/executor/cypher_utils.c" 3 4
                                              0
# 148 "src/backend/executor/cypher_utils.c"
                                                   ;

    elemTupleSlot->tts_values[2 - 1] =
        ((Datum) (startid->val.int_value));
    elemTupleSlot->tts_isnull[2 - 1] = 
# 152 "src/backend/executor/cypher_utils.c" 3 4
                                                    0
# 152 "src/backend/executor/cypher_utils.c"
                                                         ;

    elemTupleSlot->tts_values[3 - 1] =
        ((Datum) (endid->val.int_value));
    elemTupleSlot->tts_isnull[3 - 1] = 
# 156 "src/backend/executor/cypher_utils.c" 3 4
                                                  0
# 156 "src/backend/executor/cypher_utils.c"
                                                       ;

    elemTupleSlot->tts_values[4 - 1] =
        ((Datum) (agtype_value_to_agtype(properties)));
    elemTupleSlot->tts_isnull[4 - 1] = properties_isnull;
...
# 170 "src/backend/executor/cypher_utils.c" 3 4
_Bool 
# 170 "src/backend/executor/cypher_utils.c"
    entity_exists(EState *estate, Oid graph_oid, graphid id)
{
...
# 177 "src/backend/executor/cypher_utils.c" 3 4
   _Bool 
# 177 "src/backend/executor/cypher_utils.c"
        result = 
# 177 "src/backend/executor/cypher_utils.c" 3 4
                 1
# 177 "src/backend/executor/cypher_utils.c"
    ...
    label = search_label_graph_id_cache(graph_oid, (((uint64)id) >> (32 + 16)));


    ScanKeyInit(&scan_keys[0], 1, 3,
                467, ((Datum) (id)));

    rel = heap_open(label->relation, 3);
    ...
    if (!((const void*)(tuple) != 
# 198 "src/backend/executor/cypher_utils.c" 3 4
        ((void *)0)
# 198 "src/backend/executor/cypher_utils.c"
        ))
    {
        result = 
# 200 "src/backend/executor/cypher_utils.c" 3 4
                0
# 200 "src/backend/executor/cypher_utils.c"
                     ;
    }

    heap_endscan(scan_desc);
    relation_close(rel,3);

    return result;
}
# 217 "src/backend/executor/cypher_utils.c"
HeapTuple insert_entity_tuple(ResultRelInfo *resultRelInfo,
                              TupleTableSlot *elemTupleSlot,
                              EState *estate)
{
    return insert_entity_tuple_cid(resultRelInfo, elemTupleSlot, estate,
                                   GetCurrentCommandId(
# 222 "src/backend/executor/cypher_utils.c" 3 4
                                                      1
# 222 "src/backend/executor/cypher_utils.c"
                                                          ));
}
...
{
    HeapTuple tuple = 
# 235 "src/backend/executor/cypher_utils.c" 3 4
                     ((void *)0)
# 235 "src/backend/executor/cypher_utils.c"
                         ;
...
# 242 "src/backend/executor/cypher_utils.c" 3 4
                                                         ((void *)0)
# 242 "src/backend/executor/cypher_utils.c"
                                                             )
    {
    ...
    heap_insert(resultRelInfo->ri_RelationDesc, tuple, cid, 0, 
# 248 "src/backend/executor/cypher_utils.c" 3 4
                                                              ((void *)0)
# 248 "src/backend/executor/cypher_utils.c"
                                                                  );
...
# 253 "src/backend/executor/cypher_utils.c" 3 4
                                                                      0
# 253 "src/backend/executor/cypher_utils.c"
                                                                           ,
                              
# 254 "src/backend/executor/cypher_utils.c" 3 4
                             ((void *)0)
# 254 "src/backend/executor/cypher_utils.c"
                                 , ((List *) 
# 254 "src/backend/executor/cypher_utils.c" 3 4
                                   ((void *)0)
# 254 "src/backend/executor/cypher_utils.c"
