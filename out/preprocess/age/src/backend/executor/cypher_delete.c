# 0 "src/backend/executor/cypher_delete.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/executor/cypher_delete.c"
# 20 "src/backend/executor/cypher_delete.c"
...
# 21 "src/backend/executor/cypher_delete.c" 2

# 1 "/usr/include/postgresql/11/server/access/sysattr.h" 1
# 23 "src/backend/executor/cypher_delete.c" 2
...
# 24 "src/backend/executor/cypher_delete.c" 2
# 1 "/usr/include/postgresql/11/server/access/multixact.h" 1
# 14 "/usr/include/postgresql/11/server/access/multixact.h"
...
# 252 "/usr/include/postgresql/11/server/access/xlogreader.h"
       ...
       BlockNumber *blknum);
# 15 "/usr/include/postgresql/11/server/access/multixact.h" 2
...
# 16 "/usr/include/postgresql/11/server/access/multixact.h" 2
...
extern char *mxid_to_string(MultiXactId multi, int nmembers,
      MultiXactMember *members);
# 25 "src/backend/executor/cypher_delete.c" 2
# 1 "/usr/include/postgresql/11/server/access/xact.h" 1
# 21 "/usr/include/postgresql/11/server/access/xact.h"
...
# 26 "src/backend/executor/cypher_delete.c" 2
# 1 "/usr/include/postgresql/11/server/storage/bufmgr.h" 1
# 18 "/usr/include/postgresql/11/server/storage/bufmgr.h"
...
# 19 "/usr/include/postgresql/11/server/storage/bufmgr.h" 2
...
# 22 "/usr/include/postgresql/11/server/storage/bufmgr.h" 2
...
# 20 "/usr/include/postgresql/11/server/utils/snapmgr.h" 2
...
# 27 "src/backend/executor/cypher_delete.c" 2
...
# 28 "src/backend/executor/cypher_delete.c" 2
...
# 29 "src/backend/executor/cypher_delete.c" 2
...
# 158 "/usr/include/postgresql/11/server/nodes/extensible.h"
          missing_ok);
# 30 "src/backend/executor/cypher_delete.c" 2
...
# 33 "src/backend/executor/cypher_delete.c" 2
...
# 34 "src/backend/executor/cypher_delete.c" 2
...
# 35 "src/backend/executor/cypher_delete.c" 2
...
# 36 "src/backend/executor/cypher_delete.c" 2
...
# 39 "src/backend/executor/cypher_delete.c" 2
...
Oid create_label(char *graph_name, char *label_name, char label_type,
                 List *parents);
# 40 "src/backend/executor/cypher_delete.c" 2
...
# 41 "src/backend/executor/cypher_delete.c" 2
...
# 42 "src/backend/executor/cypher_delete.c" 2
# 1 ".//src/include/parser/cypher_parse_node.h" 1
# 31 ".//src/include/parser/cypher_parse_node.h"
...
# 43 "src/backend/executor/cypher_delete.c" 2
...
# 57 "src/backend/executor/cypher_delete.c" 3 4
                                _Bool 
# 57 "src/backend/executor/cypher_delete.c"
                                     detach_delete);
...
const CustomExecMethods cypher_delete_exec_methods = {"Cypher Delete",
                                                      begin_cypher_delete,
                                                      exec_cypher_delete,
                                                      end_cypher_delete,
                                                      rescan_cypher_delete,
                                                      
# 69 "src/backend/executor/cypher_delete.c" 3 4
                                                     ((void *)0)
# 69 "src/backend/executor/cypher_delete.c"
                                                         ,
                                                      
# 70 "src/backend/executor/cypher_delete.c" 3 4
                                                     ((void *)0)
# 70 "src/backend/executor/cypher_delete.c"
                                                         ,
                                                      
# 71 "src/backend/executor/cypher_delete.c" 3 4
                                                     ((void *)0)
# 71 "src/backend/executor/cypher_delete.c"
                                                         ,
                                                      
# 72 "src/backend/executor/cypher_delete.c" 3 4
                                                     ((void *)0)
# 72 "src/backend/executor/cypher_delete.c"
                                                         ,
                                                      
# 73 "src/backend/executor/cypher_delete.c" 3 4
                                                     ((void *)0)
# 73 "src/backend/executor/cypher_delete.c"
                                                         ,
                                                      
# 74 "src/backend/executor/cypher_delete.c" 3 4
                                                     ((void *)0)
# 74 "src/backend/executor/cypher_delete.c"
                                                         ,
                                                      
# 75 "src/backend/executor/cypher_delete.c" 3 4
                                                     ((void *)0)
# 75 "src/backend/executor/cypher_delete.c"
                                                         ,
                                                      
# 76 "src/backend/executor/cypher_delete.c" 3 4
                                                     ((void *)0)
# 76 "src/backend/executor/cypher_delete.c"
                                                         };
                                ...
                                int eflags)
{
    ...
    ((void)
# 91 "src/backend/executor/cypher_delete.c" 3 4
   1
# 91 "src/backend/executor/cypher_delete.c"
   );
...
# 125 "src/backend/executor/cypher_delete.c"
...
static TupleTableSlot *exec_cypher_delete(CustomScanState *node)
{
    ...
    if ((css->flags & 0x0001))
    {
        ...
        while(
# 152 "src/backend/executor/cypher_delete.c" 3 4
             1
# 152 "src/backend/executor/cypher_delete.c"
                 )
        {
            ...
            if (((slot) == 
# 159 "src/backend/executor/cypher_delete.c" 3 4
               ((void *)0) 
# 159 "src/backend/executor/cypher_delete.c"
               || (slot)->tts_isempty))
                break;
        ...
        return 
# 169 "src/backend/executor/cypher_delete.c" 3 4
              ((void *)0)
# 169 "src/backend/executor/cypher_delete.c"
                  ;
    }
    else
    {
        ...
        if (((slot) == 
# 178 "src/backend/executor/cypher_delete.c" 3 4
           ((void *)0) 
# 178 "src/backend/executor/cypher_delete.c"
           || (slot)->tts_isempty))
            return 
# 179 "src/backend/executor/cypher_delete.c" 3 4
                  ((void *)0)
# 179 "src/backend/executor/cypher_delete.c"
                      ;
...
# 211 "src/backend/executor/cypher_delete.c"
static void rescan_cypher_delete(CustomScanState *node)
{
     do { if (errstart(20, "src/backend/executor/cypher_delete.c", 213, __func__, 
# 213 "src/backend/executor/cypher_delete.c" 3 4
    ((void *)0)
# 213 "src/backend/executor/cypher_delete.c"
    )) errfinish (errcode((((('0') - '0') & 0x3F) + (((('A') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("cypher DELETE clause cannot be rescaned"), errhint("its unsafe to use joins in a query with a Cypher DELETE clause")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
...
Node *create_cypher_delete_plan_state(CustomScan *cscan)
{
    ...
    ((void)
# 238 "src/backend/executor/cypher_delete.c" 3 4
   1
# 238 "src/backend/executor/cypher_delete.c"
   );
                                    ...
                                    int entity_position)
{
    ...
    if (tupleDescriptor->attrs[entity_position -1].atttypid != get_AGTYPEOID())
        do { if (errstart(20, "src/backend/executor/cypher_delete.c", 265, __func__, 
# 265 "src/backend/executor/cypher_delete.c" 3 4
       ((void *)0)
# 265 "src/backend/executor/cypher_delete.c"
       )) errfinish (errcode((((('0') - '0') & 0x3F) + (((('A') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("DELETE clause can only delete agtype")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                ;

    original_entity = ((agtype *)pg_detoast_datum((struct varlena *) ((Pointer) (scanTupleSlot->tts_values[entity_position - 1]))));
    ...
    if (original_entity_value->type != AGTV_VERTEX && original_entity_value->type != AGTV_EDGE)
        do { if (errstart(20, "src/backend/executor/cypher_delete.c", 272, __func__, 
# 272 "src/backend/executor/cypher_delete.c" 3 4
       ((void *)0)
# 272 "src/backend/executor/cypher_delete.c"
       )) errfinish (errcode((((('0') - '0') & 0x3F) + (((('A') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("DELETE clause can only delete vertices and edges")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                            ;
                          ...
                          HeapTuple tuple)
{
    ...
    lock_result = heap_lock_tuple(resultRelInfo->ri_RelationDesc, tuple,
                                  GetCurrentCommandId(
# 299 "src/backend/executor/cypher_delete.c" 3 4
                                                     0
# 299 "src/backend/executor/cypher_delete.c"
                                                          ), lockmode,
                                  LockWaitBlock, 
# 300 "src/backend/executor/cypher_delete.c" 3 4
                                                0
# 300 "src/backend/executor/cypher_delete.c"
                                                     , &buffer, &hufd);
# 310 "src/backend/executor/cypher_delete.c"
    if (lock_result == HeapTupleMayBeUpdated)
    {
        delete_result = heap_delete(resultRelInfo->ri_RelationDesc,
                                    &tuple->t_self, GetCurrentCommandId(
# 313 "src/backend/executor/cypher_delete.c" 3 4
                                                                       1
# 313 "src/backend/executor/cypher_delete.c"
                                                                           ),
                                    estate->es_crosscheck_snapshot, 
# 314 "src/backend/executor/cypher_delete.c" 3 4
                                                                   1
# 314 "src/backend/executor/cypher_delete.c"
                                                                       , &hufd,
                                    
# 315 "src/backend/executor/cypher_delete.c" 3 4
                                   0
# 315 "src/backend/executor/cypher_delete.c"
                                        );
        ...
        switch (delete_result)
        {
                ...
                case HeapTupleSelfUpdated:
                        do { if (errstart(20, "src/backend/executor/cypher_delete.c", 326, __func__, 
# 326 "src/backend/executor/cypher_delete.c" 3 4
                       ((void *)0)
# 326 "src/backend/executor/cypher_delete.c"
                       )) errfinish (errcode((((('X') - '0') & 0x3F) + (((('X') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("deleting the same entity more than once cannot happen")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)

                                                                                                          ;

                        break;
                case HeapTupleUpdated:
                        do { if (errstart(20, "src/backend/executor/cypher_delete.c", 332, __func__, 
# 332 "src/backend/executor/cypher_delete.c" 3 4
                       ((void *)0)
# 332 "src/backend/executor/cypher_delete.c"
                       )) errfinish (errcode((((('4') - '0') & 0x3F) + (((('0') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('1') - '0') & 0x3F) << 24))), errmsg("could not serialize access due to concurrent update")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)

                                                                                                        ;

                        break;
                default:
                        do { elog_start("src/backend/executor/cypher_delete.c", 338, __func__); elog_finish(20, "Entity failed to be update"); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0);
    ...
    {
        do { if (errstart(20, "src/backend/executor/cypher_delete.c", 348, __func__, 
# 348 "src/backend/executor/cypher_delete.c" 3 4
       ((void *)0)
# 348 "src/backend/executor/cypher_delete.c"
       )) errfinish (errcode((((('X') - '0') & 0x3F) + (((('X') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("Entity could not be locked for updating")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
...
static void process_delete_list(CustomScanState *node)
{
    ...
    for ((lc) = list_head(css->delete_data->delete_items); (lc) != 
# 372 "src/backend/executor/cypher_delete.c" 3 4
   ((void *)0)
# 372 "src/backend/executor/cypher_delete.c"
   ; (lc) = ((lc)->next))
    {
        ...
        id = get_agtype_value_object_value(original_entity_value, "id", sizeof("id") - 1);
        label = get_agtype_value_object_value(original_entity_value, "label", sizeof("label") - 1);
        ...
        {
            do { if (errstart(20, "src/backend/executor/cypher_delete.c", 420, __func__, 
# 420 "src/backend/executor/cypher_delete.c" 3 4
           ((void *)0)
# 420 "src/backend/executor/cypher_delete.c"
           )) errfinish (errcode((((('0') - '0') & 0x3F) + (((('A') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("DELETE clause can only delete vertices and edges")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                                ;
        }
        ...
        if (!((const void*)(heap_tuple) != 
# 438 "src/backend/executor/cypher_delete.c" 3 4
            ((void *)0)
# 438 "src/backend/executor/cypher_delete.c"
            ))
        {
...
# 473 "src/backend/executor/cypher_delete.c" 3 4
                                _Bool 
# 473 "src/backend/executor/cypher_delete.c"
                                     detach_delete)
{
    cypher_delete_custom_scan_state *css =
        (cypher_delete_custom_scan_state *)node;
    ...
    estate->es_output_cid++; estate->es_snapshot->curcid++;;
# 491 "src/backend/executor/cypher_delete.c"
    for ((lc) = list_head(labels); (lc) != 
# 491 "src/backend/executor/cypher_delete.c" 3 4
   ((void *)0)
# 491 "src/backend/executor/cypher_delete.c"
   ; (lc) = ((lc)->next))
    {
        char *label_name = ((lc)->data.ptr_value);
        ResultRelInfo *resultRelInfo;
        HeapScanDesc scan_desc;
        HeapTuple tuple;
        TupleTableSlot *slot;
        ...
        scan_desc = heap_beginscan(resultRelInfo->ri_RelationDesc,
                                   estate->es_snapshot, 0, 
# 503 "src/backend/executor/cypher_delete.c" 3 4
                                                          ((void *)0)
# 503 "src/backend/executor/cypher_delete.c"
                                                              );
        ...
        while(
# 509 "src/backend/executor/cypher_delete.c" 3 4
             1
# 509 "src/backend/executor/cypher_delete.c"
                 )
        {
            graphid startid, endid;
            
# 512 "src/backend/executor/cypher_delete.c" 3 4
           _Bool 
# 512 "src/backend/executor/cypher_delete.c"
                isNull;
            ...
            if (!((const void*)(tuple) != 
# 517 "src/backend/executor/cypher_delete.c" 3 4
                ((void *)0)
# 517 "src/backend/executor/cypher_delete.c"
                ))
                break;

            ExecStoreTuple(tuple, slot, 0, 
# 520 "src/backend/executor/cypher_delete.c" 3 4
                                                      0
# 520 "src/backend/executor/cypher_delete.c"
                                                           );

            startid = ((Datum) (slot_getattr(slot, 2, &isNull)));
            endid = ((Datum) (slot_getattr(slot, 3, &isNull)));
            ...
            if (id == startid || id == endid)
            {
                ...
                if (detach_delete)
                    ...
                    do { if (errstart(20, "src/backend/executor/cypher_delete.c", 535, __func__, 
# 535 "src/backend/executor/cypher_delete.c" 3 4
                   ((void *)0)
# 535 "src/backend/executor/cypher_delete.c"
                   )) errfinish (errcode((((('X') - '0') & 0x3F) + (((('X') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("Cannot delete vertex %s, because it still has edges attached. " "To delete this vertex, you must first delete the attached edges.", var_name)); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
