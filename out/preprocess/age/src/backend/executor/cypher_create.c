# 0 "src/backend/executor/cypher_create.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/executor/cypher_create.c"
# 20 "src/backend/executor/cypher_create.c"
...
# 21 "src/backend/executor/cypher_create.c" 2
...
# 23 "src/backend/executor/cypher_create.c" 2
...
# 24 "src/backend/executor/cypher_create.c" 2
...
# 25 "src/backend/executor/cypher_create.c" 2
...
# 26 "src/backend/executor/cypher_create.c" 2
...
# 158 "/usr/include/postgresql/11/server/nodes/extensible.h"
          missing_ok);
# 27 "src/backend/executor/cypher_create.c" 2
...
# 30 "src/backend/executor/cypher_create.c" 2
...
# 31 "src/backend/executor/cypher_create.c" 2
...
# 32 "src/backend/executor/cypher_create.c" 2
...
# 33 "src/backend/executor/cypher_create.c" 2
...
# 35 "src/backend/executor/cypher_create.c" 2
...
# 36 "src/backend/executor/cypher_create.c" 2
...
# 37 "src/backend/executor/cypher_create.c" 2
...
# 40 "src/backend/executor/cypher_create.c" 2
...
# 63 "src/backend/executor/cypher_create.c" 3 4
                                                     ((void *)0)
# 63 "src/backend/executor/cypher_create.c"
                                                         ,
                                                      
# 64 "src/backend/executor/cypher_create.c" 3 4
                                                     ((void *)0)
# 64 "src/backend/executor/cypher_create.c"
                                                         ,
                                                      
# 65 "src/backend/executor/cypher_create.c" 3 4
                                                     ((void *)0)
# 65 "src/backend/executor/cypher_create.c"
                                                         ,
                                                      
# 66 "src/backend/executor/cypher_create.c" 3 4
                                                     ((void *)0)
# 66 "src/backend/executor/cypher_create.c"
                                                         ,
                                                      
# 67 "src/backend/executor/cypher_create.c" 3 4
                                                     ((void *)0)
# 67 "src/backend/executor/cypher_create.c"
                                                         ,
                                                      
# 68 "src/backend/executor/cypher_create.c" 3 4
                                                     ((void *)0)
# 68 "src/backend/executor/cypher_create.c"
                                                         ,
                                                      
# 69 "src/backend/executor/cypher_create.c" 3 4
                                                     ((void *)0)
# 69 "src/backend/executor/cypher_create.c"
                                                         ,
                                                      
# 70 "src/backend/executor/cypher_create.c" 3 4
                                                     ((void *)0)
# 70 "src/backend/executor/cypher_create.c"
                                                         };
                                ...
                                int eflags)
{
    ...
    ((void)
# 80 "src/backend/executor/cypher_create.c" 3 4
   1
# 80 "src/backend/executor/cypher_create.c"
   );
    ...
    for ((lc) = list_head(css->pattern); (lc) != 
# 97 "src/backend/executor/cypher_create.c" 3 4
   ((void *)0)
# 97 "src/backend/executor/cypher_create.c"
   ; (lc) = ((lc)->next))
    {
        cypher_create_path *path = ((lc)->data.ptr_value);
        ListCell *lc2;
        for ((lc2) = list_head(path->target_nodes); (lc2) != 
# 101 "src/backend/executor/cypher_create.c" 3 4
       ((void *)0)
# 101 "src/backend/executor/cypher_create.c"
       ; (lc2) = ((lc2)->next))
        {
            cypher_target_node *cypher_node =
                (cypher_target_node *)((lc2)->data.ptr_value);
            Relation rel;
...
# 114 "src/backend/executor/cypher_create.c" 3 4
                                        1
# 114 "src/backend/executor/cypher_create.c"
...
# 116 "src/backend/executor/cypher_create.c" 3 4
                                                                  ((void *)0)
# 116 "src/backend/executor/cypher_create.c"
                                                                      ,
                              estate->es_instrument);


            ExecOpenIndices(cypher_node->resultRelInfo, 
# 120 "src/backend/executor/cypher_create.c" 3 4
                                                       0
# 120 "src/backend/executor/cypher_create.c"
                                                            );
...
# 127 "src/backend/executor/cypher_create.c" 3 4
                                       ((void *)0)
# 127 "src/backend/executor/cypher_create.c"
                                           )
            {
...
# 142 "src/backend/executor/cypher_create.c"
...
static void process_pattern(cypher_create_custom_scan_state *css)
{
    ...
    for ((lc2) = list_head(css->pattern); (lc2) != 
# 155 "src/backend/executor/cypher_create.c" 3 4
   ((void *)0)
# 155 "src/backend/executor/cypher_create.c"
   ; (lc2) = ((lc2)->next))
    {
        cypher_create_path *path = ((lc2)->data.ptr_value);
        ...
        create_vertex(css, ((lc)->data.ptr_value), ((lc)->next));
...
# 184 "src/backend/executor/cypher_create.c" 3 4
                                                            0
# 184 "src/backend/executor/cypher_create.c"
                                                                 ;
        }

        css->path_values = ((List *) 
# 187 "src/backend/executor/cypher_create.c" 3 4
                          ((void *)0)
# 187 "src/backend/executor/cypher_create.c"
                          );
    }
}
...
# 198 "src/backend/executor/cypher_create.c" 3 4
   _Bool 
# 198 "src/backend/executor/cypher_create.c"
        terminal = (css->flags & 0x0001);
    
# 199 "src/backend/executor/cypher_create.c" 3 4
   _Bool 
# 199 "src/backend/executor/cypher_create.c"
        used = 
# 199 "src/backend/executor/cypher_create.c" 3 4
               0
# 199 "src/backend/executor/cypher_create.c"
    ...
    do
    {
        ...
        if (((slot) == 
# 214 "src/backend/executor/cypher_create.c" 3 4
           ((void *)0) 
# 214 "src/backend/executor/cypher_create.c"
           || (slot)->tts_isempty))
        {
            break;
        }
        ...
        if (list_length(css->pattern) > 0)
        {
            ...
            used = 
# 230 "src/backend/executor/cypher_create.c" 3 4
                  1
# 230 "src/backend/executor/cypher_create.c"
                      ;
        }
    } while (terminal);
    ...
    {
        return 
# 239 "src/backend/executor/cypher_create.c" 3 4
              ((void *)0)
# 239 "src/backend/executor/cypher_create.c"
                  ;
    }
    ...
    {
        return 
# 246 "src/backend/executor/cypher_create.c" 3 4
              ((void *)0)
# 246 "src/backend/executor/cypher_create.c"
                  ;
    }
...
static void end_cypher_create(CustomScanState *node)
{
    ...
    for ((lc) = list_head(css->pattern); (lc) != 
# 261 "src/backend/executor/cypher_create.c" 3 4
   ((void *)0)
# 261 "src/backend/executor/cypher_create.c"
   ; (lc) = ((lc)->next))
    {
        cypher_create_path *path = ((lc)->data.ptr_value);
        ListCell *lc2;
        for ((lc2) = list_head(path->target_nodes); (lc2) != 
# 265 "src/backend/executor/cypher_create.c" 3 4
       ((void *)0)
# 265 "src/backend/executor/cypher_create.c"
       ; (lc2) = ((lc2)->next))
        {
            cypher_target_node *cypher_node =
                (cypher_target_node *)((lc2)->data.ptr_value);
...
static void rescan_cypher_create(CustomScanState *node)
{
    do { if (errstart(20, "src/backend/executor/cypher_create.c", 285, __func__, 
# 285 "src/backend/executor/cypher_create.c" 3 4
   ((void *)0)
# 285 "src/backend/executor/cypher_create.c"
   )) errfinish (errcode((((('0') - '0') & 0x3F) + (((('A') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("cypher create clause cannot be rescaned"), errhint("its unsafe to use joins in a query with a Cypher CREATE clause")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
...
Node *create_cypher_create_plan_state(CustomScan *cscan)
{
    ...
    ((void)
# 305 "src/backend/executor/cypher_create.c" 3 4
   1
# 305 "src/backend/executor/cypher_create.c"
   );

    cypher_css->path_values = ((List *) 
# 307 "src/backend/executor/cypher_create.c" 3 4
                             ((void *)0)
# 307 "src/backend/executor/cypher_create.c"
                             );
...
# 325 "src/backend/executor/cypher_create.c" 3 4
   _Bool 
# 325 "src/backend/executor/cypher_create.c"
        isNull;
    EState *estate = css->css.ss.ps.state;
    ExprContext *econtext = css->css.ss.ps.ps_ExprContext;
    ResultRelInfo *resultRelInfo = node->resultRelInfo;
    ResultRelInfo *old_estate_es_result_relation_info = 
# 329 "src/backend/executor/cypher_create.c" 3 4
                                                       ((void *)0)
# 329 "src/backend/executor/cypher_create.c"
                                                           ;
    ...
    ((void)
# 336 "src/backend/executor/cypher_create.c" 3 4
   1
# 336 "src/backend/executor/cypher_create.c"
   );
    ((void)
# 337 "src/backend/executor/cypher_create.c" 3 4
   1
# 337 "src/backend/executor/cypher_create.c"
   );
    ...
    css->path_values = ((List *) 
# 343 "src/backend/executor/cypher_create.c" 3 4
                      ((void *)0)
# 343 "src/backend/executor/cypher_create.c"
                      );
    next_vertex_id = create_vertex(css, ((next)->data.ptr_value), ((next)->next));
    ...
    {
        do { if (errstart(20, "src/backend/executor/cypher_create.c", 363, __func__, 
# 363 "src/backend/executor/cypher_create.c" 3 4
       ((void *)0)
# 363 "src/backend/executor/cypher_create.c"
       )) errfinish (errcode((((('0') - '0') & 0x3F) + (((('A') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("edge direction must be specified in a CREATE clause")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)

                                                                                ;
    }
# 376 "src/backend/executor/cypher_create.c"
...
# 389 "src/backend/executor/cypher_create.c" 3 4
                                                    0
# 389 "src/backend/executor/cypher_create.c"
                                                         ;


    elemTupleSlot->tts_values[3 - 1] = end_id;
    elemTupleSlot->tts_isnull[3 - 1] = 
# 393 "src/backend/executor/cypher_create.c" 3 4
                                                  0
# 393 "src/backend/executor/cypher_create.c"
                                                       ;


    elemTupleSlot->tts_values[4 - 1] =
        scanTupleSlot->tts_values[node->prop_attr_num];
    elemTupleSlot->tts_isnull[4 - 1] =
    ...
    if ((node->flags & (0x0004 | 0x0008)))
    {
        ...
        result = make_edge(
            id, start_id, end_id, ((Datum) (node->label_name)),
            ((Datum) (scanTupleSlot->tts_values[node->prop_attr_num])));
...
# 431 "src/backend/executor/cypher_create.c" 3 4
                                                             0
# 431 "src/backend/executor/cypher_create.c"
                                                                  ;
        }
    }
}
...
# 443 "src/backend/executor/cypher_create.c" 3 4
   _Bool 
# 443 "src/backend/executor/cypher_create.c"
        isNull;
    Datum id;
    EState *estate = css->css.ss.ps.state;
    ExprContext *econtext = css->css.ss.ps.ps_ExprContext;
    ...
    ((void)
# 451 "src/backend/executor/cypher_create.c" 3 4
   1
# 451 "src/backend/executor/cypher_create.c"
   );
    ...
    {
        ResultRelInfo *old_estate_es_result_relation_info = 
# 460 "src/backend/executor/cypher_create.c" 3 4
                                                           ((void *)0)
# 460 "src/backend/executor/cypher_create.c"
                                                               ;
# 470 "src/backend/executor/cypher_create.c"
        old_estate_es_result_relation_info = estate->es_result_relation_info;
        ...
        if ((node->flags & (0x0004 | 0x0008)))
        {
            ...
            if ((node->flags & 0x0004))
            {
                scantuple->tts_values[node->tuple_position - 1] = result;
                scantuple->tts_isnull[node->tuple_position - 1] = 
# 527 "src/backend/executor/cypher_create.c" 3 4
                                                                 0
# 527 "src/backend/executor/cypher_create.c"
                                                                      ;
            }
        }
    }
    else
    {
        ...
        a = ((agtype *)pg_detoast_datum((struct varlena *) ((Pointer) (scantuple->tts_values[node->tuple_position - 1]))));


        v = get_ith_agtype_value_from_container(&a->root, 0);

        if (v->type != AGTV_VERTEX)
            do { if (errstart(20, "src/backend/executor/cypher_create.c", 549, __func__, 
# 549 "src/backend/executor/cypher_create.c" 3 4
           ((void *)0)
# 549 "src/backend/executor/cypher_create.c"
...
# 570 "src/backend/executor/cypher_create.c"
        if (!(node->flags & 0x0002))
        {
            if (!entity_exists(estate, css->graph_oid, ((int64) (id))))
                do { if (errstart(20, "src/backend/executor/cypher_create.c", 573, __func__, 
# 573 "src/backend/executor/cypher_create.c" 3 4
               ((void *)0)
# 573 "src/backend/executor/cypher_create.c"
    ...
    if (next != 
# 588 "src/backend/executor/cypher_create.c" 3 4
               ((void *)0)
# 588 "src/backend/executor/cypher_create.c"
                   )
    {
        create_edge(css, ((next)->data.ptr_value), id, ((next)->next));
    }
