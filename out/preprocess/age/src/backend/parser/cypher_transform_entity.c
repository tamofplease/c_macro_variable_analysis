# 0 "src/backend/parser/cypher_transform_entity.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/parser/cypher_transform_entity.c"
# 20 "src/backend/parser/cypher_transform_entity.c"
...
# 21 "src/backend/parser/cypher_transform_entity.c" 2

# 1 ".//src/include/parser/cypher_transform_entity.h" 1
# 23 ".//src/include/parser/cypher_transform_entity.h"
...
# 24 ".//src/include/parser/cypher_transform_entity.h" 2
# 1 "/usr/include/postgresql/11/server/parser/parse_node.h" 1
# 17 "/usr/include/postgresql/11/server/parser/parse_node.h"
...
# 18 "/usr/include/postgresql/11/server/parser/parse_node.h" 2
...
# 25 ".//src/include/parser/cypher_transform_entity.h" 2
...
# 27 ".//src/include/parser/cypher_transform_entity.h" 2
...
# 28 ".//src/include/parser/cypher_transform_entity.h" 2
...
# 49 ".//src/include/parser/cypher_transform_entity.h"
typedef struct
{

    enum transform_entity_type type;
# 62 ".//src/include/parser/cypher_transform_entity.h"
    
# 62 ".//src/include/parser/cypher_transform_entity.h" 3 4
   _Bool 
# 62 ".//src/include/parser/cypher_transform_entity.h"
        in_join_tree;
# 73 ".//src/include/parser/cypher_transform_entity.h"
    Expr *expr;
...
# 79 ".//src/include/parser/cypher_transform_entity.h" 3 4
   _Bool 
# 79 ".//src/include/parser/cypher_transform_entity.h"
        declared_in_current_clause;
...
# 23 "src/backend/parser/cypher_transform_entity.c" 2
                                        ...
                                        Node *node, Expr *expr)
{
    ...
    {
        do { if (errstart(20, "src/backend/parser/cypher_transform_entity.c", 44, __func__, 
# 44 "src/backend/parser/cypher_transform_entity.c" 3 4
       ((void *)0)
# 44 "src/backend/parser/cypher_transform_entity.c"
       )) errfinish (errcode((((('0') - '0') & 0x3F) + (((('A') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("unknown entity type")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                       ;
    }

    entity->declared_in_current_clause = 
# 48 "src/backend/parser/cypher_transform_entity.c" 3 4
                                        1
# 48 "src/backend/parser/cypher_transform_entity.c"
                                            ;
    entity->expr = expr;
    entity->in_join_tree = expr != 
# 50 "src/backend/parser/cypher_transform_entity.c" 3 4
                                  ((void *)0)
# 50 "src/backend/parser/cypher_transform_entity.c"
                                      ;
                                        ...
                                        enum transform_entity_type type)
{
    ...
    if (name == 
# 65 "src/backend/parser/cypher_transform_entity.c" 3 4
               ((void *)0)
# 65 "src/backend/parser/cypher_transform_entity.c"
                   )
    {
        return 
# 67 "src/backend/parser/cypher_transform_entity.c" 3 4
              ((void *)0)
# 67 "src/backend/parser/cypher_transform_entity.c"
                  ;
    }

    for ((lc) = list_head(cpstate->entities); (lc) != 
# 70 "src/backend/parser/cypher_transform_entity.c" 3 4
   ((void *)0)
# 70 "src/backend/parser/cypher_transform_entity.c"
   ; (lc) = ((lc)->next))
    {
        transform_entity *entity = ((lc)->data.ptr_value);
        ...
        if (type == ENT_VERTEX)
        {
            if (entity->entity.node->name != 
# 81 "src/backend/parser/cypher_transform_entity.c" 3 4
                                            ((void *)0) 
# 81 "src/backend/parser/cypher_transform_entity.c"
                                                 && !strcmp(entity->entity.node->name, name))
            {
                return entity;
            }
        }
        ...
        {
            if (entity->entity.rel->name != 
# 88 "src/backend/parser/cypher_transform_entity.c" 3 4
                                           ((void *)0) 
# 88 "src/backend/parser/cypher_transform_entity.c"
    ...
    return 
# 95 "src/backend/parser/cypher_transform_entity.c" 3 4
          ((void *)0)
# 95 "src/backend/parser/cypher_transform_entity.c"
              ;
}
...
transform_entity *find_variable(cypher_parsestate *cpstate, char *name)
{
    ...
    for ((lc) = list_head(cpstate->entities); (lc) != 
# 106 "src/backend/parser/cypher_transform_entity.c" 3 4
   ((void *)0)
# 106 "src/backend/parser/cypher_transform_entity.c"
   ; (lc) = ((lc)->next))
    {
        transform_entity *entity = ((lc)->data.ptr_value);
        char *entity_name;
        ...
        {
            do { if (errstart(20, "src/backend/parser/cypher_transform_entity.c", 121, __func__, 
# 121 "src/backend/parser/cypher_transform_entity.c" 3 4
           ((void *)0)
# 121 "src/backend/parser/cypher_transform_entity.c"
           )) errfinish (errcode((((('0') - '0') & 0x3F) + (((('A') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("unknown entity type")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                           ;
        }

        if (entity_name != 
# 125 "src/backend/parser/cypher_transform_entity.c" 3 4
                          ((void *)0) 
# 125 "src/backend/parser/cypher_transform_entity.c"
                               && !strcmp(name, entity_name))
        {
            return entity;
        }
    }
    ...
    return 
# 131 "src/backend/parser/cypher_transform_entity.c" 3 4
          ((void *)0)
# 131 "src/backend/parser/cypher_transform_entity.c"
              ;
}
...
char *get_entity_name(transform_entity *entity)
{
    ...
    {
        do { if (errstart(20, "src/backend/parser/cypher_transform_entity.c", 147, __func__, 
# 147 "src/backend/parser/cypher_transform_entity.c" 3 4
       ((void *)0)
# 147 "src/backend/parser/cypher_transform_entity.c"
       )) errfinish (errcode((((('0') - '0') & 0x3F) + (((('A') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("cannot get entity name from transform_entity type %i", entity->type)); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
    ...
    return 
# 153 "src/backend/parser/cypher_transform_entity.c" 3 4
          ((void *)0)
# 153 "src/backend/parser/cypher_transform_entity.c"
              ;
}
