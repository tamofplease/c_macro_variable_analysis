# 0 "src/backend/parser/cypher_parse_node.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/parser/cypher_parse_node.c"
# 25 "src/backend/parser/cypher_parse_node.c"
...
# 26 "src/backend/parser/cypher_parse_node.c" 2
...
# 28 "src/backend/parser/cypher_parse_node.c" 2
...
# 29 "src/backend/parser/cypher_parse_node.c" 2
...
# 30 "src/backend/parser/cypher_parse_node.c" 2
...
# 32 "src/backend/parser/cypher_parse_node.c" 2
...
# 49 "src/backend/parser/cypher_parse_node.c" 3 4
                                1
# 49 "src/backend/parser/cypher_parse_node.c"
                                    ;
...
static void errpos_ecb(void *arg)
{
    ...
    if (geterrcode() == (((('5') - '0') & 0x3F) + (((('7') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('1') - '0') & 0x3F) << 18) + (((('4') - '0') & 0x3F) << 24)))
        return;

    ((void)
# 103 "src/backend/parser/cypher_parse_node.c" 3 4
   1
# 103 "src/backend/parser/cypher_parse_node.c"
   );
...
RangeTblEntry *find_rte(cypher_parsestate *cpstate, char *varname)
{
    ...
    for ((lc) = list_head(pstate->p_rtable); (lc) != 
# 114 "src/backend/parser/cypher_parse_node.c" 3 4
   ((void *)0)
# 114 "src/backend/parser/cypher_parse_node.c"
   ; (lc) = ((lc)->next))
    {
        RangeTblEntry *rte = (RangeTblEntry *)((lc)->data.ptr_value);
    ...
    return 
# 125 "src/backend/parser/cypher_parse_node.c" 3 4
          ((void *)0)
# 125 "src/backend/parser/cypher_parse_node.c"
              ;
}
...
char *get_next_default_alias(cypher_parsestate *cpstate)
{
    ...
    nlen = snprintf(
# 138 "src/backend/parser/cypher_parse_node.c" 3 4
                   ((void *)0)
# 138 "src/backend/parser/cypher_parse_node.c"
                       , 0, "%s%d", "_age_default_alias_",
    ...
    snprintf(alias_name, nlen + 1, "%s%d", "_age_default_alias_",
             cpstate->default_alias_num);
