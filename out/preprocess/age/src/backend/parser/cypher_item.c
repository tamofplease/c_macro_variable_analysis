# 0 "src/backend/parser/cypher_item.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/parser/cypher_item.c"
# 25 "src/backend/parser/cypher_item.c"
...
# 22 "/usr/include/postgresql/11/server/nodes/primnodes.h"
...
# 29 "src/backend/parser/cypher_item.c" 2
...
# 34 "src/backend/parser/cypher_item.c" 2
...
# 35 "src/backend/parser/cypher_item.c" 2
...
# 36 "src/backend/parser/cypher_item.c" 2

# 1 ".//src/include/parser/cypher_expr.h" 1
# 31 ".//src/include/parser/cypher_expr.h"
...
TargetEntry *transform_cypher_item(cypher_parsestate *cpstate, Node *node,
                                   Node *expr, ParseExprKind expr_kind,
                                   char *colname, 
# 48 "src/backend/parser/cypher_item.c" 3 4
                                                 _Bool 
# 48 "src/backend/parser/cypher_item.c"
                                                      resjunk)
{
...
# 66 "src/backend/parser/cypher_item.c" 3 4
                       ((void *)0)
# 66 "src/backend/parser/cypher_item.c"
                       );
    ListCell *li;
    List *group_clause = ((List *) 
# 68 "src/backend/parser/cypher_item.c" 3 4
                        ((void *)0)
# 68 "src/backend/parser/cypher_item.c"
                        );
    
# 69 "src/backend/parser/cypher_item.c" 3 4
   _Bool 
# 69 "src/backend/parser/cypher_item.c"
        hasAgg = 
# 69 "src/backend/parser/cypher_item.c" 3 4
                 0
# 69 "src/backend/parser/cypher_item.c"
...
# 70 "src/backend/parser/cypher_item.c" 3 4
   _Bool 
# 70 "src/backend/parser/cypher_item.c"
        expand_star;

    expand_star = (expr_kind != EXPR_KIND_UPDATE_SOURCE);

    for ((li) = list_head(item_list); (li) != 
# 74 "src/backend/parser/cypher_item.c" 3 4
   ((void *)0)
# 74 "src/backend/parser/cypher_item.c"
   ; (li) = ((li)->next))
    {
        ...
        if (expand_star)
        {
            if (((((const Node*)(item->val))->type) == T_ColumnRef))
            {
                ColumnRef *cref = (ColumnRef *) item->val;

                if (((((const Node*)(((list_tail(cref->fields))->data.ptr_value)))->type) == T_A_Star))
                {
                    ...
                    {
                        do { if (errstart(20, "src/backend/parser/cypher_item.c", 92, __func__, 
# 92 "src/backend/parser/cypher_item.c" 3 4
                       ((void *)0)
# 92 "src/backend/parser/cypher_item.c"
                       )) errfinish (errcode((((('4') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('6') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('1') - '0') & 0x3F) << 24))), errmsg("Invalid number of fields for *"), parser_errposition(pstate, cref->location)); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
        ...
        cpstate->exprHasAgg = 
# 106 "src/backend/parser/cypher_item.c" 3 4
                             0
# 106 "src/backend/parser/cypher_item.c"
                                  ;


        te = transform_cypher_item(cpstate, item->val, 
# 109 "src/backend/parser/cypher_item.c" 3 4
                                                      ((void *)0)
# 109 "src/backend/parser/cypher_item.c"
                                                          , expr_kind,
                                   item->name, 
# 110 "src/backend/parser/cypher_item.c" 3 4
                                              0
# 110 "src/backend/parser/cypher_item.c"
                                                   );
        ...
        {
            hasAgg = 
# 125 "src/backend/parser/cypher_item.c" 3 4
                    1
# 125 "src/backend/parser/cypher_item.c"
                        ;
        }
    }
...
{
    List *target = ((List *) 
# 148 "src/backend/parser/cypher_item.c" 3 4
                  ((void *)0)
# 148 "src/backend/parser/cypher_item.c"
                  );
    
# 149 "src/backend/parser/cypher_item.c" 3 4
   _Bool 
# 149 "src/backend/parser/cypher_item.c"
        found_table = 
# 149 "src/backend/parser/cypher_item.c" 3 4
                      0
# 149 "src/backend/parser/cypher_item.c"
    ...
    for ((l) = list_head(pstate->p_namespace); (l) != 
# 152 "src/backend/parser/cypher_item.c" 3 4
   ((void *)0)
# 152 "src/backend/parser/cypher_item.c"
   ; (l) = ((l)->next))
    {
        ParseNamespaceItem *nsitem = (ParseNamespaceItem *) ((l)->data.ptr_value);
        ...
        ((void)
# 161 "src/backend/parser/cypher_item.c" 3 4
       1
# 161 "src/backend/parser/cypher_item.c"
       );

        found_table = 
# 163 "src/backend/parser/cypher_item.c" 3 4
                     1
# 163 "src/backend/parser/cypher_item.c"
                         ;
...
# 168 "src/backend/parser/cypher_item.c" 3 4
                                                                       ((void *)0)
# 168 "src/backend/parser/cypher_item.c"
                                                                           ),
                                                      0, location));
    }
    ...
    if (!found_table)
        do { if (errstart(20, "src/backend/parser/cypher_item.c", 174, __func__, 
# 174 "src/backend/parser/cypher_item.c" 3 4
       ((void *)0)
# 174 "src/backend/parser/cypher_item.c"
       )) errfinish (errcode((((('4') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('6') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('1') - '0') & 0x3F) << 24))), errmsg("RETURN * without a pattern is not valid"), parser_errposition(pstate, location)); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                              ...
                              int rtindex, int sublevels_up, int location)
{
    ...
    ListCell *name, *var;
    List *te_list = ((List *) 
# 190 "src/backend/parser/cypher_item.c" 3 4
                   ((void *)0)
# 190 "src/backend/parser/cypher_item.c"
                   );
    int var_prefix_len = strlen("_age_varname_");
    int alias_prefix_len = strlen("_age_default_alias_");

    expandRTE(rte, rtindex, sublevels_up, location, 
# 194 "src/backend/parser/cypher_item.c" 3 4
                                                   0
# 194 "src/backend/parser/cypher_item.c"
                                                        , &names, &vars);
    ...
    rte->requiredPerms |= (1<<1);


    for ((name) = list_head(names), (var) = list_head(vars); (name) != 
# 204 "src/backend/parser/cypher_item.c" 3 4
   ((void *)0) 
# 204 "src/backend/parser/cypher_item.c"
   && (var) != 
# 204 "src/backend/parser/cypher_item.c" 3 4
   ((void *)0)
# 204 "src/backend/parser/cypher_item.c"
   ; (name) = ((name)->next), (var) = ((var)->next))
    {
        char *label = (((Value *)(((name)->data.ptr_value)))->val.str);
        Var *varnode = (Var *)((var)->data.ptr_value);
        TargetEntry *te;


        if (strncmp("_age_varname_", label, var_prefix_len) == 0)
            continue;


        if (strncmp("_age_default_alias_", label, alias_prefix_len) == 0)
            continue;


        te = makeTargetEntry((Expr *)varnode,
                             (AttrNumber)pstate->p_next_resno++, label, 
# 220 "src/backend/parser/cypher_item.c" 3 4
                                                                       0
# 220 "src/backend/parser/cypher_item.c"
                                                                            );
    ...
    ((void)
# 227 "src/backend/parser/cypher_item.c" 3 4
   1
# 227 "src/backend/parser/cypher_item.c"
   );
