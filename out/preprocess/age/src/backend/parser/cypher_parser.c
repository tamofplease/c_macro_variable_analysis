# 0 "src/backend/parser/cypher_parser.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/parser/cypher_parser.c"
# 20 "src/backend/parser/cypher_parser.c"
...
# 21 "src/backend/parser/cypher_parser.c" 2
...
extern const ScanKeyword *ScanKeywordLookup(const char *text,
      ...
      int num_keywords);
# 23 "src/backend/parser/cypher_parser.c" 2
...
# 24 "src/backend/parser/cypher_parser.c" 2
# 1 "/usr/include/postgresql/11/server/parser/scansup.h" 1
# 18 "/usr/include/postgresql/11/server/parser/scansup.h"
extern char *scanstr(const char *s);

extern char *downcase_truncate_identifier(const char *ident, int len,
        
# 21 "/usr/include/postgresql/11/server/parser/scansup.h" 3 4
       _Bool 
# 21 "/usr/include/postgresql/11/server/parser/scansup.h"
            warn);

extern char *downcase_identifier(const char *ident, int len,
     
# 24 "/usr/include/postgresql/11/server/parser/scansup.h" 3 4
    _Bool 
# 24 "/usr/include/postgresql/11/server/parser/scansup.h"
         warn, 
# 24 "/usr/include/postgresql/11/server/parser/scansup.h" 3 4
               _Bool 
# 24 "/usr/include/postgresql/11/server/parser/scansup.h"
...
extern void truncate_identifier(char *ident, int len, 
# 26 "/usr/include/postgresql/11/server/parser/scansup.h" 3 4
                                                     _Bool 
# 26 "/usr/include/postgresql/11/server/parser/scansup.h"
                                                          warn);

extern 
# 28 "/usr/include/postgresql/11/server/parser/scansup.h" 3 4
      _Bool 
# 28 "/usr/include/postgresql/11/server/parser/scansup.h"
           scanner_isspace(char ch);
# 25 "src/backend/parser/cypher_parser.c" 2
...
# 27 "src/backend/parser/cypher_parser.c" 2
...
# 28 "src/backend/parser/cypher_parser.c" 2
# 1 ".//src/include/parser/cypher_keywords.h" 1
# 25 ".//src/include/parser/cypher_keywords.h"
extern const ScanKeyword cypher_keywords[];
extern const int num_cypher_keywords;
# 29 "src/backend/parser/cypher_parser.c" 2
# 1 ".//src/include/parser/cypher_parser.h" 1
# 25 ".//src/include/parser/cypher_parser.h"
List *parse_cypher(const char *s);
# 30 "src/backend/parser/cypher_parser.c" 2
...
int cypher_yylex(YYSTYPE *lvalp, int *llocp, ag_scanner_t scanner)
{
    ...
    case AG_TOKEN_IDENTIFIER:
    {
        ...
        truncate_identifier(ident, strlen(ident), 
# 87 "src/backend/parser/cypher_parser.c" 3 4
                                                 1
# 87 "src/backend/parser/cypher_parser.c"
                                                     );
        lvalp->string = ident;
        break;
    }
    ...
    default:
        do { if (errstart(20, "src/backend/parser/cypher_parser.c", 107, __func__, 
# 107 "src/backend/parser/cypher_parser.c" 3 4
       ((void *)0)
# 107 "src/backend/parser/cypher_parser.c"
       )) errfinish (errmsg("unexpected ag_token_type: %d", token.type)); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0);
        break;
    }
...
void cypher_yyerror(int *llocp, ag_scanner_t scanner,
                    cypher_yy_extra *extra, const char *msg)
{
    do { if (errstart(20, "src/backend/parser/cypher_parser.c", 118, __func__, 
# 118 "src/backend/parser/cypher_parser.c" 3 4
   ((void *)0)
# 118 "src/backend/parser/cypher_parser.c"
   )) errfinish (errcode((((('4') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('6') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('1') - '0') & 0x3F) << 24))), ag_scanner_errmsg(msg, scanner), ag_scanner_errposition(*llocp, scanner)); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
...
List *parse_cypher(const char *s)
{
    ...
    extra.result = ((List *) 
# 133 "src/backend/parser/cypher_parser.c" 3 4
                  ((void *)0)
# 133 "src/backend/parser/cypher_parser.c"
                  );
    extra.extra = 
# 134 "src/backend/parser/cypher_parser.c" 3 4
                 ((void *)0)
# 134 "src/backend/parser/cypher_parser.c"
                     ;
    ...
    if (yyresult)
        return ((List *) 
# 145 "src/backend/parser/cypher_parser.c" 3 4
              ((void *)0)
# 145 "src/backend/parser/cypher_parser.c"
              );
