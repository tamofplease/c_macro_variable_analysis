# 0 "src/backend/parser/cypher_keywords.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/parser/cypher_keywords.c"
# 25 "src/backend/parser/cypher_keywords.c"
...
# 29 "src/backend/parser/cypher_keywords.c" 2
...
# 30 "src/backend/parser/cypher_keywords.c" 2
...
# 340 "/usr/include/postgresql/11/server/catalog/pg_type.h"
      ...
      Oid typeNamespace);
# 31 "src/backend/parser/cypher_keywords.c" 2
# 1 "/usr/include/postgresql/11/server/common/keywords.h" 1
# 24 "/usr/include/postgresql/11/server/common/keywords.h"
...
extern const ScanKeyword *ScanKeywordLookup(const char *text,
      ...
      int num_keywords);
# 32 "src/backend/parser/cypher_keywords.c" 2
...
# 358 "/usr/include/postgresql/11/server/funcapi.h"
                        **nulls);
# 34 "src/backend/parser/cypher_keywords.c" 2

# 1 ".//src/include/parser/cypher_gram.h" 1
# 33 ".//src/include/parser/cypher_gram.h"
...
# 34 ".//src/include/parser/cypher_gram.h" 2
...
# 36 "src/backend/parser/cypher_keywords.c" 2
...
const int num_cypher_keywords = (sizeof (cypher_keywords) / sizeof ((cypher_keywords)[0]));

extern Datum get_cypher_keywords(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_get_cypher_keywords(void); const Pg_finfo_record * pg_finfo_get_cypher_keywords (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;


Datum get_cypher_keywords(FunctionCallInfo fcinfo)
{
    FuncCallContext *func_ctx;

    if ((fcinfo->flinfo->fn_extra == 
# 101 "src/backend/parser/cypher_keywords.c" 3 4
       ((void *)0)
# 101 "src/backend/parser/cypher_keywords.c"
       ))
    {
        MemoryContext old_mem_ctx;
        TupleDesc tup_desc;

        func_ctx = init_MultiFuncCall(fcinfo);
        old_mem_ctx = MemoryContextSwitchTo(func_ctx->multi_call_memory_ctx);

        tup_desc = CreateTemplateTupleDesc(3, 
# 109 "src/backend/parser/cypher_keywords.c" 3 4
                                             0
# 109 "src/backend/parser/cypher_keywords.c"
                                                  );
        TupleDescInitEntry(tup_desc, (AttrNumber)1, "word", 25, -1, 0);
        TupleDescInitEntry(tup_desc, (AttrNumber)2, "catcode", 18, -1, 0);
        TupleDescInitEntry(tup_desc, (AttrNumber)3, "catdesc", 25, -1, 0);
    ...
    func_ctx = per_MultiFuncCall(fcinfo);
    ...
    if (func_ctx->call_cntr < num_cypher_keywords)
    {
        ...
        default:
            ...
            values[1] = 
# 149 "src/backend/parser/cypher_keywords.c" 3 4
                       ((void *)0)
# 149 "src/backend/parser/cypher_keywords.c"
                           ;
            values[2] = 
# 150 "src/backend/parser/cypher_keywords.c" 3 4
                       ((void *)0)
# 150 "src/backend/parser/cypher_keywords.c"
                           ;
            break;
        }
        ...
        do { ReturnSetInfo *rsi; (func_ctx)->call_cntr++; rsi = (ReturnSetInfo *) fcinfo->resultinfo; rsi->isDone = ExprMultipleResult; return (HeapTupleHeaderGetDatum((tuple)->t_data)); } while (0);
    }

    do { ReturnSetInfo *rsi; end_MultiFuncCall(fcinfo, func_ctx); rsi = (ReturnSetInfo *) fcinfo->resultinfo; rsi->isDone = ExprEndResult; do { fcinfo->isnull = 
# 159 "src/backend/parser/cypher_keywords.c" 3 4
   1
# 159 "src/backend/parser/cypher_keywords.c"
