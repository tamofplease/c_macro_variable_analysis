# 0 "src/backend/nodes/ag_nodes.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/nodes/ag_nodes.c"
# 20 "src/backend/nodes/ag_nodes.c"
...
# 21 "src/backend/nodes/ag_nodes.c" 2
...
# 158 "/usr/include/postgresql/11/server/nodes/extensible.h"
          missing_ok);
# 23 "src/backend/nodes/ag_nodes.c" 2
...
# 25 "src/backend/nodes/ag_nodes.c" 2
...
# 26 "src/backend/nodes/ag_nodes.c" 2
...
# 27 "src/backend/nodes/ag_nodes.c" 2
...
# 28 "src/backend/nodes/ag_nodes.c" 2
...
# 29 "src/backend/nodes/ag_nodes.c" 2

static 
# 30 "src/backend/nodes/ag_nodes.c" 3 4
      _Bool 
# 30 "src/backend/nodes/ag_nodes.c"
           equal_ag_node(const ExtensibleNode *a, const ExtensibleNode *b);
...
# 97 "src/backend/nodes/ag_nodes.c"
const ExtensibleNodeMethods node_methods[] = {
    { "cypher_return", sizeof(cypher_return), copy_ag_node, equal_ag_node, out_cypher_return, read_ag_node },
    { "cypher_with", sizeof(cypher_with), copy_ag_node, equal_ag_node, out_cypher_with, read_ag_node },
    { "cypher_match", sizeof(cypher_match), copy_ag_node, equal_ag_node, out_cypher_match, read_ag_node },
    { "cypher_create", sizeof(cypher_create), copy_ag_node, equal_ag_node, out_cypher_create, read_ag_node },
    { "cypher_set", sizeof(cypher_set), copy_ag_node, equal_ag_node, out_cypher_set, read_ag_node },
    { "cypher_set_item", sizeof(cypher_set_item), copy_ag_node, equal_ag_node, out_cypher_set_item, read_ag_node },
    { "cypher_delete", sizeof(cypher_delete), copy_ag_node, equal_ag_node, out_cypher_delete, read_ag_node },
    { "cypher_unwind", sizeof(cypher_unwind), copy_ag_node, equal_ag_node, out_cypher_unwind, read_ag_node },
    { "cypher_merge", sizeof(cypher_merge), copy_ag_node, equal_ag_node, out_cypher_merge, read_ag_node },
    { "cypher_path", sizeof(cypher_path), copy_ag_node, equal_ag_node, out_cypher_path, read_ag_node },
    { "cypher_node", sizeof(cypher_node), copy_ag_node, equal_ag_node, out_cypher_node, read_ag_node },
    { "cypher_relationship", sizeof(cypher_relationship), copy_ag_node, equal_ag_node, out_cypher_relationship, read_ag_node },
    { "cypher_bool_const", sizeof(cypher_bool_const), copy_ag_node, equal_ag_node, out_cypher_bool_const, read_ag_node },
    { "cypher_param", sizeof(cypher_param), copy_ag_node, equal_ag_node, out_cypher_param, read_ag_node },
    { "cypher_map", sizeof(cypher_map), copy_ag_node, equal_ag_node, out_cypher_map, read_ag_node },
    { "cypher_list", sizeof(cypher_list), copy_ag_node, equal_ag_node, out_cypher_list, read_ag_node },
    { "cypher_string_match", sizeof(cypher_string_match), copy_ag_node, equal_ag_node, out_cypher_string_match, read_ag_node },
    { "cypher_typecast", sizeof(cypher_typecast), copy_ag_node, equal_ag_node, out_cypher_typecast, read_ag_node },
    { "cypher_integer_const", sizeof(cypher_integer_const), copy_ag_node, equal_ag_node, out_cypher_integer_const, read_ag_node },
    { "cypher_sub_pattern", sizeof(cypher_sub_pattern), copy_ag_node, equal_ag_node, out_cypher_sub_pattern, read_ag_node },
    { "cypher_call", sizeof(cypher_call), copy_ag_node, equal_ag_node, out_cypher_call, read_ag_node },
    { "cypher_create_target_nodes", sizeof(cypher_create_target_nodes), copy_cypher_create_target_nodes, equal_ag_node, out_cypher_create_target_nodes, read_cypher_create_target_nodes },
    { "cypher_create_path", sizeof(cypher_create_path), copy_cypher_create_path, equal_ag_node, out_cypher_create_path, read_cypher_create_path },
    { "cypher_target_node", sizeof(cypher_target_node), copy_cypher_target_node, equal_ag_node, out_cypher_target_node, read_cypher_target_node },
    { "cypher_update_information", sizeof(cypher_update_information), copy_cypher_update_information, equal_ag_node, out_cypher_update_information, read_cypher_update_information },
    { "cypher_update_item", sizeof(cypher_update_item), copy_cypher_update_item, equal_ag_node, out_cypher_update_item, read_cypher_update_item },
    { "cypher_delete_information", sizeof(cypher_delete_information), copy_cypher_delete_information, equal_ag_node, out_cypher_delete_information, read_cypher_delete_information },
    { "cypher_delete_item", sizeof(cypher_delete_item), copy_cypher_delete_item, equal_ag_node, out_cypher_delete_item, read_cypher_delete_item },
    { "cypher_merge_information", sizeof(cypher_merge_information), copy_cypher_merge_information, equal_ag_node, out_cypher_merge_information, read_cypher_merge_information }
};

static 
# 129 "src/backend/nodes/ag_nodes.c" 3 4
      _Bool 
# 129 "src/backend/nodes/ag_nodes.c"
           equal_ag_node(const ExtensibleNode *a, const ExtensibleNode *b)
{
    do { if (errstart(20, "src/backend/nodes/ag_nodes.c", 131, __func__, 
# 131 "src/backend/nodes/ag_nodes.c" 3 4
   ((void *)0)
# 131 "src/backend/nodes/ag_nodes.c"
   )) errfinish (errmsg("unexpected equal() over ag_node's")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0);
}

void register_ag_nodes(void)
{
    static 
# 136 "src/backend/nodes/ag_nodes.c" 3 4
          _Bool 
# 136 "src/backend/nodes/ag_nodes.c"
               initialized = 
# 136 "src/backend/nodes/ag_nodes.c" 3 4
                             0
# 136 "src/backend/nodes/ag_nodes.c"
    ...
    for (i = 0; i < (sizeof (node_methods) / sizeof ((node_methods)[0])); i++)
        RegisterExtensibleNodeMethods(&node_methods[i]);

    initialized = 
# 145 "src/backend/nodes/ag_nodes.c" 3 4
                 1
# 145 "src/backend/nodes/ag_nodes.c"
                     ;
}
...
ExtensibleNode *_new_ag_node(Size size, ag_node_tag tag)
{
    ...
    n = (ExtensibleNode *)( ( ((size) & (sizeof(long) - 1)) == 0 && (size) <= 1024 && 1024 != 0 && (0) == 0 ) ? MemoryContextAllocZeroAligned(CurrentMemoryContext, size) : MemoryContextAllocZero(CurrentMemoryContext, size) );
