# 0 "src/backend/nodes/cypher_outfuncs.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/nodes/cypher_outfuncs.c"
# 20 "src/backend/nodes/cypher_outfuncs.c"
...
# 21 "src/backend/nodes/cypher_outfuncs.c" 2
...
# 23 "src/backend/nodes/cypher_outfuncs.c" 2
...
# 158 "/usr/include/postgresql/11/server/nodes/extensible.h"
          missing_ok);
# 24 "src/backend/nodes/cypher_outfuncs.c" 2
...
# 27 "src/backend/nodes/cypher_outfuncs.c" 2
# 1 ".//src/include/nodes/cypher_outfuncs.h" 1
# 35 ".//src/include/nodes/cypher_outfuncs.h"
...
# 28 "src/backend/nodes/cypher_outfuncs.c" 2

static void outChar(StringInfo str, char c);
# 101 "src/backend/nodes/cypher_outfuncs.c"
void out_cypher_return(StringInfo str, const ExtensibleNode *node)
{
    cypher_return *_node = (cypher_return *)node;

    do { appendStringInfo(str, " :" "distinct" " %s", _node->distinct ? "true" : "false"); } while (0);
    do { appendStringInfoString(str, " :" "items" " "); outNode(str, _node->items); } while (0);
    do { appendStringInfoString(str, " :" "order_by" " "); outNode(str, _node->order_by); } while (0);
    do { appendStringInfoString(str, " :" "skip" " "); outNode(str, _node->skip); } while (0);
    do { appendStringInfoString(str, " :" "limit" " "); outNode(str, _node->limit); } while (0);

    do { appendStringInfo(str, " :" "all_or_distinct" " %s", _node->all_or_distinct ? "true" : "false"); } while (0);
    do { appendStringInfo(str, " :" "op" " %d", (int)_node->op); } while (0);
    do { appendStringInfoString(str, " :" "larg" " "); outNode(str, _node->larg); } while (0);
    do { appendStringInfoString(str, " :" "rarg" " "); outNode(str, _node->rarg); } while (0);
}


void out_cypher_with(StringInfo str, const ExtensibleNode *node)
{
    cypher_with *_node = (cypher_with *)node;
    ...
    do { appendStringInfoString(str, " :" "skip" " "); outNode(str, _node->skip); } while (0);
    do { appendStringInfoString(str, " :" "limit" " "); outNode(str, _node->limit); } while (0);
    do { appendStringInfoString(str, " :" "where" " "); outNode(str, _node->where); } while (0);
}


void out_cypher_match(StringInfo str, const ExtensibleNode *node)
{
    cypher_match *_node = (cypher_match *)node;

    do { appendStringInfoString(str, " :" "pattern" " "); outNode(str, _node->pattern); } while (0);
    do { appendStringInfoString(str, " :" "where" " "); outNode(str, _node->where); } while (0);
    do { appendStringInfo(str, " :" "optional" " %s", _node->optional ? "true" : "false"); } while (0);
}


void out_cypher_create(StringInfo str, const ExtensibleNode *node)
{
    cypher_create *_node = (cypher_create *)node;
...
void out_cypher_set(StringInfo str, const ExtensibleNode *node)
{
    cypher_set *_node = (cypher_set *)node;

    do { appendStringInfoString(str, " :" "items" " "); outNode(str, _node->items); } while (0);
    do { appendStringInfo(str, " :" "is_remove" " %s", _node->is_remove ? "true" : "false"); } while (0);
}


void out_cypher_set_item(StringInfo str, const ExtensibleNode *node)
{
    cypher_set_item *_node = (cypher_set_item *)node;

    do { appendStringInfoString(str, " :" "prop" " "); outNode(str, _node->prop); } while (0);
    do { appendStringInfoString(str, " :" "expr" " "); outNode(str, _node->expr); } while (0);
    do { appendStringInfo(str, " :" "is_add" " %s", _node->is_add ? "true" : "false"); } while (0);
}


void out_cypher_delete(StringInfo str, const ExtensibleNode *node)
{
    cypher_delete *_node = (cypher_delete *)node;

    do { appendStringInfo(str, " :" "detach" " %s", _node->detach ? "true" : "false"); } while (0);
    do { appendStringInfoString(str, " :" "exprs" " "); outNode(str, _node->exprs); } while (0);
}

void out_cypher_unwind(StringInfo str, const ExtensibleNode *node)
{
    cypher_unwind *_node = (cypher_unwind *)node;

    do { appendStringInfoString(str, " :" "target" " "); outNode(str, _node->target); } while (0);
}


void out_cypher_merge(StringInfo str, const ExtensibleNode *node)
{
    cypher_merge *_node = (cypher_merge *)node;

    do { appendStringInfoString(str, " :" "path" " "); outNode(str, _node->path); } while (0);
}


void out_cypher_path(StringInfo str, const ExtensibleNode *node)
{
    cypher_path *_node = (cypher_path *)node;

    do { appendStringInfoString(str, " :" "path" " "); outNode(str, _node->path); } while (0);
    do { appendStringInfo(str, " :" "location" " %d", _node->location); } while (0);
}


void out_cypher_node(StringInfo str, const ExtensibleNode *node)
{
    cypher_node *_node = (cypher_node *)node;

    do { appendStringInfoString(str, " :" "name" " "); outToken(str, _node->name); } while (0);
    do { appendStringInfoString(str, " :" "label" " "); outToken(str, _node->label); } while (0);
    do { appendStringInfoString(str, " :" "props" " "); outNode(str, _node->props); } while (0);
    do { appendStringInfo(str, " :" "location" " %d", _node->location); } while (0);
}
...
void out_cypher_relationship(StringInfo str, const ExtensibleNode *node)
{
    cypher_relationship *_node = (cypher_relationship *)node;

    do { appendStringInfoString(str, " :" "name" " "); outToken(str, _node->name); } while (0);
    do { appendStringInfoString(str, " :" "label" " "); outToken(str, _node->label); } while (0);
    do { appendStringInfoString(str, " :" "props" " "); outNode(str, _node->props); } while (0);
    do { appendStringInfoString(str, " :" "varlen" " "); outNode(str, _node->varlen); } while (0);
    do { appendStringInfo(str, " :" "dir" " %d", (int)_node->dir); } while (0);
    do { appendStringInfo(str, " :" "location" " %d", _node->location); } while (0);
}
...
void out_cypher_bool_const(StringInfo str, const ExtensibleNode *node)
{
    cypher_bool_const *_node = (cypher_bool_const *)node;

    do { appendStringInfo(str, " :" "boolean" " %s", _node->boolean ? "true" : "false"); } while (0);
    do { appendStringInfo(str, " :" "location" " %d", _node->location); } while (0);
}
...
void out_cypher_param(StringInfo str, const ExtensibleNode *node)
{
    cypher_param *_node = (cypher_param *)node;
...
void out_cypher_map(StringInfo str, const ExtensibleNode *node)
{
    cypher_map *_node = (cypher_map *)node;

    do { appendStringInfoString(str, " :" "keyvals" " "); outNode(str, _node->keyvals); } while (0);
    do { appendStringInfo(str, " :" "location" " %d", _node->location); } while (0);
}
...
void out_cypher_list(StringInfo str, const ExtensibleNode *node)
{
    cypher_list *_node = (cypher_list *)node;

    do { appendStringInfoString(str, " :" "elems" " "); outNode(str, _node->elems); } while (0);
    do { appendStringInfo(str, " :" "location" " %d", _node->location); } while (0);
}
...
void out_cypher_string_match(StringInfo str, const ExtensibleNode *node)
{
    cypher_string_match *_node = (cypher_string_match *)node;

    do { appendStringInfo(str, " :" "operation" " %d", (int)_node->operation); } while (0);
    do { appendStringInfoString(str, " :" "lhs" " "); outNode(str, _node->lhs); } while (0);
    do { appendStringInfoString(str, " :" "rhs" " "); outNode(str, _node->rhs); } while (0);
    do { appendStringInfo(str, " :" "location" " %d", _node->location); } while (0);
}
...
void out_cypher_typecast(StringInfo str, const ExtensibleNode *node)
{
    cypher_typecast *_node = (cypher_typecast *)node;

    do { appendStringInfoString(str, " :" "expr" " "); outNode(str, _node->expr); } while (0);
    do { appendStringInfoString(str, " :" "typecast" " "); outToken(str, _node->typecast); } while (0);
    do { appendStringInfo(str, " :" "location" " %d", _node->location); } while (0);
}
...
void out_cypher_integer_const(StringInfo str, const ExtensibleNode *node)
{
    cypher_integer_const *_node = (cypher_integer_const *)node;

    do { appendStringInfo(str, " :" "integer" " %ld", _node->integer); } while (0);
    do { appendStringInfo(str, " :" "location" " %d", _node->location); } while (0);
}
...
void out_cypher_sub_pattern(StringInfo str, const ExtensibleNode *node)
{
    cypher_sub_pattern *_node = (cypher_sub_pattern *)node;

    do { appendStringInfo(str, " :" "kind" " %d", (int)_node->kind); } while (0);
    do { appendStringInfoString(str, " :" "pattern" " "); outNode(str, _node->pattern); } while (0);
}
...
void out_cypher_call(StringInfo str, const ExtensibleNode *node)
{
    cypher_call *_node = (cypher_call *)node;

    do { appendStringInfoString(str, " :" "funccall" " "); outNode(str, _node->funccall); } while (0);
    do { appendStringInfoString(str, " :" "funcexpr" " "); outNode(str, _node->funcexpr); } while (0);
    do { appendStringInfoString(str, " :" "where" " "); outNode(str, _node->where); } while (0);
    do { appendStringInfoString(str, " :" "yield_items" " "); outNode(str, _node->yield_items); } while (0);
}


void out_cypher_create_target_nodes(StringInfo str, const ExtensibleNode *node)
{
    cypher_create_target_nodes *_node = (cypher_create_target_nodes *)node;

    do { appendStringInfoString(str, " :" "paths" " "); outNode(str, _node->paths); } while (0);
    do { appendStringInfo(str, " :" "flags" " %d", _node->flags); } while (0);
    do { appendStringInfo(str, " :" "graph_oid" " %u", _node->graph_oid); } while(0);;
}


void out_cypher_create_path(StringInfo str, const ExtensibleNode *node)
{
    cypher_create_path *_node = (cypher_create_path *)node;

    do { appendStringInfoString(str, " :" "target_nodes" " "); outNode(str, _node->target_nodes); } while (0);
    do { appendStringInfo(str, " :" "path_attr_num" " %d", _node->path_attr_num); } while (0);
    do { appendStringInfoString(str, " :" "var_name" " "); outToken(str, _node->var_name); } while (0);
}


void out_cypher_target_node(StringInfo str, const ExtensibleNode *node)
{
    cypher_target_node *_node = (cypher_target_node *)node;

    do { (appendStringInfo(str, " :" "type" " "), outChar(str, _node->type)); } while (0);
    do { appendStringInfo(str, " :" "flags" " %d", _node->flags); } while (0);
    do { appendStringInfo(str, " :" "dir" " %d", (int)_node->dir); } while (0);
    do { appendStringInfoString(str, " :" "id_expr" " "); outNode(str, _node->id_expr); } while (0);
    do { appendStringInfoString(str, " :" "id_expr_state" " "); outNode(str, _node->id_expr_state); } while (0);
    do { appendStringInfoString(str, " :" "prop_expr" " "); outNode(str, _node->prop_expr); } while (0);
    do { appendStringInfoString(str, " :" "prop_expr_state" " "); outNode(str, _node->prop_expr_state); } while (0);
    do { appendStringInfo(str, " :" "prop_attr_num" " %d", _node->prop_attr_num); } while (0);
    do { appendStringInfoString(str, " :" "resultRelInfo" " "); outNode(str, _node->resultRelInfo); } while (0);
    do { appendStringInfoString(str, " :" "elemTupleSlot" " "); outNode(str, _node->elemTupleSlot); } while (0);
    do { appendStringInfo(str, " :" "relid" " %u", _node->relid); } while(0);;
    do { appendStringInfoString(str, " :" "label_name" " "); outToken(str, _node->label_name); } while (0);
    do { appendStringInfoString(str, " :" "variable_name" " "); outToken(str, _node->variable_name); } while (0);
    do { appendStringInfo(str, " :" "tuple_position" " %d", _node->tuple_position); } while (0);
}


void out_cypher_update_information(StringInfo str, const ExtensibleNode *node)
{
    cypher_update_information *_node = (cypher_update_information *)node;

    do { appendStringInfoString(str, " :" "set_items" " "); outNode(str, _node->set_items); } while (0);
    do { appendStringInfo(str, " :" "flags" " %d", _node->flags); } while (0);
    do { appendStringInfo(str, " :" "tuple_position" " %d", _node->tuple_position); } while (0);
    do { appendStringInfoString(str, " :" "graph_name" " "); outToken(str, _node->graph_name); } while (0);
    do { appendStringInfoString(str, " :" "clause_name" " "); outToken(str, _node->clause_name); } while (0);
}


void out_cypher_update_item(StringInfo str, const ExtensibleNode *node)
{
    cypher_update_item *_node = (cypher_update_item *)node;

    do { appendStringInfo(str, " :" "prop_position" " %d", _node->prop_position); } while (0);
    do { appendStringInfo(str, " :" "entity_position" " %d", _node->entity_position); } while (0);
    do { appendStringInfoString(str, " :" "var_name" " "); outToken(str, _node->var_name); } while (0);
    do { appendStringInfoString(str, " :" "prop_name" " "); outToken(str, _node->prop_name); } while (0);
    do { appendStringInfoString(str, " :" "qualified_name" " "); outNode(str, _node->qualified_name); } while (0);
    do { appendStringInfo(str, " :" "remove_item" " %s", _node->remove_item ? "true" : "false"); } while (0);
}


void out_cypher_delete_information(StringInfo str, const ExtensibleNode *node)
{
    cypher_delete_information *_node = (cypher_delete_information *)node;

    do { appendStringInfoString(str, " :" "delete_items" " "); outNode(str, _node->delete_items); } while (0);
    do { appendStringInfo(str, " :" "flags" " %d", _node->flags); } while (0);
    do { appendStringInfoString(str, " :" "graph_name" " "); outToken(str, _node->graph_name); } while (0);
    do { appendStringInfo(str, " :" "graph_oid" " %u", _node->graph_oid); } while(0);;
    do { appendStringInfo(str, " :" "detach" " %s", _node->detach ? "true" : "false"); } while (0);
...
void out_cypher_delete_item(StringInfo str, const ExtensibleNode *node)
{
    cypher_delete_item *_node = (cypher_delete_item *)node;

    do { appendStringInfoString(str, " :" "entity_position" " "); outNode(str, _node->entity_position); } while (0);
    do { appendStringInfoString(str, " :" "var_name" " "); outToken(str, _node->var_name); } while (0);
}
...
void out_cypher_merge_information(StringInfo str, const ExtensibleNode *node)
{
    cypher_merge_information *_node = (cypher_merge_information *)node;

    do { appendStringInfo(str, " :" "flags" " %d", _node->flags); } while (0);
    do { appendStringInfo(str, " :" "graph_oid" " %u", _node->graph_oid); } while(0);;
    do { appendStringInfo(str, " :" "merge_function_attr" " %d", _node->merge_function_attr); } while (0);
    do { appendStringInfoString(str, " :" "path" " "); outNode(str, _node->path); } while (0);
}
