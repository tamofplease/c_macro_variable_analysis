# 0 "src/backend/nodes/cypher_copyfuncs.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/nodes/cypher_copyfuncs.c"
# 20 "src/backend/nodes/cypher_copyfuncs.c"
...
# 21 "src/backend/nodes/cypher_copyfuncs.c" 2
...
# 23 "src/backend/nodes/cypher_copyfuncs.c" 2
...
# 158 "/usr/include/postgresql/11/server/nodes/extensible.h"
          missing_ok);
# 24 "src/backend/nodes/cypher_copyfuncs.c" 2

# 1 "/usr/include/postgresql/11/server/utils/palloc.h" 1
# 26 "src/backend/nodes/cypher_copyfuncs.c" 2

# 1 ".//src/include/nodes/cypher_copyfuncs.h" 1
# 34 ".//src/include/nodes/cypher_copyfuncs.h"
...
# 28 "src/backend/nodes/cypher_copyfuncs.c" 2
...
# 29 "src/backend/nodes/cypher_copyfuncs.c" 2
# 68 "src/backend/nodes/cypher_copyfuncs.c"
void copy_ag_node(ExtensibleNode *newnode,
                         const ExtensibleNode *oldnode)
{
    do { if (errstart(20, "src/backend/nodes/cypher_copyfuncs.c", 71, __func__, 
# 71 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   ((void *)0)
# 71 "src/backend/nodes/cypher_copyfuncs.c"
   )) errfinish (errmsg("unexpected copyObject() over ag_node")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0);
}


void copy_cypher_create_target_nodes(ExtensibleNode *newnode, const ExtensibleNode *from)
{
    cypher_create_target_nodes *extended_newnode = (cypher_create_target_nodes *)newnode; cypher_create_target_nodes *extended_from = (cypher_create_target_nodes *)from; ((void)
# 77 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   1
# 77 "src/backend/nodes/cypher_copyfuncs.c"
   ); ((void)
# 77 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   1
# 77 "src/backend/nodes/cypher_copyfuncs.c"
    ...
    (extended_newnode->flags = extended_from->flags);
    (extended_newnode->graph_oid = extended_from->graph_oid);

    (extended_newnode->paths = ((typeof(extended_from->paths)) copyObjectImpl(extended_from->paths)));
}


void copy_cypher_create_path(ExtensibleNode *newnode, const ExtensibleNode *from)
{
    cypher_create_path *extended_newnode = (cypher_create_path *)newnode; cypher_create_path *extended_from = (cypher_create_path *)from; ((void)
# 88 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   1
# 88 "src/backend/nodes/cypher_copyfuncs.c"
   ); ((void)
# 88 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   1
# 88 "src/backend/nodes/cypher_copyfuncs.c"
    ...
    (extended_newnode->path_attr_num = extended_from->path_attr_num);
    (extended_newnode->var_name = extended_from->var_name ? pstrdup(extended_from->var_name) : (char *) 
# 91 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   ((void *)0)
# 91 "src/backend/nodes/cypher_copyfuncs.c"
   );
    (extended_newnode->target_nodes = ((typeof(extended_from->target_nodes)) copyObjectImpl(extended_from->target_nodes)));
}


void copy_cypher_target_node(ExtensibleNode *newnode, const ExtensibleNode *from)
{
    cypher_target_node *extended_newnode = (cypher_target_node *)newnode; cypher_target_node *extended_from = (cypher_target_node *)from; ((void)
# 98 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   1
# 98 "src/backend/nodes/cypher_copyfuncs.c"
   ); ((void)
# 98 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   1
# 98 "src/backend/nodes/cypher_copyfuncs.c"
    ...
    (extended_newnode->type = extended_from->type);
    (extended_newnode->flags = extended_from->flags);
    (extended_newnode->dir = extended_from->dir);
    (extended_newnode->prop_attr_num = extended_from->prop_attr_num);
    (extended_newnode->relid = extended_from->relid);
    (extended_newnode->tuple_position = extended_from->tuple_position);

    (extended_newnode->label_name = extended_from->label_name ? pstrdup(extended_from->label_name) : (char *) 
# 107 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   ((void *)0)
# 107 "src/backend/nodes/cypher_copyfuncs.c"
   );
    (extended_newnode->variable_name = extended_from->variable_name ? pstrdup(extended_from->variable_name) : (char *) 
# 108 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   ((void *)0)
# 108 "src/backend/nodes/cypher_copyfuncs.c"
   );

    (extended_newnode->id_expr = ((typeof(extended_from->id_expr)) copyObjectImpl(extended_from->id_expr)));
    (extended_newnode->id_expr_state = ((typeof(extended_from->id_expr_state)) copyObjectImpl(extended_from->id_expr_state)));
    (extended_newnode->prop_expr = ((typeof(extended_from->prop_expr)) copyObjectImpl(extended_from->prop_expr)));
    (extended_newnode->prop_expr_state = ((typeof(extended_from->prop_expr_state)) copyObjectImpl(extended_from->prop_expr_state)));
    (extended_newnode->resultRelInfo = ((typeof(extended_from->resultRelInfo)) copyObjectImpl(extended_from->resultRelInfo)));
    (extended_newnode->elemTupleSlot = ((typeof(extended_from->elemTupleSlot)) copyObjectImpl(extended_from->elemTupleSlot)));
}


void copy_cypher_update_information(ExtensibleNode *newnode, const ExtensibleNode *from)
{
    cypher_update_information *extended_newnode = (cypher_update_information *)newnode; cypher_update_information *extended_from = (cypher_update_information *)from; ((void)
# 121 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   1
# 121 "src/backend/nodes/cypher_copyfuncs.c"
   ); ((void)
# 121 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   1
# 121 "src/backend/nodes/cypher_copyfuncs.c"
    ...
    (extended_newnode->set_items = ((typeof(extended_from->set_items)) copyObjectImpl(extended_from->set_items)));
    (extended_newnode->flags = extended_from->flags);
    (extended_newnode->tuple_position = extended_from->tuple_position);
    (extended_newnode->graph_name = extended_from->graph_name ? pstrdup(extended_from->graph_name) : (char *) 
# 126 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   ((void *)0)
# 126 "src/backend/nodes/cypher_copyfuncs.c"
   );
    (extended_newnode->clause_name = extended_from->clause_name ? pstrdup(extended_from->clause_name) : (char *) 
# 127 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   ((void *)0)
# 127 "src/backend/nodes/cypher_copyfuncs.c"
   );
}
...
void copy_cypher_update_item(ExtensibleNode *newnode, const ExtensibleNode *from)
{
    cypher_update_item *extended_newnode = (cypher_update_item *)newnode; cypher_update_item *extended_from = (cypher_update_item *)from; ((void)
# 133 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   1
# 133 "src/backend/nodes/cypher_copyfuncs.c"
   ); ((void)
# 133 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   1
# 133 "src/backend/nodes/cypher_copyfuncs.c"
    ...
    (extended_newnode->prop_position = extended_from->prop_position);
    (extended_newnode->entity_position = extended_from->entity_position);
    (extended_newnode->var_name = extended_from->var_name ? pstrdup(extended_from->var_name) : (char *) 
# 137 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   ((void *)0)
# 137 "src/backend/nodes/cypher_copyfuncs.c"
   );
    (extended_newnode->prop_name = extended_from->prop_name ? pstrdup(extended_from->prop_name) : (char *) 
# 138 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   ((void *)0)
# 138 "src/backend/nodes/cypher_copyfuncs.c"
   );
    (extended_newnode->qualified_name = ((typeof(extended_from->qualified_name)) copyObjectImpl(extended_from->qualified_name)));
    (extended_newnode->remove_item = extended_from->remove_item);
}


void copy_cypher_delete_information(ExtensibleNode *newnode, const ExtensibleNode *from)
{
    cypher_delete_information *extended_newnode = (cypher_delete_information *)newnode; cypher_delete_information *extended_from = (cypher_delete_information *)from; ((void)
# 146 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   1
# 146 "src/backend/nodes/cypher_copyfuncs.c"
   ); ((void)
# 146 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   1
# 146 "src/backend/nodes/cypher_copyfuncs.c"
    ...
    (extended_newnode->delete_items = ((typeof(extended_from->delete_items)) copyObjectImpl(extended_from->delete_items)));
    (extended_newnode->flags = extended_from->flags);
    (extended_newnode->graph_name = extended_from->graph_name ? pstrdup(extended_from->graph_name) : (char *) 
# 150 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   ((void *)0)
# 150 "src/backend/nodes/cypher_copyfuncs.c"
   );
    (extended_newnode->graph_oid = extended_from->graph_oid);
    (extended_newnode->detach = extended_from->detach);
}


void copy_cypher_delete_item(ExtensibleNode *newnode, const ExtensibleNode *from)
{
    cypher_delete_item *extended_newnode = (cypher_delete_item *)newnode; cypher_delete_item *extended_from = (cypher_delete_item *)from; ((void)
# 158 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   1
# 158 "src/backend/nodes/cypher_copyfuncs.c"
   ); ((void)
# 158 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   1
# 158 "src/backend/nodes/cypher_copyfuncs.c"
    ...
    (extended_newnode->entity_position = ((typeof(extended_from->entity_position)) copyObjectImpl(extended_from->entity_position)));
    (extended_newnode->var_name = extended_from->var_name ? pstrdup(extended_from->var_name) : (char *) 
# 161 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   ((void *)0)
# 161 "src/backend/nodes/cypher_copyfuncs.c"
   );
}
...
void copy_cypher_merge_information(ExtensibleNode *newnode, const ExtensibleNode *from)
{
    cypher_merge_information *extended_newnode = (cypher_merge_information *)newnode; cypher_merge_information *extended_from = (cypher_merge_information *)from; ((void)
# 167 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   1
# 167 "src/backend/nodes/cypher_copyfuncs.c"
   ); ((void)
# 167 "src/backend/nodes/cypher_copyfuncs.c" 3 4
   1
# 167 "src/backend/nodes/cypher_copyfuncs.c"
    ...
    (extended_newnode->flags = extended_from->flags);
    (extended_newnode->graph_oid = extended_from->graph_oid);
    (extended_newnode->merge_function_attr = extended_from->merge_function_attr);
    (extended_newnode->path = ((typeof(extended_from->path)) copyObjectImpl(extended_from->path)));
}
