# 0 "src/backend/nodes/cypher_readfuncs.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/nodes/cypher_readfuncs.c"
# 20 "src/backend/nodes/cypher_readfuncs.c"
...
# 21 "src/backend/nodes/cypher_readfuncs.c" 2

# 1 "/usr/include/postgresql/11/server/nodes/readfuncs.h" 1
# 17 "/usr/include/postgresql/11/server/nodes/readfuncs.h"
...
# 18 "/usr/include/postgresql/11/server/nodes/readfuncs.h" 2
...
# 23 "src/backend/nodes/cypher_readfuncs.c" 2

# 1 ".//src/include/nodes/cypher_readfuncs.h" 1
# 25 ".//src/include/nodes/cypher_readfuncs.h"
...
# 158 "/usr/include/postgresql/11/server/nodes/extensible.h"
          missing_ok);
# 26 ".//src/include/nodes/cypher_readfuncs.h" 2
# 40 ".//src/include/nodes/cypher_readfuncs.h"
...
# 25 "src/backend/nodes/cypher_readfuncs.c" 2
...
# 26 "src/backend/nodes/cypher_readfuncs.c" 2
# 167 "src/backend/nodes/cypher_readfuncs.c"
void read_ag_node(ExtensibleNode *node)
{
    do { if (errstart(20, "src/backend/nodes/cypher_readfuncs.c", 169, __func__, 
# 169 "src/backend/nodes/cypher_readfuncs.c" 3 4
   ((void *)0)
# 169 "src/backend/nodes/cypher_readfuncs.c"
   )) errfinish (errmsg("unexpected parseNodeString() for ag_node")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0);
}
...
void read_cypher_create_target_nodes(struct ExtensibleNode *node)
{
    cypher_create_target_nodes *local_node = (cypher_create_target_nodes *)node; char *token; int length;;

    token = pg_strtok(&length); (void) token; local_node->paths = nodeRead(
# 180 "src/backend/nodes/cypher_readfuncs.c" 3 4
   ((void *)0)
# 180 "src/backend/nodes/cypher_readfuncs.c"
   , 0);
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->flags = atoi(token);
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->graph_oid = ((Oid) strtoul((token), 
# 182 "src/backend/nodes/cypher_readfuncs.c" 3 4
   ((void *)0)
# 182 "src/backend/nodes/cypher_readfuncs.c"
   , 10));
}
...
void read_cypher_create_path(struct ExtensibleNode *node)
{
    cypher_create_path *local_node = (cypher_create_path *)node; char *token; int length;;

    token = pg_strtok(&length); (void) token; local_node->target_nodes = nodeRead(
# 193 "src/backend/nodes/cypher_readfuncs.c" 3 4
   ((void *)0)
# 193 "src/backend/nodes/cypher_readfuncs.c"
   , 0);
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->path_attr_num = atoi(token);
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->var_name = ((length) == 0 ? "" : debackslash(token, length));
}
...
void read_cypher_target_node(struct ExtensibleNode *node)
{
    cypher_target_node *local_node = (cypher_target_node *)node; char *token; int length;;

    token = pg_strtok(&length); token = pg_strtok(&length); local_node->type = (length == 0) ? '\0' : (token[0] == '\\' ? token[1] : token[0]);
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->flags = atoi(token);
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->dir = (cypher_rel_dir) atoi(token);
    token = pg_strtok(&length); (void) token; local_node->id_expr = nodeRead(
# 209 "src/backend/nodes/cypher_readfuncs.c" 3 4
   ((void *)0)
# 209 "src/backend/nodes/cypher_readfuncs.c"
   , 0);
    token = pg_strtok(&length); (void) token; local_node->id_expr_state = nodeRead(
# 210 "src/backend/nodes/cypher_readfuncs.c" 3 4
   ((void *)0)
# 210 "src/backend/nodes/cypher_readfuncs.c"
   , 0);
    token = pg_strtok(&length); (void) token; local_node->prop_expr = nodeRead(
# 211 "src/backend/nodes/cypher_readfuncs.c" 3 4
   ((void *)0)
# 211 "src/backend/nodes/cypher_readfuncs.c"
   , 0);
    token = pg_strtok(&length); (void) token; local_node->prop_expr_state = nodeRead(
# 212 "src/backend/nodes/cypher_readfuncs.c" 3 4
   ((void *)0)
# 212 "src/backend/nodes/cypher_readfuncs.c"
   , 0);
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->prop_attr_num = atoi(token);
    token = pg_strtok(&length); (void) token; local_node->resultRelInfo = nodeRead(
# 214 "src/backend/nodes/cypher_readfuncs.c" 3 4
   ((void *)0)
# 214 "src/backend/nodes/cypher_readfuncs.c"
   , 0);
    token = pg_strtok(&length); (void) token; local_node->elemTupleSlot = nodeRead(
# 215 "src/backend/nodes/cypher_readfuncs.c" 3 4
   ((void *)0)
# 215 "src/backend/nodes/cypher_readfuncs.c"
   , 0);
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->relid = ((Oid) strtoul((token), 
# 216 "src/backend/nodes/cypher_readfuncs.c" 3 4
   ((void *)0)
# 216 "src/backend/nodes/cypher_readfuncs.c"
   , 10));
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->label_name = ((length) == 0 ? "" : debackslash(token, length));
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->variable_name = ((length) == 0 ? "" : debackslash(token, length));
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->tuple_position = atoi(token);
}
...
void read_cypher_update_information(struct ExtensibleNode *node)
{
    cypher_update_information *local_node = (cypher_update_information *)node; char *token; int length;;

    token = pg_strtok(&length); (void) token; local_node->set_items = nodeRead(
# 230 "src/backend/nodes/cypher_readfuncs.c" 3 4
   ((void *)0)
# 230 "src/backend/nodes/cypher_readfuncs.c"
   , 0);
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->flags = atoi(token);
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->tuple_position = atoi(token);
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->graph_name = ((length) == 0 ? "" : debackslash(token, length));
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->clause_name = ((length) == 0 ? "" : debackslash(token, length));
}
...
void read_cypher_update_item(struct ExtensibleNode *node)
{
    cypher_update_item *local_node = (cypher_update_item *)node; char *token; int length;;

    token = pg_strtok(&length); token = pg_strtok(&length); local_node->prop_position = atoi(token);
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->entity_position = atoi(token);
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->var_name = ((length) == 0 ? "" : debackslash(token, length));
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->prop_name = ((length) == 0 ? "" : debackslash(token, length));
    token = pg_strtok(&length); (void) token; local_node->qualified_name = nodeRead(
# 249 "src/backend/nodes/cypher_readfuncs.c" 3 4
   ((void *)0)
# 249 "src/backend/nodes/cypher_readfuncs.c"
   , 0);
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->remove_item = ((*(token) == 't') ? 
# 250 "src/backend/nodes/cypher_readfuncs.c" 3 4
   1 
# 250 "src/backend/nodes/cypher_readfuncs.c"
   : 
# 250 "src/backend/nodes/cypher_readfuncs.c" 3 4
   0
# 250 "src/backend/nodes/cypher_readfuncs.c"
...
void read_cypher_delete_information(struct ExtensibleNode *node)
{
    cypher_delete_information *local_node = (cypher_delete_information *)node; char *token; int length;;

    token = pg_strtok(&length); (void) token; local_node->delete_items = nodeRead(
# 261 "src/backend/nodes/cypher_readfuncs.c" 3 4
   ((void *)0)
# 261 "src/backend/nodes/cypher_readfuncs.c"
   , 0);
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->flags = atoi(token);
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->graph_name = ((length) == 0 ? "" : debackslash(token, length));
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->graph_oid = ((Oid) strtoul((token), 
# 264 "src/backend/nodes/cypher_readfuncs.c" 3 4
   ((void *)0)
# 264 "src/backend/nodes/cypher_readfuncs.c"
   , 10));
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->detach = ((*(token) == 't') ? 
# 265 "src/backend/nodes/cypher_readfuncs.c" 3 4
   1 
# 265 "src/backend/nodes/cypher_readfuncs.c"
   : 
# 265 "src/backend/nodes/cypher_readfuncs.c" 3 4
   0
# 265 "src/backend/nodes/cypher_readfuncs.c"
...
void read_cypher_delete_item(struct ExtensibleNode *node)
{
    cypher_delete_item *local_node = (cypher_delete_item *)node; char *token; int length;;

    token = pg_strtok(&length); (void) token; local_node->entity_position = nodeRead(
# 276 "src/backend/nodes/cypher_readfuncs.c" 3 4
   ((void *)0)
# 276 "src/backend/nodes/cypher_readfuncs.c"
   , 0);
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->var_name = ((length) == 0 ? "" : debackslash(token, length));
}
...
void read_cypher_merge_information(struct ExtensibleNode *node)
{
    cypher_merge_information *local_node = (cypher_merge_information *)node; char *token; int length;;

    token = pg_strtok(&length); token = pg_strtok(&length); local_node->flags = atoi(token);
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->graph_oid = ((Oid) strtoul((token), 
# 289 "src/backend/nodes/cypher_readfuncs.c" 3 4
   ((void *)0)
# 289 "src/backend/nodes/cypher_readfuncs.c"
   , 10));
    token = pg_strtok(&length); token = pg_strtok(&length); local_node->merge_function_attr = atoi(token);
    token = pg_strtok(&length); (void) token; local_node->path = nodeRead(
# 291 "src/backend/nodes/cypher_readfuncs.c" 3 4
   ((void *)0)
# 291 "src/backend/nodes/cypher_readfuncs.c"
   , 0);
}
