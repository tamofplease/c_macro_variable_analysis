# 0 "src/backend/catalog/ag_graph.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/catalog/ag_graph.c"
# 20 "src/backend/catalog/ag_graph.c"
...
# 21 "src/backend/catalog/ag_graph.c" 2
...
# 23 "src/backend/catalog/ag_graph.c" 2
...
# 24 "src/backend/catalog/ag_graph.c" 2
...
# 26 "src/backend/catalog/ag_graph.c" 2
...
extern int no_such_variable;
# 29 "src/backend/catalog/ag_graph.c" 2
...
# 31 "src/backend/catalog/ag_graph.c" 2
# 1 "/usr/include/postgresql/11/server/utils/fmgroids.h" 1
# 32 "src/backend/catalog/ag_graph.c" 2
...
# 33 "src/backend/catalog/ag_graph.c" 2
...
# 34 "src/backend/catalog/ag_graph.c" 2
...
# 37 "src/backend/catalog/ag_graph.c" 2
...
# 38 "src/backend/catalog/ag_graph.c" 2
...
# 45 "src/backend/catalog/ag_graph.c" 3 4
   _Bool 
# 45 "src/backend/catalog/ag_graph.c"
        nulls[2];
    Relation ag_graph;
    HeapTuple tuple;
    Oid graph_oid;
    ...
    ((void)
# 50 "src/backend/catalog/ag_graph.c" 3 4
   1
# 50 "src/backend/catalog/ag_graph.c"
   );
    ((void)
# 51 "src/backend/catalog/ag_graph.c" 3 4
   1
# 51 "src/backend/catalog/ag_graph.c"
   );

    values[1 - 1] = ((Datum) (((*(graph_name)).data)));
    nulls[1 - 1] = 
# 54 "src/backend/catalog/ag_graph.c" 3 4
                                   0
# 54 "src/backend/catalog/ag_graph.c"
                                        ;

    values[2 - 1] = ((Datum) (nsp_id));
    nulls[2 - 1] = 
# 57 "src/backend/catalog/ag_graph.c" 3 4
                                        0
# 57 "src/backend/catalog/ag_graph.c"
                                             ;

    ag_graph = heap_open(ag_relation_id("ag_graph", "table"), 3);

    tuple = heap_form_tuple(((ag_graph)->rd_att), values, nulls);
...
void delete_graph(const Name graph_name)
{
    ...
    ScanKeyInit(&scan_keys[0], 1, 3,
                62, ((Datum) (((*(graph_name)).data))));

    ag_graph = heap_open(ag_relation_id("ag_graph", "table"), 3);
    scan_desc = systable_beginscan(ag_graph, ag_relation_id("ag_graph_name_index", "index"), 
# 86 "src/backend/catalog/ag_graph.c" 3 4
                                                                      1
# 86 "src/backend/catalog/ag_graph.c"
                                                                          ,
                                   
# 87 "src/backend/catalog/ag_graph.c" 3 4
                                  ((void *)0)
# 87 "src/backend/catalog/ag_graph.c"
                                      , 1, scan_keys);

    tuple = systable_getnext(scan_desc);
    if (!((const void*)(tuple) != 
# 90 "src/backend/catalog/ag_graph.c" 3 4
        ((void *)0)
# 90 "src/backend/catalog/ag_graph.c"
        ))
    {
        do { if (errstart(20, "src/backend/catalog/ag_graph.c", 92, __func__, 
# 92 "src/backend/catalog/ag_graph.c" 3 4
       ((void *)0)
# 92 "src/backend/catalog/ag_graph.c"
       )) errfinish (errcode((((('3') - '0') & 0x3F) + (((('F') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("graph \"%s\" does not exist", ((*graph_name).data))); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
...
# 111 "src/backend/catalog/ag_graph.c" 3 4
   _Bool 
# 111 "src/backend/catalog/ag_graph.c"
        repl_isnull[2];
    
# 112 "src/backend/catalog/ag_graph.c" 3 4
   _Bool 
# 112 "src/backend/catalog/ag_graph.c"
        do_replace[2];
    HeapTuple new_tuple;
    ...
    ag_graph = heap_open(ag_relation_id("ag_graph", "table"), 3);
    scan_desc = systable_beginscan(ag_graph, ag_relation_id("ag_graph_name_index", "index"), 
# 120 "src/backend/catalog/ag_graph.c" 3 4
                                                                      1
# 120 "src/backend/catalog/ag_graph.c"
                                                                          ,
                                   
# 121 "src/backend/catalog/ag_graph.c" 3 4
                                  ((void *)0)
# 121 "src/backend/catalog/ag_graph.c"
                                      , 1, scan_keys);

    cur_tuple = systable_getnext(scan_desc);

    if (!((const void*)(cur_tuple) != 
# 125 "src/backend/catalog/ag_graph.c" 3 4
        ((void *)0)
# 125 "src/backend/catalog/ag_graph.c"
        ))
    {
        do { if (errstart(20, "src/backend/catalog/ag_graph.c", 127, __func__, 
# 127 "src/backend/catalog/ag_graph.c" 3 4
       ((void *)0)
# 127 "src/backend/catalog/ag_graph.c"
       )) errfinish (errcode((((('3') - '0') & 0x3F) + (((('F') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("graph \"%s\" does not exist", ((*graph_name).data))); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
    ...
    do { void *_vstart = (void *) (repl_values); int _val = (0); Size _len = (sizeof(repl_values)); if ((((uintptr_t) _vstart) & (sizeof(long) - 1)) == 0 && (_len & (sizeof(long) - 1)) == 0 && _val == 0 && _len <= 1024 && 1024 != 0) { long *_start = (long *) _vstart; long *_stop = (long *) ((char *) _start + _len); while (_start < _stop) *_start++ = 0; } else memset(_vstart, _val, _len); } while (0);
    do { void *_vstart = (void *) (repl_isnull); int _val = (
# 134 "src/backend/catalog/ag_graph.c" 3 4
   0
# 134 "src/backend/catalog/ag_graph.c"
   ); Size _len = (sizeof(repl_isnull)); if ((((uintptr_t) _vstart) & (sizeof(long) - 1)) == 0 && (_len & (sizeof(long) - 1)) == 0 && _val == 0 && _len <= 1024 && 1024 != 0) { long *_start = (long *) _vstart; long *_stop = (long *) ((char *) _start + _len); while (_start < _stop) *_start++ = 0; } else memset(_vstart, _val, _len); } while (0);
    do { void *_vstart = (void *) (do_replace); int _val = (
# 135 "src/backend/catalog/ag_graph.c" 3 4
   0
# 135 "src/backend/catalog/ag_graph.c"
   ); Size _len = (sizeof(do_replace)); if ((((uintptr_t) _vstart) & (sizeof(long) - 1)) == 0 && (_len & (sizeof(long) - 1)) == 0 && _val == 0 && _len <= 1024 && 1024 != 0) { long *_start = (long *) _vstart; long *_stop = (long *) ((char *) _start + _len); while (_start < _stop) *_start++ = 0; } else memset(_vstart, _val, _len); } while (0);

    repl_values[1 - 1] = ((Datum) (((*(new_name)).data)));
    repl_isnull[1 - 1] = 
# 138 "src/backend/catalog/ag_graph.c" 3 4
                                         0
# 138 "src/backend/catalog/ag_graph.c"
                                              ;
    do_replace[1 - 1] = 
# 139 "src/backend/catalog/ag_graph.c" 3 4
                                        1
# 139 "src/backend/catalog/ag_graph.c"
                                            ;

    new_tuple = heap_modify_tuple(cur_tuple, ((ag_graph)->rd_att),
...
static Oid get_graph_namespace(const char *graph_name)
{
    ...
    if (!cache_data)
    {
        do { if (errstart(20, "src/backend/catalog/ag_graph.c", 170, __func__, 
# 170 "src/backend/catalog/ag_graph.c" 3 4
       ((void *)0)
# 170 "src/backend/catalog/ag_graph.c"
