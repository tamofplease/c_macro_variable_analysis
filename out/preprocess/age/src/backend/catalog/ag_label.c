# 0 "src/backend/catalog/ag_label.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/catalog/ag_label.c"
# 20 "src/backend/catalog/ag_label.c"
...
# 21 "src/backend/catalog/ag_label.c" 2
...
# 23 "src/backend/catalog/ag_label.c" 2
...
# 24 "src/backend/catalog/ag_label.c" 2
...
# 26 "src/backend/catalog/ag_label.c" 2


# 1 "/usr/include/postgresql/11/server/catalog/indexing.h" 1
# 26 "/usr/include/postgresql/11/server/catalog/indexing.h"
...
# 65 "/usr/include/postgresql/11/server/catalog/indexing.h"
...
extern int no_such_variable;
# 29 "src/backend/catalog/ag_label.c" 2
...
# 31 "src/backend/catalog/ag_label.c" 2
...
# 32 "src/backend/catalog/ag_label.c" 2
...
# 34 "src/backend/catalog/ag_label.c" 2
# 1 "/usr/include/postgresql/11/server/utils/fmgroids.h" 1
# 35 "src/backend/catalog/ag_label.c" 2
...
# 36 "src/backend/catalog/ag_label.c" 2
...
# 18 "/usr/include/postgresql/11/server/access/xloginsert.h"
...
# 37 "/usr/include/postgresql/11/server/utils/acl.h"
...
# 37 "src/backend/catalog/ag_label.c" 2
...
# 40 "src/backend/catalog/ag_label.c" 2
...
# 41 "src/backend/catalog/ag_label.c" 2
...
Oid create_label(char *graph_name, char *label_name, char label_type,
                 List *parents);
# 42 "src/backend/catalog/ag_label.c" 2
# 1 ".//src/include/executor/cypher_utils.h" 1
# 24 ".//src/include/executor/cypher_utils.h"
...
# 158 "/usr/include/postgresql/11/server/nodes/extensible.h"
          missing_ok);
# 25 ".//src/include/executor/cypher_utils.h" 2
...
# 43 "src/backend/catalog/ag_label.c" 2
...
# 44 "src/backend/catalog/ag_label.c" 2
...
# 54 "src/backend/catalog/ag_label.c" 3 4
   _Bool 
# 54 "src/backend/catalog/ag_label.c"
        nulls[6];
    Relation ag_label;
    HeapTuple tuple;
    Oid label_oid;
    ...
    ((void)
# 63 "src/backend/catalog/ag_label.c" 3 4
   1
# 63 "src/backend/catalog/ag_label.c"
   );
    ((void)
# 64 "src/backend/catalog/ag_label.c" 3 4
   1
# 64 "src/backend/catalog/ag_label.c"
   );
    ((void)
# 65 "src/backend/catalog/ag_label.c" 3 4
   1
# 65 "src/backend/catalog/ag_label.c"
   );
    ((void)
# 66 "src/backend/catalog/ag_label.c" 3 4
   1
# 66 "src/backend/catalog/ag_label.c"
   )
                                            ;
    ((void)
# 68 "src/backend/catalog/ag_label.c" 3 4
   1
# 68 "src/backend/catalog/ag_label.c"
   );
    ((void)
# 69 "src/backend/catalog/ag_label.c" 3 4
   1
# 69 "src/backend/catalog/ag_label.c"
   );

    namestrcpy(&label_name_data, label_name);
    values[1 - 1] = ((Datum) (((*(&label_name_data)).data)));
    nulls[1 - 1] = 
# 73 "src/backend/catalog/ag_label.c" 3 4
                                   0
# 73 "src/backend/catalog/ag_label.c"
                                        ;

    values[2 - 1] = ((Datum) (label_graph));
    nulls[2 - 1] = 
# 76 "src/backend/catalog/ag_label.c" 3 4
                                    0
# 76 "src/backend/catalog/ag_label.c"
                                         ;

    values[3 - 1] = ((Datum) (label_id));
    nulls[3 - 1] = 
# 79 "src/backend/catalog/ag_label.c" 3 4
                                 0
# 79 "src/backend/catalog/ag_label.c"
                                      ;

    values[4 - 1] = ((Datum) (label_kind));
    nulls[4 - 1] = 
# 82 "src/backend/catalog/ag_label.c" 3 4
                                   0
# 82 "src/backend/catalog/ag_label.c"
                                        ;

    values[5 - 1] = ((Datum) (label_relation));
    nulls[5 - 1] = 
# 85 "src/backend/catalog/ag_label.c" 3 4
                                       0
# 85 "src/backend/catalog/ag_label.c"
                                            ;

    namestrcpy(&seq_name_data, seq_name);
    values[6 - 1] = ((Datum) (((*(&seq_name_data)).data)));
    nulls[6 - 1] = 
# 89 "src/backend/catalog/ag_label.c" 3 4
                                       0
# 89 "src/backend/catalog/ag_label.c"
                                            ;

    ag_label = heap_open(ag_relation_id("ag_label", "table"), 3);

    tuple = heap_form_tuple(((ag_label)->rd_att), values, nulls);
...
void delete_label(Oid relation)
{
    ...
    ScanKeyInit(&scan_keys[0], 5, 3,
                184, ((Datum) (relation)));

    ag_label = heap_open(ag_relation_id("ag_label", "table"), 3);
    scan_desc = systable_beginscan(ag_label, ag_relation_id("ag_label_relation_index", "index"),
                                   
# 119 "src/backend/catalog/ag_label.c" 3 4
                                  1
# 119 "src/backend/catalog/ag_label.c"
                                      , 
# 119 "src/backend/catalog/ag_label.c" 3 4
                                        ((void *)0)
# 119 "src/backend/catalog/ag_label.c"
    ...
    if (!((const void*)(tuple) != 
# 122 "src/backend/catalog/ag_label.c" 3 4
        ((void *)0)
# 122 "src/backend/catalog/ag_label.c"
        ))
    {
        do { if (errstart(20, "src/backend/catalog/ag_label.c", 124, __func__, 
# 124 "src/backend/catalog/ag_label.c" 3 4
       ((void *)0)
# 124 "src/backend/catalog/ag_label.c"
       )) errfinish (errcode((((('4') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('P') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('1') - '0') & 0x3F) << 24))), errmsg("label (relation=%u) does not exist", relation)); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
...
extern Datum _label_name(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo__label_name(void); const Pg_finfo_record * pg_finfo__label_name (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;





Datum _label_name(FunctionCallInfo fcinfo)
{
    char *label_name;
    ...
    if ((fcinfo->argnull[0]) || (fcinfo->argnull[1]))
        do { if (errstart(20, "src/backend/catalog/ag_label.c", 187, __func__, 
# 187 "src/backend/catalog/ag_label.c" 3 4
       ((void *)0)
# 187 "src/backend/catalog/ag_label.c"
       )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('4') - '0') & 0x3F) << 24))), errmsg("graph_oid and label_id must not be null")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                           ;

    graph = ((Oid) ((fcinfo->arg[0])));

    label_id = (int32)(((uint64)((int64) ((fcinfo->arg[1])))) >> (32 + 16));

    label_cache = search_label_graph_id_cache(graph, label_id);

    label_name = ((label_cache->name).data);

    if (((label_name != 
# 198 "src/backend/catalog/ag_label.c" 3 4
       ((void *)0) 
# 198 "src/backend/catalog/ag_label.c"
       && strcmp("_ag_label_edge", label_name) == 0) || (label_name != 
# 198 "src/backend/catalog/ag_label.c" 3 4
       ((void *)0) 
# 198 "src/backend/catalog/ag_label.c"
       && strcmp("_ag_label_vertex", label_name) == 0)))
        return ((Datum) (""));

    return ((Datum) (label_name));
}

extern Datum _label_id(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo__label_id(void); const Pg_finfo_record * pg_finfo__label_id (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;

Datum _label_id(FunctionCallInfo fcinfo)
{
    Name graph_name;
    Name label_name;
    Oid graph;
    ...
    if ((fcinfo->argnull[0]) || (fcinfo->argnull[1]))
    {
        do { if (errstart(20, "src/backend/catalog/ag_label.c", 215, __func__, 
# 215 "src/backend/catalog/ag_label.c" 3 4
       ((void *)0)
# 215 "src/backend/catalog/ag_label.c"
       )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('4') - '0') & 0x3F) << 24))), errmsg("graph_name and label_name must not be null")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                              ;
    }
    graph_name = ((Name) ((Pointer) ((fcinfo->arg[0]))));
    label_name = ((Name) ((Pointer) ((fcinfo->arg[1]))));

    graph = get_graph_oid(((*graph_name).data));
    id = get_label_id(((*label_name).data), graph);

    return ((Datum) (id));
}

extern Datum _extract_label_id(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo__extract_label_id(void); const Pg_finfo_record * pg_finfo__extract_label_id (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;

Datum _extract_label_id(FunctionCallInfo fcinfo)
{
    graphid graph_id;

    if ((fcinfo->argnull[0]))
    {
        do { if (errstart(20, "src/backend/catalog/ag_label.c", 235, __func__, 
# 235 "src/backend/catalog/ag_label.c" 3 4
       ((void *)0)
# 235 "src/backend/catalog/ag_label.c"
       )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('4') - '0') & 0x3F) << 24))), errmsg("graph_id must not be null")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                             ;
    }
    graph_id = ((int64) ((fcinfo->arg[0])));

    return ((Datum) (get_graphid_label_id(graph_id)));
}


# 243 "src/backend/catalog/ag_label.c" 3 4
_Bool 
# 243 "src/backend/catalog/ag_label.c"
    label_id_exists(Oid label_graph, int32 label_id)
{
    label_cache_data *cache_data;
    ...
    if (cache_data)
        return 
# 249 "src/backend/catalog/ag_label.c" 3 4
              1
# 249 "src/backend/catalog/ag_label.c"
                  ;
    else
        return 
# 251 "src/backend/catalog/ag_label.c" 3 4
              0
# 251 "src/backend/catalog/ag_label.c"
                   ;
}
...
# 277 "src/backend/catalog/ag_label.c"
List *get_all_edge_labels_per_graph(EState *estate, Oid graph_oid)
{
    List *labels = ((List *) 
# 279 "src/backend/catalog/ag_label.c" 3 4
                  ((void *)0)
# 279 "src/backend/catalog/ag_label.c"
                  );
    ...
    while(
# 300 "src/backend/catalog/ag_label.c" 3 4
         1
# 300 "src/backend/catalog/ag_label.c"
             )
    {
        Name label;
        
# 303 "src/backend/catalog/ag_label.c" 3 4
       _Bool 
# 303 "src/backend/catalog/ag_label.c"
            isNull;
        Datum datum;
        ...
        if (!((const void*)(tuple) != 
# 309 "src/backend/catalog/ag_label.c" 3 4
            ((void *)0)
# 309 "src/backend/catalog/ag_label.c"
            ))
            break;

        ExecStoreTuple(tuple, slot, 0, 
# 312 "src/backend/catalog/ag_label.c" 3 4
                                                  0
# 312 "src/backend/catalog/ag_label.c"
                                                       );

        datum = slot_getattr(slot, 1, &isNull);
        label = ((Name) ((Pointer) (datum)));
