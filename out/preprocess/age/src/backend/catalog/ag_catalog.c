# 0 "src/backend/catalog/ag_catalog.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/catalog/ag_catalog.c"
# 20 "src/backend/catalog/ag_catalog.c"
...
# 21 "src/backend/catalog/ag_catalog.c" 2
...
# 23 "src/backend/catalog/ag_catalog.c" 2
# 1 "/usr/include/postgresql/11/server/catalog/objectaccess.h" 1
# 42 "/usr/include/postgresql/11/server/catalog/objectaccess.h"
...
# 61 "/usr/include/postgresql/11/server/catalog/objectaccess.h" 3 4
_Bool 
# 61 "/usr/include/postgresql/11/server/catalog/objectaccess.h"
      is_internal;
...
# 95 "/usr/include/postgresql/11/server/catalog/objectaccess.h" 3 4
_Bool 
# 95 "/usr/include/postgresql/11/server/catalog/objectaccess.h"
      is_internal;
...
# 107 "/usr/include/postgresql/11/server/catalog/objectaccess.h" 3 4
_Bool 
# 107 "/usr/include/postgresql/11/server/catalog/objectaccess.h"
      ereport_on_violation;
# 116 "/usr/include/postgresql/11/server/catalog/objectaccess.h"
 
# 116 "/usr/include/postgresql/11/server/catalog/objectaccess.h" 3 4
_Bool 
# 116 "/usr/include/postgresql/11/server/catalog/objectaccess.h"
      result;
...
# 131 "/usr/include/postgresql/11/server/catalog/objectaccess.h" 3 4
     _Bool 
# 131 "/usr/include/postgresql/11/server/catalog/objectaccess.h"
          is_internal);
extern void RunObjectDropHook(Oid classId, Oid objectId, int subId,
      int dropflags);
extern void RunObjectPostAlterHook(Oid classId, Oid objectId, int subId,
        Oid auxiliaryId, 
# 135 "/usr/include/postgresql/11/server/catalog/objectaccess.h" 3 4
                        _Bool 
# 135 "/usr/include/postgresql/11/server/catalog/objectaccess.h"
                             is_internal);
extern 
# 136 "/usr/include/postgresql/11/server/catalog/objectaccess.h" 3 4
      _Bool 
# 136 "/usr/include/postgresql/11/server/catalog/objectaccess.h"
           RunNamespaceSearchHook(Oid objectId, 
# 136 "/usr/include/postgresql/11/server/catalog/objectaccess.h" 3 4
                                                _Bool 
# 136 "/usr/include/postgresql/11/server/catalog/objectaccess.h"
                                                     ereport_on_violation);
extern void RunFunctionExecuteHook(Oid objectId);
# 24 "src/backend/catalog/ag_catalog.c" 2
# 1 "/usr/include/postgresql/11/server/catalog/pg_class_d.h" 1
# 25 "src/backend/catalog/ag_catalog.c" 2
# 1 "/usr/include/postgresql/11/server/catalog/pg_namespace_d.h" 1
# 26 "src/backend/catalog/ag_catalog.c" 2
...
# 27 "src/backend/catalog/ag_catalog.c" 2
...
# 24 "/usr/include/postgresql/11/server/tcop/tcopprot.h"
# 1 "/usr/include/postgresql/11/server/nodes/plannodes.h" 1
# 17 "/usr/include/postgresql/11/server/nodes/plannodes.h"
...
# 25 "/usr/include/postgresql/11/server/tcop/tcopprot.h" 2
# 1 "/usr/include/postgresql/11/server/storage/procsignal.h" 1
# 17 "/usr/include/postgresql/11/server/storage/procsignal.h"
...
# 18 "/usr/include/postgresql/11/server/storage/procsignal.h" 2
...
# 28 "src/backend/catalog/ag_catalog.c" 2
...
# 29 "src/backend/catalog/ag_catalog.c" 2
...
# 31 "src/backend/catalog/ag_catalog.c" 2
...
# 32 "src/backend/catalog/ag_catalog.c" 2
...
# 18 "/usr/include/postgresql/11/server/access/genam.h"
...
# 33 "src/backend/catalog/ag_catalog.c" 2
...
# 35 "src/backend/catalog/ag_catalog.c" 2

static object_access_hook_type prev_object_access_hook;
static ProcessUtility_hook_type prev_process_utility_hook;
static 
# 38 "src/backend/catalog/ag_catalog.c" 3 4
      _Bool 
# 38 "src/backend/catalog/ag_catalog.c"
           prev_object_hook_is_set;
...
static 
# 47 "src/backend/catalog/ag_catalog.c" 3 4
      _Bool 
# 47 "src/backend/catalog/ag_catalog.c"
           is_age_drop(PlannedStmt *pstmt);
...
void object_access_hook_init(void)
{
    ...
    prev_object_hook_is_set = 
# 54 "src/backend/catalog/ag_catalog.c" 3 4
                             1
# 54 "src/backend/catalog/ag_catalog.c"
                                 ;
}
...
# 62 "src/backend/catalog/ag_catalog.c" 3 4
                                 ((void *)0)
# 62 "src/backend/catalog/ag_catalog.c"
                                     ;
        prev_object_hook_is_set = 
# 63 "src/backend/catalog/ag_catalog.c" 3 4
                                 0
# 63 "src/backend/catalog/ag_catalog.c"
                                      ;
    }
...
# 89 "src/backend/catalog/ag_catalog.c"
void ag_ProcessUtility_hook(PlannedStmt *pstmt, const char *queryString,
                             ProcessUtilityContext context, ParamListInfo params,
                             QueryEnvironment *queryEnv, DestReceiver *dest,
                             char *completionTag)
...
static 
# 124 "src/backend/catalog/ag_catalog.c" 3 4
      _Bool 
# 124 "src/backend/catalog/ag_catalog.c"
           is_age_drop(PlannedStmt *pstmt)
{
    ListCell *lc;
    DropStmt *drop_stmt;

    if (!((((const Node*)(pstmt->utilityStmt))->type) == T_DropStmt))
        return 
# 130 "src/backend/catalog/ag_catalog.c" 3 4
              0
# 130 "src/backend/catalog/ag_catalog.c"
                   ;

    drop_stmt = (DropStmt *)pstmt->utilityStmt;

    for ((lc) = list_head(drop_stmt->objects); (lc) != 
# 134 "src/backend/catalog/ag_catalog.c" 3 4
   ((void *)0)
# 134 "src/backend/catalog/ag_catalog.c"
   ; (lc) = ((lc)->next))
    {
        Node *obj = ((lc)->data.ptr_value);

        if (((((const Node*)(obj))->type) == T_String))
        {
            Value *val = (Value *)obj;
            ...
            if (!pg_strcasecmp(str, "age"))
                return 
# 144 "src/backend/catalog/ag_catalog.c" 3 4
                      1
# 144 "src/backend/catalog/ag_catalog.c"
                          ;
        }
    }

    return 
# 148 "src/backend/catalog/ag_catalog.c" 3 4
          0
# 148 "src/backend/catalog/ag_catalog.c"
               ;
}
                          ...
                          int sub_id, void *arg)
{
    ...
    drop_arg = arg;
# 181 "src/backend/catalog/ag_catalog.c"
    if (class_id == 2615)
    {
        graph_cache_data *cache_data;

        if (drop_arg->dropflags & 0x0001)
            return;
        ...
        if (cache_data)
        {
            ...
            do { if (errstart(20, "src/backend/catalog/ag_catalog.c", 193, __func__, 
# 193 "src/backend/catalog/ag_catalog.c" 3 4
           ((void *)0)
# 193 "src/backend/catalog/ag_catalog.c"
           )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('B') - '0') & 0x3F) << 6) + (((('P') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('1') - '0') & 0x3F) << 24))), errmsg("schema \"%s\" is for graph \"%s\"", nspname, ((cache_data->name).data))); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
    ...
    if (class_id == 1259)
    {
        ...
        else
        {
            ...
            do { if (errstart(20, "src/backend/catalog/ag_catalog.c", 224, __func__, 
# 224 "src/backend/catalog/ag_catalog.c" 3 4
           ((void *)0)
# 224 "src/backend/catalog/ag_catalog.c"
           )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('B') - '0') & 0x3F) << 6) + (((('P') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('1') - '0') & 0x3F) << 24))), errmsg("table \"%s\" is for label \"%s\"", relname, ((cache_data->name).data))); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
...
Oid ag_relation_id(const char *name, const char *kind)
{
    ...
    if (!((
# 236 "src/backend/catalog/ag_catalog.c" 3 4
        _Bool
# 236 "src/backend/catalog/ag_catalog.c"
        ) ((id) != ((Oid) 0))))
    {
        do { if (errstart(20, "src/backend/catalog/ag_catalog.c", 238, __func__, 
# 238 "src/backend/catalog/ag_catalog.c" 3 4
       ((void *)0)
# 238 "src/backend/catalog/ag_catalog.c"
       )) errfinish (errcode((((('4') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('P') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('1') - '0') & 0x3F) << 24))), errmsg("%s \"%s\" does not exist", kind, name)); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                        ;
    }
