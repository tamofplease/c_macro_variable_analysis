# 0 "src/backend/optimizer/cypher_pathnode.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/optimizer/cypher_pathnode.c"
# 20 "src/backend/optimizer/cypher_pathnode.c"
...
# 21 "src/backend/optimizer/cypher_pathnode.c" 2
...
# 158 "/usr/include/postgresql/11/server/nodes/extensible.h"
          missing_ok);
# 23 "src/backend/optimizer/cypher_pathnode.c" 2
...
Plan *plan_cypher_merge_path(PlannerInfo *root, RelOptInfo *rel,
                             CustomPath *best_path, List *tlist,
                             List *clauses, List *custom_plans);
# 28 "src/backend/optimizer/cypher_pathnode.c" 2
...
CustomPath *create_cypher_merge_path(PlannerInfo *root, RelOptInfo *rel,
                                     List *custom_private);
# 29 "src/backend/optimizer/cypher_pathnode.c" 2

const CustomPathMethods cypher_create_path_methods = {
    "Cypher Create", plan_cypher_create_path, 
# 31 "src/backend/optimizer/cypher_pathnode.c" 3 4
                                              ((void *)0)
# 31 "src/backend/optimizer/cypher_pathnode.c"
                                                  };
const CustomPathMethods cypher_set_path_methods = {
    "Cypher Set", plan_cypher_set_path, 
# 33 "src/backend/optimizer/cypher_pathnode.c" 3 4
                                        ((void *)0)
# 33 "src/backend/optimizer/cypher_pathnode.c"
                                            };
const CustomPathMethods cypher_delete_path_methods = {
    "Cypher Delete", plan_cypher_delete_path, 
# 35 "src/backend/optimizer/cypher_pathnode.c" 3 4
                                              ((void *)0)
# 35 "src/backend/optimizer/cypher_pathnode.c"
                                                  };
const CustomPathMethods cypher_merge_path_methods = {
    "Cypher Merge", plan_cypher_merge_path, 
# 37 "src/backend/optimizer/cypher_pathnode.c" 3 4
                                            ((void *)0)
# 37 "src/backend/optimizer/cypher_pathnode.c"
                                                };
                                      ...
                                      List *custom_private)
{
    ...
    cp = ((CustomPath *) ({ Node *_result; ((void)
# 44 "src/backend/optimizer/cypher_pathnode.c" 3 4
        1
# 44 "src/backend/optimizer/cypher_pathnode.c"
        ); _result = (Node *) ( ( ((sizeof(CustomPath)) & (sizeof(long) - 1)) == 0 && (sizeof(CustomPath)) <= 1024 && 1024 != 0 && (0) == 0 ) ? MemoryContextAllocZeroAligned(CurrentMemoryContext, sizeof(CustomPath)) : MemoryContextAllocZero(CurrentMemoryContext, sizeof(CustomPath)) ); _result->type = (T_CustomPath); _result; }));
    ...
    cp->path.param_info = 
# 51 "src/backend/optimizer/cypher_pathnode.c" 3 4
                         ((void *)0)
# 51 "src/backend/optimizer/cypher_pathnode.c"
                             ;


    cp->path.parallel_aware = 
# 54 "src/backend/optimizer/cypher_pathnode.c" 3 4
                             0
# 54 "src/backend/optimizer/cypher_pathnode.c"
                                  ;
    cp->path.parallel_safe = 
# 55 "src/backend/optimizer/cypher_pathnode.c" 3 4
                            0
# 55 "src/backend/optimizer/cypher_pathnode.c"
                                 ;
    ...
    cp->path.pathkeys = 
# 63 "src/backend/optimizer/cypher_pathnode.c" 3 4
                       ((void *)0)
# 63 "src/backend/optimizer/cypher_pathnode.c"
                           ;
                                   ...
                                   List *custom_private)
{
    ...
    cp = ((CustomPath *) ({ Node *_result; ((void)
# 80 "src/backend/optimizer/cypher_pathnode.c" 3 4
        1
# 80 "src/backend/optimizer/cypher_pathnode.c"
        ); _result = (Node *) ( ( ((sizeof(CustomPath)) & (sizeof(long) - 1)) == 0 && (sizeof(CustomPath)) <= 1024 && 1024 != 0 && (0) == 0 ) ? MemoryContextAllocZeroAligned(CurrentMemoryContext, sizeof(CustomPath)) : MemoryContextAllocZero(CurrentMemoryContext, sizeof(CustomPath)) ); _result->type = (T_CustomPath); _result; }));
    ...
    cp->path.param_info = 
# 87 "src/backend/optimizer/cypher_pathnode.c" 3 4
                         ((void *)0)
# 87 "src/backend/optimizer/cypher_pathnode.c"
                             ;


    cp->path.parallel_aware = 
# 90 "src/backend/optimizer/cypher_pathnode.c" 3 4
                             0
# 90 "src/backend/optimizer/cypher_pathnode.c"
                                  ;
    cp->path.parallel_safe = 
# 91 "src/backend/optimizer/cypher_pathnode.c" 3 4
                            0
# 91 "src/backend/optimizer/cypher_pathnode.c"
                                 ;
    cp->path.parallel_workers = 0;
    ...
    cp->path.pathkeys = 
# 99 "src/backend/optimizer/cypher_pathnode.c" 3 4
                       ((void *)0)
# 99 "src/backend/optimizer/cypher_pathnode.c"
                           ;
                                   ...
                                   List *custom_private)
{
    ...
    cp = ((CustomPath *) ({ Node *_result; ((void)
# 120 "src/backend/optimizer/cypher_pathnode.c" 3 4
        1
# 120 "src/backend/optimizer/cypher_pathnode.c"
        ); _result = (Node *) ( ( ((sizeof(CustomPath)) & (sizeof(long) - 1)) == 0 && (sizeof(CustomPath)) <= 1024 && 1024 != 0 && (0) == 0 ) ? MemoryContextAllocZeroAligned(CurrentMemoryContext, sizeof(CustomPath)) : MemoryContextAllocZero(CurrentMemoryContext, sizeof(CustomPath)) ); _result->type = (T_CustomPath); _result; }));
    ...
    cp->path.param_info = 
# 127 "src/backend/optimizer/cypher_pathnode.c" 3 4
                         ((void *)0)
# 127 "src/backend/optimizer/cypher_pathnode.c"
                             ;


    cp->path.parallel_aware = 
# 130 "src/backend/optimizer/cypher_pathnode.c" 3 4
                             0
# 130 "src/backend/optimizer/cypher_pathnode.c"
                                  ;
    cp->path.parallel_safe = 
# 131 "src/backend/optimizer/cypher_pathnode.c" 3 4
                            0
# 131 "src/backend/optimizer/cypher_pathnode.c"
                                 ;
    cp->path.parallel_workers = 0;
    ...
    cp->path.pathkeys = 
# 139 "src/backend/optimizer/cypher_pathnode.c" 3 4
                       ((void *)0)
# 139 "src/backend/optimizer/cypher_pathnode.c"
                           ;
                                   ...
                                   List *custom_private)
{
    ...
    cp = ((CustomPath *) ({ Node *_result; ((void)
# 163 "src/backend/optimizer/cypher_pathnode.c" 3 4
        1
# 163 "src/backend/optimizer/cypher_pathnode.c"
        ); _result = (Node *) ( ( ((sizeof(CustomPath)) & (sizeof(long) - 1)) == 0 && (sizeof(CustomPath)) <= 1024 && 1024 != 0 && (0) == 0 ) ? MemoryContextAllocZeroAligned(CurrentMemoryContext, sizeof(CustomPath)) : MemoryContextAllocZero(CurrentMemoryContext, sizeof(CustomPath)) ); _result->type = (T_CustomPath); _result; }));
    ...
    cp->path.param_info = 
# 170 "src/backend/optimizer/cypher_pathnode.c" 3 4
                         ((void *)0)
# 170 "src/backend/optimizer/cypher_pathnode.c"
                             ;


    cp->path.parallel_aware = 
# 173 "src/backend/optimizer/cypher_pathnode.c" 3 4
                             0
# 173 "src/backend/optimizer/cypher_pathnode.c"
                                  ;
    cp->path.parallel_safe = 
# 174 "src/backend/optimizer/cypher_pathnode.c" 3 4
                            0
# 174 "src/backend/optimizer/cypher_pathnode.c"
                                 ;
    cp->path.parallel_workers = 0;
    ...
    cp->path.pathkeys = 
# 182 "src/backend/optimizer/cypher_pathnode.c" 3 4
                       ((void *)0)
# 182 "src/backend/optimizer/cypher_pathnode.c"
                           ;
