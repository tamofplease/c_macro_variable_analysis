# 0 "src/backend/optimizer/cypher_createplan.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/optimizer/cypher_createplan.c"
# 20 "src/backend/optimizer/cypher_createplan.c"
...
# 21 "src/backend/optimizer/cypher_createplan.c" 2

# 1 "/usr/include/postgresql/11/server/access/sysattr.h" 1
# 23 "src/backend/optimizer/cypher_createplan.c" 2
# 1 "/usr/include/postgresql/11/server/catalog/pg_type_d.h" 1
# 24 "src/backend/optimizer/cypher_createplan.c" 2
...
# 158 "/usr/include/postgresql/11/server/nodes/extensible.h"
          missing_ok);
# 25 "src/backend/optimizer/cypher_createplan.c" 2
...
# 31 "src/backend/optimizer/cypher_createplan.c" 2
# 1 ".//src/include/optimizer/cypher_createplan.h" 1
# 27 ".//src/include/optimizer/cypher_createplan.h"
...
Plan *plan_cypher_merge_path(PlannerInfo *root, RelOptInfo *rel,
                             CustomPath *best_path, List *tlist,
                             List *clauses, List *custom_plans);
# 32 "src/backend/optimizer/cypher_createplan.c" 2
...
{
    CustomScan *cs;
    Plan *subplan = ((list_head(custom_plans))->data.ptr_value);

    cs = ((CustomScan *) ({ Node *_result; ((void)
# 49 "src/backend/optimizer/cypher_createplan.c" 3 4
        1
# 49 "src/backend/optimizer/cypher_createplan.c"
        ); _result = (Node *) ( ( ((sizeof(CustomScan)) & (sizeof(long) - 1)) == 0 && (sizeof(CustomScan)) <= 1024 && 1024 != 0 && (0) == 0 ) ? MemoryContextAllocZeroAligned(CurrentMemoryContext, sizeof(CustomScan)) : MemoryContextAllocZero(CurrentMemoryContext, sizeof(CustomScan)) ); _result->type = (T_CustomScan); _result; }));
    ...
    cs->scan.plan.qual = ((List *) 
# 62 "src/backend/optimizer/cypher_createplan.c" 3 4
                        ((void *)0)
# 62 "src/backend/optimizer/cypher_createplan.c"
                        );
    cs->scan.plan.lefttree = 
# 63 "src/backend/optimizer/cypher_createplan.c" 3 4
                            ((void *)0)
# 63 "src/backend/optimizer/cypher_createplan.c"
                                ;
    cs->scan.plan.righttree = 
# 64 "src/backend/optimizer/cypher_createplan.c" 3 4
                             ((void *)0)
# 64 "src/backend/optimizer/cypher_createplan.c"
                                 ;
    cs->scan.plan.initPlan = ((List *) 
# 65 "src/backend/optimizer/cypher_createplan.c" 3 4
                            ((void *)0)
# 65 "src/backend/optimizer/cypher_createplan.c"
                            );

    cs->scan.plan.extParam = 
# 67 "src/backend/optimizer/cypher_createplan.c" 3 4
                            ((void *)0)
# 67 "src/backend/optimizer/cypher_createplan.c"
                                ;
    cs->scan.plan.allParam = 
# 68 "src/backend/optimizer/cypher_createplan.c" 3 4
                            ((void *)0)
# 68 "src/backend/optimizer/cypher_createplan.c"
                                ;
    ...
    cs->custom_exprs = ((List *) 
# 75 "src/backend/optimizer/cypher_createplan.c" 3 4
                      ((void *)0)
# 75 "src/backend/optimizer/cypher_createplan.c"
                      );
    cs->custom_private = best_path->custom_private;
    cs->custom_scan_tlist = subplan->targetlist;
    cs->custom_relids = 
# 78 "src/backend/optimizer/cypher_createplan.c" 3 4
                       ((void *)0)
# 78 "src/backend/optimizer/cypher_createplan.c"
                           ;
                           ...
                           List *clauses, List *custom_plans)
{
    ...
    cs = ((CustomScan *) ({ Node *_result; ((void)
# 91 "src/backend/optimizer/cypher_createplan.c" 3 4
        1
# 91 "src/backend/optimizer/cypher_createplan.c"
        ); _result = (Node *) ( ( ((sizeof(CustomScan)) & (sizeof(long) - 1)) == 0 && (sizeof(CustomScan)) <= 1024 && 1024 != 0 && (0) == 0 ) ? MemoryContextAllocZeroAligned(CurrentMemoryContext, sizeof(CustomScan)) : MemoryContextAllocZero(CurrentMemoryContext, sizeof(CustomScan)) ); _result->type = (T_CustomScan); _result; }));
    ...
    cs->scan.plan.targetlist = tlist;
    cs->scan.plan.qual = ((List *) 
# 104 "src/backend/optimizer/cypher_createplan.c" 3 4
                        ((void *)0)
# 104 "src/backend/optimizer/cypher_createplan.c"
                        );
    cs->scan.plan.lefttree = 
# 105 "src/backend/optimizer/cypher_createplan.c" 3 4
                            ((void *)0)
# 105 "src/backend/optimizer/cypher_createplan.c"
                                ;
    cs->scan.plan.righttree = 
# 106 "src/backend/optimizer/cypher_createplan.c" 3 4
                             ((void *)0)
# 106 "src/backend/optimizer/cypher_createplan.c"
                                 ;
    cs->scan.plan.initPlan = ((List *) 
# 107 "src/backend/optimizer/cypher_createplan.c" 3 4
                            ((void *)0)
# 107 "src/backend/optimizer/cypher_createplan.c"
                            );

    cs->scan.plan.extParam = 
# 109 "src/backend/optimizer/cypher_createplan.c" 3 4
                            ((void *)0)
# 109 "src/backend/optimizer/cypher_createplan.c"
                                ;
    cs->scan.plan.allParam = 
# 110 "src/backend/optimizer/cypher_createplan.c" 3 4
                            ((void *)0)
# 110 "src/backend/optimizer/cypher_createplan.c"
                                ;
    ...
    cs->custom_plans = custom_plans;
    cs->custom_exprs = ((List *) 
# 117 "src/backend/optimizer/cypher_createplan.c" 3 4
                      ((void *)0)
# 117 "src/backend/optimizer/cypher_createplan.c"
                      );
    cs->custom_private = best_path->custom_private;
    cs->custom_scan_tlist = subplan->targetlist;

    cs->custom_relids = 
# 121 "src/backend/optimizer/cypher_createplan.c" 3 4
                       ((void *)0)
# 121 "src/backend/optimizer/cypher_createplan.c"
                           ;
                           ...
                           List *clauses, List *custom_plans)
{
    ...
    cs = ((CustomScan *) ({ Node *_result; ((void)
# 138 "src/backend/optimizer/cypher_createplan.c" 3 4
        1
# 138 "src/backend/optimizer/cypher_createplan.c"
        ); _result = (Node *) ( ( ((sizeof(CustomScan)) & (sizeof(long) - 1)) == 0 && (sizeof(CustomScan)) <= 1024 && 1024 != 0 && (0) == 0 ) ? MemoryContextAllocZeroAligned(CurrentMemoryContext, sizeof(CustomScan)) : MemoryContextAllocZero(CurrentMemoryContext, sizeof(CustomScan)) ); _result->type = (T_CustomScan); _result; }));
    ...
    cs->scan.plan.targetlist = tlist;
    cs->scan.plan.qual = ((List *) 
# 155 "src/backend/optimizer/cypher_createplan.c" 3 4
                        ((void *)0)
# 155 "src/backend/optimizer/cypher_createplan.c"
                        );
    cs->scan.plan.lefttree = 
# 156 "src/backend/optimizer/cypher_createplan.c" 3 4
                            ((void *)0)
# 156 "src/backend/optimizer/cypher_createplan.c"
                                ;
    cs->scan.plan.righttree = 
# 157 "src/backend/optimizer/cypher_createplan.c" 3 4
                             ((void *)0)
# 157 "src/backend/optimizer/cypher_createplan.c"
                                 ;
    cs->scan.plan.initPlan = ((List *) 
# 158 "src/backend/optimizer/cypher_createplan.c" 3 4
                            ((void *)0)
# 158 "src/backend/optimizer/cypher_createplan.c"
                            );

    cs->scan.plan.extParam = 
# 160 "src/backend/optimizer/cypher_createplan.c" 3 4
                            ((void *)0)
# 160 "src/backend/optimizer/cypher_createplan.c"
                                ;
    cs->scan.plan.allParam = 
# 161 "src/backend/optimizer/cypher_createplan.c" 3 4
                            ((void *)0)
# 161 "src/backend/optimizer/cypher_createplan.c"
                                ;
    ...
    cs->custom_plans = custom_plans;
    cs->custom_exprs = ((List *) 
# 173 "src/backend/optimizer/cypher_createplan.c" 3 4
                      ((void *)0)
# 173 "src/backend/optimizer/cypher_createplan.c"
                      );
    ...
    cs->custom_relids = 
# 182 "src/backend/optimizer/cypher_createplan.c" 3 4
                       ((void *)0)
# 182 "src/backend/optimizer/cypher_createplan.c"
                           ;
                           ...
                           List *clauses, List *custom_plans)
{
    ...
    cs = ((CustomScan *) ({ Node *_result; ((void)
# 199 "src/backend/optimizer/cypher_createplan.c" 3 4
        1
# 199 "src/backend/optimizer/cypher_createplan.c"
        ); _result = (Node *) ( ( ((sizeof(CustomScan)) & (sizeof(long) - 1)) == 0 && (sizeof(CustomScan)) <= 1024 && 1024 != 0 && (0) == 0 ) ? MemoryContextAllocZeroAligned(CurrentMemoryContext, sizeof(CustomScan)) : MemoryContextAllocZero(CurrentMemoryContext, sizeof(CustomScan)) ); _result->type = (T_CustomScan); _result; }));
    ...
    cs->scan.plan.targetlist = tlist;
    cs->scan.plan.qual = ((List *) 
# 216 "src/backend/optimizer/cypher_createplan.c" 3 4
                        ((void *)0)
# 216 "src/backend/optimizer/cypher_createplan.c"
                        );
    cs->scan.plan.lefttree = 
# 217 "src/backend/optimizer/cypher_createplan.c" 3 4
                            ((void *)0)
# 217 "src/backend/optimizer/cypher_createplan.c"
                                ;
    cs->scan.plan.righttree = 
# 218 "src/backend/optimizer/cypher_createplan.c" 3 4
                             ((void *)0)
# 218 "src/backend/optimizer/cypher_createplan.c"
                                 ;
    cs->scan.plan.initPlan = ((List *) 
# 219 "src/backend/optimizer/cypher_createplan.c" 3 4
                            ((void *)0)
# 219 "src/backend/optimizer/cypher_createplan.c"
                            );

    cs->scan.plan.extParam = 
# 221 "src/backend/optimizer/cypher_createplan.c" 3 4
                            ((void *)0)
# 221 "src/backend/optimizer/cypher_createplan.c"
                                ;
    cs->scan.plan.allParam = 
# 222 "src/backend/optimizer/cypher_createplan.c" 3 4
                            ((void *)0)
# 222 "src/backend/optimizer/cypher_createplan.c"
                                ;
    ...
    cs->custom_plans = custom_plans;
    cs->custom_exprs = ((List *) 
# 234 "src/backend/optimizer/cypher_createplan.c" 3 4
                      ((void *)0)
# 234 "src/backend/optimizer/cypher_createplan.c"
                      );
    ...
    cs->custom_relids = 
# 243 "src/backend/optimizer/cypher_createplan.c" 3 4
                       ((void *)0)
# 243 "src/backend/optimizer/cypher_createplan.c"
                           ;
