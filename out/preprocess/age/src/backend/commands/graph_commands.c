# 0 "src/backend/commands/graph_commands.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/commands/graph_commands.c"
# 20 "src/backend/commands/graph_commands.c"
...
# 21 "src/backend/commands/graph_commands.c" 2
...
# 23 "src/backend/commands/graph_commands.c" 2
...
# 24 "src/backend/commands/graph_commands.c" 2
...
# 25 "src/backend/commands/graph_commands.c" 2
...
# 26 "src/backend/commands/graph_commands.c" 2
...
# 28 "src/backend/commands/graph_commands.c" 2
...
# 29 "src/backend/commands/graph_commands.c" 2
...
# 100 "/usr/include/postgresql/11/server/commands/tablecmds.h"
          ...
          List *partConstraint);
# 30 "src/backend/commands/graph_commands.c" 2
...
# 32 "src/backend/commands/graph_commands.c" 2
...
# 33 "src/backend/commands/graph_commands.c" 2
...
# 38 "src/backend/commands/graph_commands.c" 2
# 1 "/usr/include/postgresql/11/server/utils/fmgroids.h" 1
# 39 "src/backend/commands/graph_commands.c" 2
...
# 41 "src/backend/commands/graph_commands.c" 2
...
# 43 "src/backend/commands/graph_commands.c" 2
...
# 44 "src/backend/commands/graph_commands.c" 2
...
Oid create_label(char *graph_name, char *label_name, char label_type,
                 List *parents);
# 45 "src/backend/commands/graph_commands.c" 2
# 53 "src/backend/commands/graph_commands.c"
static Oid create_schema_for_graph(const Name graph_name);
static void drop_schema_for_graph(char *graph_name_str, const 
# 54 "src/backend/commands/graph_commands.c" 3 4
                                                             _Bool 
# 54 "src/backend/commands/graph_commands.c"
                                                                  cascade);
...
extern Datum create_graph(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_create_graph(void); const Pg_finfo_record * pg_finfo_create_graph (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
...
Datum create_graph(FunctionCallInfo fcinfo)
{
    ...
    if ((fcinfo->argnull[0]))
    {
        do { if (errstart(20, "src/backend/commands/graph_commands.c", 69, __func__, 
# 69 "src/backend/commands/graph_commands.c" 3 4
       ((void *)0)
# 69 "src/backend/commands/graph_commands.c"
    ...
    {
        do { if (errstart(20, "src/backend/commands/graph_commands.c", 78, __func__, 
# 78 "src/backend/commands/graph_commands.c" 3 4
       ((void *)0)
# 78 "src/backend/commands/graph_commands.c"
       )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('2') - '0') & 0x3F) << 18) + (((('3') - '0') & 0x3F) << 24))), errmsg("graph name can not be empty")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)

                                                               ;
    }
    if (((
# 82 "src/backend/commands/graph_commands.c" 3 4
       _Bool
# 82 "src/backend/commands/graph_commands.c"
       ) ((get_graph_oid(graph_name_str)) != ((Oid) 0))))
    {
        do { if (errstart(20, "src/backend/commands/graph_commands.c", 84, __func__, 
# 84 "src/backend/commands/graph_commands.c" 3 4
       ((void *)0)
# 84 "src/backend/commands/graph_commands.c"
       )) errfinish (errcode((((('3') - '0') & 0x3F) + (((('F') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("graph \"%s\" already exists", graph_name_str)); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
    ...
    create_label(graph, "_ag_label_vertex", 'v', ((List *) 
# 98 "src/backend/commands/graph_commands.c" 3 4
                                                                   ((void *)0)
# 98 "src/backend/commands/graph_commands.c"
                                                                   ));
    create_label(graph, "_ag_label_edge", 'e', ((List *) 
# 99 "src/backend/commands/graph_commands.c" 3 4
                                                               ((void *)0)
# 99 "src/backend/commands/graph_commands.c"
                                                               ));

    do { if (errstart(18, "src/backend/commands/graph_commands.c", 101, __func__, 
# 101 "src/backend/commands/graph_commands.c" 3 4
   ((void *)0)
# 101 "src/backend/commands/graph_commands.c"
   )) errfinish (errmsg("graph \"%s\" has been created", ((*graph_name).data))); if (__builtin_constant_p(18) && (18) >= 20) __builtin_unreachable(); } while(0)
                                                                            ;
...
static Oid create_schema_for_graph(const Name graph_name)
{
    char *graph_name_str = ((*graph_name).data);
    ...
    DefElem *cycle;
    Oid nsp_id;
# 135 "src/backend/commands/graph_commands.c"
    schema_stmt = ((CreateSchemaStmt *) ({ Node *_result; ((void)
# 135 "src/backend/commands/graph_commands.c" 3 4
                 1
# 135 "src/backend/commands/graph_commands.c"
                 ); _result = (Node *) ( ( ((sizeof(CreateSchemaStmt)) & (sizeof(long) - 1)) == 0 && (sizeof(CreateSchemaStmt)) <= 1024 && 1024 != 0 && (0) == 0 ) ? MemoryContextAllocZeroAligned(CurrentMemoryContext, sizeof(CreateSchemaStmt)) : MemoryContextAllocZero(CurrentMemoryContext, sizeof(CreateSchemaStmt)) ); _result->type = (T_CreateSchemaStmt); _result; }));
    schema_stmt->schemaname = (graph_name_str);
    schema_stmt->authrole = 
# 137 "src/backend/commands/graph_commands.c" 3 4
                           ((void *)0)
# 137 "src/backend/commands/graph_commands.c"
                               ;
    seq_stmt = ((CreateSeqStmt *) ({ Node *_result; ((void)
# 138 "src/backend/commands/graph_commands.c" 3 4
              1
# 138 "src/backend/commands/graph_commands.c"
    ...
    seq_stmt->sequence = makeRangeVar(graph_name_str, "_label_id_seq", -1);
    integer = SystemTypeName("int4");
    data_type = makeDefElem("as", (Node *)integer, -1);
    maxvalue = makeDefElem("maxvalue", (Node *)makeInteger((0xFFFF)), -1);
    cycle = makeDefElem("cycle", (Node *)makeInteger(
# 143 "src/backend/commands/graph_commands.c" 3 4
                                                    1
# 143 "src/backend/commands/graph_commands.c"
                                                        ), -1);
    seq_stmt->options = lcons(data_type, lcons(maxvalue, lcons(cycle, ((List *) 
# 144 "src/backend/commands/graph_commands.c" 3 4
                       ((void *)0)
# 144 "src/backend/commands/graph_commands.c"
                       ))));
    seq_stmt->ownerId = ((Oid) 0);
    seq_stmt->for_identity = 
# 146 "src/backend/commands/graph_commands.c" 3 4
                            0
# 146 "src/backend/commands/graph_commands.c"
                                 ;
    seq_stmt->if_not_exists = 
# 147 "src/backend/commands/graph_commands.c" 3 4
                             0
# 147 "src/backend/commands/graph_commands.c"
                                  ;
    schema_stmt->schemaElts = lcons(seq_stmt, ((List *) 
# 148 "src/backend/commands/graph_commands.c" 3 4
                             ((void *)0)
# 148 "src/backend/commands/graph_commands.c"
                             ));
    schema_stmt->if_not_exists = 
# 149 "src/backend/commands/graph_commands.c" 3 4
                                0
# 149 "src/backend/commands/graph_commands.c"
                                     ;
...
extern Datum drop_graph(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_drop_graph(void); const Pg_finfo_record * pg_finfo_drop_graph (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;

Datum drop_graph(FunctionCallInfo fcinfo)
{
    Name graph_name;
    char *graph_name_str;
    
# 163 "src/backend/commands/graph_commands.c" 3 4
   _Bool 
# 163 "src/backend/commands/graph_commands.c"
        cascade;

    if ((fcinfo->argnull[0]))
    {
        do { if (errstart(20, "src/backend/commands/graph_commands.c", 167, __func__, 
# 167 "src/backend/commands/graph_commands.c" 3 4
       ((void *)0)
# 167 "src/backend/commands/graph_commands.c"
       )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('2') - '0') & 0x3F) << 18) + (((('3') - '0') & 0x3F) << 24))), errmsg("graph name can not be NULL")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                              ;
    }
    graph_name = ((Name) ((Pointer) ((fcinfo->arg[0]))));
    cascade = ((
# 171 "src/backend/commands/graph_commands.c" 3 4
             _Bool
# 171 "src/backend/commands/graph_commands.c"
             ) (((fcinfo->arg[1])) != 0));

    graph_name_str = ((*graph_name).data);
    if (!((
# 174 "src/backend/commands/graph_commands.c" 3 4
        _Bool
# 174 "src/backend/commands/graph_commands.c"
        ) ((get_graph_oid(graph_name_str)) != ((Oid) 0))))
    {
        do { if (errstart(20, "src/backend/commands/graph_commands.c", 176, __func__, 
# 176 "src/backend/commands/graph_commands.c" 3 4
       ((void *)0)
# 176 "src/backend/commands/graph_commands.c"
    ...
    do { if (errstart(18, "src/backend/commands/graph_commands.c", 186, __func__, 
# 186 "src/backend/commands/graph_commands.c" 3 4
   ((void *)0)
# 186 "src/backend/commands/graph_commands.c"
   )) errfinish (errmsg("graph \"%s\" has been dropped", graph_name_str)); if (__builtin_constant_p(18) && (18) >= 20) __builtin_unreachable(); } while(0);

    return (Datum) 0;
}

static void drop_schema_for_graph(char *graph_name_str, const 
# 191 "src/backend/commands/graph_commands.c" 3 4
                                                             _Bool 
# 191 "src/backend/commands/graph_commands.c"
                                                                  cascade)
{
    DropStmt *drop_stmt;
    Value *schema_name;
    ...
    drop_stmt = ((DropStmt *) ({ Node *_result; ((void)
# 204 "src/backend/commands/graph_commands.c" 3 4
               1
# 204 "src/backend/commands/graph_commands.c"
               ); _result = (Node *) ( ( ((sizeof(DropStmt)) & (sizeof(long) - 1)) == 0 && (sizeof(DropStmt)) <= 1024 && 1024 != 0 && (0) == 0 ) ? MemoryContextAllocZeroAligned(CurrentMemoryContext, sizeof(DropStmt)) : MemoryContextAllocZero(CurrentMemoryContext, sizeof(DropStmt)) ); _result->type = (T_DropStmt); _result; }));
    schema_name = makeString(get_graph_namespace_name(graph_name_str));
    label_id_seq_name = lcons(schema_name, lcons(makeString("_label_id_seq"), ((List *) 
# 206 "src/backend/commands/graph_commands.c" 3 4
                       ((void *)0)
# 206 "src/backend/commands/graph_commands.c"
                       )));
    drop_stmt->objects = lcons(label_id_seq_name, ((List *) 
# 207 "src/backend/commands/graph_commands.c" 3 4
                        ((void *)0)
# 207 "src/backend/commands/graph_commands.c"
                        ));
    drop_stmt->removeType = OBJECT_SEQUENCE;
    drop_stmt->behavior = DROP_RESTRICT;
    drop_stmt->missing_ok = 
# 210 "src/backend/commands/graph_commands.c" 3 4
                           0
# 210 "src/backend/commands/graph_commands.c"
                                ;
    drop_stmt->concurrent = 
# 211 "src/backend/commands/graph_commands.c" 3 4
                           0
# 211 "src/backend/commands/graph_commands.c"
                                ;
...
static void remove_schema(Node *schema_name, DropBehavior behavior)
{
    ...
    address = get_object_address(OBJECT_SCHEMA, schema_name, &relation,
                                 8, 
# 229 "src/backend/commands/graph_commands.c" 3 4
                                                     0
# 229 "src/backend/commands/graph_commands.c"
                                                          );

    ((void)
# 231 "src/backend/commands/graph_commands.c" 3 4
   1
# 231 "src/backend/commands/graph_commands.c"
   );

    if (!((
# 233 "src/backend/commands/graph_commands.c" 3 4
        _Bool
# 233 "src/backend/commands/graph_commands.c"
        ) ((address.objectId) != ((Oid) 0))))
    {
        ...
        do { if (errstart(20, "src/backend/commands/graph_commands.c", 241, __func__, 
# 241 "src/backend/commands/graph_commands.c" 3 4
       ((void *)0)
# 241 "src/backend/commands/graph_commands.c"
       )) errfinish (errcode((((('X') - '0') & 0x3F) + (((('X') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('0') - '0') & 0x3F) << 24))), errmsg("ag_graph catalog is corrupted"), errhint("Schema \"%s\" does not exist", (((Value *)(schema_name))->val.str))); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
...
# 254 "src/backend/commands/graph_commands.c" 3 4
                          ((void *)0)
# 254 "src/backend/commands/graph_commands.c"
                              );
# 264 "src/backend/commands/graph_commands.c"
    performDeletion(&address, behavior, 0x0001);
}

extern Datum alter_graph(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_alter_graph(void); const Pg_finfo_record * pg_finfo_alter_graph (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
# 276 "src/backend/commands/graph_commands.c"
Datum alter_graph(FunctionCallInfo fcinfo)
{
    Name graph_name;
    Name new_value;
    char *operation;
    ...
    if ((fcinfo->argnull[0]))
    {
        do { if (errstart(20, "src/backend/commands/graph_commands.c", 284, __func__, 
# 284 "src/backend/commands/graph_commands.c" 3 4
       ((void *)0)
# 284 "src/backend/commands/graph_commands.c"
       )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('2') - '0') & 0x3F) << 18) + (((('3') - '0') & 0x3F) << 24))), errmsg("graph_name must not be NULL")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                               ;
    }
    if ((fcinfo->argnull[1]))
    {
        do { if (errstart(20, "src/backend/commands/graph_commands.c", 289, __func__, 
# 289 "src/backend/commands/graph_commands.c" 3 4
       ((void *)0)
# 289 "src/backend/commands/graph_commands.c"
       )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('2') - '0') & 0x3F) << 18) + (((('3') - '0') & 0x3F) << 24))), errmsg("operation must not be NULL")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                              ;
    }
    if ((fcinfo->argnull[2]))
    {
        do { if (errstart(20, "src/backend/commands/graph_commands.c", 294, __func__, 
# 294 "src/backend/commands/graph_commands.c" 3 4
       ((void *)0)
# 294 "src/backend/commands/graph_commands.c"
       )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('2') - '0') & 0x3F) << 18) + (((('3') - '0') & 0x3F) << 24))), errmsg("new_value must not be NULL")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                              ;
    }

    graph_name = ((Name) ((Pointer) ((fcinfo->arg[0]))));
    operation = ((char *) ((Pointer) ((fcinfo->arg[1]))));
    new_value = ((Name) ((Pointer) ((fcinfo->arg[2]))));
    ...
    {
        do { if (errstart(20, "src/backend/commands/graph_commands.c", 308, __func__, 
# 308 "src/backend/commands/graph_commands.c" 3 4
       ((void *)0)
# 308 "src/backend/commands/graph_commands.c"
       )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('2') - '0') & 0x3F) << 18) + (((('3') - '0') & 0x3F) << 24))), errmsg("invalid operation \"%s\"", operation), errhint("valid operations: RENAME")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
...
static void rename_graph(const Name graph_name, const Name new_name)
{
    char *oldname = ((*graph_name).data);
    char *newname = ((*new_name).data);
    char *schema_name;
# 335 "src/backend/commands/graph_commands.c"
    ...
    do { if (errstart(18, "src/backend/commands/graph_commands.c", 341, __func__, 
# 341 "src/backend/commands/graph_commands.c" 3 4
   ((void *)0)
# 341 "src/backend/commands/graph_commands.c"
   )) errfinish (errmsg("graph \"%s\" renamed to \"%s\"", oldname, newname)); if (__builtin_constant_p(18) && (18) >= 20) __builtin_unreachable(); } while(0)
                                                                         ;
}
...
List *get_graphnames(void)
{
    ...
    HeapTuple tuple;
    List *graphnames = ((List *) 
# 352 "src/backend/commands/graph_commands.c" 3 4
                      ((void *)0)
# 352 "src/backend/commands/graph_commands.c"
                      );
    char *str;

    ag_graph = heap_open(ag_relation_id("ag_graph", "table"), 3);
    scan_desc = systable_beginscan(ag_graph, ag_relation_id("ag_graph_name_index", "index"), 
# 356 "src/backend/commands/graph_commands.c" 3 4
                                                                      1
# 356 "src/backend/commands/graph_commands.c"
                                                                          ,
                                   
# 357 "src/backend/commands/graph_commands.c" 3 4
                                  ((void *)0)
# 357 "src/backend/commands/graph_commands.c"
                                      , 0, 
# 357 "src/backend/commands/graph_commands.c" 3 4
                                           ((void *)0)
# 357 "src/backend/commands/graph_commands.c"
    ...
    slot = MakeTupleTableSlot(((ag_graph)->rd_att));

    for (;;)
    {
        tuple = systable_getnext(scan_desc);
        if (!((const void*)(tuple) != 
# 364 "src/backend/commands/graph_commands.c" 3 4
            ((void *)0)
# 364 "src/backend/commands/graph_commands.c"
            ))
            break;

        ExecClearTuple(slot);
        ExecStoreTuple(tuple, slot, 0, 
# 368 "src/backend/commands/graph_commands.c" 3 4
                                                  0
# 368 "src/backend/commands/graph_commands.c"
                                                       );

        slot_getallattrs(slot);

        str = ((char *) ((Pointer) (slot->tts_values[0])));
        graphnames = lappend(graphnames, str);
    }

    ExecDropSingleTupleTableSlot(slot);
    systable_endscan(scan_desc);
    relation_close(ag_graph,3);
...
void drop_graphs(List *graphnames)
{
    ...
    for ((lc) = list_head(graphnames); (lc) != 
# 388 "src/backend/commands/graph_commands.c" 3 4
   ((void *)0)
# 388 "src/backend/commands/graph_commands.c"
   ; (lc) = ((lc)->next))
    {
        char *graphname = ((lc)->data.ptr_value);

        DirectFunctionCall2Coll(drop_graph, ((Oid) 0), ((Datum) (graphname)), ((Datum) ((
# 392 "src/backend/commands/graph_commands.c" 3 4
       1
# 392 "src/backend/commands/graph_commands.c"
       ) ? 1 : 0)))
                                                                       ;
    }
}
