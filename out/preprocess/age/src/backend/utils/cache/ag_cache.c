# 0 "src/backend/utils/cache/ag_cache.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/utils/cache/ag_cache.c"
# 20 "src/backend/utils/cache/ag_cache.c"
...
# 24 "src/backend/utils/cache/ag_cache.c" 2
...
# 25 "src/backend/utils/cache/ag_cache.c" 2
...
# 27 "src/backend/utils/cache/ag_cache.c" 2


# 1 "/usr/include/postgresql/11/server/access/sysattr.h" 1
# 30 "src/backend/utils/cache/ag_cache.c" 2
...
# 34 "src/backend/utils/cache/ag_cache.c" 2
# 1 "/usr/include/postgresql/11/server/utils/catcache.h" 1
# 25 "/usr/include/postgresql/11/server/utils/catcache.h"
...
# 26 "/usr/include/postgresql/11/server/utils/catcache.h" 2
# 39 "/usr/include/postgresql/11/server/utils/catcache.h"
typedef uint32 (*CCHashFN) (Datum datum);


typedef 
# 42 "/usr/include/postgresql/11/server/utils/catcache.h" 3 4
       _Bool 
# 42 "/usr/include/postgresql/11/server/utils/catcache.h"
            (*CCFastEqualFN) (Datum a, Datum b);
...
# 60 "/usr/include/postgresql/11/server/utils/catcache.h" 3 4
_Bool 
# 60 "/usr/include/postgresql/11/server/utils/catcache.h"
      cc_relisshared;
 slist_node cc_next;
 ScanKeyData cc_skey[4];
# 83 "/usr/include/postgresql/11/server/utils/catcache.h"
} CatCache;
...
# 118 "/usr/include/postgresql/11/server/utils/catcache.h"
 int refcount;
 
# 119 "/usr/include/postgresql/11/server/utils/catcache.h" 3 4
_Bool 
# 119 "/usr/include/postgresql/11/server/utils/catcache.h"
      dead;
 
# 120 "/usr/include/postgresql/11/server/utils/catcache.h" 3 4
_Bool 
# 120 "/usr/include/postgresql/11/server/utils/catcache.h"
      negative;
 HeapTupleData tuple;
# 130 "/usr/include/postgresql/11/server/utils/catcache.h"
 struct catclist *c_list;

 CatCache *my_cache;

} CatCTup;
# 157 "/usr/include/postgresql/11/server/utils/catcache.h"
...
# 173 "/usr/include/postgresql/11/server/utils/catcache.h" 3 4
_Bool 
# 173 "/usr/include/postgresql/11/server/utils/catcache.h"
      dead;
 
# 174 "/usr/include/postgresql/11/server/utils/catcache.h" 3 4
_Bool 
# 174 "/usr/include/postgresql/11/server/utils/catcache.h"
      ordered;
 short nkeys;
 int n_members;
 CatCache *my_cache;
...
# 197 "/usr/include/postgresql/11/server/utils/catcache.h" 3 4
                                               _Bool 
# 197 "/usr/include/postgresql/11/server/utils/catcache.h"
                                                    touch_index);
...
# 35 "src/backend/utils/cache/ag_cache.c" 2
# 1 "/usr/include/postgresql/11/server/utils/fmgroids.h" 1
# 36 "src/backend/utils/cache/ag_cache.c" 2
...
# 37 "src/backend/utils/cache/ag_cache.c" 2
# 1 "/usr/include/postgresql/11/server/utils/inval.h" 1
# 18 "/usr/include/postgresql/11/server/utils/inval.h"
...
# 19 "/usr/include/postgresql/11/server/utils/inval.h" 2
...
# 66 "/usr/include/postgresql/11/server/utils/inval.h"
                                               debug_discard);
# 38 "src/backend/utils/cache/ag_cache.c" 2
...
extern MemoryContext GenerationContextCreate(MemoryContext parent,
      const char *name,
      Size blockSize);
# 39 "src/backend/utils/cache/ag_cache.c" 2
...
# 40 "src/backend/utils/cache/ag_cache.c" 2
...
# 42 "src/backend/utils/cache/ag_cache.c" 2
...
# 31 ".//src/include/utils/graphid.h"
...
# 44 "src/backend/utils/cache/ag_cache.c" 2
...
# 19 "/usr/include/postgresql/11/server/nodes/execnodes.h"
...
# 45 "src/backend/utils/cache/ag_cache.c" 2
...
# 46 "src/backend/utils/cache/ag_cache.c" 2
...
static HTAB *graph_name_cache_hash = 
# 103 "src/backend/utils/cache/ag_cache.c" 3 4
                                    ((void *)0)
# 103 "src/backend/utils/cache/ag_cache.c"
                                        ;
static ScanKeyData graph_name_scan_keys[1];


static HTAB *graph_namespace_cache_hash = 
# 107 "src/backend/utils/cache/ag_cache.c" 3 4
                                         ((void *)0)
# 107 "src/backend/utils/cache/ag_cache.c"
                                             ;
static ScanKeyData graph_namespace_scan_keys[1];


static HTAB *label_oid_cache_hash = 
# 111 "src/backend/utils/cache/ag_cache.c" 3 4
                                   ((void *)0)
# 111 "src/backend/utils/cache/ag_cache.c"
                                       ;
static ScanKeyData label_oid_scan_keys[1];


static HTAB *label_name_graph_cache_hash = 
# 115 "src/backend/utils/cache/ag_cache.c" 3 4
                                          ((void *)0)
# 115 "src/backend/utils/cache/ag_cache.c"
                                              ;
static ScanKeyData label_name_graph_scan_keys[2];


static HTAB *label_graph_id_cache_hash = 
# 119 "src/backend/utils/cache/ag_cache.c" 3 4
                                        ((void *)0)
# 119 "src/backend/utils/cache/ag_cache.c"
                                            ;
static ScanKeyData label_graph_id_scan_keys[2];


static HTAB *label_relation_cache_hash = 
# 123 "src/backend/utils/cache/ag_cache.c" 3 4
                                        ((void *)0)
# 123 "src/backend/utils/cache/ag_cache.c"
                                            ;
static ScanKeyData label_relation_scan_keys[1];


static HTAB *label_seq_name_graph_cache_hash = 
# 127 "src/backend/utils/cache/ag_cache.c" 3 4
                                              ((void *)0)
# 127 "src/backend/utils/cache/ag_cache.c"
                                                  ;
...
# 177 "src/backend/utils/cache/ag_cache.c" 3 4
                                               _Bool 
# 177 "src/backend/utils/cache/ag_cache.c"
                                                    *found);
...
static void *label_graph_id_cache_hash_search(Oid graph, int32 id,
                                              HASHACTION action, 
# 180 "src/backend/utils/cache/ag_cache.c" 3 4
                                                                _Bool 
# 180 "src/backend/utils/cache/ag_cache.c"
                                                                     *found);
...
# 186 "src/backend/utils/cache/ag_cache.c" 3 4
                                               _Bool 
# 186 "src/backend/utils/cache/ag_cache.c"
                                                    *found);
...
{
    static 
# 193 "src/backend/utils/cache/ag_cache.c" 3 4
          _Bool 
# 193 "src/backend/utils/cache/ag_cache.c"
               initialized = 
# 193 "src/backend/utils/cache/ag_cache.c" 3 4
                             0
# 193 "src/backend/utils/cache/ag_cache.c"
    ...
    initialized = 
# 204 "src/backend/utils/cache/ag_cache.c" 3 4
                 1
# 204 "src/backend/utils/cache/ag_cache.c"
                     ;
}
                                   ...
                                   RegProcedure func)
{
    ...
    entry->sk_strategy = 3;
    entry->sk_subtype = ((Oid) 0);
    entry->sk_collation = ((Oid) 0);
...
static int name_hash_compare(const void *key1, const void *key2, Size keysize)
{
    ...
    ((void)
# 225 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 225 "src/backend/utils/cache/ag_cache.c"
   );

    return strncmp(((*name1).data), ((*name2).data), 64);
}

static void initialize_graph_caches(void)
{

    ag_cache_scan_key_init(&graph_name_scan_keys[0], 1,
                           62);
...
static void create_graph_name_cache(void)
{
    ...
    do { void *_vstart = (void *) (&hash_ctl); int _val = (0); Size _len = (sizeof(hash_ctl)); if ((((uintptr_t) _vstart) & (sizeof(long) - 1)) == 0 && (_len & (sizeof(long) - 1)) == 0 && _val == 0 && _len <= 1024 && 1024 != 0) { long *_start = (long *) _vstart; long *_stop = (long *) ((char *) _start + _len); while (_start < _stop) *_start++ = 0; } else memset(_vstart, _val, _len); } while (0);
...
{
    ((void)
# 296 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 296 "src/backend/utils/cache/ag_cache.c"
   );
...
# 322 "src/backend/utils/cache/ag_cache.c" 3 4
                             ((void *)0)
# 322 "src/backend/utils/cache/ag_cache.c"
                                 );
        if (!removed)
            do { if (errstart(20, "src/backend/utils/cache/ag_cache.c", 324, __func__, 
# 324 "src/backend/utils/cache/ag_cache.c" 3 4
           ((void *)0)
# 324 "src/backend/utils/cache/ag_cache.c"
           )) errfinish (errmsg_internal("graph (name) cache corrupted")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0);
    }
}
...
static void flush_graph_namespace_cache(void)
{
    ...
    for (;;)
    {
        ...
        removed = hash_search(graph_namespace_cache_hash, &entry->namespace,
                              HASH_REMOVE, 
# 343 "src/backend/utils/cache/ag_cache.c" 3 4
                                          ((void *)0)
# 343 "src/backend/utils/cache/ag_cache.c"
                                              );
        if (!removed)
        {
            do { if (errstart(20, "src/backend/utils/cache/ag_cache.c", 346, __func__, 
# 346 "src/backend/utils/cache/ag_cache.c" 3 4
           ((void *)0)
# 346 "src/backend/utils/cache/ag_cache.c"
           )) errfinish (errmsg_internal("graph (namespace) cache corrupted")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                           ;
        }
    }
}
...
graph_cache_data *search_graph_name_cache(const char *name)
{
    ...
    ((void)
# 357 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 357 "src/backend/utils/cache/ag_cache.c"
   );

    initialize_caches();

    namestrcpy(&name_key, name);
    entry = hash_search(graph_name_cache_hash, &name_key, HASH_FIND, 
# 362 "src/backend/utils/cache/ag_cache.c" 3 4
                                                                    ((void *)0)
# 362 "src/backend/utils/cache/ag_cache.c"
                                                                        );
    if (entry)
        return &entry->data;
...
# 375 "src/backend/utils/cache/ag_cache.c" 3 4
   _Bool 
# 375 "src/backend/utils/cache/ag_cache.c"
        found;
    graph_name_cache_entry *entry;

    memcpy(scan_keys, graph_name_scan_keys, sizeof(graph_name_scan_keys));
    scan_keys[0].sk_argument = ((Datum) (((*(name)).data)));
    ...
    ag_graph = heap_open(ag_relation_id("ag_graph", "table"), 1);
    scan_desc = systable_beginscan(ag_graph, ag_relation_id("ag_graph_name_index", "index"), 
# 387 "src/backend/utils/cache/ag_cache.c" 3 4
                                                                      1
# 387 "src/backend/utils/cache/ag_cache.c"
                                                                          ,
                                   
# 388 "src/backend/utils/cache/ag_cache.c" 3 4
                                  ((void *)0)
# 388 "src/backend/utils/cache/ag_cache.c"
                                      , 1, scan_keys);


    tuple = systable_getnext(scan_desc);
    if (!((const void*)(tuple) != 
# 392 "src/backend/utils/cache/ag_cache.c" 3 4
        ((void *)0)
# 392 "src/backend/utils/cache/ag_cache.c"
        ))
    {
        systable_endscan(scan_desc);
        relation_close(ag_graph,1);

        return 
# 397 "src/backend/utils/cache/ag_cache.c" 3 4
              ((void *)0)
# 397 "src/backend/utils/cache/ag_cache.c"
                  ;
    }
    ...
    ((void)
# 402 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 402 "src/backend/utils/cache/ag_cache.c"
   );


    fill_graph_cache_data(&entry->data, tuple, ((ag_graph)->rd_att));
...
# 420 "src/backend/utils/cache/ag_cache.c" 3 4
                       ((void *)0)
# 420 "src/backend/utils/cache/ag_cache.c"
                           );
    if (entry)
        return &entry->data;
...
# 433 "src/backend/utils/cache/ag_cache.c" 3 4
   _Bool 
# 433 "src/backend/utils/cache/ag_cache.c"
        found;
    graph_namespace_cache_entry *entry;

    memcpy(scan_keys, graph_namespace_scan_keys,
           sizeof(graph_namespace_scan_keys));
    scan_keys[0].sk_argument = ((Datum) (namespace));
    ...
    ag_graph = heap_open(ag_relation_id("ag_graph", "table"), 1);
    scan_desc = systable_beginscan(ag_graph, ag_relation_id("ag_graph_namespace_index", "index"),
                                   
# 447 "src/backend/utils/cache/ag_cache.c" 3 4
                                  1
# 447 "src/backend/utils/cache/ag_cache.c"
                                      , 
# 447 "src/backend/utils/cache/ag_cache.c" 3 4
                                        ((void *)0)
# 447 "src/backend/utils/cache/ag_cache.c"
    ...
    tuple = systable_getnext(scan_desc);
    if (!((const void*)(tuple) != 
# 452 "src/backend/utils/cache/ag_cache.c" 3 4
        ((void *)0)
# 452 "src/backend/utils/cache/ag_cache.c"
        ))
    {
        systable_endscan(scan_desc);
        relation_close(ag_graph,1);
        ...
        return 
# 457 "src/backend/utils/cache/ag_cache.c" 3 4
              ((void *)0)
# 457 "src/backend/utils/cache/ag_cache.c"
                  ;
    }
    ...
    entry = hash_search(graph_namespace_cache_hash, &namespace, HASH_ENTER,
                        &found);
    ((void)
# 463 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 463 "src/backend/utils/cache/ag_cache.c"
   );
...
# 477 "src/backend/utils/cache/ag_cache.c" 3 4
   _Bool 
# 477 "src/backend/utils/cache/ag_cache.c"
        is_null;
    Datum value;


    value = ( (((-2)) > 0) ? ( (((-2)) > (int) (((tuple)->t_data)->t_infomask2 & 0x07FF)) ? getmissingattr((tuple_desc), ((-2)), (&is_null)) : ( ((void)
# 481 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 481 "src/backend/utils/cache/ag_cache.c"
           ), (*((&is_null)) = 
# 481 "src/backend/utils/cache/ag_cache.c" 3 4
           0
# 481 "src/backend/utils/cache/ag_cache.c"
           ), (!(((tuple))->t_data->t_infomask & 0x0001)) ? ( (&(((tuple_desc)))->attrs[((((-2)))-1)])->attcacheoff >= 0 ? ( ( (((&(((tuple_desc)))->attrs[((((-2)))-1)]))->attbyval) ? ( (((&(((tuple_desc)))->attrs[((((-2)))-1)]))->attlen) == (int) sizeof(Datum) ? *((Datum *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[((((-2)))-1)])->attcacheoff)) : ( (((&(((tuple_desc)))->attrs[((((-2)))-1)]))->attlen) == (int) sizeof(int32) ? ((Datum) (*((int32 *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[((((-2)))-1)])->attcacheoff)))) : ( (((&(((tuple_desc)))->attrs[((((-2)))-1)]))->attlen) == (int) sizeof(int16) ? ((Datum) (*((int16 *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[((((-2)))-1)])->attcacheoff)))) : ( ((void)
# 481 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 481 "src/backend/utils/cache/ag_cache.c"
           ), ((Datum) (*((char *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[((((-2)))-1)])->attcacheoff)))) ) ) ) ) : ((Datum) ((char *) ((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[((((-2)))-1)])->attcacheoff))) ) ) : nocachegetattr(((tuple)), (((-2))), ((tuple_desc))) ) : ( (!((((tuple))->t_data->t_bits)[((((-2)))-1) >> 3] & (1 << (((((-2)))-1) & 0x07)))) ? ( (*((&is_null)) = 
# 481 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 481 "src/backend/utils/cache/ag_cache.c"
           ), (Datum)
# 481 "src/backend/utils/cache/ag_cache.c" 3 4
           ((void *)0) 
# 481 "src/backend/utils/cache/ag_cache.c"
           ) : ( nocachegetattr(((tuple)), (((-2))), ((tuple_desc))) ) ) ) ) : heap_getsysattr((tuple), ((-2)), (tuple_desc), (&is_null)) );
    ((void)
# 482 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 482 "src/backend/utils/cache/ag_cache.c"
   );
    cache_data->oid = ((Oid) (value));

    value = ( ((1) > 0) ? ( ((1) > (int) (((tuple)->t_data)->t_infomask2 & 0x07FF)) ? getmissingattr((tuple_desc), (1), (&is_null)) : ( ((void)
# 485 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 485 "src/backend/utils/cache/ag_cache.c"
           ), (*((&is_null)) = 
# 485 "src/backend/utils/cache/ag_cache.c" 3 4
           0
# 485 "src/backend/utils/cache/ag_cache.c"
           ), (!(((tuple))->t_data->t_infomask & 0x0001)) ? ( (&(((tuple_desc)))->attrs[(((1))-1)])->attcacheoff >= 0 ? ( ( (((&(((tuple_desc)))->attrs[(((1))-1)]))->attbyval) ? ( (((&(((tuple_desc)))->attrs[(((1))-1)]))->attlen) == (int) sizeof(Datum) ? *((Datum *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((1))-1)])->attcacheoff)) : ( (((&(((tuple_desc)))->attrs[(((1))-1)]))->attlen) == (int) sizeof(int32) ? ((Datum) (*((int32 *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((1))-1)])->attcacheoff)))) : ( (((&(((tuple_desc)))->attrs[(((1))-1)]))->attlen) == (int) sizeof(int16) ? ((Datum) (*((int16 *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((1))-1)])->attcacheoff)))) : ( ((void)
# 485 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 485 "src/backend/utils/cache/ag_cache.c"
           ), ((Datum) (*((char *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((1))-1)])->attcacheoff)))) ) ) ) ) : ((Datum) ((char *) ((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((1))-1)])->attcacheoff))) ) ) : nocachegetattr(((tuple)), ((1)), ((tuple_desc))) ) : ( (!((((tuple))->t_data->t_bits)[(((1))-1) >> 3] & (1 << ((((1))-1) & 0x07)))) ? ( (*((&is_null)) = 
# 485 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 485 "src/backend/utils/cache/ag_cache.c"
           ), (Datum)
# 485 "src/backend/utils/cache/ag_cache.c" 3 4
           ((void *)0) 
# 485 "src/backend/utils/cache/ag_cache.c"
           ) : ( nocachegetattr(((tuple)), ((1)), ((tuple_desc))) ) ) ) ) : heap_getsysattr((tuple), (1), (tuple_desc), (&is_null)) );
    ((void)
# 486 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 486 "src/backend/utils/cache/ag_cache.c"
   );
    namecpy(&cache_data->name, ((Name) ((Pointer) (value))));

    value = ( ((2) > 0) ? ( ((2) > (int) (((tuple)->t_data)->t_infomask2 & 0x07FF)) ? getmissingattr((tuple_desc), (2), (&is_null)) : ( ((void)
# 489 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 489 "src/backend/utils/cache/ag_cache.c"
           ), (*((&is_null)) = 
# 489 "src/backend/utils/cache/ag_cache.c" 3 4
           0
# 489 "src/backend/utils/cache/ag_cache.c"
...
# 489 "src/backend/utils/cache/ag_cache.c"
    ...
    ((void)
# 490 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 490 "src/backend/utils/cache/ag_cache.c"
   );
    cache_data->namespace = ((Oid) (value));
}

static void initialize_label_caches(void)
{

    ag_cache_scan_key_init(&label_oid_scan_keys[0], (-2),
                           184);


    ag_cache_scan_key_init(&label_name_graph_scan_keys[0], 1,
                           62);
    ag_cache_scan_key_init(&label_name_graph_scan_keys[1], 2,
                           184);


    ag_cache_scan_key_init(&label_graph_id_scan_keys[0], 2,
                           184);
    ag_cache_scan_key_init(&label_graph_id_scan_keys[1], 3,
                           65);
    ...
    ag_cache_scan_key_init(&label_seq_name_graph_scan_keys[0], 6,
                           62);
    ag_cache_scan_key_init(&label_seq_name_graph_scan_keys[1], 2,
                           184);
...
{
    ((void)
# 634 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 634 "src/backend/utils/cache/ag_cache.c"
   );
    ((void)
# 635 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 635 "src/backend/utils/cache/ag_cache.c"
   );


    if (((
# 638 "src/backend/utils/cache/ag_cache.c" 3 4
       _Bool
# 638 "src/backend/utils/cache/ag_cache.c"
       ) ((relid) != ((Oid) 0))))
    {
...
# 674 "src/backend/utils/cache/ag_cache.c" 3 4
                             ((void *)0)
# 674 "src/backend/utils/cache/ag_cache.c"
                                 );
        hash_seq_term(&hash_seq);

        if (!removed)
        {
            do { if (errstart(20, "src/backend/utils/cache/ag_cache.c", 679, __func__, 
# 679 "src/backend/utils/cache/ag_cache.c" 3 4
           ((void *)0)
# 679 "src/backend/utils/cache/ag_cache.c"
           )) errfinish (errmsg_internal("label (oid) cache corrupted")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                     ;
        }
...
# 702 "src/backend/utils/cache/ag_cache.c" 3 4
                             ((void *)0)
# 702 "src/backend/utils/cache/ag_cache.c"
                                 );
        if (!removed)
        {
            do { if (errstart(20, "src/backend/utils/cache/ag_cache.c", 705, __func__, 
# 705 "src/backend/utils/cache/ag_cache.c" 3 4
           ((void *)0)
# 705 "src/backend/utils/cache/ag_cache.c"
           )) errfinish (errmsg_internal("label (oid) cache corrupted")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                     ;
        }
    }
...
static void invalidate_label_name_graph_cache(Oid relid)
{
    ...
    for (;;)
    {
        ...
        removed = hash_search(label_name_graph_cache_hash, &entry->key,
                              HASH_REMOVE, 
# 729 "src/backend/utils/cache/ag_cache.c" 3 4
                                          ((void *)0)
# 729 "src/backend/utils/cache/ag_cache.c"
                                              );
        hash_seq_term(&hash_seq);

        if (!removed)
        {
            do { if (errstart(20, "src/backend/utils/cache/ag_cache.c", 734, __func__, 
# 734 "src/backend/utils/cache/ag_cache.c" 3 4
           ((void *)0)
# 734 "src/backend/utils/cache/ag_cache.c"
           )) errfinish (errmsg_internal("label (name, graph) cache corrupted")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                             ;
        }
...
static void flush_label_name_graph_cache(void)
{
    ...
    for (;;)
    {
        ...
        removed = hash_search(label_name_graph_cache_hash, &entry->key,
                              HASH_REMOVE, 
# 757 "src/backend/utils/cache/ag_cache.c" 3 4
                                          ((void *)0)
# 757 "src/backend/utils/cache/ag_cache.c"
                                              );
        if (!removed)
        {
            do { if (errstart(20, "src/backend/utils/cache/ag_cache.c", 760, __func__, 
# 760 "src/backend/utils/cache/ag_cache.c" 3 4
           ((void *)0)
# 760 "src/backend/utils/cache/ag_cache.c"
           )) errfinish (errmsg_internal("label (name, graph) cache corrupted")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                             ;
        }
    }
...
static void invalidate_label_graph_id_cache(Oid relid)
{
    ...
    for (;;)
    {
        ...
        removed = hash_search(label_graph_id_cache_hash, &entry->key,
                              HASH_REMOVE, 
# 784 "src/backend/utils/cache/ag_cache.c" 3 4
                                          ((void *)0)
# 784 "src/backend/utils/cache/ag_cache.c"
                                              );
        hash_seq_term(&hash_seq);

        if (!removed)
        {
            do { if (errstart(20, "src/backend/utils/cache/ag_cache.c", 789, __func__, 
# 789 "src/backend/utils/cache/ag_cache.c" 3 4
           ((void *)0)
# 789 "src/backend/utils/cache/ag_cache.c"
           )) errfinish (errmsg_internal("label (graph, id) cache corrupted")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                           ;
        }
...
static void flush_label_graph_id_cache(void)
{
    ...
    for (;;)
    {
        ...
        removed = hash_search(label_graph_id_cache_hash, &entry->key,
                              HASH_REMOVE, 
# 812 "src/backend/utils/cache/ag_cache.c" 3 4
                                          ((void *)0)
# 812 "src/backend/utils/cache/ag_cache.c"
                                              );
        if (!removed)
        {
            do { if (errstart(20, "src/backend/utils/cache/ag_cache.c", 815, __func__, 
# 815 "src/backend/utils/cache/ag_cache.c" 3 4
           ((void *)0)
# 815 "src/backend/utils/cache/ag_cache.c"
           )) errfinish (errmsg_internal("label (graph, id) cache corrupted")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                           ;
        }
    }
...
static void invalidate_label_relation_cache(Oid relid)
{
    ...
    entry = hash_search(label_relation_cache_hash, &relid, HASH_FIND, 
# 826 "src/backend/utils/cache/ag_cache.c" 3 4
                                                                     ((void *)0)
# 826 "src/backend/utils/cache/ag_cache.c"
                                                                         );
    if (!entry)
        return;
...
# 831 "src/backend/utils/cache/ag_cache.c" 3 4
                         ((void *)0)
# 831 "src/backend/utils/cache/ag_cache.c"
                             );
    if (!removed)
        do { if (errstart(20, "src/backend/utils/cache/ag_cache.c", 833, __func__, 
# 833 "src/backend/utils/cache/ag_cache.c" 3 4
       ((void *)0)
# 833 "src/backend/utils/cache/ag_cache.c"
       )) errfinish (errmsg_internal("label (namespace) cache corrupted")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0);
}
...
static void flush_label_relation_cache(void)
{
    ...
    for (;;)
    {
        ...
        removed = hash_search(label_relation_cache_hash, &entry->relation,
                              HASH_REMOVE, 
# 851 "src/backend/utils/cache/ag_cache.c" 3 4
                                          ((void *)0)
# 851 "src/backend/utils/cache/ag_cache.c"
                                              );
        if (!removed)
        {
            do { if (errstart(20, "src/backend/utils/cache/ag_cache.c", 854, __func__, 
# 854 "src/backend/utils/cache/ag_cache.c" 3 4
           ((void *)0)
# 854 "src/backend/utils/cache/ag_cache.c"
           )) errfinish (errmsg_internal("label (relation) cache corrupted")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                          ;
        }
    }
}
...
static void invalidate_label_seq_name_graph_cache(Oid relid)
{
    ...
    for (;;)
    {
        ...
        removed = hash_search(label_seq_name_graph_cache_hash, &entry->key,
                              HASH_REMOVE, 
# 878 "src/backend/utils/cache/ag_cache.c" 3 4
                                          ((void *)0)
# 878 "src/backend/utils/cache/ag_cache.c"
                                              );
        hash_seq_term(&hash_seq);

        if (!removed)
        {
            do { if (errstart(20, "src/backend/utils/cache/ag_cache.c", 883, __func__, 
# 883 "src/backend/utils/cache/ag_cache.c" 3 4
           ((void *)0)
# 883 "src/backend/utils/cache/ag_cache.c"
           )) errfinish (errmsg_internal("label (seq_name, graph) cache corrupted")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                                 ;
        }
...
static void flush_label_seq_name_graph_cache(void)
{
    ...
    for (;;)
    {
        ...
        removed = hash_search(label_seq_name_graph_cache_hash, &entry->key,
                              HASH_REMOVE, 
# 906 "src/backend/utils/cache/ag_cache.c" 3 4
                                          ((void *)0)
# 906 "src/backend/utils/cache/ag_cache.c"
                                              );
        if (!removed)
        {
            do { if (errstart(20, "src/backend/utils/cache/ag_cache.c", 909, __func__, 
# 909 "src/backend/utils/cache/ag_cache.c" 3 4
           ((void *)0)
# 909 "src/backend/utils/cache/ag_cache.c"
           )) errfinish (errmsg_internal("label (seq_name, graph) cache corrupted")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                                 ;
        }
    }
...
label_cache_data *search_label_oid_cache(Oid oid)
{
    ...
    entry = hash_search(label_oid_cache_hash, &oid, HASH_FIND, 
# 921 "src/backend/utils/cache/ag_cache.c" 3 4
                                                              ((void *)0)
# 921 "src/backend/utils/cache/ag_cache.c"
                                                                  );
    if (entry)
        return entry;
...
# 934 "src/backend/utils/cache/ag_cache.c" 3 4
   _Bool 
# 934 "src/backend/utils/cache/ag_cache.c"
        found;
    label_cache_data *entry;

    memcpy(scan_keys, label_oid_scan_keys, sizeof(label_oid_scan_keys));
    scan_keys[0].sk_argument = ((Datum) (oid));
    ...
    ag_label = heap_open(ag_relation_id("ag_label", "table"), 1);
    scan_desc = systable_beginscan(ag_label, ag_relation_id("ag_label_oid_index", "index"), 
# 946 "src/backend/utils/cache/ag_cache.c" 3 4
                                                                     1
# 946 "src/backend/utils/cache/ag_cache.c"
                                                                         ,
                                   
# 947 "src/backend/utils/cache/ag_cache.c" 3 4
                                  ((void *)0)
# 947 "src/backend/utils/cache/ag_cache.c"
                                      , 1, scan_keys);


    tuple = systable_getnext(scan_desc);
    if (!((const void*)(tuple) != 
# 951 "src/backend/utils/cache/ag_cache.c" 3 4
        ((void *)0)
# 951 "src/backend/utils/cache/ag_cache.c"
        ))
    {
        systable_endscan(scan_desc);
        relation_close(ag_label,1);

        return 
# 956 "src/backend/utils/cache/ag_cache.c" 3 4
              ((void *)0)
# 956 "src/backend/utils/cache/ag_cache.c"
                  ;
    }
    ...
    ((void)
# 961 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 961 "src/backend/utils/cache/ag_cache.c"
   );


    fill_label_cache_data(entry, tuple, ((ag_label)->rd_att));

    ((void)
# 966 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 966 "src/backend/utils/cache/ag_cache.c"
   );
...
label_cache_data *search_label_name_graph_cache(const char *name, Oid graph)
{
    ...
    ((void)
# 979 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 979 "src/backend/utils/cache/ag_cache.c"
   );
    ((void)
# 980 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 980 "src/backend/utils/cache/ag_cache.c"
   );
...
# 986 "src/backend/utils/cache/ag_cache.c" 3 4
                                              ((void *)0)
# 986 "src/backend/utils/cache/ag_cache.c"
                                                  );
    if (entry)
        return &entry->data;
...
# 1000 "src/backend/utils/cache/ag_cache.c" 3 4
   _Bool 
# 1000 "src/backend/utils/cache/ag_cache.c"
        found;
    label_name_graph_cache_entry *entry;
    ...
    scan_keys[0].sk_argument = ((Datum) (((*(name)).data)));
    scan_keys[1].sk_argument = ((Datum) (graph));
    ...
    ag_label = heap_open(ag_relation_id("ag_label", "table"), 1);
    scan_desc = systable_beginscan(ag_label, ag_relation_id("ag_label_name_graph_index", "index"),
                                   
# 1015 "src/backend/utils/cache/ag_cache.c" 3 4
                                  1
# 1015 "src/backend/utils/cache/ag_cache.c"
                                      , 
# 1015 "src/backend/utils/cache/ag_cache.c" 3 4
                                        ((void *)0)
# 1015 "src/backend/utils/cache/ag_cache.c"
    ...
    tuple = systable_getnext(scan_desc);
    if (!((const void*)(tuple) != 
# 1022 "src/backend/utils/cache/ag_cache.c" 3 4
        ((void *)0)
# 1022 "src/backend/utils/cache/ag_cache.c"
        ))
    {
        systable_endscan(scan_desc);
        relation_close(ag_label,1);
        ...
        return 
# 1027 "src/backend/utils/cache/ag_cache.c" 3 4
              ((void *)0)
# 1027 "src/backend/utils/cache/ag_cache.c"
                  ;
    }
    ...
    entry = label_name_graph_cache_hash_search(name, graph, HASH_ENTER,
                                               &found);
    ((void)
# 1033 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 1033 "src/backend/utils/cache/ag_cache.c"
   );


    fill_label_cache_data(&entry->data, tuple, ((ag_label)->rd_att));
...
static void *label_name_graph_cache_hash_search(Name name, Oid graph,
                                                HASHACTION action, 
# 1045 "src/backend/utils/cache/ag_cache.c" 3 4
                                                                  _Bool 
# 1045 "src/backend/utils/cache/ag_cache.c"
                                                                       *found)
{
    label_name_graph_cache_key key;
...
label_cache_data *search_label_graph_id_cache(Oid graph, int32 id)
{
    ...
    ((void)
# 1060 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 1060 "src/backend/utils/cache/ag_cache.c"
   );
    ((void)
# 1061 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 1061 "src/backend/utils/cache/ag_cache.c"
   );

    initialize_caches();

    entry = label_graph_id_cache_hash_search(graph, id, HASH_FIND, 
# 1065 "src/backend/utils/cache/ag_cache.c" 3 4
                                                                  ((void *)0)
# 1065 "src/backend/utils/cache/ag_cache.c"
                                                                      );
    if (entry)
        return &entry->data;
...
# 1078 "src/backend/utils/cache/ag_cache.c" 3 4
   _Bool 
# 1078 "src/backend/utils/cache/ag_cache.c"
        found;
    label_graph_id_cache_entry *entry;

    memcpy(scan_keys, label_graph_id_scan_keys,
           sizeof(label_graph_id_scan_keys));
    scan_keys[0].sk_argument = ((Datum) (graph));
    scan_keys[1].sk_argument = ((Datum) (id));
    ...
    ag_label = heap_open(ag_relation_id("ag_label", "table"), 1);
    scan_desc = systable_beginscan(ag_label, ag_relation_id("ag_label_graph_id_index", "index"),
                                   
# 1093 "src/backend/utils/cache/ag_cache.c" 3 4
                                  1
# 1093 "src/backend/utils/cache/ag_cache.c"
                                      , 
# 1093 "src/backend/utils/cache/ag_cache.c" 3 4
                                        ((void *)0)
# 1093 "src/backend/utils/cache/ag_cache.c"
    ...
    tuple = systable_getnext(scan_desc);
    if (!((const void*)(tuple) != 
# 1100 "src/backend/utils/cache/ag_cache.c" 3 4
        ((void *)0)
# 1100 "src/backend/utils/cache/ag_cache.c"
        ))
    {
        systable_endscan(scan_desc);
        relation_close(ag_label,1);
        ...
        return 
# 1105 "src/backend/utils/cache/ag_cache.c" 3 4
              ((void *)0)
# 1105 "src/backend/utils/cache/ag_cache.c"
                  ;
    }
    ...
    ((void)
# 1110 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 1110 "src/backend/utils/cache/ag_cache.c"
   );
...
static void *label_graph_id_cache_hash_search(Oid graph, int32 id,
                                              HASHACTION action, 
# 1122 "src/backend/utils/cache/ag_cache.c" 3 4
                                                                _Bool 
# 1122 "src/backend/utils/cache/ag_cache.c"
                                                                     *found)
{
    label_graph_id_cache_key key;
...
label_cache_data *search_label_relation_cache(Oid relation)
{
    ...
    entry = hash_search(label_relation_cache_hash, &relation, HASH_FIND, 
# 1139 "src/backend/utils/cache/ag_cache.c" 3 4
                                                                        ((void *)0)
# 1139 "src/backend/utils/cache/ag_cache.c"
                                                                            );
    if (entry)
        return &entry->data;
...
# 1152 "src/backend/utils/cache/ag_cache.c" 3 4
   _Bool 
# 1152 "src/backend/utils/cache/ag_cache.c"
        found;
    label_cache_data *entry;

    memcpy(scan_keys, label_relation_scan_keys,
           sizeof(label_relation_scan_keys));
    scan_keys[0].sk_argument = ((Datum) (relation));
    ...
    ag_label = heap_open(ag_relation_id("ag_label", "table"), 1);
    scan_desc = systable_beginscan(ag_label, ag_relation_id("ag_label_relation_index", "index"),
                                   
# 1166 "src/backend/utils/cache/ag_cache.c" 3 4
                                  1
# 1166 "src/backend/utils/cache/ag_cache.c"
                                      , 
# 1166 "src/backend/utils/cache/ag_cache.c" 3 4
                                        ((void *)0)
# 1166 "src/backend/utils/cache/ag_cache.c"
    ...
    tuple = systable_getnext(scan_desc);
    if (!((const void*)(tuple) != 
# 1171 "src/backend/utils/cache/ag_cache.c" 3 4
        ((void *)0)
# 1171 "src/backend/utils/cache/ag_cache.c"
        ))
    {
        systable_endscan(scan_desc);
        relation_close(ag_label,1);
        ...
        return 
# 1176 "src/backend/utils/cache/ag_cache.c" 3 4
              ((void *)0)
# 1176 "src/backend/utils/cache/ag_cache.c"
                  ;
    }
    ...
    entry = hash_search(label_relation_cache_hash, &relation, HASH_ENTER,
                        &found);
    ((void)
# 1182 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 1182 "src/backend/utils/cache/ag_cache.c"
   );
...
label_cache_data *search_label_seq_name_graph_cache(const char *name, Oid graph)
{
    ...
    ((void)
# 1198 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 1198 "src/backend/utils/cache/ag_cache.c"
   );
    ((void)
# 1199 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 1199 "src/backend/utils/cache/ag_cache.c"
   );
...
# 1205 "src/backend/utils/cache/ag_cache.c" 3 4
                                              ((void *)0)
# 1205 "src/backend/utils/cache/ag_cache.c"
                                                  );
    if (entry)
        return &entry->data;
...
# 1219 "src/backend/utils/cache/ag_cache.c" 3 4
   _Bool 
# 1219 "src/backend/utils/cache/ag_cache.c"
        found;
    label_seq_name_graph_cache_entry *entry;
    ...
    ag_label = heap_open(ag_relation_id("ag_label", "table"), 1);
    scan_desc = systable_beginscan(ag_label, ag_relation_id("ag_label_seq_name_graph_index", "index"),
                                   
# 1234 "src/backend/utils/cache/ag_cache.c" 3 4
                                  1
# 1234 "src/backend/utils/cache/ag_cache.c"
                                      , 
# 1234 "src/backend/utils/cache/ag_cache.c" 3 4
                                        ((void *)0)
# 1234 "src/backend/utils/cache/ag_cache.c"
    ...
    tuple = systable_getnext(scan_desc);
    if (!((const void*)(tuple) != 
# 1241 "src/backend/utils/cache/ag_cache.c" 3 4
        ((void *)0)
# 1241 "src/backend/utils/cache/ag_cache.c"
        ))
    {
        systable_endscan(scan_desc);
        relation_close(ag_label,1);
        ...
        return 
# 1246 "src/backend/utils/cache/ag_cache.c" 3 4
              ((void *)0)
# 1246 "src/backend/utils/cache/ag_cache.c"
                  ;
    }
    ...
    entry = label_seq_name_graph_cache_hash_search(name, graph, HASH_ENTER,
                                               &found);
    ((void)
# 1252 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 1252 "src/backend/utils/cache/ag_cache.c"
   );
...
static void *label_seq_name_graph_cache_hash_search(Name name, Oid graph,
                                                HASHACTION action, 
# 1264 "src/backend/utils/cache/ag_cache.c" 3 4
                                                                  _Bool 
# 1264 "src/backend/utils/cache/ag_cache.c"
                                                                       *found)
{
    label_seq_name_graph_cache_key key;
...
# 1278 "src/backend/utils/cache/ag_cache.c" 3 4
   _Bool 
# 1278 "src/backend/utils/cache/ag_cache.c"
        is_null;
    Datum value;


    value = ( (((-2)) > 0) ? ( (((-2)) > (int) (((tuple)->t_data)->t_infomask2 & 0x07FF)) ? getmissingattr((tuple_desc), ((-2)), (&is_null)) : ( ((void)
# 1282 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 1282 "src/backend/utils/cache/ag_cache.c"
           ), (*((&is_null)) = 
# 1282 "src/backend/utils/cache/ag_cache.c" 3 4
           0
# 1282 "src/backend/utils/cache/ag_cache.c"
...
# 1282 "src/backend/utils/cache/ag_cache.c"
    ...
    ((void)
# 1283 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 1283 "src/backend/utils/cache/ag_cache.c"
   );
    cache_data->oid = ((Oid) (value));

    value = ( ((1) > 0) ? ( ((1) > (int) (((tuple)->t_data)->t_infomask2 & 0x07FF)) ? getmissingattr((tuple_desc), (1), (&is_null)) : ( ((void)
# 1286 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 1286 "src/backend/utils/cache/ag_cache.c"
           ), (*((&is_null)) = 
# 1286 "src/backend/utils/cache/ag_cache.c" 3 4
           0
# 1286 "src/backend/utils/cache/ag_cache.c"
...
# 1286 "src/backend/utils/cache/ag_cache.c"
    ...
    ((void)
# 1287 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 1287 "src/backend/utils/cache/ag_cache.c"
   );
    namecpy(&cache_data->name, ((Name) ((Pointer) (value))));

    value = ( ((2) > 0) ? ( ((2) > (int) (((tuple)->t_data)->t_infomask2 & 0x07FF)) ? getmissingattr((tuple_desc), (2), (&is_null)) : ( ((void)
# 1290 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 1290 "src/backend/utils/cache/ag_cache.c"
           ), (*((&is_null)) = 
# 1290 "src/backend/utils/cache/ag_cache.c" 3 4
           0
# 1290 "src/backend/utils/cache/ag_cache.c"
...
# 1290 "src/backend/utils/cache/ag_cache.c"
    ...
    ((void)
# 1291 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 1291 "src/backend/utils/cache/ag_cache.c"
   );
    cache_data->graph = ((Oid) (value));

    value = ( ((3) > 0) ? ( ((3) > (int) (((tuple)->t_data)->t_infomask2 & 0x07FF)) ? getmissingattr((tuple_desc), (3), (&is_null)) : ( ((void)
# 1294 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 1294 "src/backend/utils/cache/ag_cache.c"
           ), (*((&is_null)) = 
# 1294 "src/backend/utils/cache/ag_cache.c" 3 4
           0
# 1294 "src/backend/utils/cache/ag_cache.c"
           ), (!(((tuple))->t_data->t_infomask & 0x0001)) ? ( (&(((tuple_desc)))->attrs[(((3))-1)])->attcacheoff >= 0 ? ( ( (((&(((tuple_desc)))->attrs[(((3))-1)]))->attbyval) ? ( (((&(((tuple_desc)))->attrs[(((3))-1)]))->attlen) == (int) sizeof(Datum) ? *((Datum *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((3))-1)])->attcacheoff)) : ( (((&(((tuple_desc)))->attrs[(((3))-1)]))->attlen) == (int) sizeof(int32) ? ((Datum) (*((int32 *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((3))-1)])->attcacheoff)))) : ( (((&(((tuple_desc)))->attrs[(((3))-1)]))->attlen) == (int) sizeof(int16) ? ((Datum) (*((int16 *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((3))-1)])->attcacheoff)))) : ( ((void)
# 1294 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 1294 "src/backend/utils/cache/ag_cache.c"
           ), ((Datum) (*((char *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((3))-1)])->attcacheoff)))) ) ) ) ) : ((Datum) ((char *) ((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((3))-1)])->attcacheoff))) ) ) : nocachegetattr(((tuple)), ((3)), ((tuple_desc))) ) : ( (!((((tuple))->t_data->t_bits)[(((3))-1) >> 3] & (1 << ((((3))-1) & 0x07)))) ? ( (*((&is_null)) = 
# 1294 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 1294 "src/backend/utils/cache/ag_cache.c"
           ), (Datum)
# 1294 "src/backend/utils/cache/ag_cache.c" 3 4
           ((void *)0) 
# 1294 "src/backend/utils/cache/ag_cache.c"
           ) : ( nocachegetattr(((tuple)), ((3)), ((tuple_desc))) ) ) ) ) : heap_getsysattr((tuple), (3), (tuple_desc), (&is_null)) );
    ((void)
# 1295 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 1295 "src/backend/utils/cache/ag_cache.c"
   );
    cache_data->id = ((int32) (value));

    value = ( ((4) > 0) ? ( ((4) > (int) (((tuple)->t_data)->t_infomask2 & 0x07FF)) ? getmissingattr((tuple_desc), (4), (&is_null)) : ( ((void)
# 1298 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 1298 "src/backend/utils/cache/ag_cache.c"
           ), (*((&is_null)) = 
# 1298 "src/backend/utils/cache/ag_cache.c" 3 4
           0
# 1298 "src/backend/utils/cache/ag_cache.c"
           ), (!(((tuple))->t_data->t_infomask & 0x0001)) ? ( (&(((tuple_desc)))->attrs[(((4))-1)])->attcacheoff >= 0 ? ( ( (((&(((tuple_desc)))->attrs[(((4))-1)]))->attbyval) ? ( (((&(((tuple_desc)))->attrs[(((4))-1)]))->attlen) == (int) sizeof(Datum) ? *((Datum *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((4))-1)])->attcacheoff)) : ( (((&(((tuple_desc)))->attrs[(((4))-1)]))->attlen) == (int) sizeof(int32) ? ((Datum) (*((int32 *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((4))-1)])->attcacheoff)))) : ( (((&(((tuple_desc)))->attrs[(((4))-1)]))->attlen) == (int) sizeof(int16) ? ((Datum) (*((int16 *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((4))-1)])->attcacheoff)))) : ( ((void)
# 1298 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 1298 "src/backend/utils/cache/ag_cache.c"
           ), ((Datum) (*((char *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((4))-1)])->attcacheoff)))) ) ) ) ) : ((Datum) ((char *) ((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((4))-1)])->attcacheoff))) ) ) : nocachegetattr(((tuple)), ((4)), ((tuple_desc))) ) : ( (!((((tuple))->t_data->t_bits)[(((4))-1) >> 3] & (1 << ((((4))-1) & 0x07)))) ? ( (*((&is_null)) = 
# 1298 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 1298 "src/backend/utils/cache/ag_cache.c"
           ), (Datum)
# 1298 "src/backend/utils/cache/ag_cache.c" 3 4
           ((void *)0) 
# 1298 "src/backend/utils/cache/ag_cache.c"
           ) : ( nocachegetattr(((tuple)), ((4)), ((tuple_desc))) ) ) ) ) : heap_getsysattr((tuple), (4), (tuple_desc), (&is_null)) );
    ((void)
# 1299 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 1299 "src/backend/utils/cache/ag_cache.c"
   );
    cache_data->kind = ((char) (value));

    value = ( ((5) > 0) ? ( ((5) > (int) (((tuple)->t_data)->t_infomask2 & 0x07FF)) ? getmissingattr((tuple_desc), (5), (&is_null)) : ( ((void)
# 1302 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 1302 "src/backend/utils/cache/ag_cache.c"
           ), (*((&is_null)) = 
# 1302 "src/backend/utils/cache/ag_cache.c" 3 4
           0
# 1302 "src/backend/utils/cache/ag_cache.c"
           ), (!(((tuple))->t_data->t_infomask & 0x0001)) ? ( (&(((tuple_desc)))->attrs[(((5))-1)])->attcacheoff >= 0 ? ( ( (((&(((tuple_desc)))->attrs[(((5))-1)]))->attbyval) ? ( (((&(((tuple_desc)))->attrs[(((5))-1)]))->attlen) == (int) sizeof(Datum) ? *((Datum *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((5))-1)])->attcacheoff)) : ( (((&(((tuple_desc)))->attrs[(((5))-1)]))->attlen) == (int) sizeof(int32) ? ((Datum) (*((int32 *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((5))-1)])->attcacheoff)))) : ( (((&(((tuple_desc)))->attrs[(((5))-1)]))->attlen) == (int) sizeof(int16) ? ((Datum) (*((int16 *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((5))-1)])->attcacheoff)))) : ( ((void)
# 1302 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 1302 "src/backend/utils/cache/ag_cache.c"
           ), ((Datum) (*((char *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((5))-1)])->attcacheoff)))) ) ) ) ) : ((Datum) ((char *) ((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((5))-1)])->attcacheoff))) ) ) : nocachegetattr(((tuple)), ((5)), ((tuple_desc))) ) : ( (!((((tuple))->t_data->t_bits)[(((5))-1) >> 3] & (1 << ((((5))-1) & 0x07)))) ? ( (*((&is_null)) = 
# 1302 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 1302 "src/backend/utils/cache/ag_cache.c"
           ), (Datum)
# 1302 "src/backend/utils/cache/ag_cache.c" 3 4
           ((void *)0) 
# 1302 "src/backend/utils/cache/ag_cache.c"
           ) : ( nocachegetattr(((tuple)), ((5)), ((tuple_desc))) ) ) ) ) : heap_getsysattr((tuple), (5), (tuple_desc), (&is_null)) );
    ((void)
# 1303 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 1303 "src/backend/utils/cache/ag_cache.c"
   );
    cache_data->relation = ((Oid) (value));

    value = ( ((6) > 0) ? ( ((6) > (int) (((tuple)->t_data)->t_infomask2 & 0x07FF)) ? getmissingattr((tuple_desc), (6), (&is_null)) : ( ((void)
# 1306 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 1306 "src/backend/utils/cache/ag_cache.c"
           ), (*((&is_null)) = 
# 1306 "src/backend/utils/cache/ag_cache.c" 3 4
           0
# 1306 "src/backend/utils/cache/ag_cache.c"
           ), (!(((tuple))->t_data->t_infomask & 0x0001)) ? ( (&(((tuple_desc)))->attrs[(((6))-1)])->attcacheoff >= 0 ? ( ( (((&(((tuple_desc)))->attrs[(((6))-1)]))->attbyval) ? ( (((&(((tuple_desc)))->attrs[(((6))-1)]))->attlen) == (int) sizeof(Datum) ? *((Datum *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((6))-1)])->attcacheoff)) : ( (((&(((tuple_desc)))->attrs[(((6))-1)]))->attlen) == (int) sizeof(int32) ? ((Datum) (*((int32 *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((6))-1)])->attcacheoff)))) : ( (((&(((tuple_desc)))->attrs[(((6))-1)]))->attlen) == (int) sizeof(int16) ? ((Datum) (*((int16 *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((6))-1)])->attcacheoff)))) : ( ((void)
# 1306 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 1306 "src/backend/utils/cache/ag_cache.c"
           ), ((Datum) (*((char *)((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((6))-1)])->attcacheoff)))) ) ) ) ) : ((Datum) ((char *) ((char *) ((tuple))->t_data + ((tuple))->t_data->t_hoff + (&(((tuple_desc)))->attrs[(((6))-1)])->attcacheoff))) ) ) : nocachegetattr(((tuple)), ((6)), ((tuple_desc))) ) : ( (!((((tuple))->t_data->t_bits)[(((6))-1) >> 3] & (1 << ((((6))-1) & 0x07)))) ? ( (*((&is_null)) = 
# 1306 "src/backend/utils/cache/ag_cache.c" 3 4
           1
# 1306 "src/backend/utils/cache/ag_cache.c"
           ), (Datum)
# 1306 "src/backend/utils/cache/ag_cache.c" 3 4
           ((void *)0) 
# 1306 "src/backend/utils/cache/ag_cache.c"
           ) : ( nocachegetattr(((tuple)), ((6)), ((tuple_desc))) ) ) ) ) : heap_getsysattr((tuple), (6), (tuple_desc), (&is_null)) );
    ((void)
# 1307 "src/backend/utils/cache/ag_cache.c" 3 4
   1
# 1307 "src/backend/utils/cache/ag_cache.c"
   );
    namecpy(&cache_data->seq_name, ((Name) ((Pointer) (value))));
}
