# 0 "src/backend/utils/load/age_load.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/utils/load/age_load.c"
# 20 "src/backend/utils/load/age_load.c"
...
# 21 "src/backend/utils/load/age_load.c" 2
...
# 23 "src/backend/utils/load/age_load.c" 2
...
# 24 "src/backend/utils/load/age_load.c" 2
...
# 25 "src/backend/utils/load/age_load.c" 2
...
# 26 "src/backend/utils/load/age_load.c" 2

# 1 "/usr/include/postgresql/11/server/catalog/pg_class_d.h" 1
# 28 "src/backend/utils/load/age_load.c" 2
...
# 29 "src/backend/utils/load/age_load.c" 2
...
# 30 "src/backend/utils/load/age_load.c" 2
...
# 100 "/usr/include/postgresql/11/server/commands/tablecmds.h"
          ...
          List *partConstraint);
# 31 "src/backend/utils/load/age_load.c" 2
...
# 32 "src/backend/utils/load/age_load.c" 2
...
# 33 "src/backend/utils/load/age_load.c" 2
...
# 37 "src/backend/utils/load/age_load.c" 2
...
# 41 "src/backend/utils/load/age_load.c" 2
...
# 44 "src/backend/utils/load/age_load.c" 2
...
# 46 "src/backend/utils/load/age_load.c" 2
...
# 66 "/usr/include/postgresql/11/server/utils/inval.h"
                                               debug_discard);
# 47 "src/backend/utils/load/age_load.c" 2
...
# 48 "src/backend/utils/load/age_load.c" 2
...
# 29 "/usr/include/postgresql/11/server/catalog/pg_class.h"
...
# 30 "/usr/include/postgresql/11/server/catalog/pg_publication.h"
...
# 49 "src/backend/utils/load/age_load.c" 2
...
# 51 "src/backend/utils/load/age_load.c" 2
...
# 52 "src/backend/utils/load/age_load.c" 2
...
Oid create_label(char *graph_name, char *label_name, char label_type,
                 List *parents);
# 53 "src/backend/utils/load/age_load.c" 2
...
# 54 "src/backend/utils/load/age_load.c" 2



# 1 ".//src/include/utils/load/age_load.h" 1
# 60 ".//src/include/utils/load/age_load.h"
...
# 58 "src/backend/utils/load/age_load.c" 2
# 1 ".//src/include/utils/load/ag_load_labels.h" 1
# 73 ".//src/include/utils/load/ag_load_labels.h"
struct counts {
...
# 95 ".//src/include/utils/load/ag_load_labels.h" 3 4
   _Bool 
# 95 ".//src/include/utils/load/ag_load_labels.h"
        id_field_exists;
} csv_vertex_reader;
...
# 104 ".//src/include/utils/load/ag_load_labels.h" 3 4
                               _Bool 
# 104 ".//src/include/utils/load/ag_load_labels.h"
                                    id_field_exists);
# 59 "src/backend/utils/load/age_load.c" 2
# 1 ".//src/include/utils/load/ag_load_edges.h" 1
# 70 ".//src/include/utils/load/ag_load_edges.h"
typedef struct {
    size_t row;
    char **header;
    size_t *header_len;
...
int create_edges_from_csv_file(char *file_path, char *graph_name, Oid graph_id,
                                char *object_name, int object_id );
# 60 "src/backend/utils/load/age_load.c" 2
...
agtype* create_empty_agtype(void)
{
    ...
    result.res = push_agtype_value(&result.parse_state,
                                   WAGT_BEGIN_OBJECT, 
# 68 "src/backend/utils/load/age_load.c" 3 4
                                                     ((void *)0)
# 68 "src/backend/utils/load/age_load.c"
                                                         );
    result.res = push_agtype_value(&result.parse_state,
                                   WAGT_END_OBJECT, 
# 70 "src/backend/utils/load/age_load.c" 3 4
                                                   ((void *)0)
# 70 "src/backend/utils/load/age_load.c"
                                                       );
                                ...
                                size_t fields_len, int64 vertex_id)
{
    ...
    result.res = push_agtype_value(&result.parse_state,
                                   WAGT_BEGIN_OBJECT, 
# 84 "src/backend/utils/load/age_load.c" 3 4
                                                     ((void *)0)
# 84 "src/backend/utils/load/age_load.c"
                                                         );
    ...
    result.res = push_agtype_value(&result.parse_state,
                                   WAGT_END_OBJECT, 
# 104 "src/backend/utils/load/age_load.c" 3 4
                                                   ((void *)0)
# 104 "src/backend/utils/load/age_load.c"
                                                       );
                                  ...
                                  size_t fields_len, size_t start_index)
{
    ...
    result.res = push_agtype_value(&result.parse_state,
                                   WAGT_BEGIN_OBJECT, 
# 123 "src/backend/utils/load/age_load.c" 3 4
                                                     ((void *)0)
# 123 "src/backend/utils/load/age_load.c"
                                                         );
    ...
    result.res = push_agtype_value(&result.parse_state,
                                   WAGT_END_OBJECT, 
# 136 "src/backend/utils/load/age_load.c" 3 4
                                                   ((void *)0)
# 136 "src/backend/utils/load/age_load.c"
                                                       );
...
# 147 "src/backend/utils/load/age_load.c" 3 4
   _Bool 
# 147 "src/backend/utils/load/age_load.c"
        nulls[4] = {
# 147 "src/backend/utils/load/age_load.c" 3 4
                    0
# 147 "src/backend/utils/load/age_load.c"
...
# 147 "src/backend/utils/load/age_load.c"
    ...
    values[0] = ((Datum) (edge_id));
    values[1] = ((Datum) (start_id));
    values[2] = ((Datum) (end_id));
    values[3] = ((Datum) ((edge_properties)));

    label_relation = heap_open(get_label_relation(label_name,
                                                  graph_id),
                               3);

    tuple = heap_form_tuple(((label_relation)->rd_att),
                            values, nulls);
    heap_insert(label_relation, tuple,
                GetCurrentCommandId(
# 164 "src/backend/utils/load/age_load.c" 3 4
                                   1
# 164 "src/backend/utils/load/age_load.c"
                                       ), 0, 
# 164 "src/backend/utils/load/age_load.c" 3 4
                                             ((void *)0)
# 164 "src/backend/utils/load/age_load.c"
                                                 );
    relation_close(label_relation,3);
...
# 175 "src/backend/utils/load/age_load.c" 3 4
   _Bool 
# 175 "src/backend/utils/load/age_load.c"
        nulls[2] = {
# 175 "src/backend/utils/load/age_load.c" 3 4
                    0
# 175 "src/backend/utils/load/age_load.c"
...
# 175 "src/backend/utils/load/age_load.c"
    ...
    values[0] = ((Datum) (vertex_id));
    values[1] = ((Datum) ((vertex_properties)));
    ...
    heap_insert(label_relation, tuple,
                GetCurrentCommandId(
# 188 "src/backend/utils/load/age_load.c" 3 4
                                   1
# 188 "src/backend/utils/load/age_load.c"
                                       ), 0, 
# 188 "src/backend/utils/load/age_load.c" 3 4
                                             ((void *)0)
# 188 "src/backend/utils/load/age_load.c"
...
extern Datum load_labels_from_file(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_load_labels_from_file(void); const Pg_finfo_record * pg_finfo_load_labels_from_file (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
Datum load_labels_from_file(FunctionCallInfo fcinfo)
{
...
# 206 "src/backend/utils/load/age_load.c" 3 4
   _Bool 
# 206 "src/backend/utils/load/age_load.c"
        id_field_exists;

    if ((fcinfo->argnull[0]))
    {
        do { if (errstart(20, "src/backend/utils/load/age_load.c", 210, __func__, 
# 210 "src/backend/utils/load/age_load.c" 3 4
       ((void *)0)
# 210 "src/backend/utils/load/age_load.c"
    ...
    if ((fcinfo->argnull[1]))
    {
        do { if (errstart(20, "src/backend/utils/load/age_load.c", 216, __func__, 
# 216 "src/backend/utils/load/age_load.c" 3 4
       ((void *)0)
# 216 "src/backend/utils/load/age_load.c"
    ...
    if ((fcinfo->argnull[2]))
    {
        do { if (errstart(20, "src/backend/utils/load/age_load.c", 222, __func__, 
# 222 "src/backend/utils/load/age_load.c" 3 4
       ((void *)0)
# 222 "src/backend/utils/load/age_load.c"
       )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('2') - '0') & 0x3F) << 18) + (((('3') - '0') & 0x3F) << 24))), errmsg("file path must not be NULL")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                      ;
    }

    graph_name = ((Name) ((Pointer) ((fcinfo->arg[0]))));
    label_name = ((Name) ((Pointer) ((fcinfo->arg[1]))));
    file_path = ((text *) pg_detoast_datum((struct varlena *) ((Pointer) ((fcinfo->arg[2])))));
    id_field_exists = ((
# 229 "src/backend/utils/load/age_load.c" 3 4
                     _Bool
# 229 "src/backend/utils/load/age_load.c"
                     ) (((fcinfo->arg[3])) != 0));
...
extern Datum load_edges_from_file(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_load_edges_from_file(void); const Pg_finfo_record * pg_finfo_load_edges_from_file (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;
Datum load_edges_from_file(FunctionCallInfo fcinfo)
{
    ...
    if ((fcinfo->argnull[0]))
    {
        do { if (errstart(20, "src/backend/utils/load/age_load.c", 261, __func__, 
# 261 "src/backend/utils/load/age_load.c" 3 4
       ((void *)0)
# 261 "src/backend/utils/load/age_load.c"
       )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('2') - '0') & 0x3F) << 18) + (((('3') - '0') & 0x3F) << 24))), errmsg("graph name must not be NULL")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                       ;
    }
    ...
    if ((fcinfo->argnull[1]))
    {
        do { if (errstart(20, "src/backend/utils/load/age_load.c", 267, __func__, 
# 267 "src/backend/utils/load/age_load.c" 3 4
       ((void *)0)
# 267 "src/backend/utils/load/age_load.c"
       )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('2') - '0') & 0x3F) << 18) + (((('3') - '0') & 0x3F) << 24))), errmsg("label name must not be NULL")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                       ;
    }
    ...
    if ((fcinfo->argnull[2]))
    {
        do { if (errstart(20, "src/backend/utils/load/age_load.c", 273, __func__, 
# 273 "src/backend/utils/load/age_load.c" 3 4
       ((void *)0)
# 273 "src/backend/utils/load/age_load.c"
       )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('2') - '0') & 0x3F) << 18) + (((('3') - '0') & 0x3F) << 24))), errmsg("file path must not be NULL")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                      ;
    }
