# 0 "src/backend/utils/load/ag_load_labels.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/utils/load/ag_load_labels.c"
# 20 "src/backend/utils/load/ag_load_labels.c"
...
# 21 "src/backend/utils/load/ag_load_labels.c" 2
...
# 22 "src/backend/utils/load/ag_load_labels.c" 2
...
# 23 "src/backend/utils/load/ag_load_labels.c" 2
...
# 24 "src/backend/utils/load/ag_load_labels.c" 2
...
# 25 "src/backend/utils/load/ag_load_labels.c" 2
...
# 31 "/usr/include/postgresql/11/server/postgres_ext.h"
...
# 27 "src/backend/utils/load/ag_load_labels.c" 2
...
# 29 "src/backend/utils/load/ag_load_labels.c" 2
...
# 30 "src/backend/utils/load/ag_load_labels.c" 2
...
# 31 "src/backend/utils/load/ag_load_labels.c" 2
...
# 32 "src/backend/utils/load/ag_load_labels.c" 2

# 1 "/usr/include/postgresql/11/server/catalog/pg_class_d.h" 1
# 34 "src/backend/utils/load/ag_load_labels.c" 2
...
# 35 "src/backend/utils/load/ag_load_labels.c" 2
...
# 36 "src/backend/utils/load/ag_load_labels.c" 2
...
# 100 "/usr/include/postgresql/11/server/commands/tablecmds.h"
          ...
          List *partConstraint);
# 37 "src/backend/utils/load/ag_load_labels.c" 2
...
# 38 "src/backend/utils/load/ag_load_labels.c" 2
...
# 39 "src/backend/utils/load/ag_load_labels.c" 2
...
# 43 "src/backend/utils/load/ag_load_labels.c" 2
...
# 47 "src/backend/utils/load/ag_load_labels.c" 2
...
# 50 "src/backend/utils/load/ag_load_labels.c" 2
...
# 52 "src/backend/utils/load/ag_load_labels.c" 2
...
# 66 "/usr/include/postgresql/11/server/utils/inval.h"
                                               debug_discard);
# 53 "src/backend/utils/load/ag_load_labels.c" 2
...
# 54 "src/backend/utils/load/ag_load_labels.c" 2
...
# 55 "src/backend/utils/load/ag_load_labels.c" 2
...
# 57 "src/backend/utils/load/ag_load_labels.c" 2
...
# 58 "src/backend/utils/load/ag_load_labels.c" 2
...
Oid create_label(char *graph_name, char *label_name, char label_type,
                 List *parents);
# 59 "src/backend/utils/load/ag_load_labels.c" 2
...
# 60 "src/backend/utils/load/ag_load_labels.c" 2
...
# 104 ".//src/include/utils/load/ag_load_labels.h"
                                    id_field_exists);
# 64 "src/backend/utils/load/ag_load_labels.c" 2
...
# 65 "src/backend/utils/load/ag_load_labels.c" 2
# 1 ".//src/include/utils/load/csv.h" 1
# 61 ".//src/include/utils/load/csv.h"
struct csv_parser {
    int pstate;
    int quoted;
    size_t spaces;
...
# 66 "src/backend/utils/load/ag_load_labels.c" 2
...
void vertex_field_cb(void *field, size_t field_len, void *data)
{
    ...
    {
        cr->error = 1;
        do { if (errstart(18, "src/backend/utils/load/ag_load_labels.c", 75, __func__, 
# 75 "src/backend/utils/load/ag_load_labels.c" 3 4
       ((void *)0)
# 75 "src/backend/utils/load/ag_load_labels.c"
       )) errfinish (errmsg("There is some unknown error")); if (__builtin_constant_p(18) && (18) >= 20) __builtin_unreachable(); } while(0);
    }
    ...
    if (cr->cur_field == cr->alloc)
    {
        ...
        if (cr->fields == 
# 84 "src/backend/utils/load/ag_load_labels.c" 3 4
                         ((void *)0)
# 84 "src/backend/utils/load/ag_load_labels.c"
                             )
        {
            cr->error = 1;
            do { if (errstart(20, "src/backend/utils/load/ag_load_labels.c", 87, __func__, 
# 87 "src/backend/utils/load/ag_load_labels.c" 3 4
           ((void *)0)
# 87 "src/backend/utils/load/ag_load_labels.c"
           )) errfinish (errmsg("field_cb: failed to reallocate %zu bytes\n", sizeof(char *) * cr->alloc)); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
...
void vertex_row_cb(int delim __attribute__((unused)), void *data)
{
    ...
    csv_vertex_reader *cr = (csv_vertex_reader*)data;
    agtype *props = 
# 102 "src/backend/utils/load/ag_load_labels.c" 3 4
                   ((void *)0)
# 102 "src/backend/utils/load/ag_load_labels.c"
                       ;
    size_t i, n_fields;
    ...
    else
    {
        ...
        {
            label_id_int = strtol(cr->fields[0], 
# 127 "src/backend/utils/load/ag_load_labels.c" 3 4
                                                ((void *)0)
# 127 "src/backend/utils/load/ag_load_labels.c"
                                                    , 10);
        }
        else
        {
    ...
    if (cr->error)
    {
        do { if (errstart(18, "src/backend/utils/load/ag_load_labels.c", 151, __func__, 
# 151 "src/backend/utils/load/ag_load_labels.c" 3 4
       ((void *)0)
# 151 "src/backend/utils/load/ag_load_labels.c"
       )) errfinish (errmsg("THere is some error")); if (__builtin_constant_p(18) && (18) >= 20) __builtin_unreachable(); } while(0);
    }
...
# 189 "src/backend/utils/load/ag_load_labels.c" 3 4
                               _Bool 
# 189 "src/backend/utils/load/ag_load_labels.c"
                                    id_field_exists)
{
    ...
    {
        do { if (errstart(20, "src/backend/utils/load/ag_load_labels.c", 201, __func__, 
# 201 "src/backend/utils/load/ag_load_labels.c" 3 4
       ((void *)0)
# 201 "src/backend/utils/load/ag_load_labels.c"
       )) errfinish (errmsg("Failed to initialize csv parser\n")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                              ;
    }
    ...
    if (!fp)
    {
        do { if (errstart(20, "src/backend/utils/load/ag_load_labels.c", 211, __func__, 
# 211 "src/backend/utils/load/ag_load_labels.c" 3 4
       ((void *)0)
# 211 "src/backend/utils/load/ag_load_labels.c"
       )) errfinish (errmsg("Failed to open %s\n", file_path)); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                           ;
    }
    ...
    while ((bytes_read=fread(buf, 1, 1024, fp)) > 0)
    {
        ...
        {
            do { if (errstart(20, "src/backend/utils/load/ag_load_labels.c", 236, __func__, 
# 236 "src/backend/utils/load/ag_load_labels.c" 3 4
           ((void *)0)
# 236 "src/backend/utils/load/ag_load_labels.c"
           )) errfinish (errmsg("Error while parsing file: %s\n", csv_strerror(csv_error(&p)))); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                 ;
        }
    }
    ...
    if (ferror(fp))
    {
        do { if (errstart(20, "src/backend/utils/load/ag_load_labels.c", 245, __func__, 
# 245 "src/backend/utils/load/ag_load_labels.c" 3 4
       ((void *)0)
# 245 "src/backend/utils/load/ag_load_labels.c"
       )) errfinish (errmsg("Error while reading file %s\n", file_path)); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                           ;
    }
    ...
    csv_free(&p);
    return 
# 253 "src/backend/utils/load/ag_load_labels.c" 3 4
          0
# 253 "src/backend/utils/load/ag_load_labels.c"
                      ;
}
