# 0 "src/backend/utils/ag_func.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/utils/ag_func.c"
# 25 "src/backend/utils/ag_func.c"
...
# 26 "src/backend/utils/ag_func.c" 2
...
# 28 "src/backend/utils/ag_func.c" 2
# 1 "/usr/include/postgresql/11/server/access/htup_details.h" 1
# 18 "/usr/include/postgresql/11/server/access/htup_details.h"
...
# 29 "src/backend/utils/ag_func.c" 2
# 1 "/usr/include/postgresql/11/server/catalog/pg_proc.h" 1
# 21 "/usr/include/postgresql/11/server/catalog/pg_proc.h"
# 1 "/usr/include/postgresql/11/server/catalog/pg_proc_d.h" 1
# 22 "/usr/include/postgresql/11/server/catalog/pg_proc.h" 2

# 1 "/usr/include/postgresql/11/server/catalog/objectaddress.h" 1
# 17 "/usr/include/postgresql/11/server/catalog/objectaddress.h"
...
# 24 "/usr/include/postgresql/11/server/catalog/pg_proc.h" 2
...
# 61 "/usr/include/postgresql/11/server/catalog/pg_proc.h" 3 4
_Bool 
# 61 "/usr/include/postgresql/11/server/catalog/pg_proc.h"
      prosecdef ;


 
# 64 "/usr/include/postgresql/11/server/catalog/pg_proc.h" 3 4
_Bool 
# 64 "/usr/include/postgresql/11/server/catalog/pg_proc.h"
      proleakproof ;


 
# 67 "/usr/include/postgresql/11/server/catalog/pg_proc.h" 3 4
_Bool 
# 67 "/usr/include/postgresql/11/server/catalog/pg_proc.h"
      proisstrict ;


 
# 70 "/usr/include/postgresql/11/server/catalog/pg_proc.h" 3 4
_Bool 
# 70 "/usr/include/postgresql/11/server/catalog/pg_proc.h"
      proretset ;
...
# 125 "/usr/include/postgresql/11/server/catalog/pg_proc.h"
} FormData_pg_proc;
...
# 179 "/usr/include/postgresql/11/server/catalog/pg_proc.h"
extern ObjectAddress ProcedureCreate(const char *procedureName,
    Oid procNamespace,
    
# 181 "/usr/include/postgresql/11/server/catalog/pg_proc.h" 3 4
   _Bool 
# 181 "/usr/include/postgresql/11/server/catalog/pg_proc.h"
        replace,
    
# 182 "/usr/include/postgresql/11/server/catalog/pg_proc.h" 3 4
   _Bool 
# 182 "/usr/include/postgresql/11/server/catalog/pg_proc.h"
        returnsSet,
    Oid returnType,
    Oid proowner,
...
# 190 "/usr/include/postgresql/11/server/catalog/pg_proc.h" 3 4
   _Bool 
# 190 "/usr/include/postgresql/11/server/catalog/pg_proc.h"
        security_definer,
    
# 191 "/usr/include/postgresql/11/server/catalog/pg_proc.h" 3 4
   _Bool 
# 191 "/usr/include/postgresql/11/server/catalog/pg_proc.h"
        isLeakProof,
    
# 192 "/usr/include/postgresql/11/server/catalog/pg_proc.h" 3 4
   _Bool 
# 192 "/usr/include/postgresql/11/server/catalog/pg_proc.h"
        isStrict,
    char volatility,
    char parallel,
...
extern 
# 205 "/usr/include/postgresql/11/server/catalog/pg_proc.h" 3 4
      _Bool 
# 205 "/usr/include/postgresql/11/server/catalog/pg_proc.h"
           function_parse_error_transpose(const char *prosrc);

extern List *oid_array_to_list(Datum datum);
# 30 "src/backend/utils/ag_func.c" 2
...
# 32 "src/backend/utils/ag_func.c" 2
...
# 33 "src/backend/utils/ag_func.c" 2
...
# 34 "src/backend/utils/ag_func.c" 2
...
# 36 "src/backend/utils/ag_func.c" 2
...
# 37 "src/backend/utils/ag_func.c" 2



# 39 "src/backend/utils/ag_func.c" 3 4
_Bool 
# 39 "src/backend/utils/ag_func.c"
    is_oid_ag_func(Oid func_oid, const char *func_name)
{
    HeapTuple proctup;
    Form_pg_proc proc;
    ...
    ((void)
# 46 "src/backend/utils/ag_func.c" 3 4
   1
# 46 "src/backend/utils/ag_func.c"
   );
    ((void)
# 47 "src/backend/utils/ag_func.c" 3 4
   1
# 47 "src/backend/utils/ag_func.c"
   );

    proctup = SearchSysCache1(PROCOID, ((Datum) (func_oid)));
    ((void)
# 50 "src/backend/utils/ag_func.c" 3 4
   1
# 50 "src/backend/utils/ag_func.c"
   );
    proc = (Form_pg_proc)((char *) ((proctup)->t_data) + (proctup)->t_data->t_hoff);
    if (strncmp(((proc->proname).data), func_name, 64) != 0)
    {
        ReleaseSysCache(proctup);
        return 
# 55 "src/backend/utils/ag_func.c" 3 4
              0
# 55 "src/backend/utils/ag_func.c"
                   ;
    }
    ...
    ((void)
# 61 "src/backend/utils/ag_func.c" 3 4
   1
# 61 "src/backend/utils/ag_func.c"
   );
...
Oid get_ag_func_oid(const char *func_name, const int nargs, ...)
{
    ...
    ((void)
# 74 "src/backend/utils/ag_func.c" 3 4
   1
# 74 "src/backend/utils/ag_func.c"
   );
    ((void)
# 75 "src/backend/utils/ag_func.c" 3 4
   1
# 75 "src/backend/utils/ag_func.c"
   );

    
# 77 "src/backend/utils/ag_func.c" 3 4
   __builtin_va_start(
# 77 "src/backend/utils/ag_func.c"
   ap
# 77 "src/backend/utils/ag_func.c" 3 4
   ,
# 77 "src/backend/utils/ag_func.c"
...
# 77 "src/backend/utils/ag_func.c"
    ...
    for (i = 0; i < nargs; i++)
        oids[i] = 
# 79 "src/backend/utils/ag_func.c" 3 4
                 __builtin_va_arg(
# 79 "src/backend/utils/ag_func.c"
                 ap
# 79 "src/backend/utils/ag_func.c" 3 4
                 ,
# 79 "src/backend/utils/ag_func.c"
...
# 80 "src/backend/utils/ag_func.c" 3 4
   __builtin_va_end(
# 80 "src/backend/utils/ag_func.c"
   ap
# 80 "src/backend/utils/ag_func.c" 3 4
   )
# 80 "src/backend/utils/ag_func.c"
    ...
    func_oid = GetSysCacheOid(PROCNAMEARGSNSP, ((Datum) (func_name)), ((Datum) (arg_types)), ((Datum) (ag_catalog_namespace_id())), 0)

                                                                           ;
    if (!((
# 87 "src/backend/utils/ag_func.c" 3 4
        _Bool
# 87 "src/backend/utils/ag_func.c"
        ) ((func_oid) != ((Oid) 0))))
    {
        do { if (errstart(20, "src/backend/utils/ag_func.c", 89, __func__, 
# 89 "src/backend/utils/ag_func.c" 3 4
       ((void *)0)
# 89 "src/backend/utils/ag_func.c"
       )) errfinish (errmsg_internal("ag function does not exist"), errdetail_internal("%s(%d)", func_name, nargs)); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                        ;
    }
...
Oid get_pg_func_oid(const char *func_name, const int nargs, ...)
{
    ...
    ((void)
# 104 "src/backend/utils/ag_func.c" 3 4
   1
# 104 "src/backend/utils/ag_func.c"
   );
    ((void)
# 105 "src/backend/utils/ag_func.c" 3 4
   1
# 105 "src/backend/utils/ag_func.c"
   );

    
# 107 "src/backend/utils/ag_func.c" 3 4
   __builtin_va_start(
# 107 "src/backend/utils/ag_func.c"
   ap
# 107 "src/backend/utils/ag_func.c" 3 4
   ,
# 107 "src/backend/utils/ag_func.c"
...
# 107 "src/backend/utils/ag_func.c"
    ...
    for (i = 0; i < nargs; i++)
        oids[i] = 
# 109 "src/backend/utils/ag_func.c" 3 4
                 __builtin_va_arg(
# 109 "src/backend/utils/ag_func.c"
                 ap
# 109 "src/backend/utils/ag_func.c" 3 4
                 ,
# 109 "src/backend/utils/ag_func.c"
...
# 110 "src/backend/utils/ag_func.c" 3 4
   __builtin_va_end(
# 110 "src/backend/utils/ag_func.c"
   ap
# 110 "src/backend/utils/ag_func.c" 3 4
   )
# 110 "src/backend/utils/ag_func.c"
    ...
    func_oid = GetSysCacheOid(PROCNAMEARGSNSP, ((Datum) (func_name)), ((Datum) (arg_types)), ((Datum) (pg_catalog_namespace_id())), 0)

                                                                           ;
    if (!((
# 117 "src/backend/utils/ag_func.c" 3 4
        _Bool
# 117 "src/backend/utils/ag_func.c"
        ) ((func_oid) != ((Oid) 0))))
    {
        do { if (errstart(20, "src/backend/utils/ag_func.c", 119, __func__, 
# 119 "src/backend/utils/ag_func.c" 3 4
       ((void *)0)
# 119 "src/backend/utils/ag_func.c"
       )) errfinish (errmsg_internal("pg function does not exist"), errdetail_internal("%s(%d)", func_name, nargs)); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                        ;
    }
