# 0 "src/backend/utils/graph_generation.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/utils/graph_generation.c"
# 20 "src/backend/utils/graph_generation.c"
...
# 21 "src/backend/utils/graph_generation.c" 2
...
# 20 "/usr/include/postgresql/11/server/access/xact.h" 2
...
# 23 "src/backend/utils/graph_generation.c" 2
...
# 24 "src/backend/utils/graph_generation.c" 2
...
# 25 "src/backend/utils/graph_generation.c" 2
...
# 26 "src/backend/utils/graph_generation.c" 2
...
# 28 "src/backend/utils/graph_generation.c" 2
# 1 "/usr/include/postgresql/11/server/commands/schemacmds.h" 1
# 21 "/usr/include/postgresql/11/server/commands/schemacmds.h"
...
# 29 "src/backend/utils/graph_generation.c" 2
# 1 "/usr/include/postgresql/11/server/commands/tablecmds.h" 1
# 21 "/usr/include/postgresql/11/server/commands/tablecmds.h"
...
# 602 "/usr/include/postgresql/11/server/storage/lock.h"
                                                           wait);
# 22 "/usr/include/postgresql/11/server/commands/tablecmds.h" 2
...
# 100 "/usr/include/postgresql/11/server/commands/tablecmds.h"
          ...
          List *partConstraint);
# 30 "src/backend/utils/graph_generation.c" 2
...
# 32 "src/backend/utils/graph_generation.c" 2
...
# 33 "src/backend/utils/graph_generation.c" 2
...
# 38 "src/backend/utils/graph_generation.c" 2
# 1 "/usr/include/postgresql/11/server/utils/fmgroids.h" 1
# 39 "src/backend/utils/graph_generation.c" 2
...
# 41 "src/backend/utils/graph_generation.c" 2
...
# 43 "src/backend/utils/graph_generation.c" 2
...
# 44 "src/backend/utils/graph_generation.c" 2
...
Oid create_label(char *graph_name, char *label_name, char label_type,
                 List *parents);
# 45 "src/backend/utils/graph_generation.c" 2

# 1 ".//src/include/commands/graph_commands.h" 1
# 25 ".//src/include/commands/graph_commands.h"
Datum create_graph(FunctionCallInfo fcinfo);
# 47 "src/backend/utils/graph_generation.c" 2
# 1 ".//src/include/utils/load/age_load.h" 1
# 25 ".//src/include/utils/load/age_load.h"
...
# 26 ".//src/include/utils/load/age_load.h" 2
...
# 30 ".//src/include/utils/load/age_load.h" 2
# 43 ".//src/include/utils/load/age_load.h"
...
# 44 ".//src/include/utils/load/age_load.h" 2
...
# 46 ".//src/include/utils/load/age_load.h" 2
...
# 66 "/usr/include/postgresql/11/server/utils/inval.h"
                                               debug_discard);
# 47 ".//src/include/utils/load/age_load.h" 2
...
# 48 ".//src/include/utils/load/age_load.h" 2
...
# 54 ".//src/include/utils/load/age_load.h" 2
...
# 48 "src/backend/utils/graph_generation.c" 2
...
# 49 "src/backend/utils/graph_generation.c" 2
...
# 104 ".//src/include/utils/load/ag_load_labels.h"
                                    id_field_exists);
# 50 "src/backend/utils/graph_generation.c" 2


extern Datum create_complete_graph(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_create_complete_graph(void); const Pg_finfo_record * pg_finfo_create_complete_graph (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;





Datum create_complete_graph(FunctionCallInfo fcinfo)
{
    Oid graph_id;
    Name graph_name;
    ...
    Name vtx_label_name = 
# 66 "src/backend/utils/graph_generation.c" 3 4
                         ((void *)0)
# 66 "src/backend/utils/graph_generation.c"
                             ;
    ...
    agtype *props = 
# 71 "src/backend/utils/graph_generation.c" 3 4
                   ((void *)0)
# 71 "src/backend/utils/graph_generation.c"
                       ;
    ...
    if ((fcinfo->argnull[0]))
    {
        do { if (errstart(20, "src/backend/utils/graph_generation.c", 98, __func__, 
# 98 "src/backend/utils/graph_generation.c" 3 4
       ((void *)0)
# 98 "src/backend/utils/graph_generation.c"
       )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('2') - '0') & 0x3F) << 18) + (((('3') - '0') & 0x3F) << 24))), errmsg("graph name can not be NULL")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                              ;
    }

    if ((fcinfo->argnull[1]))
    {
        do { if (errstart(20, "src/backend/utils/graph_generation.c", 104, __func__, 
# 104 "src/backend/utils/graph_generation.c" 3 4
       ((void *)0)
# 104 "src/backend/utils/graph_generation.c"
       )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('2') - '0') & 0x3F) << 18) + (((('3') - '0') & 0x3F) << 24))), errmsg("number of nodes can not be NULL")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                           ;
    }

    if ((fcinfo->argnull[2]))
    {
        do { if (errstart(20, "src/backend/utils/graph_generation.c", 110, __func__, 
# 110 "src/backend/utils/graph_generation.c" 3 4
       ((void *)0)
# 110 "src/backend/utils/graph_generation.c"
       )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('2') - '0') & 0x3F) << 18) + (((('3') - '0') & 0x3F) << 24))), errmsg("edge label can not be NULL")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                      ;
    }


    graph_name = ((Name) ((Pointer) ((fcinfo->arg[0]))));
    no_vertices = (int64) ((int64) ((fcinfo->arg[1])));
    edge_label_name = ((Name) ((Pointer) ((fcinfo->arg[2]))));
    namestrcpy(vtx_label_name, "_ag_label_vertex");

    graph_name_str = ((*graph_name).data);
    vtx_name_str = "_ag_label_vertex";
    edge_name_str = ((*edge_label_name).data);


    if (!((
# 125 "src/backend/utils/graph_generation.c" 3 4
        _Bool
# 125 "src/backend/utils/graph_generation.c"
        ) ((get_graph_oid(graph_name_str)) != ((Oid) 0))))
    {
        DirectFunctionCall1Coll(create_graph, ((Oid) 0), ((Datum) (graph_name)));
    ...
    if (!(fcinfo->argnull[3]))
    {
        vtx_label_name = ((Name) ((Pointer) ((fcinfo->arg[3]))));
        vtx_name_str = ((*vtx_label_name).data);

        if (!((
# 140 "src/backend/utils/graph_generation.c" 3 4
            _Bool
# 140 "src/backend/utils/graph_generation.c"
            ) ((get_label_oid(vtx_name_str, graph_id)) != ((Oid) 0))))
        {
            DirectFunctionCall2Coll(create_vlabel, ((Oid) 0), ((Datum) (graph_name)), ((Datum) (vtx_label_name)));
        }
    }

    if (!((
# 146 "src/backend/utils/graph_generation.c" 3 4
        _Bool
# 146 "src/backend/utils/graph_generation.c"
        ) ((get_label_oid(edge_name_str, graph_id)) != ((Oid) 0))))
    {
        DirectFunctionCall2Coll(create_elabel, ((Oid) 0), ((Datum) (graph_name)), ((Datum) (edge_label_name)));
    }
    ...
    vtx_seq_name_str = ((*vtx_seq_name).data);

    edge_seq_name = &(edge_cache->seq_name);
    edge_seq_name_str = ((*edge_seq_name).data);
    ...
    {
        vid = nextval_internal(vtx_seq_id, 
# 171 "src/backend/utils/graph_generation.c" 3 4
                                          1
# 171 "src/backend/utils/graph_generation.c"
                                              );
    ...
    for (i = 1;i<=no_vertices-1;i++)
    {
        ...
        for(j=i+1;j<=no_vertices;j++)
        {
            ...
            eid = nextval_internal(edge_seq_id, 
# 186 "src/backend/utils/graph_generation.c" 3 4
                                               1
# 186 "src/backend/utils/graph_generation.c"
                                                   );
