# 0 "src/backend/utils/adt/cypher_funcs.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/utils/adt/cypher_funcs.c"
# 20 "src/backend/utils/adt/cypher_funcs.c"
...
# 21 "src/backend/utils/adt/cypher_funcs.c" 2
...
# 23 "src/backend/utils/adt/cypher_funcs.c" 2

extern Datum cypher(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_cypher(void); const Pg_finfo_record * pg_finfo_cypher (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;

Datum cypher(FunctionCallInfo fcinfo)
{
    const char *s;

    s = (fcinfo->argnull[0]) ? "NULL" : ((char *) ((Pointer) ((fcinfo->arg[0]))));

    do { if (errstart(20, "src/backend/utils/adt/cypher_funcs.c", 32, __func__, 
# 32 "src/backend/utils/adt/cypher_funcs.c" 3 4
   ((void *)0)
# 32 "src/backend/utils/adt/cypher_funcs.c"
   )) errfinish (errmsg_internal("unhandled cypher(cstring) function call"), errdetail_internal("%s", s)); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                 ;

    do { fcinfo->isnull = 
# 35 "src/backend/utils/adt/cypher_funcs.c" 3 4
   1
# 35 "src/backend/utils/adt/cypher_funcs.c"
   ; return (Datum) 0; } while (0);
}

extern Datum _cypher_create_clause(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo__cypher_create_clause(void); const Pg_finfo_record * pg_finfo__cypher_create_clause (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;

Datum _cypher_create_clause(FunctionCallInfo fcinfo)
{
    do { fcinfo->isnull = 
# 42 "src/backend/utils/adt/cypher_funcs.c" 3 4
   1
# 42 "src/backend/utils/adt/cypher_funcs.c"
   ; return (Datum) 0; } while (0);
}

extern Datum _cypher_set_clause(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo__cypher_set_clause(void); const Pg_finfo_record * pg_finfo__cypher_set_clause (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;

Datum _cypher_set_clause(FunctionCallInfo fcinfo)
{
    do { fcinfo->isnull = 
# 49 "src/backend/utils/adt/cypher_funcs.c" 3 4
   1
# 49 "src/backend/utils/adt/cypher_funcs.c"
   ; return (Datum) 0; } while (0);
}

extern Datum _cypher_delete_clause(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo__cypher_delete_clause(void); const Pg_finfo_record * pg_finfo__cypher_delete_clause (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;

Datum _cypher_delete_clause(FunctionCallInfo fcinfo)
{
    do { fcinfo->isnull = 
# 56 "src/backend/utils/adt/cypher_funcs.c" 3 4
   1
# 56 "src/backend/utils/adt/cypher_funcs.c"
   ; return (Datum) 0; } while (0);
}

extern Datum _cypher_merge_clause(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo__cypher_merge_clause(void); const Pg_finfo_record * pg_finfo__cypher_merge_clause (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;

Datum _cypher_merge_clause(FunctionCallInfo fcinfo)
{
    do { fcinfo->isnull = 
# 63 "src/backend/utils/adt/cypher_funcs.c" 3 4
   1
# 63 "src/backend/utils/adt/cypher_funcs.c"
   ; return (Datum) 0; } while (0);
}
