# 0 "src/backend/utils/adt/graphid.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/utils/adt/graphid.c"
# 20 "src/backend/utils/adt/graphid.c"
...
# 21 "src/backend/utils/adt/graphid.c" 2
...
# 23 "src/backend/utils/adt/graphid.c" 2
...
# 57 "/usr/include/postgresql/11/server/utils/sortsupport.h" 2
...
extern void PrepareSortSupportFromIndexRel(Relation indexRel, int16 strategy,
          SortSupport ssup);
# 25 "src/backend/utils/adt/graphid.c" 2
...
# 20 "/usr/include/postgresql/11/server/utils/syscache.h"
...
# 21 "/usr/include/postgresql/11/server/utils/syscache.h" 2
...
# 27 "src/backend/utils/adt/graphid.c" 2

static int graphid_btree_fast_cmp(Datum x, Datum y, SortSupport ssup);


static Oid g_GRAPHIDOID = ((Oid) 0);
static Oid g_GRAPHIDARRAYOID = ((Oid) 0);


Oid get_GRAPHIDOID(void)
{
    if (g_GRAPHIDOID == ((Oid) 0))
    {
        g_GRAPHIDOID = GetSysCacheOid(TYPENAMENSP, ((Datum) ("graphid")), ((Datum) (ag_catalog_namespace_id())), 0, 0)
                                                                                   ;
    }
...
Oid get_GRAPHIDARRAYOID(void)
{
    if (g_GRAPHIDARRAYOID == ((Oid) 0))
    {
        g_GRAPHIDARRAYOID = GetSysCacheOid(TYPENAMENSP, ((Datum) ("_graphid")), ((Datum) (ag_catalog_namespace_id())), 0, 0)
...
{
    g_GRAPHIDOID = ((Oid) 0);
    g_GRAPHIDARRAYOID = ((Oid) 0);
}

extern Datum graphid_in(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_graphid_in(void); const Pg_finfo_record * pg_finfo_graphid_in (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;


Datum graphid_in(FunctionCallInfo fcinfo)
{
    char *str = ((char *) ((Pointer) ((fcinfo->arg[0]))));
    char *endptr;
    int64 i;

    
# 75 "src/backend/utils/adt/graphid.c" 3 4
   (*__errno_location ()) 
# 75 "src/backend/utils/adt/graphid.c"
         = 0;
    i = strtol(str, &endptr, 10);
    if (
# 77 "src/backend/utils/adt/graphid.c" 3 4
       (*__errno_location ()) 
# 77 "src/backend/utils/adt/graphid.c"
             != 0 || endptr == str || *endptr != '\0')
    {
        do { if (errstart(20, "src/backend/utils/adt/graphid.c", 79, __func__, 
# 79 "src/backend/utils/adt/graphid.c" 3 4
       ((void *)0)
# 79 "src/backend/utils/adt/graphid.c"
       )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('P') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('2') - '0') & 0x3F) << 24))), errmsg("invalid value for type graphid: \"%s\"", str)); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
...
extern Datum graphid_out(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_graphid_out(void); const Pg_finfo_record * pg_finfo_graphid_out (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;


Datum graphid_out(FunctionCallInfo fcinfo)
{
    graphid gid = ((int64) ((fcinfo->arg[0])));
    char buf[32];
    char *out;
...
extern Datum graphid_eq(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_graphid_eq(void); const Pg_finfo_record * pg_finfo_graphid_eq (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;

Datum graphid_eq(FunctionCallInfo fcinfo)
{
    graphid lgid = ((int64) ((fcinfo->arg[0])));
    graphid rgid = ((int64) ((fcinfo->arg[1])));

    return ((Datum) ((lgid == rgid) ? 1 : 0));
}

extern Datum graphid_ne(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_graphid_ne(void); const Pg_finfo_record * pg_finfo_graphid_ne (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;

Datum graphid_ne(FunctionCallInfo fcinfo)
{
    graphid lgid = ((int64) ((fcinfo->arg[0])));
    graphid rgid = ((int64) ((fcinfo->arg[1])));
...
extern Datum graphid_lt(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_graphid_lt(void); const Pg_finfo_record * pg_finfo_graphid_lt (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;

Datum graphid_lt(FunctionCallInfo fcinfo)
{
    graphid lgid = ((int64) ((fcinfo->arg[0])));
    graphid rgid = ((int64) ((fcinfo->arg[1])));
...
extern Datum graphid_gt(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_graphid_gt(void); const Pg_finfo_record * pg_finfo_graphid_gt (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;

Datum graphid_gt(FunctionCallInfo fcinfo)
{
    graphid lgid = ((int64) ((fcinfo->arg[0])));
    graphid rgid = ((int64) ((fcinfo->arg[1])));
...
extern Datum graphid_le(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_graphid_le(void); const Pg_finfo_record * pg_finfo_graphid_le (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;

Datum graphid_le(FunctionCallInfo fcinfo)
{
    graphid lgid = ((int64) ((fcinfo->arg[0])));
    graphid rgid = ((int64) ((fcinfo->arg[1])));
...
extern Datum graphid_ge(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_graphid_ge(void); const Pg_finfo_record * pg_finfo_graphid_ge (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;

Datum graphid_ge(FunctionCallInfo fcinfo)
{
    graphid lgid = ((int64) ((fcinfo->arg[0])));
    graphid rgid = ((int64) ((fcinfo->arg[1])));
...
extern Datum graphid_btree_cmp(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_graphid_btree_cmp(void); const Pg_finfo_record * pg_finfo_graphid_btree_cmp (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;

Datum graphid_btree_cmp(FunctionCallInfo fcinfo)
{
    graphid lgid = ((int64) ((fcinfo->arg[0])));
    graphid rgid = ((int64) ((fcinfo->arg[1])));
...
extern Datum graphid_btree_sort(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_graphid_btree_sort(void); const Pg_finfo_record * pg_finfo_graphid_btree_sort (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;

Datum graphid_btree_sort(FunctionCallInfo fcinfo)
{
    SortSupport ssup = (SortSupport)((Pointer) ((fcinfo->arg[0])));
...
static int graphid_btree_fast_cmp(Datum x, Datum y, SortSupport ssup)
{
    graphid lgid = ((int64) (x));
    graphid rgid = ((int64) (y));
...
graphid make_graphid(const int32 label_id, const int64 entry_id)
{
    ...
    if (!(label_id >= 1 && label_id <= (0xFFFF)))
    {
        do { if (errstart(20, "src/backend/utils/adt/graphid.c", 206, __func__, 
# 206 "src/backend/utils/adt/graphid.c" 3 4
       ((void *)0)
# 206 "src/backend/utils/adt/graphid.c"
       )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('2') - '0') & 0x3F) << 18) + (((('3') - '0') & 0x3F) << 24))), errmsg("label_id must be %d .. %d", 1, (0xFFFF))); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)

                                                            ;
    }
    if (!(entry_id >= (1L) && entry_id <= (281474976710655L)))
    {
        do { if (errstart(20, "src/backend/utils/adt/graphid.c", 212, __func__, 
# 212 "src/backend/utils/adt/graphid.c" 3 4
       ((void *)0)
# 212 "src/backend/utils/adt/graphid.c"
       )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('2') - '0') & 0x3F) << 18) + (((('3') - '0') & 0x3F) << 24))), errmsg("entry_id must be " "%" "l" "d" " .. " "%" "l" "d", (1L), (281474976710655L))); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)


                                                     ;
    }

    tmp = (((uint64)label_id) << (32 + 16)) |
          (((uint64)entry_id) & (0x0000ffffffffffffL));
...
int32 get_graphid_label_id(const graphid gid)
{
    return (int32)(((uint64)gid) >> (32 + 16));
}

int64 get_graphid_entry_id(const graphid gid)
{
    return (int64)(((uint64)gid) & (0x0000ffffffffffffL));
}

extern Datum _graphid(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo__graphid(void); const Pg_finfo_record * pg_finfo__graphid (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;

Datum _graphid(FunctionCallInfo fcinfo)
{
    int32 label_id;
    int64 entry_id;
    graphid gid;
    ...
    {
        do { if (errstart(20, "src/backend/utils/adt/graphid.c", 244, __func__, 
# 244 "src/backend/utils/adt/graphid.c" 3 4
       ((void *)0)
# 244 "src/backend/utils/adt/graphid.c"
       )) errfinish (errcode((((('2') - '0') & 0x3F) + (((('2') - '0') & 0x3F) << 6) + (((('0') - '0') & 0x3F) << 12) + (((('0') - '0') & 0x3F) << 18) + (((('4') - '0') & 0x3F) << 24))), errmsg("label_id and entry_id must not be null")); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0)
                                                                          ;
    }
    label_id = ((int32) ((fcinfo->arg[0])));
    entry_id = ((int64) ((fcinfo->arg[1])));
...
extern Datum graphid_hash_cmp(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_graphid_hash_cmp(void); const Pg_finfo_record * pg_finfo_graphid_hash_cmp (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;

Datum graphid_hash_cmp(FunctionCallInfo fcinfo)
{
    graphid l = ((int64) ((fcinfo->arg[0])));
    int hash = (int) ((l >> 32) ^ l);
