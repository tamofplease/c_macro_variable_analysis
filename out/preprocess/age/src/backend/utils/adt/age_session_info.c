# 0 "src/backend/utils/adt/age_session_info.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/utils/adt/age_session_info.c"
# 20 "src/backend/utils/adt/age_session_info.c"
...
# 21 "src/backend/utils/adt/age_session_info.c" 2
...
# 358 "/usr/include/postgresql/11/server/funcapi.h"
                        **nulls);
# 23 "src/backend/utils/adt/age_session_info.c" 2
...
# 25 "src/backend/utils/adt/age_session_info.c" 2
...
# 26 "src/backend/utils/adt/age_session_info.c" 2




static int session_info_pid = -1;
static char *session_info_graph_name = 
# 31 "src/backend/utils/adt/age_session_info.c" 3 4
                                      ((void *)0)
# 31 "src/backend/utils/adt/age_session_info.c"
                                          ;
static char *session_info_cypher_statement = 
# 32 "src/backend/utils/adt/age_session_info.c" 3 4
                                            ((void *)0)
# 32 "src/backend/utils/adt/age_session_info.c"
                                                ;
static 
# 33 "src/backend/utils/adt/age_session_info.c" 3 4
      _Bool 
# 33 "src/backend/utils/adt/age_session_info.c"
           session_info_prepared = 
# 33 "src/backend/utils/adt/age_session_info.c" 3 4
                                   0
# 33 "src/backend/utils/adt/age_session_info.c"
                                        ;
...
# 40 "src/backend/utils/adt/age_session_info.c" 3 4
                          ((void *)0)
# 40 "src/backend/utils/adt/age_session_info.c"
                              ;
    ...
    if (graph_name != 
# 50 "src/backend/utils/adt/age_session_info.c" 3 4
                     ((void *)0)
# 50 "src/backend/utils/adt/age_session_info.c"
                         )
    {
    ...
    {
        session_info_graph_name = 
# 56 "src/backend/utils/adt/age_session_info.c" 3 4
                                 ((void *)0)
# 56 "src/backend/utils/adt/age_session_info.c"
                                     ;
    }

    if (cypher_statement != 
# 59 "src/backend/utils/adt/age_session_info.c" 3 4
                           ((void *)0)
# 59 "src/backend/utils/adt/age_session_info.c"
                               )
    {
    ...
    {
        session_info_cypher_statement = 
# 65 "src/backend/utils/adt/age_session_info.c" 3 4
                                       ((void *)0)
# 65 "src/backend/utils/adt/age_session_info.c"
                                           ;
    }
    ...
    session_info_prepared = 
# 72 "src/backend/utils/adt/age_session_info.c" 3 4
                           1
# 72 "src/backend/utils/adt/age_session_info.c"
                               ;
}
...
char *get_session_info_graph_name(void)
{
    if (is_session_info_prepared() &&
        session_info_graph_name != 
# 83 "src/backend/utils/adt/age_session_info.c" 3 4
                                  ((void *)0)
# 83 "src/backend/utils/adt/age_session_info.c"
                                      )
    {
    ...
    return 
# 88 "src/backend/utils/adt/age_session_info.c" 3 4
          ((void *)0)
# 88 "src/backend/utils/adt/age_session_info.c"
              ;
}
...
char *get_session_info_cypher_statement(void)
{
    if (is_session_info_prepared() &&
        session_info_cypher_statement != 
# 99 "src/backend/utils/adt/age_session_info.c" 3 4
                                        ((void *)0)
# 99 "src/backend/utils/adt/age_session_info.c"
                                            )
    {
    ...
    return 
# 104 "src/backend/utils/adt/age_session_info.c" 3 4
          ((void *)0)
# 104 "src/backend/utils/adt/age_session_info.c"
              ;
}



# 108 "src/backend/utils/adt/age_session_info.c" 3 4
_Bool 
# 108 "src/backend/utils/adt/age_session_info.c"
    is_session_info_prepared(void)
{

    if (session_info_prepared == 
# 111 "src/backend/utils/adt/age_session_info.c" 3 4
                                1 
# 111 "src/backend/utils/adt/age_session_info.c"
                                     &&
        session_info_pid == getpid())
    {
        return 
# 114 "src/backend/utils/adt/age_session_info.c" 3 4
              1
# 114 "src/backend/utils/adt/age_session_info.c"
                  ;
    }

    return 
# 117 "src/backend/utils/adt/age_session_info.c" 3 4
          0
# 117 "src/backend/utils/adt/age_session_info.c"
               ;
}
...
void reset_session_info(void)
{
    ...
    if (session_info_prepared == 
# 124 "src/backend/utils/adt/age_session_info.c" 3 4
                                1
# 124 "src/backend/utils/adt/age_session_info.c"
                                    )
    {
        if (session_info_graph_name != 
# 126 "src/backend/utils/adt/age_session_info.c" 3 4
                                      ((void *)0)
# 126 "src/backend/utils/adt/age_session_info.c"
                                          )
        {
            pfree(session_info_graph_name);
        }

        if (session_info_cypher_statement != 
# 131 "src/backend/utils/adt/age_session_info.c" 3 4
                                            ((void *)0)
# 131 "src/backend/utils/adt/age_session_info.c"
                                                )
        {
    ...
    session_info_graph_name = 
# 138 "src/backend/utils/adt/age_session_info.c" 3 4
                             ((void *)0)
# 138 "src/backend/utils/adt/age_session_info.c"
                                 ;
    session_info_cypher_statement = 
# 139 "src/backend/utils/adt/age_session_info.c" 3 4
                                   ((void *)0)
# 139 "src/backend/utils/adt/age_session_info.c"
                                       ;
    session_info_prepared = 
# 140 "src/backend/utils/adt/age_session_info.c" 3 4
                           0
# 140 "src/backend/utils/adt/age_session_info.c"
                                ;
    session_info_pid = -1;
}


extern Datum age_prepare_cypher(FunctionCallInfo fcinfo); extern const Pg_finfo_record * pg_finfo_age_prepare_cypher(void); const Pg_finfo_record * pg_finfo_age_prepare_cypher (void) { static const Pg_finfo_record my_finfo = { 1 }; return &my_finfo; } extern int no_such_variable;

Datum age_prepare_cypher(FunctionCallInfo fcinfo)
{
    char *graph_name_str = 
# 149 "src/backend/utils/adt/age_session_info.c" 3 4
                          ((void *)0)
# 149 "src/backend/utils/adt/age_session_info.c"
                              ;
    char *cypher_statement_str = 
# 150 "src/backend/utils/adt/age_session_info.c" 3 4
                                ((void *)0)
# 150 "src/backend/utils/adt/age_session_info.c"
                                    ;
    ...
    {
        return ((Datum) ((
# 155 "src/backend/utils/adt/age_session_info.c" 3 4
       0
# 155 "src/backend/utils/adt/age_session_info.c"
       ) ? 1 : 0));
    }

    graph_name_str = ((char *) ((Pointer) ((fcinfo->arg[0]))));
    cypher_statement_str = ((char *) ((Pointer) ((fcinfo->arg[1]))));


    if (graph_name_str == 
# 162 "src/backend/utils/adt/age_session_info.c" 3 4
                         ((void *)0) 
# 162 "src/backend/utils/adt/age_session_info.c"
                              || cypher_statement_str == 
# 162 "src/backend/utils/adt/age_session_info.c" 3 4
                                                         ((void *)0)
# 162 "src/backend/utils/adt/age_session_info.c"
                                                             )
    {
        return ((Datum) ((
# 164 "src/backend/utils/adt/age_session_info.c" 3 4
       0
# 164 "src/backend/utils/adt/age_session_info.c"
       ) ? 1 : 0));
    }
    ...
    return ((Datum) ((
# 169 "src/backend/utils/adt/age_session_info.c" 3 4
   1
# 169 "src/backend/utils/adt/age_session_info.c"
   ) ? 1 : 0));
}
