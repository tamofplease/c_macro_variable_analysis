# 0 "src/backend/utils/adt/ag_float8_supp.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/utils/adt/ag_float8_supp.c"
# 26 "src/backend/utils/adt/ag_float8_supp.c"
...
# 27 "src/backend/utils/adt/ag_float8_supp.c" 2
...
# 29 "src/backend/utils/adt/ag_float8_supp.c" 2
...
# 31 "src/backend/utils/adt/ag_float8_supp.c" 2
# 1 ".//src/include/utils/ag_float8_supp.h" 1
# 30 ".//src/include/utils/ag_float8_supp.h"

# 30 ".//src/include/utils/ag_float8_supp.h" 3 4
_Bool 
# 30 ".//src/include/utils/ag_float8_supp.h"
    is_float8_special_number(float8 number);
float8 float8in_internal_null(char *num, char **endptr_p, const char *type_name,
                              const char *orig_string, 
# 32 ".//src/include/utils/ag_float8_supp.h" 3 4
                                                      _Bool 
# 32 ".//src/include/utils/ag_float8_supp.h"
                                                           *is_valid);
# 32 "src/backend/utils/adt/ag_float8_supp.c" 2
# 55 "src/backend/utils/adt/ag_float8_supp.c"
float8 float8in_internal_null(char *num, char **endptr_p, const char *type_name,
                              const char *orig_string, 
# 56 "src/backend/utils/adt/ag_float8_supp.c" 3 4
                                                      _Bool 
# 56 "src/backend/utils/adt/ag_float8_supp.c"
                                                           *is_valid)
{
    double val;
    char *endptr;
    ...
    *is_valid = 
# 61 "src/backend/utils/adt/ag_float8_supp.c" 3 4
               0
# 61 "src/backend/utils/adt/ag_float8_supp.c"
                    ;


    while (*num != '\0' && 
# 64 "src/backend/utils/adt/ag_float8_supp.c" 3 4
                          ((*__ctype_b_loc ())[(int) ((
# 64 "src/backend/utils/adt/ag_float8_supp.c"
                          (unsigned char) *num
# 64 "src/backend/utils/adt/ag_float8_supp.c" 3 4
...
# 74 "src/backend/utils/adt/ag_float8_supp.c" 3 4
   (*__errno_location ()) 
# 74 "src/backend/utils/adt/ag_float8_supp.c"
         = 0;
    val = strtod(num, &endptr);


    if (endptr == num || 
# 78 "src/backend/utils/adt/ag_float8_supp.c" 3 4
                        (*__errno_location ()) 
# 78 "src/backend/utils/adt/ag_float8_supp.c"
                              != 0)
    {
        int save_errno = 
# 80 "src/backend/utils/adt/ag_float8_supp.c" 3 4
                        (*__errno_location ())
# 80 "src/backend/utils/adt/ag_float8_supp.c"
                             ;
# 92 "src/backend/utils/adt/ag_float8_supp.c"
...
# 127 "src/backend/utils/adt/ag_float8_supp.c" 3 4
                              34
# 127 "src/backend/utils/adt/ag_float8_supp.c"
                                    )
        {
# 140 "src/backend/utils/adt/ag_float8_supp.c"
            if (val == 0.0 || val >= 
# 140 "src/backend/utils/adt/ag_float8_supp.c" 3 4
                                    (__builtin_huge_val ()) 
# 140 "src/backend/utils/adt/ag_float8_supp.c"
                                             || val <= -
# 140 "src/backend/utils/adt/ag_float8_supp.c" 3 4
...
# 165 "src/backend/utils/adt/ag_float8_supp.c"
    while (*endptr != '\0' && 
# 165 "src/backend/utils/adt/ag_float8_supp.c" 3 4
                             ((*__ctype_b_loc ())[(int) ((
# 165 "src/backend/utils/adt/ag_float8_supp.c"
...
# 165 "src/backend/utils/adt/ag_float8_supp.c"
    ...
    *is_valid = 
# 174 "src/backend/utils/adt/ag_float8_supp.c" 3 4
               1
# 174 "src/backend/utils/adt/ag_float8_supp.c"
                   ;
