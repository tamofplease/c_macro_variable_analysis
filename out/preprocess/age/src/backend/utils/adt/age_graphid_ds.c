# 0 "src/backend/utils/adt/age_graphid_ds.c"
# 1 "/age//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/backend/utils/adt/age_graphid_ds.c"
# 20 "src/backend/utils/adt/age_graphid_ds.c"
...
# 21 "src/backend/utils/adt/age_graphid_ds.c" 2

# 1 ".//src/include/utils/graphid.h" 1
# 25 ".//src/include/utils/graphid.h"
...
# 26 ".//src/include/utils/graphid.h" 2
...
# 23 "src/backend/utils/adt/age_graphid_ds.c" 2
...
# 24 "src/backend/utils/adt/age_graphid_ds.c" 2
...
{
    if (stack == 
# 69 "src/backend/utils/adt/age_graphid_ds.c" 3 4
                ((void *)0)
# 69 "src/backend/utils/adt/age_graphid_ds.c"
                    )
    {
        return 
# 71 "src/backend/utils/adt/age_graphid_ds.c" 3 4
              ((void *)0)
# 71 "src/backend/utils/adt/age_graphid_ds.c"
                  ;
    }
...
ListGraphId *append_graphid(ListGraphId *container, graphid id)
{
    GraphIdNode *new_node = 
# 101 "src/backend/utils/adt/age_graphid_ds.c" 3 4
                           ((void *)0)
# 101 "src/backend/utils/adt/age_graphid_ds.c"
                               ;
    ...
    new_node->id = id;
    new_node->next = 
# 106 "src/backend/utils/adt/age_graphid_ds.c" 3 4
                    ((void *)0)
# 106 "src/backend/utils/adt/age_graphid_ds.c"
                        ;
    ...
    if (container == 
# 112 "src/backend/utils/adt/age_graphid_ds.c" 3 4
                    ((void *)0)
# 112 "src/backend/utils/adt/age_graphid_ds.c"
                        )
    {
...
# 133 "src/backend/utils/adt/age_graphid_ds.c" 3 4
                            ((void *)0)
# 133 "src/backend/utils/adt/age_graphid_ds.c"
                                ;
    GraphIdNode *next_node = 
# 134 "src/backend/utils/adt/age_graphid_ds.c" 3 4
                            ((void *)0)
# 134 "src/backend/utils/adt/age_graphid_ds.c"
                                ;


    if (container == 
# 137 "src/backend/utils/adt/age_graphid_ds.c" 3 4
                    ((void *)0)
# 137 "src/backend/utils/adt/age_graphid_ds.c"
                        )
    {
        return;
    }
    ...
    while (curr_node != 
# 144 "src/backend/utils/adt/age_graphid_ds.c" 3 4
                       ((void *)0)
# 144 "src/backend/utils/adt/age_graphid_ds.c"
                           )
    {
...
{
    ListGraphId *stack = 
# 159 "src/backend/utils/adt/age_graphid_ds.c" 3 4
                        ((void *)0)
# 159 "src/backend/utils/adt/age_graphid_ds.c"
                            ;
    ...
    stack->head = 
# 165 "src/backend/utils/adt/age_graphid_ds.c" 3 4
                 ((void *)0)
# 165 "src/backend/utils/adt/age_graphid_ds.c"
                     ;
    stack->tail = 
# 166 "src/backend/utils/adt/age_graphid_ds.c" 3 4
                 ((void *)0)
# 166 "src/backend/utils/adt/age_graphid_ds.c"
                     ;
    stack->size = 0;
...
{
    ((void)
# 176 "src/backend/utils/adt/age_graphid_ds.c" 3 4
   1
# 176 "src/backend/utils/adt/age_graphid_ds.c"
   );

    if (stack == 
# 178 "src/backend/utils/adt/age_graphid_ds.c" 3 4
                ((void *)0)
# 178 "src/backend/utils/adt/age_graphid_ds.c"
                    )
    {
        do { elog_start("src/backend/utils/adt/age_graphid_ds.c", 180, __func__); elog_finish(20, "free_graphid_stack: NULL stack"); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0);
    }


    while (stack->head != 
# 184 "src/backend/utils/adt/age_graphid_ds.c" 3 4
                         ((void *)0)
# 184 "src/backend/utils/adt/age_graphid_ds.c"
                             )
    {
    ...
    stack->tail = 
# 196 "src/backend/utils/adt/age_graphid_ds.c" 3 4
                 ((void *)0)
# 196 "src/backend/utils/adt/age_graphid_ds.c"
                     ;
    stack->size = 0;
}
...
{
    GraphIdNode *new_node = 
# 206 "src/backend/utils/adt/age_graphid_ds.c" 3 4
                           ((void *)0)
# 206 "src/backend/utils/adt/age_graphid_ds.c"
                               ;

    ((void)
# 208 "src/backend/utils/adt/age_graphid_ds.c" 3 4
   1
# 208 "src/backend/utils/adt/age_graphid_ds.c"
   );

    if (stack == 
# 210 "src/backend/utils/adt/age_graphid_ds.c" 3 4
                ((void *)0)
# 210 "src/backend/utils/adt/age_graphid_ds.c"
                    )
    {
        do { elog_start("src/backend/utils/adt/age_graphid_ds.c", 212, __func__); elog_finish(20, "push_graphid_stack: NULL stack"); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0);
    }
...
{
    GraphIdNode *node = 
# 232 "src/backend/utils/adt/age_graphid_ds.c" 3 4
                       ((void *)0)
# 232 "src/backend/utils/adt/age_graphid_ds.c"
                           ;
    graphid id;

    ((void)
# 235 "src/backend/utils/adt/age_graphid_ds.c" 3 4
   1
# 235 "src/backend/utils/adt/age_graphid_ds.c"
   );
    ((void)
# 236 "src/backend/utils/adt/age_graphid_ds.c" 3 4
   1
# 236 "src/backend/utils/adt/age_graphid_ds.c"
   );

    if (stack == 
# 238 "src/backend/utils/adt/age_graphid_ds.c" 3 4
                ((void *)0)
# 238 "src/backend/utils/adt/age_graphid_ds.c"
                    )
    {
        do { elog_start("src/backend/utils/adt/age_graphid_ds.c", 240, __func__); elog_finish(20, "pop_graphid_stack: NULL stack"); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0);
    }

    if (stack->size <= 0)
    {
        do { elog_start("src/backend/utils/adt/age_graphid_ds.c", 245, __func__); elog_finish(20, "pop_graphid_stack: empty stack"); if (__builtin_constant_p(20) && (20) >= 20) __builtin_unreachable(); } while(0);
    }
