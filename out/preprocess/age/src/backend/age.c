...
# 28 "src/backend/age.c" 2

extern const Pg_magic_struct *Pg_magic_func(void); const Pg_magic_struct * Pg_magic_func(void) { static const Pg_magic_struct Pg_magic_data = { sizeof(Pg_magic_struct), 110018 / 100, 100, 32, 64, 
# 29 "src/backend/age.c" 3 4
1
# 29 "src/backend/age.c"
, 
# 29 "src/backend/age.c" 3 4
1 
# 29 "src/backend/age.c"
