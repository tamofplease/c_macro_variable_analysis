...
# 53 "/usr/include/aarch64-linux-gnu/sys/stat.h" 3 4
typedef __ino64_t ino_t;
# 64 "/usr/include/aarch64-linux-gnu/sys/stat.h" 3 4
...
# 22 "/usr/include/aarch64-linux-gnu/sys/xattr.h" 3 4
...
# 23 "/usr/include/aarch64-linux-gnu/sys/xattr.h" 2 3 4
...
# 80 "/usr/include/aarch64-linux-gnu/bits/statvfs.h" 3 4
enum
{
  ST_RDONLY = 1,

  ST_NOSUID = 2
# 109 "/usr/include/aarch64-linux-gnu/bits/statvfs.h" 3 4
};
...
extern int fstatvfs (int __fildes, struct statvfs *__buf) __asm__ ("" "fstatvfs64") __attribute__ ((__nothrow__ , __leaf__))
                  __attribute__ ((__nonnull__ (2)));
# 88 "/usr/include/aarch64-linux-gnu/sys/statvfs.h" 3 4
...
static int getpath(int fd, char *buf) {
    ...
    ssize_t size = readlink(proc_fd, buf, 4096 - 1);
    if (size >= 0)
        buf[size] = '\0';
    return size;
...
static void lock_fchdir(int dirfd) {
    __lock(&fchdir_lock, "../fs/real.c", 39);
    fchdir(dirfd);
}
...
# 164 "../fs/real.c"
       "fd->dir != NULL"
# 164 "../fs/real.c" 3 4
       , "../fs/real.c", 164, __extension__ __PRETTY_FUNCTION__); }))
# 164 "../fs/real.c"
                              ;
    }
}
...
# 253 "../fs/real.c"
   "!(p.revents & POLLNVAL)"
# 253 "../fs/real.c" 3 4
   , "../fs/real.c", 253, __extension__ __PRETTY_FUNCTION__); }))
# 253 "../fs/real.c"
                                  ;
    return p.revents;
}
...
int realfs_getpath(struct fd *fd, char *buf) {
    ...
    if (strcmp(fd->mount->source, "/") != 0 || strcmp(buf, "/") == 0) {
        ...
        memmove(buf, buf + source_len, 4096 - source_len);
    }
    return 0;
}
...
int realfs_mount(struct mount *mount) {
    char *source_realpath = realpath(mount->source, 
# 439 "../fs/real.c" 3 4
                                                   ((void *)0)
# 439 "../fs/real.c"
                                                       );
