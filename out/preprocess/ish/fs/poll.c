...
# 56 "../fs/poll.c" 3 4
             _Bool 
# 56 "../fs/poll.c"
                  poll_fd_is_real(struct poll_fd *pollfd) {
...
static struct poll_fd *poll_find_fd(struct poll *poll, struct fd *fd) {
    ...
    for (poll_fd = ((typeof(*(poll_fd)) *) ((char *) ((&poll->poll_fds)->next) - 
# 63 "../fs/poll.c" 3 4
   __builtin_offsetof (
# 63 "../fs/poll.c"
   typeof(*(poll_fd))
...
# 63 "../fs/poll.c"
   )), tmp = ((typeof(*(poll_fd)) *) ((char *) ((poll_fd)->fds.next) - 
# 63 "../fs/poll.c" 3 4
   __builtin_offsetof (
# 63 "../fs/poll.c"
   typeof(*(poll_fd))
...
# 63 "../fs/poll.c"
   )); &poll_fd->fds != (&poll->poll_fds); poll_fd = tmp, tmp = ((typeof(*(poll_fd)) *) ((char *) ((poll_fd)->fds.next) - 
# 63 "../fs/poll.c" 3 4
   __builtin_offsetof (
# 63 "../fs/poll.c"
   typeof(*(poll_fd))
...
int poll_add_fd(struct poll *poll, struct fd *fd, int types, union poll_fd_info info) {
    int err;
    __lock(&fd->poll_lock, "../fs/poll.c", 84);
    __lock(&poll->lock, "../fs/poll.c", 85);

    struct poll_fd *poll_fd;
    if (!list_empty(&poll->pollfd_freelist)) {
        poll_fd = ((struct poll_fd *) ((char *) ((&poll->pollfd_freelist)->next) - 
# 89 "../fs/poll.c" 3 4
                 __builtin_offsetof (
# 89 "../fs/poll.c"
                 struct poll_fd
...
int poll_del_fd(struct poll *poll, struct fd *fd) {
    int err;
    __lock(&fd->poll_lock, "../fs/poll.c", 125);
    __lock(&poll->lock, "../fs/poll.c", 126);
...
int poll_mod_fd(struct poll *poll, struct fd *fd, int types, union poll_fd_info info) {
    int err;
    __lock(&fd->poll_lock, "../fs/poll.c", 154);
    __lock(&poll->lock, "../fs/poll.c", 155);
    struct poll_fd *poll_fd = poll_find_fd(poll, fd);
    if (poll_fd == 
# 157 "../fs/poll.c" 3 4
                  ((void *)0)
...
void poll_cleanup_fd(struct fd *fd) {
    __lock(&fd->poll_lock, "../fs/poll.c", 182);
    struct poll_fd *poll_fd, *tmp;
    for (poll_fd = ((typeof(*(poll_fd)) *) ((char *) ((&fd->poll_fds)->next) - 
# 184 "../fs/poll.c" 3 4
   __builtin_offsetof (
# 184 "../fs/poll.c"
   typeof(*(poll_fd))
...
# 184 "../fs/poll.c"
   )), tmp = ((typeof(*(poll_fd)) *) ((char *) ((poll_fd)->polls.next) - 
# 184 "../fs/poll.c" 3 4
   __builtin_offsetof (
# 184 "../fs/poll.c"
   typeof(*(poll_fd))
...
# 184 "../fs/poll.c"
   )); &poll_fd->polls != (&fd->poll_fds); poll_fd = tmp, tmp = ((typeof(*(poll_fd)) *) ((char *) ((poll_fd)->polls.next) - 
# 184 "../fs/poll.c" 3 4
   __builtin_offsetof (
# 184 "../fs/poll.c"
   typeof(*(poll_fd))
...
# 184 "../fs/poll.c"
        ...
        __lock(&poll_fd->poll->lock, "../fs/poll.c", 185);
        if (poll_fd_is_real(poll_fd))
...
void poll_wakeup(struct fd *fd, int events) {
    struct poll_fd *poll_fd;
    __lock(&fd->poll_lock, "../fs/poll.c", 198);
    for (poll_fd = ((typeof(*poll_fd) *) ((char *) ((&fd->poll_fds)->next) - 
# 199 "../fs/poll.c" 3 4
   __builtin_offsetof (
# 199 "../fs/poll.c"
...
# 199 "../fs/poll.c"
   )); &poll_fd->polls != (&fd->poll_fds); poll_fd = ((typeof(*poll_fd) *) ((char *) (poll_fd->polls.next) - 
# 199 "../fs/poll.c" 3 4
   __builtin_offsetof (
# 199 "../fs/poll.c"
   typeof(*poll_fd)
...
# 199 "../fs/poll.c"
        ...
        struct poll *poll = poll_fd->poll;
        __lock(&poll->lock, "../fs/poll.c", 201);
        if (poll_fd->types & (1ul << 31))
...
int poll_wait(struct poll *poll_, poll_callback_t callback, void *context, struct timespec *timeout) {
    __lock(&poll_->lock, "../fs/poll.c", 213);
...
# 217 "../fs/poll.c" 3 4
       ((void) sizeof ((
# 217 "../fs/poll.c"
       poll_->notify_pipe[0] == -1 && poll_->notify_pipe[1] == -1
# 217 "../fs/poll.c" 3 4
       ) ? 1 : 0), __extension__ ({ if (
# 217 "../fs/poll.c"
       poll_->notify_pipe[0] == -1 && poll_->notify_pipe[1] == -1
...
# 217 "../fs/poll.c"
       "poll_->notify_pipe[0] == -1 && poll_->notify_pipe[1] == -1"
# 217 "../fs/poll.c" 3 4
       , "../fs/poll.c", 217, __extension__ __PRETTY_FUNCTION__); }))
# 217 "../fs/poll.c"
                                                                         ;
...
# 223 "../fs/poll.c"
        ...
        real_poll_update(&poll_->real, poll_->notify_pipe[0], 1, 
# 224 "../fs/poll.c" 3 4
                                                                        ((void *)0)
# 224 "../fs/poll.c"
                                                                            );
...
# 229 "../fs/poll.c"
        ...
        struct poll_fd *poll_fd, *tmp;
        for (poll_fd = ((typeof(*(poll_fd)) *) ((char *) ((&poll_->poll_fds)->next) - 
# 232 "../fs/poll.c" 3 4
       __builtin_offsetof (
# 232 "../fs/poll.c"
       typeof(*(poll_fd))
...
# 232 "../fs/poll.c"
       )); &poll_fd->fds != (&poll_->poll_fds); poll_fd = tmp, tmp = ((typeof(*(poll_fd)) *) ((char *) ((poll_fd)->fds.next) - 
# 232 "../fs/poll.c" 3 4
       __builtin_offsetof (
# 232 "../fs/poll.c"
       typeof(*(poll_fd))
...
# 254 "../fs/poll.c"
        ...
        __lock(&current->sighand->lock, "../fs/poll.c", 267);
...
# 276 "../fs/poll.c"
       )); &poll_fd->fds != (&poll_->poll_fds); poll_fd = ((typeof(*poll_fd) *) ((char *) (poll_fd->fds.next) - 
# 276 "../fs/poll.c" 3 4
       __builtin_offsetof (
# 276 "../fs/poll.c"
       typeof(*poll_fd)
...
# 284 "../fs/poll.c"
        ...
        __lock(&poll_->lock, "../fs/poll.c", 285);
        for (poll_fd = ((typeof(*poll_fd) *) ((char *) ((&poll_->poll_fds)->next) - 
# 286 "../fs/poll.c" 3 4
       __builtin_offsetof (
# 286 "../fs/poll.c"
...
# 286 "../fs/poll.c"
        ...
        for (int i = 0; i < err; i++) {
            ...
            if (triggered_poll_fd != 
# 302 "../fs/poll.c" 3 4
                                    ((void *)0) 
# 302 "../fs/poll.c"
                                         && triggered_poll_fd->poll != 
# 302 "../fs/poll.c" 3 4
                                                                       ((void *)0) 
# 302 "../fs/poll.c"
                                                                            &&
                    triggered_poll_fd->types & (1ul << 31)) {
...
# 330 "../fs/poll.c"
        ...
        __lock(&poll_fd->fd->poll_lock, "../fs/poll.c", 331);
        list_remove(&poll_fd->polls);
        list_remove(&poll_fd->fds);
    ...
    for (poll_fd = ((typeof(*(poll_fd)) *) ((char *) ((&poll->pollfd_freelist)->next) - 
# 338 "../fs/poll.c" 3 4
   __builtin_offsetof (
# 338 "../fs/poll.c"
   typeof(*(poll_fd))
...
# 338 "../fs/poll.c"
   )); &poll_fd->fds != (&poll->pollfd_freelist); poll_fd = tmp, tmp = ((typeof(*(poll_fd)) *) ((char *) ((poll_fd)->fds.next) - 
# 338 "../fs/poll.c" 3 4
   __builtin_offsetof (
# 338 "../fs/poll.c"
   typeof(*(poll_fd))
