...
# 27 "../fs/proc.c"
               "next_entry.meta->parent == entry->meta"
# 27 "../fs/proc.c" 3 4
               , "../fs/proc.c", 27, __extension__ __PRETTY_FUNCTION__); }))
# 27 "../fs/proc.c"
                                                             ;
...
# 97 "../fs/proc.c"
   "S_ISREG(mode)"
# 97 "../fs/proc.c" 3 4
   , "../fs/proc.c", 97, __extension__ __PRETTY_FUNCTION__); }))
# 97 "../fs/proc.c"
                        ;
...
# 134 "../fs/proc.c"
   "data != NULL"
# 134 "../fs/proc.c" 3 4
   , "../fs/proc.c", 134, __extension__ __PRETTY_FUNCTION__); }))
# 134 "../fs/proc.c"
                       ;
...
# 148 "../fs/proc.c"
   "off <= buf->size"
# 148 "../fs/proc.c" 3 4
   , "../fs/proc.c", 148, __extension__ __PRETTY_FUNCTION__); }))
# 148 "../fs/proc.c"
                           ;
...
# 162 "../fs/proc.c"
   "tidemark <= buf->capacity"
# 162 "../fs/proc.c" 3 4
   , "../fs/proc.c", 162, __extension__ __PRETTY_FUNCTION__); }))
# 162 "../fs/proc.c"
                                    ;
...
# 173 "../fs/proc.c"
   "S_ISREG(mode)"
# 173 "../fs/proc.c" 3 4
   , "../fs/proc.c", 173, __extension__ __PRETTY_FUNCTION__); }))
# 173 "../fs/proc.c"
                        ;
...
static int proc_unlink(struct mount *UNUSED_mount __attribute__((unused)), const char *path) {
    struct proc_entry entry = {0};
    int err = proc_lookup(path, &entry);
    if (err < 0)
        return err;
