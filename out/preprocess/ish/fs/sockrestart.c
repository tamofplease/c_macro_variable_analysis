...
void sockrestart_begin_listen(struct fd *sock) {
    if (sock->ops != &socket_fdops)
        return;
    __lock(&sockrestart_lock, "../fs/sockrestart.c", 17);
...
void sockrestart_end_listen(struct fd *sock) {
    if (sock->ops != &socket_fdops)
        return;
    __lock(&sockrestart_lock, "../fs/sockrestart.c", 25);
...
void sockrestart_begin_listen_wait(struct fd *sock) {
    if (sock->ops != &socket_fdops)
        return;
    __lock(&sockrestart_lock, "../fs/sockrestart.c", 35);
...
void sockrestart_end_listen_wait(struct fd *sock) {
    if (sock->ops != &socket_fdops)
        return;
    __lock(&sockrestart_lock, "../fs/sockrestart.c", 45);
    current->sockrestart.count--;
    if (current->sockrestart.count == 0)
...
# 52 "../fs/sockrestart.c" 3 4
_Bool 
# 52 "../fs/sockrestart.c"
    sockrestart_should_restart_listen_wait() {
    __lock(&sockrestart_lock, "../fs/sockrestart.c", 53);
    
# 54 "../fs/sockrestart.c" 3 4
   _Bool 
# 54 "../fs/sockrestart.c"
        punt = current->sockrestart.punt;
    current->sockrestart.punt = 
# 55 "../fs/sockrestart.c" 3 4
                               0
# 55 "../fs/sockrestart.c"
                                    ;
    unlock(&sockrestart_lock);
...
void sockrestart_on_suspend() {
    __lock(&sockrestart_lock, "../fs/sockrestart.c", 77);
    
# 78 "../fs/sockrestart.c" 3 4
   ((void) sizeof ((
# 78 "../fs/sockrestart.c"
...
# 78 "../fs/sockrestart.c"
   "list_empty(&saved_sockets)"
# 78 "../fs/sockrestart.c" 3 4
   , "../fs/sockrestart.c", 78, __extension__ __PRETTY_FUNCTION__); }))
# 78 "../fs/sockrestart.c"
                                     ;
    struct fd *sock;
    for (sock = ((typeof(*sock) *) ((char *) ((&listen_fds)->next) - 
# 80 "../fs/sockrestart.c" 3 4
   __builtin_offsetof (
# 80 "../fs/sockrestart.c"
   typeof(*sock)
# 80 "../fs/sockrestart.c" 3 4
...
# 88 "../fs/sockrestart.c"
       "size == sizeof(saved->type)"
# 88 "../fs/sockrestart.c" 3 4
       , "../fs/sockrestart.c", 88, __extension__ __PRETTY_FUNCTION__); }))
# 88 "../fs/sockrestart.c"
                                          ;
...
# 117 "../fs/sockrestart.c" 3 4
   __builtin_offsetof (
# 117 "../fs/sockrestart.c"
   typeof(*task)
# 117 "../fs/sockrestart.c" 3 4
   , 
# 117 "../fs/sockrestart.c"
...
# 118 "../fs/sockrestart.c" 3 4
                                1
# 118 "../fs/sockrestart.c"
                                    ;
        pthread_kill(task->thread, 
# 119 "../fs/sockrestart.c" 3 4
                                  10
# 119 "../fs/sockrestart.c"
                                         );
    }
    unlock(&sockrestart_lock);
}
