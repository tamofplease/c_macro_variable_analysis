...
# 203 "../fs/pty.c"
       "tty != NULL"
# 203 "../fs/pty.c" 3 4
       , "../fs/pty.c", 203, __extension__ __PRETTY_FUNCTION__); }))
# 203 "../fs/pty.c"
                          ;
        __lock(&tty->lock, "../fs/pty.c", 204);
...
# 225 "../fs/pty.c"
   "tty != NULL"
# 225 "../fs/pty.c" 3 4
   , "../fs/pty.c", 225, __extension__ __PRETTY_FUNCTION__); }))
# 225 "../fs/pty.c"
                      ;
    __lock(&tty->lock, "../fs/pty.c", 226);
...
# 272 "../fs/pty.c"
   "fd->devpts.num == -1"
# 272 "../fs/pty.c" 3 4
   , "../fs/pty.c", 272, __extension__ __PRETTY_FUNCTION__); }))
# 272 "../fs/pty.c"
                               ;
