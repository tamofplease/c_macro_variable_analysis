...
# 40 "../fs/fake-migrate.c" 3 4
                                ((void *)0)
# 40 "../fs/fake-migrate.c"
                                ); if (err != 
# 40 "../fs/fake-migrate.c" 3 4
                                0 
# 40 "../fs/fake-migrate.c"
...
# 41 "../fs/fake-migrate.c" 3 4
   0 
# 41 "../fs/fake-migrate.c"
   && err != 
# 41 "../fs/fake-migrate.c" 3 4
   100 
# 41 "../fs/fake-migrate.c"
...
# 43 "../fs/fake-migrate.c" 3 4
   0 
# 43 "../fs/fake-migrate.c"
   && err != 
# 43 "../fs/fake-migrate.c" 3 4
   100 
# 43 "../fs/fake-migrate.c"
...
# 45 "../fs/fake-migrate.c" 3 4
   ((void *)0)
# 45 "../fs/fake-migrate.c"
   , 
# 45 "../fs/fake-migrate.c" 3 4
   ((void *)0)
# 45 "../fs/fake-migrate.c"
...
# 45 "../fs/fake-migrate.c"
    ...
    while (version < versions) {
        ...
        if (m.sql != 
# 49 "../fs/fake-migrate.c" 3 4
                    ((void *)0)
# 49 "../fs/fake-migrate.c"
                        )
            err = sqlite3_exec(db, m.sql, 
# 50 "../fs/fake-migrate.c" 3 4
           ((void *)0)
# 50 "../fs/fake-migrate.c"
           , 
# 50 "../fs/fake-migrate.c" 3 4
           ((void *)0)
# 50 "../fs/fake-migrate.c"
...
# 50 "../fs/fake-migrate.c"
        ...
        if (m.migrate != 
# 51 "../fs/fake-migrate.c" 3 4
                        ((void *)0)
# 51 "../fs/fake-migrate.c"
                            )
            m.migrate(fs);
        version++;
    }
...
# 57 "../fs/fake-migrate.c" 3 4
   ((void *)0)
# 57 "../fs/fake-migrate.c"
   , 
# 57 "../fs/fake-migrate.c" 3 4
   ((void *)0)
# 57 "../fs/fake-migrate.c"
...
# 59 "../fs/fake-migrate.c" 3 4
   ((void *)0)
# 59 "../fs/fake-migrate.c"
   , 
# 59 "../fs/fake-migrate.c" 3 4
   ((void *)0)
# 59 "../fs/fake-migrate.c"
