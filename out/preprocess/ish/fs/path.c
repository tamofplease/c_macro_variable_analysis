...
# 9 "../fs/path.c" 3 4
       , "../fs/path.c", 9, __extension__ __PRETTY_FUNCTION__); }))
# 9 "../fs/path.c"
                                            ;
    else
...
# 11 "../fs/path.c"
       "flags & N_SYMLINK_NOFOLLOW"
# 11 "../fs/path.c" 3 4
       , "../fs/path.c", 11, __extension__ __PRETTY_FUNCTION__); }))
# 11 "../fs/path.c"
                                         ;
...
# 74 "../fs/path.c"
           "path_is_normalized(possible_symlink)"
# 74 "../fs/path.c" 3 4
           , "../fs/path.c", 74, __extension__ __PRETTY_FUNCTION__); }))
# 74 "../fs/path.c"
                                                       ;
            int res = -22;
...
# 116 "../fs/path.c"
   "path_is_normalized(out)"
# 116 "../fs/path.c" 3 4
   , "../fs/path.c", 116, __extension__ __PRETTY_FUNCTION__); }))
# 116 "../fs/path.c"
                                  ;
...
# 122 "../fs/path.c"
   "at != NULL"
# 122 "../fs/path.c" 3 4
   , "../fs/path.c", 122, __extension__ __PRETTY_FUNCTION__); }))
# 122 "../fs/path.c"
                     ;
    if (strcmp(path, "") == 0)
        return -2;
    ...
    __lock(&current->fs->lock, "../fs/path.c", 127);
    if (path[0] == '/')
        at = current->fs->root;
...
# 138 "../fs/path.c"
       "path_is_normalized(at_path)"
# 138 "../fs/path.c" 3 4
       , "../fs/path.c", 138, __extension__ __PRETTY_FUNCTION__); }))
# 138 "../fs/path.c"
                                          ;
    }
...
# 163 "../fs/path.c"
   "*p == '/'"
# 163 "../fs/path.c" 3 4
   , "../fs/path.c", 163, __extension__ __PRETTY_FUNCTION__); }))
# 163 "../fs/path.c"
                    ;
    p++;
    char *c = component;
