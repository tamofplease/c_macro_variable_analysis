...
static struct termios_ termios_from_real(struct termios real) {
    ...
    if (real.c_oflag & 
# 44 "../fs/tty-real.c" 3 4
   0000001
# 44 "../fs/tty-real.c"
   ) fake.oflags |= (1 << 0);
    if (real.c_oflag & 
# 45 "../fs/tty-real.c" 3 4
   0000004
# 45 "../fs/tty-real.c"
   ) fake.oflags |= (1 << 2);
    if (real.c_oflag & 
# 46 "../fs/tty-real.c" 3 4
   0000010
# 46 "../fs/tty-real.c"
   ) fake.oflags |= (1 << 3);
    if (real.c_oflag & 
# 47 "../fs/tty-real.c" 3 4
   0000020
# 47 "../fs/tty-real.c"
   ) fake.oflags |= (1 << 4);
    if (real.c_oflag & 
# 48 "../fs/tty-real.c" 3 4
   0000040
# 48 "../fs/tty-real.c"
   ) fake.oflags |= (1 << 5);
    if (real.c_iflag & 
# 49 "../fs/tty-real.c" 3 4
   0000100
# 49 "../fs/tty-real.c"
   ) fake.iflags |= (1 << 6);
    if (real.c_iflag & 
# 50 "../fs/tty-real.c" 3 4
   0000200
# 50 "../fs/tty-real.c"
   ) fake.iflags |= (1 << 7);
    if (real.c_iflag & 
# 51 "../fs/tty-real.c" 3 4
   0000400
# 51 "../fs/tty-real.c"
   ) fake.iflags |= (1 << 8);
    if (real.c_lflag & 
# 52 "../fs/tty-real.c" 3 4
   0000001
# 52 "../fs/tty-real.c"
   ) fake.lflags |= (1 << 0);
    if (real.c_lflag & 
# 53 "../fs/tty-real.c" 3 4
   0000002
# 53 "../fs/tty-real.c"
   ) fake.lflags |= (1 << 1);
    if (real.c_lflag & 
# 54 "../fs/tty-real.c" 3 4
   0000010
# 54 "../fs/tty-real.c"
   ) fake.lflags |= (1 << 3);
    if (real.c_lflag & 
# 55 "../fs/tty-real.c" 3 4
   0000020
# 55 "../fs/tty-real.c"
   ) fake.lflags |= (1 << 4);
    if (real.c_lflag & 
# 56 "../fs/tty-real.c" 3 4
   0000040
# 56 "../fs/tty-real.c"
   ) fake.lflags |= (1 << 5);
    if (real.c_lflag & 
# 57 "../fs/tty-real.c" 3 4
   0000200
# 57 "../fs/tty-real.c"
   ) fake.lflags |= (1 << 7);
    if (real.c_lflag & 
# 58 "../fs/tty-real.c" 3 4
   0001000
# 58 "../fs/tty-real.c"
   ) fake.lflags |= (1 << 9);
    ...
    fake.cc[0] = real.c_cc[
# 63 "../fs/tty-real.c" 3 4
   0
# 63 "../fs/tty-real.c"
   ];
    fake.cc[1] = real.c_cc[
# 64 "../fs/tty-real.c" 3 4
   1
# 64 "../fs/tty-real.c"
   ];
    fake.cc[2] = real.c_cc[
# 65 "../fs/tty-real.c" 3 4
   2
# 65 "../fs/tty-real.c"
   ];
    fake.cc[3] = real.c_cc[
# 66 "../fs/tty-real.c" 3 4
   3
# 66 "../fs/tty-real.c"
   ];
    fake.cc[4] = real.c_cc[
# 67 "../fs/tty-real.c" 3 4
   4
# 67 "../fs/tty-real.c"
   ];
    fake.cc[5] = real.c_cc[
# 68 "../fs/tty-real.c" 3 4
   5
# 68 "../fs/tty-real.c"
   ];
    fake.cc[6] = real.c_cc[
# 69 "../fs/tty-real.c" 3 4
   6
# 69 "../fs/tty-real.c"
   ];
    fake.cc[8] = real.c_cc[
# 70 "../fs/tty-real.c" 3 4
   8
# 70 "../fs/tty-real.c"
   ];
    fake.cc[9] = real.c_cc[
# 71 "../fs/tty-real.c" 3 4
   9
# 71 "../fs/tty-real.c"
   ];
    fake.cc[10] = real.c_cc[
# 72 "../fs/tty-real.c" 3 4
   10
# 72 "../fs/tty-real.c"
   ];
    fake.cc[11] = real.c_cc[
# 73 "../fs/tty-real.c" 3 4
   11
# 73 "../fs/tty-real.c"
   ];
    fake.cc[12] = real.c_cc[
# 74 "../fs/tty-real.c" 3 4
   12
# 74 "../fs/tty-real.c"
   ];
    fake.cc[13] = real.c_cc[
# 75 "../fs/tty-real.c" 3 4
   13
# 75 "../fs/tty-real.c"
   ];
    fake.cc[14] = real.c_cc[
# 76 "../fs/tty-real.c" 3 4
   14
# 76 "../fs/tty-real.c"
   ];
    fake.cc[15] = real.c_cc[
# 77 "../fs/tty-real.c" 3 4
   15
# 77 "../fs/tty-real.c"
   ];
    fake.cc[16] = real.c_cc[
# 78 "../fs/tty-real.c" 3 4
   16
# 78 "../fs/tty-real.c"
   ];
