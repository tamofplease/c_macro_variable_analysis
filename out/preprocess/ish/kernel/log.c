...
# 22 "/usr/include/aarch64-linux-gnu/sys/uio.h" 3 4
...
# 23 "/usr/include/aarch64-linux-gnu/sys/uio.h" 2 3 4
...
int_t sys_syslog(int_t type, addr_t buf_addr, int_t len) {
    __lock(&log_lock, "../kernel/log.c", 85);
...
void ish_vprintk(const char *msg, va_list args) {
    ...
    __lock(&log_lock, "../kernel/log.c", 114);
    char *b = buf;
    char *p;
    while ((p = strchr(b, '\n')) != 
# 117 "../kernel/log.c" 3 4
                                   ((void *)0)
# 117 "../kernel/log.c"
                                       ) {
        *p = '\0';
