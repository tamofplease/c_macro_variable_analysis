...
# 28 "../kernel/init.c" 3 4
                              10
# 28 "../kernel/init.c"
                                     );
    sigaction(
# 29 "../kernel/init.c" 3 4
             10
# 29 "../kernel/init.c"
                    , &sigact, 
# 29 "../kernel/init.c" 3 4
...
# 104 "../kernel/init.c"
   "init != NULL"
# 104 "../kernel/init.c" 3 4
   , "../kernel/init.c", 104, __extension__ __PRETTY_FUNCTION__); }))
# 104 "../kernel/init.c"
                       ;
...
int create_stdio(const char *file, int major, int minor) {
    ...
    if (((uintptr_t) (fd) > (uintptr_t) -0xfff)) {
        ...
        fd = adhoc_fd_create(
# 132 "../kernel/init.c" 3 4
                            ((void *)0)
# 132 "../kernel/init.c"
                                );
        fd->stat.rdev = dev_make(major, minor);
        fd->stat.mode = 
# 134 "../kernel/init.c" 3 4
                       0020000 
# 134 "../kernel/init.c"
                               | 
# 134 "../kernel/init.c" 3 4
...
static struct fd *open_fd_from_actual_fd(int fd_no) {
    ...
    if (fd == 
# 150 "../kernel/init.c" 3 4
             ((void *)0)
# 150 "../kernel/init.c"
                 ) {
        return 
# 151 "../kernel/init.c" 3 4
              ((void *)0)
# 151 "../kernel/init.c"
                  ;
    }
