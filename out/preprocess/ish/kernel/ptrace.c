...
# 11 "../kernel/ptrace.c"
   )); &child->siblings != (&current->children); child = ((typeof(*child) *) ((char *) (child->siblings.next) - 
# 11 "../kernel/ptrace.c" 3 4
   __builtin_offsetof (
# 11 "../kernel/ptrace.c"
   typeof(*child)
...
# 11 "../kernel/ptrace.c"
        ...
        if (child->pid == pid) {
            __lock(&child->ptrace.lock, "../kernel/ptrace.c", 13);
...
dword_t sys_ptrace(dword_t request, dword_t pid, addr_t addr, dword_t data) {
    switch (request) {
        case 0:
            __use(0, pid, addr, data);
            current->ptrace.traced = 
# 72 "../kernel/ptrace.c" 3 4
                                    1
# 72 "../kernel/ptrace.c"
                                        ;
            return 0;
        ...
        case 2: {
            ...
            if (user_read_task(child, addr, &(peek), sizeof(peek))) {
                unlock(&child->ptrace.lock);
                return -14;
            } else if (user_write(data, &(peek), sizeof(peek))) {
                unlock(&child->ptrace.lock);
                return -14;
            }
            unlock(&child->ptrace.lock);
        ...
        case 3: {
            ...
            if (user_write(data, &(peek), sizeof(peek))) {
                unlock(&child->ptrace.lock);
                return -14;
            }
            unlock(&child->ptrace.lock);
        ...
        case 7: {
            ...
            child->cpu.tf = 
# 136 "../kernel/ptrace.c" 3 4
                           0
# 136 "../kernel/ptrace.c"
                                ;
            child->ptrace.stopped = 
# 137 "../kernel/ptrace.c" 3 4
                                   0
# 137 "../kernel/ptrace.c"
                                        ;
        ...
        case 8: {
            ...
            child->ptrace.stopped = 
# 149 "../kernel/ptrace.c" 3 4
                                   0
# 149 "../kernel/ptrace.c"
                                        ;
            send_signal(child, 9, SIGINFO_NIL);
            unlock(&child->ptrace.lock);
        ...
        case 9: {
            ...
            child->cpu.tf = 
# 161 "../kernel/ptrace.c" 3 4
                           1
# 161 "../kernel/ptrace.c"
                               ;
            child->ptrace.stopped = 
# 162 "../kernel/ptrace.c" 3 4
                                   0
# 162 "../kernel/ptrace.c"
                                        ;
            notify(&child->ptrace.cond);
        ...
        case 12: {
            ...
            if (user_write(data, &(user_regs_), sizeof(user_regs_))) {
                unlock(&child->ptrace.lock);
                return -14;
            }
            unlock(&child->ptrace.lock);
        ...
        case 13: {
            ...
            struct user_regs_struct_ user_regs_;
            if (user_read(data, &(user_regs_), sizeof(user_regs_))) {
                return -14;
            } else {
        ...
        case 14: {
            ...
            if (user_write(data, &(user_fpregs_), sizeof(user_fpregs_))) {
                unlock(&child->ptrace.lock);
                return -14;
            }
        ...
        case 15: {
            ...
            struct user_fpregs_struct_ user_fpregs_;
            if (user_read(data, &(user_fpregs_), sizeof(user_fpregs_))) {
                return -14;
            } else {
        ...
        case 0x4202: {
            ...
            if (data && user_write(data, &(child->ptrace.info), sizeof(child->ptrace.info))) {
                return -14;
            }
            unlock(&child->ptrace.lock);
