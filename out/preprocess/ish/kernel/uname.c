...
# 25 "/usr/include/aarch64-linux-gnu/sys/utsname.h" 3 4
...
# 26 "/usr/include/aarch64-linux-gnu/sys/utsname.h" 2 3 4
...
void do_uname(struct uname *uts) {
    ...
    snprintf(uts->version, sizeof(uts->version), "%s %s %s", uname_version, "Nov 25 2022", "09:54:57");
