...
int_t sys_prctl(dword_t option, uint_t arg2, uint_t UNUSED_arg3 __attribute__((unused)), uint_t UNUSED_arg4 __attribute__((unused)), uint_t UNUSED_arg5 __attribute__((unused))) {
    switch (option) {
        case 8:
...
# 41 "../kernel/misc.c"
int_t sys_reboot(int_t magic, int_t magic2, int_t cmd) {
    __use(0, magic, magic2, cmd);
    if (!(current != 
# 43 "../kernel/misc.c" 3 4
        ((void *)0) 
# 43 "../kernel/misc.c"
        && current->euid == 0))
        return -1;
    if (magic != (int) 0xfee1dead ||
            (magic2 != 672274793 &&
             magic2 != 85072278 &&
             magic2 != 369367448 &&
             magic2 != 537993216))
