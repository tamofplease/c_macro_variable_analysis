...
# 21 "/usr/include/aarch64-linux-gnu/sys/resource.h" 3 4
...
# 22 "/usr/include/aarch64-linux-gnu/sys/resource.h" 2 3 4


# 1 "/usr/include/aarch64-linux-gnu/bits/resource.h" 1 3 4
# 23 "/usr/include/aarch64-linux-gnu/bits/resource.h" 3 4
...
# 24 "/usr/include/aarch64-linux-gnu/bits/resource.h" 2 3 4
...
# 179 "/usr/include/aarch64-linux-gnu/bits/resource.h" 2 3 4
...
# 15 "../kernel/resource.c" 2

static 
# 16 "../kernel/resource.c" 3 4
      _Bool 
# 16 "../kernel/resource.c"
           resource_valid(int resource) {
    return resource >= 0 && resource < 16;
}
...
static int rlimit_get(struct task *task, int resource, struct rlimit_ *limit) {
    ...
    __lock(&group->lock, "../kernel/resource.c", 24);
...
static int rlimit_set(struct task *task, int resource, struct rlimit_ limit) {
    if (!resource_valid(resource))
        return -22;
    struct tgroup *group = task->group;
    __lock(&group->lock, "../kernel/resource.c", 34);
...
dword_t sys_getrlimit32(dword_t resource, addr_t rlim_addr) {
    ...
    if (err < 0)
        return err;
    if (user_write(rlim_addr, &(rlimit), sizeof(rlimit)))
        return -14;
    return 0;
}
...
dword_t sys_old_getrlimit32(dword_t resource, addr_t rlim_addr) {
    ...
    if (rlimit.cur > 0x7fffffff)
        rlimit.cur = 0x7fffffff;
    if (rlimit.max > 0x7fffffff)
        rlimit.max = 0x7fffffff;
...
static int check_setrlimit(int resource, struct rlimit_ new_limit) {
    if ((current != 
# 89 "../kernel/resource.c" 3 4
       ((void *)0) 
# 89 "../kernel/resource.c"
       && current->euid == 0))
        return 0;
...
dword_t sys_setrlimit32(dword_t resource, addr_t rlim_addr) {
    struct rlimit_ rlimit;
    if (user_read(rlim_addr, &(rlimit), sizeof(rlimit)))
        return -14;
    __use(0, resource, rlimit.cur, rlimit.max);
...
dword_t sys_prlimit64(pid_t_ pid, dword_t resource, addr_t new_limit_addr, addr_t old_limit_addr) {
    ...
    if (old_limit_addr != 0) {
        ...
        if (err < 0)
            return err;
        __use(0, rlimit.cur, rlimit.max);
        if (user_write(old_limit_addr, &(rlimit), sizeof(rlimit)))
            return -14;
    }

    if (new_limit_addr != 0) {
        struct rlimit_ rlimit;
        if (user_read(new_limit_addr, &(rlimit), sizeof(rlimit)))
            return -14;
        __use(0, rlimit.cur, rlimit.max);
        int err = check_setrlimit(resource, rlimit);
        if (err < 0)
...
struct rusage_ rusage_get_current() {
    ...
    struct rusage usage;
    int err = getrusage(
# 144 "../kernel/resource.c" 3 4
                       RUSAGE_THREAD
# 144 "../kernel/resource.c"
                                    , &usage);
    
# 145 "../kernel/resource.c" 3 4
   ((void) sizeof ((
# 145 "../kernel/resource.c"
   err == 0
# 145 "../kernel/resource.c" 3 4
   ) ? 1 : 0), __extension__ ({ if (
# 145 "../kernel/resource.c"
...
# 145 "../kernel/resource.c"
   "err == 0"
# 145 "../kernel/resource.c" 3 4
   , "../kernel/resource.c", 145, __extension__ __PRETTY_FUNCTION__); }))
# 145 "../kernel/resource.c"
                   ;
...
dword_t sys_getrusage(dword_t who, addr_t rusage_addr) {
    ...
    switch (who) {
        case 0:
            ...
            break;
        case -1:
            __lock(&current->group->lock, "../kernel/resource.c", 183);
    ...
    if (user_write(rusage_addr, &(rusage), sizeof(rusage)))
        return -14;
    return 0;
}

int_t sys_sched_getaffinity(pid_t_ pid, dword_t cpusetsize, addr_t cpuset_addr) {
    __use(0, pid, cpusetsize, cpuset_addr);
    if (pid != 0) {
        __lock(&pids_lock, "../kernel/resource.c", 198);
        struct task *task = pid_get_task(pid);
        unlock(&pids_lock);
        if (task == 
# 201 "../kernel/resource.c" 3 4
                   ((void *)0)
# 201 "../kernel/resource.c"
                       )
            return -3;
    }

    unsigned cpus = sysconf(
# 205 "../kernel/resource.c" 3 4
                           _SC_NPROCESSORS_ONLN
# 205 "../kernel/resource.c"
                                               );
...
int_t sys_sched_setaffinity(pid_t_ UNUSED_pid __attribute__((unused)), dword_t UNUSED_cpusetsize __attribute__((unused)), addr_t UNUSED_cpuset_addr __attribute__((unused))) {
...
int_t sys_setpriority(int_t which, pid_t_ who, int_t prio) {
    __use(0, which, who, prio);
    return 0;
}


int_t sys_sched_getparam(pid_t_ UNUSED_pid __attribute__((unused)), addr_t param_addr) {
    int_t 
# 233 "../kernel/resource.c" 3 4
         sched_priority 
# 233 "../kernel/resource.c"
                        = 0;
    if (user_write(param_addr, &(
# 234 "../kernel/resource.c" 3 4
       sched_priority
# 234 "../kernel/resource.c"
       ), sizeof(
# 234 "../kernel/resource.c" 3 4
       sched_priority
# 234 "../kernel/resource.c"
...
int_t sys_sched_setscheduler(pid_t_ UNUSED_pid __attribute__((unused)), int_t policy, addr_t param_addr) {
    if (policy != 0)
        return -22;
    int_t 
# 245 "../kernel/resource.c" 3 4
         sched_priority
# 245 "../kernel/resource.c"
                       ;
    if (user_read(param_addr, &(
# 246 "../kernel/resource.c" 3 4
       sched_priority
# 246 "../kernel/resource.c"
       ), sizeof(
# 246 "../kernel/resource.c" 3 4
       sched_priority
# 246 "../kernel/resource.c"
        ...
        return -14;
    if (
# 248 "../kernel/resource.c" 3 4
       sched_priority 
# 248 "../kernel/resource.c"
                      != 0)
        return -22;
    return 0;
}
