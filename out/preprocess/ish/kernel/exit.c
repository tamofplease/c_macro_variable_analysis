...
static 
# 13 "../kernel/exit.c" 3 4
      _Bool 
# 13 "../kernel/exit.c"
           exit_tgroup(struct task *task) {
    struct tgroup *group = task->group;
    list_remove(&task->group_links);
    
# 16 "../kernel/exit.c" 3 4
   _Bool 
# 16 "../kernel/exit.c"
        group_dead = list_empty(&group->threads);
    if (group_dead) {
...
void (*exit_hook)(struct task *task, int code) = 
# 32 "../kernel/exit.c" 3 4
                                                ((void *)0)
# 32 "../kernel/exit.c"
                                                    ;
...
static struct task *find_new_parent(struct task *task) {
    ...
    for (new_parent = ((typeof(*new_parent) *) ((char *) ((&task->group->threads)->next) - 
# 36 "../kernel/exit.c" 3 4
   __builtin_offsetof (
# 36 "../kernel/exit.c"
   typeof(*new_parent)
# 36 "../kernel/exit.c" 3 4
...
# 36 "../kernel/exit.c"
   )); &new_parent->group_links != (&task->group->threads); new_parent = ((typeof(*new_parent) *) ((char *) (new_parent->group_links.next) - 
# 36 "../kernel/exit.c" 3 4
   __builtin_offsetof (
# 36 "../kernel/exit.c"
   typeof(*new_parent)
...
# 43 "../kernel/exit.c"
    ...
    if (clear_tid) {
        pid_t_ zero = 0;
        if (user_write(clear_tid, &(zero), sizeof(zero)) == 0)
    ...
    current->mm = 
# 54 "../kernel/exit.c" 3 4
                 ((void *)0)
# 54 "../kernel/exit.c"
                     ;
    fdtable_release(current->files);
    current->files = 
# 56 "../kernel/exit.c" 3 4
                    ((void *)0)
# 56 "../kernel/exit.c"
                        ;
    fs_info_release(current->fs);
    current->fs = 
# 58 "../kernel/exit.c" 3 4
                 ((void *)0)
# 58 "../kernel/exit.c"
                     ;
    ...
    __lock(&current->group->lock, "../kernel/exit.c", 65);
    rusage_add(&current->group->rusage, &rusage);
    struct rusage_ group_rusage = current->group->rusage;
    unlock(&current->group->lock);


    __lock(&pids_lock, "../kernel/exit.c", 71);
    current->exiting = 
# 72 "../kernel/exit.c" 3 4
                      1
# 72 "../kernel/exit.c"
                          ;
...
# 77 "../kernel/exit.c"
   )), sigqueue_tmp = ((typeof(*(sigqueue)) *) ((char *) ((sigqueue)->queue.next) - 
# 77 "../kernel/exit.c" 3 4
   __builtin_offsetof (
# 77 "../kernel/exit.c"
   typeof(*(sigqueue))
...
# 77 "../kernel/exit.c"
   )); &sigqueue->queue != (&current->queue); sigqueue = sigqueue_tmp, sigqueue_tmp = ((typeof(*(sigqueue)) *) ((char *) ((sigqueue)->queue.next) - 
# 77 "../kernel/exit.c" 3 4
   __builtin_offsetof (
# 77 "../kernel/exit.c"
   typeof(*(sigqueue))
...
# 77 "../kernel/exit.c"
    ...
    for (child = ((typeof(*(child)) *) ((char *) ((&current->children)->next) - 
# 86 "../kernel/exit.c" 3 4
   __builtin_offsetof (
# 86 "../kernel/exit.c"
   typeof(*(child))
# 86 "../kernel/exit.c" 3 4
...
# 86 "../kernel/exit.c"
   )), tmp = ((typeof(*(child)) *) ((char *) ((child)->siblings.next) - 
# 86 "../kernel/exit.c" 3 4
   __builtin_offsetof (
# 86 "../kernel/exit.c"
   typeof(*(child))
...
# 86 "../kernel/exit.c"
   )); &child->siblings != (&current->children); child = tmp, tmp = ((typeof(*(child)) *) ((char *) ((child)->siblings.next) - 
# 86 "../kernel/exit.c" 3 4
   __builtin_offsetof (
# 86 "../kernel/exit.c"
   typeof(*(child))
...
# 125 "../kernel/exit.c" 3 4
_Noreturn 
# 125 "../kernel/exit.c"
        void do_exit_group(int status) {
    struct tgroup *group = current->group;
    __lock(&pids_lock, "../kernel/exit.c", 127);
    __lock(&group->lock, "../kernel/exit.c", 128);
    if (!group->doing_group_exit) {
        group->doing_group_exit = 
# 130 "../kernel/exit.c" 3 4
                                 1
# 130 "../kernel/exit.c"
                                     ;
    ...
    struct task *task;
    for (task = ((typeof(*task) *) ((char *) ((&group->threads)->next) - 
# 138 "../kernel/exit.c" 3 4
   __builtin_offsetof (
# 138 "../kernel/exit.c"
   typeof(*task)
# 138 "../kernel/exit.c" 3 4
...
# 138 "../kernel/exit.c"
   )); &task->group_links != (&group->threads); task = ((typeof(*task) *) ((char *) (task->group_links.next) - 
# 138 "../kernel/exit.c" 3 4
   __builtin_offsetof (
# 138 "../kernel/exit.c"
   typeof(*task)
...
# 138 "../kernel/exit.c"
        ...
        deliver_signal(task, 9, SIGINFO_NIL);
        task->group->stopped = 
# 140 "../kernel/exit.c" 3 4
                              0
# 140 "../kernel/exit.c"
                                   ;
...
static void halt_system(void) {
    ...
    for (int i = 2; i < (1 << 15); i++) {
        ...
        if (task != 
# 155 "../kernel/exit.c" 3 4
                   ((void *)0)
# 155 "../kernel/exit.c"
                       )
            pthread_kill(task->thread, 
# 156 "../kernel/exit.c" 3 4
                                      9
# 156 "../kernel/exit.c"
                                             );
    }
...
# 162 "../kernel/exit.c"
   )), tmp = ((typeof(*(mount)) *) ((char *) ((mount)->mounts.next) - 
# 162 "../kernel/exit.c" 3 4
   __builtin_offsetof (
# 162 "../kernel/exit.c"
   typeof(*(mount))
...
# 162 "../kernel/exit.c"
   )); &mount->mounts != (&mounts); mount = tmp, tmp = ((typeof(*(mount)) *) ((char *) ((mount)->mounts.next) - 
# 162 "../kernel/exit.c" 3 4
   __builtin_offsetof (
# 162 "../kernel/exit.c"
   typeof(*(mount))
...
# 190 "../kernel/exit.c"
static 
# 190 "../kernel/exit.c" 3 4
      _Bool 
# 190 "../kernel/exit.c"
           reap_if_zombie(struct task *task, struct siginfo_ *info_out, struct rusage_ *rusage_out, int options) {
    if (!task->zombie)
        return 
# 192 "../kernel/exit.c" 3 4
              0
# 192 "../kernel/exit.c"
                   ;
    __lock(&task->group->lock, "../kernel/exit.c", 193);
    ...
    if (!(options & (1 << 24))) {
        __lock(&current->group->lock, "../kernel/exit.c", 202);
        rusage_add(&current->group->children_rusage, &rusage);
        unlock(&current->group->lock);
    }
    if (rusage_out != 
# 206 "../kernel/exit.c" 3 4
                     ((void *)0)
# 206 "../kernel/exit.c"
                         )
        *rusage_out = rusage;
...
static 
# 225 "../kernel/exit.c" 3 4
      _Bool 
# 225 "../kernel/exit.c"
           notify_if_stopped(struct task *task, struct siginfo_ *info_out) {
    __lock(&task->group->lock, "../kernel/exit.c", 226);
    
# 227 "../kernel/exit.c" 3 4
   _Bool 
# 227 "../kernel/exit.c"
        stopped = task->group->stopped;
    unlock(&task->group->lock);
    if (!stopped || task->group->group_exit_code == 0)
        return 
# 230 "../kernel/exit.c" 3 4
              0
# 230 "../kernel/exit.c"
                   ;
...
static 
# 237 "../kernel/exit.c" 3 4
      _Bool 
# 237 "../kernel/exit.c"
           reap_if_needed(struct task *task, struct siginfo_ *info_out, struct rusage_ *rusage_out, int options) {
    
# 238 "../kernel/exit.c" 3 4
   ((void) sizeof ((
# 238 "../kernel/exit.c"
   task_is_leader(task)
# 238 "../kernel/exit.c" 3 4
...
# 238 "../kernel/exit.c"
   "task_is_leader(task)"
# 238 "../kernel/exit.c" 3 4
   , "../kernel/exit.c", 238, __extension__ __PRETTY_FUNCTION__); }))
# 238 "../kernel/exit.c"
                               ;
    if ((options & (1 << 1) && notify_if_stopped(task, info_out)) ||
        (options & (1 << 2) && reap_if_zombie(task, info_out, rusage_out, options))) {
        info_out->sig = 17;
        return 
# 242 "../kernel/exit.c" 3 4
              1
# 242 "../kernel/exit.c"
                  ;
    }
    __lock(&task->ptrace.lock, "../kernel/exit.c", 244);
...
int do_wait(int idtype, pid_t_ id, struct siginfo_ *info, struct rusage_ *rusage, int options) {
    if (idtype != 0 && idtype != 1 && idtype != 2)
        return -22;
    if (options & ~((1 << 0)|(1 << 1)|(1 << 2)|(1 << 3)|(1 << 24)|(1 << 30)))
        return -22;

    __lock(&pids_lock, "../kernel/exit.c", 264);
    int err;
    
# 266 "../kernel/exit.c" 3 4
   _Bool 
# 266 "../kernel/exit.c"
        got_signal = 
# 266 "../kernel/exit.c" 3 4
...
# 271 "../kernel/exit.c"
                              ;
        struct task *parent;
        for (parent = ((typeof(*parent) *) ((char *) ((&current->group->threads)->next) - 
# 273 "../kernel/exit.c" 3 4
       __builtin_offsetof (
# 273 "../kernel/exit.c"
       typeof(*parent)
# 273 "../kernel/exit.c" 3 4
...
# 273 "../kernel/exit.c"
       )); &parent->group_links != (&current->group->threads); parent = ((typeof(*parent) *) ((char *) (parent->group_links.next) - 
# 273 "../kernel/exit.c" 3 4
       __builtin_offsetof (
# 273 "../kernel/exit.c"
       typeof(*parent)
...
# 273 "../kernel/exit.c"
            ...
            struct task *task;
            for (task = ((typeof(*task) *) ((char *) ((&current->children)->next) - 
# 275 "../kernel/exit.c" 3 4
           __builtin_offsetof (
# 275 "../kernel/exit.c"
           typeof(*task)
# 275 "../kernel/exit.c" 3 4
...
# 275 "../kernel/exit.c"
           )); &task->siblings != (&current->children); task = ((typeof(*task) *) ((char *) (task->siblings.next) - 
# 275 "../kernel/exit.c" 3 4
           __builtin_offsetof (
# 275 "../kernel/exit.c"
           typeof(*task)
...
# 275 "../kernel/exit.c"
                ...
                if (!task_is_leader(task))
                    continue;
                if (idtype == 2 && task->group->pgid != id)
                    continue;
                no_children = 
# 280 "../kernel/exit.c" 3 4
                             0
# 280 "../kernel/exit.c"
                                  ;
...
dword_t sys_waitid(int_t idtype, pid_t_ id, addr_t info_addr, int_t options) {
    __use(0, idtype, id, info_addr, options);
    struct siginfo_ info = {};
    int_t res = do_wait(idtype, id, &info, 
# 335 "../kernel/exit.c" 3 4
                                          ((void *)0)
# 335 "../kernel/exit.c"
                                              , options);
    if (res < 0 || (res == 0 && info.child.pid == 0))
        return res;
    if (info_addr != 0 && user_write(info_addr, &(info), sizeof(info)))
        return -14;
    return 0;
}

dword_t sys_wait4(pid_t_ id, addr_t status_addr, dword_t options, addr_t rusage_addr) {
    __use(0, id, status_addr, options, rusage_addr);
    if (options & (1 << 24))
        return -22;
    ...
    struct rusage_ rusage;
    int_t res = do_wait(idtype, id, &info, &rusage, options | (1 << 2));
    if (res < 0 || (res == 0 && info.child.pid == 0))
        return res;
    if (status_addr != 0 && user_write(status_addr, &(info.child.status), sizeof(info.child.status)))
        return -14;
    if (rusage_addr != 0 && user_write(rusage_addr, &(rusage), sizeof(rusage)))
        return -14;
