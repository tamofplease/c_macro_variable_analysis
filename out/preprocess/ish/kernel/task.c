...
lock_t pids_lock = {
# 13 "../kernel/task.c" 3 4
                  { { 0, 0, 0, 0, PTHREAD_MUTEX_TIMED_NP, 0, { 0, 0 } } }
# 13 "../kernel/task.c"
                  , 0};

static 
# 15 "../kernel/task.c" 3 4
      _Bool 
# 15 "../kernel/task.c"
           pid_empty(struct pid *pid) {
    return pid->task == 
# 16 "../kernel/task.c" 3 4
                       ((void *)0) 
# 16 "../kernel/task.c"
...
struct task *pid_get_task_zombie(dword_t id) {
    ...
    if (pid == 
# 30 "../kernel/task.c" 3 4
              ((void *)0)
# 30 "../kernel/task.c"
                  )
        return 
# 31 "../kernel/task.c" 3 4
              ((void *)0)
# 31 "../kernel/task.c"
                  ;
...
struct task *pid_get_task(dword_t id) {
    ...
    if (task != 
# 38 "../kernel/task.c" 3 4
               ((void *)0) 
# 38 "../kernel/task.c"
                    && task->zombie)
        return 
# 39 "../kernel/task.c" 3 4
              ((void *)0)
# 39 "../kernel/task.c"
                  ;
    return task;
...
struct task *task_create_(struct task *parent) {
    __lock(&pids_lock, "../kernel/task.c", 44);
    ...
    if (task == 
# 56 "../kernel/task.c" 3 4
               ((void *)0)
# 56 "../kernel/task.c"
                   )
        return 
# 57 "../kernel/task.c" 3 4
              ((void *)0)
# 57 "../kernel/task.c"
                  ;
    *task = (struct task) {};
    if (parent != 
# 59 "../kernel/task.c" 3 4
                 ((void *)0)
# 59 "../kernel/task.c"
                     )
        *task = *parent;
...
# 76 "../kernel/task.c"
    ...
    task->waiting_cond = 
# 82 "../kernel/task.c" 3 4
                        ((void *)0)
# 82 "../kernel/task.c"
                            ;
    task->waiting_lock = 
# 83 "../kernel/task.c" 3 4
                        ((void *)0)
# 83 "../kernel/task.c"
                            ;
