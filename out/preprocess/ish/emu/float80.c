...
# 120 "../emu/float80.c"
       "f80_is_supported(f)"
# 120 "../emu/float80.c" 3 4
       , "../emu/float80.c", 120, __extension__ __PRETTY_FUNCTION__); }))
# 120 "../emu/float80.c"
                                  ;
...
# 412 "../emu/float80.c"
   "f80_is_supported(f)"
# 412 "../emu/float80.c" 3 4
   , "../emu/float80.c", 412, __extension__ __PRETTY_FUNCTION__); }))
# 412 "../emu/float80.c"
                              ;
    return f;
}
...
# 491 "../emu/float80.c" 3 4
_Bool 
# 491 "../emu/float80.c"
    f80_uncomparable(float80 a, float80 b) {
    if (!f80_is_supported(a) || !f80_is_supported(b))
        return 
# 493 "../emu/float80.c" 3 4
              1
# 493 "../emu/float80.c"
                  ;
    if (f80_isnan(a) || f80_isnan(b))
        return 
# 495 "../emu/float80.c" 3 4
              1
# 495 "../emu/float80.c"
                  ;
    return 
# 496 "../emu/float80.c" 3 4
          0
# 496 "../emu/float80.c"
               ;
}
...
# 499 "../emu/float80.c" 3 4
_Bool 
# 499 "../emu/float80.c"
    f80_lt(float80 a, float80 b) {
    if (f80_uncomparable(a, b))
        return 
# 501 "../emu/float80.c" 3 4
              0
# 501 "../emu/float80.c"
                   ;
...
# 512 "../emu/float80.c" 3 4
_Bool 
# 512 "../emu/float80.c"
    f80_eq(float80 a, float80 b) {
    if (f80_uncomparable(a, b))
        return 
# 514 "../emu/float80.c" 3 4
              0
# 514 "../emu/float80.c"
                   ;
