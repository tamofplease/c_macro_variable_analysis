...
int main(int argc, const char *argv[]) {
    ...
    if (strcmp(
# 16 "../tools/fakefsify.c" 3 4
              __xpg_basename
# 16 "../tools/fakefsify.c"
                      ((char *) argv[0]), "unfakefsify") == 0) {
        cmd = cmd_export;
    }

    if (argc != 3) {
        fprintf(
# 21 "../tools/fakefsify.c" 3 4
               stderr
# 21 "../tools/fakefsify.c"
                     , "wrong number of arguments\n");
        switch (cmd) {
            case cmd_import:
                fprintf(
# 24 "../tools/fakefsify.c" 3 4
                       stderr
# 24 "../tools/fakefsify.c"
                             , "usage: %s <rootfs.tar.gz> <fakefs>\n", argv[0]);
                break;
            case cmd_export:
                fprintf(
# 27 "../tools/fakefsify.c" 3 4
                       stderr
# 27 "../tools/fakefsify.c"
                             , "usage: %s <fakefs> <rootfs.tar.gz>\n", argv[0]);
                break;
        }
        return 1;
    }
...
# 34 "../tools/fakefsify.c" 3 4
   _Bool 
# 34 "../tools/fakefsify.c"
        (*func)(const char *, const char *, struct fakefsify_error *, struct progress) = 
# 34 "../tools/fakefsify.c" 3 4
                                                                                         ((void *)0)
# 34 "../tools/fakefsify.c"
                                                                                             ;
    ...
    if (!(*func)(argv[1], argv[2], &err, (struct progress) {})) {
        fprintf(
# 40 "../tools/fakefsify.c" 3 4
               stderr
# 40 "../tools/fakefsify.c"
