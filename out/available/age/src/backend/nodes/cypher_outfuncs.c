...
#define WRITE_ENUM_FIELD(field_name,enum_type) do { appendStringInfo(str, " :" CppAsString(field_name) " %d", (int)_node->field_name); } while (0)
...
#define WRITE_INT32_FIELD(field_name) do { appendStringInfo(str, " :" CppAsString(field_name) " %d", _node->field_name); } while (0)
...
#define WRITE_BOOL_FIELD(field_name) do { appendStringInfo(str, " :" CppAsString(field_name) " %s", _node->field_name ? "true" : "false"); } while (0)
...
#define WRITE_INT64_FIELD(field_name) do { appendStringInfo(str, " :" CppAsString(field_name) " %ld", _node->field_name); } while (0)
...
#define WRITE_STRING_FIELD(field_name) do { appendStringInfoString(str, " :" CppAsString(field_name) " "); outToken(str, _node->field_name); } while (0)
...
#define WRITE_CHAR_FIELD(fldname) do { (appendStringInfo(str, " :" CppAsString(fldname) " "), outChar(str, _node->fldname)); } while (0)
...
#define WRITE_NODE_FIELD(field_name) do { appendStringInfoString(str, " :" CppAsString(field_name) " "); outNode(str, _node->field_name); } while (0)
...
#define WRITE_LOCATION_FIELD(field_name) do { appendStringInfo(str, " :" CppAsString(field_name) " %d", _node->field_name); } while (0)
...
#define WRITE_OID_FIELD(fldname) do { appendStringInfo(str, " :" CppAsString(fldname) " %u", _node->fldname); } while(0);
