...
#define PROCARRAY_ANALYZE_FLAG 0x04
...
#define PROCARRAY_VACUUM_FLAG 0x02
...
#define PROCARRAY_SLOTS_XMIN 0x20
...
#define PROCARRAY_PROC_FLAGS_MASK (PROCARRAY_VACUUM_FLAG | PROCARRAY_ANALYZE_FLAG | PROCARRAY_LOGICAL_DECODING_FLAG)
