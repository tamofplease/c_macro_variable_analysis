...
#define handle_nans(a,b) do { if (!f80_is_supported(a) || !f80_is_supported(b)) return F80_NAN; if (f80_isnan(a) && f80_isnan(b) && a.sign && !b.sign) return b; if (f80_isnan(a)) return a; if (f80_isnan(b)) return b; } while(0)
