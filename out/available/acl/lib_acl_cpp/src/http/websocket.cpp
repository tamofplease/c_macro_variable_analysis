...
#define swap64(val) (((val) >> 56) | (((val) & 0x00ff000000000000ll) >> 40) | (((val) & 0x0000ff0000000000ll) >> 24) | (((val) & 0x000000ff00000000ll) >> 8) | (((val) & 0x00000000ff000000ll) << 8) | (((val) & 0x0000000000ff0000ll) << 24) | (((val) & 0x000000000000ff00ll) << 40) | (((val) << 56)))
