...
#define ERESTART 85
#define EISNAM 120
#define debug_htable_link(_table,_element,_n) { DEBUG_HTABLE_INFO **_h = _table->data + _n; _element->prev = 0; if ((_element->next = *_h) != 0) (*_h)->prev = _element; *_h = _element; _table->used++; }
