...
#define binhash_link(_table,_element,_n) { ACL_BINHASH_INFO **_h = _table->data + _n; _element->prev = 0; if ((_element->next = *_h) != 0) (*_h)->prev = _element; *_h = _element; _table->used++; }
