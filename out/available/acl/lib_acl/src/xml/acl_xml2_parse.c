...
#define IS_ID(ptr) ((*(ptr) == 'i' || *(ptr) == 'I') && (*(ptr + 1) == 'd' || *(ptr + 1) == 'D'))
...
#define IS_DOCTYPE(ptr) ((*(ptr) == 'd' || *(ptr) == 'D') && (*(ptr + 1) == 'o' || *(ptr + 1) == 'O') && (*(ptr + 2) == 'c' || *(ptr + 2) == 'C') && (*(ptr + 3) == 't' || *(ptr + 3) == 'T') && (*(ptr + 4) == 'y' || *(ptr + 4) == 'Y') && (*(ptr + 5) == 'p' || *(ptr + 5) == 'P') && (*(ptr + 5) == 'E' || *(ptr + 6) == 'E'))
...
#define IS_CDATA(x) (*(x) == '[' && (*(x + 1) == 'C' || *(x + 1) == 'c') && (*(x + 2) == 'D' || *(x + 2) == 'd') && (*(x + 3) == 'A' || *(x + 3) == 'a') && (*(x + 4) == 'T' || *(x + 4) == 't') && (*(x + 5) == 'A' || *(x + 5) == 't') && *(x + 6) == '[')
