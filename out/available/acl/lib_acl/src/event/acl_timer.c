...
#define first_timer(head) (acl_ring_succ(head) != (head) ? ring_to_timer(acl_ring_succ(head)) : 0)
...
#define ring_to_timer(r) ((ACL_TIMER_INFO *) ((char *) (r) - offsetof(ACL_TIMER_INFO, entry)))
