...
#define g_set_object(object_ptr,new_object) (G_GNUC_EXTENSION ({ G_STATIC_ASSERT (sizeof *(object_ptr) == sizeof (new_object)); union { char *in; GObject **out; } _object_ptr; _object_ptr.in = (char *) (object_ptr); (void) (0 ? *(object_ptr) = (new_object), FALSE : FALSE); (g_set_object) (_object_ptr.out, (GObject *) new_object); })) GLIB_AVAILABLE_MACRO_IN_2_44
...
#define _G_DEFINE_POINTER_TYPE_BEGIN(TypeName,type_name) static GType type_name ##_get_type_once (void); GType type_name ##_get_type (void) { static gsize static_g_define_type_id = 0; if (g_once_init_enter (&static_g_define_type_id)) { GType g_define_type_id = type_name ##_get_type_once (); g_once_init_leave (&static_g_define_type_id, g_define_type_id); } return static_g_define_type_id; } G_GNUC_NO_INLINE static GType type_name ##_get_type_once (void) { GType g_define_type_id = g_pointer_type_register_static (g_intern_static_string (#TypeName)); {
...
#define SIGFPE 8
#define G_IMPLEMENT_INTERFACE_DYNAMIC(TYPE_IFACE,iface_init) { const GInterfaceInfo g_implement_interface_info = { (GInterfaceInitFunc)(void (*)(void)) iface_init, NULL, NULL }; g_type_module_add_interface (type_module, g_define_type_id, TYPE_IFACE, &g_implement_interface_info); }
...
#define _G_DEFINE_INTERFACE_EXTENDED_END() } g_once_init_leave (&static_g_define_type_id, g_define_type_id); } return static_g_define_type_id; }
...
#define _G_DEFINE_TYPE_EXTENDED_END() } return g_define_type_id; }
...
#define g_task_set_source_tag(task,tag) G_STMT_START { GTask *_task = (task); (g_task_set_source_tag) (_task, tag); if (g_task_get_name (_task) == NULL) g_task_set_name (_task, G_STRINGIFY (tag)); } G_STMT_END
...
#define _WCHAR_T_ 
#define _G_DEFINE_INTERFACE_EXTENDED_BEGIN(TypeName,type_name,TYPE_PREREQ) static void type_name ##_default_init (TypeName ##Interface *klass); GType type_name ##_get_type (void) { static gsize static_g_define_type_id = 0; if (g_once_init_enter (&static_g_define_type_id)) { GType g_define_type_id = g_type_register_static_simple (G_TYPE_INTERFACE, g_intern_static_string (#TypeName), sizeof (TypeName ##Interface), (GClassInitFunc)(void (*)(void)) type_name ##_default_init, 0, (GInstanceInitFunc)NULL, (GTypeFlags) 0); if (TYPE_PREREQ != G_TYPE_INVALID) g_type_interface_add_prerequisite (g_define_type_id, TYPE_PREREQ); {
...
#define _G_DEFINE_TYPE_EXTENDED_BEGIN_REGISTER(TypeName,type_name,TYPE_PARENT,flags) if (g_once_init_enter (&static_g_define_type_id)) { GType g_define_type_id = type_name ##_get_type_once (); g_once_init_leave (&static_g_define_type_id, g_define_type_id); } return static_g_define_type_id; } G_GNUC_NO_INLINE static GType type_name ##_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple (TYPE_PARENT, g_intern_static_string (#TypeName), sizeof (TypeName ##Class), (GClassInitFunc)(void (*)(void)) type_name ##_class_intern_init, sizeof (TypeName), (GInstanceInitFunc)(void (*)(void)) type_name ##_init, (GTypeFlags) flags); {
...
#define g_clear_signal_handler(handler_id_ptr,instance) G_STMT_START { gpointer const _instance = (instance); gulong *const _handler_id_ptr = (handler_id_ptr); const gulong _handler_id = *_handler_id_ptr; if (_handler_id > 0) { *_handler_id_ptr = 0; g_signal_handler_disconnect (_instance, _handler_id); } } G_STMT_END GLIB_AVAILABLE_MACRO_IN_2_62
